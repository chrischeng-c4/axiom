...
//!
//! ```rust,ignore
//! use cclab_schema::custom_validators::{FieldValidator, ValidatorMode};
//! use cclab_schema::{Value, ValidationResult, ValidationErrors, ValidationError, ErrorType};
//!
...
pub fn field_error(field: impl Into<String>, message: impl Into<String>) -> ValidationErrors {
    let mut errors = ValidationErrors::new();
