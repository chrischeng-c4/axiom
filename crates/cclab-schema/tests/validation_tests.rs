...
fn test_url() {
    ...
    .is_ok());
    assert!(validate(
        &Value::String("http://localhost:8080/path".to_string()),
        &type_desc
    )
    .is_ok());
...
fn test_datetime() {
    ...
    // Valid
    assert!(validate(
        &Value::String("2024-01-19T12:00:00Z".to_string()),
        &type_desc
    )
    .is_ok());
    assert!(validate(
        &Value::String("2024-01-19T12:00:00+08:00".to_string()),
        &type_desc
    )
    .is_ok());
    ...
    // Invalid
    assert!(validate(
        &Value::String("2024-01-19 12:00:00".to_string()),
        &type_desc
    )
    .is_err());
}
