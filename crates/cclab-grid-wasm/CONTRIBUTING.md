# Contributing to cclab-grid-wasm

## Brief

How to change `crates/cclab-grid-wasm`. What it promises and the work roots it
...
| Gate | Command |
|---|---|
| unit + colocated tests | `cargo test -p cclab-grid-wasm` |
