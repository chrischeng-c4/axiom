# Cclab Cli Registry Contributing

<!-- aw:meta:project-contributing:start -->
## Brief

Project-local contribution contract for Cclab Cli Registry.
...
List the narrow commands that prove changes to Cclab Cli Registry.
