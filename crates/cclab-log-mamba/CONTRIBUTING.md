# Contributing to cclab-log-mamba

## Brief

How to change `crates/cclab-log-mamba`. What it promises and the work roots it
...
| Gate | Command |
|---|---|
| unit + colocated tests | `cargo test -p cclab-log-mamba` |
