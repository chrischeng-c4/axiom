# Cclab Grid Render Webgpu Contributing

<!-- aw:meta:project-contributing:start -->
## Brief

Project-local contribution contract for Cclab Grid Render Webgpu.
...
List the narrow commands that prove changes to Cclab Grid Render Webgpu.
