# Contributing to cclab-mcp-mamba

## Brief

How to change `crates/cclab-mcp-mamba`. What it promises and the work roots it
...
| Gate | Command |
|---|---|
| unit + colocated tests | `cargo test -p cclab-mcp-mamba` |
