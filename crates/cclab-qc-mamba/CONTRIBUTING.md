# Contributing to cclab-qc-mamba

## Brief

How to change `crates/cclab-qc-mamba`. What it promises and the work roots it
...
| Gate | Command |
|---|---|
| unit + colocated tests | `cargo test -p cclab-qc-mamba` |
