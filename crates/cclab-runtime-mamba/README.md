...
|---|---:|---|---|---|---|---|
| Mamba Async Runtime Binding | - | implemented | verified | smoke | not_ready | sleep/spawn/gather ABI and `serve` route-table bridge are behavior-smoke verified |
...
EC Dimensions: behavior: `cargo test -p cclab-runtime-mamba` - sleep/spawn/gather ABI and Axum route-table bridge smoke
Root WI: -
Status: verified
...
|---|---|---:|---|---|---|---|
| Mamba sleep spawn and gather ABI contract | epic | - | implemented | verified | conformance | `cargo test -p cclab-runtime-mamba`; crates/cclab-runtime-mamba/src/lib.rs; crates/cclab-runtime-mamba/src/methods.rs; crates/cclab-runtime-mamba/src/types.rs; crates/cclab-runtime-mamba/tests/methods_test.rs |
| Mamba HTTP serve route-table bridge | epic | - | implemented | verified | smoke | `cargo test -p cclab-runtime-mamba`; crates/cclab-runtime-mamba/src/methods.rs |
