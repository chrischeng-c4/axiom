# Task: Analyze Spec 'class-features-spec' for Change 'mamba-p1-lang-features'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-p1-lang-features`.
...
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-p1-lang-features` with scope="class-features-spec"
...
cclab sdd artifact create-change-spec mamba-p1-lang-features <payload_path>
```
