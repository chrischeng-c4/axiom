# Task: Review Reference Context for Group 'class-features' (Change 'mamba-p1-lang-features')
...
2. **Read the reference context artifact**:
   `/Users/chrischeng/projects/wt/mamba/cclab/changes/mamba-p1-lang-features/groups/class-features/reference_context.md`
