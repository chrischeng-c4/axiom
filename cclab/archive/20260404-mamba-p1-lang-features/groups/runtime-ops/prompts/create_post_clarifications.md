# Task: Post-Clarification for Group 'runtime-ops' (Change 'mamba-p1-lang-features')

Issues: #974_type-3-arg-dynamic-class-creation-type-name-bases-, #844_tuple-comparison-operators-lt-le-gt-ge-for-tuples

## Context Sources

Read these files before analysis:
1. `/Users/chrischeng/projects/wt/mamba/cclab/changes/mamba-p1-lang-features/groups/runtime-ops/requirements.md`
2. `/Users/chrischeng/projects/wt/mamba/cclab/changes/mamba-p1-lang-features/groups/runtime-ops/pre_clarifications.md`
3. `/Users/chrischeng/projects/wt/mamba/cclab/changes/mamba-p1-lang-features/groups/runtime-ops/reference_context.md`
4. Actual specs — read high/medium relevance specs from reference_context.md

- Read high/medium relevance specs listed in reference_context.md (under `/Users/chrischeng/projects/wt/mamba/cclab/specs/`)
...
cclab sdd artifact create-post-clarifications mamba-p1-lang-features cclab/changes/mamba-p1-lang-features/payloads/create-post-clarifications.json
