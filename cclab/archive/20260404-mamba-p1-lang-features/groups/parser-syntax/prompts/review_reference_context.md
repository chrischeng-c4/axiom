# Task: Review Reference Context for Group 'parser-syntax' (Change 'mamba-p1-lang-features')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chrischeng/projects/wt/mamba/cclab/changes/mamba-p1-lang-features/groups/parser-syntax/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chrischeng/projects/wt/mamba/cclab/changes/mamba-p1-lang-features/groups/parser-syntax/reference_context.md`
