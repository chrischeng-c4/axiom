# Task: Review Reference Context for Group 'exception-chaining' (Change 'mamba-p1-lang-features')
...
2. **Read the reference context artifact**:
   `/Users/chrischeng/projects/wt/mamba/cclab/changes/mamba-p1-lang-features/groups/exception-chaining/reference_context.md`
