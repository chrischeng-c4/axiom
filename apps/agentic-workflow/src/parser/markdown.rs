// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/parser/markdown.md#source
// CODEGEN-BEGIN
...
/// ```
/// @spec apps/agentic-workflow/tech-design/core/interfaces/parser/markdown.md#source
