// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/backends/github_preamble_source.md#source
// CODEGEN-BEGIN
...
// CODEGEN-END
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/backends/github.md#schema
// CODEGEN-BEGIN
/// Issue backend that calls the `gh` CLI.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/issues/backends/github.md#schema
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/backends/github_runtime_source.md#source
// CODEGEN-BEGIN
/// @spec apps/agentic-workflow/tech-design/core/interfaces/issues/backends/github_runtime_source.md#source
impl GitHubBackend {
...
impl IssueBackend for GitHubBackend {
    ...
    // @spec apps/agentic-workflow/tech-design/core/logic/issues-backend.md#R8 — writable now that create/update/close are implemented
