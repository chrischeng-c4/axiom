// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/backends/local_preamble_source.md#source
// CODEGEN-BEGIN
...
// CODEGEN-END
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/backends/local_helpers_source.md#source
// CODEGEN-BEGIN
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/backends/local.md#schema
// CODEGEN-BEGIN
/// Backend that stores issues as files under an issue directory.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/issues/backends/local.md#schema
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/backends/local_runtime_source.md#source
// CODEGEN-BEGIN
/// @spec apps/agentic-workflow/tech-design/core/interfaces/issues/backends/local_runtime_source.md#source
impl LocalBackend {
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/backends/local_frontmatter_source.md#source
// CODEGEN-BEGIN
...
struct IssueFrontmatter {
    ...
    /// @spec apps/agentic-workflow/tech-design/core/interfaces/issues/issue-merge-target.md#schema
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/backends/local_persistence_source.md#source
// CODEGEN-BEGIN
/// @spec apps/agentic-workflow/tech-design/core/interfaces/issues/backends/local_persistence_source.md#source
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/backends/local_tests_source.md#source
// CODEGEN-BEGIN
#[cfg(test)]
mod tests {
    use super::*;
