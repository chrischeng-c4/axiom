// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/slug_preamble_source.md#source
// CODEGEN-BEGIN
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/slug_runtime_source.md#source
// CODEGEN-BEGIN
/// Issue/branch kind discriminator used by `parse_branch_name`.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
/// @spec apps/agentic-workflow/tech-design/core/interfaces/issues/slug_runtime_source.md#source
pub enum BranchKind {
    Issue,
    Td,
    Cb,
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/slug_tests_source.md#source
// CODEGEN-BEGIN
#[cfg(test)]
mod tests {
    use super::*;
