...
pub trait IssueBackend: Send + Sync {
    ...
    // @spec apps/agentic-workflow/tech-design/core/logic/issues-backend.md#R1 #R8
    ...
    ///
    /// Default: returns "not supported" error. Backends opt in by overriding.
    // @spec apps/agentic-workflow/tech-design/core/logic/issues-backend.md#R2 #R8
    ...
    ///
    /// Default: returns "not supported" error. Backends opt in by overriding.
    // @spec apps/agentic-workflow/tech-design/core/logic/issues-backend.md#R3 #R8
    ...
    // @spec apps/agentic-workflow/tech-design/core/logic/issues-backend.md#R4 #R8
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/backend.md#schema
// CODEGEN-BEGIN
/// Summary of an issue sync operation.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/issues/backend.md#schema
