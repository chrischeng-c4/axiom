// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/types_preamble_source.md#source
// CODEGEN-BEGIN
...
// CODEGEN-END
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/types.md#schema
// CODEGEN-BEGIN
...
pub mod td_phase {
    ...
    /// @spec apps/agentic-workflow/tech-design/surface/specs/score-cb-review-revise-crrr.md#schema
...
pub mod lifecycle_trailer {
    ...
    /// @spec apps/agentic-workflow/tech-design/surface/specs/score-recovery-verbs.md#schema
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/types_runtime_helpers_source.md#source
// CODEGEN-BEGIN
/// Coarse phases of the CRRR loop, mirrored as `Lifecycle-Stage` git trailers.
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/issues/types_runtime_helpers_source.md#source
impl IssuePhase {
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/types_patch_apply_source.md#source
// CODEGEN-BEGIN
...
impl IssuePatch {
    ...
    pub fn apply(&self, issue: &mut Issue) {
        ...
        // @spec apps/agentic-workflow/tech-design/surface/specs/score-td-validate-lifecycle-extension.md#schema
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/issues/types_error_slug_tests_source.md#source
// CODEGEN-BEGIN
/// Structured error codes for agent-first JSON error output.
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/issues/types_error_slug_tests_source.md#source
impl Issue {
...
mod tests {
    ...
    fn strip_prefix_cases() {
        assert_eq!(
            strip_title_prefix("epic: create apps/agentic-workflow"),
            "create apps/agentic-workflow"
        );
        assert_eq!(
