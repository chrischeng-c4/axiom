// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/review/preamble-definition.md#source
// CODEGEN-BEGIN
...
/// @spec apps/agentic-workflow/tech-design/core/tools/review/preamble-definition.md#source
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/review/execute.md#source
// CODEGEN-BEGIN
/// @spec apps/agentic-workflow/tech-design/core/tools/review/execute.md#source
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/review/inline-writer.md#source
// CODEGEN-BEGIN
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/review/tests.md#source
// CODEGEN-BEGIN
#[cfg(test)]
mod tests {
    use super::*;
    ...
    fn test_review_context_approved() {
        ...
        let change_dir = crate::shared::workspace::change_path(&root, "test-change");
        std::fs::write(
