...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/analyze/mod.md#source
// CODEGEN-BEGIN
mod python;
mod rust_lang;
mod suggestions;
...
/// @spec apps/agentic-workflow/tech-design/core/tools/analyze/mod.md#source
