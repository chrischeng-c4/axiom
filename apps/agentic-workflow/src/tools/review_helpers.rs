// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/review_helpers.md#source
// CODEGEN-BEGIN
...
/// @spec apps/agentic-workflow/tech-design/core/tools/review_helpers.md#source
