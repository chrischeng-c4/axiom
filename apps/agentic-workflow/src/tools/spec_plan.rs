...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/spec_plan/section-suggestions.md#source
// CODEGEN-BEGIN
...
/// @spec apps/agentic-workflow/tech-design/core/tools/spec_plan_entry.md#changes
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/spec_plan_entry.md#schema
// CODEGEN-BEGIN
/// One row of the spec-planning table in an issue's Reference Context.
/// @spec apps/agentic-workflow/tech-design/core/tools/spec_plan_entry.md#schema
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/spec_plan/file-preparation.md#source
// CODEGEN-BEGIN
...
mod tests {
    ...
    fn test_prepare_create() {
        let tmp = TempDir::new().unwrap();
        // main_spec_ref must have ≥4 path components (apps/agentic-workflow/logic/file.md)
        write_plan(
            tmp.path(),
            "group-a",
            "- spec_id: version-api\n  action: create\n  main_spec_ref: apps/agentic-workflow/api/version-api.md\n  sections: [overview, rest-api, schema]\n",
        );
        ...
        assert!(content.contains("main_spec_ref: apps/agentic-workflow/api/version-api.md"));
    ...
    fn test_prepare_create_no_base_snapshot() {
        ...
        write_plan(
            tmp.path(),
            "group-a",
            "- spec_id: new-spec\n  action: create\n  main_spec_ref: apps/agentic-workflow/logic/new-spec.md\n  sections: [overview, changes]\n",
        );
    ...
    fn test_prepare_invalid_main_spec_ref_3_components_aborts() {
        let tmp = TempDir::new().unwrap();
        // 3 components: apps/agentic-workflow/foo.md → rejected (need ≥ 4)
        write_plan(
            tmp.path(),
            "group-a",
            "- spec_id: foo\n  action: create\n  main_spec_ref: apps/agentic-workflow/foo.md\n  sections: [overview]\n",
        );
    ...
    fn test_prepare_valid_main_spec_ref_4_components_succeeds() {
        let tmp = TempDir::new().unwrap();
        // Exactly 4 components: apps/agentic-workflow/logic/foo.md → valid
        write_plan(
            tmp.path(),
            "group-a",
            "- spec_id: foo\n  action: create\n  main_spec_ref: apps/agentic-workflow/logic/foo.md\n  sections: [overview]\n",
        );
    ...
    fn test_prepare_valid_main_spec_ref_5_components_succeeds() {
        let tmp = TempDir::new().unwrap();
        // 5 components: apps/agentic-workflow/logic/sub/deep.md → also valid
        write_plan(
            tmp.path(),
            "group-a",
            "- spec_id: deep\n  action: create\n  main_spec_ref: apps/agentic-workflow/logic/sub/deep.md\n  sections: [overview]\n",
        );
    ...
    fn test_prepare_path_validation_aborts_all_no_files_written() {
        ...
        write_plan(
            ...
            "group-a",
            concat!(
                "- spec_id: good\n  action: create\n  main_spec_ref: apps/agentic-workflow/logic/good.md\n  sections: [overview]\n",
                "- spec_id: bad\n  action: create\n  main_spec_ref: apps/agentic-workflow/bad.md\n  sections: [overview]\n",
            ),
        );
