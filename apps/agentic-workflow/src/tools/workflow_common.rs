// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/workflow_common/validation-and-paths.md#source
// CODEGEN-BEGIN
...
/// @spec apps/agentic-workflow/tech-design/core/tools/workflow_common/validation-and-paths.md#source
...
///
/// Accepts the runtime layout plus legacy read-only fallbacks:
/// - Runtime:   `/tmp/aw/workspaces/<workspace>/changes/<id>/`
/// - Worktree:  `/tmp/aw/workspaces/<workspace>/worktrees/<slug>/...`
/// - Legacy:    `project_root/.aw/changes/<id>/`
/// - Legacy WT: `project_root/.aw/worktrees/<slug>/.aw/changes/<id>/`
///
...
pub fn validate_change_dir(change_dir: &Path, project_root: &Path) -> Result<()> {
    ...
    for parent in [
        workspace::changes_path(project_root),
        workspace::worktrees_path(project_root),
        project_root.join(".aw/changes"),
...
///
/// Scans `/tmp/aw/workspaces/<workspace>/changes/*/STATE.yaml` for changes
/// whose phase is non-terminal
...
pub fn resolve_active_change_id(project_root: &Path) -> Result<String> {
    let changes_dir = workspace::changes_path(project_root);
    if !changes_dir.exists() {
        anyhow::bail!(
            "No runtime changes directory found. Start a change with `score run-change`."
        );
    }
...
/// 1. Runtime: `/tmp/aw/workspaces/<workspace>/changes/{id}/`
/// 2. Worktree runtime: `/tmp/aw/workspaces/<workspace>/worktrees/{id}/...`
/// 3. Legacy fallbacks under `project_root/.aw`
///
...
pub fn resolve_change_dir(project_root: &Path, change_id: &str) -> PathBuf {
    let runtime_path = workspace::change_path(project_root, change_id);
    if runtime_path.exists() {
        return runtime_path;
    }

    let wt_path = workspace::worktree_path(project_root, change_id)
        .join("changes")
        .join(change_id);
    if wt_path.exists() {
        return wt_path;
    ...
    for legacy_path in [
        project_root
            ...
            .join(".aw/changes")
            .join(change_id),
        project_root.join(".aw/changes").join(change_id),
    ] {
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/workflow_common/git-status.md#source
// CODEGEN-BEGIN
...
/// @spec apps/agentic-workflow/tech-design/core/tools/workflow_common/git-status.md#source
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/workflow_common/phase-and-executor.md#source
// CODEGEN-BEGIN
/// Update STATE.yaml phase after successful agent execution.
///
/// StateManager::save() now dual-writes all workflow fields (phase, branch,
...
// REQ: R1 — Issue frontmatter absorbs STATE.yaml
// REQ: R6 — StateManager reads/writes issue frontmatter
/// @spec apps/agentic-workflow/tech-design/core/tools/workflow_common/phase-and-executor.md#source
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/workflow_common/interface-and-groups.md#source
// CODEGEN-BEGIN
/// Load the SddInterface from config (defaults to Cli).
/// @spec apps/agentic-workflow/tech-design/core/tools/workflow_common/interface-and-groups.md#source
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/workflow_common/prompt-response.md#source
// CODEGEN-BEGIN
...
/// @spec apps/agentic-workflow/tech-design/core/tools/workflow_common/prompt-response.md#source
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/workflow_common/group-issues-hint.md#source
// CODEGEN-BEGIN
/// Build a hint string listing issues belonging to a group (from frontmatter).
/// @spec apps/agentic-workflow/tech-design/core/tools/workflow_common/group-issues-hint.md#source
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/workflow_common/tests.md#source
// CODEGEN-BEGIN
#[cfg(test)]
mod tests {
    use super::*;
