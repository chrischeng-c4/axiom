...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/init_change/definition.md#source
// CODEGEN-BEGIN
/// MCP tool definition for sdd_init_change
/// @spec apps/agentic-workflow/tech-design/core/logic/structured-issue.md#changes
/// @spec apps/agentic-workflow/tech-design/core/logic/state-machine.md#changes
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/init_change/standalone-flow.md#source
// CODEGEN-BEGIN
/// @spec apps/agentic-workflow/tech-design/core/logic/structured-issue.md#requirements
/// @spec apps/agentic-workflow/tech-design/core/logic/state-machine.md#requirements
pub fn execute_standalone(args: &Value, project_root: &Path) -> Result<String> {
    ...
    // in a worktree under `/tmp/aw/workspaces/<workspace>/worktrees/<slug>`.
    // Log a warning if callers still
    ...
    // @spec apps/agentic-workflow/tech-design/core/interfaces/models/state.md#R1
    ...
    let wt_path = workspace::worktree_path(project_root, &issue_slug);
    if wt_path.exists() {
        anyhow::bail!(
    ...
    let change_dir = workspace::change_path(change_root, &change_id);
    {
        ...
        // @spec apps/agentic-workflow/tech-design/core/interfaces/models/state.md#R4
...
///
/// Returns the absolute worktree path on success. Uses the runtime workspace
/// path (`/tmp/aw/workspaces/<workspace>/worktrees/<slug>`) plus branch
/// `cclab/<slug>`.
///
...
pub(super) fn create_worktree(project_root: &Path, slug: &str) -> Result<PathBuf> {
    ...
    let worktree_abs = workspace::worktree_path(project_root, slug);
...
///
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/state.md#R9
/// R9: Scans the runtime worktrees dir plus issue frontmatter (not STATE.yaml).
///
/// Algorithm:
/// 1. Iterate runtime `worktrees/{slug}/` directories — each represents an active change.
...
fn check_branch_uniqueness(
    ...
    let worktrees_dirs = [
        workspace::worktrees_path(project_root),
        project_root.join(".aw/worktrees"),
    ];
    for worktrees_dir in worktrees_dirs {
...
fn create_change_internal(
    ...
    let change_dir = workspace::change_path(project_root, change_id);
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/init_change/legacy-artifact-flow.md#source
// CODEGEN-BEGIN
/// @spec apps/agentic-workflow/tech-design/core/logic/structured-issue.md#changes
/// @spec apps/agentic-workflow/tech-design/core/logic/state-machine.md#requirements
pub fn execute(args: &Value, project_root: &Path) -> Result<String> {
    ...
    // @spec apps/agentic-workflow/tech-design/core/interfaces/models/state.md#R7
...
"#
    ...
    // @spec apps/agentic-workflow/tech-design/core/interfaces/models/state.md
...
## Scope\n\nJust the invariant.\n";
    ...
    // @spec apps/agentic-workflow/tech-design/core/interfaces/models/state.md#R2
    ...
    // @spec apps/agentic-workflow/tech-design/core/interfaces/models/state.md#R8
