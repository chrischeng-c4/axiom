...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/create_reference_context/definitions.md#source
// CODEGEN-BEGIN
/// MCP tool definition for sdd_workflow_create_reference_context
/// @spec apps/agentic-workflow/tech-design/core/logic/remaining-fixes.md#changes
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/create_reference_context/artifact.md#source
// CODEGEN-BEGIN
/// @spec apps/agentic-workflow/tech-design/core/logic/remaining-fixes.md#changes
...
mod tests {
    ...
    async fn test_workflow_prompt_includes_spec_structure_when_specs_exist() {
        ...
        // Create spec files under apps/agentic-workflow/tech-design/core/
        let specs_dir = tmp.path().join("apps/agentic-workflow/tech-design/core");
