...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/phase_transition/source.md#source
// CODEGEN-BEGIN
// @spec apps/agentic-workflow/tech-design/surface/specs/issue-crrr-state-machine.md#R1
/// @spec apps/agentic-workflow/tech-design/surface/specs/issue-crrr-state-machine.md#logic
...
pub fn parse_phase(s: &str) -> Result<StatePhase> {
    match s {
        ...
        // See apps/agentic-workflow/tech-design/surface/specs/issue-crrr-state-machine.md (CRRR-terminal
