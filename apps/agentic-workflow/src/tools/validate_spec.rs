// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/validate_spec/preamble-definition.md#source
// CODEGEN-BEGIN
...
/// @spec apps/agentic-workflow/tech-design/core/tools/validate_spec/preamble-definition.md#source
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/validate_spec/execute-logic.md#source
// CODEGEN-BEGIN
/// Execute the validate_spec_completeness tool
/// @spec apps/agentic-workflow/tech-design/core/tools/validate_spec/execute-logic.md#source
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/validate_spec/tests.md#source
// CODEGEN-BEGIN
#[cfg(test)]
mod tests {
    use super::*;
