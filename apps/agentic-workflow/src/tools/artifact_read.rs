// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/artifact_read.md#source
// CODEGEN-BEGIN
...
/// @spec apps/agentic-workflow/tech-design/core/tools/artifact_read.md#source
