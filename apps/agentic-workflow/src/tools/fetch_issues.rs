// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/fetch_issues.md#source
// CODEGEN-BEGIN
...
//! Platform is auto-detected from `[platform] type` in `aw.toml`.
...
/// @spec apps/agentic-workflow/tech-design/core/tools/fetch_issues.md#source
pub fn definition() -> ToolDefinition {
    ToolDefinition {
        name: "sdd_fetch_issues".to_string(),
        description: "Fetch issues and build dependency graph in STATE.yaml. \
            Auto-detects platform (GitHub/GitLab) from aw.toml [platform] type. \
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/fetch_issues/runtime.md#source
// CODEGEN-BEGIN
// ---------------------------------------------------------------------------
// Types
// ---------------------------------------------------------------------------
...
/// Detect platform type from aw.toml `[platform] type`
...
/// Detect repo from aw.toml `[platform] repo`
...
/// @spec apps/agentic-workflow/tech-design/core/tools/fetch_issues/runtime.md#source
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/fetch_issues/tests.md#source
// CODEGEN-BEGIN
// ---------------------------------------------------------------------------
// Tests
// ---------------------------------------------------------------------------
