...
//!
//! Spec: `apps/agentic-workflow/specs/three-role-contract.md` R5–R7.
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/workflow_validate/definition.md#source
// CODEGEN-BEGIN
