// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/platform_sync/source.md#source
// CODEGEN-BEGIN
//! Platform Sync MCP Tool
//!
//! Syncs SDD change artifacts to external platforms.
//! Configuration is read from `aw.toml` (preferred) or `aw.yaml`.
...
/// @spec apps/agentic-workflow/tech-design/core/tools/platform_sync/source.md#source
