// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/interfaces/src/update.md#source
// CODEGEN-BEGIN
use crate::Result;
...
// Run update command
// @spec apps/agentic-workflow/tech-design/surface/interfaces/src/update.md#source
