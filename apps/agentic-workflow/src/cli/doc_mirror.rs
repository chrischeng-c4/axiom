...
pub const TRAITS: &[TraitDef] = &[
    ...
    TraitDef {
        id: "agent_facing",
        baseline_caps: &["agent-task-navigation"],
        contributing_anchor: Some("## DX convention: every service and CLI ships a Developer & Agent Experience capability"),
        about: "Project is primarily driven by agents and owes an offline task-navigation protocol with verified runbooks.",
    },
    TraitDef {
        id: "stateful_storage",
        baseline_caps: &[],
