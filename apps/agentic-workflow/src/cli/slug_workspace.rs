// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/interfaces/src/slug_workspace.md#source
// CODEGEN-BEGIN
...
//!
use crate::issues::slug::BranchKind;
use anyhow::Result;
...
mod tests {
    ...
    fn enter_creates_td_branch_from_main_when_provisioning() {
        ...
        assert!(
            crate::branch_switch::branch_exists_local(tmp.path(), "td-demo").unwrap(),
