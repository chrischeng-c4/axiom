...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/patterns/types.md#schema
// CODEGEN-BEGIN
use serde::{Deserialize, Serialize};

/// A node in the abstract layout tree.
/// @spec apps/agentic-workflow/tech-design/core/generate/patterns/types.md#schema
