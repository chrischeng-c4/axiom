// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/marker.md#source
// CODEGEN-BEGIN
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-markers.md#R1
...
/// @spec apps/agentic-workflow/tech-design/core/generate/marker.md#source
pub enum Lang {
    Rust,
    Python,
    TypeScript,
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-markers.md#R2
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-markers.md#R6
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-markers.md#R4
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-markers.md#R5
...
// SPEC-MANAGED: apps/agentic-workflow/logic/state.md#state-phase
// CODEGEN-BEGIN
pub enum StatePhase {
    ChangeInited,
    ChangeArchived,
...
"#;
    ...
    fn test_parse_codegen_blocks() {
        ...
        assert_eq!(
            block.spec_ref,
            "apps/agentic-workflow/logic/state.md#state-phase"
        );
    ...
    fn test_emit_spec_ref() {
        let marker = emit_spec_ref(
            "apps/agentic-workflow/logic/state.md",
            "routing",
        ...
        assert_eq!(
            marker,
            "// SPEC-REF: apps/agentic-workflow/logic/state.md#routing\n// TODO: Implement routing logic"
        );
    }
...
"#;
    ...
    fn test_insert_codegen_block() {
        ...
        let result = insert_codegen_block(
            file,
            "apps/agentic-workflow/tech-design/core/tools/spec.md#foo",
            "// generated",
            Some("fn foo()"),
            Lang::Rust,
        );
        assert!(result
            .contains("SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/spec.md#foo"));
    ...
    fn test_multiple_codegen_blocks() {
        let file = r#"
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/spec.md#block-a
// CODEGEN-BEGIN
content a
// CODEGEN-END

// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/spec.md#block-b
// CODEGEN-BEGIN
content b
// CODEGEN-END
"#;
        ...
        assert_eq!(
            blocks[0].spec_ref,
            "apps/agentic-workflow/tech-design/core/tools/spec.md#block-a"
        );
        assert_eq!(
            blocks[1].spec_ref,
            "apps/agentic-workflow/tech-design/core/tools/spec.md#block-b"
        );
    }
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/spec.md#source
// CODEGEN-BEGIN
pub fn generated() {}
// CODEGEN-END
"##;
        ...
        assert_eq!(
            blocks[0].spec_ref,
            "apps/agentic-workflow/tech-design/core/tools/spec.md#source"
        );
...
fn fixture() {
    let content = "\
// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/interfaces/src/lib.md#source
// CODEGEN-BEGIN
// CODEGEN-END
";
}
...
"#;
        ...
        assert_eq!(
            blocks[0].spec_ref,
            "apps/agentic-workflow/tech-design/surface/interfaces/src/cb.md#source"
        );
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/spec.md#schema
// CODEGEN-BEGIN
...
"#;
        ...
        assert_eq!(
            blocks[1].spec_ref,
            "apps/agentic-workflow/tech-design/core/tools/spec.md#schema"
        );
    }
...
"#;
    ...
    fn test_insert_codegen_block_python_lang() {
        ...
        assert!(
            result.contains(
                "# SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/spec.md#foo"
            ),
    ...
    fn test_replace_codegen_block_python_style() {
        let file = "# SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/spec.md#model\n# CODEGEN-BEGIN\nold_content\n# CODEGEN-END\n";
        let result = replace_codegen_block(
            file,
            "apps/agentic-workflow/tech-design/core/tools/spec.md#model",
            "new_content",
        );
        assert!(
    ...
    fn test_emit_spec_ref_python() {
        let marker = emit_spec_ref(
            "apps/agentic-workflow/tech-design/core/tools/spec.md",
            "section",
            "Implement logic",
            Lang::Python,
        );
        assert_eq!(
            marker,
            "# SPEC-REF: apps/agentic-workflow/tech-design/core/tools/spec.md#section\n# TODO: Implement logic"
        );
    }
}
