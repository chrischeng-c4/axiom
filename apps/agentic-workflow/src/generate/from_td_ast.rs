...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/from-td-ast.md#schema
// CODEGEN-BEGIN
...
/// @spec apps/agentic-workflow/tech-design/core/generate/from-td-ast.md#schema.trait-impls.Default
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/from-td-ast.md#source
// CODEGEN-BEGIN
...
// CODEGEN-END
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/specs/mermaid-plus-ast-and-ir.md#logic
// CODEGEN-BEGIN
/// @spec apps/agentic-workflow/tech-design/core/specs/mermaid-plus-ast-and-ir.md#logic
pub fn enter() -> std::result::Result<(), Box<dyn std::error::Error>> {
    // SPEC-REF: apps/agentic-workflow/tech-design/core/specs/mermaid-plus-ast-and-ir.md#mermaid-plus-ast-and-ir-pipeline-split_fence
    ...
    /* yes */
    {
        // SPEC-REF: apps/agentic-workflow/tech-design/core/specs/mermaid-plus-ast-and-ir.md#mermaid-plus-ast-and-ir-pipeline-parse_yaml
        ...
        /* yes */
        {
            // SPEC-REF: apps/agentic-workflow/tech-design/core/specs/mermaid-plus-ast-and-ir.md#mermaid-plus-ast-and-ir-pipeline-derive_id
            ...
            // SPEC-REF: apps/agentic-workflow/tech-design/core/specs/mermaid-plus-ast-and-ir.md#mermaid-plus-ast-and-ir-pipeline-build_block
