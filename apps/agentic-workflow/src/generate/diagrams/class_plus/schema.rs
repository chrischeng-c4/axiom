...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/diagrams/class_plus/schema.md#schema
// CODEGEN-BEGIN
use serde::{Deserialize, Serialize};

/// Attribute definition.
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/class_plus/schema.md#schema
