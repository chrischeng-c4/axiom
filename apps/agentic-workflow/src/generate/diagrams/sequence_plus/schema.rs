...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/diagrams/sequence_plus/schema.md#schema
// CODEGEN-BEGIN
use serde::{Deserialize, Serialize};

/// Alt block type.
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/sequence_plus/schema.md#schema
