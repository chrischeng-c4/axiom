...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/diagrams/requirement_plus/schema.md#schema
// CODEGEN-BEGIN
use serde::{Deserialize, Serialize};

/// Design element definition.
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/requirement_plus/schema.md#schema
