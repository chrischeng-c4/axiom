...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/diagrams/block_plus/schema.md#schema
// CODEGEN-BEGIN
use serde::{Deserialize, Serialize};

/// Block diagram definition (Mermaid block-beta).
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/block_plus/schema.md#schema
