...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/diagrams/erd_plus/schema.md#schema
// CODEGEN-BEGIN
use serde::{Deserialize, Serialize};

/// Relationship cardinality between two entities.
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/erd_plus/schema.md#schema
