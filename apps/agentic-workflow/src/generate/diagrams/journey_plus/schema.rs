...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/diagrams/journey_plus/schema.md#schema
// CODEGEN-BEGIN
use serde::{Deserialize, Serialize};

/// Journey diagram definition.
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/journey_plus/schema.md#schema
