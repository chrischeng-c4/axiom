...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/diagrams/flowchart_plus/schema.md#schema
// CODEGEN-BEGIN
use serde::{Deserialize, Serialize};

/// Database operation type.
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/flowchart_plus/schema.md#schema
