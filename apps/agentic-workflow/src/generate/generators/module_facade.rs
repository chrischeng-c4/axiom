...
//! markers in files like `apps/agentic-workflow/src/td_ast/mod.rs`.
//!
//! @spec apps/agentic-workflow/tech-design/core/generate/generators/module-facade.md

// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/generators/module-facade.md#schema
// CODEGEN-BEGIN
use serde::{Deserialize, Serialize};

/// A single module-facade export pair: one pub mod declaration and one or more pub use re-exports (R1, R2).
/// @spec apps/agentic-workflow/tech-design/core/generate/generators/module-facade.md#schema
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/generators/module-facade.md#logic
// CODEGEN-BEGIN
/// @spec apps/agentic-workflow/tech-design/core/generate/generators/module-facade.md#logic
