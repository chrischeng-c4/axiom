// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/generators/axum_preamble.md#source
// CODEGEN-BEGIN
//! Axum code generator
...
use serde::Serialize;
// CODEGEN-END
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/generators/axum.md#schema
// CODEGEN-BEGIN
/// Axum generator (unit struct).
/// @spec apps/agentic-workflow/tech-design/core/generate/generators/axum.md#schema
pub struct AxumGenerator;
// CODEGEN-END

// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/generators/axum_runtime.md#source
// CODEGEN-BEGIN

/// @spec apps/agentic-workflow/tech-design/core/generate/generators/axum_runtime.md#source
impl AxumGenerator {
    pub fn new() -> Self {
        Self
    }
