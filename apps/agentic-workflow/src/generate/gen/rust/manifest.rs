// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/gen/rust/manifest.md#source
// CODEGEN-BEGIN
...
//! ```toml
//! [dependencies]
//! # SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/spec.md#manifest
//! # CODEGEN-BEGIN
...
#[derive(Debug, Clone)]
/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/manifest.md#source
