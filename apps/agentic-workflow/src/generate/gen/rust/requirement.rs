// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/gen/rust/requirement.md#source
// CODEGEN-BEGIN
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-documentation.md#R1
...
/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/requirement.md#schema
#[derive(Debug, Clone)]
...
mod tests {
    ...
    fn make_annotations() -> Vec<RequirementAnnotation> {
        vec![
            RequirementAnnotation {
                ...
                spec_path: "apps/agentic-workflow/tech-design/core/tools/spec.md".to_string(),
    ...
    fn test_generates_injection_for_impl_at_location() {
        ...
        assert!(
            joined.contains("@spec apps/agentic-workflow/tech-design/core/tools/spec.md#R1"),
