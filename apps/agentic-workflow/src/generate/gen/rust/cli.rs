// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/gen/rust/cli.md#source
// CODEGEN-BEGIN
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-structural.md#R2

use crate::generate::types::RustConfig;
use serde_yaml::Value;

/// Output from CLI codegen.
/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/cli.md#schema
#[derive(Debug, Clone)]
