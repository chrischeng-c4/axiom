// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/gen/rust/logic_emitter.md#source
// CODEGEN-BEGIN
...
//!     `apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-emitter.md`.
...
//!
//! /// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-emitter.md
...
///
/// /// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-emitter.md#schema (LogicNodeKind)
...
pub enum LogicNodeKind {
    ...
    /// convention as `Loop`).
    ///
    /// /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-2-decisions.md#schema (LogicNodeDecision)
    Decision,
    ...
    /// `after`-edge target.
    ///
    /// /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-2-decisions.md#schema (LogicNodeMatch)
    #[serde(rename = "match")]
    Match,
    ...
    ///
    /// /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-2-5-expression-decision.md#schema (LogicNodeDecisionExpr)
    ...
    /// `DecisionExpr`.
    ///
    /// /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-2-5-expression-decision.md#schema (LogicNodeMatchExpr)
...
///
/// /// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-emitter.md#schema (LogicNode)
...
pub struct LogicNode {
    ...
    ///
    /// /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-2-5-expression-decision.md#schema (LogicNodeDecisionExpr)
    /// /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-3b-result-propagation.md#schema (ProcessArmFourCaseComposition)
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// Pattern-1 behaviour.
    ///
    /// /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-3b-result-propagation.md#schema (LogicNodeFallibleField)
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// `;` and no `?`).
    ///
    /// /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-3b-result-propagation.md#schema (LogicNodeErrorPropagatingField)
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub error_propagating: Option<bool>,
}

/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/logic_emitter.md#source
...
///
/// /// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-emitter.md#schema (LogicEdgeKind)
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "lowercase")]
pub enum LogicEdgeKind {
    ...
    ///
    /// /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-2-decisions.md#schema (LogicEdgeBranch)
    Branch,
}
...
/// One edge.
///
/// /// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-emitter.md#schema (LogicEdge)
...
///
/// /// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-emitter.md#schema (LogicSpec)
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
///
/// /// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-emitter.md#logic
...
fn walk(
    ...
    match node.kind {
        // /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-3b-result-propagation.md#logic (Process arm four-case composition)
        LogicNodeKind::Process => {
            let code = node
                .code
                .as_deref()
        ...
        // /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-3b-result-propagation.md#logic (Terminal arm error_propagating)
        ...
        // /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-2-decisions.md#logic (Decision arm)
        ...
        // /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-2-decisions.md#logic (Match arm)
        LogicNodeKind::Match => {
            let expr = node
                .expr
                .as_deref()
        ...
        // /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-2-5-expression-decision.md#logic (DecisionExpr arm)
        ...
        // /// @spec apps/agentic-workflow/tech-design/core/generate/path-b-pattern-2-5-expression-decision.md#logic (MatchExpr arm)
...
mod tests {
    ...
    /// `apps/agentic-workflow/src/generate/generators/module_facade.rs`. The emitter
...
"#;
    ...
    fn emit_cli_subcommand_full_body_matches_spec_byte_for_byte() {
        ...
        let candidate_paths = [
            "apps/agentic-workflow/tech-design/core/generate/generators/cli-subcommand.md",
            "../../apps/agentic-workflow/tech-design/core/generate/generators/cli-subcommand.md",
            "../apps/agentic-workflow/tech-design/core/generate/generators/cli-subcommand.md",
        ];
        ...
        // file!() => apps/agentic-workflow/src/generate/gen/rust/logic_emitter.rs
        // sibling => apps/agentic-workflow/src/generate/generators/cli_subcommand.rs
        let crate_root = this_file
            .ancestors()
            .find(|p| p.ends_with("apps/agentic-workflow"))
            .expect("locate apps/agentic-workflow");
    ...
    fn emit_cli_subcommand_await_tail_matches_handwritten_byte_for_byte() {
        ...
        // apps/agentic-workflow/src/generate/generators/cli_subcommand.rs body, the
...
"#;
    ...
    fn emit_parse_attributes_body_matches_handwritten_byte_for_byte() {
        ...
        // apps/agentic-workflow/src/generate/audit.rs (inside the same HANDWRITE
