...
// CODEGEN-BEGIN
// Router emitter (R3 of apps/agentic-workflow/tech-design/core/specs/python-backend-emitter.md). Hand-written until
...
/// @spec apps/agentic-workflow/tech-design/core/specs/python-backend-emitter.md#py-emit-router
