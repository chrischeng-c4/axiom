...
// CODEGEN-BEGIN
// Pydantic model emitter (R2 of apps/agentic-workflow/tech-design/core/specs/python-backend-emitter.md). Hand-written
...
/// @spec apps/agentic-workflow/tech-design/core/specs/python-backend-emitter.md#py-emit-pydantic-model
...
/// @spec apps/agentic-workflow/tech-design/core/specs/python-backend-emitter.md#logic
///
