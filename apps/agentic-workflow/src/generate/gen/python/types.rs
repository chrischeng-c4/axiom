...
// apps/agentic-workflow/tech-design/core/specs/python-backend-emitter.md). Hand-written until the schema-to-Rust
// type generator can emit Pydantic-flavoured records under
// `apps/agentic-workflow/src/generate/gen/python/`.
/// @spec apps/agentic-workflow/tech-design/core/specs/python-backend-emitter.md#schema
use serde::{Deserialize, Serialize};

/// @spec apps/agentic-workflow/tech-design/semantic/agentic-workflow-generate-gen-python.md#schema
