// SPEC-MANAGED: apps/agentic-workflow/tech-design/semantic/agentic-workflow-generate-gen-python.md#schema
// CODEGEN-BEGIN
// Python backend emitter module root (R3 of apps/agentic-workflow/tech-design/core/specs/python-backend-emitter.md).
