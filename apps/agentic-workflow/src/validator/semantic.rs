// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/validate/validator/semantic.md#source
// CODEGEN-BEGIN
#![allow(deprecated)]
...
/// @spec apps/agentic-workflow/tech-design/core/validate/validator/semantic.md#schema
pub struct SemanticValidator {
    /// Validation rules from config.
    rules: ValidationRules,
}

/// @spec apps/agentic-workflow/tech-design/core/validate/validator/semantic.md#changes
