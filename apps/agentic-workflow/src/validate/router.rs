// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/validate/source/projects-sdd-src-validate-router-rs.md#source
// CODEGEN-BEGIN
...
/// @spec apps/agentic-workflow/tech-design/core/validate/source/projects-sdd-src-validate-router-rs.md#source
    ...
    fn prefix_with_slash() {
        ...
        match classify("apps/agentic-workflow/tech-design/core", &root) {
            PathShape::Prefix(p) => {
                assert_eq!(
                    p,
                    PathBuf::from("/repo/apps/agentic-workflow/tech-design/core")
                );
            }
