// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/validate/source/projects-sdd-src-validate-rules-section_format-rs.md#source
// CODEGEN-BEGIN
        ...
        let Some(project_root) = find_score_project_root(spec_path) else {
            findings.push(
                Finding::error(
                    ...
                    spec_path,
                    format!(
                        "section '{}' targets workspace '{}' but no aw.toml was found",
