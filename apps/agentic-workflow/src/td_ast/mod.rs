...
//! @spec apps/agentic-workflow/tech-design/core/interfaces/td_ast/types.md#logic-parse_td

// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/td_ast/types.md#exports
// CODEGEN-BEGIN
pub mod entities;
