...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/ui/viewer/api.md#schema
// CODEGEN-BEGIN
use serde::Serialize;

/// Full change detail.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/ui/viewer/api.md#schema
#[derive(Serialize)]
...
mod tests {
    ...
    fn test_crate_from_relative_path() {
        ...
        assert_eq!(
            crate_from_relative_path("apps/agentic-workflow/state-machine.md"),
            "agentic-workflow"
        );
        // Top-level spec
