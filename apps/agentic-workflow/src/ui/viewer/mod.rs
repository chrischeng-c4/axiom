// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/ui/viewer/mod.md#source
// CODEGEN-BEGIN
use axum::{
    extract::{Path, State},
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/ui/viewer/mod.md#source
