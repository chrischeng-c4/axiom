// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/fillback/speckit_imports_source.md#source
// CODEGEN-BEGIN
...
use std::path::Path;
// CODEGEN-END
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/fillback/speckit.md#schema
// CODEGEN-BEGIN
/// Speckit import strategy (parses Speckit Markdown specs).
/// @spec apps/agentic-workflow/tech-design/core/generate/fillback/speckit.md#schema
pub struct SpeckitStrategy;
// CODEGEN-END

// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/fillback/speckit_runtime_source.md#source
// CODEGEN-BEGIN
/// @spec apps/agentic-workflow/tech-design/core/generate/fillback/speckit_runtime_source.md#source
...
impl ImportStrategy for SpeckitStrategy {
    async fn execute(&self, source: &Path, change_id: &str) -> Result<()> {
        ...
        let change_dir = crate::shared::workspace::change_path(&current_dir, change_id);
