// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/implementation_service_preamble_source.md#source
// CODEGEN-BEGIN
...
// CODEGEN-END
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/implementation_service_requirements_runtime_source.md#source
// CODEGEN-BEGIN
use crate::Result;
use std::path::Path;
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/services/implementation_service_requirements_runtime_source.md#source
pub fn read_all_requirements(change_id: &str, project_root: &Path) -> Result<String> {
    validate_change_id(change_id)?;

    let change_dir = crate::shared::workspace::change_path(project_root, change_id);
...
// ============================================================================
// CODEGEN-END
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/implementation_service.md#schema
// CODEGEN-BEGIN
/// Input for creating a merge review.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/services/implementation_service.md#schema
#[derive(Debug, Clone)]
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/implementation_service_review_runtime_source.md#source
// CODEGEN-BEGIN
/// @spec apps/agentic-workflow/tech-design/core/interfaces/services/implementation_service_review_runtime_source.md#source
...
pub fn create_review(input: CreateReviewInput, project_root: &Path) -> Result<String> {
    ...
    let change_dir = crate::shared::workspace::change_path(project_root, &input.change_id);
    if !change_dir.exists() {
