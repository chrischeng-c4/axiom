// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/path_scope_preamble_source.md#source
// CODEGEN-BEGIN
//! Edit-scope resolution for the internal pretooluse write-scope hook.
//!
//! Reads `aw.toml`, locates the `[[projects]]` entry by name,
...
//! exactly.
//!
//! @spec apps/agentic-workflow/tech-design/core/specs/score-hook-pretooluse-write-scope.md#logic
// CODEGEN-END
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/path_scope_runtime_source.md#source
// CODEGEN-BEGIN
...
/// Narrow projection of `aw.toml` — only the fields the
/// write-scope hook needs.
#[derive(Debug, Clone, Deserialize)]
/// @spec apps/agentic-workflow/tech-design/core/interfaces/services/path_scope_runtime_source.md#source
...
/// Load `aw.toml` under `root` and return its scope projection.
...
mod tests {
    ...
    fn tp4_path_outside_blocks() {
        ...
        assert!(!scope.contains("projects/mamba/tech-design/spec.md"));
