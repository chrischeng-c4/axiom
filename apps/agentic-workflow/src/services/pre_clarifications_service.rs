// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/pre_clarifications_service_preamble_source.md#source
// CODEGEN-BEGIN
...
use std::path::Path;
// CODEGEN-END
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/pre_clarifications_service.md#schema
// CODEGEN-BEGIN
use serde::{Deserialize, Serialize};

/// Input for appending per-issue pre-clarifications to an existing artifact.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/services/pre_clarifications_service.md#schema
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/pre_clarifications_service_runtime_source.md#source
// CODEGEN-BEGIN
/// Create pre_clarifications.md file with structured Q&A
/// @spec apps/agentic-workflow/tech-design/core/interfaces/services/pre_clarifications_service_runtime_source.md#source
