...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/platform_sync/types.md#schema
// CODEGEN-BEGIN
use serde::{Deserialize, Serialize};

/// Payload for a spec issue.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/services/platform_sync/types.md#schema
#[derive(Debug, Clone)]
