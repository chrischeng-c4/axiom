// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/config/platform_sync_config_preamble_source.md#source
// CODEGEN-BEGIN
...
use std::path::Path;
// CODEGEN-END
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/config/platform_sync.md#schema
// CODEGEN-BEGIN
use serde::{Deserialize, Serialize};

/// Authentication configuration.
/// @spec apps/agentic-workflow/tech-design/core/config/platform_sync.md#schema
...
/// Platform configuration from aw.toml.
/// @spec apps/agentic-workflow/tech-design/core/config/platform_sync.md#schema
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/config/platform_sync_config_runtime_source.md#source
// CODEGEN-BEGIN
/// @spec apps/agentic-workflow/tech-design/core/config/platform_sync_config_runtime_source.md#source
impl PlatformConfig {
    /// Load platform config from project
    pub fn load(project_root: &Path) -> Result<Self> {
        // Try TOML first, then YAML for backwards-compatible platform fixtures.
        let toml_path = crate::shared::workspace::config_path(project_root);
        let yaml_path = project_root.join("aw.yaml");
        ...
        let (config_path, is_toml) = if toml_path.exists() {
            ...
            anyhow::bail!(
                "Platform config not found at aw.toml.\n\
                 Create it with:\n\
                 \n\
                 [platform]\n\
                 type = \"github\"\n\
...
"#,
    ...
    fn test_extract_scope_labels() {
            ...
            labels: Some(LabelConfig {
                ...
                scope: Some(ScopeConfig {
                    ...
                    auto_detect: Some(ScopeAutoDetect {
                        path_regex: Some(
                            "(?:apps|crates|projects)/(?:cclab-)?([^/]+)/".to_string(),
                        ),
                    }),
                }),
            }),
        ...
        let affected = vec![
            "apps/agentic-workflow/src/lib.rs".to_string(),
            "apps/agentic-workflow/src/generate/lib.rs".to_string(),
            "apps/agentic-workflow/src/types.rs".to_string(), // duplicate
        ];
