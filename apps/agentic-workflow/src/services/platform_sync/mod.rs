// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/platform_sync/mod_facade_source.md#source
// CODEGEN-BEGIN
...
// CODEGEN-END
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/platform_sync/mod.md#schema
// CODEGEN-BEGIN
/// Platform sync service handle. Holds the project root path used
/// to resolve `aw.toml` and change directories. All
/// behaviour is on the hand-written impl block.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/services/platform_sync/mod.md#schema
...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/platform_sync/mod_runtime_source.md#source
// CODEGEN-BEGIN
/// @spec apps/agentic-workflow/tech-design/core/interfaces/services/platform_sync/mod_runtime_source.md#source
impl PlatformSyncService {
    ...
    pub async fn sync(&self, change_id: &str) -> Result<SyncResult> {
        ...
        let change_dir = crate::shared::workspace::change_path(&self.project_root, change_id);
