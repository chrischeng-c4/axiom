// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/file_service.md#source
// CODEGEN-BEGIN
...
fn list_main_specs_scoped(group: Option<&str>, project_root: &Path) -> Result<String> {
    ...
    if let Some(group) = group {
        ...
        let agentic_workflow_td = project_root.join("apps/agentic-workflow/tech-design");
