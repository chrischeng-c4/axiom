// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/reference_context_service_tests.md#source
// CODEGEN-BEGIN
use super::*;
...
fn test_yaml_safe_newline_escaped() {
    ...
    let content = std::fs::read_to_string(
        crate::shared::workspace::change_path(temp.path(), "test-newline").join("spec_context.md"),
    )
    .unwrap();
