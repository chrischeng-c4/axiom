...
/// Repository platform configuration — [agentic_workflow.repo_platform] in aw.toml.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/change.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Docs generation phase configuration — [agentic_workflow.docs] in aw.toml.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/change.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Tech design storage platform configuration — [agentic_workflow.tech_design_platform] in aw.toml.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/change.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// TDD test gate configuration — [agentic_workflow.test] in aw.toml.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/change.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
...
impl Change {
    ...
    pub fn path(&self, project_root: &Path) -> PathBuf {
        crate::shared::workspace::change_path(project_root, &self.id)
    }
...
impl SddConfig {
    ...
    pub fn validate(&self) -> Result<(), String> {
        ...
        if self.repo_platform.is_none() {
            return Err("Missing [agentic_workflow.repo_platform] in aw.toml.\n\
                 Add:\n\n\
                 ...
                 auto_commit = true\n\
                 auto_pr = false\n\n\
                 Or update aw.toml with the platform producer"
                .to_string());
        }
        if self.tech_design_platform.is_none() {
            return Err(
                "Missing [agentic_workflow.tech_design_platform] in aw.toml.\n\
                 Add:\n\n\
    ...
    /// Load and validate config from aw.toml
    ///
