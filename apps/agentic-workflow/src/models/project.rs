...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/models/project.md#schema
// CODEGEN-BEGIN
use serde::{Deserialize, Serialize};

/// Codegen configuration for a workspace.
/// Used in both per-workspace overrides and `[defaults.workspace]`.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/project.md#schema
...
pub struct Project {
    ...
    pub name: String,
    /// Path relative to repo root (e.g. `apps/agentic-workflow`, `projects/conductor`).
    pub path: PathBuf,
...
pub struct Workspace {
    ...
    /// Glob path patterns relative to repo root (e.g. `["apps/agentic-workflow/**"]`).
