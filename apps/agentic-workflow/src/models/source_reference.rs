// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/models/source_reference.md#source
// CODEGEN-BEGIN
...
/// @spec apps/agentic-workflow/tech-design/surface/specs/aw-source-first-reference-artifacts.md#logic
