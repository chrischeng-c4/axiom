// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/models/mod.md#source
// CODEGEN-BEGIN
pub mod annotation;
pub mod archive_review;
/// @spec apps/agentic-workflow/tech-design/surface/specs/aw-artifact-quality-profile.md#schema
...
pub mod scenario;
pub mod section;
/// @spec apps/agentic-workflow/tech-design/surface/specs/aw-source-first-reference-artifacts.md#schema
