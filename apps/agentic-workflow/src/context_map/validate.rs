...
mod ddd_context_map_test {
    ...
    fn ddd_context_map_keeps_logical_identity_when_projections_move() {
        let original = parse_context_map(include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/tests/fixtures/ddd_context_map/valid.yaml"
        )))
        .unwrap();
        let moved = parse_context_map(include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/tests/fixtures/ddd_context_map/moved_projections.yaml"
        )))
        .unwrap();
    ...
    fn ddd_context_map_rejects_cross_context_dependency_in_the_wrong_direction() {
        let error = parse_context_map(include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/tests/fixtures/ddd_context_map/invalid_reverse_dependency.yaml"
        )))
        .unwrap_err();
    ...
    fn ddd_context_map_rejects_duplicate_identity_ownership() {
        let error = parse_context_map(include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/tests/fixtures/ddd_context_map/duplicate_identity.yaml"
        )))
        .unwrap_err();
    ...
    fn ddd_context_map_rejects_paths_and_markdown_anchors_as_identity() {
        let error = parse_context_map(include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/tests/fixtures/ddd_context_map/path_identity.yaml"
        )))
        .unwrap_err();
