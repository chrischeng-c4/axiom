...
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/logic/context_builder/mod.md#schema
// CODEGEN-BEGIN
/// Builder that orchestrates the context building pipeline.
/// @spec apps/agentic-workflow/tech-design/core/logic/context_builder/mod.md#schema
