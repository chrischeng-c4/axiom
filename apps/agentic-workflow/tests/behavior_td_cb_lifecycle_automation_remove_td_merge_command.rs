// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/specs/aw-capability-claim-closure-ec-inventory.md#td-cb-lifecycle-automation-remove-td-merge-command
// CODEGEN-BEGIN
// AW-EC-BEGIN
// @ec td-cb-lifecycle-automation-remove-td-merge-command
