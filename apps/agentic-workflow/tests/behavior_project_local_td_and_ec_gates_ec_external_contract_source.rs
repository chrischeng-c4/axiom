// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/specs/aw-capability-claim-closure-ec-inventory.md#project-local-td-and-ec-gates-ec-external-contract-source
// CODEGEN-BEGIN
// AW-EC-BEGIN
