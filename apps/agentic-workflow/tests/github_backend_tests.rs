// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/validate/github_backend_tests.md#tests
// CODEGEN-BEGIN
...
//!
//! @spec apps/agentic-workflow/tech-design/core/runtime/github_backend.md
...
#[tokio::test]
async fn list_open_issues_maps_state() {
    let _g = env_lock().lock().unwrap_or_else(|e| e.into_inner());
    std::env::set_var("GITHUB_TOKEN", "test-token");
