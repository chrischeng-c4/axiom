// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/validate/gitlab_backend_tests.md#tests
// CODEGEN-BEGIN

//! Integration tests for `GitLabIssueBackend`. Mirror of
//! `github_backend_tests.rs` adjusted for glab specifics.
//!
//! @spec apps/agentic-workflow/tech-design/core/runtime/gitlab_backend.md
