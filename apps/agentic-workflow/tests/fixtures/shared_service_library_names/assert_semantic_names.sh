...
legacy_content='libs/(operator|raft-host|h2c|server-core|tcp-server|http-server|service-durability|service-metrics|service-tls|claimtoken)|(?<!::)\boperator::|\bh2c::|\bclaimtoken::|\b(raft_host|server_core|tcp_server|http_server|service_durability|service_metrics|service_tls)::|^\s*(operator|h2c|claimtoken|raft-host|server-core|tcp-server|http-server|service-durability|service-metrics|service-tls)\s*=\s*\{\s*path|cargo test -p (operator|h2c|claimtoken|raft-host|server-core|tcp-server|http-server|service-durability|service-metrics|service-tls)|name = "(operator|h2c|claimtoken|raft-host|server-core|tcp-server|http-server|service-durability|service-metrics|service-tls)"'
