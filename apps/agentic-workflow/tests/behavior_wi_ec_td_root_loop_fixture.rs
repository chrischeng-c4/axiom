// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/specs/aw-wi-ec-td-root-loop.md#wi-ec-td-root-loop-fixture
// CODEGEN-BEGIN
// AW-EC-BEGIN
// @ec wi-ec-td-root-loop-fixture
...
// Contract: no retired lifecycle command or hidden agent-only step is required
#[test]
