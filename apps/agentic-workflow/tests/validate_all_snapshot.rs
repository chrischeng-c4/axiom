// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/validate/validate_all_snapshot.md#tests
// CODEGEN-BEGIN
...
//!
//! @spec apps/agentic-workflow/tech-design/core/validate/section-format-rule.md#test-plan
...
#[test]
fn validate_all_snapshot_matches_expected_violations() {
...
#[test]
fn validate_all_emits_zero_findings_on_clean_input() {
    let tmp = tempfile::tempdir().unwrap();
    let root = tmp.path();
