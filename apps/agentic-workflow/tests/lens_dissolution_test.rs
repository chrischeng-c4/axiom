// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/validate/lens_dissolution_test.md#tests
// CODEGEN-BEGIN
...
// ===========================================================================
#[test]
fn r5_no_residual_lens_imports() {
    let src_dir = sdd_src();
...
#[test]
fn r6_sdd_logic_specs_contain_migrated_lens_specs() {
    let sdd_logic_dir = project_root().join("apps/agentic-workflow/tech-design/core/logic");
    assert!(
        sdd_logic_dir.is_dir(),
        "apps/agentic-workflow/tech-design/core/logic/ must exist"
    );
...
#[test]
fn nf1_core_types_accessible() {
    // core module: ArgusConfig, LanguageConfig
    let _config: agentic_workflow::core::ArgusConfig =
        agentic_workflow::core::ArgusConfig::default();
    let _ = agentic_workflow::LanguageConfig::default();
}

#[test]
fn nf1_diagnostic_types_accessible() {
...
#[test]
fn nf1_syntax_types_accessible() {
...
#[test]
fn nf1_checker_types_accessible() {
...
// ===========================================================================
#[test]
fn r2_type_inference_types_accessible() {
...
// ===========================================================================
#[test]
fn nf1_multiparser_detects_python() {
...
#[test]
fn nf1_multiparser_detects_typescript() {
...
#[test]
fn nf1_multiparser_detects_rust() {
...
#[test]
fn nf1_lint_config_default_languages() {
...
#[test]
fn nf1_lint_config_excludes_defaults() {
    let config = agentic_workflow::checker::LintConfig::default();
...
#[test]
fn nf1_checker_registry_has_python() {
    let registry = agentic_workflow::lint::CheckerRegistry::new();
    assert!(
        registry
            .get(agentic_workflow::syntax::Language::Python)
            .is_some(),
...
#[test]
fn nf1_checker_registry_has_typescript() {
    let registry = agentic_workflow::lint::CheckerRegistry::new();
    assert!(
        registry
            .get(agentic_workflow::syntax::Language::TypeScript)
            .is_some(),
...
#[test]
fn nf1_checker_registry_has_rust() {
    let registry = agentic_workflow::lint::CheckerRegistry::new();
    assert!(
        registry
            .get(agentic_workflow::syntax::Language::Rust)
            .is_some(),
...
#[test]
fn nf1_diagnostic_severity_ordering() {
...
fn run_agent_check(dir: &Path) -> String {
    ...
    let mut symbol_tables: Vec<(std::path::PathBuf, agentic_workflow::semantic::SymbolTable)> =
        Vec::new();
...
#[test]
fn test_type_at_imported_symbol() {
...
#[test]
fn test_check_with_propagation_diagnostics() {
    use agentic_workflow::graph::ImportGraph;
    use agentic_workflow::type_inference::{
        DeepTypeInferencer, ImportInfo, PropagationPipeline, PropagationRequest, Type, TypeBinding,
    };
...
#[test]
fn test_pipeline_python_fixture() {
    use agentic_workflow::graph::ImportGraph;
    use agentic_workflow::type_inference::{
        DeepTypeInferencer, ImportInfo, PropagationPipeline, PropagationRequest, Type, TypeBinding,
    };
...
// CODEGEN-BEGIN
// SPEC-REF: apps/agentic-workflow/tech-design/semantic/agentic-workflow-tests.md#schema
