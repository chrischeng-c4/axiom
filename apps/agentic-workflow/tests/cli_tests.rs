// SPEC-MANAGED: apps/agentic-workflow/tech-design/semantic/agentic-workflow-tests.md#tests
// CODEGEN-BEGIN
#[path = "cli/tests/cb_claim_test.rs"]
mod cb_claim_test;
#[path = "cli/tests/cb_fill_test.rs"]
mod cb_fill_test;
...
mod legacy_cli_removal_test;
#[path = "cli/tests/merge_target_branch.rs"]
