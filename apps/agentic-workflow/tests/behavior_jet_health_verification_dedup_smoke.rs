// SPEC-MANAGED: apps/agentic-workflow/tech-design/specs/4124.md#jet-health-verification-dedup-smoke
// CODEGEN-BEGIN
// AW-EC-BEGIN
// @ec jet-health-verification-dedup-smoke
// @capability existing-project-standardization
// @claim jet-health-verification-dedup-smoke
...
// Contract: duplicate README gate commands do not multiply command execution inside one AW verification pass
#[test]
