// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/validate/spec_alignment_phase2_tests.md#tests
// CODEGEN-BEGIN
...
#[cfg(test)]
mod spec_alignment_phase2_tests {
    use std::fs;
    ...
    #[test]
    fn test_parse_annotation_rust_comment() {
        let content = "// @spec apps/agentic-workflow/logic/check-alignment.md#R1\n";
        let annotations = spec_alignment::annotations::scan_file("test.rs", content);

        assert_eq!(annotations.len(), 1);
        assert_eq!(
            annotations[0].spec_path,
            "apps/agentic-workflow/logic/check-alignment.md"
        );
    ...
    #[test]
    fn test_parse_annotation_python_comment() {
    ...
    #[test]
    fn test_parse_annotation_html_comment() {
    ...
    #[test]
    fn test_parse_annotation_multiple_per_file() {
...
"#;
    ...
    #[test]
    fn test_parse_annotation_sql_comment() {
    ...
    #[test]
    fn test_parse_annotation_c_block_comment() {
    ...
    // =========================================================================
    #[test]
    fn test_coverage_all_requirements_covered() {
        let dir = TestDir::new();
...
"#,
    ...
    #[test]
    fn test_coverage_uncovered_requirement() {
        let dir = TestDir::new();
...
"#,
        ...
        dir.write_file(
    "src/main.rs",
    "// @spec apps/agentic-workflow/tech-design/core/specs/nonexistent-spec.md#R1\nfn foo() {}\n",
);
    ...
    #[test]
    fn test_coverage_stale_annotation() {
        let dir = TestDir::new();
...
"#,
    ...
    // =========================================================================
    #[test]
    fn test_requirement_scenario_all_covered() {
        let dir = TestDir::new();
...
"#,
    ...
    #[test]
    fn test_requirement_scenario_orphan() {
        let dir = TestDir::new();
        let file = dir.write_file(
            "spec.md",
            r#"## Requirements
...
"#,
    ...
    #[test]
    fn test_requirement_test_plan_covers_column() {
        let dir = TestDir::new();
        let file = dir.write_file(
            "spec.md",
            r#"## Requirements
...
"#,
    ...
    // =========================================================================
    #[test]
    fn test_nested_schema_required_conflict() {
...
"#;
    ...
    #[test]
    fn test_nested_schema_properties_conflict() {
        let content = r#"## RPC API
<!-- type: rpc-api lang: json -->
...
"#;
    ...
    #[test]
    fn test_nested_schema_field_name_near_match() {
        let content = r#"## RPC API
<!-- type: rpc-api lang: json -->
...
"#;
    ...
    #[test]
    fn test_nested_schema_params_conflict() {
        let content = r#"## RPC API
<!-- type: rpc-api lang: json -->
...
"#;
    ...
    // =========================================================================
    #[test]
    fn test_nested_schema_no_conflict_when_identical() {
        let content = r#"## RPC API
<!-- type: rpc-api lang: json -->
...
"#;
    ...
    // =========================================================================
    #[test]
    fn test_check_with_coverage_produces_report() {
        let dir = TestDir::new();
        dir.write_file(
            "specs/clean.md",
            r#"## Overview
...
"#,
    ...
    #[test]
    fn test_check_with_coverage_detects_orphan_requirements() {
        let dir = TestDir::new();
        dir.write_file(
            "specs/orphan.md",
            r#"## Requirements
...
"#,
    ...
    #[test]
    fn test_check_with_coverage_passed_includes_coverage() {
        let dir = TestDir::new();
...
"#,
    ...
    // =========================================================================
    #[test]
    fn test_coverage_stale_requirement_id() {
        let dir = TestDir::new();
...
"#,
    ...
    // =========================================================================
    #[test]
    fn test_unspecced_function_detection_skipped_when_daemon_not_ready() {
        let dir = TestDir::new();
...
"#,
    ...
    // =========================================================================
    #[test]
    fn test_schema_struct_check_returns_empty_when_daemon_not_ready() {
        let dir = TestDir::new();
        dir.write_file(
            "specs/schema.md",
            r#"## Schema
...
"#,
    ...
    #[test]
    fn test_schema_struct_type_mapping() {
        assert_eq!(
    ...
    // =========================================================================
    #[test]
    fn test_implementation_prompt_has_spec_instruction() {
    ...
    // =========================================================================
    #[test]
    fn test_cli_coverage_flag_runs_phase2() {
...
"#,
    ...
    #[test]
    fn test_cli_coverage_json_includes_report() {
...
"#,
    ...
    #[test]
    fn test_cli_coverage_source_dir_flag() {
...
"#,
        ...
        dir.write_file(
    "dir_b/lib.rs",
    "// @spec apps/agentic-workflow/tech-design/core/specs/nonexistent.md#R99\npub fn bar() {}\n",
);
    ...
    #[test]
    fn test_cli_coverage_daemon_not_ready() {
...
"#,
    ...
    fn test_unspecced_function_detected() {
...
"#,
    ...
    #[test]
    #[ignore = "Requires daemon symbol index — stub returns empty until daemon integration"]
    fn test_unspecced_private_fn_ignored() {
...
"#,
    ...
    #[test]
    #[ignore = "Requires daemon symbol index — stub returns empty until daemon integration"]
    fn test_schema_struct_missing_field() {
