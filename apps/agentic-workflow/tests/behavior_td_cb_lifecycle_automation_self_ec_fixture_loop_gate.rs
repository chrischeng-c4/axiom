// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/specs/aw-capability-claim-closure-ec-inventory.md#td-cb-lifecycle-automation-self-ec-fixture-loop-gate
// CODEGEN-BEGIN
// AW-EC-BEGIN
// @ec td-cb-lifecycle-automation-self-ec-fixture-loop-gate
