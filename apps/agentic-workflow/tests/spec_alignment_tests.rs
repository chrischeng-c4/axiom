// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/validate/spec_alignment_tests.md#tests
// CODEGEN-BEGIN
...
"#;
    ...
    #[test]
    fn test_format_priority_violation_config_no_yaml() {
...
"#,
    ...
    fn test_zero_false_positives_on_existing_specs() {
        ...
        let spec_path =
            PathBuf::from("apps/agentic-workflow/tech-design/core/logic/spec-structure.md");
        if !spec_path.exists() {
