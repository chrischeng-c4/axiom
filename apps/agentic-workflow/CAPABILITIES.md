...
| Marker-free post-fill evidence | bug | #1904 | implemented | verified | smoke | `cargo test -p agentic-workflow --lib marker_free_brief_allows_only_declared_evidence_paths -- --nocapture`; after the last marker, `aw td fill` accepts only declared Changes paths and stages them with the terminal fill lifecycle commit |
