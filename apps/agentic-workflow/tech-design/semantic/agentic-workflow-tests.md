...
summary: Semantic coverage for "apps/agentic-workflow/tests"
...
semantic_domain:
  ...
  source_group: "apps/agentic-workflow/tests"
    ...
    source_units:
      ...
      - path: "apps/agentic-workflow/tests/validate_all_snapshot.rs"
        ...
        source_evidence_node:
          ...
          section_type: "tests"
          domain: "apps/agentic-workflow/tests"
      - path: "apps/agentic-workflow/tests/project_registry_check_test.rs"
        language: "rust"
        ownership_state: "codegen"
        generator_primitives: ["service_method", "test_case"]
        symbols:
      ...
      - path: "apps/agentic-workflow/tests/project_registry_test.rs"
        ...
        source_evidence_node:
          ...
          section_type: "tests"
          domain: "apps/agentic-workflow/tests"
      - path: "apps/agentic-workflow/tests/gitlab_backend_tests.rs"
        language: "rust"
        ownership_state: "codegen"
        generator_primitives: ["service_method", "test_case"]
        symbols:
        ...
        source_evidence_node:
          ...
          section_type: "tests"
          domain: "apps/agentic-workflow/tests"
      - path: "apps/agentic-workflow/tests/lens_dissolution_test.rs"
        language: "rust"
        ownership_state: "codegen"
        generator_primitives: ["service_method", "test_case"]
        symbols:
      ...
      - path: "apps/agentic-workflow/tests/sdd_coverage_test.rs"
        ...
        source_evidence_node:
          ...
          section_type: "tests"
          domain: "apps/agentic-workflow/tests"
      - path: "apps/agentic-workflow/tests/python_backend_emitter_real.rs"
        language: "rust"
        ownership_state: "codegen"
        generator_primitives: ["config_surface", "service_method", "test_case"]
        symbols:
        ...
        source_evidence_node:
          ...
          section_type: "tests"
          domain: "apps/agentic-workflow/tests"
      - path: "apps/agentic-workflow/tests/spec_alignment_phase2_tests.rs"
        language: "rust"
        ownership_state: "codegen"
        generator_primitives: ["test_case"]
        symbols:
      ...
      - path: "apps/agentic-workflow/tests/stage_2b_golden_tests.rs"
        ...
        source_evidence_node:
          ...
          section_type: "tests"
          domain: "apps/agentic-workflow/tests"
      - path: "apps/agentic-workflow/tests/from_td_ast_dispatch.rs"
        language: "rust"
        ownership_state: "codegen"
        generator_primitives: ["service_method", "test_case"]
        symbols:
