...
summary: Semantic coverage for "apps/agentic-workflow/src/runtime"
...
semantic_domain:
  ...
  source_group: "apps/agentic-workflow/src/runtime"
  coverage_kind: semantic
  evidence:
    source_units:
      - path: "apps/agentic-workflow/src/runtime/mainthread.rs"
        language: "rust"
        ...
        source_evidence_node:
          ...
          role: "source"
          section_type: "schema"
          domain: "apps/agentic-workflow/src/runtime"
      ...
      - path: "apps/agentic-workflow/src/runtime/github_backend.rs"
        ...
        source_evidence_node:
          ...
          section_type: "schema"
          domain: "apps/agentic-workflow/src/runtime"
      - path: "apps/agentic-workflow/src/runtime/gitlab_backend.rs"
        language: "rust"
        ownership_state: "codegen"
        generator_primitives: ["config_surface", "data_model", "service_method"]
        symbols:
        ...
        source_evidence_node:
          ...
          section_type: "schema"
          domain: "apps/agentic-workflow/src/runtime"
      - path: "apps/agentic-workflow/src/runtime/event.rs"
        language: "rust"
        ownership_state: "codegen"
      ...
      - path: "apps/agentic-workflow/src/runtime/envelope.rs"
        ...
        source_evidence_node:
          ...
          section_type: "schema"
          domain: "apps/agentic-workflow/src/runtime"
      - path: "apps/agentic-workflow/src/runtime/router.rs"
        language: "rust"
        ownership_state: "codegen"
        generator_primitives: ["data_model", "enum_model", "service_method"]
        symbols:
