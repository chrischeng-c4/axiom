...
summary: Semantic coverage for "apps/agentic-workflow/src/ui/viewer/assets"
...
frontend_semantic:
  ...
  source_group: "apps/agentic-workflow/src/ui/viewer/assets"
  coverage_kind: semantic
  evidence:
    source_units:
      - path: "apps/agentic-workflow/src/ui/viewer/assets/highlight.min.css"
        language: "stylesheet"
        ...
        source_evidence_node:
          ...
          role: "style"
          section_type: "design-token"
          domain: "apps/agentic-workflow/src/ui/viewer/assets"
          workspace_root: "apps/agentic-workflow/src/ui/viewer/assets"
        frontend_node:
          workspace_root: "apps/agentic-workflow/src/ui/viewer/assets"
          role: "style"
          section_type: "design-token"
          artifact_kind: "style-surface"
      - path: "apps/agentic-workflow/src/ui/viewer/assets/styles.css"
        language: "stylesheet"
        ownership_state: "codegen"
        generator_primitives: ["frontend_style-surface", "td_section_design_token"]
        source_evidence_node:
...
nodes:
  ...
  classify_frontend_ast:
    kind: process
    label: "Map FE ecosystem AST group \"apps/agentic-workflow/src/ui/viewer/assets\" to logic emitter primitives"
  generator_gap:
    kind: terminal
...
- apps/agentic-workflow/src/ui/viewer/assets/app.js
-->
