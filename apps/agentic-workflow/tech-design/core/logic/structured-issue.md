...
main_spec_ref: apps/agentic-workflow/logic/structured-issue.md
merge_strategy: new
capability_refs:
...
|-----------|----------|----------------|
| Issue section parser | `apps/agentic-workflow/src/services/issue_parser.rs` | Extract structured sections from issue markdown |
| init_change update | `apps/agentic-workflow/src/tools/init_change.rs` | Enforce state:open gate, set ChangeInited, route directly to spec |
| `aw wi enrich` | `apps/agentic-workflow/src/cli/issues.rs` | Run reference_context agent to fill Reference Context section |
| `aw wi validate` | `apps/agentic-workflow/src/cli/issues.rs` | CRR quality gate: promote draft to open |
...
tests:
  T1:
    ...
    file: apps/agentic-workflow/src/services/issue_parser.rs
    verifies: [R1]
  T2:
    type: test
  ...
  T4:
    ...
    file: apps/agentic-workflow/src/tools/init_change.rs
    verifies: [R2]
  T5:
    type: test
  ...
  T12:
    ...
    file: apps/agentic-workflow/src/cli/issues.rs
    verifies: [R6]
  T13:
    type: test
