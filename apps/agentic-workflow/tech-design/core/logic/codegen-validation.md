...
main_spec_ref: apps/agentic-workflow/logic/codegen-validation.md
merge_strategy: new
capability_refs:
...
changes:
  ...
  - path: apps/agentic-workflow/src/generate/render.rs
    section: source
    action: modify
    impl_mode: hand-written
    description: |
...
subcommands:
  - name: diff
    ...
    args:
      ...
      - name: --json
        ...
        required: false
    examples:
      - score gen diff apps/agentic-workflow/tech-design/core/logic/structured-issue.md
      - score gen diff --all
  ...
  - name: apply
    ...
    args:
      ...
      - name: --into-worktree
        ...
        required: false
    examples:
      - score gen apply apps/agentic-workflow/tech-design/core/logic/structured-issue.md
  ...
  - name: render
    ...
    args:
      ...
      - name: --check
        ...
        required: false
    examples:
      - score gen render apps/agentic-workflow/tech-design/core/logic/structured-issue.md
      - score gen render --check apps/agentic-workflow/tech-design/core/logic/state-machine.md
  ...
  - name: validate
    ...
    args:
      ...
      - name: --all
        ...
        required: false
    examples:
      - score gen validate apps/agentic-workflow/tech-design/core/logic/structured-issue.md
  ...
  - name: init-markers
    ...
    args:
      ...
      - name: --spec
        type: string
        description: Spec reference (e.g. apps/agentic-workflow/logic/structured-issue.md#schema)
        required: true
      - name: --symbol
        type: string
        ...
        required: false
    examples:
      - score gen init-markers apps/agentic-workflow/src/models/state.rs --spec apps/agentic-workflow/logic/state-machine.md#state-phase
```
