...
# Standardized apps/agentic-workflow/src/git.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/git.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `commit_scoped_paths` | apps/agentic-workflow/src/git.rs | function | pub | 66 | commit_scoped_paths(project_root: &Path, paths: &[PathBuf], message: &str) -> Result<bool> |
| `dirty_paths` | apps/agentic-workflow/src/git.rs | function | pub | 124 | dirty_paths(     project_root: &Path,     scopes: &[PathBuf],     include_untracked: bool, ) -> Result<Vec<String>> |
| `ensure_no_staged_changes` | apps/agentic-workflow/src/git.rs | function | pub | 48 | ensure_no_staged_changes(project_root: &Path) -> Result<()> |
| `find_git_bin` | apps/agentic-workflow/src/git.rs | function | pub | 17 | find_git_bin() -> Option<PathBuf> |
| `is_git_repo` | apps/agentic-workflow/src/git.rs | function | pub | 33 | is_git_repo(project_root: &Path) -> bool |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/git.rs -->
````rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/git.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
