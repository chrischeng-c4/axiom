...
main_spec_ref: apps/agentic-workflow/tech-design/core/logic/tech-stack-inference.md
merge_strategy: new
capability_refs:
...
changes:
  ...
  - path: apps/agentic-workflow/tech-design/core/logic/tech-stack-inference.md
    action: create
    section: logic
    impl_mode: hand-written
