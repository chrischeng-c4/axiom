---
id: sdd-context-builder-test-detection
...
Public API manifest for `apps/agentic-workflow/src/context_builder/test_detection.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TestLanguage` | apps/agentic-workflow/src/context_builder/test_detection.rs | enum | pub | 17 |  |
| `detect_test_files` | apps/agentic-workflow/src/context_builder/test_detection.rs | function | pub | 59 | detect_test_files(     project_files: &[String],     target_file: &str,     language: TestLanguage, ) -> Vec<ContextEntry> |
| `from_path` | apps/agentic-workflow/src/context_builder/test_detection.rs | function | pub | 33 | from_path(path: &Path) -> Option<Self> |
## Schema
...
definitions:
  TestLanguage:
    ...
    x-rust-enum:
      ...
      variants:
        - { name: Python, doc: "Python (.py)." }
        - { name: TypeScript, doc: "TypeScript / JavaScript (.ts/.tsx/.js/.jsx)." }
        - { name: Rust, doc: "Rust (.rs)." }
        - { name: Go, doc: "Go (.go)." }
```
...
```yaml
changes:
  - path: apps/agentic-workflow/src/context_builder/test_detection.rs
    action: modify
    section: schema
    impl_mode: codegen
    replaces:
  ...
  - path: apps/agentic-workflow/src/context_builder/test_detection.rs
    ...
    impl_mode: codegen
    description: |
      Regenerate test-file scoring, language detection, helper functions, and
...
- [overview] Single unit enum.
- [schema] Standard 4-variant enum, no serde derives.
