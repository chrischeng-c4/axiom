---
id: apps/agentic-workflow/tech-design/core/logic/issues-backend.md
main_spec_ref: "apps/agentic-workflow/logic/issues-backend.md"
merge_strategy: new
capability_refs:
...
**Arsenal layer** (`apps/agentic-workflow/src/issues/`):
...
**Show case layer** (`apps/agentic-workflow/src/cli/issues.rs`):
...
```yaml
changes:
  - file: apps/agentic-workflow/src/issues/backend.rs
    section: source
    action: modify
  ...
  - file: apps/agentic-workflow/src/issues/backends/local.rs
    section: source
    action: modify
    impl_mode: hand-written
    description: Implement create (write draft), update (patch frontmatter + body), close (set state), search (grep content).

  - file: apps/agentic-workflow/src/issues/backends/github.rs
    section: source
    action: modify
    impl_mode: hand-written
  ...
  - file: apps/agentic-workflow/src/issues/mod.rs
    section: source
    action: modify
    impl_mode: hand-written
  ...
  - file: apps/agentic-workflow/src/cli/commands.rs
    action: no-change
    section: cli
    impl_mode: hand-written
