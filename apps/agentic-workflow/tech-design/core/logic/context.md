---
id: projects-sdd-src-context-rs
...
# Standardized apps/agentic-workflow/src/context.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/context.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `cleanup_context_files` | apps/agentic-workflow/src/context.rs | function | pub | 153 | cleanup_context_files(change_dir: &Path) -> Result<()> |
| `create_archive_review_skeleton` | apps/agentic-workflow/src/context.rs | function | pub | 139 | create_archive_review_skeleton(     change_dir: &Path,     change_id: &str,     iteration: u32, ) -> Result<()> |
| `create_review_skeleton` | apps/agentic-workflow/src/context.rs | function | pub | 125 | create_review_skeleton(change_dir: &Path, change_id: &str, iteration: u32) -> Result<()> |
| `resolve_change_id_conflict` | apps/agentic-workflow/src/context.rs | function | pub | 182 | resolve_change_id_conflict(change_id: &str, changes_dir: &Path) -> Result<String> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:claim-code -->

<!-- source-snapshot: path=apps/agentic-workflow/src/context.rs -->
~~~rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/logic/context.md#source
// CODEGEN-BEGIN
use crate::Result;
...
/// @spec apps/agentic-workflow/tech-design/core/logic/context.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/context.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
    ...
    description: |
      Source template owns the complete context helper module.
```
