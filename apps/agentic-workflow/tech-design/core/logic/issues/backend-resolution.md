...
properties:
  ...
  resolve_default_backend:
    type: object
    description: "Helper added to apps/agentic-workflow/src/issues/mod.rs."
    properties:
      signature:
        type: string
  ...
  make_backend:
    type: object
    description: "Existing factory in apps/agentic-workflow/src/issues/mod.rs — signature extended."
    properties:
      old_signature:
        type: string
