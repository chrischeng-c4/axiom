...
|------|--------|------|------------|------|-----------|
| `BackendError` | apps/agentic-workflow/src/runtime/issue_backend.rs | enum | pub | 124 |  |
| `BackendKind` | apps/agentic-workflow/src/runtime/issue_backend.rs | enum | pub | 26 |  |
| `IssueBody` | apps/agentic-workflow/src/runtime/issue_backend.rs | struct | pub | 112 |  |
| `IssueId` | apps/agentic-workflow/src/runtime/issue_backend.rs | struct | pub | 52 |  |
| `IssueRef` | apps/agentic-workflow/src/runtime/issue_backend.rs | struct | pub | 99 |  |
| `IssueState` | apps/agentic-workflow/src/runtime/issue_backend.rs | enum | pub | 75 |  |
| `ListFilter` | apps/agentic-workflow/src/runtime/issue_backend.rs | struct | pub | 89 |  |
| `as_str` | apps/agentic-workflow/src/runtime/issue_backend.rs | function | pub | 36 | as_str(self) -> &'static str |
| `as_str` | apps/agentic-workflow/src/runtime/issue_backend.rs | function | pub | 60 | as_str(&self) -> &str |
| `new` | apps/agentic-workflow/src/runtime/issue_backend.rs | function | pub | 56 | new(s: impl Into<String>) -> Self |
| `LocalIssueBackend` | apps/agentic-workflow/src/runtime/score_process.rs | struct | pub | 339 |  |
| `MockBackendCall` | apps/agentic-workflow/src/runtime/score_process.rs | enum | pub | 503 |  |
| `MockIssueBackend` | apps/agentic-workflow/src/runtime/score_process.rs | struct | pub | 493 |  |
| `MockScoreProcess` | apps/agentic-workflow/src/runtime/score_process.rs | struct | pub | 211 |  |
| `RealScoreProcess` | apps/agentic-workflow/src/runtime/score_process.rs | struct | pub | 65 |  |
| `ScoreCall` | apps/agentic-workflow/src/runtime/score_process.rs | enum | pub | 171 |  |
| `ScoreProcessError` | apps/agentic-workflow/src/runtime/score_process.rs | enum | pub | 32 |  |
| `calls` | apps/agentic-workflow/src/runtime/score_process.rs | function | pub | 256 | calls(&self) -> Vec<ScoreCall> |
| `calls` | apps/agentic-workflow/src/runtime/score_process.rs | function | pub | 553 | calls(&self) -> Vec<MockBackendCall> |
| `enqueue_create` | apps/agentic-workflow/src/runtime/score_process.rs | function | pub | 226 | enqueue_create(&self, env: Envelope) -> &Self |
| `enqueue_create` | apps/agentic-workflow/src/runtime/score_process.rs | function | pub | 533 | enqueue_create(&self, id: IssueId) -> &Self |
| `enqueue_create_err` | apps/agentic-workflow/src/runtime/score_process.rs | function | pub | 231 | enqueue_create_err(&self, err: ScoreProcessError) -> &Self |
...
| `new` | apps/agentic-workflow/src/runtime/score_process.rs | function | pub | 222 | new() -> Self |
| `new` | apps/agentic-workflow/src/runtime/score_process.rs | function | pub | 346 | new(inner: Arc<dyn ScoreProcess>) -> Self |
| `new` | apps/agentic-workflow/src/runtime/score_process.rs | function | pub | 526 | new(kind: BackendKind) -> Self |
| `verb` | apps/agentic-workflow/src/runtime/score_process.rs | function | pub | 198 | verb(&self) -> &'static str |
| `with_issues_dir` | apps/agentic-workflow/src/runtime/score_process.rs | function | pub | 358 | with_issues_dir(inner: Arc<dyn ScoreProcess>, issues_dir: impl Into<PathBuf>) -> Self |
| `with_project_root` | apps/agentic-workflow/src/runtime/score_process.rs | function | pub | 351 | with_project_root(inner: Arc<dyn ScoreProcess>, project_root: impl AsRef<Path>) -> Self |
## Schema
...
//!
//! @spec apps/agentic-workflow/tech-design/core/logic/runtime/issue_backend.md
//!
//! Slice-1 contract:
...
changes:
  - path: apps/agentic-workflow/src/runtime/issue_backend.rs
    action: modify
    section: source
    impl_mode: codegen
    description: >
  ...
  - path: apps/agentic-workflow/src/runtime/score_process.rs
    action: modify
    section: source
    impl_mode: codegen
    description: >
  ...
  - path: apps/agentic-workflow/src/runtime/mod.rs
    action: modify
    section: source
    impl_mode: hand-written
    description: >
