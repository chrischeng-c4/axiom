...
Public API manifest for `apps/agentic-workflow/src/runtime/jira_backend.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `JiraIssueBackend` | apps/agentic-workflow/src/runtime/jira_backend.rs | struct | pub | 34 |  |
| `from_env` | apps/agentic-workflow/src/runtime/jira_backend.rs | function | pub | 44 | from_env() -> Result<Self, BackendError> |
| `with_base_url` | apps/agentic-workflow/src/runtime/jira_backend.rs | function | pub | 66 | with_base_url(mut self, base_url: impl Into<String>) -> Self |
## Schema
...
scenarios:
  - id: jira_create_happy_path
    ...
    acceptance:
      - test: apps/agentic-workflow/tests/jira_backend_tests.rs::create_happy_path
  ...
  - id: jira_search_open_issues
    ...
    acceptance:
      - test: apps/agentic-workflow/tests/jira_backend_tests.rs::list_open_issues_jql
...
<!-- source-snapshot: path=apps/agentic-workflow/src/runtime/jira_backend.rs -->
```rust
//! Jira Issues backend — Atlassian Cloud REST API v3.
//!
//! @spec apps/agentic-workflow/tech-design/core/logic/runtime/jira_backend.md
//!
...
/// @spec apps/agentic-workflow/tech-design/core/logic/runtime/jira_backend.md#changes
#[derive(Debug)]
...
/// @spec apps/agentic-workflow/tech-design/core/logic/runtime/jira_backend.md#source
...
changes:
  ...
  - path: apps/agentic-workflow/src/runtime/jira_backend.rs
    action: modify
    section: source
    impl_mode: codegen
    description: >
  ...
  - path: apps/agentic-workflow/tests/jira_backend_tests.rs
    action: modify
    section: source
    impl_mode: hand-written
    description: >
