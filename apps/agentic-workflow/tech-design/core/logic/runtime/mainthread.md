...
|------|--------|------|------------|------|-----------|
| `SessionEvent` | apps/agentic-workflow/src/runtime/event.rs | enum | pub | 21 |  |
| `TurnId` | apps/agentic-workflow/src/runtime/event.rs | struct | pub | 16 |  |
| `MainthreadDecision` | apps/agentic-workflow/src/runtime/mainthread.rs | enum | pub | 40 |  |
| `parse_decision` | apps/agentic-workflow/src/runtime/mainthread.rs | function | pub | 59 | parse_decision(text: &str) -> Option<MainthreadDecision> |
| `ModelChoice` | apps/agentic-workflow/src/runtime/router.rs | struct | pub | 17 |  |
| `StaticRouter` | apps/agentic-workflow/src/runtime/router.rs | struct | pub | 59 |  |
| `Task` | apps/agentic-workflow/src/runtime/router.rs | enum | pub | 24 |  |
| `as_str` | apps/agentic-workflow/src/runtime/router.rs | function | pub | 38 | as_str(self) -> &'static str |
| `defaults` | apps/agentic-workflow/src/runtime/router.rs | function | pub | 68 | defaults() -> Self |
| `empty` | apps/agentic-workflow/src/runtime/router.rs | function | pub | 101 | empty() -> Self |
| `with_route` | apps/agentic-workflow/src/runtime/router.rs | function | pub | 107 | with_route(mut self, task: Task, choice: ModelChoice) -> Self |
## Schema
...
/// @spec apps/agentic-workflow/tech-design/core/logic/runtime/mainthread.md#schema
/// @spec apps/agentic-workflow/tech-design/core/logic/runtime/mainthread.md#logic
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
