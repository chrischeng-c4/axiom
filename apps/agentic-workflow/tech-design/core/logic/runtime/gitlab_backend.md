...
Public API manifest for `apps/agentic-workflow/src/runtime/gitlab_backend.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `GitLabIssueBackend` | apps/agentic-workflow/src/runtime/gitlab_backend.rs | struct | pub | 29 |  |
| `from_env` | apps/agentic-workflow/src/runtime/gitlab_backend.rs | function | pub | 36 | from_env(repo: Option<String>) -> Result<Self, BackendError> |
| `with_binary` | apps/agentic-workflow/src/runtime/gitlab_backend.rs | function | pub | 45 | with_binary(mut self, binary: impl Into<String>) -> Self |
## Schema
...
scenarios:
  - id: gitlab_create_happy_path
    ...
    acceptance:
      - test: apps/agentic-workflow/tests/gitlab_backend_tests.rs::create_happy_path
  ...
  - id: gitlab_auth_missing
    ...
    acceptance:
      - test: apps/agentic-workflow/tests/gitlab_backend_tests.rs::auth_missing_returns_error
...
<!-- source-snapshot: path=apps/agentic-workflow/src/runtime/gitlab_backend.rs -->
```rust
//! GitLab Issues backend — shells out to the `glab` CLI.
//!
//! @spec apps/agentic-workflow/tech-design/core/logic/runtime/gitlab_backend.md
//!
...
/// @spec apps/agentic-workflow/tech-design/core/logic/runtime/gitlab_backend.md#changes
#[derive(Debug)]
...
/// @spec apps/agentic-workflow/tech-design/core/logic/runtime/gitlab_backend.md#source
