...
main_spec_ref: "apps/agentic-workflow/logic/tdd-gate.md"
merge_strategy: new
capability_refs:
...
scenarios:
  ...
  S4:
    ...
    given: |
      ...
      Changed files: apps/agentic-workflow/src/models/change.rs
...
tests:
  T1:
    ...
    file: apps/agentic-workflow/src/models/change.rs
    verifies: [R1, R2]
  T2:
    type: test
  ...
  T4:
    ...
    file: apps/agentic-workflow/src/workflow/mod.rs
    verifies: [R4]
  T5:
    type: test
  ...
  T6:
    ...
    file: apps/agentic-workflow/src/workflow/test_gate.rs
    verifies: [R5]
  T7:
    type: test
  ...
  T15:
    ...
    file: apps/agentic-workflow/src/cli/run_change.rs
    verifies: [R9]
---
requirementDiagram
