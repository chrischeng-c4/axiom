...
Public API manifest for `apps/agentic-workflow/src/spec_store.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `FileSystemSpecStore` | apps/agentic-workflow/src/spec_store.rs | struct | pub | 21 |  |
| `from_config` | apps/agentic-workflow/src/spec_store.rs | function | pub | 47 | from_config(root: PathBuf, scopes: HashMap<String, String>) -> Self |
| `new` | apps/agentic-workflow/src/spec_store.rs | function | pub | 37 | new(root: PathBuf, scopes: HashMap<String, String>) -> Self |
## Schema
...
/// @spec apps/agentic-workflow/tech-design/core/logic/spec_store.md#schema
#[derive(Debug, Clone)]
...
/// @spec apps/agentic-workflow/tech-design/core/logic/spec_store.md#source
...
mod tests {
    ...
    async fn test_search_returns_ranked_results() {
        ...
        make_spec(
            &root,
            "apps/agentic-workflow/tech-design/core/scope-resolution.md",
            "# Scope Resolution\n\nScope resolution handles group directory lookup for specs.\n",
        );
        make_spec(
            &root,
            "apps/agentic-workflow/tech-design/core/state-machine.md",
...
"#,
        ...
        make_spec(
            &root,
            "docs/td/apps/agentic-workflow/configurable.md",
        ...
        assert_eq!(results[0].path, "apps/agentic-workflow/configurable.md");
    }
...
"#,
        ...
        make_spec(
            &root,
            "apps/agentic-workflow/tech-design/logic/runtime.md",
