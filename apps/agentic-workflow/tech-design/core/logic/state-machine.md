...
main_spec_ref: apps/agentic-workflow/logic/state-machine.md
...
```yaml
- path: apps/agentic-workflow/src/tools/init_change.rs
  section: source
  action: modify
...
- path: apps/agentic-workflow/tech-design/core/logic/issue-centric-workflow.md
  action: modify
  section: cli
  impl_mode: hand-written
...
- path: apps/agentic-workflow/tech-design/core/logic/state-machine.md
  action: modify
  section: schema
  impl_mode: hand-written
  satisfies: [R4, R10]
