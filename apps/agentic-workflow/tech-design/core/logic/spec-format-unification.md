...
main_spec_ref: apps/agentic-workflow/logic/spec-format-unification.md
merge_strategy: new
capability_refs:
...
The existing generators in `apps/agentic-workflow/src/generate/diagrams/*_plus/` are already implemented. This change wires their usage into documentation and UNIVERSAL_SKELETON stubs:
