...
# Standardized apps/agentic-workflow/src/services/tech_stack_service.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/services/tech_stack_service.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `infer_tech_stack` | apps/agentic-workflow/src/services/tech_stack_service.rs | function | pub | 52 | infer_tech_stack(project_root: &Path) -> TechStack |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:claim-code -->

<!-- source-snapshot: path=apps/agentic-workflow/src/services/tech_stack_service.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/services/tech_stack_service.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/services/tech_stack_service.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
