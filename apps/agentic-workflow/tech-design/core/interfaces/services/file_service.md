...
# Standardized apps/agentic-workflow/src/services/file_service.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/services/file_service.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `list_specs` | apps/agentic-workflow/src/services/file_service.rs | function | pub | 199 | list_specs(change_id: &str, spec_id: Option<&str>, project_root: &Path) -> Result<String> |
| `read_file` | apps/agentic-workflow/src/services/file_service.rs | function | pub | 26 | read_file(change_id: &str, file: &str, project_root: &Path) -> Result<String> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:claim-code -->

<!-- source-snapshot: path=apps/agentic-workflow/src/services/file_service.rs -->
````rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/services/file_service.md#source
...
mod tests {
    ...
    fn test_read_main_spec_with_config_scopes() {
        ...
        // Create the spec file at the config-driven path: apps/agentic-workflow/tech-design/core/logic/
        let spec_dir = project_root.join("apps/agentic-workflow/tech-design/core/logic");
    ...
    fn test_read_main_spec_with_project_td_path() {
        ...
        let spec_dir = project_root.join("apps/agentic-workflow/tech-design/logic");
        std::fs::create_dir_all(&spec_dir).unwrap();
        std::fs::write(
            spec_dir.join("state-machine.md"),
            "# State Machine\n\nConfigured TD path.\n",
...
"#,
    ...
    fn test_list_main_specs_with_project_td_path() {
        ...
        let spec_dir = project_root.join("apps/agentic-workflow/tech-design");
        std::fs::create_dir_all(&spec_dir).unwrap();
...
"#,
    ...
    fn test_read_main_spec_fallback_no_config() {
        ...
        let spec_dir = project_root.join("apps/agentic-workflow/tech-design/core");
        std::fs::create_dir_all(&spec_dir).unwrap();
        std::fs::write(
...
```yaml
changes:
  - path: apps/agentic-workflow/src/services/file_service.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
