---
id: projects-sdd-src-services-platform-sync-payload-rs
...
# Standardized apps/agentic-workflow/src/services/platform_sync/payload.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/services/platform_sync/payload.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `build_payload` | apps/agentic-workflow/src/services/platform_sync/payload.rs | function | pub | 143 | build_payload(project_root: &Path, change_id: &str) -> Result<SyncPayload> |
| `build_payload_with_config` | apps/agentic-workflow/src/services/platform_sync/payload.rs | function | pub | 160 | build_payload_with_config(     project_root: &Path,     change_id: &str,     config: Option<&PlatformConfig>, ) -> Result<SyncPayload> |
| `update_body_with_spec_links` | apps/agentic-workflow/src/services/platform_sync/payload.rs | function | pub | 333 | update_body_with_spec_links(     body: &str,     spec_links: &[(String, u64, String)], // (spec_id, issue_number, url) ) -> String |
| `write_issue_to_frontmatter` | apps/agentic-workflow/src/services/platform_sync/payload.rs | function | pub | 70 | write_issue_to_frontmatter(path: &Path, issue_number: u64) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=apps/agentic-workflow/src/services/platform_sync/payload.rs -->
~~~rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/services/platform_sync/payload.md#source
// CODEGEN-BEGIN
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/services/platform_sync/payload.md#source
...
summary: "Test"
affected_code:
  - "apps/agentic-workflow/src/"
  - "apps/agentic-workflow/src/generate/"
---
# Proposal
"#;
    ...
    fn test_extract_affected_code_inline_list() {
        let proposal = r#"---
summary: "Test"
affected_code: ["apps/agentic-workflow/", "crates/cclab-lens/"]
---
# Proposal
"#;
        let paths = extract_affected_code(proposal);
        assert_eq!(
            paths,
            vec!["apps/agentic-workflow/", "crates/cclab-lens/"]
        );
    }
...
```yaml
changes:
  - path: apps/agentic-workflow/src/services/platform_sync/payload.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
    ...
    description: |
      Source template owns the complete platform sync payload module.
```
