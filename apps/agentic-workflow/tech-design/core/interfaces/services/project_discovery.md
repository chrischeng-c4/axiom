...
# Standardized apps/agentic-workflow/src/services/project_discovery.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/services/project_discovery.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `discover_projects` | apps/agentic-workflow/src/services/project_discovery.rs | function | pub | 23 | discover_projects(root: &Path) -> Result<Vec<Project>> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:claim-code -->

<!-- source-snapshot: path=apps/agentic-workflow/src/services/project_discovery.rs -->
```rust
