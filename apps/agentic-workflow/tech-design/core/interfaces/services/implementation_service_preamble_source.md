---
id: sdd-interfaces-services-implementation-service-preamble-source
...
# Implementation Service Preamble Source
...
changes:
  - path: apps/agentic-workflow/src/services/implementation_service.rs
    ...
    replaces:
      - "<module-preamble>"
    description: "Source template owns the implementation service module documentation."
```
