---
id: projects-sdd-src-services-reference-context-service-tests-rs
...
# Standardized apps/agentic-workflow/src/services/reference_context_service_tests.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/services/reference_context_service_tests.rs` generated from AST during Score force-regeneration standardization.
...
<!-- source-snapshot: path=apps/agentic-workflow/src/services/reference_context_service_tests.rs -->
```rust
use super::*;
...
```yaml
changes:
  - path: apps/agentic-workflow/src/services/reference_context_service_tests.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
    ...
    description: |
      Source template owns the complete reference-context service test module.
```
