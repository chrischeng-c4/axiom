...
# Standardized apps/agentic-workflow/src/branch_switch.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/branch_switch.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DirtyTreeError` | apps/agentic-workflow/src/branch_switch.rs | struct | pub | 38 |  |
| `MergeOutcome` | apps/agentic-workflow/src/branch_switch.rs | enum | pub | 25 |  |
| `branch_exists_local` | apps/agentic-workflow/src/branch_switch.rs | function | pub | 88 | branch_exists_local(repo_root: &Path, branch: &str) -> Result<bool> |
| `current_branch` | apps/agentic-workflow/src/branch_switch.rs | function | pub | 104 | current_branch(repo_root: &Path) -> Result<String> |
| `delete_local_branch` | apps/agentic-workflow/src/branch_switch.rs | function | pub | 199 | delete_local_branch(repo_root: &Path, branch: &str) -> Result<()> |
| `ensure_branch_clean` | apps/agentic-workflow/src/branch_switch.rs | function | pub | 61 | ensure_branch_clean(repo_root: &Path) -> Result<()> |
| `merge_branch_into_default` | apps/agentic-workflow/src/branch_switch.rs | function | pub | 152 | merge_branch_into_default(     repo_root: &Path,     source: &str,     default: &str, ) -> Result<MergeOutcome> |
| `switch_or_create_branch` | apps/agentic-workflow/src/branch_switch.rs | function | pub | 122 | switch_or_create_branch(repo_root: &Path, target: &str, fork_point: &str) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/branch_switch.rs -->
```rust
//! Phase C: in-place branch-switch helpers.
//!
//! @spec apps/agentic-workflow/tech-design/core/worktree-retirement.md#schema
//!
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/git/branch_switch.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/branch_switch.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
