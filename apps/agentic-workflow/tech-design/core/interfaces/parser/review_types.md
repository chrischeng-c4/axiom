...
Public API manifest for `apps/agentic-workflow/src/parser/review.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ReviewBlock` | apps/agentic-workflow/src/parser/review.rs | struct | pub | 75 |  |
| `parse_latest_review` | apps/agentic-workflow/src/parser/review.rs | function | pub | 84 | parse_latest_review(content: &str) -> Result<Option<ReviewBlock>> |
| `parse_review_verdict` | apps/agentic-workflow/src/parser/review.rs | function | pub | 14 | parse_review_verdict(review_path: &Path) -> Result<ReviewVerdict> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/parser/review.rs -->
```rust
/// @spec apps/agentic-workflow/tech-design/core/interfaces/parser/review_types.md#source
...
/// ReviewBlock.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/parser/review_types.md#schema
#[derive(Debug, Clone, PartialEq)]
...
```yaml
changes:
  - path: apps/agentic-workflow/src/parser/review.rs
    action: modify
    section: source
    impl_mode: codegen
