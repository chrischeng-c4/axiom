...
Public API manifest for `apps/agentic-workflow/src/parser/challenge.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ChallengeParser` | apps/agentic-workflow/src/parser/challenge.rs | struct | pub | 114 |  |
| `parse_challenge_verdict` | apps/agentic-workflow/src/parser/challenge.rs | function | pub | 14 | parse_challenge_verdict(path: &Path) -> Result<ChallengeVerdict> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/parser/challenge.rs -->
```rust
/// @spec apps/agentic-workflow/tech-design/core/interfaces/parser/challenge_types.md#source
...
/// ChallengeParser.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/parser/challenge_types.md#schema
...
```yaml
changes:
  - path: apps/agentic-workflow/src/parser/challenge.rs
    action: modify
    section: source
    impl_mode: codegen
