...
Public API manifest for `apps/agentic-workflow/src/parser/inline_yaml.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `IssueBlockWrapper` | apps/agentic-workflow/src/parser/inline_yaml.rs | struct | pub | 44 |  |
| `RequirementBlockWrapper` | apps/agentic-workflow/src/parser/inline_yaml.rs | struct | pub | 36 |  |
| `TaskBlockWrapper` | apps/agentic-workflow/src/parser/inline_yaml.rs | struct | pub | 28 |  |
| `YamlBlock` | apps/agentic-workflow/src/parser/inline_yaml.rs | struct | pub | 16 |  |
| `extract_yaml_blocks` | apps/agentic-workflow/src/parser/inline_yaml.rs | function | pub | 56 | extract_yaml_blocks(content: &str) -> Vec<YamlBlock> |
| `extract_yaml_blocks_with_lines` | apps/agentic-workflow/src/parser/inline_yaml.rs | function | pub | 98 | extract_yaml_blocks_with_lines(content: &str) -> Vec<YamlBlock> |
| `parse_issue_blocks` | apps/agentic-workflow/src/parser/inline_yaml.rs | function | pub | 197 | parse_issue_blocks(     content: &str, ) -> Result<Vec<(crate::models::IssueBlock, Option<usize>)>> |
| `parse_requirement_blocks` | apps/agentic-workflow/src/parser/inline_yaml.rs | function | pub | 189 | parse_requirement_blocks(     content: &str, ) -> Result<Vec<(crate::models::RequirementBlock, Option<usize>)>> |
| `parse_task_blocks` | apps/agentic-workflow/src/parser/inline_yaml.rs | function | pub | 183 | parse_task_blocks(content: &str) -> Result<Vec<(crate::models::TaskBlock, Option<usize>)>> |
| `parse_typed_yaml_blocks` | apps/agentic-workflow/src/parser/inline_yaml.rs | function | pub | 140 | parse_typed_yaml_blocks(     content: &str,     block_type: &str, ) -> Result<Vec<(T, Option<usize>)>> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/parser/inline_yaml.rs -->
````rust
