...
|------|--------|------|------------|------|-----------|
| `DecodedCrrr` | apps/agentic-workflow/src/issues/labels.rs | struct | pub | 113 |  |
| `FLAGGED_PREFIX` | apps/agentic-workflow/src/issues/labels.rs | constant | pub | 39 |  |
| `MANAGED_PREFIXES` | apps/agentic-workflow/src/issues/labels.rs | constant | pub | 51 |  |
| `PHASE_PREFIX` | apps/agentic-workflow/src/issues/labels.rs | constant | pub | 34 |  |
| `RETRY_PREFIX` | apps/agentic-workflow/src/issues/labels.rs | constant | pub | 36 |  |
| `REVIEW_PREFIX` | apps/agentic-workflow/src/issues/labels.rs | constant | pub | 35 |  |
| `SHIP_COMMIT_PREFIX` | apps/agentic-workflow/src/issues/labels.rs | constant | pub | 38 |  |
| `SHIP_PREFIX` | apps/agentic-workflow/src/issues/labels.rs | constant | pub | 37 |  |
| `SLUG_PREFIX` | apps/agentic-workflow/src/issues/labels.rs | constant | pub | 42 |  |
| `WORKFLOW_LOCK_LABEL` | apps/agentic-workflow/src/issues/labels.rs | constant | pub | 40 |  |
...
<!-- source-snapshot: path=apps/agentic-workflow/src/issues/labels.rs -->
```rust
