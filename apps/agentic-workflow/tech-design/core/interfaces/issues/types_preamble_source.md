---
id: sdd-interfaces-issues-types-preamble-source
...
changes:
  - path: apps/agentic-workflow/src/issues/types.rs
    ...
    replaces:
      - "<module-preamble>"
    description: "Source template owns the issue types module preamble and non-generated import."
```
