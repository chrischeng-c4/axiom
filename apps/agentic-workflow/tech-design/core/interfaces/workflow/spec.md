...
# Standardized apps/agentic-workflow/src/workflow/spec.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/workflow/spec.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `handle` | apps/agentic-workflow/src/workflow/spec.rs | function | pub | 16 | handle(change_dir: &Path, change_id: &str, project_path: &str) -> Result<Value> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/workflow/spec.rs -->
````rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/workflow/spec.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
