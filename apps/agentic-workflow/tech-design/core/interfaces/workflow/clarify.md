...
# Standardized apps/agentic-workflow/src/workflow/clarify.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/workflow/clarify.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `handle` | apps/agentic-workflow/src/workflow/clarify.rs | function | pub | 16 | handle(     change_dir: &Path,     change_id: &str,     description: Option<&str>,     project_path: &str, ) -> Result<Value> |
| `handle_clarifications_review` | apps/agentic-workflow/src/workflow/clarify.rs | function | pub | 133 | handle_clarifications_review(     change_dir: &Path,     change_id: &str,     _project_path: &str, ) -> Result<Value> |
| `handle_post_clarifications_review` | apps/agentic-workflow/src/workflow/clarify.rs | function | pub | 257 | handle_post_clarifications_review(     change_dir: &Path,     change_id: &str,     _project_path: &str, ) -> Result<Value> |
| `handle_post_clarify` | apps/agentic-workflow/src/workflow/clarify.rs | function | pub | 229 | handle_post_clarify(     change_dir: &Path,     change_id: &str,     _project_path: &str, ) -> Result<Value> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/workflow/clarify.rs -->
````rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/workflow/clarify.md#source
pub fn handle(
    change_dir: &Path,
    change_id: &str,
...
```yaml
changes:
  - path: apps/agentic-workflow/src/workflow/clarify.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
