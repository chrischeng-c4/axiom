...
Public API manifest for `apps/agentic-workflow/src/workflow/task_graph.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TaskInfo` | apps/agentic-workflow/src/workflow/task_graph.rs | struct | pub | 15 |  |
| `build_task_execution_order` | apps/agentic-workflow/src/workflow/task_graph.rs | function | pub | 99 | build_task_execution_order(tasks: &[TaskInfo]) -> Vec<String> |
| `find_completed_tasks` | apps/agentic-workflow/src/workflow/task_graph.rs | function | pub | 181 | find_completed_tasks(     change_dir: &Path,     tasks: &[TaskInfo], ) -> std::collections::HashSet<String> |
| `find_next_task` | apps/agentic-workflow/src/workflow/task_graph.rs | function | pub | 153 | find_next_task(     tasks: &[TaskInfo],     execution_order: &[String],     current_task_id: Option<&str>,     completed_tasks: &std::collections::HashSet<String>, ) -> Option<String> |
| `is_codegen_eligible` | apps/agentic-workflow/src/workflow/task_graph.rs | function | pub | 215 | is_codegen_eligible(change_dir: &Path, spec_ref: &str) -> bool |
| `parse_task_blocks` | apps/agentic-workflow/src/workflow/task_graph.rs | function | pub | 35 | parse_task_blocks(content: &str) -> Vec<TaskInfo> |
## Schema
...
definitions:
  TaskInfo:
    type: object
    required: [id, status, depends_on, spec_ref]
    description: |
    ...
    properties:
      ...
      status:
        type: string
        description: "Task status (e.g. pending, in_progress, complete)."
      depends_on:
        type: array
        items: { type: string }
      ...
      spec_ref:
        ...
        description: "Optional spec reference (e.g. \"my-spec:R1,R2\")."
    x-rust-struct:
      derive: [Debug, Clone]
```
...
<!-- source-snapshot: path=apps/agentic-workflow/src/workflow/task_graph.rs -->
~~~rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/workflow/task_graph.md#source
// CODEGEN-BEGIN
...
/// A parsed task block from tasks.md.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/workflow/task_graph.md#schema
#[derive(Debug, Clone)]
pub struct TaskInfo {
    /// Task identifier.
    pub id: String,
...
/// depends_on: [3.1]
/// ```
/// @spec apps/agentic-workflow/tech-design/core/interfaces/workflow/task_graph.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/workflow/task_graph.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
      Source template owns the complete workflow task graph helper module.
  - action: annotate
    section: schema
...
- [overview] Single struct; basic Debug+Clone.
- [schema] All four fields in `required:`; Vec + Option via x-rust-type.
