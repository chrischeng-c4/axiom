...
Public API manifest for `apps/agentic-workflow/src/workflow/test_gate.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TestGateResult` | apps/agentic-workflow/src/workflow/test_gate.rs | struct | pub | 20 |  |
| `check_requirement_coverage` | apps/agentic-workflow/src/workflow/test_gate.rs | function | pub | 86 | check_requirement_coverage(     spec_reqs: &[String],     test_markers: &HashSet<String>, ) -> std::result::Result<(), Vec<String>> |
| `get_changed_files` | apps/agentic-workflow/src/workflow/test_gate.rs | function | pub | 204 | get_changed_files(project_root: &Path) -> Vec<String> |
| `match_scopes` | apps/agentic-workflow/src/workflow/test_gate.rs | function | pub | 110 | match_scopes(changed_files: &[String], config: &'a TestConfig) -> Vec<&'a TestScope> |
| `parse_requirement_ids` | apps/agentic-workflow/src/workflow/test_gate.rs | function | pub | 34 | parse_requirement_ids(spec_content: &str) -> Vec<String> |
| `run_full_test_gate` | apps/agentic-workflow/src/workflow/test_gate.rs | function | pub | 227 | run_full_test_gate(change_dir: &Path, project_root: &Path) -> Result<TestGateResult> |
| `run_test_gate` | apps/agentic-workflow/src/workflow/test_gate.rs | function | pub | 133 | run_test_gate(     scope: &TestScope,     global: &TestConfig,     project_root: &Path, ) -> Result<String> |
| `scan_test_markers` | apps/agentic-workflow/src/workflow/test_gate.rs | function | pub | 68 | scan_test_markers(test_files: &[PathBuf]) -> HashSet<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/workflow/test_gate.rs -->
~~~rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/workflow/test_gate.md#source
// CODEGEN-BEGIN
//! TDD test gate logic.
//!
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/workflow/test_gate.md#schema
#[derive(Debug)]
...
// @spec apps/agentic-workflow/tech-design/core/logic/tdd-gate.md#R5
...
// @spec apps/agentic-workflow/tech-design/core/logic/tdd-gate.md#R6
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/workflow/test_gate.md#source
...
// @spec apps/agentic-workflow/tech-design/core/logic/tdd-gate.md#R4
...
"#;
    ...
    fn test_match_scopes() {
        ...
        // Match sdd
        let changed = vec!["apps/agentic-workflow/src/models/change.rs".to_string()];
        let matched = match_scopes(&changed, &config);
        assert_eq!(matched.len(), 1);
    ...
    fn test_match_scopes_multiple() {
        ...
        let changed = vec!["apps/agentic-workflow/src/lib.rs".to_string()];
        let matched = match_scopes(&changed, &config);
...
```yaml
changes:
  - path: apps/agentic-workflow/src/workflow/test_gate.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
