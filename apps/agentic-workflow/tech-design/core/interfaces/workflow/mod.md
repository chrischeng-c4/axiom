---
id: projects-sdd-src-workflow-mod-rs
...
# Standardized apps/agentic-workflow/src/workflow/mod.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/workflow/mod.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `definition` | apps/agentic-workflow/src/workflow/mod.rs | function | pub | 34 | definition() -> ToolDefinition |
| `execute` | apps/agentic-workflow/src/workflow/mod.rs | function | pub | 85 | execute(args: &Value, project_root: &Path) -> Result<String> |
| `helpers` | apps/agentic-workflow/src/workflow/mod.rs | module | pub | 17 |  |
| `scope` | apps/agentic-workflow/src/workflow/mod.rs | module | pub | 19 |  |
| `task_graph` | apps/agentic-workflow/src/workflow/mod.rs | module | pub | 20 |  |
| `test_gate` | apps/agentic-workflow/src/workflow/mod.rs | module | pub | 21 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/workflow/mod.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/workflow/mod.md#source
...
pub async fn execute(args: &Value, project_root: &Path) -> Result<String> {
    ...
    // @spec apps/agentic-workflow/tech-design/core/logic/tdd-gate.md#R9
    let skip_tests = args
        .get("skip_tests")
...
mod tests {
    ...
    async fn test_execute_issue_only_synthesizes_description() {
        ...
        let issues_dir = tmp.path().join(".aw/issues/open");
...
```yaml
changes:
  - path: apps/agentic-workflow/src/workflow/mod.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
      Source template owns the complete workflow module facade and run-change router.
```
