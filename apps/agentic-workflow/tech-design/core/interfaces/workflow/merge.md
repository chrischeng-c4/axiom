...
# Standardized apps/agentic-workflow/src/workflow/merge.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/workflow/merge.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `handle` | apps/agentic-workflow/src/workflow/merge.rs | function | pub | 17 | handle(     change_dir: &Path,     change_id: &str,     _project_path: &str,     project_root: &Path, ) -> Result<Value> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/workflow/merge.rs -->
````rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/workflow/merge.md#source
pub fn handle(
    change_dir: &Path,
    change_id: &str,
    _project_path: &str,
...
```yaml
changes:
  - path: apps/agentic-workflow/src/workflow/merge.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
