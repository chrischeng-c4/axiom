...
Public API manifest for `apps/agentic-workflow/src/spec_ir/generator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ApiSpecEntry` | apps/agentic-workflow/src/spec_ir/generator.rs | struct | pub | 49 |  |
| `DiagramEntry` | apps/agentic-workflow/src/spec_ir/generator.rs | struct | pub | 37 |  |
| `GenerateResult` | apps/agentic-workflow/src/spec_ir/generator.rs | struct | pub | 59 |  |
| `SpecIrInput` | apps/agentic-workflow/src/spec_ir/generator.rs | struct | pub | 17 |  |
| `generate` | apps/agentic-workflow/src/spec_ir/generator.rs | function | pub | 109 | generate(change_dir: &Path, input: &SpecIrInput) -> crate::Result<GenerateResult> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/spec_ir/generator.rs -->
```rust
...
/// Input for generating YAML IR from a spec.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/spec_ir/generator.md#schema
#[derive(Debug, Clone)]
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/spec_ir/generator.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/spec_ir/generator.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
