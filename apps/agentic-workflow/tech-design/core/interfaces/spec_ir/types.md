...
# Spec IR Manifest Types

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/spec_ir/types.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `API_VERSION` | apps/agentic-workflow/src/spec_ir/types.rs | constant | pub | 30 |  |
| `ManifestMetadata` | apps/agentic-workflow/src/spec_ir/types.rs | struct | pub | 56 |  |
| `SpecKind` | apps/agentic-workflow/src/spec_ir/types.rs | enum | pub | 37 |  |
| `SpecManifest` | apps/agentic-workflow/src/spec_ir/types.rs | struct | pub | 79 |  |
| `as_snake` | apps/agentic-workflow/src/spec_ir/types.rs | function | pub | 92 | as_snake(&self) -> &'static str |
| `filename` | apps/agentic-workflow/src/spec_ir/types.rs | function | pub | 216 | filename(&self) -> String |
| `from_file` | apps/agentic-workflow/src/spec_ir/types.rs | function | pub | 177 | from_file(path: &Path) -> crate::Result<Self> |
| `from_spec_ir_kind` | apps/agentic-workflow/src/spec_ir/types.rs | function | pub | 116 | from_spec_ir_kind(tag: &str) -> Option<Self> |
| `from_str_loose` | apps/agentic-workflow/src/spec_ir/types.rs | function | pub | 129 | from_str_loose(s: &str) -> Option<Self> |
| `from_yaml` | apps/agentic-workflow/src/spec_ir/types.rs | function | pub | 169 | from_yaml(yaml: &str) -> crate::Result<Self> |
| `new` | apps/agentic-workflow/src/spec_ir/types.rs | function | pub | 145 | new(         kind: SpecKind,         name: impl Into<String>,         change_id: impl Into<String>,         spec: serde_yaml::Value,     ) -> Self |
| `spec_ir_kind` | apps/agentic-workflow/src/spec_ir/types.rs | function | pub | 107 | spec_ir_kind(&self) -> &'static str |
| `to_yaml` | apps/agentic-workflow/src/spec_ir/types.rs | function | pub | 164 | to_yaml(&self) -> crate::Result<String> |
| `validate` | apps/agentic-workflow/src/spec_ir/types.rs | function | pub | 196 | validate(&self) -> crate::Result<()> |
| `write_to` | apps/agentic-workflow/src/spec_ir/types.rs | function | pub | 184 | write_to(&self, path: &Path) -> crate::Result<()> |
## Schema
...
definitions:
  SpecKind:
    type: string
    enum: [Api, FlowchartPlus, SequencePlus, ClassPlus, ErdPlus, RequirementPlus]
    description: Valid spec kinds (maps to SDD diagram types).
    x-rust-enum:
      derive: [Debug, Clone, PartialEq, Eq, Serialize, Deserialize]

  ManifestMetadata:
    type: object
    required: [name, change_id, source_file, spec_group, spec_id, tags]
    description: Manifest metadata (k8s-style).
    properties:
      name:
        type: string
        description: "Human-readable name for this spec artifact."
      change_id:
        type: string
        description: "Change ID this manifest belongs to."
      source_file:
        type: string
      ...
      spec_id:
        ...
        x-serde-default: true
        x-serde-skip-if: "Option::is_none"
        description: "Spec ID within the group."
      tags:
        type: array
        items: { type: string }
    ...
    x-rust-struct:
      ...
      serde_deny_unknown: true

  SpecManifest:
    type: object
    required: [api_version, kind, metadata, spec]
    description: A SpecIR YAML manifest — the k8s-style envelope.
    properties:
      api_version:
        type: string
        description: "API version (always \"cclab.dev/v1\")."
      kind:
        type: string
      ...
      metadata:
        type: object
        x-rust-type: "ManifestMetadata"
        description: "Manifest metadata."
      spec:
        type: object
        x-rust-type: "serde_yaml::Value"
        description: "Kind-specific payload (opaque YAML)."
    x-rust-struct:
...
<!-- source-snapshot: path=apps/agentic-workflow/src/spec_ir/types.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/spec_ir/types.md#schema
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum SpecKind {
    #[serde(rename = "Api")]
    Api,
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/spec_ir/types.md#source
impl SpecKind {
...
```yaml
changes:
  - path: apps/agentic-workflow/src/spec_ir/types.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
      Source template owns the complete SpecIR manifest type module.
  - action: annotate
    section: schema
...
- [overview] Three types: enum + 2 structs with deny_unknown_fields, one with camelCase rename.
- [schema] All in `required:`; foreign types via x-rust-type; uses serde_deny_unknown gap fix.
