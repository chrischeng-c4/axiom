...
Public API manifest for `apps/agentic-workflow/src/spec_ir/migration.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `FlowKind` | apps/agentic-workflow/src/spec_ir/migration.rs | enum | pub | 35 |  |
| `MigrationResult` | apps/agentic-workflow/src/spec_ir/migration.rs | struct | pub | 45 |  |
| `analyze` | apps/agentic-workflow/src/spec_ir/migration.rs | function | pub | 68 | analyze(change_dir: &Path) -> MigrationResult |
| `check_mixed_flow` | apps/agentic-workflow/src/spec_ir/migration.rs | function | pub | 92 | check_mixed_flow(change_dir: &Path, using_legacy_tool: bool) -> Result<(), String> |
| `detect_flow` | apps/agentic-workflow/src/spec_ir/migration.rs | function | pub | 56 | detect_flow(change_dir: &Path) -> FlowKind |
| `guard_tool_invocation` | apps/agentic-workflow/src/spec_ir/migration.rs | function | pub | 122 | guard_tool_invocation(     change_dir: &Path,     is_legacy_tool: bool, ) -> Result<Option<String>, String> |
| `should_use_yaml_ir_for_new_change` | apps/agentic-workflow/src/spec_ir/migration.rs | function | pub | 109 | should_use_yaml_ir_for_new_change() -> bool |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/spec_ir/migration.rs -->
```rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/spec_ir/migration.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
