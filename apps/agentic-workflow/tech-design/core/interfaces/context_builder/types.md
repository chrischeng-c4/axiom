...
Public API manifest for `apps/agentic-workflow/src/context_builder/types.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ContextEntry` | apps/agentic-workflow/src/context_builder/types.rs | struct | pub | 20 |  |
| `ContextReason` | apps/agentic-workflow/src/context_builder/types.rs | enum | pub | 34 |  |
| `ContextRequest` | apps/agentic-workflow/src/context_builder/types.rs | struct | pub | 47 |  |
| `ContextResponse` | apps/agentic-workflow/src/context_builder/types.rs | struct | pub | 56 |  |
| `ContextStats` | apps/agentic-workflow/src/context_builder/types.rs | struct | pub | 66 |  |
| `ContextTarget` | apps/agentic-workflow/src/context_builder/types.rs | struct | pub | 76 |  |
| `empty` | apps/agentic-workflow/src/context_builder/types.rs | function | pub | 111 | empty() -> Self |
| `parse` | apps/agentic-workflow/src/context_builder/types.rs | function | pub | 88 | parse(input: &str) -> Option<Self> |
## Schema
...
```yaml
changes:
  - path: apps/agentic-workflow/src/context_builder/types.rs
    action: modify
    section: schema
    impl_mode: codegen
    replaces:
