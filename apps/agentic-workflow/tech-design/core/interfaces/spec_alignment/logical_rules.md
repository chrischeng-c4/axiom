---
id: projects-sdd-src-spec-alignment-logical-rules-rs
...
# Standardized apps/agentic-workflow/src/spec_alignment/logical_rules.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/spec_alignment/logical_rules.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `check` | apps/agentic-workflow/src/spec_alignment/logical_rules.rs | function | pub | 30 | check(doc: &SpecDocument) -> Vec<Violation> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:claim-code -->

<!-- source-snapshot: path=apps/agentic-workflow/src/spec_alignment/logical_rules.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/spec_alignment/logical_rules.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/spec_alignment/logical_rules.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
    ...
    description: |
      Source template owns the complete spec-alignment logical rules module.
```
