...
# Standardized apps/agentic-workflow/src/spec_alignment/check.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/spec_alignment/check.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `check` | apps/agentic-workflow/src/spec_alignment/check.rs | function | pub | 22 | check(path: &Path) -> CheckResult |
| `check_with_coverage` | apps/agentic-workflow/src/spec_alignment/check.rs | function | pub | 49 | check_with_coverage(spec_dir: &Path, source_dirs: &[&Path]) -> CheckResult |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:claim-code -->

<!-- source-snapshot: path=apps/agentic-workflow/src/spec_alignment/check.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/spec_alignment/check.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/spec_alignment/check.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
