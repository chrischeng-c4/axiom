...
# Standardized apps/agentic-workflow/src/spec_alignment/requirement_coverage.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/spec_alignment/requirement_coverage.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `check` | apps/agentic-workflow/src/spec_alignment/requirement_coverage.rs | function | pub | 23 | check(doc: &SpecDocument) -> (Vec<Violation>, Vec<OrphanRequirementEntry>) |
| `check_with_content` | apps/agentic-workflow/src/spec_alignment/requirement_coverage.rs | function | pub | 34 | check_with_content(     doc: &SpecDocument,     content: &str, ) -> (Vec<Violation>, Vec<OrphanRequirementEntry>) |
| `extract_requirement_ids` | apps/agentic-workflow/src/spec_alignment/requirement_coverage.rs | function | pub | 215 | extract_requirement_ids(spec_path: &str) -> HashMap<String, Option<String>> |
| `extract_requirement_ids_from_content` | apps/agentic-workflow/src/spec_alignment/requirement_coverage.rs | function | pub | 226 | extract_requirement_ids_from_content(content: &str) -> HashMap<String, Option<String>> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:claim-code -->

<!-- source-snapshot: path=apps/agentic-workflow/src/spec_alignment/requirement_coverage.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/spec_alignment/requirement_coverage.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/spec_alignment/requirement_coverage.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
