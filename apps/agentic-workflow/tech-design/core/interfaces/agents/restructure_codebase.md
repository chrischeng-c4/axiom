---
id: sdd-agents-restructure-codebase
...
# Restructure Codebase Agent Types

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/agents/restructure_codebase.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RestructureCodebaseAgent` | apps/agentic-workflow/src/agents/restructure_codebase.rs | struct | pub | 70 |  |
| `RestructureCodebaseAgentBuilder` | apps/agentic-workflow/src/agents/restructure_codebase.rs | struct | pub | 79 |  |
| `RestructureCodebaseAgentConfig` | apps/agentic-workflow/src/agents/restructure_codebase.rs | struct | pub | 55 |  |
| `build` | apps/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 313 | build(self) -> NovaResult<RestructureCodebaseAgent> |
| `builder` | apps/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 192 | builder() -> RestructureCodebaseAgentBuilder |
| `new` | apps/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 271 | new() -> Self |
| `with_max_retries` | apps/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 303 | with_max_retries(mut self, n: u32) -> Self |
| `with_max_turns` | apps/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 298 | with_max_turns(mut self, max_turns: u32) -> Self |
| `with_model` | apps/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 288 | with_model(mut self, model: impl Into<String>) -> Self |
| `with_provider` | apps/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 278 | with_provider(mut self, provider: P) -> Self |
| `with_provider_arc` | apps/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 283 | with_provider_arc(mut self, provider: Arc<dyn LLMProvider>) -> Self |
| `with_temperature` | apps/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 293 | with_temperature(mut self, temperature: f32) -> Self |
| `with_token_budget` | apps/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 308 | with_token_budget(mut self, budget: u64) -> Self |
## Schema
...
definitions:
  RestructureCodebaseAgentConfig:
    type: object
    required: [model, temperature, max_turns, max_retries, token_budget]
    description: Configuration for RestructureCodebaseAgent.
    properties:
      model:
        type: string
      ...
      max_turns:
        type: integer
        x-rust-type: "u32"
        description: "Maximum exploration turns for the inner CodingAgent."
      max_retries:
        type: integer
        x-rust-type: "u32"
        description: "Retries when set_grouping was never called."
      token_budget:
        type: integer
        x-rust-type: "u64"
        description: "Token budget per group."
    x-rust-struct:
  ...
  RestructureCodebaseAgent:
    ...
    description: Codebase restructuring agent.
    properties:
      config:
        type: object
        x-rust-type: "RestructureCodebaseAgentConfig"
  ...
  RestructureCodebaseAgentBuilder:
    type: object
    required: [config, provider]
    description: Builder for RestructureCodebaseAgent.
    properties:
      config:
        type: object
        x-rust-type: "RestructureCodebaseAgentConfig"
...
<!-- source-snapshot: path=apps/agentic-workflow/src/agents/restructure_codebase.rs -->
~~~rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/agents/restructure_codebase.md#source
// CODEGEN-BEGIN
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/restructure_codebase.md#source
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/restructure_codebase.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
...
```yaml
changes:
  - path: apps/agentic-workflow/src/agents/restructure_codebase.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
      Source template owns the complete restructure-codebase agent module,
      including schema-derived structs, behavior impls, prompts, builder
      methods, and tests.
  - action: annotate
    section: schema
...
- [overview] Standard agent pattern: Config + Agent + Builder.
- [schema] All three well-formed; private trait-object fields.
- [changes] Standard split.

### Review 2
**Verdict:** approved

- [overview] Promotes behavior and tests into full source-template ownership while keeping the schema shape contract.
- [source] Uses `strip-managed-markers` to preserve current Rust behavior and remove mixed CODEGEN/HANDWRITE boundaries.
