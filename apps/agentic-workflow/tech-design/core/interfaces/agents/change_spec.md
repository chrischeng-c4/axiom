...
Public API manifest for `apps/agentic-workflow/src/agents/change_spec.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ChangeSpecAgent` | apps/agentic-workflow/src/agents/change_spec.rs | struct | pub | 85 |  |
| `ChangeSpecAgentBuilder` | apps/agentic-workflow/src/agents/change_spec.rs | struct | pub | 94 |  |
| `ChangeSpecAgentConfig` | apps/agentic-workflow/src/agents/change_spec.rs | struct | pub | 72 |  |
| `ChangeSpecInput` | apps/agentic-workflow/src/agents/change_spec.rs | struct | pub | 62 |  |
| `build` | apps/agentic-workflow/src/agents/change_spec.rs | function | pub | 421 | build(self) -> NovaResult<ChangeSpecAgent> |
...
| `with_provider` | apps/agentic-workflow/src/agents/change_spec.rs | function | pub | 391 | with_provider(mut self, provider: P) -> Self |
| `with_provider_arc` | apps/agentic-workflow/src/agents/change_spec.rs | function | pub | 396 | with_provider_arc(mut self, provider: Arc<dyn LLMProvider>) -> Self |
| `with_temperature` | apps/agentic-workflow/src/agents/change_spec.rs | function | pub | 411 | with_temperature(mut self, temperature: f32) -> Self |
## Schema
...
```yaml
changes:
  - path: apps/agentic-workflow/src/agents/change_spec.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
