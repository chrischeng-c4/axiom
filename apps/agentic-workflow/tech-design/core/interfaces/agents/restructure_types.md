...
Public API manifest for `apps/agentic-workflow/src/agents/restructure.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Clarification` | apps/agentic-workflow/src/agents/restructure.rs | struct | pub | 26 |  |
| `Question` | apps/agentic-workflow/src/agents/restructure.rs | struct | pub | 46 |  |
| `RestructureAgent` | apps/agentic-workflow/src/agents/restructure.rs | struct | pub | 158 |  |
| `RestructureAgentBuilder` | apps/agentic-workflow/src/agents/restructure.rs | struct | pub | 340 |  |
| `RestructureAgentConfig` | apps/agentic-workflow/src/agents/restructure.rs | struct | pub | 96 |  |
| `RestructureInput` | apps/agentic-workflow/src/agents/restructure.rs | struct | pub | 34 |  |
| `RestructureOutput` | apps/agentic-workflow/src/agents/restructure.rs | enum | pub | 71 |  |
| `SpecExcerpt` | apps/agentic-workflow/src/agents/restructure.rs | struct | pub | 84 |  |
| `StructuredIssue` | apps/agentic-workflow/src/agents/restructure.rs | struct | pub | 56 |  |
| `build` | apps/agentic-workflow/src/agents/restructure.rs | function | pub | 401 | build(self) -> NovaResult<RestructureAgent> |
| `builder` | apps/agentic-workflow/src/agents/restructure.rs | function | pub | 167 | builder() -> RestructureAgentBuilder |
| `new` | apps/agentic-workflow/src/agents/restructure.rs | function | pub | 348 | new() -> Self |
| `run` | apps/agentic-workflow/src/agents/restructure.rs | function | pub | 172 | run(&self, input: &RestructureInput) -> NovaResult<RestructureOutput> |
| `with_max_retries` | apps/agentic-workflow/src/agents/restructure.rs | function | pub | 396 | with_max_retries(mut self, n: u32) -> Self |
| `with_max_spec_excerpts` | apps/agentic-workflow/src/agents/restructure.rs | function | pub | 391 | with_max_spec_excerpts(mut self, n: usize) -> Self |
| `with_max_tokens` | apps/agentic-workflow/src/agents/restructure.rs | function | pub | 381 | with_max_tokens(mut self, max_tokens: u32) -> Self |
| `with_model` | apps/agentic-workflow/src/agents/restructure.rs | function | pub | 376 | with_model(mut self, model: impl Into<String>) -> Self |
| `with_provider` | apps/agentic-workflow/src/agents/restructure.rs | function | pub | 356 | with_provider(mut self, provider: P) -> Self |
| `with_provider_arc` | apps/agentic-workflow/src/agents/restructure.rs | function | pub | 361 | with_provider_arc(mut self, provider: Arc<dyn LLMProvider>) -> Self |
| `with_spec_store` | apps/agentic-workflow/src/agents/restructure.rs | function | pub | 366 | with_spec_store(mut self, store: S) -> Self |
| `with_spec_store_arc` | apps/agentic-workflow/src/agents/restructure.rs | function | pub | 371 | with_spec_store_arc(mut self, store: Arc<dyn SpecStore>) -> Self |
| `with_temperature` | apps/agentic-workflow/src/agents/restructure.rs | function | pub | 386 | with_temperature(mut self, temperature: f32) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/agents/restructure.rs -->
````rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/restructure_types.md#source
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/restructure_types.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/restructure_types.md#schema.trait-impls.Default
...
```yaml
changes:
  - path: apps/agentic-workflow/src/agents/restructure.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
