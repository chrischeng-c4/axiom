...
Public API manifest for `apps/agentic-workflow/src/agents/code_agent/tasks.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ImplementationTask` | apps/agentic-workflow/src/agents/code_agent/tasks.rs | struct | pub | 48 |  |
| `TaskAction` | apps/agentic-workflow/src/agents/code_agent/tasks.rs | enum | pub | 36 |  |
| `TaskCategory` | apps/agentic-workflow/src/agents/code_agent/tasks.rs | enum | pub | 18 |  |
| `decompose_spec` | apps/agentic-workflow/src/agents/code_agent/tasks.rs | function | pub | 71 | decompose_spec(spec: &str) -> Vec<ImplementationTask> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/agents/code_agent/tasks.rs -->
````rust
...
/// Execution category that controls the topological sort order.
/// Ord is derived so tasks sort Data < Logic < Integration < Test.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/code_agent/tasks.md#schema
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/code_agent/tasks.md#source
// ============================================================
// Public API
// ============================================================
...
```yaml
changes:
  - path: apps/agentic-workflow/src/agents/code_agent/tasks.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
