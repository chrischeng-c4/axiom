...
Public API manifest for `apps/agentic-workflow/src/agents/code_agent/parser.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `FileBlock` | apps/agentic-workflow/src/agents/code_agent/parser.rs | struct | pub | 21 |  |
| `parse_file_blocks` | apps/agentic-workflow/src/agents/code_agent/parser.rs | function | pub | 38 | parse_file_blocks(input: &str) -> NovaResult<Vec<FileBlock>> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/agents/code_agent/parser.rs -->
````rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/code_agent/file_block.md#source
use agent::error::{NovaError, NovaResult};

/// A parsed file block extracted from an LLM response.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/code_agent/file_block.md#schema
#[derive(Debug, Clone, PartialEq)]
...
```yaml
changes:
  - path: apps/agentic-workflow/src/agents/code_agent/parser.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
