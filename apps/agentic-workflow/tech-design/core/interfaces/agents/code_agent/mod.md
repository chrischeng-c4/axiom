...
Public API manifest for `apps/agentic-workflow/src/agents/code_agent/mod.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CodeAgent` | apps/agentic-workflow/src/agents/code_agent/mod.rs | struct | pub | 64 |  |
| `CodeAgentBuilder` | apps/agentic-workflow/src/agents/code_agent/mod.rs | struct | pub | 77 |  |
| `CodeAgentConfig` | apps/agentic-workflow/src/agents/code_agent/mod.rs | struct | pub | 47 |  |
| `build` | apps/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 389 | build(self) -> NovaResult<CodeAgent> |
| `builder` | apps/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 118 | builder() -> CodeAgentBuilder |
| `new` | apps/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 319 | new() -> Self |
| `with_base_branch` | apps/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 374 | with_base_branch(mut self, branch: impl Into<String>) -> Self |
| `with_branch_prefix` | apps/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 379 | with_branch_prefix(mut self, prefix: impl Into<String>) -> Self |
| `with_max_revisions` | apps/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 369 | with_max_revisions(mut self, n: u32) -> Self |
| `with_model` | apps/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 364 | with_model(mut self, model: impl Into<String>) -> Self |
| `with_platform` | apps/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 353 | with_platform(mut self, platform: P) -> Self |
| `with_platform_arc` | apps/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 359 | with_platform_arc(mut self, platform: Arc<dyn PlatformIntegration>) -> Self |
| `with_provider` | apps/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 329 | with_provider(mut self, provider: P) -> Self |
| `with_provider_arc` | apps/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 335 | with_provider_arc(mut self, provider: Arc<dyn LLMProvider>) -> Self |
| `with_reviewer` | apps/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 341 | with_reviewer(mut self, reviewer: R) -> Self |
| `with_reviewer_arc` | apps/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 347 | with_reviewer_arc(mut self, reviewer: Arc<dyn Reviewer>) -> Self |
## Schema
...
definitions:
  CodeAgentConfig:
    type: object
    required: [model, max_tokens, temperature, max_revisions, base_branch, branch_prefix]
    description: Configuration for CodeAgent.
    properties:
      model:
        type: string
      ...
      max_revisions:
        type: integer
        x-rust-type: "u32"
        description: "Maximum CRR revision rounds."
      base_branch:
        type: string
  ...
  CodeAgent:
    type: object
    required: [config, provider, reviewer, platform]
    description: Autonomous agent that implements approved specs end-to-end.
    properties:
      config:
        type: object
        x-rust-type: "CodeAgentConfig"
      ...
      reviewer:
        ...
        x-rust-visibility: private
        description: "CRR reviewer."
      platform:
        type: object
        x-rust-type: "Arc<dyn PlatformIntegration>"
        x-rust-visibility: private
  ...
  CodeAgentBuilder:
    type: object
    required: [config, provider, reviewer, platform]
    description: Builder for CodeAgent.
    properties:
      config:
        type: object
        x-rust-type: "CodeAgentConfig"
      ...
      platform:
        type: object
        x-rust-type: "Option<Arc<dyn PlatformIntegration>>"
        x-rust-visibility: private
        description: "Optional platform integration."
    x-rust-struct:
      derive: []
```
...
<!-- source-snapshot: path=apps/agentic-workflow/src/agents/code_agent/mod.rs -->
````rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/code_agent/mod.md#source
mod parser;
mod tasks;
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/code_agent/mod.md#schema
#[derive(Debug, Clone)]
...
```yaml
changes:
  - path: apps/agentic-workflow/src/agents/code_agent/mod.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
      Source template owns the complete code-agent module, including
      schema-derived structs, module facade wiring, runtime behavior, prompt
...
- [overview] 3 standard agent pattern types with multiple trait-object dependencies.
- [schema] All in `required:`; foreign types via x-rust-type; visibility private.
...
- [overview] Promotes the module facade and behavior into source-template ownership while keeping schema as the type contract.
