...
definitions:
  ...
  ReferenceSpecContextAgent:
    type: object
    required: [config, provider, spec_store]
...
~~~~~rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/agents/reference_spec_context.md#source
// CODEGEN-BEGIN
...
changes:
  - path: apps/agentic-workflow/src/agents/reference_spec_context.rs
    ...
    impl_mode: codegen
    description: |
      Source template owns the linear reference-spec-context implementation; semantic
