...
Public API manifest for `apps/agentic-workflow/src/agents/reference_spec_context.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Contradiction` | apps/agentic-workflow/src/agents/reference_spec_context.rs | struct | pub | 55 |  |
| `ReferenceContextOutput` | apps/agentic-workflow/src/agents/reference_spec_context.rs | struct | pub | 69 |  |
| `ReferenceSpecContextAgent` | apps/agentic-workflow/src/agents/reference_spec_context.rs | struct | pub | 94 |  |
| `ReferenceSpecContextAgentBuilder` | apps/agentic-workflow/src/agents/reference_spec_context.rs | struct | pub | 107 |  |
| `ReferenceSpecContextAgentConfig` | apps/agentic-workflow/src/agents/reference_spec_context.rs | struct | pub | 79 |  |
| `RelevanceLevel` | apps/agentic-workflow/src/agents/reference_spec_context.rs | enum | pub | 32 |  |
| `SpecReferenceEntry` | apps/agentic-workflow/src/agents/reference_spec_context.rs | struct | pub | 41 |  |
| `build` | apps/agentic-workflow/src/agents/reference_spec_context.rs | function | pub | 466 | build(self) -> NovaResult<ReferenceSpecContextAgent> |
| `builder` | apps/agentic-workflow/src/agents/reference_spec_context.rs | function | pub | 185 | builder() -> ReferenceSpecContextAgentBuilder |
| `new` | apps/agentic-workflow/src/agents/reference_spec_context.rs | function | pub | 402 | new() -> Self |
| `with_max_retries` | apps/agentic-workflow/src/agents/reference_spec_context.rs | function | pub | 461 | with_max_retries(mut self, n: u32) -> Self |
| `with_max_spec_excerpts` | apps/agentic-workflow/src/agents/reference_spec_context.rs | function | pub | 456 | with_max_spec_excerpts(mut self, n: usize) -> Self |
| `with_max_tokens` | apps/agentic-workflow/src/agents/reference_spec_context.rs | function | pub | 446 | with_max_tokens(mut self, max_tokens: u32) -> Self |
| `with_model` | apps/agentic-workflow/src/agents/reference_spec_context.rs | function | pub | 441 | with_model(mut self, model: impl Into<String>) -> Self |
| `with_provider` | apps/agentic-workflow/src/agents/reference_spec_context.rs | function | pub | 411 | with_provider(mut self, provider: P) -> Self |
| `with_provider_arc` | apps/agentic-workflow/src/agents/reference_spec_context.rs | function | pub | 416 | with_provider_arc(mut self, provider: Arc<dyn LLMProvider>) -> Self |
| `with_reviewer` | apps/agentic-workflow/src/agents/reference_spec_context.rs | function | pub | 431 | with_reviewer(mut self, reviewer: R) -> Self |
| `with_reviewer_arc` | apps/agentic-workflow/src/agents/reference_spec_context.rs | function | pub | 436 | with_reviewer_arc(mut self, reviewer: Arc<dyn Reviewer>) -> Self |
| `with_spec_store` | apps/agentic-workflow/src/agents/reference_spec_context.rs | function | pub | 421 | with_spec_store(mut self, store: S) -> Self |
| `with_spec_store_arc` | apps/agentic-workflow/src/agents/reference_spec_context.rs | function | pub | 426 | with_spec_store_arc(mut self, store: Arc<dyn SpecStore>) -> Self |
| `with_temperature` | apps/agentic-workflow/src/agents/reference_spec_context.rs | function | pub | 451 | with_temperature(mut self, temperature: f32) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/agents/reference_spec_context.rs -->
````rust
...
/// Relevance level.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/reference_spec_context.md#schema
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/reference_spec_context.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/agents/reference_spec_context.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
