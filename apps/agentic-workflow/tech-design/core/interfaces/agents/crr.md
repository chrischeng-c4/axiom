...
Public API manifest for `apps/agentic-workflow/src/agents/crr.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CRRCycle` | apps/agentic-workflow/src/agents/crr.rs | struct | pub | 97 |  |
| `CRRCycleBuilder` | apps/agentic-workflow/src/agents/crr.rs | struct | pub | 112 |  |
| `CRREvent` | apps/agentic-workflow/src/agents/crr.rs | enum | pub | 63 |  |
| `CRRResult` | apps/agentic-workflow/src/agents/crr.rs | struct | pub | 86 |  |
| `CRRVerdictType` | apps/agentic-workflow/src/agents/crr.rs | enum | pub | 54 |  |
| `build` | apps/agentic-workflow/src/agents/crr.rs | function | pub | 345 | build(self) -> NovaResult<CRRCycle> |
| `creator` | apps/agentic-workflow/src/agents/crr.rs | function | pub | 291 | creator(mut self, agent: A) -> Self |
| `creator_arc` | apps/agentic-workflow/src/agents/crr.rs | function | pub | 297 | creator_arc(mut self, agent: Arc<dyn Agent>) -> Self |
| `max_revisions` | apps/agentic-workflow/src/agents/crr.rs | function | pub | 329 | max_revisions(mut self, n: u32) -> Self |
| `new` | apps/agentic-workflow/src/agents/crr.rs | function | pub | 156 | new() -> CRRCycleBuilder |
| `on_event` | apps/agentic-workflow/src/agents/crr.rs | function | pub | 335 | on_event(mut self, handler: F) -> Self |
| `reviewer` | apps/agentic-workflow/src/agents/crr.rs | function | pub | 303 | reviewer(mut self, reviewer: R) -> Self |
| `reviewer_arc` | apps/agentic-workflow/src/agents/crr.rs | function | pub | 309 | reviewer_arc(mut self, reviewer: Arc<dyn Reviewer>) -> Self |
| `reviser` | apps/agentic-workflow/src/agents/crr.rs | function | pub | 315 | reviser(mut self, agent: A) -> Self |
| `reviser_arc` | apps/agentic-workflow/src/agents/crr.rs | function | pub | 321 | reviser_arc(mut self, agent: Arc<dyn Agent>) -> Self |
| `run` | apps/agentic-workflow/src/agents/crr.rs | function | pub | 167 | run(&self, input: &str) -> NovaResult<CRRResult> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/agents/crr.rs -->
````rust
