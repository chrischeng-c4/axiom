...
Public API manifest for `apps/agentic-workflow/src/agents/review/types.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ReviewIssue` | apps/agentic-workflow/src/agents/review/types.rs | struct | pub | 40 |  |
| `ReviewType` | apps/agentic-workflow/src/agents/review/types.rs | enum | pub | 11 |  |
| `ReviewVerdict` | apps/agentic-workflow/src/agents/review/types.rs | enum | pub | 56 |  |
| `Severity` | apps/agentic-workflow/src/agents/review/types.rs | enum | pub | 20 |  |
| `is_approved` | apps/agentic-workflow/src/agents/review/types.rs | function | pub | 67 | is_approved(&self) -> bool |
| `is_needs_revision` | apps/agentic-workflow/src/agents/review/types.rs | function | pub | 71 | is_needs_revision(&self) -> bool |
| `is_rejected` | apps/agentic-workflow/src/agents/review/types.rs | function | pub | 75 | is_rejected(&self) -> bool |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/agents/review/types.rs -->
```rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/agents/review/types.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
