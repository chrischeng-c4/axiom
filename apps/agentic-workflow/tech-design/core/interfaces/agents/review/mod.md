...
Public API manifest for `apps/agentic-workflow/src/agents/review/mod.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ReviewAgent` | apps/agentic-workflow/src/agents/review/mod.rs | struct | pub | 56 |  |
| `ReviewAgentBuilder` | apps/agentic-workflow/src/agents/review/mod.rs | struct | pub | 65 |  |
| `ReviewAgentConfig` | apps/agentic-workflow/src/agents/review/mod.rs | struct | pub | 41 |  |
| `build` | apps/agentic-workflow/src/agents/review/mod.rs | function | pub | 261 | build(self) -> NovaResult<ReviewAgent> |
| `builder` | apps/agentic-workflow/src/agents/review/mod.rs | function | pub | 100 | builder() -> ReviewAgentBuilder |
| `new` | apps/agentic-workflow/src/agents/review/mod.rs | function | pub | 219 | new() -> Self |
| `with_max_retries` | apps/agentic-workflow/src/agents/review/mod.rs | function | pub | 256 | with_max_retries(mut self, n: u32) -> Self |
| `with_max_tokens` | apps/agentic-workflow/src/agents/review/mod.rs | function | pub | 246 | with_max_tokens(mut self, max_tokens: u32) -> Self |
| `with_model` | apps/agentic-workflow/src/agents/review/mod.rs | function | pub | 241 | with_model(mut self, model: impl Into<String>) -> Self |
| `with_provider` | apps/agentic-workflow/src/agents/review/mod.rs | function | pub | 226 | with_provider(mut self, provider: P) -> Self |
| `with_provider_arc` | apps/agentic-workflow/src/agents/review/mod.rs | function | pub | 231 | with_provider_arc(mut self, provider: Arc<dyn LLMProvider>) -> Self |
| `with_review_type` | apps/agentic-workflow/src/agents/review/mod.rs | function | pub | 236 | with_review_type(mut self, review_type: ReviewType) -> Self |
| `with_temperature` | apps/agentic-workflow/src/agents/review/mod.rs | function | pub | 251 | with_temperature(mut self, temperature: f32) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/agents/review/mod.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/review/mod.md#source
mod types;
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/review/mod.md#schema
#[derive(Debug, Clone)]
...
```yaml
changes:
  - path: apps/agentic-workflow/src/agents/review/mod.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
