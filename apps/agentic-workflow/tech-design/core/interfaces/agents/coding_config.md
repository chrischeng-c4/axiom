...
Public API manifest for `apps/agentic-workflow/src/agents/coding.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CodingAgent` | apps/agentic-workflow/src/agents/coding.rs | struct | pub | 62 |  |
| `CodingAgentBuilder` | apps/agentic-workflow/src/agents/coding.rs | struct | pub | 377 |  |
| `CodingAgentConfig` | apps/agentic-workflow/src/agents/coding.rs | struct | pub | 23 |  |
| `build` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 457 | build(self) -> NovaResult<CodingAgent> |
| `builder` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 97 | builder() -> CodingAgentBuilder |
| `create_context` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 119 | create_context(&self) -> ContextManager |
| `new` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 387 | new() -> Self |
| `registry` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 131 | registry(&self) -> &ToolRegistry |
| `run_conversation` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 108 | run_conversation(         &self,         context: &mut ContextManager,         input: &str,         handler: &dyn StreamHandler,     ) -> NovaResult<String> |
| `run_streaming` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 102 | run_streaming(&self, input: &str) -> NovaResult<String> |
| `security` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 126 | security(&self) -> &SecurityPolicy |
| `with_approval_handler` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 422 | with_approval_handler(mut self, handler: H) -> Self |
| `with_compact_model` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 452 | with_compact_model(mut self, model: impl Into<String>) -> Self |
| `with_max_context_tokens` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 442 | with_max_context_tokens(mut self, max_tokens: u32) -> Self |
| `with_max_turns` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 437 | with_max_turns(mut self, max_turns: u32) -> Self |
| `with_model` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 432 | with_model(mut self, model: impl Into<String>) -> Self |
| `with_provider` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 397 | with_provider(mut self, provider: P) -> Self |
| `with_provider_arc` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 402 | with_provider_arc(mut self, provider: Arc<dyn LLMProvider>) -> Self |
| `with_registry` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 407 | with_registry(mut self, registry: ToolRegistry) -> Self |
| `with_registry_arc` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 412 | with_registry_arc(mut self, registry: Arc<ToolRegistry>) -> Self |
| `with_security` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 417 | with_security(mut self, security: SecurityPolicy) -> Self |
| `with_system_prompt` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 427 | with_system_prompt(mut self, prompt: impl Into<String>) -> Self |
| `with_temperature` | apps/agentic-workflow/src/agents/coding.rs | function | pub | 447 | with_temperature(mut self, temperature: f32) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/agents/coding.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/coding_config.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/coding_config.md#schema.trait-impls.Default
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/coding_config.md#changes
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/agents/coding_config.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/agents/coding.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
