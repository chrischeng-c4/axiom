...
Public API manifest for `apps/agentic-workflow/src/agents/mod.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AutoApproveHandler` | apps/agentic-workflow/src/agents/mod.rs | struct | pub | 106 |  |
...
```yaml
changes:
  - path: apps/agentic-workflow/src/agents/mod.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
