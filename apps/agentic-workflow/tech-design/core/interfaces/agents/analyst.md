...
Public API manifest for `apps/agentic-workflow/src/agents/analyst.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AnalystAgent` | apps/agentic-workflow/src/agents/analyst.rs | struct | pub | 59 |  |
| `AnalystAgentBuilder` | apps/agentic-workflow/src/agents/analyst.rs | struct | pub | 78 |  |
| `AnalystAgentConfig` | apps/agentic-workflow/src/agents/analyst.rs | struct | pub | 40 |  |
| `build` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 636 | build(self) -> NovaResult<AnalystAgent> |
| `builder` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 162 | builder() -> AnalystAgentBuilder |
| `create_context` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 184 | create_context(&self) -> ContextManager |
| `is_paused` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 209 | is_paused(&self) -> bool |
| `new` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 512 | new() -> Self |
| `pending_clarification` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 215 | pending_clarification(&self) -> Option<agent::storage::PendingClarification> |
| `registry` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 288 | registry(&self) -> &ToolRegistry |
| `resume_with_response` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 225 | resume_with_response(         &self,         user_response: &str,         handler: &dyn StreamHandler,     ) -> NovaResult<String> |
| `run_conversation` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 173 | run_conversation(         &self,         context: &mut ContextManager,         input: &str,         handler: &dyn StreamHandler,     ) -> NovaResult<String> |
| `run_streaming` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 167 | run_streaming(&self, input: &str) -> NovaResult<String> |
| `save_session` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 196 | save_session(&self) -> NovaResult<()> |
| `security` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 283 | security(&self) -> &SecurityPolicy |
| `session` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 191 | session(&self) -> SessionState |
| `with_approval_handler` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 540 | with_approval_handler(mut self, handler: H) -> Self |
| `with_compact_model` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 570 | with_compact_model(mut self, model: impl Into<String>) -> Self |
| `with_github` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 594 | with_github(         mut self,         token: impl Into<String>,         owner: impl Into<String>,         repo: impl Into<String>,     ) -> NovaResult<Self> |
| `with_gitlab` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 606 | with_gitlab(         mut self,         token: impl Into<String>,         base_url: impl Into<String>,         project_id: impl Into<String>,     ) -> NovaResult<Self> |
| `with_jira` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 618 | with_jira(         mut self,         base_url: impl Into<String>,         email: impl Into<String>,         api_token: impl Into<String>,         project_key: Option<String>,     ) -> NovaResult<Self> |
| `with_max_context_tokens` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 560 | with_max_context_tokens(mut self, max_tokens: u32) -> Self |
| `with_max_turns` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 555 | with_max_turns(mut self, max_turns: u32) -> Self |
| `with_model` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 550 | with_model(mut self, model: impl Into<String>) -> Self |
| `with_provider` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 525 | with_provider(mut self, provider: P) -> Self |
| `with_provider_arc` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 530 | with_provider_arc(mut self, provider: Arc<dyn LLMProvider>) -> Self |
| `with_security` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 535 | with_security(mut self, security: SecurityPolicy) -> Self |
| `with_session_id` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 588 | with_session_id(mut self, id: impl Into<String>) -> Self |
| `with_storage` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 576 | with_storage(mut self, storage: S) -> Self |
| `with_storage_arc` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 582 | with_storage_arc(mut self, storage: Arc<dyn Storage>) -> Self |
| `with_system_prompt` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 545 | with_system_prompt(mut self, prompt: impl Into<String>) -> Self |
| `with_temperature` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 565 | with_temperature(mut self, temperature: f32) -> Self |
| `with_tool` | apps/agentic-workflow/src/agents/analyst.rs | function | pub | 631 | with_tool(self, tool: T) -> NovaResult<Self> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/agents/analyst.rs -->
```rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/agents/analyst.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
