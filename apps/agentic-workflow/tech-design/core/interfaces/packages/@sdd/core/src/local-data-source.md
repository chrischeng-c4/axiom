...
# Standardized apps/agentic-workflow/packages/@sdd/core/src/local-data-source.ts

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/core/src/local-data-source.ts` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `LocalDataSource` | apps/agentic-workflow/packages/@sdd/core/src/local-data-source.ts | class | pub | 19 |  |
## Source
<!-- type: source lang: ts -->
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/core/src/local-data-source.ts
    action: create
    section: source
    impl_mode: codegen
    description: |
