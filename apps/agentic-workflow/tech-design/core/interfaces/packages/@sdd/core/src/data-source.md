...
# Standardized apps/agentic-workflow/packages/@sdd/core/src/data-source.ts

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/core/src/data-source.ts` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SddDataSource` | apps/agentic-workflow/packages/@sdd/core/src/data-source.ts | interface | pub | 21 |  |
## Source
<!-- type: source lang: ts -->
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/core/src/data-source.ts
    action: create
    section: source
    impl_mode: codegen
    description: |
