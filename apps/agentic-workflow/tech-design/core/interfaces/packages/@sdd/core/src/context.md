...
# Standardized apps/agentic-workflow/packages/@sdd/core/src/context.ts

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/core/src/context.ts` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DataSourceContext` | apps/agentic-workflow/packages/@sdd/core/src/context.ts | constant | pub | 10 |  |
| `DataSourceProvider` | apps/agentic-workflow/packages/@sdd/core/src/context.ts | constant | pub | 12 |  |
| `useDataSource` | apps/agentic-workflow/packages/@sdd/core/src/context.ts | function | pub | 18 | useDataSource() |
## Source
<!-- type: source lang: ts -->
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/core/src/context.ts
    action: create
    section: source
    impl_mode: codegen
    description: |
