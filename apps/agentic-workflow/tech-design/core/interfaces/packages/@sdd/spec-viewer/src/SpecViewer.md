...
# Standardized apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Token` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | interface | pub | 32 |  |
| `[MermaidDiagram, setMermaidDiagram]` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 197 |  |
| `[page, setPage]` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 265 |  |
| `[showSource, setShowSource]` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 198 |  |
| `bg` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 285 |  |
| `bgCode` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 288 |  |
| `borderColor` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 289 |  |
| `escapeHtml` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | function | pub | 20 | escapeHtml(text: string) |
| `fg` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 286 |  |
| `fgMuted` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 287 |  |
| `hasOutline` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 269 |  |
| `headings` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 268 |  |
| `isDark` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 272 |  |
| `isPaginated` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 275 |  |
| `pageTokens` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 276 |  |
| `parseMarkdown` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | function | pub | 45 | parseMarkdown(src: string) |
| `parsePipeLine` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | function | pub | 162 | parsePipeLine(line: string) |
| `renderInline` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | function | pub | 175 | renderInline(text: string) |
| `sanitizeHtml` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | function | pub | 11 | sanitizeHtml(text: string) |
| `scrollTo` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 281 |  |
| `tokens` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 267 |  |
| `totalPages` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx | constant | pub | 274 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/spec-viewer/src/SpecViewer.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
