...
# Standardized apps/agentic-workflow/packages/@sdd/spec-viewer/src/CodeBlock.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/spec-viewer/src/CodeBlock.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CodeBlock` | apps/agentic-workflow/packages/@sdd/spec-viewer/src/CodeBlock.tsx | function | pub | 10 | CodeBlock({ code, language, className = '' }: CodeBlockProps) |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/spec-viewer/src/CodeBlock.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
