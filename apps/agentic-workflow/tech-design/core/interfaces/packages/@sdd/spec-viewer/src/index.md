...
# Standardized apps/agentic-workflow/packages/@sdd/spec-viewer/src/index.ts

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/spec-viewer/src/index.ts` generated from AST during Score force-regeneration standardization.
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/spec-viewer/src/index.ts
    action: create
    section: source
    impl_mode: codegen
    description: |
