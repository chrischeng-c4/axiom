---
id: projects-sdd-packages-sdd-pipeline-src-pipelinenode-tsx
...
# Standardized apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineNode.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineNode.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `STATUS_COLORS` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineNode.tsx | constant | pub | 5 |  |
| `colors` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineNode.tsx | constant | pub | 17 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineNode.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
