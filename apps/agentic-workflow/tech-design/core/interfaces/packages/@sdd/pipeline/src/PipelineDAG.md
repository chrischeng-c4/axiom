...
# Standardized apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ZOOM_THRESHOLD` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 9 |  |
| `[internalSelectedId, setInternalSelectedId]` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 28 |  |
| `[zoom, setZoom]` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 32 |  |
| `containerRef` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 31 |  |
| `cycleNodes` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 38 |  |
| `handleNodeClick` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 45 |  |
| `hasCycles` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 39 |  |
| `isLargeGraph` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 53 |  |
| `lNode` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 199 |  |
| `layout` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 42 |  |
| `midY` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 180 |  |
| `node` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 57 |  |
| `nodeMap` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 43 |  |
| `nodes` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 35 |  |
| `selectedId` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 29 |  |
| `selectedNode` | apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx | constant | pub | 51 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/pipeline/src/PipelineDAG.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
