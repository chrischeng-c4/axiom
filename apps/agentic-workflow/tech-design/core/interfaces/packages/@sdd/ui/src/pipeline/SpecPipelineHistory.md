...
# Standardized apps/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `NodeStatusIcon` | apps/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | function | pub | 14 | NodeStatusIcon({ status }: { status: StageStatus }) |
| `[MermaidDiagram, setMermaidDiagram]` | apps/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | constant | pub | 30 |  |
| `[expanded, setExpanded]` | apps/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | constant | pub | 284 |  |
| `[showSource, setShowSource]` | apps/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | constant | pub | 29 |  |
| `buckets` | apps/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | constant | pub | 247 |  |
| `handleSelectNode` | apps/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | function | pub | 334 |  |
| `hasAnyHistory` | apps/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | constant | pub | 332 |  |
| `multiModule` | apps/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | constant | pub | 248 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
