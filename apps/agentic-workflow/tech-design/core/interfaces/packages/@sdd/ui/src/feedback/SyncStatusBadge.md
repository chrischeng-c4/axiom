...
# Standardized apps/agentic-workflow/packages/@sdd/ui/src/feedback/SyncStatusBadge.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/feedback/SyncStatusBadge.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SyncStatusBadge` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/SyncStatusBadge.tsx | function | pub | 17 | SyncStatusBadge({ status, className }: SyncStatusBadgeProps) |
| `SyncStatusBadgeProps` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/SyncStatusBadge.tsx | interface | pub | 12 |  |
| `statusConfig` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/SyncStatusBadge.tsx | constant | pub | 6 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/feedback/SyncStatusBadge.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
