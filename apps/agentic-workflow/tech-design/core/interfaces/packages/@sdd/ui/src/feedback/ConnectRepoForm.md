---
id: projects-sdd-packages-sdd-ui-src-feedback-connectrepoform-tsx
...
# Standardized apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ConnectRepoFormData` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | interface | pub | 9 |  |
| `ConnectRepoFormProps` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | interface | pub | 30 |  |
| `LegacyConnectRepoFormData` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | interface | pub | 23 |  |
| `Platform` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | type | pub | 7 |  |
| `[form, setForm]` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | constant | pub | 39 |  |
| `[platform, setPlatform]` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | constant | pub | 38 |  |
| `handleSubmit` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | function | pub | 52 |  |
| `isGitHubValid` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | constant | pub | 49 |  |
| `isGitLabValid` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | constant | pub | 48 |  |
| `isValid` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | constant | pub | 50 |  |
| `platformLabel` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | constant | pub | 76 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
