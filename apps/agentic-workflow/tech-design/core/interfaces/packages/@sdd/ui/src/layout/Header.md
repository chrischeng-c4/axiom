...
# Standardized apps/agentic-workflow/packages/@sdd/ui/src/layout/Header.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/layout/Header.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `HeaderProps` | apps/agentic-workflow/packages/@sdd/ui/src/layout/Header.tsx | interface | pub | 10 |  |
| `[captured, setCaptured]` | apps/agentic-workflow/packages/@sdd/ui/src/layout/Header.tsx | constant | pub | 16 |  |
| `[capturing, setCapturing]` | apps/agentic-workflow/packages/@sdd/ui/src/layout/Header.tsx | constant | pub | 15 |  |
| `handleCapture` | apps/agentic-workflow/packages/@sdd/ui/src/layout/Header.tsx | function | pub | 18 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/layout/Header.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
