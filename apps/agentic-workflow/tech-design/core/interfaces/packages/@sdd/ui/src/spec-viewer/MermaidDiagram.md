...
# Standardized apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MermaidDiagram.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MermaidDiagram.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MermaidDiagram` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MermaidDiagram.tsx | function | pub | 10 | MermaidDiagram({ content, className = '' }: MermaidDiagramProps) |
| `MermaidDiagramProps` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MermaidDiagram.tsx | interface | pub | 5 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MermaidDiagram.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
