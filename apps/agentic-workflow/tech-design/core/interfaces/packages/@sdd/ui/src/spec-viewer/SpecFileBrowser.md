...
# Standardized apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TreeDir` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | interface | pub | 13 |  |
| `TreeFile` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | interface | pub | 14 |  |
| `TreeNode` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | type | pub | 15 |  |
| `[MermaidDiagram, setMermaidDiagram]` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | constant | pub | 121 |  |
| `[expanded, setExpanded]` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | constant | pub | 188 |  |
| `[isResizing, setIsResizing]` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | constant | pub | 164 |  |
| `[selectedId, setSelectedId]` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | constant | pub | 162 |  |
| `[showSource, setShowSource]` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | constant | pub | 120 |  |
| `[sidebarWidth, setSidebarWidth]` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | constant | pub | 163 |  |
| `baseIndent` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | constant | pub | 71 |  |
| `buildTree` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | function | pub | 17 | buildTree(specs: ProjectSpec[]) |
| `collectDirPaths` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | function | pub | 51 | collectDirPaths(nodes: TreeNode[]) |
| `isOpen` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | constant | pub | 74 |  |
| `selectedSpec` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | constant | pub | 217 |  |
| `toggleDir` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | function | pub | 206 |  |
| `tree` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx | constant | pub | 185 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/SpecFileBrowser.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
