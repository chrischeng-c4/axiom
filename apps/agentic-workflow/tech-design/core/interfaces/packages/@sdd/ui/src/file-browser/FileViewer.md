---
id: projects-sdd-packages-sdd-ui-src-file-browser-fileviewer-tsx
...
Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `EXT_TO_LANGUAGE` | apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 15 |  |
| `FileViewer` | apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | function | pub | 43 | FileViewer({ file }: FileViewerProps) |
| `FileViewerProps` | apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | interface | pub | 11 |  |
| `IMAGE_EXTENSIONS` | apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 34 |  |
| `VIDEO_EXTENSIONS` | apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 35 |  |
| `bodyRows` | apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 166 |  |
| `getExtension` | apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | function | pub | 37 | getExtension(filename: string) |
| `language` | apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 91 |  |
| `parsed` | apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 112 |  |
| `rows` | apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 120 |  |
| `rows` | apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 151 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
