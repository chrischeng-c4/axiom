...
# Standardized apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `InlineEditDescriptionProps` | apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx | interface | pub | 9 |  |
| `[draft, setDraft]` | apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx | constant | pub | 19 |  |
| `[editing, setEditing]` | apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx | constant | pub | 18 |  |
| `save` | apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx | function | pub | 29 |  |
| `textareaRef` | apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx | constant | pub | 20 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
