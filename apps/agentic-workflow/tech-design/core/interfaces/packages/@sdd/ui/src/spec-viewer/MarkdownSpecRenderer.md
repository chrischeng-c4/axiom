...
# Standardized apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Heading` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx | interface | pub | 21 |  |
| `[MermaidDiagram, setMermaidDiagram]` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx | constant | pub | 43 |  |
| `[showSource, setShowSource]` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx | constant | pub | 42 |  |
| `makeId` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx | function | pub | 33 | makeId(scope: string, text: string) |
| `parseHeadings` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx | function | pub | 23 | parseHeadings(content: string) |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
