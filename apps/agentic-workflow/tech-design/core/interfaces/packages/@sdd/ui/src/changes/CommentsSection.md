...
# Standardized apps/agentic-workflow/packages/@sdd/ui/src/changes/CommentsSection.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/changes/CommentsSection.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CommentsSectionProps` | apps/agentic-workflow/packages/@sdd/ui/src/changes/CommentsSection.tsx | interface | pub | 10 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/changes/CommentsSection.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
