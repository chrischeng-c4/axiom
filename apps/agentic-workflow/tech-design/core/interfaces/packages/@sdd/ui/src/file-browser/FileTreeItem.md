...
# Standardized apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileTreeItem.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileTreeItem.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `FileTreeItemProps` | apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileTreeItem.tsx | interface | pub | 6 |  |
| `handleClick` | apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileTreeItem.tsx | function | pub | 16 |  |
| `isFolder` | apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileTreeItem.tsx | constant | pub | 14 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/file-browser/FileTreeItem.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
