...
# Standardized apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConfirmDialog.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConfirmDialog.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ConfirmDialog` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConfirmDialog.tsx | function | pub | 22 | ConfirmDialog({   open,   title,   description,   confirmLabel = 'Confirm',   cancelLabel = 'Cancel',   variant = 'danger',   onConfirm,   onCancel, }: ConfirmDialogProps) |
| `ConfirmDialogProps` | apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConfirmDialog.tsx | interface | pub | 11 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/feedback/ConfirmDialog.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
