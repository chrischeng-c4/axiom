...
# Standardized apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditSelect.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditSelect.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `InlineEditSelect` | apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditSelect.tsx | function | pub | 13 | InlineEditSelect({   value,   options,   onSave,   displayValue, }: InlineEditSelectProps) |
| `InlineEditSelectProps` | apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditSelect.tsx | interface | pub | 6 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditSelect.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
