...
# Standardized apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditText.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditText.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `InlineEditTextProps` | apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditText.tsx | interface | pub | 6 |  |
| `[draft, setDraft]` | apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditText.tsx | constant | pub | 18 |  |
| `[editing, setEditing]` | apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditText.tsx | constant | pub | 17 |  |
| `cancel` | apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditText.tsx | function | pub | 31 |  |
| `inputRef` | apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditText.tsx | constant | pub | 19 |  |
| `save` | apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditText.tsx | function | pub | 25 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditText.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
