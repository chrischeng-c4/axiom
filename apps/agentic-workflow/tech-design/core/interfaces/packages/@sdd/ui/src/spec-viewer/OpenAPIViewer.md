...
# Standardized apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Endpoint` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | interface | pub | 24 |  |
| `HTTP_METHODS` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 11 |  |
| `HttpMethod` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | type | pub | 12 |  |
| `METHOD_COLORS` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 14 |  |
| `OpenAPIViewerProps` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | interface | pub | 7 |  |
| `[expanded, setExpanded]` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 36 |  |
| `[showSource, setShowSource]` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 139 |  |
| `endpoints` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 149 |  |
| `parameters` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 39 |  |
| `requestBody` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 40 |  |
| `responses` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 41 |  |
| `schemaToString` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | function | pub | 31 | schemaToString(schema: unknown) |
| `{ method, path, op }` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 37 |  |
| `{ parsed, error }` | apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 141 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
