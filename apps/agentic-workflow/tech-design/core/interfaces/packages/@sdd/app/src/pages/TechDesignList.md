...
# Standardized apps/agentic-workflow/packages/@sdd/app/src/pages/TechDesignList.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/app/src/pages/TechDesignList.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `[designs, setDesigns]` | apps/agentic-workflow/packages/@sdd/app/src/pages/TechDesignList.tsx | constant | pub | 10 |  |
| `[error, setError]` | apps/agentic-workflow/packages/@sdd/app/src/pages/TechDesignList.tsx | constant | pub | 12 |  |
| `[loading, setLoading]` | apps/agentic-workflow/packages/@sdd/app/src/pages/TechDesignList.tsx | constant | pub | 11 |  |
| `ds` | apps/agentic-workflow/packages/@sdd/app/src/pages/TechDesignList.tsx | constant | pub | 9 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/app/src/pages/TechDesignList.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
