...
# Standardized apps/agentic-workflow/packages/@sdd/app/src/pages/IssueList.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/app/src/pages/IssueList.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `STATUS_TABS` | apps/agentic-workflow/packages/@sdd/app/src/pages/IssueList.tsx | constant | pub | 8 |  |
| `[error, setError]` | apps/agentic-workflow/packages/@sdd/app/src/pages/IssueList.tsx | constant | pub | 25 |  |
| `[issues, setIssues]` | apps/agentic-workflow/packages/@sdd/app/src/pages/IssueList.tsx | constant | pub | 23 |  |
| `[loading, setLoading]` | apps/agentic-workflow/packages/@sdd/app/src/pages/IssueList.tsx | constant | pub | 24 |  |
| `[statusFilter, setStatusFilter]` | apps/agentic-workflow/packages/@sdd/app/src/pages/IssueList.tsx | constant | pub | 26 |  |
| `ds` | apps/agentic-workflow/packages/@sdd/app/src/pages/IssueList.tsx | constant | pub | 22 |  |
| `filtered` | apps/agentic-workflow/packages/@sdd/app/src/pages/IssueList.tsx | constant | pub | 35 |  |
| `statusBadgeClass` | apps/agentic-workflow/packages/@sdd/app/src/pages/IssueList.tsx | function | pub | 10 | statusBadgeClass(status: IssueStatus) |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/app/src/pages/IssueList.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
