...
# Standardized apps/agentic-workflow/packages/@sdd/app/src/main.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/app/src/main.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `dataSource` | apps/agentic-workflow/packages/@sdd/app/src/main.tsx | constant | pub | 14 |  |
| `port` | apps/agentic-workflow/packages/@sdd/app/src/main.tsx | constant | pub | 13 |  |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/app/src/main.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
