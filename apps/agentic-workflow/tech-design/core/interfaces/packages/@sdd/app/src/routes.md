...
# Standardized apps/agentic-workflow/packages/@sdd/app/src/routes.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/app/src/routes.tsx` generated from AST during Score force-regeneration standardization.
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/app/src/routes.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
