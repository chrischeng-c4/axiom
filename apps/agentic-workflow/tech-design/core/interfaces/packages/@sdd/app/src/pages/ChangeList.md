...
# Standardized apps/agentic-workflow/packages/@sdd/app/src/pages/ChangeList.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/app/src/pages/ChangeList.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `PHASE_LABELS` | apps/agentic-workflow/packages/@sdd/app/src/pages/ChangeList.tsx | constant | pub | 8 |  |
| `[changes, setChanges]` | apps/agentic-workflow/packages/@sdd/app/src/pages/ChangeList.tsx | constant | pub | 35 |  |
| `[error, setError]` | apps/agentic-workflow/packages/@sdd/app/src/pages/ChangeList.tsx | constant | pub | 37 |  |
| `[loading, setLoading]` | apps/agentic-workflow/packages/@sdd/app/src/pages/ChangeList.tsx | constant | pub | 36 |  |
| `ds` | apps/agentic-workflow/packages/@sdd/app/src/pages/ChangeList.tsx | constant | pub | 34 |  |
| `phaseBadgeClass` | apps/agentic-workflow/packages/@sdd/app/src/pages/ChangeList.tsx | function | pub | 20 | phaseBadgeClass(phase: ChangePhase) |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/app/src/pages/ChangeList.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
