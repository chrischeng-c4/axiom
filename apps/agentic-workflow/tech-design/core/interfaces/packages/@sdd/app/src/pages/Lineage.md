...
# Standardized apps/agentic-workflow/packages/@sdd/app/src/pages/Lineage.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/packages/@sdd/app/src/pages/Lineage.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Lineage` | apps/agentic-workflow/packages/@sdd/app/src/pages/Lineage.tsx | function | pub | 8 | Lineage() |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/packages/@sdd/app/src/pages/Lineage.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
