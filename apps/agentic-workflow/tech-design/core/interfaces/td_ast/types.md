...
Public API manifest for `apps/agentic-workflow/src/td_ast/types.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DbEntity` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 200 |  |
| `DbField` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 206 |  |
| `DbModelFrontmatter` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 218 |  |
| `DbModelIR` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 226 |  |
| `DbRelationship` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 236 |  |
| `DependencyFrontmatter` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 247 |  |
| `IREdge` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 255 |  |
| `IRFamily` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 267 |  |
| `IRNode` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 289 |  |
| `InteractionActor` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 298 |  |
| `InteractionFrontmatter` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 306 |  |
| `InteractionIR` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 314 |  |
| `InteractionMessage` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 322 |  |
| `LogicEdge` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 332 |  |
| `LogicFrontmatter` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 341 |  |
| `LogicGraphIR` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 352 |  |
| `LogicNode` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 367 |  |
| `LowerDiagnostic` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 376 |  |
| `MermaidPlusBlockTyped` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 394 |  |
| `MermaidPlusFrontmatter` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 410 |  |
| `MermaidPlusPayload` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 106 |  |
| `MindmapFrontmatter` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 434 |  |
| `MindmapNode` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 441 |  |
| `ParseDiagnostic` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 448 |  |
| `RequirementItem` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 461 |  |
| `RequirementSetIR` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 471 |  |
| `RequirementsFrontmatter` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 480 |  |
| `ScenarioItem` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 487 |  |
| `ScenarioSetIR` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 495 |  |
| `ScenariosFrontmatter` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 502 |  |
| `SectionKind` | apps/agentic-workflow/src/td_ast/types.rs | enum | pub | 132 |  |
| `SourceSpan` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 509 |  |
| `StateEdge` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 518 |  |
| `StateMachineFrontmatter` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 527 |  |
| `StateMachineIR` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 538 |  |
| `StateNode` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 550 |  |
| `TDAst` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 15 |  |
| `TDSection` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 26 |  |
| `TdParseError` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 45 |  |
| `TestItem` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 558 |  |
| `TestPlanFrontmatter` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 569 |  |
| `TestPlanIR` | apps/agentic-workflow/src/td_ast/types.rs | struct | pub | 578 |  |
| `TypedBody` | apps/agentic-workflow/src/td_ast/types.rs | enum | pub | 66 |  |
| `for_section_type` | apps/agentic-workflow/src/td_ast/types.rs | function | pub | 163 | for_section_type(st: SectionType) -> Self |
## Schema
      ...
      variants:
        ...
        - name: RustSourceUnit
          ...
          doc: |
            ...
            @spec apps/agentic-workflow/tech-design/logic/aw-td-ast-parse-rust-source-unit-sections-as-typed-td-bodies.md#logic
        - name: Markdown
          kind: tuple
...
changes:
  - path: apps/agentic-workflow/src/td_ast/mod.rs
    ...
    description: >
      ...
      consumers (R1).
  - path: apps/agentic-workflow/src/td_ast/types.rs
    action: create
    section: schema
    impl_mode: codegen
    description: >
  ...
  - path: apps/agentic-workflow/src/td_ast/entities.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/td_ast/entities.rs
    ...
    description: >
      ...
      apps/agentic-workflow/tech-design/core/interfaces/td_ast/entities.md#source,
      which regenerates the whole entities module including this dispatch impl.
  - path: apps/agentic-workflow/src/td_ast/parse.rs
    action: create
    section: logic
    impl_mode: hand-written
    description: >
...
- [changes] R10 specifies `aw td ast <path>` (a file-path argument) but the `changes` entry for `apps/agentic-workflow/src/cli/td.rs` reads "Adds aw td ast <slug> subcommand". Align the two: either update the changes description to say `<path>` to match R10, or update R10 to say `<slug>` and add a note that the handler resolves the slug to the worktree spec path before calling `parse_td`.
