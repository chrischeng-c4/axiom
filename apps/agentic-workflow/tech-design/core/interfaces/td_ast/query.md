...
Public API manifest for `apps/agentic-workflow/src/td_ast/query.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Ref` | apps/agentic-workflow/src/td_ast/query.rs | struct | pub | 46 |  |
| `RefKind` | apps/agentic-workflow/src/td_ast/query.rs | enum | pub | 32 |  |
| `TypeDef` | apps/agentic-workflow/src/td_ast/query.rs | struct | pub | 63 |  |
| `all_references_to` | apps/agentic-workflow/src/td_ast/query.rs | function | pub | 178 | all_references_to(&self, name: &str) -> Vec<Ref> |
| `find_section_by_id` | apps/agentic-workflow/src/td_ast/query.rs | function | pub | 124 | find_section_by_id(&self, id: &str) -> Option<&TDSection> |
| `find_section_by_type` | apps/agentic-workflow/src/td_ast/query.rs | function | pub | 111 | find_section_by_type(&self, section_type: SectionType) -> Option<&TDSection> |
| `resolve_type` | apps/agentic-workflow/src/td_ast/query.rs | function | pub | 142 | resolve_type(&self, name: &str) -> Option<TypeDef> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/td_ast/query.rs -->
````rust
//! Read-only navigation API over a parsed [`TDAst`].
//!
//! Implements the query surface specified in
//! `apps/agentic-workflow/tech-design/core/interfaces/td_ast/query.md`:
//!
...
//! AST.
//!
//! @spec apps/agentic-workflow/tech-design/core/interfaces/td_ast/query.md#schema
//! @spec apps/agentic-workflow/tech-design/core/interfaces/td_ast/query.md#logic
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/td_ast/query.md#source
impl TDAst {
    ...
    ///
    /// @spec apps/agentic-workflow/tech-design/core/interfaces/td_ast/query.md#logic
    /// @spec apps/agentic-workflow/tech-design/core/td_ast/payloads.md#schema
...
```yaml
changes:
  - path: apps/agentic-workflow/src/td_ast/query.rs
    action: modify
    section: source
    impl_mode: codegen
