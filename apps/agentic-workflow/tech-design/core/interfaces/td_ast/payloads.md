...
Six payload structs land in `apps/agentic-workflow/src/td_ast/payloads.rs`:
...
Public API manifest for `apps/agentic-workflow/src/td_ast/payloads.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AsyncApiChannel` | apps/agentic-workflow/src/td_ast/payloads.rs | struct | pub | 220 |  |
| `AsyncApiPayload` | apps/agentic-workflow/src/td_ast/payloads.rs | struct | pub | 88 |  |
| `CliArgDef` | apps/agentic-workflow/src/td_ast/payloads.rs | struct | pub | 250 |  |
| `CliCommandDef` | apps/agentic-workflow/src/td_ast/payloads.rs | struct | pub | 232 |  |
...
| `OpenApiPayload` | apps/agentic-workflow/src/td_ast/payloads.rs | struct | pub | 69 |  |
| `OpenRpcPayload` | apps/agentic-workflow/src/td_ast/payloads.rs | struct | pub | 47 |  |
| `PayloadTypeDef` | apps/agentic-workflow/src/td_ast/payloads.rs | struct | pub | 135 |  |
| `RpcMethod` | apps/agentic-workflow/src/td_ast/payloads.rs | struct | pub | 152 |  |
| `RpcParam` | apps/agentic-workflow/src/td_ast/payloads.rs | struct | pub | 168 |  |
| `TdParseErrorKind` | apps/agentic-workflow/src/td_ast/payloads.rs | enum | pub | 287 |  |
| `from_yaml_str` | apps/agentic-workflow/src/td_ast/payloads.rs | function | pub | 317 | from_yaml_str(s: &str) -> Result<Self, serde_yaml::Error> |
| `from_yaml_str` | apps/agentic-workflow/src/td_ast/payloads.rs | function | pub | 327 | from_yaml_str(s: &str) -> Result<Self, serde_yaml::Error> |
| `from_yaml_str` | apps/agentic-workflow/src/td_ast/payloads.rs | function | pub | 337 | from_yaml_str(s: &str) -> Result<Self, serde_yaml::Error> |
## Schema
