...
Public API manifest for `apps/agentic-workflow/src/td_ast/parse.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `parse_td` | apps/agentic-workflow/src/td_ast/parse.rs | function | pub | 59 | parse_td(path: &Path) -> Result<TDAst, TdParseError> |
| `parse_td_str` | apps/agentic-workflow/src/td_ast/parse.rs | function | pub | 77 | parse_td_str(raw: &str) -> Result<TDAst, TdParseError> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/td_ast/parse.rs -->
~~~rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/interfaces/td_ast/parse.md#source
// CODEGEN-BEGIN
...
changes:
  - path: apps/agentic-workflow/src/td_ast/parse.rs
    ...
    impl_mode: codegen
    description: >
      Promote the TD AST parser implementation into a source template while
      preserving the existing typed-payload dispatch, content hashing, and
      parser tests.
```
