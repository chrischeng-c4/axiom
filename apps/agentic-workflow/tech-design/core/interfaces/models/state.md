...
Public API manifest for `apps/agentic-workflow/src/models/state.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ChecksumEntry` | apps/agentic-workflow/src/models/state.rs | struct | pub | 172 |  |
| `DagIssue` | apps/agentic-workflow/src/models/state.rs | struct | pub | 149 |  |
| `DagState` | apps/agentic-workflow/src/models/state.rs | struct | pub | 134 |  |
| `DelegationGuard` | apps/agentic-workflow/src/models/state.rs | struct | pub | 59 |  |
| `LlmCall` | apps/agentic-workflow/src/models/state.rs | struct | pub | 253 |  |
| `State` | apps/agentic-workflow/src/models/state.rs | struct | pub | 73 |  |
| `StatePhase` | apps/agentic-workflow/src/models/state.rs | enum | pub | 24 |  |
| `Telemetry` | apps/agentic-workflow/src/models/state.rs | struct | pub | 235 |  |
| `ValidationEntry` | apps/agentic-workflow/src/models/state.rs | struct | pub | 183 |  |
| `ValidationMode` | apps/agentic-workflow/src/models/state.rs | enum | pub | 48 |  |
| `ValidationResult` | apps/agentic-workflow/src/models/state.rs | struct | pub | 212 |  |
| `is_terminal` | apps/agentic-workflow/src/models/state.rs | function | pub | 331 | is_terminal(&self) -> bool |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/models/state.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/state.md#source
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/state.md#schema
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum StatePhase {
    ChangeInited,
    ChangeSpecCreated,
...
```yaml
changes:
  - path: apps/agentic-workflow/src/models/state.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
