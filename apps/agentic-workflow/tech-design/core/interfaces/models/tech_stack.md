...
Tech stack inference types for the `sdd` crate, located in `apps/agentic-workflow/src/models/tech_stack.rs`:
...
description: |
  ...
  apps/agentic-workflow/src/models/tech_stack.rs. Defines project tech stack
