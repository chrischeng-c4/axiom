...
Public API manifest for `apps/agentic-workflow/src/models/archive_review.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ArchiveIssueCategory` | apps/agentic-workflow/src/models/archive_review.rs | enum | pub | 56 |  |
| `ArchiveReview` | apps/agentic-workflow/src/models/archive_review.rs | struct | pub | 127 |  |
| `ArchiveReviewIssue` | apps/agentic-workflow/src/models/archive_review.rs | struct | pub | 95 |  |
| `ArchiveReviewVerdict` | apps/agentic-workflow/src/models/archive_review.rs | enum | pub | 15 |  |
| `blocks_archive` | apps/agentic-workflow/src/models/archive_review.rs | function | pub | 174 | blocks_archive(&self) -> bool |
| `count_by_severity` | apps/agentic-workflow/src/models/archive_review.rs | function | pub | 182 | count_by_severity(&self, severity: IssueSeverity) -> usize |
| `emoji` | apps/agentic-workflow/src/models/archive_review.rs | function | pub | 43 | emoji(&self) -> &'static str |
| `format` | apps/agentic-workflow/src/models/archive_review.rs | function | pub | 155 | format(&self) -> String |
| `format_summary` | apps/agentic-workflow/src/models/archive_review.rs | function | pub | 190 | format_summary(&self) -> String |
| `name` | apps/agentic-workflow/src/models/archive_review.rs | function | pub | 33 | name(&self) -> &'static str |
| `name` | apps/agentic-workflow/src/models/archive_review.rs | function | pub | 80 | name(&self) -> &'static str |
| `new` | apps/agentic-workflow/src/models/archive_review.rs | function | pub | 109 | new(         severity: IssueSeverity,         category: ArchiveIssueCategory,         spec_file: impl Into<String>,         description: impl Into<String>,     ) -> Self |
| `new` | apps/agentic-workflow/src/models/archive_review.rs | function | pub | 139 | new(         verdict: ArchiveReviewVerdict,         issues: Vec<ArchiveReviewIssue>,         summary: impl Into<String>,     ) -> Self |
| `passed` | apps/agentic-workflow/src/models/archive_review.rs | function | pub | 169 | passed(&self) -> bool |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/models/archive_review.rs -->
```rust
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/archive_review.md#source
...
/// Rejected: major issues, requires manual intervention.
/// Unknown: could not parse verdict.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/archive_review.md#schema
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/archive_review.md#schema.impls
...
```yaml
changes:
  - path: apps/agentic-workflow/src/models/archive_review.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
