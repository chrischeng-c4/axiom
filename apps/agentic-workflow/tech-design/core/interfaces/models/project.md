...
Project and workspace data model for `apps/agentic-workflow/src/models/project.rs` — the canonical
  ...
  Project:
    ...
    properties:
      ...
      path:
        type: string
        x-rust-type: PathBuf
        description: "Path relative to repo root (e.g. `apps/agentic-workflow`, `projects/conductor`)."
      tech_design_dir:
        type: string
  ...
  Workspace:
    ...
    properties:
      ...
      paths:
        ...
        items:
          type: string
        description: "Glob path patterns relative to repo root (e.g. `[\"apps/agentic-workflow/**\"]`)."
      target:
        type: string
