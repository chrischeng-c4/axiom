...
Public API manifest for `apps/agentic-workflow/src/models/verification.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Task` | apps/agentic-workflow/src/models/verification.rs | struct | pub | 123 |  |
| `TaskStatus` | apps/agentic-workflow/src/models/verification.rs | enum | pub | 56 |  |
| `TestResult` | apps/agentic-workflow/src/models/verification.rs | struct | pub | 83 |  |
| `TestStatus` | apps/agentic-workflow/src/models/verification.rs | enum | pub | 12 |  |
| `Verification` | apps/agentic-workflow/src/models/verification.rs | struct | pub | 151 |  |
| `VerificationCoverage` | apps/agentic-workflow/src/models/verification.rs | struct | pub | 135 |  |
| `all_passed` | apps/agentic-workflow/src/models/verification.rs | function | pub | 215 | all_passed(&self) -> bool |
| `completion_percentage` | apps/agentic-workflow/src/models/verification.rs | function | pub | 220 | completion_percentage(&self) -> u8 |
| `emoji` | apps/agentic-workflow/src/models/verification.rs | function | pub | 30 | emoji(&self) -> &'static str |
| `emoji` | apps/agentic-workflow/src/models/verification.rs | function | pub | 71 | emoji(&self) -> &'static str |
| `from_markdown` | apps/agentic-workflow/src/models/verification.rs | function | pub | 189 | from_markdown(s: &str) -> Self |
| `name` | apps/agentic-workflow/src/models/verification.rs | function | pub | 40 | name(&self) -> &'static str |
| `new` | apps/agentic-workflow/src/models/verification.rs | function | pub | 103 | new(         name: impl Into<String>,         status: TestStatus,         requirement: impl Into<String>,         scenario: impl Into<String>,     ) -> Self |
| `new` | apps/agentic-workflow/src/models/verification.rs | function | pub | 169 | new(change_id: impl Into<String>) -> Self |
| `pass_rate` | apps/agentic-workflow/src/models/verification.rs | function | pub | 202 | pass_rate(&self) -> f64 |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/models/verification.rs -->
```rust
...
/// Skip: test was skipped.
/// Pending: test has not yet run.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/verification.md#schema
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
pub enum TestStatus {
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/verification.md#schema.impls
impl TestStatus {
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/verification.md#source
impl TaskStatus {
...
```yaml
changes:
  - path: apps/agentic-workflow/src/models/verification.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
