...
Public API manifest for `apps/agentic-workflow/src/models/frontmatter.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DesignElements` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 275 |  |
| `DiagramElementInfo` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 264 |  |
| `HistoryEntry` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 107 |  |
| `IssueBlock` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 442 |  |
| `IssueLocation` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 428 |  |
| `IssueSeverity` | apps/agentic-workflow/src/models/frontmatter.rs | enum | pub | 95 |  |
| `LayerBreakdown` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 178 |  |
| `LayerInfo` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 167 |  |
| `MainSpecFrontmatter` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 125 |  |
| `MergeStrategy` | apps/agentic-workflow/src/models/frontmatter.rs | enum | pub | 22 |  |
| `PriorityBreakdown` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 249 |  |
| `RequirementBlock` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 409 |  |
| `RequirementPriority` | apps/agentic-workflow/src/models/frontmatter.rs | enum | pub | 68 |  |
| `RequirementStatus` | apps/agentic-workflow/src/models/frontmatter.rs | enum | pub | 81 |  |
| `RequirementsSummary` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 235 |  |
| `SpecFileChange` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 302 |  |
| `SpecFrontmatter` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 319 |  |
| `SpecReference` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 225 |  |
| `TaskAction` | apps/agentic-workflow/src/models/frontmatter.rs | enum | pub | 37 |  |
| `TaskBlock` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 385 |  |
| `TaskStatus` | apps/agentic-workflow/src/models/frontmatter.rs | enum | pub | 52 |  |
| `TasksFrontmatter` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 196 |  |
| `TasksSummary` | apps/agentic-workflow/src/models/frontmatter.rs | struct | pub | 147 |  |
| `new` | apps/agentic-workflow/src/models/frontmatter.rs | function | pub | 462 | new(agent: &str, tool: &str, action: &str, duration_secs: Option<f64>) -> Self |
| `to_yaml` | apps/agentic-workflow/src/models/frontmatter.rs | function | pub | 472 | to_yaml(&self) -> String |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/models/frontmatter.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/frontmatter.md#schema
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/frontmatter.md#source
impl HistoryEntry {
