...
Public API manifest for `apps/agentic-workflow/src/models/challenge.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Challenge` | apps/agentic-workflow/src/models/challenge.rs | struct | pub | 138 |  |
| `ChallengeImpact` | apps/agentic-workflow/src/models/challenge.rs | struct | pub | 124 |  |
| `ChallengeIssue` | apps/agentic-workflow/src/models/challenge.rs | struct | pub | 84 |  |
| `ChallengeVerdict` | apps/agentic-workflow/src/models/challenge.rs | enum | pub | 12 |  |
| `IssueSeverity` | apps/agentic-workflow/src/models/challenge.rs | enum | pub | 48 |  |
| `count_by_severity` | apps/agentic-workflow/src/models/challenge.rs | function | pub | 172 | count_by_severity(&self) -> (usize, usize, usize) |
| `emoji` | apps/agentic-workflow/src/models/challenge.rs | function | pub | 63 | emoji(&self) -> &'static str |
| `has_critical_issues` | apps/agentic-workflow/src/models/challenge.rs | function | pub | 192 | has_critical_issues(&self) -> bool |
| `is_approved` | apps/agentic-workflow/src/models/challenge.rs | function | pub | 30 | is_approved(&self) -> bool |
| `is_rejected` | apps/agentic-workflow/src/models/challenge.rs | function | pub | 40 | is_rejected(&self) -> bool |
| `name` | apps/agentic-workflow/src/models/challenge.rs | function | pub | 72 | name(&self) -> &'static str |
| `needs_revision` | apps/agentic-workflow/src/models/challenge.rs | function | pub | 35 | needs_revision(&self) -> bool |
| `new` | apps/agentic-workflow/src/models/challenge.rs | function | pub | 103 | new(         title: impl Into<String>,         severity: IssueSeverity,         location: impl Into<String>,         description: impl Into<String>,         suggestion: impl Into<String>,     ) -> Self |
| `new` | apps/agentic-workflow/src/models/challenge.rs | function | pub | 155 | new(change_id: impl Into<String>) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/models/challenge.rs -->
```rust
...
/// Rejected: proposal is rejected due to fundamental problems.
/// Unknown: verdict could not be determined (parsing error or not filled).
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/challenge.md#schema
#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/challenge.md#schema.impls
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/challenge.md#source
impl Challenge {
