...
Public API manifest for `apps/agentic-workflow/src/models/scenario.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Scenario` | apps/agentic-workflow/src/models/scenario.rs | struct | pub | 8 |  |
| `new` | apps/agentic-workflow/src/models/scenario.rs | function | pub | 22 | new(name: impl Into<String>) -> Self |
| `validate` | apps/agentic-workflow/src/models/scenario.rs | function | pub | 53 | validate(&self) -> Result<(), String> |
| `with_and` | apps/agentic-workflow/src/models/scenario.rs | function | pub | 44 | with_and(mut self, clause: impl Into<String>) -> Self |
| `with_then` | apps/agentic-workflow/src/models/scenario.rs | function | pub | 38 | with_then(mut self, clause: impl Into<String>) -> Self |
| `with_when` | apps/agentic-workflow/src/models/scenario.rs | function | pub | 32 | with_when(mut self, clause: impl Into<String>) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/models/scenario.rs -->
```rust
