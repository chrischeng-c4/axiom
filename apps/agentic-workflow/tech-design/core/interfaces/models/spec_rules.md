...
Public API manifest for `apps/agentic-workflow/src/models/spec_rules.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ApiSpecType` | apps/agentic-workflow/src/models/spec_rules.rs | enum | pub | 82 |  |
| `DiagramType` | apps/agentic-workflow/src/models/spec_rules.rs | enum | pub | 52 |  |
| `DocumentType` | apps/agentic-workflow/src/models/spec_rules.rs | enum | pub | 149 |  |
| `ScenarioFormat` | apps/agentic-workflow/src/models/spec_rules.rs | enum | pub | 139 |  |
| `SectionEntry` | apps/agentic-workflow/src/models/spec_rules.rs | enum | pub | 162 |  |
| `SectionType` | apps/agentic-workflow/src/models/spec_rules.rs | enum | pub | 21 |  |
| `SpecFormatRules` | apps/agentic-workflow/src/models/spec_rules.rs | struct | pub | 175 |  |
| `SpecType` | apps/agentic-workflow/src/models/spec_rules.rs | enum | pub | 109 |  |
| `all_in_fill_order` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 318 | all_in_fill_order() -> Vec<SectionType> |
| `apply_section_optionality` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 481 | apply_section_optionality(     sections: Vec<SectionType>,     design_system: Option<&DesignSystem>, ) -> Vec<SectionEntry> |
| `as_str` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 287 | as_str(&self) -> &'static str |
| `as_str` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 525 | as_str(&self) -> &str |
| `as_str` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 541 | as_str(&self) -> &str |
| `as_str` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 613 | as_str(&self) -> &str |
| `default_lang` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 252 | default_lang(&self) -> &'static str |
| `fill_order` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 204 | fill_order(&self) -> u8 |
| `for_document_type` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 703 | for_document_type(doc_type: DocumentType) -> Self |
| `from_fill_section_string` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 444 | from_fill_section_string(s: &str) -> Result<Self, String> |
| `is_optional` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 408 | is_optional(&self) -> bool |
| `optional` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 421 | optional(section_type: SectionType) -> Self |
| `parse_fill_section_str` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 514 | parse_fill_section_str(s: &str) -> (&str, bool) |
| `prd_defaults` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 650 | prd_defaults() -> Self |
| `required` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 416 | required(section_type: SectionType) -> Self |
| `required_api_spec` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 600 | required_api_spec(&self) -> Option<ApiSpecType> |
| `required_diagrams` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 572 | required_diagrams(&self) -> Vec<DiagramType> |
| `required_diagrams_as_strings` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 586 | required_diagrams_as_strings(&self) -> Vec<&'static str> |
| `scenario_regex_pattern` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 712 | scenario_regex_pattern(&self) -> String |
| `section_type` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 400 | section_type(&self) -> SectionType |
| `spec_defaults` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 671 | spec_defaults() -> Self |
| `task_defaults` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 687 | task_defaults() -> Self |
| `to_fill_section_string` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 432 | to_fill_section_string(&self) -> String |
| `to_markdown_skeleton` | apps/agentic-workflow/src/models/spec_rules.rs | function | pub | 739 | to_markdown_skeleton(&self) -> String |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/models/spec_rules.rs -->
~~~rust
