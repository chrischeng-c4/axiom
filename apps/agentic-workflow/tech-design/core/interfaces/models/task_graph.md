...
Public API manifest for `apps/agentic-workflow/src/models/task_graph.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Layer` | apps/agentic-workflow/src/models/task_graph.rs | struct | pub | 28 |  |
| `SpecGroup` | apps/agentic-workflow/src/models/task_graph.rs | struct | pub | 40 |  |
| `TaskGraph` | apps/agentic-workflow/src/models/task_graph.rs | struct | pub | 18 |  |
| `TaskRef` | apps/agentic-workflow/src/models/task_graph.rs | struct | pub | 54 |  |
| `can_execute_spec` | apps/agentic-workflow/src/models/task_graph.rs | function | pub | 484 | can_execute_spec(&self, spec_id: &str, completed: &HashSet<String>) -> bool |
| `from_tasks_file` | apps/agentic-workflow/src/models/task_graph.rs | function | pub | 68 | from_tasks_file(tasks_path: &Path) -> Result<Self> |
| `get_execution_order` | apps/agentic-workflow/src/models/task_graph.rs | function | pub | 430 | get_execution_order(&self) -> Vec<&SpecGroup> |
| `get_tasks_for_spec` | apps/agentic-workflow/src/models/task_graph.rs | function | pub | 472 | get_tasks_for_spec(&self, spec_id: &str) -> Vec<&TaskRef> |
| `validate_dependencies` | apps/agentic-workflow/src/models/task_graph.rs | function | pub | 496 | validate_dependencies(&self) -> Result<()> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/models/task_graph.rs -->
````rust
