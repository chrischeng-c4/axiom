...
Public API manifest for `apps/agentic-workflow/src/models/annotation.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Annotation` | apps/agentic-workflow/src/models/annotation.rs | struct | pub | 20 |  |
| `AnnotationError` | apps/agentic-workflow/src/models/annotation.rs | enum | pub | 100 |  |
| `AnnotationResult` | apps/agentic-workflow/src/models/annotation.rs | type | pub | 95 |  |
| `AnnotationStore` | apps/agentic-workflow/src/models/annotation.rs | struct | pub | 41 |  |
| `add` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 191 | add(&mut self, annotation: Annotation) |
| `find` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 196 | find(&self, id: &str) -> Option<&Annotation> |
| `find_mut` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 201 | find_mut(&mut self, id: &str) -> Option<&mut Annotation> |
| `for_file` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 206 | for_file(&self, file: &str) -> Vec<&Annotation> |
| `for_section` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 211 | for_section(&self, file: &str, section_id: &str) -> Vec<&Annotation> |
| `get_author_name` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 260 | get_author_name() -> String |
| `is_empty` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 243 | is_empty(&self) -> bool |
| `len` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 238 | len(&self) -> usize |
| `load` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 131 | load(path: &Path, change_id: &str) -> AnnotationResult<Self> |
| `new` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 51 | new(         file: impl Into<String>,         section_id: impl Into<String>,         content: impl Into<String>,         author: impl Into<String>,     ) -> Self |
| `new` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 120 | new(change_id: impl Into<String>) -> Self |
| `remove` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 228 | remove(&mut self, id: &str) -> AnnotationResult<Annotation> |
| `resolve` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 88 | resolve(&mut self) |
| `resolve` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 219 | resolve(&mut self, id: &str) -> AnnotationResult<()> |
| `save` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 162 | save(&self, path: &Path) -> AnnotationResult<()> |
| `unresolved_count` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 248 | unresolved_count(&self) -> usize |
| `with_timestamp` | apps/agentic-workflow/src/models/annotation.rs | function | pub | 69 | with_timestamp(         file: impl Into<String>,         section_id: impl Into<String>,         content: impl Into<String>,         author: impl Into<String>,         created_at: DateTime<Utc>,     ) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/models/annotation.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/annotation.md#source
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/annotation.md#schema
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
