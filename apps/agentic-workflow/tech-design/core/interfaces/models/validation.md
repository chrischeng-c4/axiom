...
Public API manifest for `apps/agentic-workflow/src/models/validation.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DocumentType` | apps/agentic-workflow/src/models/validation.rs | enum | pub | 11 |  |
| `ErrorCategory` | apps/agentic-workflow/src/models/validation.rs | enum | pub | 35 |  |
| `JsonValidationError` | apps/agentic-workflow/src/models/validation.rs | struct | pub | 166 |  |
| `Severity` | apps/agentic-workflow/src/models/validation.rs | enum | pub | 23 |  |
| `SeverityMap` | apps/agentic-workflow/src/models/validation.rs | struct | pub | 99 |  |
| `ValidationCounts` | apps/agentic-workflow/src/models/validation.rs | struct | pub | 154 |  |
| `ValidationError` | apps/agentic-workflow/src/models/validation.rs | struct | pub | 61 |  |
| `ValidationJsonOutput` | apps/agentic-workflow/src/models/validation.rs | struct | pub | 139 |  |
| `ValidationOptions` | apps/agentic-workflow/src/models/validation.rs | struct | pub | 125 |  |
| `ValidationResult` | apps/agentic-workflow/src/models/validation.rs | struct | pub | 117 |  |
| `ValidationRules` | apps/agentic-workflow/src/models/validation.rs | struct | pub | 77 |  |
| `count_by_severity` | apps/agentic-workflow/src/models/validation.rs | function | pub | 462 | count_by_severity(&self, severity: Severity) -> usize |
| `for_document_type` | apps/agentic-workflow/src/models/validation.rs | function | pub | 372 | for_document_type(doc_type: DocumentType) -> Self |
| `for_prd` | apps/agentic-workflow/src/models/validation.rs | function | pub | 303 | for_prd() -> Self |
| `for_spec` | apps/agentic-workflow/src/models/validation.rs | function | pub | 346 | for_spec() -> Self |
| `for_task` | apps/agentic-workflow/src/models/validation.rs | function | pub | 321 | for_task() -> Self |
| `format` | apps/agentic-workflow/src/models/validation.rs | function | pub | 239 | format(&self) -> String |
| `format_errors` | apps/agentic-workflow/src/models/validation.rs | function | pub | 478 | format_errors(&self) -> String |
| `from_path` | apps/agentic-workflow/src/models/validation.rs | function | pub | 184 | from_path(path: &std::path::Path) -> Self |
| `get` | apps/agentic-workflow/src/models/validation.rs | function | pub | 428 | get(&self, category: ErrorCategory) -> Severity |
| `has_errors` | apps/agentic-workflow/src/models/validation.rs | function | pub | 457 | has_errors(&self) -> bool |
| `high_severity_errors` | apps/agentic-workflow/src/models/validation.rs | function | pub | 470 | high_severity_errors(&self) -> Vec<&ValidationError> |
| `is_fixable` | apps/agentic-workflow/src/models/validation.rs | function | pub | 265 | is_fixable(&self) -> bool |
| `is_valid` | apps/agentic-workflow/src/models/validation.rs | function | pub | 452 | is_valid(&self) -> bool |
| `name` | apps/agentic-workflow/src/models/validation.rs | function | pub | 210 | name(&self) -> &'static str |
| `name` | apps/agentic-workflow/src/models/validation.rs | function | pub | 275 | name(&self) -> &'static str |
| `new` | apps/agentic-workflow/src/models/validation.rs | function | pub | 222 | new(         message: impl Into<String>,         file: impl Into<PathBuf>,         line: Option<usize>,         severity: Severity,         category: ErrorCategory,     ) -> Self |
| `new` | apps/agentic-workflow/src/models/validation.rs | function | pub | 447 | new(errors: Vec<ValidationError>) -> Self |
| `new` | apps/agentic-workflow/src/models/validation.rs | function | pub | 490 | new() -> Self |
| `symbol` | apps/agentic-workflow/src/models/validation.rs | function | pub | 201 | symbol(&self) -> &'static str |
| `with_fix` | apps/agentic-workflow/src/models/validation.rs | function | pub | 513 | with_fix(mut self, fix: bool) -> Self |
| `with_json` | apps/agentic-workflow/src/models/validation.rs | function | pub | 507 | with_json(mut self, json: bool) -> Self |
| `with_strict` | apps/agentic-workflow/src/models/validation.rs | function | pub | 495 | with_strict(mut self, strict: bool) -> Self |
| `with_verbose` | apps/agentic-workflow/src/models/validation.rs | function | pub | 501 | with_verbose(mut self, verbose: bool) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/models/validation.rs -->
```rust
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/validation.md#source
use std::path::PathBuf;

use serde::{Deserialize, Serialize};

/// Document type for type-specific validation.
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/validation.md#schema
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
...
```yaml
changes:
  - path: apps/agentic-workflow/src/models/validation.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
