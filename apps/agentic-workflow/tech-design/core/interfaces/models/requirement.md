...
Public API manifest for `apps/agentic-workflow/src/models/requirement.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Requirement` | apps/agentic-workflow/src/models/requirement.rs | struct | pub | 10 |  |
| `RequirementDelta` | apps/agentic-workflow/src/models/requirement.rs | enum | pub | 42 |  |
| `added` | apps/agentic-workflow/src/models/requirement.rs | function | pub | 60 | added(self, req: Requirement) -> Self |
| `modified` | apps/agentic-workflow/src/models/requirement.rs | function | pub | 65 | modified(self, req: Requirement) -> Self |
| `new` | apps/agentic-workflow/src/models/requirement.rs | function | pub | 22 | new(name: impl Into<String>, description: impl Into<String>) -> Self |
| `removed` | apps/agentic-workflow/src/models/requirement.rs | function | pub | 70 | removed(self, name: impl Into<String>, reason: impl Into<String>) -> Self |
| `renamed` | apps/agentic-workflow/src/models/requirement.rs | function | pub | 79 | renamed(self, from: impl Into<String>, to: impl Into<String>) -> Self |
| `validate` | apps/agentic-workflow/src/models/requirement.rs | function | pub | 90 | validate(&self) -> Result<(), String> |
| `with_scenario` | apps/agentic-workflow/src/models/requirement.rs | function | pub | 31 | with_scenario(mut self, scenario: Scenario) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/models/requirement.rs -->
```rust
use super::Scenario;
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/requirement.md#schema
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/requirement.md#schema.impls
impl Requirement {
...
/// @spec apps/agentic-workflow/tech-design/core/interfaces/models/requirement.md#source
impl Requirement {
