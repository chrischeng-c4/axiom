...
Public API manifest for `apps/agentic-workflow/src/ui/viewer/mod.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `start_viewer` | apps/agentic-workflow/src/ui/viewer/mod.rs | function | pub | 30 | start_viewer(change_id: &str, project_root: &StdPath) -> anyhow::Result<ReviewResult> |
## Schema
...
```yaml
changes:
  - path: apps/agentic-workflow/src/ui/viewer/mod.rs
    action: modify
    section: schema
    impl_mode: codegen
    replaces:
