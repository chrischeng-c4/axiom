...
# Standardized apps/agentic-workflow/src/ui/viewer/render.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/ui/viewer/render.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `render_markdown_to_html` | apps/agentic-workflow/src/ui/viewer/render.rs | function | pub | 295 | render_markdown_to_html(markdown: &str) -> String |
| `render_not_found_html` | apps/agentic-workflow/src/ui/viewer/render.rs | function | pub | 476 | render_not_found_html(filename: &str) -> String |
| `render_yaml_to_html` | apps/agentic-workflow/src/ui/viewer/render.rs | function | pub | 457 | render_yaml_to_html(yaml: &str) -> String |
| `slugify` | apps/agentic-workflow/src/ui/viewer/render.rs | function | pub | 265 | slugify(text: &str) -> String |
| `wrap_in_document` | apps/agentic-workflow/src/ui/viewer/render.rs | function | pub | 489 | wrap_in_document(content: &str, title: &str) -> String |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/ui/viewer/render.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
