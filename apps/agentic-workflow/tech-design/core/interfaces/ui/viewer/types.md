...
Public API manifest for `apps/agentic-workflow/src/ui/viewer/manager.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ViewerManager` | apps/agentic-workflow/src/ui/viewer/manager.rs | struct | pub | 5 |  |
| `annotations_path` | apps/agentic-workflow/src/ui/viewer/manager.rs | function | pub | 104 | annotations_path(&self) -> &Path |
| `change_dir` | apps/agentic-workflow/src/ui/viewer/manager.rs | function | pub | 46 | change_dir(&self) -> &Path |
| `change_exists` | apps/agentic-workflow/src/ui/viewer/manager.rs | function | pub | 41 | change_exists(&self) -> bool |
| `generate_project_tree` | apps/agentic-workflow/src/ui/viewer/manager.rs | function | pub | 174 | generate_project_tree(&self) -> Result<FileNode, ViewerError> |
| `list_files` | apps/agentic-workflow/src/ui/viewer/manager.rs | function | pub | 134 | list_files(&self) -> Vec<FileInfo> |
| `load_annotations` | apps/agentic-workflow/src/ui/viewer/manager.rs | function | pub | 94 | load_annotations(&self) -> AnnotationResult<AnnotationStore> |
| `load_file` | apps/agentic-workflow/src/ui/viewer/manager.rs | function | pub | 54 | load_file(&self, filename: &str) -> Result<FileLoadResponse, ViewerError> |
| `new` | apps/agentic-workflow/src/ui/viewer/manager.rs | function | pub | 17 | new(change_id: &str, project_root: &Path) -> Self |
| `new_project_manager` | apps/agentic-workflow/src/ui/viewer/manager.rs | function | pub | 29 | new_project_manager(project_root: &Path) -> Self |
| `save_annotations` | apps/agentic-workflow/src/ui/viewer/manager.rs | function | pub | 99 | save_annotations(&self, store: &AnnotationStore) -> AnnotationResult<()> |
| `update_phase` | apps/agentic-workflow/src/ui/viewer/manager.rs | function | pub | 285 | update_phase(&self, new_phase: &str) -> Result<(), ViewerError> |
## Schema
