...
# Standardized apps/agentic-workflow/src/ui/viewer/assets/app.js

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/ui/viewer/assets/app.js` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `apiGet` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 46 | apiGet(endpoint) |
| `apiPost` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 62 | apiPost(endpoint, data = {}) |
| `closeAnnotationModal` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 394 | closeAnnotationModal() |
| `config` | apps/agentic-workflow/src/ui/viewer/assets/app.js | constant | pub | 27 |  |
| `escapeHtml` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 296 | escapeHtml(text) |
| `extractHeadings` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 192 | extractHeadings() |
| `formatDate` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 302 | formatDate(isoString) |
| `init` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 548 | init() |
| `initFileNav` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 102 | initFileNav() |
| `initHeadingClickHandlers` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 339 | initHeadingClickHandlers() |
| `initHighlight` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 229 | initHighlight() |
| `initKaTeX` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 237 | initKaTeX() |
| `initMermaid` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 209 | initMermaid() |
| `initModal` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 431 | initModal() |
| `initReviewActions` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 476 | initReviewActions() |
| `initTableSort` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 256 | initTableSort() |
| `loadConfig` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 14 | loadConfig() |
| `loadFile` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 137 | loadFile(filename) |
| `openAnnotationModal` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 377 | openAnnotationModal(sectionId, sectionText) |
| `renderAnnotations` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 269 | renderAnnotations() |
| `resolveAnnotation` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 311 | resolveAnnotation(id) |
| `saveAnnotation` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 399 | saveAnnotation() |
| `showToast` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 86 | showToast(message, type = 'info') |
| `state` | apps/agentic-workflow/src/ui/viewer/assets/app.js | constant | pub | 30 |  |
| `updateCommentCount` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 468 | updateCommentCount() |
| `updateContent` | apps/agentic-workflow/src/ui/viewer/assets/app.js | function | pub | 166 | updateContent(html, annotations) |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/ui/viewer/assets/app.js
    action: modify
    section: source
    impl_mode: codegen
    description: |
