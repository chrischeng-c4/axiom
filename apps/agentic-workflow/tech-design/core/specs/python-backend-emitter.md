...
schemas:
  ...
  - name: PackageLayout
    description: |
      ...
      Mirrors the conventions in `apps/agentic-workflow/examples/fixture_platform/backend/`.
    fields:
      - name: rules
...
changes:
  - path: apps/agentic-workflow/src/generate/gen/python/mod.rs
    action: create
    section: logic
  ...
  - path: apps/agentic-workflow/src/generate/gen/python/types.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/python/router.rs
    action: create
    section: logic
  ...
  - path: apps/agentic-workflow/src/generate/gen/python/pydantic_model.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/python/db_model.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/python/service.rs
    action: create
    section: logic
  ...
  - path: apps/agentic-workflow/src/generate/gen/python/dependency.rs
    action: create
    section: logic
  ...
  - path: apps/agentic-workflow/src/generate/gen/python/config.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/python/test.rs
    action: create
    section: test-plan
  ...
  - path: apps/agentic-workflow/src/generate/gen/python/determinism.rs
    action: create
    section: logic
