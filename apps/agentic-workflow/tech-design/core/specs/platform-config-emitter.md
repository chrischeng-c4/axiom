...
changes:
  - path: apps/agentic-workflow/src/generate/gen/platform_config/mod.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/platform_config/types.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/platform_config/secret_validator.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/platform_config/package_manifest.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/platform_config/dockerfile.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/platform_config/gitlab_ci.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/platform_config/kustomize.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/platform_config/workspace_meta.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/platform_config/determinism.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/platform_config/codegen_marker.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/tests/platform_config_emitter.rs
    action: create
    section: test-plan
