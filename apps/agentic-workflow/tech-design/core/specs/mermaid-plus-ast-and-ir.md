...
tests:
  T1:
    ...
    file: apps/agentic-workflow/src/td_ast/mermaid_plus.rs
    verifies: [R1]
  T2:
    type: test
  ...
  T9:
    ...
    file: apps/agentic-workflow/src/td_ast/ir.rs
    verifies: [R2]
  T10:
    type: test
  ...
  T17:
    ...
    file: apps/agentic-workflow/src/validate/rules/mermaid_plus.rs
    verifies: [R3]
  T18:
    type: test
    name: from_td_ast_routes_ir_into_state_plus_generator
    file: apps/agentic-workflow/src/generate/from_td_ast.rs
    verifies: [R4]
  T19:
    type: test
...
```yaml
changes:
  - path: apps/agentic-workflow/src/td_ast/mermaid_plus.rs
  ...
  - path: apps/agentic-workflow/src/td_ast/ir.rs
  ...
  - path: apps/agentic-workflow/src/td_ast/parse.rs
    ...
    description: |
      ...
      markers.
  - path: apps/agentic-workflow/src/validate/rules/mermaid_plus.rs
    ...
    description: |
      ...
      both in `apps/agentic-workflow/src/validate/rules/mod.rs::all_rules()`.
  ...
  - path: apps/agentic-workflow/src/generate/diagrams/state_plus/generator.rs
  ...
  - path: apps/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs
  ...
  - path: apps/agentic-workflow/src/generate/diagrams/sequence_plus/generator.rs
    ...
    description: |
      ...
      markers.
  - path: apps/agentic-workflow/src/generate/diagrams/erd_plus/generator.rs
  ...
  - path: apps/agentic-workflow/src/generate/diagrams/requirement_plus/generator.rs
    ...
    description: |
      ...
      HANDWRITE markers.
  - path: apps/agentic-workflow/src/generate/diagrams/journey_plus/generator.rs
    ...
    description: |
      ...
      markers.
  - path: apps/agentic-workflow/src/generate/diagrams/class_plus/generator.rs
  ...
  - path: apps/agentic-workflow/src/generate/diagrams/mindmap_plus/generator.rs
    action: skip
    section: logic
    impl_mode: hand-written
    description: |
