...
tests:
  ...
  T6:
    ...
    file: apps/agentic-workflow/src/spec_store.rs
    verifies: [R1, R5]
  T7:
    type: test
...
changes:
  ...
  - path: apps/agentic-workflow/tech-design/core/interfaces/models/change.md
    action: modify
    section: schema
    impl_mode: hand-written
    description: |
  ...
  - path: apps/agentic-workflow/tech-design/core/validate/rules/r6-r7-rule-specs.md
    action: modify
    section: logic
    impl_mode: hand-written
    description: |
