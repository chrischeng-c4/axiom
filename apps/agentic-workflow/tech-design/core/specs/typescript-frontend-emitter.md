...
changes:
  - path: apps/agentic-workflow/src/generate/gen/typescript/mod.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/typescript/types.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/typescript/component.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/typescript/page.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/typescript/api_client.rs
    action: create
    section: logic
  ...
  - path: apps/agentic-workflow/src/generate/gen/typescript/state.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/typescript/test.rs
    action: create
    section: test-plan
  ...
  - path: apps/agentic-workflow/src/generate/gen/typescript/package_json.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/src/generate/gen/typescript/determinism.rs
    action: create
    section: schema
  ...
  - path: apps/agentic-workflow/tests/typescript_emitter.rs
    action: create
    section: test-plan
