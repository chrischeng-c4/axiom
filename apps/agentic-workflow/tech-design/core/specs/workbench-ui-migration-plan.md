...
slices:
  - id: s0_spec_alignment
    ...
    owner_path: apps/agentic-workflow/tech-design/core/
    objective: |
...
```yaml
changes:
  - path: apps/agentic-workflow/tech-design/core/specs/workbench-ui-migration-plan.md
    action: create
    section: logic
    impl_mode: hand-written
    description: Capture impact map, ordered migration slices, import boundaries, and acceptance gates.

  - path: apps/agentic-workflow/tech-design/core/README.md
    action: modify
    section: logic
    impl_mode: hand-written
    description: Add the migration plan to the SDD workbench spec index.

  - path: apps/agentic-workflow/tech-design/core/specs/workbench-ui-primitive-design.md
    action: modify
    section: logic
    impl_mode: hand-written
...
tests:
  migration_spec_conformance:
    kind: score
    command: aw td check --section-type-conformance apps/agentic-workflow/tech-design/core/specs/workbench-ui-migration-plan.md --json
    verifies:
