...
`apps/agentic-workflow/tech-design/core/specs/fixtures/` exercises
...
tests:
  T1:
    ...
    file: apps/agentic-workflow/tests/frontend_td_sections.rs
    verifies: [R1]
  T2:
    type: test
...
changes:
  ...
  - path: apps/agentic-workflow/src/generate/ui_ir/mod.rs
    action: create
    section: schema
    section_id: logic
  ...
  - path: apps/agentic-workflow/tests/frontend_td_sections.rs
    action: create
    section: test-plan
  ...
  - path: apps/agentic-workflow/tech-design/core/specs/fixtures/frontend-page.md
    action: create
    section: test-plan
    section_id: scenario
    symbol: fixture
