...
language_layout_profiles:
  ...
  role_source_of_truth:
    spec: apps/agentic-workflow/tech-design/surface/specs/score-section-type-registry.md
  ...
  profiles:
    rust:
      status: stable
      spec: apps/agentic-workflow/tech-design/core/generate/rust-layout-profile.md
      notes:
...
```yaml
changes:
  - path: apps/agentic-workflow/tech-design/core/generate/language-layout-profiles.md
    action: create
    section: overview
    impl_mode: hand-written
    description: |
