...
Public API manifest for `apps/agentic-workflow/src/generate/engine/filters.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `camel_case` | apps/agentic-workflow/src/generate/engine/filters.rs | function | pub | 20 | camel_case(value: &Value, _args: &HashMap<String, Value>) -> Result<Value> |
| `kebab_case` | apps/agentic-workflow/src/generate/engine/filters.rs | function | pub | 38 | kebab_case(value: &Value, _args: &HashMap<String, Value>) -> Result<Value> |
| `pascal_case` | apps/agentic-workflow/src/generate/engine/filters.rs | function | pub | 11 | pascal_case(value: &Value, _args: &HashMap<String, Value>) -> Result<Value> |
| `snake_case` | apps/agentic-workflow/src/generate/engine/filters.rs | function | pub | 29 | snake_case(value: &Value, _args: &HashMap<String, Value>) -> Result<Value> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:claim-code -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generate/engine/filters.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/generate/engine/filters.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/engine/filters.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
