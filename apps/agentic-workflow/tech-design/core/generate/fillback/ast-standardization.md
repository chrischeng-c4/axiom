...
description: >
  Standardization inventory for apps/agentic-workflow/src/fillback/ast.rs.
  ...
  Upstream mission: apps/agentic-workflow/tech-design/surface/specs/score-standardization.md
$defs:
  MarkerAction:
    type: string
    enum:
...
inventory:
  file: apps/agentic-workflow/src/fillback/ast.rs
  drift_finding:
