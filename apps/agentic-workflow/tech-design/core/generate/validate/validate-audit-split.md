...
definitions:
  ...
  LintRule:
    ...
    properties:
      ...
      impl_module:
        type: string
        description: Rust module path under apps/agentic-workflow/src/validate/rules/
      skip_condition:
        type: string
...
changes:
  ...
  - path: apps/agentic-workflow/tests/validate_rules/mod.rs
    action: create
    section: test-plan
    impl_mode: hand-written
    description: |
      Integration test module for all 7 lint rules. One test fixture file per rule
      under apps/agentic-workflow/tests/validate_rules/fixtures/. Each test verifies: fixture
      triggers exactly the target rule and no other rules.

  - path: apps/agentic-workflow/tests/audit_walk/mod.rs
    action: create
    section: test-plan
    impl_mode: hand-written
    description: |
  ...
  - path: apps/agentic-workflow/tests/contract/mod.rs
    action: create
    section: test-plan
    impl_mode: hand-written
    description: |
...
- [changes] File paths in changes match the actual codebase (`apps/agentic-workflow/`, `apps/agentic-workflow/src/cli/td.rs`). The issue scope section used an older `cclab-sdd` name but the changes section has the correct real paths — no drift.
