...
Public API manifest for `apps/agentic-workflow/src/generate/render.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `BlockRenderResult` | apps/agentic-workflow/src/generate/render.rs | struct | pub | 16 |  |
| `RenderReport` | apps/agentic-workflow/src/generate/render.rs | struct | pub | 32 |  |
| `run_render` | apps/agentic-workflow/src/generate/render.rs | function | pub | 45 | run_render(spec_path: &Path, check_only: bool) -> crate::generate::Result<RenderReport> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/render.rs -->
```rust
...
// @spec apps/agentic-workflow/tech-design/core/generate/render.md#source

use std::path::Path;

/// Per-block render result.
/// @spec apps/agentic-workflow/tech-design/core/generate/render.md#schema
#[derive(Debug, Clone)]
