...
# Standardized apps/agentic-workflow/src/generate/tests/handwrite_scaffold_test.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/generate/tests/handwrite_scaffold_test.rs` generated from AST during Score force-regeneration standardization.
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/tests/handwrite_scaffold_test.rs -->
```rust
...
//!
//! @spec apps/agentic-workflow/tech-design/core/generate/handwrite-marker.md#test-plan
