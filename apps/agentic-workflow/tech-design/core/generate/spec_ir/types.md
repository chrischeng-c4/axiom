...
Public API manifest for `apps/agentic-workflow/src/generate/spec_ir/types.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AttributeDef` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 143 |  |
| `BundleMetadata` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 303 |  |
| `ComponentSpec` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 122 |  |
| `DeploySpec` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 21 |  |
| `DesignTokenEntry` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 197 |  |
| `DesignTokenSpec` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 185 |  |
| `EnvVar` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 45 |  |
| `EventDef` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 171 |  |
| `PropDef` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 89 |  |
| `ResourceLimits` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 59 |  |
| `SlotDef` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 160 |  |
| `SpecBundle` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 315 |  |
| `SpecIR` | apps/agentic-workflow/src/generate/spec_ir/types.rs | enum | pub | 231 |  |
| `SpecMetadata` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 212 |  |
| `WireframeNode` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 108 |  |
| `WireframeSpec` | apps/agentic-workflow/src/generate/spec_ir/types.rs | struct | pub | 71 |  |
| `add_dependency` | apps/agentic-workflow/src/generate/spec_ir/types.rs | function | pub | 538 | add_dependency(&mut self, from: usize, to: usize) |
| `is_empty` | apps/agentic-workflow/src/generate/spec_ir/types.rs | function | pub | 548 | is_empty(&self) -> bool |
| `kind` | apps/agentic-workflow/src/generate/spec_ir/types.rs | function | pub | 354 | kind(&self) -> &'static str |
| `len` | apps/agentic-workflow/src/generate/spec_ir/types.rs | function | pub | 543 | len(&self) -> usize |
| `metadata` | apps/agentic-workflow/src/generate/spec_ir/types.rs | function | pub | 371 | metadata(&self) -> &SpecMetadata |
| `metadata_mut` | apps/agentic-workflow/src/generate/spec_ir/types.rs | function | pub | 388 | metadata_mut(&mut self) -> &mut SpecMetadata |
| `new` | apps/agentic-workflow/src/generate/spec_ir/types.rs | function | pub | 526 | new() -> Self |
| `push` | apps/agentic-workflow/src/generate/spec_ir/types.rs | function | pub | 531 | push(&mut self, spec: SpecIR) -> usize |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/spec_ir/types.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/generate/spec_ir/types.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/spec_ir/types.md#source
