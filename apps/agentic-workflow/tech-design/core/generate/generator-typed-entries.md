...
description: >
  ...
  apps/agentic-workflow/src/td_ast/payloads.rs (not present after Stage 2).
...
preamble: |
  ...
  // under apps/agentic-workflow/tests/fixtures/stage_2b_typed_migration/ (R7, R8).
tests:
...
changes:
  ...
  - path: apps/agentic-workflow/src/generate/generators/module_facade.rs
    action: modify
    section: logic
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/src/generate/generators/trait_impl.rs
    action: modify
    section: logic
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/src/td_ast/validate.rs
    action: modify
    section: schema
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/tests/fixtures/stage_2b_typed_migration/schema_fixture.yaml
    action: create
    section: test-plan
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/tests/fixtures/stage_2b_typed_migration/cli_subcommand_fixture.yaml
    action: create
    section: test-plan
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/tests/fixtures/stage_2b_typed_migration/module_facade_fixture.yaml
    action: create
    section: test-plan
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/tests/fixtures/stage_2b_typed_migration/trait_impl_fixture.yaml
    action: create
    section: test-plan
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/tests/fixtures/stage_2b_typed_migration/logic_emitter_fixture.yaml
    action: create
    section: test-plan
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/tests/stage_2b_golden_tests.rs
    action: create
    section: tests
    impl_mode: codegen
    description: >
