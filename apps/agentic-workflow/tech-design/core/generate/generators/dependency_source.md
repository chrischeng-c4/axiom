...
Public API manifest for `apps/agentic-workflow/src/generators/dependency.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DependencyGenerator` | apps/agentic-workflow/src/generators/dependency.rs | struct | pub | 95 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:fold-shadow -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generators/dependency.rs -->
````rust
/// @spec apps/agentic-workflow/tech-design/core/generate/generators/dependency_source.md#source
