...
Public API manifest for `apps/agentic-workflow/src/generate/generators/mod.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `cli_subcommand` | apps/agentic-workflow/src/generate/generators/mod.rs | module | pub | 22 |  |
| `logic_primitive_emitter` | apps/agentic-workflow/src/generate/generators/mod.rs | module | pub | 28 |  |
| `module_facade` | apps/agentic-workflow/src/generate/generators/mod.rs | module | pub | 29 |  |
| `primitive_registry` | apps/agentic-workflow/src/generate/generators/mod.rs | module | pub | 30 |  |
| `quality_primitives` | apps/agentic-workflow/src/generate/generators/mod.rs | module | pub | 31 |  |
| `trait_impl` | apps/agentic-workflow/src/generate/generators/mod.rs | module | pub | 36 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:claim-code -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generate/generators/mod.rs -->
```rust
//! Code Generators
//!
