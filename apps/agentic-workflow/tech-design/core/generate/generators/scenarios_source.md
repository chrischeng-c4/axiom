...
Public API manifest for `apps/agentic-workflow/src/generators/scenarios.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ScenariosGenerator` | apps/agentic-workflow/src/generators/scenarios.rs | struct | pub | 96 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:fold-shadow -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generators/scenarios.rs -->
````rust
/// @spec apps/agentic-workflow/tech-design/core/generate/generators/scenarios_source.md#source
