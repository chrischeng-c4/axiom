...
Public API manifest for `apps/agentic-workflow/src/generators/async_api.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AsyncApiGenerator` | apps/agentic-workflow/src/generators/async_api.rs | struct | pub | 110 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:fold-shadow -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generators/async_api.rs -->
````rust
