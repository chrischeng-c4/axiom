...
Public API manifest for `apps/agentic-workflow/src/generators/doc.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DocGenerator` | apps/agentic-workflow/src/generators/doc.rs | struct | pub | 84 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:fold-shadow -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generators/doc.rs -->
```rust
/// @spec apps/agentic-workflow/tech-design/core/generate/generators/doc_source.md#source
