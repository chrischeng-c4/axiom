...
Public API manifest for `apps/agentic-workflow/src/generators/overview.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `OverviewGenerator` | apps/agentic-workflow/src/generators/overview.rs | struct | pub | 86 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:fold-shadow -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generators/overview.rs -->
```rust
/// @spec apps/agentic-workflow/tech-design/core/generate/generators/overview_source.md#source
