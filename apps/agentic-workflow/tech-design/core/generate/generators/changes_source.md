...
Public API manifest for `apps/agentic-workflow/src/generators/changes.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ChangesGenerator` | apps/agentic-workflow/src/generators/changes.rs | struct | pub | 110 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:fold-shadow -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generators/changes.rs -->
````rust
