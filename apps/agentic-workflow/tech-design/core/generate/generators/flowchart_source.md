...
Public API manifest for `apps/agentic-workflow/src/generators/flowchart.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `FlowchartGenerator` | apps/agentic-workflow/src/generators/flowchart.rs | struct | pub | 88 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:fold-shadow -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generators/flowchart.rs -->
````rust
/// @spec apps/agentic-workflow/tech-design/core/generate/generators/flowchart_source.md#source
