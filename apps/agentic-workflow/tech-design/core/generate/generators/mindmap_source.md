...
Public API manifest for `apps/agentic-workflow/src/generators/mindmap.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MindmapGenerator` | apps/agentic-workflow/src/generators/mindmap.rs | struct | pub | 90 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:fold-shadow -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generators/mindmap.rs -->
````rust
/// @spec apps/agentic-workflow/tech-design/core/generate/generators/mindmap_source.md#source
