...
Public API manifest for `apps/agentic-workflow/src/generate/schema/types.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AdditionalProperties` | apps/agentic-workflow/src/generate/schema/types.rs | enum | pub | 98 |  |
| `JsonSchema` | apps/agentic-workflow/src/generate/schema/types.rs | struct | pub | 107 |  |
| `SchemaType` | apps/agentic-workflow/src/generate/schema/types.rs | enum | pub | 27 |  |
| `SchemaVersion` | apps/agentic-workflow/src/generate/schema/types.rs | enum | pub | 14 |  |
| `StringFormat` | apps/agentic-workflow/src/generate/schema/types.rs | enum | pub | 41 |  |
| `TypeConstraint` | apps/agentic-workflow/src/generate/schema/types.rs | enum | pub | 89 |  |
| `all_definitions` | apps/agentic-workflow/src/generate/schema/types.rs | function | pub | 274 | all_definitions(&self) -> HashMap<String, &JsonSchema> |
| `array` | apps/agentic-workflow/src/generate/schema/types.rs | function | pub | 252 | array(items: JsonSchema) -> Self |
| `boolean` | apps/agentic-workflow/src/generate/schema/types.rs | function | pub | 247 | boolean() -> Self |
| `effective_type` | apps/agentic-workflow/src/generate/schema/types.rs | function | pub | 295 | effective_type(&self) -> Option<SchemaType> |
| `integer` | apps/agentic-workflow/src/generate/schema/types.rs | function | pub | 237 | integer() -> Self |
| `is_ref` | apps/agentic-workflow/src/generate/schema/types.rs | function | pub | 290 | is_ref(&self) -> bool |
| `new` | apps/agentic-workflow/src/generate/schema/types.rs | function | pub | 219 | new() -> Self |
| `number` | apps/agentic-workflow/src/generate/schema/types.rs | function | pub | 242 | number() -> Self |
| `object` | apps/agentic-workflow/src/generate/schema/types.rs | function | pub | 261 | object() -> Self |
| `reference` | apps/agentic-workflow/src/generate/schema/types.rs | function | pub | 266 | reference(ref_path: impl Into<String>) -> Self |
| `string` | apps/agentic-workflow/src/generate/schema/types.rs | function | pub | 232 | string() -> Self |
| `with_type` | apps/agentic-workflow/src/generate/schema/types.rs | function | pub | 224 | with_type(type_: SchemaType) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/schema/types.rs -->
```rust
//! JSON Schema type definitions
//!
...
/// JSON Schema version.
/// @spec apps/agentic-workflow/tech-design/core/generate/schema/types.md#schema
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/schema/types.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/schema/types.rs
    action: modify
    section: source
    impl_mode: codegen
