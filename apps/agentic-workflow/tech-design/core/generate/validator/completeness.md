...
Public API manifest for `apps/agentic-workflow/src/generate/validator/completeness.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Severity` | apps/agentic-workflow/src/generate/validator/completeness.rs | enum | pub | 11 |  |
| `ValidationIssue` | apps/agentic-workflow/src/generate/validator/completeness.rs | struct | pub | 21 |  |
| `ValidationResult` | apps/agentic-workflow/src/generate/validator/completeness.rs | struct | pub | 33 |  |
| `add` | apps/agentic-workflow/src/generate/validator/completeness.rs | function | pub | 62 | add(&mut self, issue: ValidationIssue) |
| `error` | apps/agentic-workflow/src/generate/validator/completeness.rs | function | pub | 39 | error(path: impl Into<String>, message: impl Into<String>) -> Self |
| `error_count` | apps/agentic-workflow/src/generate/validator/completeness.rs | function | pub | 80 | error_count(&self) -> usize |
| `errors` | apps/agentic-workflow/src/generate/validator/completeness.rs | function | pub | 70 | errors(&self) -> impl Iterator<Item = &ValidationIssue> |
| `is_valid` | apps/agentic-workflow/src/generate/validator/completeness.rs | function | pub | 66 | is_valid(&self) -> bool |
| `new` | apps/agentic-workflow/src/generate/validator/completeness.rs | function | pub | 58 | new() -> Self |
| `validate_schema` | apps/agentic-workflow/src/generate/validator/completeness.rs | function | pub | 91 | validate_schema(schema: &JsonSchema) -> ValidationResult |
| `warning` | apps/agentic-workflow/src/generate/validator/completeness.rs | function | pub | 47 | warning(path: impl Into<String>, message: impl Into<String>) -> Self |
| `warning_count` | apps/agentic-workflow/src/generate/validator/completeness.rs | function | pub | 84 | warning_count(&self) -> usize |
| `warnings` | apps/agentic-workflow/src/generate/validator/completeness.rs | function | pub | 74 | warnings(&self) -> impl Iterator<Item = &ValidationIssue> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/validator/completeness.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/generate/validator/completeness.md#schema
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum Severity {
...
/// @spec apps/agentic-workflow/tech-design/core/generate/validator/completeness.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/validator/completeness.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
