---
id: sdd-generate-validator-spec-ir
...
Public API manifest for `apps/agentic-workflow/src/generate/validator/spec_ir_validator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ComponentValidator` | apps/agentic-workflow/src/generate/validator/spec_ir_validator.rs | struct | pub | 99 |  |
| `DeployValidator` | apps/agentic-workflow/src/generate/validator/spec_ir_validator.rs | struct | pub | 91 |  |
| `DesignTokenValidator` | apps/agentic-workflow/src/generate/validator/spec_ir_validator.rs | struct | pub | 103 |  |
| `WireframeValidator` | apps/agentic-workflow/src/generate/validator/spec_ir_validator.rs | struct | pub | 95 |  |
| `validate_spec_ir` | apps/agentic-workflow/src/generate/validator/spec_ir_validator.rs | function | pub | 68 | validate_spec_ir(spec: &SpecIR) -> ValidationResult |
## Schema
...
definitions:
  DeployValidator:
    ...
    required: []
    properties: {}
    description: Internal-consistency validator for SpecIR Deploy.
    x-rust-struct:
      derive: []
      unit: true
  ...
  WireframeValidator:
    ...
    required: []
    properties: {}
    description: Internal-consistency validator for SpecIR Wireframe.
    x-rust-struct:
      derive: []
      unit: true
  ...
  ComponentValidator:
    ...
    required: []
    properties: {}
    description: Internal-consistency validator for SpecIR Component.
    x-rust-struct:
      derive: []
      unit: true
  ...
  DesignTokenValidator:
    ...
    required: []
    properties: {}
    description: Internal-consistency validator for SpecIR DesignToken.
    x-rust-struct:
      derive: []
      unit: true
```
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/validator/spec_ir_validator.rs -->
```rust
...
/// [`validate_spec_ir`].
/// @spec apps/agentic-workflow/tech-design/core/generate/validator/spec_ir_validator.md#source
...
/// @spec apps/agentic-workflow/tech-design/core/generate/validator/spec_ir_validator.md#schema
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/validator/spec_ir_validator.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
      Source template owns the complete SpecIR validator module.
  - action: annotate
    section: schema
...
- [overview] Four sibling unit-struct validators.
- [schema] Standard unit-struct shape replicated 4x.
- [changes] All four in `replaces`; trait + impls preserved.
