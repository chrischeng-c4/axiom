...
Public API manifest for `apps/agentic-workflow/src/generate/mcp/tools.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SddTools` | apps/agentic-workflow/src/generate/mcp/tools.rs | struct | pub | 25 |  |
| `ToolSchema` | apps/agentic-workflow/src/generate/mcp/tools.rs | struct | pub | 14 |  |
| `count` | apps/agentic-workflow/src/generate/mcp/tools.rs | function | pub | 59 | count() -> usize |
| `list` | apps/agentic-workflow/src/generate/mcp/tools.rs | function | pub | 29 | list() -> Vec<ToolSchema> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/mcp/tools.rs -->
```rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/mcp/tools.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
