...
# Standardized apps/agentic-workflow/src/generate/mcp/handlers.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/generate/mcp/handlers.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `HandlerResult` | apps/agentic-workflow/src/generate/mcp/handlers.rs | type | pub | 37 |  |
| `call_tool` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 501 | call_tool(name: &str, args: &Value) -> HandlerResult |
| `handle_generate_asyncapi` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 457 | handle_generate_asyncapi(args: &Value) -> HandlerResult |
| `handle_generate_block_plus` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 410 | handle_generate_block_plus(args: &Value) -> HandlerResult |
| `handle_generate_class` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 71 | handle_generate_class(args: &Value) -> HandlerResult |
| `handle_generate_class_plus` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 255 | handle_generate_class_plus(args: &Value) -> HandlerResult |
| `handle_generate_erd` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 101 | handle_generate_erd(args: &Value) -> HandlerResult |
| `handle_generate_erd_plus` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 286 | handle_generate_erd_plus(args: &Value) -> HandlerResult |
| `handle_generate_flowchart` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 41 | handle_generate_flowchart(args: &Value) -> HandlerResult |
| `handle_generate_flowchart_plus` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 193 | handle_generate_flowchart_plus(args: &Value) -> HandlerResult |
| `handle_generate_journey` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 145 | handle_generate_journey(args: &Value) -> HandlerResult |
| `handle_generate_journey_plus` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 379 | handle_generate_journey_plus(args: &Value) -> HandlerResult |
| `handle_generate_mermaid_plus` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 160 | handle_generate_mermaid_plus(args: &Value) -> HandlerResult |
| `handle_generate_mindmap` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 115 | handle_generate_mindmap(args: &Value) -> HandlerResult |
| `handle_generate_mindmap_plus` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 348 | handle_generate_mindmap_plus(args: &Value) -> HandlerResult |
| `handle_generate_openapi` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 443 | handle_generate_openapi(args: &Value) -> HandlerResult |
| `handle_generate_openrpc` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 472 | handle_generate_openrpc(args: &Value) -> HandlerResult |
| `handle_generate_requirement` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 130 | handle_generate_requirement(args: &Value) -> HandlerResult |
| `handle_generate_requirement_plus` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 317 | handle_generate_requirement_plus(args: &Value) -> HandlerResult |
| `handle_generate_sequence` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 56 | handle_generate_sequence(args: &Value) -> HandlerResult |
| `handle_generate_sequence_plus` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 224 | handle_generate_sequence_plus(args: &Value) -> HandlerResult |
| `handle_generate_serverless_workflow` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 486 | handle_generate_serverless_workflow(args: &Value) -> HandlerResult |
| `handle_generate_state` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 86 | handle_generate_state(args: &Value) -> HandlerResult |
| `is_sdd_tool` | apps/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 533 | is_sdd_tool(name: &str) -> bool |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generate/mcp/handlers.rs -->
```rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/mcp/handlers.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
