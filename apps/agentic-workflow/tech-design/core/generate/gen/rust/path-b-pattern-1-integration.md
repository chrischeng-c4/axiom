...
changes:
  ...
  - path: apps/agentic-workflow/tech-design/core/generate/generators/module-facade.md
    action: modify
    section: changes
    impl_mode: hand-written
    description: >
      ...
      apps/agentic-workflow/src/generate/generators/module_facade.rs with section: logic
  ...
  - path: apps/agentic-workflow/src/generate/apply.rs
    ...
    description: >
      ...
      (or a new file in apps/agentic-workflow/src/generate/tests/):
