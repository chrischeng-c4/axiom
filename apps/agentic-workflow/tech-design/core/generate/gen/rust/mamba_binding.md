...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/mamba_binding.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MambaBindingGenOutput` | apps/agentic-workflow/src/generate/gen/rust/mamba_binding.rs | struct | pub | 37 |  |
| `generate_mamba_binding` | apps/agentic-workflow/src/generate/gen/rust/mamba_binding.rs | function | pub | 46 | generate_mamba_binding(schema_yaml: &Value, struct_name: &str) -> MambaBindingGenOutput |
| `generate_mamba_binding_with_provenance` | apps/agentic-workflow/src/generate/gen/rust/mamba_binding.rs | function | pub | 53 | generate_mamba_binding_with_provenance(     schema_yaml: &Value,     struct_name: &str,     spec_path: &str, ) -> MambaBindingGenOutput |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/mamba_binding.rs -->
```rust
