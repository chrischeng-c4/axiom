...
fixture: apps/agentic-workflow/src/generate/generators/module_facade.rs::run_module_facade
capability_refs:
...
`apps/agentic-workflow/src/generate/gen/rust/logic_emitter.rs` (391 production LOC,
...
| File                                                           | Change | Notes                                                      |
|----------------------------------------------------------------|--------|------------------------------------------------------------|
| `apps/agentic-workflow/src/generate/gen/rust/logic_emitter.rs`            | NEW    | The emitter + tests. ~391 prod LOC, 176 test LOC.          |
| `apps/agentic-workflow/src/generate/gen/rust/mod.rs`                      | MOD    | One `pub mod logic_emitter;` line + a 4-line docblock.     |
| `apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-emitter.md` | NEW | This spec.                                                 |
...
`apps/agentic-workflow/src/generate/generators/cli_subcommand.rs`. The
...
See `apps/agentic-workflow/tech-design/core/generate/path-b-pattern-2-5-expression-decision.md`
