---
id: sdd-generate-gen-rust-schema
...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/schema.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SchemaGenOutput` | apps/agentic-workflow/src/generate/gen/rust/schema.rs | struct | pub | 19 |  |
| `generate_schema` | apps/agentic-workflow/src/generate/gen/rust/schema.rs | function | pub | 30 | generate_schema(schema_yaml: &Value, config: &RustConfig) -> SchemaGenOutput |
| `generate_schema_with_provenance` | apps/agentic-workflow/src/generate/gen/rust/schema.rs | function | pub | 38 | generate_schema_with_provenance(     schema_yaml: &Value,     config: &RustConfig,     spec_path: &str, ) -> SchemaGenOutput |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/schema.rs -->
```rust
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-structural.md#R1
...
#[derive(Debug, Clone)]
/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/schema.md#source
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-structural.md#R1
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-structural.md#R6
...
/// @spec apps/agentic-workflow/tech-design/core/generate/generators/adjacent-tagged-enum.md#logic
...
"#;
    ...
    //
    // @spec apps/agentic-workflow/tech-design/core/generate/generators/adjacent-tagged-enum.md#test-plan
...
"#;
    ...
    /// `apps/agentic-workflow/src/td_ast/types.rs`. Run with
  ...
  variants:
    - name: MermaidPlus
      ...
      doc: |-
        ...
        db-model, scenarios, test-plan). Hash covers frontmatter only (R4, R8).
    - name: JsonSchema
      kind: tuple
      fields: [{ rust_type: "serde_yaml::Value" }]
      doc: |-
        JSON Schema document (schema, config, wireframe, component,
        design-token, manifest, tests).
    - name: OpenRpc
      kind: tuple
      fields: [{ rust_type: "serde_yaml::Value" }]
...
"#;
        ...
        let out = generate_schema_with_provenance(
            &yaml,
            &RustConfig::default(),
            "apps/agentic-workflow/tech-design/core/td_ast/types.md",
        );
        println!(
            "===CODEGEN-DUMP-START===\n{}===CODEGEN-DUMP-END===",
            out.code
    ...
    /// `TypedBody` enum block in `apps/agentic-workflow/src/td_ast/types.rs`.
    #[test]
...
changes:
  - path: apps/agentic-workflow/src/generate/gen/rust/schema.rs
    ...
    impl_mode: codegen
    description: |
      Source template owns the complete schema structural generator module.
```
