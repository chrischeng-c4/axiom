...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/logic_emitter.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `EmitError` | apps/agentic-workflow/src/generate/gen/rust/logic_emitter.rs | enum | pub | 296 |  |
| `EmitOutput` | apps/agentic-workflow/src/generate/gen/rust/logic_emitter.rs | struct | pub | 334 |  |
| `LogicEdge` | apps/agentic-workflow/src/generate/gen/rust/logic_emitter.rs | struct | pub | 251 |  |
| `LogicEdgeKind` | apps/agentic-workflow/src/generate/gen/rust/logic_emitter.rs | enum | pub | 220 |  |
| `LogicNode` | apps/agentic-workflow/src/generate/gen/rust/logic_emitter.rs | struct | pub | 111 |  |
| `LogicNodeKind` | apps/agentic-workflow/src/generate/gen/rust/logic_emitter.rs | enum | pub | 46 |  |
| `LogicSpec` | apps/agentic-workflow/src/generate/gen/rust/logic_emitter.rs | struct | pub | 269 |  |
| `emit` | apps/agentic-workflow/src/generate/gen/rust/logic_emitter.rs | function | pub | 351 | emit(spec: &LogicSpec) -> Result<EmitOutput, EmitError> |
| `parse_yaml` | apps/agentic-workflow/src/generate/gen/rust/logic_emitter.rs | function | pub | 826 | parse_yaml(s: &str) -> Result<LogicSpec, serde_yaml::Error> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/logic_emitter.rs -->
````rust
