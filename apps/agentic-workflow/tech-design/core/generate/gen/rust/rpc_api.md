...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/rpc_api.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RpcApiGenOutput` | apps/agentic-workflow/src/generate/gen/rust/rpc_api.rs | struct | pub | 10 |  |
| `generate_rpc_api` | apps/agentic-workflow/src/generate/gen/rust/rpc_api.rs | function | pub | 23 | generate_rpc_api(     openrpc_yaml: &Value,     spec_path: &str,     config: &RustConfig, ) -> RpcApiGenOutput |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/rpc_api.rs -->
```rust
//! RPC-API structural generator.
//!
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-structural.md#R3
...
/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/rpc_api_types.md#schema
#[derive(Debug, Clone)]
