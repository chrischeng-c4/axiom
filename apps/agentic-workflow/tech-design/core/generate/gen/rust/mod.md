...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/mod.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `cli` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 6 |  |
| `config` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 7 |  |
| `db_model` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 8 |  |
| `interaction` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 18 |  |
| `logic` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 19 |  |
| `logic_emitter` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 26 |  |
| `mamba_binding` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 9 |  |
| `manifest` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 10 |  |
| `readme` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 11 |  |
| `requirement` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 29 |  |
| `rpc_api` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 12 |  |
| `scenario` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 30 |  |
| `schema` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 13 |  |
| `state_machine` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 20 |  |
| `test_plan` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 31 |  |
| `tests_gen` | apps/agentic-workflow/src/generate/gen/rust/mod.rs | module | pub | 15 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/mod.rs -->
```rust
...
// apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-emitter.md for
