...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/test_plan.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MarkdownTest` | apps/agentic-workflow/src/generate/gen/rust/test_plan.rs | struct | pub | 59 |  |
| `MarkdownTestPlanOutput` | apps/agentic-workflow/src/generate/gen/rust/test_plan.rs | struct | pub | 73 |  |
| `ScenarioRef` | apps/agentic-workflow/src/generate/gen/rust/test_plan.rs | struct | pub | 33 |  |
| `TestElement` | apps/agentic-workflow/src/generate/gen/rust/test_plan.rs | struct | pub | 21 |  |
| `TestPlanGenOutput` | apps/agentic-workflow/src/generate/gen/rust/test_plan.rs | struct | pub | 49 |  |
| `generate_test_plan` | apps/agentic-workflow/src/generate/gen/rust/test_plan.rs | function | pub | 88 | generate_test_plan(     test_plan_yaml: &Value,     scenarios: &[ScenarioRef],     spec_path: &str, ) -> TestPlanGenOutput |
| `generate_test_plan_from_markdown` | apps/agentic-workflow/src/generate/gen/rust/test_plan.rs | function | pub | 224 | generate_test_plan_from_markdown(     spec_content: &str,     spec_path: &str, ) -> Option<MarkdownTestPlanOutput> |
| `generate_unit_tests_from_mermaid` | apps/agentic-workflow/src/generate/gen/rust/test_plan.rs | function | pub | 269 | generate_unit_tests_from_mermaid(     spec_content: &str,     spec_path: &str, ) -> Option<TestPlanGenOutput> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/test_plan.rs -->
~~~rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/gen/rust/test_plan.md#source
// CODEGEN-BEGIN
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-documentation.md#R2
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-documentation.md#R4
...
/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/test_plan.md#schema
#[derive(Debug, Clone)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/test_plan.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/gen/rust/test_plan.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
