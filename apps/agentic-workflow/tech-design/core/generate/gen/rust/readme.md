...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/readme.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ReadmeGenOutput` | apps/agentic-workflow/src/generate/gen/rust/readme.rs | struct | pub | 39 |  |
| `SymbolEntry` | apps/agentic-workflow/src/generate/gen/rust/readme.rs | struct | pub | 29 |  |
| `generate_readme_symbols` | apps/agentic-workflow/src/generate/gen/rust/readme.rs | function | pub | 55 | generate_readme_symbols(tech_design_dir: &Path, project_root: &Path) -> ReadmeGenOutput |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/readme.rs -->
~~~rust
