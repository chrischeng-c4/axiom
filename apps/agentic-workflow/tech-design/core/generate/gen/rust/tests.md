...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/tests.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TestsGenOutput` | apps/agentic-workflow/src/generate/gen/rust/tests.rs | struct | pub | 74 |  |
| `generate_e2e_tests` | apps/agentic-workflow/src/generate/gen/rust/tests.rs | function | pub | 169 | generate_e2e_tests(spec_content: &str) -> TestsGenOutput |
| `generate_tests` | apps/agentic-workflow/src/generate/gen/rust/tests.rs | function | pub | 86 | generate_tests(spec_content: &str) -> TestsGenOutput |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/tests.rs -->
~~~rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/generate/gen/rust/tests.md#source
// CODEGEN-BEGIN
...
/// Output from test cases generation.
/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/tests.md#schema
#[derive(Debug, Clone)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/tests.md#source
