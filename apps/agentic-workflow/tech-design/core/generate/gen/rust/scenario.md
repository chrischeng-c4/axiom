...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/scenario.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ScenarioDef` | apps/agentic-workflow/src/generate/gen/rust/scenario.rs | struct | pub | 18 |  |
| `ScenarioGenOutput` | apps/agentic-workflow/src/generate/gen/rust/scenario.rs | struct | pub | 30 |  |
| `generate_scenarios` | apps/agentic-workflow/src/generate/gen/rust/scenario.rs | function | pub | 41 | generate_scenarios(scenarios_yaml: &Value, spec_path: &str) -> ScenarioGenOutput |
| `parse_scenarios` | apps/agentic-workflow/src/generate/gen/rust/scenario.rs | function | pub | 95 | parse_scenarios(yaml: &Value) -> Vec<ScenarioDef> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/scenario.rs -->
```rust
