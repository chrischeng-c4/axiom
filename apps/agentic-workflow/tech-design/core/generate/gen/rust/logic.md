---
id: sdd-generate-gen-rust-logic
...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/logic.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `LogicGenOutput` | apps/agentic-workflow/src/generate/gen/rust/logic.rs | struct | pub | 190 |  |
| `generate_logic` | apps/agentic-workflow/src/generate/gen/rust/logic.rs | function | pub | 203 | generate_logic(     content: &LogicContent,     spec_path: &str,     config: &RustConfig, ) -> LogicGenOutput |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/logic.rs -->
```rust
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-behavioral.md#R3
...
///
/// /// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-cycle-detection.md#logic (cycle detection flowchart)
...
///
/// /// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-cycle-detection.md#logic (loop opening rules)
...
#[derive(Debug, Clone)]
/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/logic.md#source
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-behavioral.md#R3
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-behavioral.md#R4
...
mod tests {
    ...
    /// REQ apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-cycle-detection.md — R5 (generic loop) + R7 (continue) + R8 (break)
    #[test]
    ...
    /// REQ apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-cycle-detection.md — R5 (generic loop) on multi-node cycle
    #[test]
    ...
    /// REQ apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-cycle-detection.md — R6 (for_each form)
    #[test]
    ...
    /// REQ apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-cycle-detection.md — R9 (regression guard)
    #[test]
    ...
    /// REQ apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-cycle-detection.md — R11 (malformed for_each fallback)
    #[test]
...
///
/// /// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/logic-cycle-detection.md#logic (edge handling)
#[allow(clippy::too_many_arguments)]
fn emit_edge_target(
    content: &LogicContent,
    from_node: &str,
...
changes:
  - path: apps/agentic-workflow/src/generate/gen/rust/logic.rs
    ...
    impl_mode: codegen
    description: |
      Source template owns the complete logic/flowchart generator module.
```
