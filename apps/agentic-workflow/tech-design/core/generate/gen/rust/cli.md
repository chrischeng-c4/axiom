...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/cli.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CliArgDef` | apps/agentic-workflow/src/generate/gen/rust/cli.rs | struct | pub | 23 |  |
| `CliCommandDef` | apps/agentic-workflow/src/generate/gen/rust/cli.rs | struct | pub | 34 |  |
| `CliGenOutput` | apps/agentic-workflow/src/generate/gen/rust/cli.rs | struct | pub | 16 |  |
| `generate_cli` | apps/agentic-workflow/src/generate/gen/rust/cli.rs | function | pub | 46 | generate_cli(cli_yaml: &Value, config: &RustConfig) -> CliGenOutput |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/cli.rs -->
```rust
