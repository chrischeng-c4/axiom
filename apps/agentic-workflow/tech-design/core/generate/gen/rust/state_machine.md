...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/state_machine.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `StateMachineGenOutput` | apps/agentic-workflow/src/generate/gen/rust/state_machine.rs | struct | pub | 23 |  |
| `generate_state_machine` | apps/agentic-workflow/src/generate/gen/rust/state_machine.rs | function | pub | 35 | generate_state_machine(     content: &StateMachineContent,     spec_path: &str,     config: &RustConfig, ) -> StateMachineGenOutput |
| `snake_to_pascal` | apps/agentic-workflow/src/generate/gen/rust/state_machine.rs | function | pub | 257 | snake_to_pascal(s: &str) -> String |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/state_machine.rs -->
```rust
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-behavioral.md#R1
...
#[derive(Debug, Clone)]
/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/state_machine.md#source
...
mod tests {
    ...
    // @spec apps/agentic-workflow/tech-design/core/logic/codegen-behavioral.md#R5
    #[test]
