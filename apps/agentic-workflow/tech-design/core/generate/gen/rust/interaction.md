---
id: sdd-generate-gen-rust-interaction
...
# Interaction Behavioral Generator

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/interaction.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `InteractionGenOutput` | apps/agentic-workflow/src/generate/gen/rust/interaction.rs | struct | pub | 22 |  |
| `generate_interaction` | apps/agentic-workflow/src/generate/gen/rust/interaction.rs | function | pub | 37 | generate_interaction(     content: &InteractionContent,     spec_path: &str,     config: &RustConfig, ) -> InteractionGenOutput |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/interaction.rs -->
```rust
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-behavioral.md#R2
...
#[derive(Debug, Clone)]
/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/interaction.md#source
...
changes:
  - path: apps/agentic-workflow/src/generate/gen/rust/interaction.rs
    ...
    impl_mode: codegen
    description: |
      Source template owns the complete interaction behavioral generator module.
```
