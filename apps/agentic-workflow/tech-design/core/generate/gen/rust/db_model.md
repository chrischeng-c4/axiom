...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/db_model.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DbModelGenOutput` | apps/agentic-workflow/src/generate/gen/rust/db_model.rs | struct | pub | 9 |  |
| `generate_db_model` | apps/agentic-workflow/src/generate/gen/rust/db_model.rs | function | pub | 20 | generate_db_model(erd_yaml: &Value, config: &RustConfig) -> DbModelGenOutput |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/db_model.rs -->
```rust
//! DB-model structural generator.
//!
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-structural.md#R4
...
/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/db_model_types.md#schema
#[derive(Debug, Clone)]
