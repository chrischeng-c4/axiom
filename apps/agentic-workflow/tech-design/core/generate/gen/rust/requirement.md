...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/requirement.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ImplAtLocation` | apps/agentic-workflow/src/generate/gen/rust/requirement.rs | struct | pub | 20 |  |
| `RequirementAnnotation` | apps/agentic-workflow/src/generate/gen/rust/requirement.rs | struct | pub | 28 |  |
| `RequirementAnnotationOutput` | apps/agentic-workflow/src/generate/gen/rust/requirement.rs | struct | pub | 38 |  |
| `generate_requirement_annotations` | apps/agentic-workflow/src/generate/gen/rust/requirement.rs | function | pub | 106 | generate_requirement_annotations(     annotations: &[RequirementAnnotation],     lang: Lang, ) -> RequirementAnnotationOutput |
| `parse_requirement_annotations` | apps/agentic-workflow/src/generate/gen/rust/requirement.rs | function | pub | 48 | parse_requirement_annotations(     frontmatter: &Value,     spec_path: &str, ) -> Vec<RequirementAnnotation> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/requirement.rs -->
```rust
