...
Public API manifest for `apps/agentic-workflow/src/generate/gen/rust/config.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ConfigGenOutput` | apps/agentic-workflow/src/generate/gen/rust/config.rs | struct | pub | 16 |  |
| `generate_config` | apps/agentic-workflow/src/generate/gen/rust/config.rs | function | pub | 28 | generate_config(config_yaml: &Value, rust_config: &RustConfig) -> ConfigGenOutput |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/gen/rust/config.rs -->
```rust
...
// @spec apps/agentic-workflow/tech-design/core/logic/codegen-structural.md#R5

use crate::generate::types::RustConfig;
use serde_yaml::Value;

/// Output from config code generation.
/// @spec apps/agentic-workflow/tech-design/core/generate/gen/rust/config.md#schema
#[derive(Debug, Clone)]
