...
`apps/agentic-workflow/src/generate/from_td_ast.rs` is the new entry point for the
...
Public API manifest for `apps/agentic-workflow/src/generate/from_td_ast.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DispatchCtx` | apps/agentic-workflow/src/generate/from_td_ast.rs | struct | pub | 14 |  |
| `DispatchOutcome` | apps/agentic-workflow/src/generate/from_td_ast.rs | struct | pub | 27 |  |
| `DispatchReport` | apps/agentic-workflow/src/generate/from_td_ast.rs | struct | pub | 42 |  |
| `DispatchStatus` | apps/agentic-workflow/src/generate/from_td_ast.rs | enum | pub | 54 |  |
| `DispatchStrategy` | apps/agentic-workflow/src/generate/from_td_ast.rs | enum | pub | 68 |  |
| `DispatchMaturity` | apps/agentic-workflow/src/generate/from_td_ast.rs | enum | pub | 91 |  |
| `GeneratorInput` | apps/agentic-workflow/src/generate/from_td_ast.rs | struct | pub | 123 |  |
| `dispatch_from_tdast` | apps/agentic-workflow/src/generate/from_td_ast.rs | function | pub | 82 | dispatch_from_tdast(td_ast: &TDAst, _ctx: &DispatchCtx) -> DispatchReport |
| `enter` | apps/agentic-workflow/src/generate/from_td_ast.rs | function | pub | 217 | enter() -> std::result::Result<(), Box<dyn std::error::Error>> |
## Schema
...
description: >
  ...
  apps/agentic-workflow/src/generate/from_td_ast.rs.
...
preamble: |
  ...
  changes:
    - path: apps/agentic-workflow/src/foo.rs
      action: create
      impl_mode: codegen
...
///
/// @spec apps/agentic-workflow/tech-design/core/generate/from-td-ast.md#schema
