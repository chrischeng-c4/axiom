...
surface under `apps/agentic-workflow/src/cli/`, while `projects/sdd`
corresponds to the spec compiler, TD AST, generator, and validation surfaces
under `apps/agentic-workflow/src/{td_ast,generate,validate,validator}/`.
...
rust_layout_profile:
  ...
  dogfood_examples:
    projects_score:
      current_path: "apps/agentic-workflow/src/cli/"
      mapping:
    ...
    projects_sdd:
      current_path: "apps/agentic-workflow/src/{td_ast,generate,validate,validator}/"
      mapping:
        td_ast: "src/td_ast/"
...
```yaml
changes:
  - path: apps/agentic-workflow/tech-design/core/generate/rust-layout-profile.md
    action: create
    section: overview
