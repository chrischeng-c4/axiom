...
Public API manifest for `apps/agentic-workflow/src/generate/specs/openapi.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ApiInfo` | apps/agentic-workflow/src/generate/specs/openapi.rs | struct | pub | 39 |  |
| `ApiResponse` | apps/agentic-workflow/src/generate/specs/openapi.rs | struct | pub | 101 |  |
| `HttpMethod` | apps/agentic-workflow/src/generate/specs/openapi.rs | enum | pub | 17 |  |
| `OpenApiInput` | apps/agentic-workflow/src/generate/specs/openapi.rs | struct | pub | 147 |  |
| `Parameter` | apps/agentic-workflow/src/generate/specs/openapi.rs | struct | pub | 63 |  |
| `ParameterIn` | apps/agentic-workflow/src/generate/specs/openapi.rs | enum | pub | 29 |  |
| `PathOperation` | apps/agentic-workflow/src/generate/specs/openapi.rs | struct | pub | 117 |  |
| `RequestBody` | apps/agentic-workflow/src/generate/specs/openapi.rs | struct | pub | 83 |  |
| `Server` | apps/agentic-workflow/src/generate/specs/openapi.rs | struct | pub | 52 |  |
| `generate_openapi` | apps/agentic-workflow/src/generate/specs/openapi.rs | function | pub | 161 | generate_openapi(input: &OpenApiInput) -> Result<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/specs/openapi.rs -->
```rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/specs/openapi.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
