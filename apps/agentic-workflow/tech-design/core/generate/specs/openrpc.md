...
Public API manifest for `apps/agentic-workflow/src/generate/specs/openrpc.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `OpenRpcInfo` | apps/agentic-workflow/src/generate/specs/openrpc.rs | struct | pub | 15 |  |
| `OpenRpcInput` | apps/agentic-workflow/src/generate/specs/openrpc.rs | struct | pub | 73 |  |
| `RpcError` | apps/agentic-workflow/src/generate/specs/openrpc.rs | struct | pub | 47 |  |
| `RpcMethod` | apps/agentic-workflow/src/generate/specs/openrpc.rs | struct | pub | 56 |  |
| `RpcParam` | apps/agentic-workflow/src/generate/specs/openrpc.rs | struct | pub | 24 |  |
| `RpcResult` | apps/agentic-workflow/src/generate/specs/openrpc.rs | struct | pub | 36 |  |
| `generate_openrpc` | apps/agentic-workflow/src/generate/specs/openrpc.rs | function | pub | 81 | generate_openrpc(input: &OpenRpcInput) -> Result<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/specs/openrpc.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/generate/specs/openrpc.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/specs/openrpc.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/specs/openrpc.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
