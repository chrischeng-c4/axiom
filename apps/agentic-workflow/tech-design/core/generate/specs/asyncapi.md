...
Public API manifest for `apps/agentic-workflow/src/generate/specs/asyncapi.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AsyncApiInfo` | apps/agentic-workflow/src/generate/specs/asyncapi.rs | struct | pub | 39 |  |
| `AsyncApiInput` | apps/agentic-workflow/src/generate/specs/asyncapi.rs | struct | pub | 88 |  |
| `AsyncApiServer` | apps/agentic-workflow/src/generate/specs/asyncapi.rs | struct | pub | 49 |  |
| `AsyncMessage` | apps/agentic-workflow/src/generate/specs/asyncapi.rs | struct | pub | 59 |  |
| `Channel` | apps/agentic-workflow/src/generate/specs/asyncapi.rs | struct | pub | 74 |  |
| `OperationType` | apps/agentic-workflow/src/generate/specs/asyncapi.rs | enum | pub | 31 |  |
| `ServerProtocol` | apps/agentic-workflow/src/generate/specs/asyncapi.rs | enum | pub | 17 |  |
| `generate_asyncapi` | apps/agentic-workflow/src/generate/specs/asyncapi.rs | function | pub | 98 | generate_asyncapi(input: &AsyncApiInput) -> Result<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/specs/asyncapi.rs -->
```rust
...
/// Server protocol.
/// @spec apps/agentic-workflow/tech-design/core/generate/specs/asyncapi.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/specs/asyncapi.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/specs/asyncapi.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
