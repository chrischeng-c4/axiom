...
Public API manifest for `apps/agentic-workflow/src/generate/specs/serverless.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DataCondition` | apps/agentic-workflow/src/generate/specs/serverless.rs | struct | pub | 71 |  |
| `DefaultCondition` | apps/agentic-workflow/src/generate/specs/serverless.rs | struct | pub | 84 |  |
| `FunctionType` | apps/agentic-workflow/src/generate/specs/serverless.rs | enum | pub | 16 |  |
| `OnError` | apps/agentic-workflow/src/generate/specs/serverless.rs | struct | pub | 92 |  |
| `ParallelBranch` | apps/agentic-workflow/src/generate/specs/serverless.rs | struct | pub | 107 |  |
| `ServerlessWorkflowInput` | apps/agentic-workflow/src/generate/specs/serverless.rs | struct | pub | 173 |  |
| `StateType` | apps/agentic-workflow/src/generate/specs/serverless.rs | enum | pub | 28 |  |
| `WorkflowAction` | apps/agentic-workflow/src/generate/specs/serverless.rs | struct | pub | 56 |  |
| `WorkflowError` | apps/agentic-workflow/src/generate/specs/serverless.rs | struct | pub | 162 |  |
| `WorkflowFunction` | apps/agentic-workflow/src/generate/specs/serverless.rs | struct | pub | 42 |  |
| `WorkflowState` | apps/agentic-workflow/src/generate/specs/serverless.rs | struct | pub | 118 |  |
| `generate_serverless_workflow` | apps/agentic-workflow/src/generate/specs/serverless.rs | function | pub | 197 | generate_serverless_workflow(input: &ServerlessWorkflowInput) -> Result<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/specs/serverless.rs -->
```rust
...
/// Function type.
/// @spec apps/agentic-workflow/tech-design/core/generate/specs/serverless.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/specs/serverless.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/specs/serverless.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
