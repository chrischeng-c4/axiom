...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/content/logic.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `FlowEdge` | apps/agentic-workflow/src/generate/diagrams/content/logic.rs | struct | pub | 74 |  |
| `FlowNode` | apps/agentic-workflow/src/generate/diagrams/content/logic.rs | struct | pub | 33 |  |
| `FlowNodeKind` | apps/agentic-workflow/src/generate/diagrams/content/logic.rs | enum | pub | 18 |  |
| `LogicContent` | apps/agentic-workflow/src/generate/diagrams/content/logic.rs | struct | pub | 84 |  |
| `decision_ids` | apps/agentic-workflow/src/generate/diagrams/content/logic.rs | function | pub | 125 | decision_ids(&self) -> Vec<&str> |
| `edges_from` | apps/agentic-workflow/src/generate/diagrams/content/logic.rs | function | pub | 120 | edges_from(&self, node_id: &str) -> Vec<&FlowEdge> |
| `terminal_ids` | apps/agentic-workflow/src/generate/diagrams/content/logic.rs | function | pub | 134 | terminal_ids(&self) -> Vec<&str> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/content/logic.rs -->
````rust
