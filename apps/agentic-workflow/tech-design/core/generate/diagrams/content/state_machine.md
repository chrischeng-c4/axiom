...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/content/state_machine.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `StateKind` | apps/agentic-workflow/src/generate/diagrams/content/state_machine.rs | enum | pub | 18 |  |
| `StateMachineContent` | apps/agentic-workflow/src/generate/diagrams/content/state_machine.rs | struct | pub | 61 |  |
| `StateNode` | apps/agentic-workflow/src/generate/diagrams/content/state_machine.rs | struct | pub | 35 |  |
| `Transition` | apps/agentic-workflow/src/generate/diagrams/content/state_machine.rs | struct | pub | 47 |  |
| `terminal_ids` | apps/agentic-workflow/src/generate/diagrams/content/state_machine.rs | function | pub | 98 | terminal_ids(&self) -> Vec<&str> |
| `transient_ids` | apps/agentic-workflow/src/generate/diagrams/content/state_machine.rs | function | pub | 107 | transient_ids(&self) -> Vec<&str> |
| `transitions_from` | apps/agentic-workflow/src/generate/diagrams/content/state_machine.rs | function | pub | 116 | transitions_from(&self, state_id: &str) -> Vec<&Transition> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/content/state_machine.rs -->
````rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/content/state_machine.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
