...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/content/requirement.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Element` | apps/agentic-workflow/src/generate/diagrams/content/requirement.rs | struct | pub | 82 |  |
| `Relationship` | apps/agentic-workflow/src/generate/diagrams/content/requirement.rs | struct | pub | 106 |  |
| `RelationshipKind` | apps/agentic-workflow/src/generate/diagrams/content/requirement.rs | enum | pub | 93 |  |
| `Requirement` | apps/agentic-workflow/src/generate/diagrams/content/requirement.rs | struct | pub | 65 |  |
| `RequirementContent` | apps/agentic-workflow/src/generate/diagrams/content/requirement.rs | struct | pub | 115 |  |
| `RequirementType` | apps/agentic-workflow/src/generate/diagrams/content/requirement.rs | enum | pub | 18 |  |
| `RiskLevel` | apps/agentic-workflow/src/generate/diagrams/content/requirement.rs | enum | pub | 36 |  |
| `VerifyMethod` | apps/agentic-workflow/src/generate/diagrams/content/requirement.rs | enum | pub | 50 |  |
| `uncovered_ids` | apps/agentic-workflow/src/generate/diagrams/content/requirement.rs | function | pub | 158 | uncovered_ids(&self) -> Vec<&str> |
| `verified_by` | apps/agentic-workflow/src/generate/diagrams/content/requirement.rs | function | pub | 149 | verified_by(&self, element_id: &str) -> Vec<&str> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/content/requirement.rs -->
````rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/content/requirement.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
