...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/requirement_plus/validator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RequirementSeverity` | apps/agentic-workflow/src/generate/diagrams/requirement_plus/validator.rs | enum | pub | 12 |  |
| `RequirementValidationError` | apps/agentic-workflow/src/generate/diagrams/requirement_plus/validator.rs | struct | pub | 20 |  |
| `RequirementValidationResult` | apps/agentic-workflow/src/generate/diagrams/requirement_plus/validator.rs | struct | pub | 30 |  |
| `RequirementValidator` | apps/agentic-workflow/src/generate/diagrams/requirement_plus/validator.rs | struct | pub | 58 |  |
| `new` | apps/agentic-workflow/src/generate/diagrams/requirement_plus/validator.rs | function | pub | 64 | new() -> Self |
| `ok` | apps/agentic-workflow/src/generate/diagrams/requirement_plus/validator.rs | function | pub | 37 | ok() -> Self |
| `strict` | apps/agentic-workflow/src/generate/diagrams/requirement_plus/validator.rs | function | pub | 68 | strict(mut self) -> Self |
| `validate` | apps/agentic-workflow/src/generate/diagrams/requirement_plus/validator.rs | function | pub | 73 | validate(&self, diagram: &RequirementDiagramDef) -> RequirementValidationResult |
| `with_error` | apps/agentic-workflow/src/generate/diagrams/requirement_plus/validator.rs | function | pub | 45 | with_error(mut self, error: RequirementValidationError) -> Self |
| `with_warning` | apps/agentic-workflow/src/generate/diagrams/requirement_plus/validator.rs | function | pub | 51 | with_warning(mut self, warning: RequirementValidationError) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/requirement_plus/validator.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/requirement_plus/validator.md#schema
#[derive(Debug, Clone, serde::Serialize, PartialEq)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/requirement_plus/validator.md#source
