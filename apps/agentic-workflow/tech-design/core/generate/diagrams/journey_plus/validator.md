...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/journey_plus/validator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `JourneySeverity` | apps/agentic-workflow/src/generate/diagrams/journey_plus/validator.rs | enum | pub | 12 |  |
| `JourneyValidationError` | apps/agentic-workflow/src/generate/diagrams/journey_plus/validator.rs | struct | pub | 20 |  |
| `JourneyValidationResult` | apps/agentic-workflow/src/generate/diagrams/journey_plus/validator.rs | struct | pub | 30 |  |
| `JourneyValidator` | apps/agentic-workflow/src/generate/diagrams/journey_plus/validator.rs | struct | pub | 58 |  |
| `new` | apps/agentic-workflow/src/generate/diagrams/journey_plus/validator.rs | function | pub | 64 | new() -> Self |
| `ok` | apps/agentic-workflow/src/generate/diagrams/journey_plus/validator.rs | function | pub | 37 | ok() -> Self |
| `strict` | apps/agentic-workflow/src/generate/diagrams/journey_plus/validator.rs | function | pub | 68 | strict(mut self) -> Self |
| `validate` | apps/agentic-workflow/src/generate/diagrams/journey_plus/validator.rs | function | pub | 73 | validate(&self, journey: &JourneyDef) -> JourneyValidationResult |
| `with_error` | apps/agentic-workflow/src/generate/diagrams/journey_plus/validator.rs | function | pub | 45 | with_error(mut self, error: JourneyValidationError) -> Self |
| `with_warning` | apps/agentic-workflow/src/generate/diagrams/journey_plus/validator.rs | function | pub | 51 | with_warning(mut self, warning: JourneyValidationError) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/journey_plus/validator.rs -->
```rust
