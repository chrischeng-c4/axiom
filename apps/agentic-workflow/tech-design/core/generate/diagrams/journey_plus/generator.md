...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/journey_plus/generator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `JourneyPlusGenerator` | apps/agentic-workflow/src/generate/diagrams/journey_plus/generator.rs | struct | pub | 18 |  |
| `JourneyPlusOutput` | apps/agentic-workflow/src/generate/diagrams/journey_plus/generator.rs | struct | pub | 11 |  |
| `generate` | apps/agentic-workflow/src/generate/diagrams/journey_plus/generator.rs | function | pub | 26 | generate(         &self,         journey: &JourneyDef,         validation: JourneyValidationResult,     ) -> Result<JourneyPlusOutput, String> |
| `generate_mermaid` | apps/agentic-workflow/src/generate/diagrams/journey_plus/generator.rs | function | pub | 64 | generate_mermaid(&self, journey: &JourneyDef) -> Result<String, String> |
| `new` | apps/agentic-workflow/src/generate/diagrams/journey_plus/generator.rs | function | pub | 22 | new() -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/journey_plus/generator.rs -->
````rust
//! Journey+ generator
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/journey_plus/generator.md#schema
#[derive(Debug, Clone, serde::Serialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/journey_plus/generator.md#source
