...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/journey.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `JourneyInput` | apps/agentic-workflow/src/generate/diagrams/journey.rs | struct | pub | 36 |  |
| `JourneySection` | apps/agentic-workflow/src/generate/diagrams/journey.rs | struct | pub | 26 |  |
| `JourneyTask` | apps/agentic-workflow/src/generate/diagrams/journey.rs | struct | pub | 14 |  |
| `generate_journey` | apps/agentic-workflow/src/generate/diagrams/journey.rs | function | pub | 44 | generate_journey(input: &JourneyInput) -> Result<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/journey.rs -->
```rust
...
/// Journey task.
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/journey.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/journey.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/journey.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
