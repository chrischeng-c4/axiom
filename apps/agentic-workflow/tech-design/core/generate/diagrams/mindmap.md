...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/mindmap.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MindmapInput` | apps/agentic-workflow/src/generate/diagrams/mindmap.rs | struct | pub | 65 |  |
| `MindmapNode` | apps/agentic-workflow/src/generate/diagrams/mindmap.rs | struct | pub | 49 |  |
| `MindmapRoot` | apps/agentic-workflow/src/generate/diagrams/mindmap.rs | struct | pub | 35 |  |
| `MindmapShape` | apps/agentic-workflow/src/generate/diagrams/mindmap.rs | enum | pub | 16 |  |
| `generate_mindmap` | apps/agentic-workflow/src/generate/diagrams/mindmap.rs | function | pub | 74 | generate_mindmap(input: &MindmapInput) -> Result<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/mindmap.rs -->
```rust
...
/// Mindmap node shape.
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/mindmap.md#schema
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/mindmap.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/mindmap.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
