...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/flowchart.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DbOperation` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | enum | pub | 96 |  |
| `EdgeSemantic` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | struct | pub | 194 |  |
| `EdgeStyle` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | enum | pub | 64 |  |
| `ErrorSpec` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | struct | pub | 146 |  |
| `FlowDirection` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | enum | pub | 16 |  |
| `FlowchartEdge` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | struct | pub | 222 |  |
| `FlowchartInput` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | struct | pub | 253 |  |
| `FlowchartNode` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | struct | pub | 206 |  |
| `HttpMethod` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | enum | pub | 108 |  |
| `InputSpec` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | struct | pub | 119 |  |
| `NodeSemantic` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | struct | pub | 158 |  |
| `NodeShape` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | enum | pub | 36 |  |
| `OutputSpec` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | struct | pub | 134 |  |
| `SemanticType` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | enum | pub | 78 |  |
| `Subgraph` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | struct | pub | 241 |  |
| `generate_flowchart` | apps/agentic-workflow/src/generate/diagrams/flowchart.rs | function | pub | 268 | generate_flowchart(input: &FlowchartInput) -> Result<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/flowchart.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/flowchart.md#schema
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/flowchart.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/flowchart.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
