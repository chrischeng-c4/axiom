...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/envelope.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Diagram` | apps/agentic-workflow/src/generate/diagrams/envelope.rs | struct | pub | 27 |  |
| `from_yaml` | apps/agentic-workflow/src/generate/diagrams/envelope.rs | function | pub | 40 | from_yaml(value: &serde_yaml::Value) -> Result<Self, serde_yaml::Error> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/envelope.rs -->
````rust
...
// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/envelope.md#source
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/envelope.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/envelope.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
