...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `FlowchartPlusGenerator` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs | struct | pub | 33 |  |
| `FlowchartPlusOutput` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs | struct | pub | 20 |  |
| `generate` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs | function | pub | 41 | generate(         &self,         flowchart: &FlowchartDef,         validation: FlowchartValidationResult,     ) -> Result<FlowchartPlusOutput, String> |
| `generate_mermaid` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs | function | pub | 187 | generate_mermaid(&self, flowchart: &FlowchartDef) -> Result<String, String> |
| `new` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs | function | pub | 36 | new() -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs -->
````rust
//! Flowchart+ generator
//!
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/flowchart_plus/generator.md#schema
#[derive(Debug, Clone, Serialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/flowchart_plus/generator.md#source
