...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/flowchart_plus/validator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `FlowchartSeverity` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/validator.rs | enum | pub | 18 |  |
| `FlowchartValidationError` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/validator.rs | struct | pub | 38 |  |
| `FlowchartValidationResult` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/validator.rs | struct | pub | 26 |  |
| `FlowchartValidator` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/validator.rs | struct | pub | 51 |  |
| `new` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/validator.rs | function | pub | 79 | new() -> Self |
| `ok` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/validator.rs | function | pub | 57 | ok() -> Self |
| `strict` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/validator.rs | function | pub | 83 | strict(mut self) -> Self |
| `validate` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/validator.rs | function | pub | 89 | validate(&self, flowchart: &FlowchartDef) -> FlowchartValidationResult |
| `with_error` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/validator.rs | function | pub | 65 | with_error(mut self, error: FlowchartValidationError) -> Self |
| `with_warning` | apps/agentic-workflow/src/generate/diagrams/flowchart_plus/validator.rs | function | pub | 71 | with_warning(mut self, warning: FlowchartValidationError) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/flowchart_plus/validator.rs -->
```rust
...
/// Error severity.
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/flowchart_plus/validator.md#schema
#[derive(Debug, Clone, Serialize, PartialEq)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/flowchart_plus/validator.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/flowchart_plus/validator.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
