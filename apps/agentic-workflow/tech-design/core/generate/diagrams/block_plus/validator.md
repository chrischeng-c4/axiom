...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/block_plus/validator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `BlockSeverity` | apps/agentic-workflow/src/generate/diagrams/block_plus/validator.rs | enum | pub | 11 |  |
| `BlockValidationError` | apps/agentic-workflow/src/generate/diagrams/block_plus/validator.rs | struct | pub | 18 |  |
| `BlockValidationResult` | apps/agentic-workflow/src/generate/diagrams/block_plus/validator.rs | struct | pub | 27 |  |
| `BlockValidator` | apps/agentic-workflow/src/generate/diagrams/block_plus/validator.rs | struct | pub | 55 |  |
| `new` | apps/agentic-workflow/src/generate/diagrams/block_plus/validator.rs | function | pub | 61 | new() -> Self |
| `ok` | apps/agentic-workflow/src/generate/diagrams/block_plus/validator.rs | function | pub | 34 | ok() -> Self |
| `strict` | apps/agentic-workflow/src/generate/diagrams/block_plus/validator.rs | function | pub | 65 | strict(mut self) -> Self |
| `validate` | apps/agentic-workflow/src/generate/diagrams/block_plus/validator.rs | function | pub | 70 | validate(&self, diagram: &BlockDef) -> BlockValidationResult |
| `with_error` | apps/agentic-workflow/src/generate/diagrams/block_plus/validator.rs | function | pub | 42 | with_error(mut self, error: BlockValidationError) -> Self |
| `with_warning` | apps/agentic-workflow/src/generate/diagrams/block_plus/validator.rs | function | pub | 48 | with_warning(mut self, warning: BlockValidationError) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/block_plus/validator.rs -->
```rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/block_plus/validator.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
