---
id: sdd-block-plus-generator-output
...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/block_plus/generator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `BlockPlusGenerator` | apps/agentic-workflow/src/generate/diagrams/block_plus/generator.rs | struct | pub | 18 |  |
| `BlockPlusOutput` | apps/agentic-workflow/src/generate/diagrams/block_plus/generator.rs | struct | pub | 11 |  |
| `generate` | apps/agentic-workflow/src/generate/diagrams/block_plus/generator.rs | function | pub | 26 | generate(         &self,         diagram: &BlockDef,         validation: BlockValidationResult,     ) -> Result<BlockPlusOutput, String> |
| `generate_mermaid` | apps/agentic-workflow/src/generate/diagrams/block_plus/generator.rs | function | pub | 63 | generate_mermaid(&self, diagram: &BlockDef) -> Result<String, String> |
| `new` | apps/agentic-workflow/src/generate/diagrams/block_plus/generator.rs | function | pub | 22 | new() -> Self |
## Schema
...
definitions:
  BlockPlusOutput:
    ...
    description: Output of the Mermaid Plus block generator.
    properties:
      frontmatter: { type: string }
      diagram: { type: string }
      validation:
        type: object
        x-rust-type: BlockValidationResult
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/block_plus/generator.rs -->
````rust
//! Block+ generator
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/block_plus/generator.md#schema
#[derive(Debug, Clone, serde::Serialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/block_plus/generator.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/block_plus/generator.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
      Source template owns the complete Block+ generator module.
  - action: annotate
    section: schema
