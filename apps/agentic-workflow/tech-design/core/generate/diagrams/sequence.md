...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/sequence.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AltBlock` | apps/agentic-workflow/src/generate/diagrams/sequence.rs | struct | pub | 108 |  |
| `LoopBlock` | apps/agentic-workflow/src/generate/diagrams/sequence.rs | struct | pub | 96 |  |
| `Message` | apps/agentic-workflow/src/generate/diagrams/sequence.rs | struct | pub | 55 |  |
| `MessageType` | apps/agentic-workflow/src/generate/diagrams/sequence.rs | enum | pub | 27 |  |
| `Participant` | apps/agentic-workflow/src/generate/diagrams/sequence.rs | struct | pub | 42 |  |
| `ParticipantType` | apps/agentic-workflow/src/generate/diagrams/sequence.rs | enum | pub | 15 |  |
| `SequenceInput` | apps/agentic-workflow/src/generate/diagrams/sequence.rs | struct | pub | 126 |  |
| `SequenceNote` | apps/agentic-workflow/src/generate/diagrams/sequence.rs | struct | pub | 76 |  |
| `generate_sequence` | apps/agentic-workflow/src/generate/diagrams/sequence.rs | function | pub | 143 | generate_sequence(input: &SequenceInput) -> Result<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/sequence.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/sequence.md#schema
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/sequence.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/sequence.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
