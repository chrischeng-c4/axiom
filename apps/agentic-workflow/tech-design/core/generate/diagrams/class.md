...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/class.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ClassAttribute` | apps/agentic-workflow/src/generate/diagrams/class.rs | struct | pub | 41 |  |
| `ClassDef` | apps/agentic-workflow/src/generate/diagrams/class.rs | struct | pub | 92 |  |
| `ClassInput` | apps/agentic-workflow/src/generate/diagrams/class.rs | struct | pub | 154 |  |
| `ClassMethod` | apps/agentic-workflow/src/generate/diagrams/class.rs | struct | pub | 58 |  |
| `ClassRelationship` | apps/agentic-workflow/src/generate/diagrams/class.rs | struct | pub | 122 |  |
| `MethodParam` | apps/agentic-workflow/src/generate/diagrams/class.rs | struct | pub | 81 |  |
| `Namespace` | apps/agentic-workflow/src/generate/diagrams/class.rs | struct | pub | 144 |  |
| `RelationshipType` | apps/agentic-workflow/src/generate/diagrams/class.rs | enum | pub | 110 |  |
| `Stereotype` | apps/agentic-workflow/src/generate/diagrams/class.rs | enum | pub | 31 |  |
| `Visibility` | apps/agentic-workflow/src/generate/diagrams/class.rs | enum | pub | 15 |  |
| `generate_class_diagram` | apps/agentic-workflow/src/generate/diagrams/class.rs | function | pub | 166 | generate_class_diagram(input: &ClassInput) -> Result<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/class.rs -->
```rust
...
/// Visibility modifier.
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/class.md#schema
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/class.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/class.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
