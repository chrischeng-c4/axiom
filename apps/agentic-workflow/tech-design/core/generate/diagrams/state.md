...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/state.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CompositeState` | apps/agentic-workflow/src/generate/diagrams/state.rs | struct | pub | 63 |  |
| `StateDef` | apps/agentic-workflow/src/generate/diagrams/state.rs | struct | pub | 34 |  |
| `StateInput` | apps/agentic-workflow/src/generate/diagrams/state.rs | struct | pub | 88 |  |
| `StateNote` | apps/agentic-workflow/src/generate/diagrams/state.rs | struct | pub | 75 |  |
| `StateTransition` | apps/agentic-workflow/src/generate/diagrams/state.rs | struct | pub | 50 |  |
| `StateType` | apps/agentic-workflow/src/generate/diagrams/state.rs | enum | pub | 15 |  |
| `generate_state_diagram` | apps/agentic-workflow/src/generate/diagrams/state.rs | function | pub | 106 | generate_state_diagram(input: &StateInput) -> Result<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/state.rs -->
```rust
...
/// State node kind.
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/state.md#schema
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/state.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/state.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
