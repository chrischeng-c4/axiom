...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/erd_plus/validator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ERDSeverity` | apps/agentic-workflow/src/generate/diagrams/erd_plus/validator.rs | enum | pub | 11 |  |
| `ERDValidationError` | apps/agentic-workflow/src/generate/diagrams/erd_plus/validator.rs | struct | pub | 18 |  |
| `ERDValidationResult` | apps/agentic-workflow/src/generate/diagrams/erd_plus/validator.rs | struct | pub | 27 |  |
| `ERDValidator` | apps/agentic-workflow/src/generate/diagrams/erd_plus/validator.rs | struct | pub | 55 |  |
| `new` | apps/agentic-workflow/src/generate/diagrams/erd_plus/validator.rs | function | pub | 61 | new() -> Self |
| `ok` | apps/agentic-workflow/src/generate/diagrams/erd_plus/validator.rs | function | pub | 34 | ok() -> Self |
| `strict` | apps/agentic-workflow/src/generate/diagrams/erd_plus/validator.rs | function | pub | 65 | strict(mut self) -> Self |
| `validate` | apps/agentic-workflow/src/generate/diagrams/erd_plus/validator.rs | function | pub | 70 | validate(&self, erd: &ERDDef) -> ERDValidationResult |
| `with_error` | apps/agentic-workflow/src/generate/diagrams/erd_plus/validator.rs | function | pub | 42 | with_error(mut self, error: ERDValidationError) -> Self |
| `with_warning` | apps/agentic-workflow/src/generate/diagrams/erd_plus/validator.rs | function | pub | 48 | with_warning(mut self, warning: ERDValidationError) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/erd_plus/validator.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/erd_plus/validator.md#schema
#[derive(Debug, Clone, serde::Serialize, PartialEq)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/erd_plus/validator.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/erd_plus/validator.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
