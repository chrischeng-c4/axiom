...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/erd_plus/generator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ERDPlusGenerator` | apps/agentic-workflow/src/generate/diagrams/erd_plus/generator.rs | struct | pub | 28 |  |
| `ERDPlusOutput` | apps/agentic-workflow/src/generate/diagrams/erd_plus/generator.rs | struct | pub | 15 |  |
| `generate` | apps/agentic-workflow/src/generate/diagrams/erd_plus/generator.rs | function | pub | 35 | generate(         &self,         erd: &ERDDef,         validation: ERDValidationResult,     ) -> Result<ERDPlusOutput, String> |
| `generate_mermaid` | apps/agentic-workflow/src/generate/diagrams/erd_plus/generator.rs | function | pub | 160 | generate_mermaid(&self, erd: &ERDDef) -> Result<String, String> |
| `new` | apps/agentic-workflow/src/generate/diagrams/erd_plus/generator.rs | function | pub | 31 | new() -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/erd_plus/generator.rs -->
````rust
//! ERD+ generator
