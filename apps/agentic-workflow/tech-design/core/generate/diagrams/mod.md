...
# Standardized apps/agentic-workflow/src/generate/diagrams/mod.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/generate/diagrams/mod.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `block_plus` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 27 |  |
| `class` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 17 |  |
| `class_plus` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 28 |  |
| `content` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 13 |  |
| `envelope` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 14 |  |
| `erd` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 18 |  |
| `erd_plus` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 29 |  |
| `flowchart` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 19 |  |
| `flowchart_plus` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 30 |  |
| `journey` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 20 |  |
| `journey_plus` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 31 |  |
| `mermaid_plus` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 32 |  |
| `mindmap` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 21 |  |
| `mindmap_plus` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 33 |  |
| `requirement` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 22 |  |
| `requirement_plus` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 34 |  |
| `sequence` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 23 |  |
| `sequence_plus` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 35 |  |
| `state` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 24 |  |
| `state_plus` | apps/agentic-workflow/src/generate/diagrams/mod.rs | module | pub | 36 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/mod.rs -->
```rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/mod.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
