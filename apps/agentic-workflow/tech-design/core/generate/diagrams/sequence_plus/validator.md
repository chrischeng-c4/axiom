...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/sequence_plus/validator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SequenceSeverity` | apps/agentic-workflow/src/generate/diagrams/sequence_plus/validator.rs | enum | pub | 19 |  |
| `SequenceValidationError` | apps/agentic-workflow/src/generate/diagrams/sequence_plus/validator.rs | struct | pub | 39 |  |
| `SequenceValidationResult` | apps/agentic-workflow/src/generate/diagrams/sequence_plus/validator.rs | struct | pub | 27 |  |
| `SequenceValidator` | apps/agentic-workflow/src/generate/diagrams/sequence_plus/validator.rs | struct | pub | 52 |  |
| `new` | apps/agentic-workflow/src/generate/diagrams/sequence_plus/validator.rs | function | pub | 80 | new() -> Self |
| `ok` | apps/agentic-workflow/src/generate/diagrams/sequence_plus/validator.rs | function | pub | 58 | ok() -> Self |
| `strict` | apps/agentic-workflow/src/generate/diagrams/sequence_plus/validator.rs | function | pub | 84 | strict(mut self) -> Self |
| `validate` | apps/agentic-workflow/src/generate/diagrams/sequence_plus/validator.rs | function | pub | 90 | validate(&self, sequence: &SequenceDef) -> SequenceValidationResult |
| `with_error` | apps/agentic-workflow/src/generate/diagrams/sequence_plus/validator.rs | function | pub | 66 | with_error(mut self, error: SequenceValidationError) -> Self |
| `with_warning` | apps/agentic-workflow/src/generate/diagrams/sequence_plus/validator.rs | function | pub | 72 | with_warning(mut self, warning: SequenceValidationError) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/sequence_plus/validator.rs -->
```rust
