...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/erd.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Cardinality` | apps/agentic-workflow/src/generate/diagrams/erd.rs | enum | pub | 61 |  |
| `Entity` | apps/agentic-workflow/src/generate/diagrams/erd.rs | struct | pub | 49 |  |
| `EntityAttribute` | apps/agentic-workflow/src/generate/diagrams/erd.rs | struct | pub | 29 |  |
| `ErdInput` | apps/agentic-workflow/src/generate/diagrams/erd.rs | struct | pub | 92 |  |
| `ErdRelationship` | apps/agentic-workflow/src/generate/diagrams/erd.rs | struct | pub | 75 |  |
| `KeyType` | apps/agentic-workflow/src/generate/diagrams/erd.rs | enum | pub | 14 |  |
| `generate_erd` | apps/agentic-workflow/src/generate/diagrams/erd.rs | function | pub | 101 | generate_erd(input: &ErdInput) -> Result<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/erd.rs -->
```rust
...
/// Attribute key type.
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/erd.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum KeyType {
    /// Primary key.
    #[serde(rename = "PK")]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/erd.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/erd.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
