...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ActionDef` | apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs | struct | pub | 130 |  |
| `ActionRef` | apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs | enum | pub | 45 |  |
| `BlockMigrationResult` | apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs | struct | pub | 246 |  |
| `BlockMigrationStatus` | apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs | enum | pub | 263 |  |
| `GuardDef` | apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs | struct | pub | 119 |  |
| `MigrationAudit` | apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs | struct | pub | 273 |  |
| `MigrationMode` | apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs | enum | pub | 284 |  |
| `MigrationReport` | apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs | struct | pub | 292 |  |
| `StateMachineDef` | apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs | struct | pub | 53 |  |
| `StateNodeDef` | apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs | struct | pub | 74 |  |
| `StateType` | apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs | enum | pub | 16 |  |
| `TransitionDetail` | apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs | struct | pub | 101 |  |
| `TransitionInput` | apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs | enum | pub | 32 |  |
| `to_vec` | apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs | function | pub | 139 | to_vec(&self) -> Vec<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/mermaid_plus/schema.rs -->
```rust
...
/// State node types.
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/mermaid_plus/schema.md#schema
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Default)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/mermaid_plus/schema.md#source
impl ActionRef {
