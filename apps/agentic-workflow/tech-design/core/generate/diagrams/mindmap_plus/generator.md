...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/mindmap_plus/generator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MindmapPlusGenerator` | apps/agentic-workflow/src/generate/diagrams/mindmap_plus/generator.rs | struct | pub | 18 |  |
| `MindmapPlusOutput` | apps/agentic-workflow/src/generate/diagrams/mindmap_plus/generator.rs | struct | pub | 11 |  |
| `generate` | apps/agentic-workflow/src/generate/diagrams/mindmap_plus/generator.rs | function | pub | 26 | generate(         &self,         mindmap: &MindmapDef,         validation: MindmapValidationResult,     ) -> Result<MindmapPlusOutput, String> |
| `generate_mermaid` | apps/agentic-workflow/src/generate/diagrams/mindmap_plus/generator.rs | function | pub | 64 | generate_mermaid(&self, mindmap: &MindmapDef) -> Result<String, String> |
| `new` | apps/agentic-workflow/src/generate/diagrams/mindmap_plus/generator.rs | function | pub | 22 | new() -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/mindmap_plus/generator.rs -->
````rust
//! Mindmap+ generator
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/mindmap_plus/generator.md#schema
#[derive(Debug, Clone, serde::Serialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/mindmap_plus/generator.md#source
