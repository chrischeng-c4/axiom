...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/requirement.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DesignElement` | apps/agentic-workflow/src/generate/diagrams/requirement.rs | struct | pub | 77 |  |
| `ReqRelationship` | apps/agentic-workflow/src/generate/diagrams/requirement.rs | struct | pub | 107 |  |
| `ReqRelationshipType` | apps/agentic-workflow/src/generate/diagrams/requirement.rs | enum | pub | 94 |  |
| `RequirementDef` | apps/agentic-workflow/src/generate/diagrams/requirement.rs | struct | pub | 60 |  |
| `RequirementInput` | apps/agentic-workflow/src/generate/diagrams/requirement.rs | struct | pub | 120 |  |
| `RequirementType` | apps/agentic-workflow/src/generate/diagrams/requirement.rs | enum | pub | 15 |  |
| `RiskLevel` | apps/agentic-workflow/src/generate/diagrams/requirement.rs | enum | pub | 34 |  |
| `VerificationMethod` | apps/agentic-workflow/src/generate/diagrams/requirement.rs | enum | pub | 46 |  |
| `generate_requirement_diagram` | apps/agentic-workflow/src/generate/diagrams/requirement.rs | function | pub | 132 | generate_requirement_diagram(input: &RequirementInput) -> Result<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/requirement.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/requirement.md#schema
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/requirement.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/requirement.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
...
- [overview] Round 1 findings were wrong. The reviser correctly pushed back and added a clarifying paragraph documenting the codegen convention: fields listed in `required:` with `x-serde-default: true` emit bare `Vec<T>` + `#[serde(default)]` (not `Option<Vec<T>>`), while fields omitted from `required:` are auto-wrapped as `Option<T>`. This is consistent with the already-merged sibling specs and the rust-schema generator in `apps/agentic-workflow/src/generate/gen/rust/schema.rs`. The schema and changes sections are correct and unchanged.
