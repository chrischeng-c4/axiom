...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/state_plus/schema.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ActionDef` | apps/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | struct | pub | 130 |  |
| `ActionRef` | apps/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | enum | pub | 45 |  |
| `GuardDef` | apps/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | struct | pub | 119 |  |
| `StateMachineDef` | apps/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | struct | pub | 53 |  |
| `StateNodeDef` | apps/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | struct | pub | 74 |  |
| `StateType` | apps/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | enum | pub | 16 |  |
| `TransitionDetail` | apps/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | struct | pub | 101 |  |
| `TransitionInput` | apps/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | enum | pub | 32 |  |
| `to_vec` | apps/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | function | pub | 139 | to_vec(&self) -> Vec<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/state_plus/schema.rs -->
```rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/diagrams/state_plus/schema.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
