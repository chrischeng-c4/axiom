...
Public API manifest for `apps/agentic-workflow/src/generate/diagrams/state_plus/generator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MermaidPlusGenerator` | apps/agentic-workflow/src/generate/diagrams/state_plus/generator.rs | struct | pub | 32 |  |
| `MermaidPlusOutput` | apps/agentic-workflow/src/generate/diagrams/state_plus/generator.rs | struct | pub | 19 |  |
| `generate` | apps/agentic-workflow/src/generate/diagrams/state_plus/generator.rs | function | pub | 40 | generate(         &self,         machine: &StateMachineDef,         validation: ValidationResult,     ) -> Result<MermaidPlusOutput, String> |
| `generate_mermaid` | apps/agentic-workflow/src/generate/diagrams/state_plus/generator.rs | function | pub | 90 | generate_mermaid(&self, machine: &StateMachineDef) -> Result<String, String> |
| `new` | apps/agentic-workflow/src/generate/diagrams/state_plus/generator.rs | function | pub | 35 | new() -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/diagrams/state_plus/generator.rs -->
````rust
//! Mermaid+ generator
//!
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/state_plus/generator.md#schema
#[derive(Debug, Clone, Serialize)]
...
/// @spec apps/agentic-workflow/tech-design/core/generate/diagrams/state_plus/generator.md#source
