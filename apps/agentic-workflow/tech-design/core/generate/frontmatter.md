...
Public API manifest for `apps/agentic-workflow/src/generate/frontmatter.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MermaidPlusBlock` | apps/agentic-workflow/src/generate/frontmatter.rs | struct | pub | 32 |  |
| `extract_mermaid_plus_blocks` | apps/agentic-workflow/src/generate/frontmatter.rs | function | pub | 51 | extract_mermaid_plus_blocks(content: &str) -> Vec<MermaidPlusBlock> |
| `parse_mermaid_block` | apps/agentic-workflow/src/generate/frontmatter.rs | function | pub | 142 | parse_mermaid_block(block_content: &str) -> Option<(Value, String)> |
| `parse_section_type_annotation` | apps/agentic-workflow/src/generate/frontmatter.rs | function | pub | 133 | parse_section_type_annotation(comment: &str) -> Option<String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/frontmatter.rs -->
~~~rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/frontmatter.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
