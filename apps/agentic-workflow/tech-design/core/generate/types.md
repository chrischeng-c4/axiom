---
id: sdd-generate-types-rust-config
...
# RustConfig + RustTypeTranslator Types

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/generate/types.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AbstractType` | apps/agentic-workflow/src/generate/types.rs | enum | pub | 23 |  |
| `RustConfig` | apps/agentic-workflow/src/generate/types.rs | struct | pub | 75 |  |
| `RustTypeTranslator` | apps/agentic-workflow/src/generate/types.rs | struct | pub | 95 |  |
| `derive_attr` | apps/agentic-workflow/src/generate/types.rs | function | pub | 320 | derive_attr(&self) -> String |
| `has_serde_derives` | apps/agentic-workflow/src/generate/types.rs | function | pub | 285 | has_serde_derives(&self) -> bool |
| `merge_overrides` | apps/agentic-workflow/src/generate/types.rs | function | pub | 292 | merge_overrides(&self, frontmatter: &serde_yaml::Value) -> Self |
| `parse_abstract_type` | apps/agentic-workflow/src/generate/types.rs | function | pub | 135 | parse_abstract_type(s: &str) -> Result<AbstractType, String> |
| `serde_rename_attr` | apps/agentic-workflow/src/generate/types.rs | function | pub | 338 | serde_rename_attr(&self) -> String |
| `vis_prefix` | apps/agentic-workflow/src/generate/types.rs | function | pub | 350 | vis_prefix(&self) -> String |
## Schema
...
definitions:
  RustConfig:
    type: object
    required: [derives, serde_rename_strategy, visibility, derive_hash, derive_copy]
    ...
    properties:
      derives:
        ...
        x-serde-default: "default_rust_derives"
        description: "Top-level derives applied to generated structs/enums."
      serde_rename_strategy:
        type: string
        x-serde-default: "default_serde_rename"
        description: "Serde `rename_all` strategy applied container-level."
      visibility:
        type: string
        x-serde-default: "default_visibility"
        description: "Visibility prefix for generated items."
      derive_hash:
        type: boolean
        x-serde-default: true
        description: "Whether to add Hash to derive list."
      derive_copy:
        type: boolean
        x-serde-default: true
        description: "Whether to add Copy to derive list."
    x-rust-struct:
  ...
  RustTypeTranslator:
    ...
    required: []
    properties: {}
    description: Translates abstract types to Rust type expressions.
    x-rust-struct:
      derive: []
      unit: true
```
...
<!-- source-snapshot: path=apps/agentic-workflow/src/generate/types.rs -->
```rust
...
// @spec apps/agentic-workflow/tech-design/core/generate/types.md#source
...
/// @spec apps/agentic-workflow/tech-design/core/generate/types.md#schema
#[derive(Debug, Clone, Serialize, Deserialize)]
...
```yaml
changes:
  - path: apps/agentic-workflow/src/generate/types.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
      Source template owns the complete abstract type and Rust config module.
  - action: annotate
    section: schema
...
- [overview] 2 types: serde-config struct + unit translator.
- [schema] Each RustConfig field uses x-serde-default with a helper fn name (string form).
- [changes] Standard split; AbstractType enum stays hand-written until externally-tagged enum support lands.
