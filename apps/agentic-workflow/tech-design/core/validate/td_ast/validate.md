...
Public API manifest for `apps/agentic-workflow/src/td_ast/validate.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TdError` | apps/agentic-workflow/src/td_ast/validate.rs | struct | pub | 60 |  |
| `TdErrorCode` | apps/agentic-workflow/src/td_ast/validate.rs | enum | pub | 38 |  |
| `validate_td` | apps/agentic-workflow/src/td_ast/validate.rs | function | pub | 104 | validate_td(ast: &TDAst) -> Vec<TdError> |
| `validate_td_full` | apps/agentic-workflow/src/td_ast/validate.rs | function | pub | 126 | validate_td_full(     ast: &TDAst,     spec_content: &str,     project_root: Option<&std::path::Path>, ) -> Vec<TdError> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/td_ast/validate.rs -->
````rust
//! Cross-section semantic validation over a parsed [`TDAst`].
//!
//! Implements the five checks specified in
//! `apps/agentic-workflow/tech-design/core/validate/td_ast/validate.md`:
//!
...
//!
//! @spec apps/agentic-workflow/tech-design/core/validate/td_ast/validate.md#schema
//! @spec apps/agentic-workflow/tech-design/core/validate/td_ast/validate.md#logic
...
fn check_orphan_changes_targets(ast: &TDAst) -> Vec<TdError> {
    ...
    for target in targets {
        // Targets in changes are file paths (e.g. `apps/agentic-workflow/src/foo.rs`);
...
/// @spec apps/agentic-workflow/tech-design/core/validate/td_ast/validate.md#source
impl TDAst {
