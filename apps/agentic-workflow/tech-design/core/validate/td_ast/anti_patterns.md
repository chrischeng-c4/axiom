...
# TD AST Anti-Pattern Detectors

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/td_ast/anti_patterns.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `check_content_anti_patterns` | apps/agentic-workflow/src/td_ast/anti_patterns.rs | function | pub | 31 | check_content_anti_patterns(ast: &TDAst, spec_content: &str) -> Vec<TdError> |
| `check_filesystem_anti_patterns` | apps/agentic-workflow/src/td_ast/anti_patterns.rs | function | pub | 42 | check_filesystem_anti_patterns(     ast: &TDAst,     spec_content: &str,     project_root: &Path, ) -> Vec<TdError> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/td_ast/anti_patterns.rs -->
````rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/td_ast/anti_patterns.rs
    action: modify
    section: source
    impl_mode: codegen
    description: >
      Promote the anti-pattern detector pipeline into a source template so the
      full file is regenerable while preserving the existing AP-001, AP-004,
      AP-008, AP-009, and AP-010 checks and tests.
```
