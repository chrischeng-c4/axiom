---
id: projects-sdd-src-validate-rules-section_format-rs
...
# Standardized apps/agentic-workflow/src/validate/rules/section_format.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/validate/rules/section_format.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DEFAULT_LOOKAHEAD` | apps/agentic-workflow/src/validate/rules/section_format.rs | constant | pub | 29 |  |
| `PLACEHOLDER_MARKER` | apps/agentic-workflow/src/validate/rules/section_format.rs | constant | pub | 34 |  |
| `SectionFormatRule` | apps/agentic-workflow/src/validate/rules/section_format.rs | struct | pub | 40 |  |
| `check_section_format` | apps/agentic-workflow/src/validate/rules/section_format.rs | function | pub | 67 | check_section_format(spec_path: &Path, content: &str, lookahead: usize) -> Vec<Finding> |
## Source
...
//! `apps/agentic-workflow/tech-design/core/validate/section-format-rule.md`:
//!
...
///
/// @spec apps/agentic-workflow/tech-design/core/validate/section-format-rule.md#logic
...
mod tests {
    ...
    fn run_with_config(content: &str, config: &str) -> RuleReport {
        ...
        let spec = tmp
            .path()
            .join("apps/agentic-workflow/tech-design/surface/specs/demo.md");
        let mut r = RuleReport::new();
