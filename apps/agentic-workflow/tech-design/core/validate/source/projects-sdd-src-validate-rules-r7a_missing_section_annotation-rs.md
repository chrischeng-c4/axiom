...
# Standardized apps/agentic-workflow/src/validate/rules/r7a_missing_section_annotation.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/validate/rules/r7a_missing_section_annotation.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MissingSectionAnnotationRule` | apps/agentic-workflow/src/validate/rules/r7a_missing_section_annotation.rs | struct | pub | 16 |  |
## Source
