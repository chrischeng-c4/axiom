---
id: projects-sdd-src-validate-rules-r6a_loose_root_file-rs
...
# Standardized apps/agentic-workflow/src/validate/rules/r6a_loose_root_file.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/validate/rules/r6a_loose_root_file.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `LooseRootFileRule` | apps/agentic-workflow/src/validate/rules/r6a_loose_root_file.rs | struct | pub | 20 |  |
| `is_codegen_fixture_spec` | apps/agentic-workflow/src/validate/rules/r6a_loose_root_file.rs | function | pub | 141 | is_codegen_fixture_spec(content: &str) -> bool |
| `locate_in_crate_spec_root` | apps/agentic-workflow/src/validate/rules/r6a_loose_root_file.rs | function | pub | 82 | locate_in_crate_spec_root(spec_path: &Path) -> Option<(String, String)> |
## Source
...
/// @spec apps/agentic-workflow/tech-design/core/validate/source/projects-sdd-src-validate-rules-r6a_loose_root_file-rs.md#source
...
impl Rule for LooseRootFileRule {
    ...
    fn check(&self, spec_path: &Path, content: &str, report: &mut RuleReport) {
        ...
        // Loose .md at crate spec root, e.g. apps/agentic-workflow/foo.md
        ...
        // Loose file directly under interfaces/, e.g. apps/agentic-workflow/interfaces/foo.md
...
mod tests {
    ...
    fn loose_md_at_crate_root_flagged() {
        let r = run("apps/agentic-workflow/tech-design/core/state.md");
    ...
    fn configured_base_crate_root_flagged() {
        let r = run("docs/td/apps/agentic-workflow/state.md");
        assert_eq!(r.findings.len(), 1);
        assert!(r.findings[0].message.contains("state.md"));
    }
    ...
    fn readme_at_crate_root_is_ok() {
        let r = run("apps/agentic-workflow/tech-design/core/README.md");
        assert!(r.is_empty());
    }

    #[test]
    fn file_inside_canonical_subdir_is_ok() {
        let r = run("apps/agentic-workflow/tech-design/core/logic/state.md");
        assert!(r.is_empty());
    }

    #[test]
    fn loose_file_directly_under_interfaces_flagged() {
        let r = run("apps/agentic-workflow/tech-design/core/interfaces/commands.md");
        assert_eq!(r.findings.len(), 1);
    ...
    fn absolute_host_projects_prefix_uses_inner_project_root() {
        let r = run(
            "/Users/chrischeng/projects/cclab/project-aw/apps/agentic-workflow/tech-design/core/state.md",
        );
        assert_eq!(r.findings.len(), 1);
        assert_eq!(r.findings[0].rule, RuleId::LooseRootFile);
        assert!(r.findings[0].message.contains("state.md"));
    ...
    fn absolute_host_projects_prefix_keeps_canonical_subdir_clean() {
        let r = run(
            "/Users/chrischeng/projects/cclab/project-aw/apps/agentic-workflow/tech-design/core/logic/state.md",
        );
        assert!(r.is_empty());
    }
    ...
    fn absolute_host_projects_prefix_rejects_direct_interfaces_file() {
        let r = run(
            "/Users/chrischeng/projects/cclab/project-aw/apps/agentic-workflow/tech-design/core/interfaces/commands.md",
        );
        assert_eq!(r.findings.len(), 1);
        assert!(r.findings[0].message.contains("interfaces/commands.md"));
    }
    ...
    fn file_under_interface_protocol_subdir_is_ok() {
        let r = run("apps/agentic-workflow/tech-design/core/interfaces/cli/commands.md");
        assert!(r.is_empty());
    }

    #[test]
    fn project_specs_path_is_not_checked() {
        let r = run("apps/agentic-workflow/tech-design/surface/specs/foo.md");
        assert!(r.is_empty());
    }
