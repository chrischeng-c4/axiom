...
# Standardized apps/agentic-workflow/src/validate/rules/r7b_format_priority_violation.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/validate/rules/r7b_format_priority_violation.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `FormatPriorityViolationRule` | apps/agentic-workflow/src/validate/rules/r7b_format_priority_violation.rs | struct | pub | 47 |  |
## Source
...
/// @spec apps/agentic-workflow/tech-design/core/validate/source/projects-sdd-src-validate-rules-r7b_format_priority_violation-rs.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/validate/rules/r7b_format_priority_violation.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
