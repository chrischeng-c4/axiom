...
# Standardized apps/agentic-workflow/src/validate/rules/r3b_nullable_required.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/validate/rules/r3b_nullable_required.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `NullableRequiredRule` | apps/agentic-workflow/src/validate/rules/r3b_nullable_required.rs | struct | pub | 269 |  |
| `YamlBlock` | apps/agentic-workflow/src/validate/rules/r3b_nullable_required.rs | struct | pub | 126 |  |
| `extract_yaml_blocks` | apps/agentic-workflow/src/validate/rules/r3b_nullable_required.rs | function | pub | 132 | extract_yaml_blocks(content: &str) -> Vec<YamlBlock> |
## Source
...
/// @spec apps/agentic-workflow/tech-design/core/validate/rules/r3b_nullable_required.md#schema
