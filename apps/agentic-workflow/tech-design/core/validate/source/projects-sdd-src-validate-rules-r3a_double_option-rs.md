...
# Standardized apps/agentic-workflow/src/validate/rules/r3a_double_option.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/validate/rules/r3a_double_option.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DoubleOptionRule` | apps/agentic-workflow/src/validate/rules/r3a_double_option.rs | struct | pub | 168 |  |
## Source
...
/// @spec apps/agentic-workflow/tech-design/core/validate/rules/r3a_double_option.md#schema
