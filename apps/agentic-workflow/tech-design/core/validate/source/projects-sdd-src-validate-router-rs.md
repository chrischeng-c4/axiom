---
id: projects-sdd-src-validate-router-rs
...
# Standardized apps/agentic-workflow/src/validate/router.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/validate/router.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `PathShape` | apps/agentic-workflow/src/validate/router.rs | enum | pub | 20 |  |
| `classify` | apps/agentic-workflow/src/validate/router.rs | function | pub | 31 | classify(target: &str, project_root: &Path) -> PathShape |
| `resolve_spec_files` | apps/agentic-workflow/src/validate/router.rs | function | pub | 56 | resolve_spec_files(shape: &PathShape) -> std::io::Result<Vec<PathBuf>> |
## Source
...
//!   CRRR commit-gate path. Owned by `apps/agentic-workflow/cli/src/td.rs`; this
...
/// @spec apps/agentic-workflow/tech-design/core/validate/router.md#schema
...
mod tests {
    ...
    fn prefix_with_slash() {
        let root = PathBuf::from("/repo");
        match classify("apps/agentic-workflow/tech-design/core", &root) {
            PathShape::Prefix(p) => {
                assert_eq!(p, PathBuf::from("/repo/apps/agentic-workflow/tech-design/core"));
            }
...
```yaml
changes:
  - path: apps/agentic-workflow/src/validate/router.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
