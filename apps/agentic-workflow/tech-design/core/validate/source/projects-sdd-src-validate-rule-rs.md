---
id: projects-sdd-src-validate-rule-rs
...
# Standardized apps/agentic-workflow/src/validate/rule.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/validate/rule.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Finding` | apps/agentic-workflow/src/validate/rule.rs | struct | pub | 287 |  |
| `RuleId` | apps/agentic-workflow/src/validate/rule.rs | enum | pub | 193 |  |
| `RuleReport` | apps/agentic-workflow/src/validate/rule.rs | struct | pub | 334 |  |
| `Severity` | apps/agentic-workflow/src/validate/rule.rs | enum | pub | 277 |  |
| `category` | apps/agentic-workflow/src/validate/rule.rs | function | pub | 64 | category(&self) -> &'static str |
| `error` | apps/agentic-workflow/src/validate/rule.rs | function | pub | 307 | error(rule: RuleId, file: impl Into<PathBuf>, message: impl Into<String>) -> Self |
| `extend` | apps/agentic-workflow/src/validate/rule.rs | function | pub | 112 | extend(&mut self, other: RuleReport) |
| `format` | apps/agentic-workflow/src/validate/rule.rs | function | pub | 43 | format(&self) -> String |
| `has_errors` | apps/agentic-workflow/src/validate/rule.rs | function | pub | 117 | has_errors(&self) -> bool |
| `is_empty` | apps/agentic-workflow/src/validate/rule.rs | function | pub | 121 | is_empty(&self) -> bool |
| `new` | apps/agentic-workflow/src/validate/rule.rs | function | pub | 104 | new() -> Self |
| `push` | apps/agentic-workflow/src/validate/rule.rs | function | pub | 108 | push(&mut self, f: Finding) |
| `short` | apps/agentic-workflow/src/validate/rule.rs | function | pub | 251 | short(&self) -> &'static str |
| `slug` | apps/agentic-workflow/src/validate/rule.rs | function | pub | 93 | slug(&self) -> &'static str |
| `with_line` | apps/agentic-workflow/src/validate/rule.rs | function | pub | 319 | with_line(mut self, line: usize) -> Self |
| `with_path` | apps/agentic-workflow/src/validate/rule.rs | function | pub | 325 | with_path(mut self, path: impl Into<String>) -> Self |
## Source
...
//! `apps/agentic-workflow/tech-design/core/validate/rule.md` and live inside the
...
/// @spec apps/agentic-workflow/tech-design/core/validate/source/projects-sdd-src-validate-rule-rs.md#source
impl Finding {
...
/// @spec apps/agentic-workflow/tech-design/core/validate/rule.md#schema
...
/// @spec apps/agentic-workflow/tech-design/core/validate/rule.md#schema.impls
impl RuleId {
...
```yaml
changes:
  - path: apps/agentic-workflow/src/validate/rule.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
