---
id: projects-sdd-src-validate-rules-r3e_impl_mode_misuse-rs
...
# Standardized apps/agentic-workflow/src/validate/rules/r3e_impl_mode_misuse.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/validate/rules/r3e_impl_mode_misuse.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ImplModeMisuseRule` | apps/agentic-workflow/src/validate/rules/r3e_impl_mode_misuse.rs | struct | pub | 194 |  |
## Source
...
/// @spec apps/agentic-workflow/tech-design/core/validate/source/projects-sdd-src-validate-rules-r3e_impl_mode_misuse-rs.md#source
...
/// @spec apps/agentic-workflow/tech-design/core/validate/rules/r3e_impl_mode_misuse.md#schema
