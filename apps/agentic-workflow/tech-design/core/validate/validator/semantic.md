...
Public API manifest for `apps/agentic-workflow/src/validator/semantic.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SemanticValidator` | apps/agentic-workflow/src/validator/semantic.rs | struct | pub | 13 |  |
| `new` | apps/agentic-workflow/src/validator/semantic.rs | function | pub | 21 | new(rules: ValidationRules) -> Self |
| `validate` | apps/agentic-workflow/src/validator/semantic.rs | function | pub | 26 | validate(&self, file_path: &Path) -> ValidationResult |
| `validate_batch` | apps/agentic-workflow/src/validator/semantic.rs | function | pub | 370 | validate_batch(&self, file_paths: &[PathBuf]) -> ValidationResult |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/validator/semantic.rs -->
~~~rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/validator/semantic.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
