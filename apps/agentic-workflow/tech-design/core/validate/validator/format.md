...
Public API manifest for `apps/agentic-workflow/src/validator/format.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SpecFormatValidator` | apps/agentic-workflow/src/validator/format.rs | struct | pub | 12 |  |
| `new` | apps/agentic-workflow/src/validator/format.rs | function | pub | 20 | new(rules: ValidationRules) -> Self |
| `validate` | apps/agentic-workflow/src/validator/format.rs | function | pub | 33 | validate(&self, file_path: &Path) -> ValidationResult |
| `validate_with_type` | apps/agentic-workflow/src/validator/format.rs | function | pub | 25 | validate_with_type(&self, file_path: &Path, doc_type: DocumentType) -> ValidationResult |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/validator/format.rs -->
~~~rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/validate/validator/format.md#source
// CODEGEN-BEGIN
use crate::models::{
...
/// @spec apps/agentic-workflow/tech-design/core/validate/validator/format.md#schema
pub struct SpecFormatValidator {
    /// Validation rules from config.
    rules: ValidationRules,
}

/// @spec apps/agentic-workflow/tech-design/core/validate/validator/format.md#changes
...
/// @spec apps/agentic-workflow/tech-design/core/validate/validator/format.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/validator/format.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
