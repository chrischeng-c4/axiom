...
Public API manifest for `apps/agentic-workflow/src/validator/fix.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AutoFixer` | apps/agentic-workflow/src/validator/fix.rs | struct | pub | 15 |  |
| `FixResult` | apps/agentic-workflow/src/validator/fix.rs | struct | pub | 23 |  |
| `fix_errors` | apps/agentic-workflow/src/validator/fix.rs | function | pub | 44 | fix_errors(&self, errors: &[ValidationError]) -> Result<FixResult> |
| `new` | apps/agentic-workflow/src/validator/fix.rs | function | pub | 37 | new(project_root: impl Into<PathBuf>) -> Self |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/validator/fix.rs -->
```rust
...
/// Auto-fixer for validation errors.
/// @spec apps/agentic-workflow/tech-design/core/validate/validator/fix.md#schema
...
/// @spec apps/agentic-workflow/tech-design/core/validate/validator/fix.md#changes
impl AutoFixer {
...
```yaml
changes:
  - path: apps/agentic-workflow/src/validator/fix.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
