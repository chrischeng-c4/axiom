...
Public API manifest for `apps/agentic-workflow/src/validator/schema.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DocumentType` | apps/agentic-workflow/src/validator/schema.rs | enum | pub | 17 |  |
| `SchemaValidator` | apps/agentic-workflow/src/validator/schema.rs | struct | pub | 32 |  |
| `from_filename` | apps/agentic-workflow/src/validator/schema.rs | function | pub | 53 | from_filename(filename: &str) -> Option<Self> |
| `from_type_field` | apps/agentic-workflow/src/validator/schema.rs | function | pub | 72 | from_type_field(type_field: &str) -> Option<Self> |
| `new` | apps/agentic-workflow/src/validator/schema.rs | function | pub | 90 | new(schemas_dir: impl Into<std::path::PathBuf>) -> Self |
| `schema_filename` | apps/agentic-workflow/src/validator/schema.rs | function | pub | 42 | schema_filename(&self) -> &'static str |
| `validate_content` | apps/agentic-workflow/src/validator/schema.rs | function | pub | 141 | validate_content(&mut self, content: &str, file_path: &Path) -> ValidationResult |
| `validate_file` | apps/agentic-workflow/src/validator/schema.rs | function | pub | 117 | validate_file(&mut self, file_path: &Path) -> ValidationResult |
| `validate_frontmatter_content` | apps/agentic-workflow/src/validator/schema.rs | function | pub | 332 | validate_frontmatter_content(     content: &str,     doc_type: DocumentType,     project_root: &Path, ) -> ValidationResult |
| `validate_frontmatter_schema` | apps/agentic-workflow/src/validator/schema.rs | function | pub | 324 | validate_frontmatter_schema(file_path: &Path, project_root: &Path) -> ValidationResult |
| `validate_required_fields` | apps/agentic-workflow/src/validator/schema.rs | function | pub | 273 | validate_required_fields(         &self,         frontmatter: &serde_yaml::Value,         doc_type: DocumentType,         file_path: &Path,     ) -> ValidationResult |
## Schema
...
definitions:
  DocumentType:
    type: string
    enum: [Proposal, Tasks, Spec, Challenge, State]
    description: SDD document types validated by schema.
    x-rust-enum:
      derive: [Debug, Clone, Copy, PartialEq, Eq, Hash]
      variants:
        - { name: Proposal, doc: "Proposal document." }
        - { name: Tasks, doc: "Tasks document." }
        - { name: Spec, doc: "Spec document." }
        - { name: Challenge, doc: "Challenge document." }
        - { name: State, doc: "State document." }

  SchemaValidator:
    type: object
    required: [schemas_dir, validators]
    description: Schema validator for frontmatter.
    properties:
      schemas_dir:
        type: string
      ...
      validators:
        type: object
        x-rust-type: "std::collections::HashMap<DocumentType, Validator>"
        x-rust-visibility: private
        description: "Cached compiled validators."
    x-rust-struct:
      derive: []
```
...
<!-- source-snapshot: path=apps/agentic-workflow/src/validator/schema.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/core/validate/validator/schema.md#schema
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
...
/// @spec apps/agentic-workflow/tech-design/core/validate/validator/schema.md#changes
impl DocumentType {
...
/// @spec apps/agentic-workflow/tech-design/core/validate/validator/schema.md#source
...
mod tests {
    ...
    fn test_detect_document_type_type_field_precedence() {
        ...
        // filename says apps/agentic-workflow/tech-design/core/tools/spec.md but type field says proposal — type field wins
...
```yaml
changes:
  - path: apps/agentic-workflow/src/validator/schema.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
