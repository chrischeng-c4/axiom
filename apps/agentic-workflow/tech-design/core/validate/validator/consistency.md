...
Public API manifest for `apps/agentic-workflow/src/validator/consistency.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ConsistencyValidator` | apps/agentic-workflow/src/validator/consistency.rs | struct | pub | 23 |  |
| `is_reference_error` | apps/agentic-workflow/src/validator/consistency.rs | function | pub | 369 | is_reference_error(&self) -> bool |
| `new` | apps/agentic-workflow/src/validator/consistency.rs | function | pub | 56 | new(change_dir: impl Into<PathBuf>) -> Self |
| `validate_all` | apps/agentic-workflow/src/validator/consistency.rs | function | pub | 63 | validate_all(&self) -> ValidationResult |
| `validate_proposal_spec_alignment` | apps/agentic-workflow/src/validator/consistency.rs | function | pub | 196 | validate_proposal_spec_alignment(&self) -> Result<Vec<ValidationError>> |
| `validate_spec_hierarchy` | apps/agentic-workflow/src/validator/consistency.rs | function | pub | 297 | validate_spec_hierarchy(&self) -> Result<Vec<ValidationError>> |
| `validate_task_dependencies` | apps/agentic-workflow/src/validator/consistency.rs | function | pub | 205 | validate_task_dependencies(&self) -> Result<Vec<ValidationError>> |
| `validate_task_spec_refs` | apps/agentic-workflow/src/validator/consistency.rs | function | pub | 89 | validate_task_spec_refs(&self) -> Result<Vec<ValidationError>> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/validator/consistency.rs -->
~~~rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/validator/consistency.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
