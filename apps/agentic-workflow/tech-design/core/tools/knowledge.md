...
# Standardized apps/agentic-workflow/src/tools/knowledge.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/tools/knowledge.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `execute_write_main_spec` | apps/agentic-workflow/src/tools/knowledge.rs | function | pub | 46 | execute_write_main_spec(args: &Value, project_root: &Path) -> Result<String> |
| `write_main_spec_definition` | apps/agentic-workflow/src/tools/knowledge.rs | function | pub | 17 | write_main_spec_definition() -> ToolDefinition |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/tools/knowledge.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
