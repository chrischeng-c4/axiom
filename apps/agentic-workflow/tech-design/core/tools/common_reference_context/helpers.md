---
id: sdd-tools-common-reference-context-helpers-source
...
# Common Reference Context Helpers Source

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/tools/common_reference_context.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `GroupSubState` | apps/agentic-workflow/src/tools/common_reference_context.rs | enum | pub | 21 |  |
| `build_already_filled_summary` | apps/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 162 | build_already_filled_summary(content: &str, filled_sections: &[String]) -> String |
| `extract_specs_from_prose` | apps/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 372 | extract_specs_from_prose(prose: &str) -> Vec<serde_json::Value> |
| `generate_section_loop_skeleton` | apps/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 226 | generate_section_loop_skeleton(     change_id: &str,     group_id: &str,     sections: &[&str], ) -> String |
| `is_create_complete` | apps/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 135 | is_create_complete(content: &str) -> bool |
| `mark_group_done` | apps/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 110 | mark_group_done(_change_dir: &Path, _group_id: &str) -> Result<()> |
| `read_fill_sections` | apps/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 121 | read_fill_sections(content: &str) -> Vec<String> |
| `read_filled_sections` | apps/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 129 | read_filled_sections(content: &str) -> Vec<String> |
| `render_specs_markdown` | apps/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 498 | render_specs_markdown(     change_id: &str,     group_id: &str,     date: &str,     specs: &[Value],     spec_plan: Option<&Vec<Value>>, ) -> String |
| `replace_ref_ctx_section` | apps/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 256 | replace_ref_ctx_section(content: &str, section: &str, new_content: &str) -> String |
| `resolve_next_group` | apps/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 42 | resolve_next_group(change_dir: &Path) -> Result<GroupSubState> |
| `resolve_next_section` | apps/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 151 | resolve_next_section(content: &str) -> Option<String> |
| `verify_artifact_written` | apps/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 355 | verify_artifact_written(change_dir: &Path, group_id: &str) -> bool |
| `write_spec_plan_yaml` | apps/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 583 | write_spec_plan_yaml(group_dir: &Path, plan_entries: &[Value]) -> crate::Result<()> |
## Source
...
// @spec apps/agentic-workflow/tech-design/core/logic/reference-context.md#R1
...
// @spec apps/agentic-workflow/tech-design/core/logic/reference-context.md#R4
...
// @spec apps/agentic-workflow/tech-design/core/logic/reference-context.md#R5
...
```yaml
changes:
  - path: apps/agentic-workflow/src/tools/common_reference_context.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
      - "<handwrite-tracker:projects-sdd-src-tools-common-reference-context-rs-helpers>"
    description: "Reference-context helper functions and regression tests."
```
