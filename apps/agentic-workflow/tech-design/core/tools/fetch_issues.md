...
# Standardized apps/agentic-workflow/src/tools/fetch_issues.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/tools/fetch_issues.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `definition` | apps/agentic-workflow/src/tools/fetch_issues.rs | function | pub | 29 | definition() -> ToolDefinition |
| `execute` | apps/agentic-workflow/src/tools/fetch_issues.rs | function | pub | 61 | execute(args: &Value, project_root: &Path) -> Result<String> |
| `list_issues_by_labels` | apps/agentic-workflow/src/tools/fetch_issues.rs | function | pub | 657 | list_issues_by_labels(     labels: &[String],     repo: Option<&str>,     project_root: Option<&Path>, ) -> Result<Vec<u64>> |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/tools/fetch_issues.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
