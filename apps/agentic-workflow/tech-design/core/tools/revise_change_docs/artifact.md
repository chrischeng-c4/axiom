...
Public API manifest for `apps/agentic-workflow/src/tools/revise_change_docs.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `artifact_definition` | apps/agentic-workflow/src/tools/revise_change_docs.rs | function | pub | 46 | artifact_definition() -> ToolDefinition |
| `execute_artifact` | apps/agentic-workflow/src/tools/revise_change_docs.rs | function | pub | 157 | execute_artifact(args: &Value, project_root: &Path) -> Result<String> |
| `execute_workflow` | apps/agentic-workflow/src/tools/revise_change_docs.rs | function | pub | 96 | execute_workflow(args: &Value, project_root: &Path) -> Result<String> |
| `workflow_definition` | apps/agentic-workflow/src/tools/revise_change_docs.rs | function | pub | 21 | workflow_definition() -> ToolDefinition |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/tools/revise_change_docs.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
