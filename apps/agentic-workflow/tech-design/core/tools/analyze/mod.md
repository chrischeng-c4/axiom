...
# Standardized apps/agentic-workflow/src/tools/analyze/mod.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/tools/analyze/mod.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AnalysisResult` | apps/agentic-workflow/src/tools/analyze/mod.rs | struct | pub | 98 |  |
| `ClassInfo` | apps/agentic-workflow/src/tools/analyze/mod.rs | struct | pub | 79 |  |
| `FieldInfo` | apps/agentic-workflow/src/tools/analyze/mod.rs | struct | pub | 90 |  |
| `FunctionInfo` | apps/agentic-workflow/src/tools/analyze/mod.rs | struct | pub | 58 |  |
| `ParamInfo` | apps/agentic-workflow/src/tools/analyze/mod.rs | struct | pub | 70 |  |
| `definition` | apps/agentic-workflow/src/tools/analyze/mod.rs | function | pub | 21 | definition() -> ToolDefinition |
| `execute` | apps/agentic-workflow/src/tools/analyze/mod.rs | function | pub | 106 | execute(args: &Value, project_root: &Path) -> Result<String> |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/tools/analyze/mod.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
      - "<handwrite-tracker:apps/agentic-workflow/tech-design/core/tools/analyze/mod.md#changes>"
