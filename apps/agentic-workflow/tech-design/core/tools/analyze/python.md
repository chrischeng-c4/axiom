...
# Standardized apps/agentic-workflow/src/tools/analyze/python.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/tools/analyze/python.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `analyze` | apps/agentic-workflow/src/tools/analyze/python.rs | function | pub | 10 | analyze(source: &str) -> Result<AnalysisResult> |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/tools/analyze/python.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
