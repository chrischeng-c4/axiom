...
# Standardized apps/agentic-workflow/src/tools/read.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/tools/read.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `definition` | apps/agentic-workflow/src/tools/read.rs | function | pub | 16 | definition() -> ToolDefinition |
| `execute` | apps/agentic-workflow/src/tools/read.rs | function | pub | 44 | execute(args: &Value, project_root: &Path) -> Result<String> |
## Source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/tools/read.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
