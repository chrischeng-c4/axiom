...
Public API manifest for `apps/agentic-workflow/src/tools/common_change_spec.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ALL_SECTIONS` | apps/agentic-workflow/src/tools/common_change_spec.rs | constant | pub | 285 |  |
| `SpecSubState` | apps/agentic-workflow/src/tools/common_change_spec.rs | enum | pub | 439 |  |
| `UNIVERSAL_SKELETON` | apps/agentic-workflow/src/tools/common_change_spec.rs | constant | pub | 30 |  |
| `fill_section_base_name` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 1281 | fill_section_base_name(s: &str) -> &str |
| `find_spec_path` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 343 | find_spec_path(change_dir: &std::path::Path, spec_id: &str) -> std::path::PathBuf |
| `generate_skeleton` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 770 | generate_skeleton(     spec_id: &str,     title: &str,     main_spec_ref: Option<&str>,     merge_strategy: Option<&str>,     project_root: &Path, ) -> String |
| `get_primary_specs_dir` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 369 | get_primary_specs_dir(change_dir: &std::path::Path) -> std::path::PathBuf |
| `get_spec_path` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 329 | get_spec_path(     change_dir: &std::path::Path,     group_id: Option<&str>,     spec_id: &str, ) -> std::path::PathBuf |
| `get_specs_dir` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 320 | get_specs_dir(change_dir: &std::path::Path, group_id: Option<&str>) -> std::path::PathBuf |
| `is_create_complete` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 1344 | is_create_complete(content: &str) -> bool |
| `is_fill_section_optional` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 1287 | is_fill_section_optional(s: &str) -> bool |
| `parse_fill_section` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 1272 | parse_fill_section(s: &str) -> (&str, bool) |
| `prune_todo_sections` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 1091 | prune_todo_sections(content: &str) -> String |
| `read_fill_sections` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 1171 | read_fill_sections(content: &str) -> Vec<String> |
| `read_filled_sections` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 1218 | read_filled_sections(content: &str) -> Vec<String> |
| `read_main_spec_ref` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 1295 | read_main_spec_ref(content: &str) -> Option<String> |
| `replace_section` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 911 | replace_section(content: &str, section: &str, new_content: &str) -> String |
| `resolve_group_id_for_spec` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 395 | resolve_group_id_for_spec(change_dir: &std::path::Path, spec_id: &str) -> Option<String> |
| `resolve_next_spec` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 463 | resolve_next_spec(change_dir: &Path, change_id: &str) -> Result<SpecSubState> |
| `strip_change_spec_fields` | apps/agentic-workflow/src/tools/common_change_spec.rs | function | pub | 1324 | strip_change_spec_fields(content: &str) -> String |
## Source
...
// @spec apps/agentic-workflow/tech-design/core/logic/spec-format-unification.md#R6
// @spec apps/agentic-workflow/tech-design/core/logic/spec-format-unification.md#R7
// @spec apps/agentic-workflow/tech-design/core/logic/spec-format-unification.md#R8
...
// @spec apps/agentic-workflow/tech-design/core/logic/spec-structure.md#R2
...
/// @spec apps/agentic-workflow/tech-design/core/tools/common_change_spec/preamble.md#source
