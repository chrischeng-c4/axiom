...
# Standardized apps/agentic-workflow/src/tools/state_update.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/tools/state_update.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `definition` | apps/agentic-workflow/src/tools/state_update.rs | function | pub | 17 | definition() -> ToolDefinition |
| `execute` | apps/agentic-workflow/src/tools/state_update.rs | function | pub | 71 | execute(args: &Value, project_root: &Path) -> Result<String> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/tools/state_update.rs -->
```rust
...
```yaml
changes:
  - path: apps/agentic-workflow/src/tools/state_update.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
