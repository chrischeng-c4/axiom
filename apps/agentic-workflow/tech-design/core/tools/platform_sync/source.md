...
Public API manifest for `apps/agentic-workflow/src/tools/platform_sync.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `definition` | apps/agentic-workflow/src/tools/platform_sync.rs | function | pub | 16 | definition() -> ToolDefinition |
| `execute` | apps/agentic-workflow/src/tools/platform_sync.rs | function | pub | 42 | execute(args: &Value, project_root: &Path) -> Result<String> |
## Source
