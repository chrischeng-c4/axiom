---
id: projects-sdd-src-tools-review-change-impl-rs
...
# Standardized apps/agentic-workflow/src/tools/review_change_impl.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/tools/review_change_impl.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `artifact_definition` | apps/agentic-workflow/src/tools/review_change_impl.rs | function | pub | 45 | artifact_definition() -> ToolDefinition |
| `execute_artifact` | apps/agentic-workflow/src/tools/review_change_impl.rs | function | pub | 152 | execute_artifact(args: &Value, project_root: &Path) -> Result<String> |
| `execute_workflow` | apps/agentic-workflow/src/tools/review_change_impl.rs | function | pub | 115 | execute_workflow(args: &Value, project_root: &Path) -> Result<String> |
| `workflow_definition` | apps/agentic-workflow/src/tools/review_change_impl.rs | function | pub | 22 | workflow_definition() -> ToolDefinition |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=apps/agentic-workflow/src/tools/review_change_impl.rs -->
~~~rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/core/tools/review_change_impl.md#source
// CODEGEN-BEGIN
...
/// @spec apps/agentic-workflow/tech-design/core/tools/review_change_impl.md#source
...
mod tests {
    ...
    async fn test_review_checklist_includes_test_plan_item() {
        ...
        assert!(
            ...
            "Prompt should reference Test Plan section"
        );
        assert!(
...
```yaml
changes:
  - path: apps/agentic-workflow/src/tools/review_change_impl.rs
    action: modify
    section: source
    impl_mode: codegen
    description: "Change implementation review workflow and artifact tools."
```
