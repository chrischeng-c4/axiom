...
Public API manifest for `apps/agentic-workflow/src/tools/phase_transition.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `parse_phase` | apps/agentic-workflow/src/tools/phase_transition.rs | function | pub | 14 | parse_phase(s: &str) -> Result<StatePhase> |
| `phase_order` | apps/agentic-workflow/src/tools/phase_transition.rs | function | pub | 133 | phase_order(phase: &StatePhase) -> u8 |
| `phase_to_string` | apps/agentic-workflow/src/tools/phase_transition.rs | function | pub | 109 | phase_to_string(phase: &StatePhase) -> &'static str |
| `validate_transition` | apps/agentic-workflow/src/tools/phase_transition.rs | function | pub | 164 | validate_transition(from: &StatePhase, to: &StatePhase) -> Result<()> |
## Source
