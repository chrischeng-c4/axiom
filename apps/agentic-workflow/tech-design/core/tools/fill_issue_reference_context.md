---
id: projects-sdd-src-tools-fill-issue-reference-context-rs
...
# Standardized apps/agentic-workflow/src/tools/fill_issue_reference_context.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/tools/fill_issue_reference_context.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `artifact_definition` | apps/agentic-workflow/src/tools/fill_issue_reference_context.rs | function | pub | 48 | artifact_definition() -> ToolDefinition |
| `execute_artifact` | apps/agentic-workflow/src/tools/fill_issue_reference_context.rs | function | pub | 129 | execute_artifact(args: &Value, project_root: &Path) -> Result<String> |
| `execute_workflow` | apps/agentic-workflow/src/tools/fill_issue_reference_context.rs | function | pub | 84 | execute_workflow(args: &Value, project_root: &Path) -> Result<String> |
| `workflow_definition` | apps/agentic-workflow/src/tools/fill_issue_reference_context.rs | function | pub | 24 | workflow_definition() -> ToolDefinition |
## Source
...
// @spec apps/agentic-workflow/tech-design/core/logic/reference-context.md#R2
...
```yaml
changes:
  - path: apps/agentic-workflow/src/tools/fill_issue_reference_context.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
      - "<handwrite-tracker:projects-sdd-src-tools-fill-issue-reference-context-rs>"
    description: "Issue Reference Context section-loop workflow and artifact tools."
```
