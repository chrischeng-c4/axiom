...
Public API manifest for `apps/agentic-workflow/src/tools/spec_plan.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SpecPlanEntry` | apps/agentic-workflow/src/tools/spec_plan.rs | struct | pub | 203 |  |
| `deduplicate_spec_plans` | apps/agentic-workflow/src/tools/spec_plan.rs | function | pub | 262 | deduplicate_spec_plans(change_dir: &Path) -> Result<()> |
| `prepare_specs_from_plan` | apps/agentic-workflow/src/tools/spec_plan.rs | function | pub | 319 | prepare_specs_from_plan(change_dir: &Path, project_root: &Path) -> Result<Vec<String>> |
| `suggest_sections` | apps/agentic-workflow/src/tools/spec_plan.rs | function | pub | 51 | suggest_sections(requirements: &str) -> Vec<String> |
## Source
