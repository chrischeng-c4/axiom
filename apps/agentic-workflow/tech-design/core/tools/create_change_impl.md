...
# Standardized apps/agentic-workflow/src/tools/create_change_impl.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/tools/create_change_impl.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `artifact_definition` | apps/agentic-workflow/src/tools/create_change_impl.rs | function | pub | 46 | artifact_definition() -> ToolDefinition |
| `execute_artifact` | apps/agentic-workflow/src/tools/create_change_impl.rs | function | pub | 348 | execute_artifact(args: &Value, project_root: &Path) -> Result<String> |
| `execute_workflow` | apps/agentic-workflow/src/tools/create_change_impl.rs | function | pub | 83 | execute_workflow(args: &Value, project_root: &Path) -> Result<String> |
| `parse_test_plan_count` | apps/agentic-workflow/src/tools/create_change_impl.rs | function | pub | 869 | parse_test_plan_count(spec_content: &str) -> Option<usize> |
| `workflow_definition` | apps/agentic-workflow/src/tools/create_change_impl.rs | function | pub | 21 | workflow_definition() -> ToolDefinition |
## Source
...
/// @spec apps/agentic-workflow/tech-design/core/tools/create_change_impl.md#source
...
```yaml
changes:
  - path: apps/agentic-workflow/src/tools/create_change_impl.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
