...
Public API manifest for `apps/agentic-workflow/src/tools/review.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `definition` | apps/agentic-workflow/src/tools/review.rs | function | pub | 40 | definition() -> ToolDefinition |
| `execute` | apps/agentic-workflow/src/tools/review.rs | function | pub | 135 | execute(args: &Value, project_root: &Path) -> Result<String> |
## Source
