...
description: >
  Extends the `cb` namespace (@spec apps/agentic-workflow/tech-design/surface/specs/aw-cb-fill-crrr.md#cli) with two new
    ...
    subcommands:
        ...
        flags:
          ...
          - name: non-interactive
            ...
            description: >
              ...
              CI contexts. Follows @spec apps/agentic-workflow/tech-design/surface/specs/score-recovery-verbs-non-interactive.md#cli.
          - name: json
            type: boolean
            default: false
      ...
      fill:
        description: >
          ...
          (@spec apps/agentic-workflow/tech-design/surface/specs/aw-cb-fill-crrr.md#cli, @spec apps/agentic-workflow/tech-design/surface/specs/score-cb-fill-workflow.md#cli).
        args:
          - name: slug
            required: true
            type: string
...
definitions:
  IssuePhase:
    ...
    description: >
      ...
      Extends @spec apps/agentic-workflow/tech-design/surface/specs/aw-cb-fill-crrr.md#schema IssuePhase.
    enum:
      - td_inited
      - td_created
      - td_reviewed
  ...
  LifecycleTrailer:
    ...
    description: >
      ...
      Extends @spec apps/agentic-workflow/tech-design/surface/specs/aw-cb-fill-crrr.md#schema LifecycleTrailer.
    enum:
      - TdInit
      - TdCreate
      - TdValidate
...
```yaml
changes:
  # ── Phase enum (apps/agentic-workflow) ─────────────────────────────────────────────
  - path: apps/agentic-workflow/src/issues/phase.rs
    action: modify
    section: logic
  ...
  # ── Lifecycle trailer registry (apps/agentic-workflow) ─────────────────────────────
  - path: apps/agentic-workflow/src/issues/lifecycle_trailer.rs
    action: modify
  ...
  # ── CLI verbs: cb.rs (apps/agentic-workflow) ───────────────────────────────
  ...
  # ── Integration tests ────────────────────────────────────────────────────
  - path: apps/agentic-workflow/tests/cb_review_revise_test.rs
    action: create
    section: test-plan
    impl_mode: hand-written
    description: >
  ...
  # ── Spec file ─────────────────────────────────────────────────────────────
  - path: apps/agentic-workflow/tech-design/surface/specs/score-cb-review-revise-crrr.md
    action: create
    section: logic
    impl_mode: hand-written
