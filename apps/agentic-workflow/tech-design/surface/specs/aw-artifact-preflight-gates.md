...
Public API manifest for `apps/agentic-workflow/src/models/preflight.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `PreFlightEvidence` | apps/agentic-workflow/src/models/preflight.rs | struct | pub | 58 |  |
| `PreFlightEvidenceKind` | apps/agentic-workflow/src/models/preflight.rs | enum | pub | 18 |  |
| `PreFlightEvidenceStatus` | apps/agentic-workflow/src/models/preflight.rs | enum | pub | 30 |  |
| `PreFlightGate` | apps/agentic-workflow/src/models/preflight.rs | struct | pub | 48 |  |
| `PreFlightGateReport` | apps/agentic-workflow/src/models/preflight.rs | struct | pub | 76 |  |
| `PreFlightGateResult` | apps/agentic-workflow/src/models/preflight.rs | struct | pub | 67 |  |
| `PreFlightGateSeverity` | apps/agentic-workflow/src/models/preflight.rs | enum | pub | 10 |  |
| `PreFlightGateStatus` | apps/agentic-workflow/src/models/preflight.rs | enum | pub | 39 |  |
| `blocks_production` | apps/agentic-workflow/src/models/preflight.rs | function | pub | 177 | blocks_production(&self) -> bool |
| `default_preflight_gates` | apps/agentic-workflow/src/models/preflight.rs | function | pub | 193 | default_preflight_gates(artifact_kind: ArtifactKind) -> Vec<PreFlightGate> |
| `evaluate` | apps/agentic-workflow/src/models/preflight.rs | function | pub | 86 | evaluate(         artifact_ref: impl Into<String>,         gates: &[PreFlightGate],         evidence: &[PreFlightEvidence],     ) -> Self |
| `production_blockers` | apps/agentic-workflow/src/models/preflight.rs | function | pub | 182 | production_blockers(&self) -> &[String] |
| `quality_warnings` | apps/agentic-workflow/src/models/preflight.rs | function | pub | 187 | quality_warnings(&self) -> &[String] |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/models/preflight.rs -->
```rust
