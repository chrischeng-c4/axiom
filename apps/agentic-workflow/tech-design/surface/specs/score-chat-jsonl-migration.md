...
# T1-T6: filter-rule unit tests (inherited from apps/agentic-workflow/tech-design/surface/specs/score-chat-listen-filter.md)
...
changes:
  ...
  - path: apps/agentic-workflow/src/cli/chat/helpers.rs
    action: modify
    section: cli
    impl_mode: hand-written
    description: |
      ...
      hand_written_blocks:
        - functions: [parse_channel]
          handwrite_marker: |
            ...
            // HANDWRITE-END
          spec_anchors: ["@spec apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#schema (ChannelMessage)"]

        - functions: [run_post]
          handwrite_marker: |
            // HANDWRITE-BEGIN reason: codegen lacks O_APPEND atomic-line-write primitive (#append-line-atomic).
            // HANDWRITE-END
          spec_anchors: ["@spec apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#interaction (post sequence)"]
        ...
        - functions: [run_listen, TailGuard]
          handwrite_marker: |
            ...
            // HANDWRITE-END
          spec_anchors: ["@spec apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#logic (listen branch / tail_spawn node)"]
        ...
        - functions: [should_emit, thread_root_of]
          handwrite_marker: |
            ...
            // HANDWRITE-END
          spec_anchors: ["@spec apps/agentic-workflow/tech-design/surface/specs/score-chat-listen-filter.md#logic (should_emit flowchart)"]
  ...
  - path: apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md
    ...
    description: |
      ...
      that are obsoleted by the JSONL migration in apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md.
