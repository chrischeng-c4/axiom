...
$id: score-chat-msg-members-schema
description: |
  Extended data shapes for the `aw chat` verb. Extends apps/agentic-workflow/tech-design/surface/specs/score-chat.md.
...
definitions:
  ...
  PostArgsV2:
    ...
    description: |
      ...
      Extends PostArgs from apps/agentic-workflow/tech-design/surface/specs/score-chat.md.
    properties:
      to:
        type: array
        items:
