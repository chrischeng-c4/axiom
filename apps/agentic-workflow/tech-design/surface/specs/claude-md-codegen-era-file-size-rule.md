...
tests:
  - name: generated-file-no-longer-flagged
    kind: manual
    description: >
      After merge, verify that `apps/agentic-workflow/src/models/change.rs` (1011 lines,
    ...
    steps:
      - step: Open `apps/agentic-workflow/src/models/change.rs` and confirm it contains
