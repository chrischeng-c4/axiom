...
definitions:
  ...
  Issue:
    type: object
    description: >
      Existing Issue struct (apps/agentic-workflow/src/issues/types.rs).
...
changes:
  - path: apps/agentic-workflow/src/issues/types.rs
    ...
    description: >
      ...
      `apps/agentic-workflow/tech-design/core/issues/types.md#schema` so the primary
  ...
  - path: apps/agentic-workflow/src/cli/codegen.rs
    action: modify
    section: logic
    impl_mode: hand-written
    description: >
