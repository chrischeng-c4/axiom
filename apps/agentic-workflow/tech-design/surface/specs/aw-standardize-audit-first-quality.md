...
|------|--------|------|------------|------|-----------|
| `StandardizeCommand::Audit` | apps/agentic-workflow/src/cli/standardize.rs | enum variant | pub | 46 | Audit(StandardizeAuditArgs) |
| `StandardizeAuditArgs` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 59 |  |
| `StandardizeAuditCommand` | apps/agentic-workflow/src/cli/standardize.rs | enum | pub | 66 |  |
| `StandardizeAuditCheckArgs` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 75 |  |
| `StandardizeAuditRecordArgs` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 88 |  |
| `StandardizeActionKind::AuditRequired` | apps/agentic-workflow/src/cli/standardize.rs | enum variant | pub | 516 | AuditRequired |
| `PreservationSurfaceKind` | apps/agentic-workflow/src/cli/standardize_audit.rs | enum | pub(crate) | 11 |  |
| `PreservationSurface` | apps/agentic-workflow/src/cli/standardize_audit.rs | struct | pub(crate) | 23 |  |
| `ModernizationRisk` | apps/agentic-workflow/src/cli/standardize_audit.rs | enum | pub(crate) | 31 |  |
| `SafeModernizationLever` | apps/agentic-workflow/src/cli/standardize_audit.rs | struct | pub(crate) | 38 |  |
| `PreservationAudit` | apps/agentic-workflow/src/cli/standardize_audit.rs | struct | pub(crate) | 44 |  |
| `StandardizeAuditDecision` | apps/agentic-workflow/src/cli/standardize_audit.rs | struct | pub(crate) | 53 |  |
| `audit_path` | apps/agentic-workflow/src/cli/standardize_audit.rs | function | pub(crate) | 59 | audit_path(project_root: &Path, project: &str) -> PathBuf |
| `evaluate_audit_decision` | apps/agentic-workflow/src/cli/standardize_audit.rs | function | pub(crate) | 65 | evaluate_audit_decision(project_root: &Path, project: &str, scopes: &[String], action_kind: StandardizeActionKind) -> StandardizeAuditDecision |
| `fixture_audit` | apps/agentic-workflow/src/cli/standardize_audit.rs | function | pub(crate) | 81 | fixture_audit(project: &str, scopes: &[String]) -> PreservationAudit |
...
evidence:
  source_tests:
    - apps/agentic-workflow/src/cli/standardize_audit.rs
  cli_smoke:
...
```yaml
changes:
  - path: apps/agentic-workflow/tech-design/surface/specs/aw-standardize-audit-first-quality.md
    action: create
    section: schema
