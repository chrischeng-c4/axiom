...
commands:
  cb:
    ...
    subcommands:
      ...
      # Phase 3 marker-fill verb. See apps/agentic-workflow/tech-design/surface/specs/score-cb-fill-workflow.md for full schema.
...
changes:
  ...
  - path: apps/agentic-workflow/tests/cb_namespace_test.rs
    action: create
    section: test-plan
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/tests/td_check_test.rs
    action: create
    section: test-plan
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/tests/deprecation_alias_test.rs
    action: create
    section: test-plan
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/tests/phase_migration_test.rs
    action: create
    section: test-plan
    impl_mode: hand-written
    description: >
