...
authors: [score]
related:
  - apps/agentic-workflow/tech-design/surface/specs/score-namespaces.md
  - apps/agentic-workflow/tech-design/surface/specs/score-cb-fill-workflow.md
  - apps/agentic-workflow/tech-design/surface/specs/score-cb-review-revise-crrr.md
...
This prevents migration states like `sdd` moving from `apps/agentic-workflow` to
`apps/agentic-workflow` while config still says `apps/agentic-workflow/**` from reporting
...
requirements:
  - id: r_invariant_definition
    statement: >
      ...
      apps/agentic-workflow/CLAUDE.md, and referenced from the root CLAUDE.md
...
elements:
  ...
  - id: t_stale_scope_replaced_by_same_project_discovery
    ...
    description: >
      ...
      `apps/agentic-workflow/**`, create only `apps/agentic-workflow/Cargo.toml` and
      `apps/agentic-workflow/src/lib.rs`, then assert resolved scopes contain
      `apps/agentic-workflow/**` and not `apps/agentic-workflow/**`.
---
```
...
changes:
  ...
  - path: apps/agentic-workflow/tests/standardize_test.rs
    action: modify
    section: test-plan
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/templates/mainthread/skills/score-standardize-run/SKILL.md
    action: modify
    section: logic
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/src/cli/standardize.rs
    ...
    description: >
      ...
      projects such as sdd (`apps/agentic-workflow` -> `apps/agentic-workflow`) from
  ...
  - path: apps/agentic-workflow/src/cli/standardize.rs
    ...
    description: >
      ...
      declares `sdd` at `apps/agentic-workflow/**`, the repo contains only
      `apps/agentic-workflow/**`, and default scope resolution returns
  ...
  - path: apps/agentic-workflow/src/cli/audit_coverage.rs
    action: create
    section: interaction
    impl_mode: hand-written
    description: >
      ...
      Carries @spec apps/agentic-workflow/tech-design/surface/specs/score-standardization.md#logic/standardize-driver-tick.
  ...
  - path: apps/agentic-workflow/tests/audit_coverage_test.rs
    action: create
    section: test-plan
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/CLAUDE.md
    ...
    description: >
      ...
      gaps as "missing — see apps/agentic-workflow/tech-design/surface/specs/score-standardization.md#changes". Add
  ...
  - path: CLAUDE.md
    ...
    description: >
      ...
      apps/agentic-workflow/tech-design/surface/specs/score-standardization.md
