...
changes:
  ...
  - path: apps/agentic-workflow/tech-design/core/interfaces/models/section.md
    action: modify
    section: schema
    impl_mode: hand-written
    description: Extend the SectionMeta contract to include optional annotation attributes.
  - path: apps/agentic-workflow/tech-design/core/interfaces/spec_alignment/models.md
    action: modify
    section: schema
    impl_mode: hand-written
