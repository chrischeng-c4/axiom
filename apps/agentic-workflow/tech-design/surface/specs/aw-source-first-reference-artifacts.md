...
|------|--------|------|------------|------|-----------|
| `SourceReferenceKind` | apps/agentic-workflow/src/models/source_reference.rs | enum | pub | 7 |  |
| `SourceReferenceAvailability` | apps/agentic-workflow/src/models/source_reference.rs | enum | pub | 18 |  |
| `SourceFailureMode` | apps/agentic-workflow/src/models/source_reference.rs | enum | pub | 27 |  |
| `SourceReferenceRequirement` | apps/agentic-workflow/src/models/source_reference.rs | struct | pub | 35 |  |
| `SourceReferencePolicy` | apps/agentic-workflow/src/models/source_reference.rs | struct | pub | 45 |  |
| `SourceReference` | apps/agentic-workflow/src/models/source_reference.rs | struct | pub | 53 |  |
| `SourceReviewSeverity` | apps/agentic-workflow/src/models/source_reference.rs | enum | pub | 70 |  |
| `SourceReviewFinding` | apps/agentic-workflow/src/models/source_reference.rs | struct | pub | 78 |  |
| `SourceReferenceReview` | apps/agentic-workflow/src/models/source_reference.rs | struct | pub | 86 |  |
| `evaluate_source_references` | apps/agentic-workflow/src/models/source_reference.rs | function | pub | 93 | evaluate_source_references(policy: &SourceReferencePolicy, references: &[SourceReference], implementation_citations: &[String]) -> SourceReferenceReview |
...
evidence:
  source_tests:
    - apps/agentic-workflow/src/models/source_reference.rs
---
requirementDiagram
...
```yaml
changes:
  - path: apps/agentic-workflow/tech-design/surface/specs/aw-source-first-reference-artifacts.md
    action: create
    section: schema
