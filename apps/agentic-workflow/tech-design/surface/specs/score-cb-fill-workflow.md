...
> actor moves. See `apps/agentic-workflow/tech-design/surface/specs/aw-mainthread-only-execution.md`.
>
...
> but the ephemeral `/tmp/aw` issue projection is missing, `aw cb fill`
...
> canonical command selected by the goal phase router executable after local
> runtime-state loss.
...
description: >
  ...
  established by Phase 1 (@spec apps/agentic-workflow/tech-design/surface/specs/score-namespaces.md#cli).
...
definitions:
  ...
  IssuePhase:
    ...
    description: >
      ...
      Extends @spec apps/agentic-workflow/tech-design/surface/specs/score-namespaces.md#schema IssuePhase and
      @spec apps/agentic-workflow/tech-design/surface/specs/score-namespaces.md#schema IssuePhase.
    enum:
      - td_inited
      - td_created
      - td_reviewed
  ...
  LifecycleTrailer:
    ...
    description: >
      ...
      Extends @spec apps/agentic-workflow/tech-design/surface/specs/score-namespaces.md#schema LifecycleTrailer and
      @spec apps/agentic-workflow/tech-design/surface/specs/score-namespaces.md#schema LifecycleTrailer.
    enum:
      - TdInit
      - TdCreate
      - TdValidate
...
changes:
  ...
  - path: apps/agentic-workflow/templates/mainthread/skills/score-cb-handwriter/SKILL.md
    action: create
    section: logic
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/src/issues/lifecycle.rs
    action: modify
  ...
  - path: apps/agentic-workflow/src/worktree.rs
    action: modify
    section: logic
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/templates/mainthread/skills/score-td-init/SKILL.md
    action: modify
    section: logic
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/templates/mainthread/skills/score-td-create/SKILL.md
    action: modify
    section: logic
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/templates/mainthread/skills/tdc-handwrite/SKILL.md
    action: modify
    section: logic
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/tech-design/surface/specs/score-namespaces.md
    action: modify
    section: logic
    impl_mode: hand-written
    description: >
      ...
      Reference this spec (@spec apps/agentic-workflow/tech-design/surface/specs/score-cb-fill-workflow.md#cli) for full argument
