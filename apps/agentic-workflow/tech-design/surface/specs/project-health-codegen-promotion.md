...
```yaml
changes:
  - path: apps/agentic-workflow/tech-design/surface/generate/project-health-source.md
    action: create
    impl_mode: codegen
    section: source
    description: "Canonical source TD for apps/agentic-workflow/src/cli/project.rs using source-from-target strip-handwrite."
  - path: apps/agentic-workflow/tech-design/surface/generate/project-health-test-source.md
    action: create
    impl_mode: codegen
    section: source
    description: "Canonical source TD for apps/agentic-workflow/tests/cli/tests/project_health_test.rs using source-from-target strip-handwrite."
