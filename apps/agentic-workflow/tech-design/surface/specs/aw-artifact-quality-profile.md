...
Public API manifest for `apps/agentic-workflow/src/models/artifact_quality.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ArtifactKind` | apps/agentic-workflow/src/models/artifact_quality.rs | enum | pub | 8 |  |
| `ArtifactQualityProfile` | apps/agentic-workflow/src/models/artifact_quality.rs | struct | pub | 141 |  |
| `ArtifactSourceMode` | apps/agentic-workflow/src/models/artifact_quality.rs | enum | pub | 174 |  |
| `ArtifactSourcePolicy` | apps/agentic-workflow/src/models/artifact_quality.rs | struct | pub | 163 |  |
| `PreflightGateSet` | apps/agentic-workflow/src/models/artifact_quality.rs | struct | pub | 186 |  |
| `QualityDial` | apps/agentic-workflow/src/models/artifact_quality.rs | struct | pub | 154 |  |
| `default_for_kind` | apps/agentic-workflow/src/models/artifact_quality.rs | function | pub | 195 | default_for_kind(artifact_kind: ArtifactKind) -> Self |
| `infer_artifact_kind_from_hint` | apps/agentic-workflow/src/models/artifact_quality.rs | function | pub | 20 | infer_artifact_kind_from_hint(hint: &str) -> ArtifactKind |
| `neutral_default` | apps/agentic-workflow/src/models/artifact_quality.rs | function | pub | 312 | neutral_default() -> Self |
| `to_review_prompt_context` | apps/agentic-workflow/src/models/artifact_quality.rs | function | pub | 348 | to_review_prompt_context(&self) -> String |
| `validate` | apps/agentic-workflow/src/models/artifact_quality.rs | function | pub | 331 | validate(&self) -> Result<(), String> |
## Schema
...
<!-- source-snapshot: path=apps/agentic-workflow/src/models/artifact_quality.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/surface/specs/aw-artifact-quality-profile.md#logic
