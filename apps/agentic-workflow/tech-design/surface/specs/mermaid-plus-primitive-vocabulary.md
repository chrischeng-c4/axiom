...
definitions:
  ...
  PrimitiveRegistry:
    ...
    description: >
      ...
      apps/agentic-workflow/src/generate/generators/primitive_registry.rs.
    properties:
      entries:
        type: object
...
changes:
  ...
  - path: apps/agentic-workflow/src/generate/generators/logic_primitive_emitter.rs
    action: create
    section: logic
    impl_mode: hand-written
    description: >
  ...
  - path: apps/agentic-workflow/src/generate/generators/primitive_registry_tests.rs
    action: create
    section: tests
    impl_mode: hand-written
    description: >
