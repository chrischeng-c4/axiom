---
id: score-proposal
fill_sections: [overview, source, schema, changes]
capability_refs:
...
# ProposalCommands Type

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/cli/proposal.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ProposalCommands` | apps/agentic-workflow/src/cli/proposal.rs | enum | pub | 16 |  |
| `run` | apps/agentic-workflow/src/cli/proposal.rs | function | pub | 31 | run(cmd: ProposalCommands) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/proposal.rs -->
```rust
...
/// @spec apps/agentic-workflow/tech-design/surface/commands/proposal.md#schema
#[derive(Subcommand)]
...
/// @spec apps/agentic-workflow/tech-design/surface/commands/proposal.md#source
...
definitions:
  ProposalCommands:
    type: string
    enum: [Create, Review]
    description: Available subcommands for `score proposal`.
    x-rust-enum:
      derive: [Subcommand]
      variants:
        - name: Create
          kind: struct
          doc: "Create a new proposal from JSON file."
          fields:
            - { name: change_id, rust_type: String }
            - { name: json_file, rust_type: PathBuf, "x-clap-arg": "long" }
        - name: Review
          kind: struct
          doc: "Add review to proposal from JSON file."
          fields:
            - { name: change_id, rust_type: String }
            - { name: json_file, rust_type: PathBuf, "x-clap-arg": "long" }
```
...
- [overview] Subcommand enum, both variants struct-kind with variant-field clap-arg.
- [schema] x-clap-arg "long" on json_file in both variants.
