...
# Standardized apps/agentic-workflow/tests/cli/tests/root_trait_coverage_test.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/tests/cli/tests/root_trait_coverage_test.rs`.
...
<!-- source-snapshot: path=apps/agentic-workflow/tests/cli/tests/root_trait_coverage_test.rs -->
```rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/validate/tests/root_trait_coverage_test.md#source
// CODEGEN-BEGIN
