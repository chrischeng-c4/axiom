...
# Standardized apps/agentic-workflow/tests/cli/tests/root_doc_allowlist_test.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/tests/cli/tests/root_doc_allowlist_test.rs`.
...
<!-- source-snapshot: path=apps/agentic-workflow/tests/cli/tests/root_doc_allowlist_test.rs -->
```rust
