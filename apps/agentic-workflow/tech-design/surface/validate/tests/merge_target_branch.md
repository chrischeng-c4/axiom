...
# Standardized apps/agentic-workflow/tests/cli/tests/merge_target_branch.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/tests/cli/tests/merge_target_branch.rs` generated from AST during Score force-regeneration standardization.
...
<!-- source-snapshot: path=apps/agentic-workflow/tests/cli/tests/merge_target_branch.rs -->
```rust
