---
id: projects-agentic-workflow-tests-cli-tests-chain-liveness-test-rs
fill_sections: [overview, changes]
capability_refs:
  - id: td-cb-lifecycle-automation
    role: primary
    gap: chain-liveness-proof
    claim: chain-liveness-proof
    coverage: full
    rationale: "Bounded-tick liveness regression coverage (#921, epic #914 slice G) proving the internal td claim / td code-check lifecycle layer converges instead of deadlocking (#843) or stranding a partial terminal failure unretryably (#846)."
---

# Standardized apps/agentic-workflow/tests/cli/tests/chain_liveness_test.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/tests/cli/tests/chain_liveness_test.rs`.
...
<!-- source-snapshot: path=apps/agentic-workflow/tests/cli/tests/chain_liveness_test.rs -->
```rust
