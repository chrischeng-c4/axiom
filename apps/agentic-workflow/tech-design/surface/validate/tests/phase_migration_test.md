...
# Standardized apps/agentic-workflow/tests/cli/tests/phase_migration_test.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/tests/cli/tests/phase_migration_test.rs` generated from AST during Score force-regeneration standardization.
...
<!-- source-snapshot: path=apps/agentic-workflow/tests/cli/tests/phase_migration_test.rs -->
```rust
