...
Public API manifest for `apps/agentic-workflow/src/cli/project.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CapabilityHealthReport` | apps/agentic-workflow/src/cli/project.rs | struct | pub | 201 |  |
| `CbOwnershipSummary` | apps/agentic-workflow/src/cli/project.rs | struct | pub | 188 |  |
| `ProjectClaimClosureItem` | apps/agentic-workflow/src/cli/project.rs | struct | pub | 396 |  |
| `ProjectClaimClosureReport` | apps/agentic-workflow/src/cli/project.rs | struct | pub | 379 |  |
| `ProjectClaimClosureStatus` | apps/agentic-workflow/src/cli/project.rs | enum | pub | 410 |  |
| `ProjectEcCommandReport` | apps/agentic-workflow/src/cli/project.rs | struct | pub | 366 |  |
| `ProjectEcGateReport` | apps/agentic-workflow/src/cli/project.rs | struct | pub | 329 |  |
| `ProjectEcGateStatus` | apps/agentic-workflow/src/cli/project.rs | enum | pub | 355 |  |
| `ProjectHealthArgs` | apps/agentic-workflow/src/cli/project.rs | struct | pub | 52 |  |
| `ProjectHealthReport` | apps/agentic-workflow/src/cli/project.rs | struct | pub | 113 |  |
| `ProjectHealthSection` | apps/agentic-workflow/src/cli/project.rs | enum | pub | 92 |  |
| `ProjectHealthStatus` | apps/agentic-workflow/src/cli/project.rs | enum | pub | 277 |  |
| `ProjectTestCommandReport` | apps/agentic-workflow/src/cli/project.rs | struct | pub | 307 |  |
| `ProjectTestCommandStatus` | apps/agentic-workflow/src/cli/project.rs | enum | pub | 320 |  |
| `ProjectTestGateReport` | apps/agentic-workflow/src/cli/project.rs | struct | pub | 284 |  |
| `ProjectTestGateStatus` | apps/agentic-workflow/src/cli/project.rs | enum | pub | 298 |  |
| `RegenerabilityAuthorityReport` | apps/agentic-workflow/src/cli/project.rs | struct | pub | 264 |  |
| `apply_claim_closure_to_report` | apps/agentic-workflow/src/cli/project.rs | function | pub | 3146 | apply_claim_closure_to_report(report: &mut ProjectHealthReport) -> Result<()> |
| `apply_ec_to_report` | apps/agentic-workflow/src/cli/project.rs | function | pub | 2965 | apply_ec_to_report(report: &mut ProjectHealthReport, verify_ec: bool) -> Result<()> |
| `apply_preflight_gate_report` | apps/agentic-workflow/src/cli/project.rs | function | pub | 1350 | apply_preflight_gate_report(&mut self, report: PreFlightGateReport) |
| `apply_td_lock_to_report` | apps/agentic-workflow/src/cli/project.rs | function | pub | 2947 | apply_td_lock_to_report(report: &mut ProjectHealthReport) -> Result<()> |
| `apply_workflow_locks_to_report` | apps/agentic-workflow/src/cli/project.rs | function | pub | 3627 | apply_workflow_locks_to_report(report: &mut ProjectHealthReport) -> Result<()> |
| `build_health_report` | apps/agentic-workflow/src/cli/project.rs | function | pub | 529 | build_health_report(project: &str) -> Result<ProjectHealthReport> |
| `build_health_report_with_options` | apps/agentic-workflow/src/cli/project.rs | function | pub | 534 | build_health_report_with_options(     project: &str,     verify_traceability: bool,     verify_cb: bool,     verify_cold: bool,     verify_tests: bool,     verify_ec: bool, ) -> Result<ProjectHealthReport> |
| `build_health_report_with_test_gates` | apps/agentic-workflow/src/cli/project.rs | function | pub | 600 | build_health_report_with_test_gates(     project: &str,     verify_traceability: bool,     verify_cb: bool,     verify_cold: bool,     test_gates: ProjectTestGateReport,     production_gates_evaluated: bool, ) -> Result<ProjectHealthReport> |
| `build_health_report_with_test_gates_and_capability_verified` | apps/agentic-workflow/src/cli/project.rs | function | pub | 620 | build_health_report_with_test_gates_and_capability_verified(     project: &str,     verify_traceability: bool,     verify_cb: bool,     verify_cold: bool,     test_gates: ProjectTestGateReport,     production_gates_evaluated: bool,     capability_verified_by_id: Option<BTreeMap<String, bool>>, ) -> Result<ProjectHealthReport> |
| `command` | apps/agentic-workflow/src/cli/project.rs | function | pub | 3452 | command(&self) -> Result<String> |
| `from_components` | apps/agentic-workflow/src/cli/project.rs | function | pub | 1003 | from_components(         project: &str,         managed: StandardizationCoverage,         semantic: SemanticCoverage,         regenerable: RegenerabilityCoverage,         stack_migration: StackMigrationCoverage,         cb: CbVerifySummary,         cold_rebuilds: Vec<CbColdVerifySummary>,         test_gates: ProjectTestGateReport,     ) -> Self |
| `from_components_with_traceability` | apps/agentic-workflow/src/cli/project.rs | function | pub | 1027 | from_components_with_traceability(         project: &str,         managed: StandardizationCoverage,         semantic: SemanticCoverage,         traceability: TraceabilityCoverage,         regenerable: RegenerabilityCoverage,         stack_migration: StackMigrationCoverage,         cb: CbVerifySummary,         cold_rebuilds: Vec<CbColdVerifySummary>,         test_gates: ProjectTestGateReport,     ) -> Self |
| `not_evaluated` | apps/agentic-workflow/src/cli/project.rs | function | pub | 416 | not_evaluated(project: &str) -> Self |
| `not_evaluated` | apps/agentic-workflow/src/cli/project.rs | function | pub | 455 | not_evaluated(project: &str) -> Self |
| `not_evaluated` | apps/agentic-workflow/src/cli/project.rs | function | pub | 1489 | not_evaluated(project: &str) -> Self |
| `passed_fixture` | apps/agentic-workflow/src/cli/project.rs | function | pub | 1504 | passed_fixture(command: &str) -> Self |
| `project_health_caps_ec_only` | apps/agentic-workflow/src/cli/project.rs | function | pub | 819 | project_health_caps_ec_only(project: &str) -> bool |
| `project_health_compact_summary` | apps/agentic-workflow/src/cli/project.rs | function | pub | 1851 | project_health_compact_summary(report: &ProjectHealthReport) -> serde_json::Value |
| `project_health_compact_summary_with_payload_path` | apps/agentic-workflow/src/cli/project.rs | function | pub | 1867 | project_health_compact_summary_with_payload_path(     report: &ProjectHealthReport,     payload_path: &str, ) -> serde_json::Value |
| `project_health_section_summary` | apps/agentic-workflow/src/cli/project.rs | function | pub | 1875 | project_health_section_summary(     report: &ProjectHealthReport,     section: ProjectHealthSection, ) -> serde_json::Value |
| `project_health_section_summary_with_payload_path` | apps/agentic-workflow/src/cli/project.rs | function | pub | 1979 | project_health_section_summary_with_payload_path(     report: &ProjectHealthReport,     section: ProjectHealthSection,     payload_path: &str, ) -> serde_json::Value |
| `project_health_summary` | apps/agentic-workflow/src/cli/project.rs | function | pub | 1991 | project_health_summary(report: &ProjectHealthReport) -> serde_json::Value |
| `project_health_summary_with_payload_path` | apps/agentic-workflow/src/cli/project.rs | function | pub | 2007 | project_health_summary_with_payload_path(     report: &ProjectHealthReport,     payload_path: &str, ) -> serde_json::Value |
| `project_test_gate_report` | apps/agentic-workflow/src/cli/project.rs | function | pub | 1542 | project_test_gate_report(     project: &str,     project_root: &std::path::Path,     verify_tests: bool, ) -> Result<ProjectTestGateReport> |
| `run_health` | apps/agentic-workflow/src/cli/project.rs | function | pub | 2753 | run_health(args: ProjectHealthArgs) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/project.rs -->
````rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/generate/project-health-source.md#source
// CODEGEN-BEGIN
...
// @spec apps/agentic-workflow/tech-design/surface/specs/project-health-governance-report.md#logic
/// @spec apps/agentic-workflow/tech-design/surface/generate/project-health-source.md#source
...
fn project_test_gate_report_with_progress(
    ...
    let Some(row) = projects.iter().find(|row| row.name == project) else {
        return Ok(ProjectTestGateReport {
            ...
            note: Some(format!("project `{project}` is not configured in aw.toml")),
            command_count: 0,
            passed_count: 0,
            failed_count: 0,
            skipped_count: 0,
    ...
    if configured.is_empty() {
        return Ok(ProjectTestGateReport {
            ...
            status: ProjectTestGateStatus::NotConfigured,
            note: Some(format!(
                "project `{project}` has no workspace `test_cmd`; configure tests in aw.toml"
            )),
            command_count: 0,
            passed_count: 0,
            failed_count: 0,
...
mod tests {
    ...
    fn agentic_workflow_self_health_next_ignores_td_lock() {
        ...
        report.td_lock = crate::cli::td_lock::TdLockStatus {
            ...
            lock_path: "apps/agentic-workflow/tech-design/td.lock".to_string(),
        ...
        report.ec = ProjectEcGateReport {
            ...
            lock_clean: true,
            lock_path: "apps/agentic-workflow/external-contracts/ec.lock".to_string(),
            lock_ir_digest: Some("sha256:lock".to_string()),
            locked_lock_ir_digest: Some("sha256:lock".to_string()),
            inventory_path: "apps/agentic-workflow/aw.toml".to_string(),
...
changes:
  - path: apps/agentic-workflow/src/cli/project.rs
    ...
    description: |
      ...
      #920 (epic #914 slice F): `ProjectHealthReport` gained
      `managed_next_uncovered_file: Option<String>` (the first managed-layer
      uncovered/unmarked source file, carried through from the managed
      coverage computation already run to produce the report).
      `project_health_next_command`'s `managed`/`semantic`/`traceability`
      branches no longer emit the retired `aw standardize
      managed|semantic|traceability run --project <p> --non-interactive
      --max-ticks 1` layer-driver commands; they call the new
      `managed_health_worker_command` / `semantic_health_worker_command` /
      `traceability_health_worker_command` helpers in
      `src/cli/standardize.rs`, which name the concrete slice-E worker verb
      (`aw td code-claim <path>` when a managed gap file is known) or a
      read-only `aw health --project <p> metrics|traceability --verbose`
      pointer when no single deterministic worker verb exists for the gap
      kind. NOTE: this mirror predates this session with substantial
      unrelated drift from `src/cli/project.rs` (tracked separately, #848);
      only the hunks this change touches were resynced here -- the mirror is
      not otherwise byte-true to the current source.
  - path: apps/agentic-workflow/src/cli/project.rs
    action: modify
    impl_mode: codegen
    section: source
    description: |
      Issue #848: whole-file resync — the mirror above predated this session
      with substantial drift from the current 5000+ line src/cli/project.rs;
      this entry closes that gap with a byte-equivalent full-file snapshot
      and a regenerated Overview/Symbols table (adds
      ProjectHealthSection/CbOwnershipSummary/ProjectClaimClosure*/
      ProjectEc* report types and the ec/claim-closure/td-lock
      report-application functions that had accumulated since the last
      resync).
  - path: apps/agentic-workflow/src/cli/project.rs
    action: modify
    impl_mode: codegen
    section: source
    description: |
      Issue #1501 exposes `policy_mode`, `hard_gates`, and `advisory_axes`
