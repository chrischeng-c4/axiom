...
Public API manifest for `apps/agentic-workflow/tests/cli/tests/project_health_test.rs` generated from AST during Score force-regeneration standardization.
...
<!-- source-snapshot: path=apps/agentic-workflow/tests/cli/tests/project_health_test.rs -->
```rust
