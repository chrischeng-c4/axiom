...
Public API manifest for `apps/agentic-workflow/build.rs` generated from AST during Score force-regeneration standardization.
...
<!-- source-snapshot: path=apps/agentic-workflow/build.rs -->
```rust
...
fn main() {
    ...
    // Workspace Cargo.toml lives 2 levels up from apps/agentic-workflow/.
