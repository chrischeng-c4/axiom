...
Public API manifest for `apps/agentic-workflow/src/cli/standardize.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CommandTraceabilityCoverage` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 281 |  |
| `CoverageMapEntry` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 532 |  |
| `DependencyPolicyFinding` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 419 |  |
| `DeploymentFacetFinding` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 428 |  |
| `FrontendEcosystemAst` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 488 |  |
| `FrontendSourceNode` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 504 |  |
| `FrontendWorkspaceNode` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 495 |  |
| `GeneratorPrimitiveGap` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 541 |  |
| `ImportEdge` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 524 |  |
| `MarkerCounts` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 181 |  |
| `RegenerabilityCoverage` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 188 |  |
| `SemanticCoverage` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 216 |  |
| `SemanticGap` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 550 |  |
| `SourceEvidenceDomain` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 462 |  |
| `SourceEvidenceGraph` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 455 |  |
| `SourceEvidenceNode` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 471 |  |
| `SourceSymbol` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 516 |  |
| `SourceUnit` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 440 |  |
| `StackMigrationCoverage` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 380 |  |
| `StandardizationCoverage` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 169 |  |
| `StandardizeAction` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 559 |  |
| `StandardizeActionKind` | apps/agentic-workflow/src/cli/standardize.rs | enum | pub | 572 |  |
| `StandardizeArgs` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 88 |  |
| `StandardizeAuditArgs` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 105 |  |
| `StandardizeAuditCheckArgs` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 127 |  |
| `StandardizeAuditCommand` | apps/agentic-workflow/src/cli/standardize.rs | enum | pub | 112 |  |
| `StandardizeAuditRecordArgs` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 152 |  |
| `StandardizeCommand` | apps/agentic-workflow/src/cli/standardize.rs | enum | pub | 98 |  |
| `TraceabilityBlocker` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 312 |  |
| `TraceabilityBlockerKind` | apps/agentic-workflow/src/cli/standardize.rs | enum | pub | 323 |  |
| `TraceabilityCoverage` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 240 |  |
| `WorkspaceStackMigration` | apps/agentic-workflow/src/cli/standardize.rs | struct | pub | 401 |  |
| `as_str` | apps/agentic-workflow/src/cli/standardize.rs | function | pub | 346 | as_str(self) -> &'static str |
| `project_managed_coverage` | apps/agentic-workflow/src/cli/standardize.rs | function | pub | 1098 | project_managed_coverage(project: &str) -> Result<StandardizationCoverage> |
| `project_regenerability_coverage` | apps/agentic-workflow/src/cli/standardize.rs | function | pub | 1175 | project_regenerability_coverage(project: &str) -> Result<RegenerabilityCoverage> |
| `project_regenerability_fast_coverage` | apps/agentic-workflow/src/cli/standardize.rs | function | pub | 1183 | project_regenerability_fast_coverage(project: &str) -> Result<RegenerabilityCoverage> |
| `project_semantic_coverage` | apps/agentic-workflow/src/cli/standardize.rs | function | pub | 1206 | project_semantic_coverage(project: &str) -> Result<SemanticCoverage> |
| `project_stack_migration_coverage` | apps/agentic-workflow/src/cli/standardize.rs | function | pub | 1236 | project_stack_migration_coverage(project: &str) -> Result<StackMigrationCoverage> |
| `project_traceability_coverage` | apps/agentic-workflow/src/cli/standardize.rs | function | pub | 1215 | project_traceability_coverage(project: &str) -> Result<TraceabilityCoverage> |
| `ready_fixture` | apps/agentic-workflow/src/cli/standardize.rs | function | pub | 259 | ready_fixture(project: &str) -> Self |
| `ready_fixture` | apps/agentic-workflow/src/cli/standardize.rs | function | pub | 295 | ready_fixture() -> Self |
| `run` | apps/agentic-workflow/src/cli/standardize.rs | function | pub | 707 | run(args: StandardizeArgs) -> Result<()> |
