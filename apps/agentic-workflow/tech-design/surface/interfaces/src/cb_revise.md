...
# Standardized apps/agentic-workflow/src/cli/cb_revise.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/cli/cb_revise.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CbReviseArgs` | apps/agentic-workflow/src/cli/cb_revise.rs | struct | pub | 26 |  |
| `run_revise` | apps/agentic-workflow/src/cli/cb_revise.rs | function | pub | 42 | run_revise(args: CbReviseArgs) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/cb_revise.rs -->
```rust
...
// @spec apps/agentic-workflow/tech-design/surface/interfaces/src/cb_revise.md#source
