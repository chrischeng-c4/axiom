...
# Standardized apps/agentic-workflow/src/cli/tasks.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/cli/tasks.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TasksCommands` | apps/agentic-workflow/src/cli/tasks.rs | enum | pub | 15 |  |
| `run` | apps/agentic-workflow/src/cli/tasks.rs | function | pub | 26 | run(cmd: TasksCommands) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/tasks.rs -->
```rust
//! Tasks CLI commands
...
// @spec apps/agentic-workflow/tech-design/surface/tasks.md#schema
#[derive(Subcommand)]
...
// @spec apps/agentic-workflow/tech-design/surface/interfaces/src/tasks.md#source
