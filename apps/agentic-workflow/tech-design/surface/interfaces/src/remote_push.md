...
# Standardized apps/agentic-workflow/src/cli/remote_push.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/cli/remote_push.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `maybe_push_remote` | apps/agentic-workflow/src/cli/remote_push.rs | function | pub | 27 | maybe_push_remote(project_root: &Path, issue_path: &Path, slug: &str) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/remote_push.rs -->
```rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/interfaces/src/remote_push.md#source
// CODEGEN-BEGIN
...
// @spec apps/agentic-workflow/tech-design/surface/interfaces/src/remote_push.md#source
