---
id: apps-agentic-workflow-src-cli-meta-docs-rs
summary: Canonical source unit for the repository/project META-doc ownership matrix and validator.
capability_refs:
  - id: aw-core-client-model-workitem-first-artifact-lifecycle
    role: primary
    gap: meta-doc-ownership-matrix
    claim: meta-doc-ownership-matrix-source
    coverage: full
    rationale: "The executable matrix is the single source used by documentation projection and layout validation."
---

# Standardized apps/agentic-workflow/src/cli/meta_docs.rs

## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/meta_docs.rs -->
~~~~~rust
...
changes:
  - path: apps/agentic-workflow/src/cli/meta_docs.rs
    ...
    section: source
    impl_mode: codegen
    description: Whole-file source template for the machine-readable META-doc ownership matrix, renderer, findings, and validator.
```
