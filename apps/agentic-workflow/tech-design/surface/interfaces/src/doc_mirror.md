...
capability_refs:
  - id: aw-core-client-model-workitem-first-artifact-lifecycle
    ...
    coverage: full
    rationale: "Shared whitelist definition consumed by root-doc producers and root_doc_mirror_test so the root-doc mirror contract cannot drift (issue #984)."
---

# Standardized apps/agentic-workflow/src/cli/doc_mirror.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/cli/doc_mirror.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CLAUDE_TITLE` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 23 | CLAUDE_TITLE: &str |
| `AGENTS_TITLE` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 26 | AGENTS_TITLE: &str |
| `CODEX_RULES_HEADING` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 30 | CODEX_RULES_HEADING: &str |
| `CODEX_TRANSLATE_PREFIX` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 35 | CODEX_TRANSLATE_PREFIX: &str |
| `CODEX_TRANSLATE_PARAGRAPH` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 39 | CODEX_TRANSLATE_PARAGRAPH: &str |
| `CODEX_TRANSLATE_ANCHOR` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 44 | CODEX_TRANSLATE_ANCHOR: &str |
| `agents_block_from_claude_block` | apps/agentic-workflow/src/cli/doc_mirror.rs | function | pub | 59 | agents_block_from_claude_block(block: &str) -> String |
| `WORKFLOW_TABLE_VERBS` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 83 | WORKFLOW_TABLE_VERBS: &[&str] |
| `SUPPORT_TABLE_VERBS` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 90 | SUPPORT_TABLE_VERBS: &[&str] |
| `CLI_TABLE_WORKFLOW_START` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 95 | CLI_TABLE_WORKFLOW_START: &str |
| `CLI_TABLE_WORKFLOW_END` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 96 | CLI_TABLE_WORKFLOW_END: &str |
| `CLI_TABLE_SUPPORT_START` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 100 | CLI_TABLE_SUPPORT_START: &str |
| `CLI_TABLE_SUPPORT_END` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 101 | CLI_TABLE_SUPPORT_END: &str |
| `PROJECTS_TABLE_START` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 106 | PROJECTS_TABLE_START: &str |
| `PROJECTS_TABLE_END` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 107 | PROJECTS_TABLE_END: &str |
| `render_verb_table` | apps/agentic-workflow/src/cli/doc_mirror.rs | function | pub | 151 | render_verb_table(verbs: &[&str]) -> String |
| `render_cli_tables` | apps/agentic-workflow/src/cli/doc_mirror.rs | function | pub | 198 | render_cli_tables(section: &str) -> String |
| `agents_skill_body_from_claude_skill_body` | apps/agentic-workflow/src/cli/doc_mirror.rs | function | pub | 239 | agents_skill_body_from_claude_skill_body(body: &str) -> String |
| `render_projects_table` | apps/agentic-workflow/src/cli/doc_mirror.rs | function | pub | 362 | render_projects_table(project_root: &std::path::Path) -> anyhow::Result<String> |
| `upsert_projects_table` | apps/agentic-workflow/src/cli/doc_mirror.rs | function | pub | 397 | upsert_projects_table(project_root: &std::path::Path, doc_text: &str) -> anyhow::Result<String> |
| `TraitDef` | apps/agentic-workflow/src/cli/doc_mirror.rs | struct | pub | 451 | TraitDef { id: &'static str, baseline_caps: &'static [&'static str], contributing_anchor: Option<&'static str>, about: &'static str } |
| `TRAITS` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 460 | TRAITS: &[TraitDef] |
| `TraitExpansion` | apps/agentic-workflow/src/cli/doc_mirror.rs | struct | pub | 550 | TraitExpansion { id: &'static str, members: &'static [&'static str], about: &'static str } |
| `TRAIT_EXPANSIONS` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 561 | TRAIT_EXPANSIONS: &[TraitExpansion] |
| `expand_capability_profile_traits` | apps/agentic-workflow/src/cli/doc_mirror.rs | function | pub | 580 | expand_capability_profile_traits(traits: &[String]) -> std::collections::BTreeSet<String> |
| `TRAIT_TABLE_START` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 600 | TRAIT_TABLE_START: &str |
| `TRAIT_TABLE_END` | apps/agentic-workflow/src/cli/doc_mirror.rs | const | pub | 601 | TRAIT_TABLE_END: &str |
| `render_trait_table` | apps/agentic-workflow/src/cli/doc_mirror.rs | function | pub | 635 | render_trait_table() -> String |
| `upsert_trait_table` | apps/agentic-workflow/src/cli/doc_mirror.rs | function | pub | 679 | upsert_trait_table(doc_text: &str) -> String |

## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/doc_mirror.rs -->
```rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/interfaces/src/doc_mirror.md#source
// CODEGEN-BEGIN
...
changes:
  - path: apps/agentic-workflow/src/cli/doc_mirror.rs
    ...
    description: |
      ...
      root-doc projection and `root_doc_mirror_test` so the
      ...
      the shared skill installer and its skill-tree staleness
      check (`crate::cli::init::skill_tree_stale_entries`) so the two
      installed trees can never disagree.

      Issue #1077 (archetype-as-traits slice 1/3) adds the trait registry:
      `TraitDef`/`TRAITS` data-ifies the three archetype-anchored
      `[capability.profile].traits` ids (`http2_api`, `kubernetes_native`,
      `primary_replicas`) that already have a settled CONTRIBUTING.md
      "Service archetype" doc home, replacing the equivalent hand-maintained
      match arms in `crate::cli::capability` with thin lookups over this
      table. `render_trait_table` renders the generated
      `| Trait | Derives | Enforces | About |` table (`Enforces` = a
      same-document Markdown link built from `slugify_heading` against each
      `TraitDef::contributing_anchor`'s literal heading text), and
      `upsert_trait_table` regenerates it between the new
      `TRAIT_TABLE_START`/`TRAIT_TABLE_END` markers, reusing the same
      `replace_between_markers` helper and opt-in-per-document contract as
      `upsert_projects_table`. `TraitDef`/`TRAITS` are `pub` (not
      `pub(crate)`, unlike the issue's illustrative snippet) because the new
      bidirectional coverage test (`root_trait_coverage_test`, in `tests/`)
