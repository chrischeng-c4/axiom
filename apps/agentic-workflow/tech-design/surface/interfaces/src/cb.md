...
capability_refs:
  ...
  - id: td-cb-lifecycle-automation
    ...
    coverage: full
    rationale: "Terminal code-check selects accepted CODEGEN claims changed since Td-Init, reuses deterministic path-mode audit before EC or mutation, and exposes phase-safe scoped regeneration."
---
...
|------|--------|------|------------|------|-----------|
| `CbCheckArgs` | apps/agentic-workflow/src/cli/cb.rs | struct | pub | 156 |  |
| `CbClaimArgs` | apps/agentic-workflow/src/cli/cb.rs | struct | pub | 77 |  |
| `CbCodegenOriginSummary` | apps/agentic-workflow/src/cli/cb.rs | struct | pub | 743 |  |
| `CbColdVerifySummary` | apps/agentic-workflow/src/cli/cb.rs | struct | pub | 752 |  |
| `CbFillArgs` | apps/agentic-workflow/src/cli/cb.rs | struct | pub | 50 |  |
| `CbGenArgs` | apps/agentic-workflow/src/cli/cb.rs | struct | pub | 111 |  |
| `CbGenSourceArgs` | apps/agentic-workflow/src/cli/cb.rs | struct | pub | 175 |  |
| `CbVerifySummary` | apps/agentic-workflow/src/cli/cb.rs | struct | pub | 733 |  |
| `code_check_target_is_slug` | apps/agentic-workflow/src/cli/cb.rs | function | pub | 4305 | code_check_target_is_slug(project_root: &std::path::Path, target: &str) -> bool |
| `project_force_regen_cold_verify_summary` | apps/agentic-workflow/src/cli/cb.rs | function | pub | 830 | project_force_regen_cold_verify_summary(project: &str) -> Result<Vec<CbColdVerifySummary>> |
| `project_force_regen_cold_verify_workspaces` | apps/agentic-workflow/src/cli/cb.rs | function | pub | 846 | project_force_regen_cold_verify_workspaces(project: &str) -> Result<Vec<String>> |
| `project_force_regen_verify_summary` | apps/agentic-workflow/src/cli/cb.rs | function | pub | 774 | project_force_regen_verify_summary(project: &str) -> Result<CbVerifySummary> |
| `run_check` | apps/agentic-workflow/src/cli/cb.rs | function | pub | 4320 | run_check(args: CbCheckArgs) -> Result<()> |
| `run_claim` | apps/agentic-workflow/src/cli/cb.rs | function | pub | 5112 | run_claim(args: CbClaimArgs) -> Result<()> |
| `run_gen` | apps/agentic-workflow/src/cli/cb.rs | function | pub | 223 | run_gen(args: CbGenArgs) -> Result<()> |
| `run_gen_source` | apps/agentic-workflow/src/cli/cb.rs | function | pub | 192 | run_gen_source(args: CbGenSourceArgs) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/cb.rs -->
`````rust
...
///
// @spec apps/agentic-workflow/tech-design/surface/specs/score-cb-fill-workflow.md#cli
#[derive(Debug, Args)]
...
"#,
    ...
    fn cb_force_regen_commit_records_lifecycle_trailers() {
        ...
        let root = tmp.path();
        init_git_repo(root);
        let source = root.join("apps/agentic-workflow/src/lib.rs");
    ...
    fn cb_gen_force_regen_collects_current_spec_managed_refs_only() {
        let tmp = tempfile::tempdir().unwrap();
        let root = tmp.path();
        let td_root = root.join("apps/agentic-workflow/tech-design/surface");
        let source_root = root.join("apps/agentic-workflow");
        ...
        std::fs::write(
            ...
            "// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/interfaces/src/lib.md#source\n// CODEGEN-BEGIN\n// CODEGEN-END\n// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/interfaces/src/schema.md#schema\n// CODEGEN-BEGIN\n// CODEGEN-END\n",
        )
        .unwrap();
        std::fs::write(
            source_root.join("tests/behavior_ec.rs"),
            "// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/specs/external-contracts.md#demo-contract\n// CODEGEN-BEGIN\n// AW-EC-BEGIN\n// @ec demo-contract\n// AW-EC-END\n// CODEGEN-END\n",
        )
        .unwrap();
...
",
    ...
    fn cb_gen_force_regen_extracts_spec_managed_ref_without_fragment() {
        ...
        assert_eq!(
            ...
            Some("apps/agentic-workflow/tech-design/surface/interfaces/src/lib.md".to_string())
        );
    }
...
";
        assert_eq!(
            extract_spec_managed_ref(content),
            Some(
                "apps/agentic-workflow/tech-design/surface/interfaces/src/workflow_guard.md"
                    .to_string()
            )
        );
    }
...
```yaml
changes:
  - path: apps/agentic-workflow/src/cli/cap.rs
    action: modify
    impl_mode: hand-written
```
";
...
";
        assert_eq!(
            ...
            vec![std::path::PathBuf::from(
                "apps/agentic-workflow/src/cli/workflow_guard.rs"
            )]
        );
    }
...
"#,
    ...
    fn cb_gen_force_regen_compare_source_roots_detects_byte_mismatch() {
        ...
        let rel = std::path::Path::new("apps/agentic-workflow/src/cli/lib.rs");
        std::fs::create_dir_all(original.join("apps/agentic-workflow/src/cli")).unwrap();
        std::fs::create_dir_all(generated.join("apps/agentic-workflow/src/cli")).unwrap();
        ...
        let mismatches = compare_source_roots(
            &original,
            &generated,
            &[original.join("apps/agentic-workflow")],
        )
        .unwrap();

        assert_eq!(mismatches, vec!["apps/agentic-workflow/src/cli/lib.rs"]);
    }
...
"#,
    ...
    fn cb_gen_force_regen_upserts_public_api_overview_manifest() {
        ...
        let updated =
            upsert_public_api_overview(spec, "apps/agentic-workflow/src/cli/demo.rs", &symbols);

        assert!(updated.contains("fill_sections: [overview, source, changes]"));
        assert!(updated.contains("## Overview\n<!-- type: overview lang: markdown -->"));
        assert!(updated.contains(
            "| `run` | apps/agentic-workflow/src/cli/demo.rs | function | pub | 12 | pub fn run() -> Result<()> |"
        ));
...
"#;
    ...
    fn cb_gen_force_regen_fails_unmanaged_source_files() {
        let mut report = ForceRegenConformanceReport {
            ...
            unmanaged_code_files: vec![SemanticReviewUnit {
                ...
                target_path: std::path::PathBuf::from(
                    "apps/agentic-workflow/src/generate/marker.rs",
                ),
                reason: "no-ownership-marker".to_string(),
            }],
            ..Default::default()
        ...
        assert!(report.failures[0].contains("apps/agentic-workflow/src/generate/marker.rs"));
    }
...
async fn run_check_lifecycle_terminal(
    ...
    let (closed_issue, ec_gate_json) = if is_retry {
        ...
        if let Some(message) = touched_scope_standardization_gate_message(&issue, &touched_scope) {
            let env = serde_json::json!({
                "action": "error",
                "slug": slug,
                "message": message,
...
changes:
  ...
  - path: apps/agentic-workflow/src/cli/cb.rs
    ...
    section: source
    description: |
      Issue #1506 adds the exact `td gen-source` single-target replay and its
