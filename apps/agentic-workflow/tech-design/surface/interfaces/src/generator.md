...
Public API manifest for `apps/agentic-workflow/src/cli/generator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `GeneratorArgs` | apps/agentic-workflow/src/cli/generator.rs | struct | pub | 15 |  |
| `GeneratorCheckArgs` | apps/agentic-workflow/src/cli/generator.rs | struct | pub | 50 |  |
| `GeneratorCheckReport` | apps/agentic-workflow/src/cli/generator.rs | struct | pub | 117 |  |
| `GeneratorCommand` | apps/agentic-workflow/src/cli/generator.rs | enum | pub | 22 |  |
| `GeneratorGap` | apps/agentic-workflow/src/cli/generator.rs | struct | pub | 90 |  |
| `GeneratorHealthSummary` | apps/agentic-workflow/src/cli/generator.rs | struct | pub | 97 |  |
| `GeneratorNextAction` | apps/agentic-workflow/src/cli/generator.rs | struct | pub | 110 |  |
| `GeneratorRequestArgs` | apps/agentic-workflow/src/cli/generator.rs | struct | pub | 75 |  |
| `GeneratorRequestReport` | apps/agentic-workflow/src/cli/generator.rs | struct | pub | 129 |  |
| `run` | apps/agentic-workflow/src/cli/generator.rs | function | pub | 142 | run(args: GeneratorArgs) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/generator.rs -->
`````rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/interfaces/src/generator.md#source
// CODEGEN-BEGIN
