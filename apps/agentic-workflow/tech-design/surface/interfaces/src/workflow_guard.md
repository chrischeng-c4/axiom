---
id: projects-score-src-workflow-guard-rs
...
# Standardized apps/agentic-workflow/src/cli/workflow_guard.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/cli/workflow_guard.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CB_LOCK_LABEL` | apps/agentic-workflow/src/cli/workflow_guard.rs | constant | pub | 18 |  |
| `HookDecision` | apps/agentic-workflow/src/cli/workflow_guard.rs | enum | pub | 534 |  |
| `IssueLockView` | apps/agentic-workflow/src/cli/workflow_guard.rs | struct | pub | 167 |  |
| `LOCK_LABEL` | apps/agentic-workflow/src/cli/workflow_guard.rs | constant | pub | 16 |  |
| `TD_LOCK_LABEL` | apps/agentic-workflow/src/cli/workflow_guard.rs | constant | pub | 17 |  |
| `TransitionLock` | apps/agentic-workflow/src/cli/workflow_guard.rs | struct | pub | 25 |  |
| `WorkflowProjection` | apps/agentic-workflow/src/cli/workflow_guard.rs | struct | pub | 114 |  |
| `complete_issue_lock` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 297 | complete_issue_lock(project_root: &Path, issue_id: &str, owner: &str) -> Result<()> |
| `create_issue_lock` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 275 | create_issue_lock(project_root: &Path, lock: &TransitionLock) -> Result<()> |
| `guard_issue_mutation` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 392 | guard_issue_mutation(     project_root: &Path,     allowed: Option<(&str, &str)>, ) -> Result<()> |
| `hook_posttooluse_workflow_apply` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 478 | hook_posttooluse_workflow_apply(     project_root: &Path,     payload: &Value, ) -> Result<HookDecision> |
| `hook_pretooluse_workflow_guard` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 432 | hook_pretooluse_workflow_guard(     project_root: &Path,     payload: &Value, ) -> Result<HookDecision> |
| `issue_locks` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 418 | issue_locks(project_root: &Path) -> Result<Vec<IssueLockView>> |
| `new` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 51 | new(         issue_id: impl Into<String>,         owner: impl Into<String>,         expected_command: impl Into<String>,     ) -> Self |
| `parse_projection` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 217 | parse_projection(body: &str) -> Option<WorkflowProjection> |
| `record_issue_blocker` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 358 | record_issue_blocker(     project_root: &Path,     issue_id: &str,     owner: &str,     message: &str, ) -> Result<()> |
| `unlock_projection_for_closed_issue` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 251 | unlock_projection_for_closed_issue(body: &str, issue_id: &str) -> Result<Option<String>> |
| `upsert_projection` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 227 | upsert_projection(body: &str, projection: &WorkflowProjection) -> Result<String> |
| `with_active_branch` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 88 | with_active_branch(mut self, branch: impl Into<String>) -> Self |
| `with_active_phase` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 83 | with_active_phase(mut self, phase: impl Into<String>) -> Self |
| `with_current_section` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 93 | with_current_section(mut self, section: impl Into<String>) -> Self |
| `with_dirty_paths` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 106 | with_dirty_paths(mut self, paths: impl IntoIterator<Item = impl Into<String>>) -> Self |
| `with_expected_payload` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 73 | with_expected_payload(mut self, path: impl Into<String>) -> Self |
| `with_phase_from` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 78 | with_phase_from(mut self, phase: impl Into<String>) -> Self |
| `with_remaining_sections` | apps/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 98 | with_remaining_sections(         mut self,         sections: impl IntoIterator<Item = impl Into<String>>,     ) -> Self |
## Source
<!-- type: source lang: rust -->
<!-- source-snapshot: path=apps/agentic-workflow/src/cli/workflow_guard.rs -->
`````rust
// SPEC-MANAGED: apps/agentic-workflow/tech-design/surface/interfaces/src/workflow_guard.md#source
// CODEGEN-BEGIN
...
mod tests {
    ...
    fn hook_guard_blocks_wrong_payload_path() {
        let lock = IssueLockView {
            ...
            current_section: None,
            dirty_paths: vec![
                "apps/agentic-workflow/tech-design/surface/specs/123.md".to_string()
            ],
            blocker_summary: None,
        };
        ...
        assert!(!path_allowed_by_lock(
            "apps/agentic-workflow/tech-design/surface/specs/123.md",
            &lock
        ));
        assert!(!path_allowed_by_lock(
...
// CODEGEN-BEGIN
// SPEC-REF: apps/agentic-workflow/tech-design/semantic/agentic-workflow-cli.md#schema
...
changes:
  - path: apps/agentic-workflow/src/cli/workflow_guard.rs
    ...
    section: source
    description: |
      WI-backed transition locks for TD/CB gates, including hook guard/apply
      helpers and hidden issue-body projection parsing.
```
