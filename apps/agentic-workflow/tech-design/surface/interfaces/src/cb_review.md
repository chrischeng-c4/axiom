...
# Standardized apps/agentic-workflow/src/cli/cb_review.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/cli/cb_review.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CbReviewArgs` | apps/agentic-workflow/src/cli/cb_review.rs | struct | pub | 31 |  |
| `extract_flagged_markers_from` | apps/agentic-workflow/src/cli/cb_review.rs | function | pub | 338 | extract_flagged_markers_from(text: &str) -> Vec<String> |
| `run_review` | apps/agentic-workflow/src/cli/cb_review.rs | function | pub | 48 | run_review(args: CbReviewArgs) -> Result<()> |
| `stage_and_commit_for_revise` | apps/agentic-workflow/src/cli/cb_review.rs | function | pub | 530 | stage_and_commit_for_revise(     worktree: &Path,     slug: &str,     trailer: &str,     detail: &str,     paths: &[&str], ) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/cb_review.rs -->
```rust
...
//!
//! @spec apps/agentic-workflow/tech-design/surface/specs/score-cb-review-revise-crrr.md#cli
...
// Top-level dispatch.
// @spec apps/agentic-workflow/tech-design/surface/interfaces/src/cb_review.md#source
