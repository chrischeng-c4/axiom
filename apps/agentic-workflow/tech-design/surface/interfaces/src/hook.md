...
# Standardized apps/agentic-workflow/src/cli/hook.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/cli/hook.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `HookArgs` | apps/agentic-workflow/src/cli/hook.rs | struct | pub | 26 |  |
| `HookEvent` | apps/agentic-workflow/src/cli/hook.rs | enum | pub | 33 |  |
| `PosttooluseKind` | apps/agentic-workflow/src/cli/hook.rs | enum | pub | 61 |  |
| `PretooluseKind` | apps/agentic-workflow/src/cli/hook.rs | enum | pub | 48 |  |
| `run` | apps/agentic-workflow/src/cli/hook.rs | function | pub | 81 | run(args: HookArgs) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/hook.rs -->
```rust
