...
# Standardized apps/agentic-workflow/src/cli/chat.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/cli/chat.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AgentLastSeen` | apps/agentic-workflow/src/cli/chat.rs | struct | pub | 187 |  |
| `ChatArgs` | apps/agentic-workflow/src/cli/chat.rs | struct | pub | 45 |  |
| `ChatCommand` | apps/agentic-workflow/src/cli/chat.rs | enum | pub | 53 |  |
| `ListArgs` | apps/agentic-workflow/src/cli/chat.rs | struct | pub | 107 |  |
| `ListenArgs` | apps/agentic-workflow/src/cli/chat.rs | struct | pub | 169 |  |
| `ListenState` | apps/agentic-workflow/src/cli/chat.rs | type | pub | 194 |  |
| `MembersArgs` | apps/agentic-workflow/src/cli/chat.rs | struct | pub | 141 |  |
| `PostArgs` | apps/agentic-workflow/src/cli/chat.rs | struct | pub | 74 |  |
| `ReadArgs` | apps/agentic-workflow/src/cli/chat.rs | struct | pub | 125 |  |
| `chat_members` | apps/agentic-workflow/src/cli/chat.rs | module | pub | 20 |  |
| `run_chat` | apps/agentic-workflow/src/cli/chat.rs | function | pub | 212 | run_chat(args: ChatArgs) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/chat.rs -->
```rust
...
//!
//! @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#overview
...
///
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-cli-contract.md#schema
#[derive(Debug, Args)]
pub struct PostArgs {
...
// Args for `aw chat list`. @spec apps/agentic-workflow/tech-design/surface/specs/score-chat.md#schema
#[derive(Debug, Args)]
pub struct ListArgs {
...
// Args for `aw chat read`. @spec apps/agentic-workflow/tech-design/surface/specs/score-chat.md#schema
#[derive(Debug, Args)]
pub struct ReadArgs {
...
///
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#schema (ListenArgsV4)
#[derive(Debug, Args)]
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat.md#logic  Node: detect_format
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic  Node: read_channel → detect_format
...
///
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#logic (run_post)
...
// Handle `aw chat list`.
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat.md#logic  Node: run_list
...
// Handle `aw chat read`.
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat.md#logic  Node: run_read
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic  Node: branch_cmd → members_read
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic  Node: members_list
...
// apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#logic (listen branch / tail_spawn node).
...
///
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#logic (cleanup_child)
struct TailGuard {
    child: Child,
}

// @spec apps/agentic-workflow/tech-design/surface/interfaces/src/chat.md#source
...
///
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#logic (run_listen)
...
// Once that primitive exists, this region regenerates from
// apps/agentic-workflow/tech-design/surface/specs/score-chat-listen-filter.md#logic (should_emit flowchart).
...
///
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-listen-filter.md#logic
fn should_emit(
    msg: &ChannelMessage,
    self_name: &str,
...
mod tests {
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat.md#schema — empty channel returns empty vec
    #[test]
    fn test_parse_channel_markdown_empty() {
        assert!(parse_channel_markdown("").is_empty());
    }

    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat.md#schema — message id and fields parsed correctly (new YAML format)
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat.md#schema — multiple messages parsed correctly (new YAML format)
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat.md#logic — terse format shorter than human format
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat.md#logic — identity fallback when no .aw/config.toml
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat.md#schema — ListenState serde round-trip
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat.md#logic — detect_team_identity reads [team] name from config
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-listen-filter.md#logic — Rule 1: direct cue
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-listen-filter.md#logic — Rule 2: broadcast
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-listen-filter.md#logic — Rule 3: echo
    #[test]
    fn test_filter_echo() {
        let msg = ChannelMessage {
            id: 3,
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-listen-filter.md#logic — Rule 4: dynamic thread membership pulls in later msgs
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-listen-filter.md#logic — unrelated thread not emitted
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-listen-filter.md#logic — Rule 0: --all flag emits everything
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-listen-filter.md#logic — thread_root_of cycle guard doesn't infinite-loop
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-cli-contract.md#tests
    // ─────────────────────────────────────────────────────────────────────────
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-cli-contract.md#tests — T1: post without --to or --all fails at clap
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-cli-contract.md#tests — T2: post --all parses; all=true, to=[]
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-cli-contract.md#tests — T3: post --to a,b parses to Vec["a","b"]
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-cli-contract.md#tests — T4: post --from flag is rejected by clap (removed)
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-cli-contract.md#tests — T5: listen --once flag is rejected by clap (removed)
    #[test]
    ...
    // T10: REQ apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#tests — listen --interval flag is rejected by clap (removed in JSONL migration)
    #[test]
    ...
    // T7: REQ apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#tests — ChannelMessage round-trips via serde_json
    ...
    // T8: REQ apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#tests — JSONL line size guarantees POSIX atomic O_APPEND
    #[test]
    ...
    // REQ apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#logic — parse_channel_jsonl skips malformed lines
    #[test]
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-cli-contract.md#tests — T6: resolve_identity returns branch
