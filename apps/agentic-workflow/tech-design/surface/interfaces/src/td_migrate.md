...
|------|--------|------|------------|------|-----------|
| `MigrateMermaidArgs` | apps/agentic-workflow/src/cli/td_migrate.rs | struct | pub | 29 |  |
| `run` | apps/agentic-workflow/src/cli/td_migrate.rs | function | pub | 50 | run(args: MigrateMermaidArgs) -> Result<()> |
## Source
