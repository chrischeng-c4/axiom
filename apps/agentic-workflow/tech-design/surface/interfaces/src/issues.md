...
`aw wi plan` projects missing capability claims into bounded, deduplicated
child-WI candidates and emits a digest-bound review payload. `aw wi
plan-review` rejects same-agent or stale evidence; accepted independent review
