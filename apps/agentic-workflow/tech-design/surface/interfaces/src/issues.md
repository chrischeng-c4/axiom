---
id: projects-score-src-issues-rs
...
command_refs:
  ...
  - command: aw wi close
  - command: aw wi create
  - command: aw wi draft
  - command: aw wi draft fill
...
# Standardized apps/agentic-workflow/src/cli/issues.rs
...
`aw wi plan` has two contracts selected by its caller. Capability-plan
producers project missing claims into bounded, deduplicated child-WI
candidates. The canonical project-plan producer is a stable `aw.cli.v1` root
that relays normalize, reconcile, atomize, and verify. Project-plan
`plan-review` records independent evidence without tracker mutation,
`plan-answer` records the exact HITL choice, and `plan-apply` is the sole
idempotent tracker writer. Only strict zero-diff verify reports
...
One claim id produces at most one candidate even when several capabilities
reference it, while a semantically matching open non-epic WI suppresses a
duplicate draft even if the older issue predates the claim id. Claim drafts
carry a runnable verification command and a claim-specific expected result;
paths or generic "verification passes" prose are not sufficient review proof.
...
|------|--------|------|------------|------|-----------|
| `AtomizeArgs` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 449 |  |
| `BackendKind` | apps/agentic-workflow/src/cli/issues.rs | enum | pub | 603 |  |
| `CloseArgs` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 359 |  |
| `CreateArgs` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 239 |  |
| `CreateValidationError` | apps/agentic-workflow/src/cli/issues.rs | enum | pub | 1323 |  |
| `DraftArgs` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 71 |  |
| `DraftCommand` | apps/agentic-workflow/src/cli/issues.rs | enum | pub | 78 |  |
| `DraftFillArgs` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 129 |  |
| `DraftInitArgs` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 91 |  |
| `DraftValidateArgs` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 154 |  |
| `EnrichArgs` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 497 |  |
...
| `PlanArgs` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 397 |  |
| `PlanReviewArgs` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 428 |  |
| `PrioritizeArgs` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 473 |  |
| `PrioritizeLanes` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 3768 |  |
| `PriorityFilter` | apps/agentic-workflow/src/cli/issues.rs | enum | pub | 298 |  |
| `ShowArgs` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 216 |  |
| `StateFilter` | apps/agentic-workflow/src/cli/issues.rs | enum | pub | 612 |  |
| `TypeFilter` | apps/agentic-workflow/src/cli/issues.rs | enum | pub | 631 |  |
| `UpdateArgs` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 320 |  |
| `ValidateArgs` | apps/agentic-workflow/src/cli/issues.rs | struct | pub | 505 |  |
| `as_label_suffix` | apps/agentic-workflow/src/cli/issues.rs | function | pub | 308 | as_label_suffix(&self) -> &'static str |
| `build_create_label_vec` | apps/agentic-workflow/src/cli/issues.rs | function | pub | 1416 | build_create_label_vec(     type_label: &str,     project_labels: &[String],     priority_label: Option<&str>,     agent_label: Option<&str>, ) -> Vec<String> |
| `check_project_cardinality` | apps/agentic-workflow/src/cli/issues.rs | function | pub | 1391 | check_project_cardinality(     issue_type: IssueType,     observed: usize, ) -> std::result::Result<(), CreateValidationError> |
| `load_project_open_issues` | apps/agentic-workflow/src/cli/issues.rs | function | pub | 3349 | load_project_open_issues(     project_root: &Path,     project: &str,     repo: Option<String>, ) -> Result<(String, String, Vec<Issue>)> |
| `prioritize_lanes` | apps/agentic-workflow/src/cli/issues.rs | function | pub | 3777 | prioritize_lanes(issues: &[Issue]) -> PrioritizeLanes |
| `read_known_agent_name_label_pairs` | apps/agentic-workflow/src/cli/issues.rs | function | pub | 1172 | read_known_agent_name_label_pairs(project_root: &Path) -> Vec<(String, String)> |
| `read_known_project_name_label_pairs` | apps/agentic-workflow/src/cli/issues.rs | function | pub | 1163 | read_known_project_name_label_pairs(project_root: &Path) -> Vec<(String, String)> |
| `resolve_agent_label` | apps/agentic-workflow/src/cli/issues.rs | function | pub | 1298 | resolve_agent_label(     project_root: &Path,     name: &str, ) -> std::result::Result<String, CreateValidationError> |
| `resolve_project_label` | apps/agentic-workflow/src/cli/issues.rs | function | pub | 1225 | resolve_project_label(     project_root: &Path,     name: &str, ) -> std::result::Result<String, CreateValidationError> |
| `run` | apps/agentic-workflow/src/cli/issues.rs | function | pub | 1009 | run(args: IssuesArgs) -> Result<()> |
| `to_envelope_message` | apps/agentic-workflow/src/cli/issues.rs | function | pub | 1352 | to_envelope_message(&self) -> String |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/issues.rs -->
~~~~~rust
...
"#,
    ...
    fn too_large_gate_regression_false_positives_pass_issue_1294() {
        ...
        // #2142: "from scratch" can describe current waste in a bounded
        // performance WI. It is roadmap-scale only when it appears near a
        // scope noun, like "rebuild the platform from scratch".
        let reruns_from_scratch = planning_issue(
            IssueType::Enhancement,
            "Cache the build graph when it re-runs from scratch",
            Some("p1"),
            27,
        );
        assert!(
            !looks_too_large_for_atomic_wi(&reruns_from_scratch),
            "a bounded build-cache deficiency must not flag too-large"
        );

        let rescans_imports = planning_issue(
            IssueType::Enhancement,
            "Avoid re-scanning imports from scratch on an unchanged module",
            Some("p1"),
            28,
        );
        assert!(
            !looks_too_large_for_atomic_wi(&rescans_imports),
            "a bounded import-scan deficiency must not flag too-large"
        );
    }
    ...
    fn too_large_gate_still_flags_context_and_hard_phrases() {
        ...
        let rebuild_platform_from_scratch = planning_issue(
            IssueType::Enhancement,
        ...
        assert!(
            looks_too_large_for_atomic_wi(&rebuild_platform_from_scratch),
            "'from scratch' beside a scope noun must remain a too-large signal"
        );
    }
...
changes:
  ...
  - path: apps/agentic-workflow/src/cli/issues.rs
    ...
    section: source
    description: |
      Issue #2187: capability planning emits a manifest-backed digest and an
  ...
  - path: apps/agentic-workflow/src/cli/issues.rs
    ...
    section: source
    description: |
      Project-plan v2 adds one stable normalize/reconcile/atomize/verify
