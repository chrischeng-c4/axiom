---
id: projects-score-src-td-check-section-type-rs
...
# Standardized apps/agentic-workflow/src/cli/td_check_section_type.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/cli/td_check_section_type.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CheckArgs` | apps/agentic-workflow/src/cli/td_check_section_type.rs | struct | pub | 32 |  |
| `Finding` | apps/agentic-workflow/src/cli/td_check_section_type.rs | struct | pub | 48 |  |
| `FindingKind` | apps/agentic-workflow/src/cli/td_check_section_type.rs | enum | pub | 40 |  |
| `Report` | apps/agentic-workflow/src/cli/td_check_section_type.rs | struct | pub | 60 |  |
| `run` | apps/agentic-workflow/src/cli/td_check_section_type.rs | function | pub | 77 | run(args: CheckArgs) -> Result<()> |
## Source
...
// @spec apps/agentic-workflow/tech-design/surface/interfaces/src/td_check_section_type.md#source
...
///
// @spec apps/agentic-workflow/tech-design/surface/specs/score-td-check-section-type-conformance.md#logic
