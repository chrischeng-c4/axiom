...
# Standardized apps/agentic-workflow/src/cli/cb_arbitrate.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/cli/cb_arbitrate.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CbArbitrateArgs` | apps/agentic-workflow/src/cli/cb_arbitrate.rs | struct | pub | 22 |  |
| `run_arbitrate` | apps/agentic-workflow/src/cli/cb_arbitrate.rs | function | pub | 51 | run_arbitrate(args: CbArbitrateArgs) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/cb_arbitrate.rs -->
```rust
...
// @spec apps/agentic-workflow/tech-design/surface/interfaces/src/cb_arbitrate.md#source
