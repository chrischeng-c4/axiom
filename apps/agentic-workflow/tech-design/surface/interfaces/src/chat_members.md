---
id: projects-score-src-chat-members-rs
...
# Standardized apps/agentic-workflow/src/cli/chat_members.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/cli/chat_members.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ChannelMessage` | apps/agentic-workflow/src/cli/chat_members.rs | struct | pub | 31 |  |
| `Member` | apps/agentic-workflow/src/cli/chat_members.rs | struct | pub | 65 |  |
| `MembersFile` | apps/agentic-workflow/src/cli/chat_members.rs | struct | pub | 80 |  |
| `MessageFrontmatter` | apps/agentic-workflow/src/cli/chat_members.rs | struct | pub | 51 |  |
| `detect_git_branch` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 214 | detect_git_branch(cwd: &Path) -> Option<String> |
| `detect_git_toplevel` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 227 | detect_git_toplevel(cwd: &Path) -> Option<String> |
| `detect_team_identity` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 208 | detect_team_identity(cwd: &Path, _members_path: &Path) -> Result<String> |
| `is_old_pipe_format` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 282 | is_old_pipe_format(content: &str) -> bool |
| `lookup_member_name_by_branch` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 241 | lookup_member_name_by_branch(branch: &str, members_path: &Path) -> Option<String> |
| `parse_channel_jsonl` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 526 | parse_channel_jsonl(content: &str) -> Vec<ChannelMessage> |
| `parse_channel_markdown` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 493 | parse_channel_markdown(content: &str) -> Vec<ChannelMessage> |
| `parse_frontmatter_blocks` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 557 | parse_frontmatter_blocks(content: &str) -> Vec<ChannelMessage> |
| `parse_pipe_format` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 358 | parse_pipe_format(content: &str) -> Vec<ChannelMessage> |
| `parse_pipe_line` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 310 | parse_pipe_line(id: i64, line: &str) -> ChannelMessage |
| `read_config_team_name` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 251 | read_config_team_name(cwd: &Path) -> Option<String> |
| `read_members_file` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 613 | read_members_file(path: &Path) -> Result<MembersFile> |
| `resolve_identity` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 126 | resolve_identity(cwd: &Path) -> Result<String> |
| `rewrite_channel_as_frontmatter` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 481 | rewrite_channel_as_frontmatter(path: &Path, msgs: &[ChannelMessage]) -> Result<()> |
| `run_members_register` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 632 | run_members_register(     identity: &str,     branch: &str,     wt_path: &str,     projects: &[String],     capabilities: &[String],     members_path: &Path, ) -> Result<()> |
| `serialize_message_block` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 452 | serialize_message_block(msg: &ChannelMessage) -> String |
| `serialize_message_jsonl` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 550 | serialize_message_jsonl(msg: &ChannelMessage) -> Result<String> |
| `write_members_file` | apps/agentic-workflow/src/cli/chat_members.rs | function | pub | 625 | write_members_file(path: &Path, mf: &MembersFile) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/chat_members.rs -->
```rust
...
//!
//! @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#overview
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#schema
...
pub struct ChannelMessage {
    ...
    // @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#schema
    pub body: String,
}
...
// @spec apps/agentic-workflow/tech-design/surface/interfaces/src/chat_members.md#source
...
///
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-cli-contract.md#logic
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic  Node: detect_branch
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic  Node: members_detect_branch
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic  Node: lookup_member
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic  Node: from_branch (config fallback)
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic  Node: detect_format
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic  Node: parse_pipe
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#schema  Node: rewrite_frontmatter
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic  Node: rewrite_frontmatter
...
///
// /// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#logic (parse_channel)
...
// apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#schema (ChannelMessage).
...
// stderr warning.
///
// /// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#logic (parse_channel JSONL branch)
...
// Once that primitive exists, this function regenerates from
// apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#interaction (post sequence).
...
///
// /// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-jsonl-migration.md#logic (run_post serialize step)
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic  Node: parse_messages
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic  Node: members_read
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic  Node: members_write
...
// @spec apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic  Node: members_find → members_upsert / members_insert → members_write
...
mod tests {
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#schema
    ...
    // REQ: apps/agentic-workflow/tech-design/surface/specs/score-chat-msg-members-schema.md#logic
