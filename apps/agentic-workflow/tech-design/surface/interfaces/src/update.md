...
# Standardized apps/agentic-workflow/src/cli/update.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/cli/update.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `is_newer` | apps/agentic-workflow/src/cli/update.rs | function | pub | 102 | is_newer(new_version: &str, current: &str) -> bool |
| `run` | apps/agentic-workflow/src/cli/update.rs | function | pub | 14 | run(check_only: bool) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/update.rs -->
```rust
