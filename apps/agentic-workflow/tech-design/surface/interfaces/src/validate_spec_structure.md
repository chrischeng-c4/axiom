...
# Standardized apps/agentic-workflow/src/cli/validate_spec_structure.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/agentic-workflow/src/cli/validate_spec_structure.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `run` | apps/agentic-workflow/src/cli/validate_spec_structure.rs | function | pub | 43 | run(path: Option<&str>, json: bool) -> Result<()> |
| `run_all` | apps/agentic-workflow/src/cli/validate_spec_structure.rs | function | pub | 131 | run_all() -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/validate_spec_structure.rs -->
```rust
...
// text lines.
// @spec apps/agentic-workflow/tech-design/surface/interfaces/src/validate_spec_structure.md#source
