---
id: apps-agentic-workflow-src-cli-artifact-producer-rs
summary: Canonical source unit for the shared WI, EC, and TD skeleton-fill protocol.
fill_sections: [source, changes]
capability_refs:
  - id: aw-core-client-model-workitem-first-artifact-lifecycle
    role: primary
    gap: shared-artifact-producer-contract
    claim: shared-artifact-producer-contract-source
    coverage: full
    rationale: "One internal contract exposes identity, skeleton, bounded slots, payloads, transitions, evidence, and TD ownership outputs."
---

# Standardized apps/agentic-workflow/src/cli/artifact_producer.rs

## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=apps/agentic-workflow/src/cli/artifact_producer.rs -->
~~~~~rust
...
changes:
  - path: apps/agentic-workflow/src/cli/artifact_producer.rs
    ...
    impl_mode: codegen
    description: |
      Issue #1499: define the shared internal artifact producer contract used
      by WI, EC, and TD without adding a public artifact namespace.
```
