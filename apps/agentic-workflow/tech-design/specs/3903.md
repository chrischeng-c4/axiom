...
```yaml
artifacts:
  - path: "apps/agentic-workflow/tech-design/surface/specs/aw-artifact-quality-profile.md"
  ...
  - path: "apps/agentic-workflow/tests/fixtures/artifact_quality_profiles"
...
e2e_tests:
  ...
  - name: runtime_envelope_backward_compatibility
    ...
    claim_id: runtime-envelope-backward-compatibility
  ...
  - name: project_health_no_regression
    ...
    claim_id: project-health-no-regression
