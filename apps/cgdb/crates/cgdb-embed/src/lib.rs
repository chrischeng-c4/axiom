// SPEC-MANAGED: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#changes
// CODEGEN-BEGIN
#[derive(Subcommand)]
pub enum Commands {
}
...
pub async fn lens_overview(&self, project: String) -> Result<serde_json::Value> {
    // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#lens-overview
...
pub async fn lens_zoom_in(&self, node_id: String) -> Result<serde_json::Value> {
    // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#lens-zoom-in
...
pub async fn lens_zoom_out(&self, node_id: String) -> Result<serde_json::Value> {
    // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#lens-zoom-out
...
pub async fn lens_focus(&self, node_id: String, depth: i64, include_semantic: bool) -> Result<serde_json::Value> {
    // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#lens-focus
...
pub async fn lens_breadcrumb(&self, node_id: String) -> Result<serde_json::Value> {
    // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#lens-breadcrumb
...
pub async fn query_coverage(&self, name: String, include_semantic: bool) -> Result<serde_json::Value> {
    // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#query-coverage
...
pub async fn query_impact(&self, name: String, spec_section: String, include_semantic: bool) -> Result<serde_json::Value> {
    // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#query-impact
...
pub fn start() -> std::result::Result<(), Box<dyn std::error::Error>> {
    // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#cgdb-v0-1-lens-dispatch-resolve
    ...
    if todo!("decision: method?") /* overview */ {
        // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#cgdb-v0-1-lens-dispatch-ov
        ...
        if nodes.len > 50? /* yes */ {
            // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#cgdb-v0-1-lens-dispatch-summarize
            ...
            if format == mermaid? /* json */ {
                // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#cgdb-v0-1-lens-dispatch-json_out
                ...
                // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#cgdb-v0-1-lens-dispatch-mermaid_out
        ...
        // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#cgdb-v0-1-lens-dispatch-zin
        ...
        // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#cgdb-v0-1-lens-dispatch-zout
        ...
        // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#cgdb-v0-1-lens-dispatch-foc
        ...
        // SPEC-REF: .score/tech_design/apps/cgdb/specs/cgdb-v0-1.md#cgdb-v0-1-lens-dispatch-bc
