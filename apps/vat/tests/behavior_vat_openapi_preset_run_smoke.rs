// SPEC-MANAGED: apps/vat/tech-design/interfaces/rest/openapi-driven-mock-http-service.md#vat-openapi-preset-run-smoke
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
fn vat_openapi_preset_run_smoke() {
    let command = "cargo test -p vat --test vat_emulator_openapi -- --nocapture --include-ignored";
