// HANDWRITE-BEGIN gap="missing-generator:e2e-test:950cee14" tracker="#1474" reason="AC3/AC4: new fail-closed integration test file covering GpuRequest::Required, missing microvm_image, EgressPolicy::LocalhostOnly, and container-unavailable pick() rejections, plus the dedicated run.rs gpu_satisfied() preflight rejection case proving the second independent fail-closed layer (R4)."
