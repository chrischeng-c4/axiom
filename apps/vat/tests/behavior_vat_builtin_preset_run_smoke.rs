// SPEC-MANAGED: apps/vat/tech-design/logic/built-in-rust-emulators-pub-sub-firebase-auth.md#vat-builtin-preset-run-smoke
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: a `preset = "firebase-auth"` or `preset = "gcloud-pubsub"` vat.toml run exports FIREBASE_AUTH_EMULATOR_HOST / PUBSUB_EMULATOR_HOST and the runner reaches the emulator; nothing remains after teardown.
#[test]
