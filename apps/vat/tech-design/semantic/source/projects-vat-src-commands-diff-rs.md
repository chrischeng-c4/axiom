...
summary: >
  rust-source-unit TD AST payload for apps/vat/src/commands/diff.rs.
...
# Standardized apps/vat/src/commands/diff.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/vat/src/commands/diff.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `exec` | apps/vat/src/commands/diff.rs | function | pub | 15 | exec(id: String, json: bool) -> Result<ExitCode> |
## Source
...
changes:
  - path: apps/vat/src/commands/diff.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/vat/src/commands/diff.rs` captured during #39 vat standardization.
```
