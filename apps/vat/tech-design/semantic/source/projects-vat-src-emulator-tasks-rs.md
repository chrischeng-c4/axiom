...
summary: >
  rust-source-unit TD AST payload for apps/vat/src/emulator/tasks.rs.
...
# Standardized apps/vat/src/emulator/tasks.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/vat/src/emulator/tasks.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `serve` | apps/vat/src/emulator/tasks.rs | function | pub | 41 | serve(host_port: &str) -> Result<()> |
## Source
...
changes:
  - path: apps/vat/src/emulator/tasks.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/vat/src/emulator/tasks.rs` captured during #39 vat standardization.
```
