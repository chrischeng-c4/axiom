...
summary: >
  rust-source-unit TD AST payload for apps/vat/tests/vat_toml_runner.rs.
...
# Standardized apps/vat/tests/vat_toml_runner.rs
...
changes:
  - path: apps/vat/tests/vat_toml_runner.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/vat/tests/vat_toml_runner.rs` captured during #39 vat standardization.
```
