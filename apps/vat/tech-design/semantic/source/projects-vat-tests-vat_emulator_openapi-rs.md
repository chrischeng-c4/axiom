...
summary: >
  rust-source-unit TD AST payload for apps/vat/tests/vat_emulator_openapi.rs.
...
# Standardized apps/vat/tests/vat_emulator_openapi.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/vat/tests/vat_emulator_openapi.rs` generated from AST during Score force-regeneration standardization.
...
changes:
  - path: apps/vat/tests/vat_emulator_openapi.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/vat/tests/vat_emulator_openapi.rs` captured during #39 vat standardization.
```
