...
# Standardized apps/vat/tests/vat_emulator_grpc_mitm_routing.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/vat/tests/vat_emulator_grpc_mitm_routing.rs` generated from AST during Score force-regeneration standardization.
...
changes:
  - path: apps/vat/tests/vat_emulator_grpc_mitm_routing.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/vat/tests/vat_emulator_grpc_mitm_routing.rs` captured during vat standardization.
```
