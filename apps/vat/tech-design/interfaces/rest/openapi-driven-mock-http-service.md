...
```yaml
changes:
  - path: apps/vat/tech-design/interfaces/rest/openapi-driven-mock-http-service.md
    action: create
    section: changes
  ...
  - path: apps/vat/src/emulator/openapi.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/interfaces/rest/openapi-driven-mock-http-service.md#logic"
  ...
  - path: apps/vat/src/emulator/openapi.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/interfaces/rest/openapi-driven-mock-http-service.md#schema"
  ...
  - path: apps/vat/src/cli.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/interfaces/rest/openapi-driven-mock-http-service.md#cli"
  ...
  - path: apps/vat/src/config.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/interfaces/rest/openapi-driven-mock-http-service.md#config"
  ...
  - path: apps/vat/tests/vat_emulator_openapi.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/interfaces/rest/openapi-driven-mock-http-service.md#unit-test"
      - "apps/vat/tech-design/interfaces/rest/openapi-driven-mock-http-service.md#e2e-test"
