...
```yaml
changes:
  - path: apps/vat/tech-design/logic/kind-like-local-kubernetes-clusters.md
    action: create
    section: changes
  ...
  - path: apps/vat/src/config.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/kind-like-local-kubernetes-clusters.md#config"
      - "apps/vat/tech-design/logic/kind-like-local-kubernetes-clusters.md#schema"
  ...
  - path: apps/vat/src/cluster.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/kind-like-local-kubernetes-clusters.md#logic"
  ...
  - path: apps/vat/src/commands/cluster.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/kind-like-local-kubernetes-clusters.md#cli"
  ...
  - path: apps/vat/tests
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/kind-like-local-kubernetes-clusters.md#unit-test"
  ...
  - path: apps/vat/tests
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/kind-like-local-kubernetes-clusters.md#e2e-test"
