...
```yaml
changes:
  - path: apps/vat/tech-design/logic/built-in-cloud-tasks-cloud-scheduler-emulators.md
    action: create
    section: changes
  ...
  - path: apps/vat/Cargo.toml
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-cloud-tasks-cloud-scheduler-emulators.md#config"
  ...
  - path: apps/vat/src/emulator/dispatch.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-cloud-tasks-cloud-scheduler-emulators.md#logic"
  ...
  - path: apps/vat/src/cli.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-cloud-tasks-cloud-scheduler-emulators.md#cli"
  ...
  - path: apps/vat/tests
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-cloud-tasks-cloud-scheduler-emulators.md#unit-test"
      - "apps/vat/tech-design/logic/built-in-cloud-tasks-cloud-scheduler-emulators.md#e2e-test"
