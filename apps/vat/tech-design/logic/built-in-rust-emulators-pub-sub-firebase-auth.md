...
```yaml
changes:
  - path: apps/vat/tech-design/logic/built-in-rust-emulators-pub-sub-firebase-auth.md
    action: create
    section: changes
  ...
  - path: apps/vat/Cargo.toml
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-rust-emulators-pub-sub-firebase-auth.md#config"
  ...
  - path: apps/vat/build.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-rust-emulators-pub-sub-firebase-auth.md#logic"
  ...
  - path: apps/vat/proto/google/pubsub/v1/pubsub.proto
    action: add
    section: logic
    impl_mode: hand-written
    refs:
  ...
  - path: apps/vat/src/commands/emulator.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-rust-emulators-pub-sub-firebase-auth.md#cli"
  ...
  - path: apps/vat/tests
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-rust-emulators-pub-sub-firebase-auth.md#unit-test"
      - "apps/vat/tech-design/logic/built-in-rust-emulators-pub-sub-firebase-auth.md#e2e-test"
