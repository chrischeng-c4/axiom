...
```yaml
changes:
  - path: apps/vat/tech-design/logic/built-in-http-mock-record-replay-proxy.md
    action: create
    section: changes
  ...
  - path: apps/vat/Cargo.toml
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-http-mock-record-replay-proxy.md#config"
  ...
  - path: apps/vat/src/emulator/httpmock/ca.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-http-mock-record-replay-proxy.md#logic"
  ...
  - path: apps/vat/src/cli.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-http-mock-record-replay-proxy.md#cli"
  ...
  - path: apps/vat/tests
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-http-mock-record-replay-proxy.md#unit-test"
      - "apps/vat/tech-design/logic/built-in-http-mock-record-replay-proxy.md#e2e-test"
