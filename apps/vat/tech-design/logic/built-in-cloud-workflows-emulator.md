...
```yaml
changes:
  - path: apps/vat/tech-design/logic/built-in-cloud-workflows-emulator.md
    action: create
    section: changes
  ...
  - path: apps/vat/Cargo.toml
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-cloud-workflows-emulator.md#config"
  ...
  - path: apps/vat/src/emulator/workflows/expr.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-cloud-workflows-emulator.md#logic"
  ...
  - path: apps/vat/src/cli.rs
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-cloud-workflows-emulator.md#cli"
  ...
  - path: apps/vat/tests
    ...
    impl_mode: hand-written
    refs:
      - "apps/vat/tech-design/logic/built-in-cloud-workflows-emulator.md#unit-test"
      - "apps/vat/tech-design/logic/built-in-cloud-workflows-emulator.md#e2e-test"
