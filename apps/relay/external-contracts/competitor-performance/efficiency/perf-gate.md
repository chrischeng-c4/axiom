...
is captured as runtime evidence. The external RabbitMQ/NATS JetStream/Redis
Streams/Dragonfly comparison remains advisory until the native broker harness is
promoted into a required gate.
...
e2e_tests:
  - id: relay-competitor-performance-meter-gate
    ...
    category: efficiency
    test_path: apps/relay/tests/benchmark_relay_competitor_performance_meter_gate.rs
    ...
    assertions:
      ...
      - "The small-scale publish and work-queue lease/ack workloads complete correctly."
