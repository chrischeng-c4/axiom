...
| Stateful Service Workload | 1555 | implemented | passing | conformance | not_ready | mandatory baseline: one capability root composes existing durable acknowledgement, stable StatefulSet identity, raft, backup, security, and deployment evidence |
