...
How to change `apps/courier`. What it promises and the work roots it owns live
...
`courier-qa` runs the declared complete gate. The controller owns Git, tracker,
...
| Gate | Command |
|---|---|
| unit + colocated tests | `cargo test -p courier` |
