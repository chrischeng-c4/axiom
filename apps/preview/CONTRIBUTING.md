...
How to change `apps/preview`. What it promises and the work roots it owns live
...
`preview-qa` runs the declared complete gate. The controller owns Git, tracker,
...
| Gate | Command |
|---|---|
| unit + colocated tests | `cargo test -p preview` |
