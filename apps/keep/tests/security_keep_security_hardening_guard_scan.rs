// SPEC-MANAGED: apps/keep/external-contracts/security-hardening/security/security-evidence.md#keep-security-hardening-guard-scan
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// @command cd apps/keep && ../../target/debug/vat run guard-security
// AW-EC-END
...
fn keep_security_hardening_guard_scan() {
    let command = "cd apps/keep && ../../target/debug/vat run guard-security";
