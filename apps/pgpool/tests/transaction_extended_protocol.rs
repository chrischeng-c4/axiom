...
// <HANDWRITE gap="missing-generator:logic" tracker="#1922" reason="Give the existing transaction extended-protocol integration proof explicit, auditable ownership without changing behavior.">
