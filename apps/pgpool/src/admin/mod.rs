...
//! `server_http::serve_h2c_with_options`, sharing ONE
//! `server_lifecycle::DrainController` with the TCP frontend so `/readyz` and
...
pub use wiring::{drain_on_shutdown_signal, wire_server_tcp_drain};
// </HANDWRITE>
