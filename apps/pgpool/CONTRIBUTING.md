...
How to change `apps/pgpool`. What it promises and the work roots it owns live
...
`pgpool-qa` runs the declared complete gate. The controller owns Git, tracker,
...
| Gate | Command |
|---|---|
| unit + colocated tests | `cargo test -p pgpool` |
