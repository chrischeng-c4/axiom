...
mod tests {
    ...
    fn report(outcome: Outcome) -> TestReport {
        TestReport {
            file: PathBuf::from("flows/artifact-studio.spec.ts"),
            suite: vec!["Artifact Studio".to_string()],
    ...
    fn manual_docs_writer_publishes_markdown_html_and_copied_screenshots() {
        ...
        assert!(markdown.contains("![Artifact Studio"), "{markdown}");
        ...
        E2eEvidenceBundle {
            ...
            cases: vec![
                E2eCaseEvidence {
                    ...
                    file: PathBuf::from("e2e/artifact-studio.spec.js"),
                    outcome: "passed".to_string(),
                    duration_ms: 250,
                    steps: vec![
