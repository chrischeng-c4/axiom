...
// <HANDWRITE gap="standardize:projects-jet-src-codegen-client-emit-rs" tracker="standardize-gap-projects-jet-src-codegen-client-emit-rs" reason="Existing hand-written code in apps/jet/src/codegen/client_emit.rs requires tracked generator coverage.">
