...
// <HANDWRITE gap="standardize:projects-jet-src-codegen-plan-rs" tracker="standardize-gap-projects-jet-src-codegen-plan-rs" reason="Existing hand-written code in apps/jet/src/codegen/plan.rs requires tracked generator coverage.">
