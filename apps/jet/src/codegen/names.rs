...
// <HANDWRITE gap="standardize:projects-jet-src-codegen-names-rs" tracker="standardize-gap-projects-jet-src-codegen-names-rs" reason="Existing hand-written code in apps/jet/src/codegen/names.rs requires tracked generator coverage.">
