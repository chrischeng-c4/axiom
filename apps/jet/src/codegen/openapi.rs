...
// <HANDWRITE gap="standardize:projects-jet-src-codegen-openapi-rs" tracker="standardize-gap-projects-jet-src-codegen-openapi-rs" reason="Existing hand-written code in apps/jet/src/codegen/openapi.rs requires tracked generator coverage.">
