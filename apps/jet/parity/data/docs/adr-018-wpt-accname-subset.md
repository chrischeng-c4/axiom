...
```
apps/jet/data/parity/wpt/accname/
...
`apps/jet/data/parity/wpt/accname/manifest.toml`:
...
The runner lives under `apps/jet/data/parity/runners/accname/` and is
