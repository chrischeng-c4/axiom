...
```js
// apps/jet/data/parity/harness/preface/await-fonts.js
...
`apps/jet/data/parity/fixtures/<fixture>/fonts/` as subset WOFF2 files.
...
```toml
# apps/jet/data/parity/fixtures/mui-button/fonts/manifest.toml
[font.roboto-regular]
