...
//!
//! @spec `.score/tech_design/apps/jet/logic/multi-target/desktop-runtime.md`
//! @issue #1242
//!
...
//!   `apps/jet/src/wasm_build/manifest.rs` emits to
...
/// emitter at `apps/jet/src/wasm_build/manifest.rs` exactly. We
