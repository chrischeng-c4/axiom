...
summary: Semantic coverage for "apps/jet/tests/fixtures/dom-production-build"
capability_refs:
  - id: "rust-native-frontend-toolchain"
    role: primary
    claim: "production-replacement-readiness"
    coverage: partial
    rationale: "Semantic takeover coverage for existing source group `apps/jet/tests/fixtures/dom-production-build`."
...
frontend_semantic:
  ...
  source_group: "apps/jet/tests/fixtures/dom-production-build"
  coverage_kind: semantic
  evidence:
    source_units:
      - path: "apps/jet/tests/fixtures/dom-production-build/styled-components-visual/src/main.tsx"
        language: "typescript"
        ...
        source_evidence_node:
          ...
          role: "component"
          section_type: "component"
          domain: "apps/jet/tests/fixtures/dom-production-build"
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/styled-components-visual/src"
          component: "Main"
        frontend_node:
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/styled-components-visual/src"
          role: "component"
          ...
          component: "Main"
      - path: "apps/jet/tests/fixtures/dom-production-build/mui-visual/src/main.tsx"
        language: "typescript"
        ownership_state: "handwrite"
        ...
        source_evidence_node:
          ...
          section_type: "component"
          domain: "apps/jet/tests/fixtures/dom-production-build"
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/mui-visual/src"
          component: "Main"
        frontend_node:
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/mui-visual/src"
          role: "component"
          ...
          artifact_kind: "component"
          component: "Main"
      - path: "apps/jet/tests/fixtures/dom-production-build/mui-visual/src/MuiVisualFixture.tsx"
        language: "typescript"
        ownership_state: "handwrite"
        ...
        frontend_node:
          ...
          artifact_kind: "component"
          component: "MuiVisualFixture"
      - path: "apps/jet/tests/fixtures/dom-production-build/dom-production-assets/src/main.tsx"
        language: "typescript"
        ownership_state: "handwrite"
        generator_primitives: ["frontend_component", "td_section_component", "test_case", "ts_component"]
        source_evidence_node:
          ...
          section_type: "component"
          domain: "apps/jet/tests/fixtures/dom-production-build"
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/dom-production-assets/src"
          component: "Main"
        frontend_node:
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/dom-production-assets/src"
          role: "component"
          ...
          artifact_kind: "component"
          component: "Main"
      - path: "apps/jet/tests/fixtures/dom-production-build/antd-visual/src/main.tsx"
        language: "typescript"
        ownership_state: "handwrite"
        generator_primitives: ["frontend_component", "td_section_component", "test_case", "ts_component"]
        source_evidence_node:
          ...
          section_type: "component"
          domain: "apps/jet/tests/fixtures/dom-production-build"
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/antd-visual/src"
          component: "Main"
        frontend_node:
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/antd-visual/src"
          role: "component"
          ...
          artifact_kind: "component"
          component: "Main"
      - path: "apps/jet/tests/fixtures/dom-production-build/antd-visual/src/AntdVisualFixture.tsx"
        language: "typescript"
        ownership_state: "handwrite"
        generator_primitives: ["frontend_component", "service_method", "td_section_component", "test_case", "ts_component"]
        symbols:
        ...
        frontend_node:
          ...
          artifact_kind: "component"
          component: "AntdVisualFixture"
      - path: "apps/jet/tests/fixtures/dom-production-build/tailwind-visual/src/main.tsx"
        language: "typescript"
        ownership_state: "handwrite"
        generator_primitives: ["config_surface", "frontend_component", "td_section_component", "test_case", "ts_component"]
        symbols:
        ...
        source_evidence_node:
          ...
          section_type: "component"
          domain: "apps/jet/tests/fixtures/dom-production-build"
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/tailwind-visual/src"
          component: "Main"
        frontend_node:
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/tailwind-visual/src"
          role: "component"
          ...
          artifact_kind: "component"
          component: "Main"
      - path: "apps/jet/tests/fixtures/dom-production-build/react-bench/src/App.tsx"
        language: "typescript"
        ownership_state: "handwrite"
        generator_primitives: ["config_surface", "frontend_component", "td_section_component", "test_case", "ts_component"]
        symbols:
        ...
        source_evidence_node:
          ...
          section_type: "component"
          domain: "apps/jet/tests/fixtures/dom-production-build"
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/react-bench/src"
          component: "App"
        frontend_node:
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/react-bench/src"
          role: "component"
          ...
          artifact_kind: "component"
          component: "App"
      - path: "apps/jet/tests/fixtures/dom-production-build/react-bench/src/main.tsx"
        language: "typescript"
        ownership_state: "handwrite"
        generator_primitives: ["frontend_component", "td_section_component", "test_case", "ts_component"]
        source_evidence_node:
        ...
        frontend_node:
          ...
          artifact_kind: "component"
          component: "Main"
      - path: "apps/jet/tests/fixtures/dom-production-build/react-bench/src/components/Counter.tsx"
        language: "typescript"
        ownership_state: "handwrite"
        generator_primitives: ["frontend_component", "service_method", "td_section_component", "test_case", "ts_component"]
        symbols:
        ...
        source_evidence_node:
          ...
          section_type: "component"
          domain: "apps/jet/tests/fixtures/dom-production-build"
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/react-bench/src/components"
          component: "Counter"
        frontend_node:
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/react-bench/src/components"
          role: "component"
          ...
          artifact_kind: "component"
          component: "Counter"
      - path: "apps/jet/tests/fixtures/dom-production-build/react-bench/src/components/TodoList.tsx"
        language: "typescript"
        ownership_state: "handwrite"
...
frontend_semantic:
  ...
  evidence:
    source_units:
      - path: "apps/jet/tests/fixtures/dom-production-build/dom-production-assets/src/main.css"
        language: "stylesheet"
        ownership_state: "handwrite"
      ...
      - path: "apps/jet/tests/fixtures/dom-production-build/tailwind-visual/src/main.css"
        language: "stylesheet"
        ownership_state: "handwrite"
        generator_primitives: ["frontend_style-surface", "td_section_design_token", "test_case"]
        source_evidence_node:
...
frontend_semantic:
  ...
  evidence:
    source_units:
      - path: "apps/jet/tests/fixtures/dom-production-build/tailwind-visual/postcss.config.cjs"
        language: "javascript"
        ownership_state: "handwrite"
        ...
        source_evidence_node:
          ...
          section_type: "schema"
          domain: "apps/jet/tests/fixtures/dom-production-build"
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/tailwind-visual"
        frontend_node:
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/tailwind-visual"
          role: "source"
          section_type: "schema"
...
nodes:
  ...
  classify_frontend_ast:
    kind: process
    label: "Map FE ecosystem AST group \"apps/jet/tests/fixtures/dom-production-build\" to logic emitter primitives"
  generator_gap:
    kind: terminal
...
- apps/jet/tests/fixtures/dom-production-build/dom-production-assets/css-inject-loader.cjs
- apps/jet/tests/fixtures/dom-production-build/dom-production-assets/webpack.config.cjs
- apps/jet/tests/fixtures/dom-production-build/react-bench/webpack.config.cjs
-->
...
changes:
  ...
  - path: "apps/jet/tests/fixtures/dom-production-build/dom-production-assets/css-inject-loader.cjs"
    action: modify
    section: logic
    description: |
      Existing source behavior is covered by this feature/domain semantic TD.
  ...
  - path: "apps/jet/tests/fixtures/dom-production-build/dom-production-assets/webpack.config.cjs"
    action: modify
    section: logic
    description: |
      Existing source behavior is covered by this feature/domain semantic TD.
  ...
  - path: "apps/jet/tests/fixtures/dom-production-build/react-bench/webpack.config.cjs"
    action: modify
    section: logic
    description: |
      Existing source behavior is covered by this feature/domain semantic TD.
