...
summary: Semantic coverage for "apps/jet/tests/fixtures/dom-production-build/dom-production-assets"
capability_refs:
  - id: "rust-native-frontend-toolchain"
    role: primary
    claim: "production-replacement-readiness"
    coverage: partial
    rationale: "Semantic takeover coverage for existing source group `apps/jet/tests/fixtures/dom-production-build/dom-production-assets`."
...
frontend_semantic:
  ...
  source_group: "apps/jet/tests/fixtures/dom-production-build/dom-production-assets"
  coverage_kind: semantic
  evidence:
    source_units:
      - path: "apps/jet/tests/fixtures/dom-production-build/dom-production-assets/package.json"
        language: "json"
        ...
        source_evidence_node:
          ...
          role: "manifest"
          section_type: "manifest"
          domain: "apps/jet/tests/fixtures/dom-production-build/dom-production-assets"
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/dom-production-assets"
        frontend_node:
          workspace_root: "apps/jet/tests/fixtures/dom-production-build/dom-production-assets"
          role: "manifest"
          section_type: "manifest"
...
frontend_semantic:
  ...
  evidence:
    source_units:
      - path: "apps/jet/tests/fixtures/dom-production-build/dom-production-assets/vite.config.ts"
        language: "typescript"
        ownership_state: "handwrite"
