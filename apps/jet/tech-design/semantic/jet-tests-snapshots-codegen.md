...
summary: Semantic coverage for "apps/jet/tests/__snapshots__/codegen"
capability_refs:
  - id: "rust-native-frontend-toolchain"
    role: primary
    claim: "production-replacement-readiness"
    coverage: partial
    rationale: "Semantic takeover coverage for existing source group `apps/jet/tests/__snapshots__/codegen`."
...
frontend_semantic:
  ...
  source_group: "apps/jet/tests/__snapshots__/codegen"
  coverage_kind: semantic
  evidence:
    source_units:
      - path: "apps/jet/tests/__snapshots__/codegen/minimal__types.ts"
        language: "typescript"
        ...
        source_evidence_node:
          ...
          role: "source"
          section_type: "schema"
          domain: "apps/jet/tests/__snapshots__/codegen"
          workspace_root: "apps/jet/tests/__snapshots__/codegen"
        frontend_node:
          workspace_root: "apps/jet/tests/__snapshots__/codegen"
          role: "source"
          section_type: "schema"
          artifact_kind: "source-unit"
      - path: "apps/jet/tests/__snapshots__/codegen/minimal__index.ts"
        language: "typescript"
        ownership_state: "handwrite"
...
nodes:
  ...
  classify_frontend_ast:
    kind: process
    label: "Map FE ecosystem AST group \"apps/jet/tests/__snapshots__/codegen\" to logic emitter primitives"
  generator_gap:
    kind: terminal
...
- apps/jet/tests/__snapshots__/codegen/minimal__client.ts
- apps/jet/tests/__snapshots__/codegen/minimal__runtime.ts
- apps/jet/tests/__snapshots__/codegen/minimal__hooks.ts
- apps/jet/tests/__snapshots__/codegen/minimal__runtime.axios.ts
-->
...
coverage_kind: semantic
changes:
  - path: "apps/jet/tests/__snapshots__/codegen/minimal__client.ts"
    action: modify
    section: logic
    description: |
  ...
  - path: "apps/jet/tests/__snapshots__/codegen/minimal__runtime.ts"
    action: modify
    section: logic
    description: |
      Existing source behavior is covered by this feature/domain semantic TD.
  ...
  - path: "apps/jet/tests/__snapshots__/codegen/minimal__hooks.ts"
    action: modify
    section: logic
    description: |
      Existing source behavior is covered by this feature/domain semantic TD.
  ...
  - path: "apps/jet/tests/__snapshots__/codegen/minimal__runtime.axios.ts"
    action: modify
    section: logic
    description: |
      Existing source behavior is covered by this feature/domain semantic TD.
