...
summary: Semantic coverage for "apps/jet/tests/pkg-mgmt"
capability_refs:
  - id: "rust-native-frontend-toolchain"
    role: primary
    claim: "production-replacement-readiness"
    coverage: partial
    rationale: "Semantic takeover coverage for existing source group `apps/jet/tests/pkg-mgmt`."
...
semantic_domain:
  ...
  source_group: "apps/jet/tests/pkg-mgmt"
  coverage_kind: semantic
  evidence:
    source_units:
      - path: "apps/jet/tests/pkg-mgmt/workspace_protocol.rs"
        language: "rust"
        ...
        source_evidence_node:
          ...
          domain: "apps/jet/tests/pkg-mgmt"
      - path: "apps/jet/tests/pkg-mgmt/pkg_replacement_gate.rs"
        language: "rust"
        ...
        symbols:
          - name: "harness"
            kind: "module"
            public: false
          - name: "jet_pkg_management_replaces_npm_pnpm_and_is_faster"
            kind: "function"
            public: false
        source_evidence_node:
          layer: "backend"
