// SPEC-MANAGED: apps/jet/external-contracts/behavior/hook-state-preserving-refresh.md#hook-state-preserving-refresh
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Preview HMR preserves React hook state across a compatible source edit.
#[test]
