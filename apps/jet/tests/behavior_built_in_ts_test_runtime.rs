// SPEC-MANAGED: apps/jet/external-contracts/behavior/built-in-ts-test-runtime.md#built-in-ts-test-runtime
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet built-in TypeScript test runtime executes supported TypeScript tests with expected results.
#[test]
