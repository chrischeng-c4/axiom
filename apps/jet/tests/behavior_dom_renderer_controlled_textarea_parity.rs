// SPEC-MANAGED: apps/jet/external-contracts/behavior/dom-renderer-controlled-textarea-parity.md#dom-renderer-controlled-textarea-parity
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Controlled textarea values remain equal between React DOM and Jet WASM after updates.
#[test]
