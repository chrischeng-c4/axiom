// SPEC-MANAGED: apps/jet/external-contracts/behavior/prebundle-importmap-parity.md#prebundle-importmap-parity
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Dev-server prebundling produces an import map that resolves configured dependencies.
#[test]
