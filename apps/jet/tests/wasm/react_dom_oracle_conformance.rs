...
const LIBRARY_FIXTURE_MANIFEST: &str = "apps/jet/parity/data/fixtures/libraries/fixtures.toml";
const LIBRARY_PACKAGE_MANIFEST: &str = "apps/jet/parity/data/fixtures/libraries/package.json";
