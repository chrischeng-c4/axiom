// SPEC-MANAGED: apps/jet/external-contracts/behavior/dev-server-replacement-readiness.md#dev-server-replacement-readiness
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet dev server satisfies the replacement readiness suite for local serving, HMR, and proxy behavior.
#[test]
