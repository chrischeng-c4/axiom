// SPEC-MANAGED: apps/jet/external-contracts/behavior/trace-evidence-artifacts.md#trace-evidence-artifacts
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet trace subsystem emits required trace evidence artifacts for supported runs.
#[test]
