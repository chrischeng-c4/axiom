// SPEC-MANAGED: apps/jet/external-contracts/behavior/stack-aware-openapi-codegen.md#stack-aware-openapi-codegen
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet OpenAPI code generation selects the correct stack-aware client and hook output.
#[test]
