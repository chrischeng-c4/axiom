// SPEC-MANAGED: apps/jet/external-contracts/behavior/dev-server-local-serving-hmr.md#dev-server-local-serving-hmr
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet dev server serves local modules and applies hot updates without requiring a full restart.
#[test]
