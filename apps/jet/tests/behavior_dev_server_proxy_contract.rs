// SPEC-MANAGED: apps/jet/external-contracts/behavior/dev-server-proxy-contract.md#dev-server-proxy-contract
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Configured dev-server proxy routes requests to the upstream target with preserved contract behavior.
#[test]
