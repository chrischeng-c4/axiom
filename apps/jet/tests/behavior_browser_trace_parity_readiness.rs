// SPEC-MANAGED: apps/jet/external-contracts/behavior/browser-trace-parity-readiness.md#browser-trace-parity-readiness
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: The browser verification phase produces the required trace and parity evidence.
#[test]
