// SPEC-MANAGED: apps/jet/external-contracts/behavior/package-manager-workspace-parity.md#package-manager-workspace-parity
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet workspace package discovery and linking preserve declared workspace relationships.
#[test]
