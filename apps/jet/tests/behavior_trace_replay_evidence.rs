// SPEC-MANAGED: apps/jet/external-contracts/behavior/trace-replay-evidence.md#trace-replay-evidence
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Recorded Jet trace evidence replays into the expected observable outcome.
#[test]
