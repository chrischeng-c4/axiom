// SPEC-MANAGED: apps/jet/external-contracts/behavior/webgpu-wasm-build-default.md#webgpu-wasm-build-default
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet WASM build selects the WebGPU scaffold by default.
#[test]
