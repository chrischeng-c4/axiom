// SPEC-MANAGED: apps/jet/external-contracts/behavior/library-wasm-lowering-fixtures.md#library-wasm-lowering-fixtures
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: TSX-to-Rust lowering preserves supported import forms in library fixtures.
#[test]
