// SPEC-MANAGED: apps/jet/external-contracts/behavior/task-runner-graph-cache.md#task-runner-graph-cache
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet task runner builds and executes a dependency graph with its cache contract intact.
#[test]
