// SPEC-MANAGED: apps/jet/external-contracts/behavior/stories-controls-panel.md#stories-controls-panel
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Stories controls render prop-derived inputs and update the preview when args change.
#[test]
