// SPEC-MANAGED: apps/jet/external-contracts/behavior/asset-sourcemap-negative-paths.md#asset-sourcemap-negative-paths
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Invalid asset source-map inputs report a safe failure without producing malformed output.
#[test]
