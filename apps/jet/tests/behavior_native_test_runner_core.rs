// SPEC-MANAGED: apps/jet/external-contracts/behavior/native-test-runner-core.md#native-test-runner-core
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet native test runner discovers, executes, and reports supported test cases.
#[test]
