// SPEC-MANAGED: apps/jet/external-contracts/behavior/stories-preview-hmr.md#stories-preview-hmr
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Stories preview HMR refreshes modules while preserving compatible component state.
#[test]
