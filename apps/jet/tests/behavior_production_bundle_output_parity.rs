// SPEC-MANAGED: apps/jet/external-contracts/behavior/production-bundle-output-parity.md#production-bundle-output-parity
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet production bundler emits parseable output with required module resolution behavior.
#[test]
