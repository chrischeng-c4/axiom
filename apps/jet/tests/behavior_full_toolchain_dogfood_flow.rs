// SPEC-MANAGED: apps/jet/external-contracts/behavior/full-toolchain-dogfood-flow.md#full-toolchain-dogfood-flow
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: The end-to-end Jet toolchain dogfood flow passes all required package, build, browser, and production gates.
#[test]
