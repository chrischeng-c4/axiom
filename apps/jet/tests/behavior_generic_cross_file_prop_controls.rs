// SPEC-MANAGED: apps/jet/external-contracts/behavior/generic-cross-file-prop-controls.md#generic-cross-file-prop-controls
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Stories controls derive editable values for generic, cross-file, and intersection prop types.
#[test]
