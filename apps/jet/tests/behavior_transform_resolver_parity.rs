// SPEC-MANAGED: apps/jet/external-contracts/behavior/transform-resolver-parity.md#transform-resolver-parity
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet transform resolver resolves supported source and package imports consistently.
#[test]
