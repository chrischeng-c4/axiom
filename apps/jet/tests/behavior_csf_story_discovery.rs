// SPEC-MANAGED: apps/jet/external-contracts/behavior/csf-story-discovery.md#csf-story-discovery
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: CSF story modules are discovered and parsed into a usable story index.
#[test]
