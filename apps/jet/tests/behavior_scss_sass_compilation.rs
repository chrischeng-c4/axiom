// SPEC-MANAGED: apps/jet/external-contracts/behavior/scss-sass-compilation.md#scss-sass-compilation
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet compiles SCSS and Sass imports through the library CSS build pipeline.
#[test]
