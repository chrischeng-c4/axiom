// SPEC-MANAGED: apps/jet/external-contracts/behavior/stories-dev-manager.md#stories-dev-manager
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet stories dev starts a manager with sidebar and preview behavior for discovered stories.
#[test]
