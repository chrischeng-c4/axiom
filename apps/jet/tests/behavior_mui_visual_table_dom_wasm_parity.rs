// SPEC-MANAGED: apps/jet/external-contracts/behavior/mui-visual-table-dom-wasm-parity.md#mui-visual-table-dom-wasm-parity
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Material UI visual-table rendering stays equivalent between React DOM and Jet WASM.
#[test]
