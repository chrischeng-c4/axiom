// <HANDWRITE gap="standardize:claim-code" tracker="projects-jet-tests-snapshots-codegen-minimal-hooks-swr-ts" reason="Existing code claimed during Score standardization until deterministic generator coverage lands.">
