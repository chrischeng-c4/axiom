// SPEC-MANAGED: apps/jet/external-contracts/behavior/workspace-task-runner-readiness.md#workspace-task-runner-readiness
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet workspace task runner passes its readiness suite for graph execution and caching.
#[test]
