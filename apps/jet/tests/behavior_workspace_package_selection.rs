// SPEC-MANAGED: apps/jet/external-contracts/behavior/workspace-package-selection.md#workspace-package-selection
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet workspace package selection resolves the requested workspace package and its metadata.
#[test]
