// SPEC-MANAGED: apps/jet/external-contracts/behavior/nx-graph-parity.md#nx-graph-parity
// CODEGEN-BEGIN
// AW-EC-BEGIN
// @ec nx-graph-parity
...
// Contract: Jet builds an Nx workspace dependency graph consistent with the workspace configuration.
#[test]
