// SPEC-MANAGED: apps/jet/external-contracts/behavior/dev-server-cli-contract.md#dev-server-cli-contract
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Jet dev-server command accepts the supported CLI contract and rejects invalid invocations.
#[test]
