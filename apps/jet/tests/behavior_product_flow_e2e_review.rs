// SPEC-MANAGED: apps/jet/external-contracts/behavior/product-flow-e2e-review.md#product-flow-e2e-review
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// Contract: Product-flow evidence exposes the required reviewable end-to-end outcome.
#[test]
