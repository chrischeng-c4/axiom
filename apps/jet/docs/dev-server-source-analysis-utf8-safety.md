...
> **Issue**: #1485
> **Crate**: `cclab-jet` (`apps/jet/src/dev_server/source_analysis.rs`)
> **Type**: bug
...
```text
thread tokio-rt-worker panicked at apps/jet/src/dev_server/source_analysis.rs:35:21:
...
- `apps/jet/src/dev_server/source_analysis.rs` — file under fix.
