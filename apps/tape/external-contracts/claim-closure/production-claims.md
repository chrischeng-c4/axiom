...
e2e_tests:
  - id: tape-cli-interface-replay-verbs
    ...
    category: behavior
    test_path: tests/behavior_tape_claim_cli_interface.rs
  ...
  - id: tape-cli-standard-surface
    ...
    category: behavior
    test_path: tests/behavior_tape_claim_cli_standard_surface.rs
  ...
  - id: tape-chainable-output-conformance
    ...
    category: behavior
    test_path: tests/behavior_tape_claim_chainable_output.rs
  ...
  - id: tape-topic-replay-journal
    ...
    category: behavior
    test_path: tests/behavior_tape_claim_topic_replay_journal.rs
  ...
  - id: tape-consumer-checkpoints
    ...
    category: behavior
    test_path: tests/behavior_tape_claim_consumer_checkpoints.rs
  ...
  - id: tape-http2-api-list
    ...
    category: behavior
    test_path: tests/behavior_tape_claim_http2_api_list.rs
  ...
  - id: tape-standard-operational-endpoints
    ...
    category: behavior
    test_path: tests/behavior_tape_claim_standard_operational_endpoints.rs
    command: "cargo test -p tape --test cli_contract spec_routes_list_topic_contract -- --exact --nocapture"
    assertions:
