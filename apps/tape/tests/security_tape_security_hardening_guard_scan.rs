// SPEC-MANAGED: apps/tape/external-contracts/security-hardening/security/security-evidence.md#tape-security-hardening-guard-scan
// CODEGEN-BEGIN
// AW-EC-BEGIN
// @ec tape-security-hardening-guard-scan
// @capability security-hardening
// @claim guard-static-runtime-evidence
// @contract tape-guard-security-report
// @category security
...
fn tape_security_hardening_guard_scan() {
    let command = "cd apps/tape && ../../target/debug/vat run guard-security";
    let id = "tape-security-hardening-guard-scan";
