...
summary: Semantic coverage for "apps/guard/src"
capability_refs:
  - id: "static-security-scan"
    role: primary
    claim: "compass-backed-diagnostic-scan"
    coverage: partial
    rationale: "Semantic takeover coverage for existing source group `apps/guard/src`."
