// SPEC-MANAGED: apps/guard/tech-design/semantic/source/projects-guard-guard-cli-src-lib-rs.md#rust-source-unit
// CODEGEN-BEGIN
...
/// @spec apps/guard/tech-design/semantic/source/projects-guard-guard-cli-src-lib-rs.md#source
pub struct GuardCli;
