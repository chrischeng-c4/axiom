// SPEC-MANAGED: apps/guard/tech-design/semantic/guard-ec-static-security-smoke.md#guard-security-lint-policy
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
// @command target/debug/guard scan apps/guard --profile security-lint --compact --no-persist
// AW-EC-END
