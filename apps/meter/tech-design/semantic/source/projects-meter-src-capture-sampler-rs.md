...
# Standardized apps/meter/src/capture/sampler.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/meter/src/capture/sampler.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `FoldedStack` | apps/meter/src/capture/sampler.rs | struct | pub | 35 |  |
| `SampleError` | apps/meter/src/capture/sampler.rs | enum | pub | 79 |  |
| `SampleRun` | apps/meter/src/capture/sampler.rs | struct | pub | 64 |  |
| `Target` | apps/meter/src/capture/sampler.rs | enum | pub | 105 |  |
| `label` | apps/meter/src/capture/sampler.rs | function | pub | 120 | label(&self) -> String |
| `leaf` | apps/meter/src/capture/sampler.rs | function | pub | 50 | leaf(&self) -> Option<&str> |
| `new` | apps/meter/src/capture/sampler.rs | function | pub | 45 | new(frames: Vec<String>, count: u64) -> Self |
| `parse_perf_script` | apps/meter/src/capture/sampler.rs | function | pub | 649 | parse_perf_script(text: &str) -> Vec<FoldedStack> |
| `parse_perf_script` | apps/meter/src/capture/sampler.rs | function | pub | 687 | parse_perf_script(_text: &str) -> Vec<FoldedStack> |
| `parse_sample_report` | apps/meter/src/capture/sampler.rs | function | pub | 461 | parse_sample_report(report: &str) -> Vec<FoldedStack> |
| `resolve_target_exec` | apps/meter/src/capture/sampler.rs | function | pub | 363 | resolve_target_exec(target: &Target) -> Result<PathBuf, SampleError> |
| `sample_target` | apps/meter/src/capture/sampler.rs | function | pub | 138 | sample_target(     target: &Target,     extra_args: &[String],     duration_secs: u64,     hz: Option<u64>, ) -> Result<SampleRun, SampleError> |
| `spawn_exec` | apps/meter/src/capture/sampler.rs | function | pub | 433 | spawn_exec(     exec: &std::path::Path,     extra_args: &[String], ) -> Result<Child, SampleError> |
| `to_folded_line` | apps/meter/src/capture/sampler.rs | function | pub | 55 | to_folded_line(&self) -> String |
## Source
...
```yaml
changes:
  - path: apps/meter/src/capture/sampler.rs
    action: modify
    section: rust-source-unit
    impl_mode: codegen
    description: |
      Source template for `apps/meter/src/capture/sampler.rs` captured during meter full-codegen standardization.
```
