---
id: projects-meter-src-assertions-rs
...
# Standardized apps/meter/src/assertions.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/meter/src/assertions.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AssertionError` | apps/meter/src/assertions.rs | struct | pub | 19 |  |
| `AssertionResult` | apps/meter/src/assertions.rs | type | pub | 13 |  |
| `Expectation` | apps/meter/src/assertions.rs | struct | pub | 58 |  |
| `expect` | apps/meter/src/assertions.rs | function | pub | 595 | expect(value: T) -> Expectation<T> |
| `is_negated` | apps/meter/src/assertions.rs | function | pub | 85 | is_negated(&self) -> bool |
| `new` | apps/meter/src/assertions.rs | function | pub | 33 | new(message: impl Into<String>, assertion_type: impl Into<String>) -> Self |
| `new` | apps/meter/src/assertions.rs | function | pub | 65 | new(value: T) -> Self |
| `not` | apps/meter/src/assertions.rs | function | pub | 74 | not(mut self) -> Self |
| `to_be_at_least` | apps/meter/src/assertions.rs | function | pub | 264 | to_be_at_least(&self, expected: &T) -> AssertionResult |
| `to_be_at_most` | apps/meter/src/assertions.rs | function | pub | 279 | to_be_at_most(&self, expected: &T) -> AssertionResult |
| `to_be_between` | apps/meter/src/assertions.rs | function | pub | 296 | to_be_between(&self, low: T, high: T) -> AssertionResult |
| `to_be_empty` | apps/meter/src/assertions.rs | function | pub | 409 | to_be_empty(&self) -> AssertionResult |
| `to_be_empty` | apps/meter/src/assertions.rs | function | pub | 501 | to_be_empty(&self) -> AssertionResult |
| `to_be_false` | apps/meter/src/assertions.rs | function | pub | 154 | to_be_false(&self) -> AssertionResult |
| `to_be_greater_than` | apps/meter/src/assertions.rs | function | pub | 217 | to_be_greater_than(&self, expected: &T) -> AssertionResult |
| `to_be_less_than` | apps/meter/src/assertions.rs | function | pub | 242 | to_be_less_than(&self, expected: &T) -> AssertionResult |
| `to_be_none` | apps/meter/src/assertions.rs | function | pub | 194 | to_be_none(&self) -> AssertionResult |
| `to_be_some` | apps/meter/src/assertions.rs | function | pub | 177 | to_be_some(&self) -> AssertionResult |
| `to_be_true` | apps/meter/src/assertions.rs | function | pub | 137 | to_be_true(&self) -> AssertionResult |
| `to_contain` | apps/meter/src/assertions.rs | function | pub | 319 | to_contain(&self, substring: &str) -> AssertionResult |
| `to_contain` | apps/meter/src/assertions.rs | function | pub | 429 | to_contain(&self, substring: &str) -> AssertionResult |
| `to_contain_item` | apps/meter/src/assertions.rs | function | pub | 469 | to_contain_item(&self, item: &T) -> AssertionResult |
| `to_end_with` | apps/meter/src/assertions.rs | function | pub | 356 | to_end_with(&self, suffix: &str) -> AssertionResult |
| `to_equal` | apps/meter/src/assertions.rs | function | pub | 96 | to_equal(&self, expected: &T) -> AssertionResult |
| `to_have_key` | apps/meter/src/assertions.rs | function | pub | 525 | to_have_key(&self, key: &str) -> AssertionResult |
| `to_have_keys` | apps/meter/src/assertions.rs | function | pub | 538 | to_have_keys(&self, keys: &[&str]) -> AssertionResult |
| `to_have_length` | apps/meter/src/assertions.rs | function | pub | 390 | to_have_length(&self, length: usize) -> AssertionResult |
| `to_have_length` | apps/meter/src/assertions.rs | function | pub | 482 | to_have_length(&self, length: usize) -> AssertionResult |
| `to_have_path_value` | apps/meter/src/assertions.rs | function | pub | 558 | to_have_path_value(&self, path: &str, expected: &JsonValue) -> AssertionResult |
| `to_match` | apps/meter/src/assertions.rs | function | pub | 371 | to_match(&self, pattern: &str) -> AssertionResult |
| `to_match` | apps/meter/src/assertions.rs | function | pub | 444 | to_match(&self, pattern: &str) -> AssertionResult |
| `to_not_equal` | apps/meter/src/assertions.rs | function | pub | 115 | to_not_equal(&self, expected: &T) -> AssertionResult |
| `to_start_with` | apps/meter/src/assertions.rs | function | pub | 341 | to_start_with(&self, prefix: &str) -> AssertionResult |
| `value` | apps/meter/src/assertions.rs | function | pub | 80 | value(&self) -> &T |
| `with_actual` | apps/meter/src/assertions.rs | function | pub | 49 | with_actual(mut self, actual: impl fmt::Debug) -> Self |
| `with_expected` | apps/meter/src/assertions.rs | function | pub | 43 | with_expected(mut self, expected: impl fmt::Debug) -> Self |
## Source
...
```yaml
changes:
  - path: apps/meter/src/assertions.rs
    action: modify
    section: rust-source-unit
    impl_mode: codegen
    description: |
      Source template for `apps/meter/src/assertions.rs` captured during meter full-codegen standardization.
```
