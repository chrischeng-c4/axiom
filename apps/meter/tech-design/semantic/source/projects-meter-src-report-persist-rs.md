...
# Standardized apps/meter/src/report/persist.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/meter/src/report/persist.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `LAST_REPORT_REL` | apps/meter/src/report/persist.rs | constant | pub | 15 |  |
| `last_report_path` | apps/meter/src/report/persist.rs | function | pub | 19 | last_report_path(base: impl AsRef<Path>) -> PathBuf |
| `read_last_report` | apps/meter/src/report/persist.rs | function | pub | 51 | read_last_report() -> Option<MeterReport> |
| `read_last_report_in` | apps/meter/src/report/persist.rs | function | pub | 58 | read_last_report_in(base: impl AsRef<Path>) -> Option<MeterReport> |
| `write_last_report` | apps/meter/src/report/persist.rs | function | pub | 28 | write_last_report(report: &MeterReport) -> std::io::Result<PathBuf> |
| `write_last_report_in` | apps/meter/src/report/persist.rs | function | pub | 35 | write_last_report_in(     base: impl AsRef<Path>,     report: &MeterReport, ) -> std::io::Result<PathBuf> |
## Source
...
```yaml
changes:
  - path: apps/meter/src/report/persist.rs
    action: modify
    section: rust-source-unit
    impl_mode: codegen
    description: |
      Source template for `apps/meter/src/report/persist.rs` captured during meter full-codegen standardization.
```
