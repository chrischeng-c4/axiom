...
# Standardized apps/meter/src/report/producer.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/meter/src/report/producer.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `InjectionHit` | apps/meter/src/report/producer.rs | struct | pub | 364 |  |
| `fuzz_crash_finding` | apps/meter/src/report/producer.rs | function | pub | 383 | fuzz_crash_finding(     target: &str,     crash: &crate::security::FuzzCrash,     strategy: &str,     seed: u64, ) -> Finding |
| `generic_test_failure` | apps/meter/src/report/producer.rs | function | pub | 91 | generic_test_failure(target: &str, exit_code: i32) -> Finding |
| `hash8` | apps/meter/src/report/producer.rs | function | pub | 350 | hash8(bytes: &[u8]) -> String |
| `injection_finding` | apps/meter/src/report/producer.rs | function | pub | 424 | injection_finding(target: &str, hit: &InjectionHit) -> Finding |
| `test_failure_finding` | apps/meter/src/report/producer.rs | function | pub | 51 | test_failure_finding(     name: &str,     stdout_tail: &str,     file: Option<String>,     line: Option<u32>, ) -> Finding |
## Source
...
/// @spec apps/meter/tech-design/semantic/source/projects-meter-src-report-producer-rs.md#source
...
```yaml
changes:
  - path: apps/meter/src/report/producer.rs
    action: modify
    section: rust-source-unit
    impl_mode: codegen
    description: |
      Source template for `apps/meter/src/report/producer.rs` captured during meter full-codegen standardization.
```
