---
id: semantic-meter-install-script
summary: Lossless source-unit coverage for the meter project install script.
capability_refs:
...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/chrischeng-c4/axiom/main/apps/meter/install.sh | sh
#
# Env overrides:
...
changes:
  - path: "apps/meter/install.sh"
    ...
    description: "Regenerate the meter installer script from a TD-owned text source unit."
    impl_mode: codegen
```
