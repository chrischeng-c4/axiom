...
# Standardized apps/lumen/src/vector_index.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/lumen/src/vector_index.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `FlatCpuIndex` | apps/lumen/src/vector_index.rs | struct | pub | 669 |  |
| `HnswCpuIndex` | apps/lumen/src/vector_index.rs | struct | pub | 365 |  |
| `ScalarCodebook` | apps/lumen/src/vector_index.rs | struct | pub | 139 |  |
| `decode_sq` | apps/lumen/src/vector_index.rs | function | pub | 194 | decode_sq(bytes: &[u8], cb: &ScalarCodebook) -> Vec<f32> |
| `empty` | apps/lumen/src/vector_index.rs | function | pub | 148 | empty(dim: usize) -> Self |
| `encode_sq` | apps/lumen/src/vector_index.rs | function | pub | 182 | encode_sq(vec: &[f32], cb: &ScalarCodebook) -> Vec<u8> |
| `new` | apps/lumen/src/vector_index.rs | function | pub | 479 | new(spec: VectorSpec) -> Self |
| `new` | apps/lumen/src/vector_index.rs | function | pub | 739 | new(spec: VectorSpec) -> Self |
| `open_backend` | apps/lumen/src/vector_index.rs | function | pub | 1188 | open_backend(spec: VectorSpec) -> Box<dyn VectorIndex> |
| `open_from_segment` | apps/lumen/src/vector_index.rs | function | pub | 887 | open_from_segment(         spec: VectorSpec,         seg: std::sync::Arc<crate::segment::SegmentReader>,         row_eids: Vec<String>,     ) -> Result<Self> |
| `restore` | apps/lumen/src/vector_index.rs | function | pub | 495 | restore(         spec: VectorSpec,         vectors: Vec<(String, Vec<f32>)>,         codebook: Option<ScalarCodebook>,     ) -> Result<Self> |
| `restore` | apps/lumen/src/vector_index.rs | function | pub | 749 | restore(         spec: VectorSpec,         vectors: Vec<(String, Vec<f32>)>,         codebook: Option<ScalarCodebook>,     ) -> Result<Self> |
| `set_ef_search` | apps/lumen/src/vector_index.rs | function | pub | 522 | set_ef_search(&self, ef: usize) |
| `widen` | apps/lumen/src/vector_index.rs | function | pub | 158 | widen(&mut self, vec: &[f32]) |
## Source
...
/// @spec apps/lumen/tech-design/semantic/source/projects-lumen-src-vector_index-rs.md#source
...
changes:
  - path: apps/lumen/src/vector_index.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/lumen/src/vector_index.rs` captured during lumen
