...
# Standardized apps/lumen/src/wal_nats.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/lumen/src/wal_nats.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `NatsWal` | apps/lumen/src/wal_nats.rs | struct | pub | 45 |  |
| `NatsWalConfig` | apps/lumen/src/wal_nats.rs | struct | pub | 61 |  |
| `connect` | apps/lumen/src/wal_nats.rs | function | pub | 105 | connect(url: &str) -> Result<Self> |
| `connect_with_config` | apps/lumen/src/wal_nats.rs | function | pub | 110 | connect_with_config(url: &str, config: NatsWalConfig) -> Result<Self> |
| `new` | apps/lumen/src/wal_nats.rs | function | pub | 78 | new(stream_name: impl Into<String>, subject: impl Into<String>) -> Result<Self> |
| `shard` | apps/lumen/src/wal_nats.rs | function | pub | 93 | shard(shard: usize) -> Self |
## Source
...
changes:
  - path: apps/lumen/src/wal_nats.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/lumen/src/wal_nats.rs` captured during lumen
