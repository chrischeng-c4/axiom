...
capability_refs:
  ...
  - id: "dynamic-shard-topology"
    role: primary
    gap: "versioned-virtual-bucket-shard-map"
    claim: "versioned-virtual-bucket-shard-map"
    coverage: full
    rationale: "This source unit owns the versioned virtual-bucket shard-map routing contract."
fill_sections: [overview, source, changes]
---

# Standardized apps/lumen/src/routing.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/lumen/src/routing.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DEFAULT_VIRTUAL_BUCKET_COUNT` | apps/lumen/src/routing.rs | constant | pub | 32 |  |
| `EngineShardSearch` | apps/lumen/src/routing.rs | struct | pub | 221 |  |
| `EngineShardWrite` | apps/lumen/src/routing.rs | struct | pub | 286 |  |
| `SearchShardTarget` | apps/lumen/src/routing.rs | enum | pub | 73 |  |
...
changes:
  - path: apps/lumen/src/routing.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/lumen/src/routing.rs` captured during lumen
