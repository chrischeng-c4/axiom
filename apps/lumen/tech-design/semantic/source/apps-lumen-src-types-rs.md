---
id: projects-lumen-src-types-rs
capability_refs:
...
# Standardized apps/lumen/src/types.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/lumen/src/types.rs` generated from AST during Score force-regeneration standardization.
...
changes:
  - path: apps/lumen/src/types.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/lumen/src/types.rs` captured during lumen
