...
# Standardized apps/lumen/src/aof.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/lumen/src/aof.rs` generated from AST during Score force-regeneration standardization.
...
changes:
  - path: apps/lumen/src/aof.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/lumen/src/aof.rs` captured during lumen
