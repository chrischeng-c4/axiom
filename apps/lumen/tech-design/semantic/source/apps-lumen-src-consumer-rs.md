...
# Standardized apps/lumen/src/consumer.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/lumen/src/consumer.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ShardRouter` | apps/lumen/src/consumer.rs | struct | pub | 26 |  |
| `index_url` | apps/lumen/src/consumer.rs | function | pub | 37 | index_url(&self, collection_id: &str) -> String |
## Source
<!-- type: rust-source-unit lang: rust -->

````rust
// SPEC-MANAGED: apps/lumen/tech-design/semantic/source/apps-lumen-src-consumer-rs.md#rust-source-unit
// CODEGEN-BEGIN
...
changes:
  - path: apps/lumen/src/consumer.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/lumen/src/consumer.rs` captured during lumen
