...
# Standardized apps/lumen/src/lib.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/lumen/src/lib.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `aof` | apps/lumen/src/lib.rs | module | pub | 22 |  |
| `api` | apps/lumen/src/lib.rs | module | pub | 23 |  |
| `auth` | apps/lumen/src/lib.rs | module | pub | 24 |  |
| `backup` | apps/lumen/src/lib.rs | module | pub | 33 |  |
| `backup_sink` | apps/lumen/src/lib.rs | module | pub | 34 |  |
...
changes:
  - path: apps/lumen/src/lib.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/lumen/src/lib.rs` captured during lumen
