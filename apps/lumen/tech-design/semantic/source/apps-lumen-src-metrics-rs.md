...
|------|--------|------|------------|------|-----------|
| `Metrics` | apps/lumen/src/metrics.rs | struct | pub | 28 |  |
| `incr_collection_created` | apps/lumen/src/metrics.rs | function | pub | 91 | incr_collection_created(&self, fields: u64) |
...
changes:
  - path: apps/lumen/src/metrics.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/lumen/src/metrics.rs` captured during lumen
