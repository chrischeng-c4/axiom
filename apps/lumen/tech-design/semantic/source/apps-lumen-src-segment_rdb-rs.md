---
id: projects-lumen-src-segment_rdb-rs
capability_refs:
...
# Standardized apps/lumen/src/segment_rdb.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/lumen/src/segment_rdb.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SegmentRdbStore` | apps/lumen/src/segment_rdb.rs | struct | pub | 86 |  |
| `generation_seqs` | apps/lumen/src/segment_rdb.rs | function | pub | 348 | generation_seqs(&self) -> Result<Vec<u64>> |
| `load_latest` | apps/lumen/src/segment_rdb.rs | function | pub | 287 | load_latest(&self) -> Result<Option<(Arc<Engine>, u64)>> |
| `new` | apps/lumen/src/segment_rdb.rs | function | pub | 94 | new(root: impl Into<PathBuf>) -> Result<Self> |
| `prune` | apps/lumen/src/segment_rdb.rs | function | pub | 326 | prune(&self, keep: usize) -> Result<usize> |
| `reopen_into` | apps/lumen/src/segment_rdb.rs | function | pub | 305 | reopen_into(&self, engine: &Arc<Engine>) -> Result<Option<u64>> |
| `save` | apps/lumen/src/segment_rdb.rs | function | pub | 226 | save(&self, engine: &Arc<Engine>, up_to_seq: u64) -> Result<()> |
## Source
...
changes:
  - path: apps/lumen/src/segment_rdb.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/lumen/src/segment_rdb.rs` captured during lumen
