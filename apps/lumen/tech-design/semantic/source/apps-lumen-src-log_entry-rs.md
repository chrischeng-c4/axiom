...
# Standardized apps/lumen/src/log_entry.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/lumen/src/log_entry.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RaftLogEntry` | apps/lumen/src/log_entry.rs | enum | pub | 23 |  |
| `RaftLogResponse` | apps/lumen/src/log_entry.rs | struct | pub | 66 |  |
## Source
...
//! any heavier replication machinery. The `RaftLogEntry` name is retained for
...
changes:
  - path: apps/lumen/src/log_entry.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/lumen/src/log_entry.rs` captured during lumen
