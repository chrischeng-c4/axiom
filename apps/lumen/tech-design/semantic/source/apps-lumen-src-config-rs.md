...
# Standardized apps/lumen/src/config.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/lumen/src/config.rs` generated from AST during Score force-regeneration standardization.
...
changes:
  - path: apps/lumen/src/config.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/lumen/src/config.rs` captured during lumen
