...
# Standardized apps/lumen/tests/lumen_bench_cli.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/lumen/tests/lumen_bench_cli.rs` generated from AST during Score force-regeneration standardization.
...
```yaml
changes:
  - path: apps/lumen/tests/lumen_bench_cli.rs
    action: modify
    section: rust-source-unit
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/lumen/tests/lumen_bench_cli.rs` captured for the sorted_page_deep benchmark CLI smoke test.
```
