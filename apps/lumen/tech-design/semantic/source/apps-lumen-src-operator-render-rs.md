...
capability_refs:
  ...
  - id: "dynamic-shard-topology"
    role: primary
    gap: "single-member-durable-persistence-render"
...
# Standardized apps/lumen/src/operator/render.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/lumen/src/operator/render.rs` generated from AST during Score force-regeneration standardization.
...
changes:
  - path: apps/lumen/src/operator/render.rs
    ...
    impl_mode: codegen
    description: |
      Canonical lossless source unit for Lumen operator workload rendering.
