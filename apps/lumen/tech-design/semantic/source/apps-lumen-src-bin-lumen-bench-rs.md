...
# Standardized apps/lumen/src/bin/lumen-bench.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `apps/lumen/src/bin/lumen-bench.rs` generated from AST during Score force-regeneration standardization.
...
changes:
  - path: apps/lumen/src/bin/lumen-bench.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `apps/lumen/src/bin/lumen-bench.rs` captured for the sorted_page_deep benchmark cell.
```
