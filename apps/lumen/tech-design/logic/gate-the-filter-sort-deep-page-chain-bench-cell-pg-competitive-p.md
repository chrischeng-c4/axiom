...
e2e_tests:
  - id: rig-data-table-browse
    ...
    runner: rig
    path: apps/lumen/tests/rig/cases/load/data_table_browse.toml
    command: "cd apps/lumen && ../../target/debug/rig run --dir tests/rig/cases/load --case data_table_browse"
    verifies:
...
changes:
  ...
  - path: apps/lumen/tests/perf-baseline.json
    action: modify
    section: logic
    impl_mode: hand-written
