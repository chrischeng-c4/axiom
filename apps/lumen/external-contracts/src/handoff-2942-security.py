...
def verify_handoff_2942_security() -> dict:
    ...
    # 14-16. AC3 -- both joint quorums and transfer must precede leader termination.
    obs14 = _outcome(missing_old_quorum); exp14 = HANDOFF_2942_SECURITY_MATRIX[13][1]
    checks.append({"name": HANDOFF_2942_SECURITY_MATRIX[13][0], "expected": exp14, "observed": obs14, "passed": obs14 == exp14})
    obs15 = _outcome(missing_transfer); exp15 = HANDOFF_2942_SECURITY_MATRIX[14][1]
    ...
    obs16 = _outcome(terminate); exp16 = HANDOFF_2942_SECURITY_MATRIX[15][1]
    checks.append({"name": HANDOFF_2942_SECURITY_MATRIX[15][0], "expected": exp16, "observed": obs16, "passed": obs16 == exp16})

    # 17. R2/AC4 -- status names the value state; it cannot overclaim convergence during a surge.
    ...
    obs17 = multi_generation.state; exp17 = HANDOFF_2942_SECURITY_MATRIX[16][1]
