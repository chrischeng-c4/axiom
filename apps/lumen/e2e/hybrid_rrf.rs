...
//! `apps/lumen/e2e/`, which ran `cargo test -p lumen --test hybrid_rrf` in a subprocess
...
//!
//! - `lumen-claim-hybrid-rrf` — Lexical and semantic result lists are fused through RRF
//!   while preserving per-leg filters.
