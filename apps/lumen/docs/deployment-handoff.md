...
# The operator consumes externally provisioned `servingTlsSecret` and
# `peerTlsSecret` Secrets in the instance namespace. It does not resolve an
# issuer, contact CAS, select a trust domain, or mint certificate tokens.
