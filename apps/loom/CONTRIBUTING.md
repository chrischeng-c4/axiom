...
How to change `apps/loom`. What it promises and the work roots it owns live in
...
`loom-qa` runs the declared complete gate. The controller owns Git, tracker,
...
| Gate | Command |
|---|---|
| unit + colocated tests | `cargo test -p loom` |
