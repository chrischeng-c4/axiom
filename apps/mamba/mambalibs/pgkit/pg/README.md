...
`apps/mamba/mambalibs/pgkit/pg` owns pgkit's source/logic layer: PostgreSQL driver
...
sibling `apps/mamba/mambalibs/pgkit/binding` crate and expose this core as
`mambalibs.pg`.
