...
Output file: ``apps/mamba/data/cpython312_surface.json`` (relative to
...
::
    ...
    python3 apps/mamba/scripts/dump_cpython_surface.py \\
        --output apps/mamba/data/cpython312_surface.json
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        "apps/mamba/data/cpython312_surface.json).",
    )
