...
#
# Usage:
#   apps/mamba/scripts/run-conformance.sh                 # 60s cap, default
#   CAP=120 apps/mamba/scripts/run-conformance.sh         # bump cap
#   FILTER=stdlib apps/mamba/scripts/run-conformance.sh   # only stdlib::* tests
#
# Env knobs:
