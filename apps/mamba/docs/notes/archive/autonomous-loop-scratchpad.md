...
`apps/mamba/docs/MVP_TEST_PROFILE.md`. The doc is the canonical
...
`apps/mamba/tests/cpython/lib_test_seeds/`:
...
```
python3 apps/mamba/scripts/gate0_list_tests.py --release
```
