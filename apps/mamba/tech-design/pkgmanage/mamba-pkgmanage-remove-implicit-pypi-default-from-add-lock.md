...
```yaml
changes:
  - file: apps/mamba/src/pkgmanage/add.rs
    action: modify
    section: logic
  ...
  - file: apps/mamba/src/pkgmanage/lock.rs
    action: modify
    section: logic
    impl_mode: hand-written
  ...
  - file: apps/mamba/tests/pkgmgr/add.rs
    action: modify
    section: unit-test
    impl_mode: hand-written
  ...
  - file: apps/mamba/tests/pkgmgr/lock.rs
    action: modify
    section: unit-test
    impl_mode: hand-written
