...
Per `apps/mamba/external-contracts/README.md`: memory = `gc/`, `stability/` soaks, **plus absence of hang/SIGTRAP anywhere in the 46k corpus** — symptom jurisdiction, not directory jurisdiction.
