...
/// Ported from `tests/cpython/type/std-libs/email_mime_base/MIMEBase__init___maintype_as_str_wrong.py`.
#[test]
fn test_gen_type_std_libs_email_mime_base_MIMEBase__init___maintype_as_str_wrong() {
