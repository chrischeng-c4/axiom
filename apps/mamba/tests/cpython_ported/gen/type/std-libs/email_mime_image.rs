...
/// Ported from `tests/cpython/type/std-libs/email_mime_image/MIMEImage__init___imagedata_as_typed_wrong.py`.
#[test]
fn test_gen_type_std_libs_email_mime_image_MIMEImage__init___imagedata_as_typed_wrong() {
