...
/// Ported from `tests/cpython/type/std-libs/distutils_command_upload/upload__upload_file__command_as_str_wrong.py`.
#[test]
fn test_gen_type_std_libs_distutils_command_upload_upload__upload_file__command_as_str_wrong() {
