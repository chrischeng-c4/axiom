...
/// Ported from `tests/cpython/type/std-libs/profiling_tracing/label__code_as_typed_wrong.py`.
#[test]
fn test_gen_type_std_libs_profiling_tracing_label__code_as_typed_wrong() {
