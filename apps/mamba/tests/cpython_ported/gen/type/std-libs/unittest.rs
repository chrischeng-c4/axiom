...
/// Ported from `tests/cpython/type/std-libs/unittest/load_tests__loader_as_TestLoader_wrong.py`.
#[test]
fn test_gen_type_std_libs_unittest_load_tests__loader_as_TestLoader_wrong() {
