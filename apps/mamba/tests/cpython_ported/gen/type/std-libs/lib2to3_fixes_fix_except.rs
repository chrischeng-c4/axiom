...
/// Ported from `tests/cpython/type/std-libs/lib2to3_fixes_fix_except/find_excepts__nodes_as_Iterable_wrong.py`.
#[test]
fn test_gen_type_std_libs_lib2to3_fixes_fix_except_find_excepts__nodes_as_Iterable_wrong() {
