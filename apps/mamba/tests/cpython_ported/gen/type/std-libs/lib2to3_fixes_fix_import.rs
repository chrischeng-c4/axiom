...
/// Ported from `tests/cpython/type/std-libs/lib2to3_fixes_fix_import/FixImport__start_tree__tree_as_Node_wrong.py`.
#[test]
fn test_gen_type_std_libs_lib2to3_fixes_fix_import_FixImport__start_tree__tree_as_Node_wrong() {
