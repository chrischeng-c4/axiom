...
/// Ported from `tests/cpython/type/std-libs/py_compile/PyCompileError__init__exc_type_as_type_wrong.py`.
#[test]
fn test_gen_type_std_libs_py_compile_PyCompileError__init__exc_type_as_type_wrong() {
...
/// Ported from `tests/cpython/type/std-libs/py_compile/compile__file_as_AnyStr_wrong.py`.
#[test]
fn test_gen_type_std_libs_py_compile_compile__file_as_AnyStr_wrong() {
    let out = run_type_wall_fixture(r###"# /// script
# requires-python = ">=3.12"
# dependencies = []
#
