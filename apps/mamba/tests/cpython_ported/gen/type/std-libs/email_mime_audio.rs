...
/// Ported from `tests/cpython/type/std-libs/email_mime_audio/MIMEAudio__init___audiodata_as_typed_wrong.py`.
#[test]
fn test_gen_type_std_libs_email_mime_audio_MIMEAudio__init___audiodata_as_typed_wrong() {
