...
/// Ported from `tests/cpython/type/std-libs/unittest_util/three_way_cmp__x_as__SupportsComparison_wrong.py`.
#[test]
fn test_gen_type_std_libs_unittest_util_three_way_cmp__x_as__SupportsComparison_wrong() {
