...
/// Ported from `tests/cpython/type/std-libs/asyncio_proactor_events/BaseProactorEventLoop__sock_recv__sock_as_socket_wrong.py`.
#[test]
fn test_gen_type_std_libs_asyncio_proactor_events_BaseProactorEventLoop__sock_recv__sock_as_socket_wrong() {
