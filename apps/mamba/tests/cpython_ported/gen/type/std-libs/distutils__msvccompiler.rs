...
/// Ported from `tests/cpython/type/std-libs/distutils__msvccompiler/MSVCCompiler__initialize__plat_name_as_typed_wrong.py`.
#[test]
fn test_gen_type_std_libs_distutils__msvccompiler_MSVCCompiler__initialize__plat_name_as_typed_wrong() {
