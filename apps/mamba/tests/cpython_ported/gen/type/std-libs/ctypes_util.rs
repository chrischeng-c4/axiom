...
/// Ported from `tests/cpython/type/std-libs/ctypes_util/find_library__name_as_str_wrong.py`.
#[test]
fn test_gen_type_std_libs_ctypes_util_find_library__name_as_str_wrong() {
