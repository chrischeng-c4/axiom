...
/// Ported from `tests/cpython/type/std-libs/zoneinfo__tzpath/find_tzfile__key_as_str_wrong.py`.
#[test]
fn test_gen_type_std_libs_zoneinfo__tzpath_find_tzfile__key_as_str_wrong() {
