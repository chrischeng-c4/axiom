...
/// Ported from `tests/cpython/type/std-libs/string_templatelib/Template____add____other_as_Template_wrong.py`.
#[test]
fn test_gen_type_std_libs_string_templatelib_Template____add____other_as_Template_wrong() {
