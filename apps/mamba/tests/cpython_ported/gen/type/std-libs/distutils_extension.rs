...
/// Ported from `tests/cpython/type/std-libs/distutils_extension/Extension__init__name_as_str_wrong.py`.
#[test]
fn test_gen_type_std_libs_distutils_extension_Extension__init__name_as_str_wrong() {
