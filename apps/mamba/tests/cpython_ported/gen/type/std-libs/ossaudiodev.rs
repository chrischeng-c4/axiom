...
/// Ported from `tests/cpython/type/std-libs/ossaudiodev/openmixer__device_as_str_wrong.py`.
#[test]
fn test_gen_type_std_libs_ossaudiodev_openmixer__device_as_str_wrong() {
