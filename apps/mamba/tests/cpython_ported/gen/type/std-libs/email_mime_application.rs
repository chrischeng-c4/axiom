...
/// Ported from `tests/cpython/type/std-libs/email_mime_application/MIMEApplication__init___data_as_typed_wrong.py`.
#[test]
fn test_gen_type_std_libs_email_mime_application_MIMEApplication__init___data_as_typed_wrong() {
