...
/// Ported from `tests/cpython/type/std-libs/ctypes_macholib_dylib/dylib_info__filename_as_str_wrong.py`.
#[test]
fn test_gen_type_std_libs_ctypes_macholib_dylib_dylib_info__filename_as_str_wrong() {
