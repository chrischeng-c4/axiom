...
/// Ported from `tests/cpython/type/std-libs/asyncio_taskgroups/TaskGroup____aexit____et_as_typed_wrong.py`.
#[test]
fn test_gen_type_std_libs_asyncio_taskgroups_TaskGroup____aexit____et_as_typed_wrong() {
...
/// Ported from `tests/cpython/type/std-libs/asyncio_taskgroups/TaskGroup__create_task__coro_as__CoroutineLike_wrong.py`.
#[test]
fn test_gen_type_std_libs_asyncio_taskgroups_TaskGroup__create_task__coro_as__CoroutineLike_wrong() {
    let out = run_type_wall_fixture(r###"# /// script
# requires-python = ">=3.12"
# dependencies = []
#
