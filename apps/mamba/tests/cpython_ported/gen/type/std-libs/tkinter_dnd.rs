...
/// Ported from `tests/cpython/type/std-libs/tkinter_dnd/DndHandler__init__source_as__DndSource_wrong.py`.
#[test]
fn test_gen_type_std_libs_tkinter_dnd_DndHandler__init__source_as__DndSource_wrong() {
...
/// Ported from `tests/cpython/type/std-libs/tkinter_dnd/dnd_start__source_as__DndSource_wrong.py`.
#[test]
fn test_gen_type_std_libs_tkinter_dnd_dnd_start__source_as__DndSource_wrong() {
    let out = run_type_wall_fixture(r###"# /// script
# requires-python = ">=3.12"
# dependencies = []
#
