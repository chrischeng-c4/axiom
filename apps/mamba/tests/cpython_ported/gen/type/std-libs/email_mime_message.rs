...
/// Ported from `tests/cpython/type/std-libs/email_mime_message/MIMEMessage__init___msg_as__MessageT_wrong.py`.
#[test]
fn test_gen_type_std_libs_email_mime_message_MIMEMessage__init___msg_as__MessageT_wrong() {
