...
/// Ported from `tests/cpython/errors/pep/union_types/calling_union_raises.py`.
#[test]
fn test_gen_errors_pep_union_types_calling_union_raises() {
...
/// Ported from `tests/cpython/errors/pep/union_types/union_with_non_type_value_raises.py`.
#[test]
fn test_gen_errors_pep_union_types_union_with_non_type_value_raises() {
    let out = jit_capture(r###"# /// script
# requires-python = ">=3.12"
# dependencies = []
#
