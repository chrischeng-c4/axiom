...
/// Ported from `tests/cpython/errors/std-libs/keyword/bind_hard_keyword_raises_syntaxerror.py`.
#[test]
fn test_gen_errors_std_libs_keyword_bind_hard_keyword_raises_syntaxerror() {
...
"###);
    assert_output(&out, r###"bind_hard_keyword_raises_syntaxerror OK
"###);
}
