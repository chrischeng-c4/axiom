...
/// Ported from `tests/cpython/behavior/std-libs/context/hamt_test__test_hashkey_helper_1.py`.
#[test]
fn test_gen_behavior_std_libs_context_hamt_test__test_hashkey_helper_1() {
...
"###);
    assert_output(&out, r###"HamtTest::test_hashkey_helper_1: ok
"###);
}
