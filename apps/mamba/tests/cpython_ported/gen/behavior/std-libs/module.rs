...
/// Ported from `tests/cpython/behavior/std-libs/module/module_tests__test_descriptor_errors_propagate.py`.
#[test]
fn test_gen_behavior_std_libs_module_module_tests__test_descriptor_errors_propagate() {
...
"###);
    assert_output(&out, r###"ModuleTests::test_descriptor_errors_propagate: ok
"###);
}
