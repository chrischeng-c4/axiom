...
/// Ported from `tests/cpython/behavior/std-libs/string_literals/test_literals__test_template.py`.
#[test]
fn test_gen_behavior_std_libs_string_literals_test_literals__test_template() {
...
"###);
    assert_output(&out, r###"TestLiterals::test_template: ok
"###);
}
