...
/// Ported from `tests/cpython/behavior/std-libs/tabnanny/test_check__test_correct_directory.py`.
#[test]
fn test_gen_behavior_std_libs_tabnanny_test_check__test_correct_directory() {
...
# lib = "tabnanny"
# dimension = "behavior"
# case = "test_check__test_correct_directory"
# subject = "cpython.test_tabnanny.TestCheck.test_correct_directory"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_tabnanny.py::TestCheck::test_correct_directory
"""Auto-ported test: TestCheck::test_correct_directory (CPython 3.12 oracle)."""
...
with tempfile.TemporaryDirectory() as tmp_dir:
    with TemporaryPyFile(SOURCE_CODES['error_free'], directory=tmp_dir):
        verify_tabnanny_check(tmp_dir)
print("TestCheck::test_correct_directory: ok")
"###);
    assert_output(&out, r###"TestCheck::test_correct_directory: ok
"###);
}

/// Ported from `tests/cpython/behavior/std-libs/tabnanny/test_check__test_correct_file.py`.
#[test]
fn test_gen_behavior_std_libs_tabnanny_test_check__test_correct_file() {
    let out = jit_capture(r###"# /// script
# requires-python = ">=3.12"
# dependencies = []
#
...
# lib = "tabnanny"
# dimension = "behavior"
# case = "test_check__test_correct_file"
# subject = "cpython.test_tabnanny.TestCheck.test_correct_file"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
# source = "Lib/test/test_tabnanny.py"
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_tabnanny.py::TestCheck::test_correct_file
"""Auto-ported test: TestCheck::test_correct_file (CPython 3.12 oracle)."""
...
with TemporaryPyFile(SOURCE_CODES['error_free']) as file_path:
    verify_tabnanny_check(file_path)
print("TestCheck::test_correct_file: ok")
"###);
    assert_output(&out, r###"TestCheck::test_correct_file: ok
"###);
}
