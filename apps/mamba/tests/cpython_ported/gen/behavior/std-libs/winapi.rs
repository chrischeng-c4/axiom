...
/// Ported from `tests/cpython/behavior/std-libs/winapi/win_api_tests__test_namedpipe.py`.
#[test]
fn test_gen_behavior_std_libs_winapi_win_api_tests__test_namedpipe() {
...
"###);
    assert_output(&out, r###"WinAPITests::test_namedpipe: skipped Windows only
"###);
}
