...
/// Ported from `tests/cpython/behavior/std-libs/uu/uu_file_test__test_encode.py`.
#[test]
fn test_gen_behavior_std_libs_uu_uu_file_test__test_encode() {
...
"###);
    assert_output(&out, r###"UUFileTest::test_encode: ok
"###);
}
