...
/// Ported from `tests/cpython/behavior/std-libs/marshal/string_test_case__test_unicode.py`.
#[test]
fn test_gen_behavior_std_libs_marshal_string_test_case__test_unicode() {
...
"###);
    assert_output(&out, r###"StringTestCase::test_unicode: ok
"###);
}
