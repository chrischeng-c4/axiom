...
/// Ported from `tests/cpython/behavior/std-libs/perfmaps/test_perf_map_writing__test_write_perf_map_entry.py`.
#[test]
fn test_gen_behavior_std_libs_perfmaps_test_perf_map_writing__test_write_perf_map_entry() {
...
"###);
    assert_output(&out, r###"TestPerfMapWriting::test_write_perf_map_entry: skipped Linux only
"###);
}
