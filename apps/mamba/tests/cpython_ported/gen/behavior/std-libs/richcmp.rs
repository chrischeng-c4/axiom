...
/// Ported from `tests/cpython/behavior/std-libs/richcmp/list_test__test_coverage.py`.
#[test]
fn test_gen_behavior_std_libs_richcmp_list_test__test_coverage() {
...
"###);
    assert_output(&out, r###"ListTest::test_coverage: ok
"###);
}

/// Ported from `tests/cpython/behavior/std-libs/richcmp/list_test__test_goodentry.py`.
#[test]
fn test_gen_behavior_std_libs_richcmp_list_test__test_goodentry() {
    let out = jit_capture(r###"# /// script
# requires-python = ">=3.12"
# dependencies = []
#
...
"###);
    assert_output(&out, r###"ListTest::test_goodentry: ok
"###);
}

/// Ported from `tests/cpython/behavior/std-libs/richcmp/misc_test__test_misbehavin.py`.
#[test]
fn test_gen_behavior_std_libs_richcmp_misc_test__test_misbehavin() {
    let out = jit_capture(r###"# /// script
# requires-python = ">=3.12"
# dependencies = []
#
...
# lib = "richcmp"
# dimension = "behavior"
# case = "misc_test__test_misbehavin"
# subject = "cpython.test_richcmp.MiscTest.test_misbehavin"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
# source = "Lib/test/test_richcmp.py"
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_richcmp.py::MiscTest::test_misbehavin
"""Auto-ported test: MiscTest::test_misbehavin (CPython 3.12 oracle)."""
...
assert (a > b) == 0
print("MiscTest::test_misbehavin: ok")
"###);
    assert_output(&out, r###"MiscTest::test_misbehavin: ok
"###);
}
