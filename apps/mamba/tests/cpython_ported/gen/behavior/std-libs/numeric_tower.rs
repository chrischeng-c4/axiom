...
/// Ported from `tests/cpython/behavior/std-libs/numeric_tower/hash_test__test_bools.py`.
#[test]
fn test_gen_behavior_std_libs_numeric_tower_hash_test__test_bools() {
...
"###);
    assert_output(&out, r###"HashTest::test_bools: ok
"###);
}
