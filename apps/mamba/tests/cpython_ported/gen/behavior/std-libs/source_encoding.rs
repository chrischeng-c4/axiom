...
/// Ported from `tests/cpython/behavior/std-libs/source_encoding/misc_source_encoding_test__test_file_parse.py`.
#[test]
fn test_gen_behavior_std_libs_source_encoding_misc_source_encoding_test__test_file_parse() {
...
"###);
    assert_output(&out, r###"MiscSourceEncodingTest::test_file_parse: ok
"###);
}
