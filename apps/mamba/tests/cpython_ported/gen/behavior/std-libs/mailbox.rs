...
/// Ported from `tests/cpython/behavior/std-libs/mailbox/test_proxy_file__test_close.py`.
#[test]
fn test_gen_behavior_std_libs_mailbox_test_proxy_file__test_close() {
...
"###);
    assert_output(&out, r###"TestProxyFile::test_close: ok
"###);
}
