...
/// Ported from `tests/cpython/behavior/std-libs/imaplib/test_imaplib__test_that_time2_internaldate_returns_a_result.py`.
#[test]
fn test_gen_behavior_std_libs_imaplib_test_imaplib__test_that_time2_internaldate_returns_a_result() {
...
"###);
    assert_output(&out, r###"TestImaplib::test_that_Time2Internaldate_returns_a_result: ok
"###);
}
