...
/// Ported from `tests/cpython/behavior/core/args_kwargs_binding/dynamic_value_kwargs_bind_by_name.py`.
#[test]
fn test_gen_behavior_core_args_kwargs_binding_dynamic_value_kwargs_bind_by_name() {
...
"###);
    assert_output(&out, r###"dynamic_value_kwargs_bind_by_name OK
"###);
}
