...
# lib = "telnetlib"
# dimension = "type"
# case = "Telnet__msg__msg_as_str_wrong"
# subject = "telnetlib.Telnet.msg(msg: str)"
# kind = "semantic"
...
"""Type wall: telnetlib.Telnet.msg(msg: str); call it with the wrong type.
...
try:
    obj.msg(12345)  # msg: str <- wrong-typed
