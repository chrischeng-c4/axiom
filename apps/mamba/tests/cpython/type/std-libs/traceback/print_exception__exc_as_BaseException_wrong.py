...
# lib = "traceback"
# dimension = "type"
# case = "print_exception__exc_as_BaseException_wrong"
# subject = "traceback.print_exception(exc: BaseException)"
# kind = "semantic"
...
"""Type wall: traceback.print_exception(exc: BaseException); call it with the wrong type.
...
try:
    print_exception(_W())  # exc: BaseException <- wrong-typed
