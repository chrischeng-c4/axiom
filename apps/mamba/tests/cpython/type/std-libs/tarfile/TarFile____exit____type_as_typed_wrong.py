...
# lib = "tarfile"
# dimension = "type"
# case = "TarFile____exit____type_as_typed_wrong"
# subject = "tarfile.TarFile.__exit__(type: typed)"
# kind = "semantic"
...
"""Type wall: tarfile.TarFile.__exit__(type: typed); call it with the wrong type.
