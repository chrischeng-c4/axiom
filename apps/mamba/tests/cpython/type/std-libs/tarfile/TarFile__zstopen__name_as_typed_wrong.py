...
# lib = "tarfile"
# dimension = "type"
# case = "TarFile__zstopen__name_as_typed_wrong"
# subject = "tarfile.TarFile.zstopen(name: typed)"
# kind = "semantic"
...
"""Type wall: tarfile.TarFile.zstopen(name: typed); call it with the wrong type.
...
try:
    TarFile.zstopen(_W())  # name: typed <- wrong-typed
