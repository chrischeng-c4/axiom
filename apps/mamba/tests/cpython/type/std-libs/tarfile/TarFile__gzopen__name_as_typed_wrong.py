...
# lib = "tarfile"
# dimension = "type"
# case = "TarFile__gzopen__name_as_typed_wrong"
# subject = "tarfile.TarFile.gzopen(name: typed)"
# kind = "semantic"
...
"""Type wall: tarfile.TarFile.gzopen(name: typed); call it with the wrong type.
...
try:
    TarFile.gzopen(_W())  # name: typed <- wrong-typed
