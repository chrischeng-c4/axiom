...
# lib = "random"
# dimension = "type"
# case = "Random__setstate__state_as_tuple_wrong"
# subject = "random.Random.setstate(state: tuple)"
# kind = "semantic"
...
"""Type wall: random.Random.setstate(state: tuple); call it with the wrong type.
