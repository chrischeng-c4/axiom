...
# dimension = "type"
# case = "filter_internal_frames__frames_as_Sequence_wrong"
# subject = "profiling.sampling.collector.filter_internal_frames(frames: Sequence)"
# kind = "semantic"
...
"""Type wall: profiling.sampling.collector.filter_internal_frames(frames: Sequence); call it with the wrong type.
...
try:
    filter_internal_frames(_W())  # frames: Sequence <- wrong-typed
