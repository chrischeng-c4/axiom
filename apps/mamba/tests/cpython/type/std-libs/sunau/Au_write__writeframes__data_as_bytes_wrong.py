...
# lib = "sunau"
# dimension = "type"
# case = "Au_write__writeframes__data_as_bytes_wrong"
# subject = "sunau.Au_write.writeframes(data: bytes)"
# kind = "semantic"
...
"""Type wall: sunau.Au_write.writeframes(data: bytes); call it with the wrong type.
...
try:
    obj.writeframes(12345)  # data: bytes <- wrong-typed
