...
# lib = "sunau"
# dimension = "type"
# case = "Au_write__writeframesraw__data_as_bytes_wrong"
# subject = "sunau.Au_write.writeframesraw(data: bytes)"
# kind = "semantic"
...
"""Type wall: sunau.Au_write.writeframesraw(data: bytes); call it with the wrong type.
...
try:
    obj.writeframesraw(12345)  # data: bytes <- wrong-typed
