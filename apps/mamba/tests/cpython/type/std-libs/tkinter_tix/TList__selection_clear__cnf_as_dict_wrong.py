...
# lib = "tkinter_tix"
# dimension = "type"
# case = "TList__selection_clear__cnf_as_dict_wrong"
# subject = "tkinter.tix.TList.selection_clear(cnf: dict)"
# kind = "semantic"
...
"""Type wall: tkinter.tix.TList.selection_clear(cnf: dict); call it with the wrong type.
...
try:
    obj.selection_clear(12345)  # cnf: dict <- wrong-typed
