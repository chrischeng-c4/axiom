...
# lib = "tkinter_tix"
# dimension = "type"
# case = "DisplayStyle__config__cnf_as_dict_wrong"
# subject = "tkinter.tix.DisplayStyle.config(cnf: dict)"
# kind = "semantic"
...
"""Type wall: tkinter.tix.DisplayStyle.config(cnf: dict); call it with the wrong type.
...
try:
    obj.config(12345)  # cnf: dict <- wrong-typed
