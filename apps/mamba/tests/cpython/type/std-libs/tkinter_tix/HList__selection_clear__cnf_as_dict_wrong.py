...
# lib = "tkinter_tix"
# dimension = "type"
# case = "HList__selection_clear__cnf_as_dict_wrong"
# subject = "tkinter.tix.HList.selection_clear(cnf: dict)"
# kind = "semantic"
...
"""Type wall: tkinter.tix.HList.selection_clear(cnf: dict); call it with the wrong type.
