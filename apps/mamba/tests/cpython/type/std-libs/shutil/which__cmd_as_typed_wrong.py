...
# lib = "shutil"
# dimension = "type"
# case = "which__cmd_as_typed_wrong"
# subject = "shutil.which(cmd: typed)"
# kind = "semantic"
...
"""Type wall: shutil.which(cmd: typed); call it with the wrong type.
...
try:
    which(_W())  # cmd: typed <- wrong-typed
