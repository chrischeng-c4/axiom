...
# lib = "http_client"
# dimension = "type"
# case = "HTTPResponse____exit____exc_type_as_typed_wrong"
# subject = "http.client.HTTPResponse.__exit__(exc_type: typed)"
# kind = "semantic"
...
"""Type wall: http.client.HTTPResponse.__exit__(exc_type: typed); call it with the wrong type.
