...
# lib = "inspect"
# dimension = "type"
# case = "getmembers__predicate_as_typed_wrong"
# subject = "inspect.getmembers(predicate: typed)"
# kind = "semantic"
...
"""Type wall: inspect.getmembers(predicate: typed); call it with the wrong type.
...
try:
    getmembers(None, _W())  # predicate: typed <- wrong-typed
