...
# lib = "threading"
# dimension = "type"
# case = "Condition__acquire__blocking_as_bool_wrong"
# subject = "threading.Condition.acquire(blocking: bool)"
# kind = "semantic"
...
"""Type wall: threading.Condition.acquire(blocking: bool); call it with the wrong type.
