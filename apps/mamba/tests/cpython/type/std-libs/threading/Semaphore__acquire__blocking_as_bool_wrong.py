...
# lib = "threading"
# dimension = "type"
# case = "Semaphore__acquire__blocking_as_bool_wrong"
# subject = "threading.Semaphore.acquire(blocking: bool)"
# kind = "semantic"
...
"""Type wall: threading.Semaphore.acquire(blocking: bool); call it with the wrong type.
