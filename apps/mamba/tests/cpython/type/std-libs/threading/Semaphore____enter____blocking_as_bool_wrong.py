...
# lib = "threading"
# dimension = "type"
# case = "Semaphore____enter____blocking_as_bool_wrong"
# subject = "threading.Semaphore.__enter__(blocking: bool)"
# kind = "semantic"
...
"""Type wall: threading.Semaphore.__enter__(blocking: bool); call it with the wrong type.
...
try:
    obj.__enter__("not_a_bool")  # blocking: bool <- wrong-typed
