...
# dimension = "type"
# case = "ExpatParser__setProperty__name_as_Literal_wrong"
# subject = "xml.sax.expatreader.ExpatParser.setProperty(name: Literal)"
# kind = "semantic"
...
"""Type wall: xml.sax.expatreader.ExpatParser.setProperty(name: Literal); call it with the wrong type.
...
try:
    obj.setProperty(_W(), None)  # name: Literal <- wrong-typed
