...
# lib = "urllib_request"
# dimension = "type"
# case = "ProxyHandler__init__proxies_as_typed_wrong"
# subject = "urllib.request.ProxyHandler.__init__(proxies: typed)"
# kind = "semantic"
...
"""Type wall: urllib.request.ProxyHandler.__init__(proxies: typed); call it with the wrong type.
...
try:
    ProxyHandler(_W())  # proxies: typed <- wrong-typed
