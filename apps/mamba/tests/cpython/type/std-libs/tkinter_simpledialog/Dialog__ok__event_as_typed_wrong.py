...
# dimension = "type"
# case = "Dialog__ok__event_as_typed_wrong"
# subject = "tkinter.simpledialog.Dialog.ok(event: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.simpledialog.Dialog.ok(event: typed); call it with the wrong type.
...
try:
    obj.ok(_W())  # event: typed <- wrong-typed
