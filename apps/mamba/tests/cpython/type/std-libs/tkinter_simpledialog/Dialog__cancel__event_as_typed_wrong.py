...
# dimension = "type"
# case = "Dialog__cancel__event_as_typed_wrong"
# subject = "tkinter.simpledialog.Dialog.cancel(event: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.simpledialog.Dialog.cancel(event: typed); call it with the wrong type.
...
try:
    obj.cancel(_W())  # event: typed <- wrong-typed
