...
# dimension = "type"
# case = "findall__elem_as_Element_wrong"
# subject = "xml.etree.ElementPath.findall(elem: Element)"
# kind = "semantic"
...
"""Type wall: xml.etree.ElementPath.findall(elem: Element); call it with the wrong type.
...
try:
    findall(_W(), "")  # elem: Element <- wrong-typed
