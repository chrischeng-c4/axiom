...
# dimension = "type"
# case = "find__elem_as_Element_wrong"
# subject = "xml.etree.ElementPath.find(elem: Element)"
# kind = "semantic"
...
"""Type wall: xml.etree.ElementPath.find(elem: Element); call it with the wrong type.
...
try:
    find(_W(), "")  # elem: Element <- wrong-typed
