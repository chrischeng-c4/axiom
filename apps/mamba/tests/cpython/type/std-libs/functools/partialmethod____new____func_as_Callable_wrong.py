...
# lib = "functools"
# dimension = "type"
# case = "partialmethod____new____func_as_Callable_wrong"
# subject = "functools.partialmethod.__new__(func: Callable)"
# kind = "semantic"
...
"""Type wall: functools.partialmethod.__new__(func: Callable); call it with the wrong type.
...
try:
    obj.__new__(_W())  # func: Callable <- wrong-typed
