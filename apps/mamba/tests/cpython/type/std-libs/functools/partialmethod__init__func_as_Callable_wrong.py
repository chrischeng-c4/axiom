...
# lib = "functools"
# dimension = "type"
# case = "partialmethod__init__func_as_Callable_wrong"
# subject = "functools.partialmethod.__init__(func: Callable)"
# kind = "semantic"
...
"""Type wall: functools.partialmethod.__init__(func: Callable); call it with the wrong type.
...
try:
    partialmethod(_W())  # func: Callable <- wrong-typed
