...
# lib = "functools"
# dimension = "type"
# case = "partialmethod__init__func_as__Descriptor_wrong"
# subject = "functools.partialmethod.__init__(func: _Descriptor)"
# kind = "semantic"
...
"""Type wall: functools.partialmethod.__init__(func: _Descriptor); call it with the wrong type.
...
try:
    partialmethod(_W())  # func: _Descriptor <- wrong-typed
