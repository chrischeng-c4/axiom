...
# lib = "enum"
# dimension = "type"
# case = "auto____xor____other_as_typed_wrong"
# subject = "enum.auto.__xor__(other: typed)"
# kind = "semantic"
...
"""Type wall: enum.auto.__xor__(other: typed); call it with the wrong type.
...
try:
    obj.__xor__(_W())  # other: typed <- wrong-typed
