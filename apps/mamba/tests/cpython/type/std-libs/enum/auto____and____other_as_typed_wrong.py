...
# lib = "enum"
# dimension = "type"
# case = "auto____and____other_as_typed_wrong"
# subject = "enum.auto.__and__(other: typed)"
# kind = "semantic"
...
"""Type wall: enum.auto.__and__(other: typed); call it with the wrong type.
...
obj = object.__new__(auto)
try:
    obj.__and__(_W())  # other: typed <- wrong-typed
