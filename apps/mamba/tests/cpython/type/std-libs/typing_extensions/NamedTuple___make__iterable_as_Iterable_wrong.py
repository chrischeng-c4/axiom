...
# dimension = "type"
# case = "NamedTuple___make__iterable_as_Iterable_wrong"
# subject = "typing_extensions.NamedTuple._make(iterable: Iterable)"
# kind = "semantic"
...
"""Type wall: typing_extensions.NamedTuple._make(iterable: Iterable); call it with the wrong type.
...
try:
    NamedTuple._make(_W())  # iterable: Iterable <- wrong-typed
