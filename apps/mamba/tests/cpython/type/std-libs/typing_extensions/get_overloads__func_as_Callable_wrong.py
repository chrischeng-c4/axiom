...
# dimension = "type"
# case = "get_overloads__func_as_Callable_wrong"
# subject = "typing_extensions.get_overloads(func: Callable)"
# kind = "semantic"
...
"""Type wall: typing_extensions.get_overloads(func: Callable); call it with the wrong type.
...
try:
    get_overloads(_W())  # func: Callable <- wrong-typed
