...
# dimension = "type"
# case = "BaseContext__RawArray__typecode_or_type_as_type_wrong"
# subject = "multiprocessing.context.BaseContext.RawArray(typecode_or_type: type)"
# kind = "semantic"
...
"""Type wall: multiprocessing.context.BaseContext.RawArray(typecode_or_type: type); call it with the wrong type.
...
try:
    obj.RawArray(_W(), None)  # typecode_or_type: type <- wrong-typed
