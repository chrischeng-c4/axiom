...
# dimension = "type"
# case = "BaseContext__RawArray__typecode_or_type_as_str_wrong"
# subject = "multiprocessing.context.BaseContext.RawArray(typecode_or_type: str)"
# kind = "semantic"
...
"""Type wall: multiprocessing.context.BaseContext.RawArray(typecode_or_type: str); call it with the wrong type.
...
try:
    obj.RawArray(12345, None)  # typecode_or_type: str <- wrong-typed
