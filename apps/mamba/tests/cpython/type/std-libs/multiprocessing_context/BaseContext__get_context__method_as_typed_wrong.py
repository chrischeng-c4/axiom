...
# dimension = "type"
# case = "BaseContext__get_context__method_as_typed_wrong"
# subject = "multiprocessing.context.BaseContext.get_context(method: typed)"
# kind = "semantic"
...
"""Type wall: multiprocessing.context.BaseContext.get_context(method: typed); call it with the wrong type.
...
try:
    obj.get_context(_W())  # method: typed <- wrong-typed
