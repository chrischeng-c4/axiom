...
# dimension = "type"
# case = "BaseContext__RawValue__typecode_or_type_as_type_wrong"
# subject = "multiprocessing.context.BaseContext.RawValue(typecode_or_type: type)"
# kind = "semantic"
...
"""Type wall: multiprocessing.context.BaseContext.RawValue(typecode_or_type: type); call it with the wrong type.
...
try:
    obj.RawValue(_W())  # typecode_or_type: type <- wrong-typed
