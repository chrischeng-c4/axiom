...
# dimension = "type"
# case = "BaseContext__Value__typecode_or_type_as_typed_wrong"
# subject = "multiprocessing.context.BaseContext.Value(typecode_or_type: typed)"
# kind = "semantic"
...
"""Type wall: multiprocessing.context.BaseContext.Value(typecode_or_type: typed); call it with the wrong type.
...
try:
    obj.Value(_W())  # typecode_or_type: typed <- wrong-typed
