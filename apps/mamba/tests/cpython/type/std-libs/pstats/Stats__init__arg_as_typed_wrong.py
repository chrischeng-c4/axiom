...
# lib = "pstats"
# dimension = "type"
# case = "Stats__init__arg_as_typed_wrong"
# subject = "pstats.Stats.__init__(arg: typed)"
# kind = "semantic"
...
"""Type wall: pstats.Stats.__init__(arg: typed); call it with the wrong type.
...
try:
    Stats(_W())  # arg: typed <- wrong-typed
