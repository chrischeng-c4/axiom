...
# lib = "syslog"
# dimension = "type"
# case = "syslog__message_as_str_wrong"
# subject = "syslog.syslog(message: str)"
# kind = "semantic"
...
"""Type wall: syslog.syslog(message: str); call it with the wrong type.
...
try:
    syslog(12345)  # message: str <- wrong-typed
