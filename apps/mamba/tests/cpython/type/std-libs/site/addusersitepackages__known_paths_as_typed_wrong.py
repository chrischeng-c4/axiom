...
# lib = "site"
# dimension = "type"
# case = "addusersitepackages__known_paths_as_typed_wrong"
# subject = "site.addusersitepackages(known_paths: typed)"
# kind = "semantic"
...
"""Type wall: site.addusersitepackages(known_paths: typed); call it with the wrong type.
...
try:
    addusersitepackages(_W())  # known_paths: typed <- wrong-typed
