...
# lib = "ctypes"
# dimension = "type"
# case = "POINTER__cls_as_str_wrong"
# subject = "ctypes.POINTER(cls: str)"
# kind = "semantic"
...
"""Type wall: ctypes.POINTER(cls: str); call it with the wrong type.
...
try:
    POINTER(12345)  # cls: str <- wrong-typed
