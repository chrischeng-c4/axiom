...
# lib = "contextlib"
# dimension = "type"
# case = "ExitStack____exit____exc_type_as_typed_wrong"
# subject = "contextlib.ExitStack.__exit__(exc_type: typed)"
# kind = "semantic"
...
"""Type wall: contextlib.ExitStack.__exit__(exc_type: typed); call it with the wrong type.
