...
# dimension = "type"
# case = "ContentManager__set_content__msg_as_Message_wrong"
# subject = "email.contentmanager.ContentManager.set_content(msg: Message)"
# kind = "semantic"
...
"""Type wall: email.contentmanager.ContentManager.set_content(msg: Message); call it with the wrong type.
...
try:
    obj.set_content(_W(), None)  # msg: Message <- wrong-typed
