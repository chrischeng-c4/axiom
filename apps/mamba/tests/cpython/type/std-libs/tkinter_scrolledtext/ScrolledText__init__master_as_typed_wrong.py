...
"""Type wall: tkinter.scrolledtext.ScrolledText.__init__(master: typed); call it with the wrong type.
...
try:
    ScrolledText(_W())  # master: typed <- wrong-typed
