...
# lib = "socket"
# dimension = "type"
# case = "socket__makefile__mode_as_Literal_wrong"
# subject = "socket.socket.makefile(mode: Literal)"
# kind = "semantic"
...
"""Type wall: socket.socket.makefile(mode: Literal); call it with the wrong type.
...
try:
    obj.makefile(_W(), None)  # mode: Literal <- wrong-typed
