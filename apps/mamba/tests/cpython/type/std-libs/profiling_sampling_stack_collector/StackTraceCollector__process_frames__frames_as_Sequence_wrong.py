...
# dimension = "type"
# case = "StackTraceCollector__process_frames__frames_as_Sequence_wrong"
# subject = "profiling.sampling.stack_collector.StackTraceCollector.process_frames(frames: Sequence)"
# kind = "semantic"
...
"""Type wall: profiling.sampling.stack_collector.StackTraceCollector.process_frames(frames: Sequence); call it with the wrong type.
...
obj = object.__new__(StackTraceCollector)
try:
