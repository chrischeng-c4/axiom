...
# dimension = "type"
# case = "StackTraceCollector__collect__stack_frames_as_typed_wrong"
# subject = "profiling.sampling.stack_collector.StackTraceCollector.collect(stack_frames: typed)"
# kind = "semantic"
...
"""Type wall: profiling.sampling.stack_collector.StackTraceCollector.collect(stack_frames: typed); call it with the wrong type.
