...
# lib = "zipfile__path"
# dimension = "type"
# case = "Path__relative_to__other_as_Path_wrong"
# subject = "zipfile._path.Path.relative_to(other: Path)"
# kind = "semantic"
...
"""Type wall: zipfile._path.Path.relative_to(other: Path); call it with the wrong type.

typeshed contract: other is Path. mamba is force-typed, so a wrong-typed
...
try:
    obj.relative_to(_W())  # other: Path <- wrong-typed
