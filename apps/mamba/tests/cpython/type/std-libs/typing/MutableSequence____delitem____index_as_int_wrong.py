...
# lib = "typing"
# dimension = "type"
# case = "MutableSequence____delitem____index_as_int_wrong"
# subject = "typing.MutableSequence.__delitem__(index: int)"
# kind = "semantic"
...
"""Type wall: typing.MutableSequence.__delitem__(index: int); call it with the wrong type.
...
try:
    obj.__delitem__("not_an_int")  # index: int <- wrong-typed
