...
# lib = "typing"
# dimension = "type"
# case = "AbstractSet____xor____other_as_AbstractSet_wrong"
# subject = "typing.AbstractSet.__xor__(other: AbstractSet)"
# kind = "semantic"
...
"""Type wall: typing.AbstractSet.__xor__(other: AbstractSet); call it with the wrong type.
...
try:
    obj.__xor__(_W())  # other: AbstractSet <- wrong-typed
