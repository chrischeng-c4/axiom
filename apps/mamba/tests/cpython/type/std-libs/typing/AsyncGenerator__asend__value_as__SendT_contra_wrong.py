...
# lib = "typing"
# dimension = "type"
# case = "AsyncGenerator__asend__value_as__SendT_contra_wrong"
# subject = "typing.AsyncGenerator.asend(value: _SendT_contra)"
# kind = "semantic"
...
"""Type wall: typing.AsyncGenerator.asend(value: _SendT_contra); call it with the wrong type.
...
try:
    obj.asend(_W())  # value: _SendT_contra <- wrong-typed
