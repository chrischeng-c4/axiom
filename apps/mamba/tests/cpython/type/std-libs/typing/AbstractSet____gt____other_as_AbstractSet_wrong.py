...
# lib = "typing"
# dimension = "type"
# case = "AbstractSet____gt____other_as_AbstractSet_wrong"
# subject = "typing.AbstractSet.__gt__(other: AbstractSet)"
# kind = "semantic"
...
"""Type wall: typing.AbstractSet.__gt__(other: AbstractSet); call it with the wrong type.
...
try:
    obj.__gt__(_W())  # other: AbstractSet <- wrong-typed
