...
# lib = "typing"
# dimension = "type"
# case = "AsyncGenerator__athrow__typ_as_BaseException_wrong"
# subject = "typing.AsyncGenerator.athrow(typ: BaseException)"
# kind = "semantic"
...
"""Type wall: typing.AsyncGenerator.athrow(typ: BaseException); call it with the wrong type.
...
obj = object.__new__(AsyncGenerator)
try:
