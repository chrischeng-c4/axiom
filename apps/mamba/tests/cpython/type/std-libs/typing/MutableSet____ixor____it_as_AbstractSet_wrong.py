...
# lib = "typing"
# dimension = "type"
# case = "MutableSet____ixor____it_as_AbstractSet_wrong"
# subject = "typing.MutableSet.__ixor__(it: AbstractSet)"
# kind = "semantic"
...
"""Type wall: typing.MutableSet.__ixor__(it: AbstractSet); call it with the wrong type.
...
try:
    obj.__ixor__(_W())  # it: AbstractSet <- wrong-typed
