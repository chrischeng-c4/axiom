...
# lib = "typing"
# dimension = "type"
# case = "MutableSequence__remove__value_as__T_wrong"
# subject = "typing.MutableSequence.remove(value: _T)"
# kind = "semantic"
...
"""Type wall: typing.MutableSequence.remove(value: _T); call it with the wrong type.
