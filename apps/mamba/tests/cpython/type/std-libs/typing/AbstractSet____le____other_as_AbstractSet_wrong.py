...
# lib = "typing"
# dimension = "type"
# case = "AbstractSet____le____other_as_AbstractSet_wrong"
# subject = "typing.AbstractSet.__le__(other: AbstractSet)"
# kind = "semantic"
...
"""Type wall: typing.AbstractSet.__le__(other: AbstractSet); call it with the wrong type.
...
try:
    obj.__le__(_W())  # other: AbstractSet <- wrong-typed
