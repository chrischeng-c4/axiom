...
# lib = "typing"
# dimension = "type"
# case = "AbstractSet____and____other_as_AbstractSet_wrong"
# subject = "typing.AbstractSet.__and__(other: AbstractSet)"
# kind = "semantic"
...
"""Type wall: typing.AbstractSet.__and__(other: AbstractSet); call it with the wrong type.
...
try:
    obj.__and__(_W())  # other: AbstractSet <- wrong-typed
