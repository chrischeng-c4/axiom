...
# dimension = "type"
# case = "Deprecated____getitem____name_as__KT_wrong"
# subject = "importlib.metadata.Deprecated.__getitem__(name: _KT)"
# kind = "semantic"
...
"""Type wall: importlib.metadata.Deprecated.__getitem__(name: _KT); call it with the wrong type.
...
try:
    obj.__getitem__(_W())  # name: _KT <- wrong-typed
