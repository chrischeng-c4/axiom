...
# dimension = "type"
# case = "AttributesImpl____getitem____name_as__AttrKey_wrong"
# subject = "xml.sax.xmlreader.AttributesImpl.__getitem__(name: _AttrKey)"
# kind = "semantic"
...
"""Type wall: xml.sax.xmlreader.AttributesImpl.__getitem__(name: _AttrKey); call it with the wrong type.
...
try:
    obj.__getitem__(_W())  # name: _AttrKey <- wrong-typed
