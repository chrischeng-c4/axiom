...
# dimension = "type"
# case = "AttributesImpl__getQNameByName__name_as__AttrKey_wrong"
# subject = "xml.sax.xmlreader.AttributesImpl.getQNameByName(name: _AttrKey)"
# kind = "semantic"
...
"""Type wall: xml.sax.xmlreader.AttributesImpl.getQNameByName(name: _AttrKey); call it with the wrong type.
...
try:
    obj.getQNameByName(_W())  # name: _AttrKey <- wrong-typed
