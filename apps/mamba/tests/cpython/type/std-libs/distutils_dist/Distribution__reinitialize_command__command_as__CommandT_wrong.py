...
# lib = "distutils_dist"
# dimension = "type"
# case = "Distribution__reinitialize_command__command_as__CommandT_wrong"
# subject = "distutils.dist.Distribution.reinitialize_command(command: _CommandT)"
# kind = "semantic"
...
"""Type wall: distutils.dist.Distribution.reinitialize_command(command: _CommandT); call it with the wrong type.
