...
# lib = "turtle"
# dimension = "type"
# case = "TurtleScreen__delay__delay_as_typed_wrong"
# subject = "turtle.TurtleScreen.delay(delay: typed)"
# kind = "semantic"
...
"""Type wall: turtle.TurtleScreen.delay(delay: typed); call it with the wrong type.
...
try:
    obj.delay(_W())  # delay: typed <- wrong-typed
