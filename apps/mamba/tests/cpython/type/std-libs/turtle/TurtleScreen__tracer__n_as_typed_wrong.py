...
# lib = "turtle"
# dimension = "type"
# case = "TurtleScreen__tracer__n_as_typed_wrong"
# subject = "turtle.TurtleScreen.tracer(n: typed)"
# kind = "semantic"
...
"""Type wall: turtle.TurtleScreen.tracer(n: typed); call it with the wrong type.
...
try:
    obj.tracer(_W())  # n: typed <- wrong-typed
