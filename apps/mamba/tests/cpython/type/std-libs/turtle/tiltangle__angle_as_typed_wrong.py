...
# lib = "turtle"
# dimension = "type"
# case = "tiltangle__angle_as_typed_wrong"
# subject = "turtle.tiltangle(angle: typed)"
# kind = "semantic"
...
"""Type wall: turtle.tiltangle(angle: typed); call it with the wrong type.
...
try:
    tiltangle(_W())  # angle: typed <- wrong-typed
