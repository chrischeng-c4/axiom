...
# lib = "turtle"
# dimension = "type"
# case = "screensize__canvwidth_as_typed_wrong"
# subject = "turtle.screensize(canvwidth: typed)"
# kind = "semantic"
...
"""Type wall: turtle.screensize(canvwidth: typed); call it with the wrong type.
...
try:
    screensize(_W())  # canvwidth: typed <- wrong-typed
