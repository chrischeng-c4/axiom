...
# lib = "turtle"
# dimension = "type"
# case = "TNavigator__towards__x_as_typed_wrong"
# subject = "turtle.TNavigator.towards(x: typed)"
# kind = "semantic"
...
"""Type wall: turtle.TNavigator.towards(x: typed); call it with the wrong type.
...
try:
    obj.towards(_W())  # x: typed <- wrong-typed
