...
# lib = "turtle"
# dimension = "type"
# case = "TurtleScreen__mode__mode_as_typed_wrong"
# subject = "turtle.TurtleScreen.mode(mode: typed)"
# kind = "semantic"
...
"""Type wall: turtle.TurtleScreen.mode(mode: typed); call it with the wrong type.
...
try:
    obj.mode(_W())  # mode: typed <- wrong-typed
