...
# lib = "turtle"
# dimension = "type"
# case = "towards__x_as_float_wrong"
# subject = "turtle.towards(x: float)"
# kind = "semantic"
...
"""Type wall: turtle.towards(x: float); call it with the wrong type.
...
try:
    towards("not_a_float", 0.0)  # x: float <- wrong-typed
