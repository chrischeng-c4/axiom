...
# lib = "turtle"
# dimension = "type"
# case = "shearfactor__shear_as_typed_wrong"
# subject = "turtle.shearfactor(shear: typed)"
# kind = "semantic"
...
"""Type wall: turtle.shearfactor(shear: typed); call it with the wrong type.
...
try:
    shearfactor(_W())  # shear: typed <- wrong-typed
