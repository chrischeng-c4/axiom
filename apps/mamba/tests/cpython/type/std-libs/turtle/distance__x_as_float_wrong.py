...
# lib = "turtle"
# dimension = "type"
# case = "distance__x_as_float_wrong"
# subject = "turtle.distance(x: float)"
# kind = "semantic"
...
"""Type wall: turtle.distance(x: float); call it with the wrong type.
...
try:
    distance("not_a_float", 0.0)  # x: float <- wrong-typed
