...
# lib = "turtle"
# dimension = "type"
# case = "RawTurtle__onrelease__fun_as_Callable_wrong"
# subject = "turtle.RawTurtle.onrelease(fun: Callable)"
# kind = "semantic"
...
"""Type wall: turtle.RawTurtle.onrelease(fun: Callable); call it with the wrong type.
...
try:
    obj.onrelease(_W())  # fun: Callable <- wrong-typed
