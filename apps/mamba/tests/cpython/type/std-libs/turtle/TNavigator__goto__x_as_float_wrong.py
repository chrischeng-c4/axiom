...
# lib = "turtle"
# dimension = "type"
# case = "TNavigator__goto__x_as_float_wrong"
# subject = "turtle.TNavigator.goto(x: float)"
# kind = "semantic"
...
"""Type wall: turtle.TNavigator.goto(x: float); call it with the wrong type.
...
try:
    obj.goto("not_a_float", 0.0)  # x: float <- wrong-typed
