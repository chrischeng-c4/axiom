...
# lib = "turtle"
# dimension = "type"
# case = "fillcolor__color_as__Color_wrong"
# subject = "turtle.fillcolor(color: _Color)"
# kind = "semantic"
...
"""Type wall: turtle.fillcolor(color: _Color); call it with the wrong type.
...
try:
    fillcolor(_W())  # color: _Color <- wrong-typed
