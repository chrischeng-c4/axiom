...
# lib = "turtle"
# dimension = "type"
# case = "TPen__pencolor__color_as__Color_wrong"
# subject = "turtle.TPen.pencolor(color: _Color)"
# kind = "semantic"
...
"""Type wall: turtle.TPen.pencolor(color: _Color); call it with the wrong type.
...
try:
    obj.pencolor(_W())  # color: _Color <- wrong-typed
