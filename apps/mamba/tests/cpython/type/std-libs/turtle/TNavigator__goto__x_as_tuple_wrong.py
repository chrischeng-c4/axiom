...
# lib = "turtle"
# dimension = "type"
# case = "TNavigator__goto__x_as_tuple_wrong"
# subject = "turtle.TNavigator.goto(x: tuple)"
# kind = "semantic"
...
"""Type wall: turtle.TNavigator.goto(x: tuple); call it with the wrong type.
...
try:
    obj.goto(12345)  # x: tuple <- wrong-typed
