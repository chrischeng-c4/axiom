...
# lib = "turtle"
# dimension = "type"
# case = "TPen__color__color_as__Color_wrong"
# subject = "turtle.TPen.color(color: _Color)"
# kind = "semantic"
...
"""Type wall: turtle.TPen.color(color: _Color); call it with the wrong type.
...
try:
    obj.color(_W())  # color: _Color <- wrong-typed
