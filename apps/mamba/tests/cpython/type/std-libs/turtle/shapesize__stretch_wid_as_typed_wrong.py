...
# lib = "turtle"
# dimension = "type"
# case = "shapesize__stretch_wid_as_typed_wrong"
# subject = "turtle.shapesize(stretch_wid: typed)"
# kind = "semantic"
...
"""Type wall: turtle.shapesize(stretch_wid: typed); call it with the wrong type.
...
try:
    shapesize(_W())  # stretch_wid: typed <- wrong-typed
