...
# lib = "turtle"
# dimension = "type"
# case = "TNavigator__distance__x_as_float_wrong"
# subject = "turtle.TNavigator.distance(x: float)"
# kind = "semantic"
...
"""Type wall: turtle.TNavigator.distance(x: float); call it with the wrong type.
...
try:
    obj.distance("not_a_float", 0.0)  # x: float <- wrong-typed
