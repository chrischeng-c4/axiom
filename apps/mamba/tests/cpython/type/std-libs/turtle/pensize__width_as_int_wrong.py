...
# lib = "turtle"
# dimension = "type"
# case = "pensize__width_as_int_wrong"
# subject = "turtle.pensize(width: int)"
# kind = "semantic"
...
"""Type wall: turtle.pensize(width: int); call it with the wrong type.
...
try:
    pensize("not_an_int")  # width: int <- wrong-typed
