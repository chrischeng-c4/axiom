...
# lib = "turtle"
# dimension = "type"
# case = "RawTurtle__tiltangle__angle_as_float_wrong"
# subject = "turtle.RawTurtle.tiltangle(angle: float)"
# kind = "semantic"
...
"""Type wall: turtle.RawTurtle.tiltangle(angle: float); call it with the wrong type.
...
try:
    obj.tiltangle("not_a_float")  # angle: float <- wrong-typed
