...
# lib = "turtle"
# dimension = "type"
# case = "distance__x_as_typed_wrong"
# subject = "turtle.distance(x: typed)"
# kind = "semantic"
...
"""Type wall: turtle.distance(x: typed); call it with the wrong type.
...
try:
    distance(_W())  # x: typed <- wrong-typed
