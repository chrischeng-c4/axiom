...
# lib = "turtle"
# dimension = "type"
# case = "color__r_as_float_wrong"
# subject = "turtle.color(r: float)"
# kind = "semantic"
...
"""Type wall: turtle.color(r: float); call it with the wrong type.
...
try:
    color("not_a_float", 0.0, 0.0)  # r: float <- wrong-typed
