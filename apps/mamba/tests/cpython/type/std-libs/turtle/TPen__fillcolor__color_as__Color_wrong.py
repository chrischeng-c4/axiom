...
# lib = "turtle"
# dimension = "type"
# case = "TPen__fillcolor__color_as__Color_wrong"
# subject = "turtle.TPen.fillcolor(color: _Color)"
# kind = "semantic"
...
"""Type wall: turtle.TPen.fillcolor(color: _Color); call it with the wrong type.
...
try:
    obj.fillcolor(_W())  # color: _Color <- wrong-typed
