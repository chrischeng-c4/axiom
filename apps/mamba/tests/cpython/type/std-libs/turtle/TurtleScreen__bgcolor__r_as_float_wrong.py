...
# lib = "turtle"
# dimension = "type"
# case = "TurtleScreen__bgcolor__r_as_float_wrong"
# subject = "turtle.TurtleScreen.bgcolor(r: float)"
# kind = "semantic"
...
"""Type wall: turtle.TurtleScreen.bgcolor(r: float); call it with the wrong type.
...
try:
    obj.bgcolor("not_a_float", 0.0, 0.0)  # r: float <- wrong-typed
