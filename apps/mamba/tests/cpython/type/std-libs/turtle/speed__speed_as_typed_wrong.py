...
# lib = "turtle"
# dimension = "type"
# case = "speed__speed_as_typed_wrong"
# subject = "turtle.speed(speed: typed)"
# kind = "semantic"
...
"""Type wall: turtle.speed(speed: typed); call it with the wrong type.
...
try:
    speed(_W())  # speed: typed <- wrong-typed
