...
# lib = "turtle"
# dimension = "type"
# case = "TPen__color__r_as_float_wrong"
# subject = "turtle.TPen.color(r: float)"
# kind = "semantic"
...
"""Type wall: turtle.TPen.color(r: float); call it with the wrong type.
...
try:
    obj.color("not_a_float", 0.0, 0.0)  # r: float <- wrong-typed
