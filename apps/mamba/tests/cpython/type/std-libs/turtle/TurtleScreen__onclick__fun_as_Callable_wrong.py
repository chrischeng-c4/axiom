...
# lib = "turtle"
# dimension = "type"
# case = "TurtleScreen__onclick__fun_as_Callable_wrong"
# subject = "turtle.TurtleScreen.onclick(fun: Callable)"
# kind = "semantic"
...
"""Type wall: turtle.TurtleScreen.onclick(fun: Callable); call it with the wrong type.
...
try:
    obj.onclick(_W())  # fun: Callable <- wrong-typed
