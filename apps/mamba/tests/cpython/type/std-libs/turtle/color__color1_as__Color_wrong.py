...
# lib = "turtle"
# dimension = "type"
# case = "color__color1_as__Color_wrong"
# subject = "turtle.color(color1: _Color)"
# kind = "semantic"
...
"""Type wall: turtle.color(color1: _Color); call it with the wrong type.
...
try:
    color(_W(), None)  # color1: _Color <- wrong-typed
