...
# lib = "turtle"
# dimension = "type"
# case = "TurtleScreen__tracer__n_as_int_wrong"
# subject = "turtle.TurtleScreen.tracer(n: int)"
# kind = "semantic"
...
"""Type wall: turtle.TurtleScreen.tracer(n: int); call it with the wrong type.
...
try:
    obj.tracer("not_an_int")  # n: int <- wrong-typed
