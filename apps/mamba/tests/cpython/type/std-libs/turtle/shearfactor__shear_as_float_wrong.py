...
# lib = "turtle"
# dimension = "type"
# case = "shearfactor__shear_as_float_wrong"
# subject = "turtle.shearfactor(shear: float)"
# kind = "semantic"
...
"""Type wall: turtle.shearfactor(shear: float); call it with the wrong type.
...
try:
    shearfactor("not_a_float")  # shear: float <- wrong-typed
