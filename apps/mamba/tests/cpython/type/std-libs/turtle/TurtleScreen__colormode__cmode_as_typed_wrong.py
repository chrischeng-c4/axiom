...
# lib = "turtle"
# dimension = "type"
# case = "TurtleScreen__colormode__cmode_as_typed_wrong"
# subject = "turtle.TurtleScreen.colormode(cmode: typed)"
# kind = "semantic"
...
"""Type wall: turtle.TurtleScreen.colormode(cmode: typed); call it with the wrong type.
...
try:
    obj.colormode(_W())  # cmode: typed <- wrong-typed
