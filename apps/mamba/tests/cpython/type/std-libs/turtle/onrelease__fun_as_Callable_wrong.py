...
# lib = "turtle"
# dimension = "type"
# case = "onrelease__fun_as_Callable_wrong"
# subject = "turtle.onrelease(fun: Callable)"
# kind = "semantic"
...
"""Type wall: turtle.onrelease(fun: Callable); call it with the wrong type.
...
try:
    onrelease(_W())  # fun: Callable <- wrong-typed
