...
# lib = "weakref"
# dimension = "type"
# case = "finalize__init__obj_as__T_wrong"
# subject = "weakref.finalize.__init__(obj: _T)"
# kind = "semantic"
...
"""Type wall: weakref.finalize.__init__(obj: _T); call it with the wrong type.
...
try:
    finalize(_W(), None)  # obj: _T <- wrong-typed
