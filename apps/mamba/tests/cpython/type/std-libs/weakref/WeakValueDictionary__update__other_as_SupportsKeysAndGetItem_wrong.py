...
# lib = "weakref"
# dimension = "type"
# case = "WeakValueDictionary__update__other_as_SupportsKeysAndGetItem_wrong"
# subject = "weakref.WeakValueDictionary.update(other: SupportsKeysAndGetItem)"
# kind = "semantic"
...
"""Type wall: weakref.WeakValueDictionary.update(other: SupportsKeysAndGetItem); call it with the wrong type.
...
try:
    obj.update(_W())  # other: SupportsKeysAndGetItem <- wrong-typed
