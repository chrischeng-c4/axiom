...
# lib = "weakref"
# dimension = "type"
# case = "WeakKeyDictionary__update__dict_as_typed_wrong"
# subject = "weakref.WeakKeyDictionary.update(dict: typed)"
# kind = "semantic"
...
"""Type wall: weakref.WeakKeyDictionary.update(dict: typed); call it with the wrong type.
...
try:
    obj.update(_W())  # dict: typed <- wrong-typed
