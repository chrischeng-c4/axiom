...
# lib = "weakref"
# dimension = "type"
# case = "WeakValueDictionary____ior____other_as_Iterable_wrong"
# subject = "weakref.WeakValueDictionary.__ior__(other: Iterable)"
# kind = "semantic"
...
"""Type wall: weakref.WeakValueDictionary.__ior__(other: Iterable); call it with the wrong type.
