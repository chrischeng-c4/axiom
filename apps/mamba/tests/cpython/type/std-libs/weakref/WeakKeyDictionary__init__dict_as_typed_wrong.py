...
# lib = "weakref"
# dimension = "type"
# case = "WeakKeyDictionary__init__dict_as_typed_wrong"
# subject = "weakref.WeakKeyDictionary.__init__(dict: typed)"
# kind = "semantic"
...
"""Type wall: weakref.WeakKeyDictionary.__init__(dict: typed); call it with the wrong type.
...
try:
    WeakKeyDictionary(_W())  # dict: typed <- wrong-typed
