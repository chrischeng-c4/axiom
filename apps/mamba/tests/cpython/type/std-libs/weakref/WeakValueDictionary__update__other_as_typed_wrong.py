...
# lib = "weakref"
# dimension = "type"
# case = "WeakValueDictionary__update__other_as_typed_wrong"
# subject = "weakref.WeakValueDictionary.update(other: typed)"
# kind = "semantic"
...
"""Type wall: weakref.WeakValueDictionary.update(other: typed); call it with the wrong type.
...
try:
    obj.update(_W())  # other: typed <- wrong-typed
