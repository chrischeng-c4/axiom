...
# lib = "weakref"
# dimension = "type"
# case = "WeakKeyDictionary____ior____other_as_Iterable_wrong"
# subject = "weakref.WeakKeyDictionary.__ior__(other: Iterable)"
# kind = "semantic"
...
"""Type wall: weakref.WeakKeyDictionary.__ior__(other: Iterable); call it with the wrong type.
