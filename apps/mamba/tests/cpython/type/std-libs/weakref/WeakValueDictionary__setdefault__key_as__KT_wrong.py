...
# lib = "weakref"
# dimension = "type"
# case = "WeakValueDictionary__setdefault__key_as__KT_wrong"
# subject = "weakref.WeakValueDictionary.setdefault(key: _KT)"
# kind = "semantic"
...
"""Type wall: weakref.WeakValueDictionary.setdefault(key: _KT); call it with the wrong type.
...
try:
    obj.setdefault(_W(), None)  # key: _KT <- wrong-typed
