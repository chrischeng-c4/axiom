...
# lib = "tokenize"
# dimension = "type"
# case = "detect_encoding__readline_as_Callable_wrong"
# subject = "tokenize.detect_encoding(readline: Callable)"
# kind = "semantic"
...
"""Type wall: tokenize.detect_encoding(readline: Callable); call it with the wrong type.
...
try:
    detect_encoding(_W())  # readline: Callable <- wrong-typed
