...
# lib = "readline"
# dimension = "type"
# case = "set_auto_history__enabled_as_bool_wrong"
# subject = "readline.set_auto_history(enabled: bool)"
# kind = "semantic"
...
"""Type wall: readline.set_auto_history(enabled: bool); call it with the wrong type.
...
try:
    set_auto_history("not_a_bool")  # enabled: bool <- wrong-typed
