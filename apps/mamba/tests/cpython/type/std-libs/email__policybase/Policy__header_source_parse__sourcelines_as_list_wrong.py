...
# dimension = "type"
# case = "Policy__header_source_parse__sourcelines_as_list_wrong"
# subject = "email._policybase.Policy.header_source_parse(sourcelines: list)"
# kind = "semantic"
...
"""Type wall: email._policybase.Policy.header_source_parse(sourcelines: list); call it with the wrong type.
