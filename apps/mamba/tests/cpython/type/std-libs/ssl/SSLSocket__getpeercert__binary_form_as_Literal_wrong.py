...
# lib = "ssl"
# dimension = "type"
# case = "SSLSocket__getpeercert__binary_form_as_Literal_wrong"
# subject = "ssl.SSLSocket.getpeercert(binary_form: Literal)"
# kind = "semantic"
...
"""Type wall: ssl.SSLSocket.getpeercert(binary_form: Literal); call it with the wrong type.
