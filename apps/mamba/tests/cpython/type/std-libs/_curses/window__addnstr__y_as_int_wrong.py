...
# lib = "_curses"
# dimension = "type"
# case = "window__addnstr__y_as_int_wrong"
# subject = "_curses.window.addnstr(y: int)"
# kind = "semantic"
...
"""Type wall: _curses.window.addnstr(y: int); call it with the wrong type.
...
try:
    obj.addnstr("not_an_int", 0, "", 0)  # y: int <- wrong-typed
