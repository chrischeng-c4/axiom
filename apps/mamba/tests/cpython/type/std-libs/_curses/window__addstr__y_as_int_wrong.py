...
# lib = "_curses"
# dimension = "type"
# case = "window__addstr__y_as_int_wrong"
# subject = "_curses.window.addstr(y: int)"
# kind = "semantic"
...
"""Type wall: _curses.window.addstr(y: int); call it with the wrong type.
...
try:
    obj.addstr("not_an_int", 0, "")  # y: int <- wrong-typed
