...
# lib = "_curses"
# dimension = "type"
# case = "window__insch__y_as_int_wrong"
# subject = "_curses.window.insch(y: int)"
# kind = "semantic"
...
"""Type wall: _curses.window.insch(y: int); call it with the wrong type.
...
try:
    obj.insch("not_an_int", 0, None)  # y: int <- wrong-typed
