...
# lib = "_curses"
# dimension = "type"
# case = "window__scrollok__flag_as_bool_wrong"
# subject = "_curses.window.scrollok(flag: bool)"
# kind = "semantic"
...
"""Type wall: _curses.window.scrollok(flag: bool); call it with the wrong type.
...
try:
    obj.scrollok("not_a_bool")  # flag: bool <- wrong-typed
