...
# lib = "_curses"
# dimension = "type"
# case = "window__get_wch__y_as_int_wrong"
# subject = "_curses.window.get_wch(y: int)"
# kind = "semantic"
...
"""Type wall: _curses.window.get_wch(y: int); call it with the wrong type.
...
try:
    obj.get_wch("not_an_int", 0)  # y: int <- wrong-typed
