...
# lib = "_curses"
# dimension = "type"
# case = "window__delch__y_as_int_wrong"
# subject = "_curses.window.delch(y: int)"
# kind = "semantic"
...
"""Type wall: _curses.window.delch(y: int); call it with the wrong type.
...
try:
    obj.delch("not_an_int", 0)  # y: int <- wrong-typed
