...
# lib = "_curses"
# dimension = "type"
# case = "window__addch__ch_as__ChType_wrong"
# subject = "_curses.window.addch(ch: _ChType)"
# kind = "semantic"
...
"""Type wall: _curses.window.addch(ch: _ChType); call it with the wrong type.
...
try:
    obj.addch(_W())  # ch: _ChType <- wrong-typed
