...
# lib = "_curses"
# dimension = "type"
# case = "window__inch__y_as_int_wrong"
# subject = "_curses.window.inch(y: int)"
# kind = "semantic"
...
"""Type wall: _curses.window.inch(y: int); call it with the wrong type.
...
try:
    obj.inch("not_an_int", 0)  # y: int <- wrong-typed
