...
# lib = "_curses"
# dimension = "type"
# case = "window__vline__y_as_int_wrong"
# subject = "_curses.window.vline(y: int)"
# kind = "semantic"
...
"""Type wall: _curses.window.vline(y: int); call it with the wrong type.
...
try:
    obj.vline("not_an_int", 0, None, 0)  # y: int <- wrong-typed
