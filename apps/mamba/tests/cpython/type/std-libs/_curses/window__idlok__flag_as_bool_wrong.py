...
# lib = "_curses"
# dimension = "type"
# case = "window__idlok__flag_as_bool_wrong"
# subject = "_curses.window.idlok(flag: bool)"
# kind = "semantic"
...
"""Type wall: _curses.window.idlok(flag: bool); call it with the wrong type.
...
try:
    obj.idlok("not_a_bool")  # flag: bool <- wrong-typed
