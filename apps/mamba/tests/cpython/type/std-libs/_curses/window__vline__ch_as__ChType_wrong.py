...
# lib = "_curses"
# dimension = "type"
# case = "window__vline__ch_as__ChType_wrong"
# subject = "_curses.window.vline(ch: _ChType)"
# kind = "semantic"
...
"""Type wall: _curses.window.vline(ch: _ChType); call it with the wrong type.
...
try:
    obj.vline(_W(), 0)  # ch: _ChType <- wrong-typed
