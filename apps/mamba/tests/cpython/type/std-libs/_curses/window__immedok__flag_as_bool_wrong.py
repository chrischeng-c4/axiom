...
# lib = "_curses"
# dimension = "type"
# case = "window__immedok__flag_as_bool_wrong"
# subject = "_curses.window.immedok(flag: bool)"
# kind = "semantic"
...
"""Type wall: _curses.window.immedok(flag: bool); call it with the wrong type.
...
try:
    obj.immedok("not_a_bool")  # flag: bool <- wrong-typed
