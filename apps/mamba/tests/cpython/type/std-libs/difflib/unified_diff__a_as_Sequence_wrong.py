...
# lib = "difflib"
# dimension = "type"
# case = "unified_diff__a_as_Sequence_wrong"
# subject = "difflib.unified_diff(a: Sequence)"
# kind = "semantic"
...
"""Type wall: difflib.unified_diff(a: Sequence); call it with the wrong type.
...
try:
    unified_diff(_W(), None)  # a: Sequence <- wrong-typed
