...
# lib = "difflib"
# dimension = "type"
# case = "SequenceMatcher__set_seqs__a_as_Sequence_wrong"
# subject = "difflib.SequenceMatcher.set_seqs(a: Sequence)"
# kind = "semantic"
...
"""Type wall: difflib.SequenceMatcher.set_seqs(a: Sequence); call it with the wrong type.
...
try:
    obj.set_seqs(_W(), None)  # a: Sequence <- wrong-typed
