...
# lib = "difflib"
# dimension = "type"
# case = "HtmlDiff__make_table__fromlines_as_Sequence_wrong"
# subject = "difflib.HtmlDiff.make_table(fromlines: Sequence)"
# kind = "semantic"
...
"""Type wall: difflib.HtmlDiff.make_table(fromlines: Sequence); call it with the wrong type.
...
try:
    obj.make_table(_W(), None)  # fromlines: Sequence <- wrong-typed
