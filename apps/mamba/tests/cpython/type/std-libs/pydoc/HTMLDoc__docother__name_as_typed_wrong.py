...
# lib = "pydoc"
# dimension = "type"
# case = "HTMLDoc__docother__name_as_typed_wrong"
# subject = "pydoc.HTMLDoc.docother(name: typed)"
# kind = "semantic"
...
"""Type wall: pydoc.HTMLDoc.docother(name: typed); call it with the wrong type.
