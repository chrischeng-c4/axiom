...
# lib = "pydoc"
# dimension = "type"
# case = "HTMLDoc__docproperty__name_as_typed_wrong"
# subject = "pydoc.HTMLDoc.docproperty(name: typed)"
# kind = "semantic"
...
"""Type wall: pydoc.HTMLDoc.docproperty(name: typed); call it with the wrong type.
