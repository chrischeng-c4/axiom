...
# lib = "pydoc"
# dimension = "type"
# case = "HTMLDoc__docclass__name_as_typed_wrong"
# subject = "pydoc.HTMLDoc.docclass(name: typed)"
# kind = "semantic"
...
"""Type wall: pydoc.HTMLDoc.docclass(name: typed); call it with the wrong type.
...
try:
    obj.docclass(None, _W())  # name: typed <- wrong-typed
