...
# lib = "pydoc"
# dimension = "type"
# case = "TextDoc__docdata__name_as_typed_wrong"
# subject = "pydoc.TextDoc.docdata(name: typed)"
# kind = "semantic"
...
"""Type wall: pydoc.TextDoc.docdata(name: typed); call it with the wrong type.
