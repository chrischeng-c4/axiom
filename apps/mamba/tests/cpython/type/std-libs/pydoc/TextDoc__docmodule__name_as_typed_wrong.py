...
# lib = "pydoc"
# dimension = "type"
# case = "TextDoc__docmodule__name_as_typed_wrong"
# subject = "pydoc.TextDoc.docmodule(name: typed)"
# kind = "semantic"
...
"""Type wall: pydoc.TextDoc.docmodule(name: typed); call it with the wrong type.
