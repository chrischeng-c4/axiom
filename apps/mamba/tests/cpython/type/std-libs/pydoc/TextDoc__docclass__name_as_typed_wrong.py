...
# lib = "pydoc"
# dimension = "type"
# case = "TextDoc__docclass__name_as_typed_wrong"
# subject = "pydoc.TextDoc.docclass(name: typed)"
# kind = "semantic"
...
"""Type wall: pydoc.TextDoc.docclass(name: typed); call it with the wrong type.
