...
# lib = "pydoc"
# dimension = "type"
# case = "TextRepr__repr1__level_as_complex_wrong"
# subject = "pydoc.TextRepr.repr1(level: complex)"
# kind = "semantic"
...
"""Type wall: pydoc.TextRepr.repr1(level: complex); call it with the wrong type.
...
try:
    obj.repr1(None, "not_a_complex")  # level: complex <- wrong-typed
