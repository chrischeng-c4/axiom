...
# lib = "xmlrpc_client"
# dimension = "type"
# case = "getparser__use_datetime_as_bool_wrong"
# subject = "xmlrpc.client.getparser(use_datetime: bool)"
# kind = "semantic"
...
"""Type wall: xmlrpc.client.getparser(use_datetime: bool); call it with the wrong type.
...
try:
    getparser("not_a_bool")  # use_datetime: bool <- wrong-typed
