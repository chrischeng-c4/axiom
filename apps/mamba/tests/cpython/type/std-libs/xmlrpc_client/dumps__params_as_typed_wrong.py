...
# lib = "xmlrpc_client"
# dimension = "type"
# case = "dumps__params_as_typed_wrong"
# subject = "xmlrpc.client.dumps(params: typed)"
# kind = "semantic"
...
"""Type wall: xmlrpc.client.dumps(params: typed); call it with the wrong type.
...
try:
    dumps(_W())  # params: typed <- wrong-typed
