...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Combobox__config__cnf_as_str_wrong"
# subject = "tkinter.ttk.Combobox.config(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Combobox.config(cnf: str); call it with the wrong type.
