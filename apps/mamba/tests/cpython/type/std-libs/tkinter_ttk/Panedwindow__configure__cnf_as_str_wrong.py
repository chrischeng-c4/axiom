...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Panedwindow__configure__cnf_as_str_wrong"
# subject = "tkinter.ttk.Panedwindow.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Panedwindow.configure(cnf: str); call it with the wrong type.
