...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Separator__configure__cnf_as_str_wrong"
# subject = "tkinter.ttk.Separator.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Separator.configure(cnf: str); call it with the wrong type.
