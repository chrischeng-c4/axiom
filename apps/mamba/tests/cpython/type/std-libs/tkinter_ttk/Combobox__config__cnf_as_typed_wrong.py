...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Combobox__config__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Combobox.config(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Combobox.config(cnf: typed); call it with the wrong type.
