...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Sizegrip__configure__cnf_as_str_wrong"
# subject = "tkinter.ttk.Sizegrip.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Sizegrip.configure(cnf: str); call it with the wrong type.

typeshed contract: cnf is str. mamba is force-typed, so a wrong-typed
argument MUST raise TypeError (CPython may accept or raise — mamba's to enforce)."""

from tkinter.ttk import Sizegrip
obj = object.__new__(Sizegrip)
try:
