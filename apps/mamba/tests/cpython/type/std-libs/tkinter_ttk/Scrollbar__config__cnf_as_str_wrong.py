...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Scrollbar__config__cnf_as_str_wrong"
# subject = "tkinter.ttk.Scrollbar.config(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Scrollbar.config(cnf: str); call it with the wrong type.
