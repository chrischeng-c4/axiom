...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Scrollbar__config__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Scrollbar.config(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Scrollbar.config(cnf: typed); call it with the wrong type.
...
try:
    obj.config(_W())  # cnf: typed <- wrong-typed
