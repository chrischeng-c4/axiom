...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Menubutton__configure__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Menubutton.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Menubutton.configure(cnf: typed); call it with the wrong type.
