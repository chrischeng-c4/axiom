...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Frame__configure__cnf_as_str_wrong"
# subject = "tkinter.ttk.Frame.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Frame.configure(cnf: str); call it with the wrong type.
