...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Treeview__set__item_as_typed_wrong"
# subject = "tkinter.ttk.Treeview.set(item: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Treeview.set(item: typed); call it with the wrong type.
...
try:
    obj.set(_W())  # item: typed <- wrong-typed
