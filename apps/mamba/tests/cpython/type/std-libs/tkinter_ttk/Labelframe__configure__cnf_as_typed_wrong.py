...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Labelframe__configure__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Labelframe.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Labelframe.configure(cnf: typed); call it with the wrong type.
