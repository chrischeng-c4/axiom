...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Notebook__configure__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Notebook.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Notebook.configure(cnf: typed); call it with the wrong type.
