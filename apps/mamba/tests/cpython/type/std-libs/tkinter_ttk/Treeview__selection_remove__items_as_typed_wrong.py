...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Treeview__selection_remove__items_as_typed_wrong"
# subject = "tkinter.ttk.Treeview.selection_remove(items: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Treeview.selection_remove(items: typed); call it with the wrong type.
...
try:
    obj.selection_remove(_W())  # items: typed <- wrong-typed
