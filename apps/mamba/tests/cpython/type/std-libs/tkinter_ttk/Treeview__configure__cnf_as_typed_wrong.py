...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Treeview__configure__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Treeview.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Treeview.configure(cnf: typed); call it with the wrong type.
