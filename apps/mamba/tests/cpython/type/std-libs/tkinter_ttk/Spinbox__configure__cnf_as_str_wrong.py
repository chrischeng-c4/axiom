...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Spinbox__configure__cnf_as_str_wrong"
# subject = "tkinter.ttk.Spinbox.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Spinbox.configure(cnf: str); call it with the wrong type.
