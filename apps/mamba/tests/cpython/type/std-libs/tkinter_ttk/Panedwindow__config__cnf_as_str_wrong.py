...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Panedwindow__config__cnf_as_str_wrong"
# subject = "tkinter.ttk.Panedwindow.config(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Panedwindow.config(cnf: str); call it with the wrong type.
...
try:
    obj.config(12345)  # cnf: str <- wrong-typed
