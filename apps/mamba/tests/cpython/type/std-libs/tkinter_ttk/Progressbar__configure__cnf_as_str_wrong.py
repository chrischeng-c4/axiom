...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Progressbar__configure__cnf_as_str_wrong"
# subject = "tkinter.ttk.Progressbar.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Progressbar.configure(cnf: str); call it with the wrong type.
