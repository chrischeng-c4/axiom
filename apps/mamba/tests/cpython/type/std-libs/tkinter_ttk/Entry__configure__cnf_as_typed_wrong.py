...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Entry__configure__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Entry.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Entry.configure(cnf: typed); call it with the wrong type.
