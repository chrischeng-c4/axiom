...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Sizegrip__configure__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Sizegrip.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Sizegrip.configure(cnf: typed); call it with the wrong type.
