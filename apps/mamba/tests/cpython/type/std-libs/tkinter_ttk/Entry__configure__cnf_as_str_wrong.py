...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Entry__configure__cnf_as_str_wrong"
# subject = "tkinter.ttk.Entry.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Entry.configure(cnf: str); call it with the wrong type.
