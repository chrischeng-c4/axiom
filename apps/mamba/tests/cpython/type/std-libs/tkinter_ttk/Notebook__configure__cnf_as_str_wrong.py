...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Notebook__configure__cnf_as_str_wrong"
# subject = "tkinter.ttk.Notebook.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Notebook.configure(cnf: str); call it with the wrong type.
