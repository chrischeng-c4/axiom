...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Progressbar__configure__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Progressbar.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Progressbar.configure(cnf: typed); call it with the wrong type.
