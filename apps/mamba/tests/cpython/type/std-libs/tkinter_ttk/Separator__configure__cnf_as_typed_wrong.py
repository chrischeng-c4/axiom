...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Separator__configure__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Separator.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Separator.configure(cnf: typed); call it with the wrong type.
