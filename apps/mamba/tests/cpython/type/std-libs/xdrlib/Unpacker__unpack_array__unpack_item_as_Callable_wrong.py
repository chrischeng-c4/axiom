...
# lib = "xdrlib"
# dimension = "type"
# case = "Unpacker__unpack_array__unpack_item_as_Callable_wrong"
# subject = "xdrlib.Unpacker.unpack_array(unpack_item: Callable)"
# kind = "semantic"
...
"""Type wall: xdrlib.Unpacker.unpack_array(unpack_item: Callable); call it with the wrong type.
...
try:
    obj.unpack_array(_W())  # unpack_item: Callable <- wrong-typed
