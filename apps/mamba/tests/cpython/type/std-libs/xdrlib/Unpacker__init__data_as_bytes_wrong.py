...
# lib = "xdrlib"
# dimension = "type"
# case = "Unpacker__init__data_as_bytes_wrong"
# subject = "xdrlib.Unpacker.__init__(data: bytes)"
# kind = "semantic"
...
"""Type wall: xdrlib.Unpacker.__init__(data: bytes); call it with the wrong type.
...
try:
    Unpacker(12345)  # data: bytes <- wrong-typed
