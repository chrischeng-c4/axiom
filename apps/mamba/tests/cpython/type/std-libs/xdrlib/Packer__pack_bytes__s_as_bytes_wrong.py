...
# lib = "xdrlib"
# dimension = "type"
# case = "Packer__pack_bytes__s_as_bytes_wrong"
# subject = "xdrlib.Packer.pack_bytes(s: bytes)"
# kind = "semantic"
...
"""Type wall: xdrlib.Packer.pack_bytes(s: bytes); call it with the wrong type.
...
try:
    obj.pack_bytes(12345)  # s: bytes <- wrong-typed
