...
# lib = "xdrlib"
# dimension = "type"
# case = "Packer__pack_array__list_as_Sequence_wrong"
# subject = "xdrlib.Packer.pack_array(list: Sequence)"
# kind = "semantic"
...
"""Type wall: xdrlib.Packer.pack_array(list: Sequence); call it with the wrong type.
...
try:
    obj.pack_array(_W(), None)  # list: Sequence <- wrong-typed
