...
# lib = "xdrlib"
# dimension = "type"
# case = "Packer__pack_opaque__s_as_bytes_wrong"
# subject = "xdrlib.Packer.pack_opaque(s: bytes)"
# kind = "semantic"
...
"""Type wall: xdrlib.Packer.pack_opaque(s: bytes); call it with the wrong type.
...
try:
    obj.pack_opaque(12345)  # s: bytes <- wrong-typed
