...
# subject = "concurrent.interpreters._queues.Queue.get(block: bool)"
# kind = "semantic"
...
"""Type wall: concurrent.interpreters._queues.Queue.get(block: bool); call it with the wrong type.
