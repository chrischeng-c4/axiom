...
# dimension = "type"
# case = "XMLGenerator__endElementNS__name_as_tuple_wrong"
# subject = "xml.sax.saxutils.XMLGenerator.endElementNS(name: tuple)"
# kind = "semantic"
...
"""Type wall: xml.sax.saxutils.XMLGenerator.endElementNS(name: tuple); call it with the wrong type.
