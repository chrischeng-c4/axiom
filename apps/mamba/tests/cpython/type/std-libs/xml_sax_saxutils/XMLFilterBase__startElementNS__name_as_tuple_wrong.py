...
# dimension = "type"
# case = "XMLFilterBase__startElementNS__name_as_tuple_wrong"
# subject = "xml.sax.saxutils.XMLFilterBase.startElementNS(name: tuple)"
# kind = "semantic"
...
"""Type wall: xml.sax.saxutils.XMLFilterBase.startElementNS(name: tuple); call it with the wrong type.
...
try:
    obj.startElementNS(12345, None, None)  # name: tuple <- wrong-typed
