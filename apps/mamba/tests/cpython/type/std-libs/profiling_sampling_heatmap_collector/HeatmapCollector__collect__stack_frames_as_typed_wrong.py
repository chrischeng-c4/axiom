...
# dimension = "type"
# case = "HeatmapCollector__collect__stack_frames_as_typed_wrong"
# subject = "profiling.sampling.heatmap_collector.HeatmapCollector.collect(stack_frames: typed)"
# kind = "semantic"
...
"""Type wall: profiling.sampling.heatmap_collector.HeatmapCollector.collect(stack_frames: typed); call it with the wrong type.
