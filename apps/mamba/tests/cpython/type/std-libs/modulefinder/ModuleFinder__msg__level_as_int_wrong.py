...
# lib = "modulefinder"
# dimension = "type"
# case = "ModuleFinder__msg__level_as_int_wrong"
# subject = "modulefinder.ModuleFinder.msg(level: int)"
# kind = "semantic"
...
"""Type wall: modulefinder.ModuleFinder.msg(level: int); call it with the wrong type.
...
try:
    obj.msg("not_an_int", "")  # level: int <- wrong-typed
