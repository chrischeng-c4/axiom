...
# dimension = "type"
# case = "Version____le____other_as_typed_wrong"
# subject = "distutils.version.Version.__le__(other: typed)"
# kind = "semantic"
...
"""Type wall: distutils.version.Version.__le__(other: typed); call it with the wrong type.
