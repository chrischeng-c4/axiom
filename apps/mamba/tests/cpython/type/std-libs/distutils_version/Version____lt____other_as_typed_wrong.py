...
# dimension = "type"
# case = "Version____lt____other_as_typed_wrong"
# subject = "distutils.version.Version.__lt__(other: typed)"
# kind = "semantic"
...
"""Type wall: distutils.version.Version.__lt__(other: typed); call it with the wrong type.
