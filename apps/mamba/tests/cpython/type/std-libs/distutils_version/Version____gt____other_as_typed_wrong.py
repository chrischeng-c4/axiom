...
# dimension = "type"
# case = "Version____gt____other_as_typed_wrong"
# subject = "distutils.version.Version.__gt__(other: typed)"
# kind = "semantic"
...
"""Type wall: distutils.version.Version.__gt__(other: typed); call it with the wrong type.
