...
# lib = "tkinter"
# dimension = "type"
# case = "Canvas__create_window__x_as_float_wrong"
# subject = "tkinter.Canvas.create_window(x: float)"
# kind = "semantic"
...
"""Type wall: tkinter.Canvas.create_window(x: float); call it with the wrong type.
...
try:
    obj.create_window("not_a_float", 0.0)  # x: float <- wrong-typed
