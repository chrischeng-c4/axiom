...
# lib = "tkinter"
# dimension = "type"
# case = "Widget__bind__sequence_as_typed_wrong"
# subject = "tkinter.Widget.bind(sequence: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Widget.bind(sequence: typed); call it with the wrong type.
...
try:
    obj.bind(_W())  # sequence: typed <- wrong-typed
