...
# lib = "tkinter"
# dimension = "type"
# case = "Canvas__create_rectangle__x0_as_float_wrong"
# subject = "tkinter.Canvas.create_rectangle(x0: float)"
# kind = "semantic"
...
"""Type wall: tkinter.Canvas.create_rectangle(x0: float); call it with the wrong type.
...
try:
    obj.create_rectangle("not_a_float", 0.0, 0.0, 0.0)  # x0: float <- wrong-typed
