...
# lib = "tkinter"
# dimension = "type"
# case = "Pack__pack_configure__cnf_as_typed_wrong"
# subject = "tkinter.Pack.pack_configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Pack.pack_configure(cnf: typed); call it with the wrong type.
...
obj = object.__new__(Pack)
try:
    obj.pack_configure(_W())  # cnf: typed <- wrong-typed
