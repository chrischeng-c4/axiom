...
# lib = "tkinter"
# dimension = "type"
# case = "Button__configure__cnf_as_str_wrong"
# subject = "tkinter.Button.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.Button.configure(cnf: str); call it with the wrong type.
