...
# lib = "tkinter"
# dimension = "type"
# case = "Canvas__coords__tagOrId_as_typed_wrong"
# subject = "tkinter.Canvas.coords(tagOrId: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Canvas.coords(tagOrId: typed); call it with the wrong type.
...
try:
    obj.coords(_W())  # tagOrId: typed <- wrong-typed
