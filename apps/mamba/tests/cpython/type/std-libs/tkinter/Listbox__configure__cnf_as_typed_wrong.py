...
# lib = "tkinter"
# dimension = "type"
# case = "Listbox__configure__cnf_as_typed_wrong"
# subject = "tkinter.Listbox.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Listbox.configure(cnf: typed); call it with the wrong type.
