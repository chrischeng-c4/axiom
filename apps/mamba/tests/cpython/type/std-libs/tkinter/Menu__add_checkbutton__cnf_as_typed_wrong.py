...
# lib = "tkinter"
# dimension = "type"
# case = "Menu__add_checkbutton__cnf_as_typed_wrong"
# subject = "tkinter.Menu.add_checkbutton(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Menu.add_checkbutton(cnf: typed); call it with the wrong type.
...
try:
    obj.add_checkbutton(_W())  # cnf: typed <- wrong-typed
