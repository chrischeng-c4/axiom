...
# lib = "tkinter"
# dimension = "type"
# case = "Variable__trace_remove__mode_as_Literal_wrong"
# subject = "tkinter.Variable.trace_remove(mode: Literal)"
# kind = "semantic"
...
"""Type wall: tkinter.Variable.trace_remove(mode: Literal); call it with the wrong type.
...
try:
    obj.trace_remove(_W(), "")  # mode: Literal <- wrong-typed
