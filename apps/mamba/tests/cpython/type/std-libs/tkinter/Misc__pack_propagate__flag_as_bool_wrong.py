...
# lib = "tkinter"
# dimension = "type"
# case = "Misc__pack_propagate__flag_as_bool_wrong"
# subject = "tkinter.Misc.pack_propagate(flag: bool)"
# kind = "semantic"
...
"""Type wall: tkinter.Misc.pack_propagate(flag: bool); call it with the wrong type.
...
try:
    obj.pack_propagate("not_a_bool")  # flag: bool <- wrong-typed
