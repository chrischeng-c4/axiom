...
# lib = "tkinter"
# dimension = "type"
# case = "Canvas__configure__cnf_as_str_wrong"
# subject = "tkinter.Canvas.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.Canvas.configure(cnf: str); call it with the wrong type.
