...
# lib = "tkinter"
# dimension = "type"
# case = "Canvas__create_oval__coords_as_typed_wrong"
# subject = "tkinter.Canvas.create_oval(coords: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Canvas.create_oval(coords: typed); call it with the wrong type.
...
try:
    obj.create_oval(_W())  # coords: typed <- wrong-typed
