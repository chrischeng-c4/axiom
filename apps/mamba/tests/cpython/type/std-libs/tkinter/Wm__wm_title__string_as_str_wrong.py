...
# lib = "tkinter"
# dimension = "type"
# case = "Wm__wm_title__string_as_str_wrong"
# subject = "tkinter.Wm.wm_title(string: str)"
# kind = "semantic"
...
"""Type wall: tkinter.Wm.wm_title(string: str); call it with the wrong type.
...
try:
    obj.wm_title(12345)  # string: str <- wrong-typed
