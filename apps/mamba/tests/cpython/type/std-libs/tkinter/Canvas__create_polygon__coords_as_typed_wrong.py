...
# lib = "tkinter"
# dimension = "type"
# case = "Canvas__create_polygon__coords_as_typed_wrong"
# subject = "tkinter.Canvas.create_polygon(coords: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Canvas.create_polygon(coords: typed); call it with the wrong type.
...
try:
    obj.create_polygon(_W())  # coords: typed <- wrong-typed
