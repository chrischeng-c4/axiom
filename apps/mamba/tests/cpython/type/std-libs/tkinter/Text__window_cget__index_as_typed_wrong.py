...
# lib = "tkinter"
# dimension = "type"
# case = "Text__window_cget__index_as_typed_wrong"
# subject = "tkinter.Text.window_cget(index: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Text.window_cget(index: typed); call it with the wrong type.
...
try:
    obj.window_cget(_W(), None)  # index: typed <- wrong-typed
