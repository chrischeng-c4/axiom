...
# lib = "tkinter"
# dimension = "type"
# case = "Canvas__create_text__x_as_float_wrong"
# subject = "tkinter.Canvas.create_text(x: float)"
# kind = "semantic"
...
"""Type wall: tkinter.Canvas.create_text(x: float); call it with the wrong type.
...
try:
    obj.create_text("not_a_float", 0.0)  # x: float <- wrong-typed
