...
# lib = "tkinter"
# dimension = "type"
# case = "Button__configure__cnf_as_typed_wrong"
# subject = "tkinter.Button.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Button.configure(cnf: typed); call it with the wrong type.
