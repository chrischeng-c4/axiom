...
# lib = "tkinter"
# dimension = "type"
# case = "Canvas__create_rectangle__coords_as_typed_wrong"
# subject = "tkinter.Canvas.create_rectangle(coords: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Canvas.create_rectangle(coords: typed); call it with the wrong type.
...
try:
    obj.create_rectangle(_W())  # coords: typed <- wrong-typed
