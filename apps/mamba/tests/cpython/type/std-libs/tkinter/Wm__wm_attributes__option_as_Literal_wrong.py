...
# lib = "tkinter"
# dimension = "type"
# case = "Wm__wm_attributes__option_as_Literal_wrong"
# subject = "tkinter.Wm.wm_attributes(option: Literal)"
# kind = "semantic"
...
"""Type wall: tkinter.Wm.wm_attributes(option: Literal); call it with the wrong type.
...
try:
    obj.wm_attributes(_W())  # option: Literal <- wrong-typed
