...
# lib = "tkinter"
# dimension = "type"
# case = "Menu__configure__cnf_as_typed_wrong"
# subject = "tkinter.Menu.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Menu.configure(cnf: typed); call it with the wrong type.
