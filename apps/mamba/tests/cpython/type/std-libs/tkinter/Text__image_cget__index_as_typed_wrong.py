...
# lib = "tkinter"
# dimension = "type"
# case = "Text__image_cget__index_as_typed_wrong"
# subject = "tkinter.Text.image_cget(index: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Text.image_cget(index: typed); call it with the wrong type.
...
try:
    obj.image_cget(_W(), None)  # index: typed <- wrong-typed
