...
# lib = "tkinter"
# dimension = "type"
# case = "Menu__add_command__cnf_as_typed_wrong"
# subject = "tkinter.Menu.add_command(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Menu.add_command(cnf: typed); call it with the wrong type.
...
try:
    obj.add_command(_W())  # cnf: typed <- wrong-typed
