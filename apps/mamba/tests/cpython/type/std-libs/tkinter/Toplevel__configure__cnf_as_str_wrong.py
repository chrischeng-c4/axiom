...
# lib = "tkinter"
# dimension = "type"
# case = "Toplevel__configure__cnf_as_str_wrong"
# subject = "tkinter.Toplevel.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.Toplevel.configure(cnf: str); call it with the wrong type.
