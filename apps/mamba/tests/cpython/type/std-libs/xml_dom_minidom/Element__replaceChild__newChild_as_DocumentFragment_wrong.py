...
# lib = "xml_dom_minidom"
# dimension = "type"
# case = "Element__replaceChild__newChild_as_DocumentFragment_wrong"
# subject = "xml.dom.minidom.Element.replaceChild(newChild: DocumentFragment)"
# kind = "semantic"
...
"""Type wall: xml.dom.minidom.Element.replaceChild(newChild: DocumentFragment); call it with the wrong type.
