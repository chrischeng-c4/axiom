...
# lib = "sre_parse"
# dimension = "type"
# case = "parse_template__source_as_str_wrong"
# subject = "sre_parse.parse_template(source: str)"
# kind = "semantic"
...
"""Type wall: sre_parse.parse_template(source: str); call it with the wrong type.
...
try:
    parse_template(12345, None)  # source: str <- wrong-typed
