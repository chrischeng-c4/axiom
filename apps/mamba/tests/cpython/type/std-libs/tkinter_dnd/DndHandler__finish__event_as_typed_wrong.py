...
# lib = "tkinter_dnd"
# dimension = "type"
# case = "DndHandler__finish__event_as_typed_wrong"
# subject = "tkinter.dnd.DndHandler.finish(event: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.dnd.DndHandler.finish(event: typed); call it with the wrong type.
...
try:
    obj.finish(_W())  # event: typed <- wrong-typed
