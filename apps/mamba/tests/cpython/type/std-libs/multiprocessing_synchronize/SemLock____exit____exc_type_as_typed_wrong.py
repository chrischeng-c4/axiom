...
# dimension = "type"
# case = "SemLock____exit____exc_type_as_typed_wrong"
# subject = "multiprocessing.synchronize.SemLock.__exit__(exc_type: typed)"
# kind = "semantic"
...
"""Type wall: multiprocessing.synchronize.SemLock.__exit__(exc_type: typed); call it with the wrong type.
