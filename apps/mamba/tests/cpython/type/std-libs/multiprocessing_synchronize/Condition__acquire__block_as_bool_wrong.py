...
# dimension = "type"
# case = "Condition__acquire__block_as_bool_wrong"
# subject = "multiprocessing.synchronize.Condition.acquire(block: bool)"
# kind = "semantic"
...
"""Type wall: multiprocessing.synchronize.Condition.acquire(block: bool); call it with the wrong type.
