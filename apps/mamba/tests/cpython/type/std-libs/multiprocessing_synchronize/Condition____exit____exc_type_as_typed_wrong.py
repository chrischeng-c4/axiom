...
# subject = "multiprocessing.synchronize.Condition.__exit__(exc_type: typed)"
# kind = "semantic"
...
"""Type wall: multiprocessing.synchronize.Condition.__exit__(exc_type: typed); call it with the wrong type.
