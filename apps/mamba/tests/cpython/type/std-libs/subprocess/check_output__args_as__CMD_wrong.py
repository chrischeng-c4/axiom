...
# lib = "subprocess"
# dimension = "type"
# case = "check_output__args_as__CMD_wrong"
# subject = "subprocess.check_output(args: _CMD)"
# kind = "semantic"
...
"""Type wall: subprocess.check_output(args: _CMD); call it with the wrong type.
...
try:
    check_output(_W())  # args: _CMD <- wrong-typed
