...
# lib = "subprocess"
# dimension = "type"
# case = "run__args_as__CMD_wrong"
# subject = "subprocess.run(args: _CMD)"
# kind = "semantic"
...
"""Type wall: subprocess.run(args: _CMD); call it with the wrong type.
