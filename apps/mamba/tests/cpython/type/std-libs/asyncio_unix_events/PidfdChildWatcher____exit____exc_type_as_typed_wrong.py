...
# dimension = "type"
# case = "PidfdChildWatcher____exit____exc_type_as_typed_wrong"
# subject = "asyncio.unix_events.PidfdChildWatcher.__exit__(exc_type: typed)"
# kind = "semantic"
...
"""Type wall: asyncio.unix_events.PidfdChildWatcher.__exit__(exc_type: typed); call it with the wrong type.
