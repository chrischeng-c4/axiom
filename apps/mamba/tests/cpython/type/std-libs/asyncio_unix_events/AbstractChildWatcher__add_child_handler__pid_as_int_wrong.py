...
# dimension = "type"
# case = "AbstractChildWatcher__add_child_handler__pid_as_int_wrong"
# subject = "asyncio.unix_events.AbstractChildWatcher.add_child_handler(pid: int)"
# kind = "semantic"
...
"""Type wall: asyncio.unix_events.AbstractChildWatcher.add_child_handler(pid: int); call it with the wrong type.
