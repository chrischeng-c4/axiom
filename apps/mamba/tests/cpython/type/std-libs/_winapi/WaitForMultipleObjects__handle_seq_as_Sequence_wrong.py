...
# lib = "_winapi"
# dimension = "type"
# case = "WaitForMultipleObjects__handle_seq_as_Sequence_wrong"
# subject = "_winapi.WaitForMultipleObjects(handle_seq: Sequence)"
# kind = "semantic"
...
"""Type wall: _winapi.WaitForMultipleObjects(handle_seq: Sequence); call it with the wrong type.
...
from _winapi import WaitForMultipleObjects
try:
    WaitForMultipleObjects(_W(), True)  # handle_seq: Sequence <- wrong-typed
