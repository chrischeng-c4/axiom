...
# lib = "xmlrpc_server"
# dimension = "type"
# case = "CGIXMLRPCRequestHandler__init__allow_none_as_bool_wrong"
# subject = "xmlrpc.server.CGIXMLRPCRequestHandler.__init__(allow_none: bool)"
# kind = "semantic"
...
"""Type wall: xmlrpc.server.CGIXMLRPCRequestHandler.__init__(allow_none: bool); call it with the wrong type.
...
try:
    CGIXMLRPCRequestHandler("not_a_bool")  # allow_none: bool <- wrong-typed
