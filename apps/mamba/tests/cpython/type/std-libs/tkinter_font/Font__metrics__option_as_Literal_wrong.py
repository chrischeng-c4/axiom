...
# lib = "tkinter_font"
# dimension = "type"
# case = "Font__metrics__option_as_Literal_wrong"
# subject = "tkinter.font.Font.metrics(option: Literal)"
# kind = "semantic"
...
"""Type wall: tkinter.font.Font.metrics(option: Literal); call it with the wrong type.
...
try:
    obj.metrics(_W())  # option: Literal <- wrong-typed
