...
# lib = "tempfile"
# dimension = "type"
# case = "NamedTemporaryFile__mode_as_OpenTextMode_wrong"
# subject = "tempfile.NamedTemporaryFile(mode: OpenTextMode)"
# kind = "semantic"
...
"""Type wall: tempfile.NamedTemporaryFile(mode: OpenTextMode); call it with the wrong type.
...
try:
    NamedTemporaryFile(_W())  # mode: OpenTextMode <- wrong-typed
