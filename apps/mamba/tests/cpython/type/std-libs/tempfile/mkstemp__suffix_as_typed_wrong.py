...
# lib = "tempfile"
# dimension = "type"
# case = "mkstemp__suffix_as_typed_wrong"
# subject = "tempfile.mkstemp(suffix: typed)"
# kind = "semantic"
...
"""Type wall: tempfile.mkstemp(suffix: typed); call it with the wrong type.
...
try:
    mkstemp(_W())  # suffix: typed <- wrong-typed
