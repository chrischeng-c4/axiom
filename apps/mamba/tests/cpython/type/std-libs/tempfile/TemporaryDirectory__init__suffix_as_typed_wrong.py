...
# lib = "tempfile"
# dimension = "type"
# case = "TemporaryDirectory__init__suffix_as_typed_wrong"
# subject = "tempfile.TemporaryDirectory.__init__(suffix: typed)"
# kind = "semantic"
...
"""Type wall: tempfile.TemporaryDirectory.__init__(suffix: typed); call it with the wrong type.
...
try:
    TemporaryDirectory(_W())  # suffix: typed <- wrong-typed
