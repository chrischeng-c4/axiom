...
# lib = "tempfile"
# dimension = "type"
# case = "TemporaryFile__mode_as_OpenBinaryModeReading_wrong"
# subject = "tempfile.TemporaryFile(mode: OpenBinaryModeReading)"
# kind = "semantic"
...
"""Type wall: tempfile.TemporaryFile(mode: OpenBinaryModeReading); call it with the wrong type.
...
try:
    TemporaryFile(_W())  # mode: OpenBinaryModeReading <- wrong-typed
