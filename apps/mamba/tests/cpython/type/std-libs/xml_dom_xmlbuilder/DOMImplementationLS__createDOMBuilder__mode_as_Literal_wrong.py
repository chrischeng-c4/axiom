...
# dimension = "type"
# case = "DOMImplementationLS__createDOMBuilder__mode_as_Literal_wrong"
# subject = "xml.dom.xmlbuilder.DOMImplementationLS.createDOMBuilder(mode: Literal)"
# kind = "semantic"
...
"""Type wall: xml.dom.xmlbuilder.DOMImplementationLS.createDOMBuilder(mode: Literal); call it with the wrong type.
...
obj = object.__new__(DOMImplementationLS)
try:
    obj.createDOMBuilder(_W(), None)  # mode: Literal <- wrong-typed
