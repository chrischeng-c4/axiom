...
# dimension = "type"
# case = "ProactorEventLoop__create_pipe_connection__protocol_factory_as_Callable_wrong"
# subject = "asyncio.windows_events.ProactorEventLoop.create_pipe_connection(protocol_factory: Callable)"
# kind = "semantic"
...
"""Type wall: asyncio.windows_events.ProactorEventLoop.create_pipe_connection(protocol_factory: Callable); call it with the wrong type.
...
try:
    obj.create_pipe_connection(_W(), "")  # protocol_factory: Callable <- wrong-typed
