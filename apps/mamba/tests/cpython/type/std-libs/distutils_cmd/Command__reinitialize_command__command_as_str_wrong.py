...
# lib = "distutils_cmd"
# dimension = "type"
# case = "Command__reinitialize_command__command_as_str_wrong"
# subject = "distutils.cmd.Command.reinitialize_command(command: str)"
# kind = "semantic"
...
"""Type wall: distutils.cmd.Command.reinitialize_command(command: str); call it with the wrong type.
