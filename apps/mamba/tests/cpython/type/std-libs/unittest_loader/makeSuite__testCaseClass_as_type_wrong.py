...
# lib = "unittest_loader"
# dimension = "type"
# case = "makeSuite__testCaseClass_as_type_wrong"
# subject = "unittest.loader.makeSuite(testCaseClass: type)"
# kind = "semantic"
...
"""Type wall: unittest.loader.makeSuite(testCaseClass: type); call it with the wrong type.
...
try:
    makeSuite(_W())  # testCaseClass: type <- wrong-typed
