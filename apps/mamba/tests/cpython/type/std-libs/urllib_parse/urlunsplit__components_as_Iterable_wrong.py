...
# lib = "urllib_parse"
# dimension = "type"
# case = "urlunsplit__components_as_Iterable_wrong"
# subject = "urllib.parse.urlunsplit(components: Iterable)"
# kind = "semantic"
...
"""Type wall: urllib.parse.urlunsplit(components: Iterable); call it with the wrong type.
...
try:
    urlunsplit(_W())  # components: Iterable <- wrong-typed
