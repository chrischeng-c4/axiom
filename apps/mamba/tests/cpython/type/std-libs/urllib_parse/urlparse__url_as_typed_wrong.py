...
# lib = "urllib_parse"
# dimension = "type"
# case = "urlparse__url_as_typed_wrong"
# subject = "urllib.parse.urlparse(url: typed)"
# kind = "semantic"
...
"""Type wall: urllib.parse.urlparse(url: typed); call it with the wrong type.
...
try:
    urlparse(_W())  # url: typed <- wrong-typed
