...
# lib = "urllib_parse"
# dimension = "type"
# case = "urlparse__url_as_str_wrong"
# subject = "urllib.parse.urlparse(url: str)"
# kind = "semantic"
...
"""Type wall: urllib.parse.urlparse(url: str); call it with the wrong type.
...
try:
    urlparse(12345)  # url: str <- wrong-typed
