...
# lib = "urllib_parse"
# dimension = "type"
# case = "quote_plus__string_as_str_wrong"
# subject = "urllib.parse.quote_plus(string: str)"
# kind = "semantic"
...
"""Type wall: urllib.parse.quote_plus(string: str); call it with the wrong type.
...
try:
    quote_plus(12345)  # string: str <- wrong-typed
