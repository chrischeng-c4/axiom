...
# lib = "xml_sax_handler"
# dimension = "type"
# case = "ContentHandler__startElementNS__name_as_tuple_wrong"
# subject = "xml.sax.handler.ContentHandler.startElementNS(name: tuple)"
# kind = "semantic"
...
"""Type wall: xml.sax.handler.ContentHandler.startElementNS(name: tuple); call it with the wrong type.
