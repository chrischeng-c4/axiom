...
# lib = "re"
# dimension = "type"
# case = "template__pattern_as_typed_wrong"
# subject = "re.template(pattern: typed)"
# kind = "semantic"
...
"""Type wall: re.template(pattern: typed); call it with the wrong type.
...
try:
    template(_W())  # pattern: typed <- wrong-typed
