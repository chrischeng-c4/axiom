...
# lib = "re"
# dimension = "type"
# case = "Pattern__fullmatch__string_as_ReadableBuffer_wrong"
# subject = "re.Pattern.fullmatch(string: ReadableBuffer)"
# kind = "semantic"
...
"""Type wall: re.Pattern.fullmatch(string: ReadableBuffer); call it with the wrong type.
...
try:
    obj.fullmatch(_W())  # string: ReadableBuffer <- wrong-typed
