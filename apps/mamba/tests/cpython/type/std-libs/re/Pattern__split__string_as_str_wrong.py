...
# lib = "re"
# dimension = "type"
# case = "Pattern__split__string_as_str_wrong"
# subject = "re.Pattern.split(string: str)"
# kind = "semantic"
...
"""Type wall: re.Pattern.split(string: str); call it with the wrong type.
...
try:
    obj.split(12345)  # string: str <- wrong-typed
