...
# lib = "re"
# dimension = "type"
# case = "Pattern__match__string_as_str_wrong"
# subject = "re.Pattern.match(string: str)"
# kind = "semantic"
...
"""Type wall: re.Pattern.match(string: str); call it with the wrong type.
...
try:
    obj.match(12345)  # string: str <- wrong-typed
