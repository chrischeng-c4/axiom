...
# lib = "re"
# dimension = "type"
# case = "Pattern__findall__string_as_ReadableBuffer_wrong"
# subject = "re.Pattern.findall(string: ReadableBuffer)"
# kind = "semantic"
...
"""Type wall: re.Pattern.findall(string: ReadableBuffer); call it with the wrong type.
...
try:
    obj.findall(_W())  # string: ReadableBuffer <- wrong-typed
