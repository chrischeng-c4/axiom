...
# lib = "re"
# dimension = "type"
# case = "finditer__pattern_as_typed_wrong"
# subject = "re.finditer(pattern: typed)"
# kind = "semantic"
...
"""Type wall: re.finditer(pattern: typed); call it with the wrong type.
...
try:
    finditer(_W(), "")  # pattern: typed <- wrong-typed
