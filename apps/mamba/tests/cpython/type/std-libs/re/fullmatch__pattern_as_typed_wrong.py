...
# lib = "re"
# dimension = "type"
# case = "fullmatch__pattern_as_typed_wrong"
# subject = "re.fullmatch(pattern: typed)"
# kind = "semantic"
...
"""Type wall: re.fullmatch(pattern: typed); call it with the wrong type.
...
try:
    fullmatch(_W(), "")  # pattern: typed <- wrong-typed
