...
# lib = "re"
# dimension = "type"
# case = "subn__pattern_as_typed_wrong"
# subject = "re.subn(pattern: typed)"
# kind = "semantic"
...
"""Type wall: re.subn(pattern: typed); call it with the wrong type.
...
from re import subn
try:
    subn(_W(), None, "")  # pattern: typed <- wrong-typed
