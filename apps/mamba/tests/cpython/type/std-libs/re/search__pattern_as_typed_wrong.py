...
# lib = "re"
# dimension = "type"
# case = "search__pattern_as_typed_wrong"
# subject = "re.search(pattern: typed)"
# kind = "semantic"
...
"""Type wall: re.search(pattern: typed); call it with the wrong type.
...
try:
    search(_W(), "")  # pattern: typed <- wrong-typed
