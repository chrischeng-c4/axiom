...
# lib = "re"
# dimension = "type"
# case = "Match__expand__template_as_str_wrong"
# subject = "re.Match.expand(template: str)"
# kind = "semantic"
...
"""Type wall: re.Match.expand(template: str); call it with the wrong type.
...
try:
    obj.expand(12345)  # template: str <- wrong-typed
