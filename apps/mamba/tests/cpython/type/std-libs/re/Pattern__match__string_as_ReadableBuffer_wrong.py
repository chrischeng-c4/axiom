...
# lib = "re"
# dimension = "type"
# case = "Pattern__match__string_as_ReadableBuffer_wrong"
# subject = "re.Pattern.match(string: ReadableBuffer)"
# kind = "semantic"
...
"""Type wall: re.Pattern.match(string: ReadableBuffer); call it with the wrong type.
...
try:
    obj.match(_W())  # string: ReadableBuffer <- wrong-typed
