...
# lib = "re"
# dimension = "type"
# case = "Pattern__search__string_as_ReadableBuffer_wrong"
# subject = "re.Pattern.search(string: ReadableBuffer)"
# kind = "semantic"
...
"""Type wall: re.Pattern.search(string: ReadableBuffer); call it with the wrong type.
...
try:
    obj.search(_W())  # string: ReadableBuffer <- wrong-typed
