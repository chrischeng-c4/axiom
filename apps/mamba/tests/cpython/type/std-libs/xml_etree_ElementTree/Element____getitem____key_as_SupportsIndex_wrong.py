...
# dimension = "type"
# case = "Element____getitem____key_as_SupportsIndex_wrong"
# subject = "xml.etree.ElementTree.Element.__getitem__(key: SupportsIndex)"
# kind = "semantic"
...
"""Type wall: xml.etree.ElementTree.Element.__getitem__(key: SupportsIndex); call it with the wrong type.
