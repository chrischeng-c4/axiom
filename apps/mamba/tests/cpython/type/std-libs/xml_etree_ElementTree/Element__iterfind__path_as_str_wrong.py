...
# dimension = "type"
# case = "Element__iterfind__path_as_str_wrong"
# subject = "xml.etree.ElementTree.Element.iterfind(path: str)"
# kind = "semantic"
...
"""Type wall: xml.etree.ElementTree.Element.iterfind(path: str); call it with the wrong type.
