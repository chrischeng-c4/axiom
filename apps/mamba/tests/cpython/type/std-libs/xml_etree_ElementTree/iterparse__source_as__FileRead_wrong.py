...
# dimension = "type"
# case = "iterparse__source_as__FileRead_wrong"
# subject = "xml.etree.ElementTree.iterparse(source: _FileRead)"
# kind = "semantic"
...
"""Type wall: xml.etree.ElementTree.iterparse(source: _FileRead); call it with the wrong type.
...
try:
    iterparse(_W(), None)  # source: _FileRead <- wrong-typed
