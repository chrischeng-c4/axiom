...
# dimension = "type"
# case = "tostring__element_as_Element_wrong"
# subject = "xml.etree.ElementTree.tostring(element: Element)"
# kind = "semantic"
...
"""Type wall: xml.etree.ElementTree.tostring(element: Element); call it with the wrong type.
...
try:
    tostring(_W())  # element: Element <- wrong-typed
