...
# lib = "ast"
# dimension = "type"
# case = "TemplateStr__init__values_as_list_wrong"
# subject = "ast.TemplateStr.__init__(values: list)"
# kind = "semantic"
...
"""Type wall: ast.TemplateStr.__init__(values: list); call it with the wrong type.
...
try:
    TemplateStr(12345)  # values: list <- wrong-typed
