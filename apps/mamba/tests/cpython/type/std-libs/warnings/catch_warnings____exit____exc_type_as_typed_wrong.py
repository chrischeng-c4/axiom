...
# lib = "warnings"
# dimension = "type"
# case = "catch_warnings____exit____exc_type_as_typed_wrong"
# subject = "warnings.catch_warnings.__exit__(exc_type: typed)"
# kind = "semantic"
...
"""Type wall: warnings.catch_warnings.__exit__(exc_type: typed); call it with the wrong type.
...
obj = object.__new__(catch_warnings)
try:
