...
# dimension = "type"
# case = "replace__match_as_Match_wrong"
# subject = "zipfile._path.glob.replace(match: Match)"
# kind = "semantic"
...
"""Type wall: zipfile._path.glob.replace(match: Match); call it with the wrong type.
...
from zipfile._path.glob import replace
try:
    replace(_W())  # match: Match <- wrong-typed
