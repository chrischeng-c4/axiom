...
# dimension = "perf"
# case = "hexiom"
# subject = "pyperformance hexiom"
# kind = "bench"
# xfail = "mamba must run the pyperformance hexiom workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_hexiom/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance hexiom workload faster than CPython on CPU+RSS
