...
# dimension = "perf"
# case = "barnes_hut"
# subject = "pyperformance barnes_hut"
# kind = "bench"
# xfail = "mamba must run the pyperformance barnes_hut workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_barnes_hut/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance barnes_hut workload faster than CPython on CPU+RSS
