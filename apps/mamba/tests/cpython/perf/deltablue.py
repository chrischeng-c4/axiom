...
# dimension = "perf"
# case = "deltablue"
# subject = "pyperformance deltablue"
# kind = "bench"
# xfail = "mamba must run the pyperformance deltablue workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_deltablue/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance deltablue workload faster than CPython on CPU+RSS
