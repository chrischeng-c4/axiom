...
# dimension = "perf"
# case = "coroutines"
# subject = "pyperformance coroutines"
# kind = "bench"
# xfail = "mamba must run the pyperformance coroutines workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_coroutines/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance coroutines workload faster than CPython on CPU+RSS
