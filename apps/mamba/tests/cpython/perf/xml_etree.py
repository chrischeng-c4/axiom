...
# dimension = "perf"
# case = "xml_etree"
# subject = "pyperformance xml_etree"
# kind = "bench"
# xfail = "mamba must run the pyperformance xml_etree workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_xml_etree/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance xml_etree workload faster than CPython on CPU+RSS
