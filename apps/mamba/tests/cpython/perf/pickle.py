...
# dimension = "perf"
# case = "pickle"
# subject = "pyperformance pickle"
# kind = "bench"
# xfail = "mamba must run the pyperformance pickle workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_pickle/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance pickle workload faster than CPython on CPU+RSS
