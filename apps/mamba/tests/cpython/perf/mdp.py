...
# dimension = "perf"
# case = "mdp"
# subject = "pyperformance mdp"
# kind = "bench"
# xfail = "mamba must run the pyperformance mdp workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_mdp/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance mdp workload faster than CPython on CPU+RSS
