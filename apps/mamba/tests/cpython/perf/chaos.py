...
# dimension = "perf"
# case = "chaos"
# subject = "pyperformance chaos"
# kind = "bench"
# xfail = "mamba must run the pyperformance chaos workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_chaos/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance chaos workload faster than CPython on CPU+RSS
