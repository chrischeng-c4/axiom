...
# dimension = "perf"
# case = "meteor_contest"
# subject = "pyperformance meteor_contest"
# kind = "bench"
# xfail = "mamba must run the pyperformance meteor_contest workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_meteor_contest/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance meteor_contest workload faster than CPython on CPU+RSS
