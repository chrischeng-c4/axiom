...
# dimension = "perf"
# case = "go"
# subject = "pyperformance go"
# kind = "bench"
# xfail = "mamba must run the pyperformance go workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_go/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance go workload faster than CPython on CPU+RSS
