...
# lib = "peepholer"
# dimension = "behavior"
# case = "test_tranforms__test_trailing_nops"
# subject = "cpython.test_peepholer.TestTranforms.test_trailing_nops"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_peepholer.py::TestTranforms::test_trailing_nops
"""Auto-ported test: TestTranforms::test_trailing_nops (CPython 3.12 oracle)."""
...
def f(x):
    ...
    return 6
check_lnotab(f)
print("TestTranforms::test_trailing_nops: ok")
