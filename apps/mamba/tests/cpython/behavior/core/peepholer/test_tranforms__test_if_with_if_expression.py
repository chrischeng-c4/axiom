...
# lib = "peepholer"
# dimension = "behavior"
# case = "test_tranforms__test_if_with_if_expression"
# subject = "cpython.test_peepholer.TestTranforms.test_if_with_if_expression"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_peepholer.py::TestTranforms::test_if_with_if_expression
"""Auto-ported test: TestTranforms::test_if_with_if_expression (CPython 3.12 oracle)."""
...
assert f(True)
check_lnotab(f)
print("TestTranforms::test_if_with_if_expression: ok")
