...
# lib = "exceptions"
# dimension = "behavior"
# case = "exception_tests__test_notes"
# subject = "cpython.test_exceptions.ExceptionTests.test_notes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::ExceptionTests::test_notes
"""Auto-ported test: ExceptionTests::test_notes (CPython 3.12 oracle)."""
...
for e in [BaseException(1), Exception(2), ValueError(3)]:
    ...
    assert e.__notes__ == ['My Note', 'Your Note']
    del e.__notes__

    assert not hasattr(e, '__notes__')
    e.add_note('Our Note')

    assert e.__notes__ == ['Our Note']
    e.__notes__ = 42

    assert e.__notes__ == 42
    try:
    ...
    assert e.__notes__ == 42
print("ExceptionTests::test_notes: ok")
