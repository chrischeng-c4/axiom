...
# lib = "exceptions"
# dimension = "behavior"
# case = "exception_tests__test_infinite_recursion"
# subject = "cpython.test_exceptions.ExceptionTests.testInfiniteRecursion"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::ExceptionTests::testInfiniteRecursion
"""Auto-ported test: ExceptionTests::testInfiniteRecursion (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("ExceptionTests::testInfiniteRecursion: ok")
