...
# lib = "exceptions"
# dimension = "behavior"
# case = "import_error_tests__test_copy_pickle"
# subject = "cpython.test_exceptions.ImportErrorTests.test_copy_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::ImportErrorTests::test_copy_pickle
"""Auto-ported test: ImportErrorTests::test_copy_pickle (CPython 3.12 oracle)."""
...
for kwargs in (dict(), dict(name='somename'), dict(path='somepath'), dict(name='somename', path='somepath')):
    ...
    for proto in range(pickle.HIGHEST_PROTOCOL + 1):
        ...
        assert exc.name == orig.name

        assert exc.path == orig.path
    for c in (copy.copy, copy.deepcopy):
        ...
        assert exc.path == orig.path
print("ImportErrorTests::test_copy_pickle: ok")
