...
# lib = "exceptions"
# dimension = "behavior"
# case = "import_error_tests__test_attributes"
# subject = "cpython.test_exceptions.ImportErrorTests.test_attributes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::ImportErrorTests::test_attributes
"""Auto-ported test: ImportErrorTests::test_attributes (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(msg, str(_aR_e))
print("ImportErrorTests::test_attributes: ok")
