...
# lib = "exceptions"
# dimension = "behavior"
# case = "exception_tests__test_exception_cleanup_state"
# subject = "cpython.test_exceptions.ExceptionTests.testExceptionCleanupState"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::ExceptionTests::testExceptionCleanupState
"""Auto-ported test: ExceptionTests::testExceptionCleanupState (CPython 3.12 oracle)."""
...
assert obj is None
print("ExceptionTests::testExceptionCleanupState: ok")
