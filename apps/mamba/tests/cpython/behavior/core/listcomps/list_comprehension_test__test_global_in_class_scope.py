...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_global_in_class_scope"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_global_in_class_scope"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_global_in_class_scope
"""Auto-ported test: ListComprehensionTest::test_global_in_class_scope (CPython 3.12 oracle)."""
...
_check_in_scopes(code, outputs, ns={'y': 1}, scopes=['class'])
print("ListComprehensionTest::test_global_in_class_scope: ok")
