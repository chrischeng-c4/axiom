...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_multiple_comprehension_name_reuse"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_multiple_comprehension_name_reuse"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_multiple_comprehension_name_reuse
"""Auto-ported test: ListComprehensionTest::test_multiple_comprehension_name_reuse (CPython 3.12 oracle)."""
...
def _replacing_exec(code_string, ns):
    ...
    exec(co, ns)
code = '\n            [x for x in [1]]\n            y = [x for _ in [1]]\n        '
_check_in_scopes(code, {'y': [3]}, ns={'x': 3})
code = '\n            x = 2\n            [x for x in [1]]\n            y = [x for _ in [1]]\n        '
_check_in_scopes(code, {'x': 2, 'y': [3]}, ns={'x': 3}, scopes=['class'])
_check_in_scopes(code, {'x': 2, 'y': [2]}, ns={'x': 3}, scopes=['function', 'module'])
print("ListComprehensionTest::test_multiple_comprehension_name_reuse: ok")
