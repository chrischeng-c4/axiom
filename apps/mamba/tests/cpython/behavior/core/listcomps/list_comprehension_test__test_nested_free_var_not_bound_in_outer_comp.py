...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_nested_free_var_not_bound_in_outer_comp"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_nested_free_var_not_bound_in_outer_comp"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_nested_free_var_not_bound_in_outer_comp
"""Auto-ported test: ListComprehensionTest::test_nested_free_var_not_bound_in_outer_comp (CPython 3.12 oracle)."""
...
_check_in_scopes(code, {'items': [1]}, scopes=['module', 'function'])
_check_in_scopes(code, {'items': []}, ns={'z': 0}, scopes=['class'])
print("ListComprehensionTest::test_nested_free_var_not_bound_in_outer_comp: ok")
