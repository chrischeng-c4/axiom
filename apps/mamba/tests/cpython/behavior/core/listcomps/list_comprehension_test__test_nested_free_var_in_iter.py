...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_nested_free_var_in_iter"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_nested_free_var_in_iter"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_nested_free_var_in_iter
"""Auto-ported test: ListComprehensionTest::test_nested_free_var_in_iter (CPython 3.12 oracle)."""
...
_check_in_scopes(code, {'items': [1]})
print("ListComprehensionTest::test_nested_free_var_in_iter: ok")
