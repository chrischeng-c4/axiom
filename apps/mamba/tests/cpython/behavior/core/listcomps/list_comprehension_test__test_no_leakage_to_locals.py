...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_no_leakage_to_locals"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_no_leakage_to_locals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_no_leakage_to_locals
"""Auto-ported test: ListComprehensionTest::test_no_leakage_to_locals (CPython 3.12 oracle)."""
...
_check_in_scopes(code, {'x': True, 'y': []}, scopes=['module'])
_check_in_scopes(code, {'x': True, 'y': ['b']}, scopes=['function'])
_check_in_scopes(code, raises=NameError, scopes=['class'])
print("ListComprehensionTest::test_no_leakage_to_locals: ok")
