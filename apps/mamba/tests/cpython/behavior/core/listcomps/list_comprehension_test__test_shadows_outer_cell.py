...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_shadows_outer_cell"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_shadows_outer_cell"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_shadows_outer_cell
"""Auto-ported test: ListComprehensionTest::test_shadows_outer_cell (CPython 3.12 oracle)."""
...
code = '\n            def inner():\n                return g\n            [g for g in range(5)]\n            x = inner()\n        '
outputs = {'x': -1}
_check_in_scopes(code, outputs, ns={'g': -1})
print("ListComprehensionTest::test_shadows_outer_cell: ok")
