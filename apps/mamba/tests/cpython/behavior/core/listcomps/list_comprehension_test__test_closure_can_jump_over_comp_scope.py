...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_closure_can_jump_over_comp_scope"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_closure_can_jump_over_comp_scope"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_closure_can_jump_over_comp_scope
"""Auto-ported test: ListComprehensionTest::test_closure_can_jump_over_comp_scope (CPython 3.12 oracle)."""
...
outputs = {'z': [2, 2, 2, 2, 2]}
_check_in_scopes(code, outputs, scopes=['module', 'function'])
print("ListComprehensionTest::test_closure_can_jump_over_comp_scope: ok")
