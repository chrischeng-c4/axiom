...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_in_class_scope_with_global"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_in_class_scope_with_global"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_in_class_scope_with_global
"""Auto-ported test: ListComprehensionTest::test_in_class_scope_with_global (CPython 3.12 oracle)."""
...
_check_in_scopes(code, outputs, scopes=['module', 'class'])
outputs = {'vals': [(0, 1), (1, 1)]}
_check_in_scopes(code, outputs, scopes=['function'])
print("ListComprehensionTest::test_in_class_scope_with_global: ok")
