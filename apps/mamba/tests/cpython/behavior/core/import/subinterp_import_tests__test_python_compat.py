...
# lib = "import"
# dimension = "behavior"
# case = "subinterp_import_tests__test_python_compat"
# subject = "cpython.__init__.SubinterpImportTests.test_python_compat"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::SubinterpImportTests::test_python_compat
"""Auto-ported test: SubinterpImportTests::test_python_compat (CPython 3.12 oracle)."""
...
check_compatible_here(module, strict=True)
check_compatible_fresh(module, strict=True)
print("SubinterpImportTests::test_python_compat: ok")
