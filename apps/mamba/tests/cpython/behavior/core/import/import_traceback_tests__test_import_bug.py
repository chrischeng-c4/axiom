...
# lib = "import"
# dimension = "behavior"
# case = "import_traceback_tests__test_import_bug"
# subject = "cpython.__init__.ImportTracebackTests.test_import_bug"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTracebackTests::test_import_bug
"""Auto-ported test: ImportTracebackTests::test_import_bug (CPython 3.12 oracle)."""
...
try:
    ...
    assert_traceback(tb, [__file__, '<frozen importlib', __file__])
finally:
    if old_exec_module is None:
        del importlib.SourceLoader.exec_module
    else:
        importlib.SourceLoader.exec_module = old_exec_module
print("ImportTracebackTests::test_import_bug: ok")
