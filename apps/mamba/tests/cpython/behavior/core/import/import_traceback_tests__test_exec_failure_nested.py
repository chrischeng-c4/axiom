...
# lib = "import"
# dimension = "behavior"
# case = "import_traceback_tests__test_exec_failure_nested"
# subject = "cpython.__init__.ImportTracebackTests.test_exec_failure_nested"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTracebackTests::test_exec_failure_nested
"""Auto-ported test: ImportTracebackTests::test_exec_failure_nested (CPython 3.12 oracle)."""
...
create_module('foo', 'import bar')
create_module('bar', '1/0')
try:
    import foo
...
assert_traceback(tb, [__file__, 'foo.py', 'bar.py'])
print("ImportTracebackTests::test_exec_failure_nested: ok")
