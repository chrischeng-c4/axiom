...
# lib = "import"
# dimension = "behavior"
# case = "circular_import_tests__test_indirect"
# subject = "cpython.__init__.CircularImportTests.test_indirect"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::CircularImportTests::test_indirect
"""Auto-ported test: CircularImportTests::test_indirect (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('relative import in module contributing to circular import failed')
print("CircularImportTests::test_indirect: ok")
