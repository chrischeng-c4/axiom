...
# lib = "import"
# dimension = "behavior"
# case = "circular_import_tests__test_binding"
# subject = "cpython.__init__.CircularImportTests.test_binding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::CircularImportTests::test_binding
"""Auto-ported test: CircularImportTests::test_binding (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('circular import with binding a submodule to a name failed')
print("CircularImportTests::test_binding: ok")
