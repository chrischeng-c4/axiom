...
# lib = "import"
# dimension = "behavior"
# case = "circular_import_tests__test_crossreference2"
# subject = "cpython.__init__.CircularImportTests.test_crossreference2"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::CircularImportTests::test_crossreference2
"""Auto-ported test: CircularImportTests::test_crossreference2 (CPython 3.12 oracle)."""
...
assert 'test.test_import.data.circular_imports.source' in errmsg

assert 'spam' in errmsg

assert 'partially initialized module' in errmsg

assert 'circular import' in errmsg
print("CircularImportTests::test_crossreference2: ok")
