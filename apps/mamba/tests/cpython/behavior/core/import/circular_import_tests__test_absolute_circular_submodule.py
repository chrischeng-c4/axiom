...
# lib = "import"
# dimension = "behavior"
# case = "circular_import_tests__test_absolute_circular_submodule"
# subject = "cpython.__init__.CircularImportTests.test_absolute_circular_submodule"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::CircularImportTests::test_absolute_circular_submodule
"""Auto-ported test: CircularImportTests::test_absolute_circular_submodule (CPython 3.12 oracle)."""
...
assert "cannot access submodule 'parent' of module 'test.test_import.data.circular_imports.subpkg2' (most likely due to a circular import)" in str(cm.exception)
print("CircularImportTests::test_absolute_circular_submodule: ok")
