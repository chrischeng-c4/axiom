...
# lib = "import"
# dimension = "behavior"
# case = "paths_tests__test_trailing_slash"
# subject = "cpython.__init__.PathsTests.test_trailing_slash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::PathsTests::test_trailing_slash
"""Auto-ported test: PathsTests::test_trailing_slash (CPython 3.12 oracle)."""
...
path = TESTFN
os.mkdir(path)
self_syspath = sys.path[:]
with open(os.path.join(path, 'test_trailing_slash.py'), 'w', encoding='utf-8') as f:
    f.write("testdata = 'test_trailing_slash'")
sys.path.append(path + '/')
mod = __import__('test_trailing_slash')

assert mod.testdata == 'test_trailing_slash'
unload('test_trailing_slash')
print("PathsTests::test_trailing_slash: ok")
