...
# lib = "import"
# dimension = "behavior"
# case = "circular_import_tests__test_direct"
# subject = "cpython.__init__.CircularImportTests.test_direct"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::CircularImportTests::test_direct
"""Auto-ported test: CircularImportTests::test_direct (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('circular import through relative imports failed')
print("CircularImportTests::test_direct: ok")
