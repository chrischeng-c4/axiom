...
# lib = "import"
# dimension = "behavior"
# case = "import_tests__test_from_import_missing_attr_path_is_canonical"
# subject = "cpython.__init__.ImportTests.test_from_import_missing_attr_path_is_canonical"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTests::test_from_import_missing_attr_path_is_canonical
"""Auto-ported test: ImportTests::test_from_import_missing_attr_path_is_canonical (CPython 3.12 oracle)."""
...
assert cm.exception.name in {'posixpath', 'ntpath'}

assert cm.exception is not None
print("ImportTests::test_from_import_missing_attr_path_is_canonical: ok")
