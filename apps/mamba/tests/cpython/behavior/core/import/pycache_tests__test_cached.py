...
# lib = "import"
# dimension = "behavior"
# case = "pycache_tests__test_cached"
# subject = "cpython.__init__.PycacheTests.test___cached__"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::PycacheTests::test___cached__
"""Auto-ported test: PycacheTests::test___cached__ (CPython 3.12 oracle)."""
...
assert m.__cached__ == os.path.join(os.getcwd(), pyc_file)
print("PycacheTests::test___cached__: ok")
