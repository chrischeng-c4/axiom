...
# lib = "import"
# dimension = "behavior"
# case = "circular_import_tests__test_circular_from_import"
# subject = "cpython.__init__.CircularImportTests.test_circular_from_import"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::CircularImportTests::test_circular_from_import
"""Auto-ported test: CircularImportTests::test_circular_from_import (CPython 3.12 oracle)."""
...
assert "cannot import name 'b' from partially initialized module 'test.test_import.data.circular_imports.from_cycle1' (most likely due to a circular import)" in str(cm.exception)
print("CircularImportTests::test_circular_from_import: ok")
