...
# lib = "import"
# dimension = "behavior"
# case = "import_tests__test_bogus_fromlist"
# subject = "cpython.__init__.ImportTests.test_bogus_fromlist"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTests::test_bogus_fromlist
"""Auto-ported test: ImportTests::test_bogus_fromlist (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('fromlist must allow bogus names')
print("ImportTests::test_bogus_fromlist: ok")
