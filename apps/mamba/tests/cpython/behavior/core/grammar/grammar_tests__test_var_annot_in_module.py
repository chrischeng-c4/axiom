...
# lib = "grammar"
# dimension = "behavior"
# case = "grammar_tests__test_var_annot_in_module"
# subject = "cpython.test_grammar.GrammarTests.test_var_annot_in_module"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::GrammarTests::test_var_annot_in_module
"""Auto-ported test: GrammarTests::test_var_annot_in_module (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("GrammarTests::test_var_annot_in_module: ok")
