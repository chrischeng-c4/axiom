...
# lib = "grammar"
# dimension = "behavior"
# case = "grammar_tests__test_for"
# subject = "cpython.test_grammar.GrammarTests.test_for"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::GrammarTests::test_for
"""Auto-ported test: GrammarTests::test_for (CPython 3.12 oracle)."""
...
if n != 285:
    ...
    raise AssertionError('for over growing sequence')
result = []
for x, in [(1,), (2,), (3,)]:
    result.append(x)
...
assert result == 3 * a
print("GrammarTests::test_for: ok")
