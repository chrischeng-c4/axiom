...
# lib = "grammar"
# dimension = "behavior"
# case = "token_tests__test_float_exponent_tokenization"
# subject = "cpython.test_grammar.TokenTests.test_float_exponent_tokenization"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::TokenTests::test_float_exponent_tokenization
"""Auto-ported test: TokenTests::test_float_exponent_tokenization (CPython 3.12 oracle)."""
...
with warnings.catch_warnings():
    ...
    assert eval('1 if 1else 0') == 1

    assert eval('1 if 0else 0') == 0
...
try:
    ...
    pass
print("TokenTests::test_float_exponent_tokenization: ok")
