...
# lib = "grammar"
# dimension = "behavior"
# case = "grammar_tests__test_matrix_mul"
# subject = "cpython.test_grammar.GrammarTests.test_matrix_mul"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::GrammarTests::test_matrix_mul
"""Auto-ported test: GrammarTests::test_matrix_mul (CPython 3.12 oracle)."""
...
assert m.other == 42
print("GrammarTests::test_matrix_mul: ok")
