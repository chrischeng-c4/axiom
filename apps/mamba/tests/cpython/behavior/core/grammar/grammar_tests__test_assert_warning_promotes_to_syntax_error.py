...
# lib = "grammar"
# dimension = "behavior"
# case = "grammar_tests__test_assert_warning_promotes_to_syntax_error"
# subject = "cpython.test_grammar.GrammarTests.test_assert_warning_promotes_to_syntax_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::GrammarTests::test_assert_warning_promotes_to_syntax_error
"""Auto-ported test: GrammarTests::test_assert_warning_promotes_to_syntax_error (CPython 3.12 oracle)."""
...
with warnings.catch_warnings():
    ...
    try:
        ...
        raise AssertionError('SyntaxError incorrectly raised for \'assert x, "msg"\'')
    try:
        compile('assert(x, "msg")', '<testcase>', 'exec')
    ...
    try:
        ...
        pass
print("GrammarTests::test_assert_warning_promotes_to_syntax_error: ok")
