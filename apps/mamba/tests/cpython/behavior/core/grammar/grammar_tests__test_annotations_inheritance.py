...
# lib = "grammar"
# dimension = "behavior"
# case = "grammar_tests__test_annotations_inheritance"
# subject = "cpython.test_grammar.GrammarTests.test_annotations_inheritance"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::GrammarTests::test_annotations_inheritance
"""Auto-ported test: GrammarTests::test_annotations_inheritance (CPython 3.12 oracle)."""
...
assert A.__annotations__ == {'attr': int}

assert B.__annotations__ == {}

assert C.__annotations__ == {'attr': str}

assert D.__annotations__ == {'attr2': int}

assert E.__annotations__ == {}

assert F.__annotations__ == {}
print("GrammarTests::test_annotations_inheritance: ok")
