...
# lib = "grammar"
# dimension = "behavior"
# case = "grammar_tests__test_async_await"
# subject = "cpython.test_grammar.GrammarTests.test_async_await"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::GrammarTests::test_async_await
"""Auto-ported test: GrammarTests::test_async_await (CPython 3.12 oracle)."""
...
assert bool(test.__code__.co_flags & inspect.CO_COROUTINE)
...
assert test2._marked

assert test2.__name__ == 'test2'

assert bool(test2.__code__.co_flags & inspect.CO_COROUTINE)
print("GrammarTests::test_async_await: ok")
