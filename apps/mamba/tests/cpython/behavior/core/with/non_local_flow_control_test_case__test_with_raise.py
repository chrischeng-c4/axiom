...
# lib = "with"
# dimension = "behavior"
# case = "non_local_flow_control_test_case__test_with_raise"
# subject = "cpython.test_with.NonLocalFlowControlTestCase.testWithRaise"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_with.py::NonLocalFlowControlTestCase::testWithRaise
"""Auto-ported test: NonLocalFlowControlTestCase::testWithRaise (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError("Didn't raise RuntimeError")
print("NonLocalFlowControlTestCase::testWithRaise: ok")
