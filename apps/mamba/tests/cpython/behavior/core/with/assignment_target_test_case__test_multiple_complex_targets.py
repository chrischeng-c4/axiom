...
# lib = "with"
# dimension = "behavior"
# case = "assignment_target_test_case__test_multiple_complex_targets"
# subject = "cpython.test_with.AssignmentTargetTestCase.testMultipleComplexTargets"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_with.py::AssignmentTargetTestCase::testMultipleComplexTargets
"""Auto-ported test: AssignmentTargetTestCase::testMultipleComplexTargets (CPython 3.12 oracle)."""
...
with C() as (blah.one, blah.two, blah.three):
    ...
    assert blah.three == 3
print("AssignmentTargetTestCase::testMultipleComplexTargets: ok")
