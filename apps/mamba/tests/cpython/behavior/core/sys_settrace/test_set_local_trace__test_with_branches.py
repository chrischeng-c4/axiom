...
# lib = "sys_settrace"
# dimension = "behavior"
# case = "test_set_local_trace__test_with_branches"
# subject = "cpython.test.test_sys_settrace.TestSetLocalTrace.test_with_branches"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_settrace.py::TestSetLocalTrace::test_with_branches
"""Auto-ported test: TestSetLocalTrace::test_with_branches (CPython 3.12 oracle)."""
...
def func(arg=1):
    ...
    if arg >= 3:
        ...
        reached = 9
    the_end = 10
EXPECTED_EVENTS = [(0, 'call'), (1, 'line'), (2, 'line'), (5, 'line'), (6, 'line'), (9, 'line'), (10, 'line'), (10, 'return')]
events = []
sys.settrace(tracefunc)
...
sys.settrace(None)
print("TestSetLocalTrace::test_with_branches: ok")
