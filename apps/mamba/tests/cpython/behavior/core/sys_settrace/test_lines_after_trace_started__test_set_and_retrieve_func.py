...
# lib = "sys_settrace"
# dimension = "behavior"
# case = "test_lines_after_trace_started__test_set_and_retrieve_func"
# subject = "cpython.test.test_sys_settrace.TestLinesAfterTraceStarted.test_set_and_retrieve_func"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_settrace.py::TestLinesAfterTraceStarted::test_set_and_retrieve_func
"""Auto-ported test: TestLinesAfterTraceStarted::test_set_and_retrieve_func (CPython 3.12 oracle)."""
...
try:
    ...
    sys.settrace(None)
print("TestLinesAfterTraceStarted::test_set_and_retrieve_func: ok")
