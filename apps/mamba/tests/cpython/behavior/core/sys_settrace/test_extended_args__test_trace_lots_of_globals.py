...
# lib = "sys_settrace"
# dimension = "behavior"
# case = "test_extended_args__test_trace_lots_of_globals"
# subject = "cpython.test.test_sys_settrace.TestExtendedArgs.test_trace_lots_of_globals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_settrace.py::TestExtendedArgs::test_trace_lots_of_globals
"""Auto-ported test: TestExtendedArgs::test_trace_lots_of_globals (CPython 3.12 oracle)."""
...
exec(code, ns)
counts = count_traces(ns['f'])

assert counts == {'call': 1, 'line': count * 2, 'return': 1}
print("TestExtendedArgs::test_trace_lots_of_globals: ok")
