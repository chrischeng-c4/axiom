...
# lib = "compile"
# dimension = "behavior"
# case = "test_source_positions__test_attribute_del"
# subject = "cpython.test_compile.TestSourcePositions.test_attribute_del"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestSourcePositions::test_attribute_del
"""Auto-ported test: TestSourcePositions::test_attribute_del (CPython 3.12 oracle)."""
...
assertOpcodeSourcePositionIs(code, 'DELETE_ATTR', line=4, end_line=4, column=5, end_column=8)
print("TestSourcePositions::test_attribute_del: ok")
