...
# lib = "compile"
# dimension = "behavior"
# case = "test_stack_size_stability__test_try_finally"
# subject = "cpython.test_compile.TestStackSizeStability.test_try_finally"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestStackSizeStability::test_try_finally
"""Auto-ported test: TestStackSizeStability::test_try_finally (CPython 3.12 oracle)."""
...
print("TestStackSizeStability::test_try_finally: ok")
