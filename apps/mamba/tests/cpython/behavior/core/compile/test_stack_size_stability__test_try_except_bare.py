...
# lib = "compile"
# dimension = "behavior"
# case = "test_stack_size_stability__test_try_except_bare"
# subject = "cpython.test_compile.TestStackSizeStability.test_try_except_bare"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestStackSizeStability::test_try_except_bare
"""Auto-ported test: TestStackSizeStability::test_try_except_bare (CPython 3.12 oracle)."""
...
print("TestStackSizeStability::test_try_except_bare: ok")
