...
# lib = "compile"
# dimension = "behavior"
# case = "test_source_positions__test_multiline_async_dict_comprehension"
# subject = "cpython.test_compile.TestSourcePositions.test_multiline_async_dict_comprehension"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestSourcePositions::test_multiline_async_dict_comprehension
"""Auto-ported test: TestSourcePositions::test_multiline_async_dict_comprehension (CPython 3.12 oracle)."""
...
assertOpcodeSourcePositionIs(compiled_code, 'MAP_ADD', line=2, end_line=3, column=5, end_column=11, occurrence=1)
assertOpcodeSourcePositionIs(compiled_code, 'JUMP_BACKWARD', line=2, end_line=3, column=5, end_column=11, occurrence=1)
assertOpcodeSourcePositionIs(compiled_code, 'RETURN_CONST', line=2, end_line=7, column=4, end_column=36, occurrence=1)
print("TestSourcePositions::test_multiline_async_dict_comprehension: ok")
