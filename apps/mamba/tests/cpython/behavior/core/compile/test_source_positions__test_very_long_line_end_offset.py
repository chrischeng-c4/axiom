...
# lib = "compile"
# dimension = "behavior"
# case = "test_source_positions__test_very_long_line_end_offset"
# subject = "cpython.test_compile.TestSourcePositions.test_very_long_line_end_offset"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestSourcePositions::test_very_long_line_end_offset
"""Auto-ported test: TestSourcePositions::test_very_long_line_end_offset (CPython 3.12 oracle)."""
...
assertOpcodeSourcePositionIs(compiled_code, 'CALL', line=1, end_line=1, column=0, end_column=1005)
print("TestSourcePositions::test_very_long_line_end_offset: ok")
