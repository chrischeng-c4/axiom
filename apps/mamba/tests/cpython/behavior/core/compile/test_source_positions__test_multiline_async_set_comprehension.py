...
# lib = "compile"
# dimension = "behavior"
# case = "test_source_positions__test_multiline_async_set_comprehension"
# subject = "cpython.test_compile.TestSourcePositions.test_multiline_async_set_comprehension"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestSourcePositions::test_multiline_async_set_comprehension
"""Auto-ported test: TestSourcePositions::test_multiline_async_set_comprehension (CPython 3.12 oracle)."""
...
assertOpcodeSourcePositionIs(compiled_code, 'SET_ADD', line=2, end_line=3, column=5, end_column=12, occurrence=1)
...
print("TestSourcePositions::test_multiline_async_set_comprehension: ok")
