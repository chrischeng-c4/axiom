...
# lib = "compile"
# dimension = "behavior"
# case = "test_stack_size_stability__test_while_else"
# subject = "cpython.test_compile.TestStackSizeStability.test_while_else"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestStackSizeStability::test_while_else
"""Auto-ported test: TestStackSizeStability::test_while_else (CPython 3.12 oracle)."""
...
print("TestStackSizeStability::test_while_else: ok")
