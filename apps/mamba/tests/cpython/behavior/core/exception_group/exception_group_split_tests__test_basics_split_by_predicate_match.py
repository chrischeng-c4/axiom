...
# lib = "exception_group"
# dimension = "behavior"
# case = "exception_group_split_tests__test_basics_split_by_predicate_match"
# subject = "cpython.test_exception_group.ExceptionGroupSplitTests.test_basics_split_by_predicate__match"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exception_group.py::ExceptionGroupSplitTests::test_basics_split_by_predicate__match
"""Auto-ported test: ExceptionGroupSplitTests::test_basics_split_by_predicate__match (CPython 3.12 oracle)."""
...
VE = ValueError
TE = TypeError
testcases = [(VE, [VE(1), VE(2)], [TE(int)]), (TE, [TE(int)], [VE(1), VE(2)]), ((VE, TE), self_eg_template, None)]
...
print("ExceptionGroupSplitTests::test_basics_split_by_predicate__match: ok")
