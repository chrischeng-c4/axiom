...
# lib = "exception_group"
# dimension = "behavior"
# case = "nested_exception_group_split_test__test_drive_invalid_return_value"
# subject = "cpython.test_exception_group.NestedExceptionGroupSplitTest.test_drive_invalid_return_value"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exception_group.py::NestedExceptionGroupSplitTest::test_drive_invalid_return_value
"""Auto-ported test: NestedExceptionGroupSplitTest::test_drive_invalid_return_value (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(msg, str(_aR_e))
print("NestedExceptionGroupSplitTest::test_drive_invalid_return_value: ok")
