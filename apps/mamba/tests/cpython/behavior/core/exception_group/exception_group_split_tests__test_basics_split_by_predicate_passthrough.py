...
# lib = "exception_group"
# dimension = "behavior"
# case = "exception_group_split_tests__test_basics_split_by_predicate_passthrough"
# subject = "cpython.test_exception_group.ExceptionGroupSplitTests.test_basics_split_by_predicate__passthrough"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exception_group.py::ExceptionGroupSplitTests::test_basics_split_by_predicate__passthrough
"""Auto-ported test: ExceptionGroupSplitTests::test_basics_split_by_predicate__passthrough (CPython 3.12 oracle)."""
...
match, rest = self_eg.split(lambda e: True)
assertMatchesTemplate(match, ExceptionGroup, self_eg_template)

assert rest is None
print("ExceptionGroupSplitTests::test_basics_split_by_predicate__passthrough: ok")
