...
# lib = "exception_group"
# dimension = "behavior"
# case = "nested_exception_group_split_test__test_split_copies_notes"
# subject = "cpython.test_exception_group.NestedExceptionGroupSplitTest.test_split_copies_notes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exception_group.py::NestedExceptionGroupSplitTest::test_split_copies_notes
"""Auto-ported test: NestedExceptionGroupSplitTest::test_split_copies_notes (CPython 3.12 oracle)."""
...
assert eg.__notes__ == orig_notes

assert match.__notes__ == orig_notes

assert rest.__notes__ == orig_notes
...
assert eg.__notes__ == orig_notes + ['eg']

assert match.__notes__ == orig_notes + ['match']

assert rest.__notes__ == orig_notes + ['rest']
print("NestedExceptionGroupSplitTest::test_split_copies_notes: ok")
