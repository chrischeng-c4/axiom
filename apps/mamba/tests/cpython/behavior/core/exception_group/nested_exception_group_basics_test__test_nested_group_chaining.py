...
# lib = "exception_group"
# dimension = "behavior"
# case = "nested_exception_group_basics_test__test_nested_group_chaining"
# subject = "cpython.test_exception_group.NestedExceptionGroupBasicsTest.test_nested_group_chaining"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exception_group.py::NestedExceptionGroupBasicsTest::test_nested_group_chaining
"""Auto-ported test: NestedExceptionGroupBasicsTest::test_nested_group_chaining (CPython 3.12 oracle)."""
...
assert isinstance(eg.exceptions[1].__context__, MemoryError)

assert isinstance(eg.exceptions[1].__cause__, MemoryError)

assert isinstance(eg.exceptions[0].__context__, TypeError)
print("NestedExceptionGroupBasicsTest::test_nested_group_chaining: ok")
