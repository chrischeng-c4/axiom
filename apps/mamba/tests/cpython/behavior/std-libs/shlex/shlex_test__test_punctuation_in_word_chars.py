...
# lib = "shlex"
# dimension = "behavior"
# case = "shlex_test__test_punctuation_in_word_chars"
# subject = "cpython.test_shlex.ShlexTest.testPunctuationInWordChars"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shlex.py::ShlexTest::testPunctuationInWordChars
"""Auto-ported test: ShlexTest::testPunctuationInWordChars (CPython 3.12 oracle)."""
...
assert '_' not in s.wordchars

assert list(s) == ['a', '_', 'b', '__', 'c']
print("ShlexTest::testPunctuationInWordChars: ok")
