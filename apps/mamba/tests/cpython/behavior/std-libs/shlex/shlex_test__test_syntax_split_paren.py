...
# lib = "shlex"
# dimension = "behavior"
# case = "shlex_test__test_syntax_split_paren"
# subject = "cpython.test_shlex.ShlexTest.testSyntaxSplitParen"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shlex.py::ShlexTest::testSyntaxSplitParen
"""Auto-ported test: ShlexTest::testSyntaxSplitParen (CPython 3.12 oracle)."""
...
for ss, ws in itertools.product(src, (False, True)):
    ...
    assert ref == result
print("ShlexTest::testSyntaxSplitParen: ok")
