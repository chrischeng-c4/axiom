...
# lib = "shlex"
# dimension = "behavior"
# case = "shlex_test__test_join"
# subject = "cpython.test_shlex.ShlexTest.testJoin"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shlex.py::ShlexTest::testJoin
"""Auto-ported test: ShlexTest::testJoin (CPython 3.12 oracle)."""
...
for split_command, command in [(['a ', 'b'], "'a ' b"), (['a', ' b'], "a ' b'"), (['a', ' ', 'b'], "a ' ' b"), (['"a', 'b"'], '\'"a\' \'b"\'')]:
    ...
    assert joined == command
print("ShlexTest::testJoin: ok")
