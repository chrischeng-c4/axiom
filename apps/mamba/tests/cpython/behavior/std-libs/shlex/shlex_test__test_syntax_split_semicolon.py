...
# lib = "shlex"
# dimension = "behavior"
# case = "shlex_test__test_syntax_split_semicolon"
# subject = "cpython.test_shlex.ShlexTest.testSyntaxSplitSemicolon"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shlex.py::ShlexTest::testSyntaxSplitSemicolon
"""Auto-ported test: ShlexTest::testSyntaxSplitSemicolon (CPython 3.12 oracle)."""
...
for delimiter in (';', ';;', ';&', ';;&'):
    ...
    for ss, ws in itertools.product(src, (False, True)):
        ...
        assert ref == result
print("ShlexTest::testSyntaxSplitSemicolon: ok")
