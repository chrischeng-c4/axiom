...
# lib = "audioop"
# dimension = "behavior"
# case = "test_audioop__test_lin2alaw"
# subject = "cpython.test_audioop.TestAudioop.test_lin2alaw"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audioop.py::TestAudioop::test_lin2alaw
"""Auto-ported test: TestAudioop::test_lin2alaw (CPython 3.12 oracle)."""
...
assert audioop.lin2alaw(datas[1], 1) == b'\xd5\x87\xa4$\xaa*Z'

assert audioop.lin2alaw(bytearray(datas[1]), 1) == b'\xd5\x87\xa4$\xaa*Z'

assert audioop.lin2alaw(memoryview(datas[1]), 1) == b'\xd5\x87\xa4$\xaa*Z'
for w in (2, 3, 4):

    assert audioop.lin2alaw(datas[w], w) == b'\xd5\x87\xa4$\xaa*U'
print("TestAudioop::test_lin2alaw: ok")
