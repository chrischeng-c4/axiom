...
# lib = "audioop"
# dimension = "behavior"
# case = "test_audioop__test_wrongsize"
# subject = "cpython.test_audioop.TestAudioop.test_wrongsize"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audioop.py::TestAudioop::test_wrongsize
"""Auto-ported test: TestAudioop::test_wrongsize (CPython 3.12 oracle)."""
...
for size in (-1, 0, 5, 1024):
    ...
    try:
        ...
        pass
print("TestAudioop::test_wrongsize: ok")
