...
# lib = "codecs"
# dimension = "behavior"
# case = "utf16_ex_test__test_errors"
# subject = "cpython.test_codecs.UTF16ExTest.test_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF16ExTest::test_errors
"""Auto-ported test: UTF16ExTest::test_errors (CPython 3.12 oracle)."""
...
try:
    codecs.utf_16_ex_decode(b'\xff', 'strict', 0, True)
    raise AssertionError('expected UnicodeDecodeError')
except UnicodeDecodeError:
    pass
print("UTF16ExTest::test_errors: ok")
