...
# lib = "codecs"
# dimension = "behavior"
# case = "transform_codec_test__test_basics"
# subject = "cpython.test_codecs.TransformCodecTest.test_basics"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::TransformCodecTest::test_basics
"""Auto-ported test: TransformCodecTest::test_basics (CPython 3.12 oracle)."""
...
for encoding in bytes_transform_encodings:
    ...
    assert size == len(binput)
    i, size = codecs.getdecoder(encoding)(o)

    assert size == len(o)

    assert i == binput
print("TransformCodecTest::test_basics: ok")
