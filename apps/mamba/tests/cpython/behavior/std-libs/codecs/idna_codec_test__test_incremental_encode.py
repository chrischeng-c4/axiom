...
# lib = "codecs"
# dimension = "behavior"
# case = "idna_codec_test__test_incremental_encode"
# subject = "cpython.test_codecs.IDNACodecTest.test_incremental_encode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::IDNACodecTest::test_incremental_encode
"""Auto-ported test: IDNACodecTest::test_incremental_encode (CPython 3.12 oracle)."""
...
assert b''.join(codecs.iterencode('python.org', 'idna')) == b'python.org'
...
assert encoder.encode('äx') == b''

assert encoder.encode('ample.org') == b'xn--xample-9ta.'

assert encoder.encode('', True) == b'org'
encoder.reset()

assert encoder.encode('äx') == b''

assert encoder.encode('ample.org.') == b'xn--xample-9ta.org.'

assert encoder.encode('', True) == b''
print("IDNACodecTest::test_incremental_encode: ok")
