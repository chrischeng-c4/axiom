...
# lib = "codecs"
# dimension = "behavior"
# case = "latin1_test__test_encode"
# subject = "cpython.test_codecs.Latin1Test.test_encode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::Latin1Test::test_encode
"""Auto-ported test: Latin1Test::test_encode (CPython 3.12 oracle)."""
...
for data, expected in (('abc', b'abc'), ('\x80éÿ', b'\x80\xe9\xff')):
    ...
    assert data.encode('latin1') == expected
print("Latin1Test::test_encode: ok")
