...
# lib = "codecs"
# dimension = "behavior"
# case = "escape_encode_test__test_escape_encode"
# subject = "cpython.test_codecs.EscapeEncodeTest.test_escape_encode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::EscapeEncodeTest::test_escape_encode
"""Auto-ported test: EscapeEncodeTest::test_escape_encode (CPython 3.12 oracle)."""
...
for data, output in tests:
    ...
    assert codecs.escape_encode(data) == output

try:
    codecs.escape_encode('spam')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    codecs.escape_encode(bytearray(b'spam'))
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("EscapeEncodeTest::test_escape_encode: ok")
