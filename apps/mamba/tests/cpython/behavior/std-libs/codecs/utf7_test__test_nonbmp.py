...
# lib = "codecs"
# dimension = "behavior"
# case = "utf7_test__test_nonbmp"
# subject = "cpython.test_codecs.UTF7Test.test_nonbmp"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF7Test::test_nonbmp
"""Auto-ported test: UTF7Test::test_nonbmp (CPython 3.12 oracle)."""
...
assert '𐒠'.encode(encoding) == b'+2AHcoA-'

assert '\ud801\udca0'.encode(encoding) == b'+2AHcoA-'

assert b'+2AHcoA-'.decode(encoding) == '𐒠'

assert b'+2AHcoA'.decode(encoding) == '𐒠'

assert '€𐒠'.encode(encoding) == b'+IKzYAdyg-'

assert b'+IKzYAdyg-'.decode(encoding) == '€𐒠'

assert b'+IKzYAdyg'.decode(encoding) == '€𐒠'

assert '€€𐒠'.encode(encoding) == b'+IKwgrNgB3KA-'

assert b'+IKwgrNgB3KA-'.decode(encoding) == '€€𐒠'

assert b'+IKwgrNgB3KA'.decode(encoding) == '€€𐒠'
print("UTF7Test::test_nonbmp: ok")
