...
# lib = "codecs"
# dimension = "behavior"
# case = "codecs_module_test__test_getdecoder"
# subject = "cpython.test_codecs.CodecsModuleTest.test_getdecoder"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_codecs.py::CodecsModuleTest::test_getdecoder
"""Auto-ported test: CodecsModuleTest::test_getdecoder (CPython 3.12 oracle)."""
...
try:
    codecs.getdecoder('__spam__')
    raise AssertionError('expected LookupError')
except LookupError:
    pass
print("CodecsModuleTest::test_getdecoder: ok")
