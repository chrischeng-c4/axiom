...
# lib = "codecs"
# dimension = "behavior"
# case = "utf32_test__test_handlers"
# subject = "cpython.test_codecs.UTF32Test.test_handlers"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF32Test::test_handlers
"""Auto-ported test: UTF32Test::test_handlers (CPython 3.12 oracle)."""
...
assert ('�', 1) == codecs.utf_32_decode(b'\x01', 'replace', True)

assert ('', 1) == codecs.utf_32_decode(b'\x01', 'ignore', True)
print("UTF32Test::test_handlers: ok")
