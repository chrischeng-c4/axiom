...
# lib = "codecs"
# dimension = "behavior"
# case = "with_stmt_test__test_streamreaderwriter"
# subject = "cpython.test_codecs.WithStmtTest.test_streamreaderwriter"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::WithStmtTest::test_streamreaderwriter
"""Auto-ported test: WithStmtTest::test_streamreaderwriter (CPython 3.12 oracle)."""
...
with codecs.StreamReaderWriter(f, info.streamreader, info.streamwriter, 'strict') as srw:
    ...
    assert srw.read() == 'ü'
print("WithStmtTest::test_streamreaderwriter: ok")
