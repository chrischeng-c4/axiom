...
# lib = "codecs"
# dimension = "behavior"
# case = "utf16_test__test_bug691291"
# subject = "cpython.test_codecs.UTF16Test.test_bug691291"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF16Test::test_bug691291
"""Auto-ported test: UTF16Test::test_bug691291 (CPython 3.12 oracle)."""
...
s1 = 'Hello\r\nworld\r\n'
s = s1.encode(encoding)
pass
with open(os_helper.TESTFN, 'wb') as fp:
    fp.write(s)
with codecs.open(os_helper.TESTFN, 'r', encoding=encoding) as reader:

    assert reader.read() == s1
print("UTF16Test::test_bug691291: ok")
