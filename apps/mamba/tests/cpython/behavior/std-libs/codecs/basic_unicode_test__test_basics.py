...
# lib = "codecs"
# dimension = "behavior"
# case = "basic_unicode_test__test_basics"
# subject = "cpython.test_codecs.BasicUnicodeTest.test_basics"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::BasicUnicodeTest::test_basics
"""Auto-ported test: BasicUnicodeTest::test_basics (CPython 3.12 oracle)."""
...
for encoding in all_unicode_encodings:
    ...
    if name != 'mbcs':
        ...
        assert encoding.replace('_', '-') == name.replace('_', '-')
    ...
    if encoding not in broken_unicode_with_stateful:
        ...
        if encoding not in ('idna', 'mbcs'):
            try:
                ...
                assert decodedresult == s
print("BasicUnicodeTest::test_basics: ok")
