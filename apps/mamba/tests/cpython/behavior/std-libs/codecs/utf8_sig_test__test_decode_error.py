...
# lib = "codecs"
# dimension = "behavior"
# case = "utf8_sig_test__test_decode_error"
# subject = "cpython.test_codecs.UTF8SigTest.test_decode_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF8SigTest::test_decode_error
"""Auto-ported test: UTF8SigTest::test_decode_error (CPython 3.12 oracle)."""
...
for data, error_handler, expected in ((b'[\x80\xff]', 'ignore', '[]'), (b'[\x80\xff]', 'replace', '[��]'), (b'[\x80\xff]', 'surrogateescape', '[\udc80\udcff]'), (b'[\x80\xff]', 'backslashreplace', '[\\x80\\xff]')):
    ...
    assert data.decode(encoding, error_handler) == expected
print("UTF8SigTest::test_decode_error: ok")
