...
# lib = "codecs"
# dimension = "behavior"
# case = "punycode_test__test_decode"
# subject = "cpython.test_codecs.PunycodeTest.test_decode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::PunycodeTest::test_decode
"""Auto-ported test: PunycodeTest::test_decode (CPython 3.12 oracle)."""
...
for uni, puny in punycode_testcases:
    ...
    assert uni == puny.decode('punycode')
    puny = puny.decode('ascii').encode('ascii')

    assert uni == puny.decode('punycode')
print("PunycodeTest::test_decode: ok")
