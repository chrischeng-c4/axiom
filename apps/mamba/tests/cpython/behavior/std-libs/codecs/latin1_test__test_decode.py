...
# lib = "codecs"
# dimension = "behavior"
# case = "latin1_test__test_decode"
# subject = "cpython.test_codecs.Latin1Test.test_decode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::Latin1Test::test_decode
"""Auto-ported test: Latin1Test::test_decode (CPython 3.12 oracle)."""
...
for data, expected in ((b'abc', 'abc'), (b'[\x80\xff]', '[\x80ÿ]')):
    ...
    assert data.decode('latin1') == expected
print("Latin1Test::test_decode: ok")
