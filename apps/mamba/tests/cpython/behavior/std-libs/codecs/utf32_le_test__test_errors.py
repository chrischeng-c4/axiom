...
# lib = "codecs"
# dimension = "behavior"
# case = "utf32_le_test__test_errors"
# subject = "cpython.test_codecs.UTF32LETest.test_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF32LETest::test_errors
"""Auto-ported test: UTF32LETest::test_errors (CPython 3.12 oracle)."""
...
try:
    codecs.utf_32_le_decode(b'\xff', 'strict', True)
    raise AssertionError('expected UnicodeDecodeError')
except UnicodeDecodeError:
    pass
print("UTF32LETest::test_errors: ok")
