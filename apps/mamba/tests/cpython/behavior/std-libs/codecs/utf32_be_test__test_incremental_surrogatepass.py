...
# lib = "codecs"
# dimension = "behavior"
# case = "utf32_be_test__test_incremental_surrogatepass"
# subject = "cpython.test_codecs.UTF32BETest.test_incremental_surrogatepass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF32BETest::test_incremental_surrogatepass
"""Auto-ported test: UTF32BETest::test_incremental_surrogatepass (CPython 3.12 oracle)."""
...
for i in range(1, len(data)):
    ...
    assert dec.decode(data[i:]) == '\udc02'
print("UTF32BETest::test_incremental_surrogatepass: ok")
