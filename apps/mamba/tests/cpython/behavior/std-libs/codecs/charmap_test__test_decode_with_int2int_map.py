...
# lib = "codecs"
# dimension = "behavior"
# case = "charmap_test__test_decode_with_int2int_map"
# subject = "cpython.test_codecs.CharmapTest.test_decode_with_int2int_map"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::CharmapTest::test_decode_with_int2int_map
"""Auto-ported test: CharmapTest::test_decode_with_int2int_map (CPython 3.12 oracle)."""
...
assert codecs.charmap_decode(b'\x00\x01\x02', 'strict', {0: a, 1: b, 2: c}) == ('abc', 3)

assert codecs.charmap_decode(b'\x00\x01\x02', 'strict', {0: 1114111, 1: b, 2: c}) == ('\U0010ffffbc', 3)

assert codecs.charmap_decode(b'\x00\x01\x02', 'strict', {0: sys.maxunicode, 1: b, 2: c}) == (chr(sys.maxunicode) + 'bc', 3)

try:
    codecs.charmap_decode(b'\x00\x01\x02', 'strict', {0: sys.maxunicode + 1, 1: b, 2: c})
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    codecs.charmap_decode(b'\x00\x01\x02', 'strict', {0: a, 1: b})
    raise AssertionError('expected UnicodeDecodeError')
except UnicodeDecodeError:
    pass

try:
    codecs.charmap_decode(b'\x00\x01\x02', 'strict', {0: a, 1: b, 2: 65534})
    raise AssertionError('expected UnicodeDecodeError')
except UnicodeDecodeError:
    pass

assert codecs.charmap_decode(b'\x00\x01\x02', 'replace', {0: a, 1: b}) == ('ab�', 3)

assert codecs.charmap_decode(b'\x00\x01\x02', 'replace', {0: a, 1: b, 2: 65534}) == ('ab�', 3)

assert codecs.charmap_decode(b'\x00\x01\x02', 'backslashreplace', {0: a, 1: b}) == ('ab\\x02', 3)

assert codecs.charmap_decode(b'\x00\x01\x02', 'backslashreplace', {0: a, 1: b, 2: 65534}) == ('ab\\x02', 3)

assert codecs.charmap_decode(b'\x00\x01\x02', 'ignore', {0: a, 1: b}) == ('ab', 3)

assert codecs.charmap_decode(b'\x00\x01\x02', 'ignore', {0: a, 1: b, 2: 65534}) == ('ab', 3)
print("CharmapTest::test_decode_with_int2int_map: ok")
