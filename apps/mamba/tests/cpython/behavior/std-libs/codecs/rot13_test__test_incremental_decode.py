...
# lib = "codecs"
# dimension = "behavior"
# case = "rot13_test__test_incremental_decode"
# subject = "cpython.test_codecs.Rot13Test.test_incremental_decode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::Rot13Test::test_incremental_decode
"""Auto-ported test: Rot13Test::test_incremental_decode (CPython 3.12 oracle)."""
...
assert plaintext == 'green Nerf rail gun'
print("Rot13Test::test_incremental_decode: ok")
