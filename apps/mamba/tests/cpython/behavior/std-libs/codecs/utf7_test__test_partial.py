...
# lib = "codecs"
# dimension = "behavior"
# case = "utf7_test__test_partial"
# subject = "cpython.test_codecs.UTF7Test.test_partial"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF7Test::test_partial
"""Auto-ported test: UTF7Test::test_partial (CPython 3.12 oracle)."""
...
check_partial('a+-b\x00c\x80dĀe𐀀f', ['a', 'a', 'a+', 'a+-', 'a+-b', 'a+-b', 'a+-b', 'a+-b', 'a+-b', 'a+-b\x00', 'a+-b\x00c', 'a+-b\x00c', 'a+-b\x00c', 'a+-b\x00c', 'a+-b\x00c', 'a+-b\x00c\x80', 'a+-b\x00c\x80d', 'a+-b\x00c\x80d', 'a+-b\x00c\x80d', 'a+-b\x00c\x80d', 'a+-b\x00c\x80d', 'a+-b\x00c\x80dĀ', 'a+-b\x00c\x80dĀe', 'a+-b\x00c\x80dĀe', 'a+-b\x00c\x80dĀe', 'a+-b\x00c\x80dĀe', 'a+-b\x00c\x80dĀe', 'a+-b\x00c\x80dĀe', 'a+-b\x00c\x80dĀe', 'a+-b\x00c\x80dĀe', 'a+-b\x00c\x80dĀe𐀀', 'a+-b\x00c\x80dĀe𐀀f'])
print("UTF7Test::test_partial: ok")
