...
# lib = "codecs"
# dimension = "behavior"
# case = "utf32_test__test_incremental_surrogatepass"
# subject = "cpython.test_codecs.UTF32Test.test_incremental_surrogatepass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF32Test::test_incremental_surrogatepass
"""Auto-ported test: UTF32Test::test_incremental_surrogatepass (CPython 3.12 oracle)."""
...
for i in range(1, len(data)):
    ...
    assert dec.decode(data[i:]) == '\udc02'
print("UTF32Test::test_incremental_surrogatepass: ok")
