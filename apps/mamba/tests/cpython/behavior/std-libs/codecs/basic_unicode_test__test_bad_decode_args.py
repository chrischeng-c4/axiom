...
# lib = "codecs"
# dimension = "behavior"
# case = "basic_unicode_test__test_bad_decode_args"
# subject = "cpython.test_codecs.BasicUnicodeTest.test_bad_decode_args"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::BasicUnicodeTest::test_bad_decode_args
"""Auto-ported test: BasicUnicodeTest::test_bad_decode_args (CPython 3.12 oracle)."""
...
for encoding in all_unicode_encodings:
    ...
    if encoding not in ('idna', 'punycode'):
        ...
        try:
            ...
            pass
print("BasicUnicodeTest::test_bad_decode_args: ok")
