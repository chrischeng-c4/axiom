...
# lib = "codecs"
# dimension = "behavior"
# case = "utf16_test__test_invalid_modes"
# subject = "cpython.test_codecs.UTF16Test.test_invalid_modes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF16Test::test_invalid_modes
"""Auto-ported test: UTF16Test::test_invalid_modes (CPython 3.12 oracle)."""
...
for mode in ('U', 'rU', 'r+U'):
    try:
        codecs.open(os_helper.TESTFN, mode, encoding=encoding)
        raise AssertionError('expected ValueError')
    except ValueError as _aR_e:
        import types as _types_aR
        cm = _types_aR.SimpleNamespace(exception=_aR_e)

    assert 'invalid mode' in str(cm.exception)
for mode in ('rt', 'wt', 'at', 'r+t'):
    ...
    assert "can't have text and binary mode at once" in str(cm.exception)
print("UTF16Test::test_invalid_modes: ok")
