...
# lib = "codecs"
# dimension = "behavior"
# case = "codecs_module_test__test_encode"
# subject = "cpython.test_codecs.CodecsModuleTest.test_encode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::CodecsModuleTest::test_encode
"""Auto-ported test: CodecsModuleTest::test_encode (CPython 3.12 oracle)."""
...
assert codecs.encode('äöü', 'latin-1') == b'\xe4\xf6\xfc'
...
try:
    codecs.encode('ÿff', 'ascii')
    raise AssertionError('expected UnicodeEncodeError')
except UnicodeEncodeError:
    pass

assert codecs.encode(obj='äöü', encoding='latin-1') == b'\xe4\xf6\xfc'

assert codecs.encode('[ÿ]', 'ascii', errors='ignore') == b'[]'
print("CodecsModuleTest::test_encode: ok")
