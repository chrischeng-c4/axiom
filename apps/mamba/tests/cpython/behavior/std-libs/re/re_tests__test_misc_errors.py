...
# lib = "re"
# dimension = "behavior"
# case = "re_tests__test_misc_errors"
# subject = "cpython.test_re.ReTests.test_misc_errors"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_re.py::ReTests::test_misc_errors
"""Auto-ported test: ReTests::test_misc_errors (CPython 3.12 oracle)."""
...
checkPatternError('(', 'missing ), unterminated subpattern', 0)
checkPatternError('((a|b)', 'missing ), unterminated subpattern', 0)
checkPatternError('(a|b))', 'unbalanced parenthesis', 5)
checkPatternError('(?P', 'unexpected end of pattern', 3)
checkPatternError('(?z)', 'unknown extension ?z', 1)
checkPatternError('(?iz)', 'unknown flag', 3)
checkPatternError('(?i', 'missing -, : or )', 3)
checkPatternError('(?#abc', 'missing ), unterminated comment', 0)
checkPatternError('(?<', 'unexpected end of pattern', 3)
checkPatternError('(?<>)', 'unknown extension ?<>', 1)
checkPatternError('(?', 'unexpected end of pattern', 2)
print("ReTests::test_misc_errors: ok")
