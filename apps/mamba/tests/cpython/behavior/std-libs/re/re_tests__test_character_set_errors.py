...
# lib = "re"
# dimension = "behavior"
# case = "re_tests__test_character_set_errors"
# subject = "cpython.test_re.ReTests.test_character_set_errors"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_re.py::ReTests::test_character_set_errors
"""Auto-ported test: ReTests::test_character_set_errors (CPython 3.12 oracle)."""
...
checkPatternError('[', 'unterminated character set', 0)
checkPatternError('[^', 'unterminated character set', 0)
checkPatternError('[a', 'unterminated character set', 0)
checkPatternError('[a-', 'unterminated character set', 0)
checkPatternError('[\\w-b]', 'bad character range \\w-b', 1)
checkPatternError('[a-\\w]', 'bad character range a-\\w', 1)
checkPatternError('[b-a]', 'bad character range b-a', 1)
print("ReTests::test_character_set_errors: ok")
