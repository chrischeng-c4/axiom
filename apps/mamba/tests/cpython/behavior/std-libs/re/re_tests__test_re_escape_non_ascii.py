...
# lib = "re"
# dimension = "behavior"
# case = "re_tests__test_re_escape_non_ascii"
# subject = "cpython.test_re.ReTests.test_re_escape_non_ascii"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_re.py::ReTests::test_re_escape_non_ascii
"""Auto-ported test: ReTests::test_re_escape_non_ascii (CPython 3.12 oracle)."""
...
assertMatch('.%s+.' % re.escape('☠'), s, 'x☠☠☠x', (2, 7), re.search)
print("ReTests::test_re_escape_non_ascii: ok")
