...
# lib = "unicode_file"
# dimension = "behavior"
# case = "test_unicode_files__test_directories"
# subject = "cpython.test_unicode_file.TestUnicodeFiles.test_directories"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode_file.py::TestUnicodeFiles::test_directories
"""Auto-ported test: TestUnicodeFiles::test_directories (CPython 3.12 oracle)."""
...
def _test_single(filename):
    ...
    try:
        ...
        os.unlink(filename)
ext = '.dir'
_do_directory(TESTFN_UNICODE + ext, TESTFN_UNICODE + ext)
if TESTFN_UNENCODABLE is not None:
    _do_directory(TESTFN_UNENCODABLE + ext, TESTFN_UNENCODABLE + ext)
print("TestUnicodeFiles::test_directories: ok")
