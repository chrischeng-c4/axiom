...
# lib = "mmap"
# dimension = "behavior"
# case = "mmap_tests__test_double_close"
# subject = "cpython.test_mmap.MmapTests.test_double_close"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mmap.py::MmapTests::test_double_close
"""Auto-ported test: MmapTests::test_double_close (CPython 3.12 oracle)."""
...
with open(TESTFN, 'rb') as f:
    ...
    mf.close()
    mf.close()
print("MmapTests::test_double_close: ok")
