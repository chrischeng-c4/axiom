...
# lib = "mmap"
# dimension = "behavior"
# case = "mmap_tests__test_read_invalid_arg"
# subject = "cpython.test_mmap.MmapTests.test_read_invalid_arg"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mmap.py::MmapTests::test_read_invalid_arg
"""Auto-ported test: MmapTests::test_read_invalid_arg (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("MmapTests::test_read_invalid_arg: ok")
