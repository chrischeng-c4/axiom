...
# lib = "mmap"
# dimension = "behavior"
# case = "mmap_tests__test_non_ascii_byte"
# subject = "cpython.test_mmap.MmapTests.test_non_ascii_byte"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mmap.py::MmapTests::test_non_ascii_byte
"""Auto-ported test: MmapTests::test_non_ascii_byte (CPython 3.12 oracle)."""
...
for b in (129, 200, 255):
    ...
    m.close()
print("MmapTests::test_non_ascii_byte: ok")
