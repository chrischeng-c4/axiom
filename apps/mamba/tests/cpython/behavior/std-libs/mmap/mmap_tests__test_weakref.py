...
# lib = "mmap"
# dimension = "behavior"
# case = "mmap_tests__test_weakref"
# subject = "cpython.test_mmap.MmapTests.test_weakref"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mmap.py::MmapTests::test_weakref
"""Auto-ported test: MmapTests::test_weakref (CPython 3.12 oracle)."""
...
assert wr() is None
print("MmapTests::test_weakref: ok")
