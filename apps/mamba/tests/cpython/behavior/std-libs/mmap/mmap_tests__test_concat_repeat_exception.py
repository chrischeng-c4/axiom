...
# lib = "mmap"
# dimension = "behavior"
# case = "mmap_tests__test_concat_repeat_exception"
# subject = "cpython.test_mmap.MmapTests.test_concat_repeat_exception"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mmap.py::MmapTests::test_concat_repeat_exception
"""Auto-ported test: MmapTests::test_concat_repeat_exception (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("MmapTests::test_concat_repeat_exception: ok")
