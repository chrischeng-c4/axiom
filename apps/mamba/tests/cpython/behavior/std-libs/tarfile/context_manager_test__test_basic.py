...
# lib = "tarfile"
# dimension = "behavior"
# case = "context_manager_test__test_basic"
# subject = "cpython.test_tarfile.ContextManagerTest.test_basic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tarfile.py::ContextManagerTest::test_basic
"""Auto-ported test: ContextManagerTest::test_basic (CPython 3.12 oracle)."""
...
with tarfile.open(tarname) as tar:
    ...
    assert not tar.closed

assert tar.closed
print("ContextManagerTest::test_basic: ok")
