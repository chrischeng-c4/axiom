...
# subject = "cpython.test_tarfile.CommandLineTest.test_create_command"
# kind = "semantic"
...
_suite = unittest.defaultTestLoader.loadTestsFromName("CommandLineTest.test_create_command", test_tarfile)
