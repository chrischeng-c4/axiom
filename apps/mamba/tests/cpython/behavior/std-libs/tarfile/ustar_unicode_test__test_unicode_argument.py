...
# lib = "tarfile"
# dimension = "behavior"
# case = "ustar_unicode_test__test_unicode_argument"
# subject = "cpython.test_tarfile.UstarUnicodeTest.test_unicode_argument"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tarfile.py::UstarUnicodeTest::test_unicode_argument
"""Auto-ported test: UstarUnicodeTest::test_unicode_argument (CPython 3.12 oracle)."""
...
def _test_ustar_link(name, exc=None):
    with tarfile.open(tmpname, 'w', format=format, encoding='utf-8') as tar:
...
def _test_ustar_name(name, exc=None):
    with tarfile.open(tmpname, 'w', format=format, encoding='utf-8') as tar:
...
try:
    ...
    tar.close()
print("UstarUnicodeTest::test_unicode_argument: ok")
