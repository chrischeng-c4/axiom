...
# lib = "tarfile"
# dimension = "behavior"
# case = "test_extraction_filters__test_fully_trusted_filter"
# subject = "cpython.test_tarfile.TestExtractionFilters.test_fully_trusted_filter"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tarfile.py::TestExtractionFilters::test_fully_trusted_filter
"""Auto-ported test: TestExtractionFilters::test_fully_trusted_filter (CPython 3.12 oracle)."""
...
with tarfile.TarFile.open(tarname) as tar:
    for tarinfo in tar.getmembers():
        ...
        assert filtered is tarinfo
print("TestExtractionFilters::test_fully_trusted_filter: ok")
