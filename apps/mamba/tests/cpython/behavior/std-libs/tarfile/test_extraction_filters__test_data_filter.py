...
# lib = "tarfile"
# dimension = "behavior"
# case = "test_extraction_filters__test_data_filter"
# subject = "cpython.test_tarfile.TestExtractionFilters.test_data_filter"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tarfile.py::TestExtractionFilters::test_data_filter
"""Auto-ported test: TestExtractionFilters::test_data_filter (CPython 3.12 oracle)."""
...
with tarfile.TarFile.open(tarname, encoding='iso8859-1') as tar:
    for tarinfo in tar.getmembers():
        ...
        assert filtered.name is tarinfo.name

        assert filtered.type is tarinfo.type
print("TestExtractionFilters::test_data_filter: ok")
