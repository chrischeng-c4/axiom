...
# lib = "tarfile"
# dimension = "behavior"
# case = "misc_test__test_read_number_fields"
# subject = "cpython.test_tarfile.MiscTest.test_read_number_fields"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tarfile.py::MiscTest::test_read_number_fields
"""Auto-ported test: MiscTest::test_read_number_fields (CPython 3.12 oracle)."""
...
assert tarfile.nti(b'0000001\x00') == 1

assert tarfile.nti(b'7777777\x00') == 2097151

assert tarfile.nti(b'\x80\x00\x00\x00\x00 \x00\x00') == 2097152

assert tarfile.nti(b'\x80\x00\x00\x00\xff\xff\xff\xff') == 4294967295

assert tarfile.nti(b'\xff\xff\xff\xff\xff\xff\xff\xff') == -1

assert tarfile.nti(b'\xff\xff\xff\xff\xff\xff\xff\x9c') == -100

assert tarfile.nti(b'\xff\x00\x00\x00\x00\x00\x00\x00') == -72057594037927936

assert tarfile.nti(b'\x00') == 0

assert tarfile.nti(b'       \x00') == 0
print("MiscTest::test_read_number_fields: ok")
