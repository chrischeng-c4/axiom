...
# lib = "tarfile"
# dimension = "behavior"
# case = "misc_test__test_char_fields"
# subject = "cpython.test_tarfile.MiscTest.test_char_fields"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tarfile.py::MiscTest::test_char_fields
"""Auto-ported test: MiscTest::test_char_fields (CPython 3.12 oracle)."""
...
assert tarfile.stn('foo', 8, 'ascii', 'strict') == b'foo\x00\x00\x00\x00\x00'

assert tarfile.stn('foobar', 3, 'ascii', 'strict') == b'foo'

assert tarfile.nts(b'foo\x00\x00\x00\x00\x00', 'ascii', 'strict') == 'foo'

assert tarfile.nts(b'foo\x00bar\x00', 'ascii', 'strict') == 'foo'
print("MiscTest::test_char_fields: ok")
