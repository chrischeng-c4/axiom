...
# lib = "timeit"
# dimension = "behavior"
# case = "test_timeit__test_reindent_multi"
# subject = "cpython.test_timeit.TestTimeit.test_reindent_multi"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_timeit.py::TestTimeit::test_reindent_multi
"""Auto-ported test: TestTimeit::test_reindent_multi (CPython 3.12 oracle)."""
...
assert timeit.reindent('print()\npass\nbreak', 4) == 'print()\n    pass\n    break'
print("TestTimeit::test_reindent_multi: ok")
