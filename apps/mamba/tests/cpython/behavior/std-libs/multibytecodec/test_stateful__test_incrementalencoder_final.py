...
# lib = "multibytecodec"
# dimension = "behavior"
# case = "test_stateful__test_incrementalencoder_final"
# subject = "cpython.test_multibytecodec.TestStateful.test_incrementalencoder_final"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_multibytecodec.py::TestStateful::test_incrementalencoder_final
"""Auto-ported test: TestStateful::test_incrementalencoder_final (CPython 3.12 oracle)."""
...
print("TestStateful::test_incrementalencoder_final: ok")
