...
# lib = "multibytecodec"
# dimension = "behavior"
# case = "test_hz_stateful__test_incrementalencoder"
# subject = "cpython.test_multibytecodec.TestHZStateful.test_incrementalencoder"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_multibytecodec.py::TestHZStateful::test_incrementalencoder
"""Auto-ported test: TestHZStateful::test_incrementalencoder (CPython 3.12 oracle)."""
...
print("TestHZStateful::test_incrementalencoder: ok")
