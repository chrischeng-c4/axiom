...
# lib = "tabnanny"
# dimension = "behavior"
# case = "test_check__test_when_tokenize_tokenerror"
# subject = "cpython.test_tabnanny.TestCheck.test_when_tokenize_tokenerror"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tabnanny.py::TestCheck::test_when_tokenize_tokenerror
"""Auto-ported test: TestCheck::test_when_tokenize_tokenerror (CPython 3.12 oracle)."""
...
with TemporaryPyFile(SOURCE_CODES['incomplete_expression']) as file_path:
    ...
    try:
        verify_tabnanny_check(file_path, err=err)
        raise AssertionError('expected SystemExit')
    except SystemExit:
        pass
print("TestCheck::test_when_tokenize_tokenerror: ok")
