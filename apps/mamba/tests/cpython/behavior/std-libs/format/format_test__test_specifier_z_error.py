...
# lib = "format"
# dimension = "behavior"
# case = "format_test__test_specifier_z_error"
# subject = "cpython.test_format.FormatTest.test_specifier_z_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_format.py::FormatTest::test_specifier_z_error
"""Auto-ported test: FormatTest::test_specifier_z_error (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(error_msg, str(_aR_e))
print("FormatTest::test_specifier_z_error: ok")
