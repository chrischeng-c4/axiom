...
# lib = "format"
# dimension = "behavior"
# case = "format_test__test_precision"
# subject = "cpython.test_format.FormatTest.test_precision"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_format.py::FormatTest::test_precision
"""Auto-ported test: FormatTest::test_precision (CPython 3.12 oracle)."""
...
assert format(f, '.0f') == '1'

assert format(f, '.3f') == '1.200'
try:
...
assert format(c, '.0f') == '1+0j'

assert format(c, '.3f') == '1.200+0.000j'
try:
    ...
    import types as _types_aR
    cm = _types_aR.SimpleNamespace(exception=_aR_e)
print("FormatTest::test_precision: ok")
