...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_issue14072"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_issue14072"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_issue14072
"""Auto-ported test: UrlParseTestCase::test_issue14072 (CPython 3.12 oracle)."""
...
assert p1.path == '+31-641044153'
p2 = urllib.parse.urlsplit('tel:+31641044153')

assert p2.scheme == 'tel'

assert p2.path == '+31641044153'
...
assert p2.path == '+31641044153'
print("UrlParseTestCase::test_issue14072: ok")
