...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "utility_tests__test_splituser"
# subject = "cpython.test_urlparse.Utility_Tests.test_splituser"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::Utility_Tests::test_splituser
"""Auto-ported test: Utility_Tests::test_splituser (CPython 3.12 oracle)."""
...
assert splituser('User:Pass@www.python.org:080') == ('User:Pass', 'www.python.org:080')

assert splituser('@www.python.org:080') == ('', 'www.python.org:080')

assert splituser('www.python.org:080') == (None, 'www.python.org:080')

assert splituser('User:Pass@') == ('User:Pass', '')

assert splituser('User@example.com:Pass@www.python.org:080') == ('User@example.com:Pass', 'www.python.org:080')
print("Utility_Tests::test_splituser: ok")
