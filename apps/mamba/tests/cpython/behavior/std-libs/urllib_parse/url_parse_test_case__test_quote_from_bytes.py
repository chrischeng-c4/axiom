...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_quote_from_bytes"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_quote_from_bytes"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_quote_from_bytes
"""Auto-ported test: UrlParseTestCase::test_quote_from_bytes (CPython 3.12 oracle)."""
...
try:
    urllib.parse.quote_from_bytes('foo')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
result = urllib.parse.quote_from_bytes(b'archaeological arcana')

assert result == 'archaeological%20arcana'
result = urllib.parse.quote_from_bytes(b'')

assert result == ''
result = urllib.parse.quote_from_bytes(b'A' * 10000)

assert result == 'A' * 10000
result = urllib.parse.quote_from_bytes(b'z\x01/ ' * 253183)

assert result == 'z%01/%20' * 253183
print("UrlParseTestCase::test_quote_from_bytes: ok")
