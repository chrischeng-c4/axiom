...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_parse_qsl_bytes"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_parse_qsl_bytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_parse_qsl_bytes
"""Auto-ported test: UrlParseTestCase::test_parse_qsl_bytes (CPython 3.12 oracle)."""
...
assert urllib.parse.parse_qsl(b'a=b') == [(b'a', b'b')]

assert urllib.parse.parse_qsl(bytearray(b'a=b')) == [(b'a', b'b')]

assert urllib.parse.parse_qsl(memoryview(b'a=b')) == [(b'a', b'b')]
print("UrlParseTestCase::test_parse_qsl_bytes: ok")
