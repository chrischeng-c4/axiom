...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "utility_tests__test_splittype"
# subject = "cpython.test_urlparse.Utility_Tests.test_splittype"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::Utility_Tests::test_splittype
"""Auto-ported test: Utility_Tests::test_splittype (CPython 3.12 oracle)."""
...
assert splittype('type:opaquestring') == ('type', 'opaquestring')

assert splittype('opaquestring') == (None, 'opaquestring')

assert splittype(':opaquestring') == (None, ':opaquestring')

assert splittype('type:') == ('type', '')

assert splittype('type:opaque:string') == ('type', 'opaque:string')
print("Utility_Tests::test_splittype: ok")
