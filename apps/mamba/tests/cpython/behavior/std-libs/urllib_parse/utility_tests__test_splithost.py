...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "utility_tests__test_splithost"
# subject = "cpython.test_urlparse.Utility_Tests.test_splithost"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::Utility_Tests::test_splithost
"""Auto-ported test: Utility_Tests::test_splithost (CPython 3.12 oracle)."""
...
assert splithost('//www.example.org:80/foo/bar/baz.html') == ('www.example.org:80', '/foo/bar/baz.html')

assert splithost('//www.example.org:80') == ('www.example.org:80', '')

assert splithost('/foo/bar/baz.html') == (None, '/foo/bar/baz.html')

assert splithost('//127.0.0.1#@host.com') == ('127.0.0.1', '/#@host.com')

assert splithost('//127.0.0.1#@host.com:80') == ('127.0.0.1', '/#@host.com:80')

assert splithost('//127.0.0.1:80#@host.com') == ('127.0.0.1:80', '/#@host.com')

assert splithost('///file') == ('', '/file')

assert splithost('//example.net/file;') == ('example.net', '/file;')

assert splithost('//example.net/file?') == ('example.net', '/file?')

assert splithost('//example.net/file#') == ('example.net', '/file#')
print("Utility_Tests::test_splithost: ok")
