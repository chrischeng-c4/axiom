...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_quote_errors"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_quote_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_quote_errors
"""Auto-ported test: UrlParseTestCase::test_quote_errors (CPython 3.12 oracle)."""
...
try:
    urllib.parse.quote(b'foo', encoding='utf-8')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    urllib.parse.quote(b'foo', errors='strict')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("UrlParseTestCase::test_quote_errors: ok")
