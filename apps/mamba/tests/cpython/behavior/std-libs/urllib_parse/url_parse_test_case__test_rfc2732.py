...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_rfc2732"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_RFC2732"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_RFC2732
"""Auto-ported test: UrlParseTestCase::test_RFC2732 (CPython 3.12 oracle)."""
...
for url, hostname, port in str_cases + bytes_cases:
    ...
    assert (urlparsed.hostname, urlparsed.port) == (hostname, port)
...
for invalid_url in str_cases + bytes_cases:
    ...
    try:
        ...
        pass
print("UrlParseTestCase::test_RFC2732: ok")
