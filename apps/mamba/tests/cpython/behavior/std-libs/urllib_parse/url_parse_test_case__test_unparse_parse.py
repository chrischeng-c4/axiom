...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_unparse_parse"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_unparse_parse"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_unparse_parse
"""Auto-ported test: UrlParseTestCase::test_unparse_parse (CPython 3.12 oracle)."""
...
for u in str_cases + bytes_cases:
    ...
    assert urllib.parse.urlunsplit(urllib.parse.urlsplit(u)) == u

    assert urllib.parse.urlunparse(urllib.parse.urlparse(u)) == u
print("UrlParseTestCase::test_unparse_parse: ok")
