...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_parse_qsl_false_value"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_parse_qsl_false_value"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_parse_qsl_false_value
"""Auto-ported test: UrlParseTestCase::test_parse_qsl_false_value (CPython 3.12 oracle)."""
...
for x in ('', b'', None, 0, 0.0, [], {}, memoryview(b'')):
    ...
    assert urllib.parse.parse_qsl(x, **kwargs) == []

    try:
        urllib.parse.parse_qsl(x, separator=1)
        raise AssertionError('expected ValueError')
    except ValueError:
        pass
print("UrlParseTestCase::test_parse_qsl_false_value: ok")
