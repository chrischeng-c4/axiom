...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_mixed_types_rejected"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_mixed_types_rejected"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_mixed_types_rejected
"""Auto-ported test: UrlParseTestCase::test_mixed_types_rejected (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot mix str', str(_aR_e))
try:
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot mix str', str(_aR_e))
print("UrlParseTestCase::test_mixed_types_rejected: ok")
