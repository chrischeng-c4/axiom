...
# lib = "configparser"
# dimension = "behavior"
# case = "raw_config_parser_test_case_non_standard_delimiters__test_items"
# subject = "cpython.test_configparser.RawConfigParserTestCaseNonStandardDelimiters.test_items"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::RawConfigParserTestCaseNonStandardDelimiters::test_items
"""Auto-ported test: RawConfigParserTestCaseNonStandardDelimiters::test_items (CPython 3.12 oracle)."""
...
def parse_error(cf, exc, src):
    ...
    try:
        ...
        cm = _types_aR.SimpleNamespace(exception=_aR_e)
    return cm.exception
check_items_config([('default', '<default>'), ('getdefault', '|%(default)s|'), ('key', '|%(name)s|'), ('name', '%(value)s')])
print("RawConfigParserTestCaseNonStandardDelimiters::test_items: ok")
