...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_no_value__test_interpolation_missing_value"
# subject = "cpython.test_configparser.ConfigParserTestCaseNoValue.test_interpolation_missing_value"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNoValue::test_interpolation_missing_value
"""Auto-ported test: ConfigParserTestCaseNoValue::test_interpolation_missing_value (CPython 3.12 oracle)."""
...
if interpolation == configparser._UNSET:
    ...
    assert e.args == ('name', 'Interpolation Error', '%(reference)s', 'reference')
print("ConfigParserTestCaseNoValue::test_interpolation_missing_value: ok")
