...
# lib = "configparser"
# dimension = "behavior"
# case = "strict_test_case__test_setitem"
# subject = "cpython.test_configparser.StrictTestCase.test_setitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::StrictTestCase::test_setitem
"""Auto-ported test: StrictTestCase::test_setitem (CPython 3.12 oracle)."""
...
assert set(cf['section2'].keys()) == {'name22'}
print("StrictTestCase::test_setitem: ok")
