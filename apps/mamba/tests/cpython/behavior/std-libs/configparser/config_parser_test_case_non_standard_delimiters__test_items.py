...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_non_standard_delimiters__test_items"
# subject = "cpython.test_configparser.ConfigParserTestCaseNonStandardDelimiters.test_items"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNonStandardDelimiters::test_items
"""Auto-ported test: ConfigParserTestCaseNonStandardDelimiters::test_items (CPython 3.12 oracle)."""
...
def parse_error(cf, exc, src):
    ...
    try:
        ...
        cm = _types_aR.SimpleNamespace(exception=_aR_e)
    return cm.exception
check_items_config([('default', '<default>'), ('getdefault', '|<default>|'), ('key', '|value|'), ('name', 'value')])
print("ConfigParserTestCaseNonStandardDelimiters::test_items: ok")
