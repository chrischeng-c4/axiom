...
# lib = "configparser"
# dimension = "behavior"
# case = "sorted_test_case__test_defaults_keyword"
# subject = "cpython.test_configparser.SortedTestCase.test_defaults_keyword"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::SortedTestCase::test_defaults_keyword
"""Auto-ported test: SortedTestCase::test_defaults_keyword (CPython 3.12 oracle)."""
...
assert str(err) == "'int' object has no attribute 'lower'"
cf = newconfig(defaults={'A': 5.2})

assert abs(cf[default_section]['a'] - 5.2) < 1e-07
print("SortedTestCase::test_defaults_keyword: ok")
