...
# lib = "configparser"
# dimension = "behavior"
# case = "exception_pickling_test_case__test_parsingerror"
# subject = "cpython.test_configparser.ExceptionPicklingTestCase.test_parsingerror"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_configparser.py::ExceptionPicklingTestCase::test_parsingerror
"""Auto-ported test: ExceptionPicklingTestCase::test_parsingerror (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert repr(e1) == repr(e2)
print("ExceptionPicklingTestCase::test_parsingerror: ok")
