...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_no_interpolation__test_none_as_default_interpolation"
# subject = "cpython.test_configparser.ConfigParserTestCaseNoInterpolation.test_none_as_default_interpolation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNoInterpolation::test_none_as_default_interpolation
"""Auto-ported test: ConfigParserTestCaseNoInterpolation::test_none_as_default_interpolation (CPython 3.12 oracle)."""
...
cf.read_string(ini)
assertMatchesIni(cf)
print("ConfigParserTestCaseNoInterpolation::test_none_as_default_interpolation: ok")
