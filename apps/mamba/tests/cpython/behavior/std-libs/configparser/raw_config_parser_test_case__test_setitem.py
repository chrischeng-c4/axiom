...
# lib = "configparser"
# dimension = "behavior"
# case = "raw_config_parser_test_case__test_setitem"
# subject = "cpython.test_configparser.RawConfigParserTestCase.test_setitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::RawConfigParserTestCase::test_setitem
"""Auto-ported test: RawConfigParserTestCase::test_setitem (CPython 3.12 oracle)."""
...
assert set(cf['section2'].keys()) == {'name22'}
print("RawConfigParserTestCase::test_setitem: ok")
