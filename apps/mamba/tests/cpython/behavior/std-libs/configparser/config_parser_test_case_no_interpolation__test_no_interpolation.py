...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_no_interpolation__test_no_interpolation"
# subject = "cpython.test_configparser.ConfigParserTestCaseNoInterpolation.test_no_interpolation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNoInterpolation::test_no_interpolation
"""Auto-ported test: ConfigParserTestCaseNoInterpolation::test_no_interpolation (CPython 3.12 oracle)."""
...
cf = fromstring(ini)
assertMatchesIni(cf)
print("ConfigParserTestCaseNoInterpolation::test_no_interpolation: ok")
