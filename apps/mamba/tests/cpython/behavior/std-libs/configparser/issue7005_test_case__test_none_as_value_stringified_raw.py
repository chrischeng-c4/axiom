...
# lib = "configparser"
# dimension = "behavior"
# case = "issue7005_test_case__test_none_as_value_stringified_raw"
# subject = "cpython.test_configparser.Issue7005TestCase.test_none_as_value_stringified_raw"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::Issue7005TestCase::test_none_as_value_stringified_raw
"""Auto-ported test: Issue7005TestCase::test_none_as_value_stringified_raw (CPython 3.12 oracle)."""
...
def prepare(config_class):
    ...
    cp.write(sio)
    return sio.getvalue()
output = prepare(configparser.RawConfigParser)

assert output == expected_output
print("Issue7005TestCase::test_none_as_value_stringified_raw: ok")
