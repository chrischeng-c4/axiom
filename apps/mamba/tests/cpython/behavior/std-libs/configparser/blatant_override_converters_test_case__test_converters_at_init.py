...
# lib = "configparser"
# dimension = "behavior"
# case = "blatant_override_converters_test_case__test_converters_at_init"
# subject = "cpython.test_configparser.BlatantOverrideConvertersTestCase.test_converters_at_init"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::BlatantOverrideConvertersTestCase::test_converters_at_init
"""Auto-ported test: BlatantOverrideConvertersTestCase::test_converters_at_init (CPython 3.12 oracle)."""
...
assert cfg.converters['len'] is not None
print("BlatantOverrideConvertersTestCase::test_converters_at_init: ok")
