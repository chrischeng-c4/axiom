...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_extended_interpolation__test_popitem"
# subject = "cpython.test_configparser.ConfigParserTestCaseExtendedInterpolation.test_popitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseExtendedInterpolation::test_popitem
"""Auto-ported test: ConfigParserTestCaseExtendedInterpolation::test_popitem (CPython 3.12 oracle)."""
...
assert cf.popitem()[0] == 'section1'

assert cf.popitem()[0] == 'section2'

assert cf.popitem()[0] == 'section3'
try:
    cf.popitem()
    raise AssertionError('expected KeyError')
except KeyError:
    pass
print("ConfigParserTestCaseExtendedInterpolation::test_popitem: ok")
