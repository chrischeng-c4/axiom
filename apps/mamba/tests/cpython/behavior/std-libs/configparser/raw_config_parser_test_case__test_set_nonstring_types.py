...
# lib = "configparser"
# dimension = "behavior"
# case = "raw_config_parser_test_case__test_set_nonstring_types"
# subject = "cpython.test_configparser.RawConfigParserTestCase.test_set_nonstring_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::RawConfigParserTestCase::test_set_nonstring_types
"""Auto-ported test: RawConfigParserTestCase::test_set_nonstring_types (CPython 3.12 oracle)."""
...
assert cf.get('non-string', 'int') == 1

assert cf.get('non-string', 'list') == [0, 1, 1, 2, 3, 5, 8, 13]

assert cf.get('non-string', 'dict') == {'pi': 3.14159}
cf.add_section(123)
cf.set(123, 'this is sick', True)

assert cf.get(123, 'this is sick') == True
if cf._dict is configparser._default_dict:
    cf.optionxform = lambda x: x
    cf.set('non-string', 1, 1)

    assert cf.get('non-string', 1) == 1
print("RawConfigParserTestCase::test_set_nonstring_types: ok")
