...
# lib = "configparser"
# dimension = "behavior"
# case = "strict_test_case__test_boolean"
# subject = "cpython.test_configparser.StrictTestCase.test_boolean"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::StrictTestCase::test_boolean
"""Auto-ported test: StrictTestCase::test_boolean (CPython 3.12 oracle)."""
...
for x in range(1, 5):
    ...
    try:
        ...
        pass
print("StrictTestCase::test_boolean: ok")
