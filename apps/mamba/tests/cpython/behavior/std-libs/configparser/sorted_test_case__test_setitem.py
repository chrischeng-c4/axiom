...
# lib = "configparser"
# dimension = "behavior"
# case = "sorted_test_case__test_setitem"
# subject = "cpython.test_configparser.SortedTestCase.test_setitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::SortedTestCase::test_setitem
"""Auto-ported test: SortedTestCase::test_setitem (CPython 3.12 oracle)."""
...
assert set(cf['section2'].keys()) == {'name22'}
print("SortedTestCase::test_setitem: ok")
