...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_non_standard_delimiters__test_setitem"
# subject = "cpython.test_configparser.ConfigParserTestCaseNonStandardDelimiters.test_setitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNonStandardDelimiters::test_setitem
"""Auto-ported test: ConfigParserTestCaseNonStandardDelimiters::test_setitem (CPython 3.12 oracle)."""
...
assert set(cf['section2'].keys()) == {'name22'}
print("ConfigParserTestCaseNonStandardDelimiters::test_setitem: ok")
