...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_extended_interpolation__test_write"
# subject = "cpython.test_configparser.ConfigParserTestCaseExtendedInterpolation.test_write"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseExtendedInterpolation::test_write
"""Auto-ported test: ConfigParserTestCaseExtendedInterpolation::test_write (CPython 3.12 oracle)."""
...
def parse_error(cf, exc, src):
    ...
    try:
        ...
        cm = _types_aR.SimpleNamespace(exception=_aR_e)
    return cm.exception
config_string = '[Long Line]\nfoo{0[0]} this line is much, much longer than my editor\n   likes it.\n[{default_section}]\nfoo{0[1]} another very\n long line\n[Long Line - With Comments!]\ntest {0[1]} we        {comment} can\n            also      {comment} place\n            comments  {comment} in\n            multiline {comment} values\n'.format(delimiters, comment=comment_prefixes[0], default_section=default_section)
if allow_no_value:
...
for space_around_delimiters in (True, False):
    ...
    expect_string = '[{default_section}]\nfoo{equals}another very\n\tlong line\n\n[Long Line]\nfoo{equals}this line is much, much longer than my editor\n\tlikes it.\n\n[Long Line - With Comments!]\ntest{equals}we\n\talso\n\tcomments\n\tmultiline\n\n'.format(equals=delimiter, default_section=default_section)
    if allow_no_value:
        expect_string += '[Valueless]\noption-without-value\n\n'

    assert output.getvalue() == expect_string
print("ConfigParserTestCaseExtendedInterpolation::test_write: ok")
