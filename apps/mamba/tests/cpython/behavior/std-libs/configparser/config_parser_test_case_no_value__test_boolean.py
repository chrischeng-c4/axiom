...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_no_value__test_boolean"
# subject = "cpython.test_configparser.ConfigParserTestCaseNoValue.test_boolean"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNoValue::test_boolean
"""Auto-ported test: ConfigParserTestCaseNoValue::test_boolean (CPython 3.12 oracle)."""
...
for x in range(1, 5):
    ...
    try:
        ...
        pass
print("ConfigParserTestCaseNoValue::test_boolean: ok")
