...
# lib = "gzip"
# dimension = "behavior"
# case = "test_gzip__test_write_bytearray"
# subject = "cpython.test_gzip.TestGzip.test_write_bytearray"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_gzip.py::TestGzip::test_write_bytearray
"""Auto-ported test: TestGzip::test_write_bytearray (CPython 3.12 oracle)."""
...
write_and_read_back(bytearray(data1 * 50))
print("TestGzip::test_write_bytearray: ok")
