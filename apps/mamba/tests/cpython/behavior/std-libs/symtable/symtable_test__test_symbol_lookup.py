...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_symbol_lookup"
# subject = "cpython.test_symtable.SymtableTest.test_symbol_lookup"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_symbol_lookup
"""Auto-ported test: SymtableTest::test_symbol_lookup (CPython 3.12 oracle)."""
...
assert len(top.get_identifiers()) == len(top.get_symbols())
...
try:
    ...
    pass
print("SymtableTest::test_symbol_lookup: ok")
