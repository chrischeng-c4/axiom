...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_namespaces"
# subject = "cpython.test_symtable.SymtableTest.test_namespaces"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_namespaces
"""Auto-ported test: SymtableTest::test_namespaces (CPython 3.12 oracle)."""
...
assert not spam.lookup('x').is_namespace()

assert top.lookup('spam').get_namespace() is spam
ns_test = top.lookup('namespace_test')

assert len(ns_test.get_namespaces()) == 2

try:
    ns_test.get_namespace()
    raise AssertionError('expected ValueError')
except ValueError:
    pass
ns_test_2 = top.lookup('glob')

assert len(ns_test_2.get_namespaces()) == 0

try:
    ns_test_2.get_namespace()
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("SymtableTest::test_namespaces: ok")
