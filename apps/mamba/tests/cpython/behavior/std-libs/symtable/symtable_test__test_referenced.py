...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_referenced"
# subject = "cpython.test_symtable.SymtableTest.test_referenced"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_referenced
"""Auto-ported test: SymtableTest::test_referenced (CPython 3.12 oracle)."""
...
assert not spam.lookup('x').is_referenced()
print("SymtableTest::test_referenced: ok")
