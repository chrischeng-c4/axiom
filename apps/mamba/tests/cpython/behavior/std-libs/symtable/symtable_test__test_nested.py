...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_nested"
# subject = "cpython.test_symtable.SymtableTest.test_nested"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_nested
"""Auto-ported test: SymtableTest::test_nested (CPython 3.12 oracle)."""
...
assert not top.is_nested()

assert not Mine.is_nested()

assert not spam.is_nested()

assert internal.is_nested()
print("SymtableTest::test_nested: ok")
