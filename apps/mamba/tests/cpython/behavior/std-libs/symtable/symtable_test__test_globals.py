...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_globals"
# subject = "cpython.test_symtable.SymtableTest.test_globals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_globals
"""Auto-ported test: SymtableTest::test_globals (CPython 3.12 oracle)."""
...
assert not spam.lookup('glob').is_declared_global()

assert spam.lookup('bar').is_global()

assert spam.lookup('bar').is_declared_global()

assert not internal.lookup('x').is_global()

assert not Mine.lookup('instance_var').is_global()
...
print("SymtableTest::test_globals: ok")
