...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_name"
# subject = "cpython.test_symtable.SymtableTest.test_name"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_name
"""Auto-ported test: SymtableTest::test_name (CPython 3.12 oracle)."""
...
assert top.get_name() == 'top'

assert spam.get_name() == 'spam'

assert spam.lookup('x').get_name() == 'x'

assert Mine.get_name() == 'Mine'
print("SymtableTest::test_name: ok")
