...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_id"
# subject = "cpython.test_symtable.SymtableTest.test_id"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_id
"""Auto-ported test: SymtableTest::test_id (CPython 3.12 oracle)."""
...
assert Mine.get_id() > 0

assert a_method.get_id() > 0

assert spam.get_id() > 0

assert internal.get_id() > 0

assert foo.get_id() > 0

assert Alias.get_id() > 0

assert GenericAlias.get_id() > 0

assert generic_spam.get_id() > 0

assert GenericMine.get_id() > 0
print("SymtableTest::test_id: ok")
