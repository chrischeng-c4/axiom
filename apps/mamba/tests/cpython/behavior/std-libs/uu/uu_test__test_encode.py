...
# lib = "uu"
# dimension = "behavior"
# case = "uu_test__test_encode"
# subject = "cpython.test_uu.UUTest.test_encode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_uu.py::UUTest::test_encode
"""Auto-ported test: UUTest::test_encode (CPython 3.12 oracle)."""
...
assert out.getvalue() == encodedtextwrapped(438, 't1')
inp = io.BytesIO(plaintext)
out = io.BytesIO()
uu.encode(inp, out, 't1', 420)

assert out.getvalue() == encodedtextwrapped(420, 't1')
inp = io.BytesIO(plaintext)
out = io.BytesIO()
uu.encode(inp, out, 't1', backtick=True)

assert out.getvalue() == encodedtextwrapped(438, 't1', True)
try:
    uu.encode(inp, out, 't1', 420, True)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("UUTest::test_encode: ok")
