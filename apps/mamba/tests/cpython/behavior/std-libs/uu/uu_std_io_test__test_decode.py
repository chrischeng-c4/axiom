...
# lib = "uu"
# dimension = "behavior"
# case = "uu_std_io_test__test_decode"
# subject = "cpython.test_uu.UUStdIOTest.test_decode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_uu.py::UUStdIOTest::test_decode
"""Auto-ported test: UUStdIOTest::test_decode (CPython 3.12 oracle)."""
...
uu.decode('-', '-')
stdout = sys.stdout
sys.stdout = self_stdout
sys.stdin = self_stdin

assert stdout.getvalue() == plaintext.decode('ascii')
print("UUStdIOTest::test_decode: ok")
