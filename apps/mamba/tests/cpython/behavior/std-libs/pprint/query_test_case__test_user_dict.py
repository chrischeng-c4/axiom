...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_user_dict"
# subject = "cpython.test_pprint.QueryTestCase.test_user_dict"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_user_dict
"""Auto-ported test: QueryTestCase::test_user_dict (CPython 3.12 oracle)."""
...
assert pprint.pformat(d) == "{'a': 6,\n 'brown': 2,\n 'dog': 8,\n 'fox': 3,\n 'jumped': 4,\n 'lazy': 7,\n 'over': 5,\n 'quick': 1,\n 'the': 0}"
print("QueryTestCase::test_user_dict: ok")
