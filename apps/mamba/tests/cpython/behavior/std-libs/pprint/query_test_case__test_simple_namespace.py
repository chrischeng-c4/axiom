...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_simple_namespace"
# subject = "cpython.test_pprint.QueryTestCase.test_simple_namespace"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_simple_namespace
"""Auto-ported test: QueryTestCase::test_simple_namespace (CPython 3.12 oracle)."""
...
assert formatted == 'namespace(the=0,\n          quick=1,\n          brown=2,\n          fox=3,\n          jumped=4,\n          over=5,\n          a=6,\n          lazy=7,\n          dog=8)'
print("QueryTestCase::test_simple_namespace: ok")
