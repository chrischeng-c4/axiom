...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_subclassing"
# subject = "cpython.test_pprint.QueryTestCase.test_subclassing"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_subclassing
"""Auto-ported test: QueryTestCase::test_subclassing (CPython 3.12 oracle)."""
...
assert dotted_printer.pformat(o) == exp
o1 = ['with space']
exp1 = "['with space']"

assert dotted_printer.pformat(o1) == exp1
o2 = ['without.space']
exp2 = '[without.space]'

assert dotted_printer.pformat(o2) == exp2
print("QueryTestCase::test_subclassing: ok")
