...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_cyclic_dataclass"
# subject = "cpython.test_pprint.QueryTestCase.test_cyclic_dataclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_cyclic_dataclass
"""Auto-ported test: QueryTestCase::test_cyclic_dataclass (CPython 3.12 oracle)."""
...
assert formatted == 'dataclass5(a=dataclass6(c=...,\n                        d=1),\n           b=1)'
print("QueryTestCase::test_cyclic_dataclass: ok")
