...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_basic"
# subject = "cpython.test_pprint.QueryTestCase.test_basic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_basic
"""Auto-ported test: QueryTestCase::test_basic (CPython 3.12 oracle)."""
...
for safe in (2, 2.0, 2j, 'abc', [3], (2, 2), {3: 3}, b'def', bytearray(b'ghi'), True, False, None, ..., self_a, self_b):
...
print("QueryTestCase::test_basic: ok")
