...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_counter"
# subject = "cpython.test_pprint.QueryTestCase.test_counter"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_counter
"""Auto-ported test: QueryTestCase::test_counter (CPython 3.12 oracle)."""
...
assert pprint.pformat(d, width=1) == 'Counter()'
d = collections.Counter('senselessness')

assert pprint.pformat(d, width=40) == "Counter({'s': 6,\n         'e': 4,\n         'n': 2,\n         'l': 1})"
print("QueryTestCase::test_counter: ok")
