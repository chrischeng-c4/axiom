...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_mapping_proxy"
# subject = "cpython.test_pprint.QueryTestCase.test_mapping_proxy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_mapping_proxy
"""Auto-ported test: QueryTestCase::test_mapping_proxy (CPython 3.12 oracle)."""
...
assert pprint.pformat(m) == "mappingproxy({'a': 6,\n              'brown': 2,\n              'dog': 8,\n              'fox': 3,\n              'jumped': 4,\n              'lazy': 7,\n              'over': 5,\n              'quick': 1,\n              'the': 0})"
d = collections.OrderedDict(zip(words, itertools.count()))
m = types.MappingProxyType(d)

assert pprint.pformat(m) == "mappingproxy(OrderedDict([('the', 0),\n                          ('quick', 1),\n                          ('brown', 2),\n                          ('fox', 3),\n                          ('jumped', 4),\n                          ('over', 5),\n                          ('a', 6),\n                          ('lazy', 7),\n                          ('dog', 8)]))"
print("QueryTestCase::test_mapping_proxy: ok")
