...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_depth"
# subject = "cpython.test_pprint.QueryTestCase.test_depth"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_depth
"""Auto-ported test: QueryTestCase::test_depth (CPython 3.12 oracle)."""
...
assert pprint.pformat(nested_tuple, depth=1) == lv1_tuple

assert pprint.pformat(nested_dict, depth=1) == lv1_dict

assert pprint.pformat(nested_list, depth=1) == lv1_list
print("QueryTestCase::test_depth: ok")
