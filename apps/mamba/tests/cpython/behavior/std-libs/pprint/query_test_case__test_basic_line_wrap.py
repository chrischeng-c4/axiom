...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_basic_line_wrap"
# subject = "cpython.test_pprint.QueryTestCase.test_basic_line_wrap"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_basic_line_wrap
"""Auto-ported test: QueryTestCase::test_basic_line_wrap (CPython 3.12 oracle)."""
...
for type in [dict, dict2]:
    ...
    assert pprint.pformat(type(o)) == exp
o = range(100)
exp = '[%s]' % ',\n '.join(map(str, o))
...
for type in [list, list2]:
    ...
    assert pprint.pformat(type(o), indent=4) == exp
print("QueryTestCase::test_basic_line_wrap: ok")
