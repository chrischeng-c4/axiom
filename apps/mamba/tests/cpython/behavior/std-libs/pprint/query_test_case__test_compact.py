...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_compact"
# subject = "cpython.test_pprint.QueryTestCase.test_compact"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_compact
"""Auto-ported test: QueryTestCase::test_compact (CPython 3.12 oracle)."""
...
assert pprint.pformat(o, width=47, compact=True) == expected
print("QueryTestCase::test_compact: ok")
