...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_sorted_dict"
# subject = "cpython.test_pprint.QueryTestCase.test_sorted_dict"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_sorted_dict
"""Auto-ported test: QueryTestCase::test_sorted_dict (CPython 3.12 oracle)."""
...
assert pprint.pformat([d, d]) == "[{'a': 1, 'b': 1, 'c': 1}, {'a': 1, 'b': 1, 'c': 1}]"

assert pprint.pformat({'xy\tab\n': (3,), 5: [[]], (): {}}) == "{5: [[]], 'xy\\tab\\n': (3,), (): {}}"
print("QueryTestCase::test_sorted_dict: ok")
