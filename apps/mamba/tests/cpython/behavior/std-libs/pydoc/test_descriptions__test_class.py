...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_class"
# subject = "cpython.test_pydoc.TestDescriptions.test_class"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_class
"""Auto-ported test: TestDescriptions::test_class (CPython 3.12 oracle)."""
...
assert pydoc.describe(C) == 'class C'

assert pydoc.describe(c) == 'C'
expected = 'C in module %s object' % __name__

assert expected in pydoc.render_doc(c)
print("TestDescriptions::test_class: ok")
