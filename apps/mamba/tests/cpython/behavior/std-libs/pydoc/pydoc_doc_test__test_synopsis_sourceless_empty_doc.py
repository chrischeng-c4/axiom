...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_doc_test__test_synopsis_sourceless_empty_doc"
# subject = "cpython.test_pydoc.PydocDocTest.test_synopsis_sourceless_empty_doc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocDocTest::test_synopsis_sourceless_empty_doc
"""Auto-ported test: PydocDocTest::test_synopsis_sourceless_empty_doc (CPython 3.12 oracle)."""
...
with os_helper.temp_cwd() as test_dir:
    ...
    assert synopsis_cached is None
print("PydocDocTest::test_synopsis_sourceless_empty_doc: ok")
