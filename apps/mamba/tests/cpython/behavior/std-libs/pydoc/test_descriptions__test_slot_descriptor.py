...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_slot_descriptor"
# subject = "cpython.test_pydoc.TestDescriptions.test_slot_descriptor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_slot_descriptor
"""Auto-ported test: TestDescriptions::test_slot_descriptor (CPython 3.12 oracle)."""
...
assert _get_summary_line(Point.x) == 'x'
print("TestDescriptions::test_slot_descriptor: ok")
