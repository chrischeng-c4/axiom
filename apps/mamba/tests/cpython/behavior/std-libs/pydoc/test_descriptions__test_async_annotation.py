...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_async_annotation"
# subject = "cpython.test_pydoc.TestDescriptions.test_async_annotation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_async_annotation
"""Auto-ported test: TestDescriptions::test_async_annotation (CPython 3.12 oracle)."""
...
assert 'async coro_function' in text
html = pydoc.HTMLDoc().document(coro_function)

assert 'async <a name="-coro_function"><strong>coro_function' in html
print("TestDescriptions::test_async_annotation: ok")
