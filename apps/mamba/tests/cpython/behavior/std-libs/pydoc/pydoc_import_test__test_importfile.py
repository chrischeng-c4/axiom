...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_import_test__test_importfile"
# subject = "cpython.test_pydoc.PydocImportTest.test_importfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocImportTest::test_importfile
"""Auto-ported test: PydocImportTest::test_importfile (CPython 3.12 oracle)."""
...
try:
    ...
    assert loaded_pydoc is not pydoc

    assert loaded_pydoc.__name__ == 'pydoc'

    assert loaded_pydoc.__file__ == pydoc.__file__

    assert loaded_pydoc.__spec__ == pydoc.__spec__
finally:
    sys.modules['pydoc'] = pydoc
print("PydocImportTest::test_importfile: ok")
