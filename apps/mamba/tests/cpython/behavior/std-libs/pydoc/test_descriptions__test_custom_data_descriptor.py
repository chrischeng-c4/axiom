...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_custom_data_descriptor"
# subject = "cpython.test_pydoc.TestDescriptions.test_custom_data_descriptor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_custom_data_descriptor
"""Auto-ported test: TestDescriptions::test_custom_data_descriptor (CPython 3.12 oracle)."""
...
assert _get_summary_lines(X.attr) == ''
X.attr.__doc__ = 'Custom descriptor'

assert _get_summary_lines(X.attr) == '    Custom descriptor\n'
X.attr.__name__ = 'foo'

assert _get_summary_lines(X.attr) == 'foo\n    Custom descriptor\n'
print("TestDescriptions::test_custom_data_descriptor: ok")
