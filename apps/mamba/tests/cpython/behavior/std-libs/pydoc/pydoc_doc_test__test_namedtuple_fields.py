...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_doc_test__test_namedtuple_fields"
# subject = "cpython.test_pydoc.PydocDocTest.test_namedtuple_fields"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocDocTest::test_namedtuple_fields
"""Auto-ported test: PydocDocTest::test_namedtuple_fields (CPython 3.12 oracle)."""
...
assert 'nickname' in helptext

assert 'firstname' in helptext

assert 'Alias for field number 0' in helptext

assert 'Alias for field number 1' in helptext
print("PydocDocTest::test_namedtuple_fields: ok")
