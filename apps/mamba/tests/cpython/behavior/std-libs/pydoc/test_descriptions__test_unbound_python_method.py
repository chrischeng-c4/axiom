...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_unbound_python_method"
# subject = "cpython.test_pydoc.TestDescriptions.test_unbound_python_method"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_unbound_python_method
"""Auto-ported test: TestDescriptions::test_unbound_python_method (CPython 3.12 oracle)."""
...
assert _get_summary_line(textwrap.TextWrapper.wrap) == 'wrap(self, text)'
print("TestDescriptions::test_unbound_python_method: ok")
