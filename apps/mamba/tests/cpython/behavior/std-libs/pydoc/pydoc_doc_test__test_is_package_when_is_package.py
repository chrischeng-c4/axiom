...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_doc_test__test_is_package_when_is_package"
# subject = "cpython.test_pydoc.PydocDocTest.test_is_package_when_is_package"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocDocTest::test_is_package_when_is_package
"""Auto-ported test: PydocDocTest::test_is_package_when_is_package (CPython 3.12 oracle)."""
...
with os_helper.temp_cwd() as test_dir:
    ...
    assert pydoc.ispackage(test_dir)
    os.remove(init_path)
print("PydocDocTest::test_is_package_when_is_package: ok")
