...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_fodder_test__test_html_doc_routines_in_module"
# subject = "cpython.test_pydoc.PydocFodderTest.test_html_doc_routines_in_module"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocFodderTest::test_html_doc_routines_in_module
"""Auto-ported test: PydocFodderTest::test_html_doc_routines_in_module (CPython 3.12 oracle)."""
...
# --- test body ---
def getsection(text, beginline, endline):
...
lines = getsection(result, ' Functions', None)

assert ' global_func_alias = global_func(x, y)' in lines

assert ' A_staticmethod(x, y)' in lines

assert ' A_staticmethod_alias = A_staticmethod(x, y)' in lines

assert 'A_classmethod(x) class method of A' in lines

assert ' A_classmethod2 = A_classmethod(x) class method of A' in lines

assert ' A_classmethod3 = A_classmethod(x) class method of B' in lines

assert ' A_method() method of A instance' in lines

assert ' A_method2 = A_method() method of A instance' in lines

assert ' A_method3 = A_method() method of B instance' in lines

assert ' A_staticmethod_ref = A_staticmethod(x, y)' in lines

assert ' A_staticmethod_ref2 = A_staticmethod(y) method of B instance' in lines

assert ' get(key, default=None, /) method of builtins.dict instance' in lines

assert ' dict_get = get(key, default=None, /) method of builtins.dict instance' in lines

assert ' B_method(self)' in lines

assert ' B_method2 = B_method(self)' in lines
print("PydocFodderTest::test_html_doc_routines_in_module: ok")
