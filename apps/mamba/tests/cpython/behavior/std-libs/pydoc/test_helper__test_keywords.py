...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_helper__test_keywords"
# subject = "cpython.test_pydoc.TestHelper.test_keywords"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestHelper::test_keywords
"""Auto-ported test: TestHelper::test_keywords (CPython 3.12 oracle)."""
...
assert sorted(pydoc.Helper.keywords) == sorted(keyword.kwlist)
print("TestHelper::test_keywords: ok")
