...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_member_descriptor"
# subject = "cpython.test_pydoc.TestDescriptions.test_member_descriptor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_member_descriptor
"""Auto-ported test: TestDescriptions::test_member_descriptor (CPython 3.12 oracle)."""
...
assert _get_summary_line(complex.real) == 'real'

assert _get_summary_line(range.start) == 'start'

assert _get_summary_line(slice.start) == 'start'

assert _get_summary_line(property.fget) == 'fget'

assert _get_summary_line(StopIteration.value) == 'value'
print("TestDescriptions::test_member_descriptor: ok")
