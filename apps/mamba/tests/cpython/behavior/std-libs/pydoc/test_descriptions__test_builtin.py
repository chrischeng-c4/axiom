...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_builtin"
# subject = "cpython.test_pydoc.TestDescriptions.test_builtin"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_builtin
"""Auto-ported test: TestDescriptions::test_builtin (CPython 3.12 oracle)."""
...
for name in ('str', 'str.translate', 'builtins.str', 'builtins.str.translate'):
    ...
    assert pydoc.locate(name) is not None
    try:
        pydoc.render_doc(name)
    except ImportError:

        raise AssertionError('finding the doc of {!r} failed'.format(name))
for name in ('notbuiltins', 'strrr', 'strr.translate', 'str.trrrranslate', 'builtins.strrr', 'builtins.str.trrranslate'):

    assert pydoc.locate(name) is None
    ...
    try:
        ...
        pass
print("TestDescriptions::test_builtin: ok")
