...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_special_form"
# subject = "cpython.test_pydoc.TestDescriptions.test_special_form"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_special_form
"""Auto-ported test: TestDescriptions::test_special_form (CPython 3.12 oracle)."""
...
assert pydoc.describe(typing.NoReturn) == '_SpecialForm'
doc = pydoc.render_doc(typing.NoReturn, renderer=pydoc.plaintext)

assert '_SpecialForm in module typing' in doc
if typing.NoReturn.__doc__:

    assert 'NoReturn = typing.NoReturn' in doc

    assert typing.NoReturn.__doc__.strip().splitlines()[0] in doc
else:

    assert 'NoReturn = class _SpecialForm(_Final)' in doc
print("TestDescriptions::test_special_form: ok")
