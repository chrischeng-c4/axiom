...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_generic_alias"
# subject = "cpython.test_pydoc.TestDescriptions.test_generic_alias"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_generic_alias
"""Auto-ported test: TestDescriptions::test_generic_alias (CPython 3.12 oracle)."""
...
assert pydoc.describe(typing.List[int]) == '_GenericAlias'
doc = pydoc.render_doc(typing.List[int], renderer=pydoc.plaintext)

assert '_GenericAlias in module typing' in doc

assert 'List = class list(object)' in doc
if not MISSING_C_DOCSTRINGS:

    assert list.__doc__.strip().splitlines()[0] in doc

assert pydoc.describe(list[int]) == 'GenericAlias'
doc = pydoc.render_doc(list[int], renderer=pydoc.plaintext)

assert 'GenericAlias in module builtins' in doc

assert '\nclass list(object)' in doc
if not MISSING_C_DOCSTRINGS:

    assert list.__doc__.strip().splitlines()[0] in doc
print("TestDescriptions::test_generic_alias: ok")
