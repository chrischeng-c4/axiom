...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_unbound_builtin_method"
# subject = "cpython.test_pydoc.TestDescriptions.test_unbound_builtin_method"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_unbound_builtin_method
"""Auto-ported test: TestDescriptions::test_unbound_builtin_method (CPython 3.12 oracle)."""
...
assert _get_summary_line(_pickle.Pickler.dump) == 'dump(self, obj, /) unbound _pickle.Pickler method'
print("TestDescriptions::test_unbound_builtin_method: ok")
