...
# lib = "cmd_line"
# dimension = "behavior"
# case = "cmd_line_test__test_site_flag"
# subject = "cpython.test_cmd_line.CmdLineTest.test_site_flag"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line.py::CmdLineTest::test_site_flag
"""Auto-ported test: CmdLineTest::test_site_flag (CPython 3.12 oracle)."""
...
def verify_valid_flag(cmd_line):
    ...
    return out
verify_valid_flag('-S')
print("CmdLineTest::test_site_flag: ok")
