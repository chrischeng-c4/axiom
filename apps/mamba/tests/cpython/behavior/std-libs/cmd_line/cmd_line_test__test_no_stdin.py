...
# lib = "cmd_line"
# dimension = "behavior"
# case = "cmd_line_test__test_no_stdin"
# subject = "cpython.test_cmd_line.CmdLineTest.test_no_stdin"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line.py::CmdLineTest::test_no_stdin
"""Auto-ported test: CmdLineTest::test_no_stdin (CPython 3.12 oracle)."""
...
def verify_valid_flag(cmd_line):
    ...
    return out
_test_no_stdio(['stdin'])
print("CmdLineTest::test_no_stdin: ok")
