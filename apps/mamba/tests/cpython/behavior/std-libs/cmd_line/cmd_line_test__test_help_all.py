...
# lib = "cmd_line"
# dimension = "behavior"
# case = "cmd_line_test__test_help_all"
# subject = "cpython.test_cmd_line.CmdLineTest.test_help_all"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line.py::CmdLineTest::test_help_all
"""Auto-ported test: CmdLineTest::test_help_all (CPython 3.12 oracle)."""
...
def verify_valid_flag(cmd_line):
    ...
    return out
out = verify_valid_flag('--help-all')
lines = out.splitlines()

assert b'usage' in lines[0]

assert b'PYTHONHOME' in out

assert b'-X dev' in out
b''.join(lines[1:]).decode('ascii')
print("CmdLineTest::test_help_all: ok")
