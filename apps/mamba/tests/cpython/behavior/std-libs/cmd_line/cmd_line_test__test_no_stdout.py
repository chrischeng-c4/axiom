...
# lib = "cmd_line"
# dimension = "behavior"
# case = "cmd_line_test__test_no_stdout"
# subject = "cpython.test_cmd_line.CmdLineTest.test_no_stdout"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line.py::CmdLineTest::test_no_stdout
"""Auto-ported test: CmdLineTest::test_no_stdout (CPython 3.12 oracle)."""
...
def verify_valid_flag(cmd_line):
    ...
    return out
_test_no_stdio(['stdout'])
print("CmdLineTest::test_no_stdout: ok")
