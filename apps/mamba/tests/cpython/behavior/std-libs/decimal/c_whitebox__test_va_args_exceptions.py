...
# lib = "decimal"
# dimension = "behavior"
# case = "c_whitebox__test_va_args_exceptions"
# subject = "cpython.test_decimal.CWhitebox.test_va_args_exceptions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CWhitebox::test_va_args_exceptions
"""Auto-ported test: CWhitebox::test_va_args_exceptions (CPython 3.12 oracle)."""
...
try:
    x.to_integral(rounding=None, context=[])
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    x.to_integral(rounding={}, context=[])
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
try:
    x.to_integral_value(rounding=None, context=[])
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    x.to_integral_value(rounding={}, context=[])
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
try:
    x.to_integral_exact(rounding=None, context=[])
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    x.to_integral_exact(rounding={}, context=[])
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
try:
    x.fma(1, 2, 'x', context=None)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    x.quantize(1, [], context=None)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    x.quantize(1, [], rounding=None)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
try:
    c.power(1, 'x', mod=None)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    c.power('x', 2, mod=None)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("CWhitebox::test_va_args_exceptions: ok")
