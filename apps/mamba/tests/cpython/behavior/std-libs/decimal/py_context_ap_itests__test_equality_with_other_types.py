...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_equality_with_other_types"
# subject = "cpython.test_decimal.PyContextAPItests.test_equality_with_other_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_equality_with_other_types
"""Auto-ported test: PyContextAPItests::test_equality_with_other_types (CPython 3.12 oracle)."""
...
assert Decimal(10) in ['a', 1.0, Decimal(10), (1, 2), {}]

assert Decimal(10) not in ['a', 1.0, (1, 2), {}]
print("PyContextAPItests::test_equality_with_other_types: ok")
