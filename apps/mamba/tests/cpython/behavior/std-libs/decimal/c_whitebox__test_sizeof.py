...
# lib = "decimal"
# dimension = "behavior"
# case = "c_whitebox__test_sizeof"
# subject = "cpython.test_decimal.CWhitebox.test_sizeof"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CWhitebox::test_sizeof
"""Auto-ported test: CWhitebox::test_sizeof (CPython 3.12 oracle)."""
...
if HAVE_CONFIG_64:
    ...
    assert y == x + 4
print("CWhitebox::test_sizeof: ok")
