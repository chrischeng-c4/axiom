...
# lib = "decimal"
# dimension = "behavior"
# case = "c_implicit_construction_test__test_implicit_from_none"
# subject = "cpython.test_decimal.CImplicitConstructionTest.test_implicit_from_None"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CImplicitConstructionTest::test_implicit_from_None
"""Auto-ported test: CImplicitConstructionTest::test_implicit_from_None (CPython 3.12 oracle)."""
...
try:
    eval('Decimal(5) + None', locals())
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("CImplicitConstructionTest::test_implicit_from_None: ok")
