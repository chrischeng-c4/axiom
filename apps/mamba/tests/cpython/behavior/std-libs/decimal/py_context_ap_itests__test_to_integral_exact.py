...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_to_integral_exact"
# subject = "cpython.test_decimal.PyContextAPItests.test_to_integral_exact"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_to_integral_exact
"""Auto-ported test: PyContextAPItests::test_to_integral_exact (CPython 3.12 oracle)."""
...
assert c.to_integral_exact(10) == d

try:
    c.to_integral_exact('10')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("PyContextAPItests::test_to_integral_exact: ok")
