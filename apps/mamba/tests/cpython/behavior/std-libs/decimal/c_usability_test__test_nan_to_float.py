...
# lib = "decimal"
# dimension = "behavior"
# case = "c_usability_test__test_nan_to_float"
# subject = "cpython.test_decimal.CUsabilityTest.test_nan_to_float"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CUsabilityTest::test_nan_to_float
"""Auto-ported test: CUsabilityTest::test_nan_to_float (CPython 3.12 oracle)."""
...
for s in ('nan', 'nan1234', '-nan', '-nan2468'):
    ...
    assert sign == (-1.0 if s.startswith('-') else 1.0)
print("CUsabilityTest::test_nan_to_float: ok")
