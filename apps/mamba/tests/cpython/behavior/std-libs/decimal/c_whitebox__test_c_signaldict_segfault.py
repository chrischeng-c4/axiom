...
# lib = "decimal"
# dimension = "behavior"
# case = "c_whitebox__test_c_signaldict_segfault"
# subject = "cpython.test_decimal.CWhitebox.test_c_signaldict_segfault"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CWhitebox::test_c_signaldict_segfault
"""Auto-ported test: CWhitebox::test_c_signaldict_segfault (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(err_msg, str(_aR_e))
try:
    iter(sd)
    raise AssertionError('expected ValueError')
except ValueError as _aR_e:
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(err_msg, str(_aR_e))
print("CWhitebox::test_c_signaldict_segfault: ok")
