...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_copy"
# subject = "cpython.test_decimal.PyContextAPItests.test_copy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_copy
"""Auto-ported test: PyContextAPItests::test_copy (CPython 3.12 oracle)."""
...
assert id(c.flags) != id(d.flags)

assert id(c.traps) != id(d.traps)
k1 = set(c.flags.keys())
k2 = set(d.flags.keys())

assert k1 == k2

assert c.flags == d.flags
print("PyContextAPItests::test_copy: ok")
