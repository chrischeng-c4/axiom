...
# lib = "decimal"
# dimension = "behavior"
# case = "c_whitebox__test_c_format"
# subject = "cpython.test_decimal.CWhitebox.test_c_format"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CWhitebox::test_c_format
"""Auto-ported test: CWhitebox::test_c_format (CPython 3.12 oracle)."""
...
try:
    Decimal(1).__format__([])
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    Decimal(1).__format__('<>=10.10')
...
try:
    Decimal('1.23456789').__format__('=%d.1' % maxsize)
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("CWhitebox::test_c_format: ok")
