...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_max"
# subject = "cpython.test_decimal.PyContextAPItests.test_max"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_max
"""Auto-ported test: PyContextAPItests::test_max (CPython 3.12 oracle)."""
...
assert c.max(Decimal(1), 2) == d

assert c.max(1, Decimal(2)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_max: ok")
