...
# lib = "decimal"
# dimension = "behavior"
# case = "py_explicit_construction_test__test_explicit_from_float"
# subject = "cpython.test_decimal.PyExplicitConstructionTest.test_explicit_from_float"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyExplicitConstructionTest::test_explicit_from_float
"""Auto-ported test: PyExplicitConstructionTest::test_explicit_from_float (CPython 3.12 oracle)."""
...
for i in range(200):
    ...
    assert x == float(Decimal(x))
print("PyExplicitConstructionTest::test_explicit_from_float: ok")
