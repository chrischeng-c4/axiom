...
# lib = "decimal"
# dimension = "behavior"
# case = "c_explicit_construction_test__test_explicit_from_int"
# subject = "cpython.test_decimal.CExplicitConstructionTest.test_explicit_from_int"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CExplicitConstructionTest::test_explicit_from_int
"""Auto-ported test: CExplicitConstructionTest::test_explicit_from_int (CPython 3.12 oracle)."""
...
for n in range(0, 32):
    for sign in (-1, 1):
        for x in range(-5, 5):
            ...
            assert str(d) == str(i)
print("CExplicitConstructionTest::test_explicit_from_int: ok")
