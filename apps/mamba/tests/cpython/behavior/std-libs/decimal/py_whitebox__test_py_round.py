...
# lib = "decimal"
# dimension = "behavior"
# case = "py_whitebox__test_py_round"
# subject = "cpython.test_decimal.PyWhitebox.test_py__round"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyWhitebox::test_py__round
"""Auto-ported test: PyWhitebox::test_py__round (CPython 3.12 oracle)."""
...
try:
    Decimal('3.1234')._round(0, ROUND_UP)
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("PyWhitebox::test_py__round: ok")
