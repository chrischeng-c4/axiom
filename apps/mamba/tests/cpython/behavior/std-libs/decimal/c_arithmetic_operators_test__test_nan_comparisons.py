...
# lib = "decimal"
# dimension = "behavior"
# case = "c_arithmetic_operators_test__test_nan_comparisons"
# subject = "cpython.test_decimal.CArithmeticOperatorsTest.test_nan_comparisons"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CArithmeticOperatorsTest::test_nan_comparisons
"""Auto-ported test: CArithmeticOperatorsTest::test_nan_comparisons (CPython 3.12 oracle)."""
    ...
    for x, y in qnan_pairs + snan_pairs:
        for op in order_ops:
            ...
            try:
                ...
                pass
print("CArithmeticOperatorsTest::test_nan_comparisons: ok")
