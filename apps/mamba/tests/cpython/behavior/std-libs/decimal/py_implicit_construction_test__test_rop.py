...
# lib = "decimal"
# dimension = "behavior"
# case = "py_implicit_construction_test__test_rop"
# subject = "cpython.test_decimal.PyImplicitConstructionTest.test_rop"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyImplicitConstructionTest::test_rop
"""Auto-ported test: PyImplicitConstructionTest::test_rop (CPython 3.12 oracle)."""
...
assert divmod(E(), Decimal(10)) == 'divmod 10'

assert divmod(Decimal(10), E()) == '10 rdivmod'

assert eval('Decimal(10) < E()') == 'gt 10'

assert eval('Decimal(10) > E()') == 'lt 10'

assert eval('Decimal(10) <= E()') == 'ge 10'

assert eval('Decimal(10) >= E()') == 'le 10'

assert eval('Decimal(10) == E()') == 'eq 10'

assert eval('Decimal(10) != E()') == 'ne 10'
...
for sym, lop, rop in oplist:
    ...
    assert eval('E()' + sym + 'Decimal(10)') == 'str' + lop + '10'

    assert eval('Decimal(10)' + sym + 'E()') == '10' + rop + 'str'
print("PyImplicitConstructionTest::test_rop: ok")
