...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_remainder_near"
# subject = "cpython.test_decimal.PyContextAPItests.test_remainder_near"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_remainder_near
"""Auto-ported test: PyContextAPItests::test_remainder_near (CPython 3.12 oracle)."""
...
assert c.remainder_near(1, 2) == d

assert c.remainder_near(Decimal(1), 2) == d

assert c.remainder_near(1, Decimal(2)) == d

try:
    c.remainder_near('1', 2)
...
try:
    ...
    pass
print("PyContextAPItests::test_remainder_near: ok")
