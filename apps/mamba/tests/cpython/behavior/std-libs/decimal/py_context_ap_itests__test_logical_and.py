...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_logical_and"
# subject = "cpython.test_decimal.PyContextAPItests.test_logical_and"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_logical_and
"""Auto-ported test: PyContextAPItests::test_logical_and (CPython 3.12 oracle)."""
...
assert c.logical_and(1, 1) == d

assert c.logical_and(Decimal(1), 1) == d

assert c.logical_and(1, Decimal(1)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_logical_and: ok")
