...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_fma"
# subject = "cpython.test_decimal.PyContextAPItests.test_fma"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_fma
"""Auto-ported test: PyContextAPItests::test_fma (CPython 3.12 oracle)."""
...
assert c.fma(2, 3, 4) == d

assert c.fma(Decimal(2), 3, 4) == d

assert c.fma(2, Decimal(3), 4) == d

assert c.fma(2, 3, Decimal(4)) == d

assert c.fma(Decimal(2), Decimal(3), 4) == d
...
try:
    c.fma(Decimal('Infinity'), Decimal(0), 'not a decimal')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    c.fma(Decimal(1), Decimal('snan'), 1.222)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    Decimal('Infinity').fma(Decimal(0), 'not a decimal')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    Decimal(1).fma(Decimal('snan'), 1.222)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("PyContextAPItests::test_fma: ok")
