...
# lib = "decimal"
# dimension = "behavior"
# case = "py_arithmetic_operators_test__test_nan_comparisons"
# subject = "cpython.test_decimal.PyArithmeticOperatorsTest.test_nan_comparisons"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyArithmeticOperatorsTest::test_nan_comparisons
"""Auto-ported test: PyArithmeticOperatorsTest::test_nan_comparisons (CPython 3.12 oracle)."""
    ...
    for x, y in qnan_pairs + snan_pairs:
        for op in order_ops:
            ...
            try:
                ...
                pass
print("PyArithmeticOperatorsTest::test_nan_comparisons: ok")
