...
# lib = "decimal"
# dimension = "behavior"
# case = "c_whitebox__test_from_tuple"
# subject = "cpython.test_decimal.CWhitebox.test_from_tuple"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CWhitebox::test_from_tuple
"""Auto-ported test: CWhitebox::test_from_tuple (CPython 3.12 oracle)."""
...
with localcontext() as c:
    ...
    assert str(c.create_decimal(x)) == '-0E+999999'
    ...
    assert str(c.create_decimal(x)) == '-0E-1000007'
    ...
    assert str(Decimal(x)) == '-sNaN'
    x = (1, (0,), 'N')

    assert str(Decimal(x)) == '-sNaN'
    x = (1, (0, 1), 'N')

    assert str(Decimal(x)) == '-sNaN1'
print("CWhitebox::test_from_tuple: ok")
