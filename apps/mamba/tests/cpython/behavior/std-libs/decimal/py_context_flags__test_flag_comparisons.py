...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_flags__test_flag_comparisons"
# subject = "cpython.test_decimal.PyContextFlags.test_flag_comparisons"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextFlags::test_flag_comparisons
"""Auto-ported test: PyContextFlags::test_flag_comparisons (CPython 3.12 oracle)."""
...
assert c.flags != c.traps

assert c.traps != c.flags
c.flags = c.traps
...
assert c.flags != d
print("PyContextFlags::test_flag_comparisons: ok")
