...
# lib = "decimal"
# dimension = "behavior"
# case = "c_whitebox__test_rounding_strings_interned"
# subject = "cpython.test_decimal.CWhitebox.test_rounding_strings_interned"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CWhitebox::test_rounding_strings_interned
"""Auto-ported test: CWhitebox::test_rounding_strings_interned (CPython 3.12 oracle)."""
...
assert C.ROUND_UP is P.ROUND_UP

assert C.ROUND_DOWN is P.ROUND_DOWN

assert C.ROUND_CEILING is P.ROUND_CEILING

assert C.ROUND_FLOOR is P.ROUND_FLOOR

assert C.ROUND_HALF_UP is P.ROUND_HALF_UP

assert C.ROUND_HALF_DOWN is P.ROUND_HALF_DOWN

assert C.ROUND_HALF_EVEN is P.ROUND_HALF_EVEN

assert C.ROUND_05UP is P.ROUND_05UP
print("CWhitebox::test_rounding_strings_interned: ok")
