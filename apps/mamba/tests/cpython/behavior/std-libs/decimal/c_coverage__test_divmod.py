...
# lib = "decimal"
# dimension = "behavior"
# case = "c_coverage__test_divmod"
# subject = "cpython.test_decimal.CCoverage.test_divmod"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CCoverage::test_divmod
"""Auto-ported test: CCoverage::test_divmod (CPython 3.12 oracle)."""
...
with localcontext() as c:
    ...
    assert q == Decimal('10901935')

    assert r == Decimal('194')
    q, r = divmod(Decimal('NaN'), 7)

    assert q.is_nan() and r.is_nan()
    ...
    assert q.is_infinite() and r.is_nan()
    ...
    assert c.flags[InvalidOperation] and c.flags[DivisionByZero]
print("CCoverage::test_divmod: ok")
