...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_divmod"
# subject = "cpython.test_decimal.PyContextAPItests.test_divmod"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_divmod
"""Auto-ported test: PyContextAPItests::test_divmod (CPython 3.12 oracle)."""
...
assert c.divmod(1, 2) == d

assert c.divmod(Decimal(1), 2) == d

assert c.divmod(1, Decimal(2)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_divmod: ok")
