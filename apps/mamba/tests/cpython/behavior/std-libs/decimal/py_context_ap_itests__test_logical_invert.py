...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_logical_invert"
# subject = "cpython.test_decimal.PyContextAPItests.test_logical_invert"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_logical_invert
"""Auto-ported test: PyContextAPItests::test_logical_invert (CPython 3.12 oracle)."""
...
assert c.logical_invert(1000) == d

try:
    c.logical_invert('1000')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("PyContextAPItests::test_logical_invert: ok")
