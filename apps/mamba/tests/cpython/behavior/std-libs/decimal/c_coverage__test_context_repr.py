...
# lib = "decimal"
# dimension = "behavior"
# case = "c_coverage__test_context_repr"
# subject = "cpython.test_decimal.CCoverage.test_context_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CCoverage::test_context_repr
"""Auto-ported test: CCoverage::test_context_repr (CPython 3.12 oracle)."""
...
c.capitals = 0
c.clamp = 1
for sig in OrderedSignals[decimal]:
    c.flags[sig] = False
    c.traps[sig] = False
s = c.__repr__()
...
assert s == t
print("CCoverage::test_context_repr: ok")
