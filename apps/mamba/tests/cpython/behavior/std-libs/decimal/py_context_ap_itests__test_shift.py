...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_shift"
# subject = "cpython.test_decimal.PyContextAPItests.test_shift"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_shift
"""Auto-ported test: PyContextAPItests::test_shift (CPython 3.12 oracle)."""
...
assert c.shift(1, 2) == d

assert c.shift(Decimal(1), 2) == d

assert c.shift(1, Decimal(2)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_shift: ok")
