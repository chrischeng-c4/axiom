...
# lib = "decimal"
# dimension = "behavior"
# case = "py_explicit_construction_test__test_unicode_digits"
# subject = "cpython.test_decimal.PyExplicitConstructionTest.test_unicode_digits"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyExplicitConstructionTest::test_unicode_digits
"""Auto-ported test: PyExplicitConstructionTest::test_unicode_digits (CPython 3.12 oracle)."""
...
for input, expected in test_values.items():
    ...
    assert str(Decimal(input)) == expected
print("PyExplicitConstructionTest::test_unicode_digits: ok")
