...
# lib = "decimal"
# dimension = "behavior"
# case = "c_context_with_statement__test_with_statements_gc1"
# subject = "cpython.test_decimal.CContextWithStatement.test_with_statements_gc1"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CContextWithStatement::test_with_statements_gc1
"""Auto-ported test: CContextWithStatement::test_with_statements_gc1 (CPython 3.12 oracle)."""
    ...
    with localcontext() as c2:
        ...
        with localcontext() as c3:
            ...
            with localcontext() as c4:
                del c4
print("CContextWithStatement::test_with_statements_gc1: ok")
