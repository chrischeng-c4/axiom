...
# lib = "decimal"
# dimension = "behavior"
# case = "c_usability_test__test_decimal_fraction_comparison"
# subject = "cpython.test_decimal.CUsabilityTest.test_decimal_fraction_comparison"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CUsabilityTest::test_decimal_fraction_comparison
"""Auto-ported test: CUsabilityTest::test_decimal_fraction_comparison (CPython 3.12 oracle)."""
...
with localcontext(c):
    ...
    try:
        D('nan').__gt__(F(-9, 123))
        raise AssertionError('expected InvalidOperation')
    except InvalidOperation:
        pass

    assert NotImplemented is F(-9, 123).__lt__(D('nan'))

    assert D('nan') != F(-9, 123)

    assert F(-9, 123) != D('nan')
print("CUsabilityTest::test_decimal_fraction_comparison: ok")
