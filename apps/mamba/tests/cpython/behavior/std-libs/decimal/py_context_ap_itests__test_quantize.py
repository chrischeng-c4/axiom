...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_quantize"
# subject = "cpython.test_decimal.PyContextAPItests.test_quantize"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_quantize
"""Auto-ported test: PyContextAPItests::test_quantize (CPython 3.12 oracle)."""
...
assert c.quantize(1, 2) == d

assert c.quantize(Decimal(1), 2) == d

assert c.quantize(1, Decimal(2)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_quantize: ok")
