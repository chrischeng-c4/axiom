...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_min"
# subject = "cpython.test_decimal.PyContextAPItests.test_min"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_min
"""Auto-ported test: PyContextAPItests::test_min (CPython 3.12 oracle)."""
...
assert c.min(Decimal(1), 2) == d

assert c.min(1, Decimal(2)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_min: ok")
