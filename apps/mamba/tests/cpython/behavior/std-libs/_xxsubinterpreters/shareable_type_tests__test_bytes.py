...
# dimension = "behavior"
# case = "shareable_type_tests__test_bytes"
# subject = "cpython.test__xxsubinterpreters.ShareableTypeTests.test_bytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxsubinterpreters.py::ShareableTypeTests::test_bytes
"""Auto-ported test: ShareableTypeTests::test_bytes (CPython 3.12 oracle)."""
...
_assert_values((i.to_bytes(2, 'little', signed=True) for i in range(-1, 258)))
print("ShareableTypeTests::test_bytes: ok")
