...
# subject = "cpython.test__xxsubinterpreters.ListAllTests.test_after_destroying"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxsubinterpreters.py::ListAllTests::test_after_destroying
