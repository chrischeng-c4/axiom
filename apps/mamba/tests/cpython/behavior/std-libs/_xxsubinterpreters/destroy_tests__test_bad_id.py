...
# dimension = "behavior"
# case = "destroy_tests__test_bad_id"
# subject = "cpython.test__xxsubinterpreters.DestroyTests.test_bad_id"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxsubinterpreters.py::DestroyTests::test_bad_id
"""Auto-ported test: DestroyTests::test_bad_id (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("DestroyTests::test_bad_id: ok")
