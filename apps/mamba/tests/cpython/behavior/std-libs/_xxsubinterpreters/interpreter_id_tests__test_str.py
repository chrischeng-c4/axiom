...
# dimension = "behavior"
# case = "interpreter_id_tests__test_str"
# subject = "cpython.test__xxsubinterpreters.InterpreterIDTests.test_str"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxsubinterpreters.py::InterpreterIDTests::test_str
"""Auto-ported test: InterpreterIDTests::test_str (CPython 3.12 oracle)."""
...
assert str(id) == '10'
print("InterpreterIDTests::test_str: ok")
