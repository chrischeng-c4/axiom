...
# dimension = "behavior"
# case = "destroy_tests__test_main"
# subject = "cpython.test__xxsubinterpreters.DestroyTests.test_main"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxsubinterpreters.py::DestroyTests::test_main
"""Auto-ported test: DestroyTests::test_main (CPython 3.12 oracle)."""
...
t.start()
t.join()
print("DestroyTests::test_main: ok")
