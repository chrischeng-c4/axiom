...
# lib = "urllib"
# dimension = "behavior"
# case = "quoting_tests__test_default_safe"
# subject = "cpython.test_urllib.QuotingTests.test_default_safe"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::QuotingTests::test_default_safe
"""Auto-ported test: QuotingTests::test_default_safe (CPython 3.12 oracle)."""
...
assert urllib.parse.quote.__defaults__[0] == '/'
print("QuotingTests::test_default_safe: ok")
