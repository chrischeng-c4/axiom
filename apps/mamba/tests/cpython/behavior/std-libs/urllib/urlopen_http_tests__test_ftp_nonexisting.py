...
# lib = "urllib"
# dimension = "behavior"
# case = "urlopen_http_tests__test_ftp_nonexisting"
# subject = "cpython.test_urllib.urlopen_HttpTests.test_ftp_nonexisting"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::urlopen_HttpTests::test_ftp_nonexisting
"""Auto-ported test: urlopen_HttpTests::test_ftp_nonexisting (CPython 3.12 oracle)."""
...
assert not e.exception.filename

assert e.exception.reason
print("urlopen_HttpTests::test_ftp_nonexisting: ok")
