...
# lib = "urllib"
# dimension = "behavior"
# case = "quoting_tests__test_safe"
# subject = "cpython.test_urllib.QuotingTests.test_safe"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::QuotingTests::test_safe
"""Auto-ported test: QuotingTests::test_safe (CPython 3.12 oracle)."""
...
assert quote_by_default == result
...
assert expect == result
print("QuotingTests::test_safe: ok")
