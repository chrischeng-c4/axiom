...
# lib = "urllib"
# dimension = "behavior"
# case = "ur_lopener_tests__test_local_file_open"
# subject = "cpython.test_urllib.URLopener_Tests.test_local_file_open"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::URLopener_Tests::test_local_file_open
"""Auto-ported test: URLopener_Tests::test_local_file_open (CPython 3.12 oracle)."""
...
for url in ('local_file://example', 'local-file://example'):
    ...
    try:
        DummyURLopener().open(url)
        raise AssertionError('expected OSError')
    except OSError:
        pass

    try:
        DummyURLopener().retrieve(url)
        raise AssertionError('expected OSError')
    except OSError:
        pass
print("URLopener_Tests::test_local_file_open: ok")
