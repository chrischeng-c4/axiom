...
# lib = "regrtest"
# dimension = "behavior"
# case = "test_utils__test_normalize_test_name"
# subject = "cpython.test_regrtest.TestUtils.test_normalize_test_name"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_regrtest.py::TestUtils::test_normalize_test_name
"""Auto-ported test: TestUtils::test_normalize_test_name (CPython 3.12 oracle)."""
...
assert normalize('test_access (test.test_os.FileTests.test_access)') == 'test_access'

assert normalize('setUpClass (test.test_os.ChownFileTests)', is_error=True) == 'ChownFileTests'

assert normalize('test_success (test.test_bug.ExampleTests.test_success)', is_error=True) == 'test_success'

assert normalize('setUpModule (test.test_x)', is_error=True) is None

assert normalize('tearDownModule (test.test_module)', is_error=True) is None
print("TestUtils::test_normalize_test_name: ok")
