...
# lib = "pyexpat"
# dimension = "behavior"
# case = "set_attribute_test__test_invalid_attributes"
# subject = "cpython.test_pyexpat.SetAttributeTest.test_invalid_attributes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pyexpat.py::SetAttributeTest::test_invalid_attributes
"""Auto-ported test: SetAttributeTest::test_invalid_attributes (CPython 3.12 oracle)."""
...
# --- test body ---
self_parser = expat.ParserCreate(namespace_separator='!')
try:
    self_parser.returns_unicode = 1
    raise AssertionError('expected AttributeError')
except AttributeError:
    pass
try:
    self_parser.returns_unicode
    raise AssertionError('expected AttributeError')
except AttributeError:
    pass

try:
    setattr(self_parser, range(15), 0)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    self_parser.__setattr__(range(15), 0)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    getattr(self_parser, range(15))
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("SetAttributeTest::test_invalid_attributes: ok")
