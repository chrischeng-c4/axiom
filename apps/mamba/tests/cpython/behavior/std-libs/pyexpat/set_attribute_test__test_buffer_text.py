...
# lib = "pyexpat"
# dimension = "behavior"
# case = "set_attribute_test__test_buffer_text"
# subject = "cpython.test_pyexpat.SetAttributeTest.test_buffer_text"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pyexpat.py::SetAttributeTest::test_buffer_text
"""Auto-ported test: SetAttributeTest::test_buffer_text (CPython 3.12 oracle)."""
...
assert self_parser.buffer_text is False
for x in (0, 1, 2, 0):
    self_parser.buffer_text = x

    assert self_parser.buffer_text is bool(x)
print("SetAttributeTest::test_buffer_text: ok")
