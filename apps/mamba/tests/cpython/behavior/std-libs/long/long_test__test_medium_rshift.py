...
# lib = "long"
# dimension = "behavior"
# case = "long_test__test_medium_rshift"
# subject = "cpython.test_long.LongTest.test_medium_rshift"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_long.py::LongTest::test_medium_rshift
"""Auto-ported test: LongTest::test_medium_rshift (CPython 3.12 oracle)."""
...
assert 2 ** 128 >> 9 == 2 ** 119

assert -2 ** 128 >> 9 == -2 ** 119

assert 1 - BASE * BASE >> SHIFT == -BASE

assert BASE - 1 - BASE * BASE >> SHIFT == -BASE
print("LongTest::test_medium_rshift: ok")
