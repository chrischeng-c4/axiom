...
# lib = "long"
# dimension = "behavior"
# case = "long_test__test_shift_bool"
# subject = "cpython.test_long.LongTest.test_shift_bool"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_long.py::LongTest::test_shift_bool
"""Auto-ported test: LongTest::test_shift_bool (CPython 3.12 oracle)."""
...
for value in (True, False):
    for shift in (0, 2):
        ...
        assert type(value << shift) == int

        assert type(value >> shift) == int
print("LongTest::test_shift_bool: ok")
