...
# lib = "long"
# dimension = "behavior"
# case = "long_test__test_from_bytes_small"
# subject = "cpython.test_long.LongTest.test_from_bytes_small"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_long.py::LongTest::test_from_bytes_small
"""Auto-ported test: LongTest::test_from_bytes_small (CPython 3.12 oracle)."""
...
for i in range(-5, 257):
    ...
    assert int.from_bytes(b, signed=True) is i
print("LongTest::test_from_bytes_small: ok")
