...
# lib = "long"
# dimension = "behavior"
# case = "long_test__test_as_integer_ratio"
# subject = "cpython.test_long.LongTest.test_as_integer_ratio"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_long.py::LongTest::test_as_integer_ratio
"""Auto-ported test: LongTest::test_as_integer_ratio (CPython 3.12 oracle)."""
...
for value in tests:
    ...
    assert (numerator, denominator) == (int(value), 1)

    assert type(numerator) == int

    assert type(denominator) == int
print("LongTest::test_as_integer_ratio: ok")
