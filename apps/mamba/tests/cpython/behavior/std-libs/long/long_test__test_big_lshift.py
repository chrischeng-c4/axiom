...
# lib = "long"
# dimension = "behavior"
# case = "long_test__test_big_lshift"
# subject = "cpython.test_long.LongTest.test_big_lshift"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_long.py::LongTest::test_big_lshift
"""Auto-ported test: LongTest::test_big_lshift (CPython 3.12 oracle)."""
...
assert 42 << 32 == 42 * 2 ** 32

assert -42 << 32 == -42 * 2 ** 32

assert 1122 << 32 == 1122 * 2 ** 32

assert -1122 << 32 == -1122 * 2 ** 32

assert 2 ** 128 << 32 == 2 ** 160

assert -2 ** 128 << 32 == -2 ** 160
print("LongTest::test_big_lshift: ok")
