...
# lib = "long"
# dimension = "behavior"
# case = "long_test__test_divmod_uses_cached_small_ints"
# subject = "cpython.test_long.LongTest.test_divmod_uses_cached_small_ints"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_long.py::LongTest::test_divmod_uses_cached_small_ints
"""Auto-ported test: LongTest::test_divmod_uses_cached_small_ints (CPython 3.12 oracle)."""
...
assert (big + 1) % big is 1

assert (big + 1) // big is 1

assert big // (big // 2) is 2

assert big // (big // -4) is -4
...
assert r is -1
print("LongTest::test_divmod_uses_cached_small_ints: ok")
