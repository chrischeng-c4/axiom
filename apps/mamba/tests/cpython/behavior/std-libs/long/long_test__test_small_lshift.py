...
# lib = "long"
# dimension = "behavior"
# case = "long_test__test_small_lshift"
# subject = "cpython.test_long.LongTest.test_small_lshift"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_long.py::LongTest::test_small_lshift
"""Auto-ported test: LongTest::test_small_lshift (CPython 3.12 oracle)."""
...
assert 2 ** 127 << 1 == 2 ** 128

assert -2 ** 127 << 1 == -2 ** 128
print("LongTest::test_small_lshift: ok")
