...
# lib = "long"
# dimension = "behavior"
# case = "long_test__test_sizeof"
# subject = "cpython.test_long.LongTest.test___sizeof__"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_long.py::LongTest::test___sizeof__
"""Auto-ported test: LongTest::test___sizeof__ (CPython 3.12 oracle)."""
...
assert int.__itemsize__ == sys.int_info.sizeof_digit
test_values = [(0, 1), (1, 1), (-1, 1), (BASE - 1, 1), (1 - BASE, 1), (BASE, 2), (-BASE, 2), (BASE * BASE - 1, 2), (BASE * BASE, 3)]
for value, ndigits in test_values:

    assert value.__sizeof__() == int.__basicsize__ + int.__itemsize__ * ndigits

class MyInt(int):
    pass

assert MyInt.__itemsize__ == sys.int_info.sizeof_digit
for value, ndigits in test_values:

    assert MyInt(value).__sizeof__() == MyInt.__basicsize__ + MyInt.__itemsize__ * ndigits
object.__sizeof__(1)
print("LongTest::test___sizeof__: ok")
