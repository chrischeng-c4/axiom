...
# lib = "optparse"
# dimension = "behavior"
# case = "test_standard__test_defaults"
# subject = "cpython.test_optparse.TestStandard.test_defaults"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_optparse.py::TestStandard::test_defaults
"""Auto-ported test: TestStandard::test_defaults (CPython 3.12 oracle)."""
...
self_parser = InterceptingOptionParser(usage=SUPPRESS_USAGE, option_list=options)
options, args = self_parser.parse_args([])
defaults = self_parser.get_default_values()

assert vars(defaults) == vars(options)
print("TestStandard::test_defaults: ok")
