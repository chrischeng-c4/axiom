...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_sequence"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_sequence"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_sequence
"""Auto-ported test: TestBufferProtocol::test_ndarray_sequence (CPython 3.12 oracle)."""
...
for fmt, items, _ in iter_format(5):
    ...
    if is_memoryview_format(fmt):
        ...
        for i, v in enumerate(mv):
            ...
            assert v in mv
print("TestBufferProtocol::test_ndarray_sequence: ok")
