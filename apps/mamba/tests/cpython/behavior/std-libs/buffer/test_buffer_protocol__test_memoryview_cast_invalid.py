...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_cast_invalid"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_cast_invalid"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_cast_invalid
"""Auto-ported test: TestBufferProtocol::test_memoryview_cast_invalid (CPython 3.12 oracle)."""
...
try:
    msrc.cast(shape=[2, 2, size_h], format='d')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
try:
    m.cast('B', shape=[2, 3, 4, 5, 6, 7, -1])
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    m.cast('B', shape=[2, 3, 4, 5, 6, 7, 0])
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    m.cast('B', shape=[2, 3, 4, 5, 6, 7, 'x'])
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
if sys.maxsize == 2 ** 63 - 1:
    ...
    try:
        m1.cast('B', [7, 7, 73, 127, 337, 92737, 649657])
        raise AssertionError('expected TypeError')
    except TypeError:
        pass

    try:
        m1.cast('B', [2 ** 20, 2 ** 20, 2 ** 10, 2 ** 10, 2 ** 3])
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        m2.cast('I', [2 ** 20, 2 ** 20, 2 ** 10, 2 ** 10, 2 ** 1])
        raise AssertionError('expected ValueError')
    except ValueError:
        pass
else:
    ...
    try:
        m1.cast('B', [1, 2147483647])
        raise AssertionError('expected TypeError')
    except TypeError:
        pass

    try:
        m1.cast('B', [2 ** 10, 2 ** 10, 2 ** 5, 2 ** 5, 2 ** 1])
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        m2.cast('I', [2 ** 10, 2 ** 10, 2 ** 5, 2 ** 3, 2 ** 1])
        raise AssertionError('expected ValueError')
    except ValueError:
        pass
print("TestBufferProtocol::test_memoryview_cast_invalid: ok")
