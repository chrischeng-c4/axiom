...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_slice_assign_multidim"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_slice_assign_multidim"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_slice_assign_multidim
"""Auto-ported test: TestBufferProtocol::test_ndarray_slice_assign_multidim (CPython 3.12 oracle)."""
    ...
    for flags in (0, ND_PIL):
        for _ in range(ITERATIONS):
            ...
            if nderr or listerr:
                ...
                assert nd.tolist() == result
print("TestBufferProtocol::test_ndarray_slice_assign_multidim: ok")
