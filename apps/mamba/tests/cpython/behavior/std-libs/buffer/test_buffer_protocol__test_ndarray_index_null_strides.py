...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_index_null_strides"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_index_null_strides"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_index_null_strides
"""Auto-ported test: TestBufferProtocol::test_ndarray_index_null_strides (CPython 3.12 oracle)."""
...
try:
    nd.__getitem__(slice(3, 5, 1))
    raise AssertionError('expected BufferError')
except BufferError:
    pass
print("TestBufferProtocol::test_ndarray_index_null_strides: ok")
