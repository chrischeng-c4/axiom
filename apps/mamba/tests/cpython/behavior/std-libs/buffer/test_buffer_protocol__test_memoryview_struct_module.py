...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_struct_module"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_struct_module"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_struct_module
"""Auto-ported test: TestBufferProtocol::test_memoryview_struct_module (CPython 3.12 oracle)."""
...
for fmt, items, item in iter_format(10, 'memoryview'):
    ...
    for v in values:
        ...
        if struct_err or mv_err:
            ...
            assert struct_err is not None

            assert mv_err is not None
        else:

            assert m[1] == nd[1]
print("TestBufferProtocol::test_memoryview_struct_module: ok")
