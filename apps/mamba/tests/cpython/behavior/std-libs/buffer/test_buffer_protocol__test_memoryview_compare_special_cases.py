...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_compare_special_cases"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_compare_special_cases"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_compare_special_cases
"""Auto-ported test: TestBufferProtocol::test_memoryview_compare_special_cases (CPython 3.12 oracle)."""
...
for attr in ('__lt__', '__le__', '__gt__', '__ge__'):
    ...
    assert getattr(v, attr)(w) is NotImplemented

    assert getattr(a, attr)(v) is NotImplemented
v = memoryview(a)
v.release()
...
if ctypes:
    ...
    try:
        ...
        pass
print("TestBufferProtocol::test_memoryview_compare_special_cases: ok")
