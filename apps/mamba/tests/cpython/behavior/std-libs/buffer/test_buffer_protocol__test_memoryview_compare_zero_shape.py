...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_compare_zero_shape"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_compare_zero_shape"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_compare_zero_shape
"""Auto-ported test: TestBufferProtocol::test_memoryview_compare_zero_shape (CPython 3.12 oracle)."""
...
assert v == w
print("TestBufferProtocol::test_memoryview_compare_zero_shape: ok")
