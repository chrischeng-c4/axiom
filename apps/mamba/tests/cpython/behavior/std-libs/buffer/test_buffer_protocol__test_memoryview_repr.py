...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_repr"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_repr
"""Auto-ported test: TestBufferProtocol::test_memoryview_repr (CPython 3.12 oracle)."""
...
assert r.startswith('<memory')
m.release()
r = m.__repr__()

assert r.startswith('<released')
print("TestBufferProtocol::test_memoryview_repr: ok")
