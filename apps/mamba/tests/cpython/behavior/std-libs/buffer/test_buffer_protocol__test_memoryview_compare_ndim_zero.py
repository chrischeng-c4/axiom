...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_compare_ndim_zero"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_compare_ndim_zero"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_compare_ndim_zero
"""Auto-ported test: TestBufferProtocol::test_memoryview_compare_ndim_zero (CPython 3.12 oracle)."""
...
assert not v.__ne__(w)

assert not w.__ne__(v)
w[()] = 1728
...
assert not v.__eq__(w)

assert not w.__eq__(v)
...
assert w == nd2
print("TestBufferProtocol::test_memoryview_compare_ndim_zero: ok")
