...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_tobytes"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_tobytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_tobytes
"""Auto-ported test: TestBufferProtocol::test_memoryview_tobytes (CPython 3.12 oracle)."""
...
if ctypes:
    ...
    assert a.tobytes() == bytes(point)
print("TestBufferProtocol::test_memoryview_tobytes: ok")
