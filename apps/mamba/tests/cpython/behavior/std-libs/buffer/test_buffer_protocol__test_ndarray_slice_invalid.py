...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_slice_invalid"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_slice_invalid"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_slice_invalid
"""Auto-ported test: TestBufferProtocol::test_ndarray_slice_invalid (CPython 3.12 oracle)."""
...
try:
    xl.__setitem__(slice(0, 8, 1), items)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    ml.__setitem__(slice(0, 8, 1), items)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
xl = ndarray(items, shape=[8], flags=ND_WRITABLE)
...
try:
    nd.__getitem__(slice(0, 1, 0))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    mv.__getitem__(slice(0, 1, 0))
    raise AssertionError('expected ValueError')
except ValueError:
    pass
...
try:
    nd.__getitem__((slice(0, 1, 1), slice(0, 1, 0)))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    nd.__getitem__((slice(0, 1, 0), slice(0, 1, 1)))
    raise AssertionError('expected ValueError')
except ValueError:
    pass
...
try:
    mv.__getitem__((slice(0, 1, 1), slice(0, 1, 0)))
...
try:
    xl.__setitem__(slice(0, 1, 1), xr[7:8])
    raise AssertionError('expected ValueError')
except ValueError:
    pass

assert xl.tolist() == items

try:
    ml.__setitem__(slice(0, 1, 1), mr[7:8])
    raise AssertionError('expected ValueError')
except ValueError:
    pass

assert ml.tolist() == items
xl = ndarray(items, shape=[8], format='B', flags=ND_WRITABLE)
...
assert xl.tolist() == [[1, 2, 3, 4], [5, 6, 7, 8]]
...
try:
    xl.__setitem__(slice(0, 2, 1), xr[7:8])
    raise AssertionError('expected ValueError')
except ValueError:
    pass
...
try:
    ml.__setitem__(slice(0, 2, 1), mr[7:8])
    raise AssertionError('expected ValueError')
except ValueError:
    pass
...
try:
    ...
    pass
print("TestBufferProtocol::test_ndarray_slice_invalid: ok")
