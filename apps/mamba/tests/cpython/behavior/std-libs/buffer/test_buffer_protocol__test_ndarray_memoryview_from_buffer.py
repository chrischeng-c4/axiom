...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_memoryview_from_buffer"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_memoryview_from_buffer"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_memoryview_from_buffer
"""Auto-ported test: TestBufferProtocol::test_ndarray_memoryview_from_buffer (CPython 3.12 oracle)."""
...
for flags in (0, ND_PIL):
    ...
    assert m == nd
print("TestBufferProtocol::test_ndarray_memoryview_from_buffer: ok")
