...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_compare_ndim_one"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_compare_ndim_one"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_compare_ndim_one
"""Auto-ported test: TestBufferProtocol::test_memoryview_compare_ndim_one (CPython 3.12 oracle)."""
...
assert v[::-1] == w[::-2]
print("TestBufferProtocol::test_memoryview_compare_ndim_one: ok")
