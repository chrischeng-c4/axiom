...
# lib = "buffer"
# dimension = "behavior"
# case = "test_python_buffer_protocol__test_bad_buffer_method"
# subject = "cpython.test_buffer.TestPythonBufferProtocol.test_bad_buffer_method"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestPythonBufferProtocol::test_bad_buffer_method
"""Auto-ported test: TestPythonBufferProtocol::test_bad_buffer_method (CPython 3.12 oracle)."""
...
try:
    memoryview(WrongArity())
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("TestPythonBufferProtocol::test_bad_buffer_method: ok")
