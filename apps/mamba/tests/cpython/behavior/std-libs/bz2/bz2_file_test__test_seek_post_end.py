...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_seek_post_end"
# subject = "cpython.test_bz2.BZ2FileTest.testSeekPostEnd"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::testSeekPostEnd
"""Auto-ported test: BZ2FileTest::testSeekPostEnd (CPython 3.12 oracle)."""
...
with BZ2File(self_filename) as bz2f:
    ...
    assert bz2f.read() == b''
print("BZ2FileTest::testSeekPostEnd: ok")
