...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_open_path_like_filename"
# subject = "cpython.test_bz2.BZ2FileTest.testOpenPathLikeFilename"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::testOpenPathLikeFilename
"""Auto-ported test: BZ2FileTest::testOpenPathLikeFilename (CPython 3.12 oracle)."""
...
os.close(fd)
filename = FakePath(self_filename)
with BZ2File(filename, 'wb') as f:
    f.write(DATA)
with BZ2File(filename, 'rb') as f:

    assert f.read() == DATA
print("BZ2FileTest::testOpenPathLikeFilename: ok")
