...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_read_trailing_junk"
# subject = "cpython.test_bz2.BZ2FileTest.testReadTrailingJunk"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::testReadTrailingJunk
"""Auto-ported test: BZ2FileTest::testReadTrailingJunk (CPython 3.12 oracle)."""
...
os.close(fd)
createTempFile(suffix=BAD_DATA)
with BZ2File(self_filename) as bz2f:

    assert bz2f.read() == TEXT
print("BZ2FileTest::testReadTrailingJunk: ok")
