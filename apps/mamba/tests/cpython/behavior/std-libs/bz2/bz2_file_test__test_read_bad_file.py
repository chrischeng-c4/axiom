...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_read_bad_file"
# subject = "cpython.test_bz2.BZ2FileTest.testReadBadFile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::testReadBadFile
"""Auto-ported test: BZ2FileTest::testReadBadFile (CPython 3.12 oracle)."""
...
os.close(fd)
createTempFile(streams=0, suffix=BAD_DATA)
with BZ2File(self_filename) as bz2f:
    ...
    try:
        ...
        pass
print("BZ2FileTest::testReadBadFile: ok")
