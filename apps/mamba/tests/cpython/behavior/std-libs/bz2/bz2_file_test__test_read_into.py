...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_read_into"
# subject = "cpython.test_bz2.BZ2FileTest.testReadInto"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::testReadInto
"""Auto-ported test: BZ2FileTest::testReadInto (CPython 3.12 oracle)."""
...
with BZ2File(self_filename) as bz2f:
    ...
    assert b[:n] == TEXT[-n:]
print("BZ2FileTest::testReadInto: ok")
