...
# lib = "bz2"
# dimension = "behavior"
# case = "open_test__test_newline"
# subject = "cpython.test_bz2.OpenTest.test_newline"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::OpenTest::test_newline
"""Auto-ported test: OpenTest::test_newline (CPython 3.12 oracle)."""
...
with open(self_filename, 'wt', encoding='utf-8', newline='\n') as f:
    f.write(text)
with open(self_filename, 'rt', encoding='utf-8', newline='\r') as f:

    assert f.readlines() == [text]
print("OpenTest::test_newline: ok")
