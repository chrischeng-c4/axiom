...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_open_filename"
# subject = "cpython.test_bz2.BZ2FileTest.testOpenFilename"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::testOpenFilename
"""Auto-ported test: BZ2FileTest::testOpenFilename (CPython 3.12 oracle)."""
...
try:
    ...
    pass
with BZ2File(self_filename, 'ab') as f:
    f.write(b'appendix')
...
try:
    ...
    pass
with BZ2File(self_filename, 'rb') as f:
...
try:
    ...
    pass
print("BZ2FileTest::testOpenFilename: ok")
