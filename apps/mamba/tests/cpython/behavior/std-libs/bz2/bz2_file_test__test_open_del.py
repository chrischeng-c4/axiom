...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_open_del"
# subject = "cpython.test_bz2.BZ2FileTest.testOpenDel"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::testOpenDel
"""Auto-ported test: BZ2FileTest::testOpenDel (CPython 3.12 oracle)."""
...
for i in range(10000):
    o = BZ2File(self_filename)
    del o
print("BZ2FileTest::testOpenDel: ok")
