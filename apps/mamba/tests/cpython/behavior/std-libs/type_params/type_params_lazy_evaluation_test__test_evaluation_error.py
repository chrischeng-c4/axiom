...
# lib = "type_params"
# dimension = "behavior"
# case = "type_params_lazy_evaluation_test__test_evaluation_error"
# subject = "cpython.test_type_params.TypeParamsLazyEvaluationTest.test_evaluation_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_params.py::TypeParamsLazyEvaluationTest::test_evaluation_error
"""Auto-ported test: TypeParamsLazyEvaluationTest::test_evaluation_error (CPython 3.12 oracle)."""
...
assert type_params[0].__bound__ == 'defined'

assert type_params[0].__constraints__ == ()

assert type_params[1].__bound__ is None

assert type_params[1].__constraints__ == ('defined',)
print("TypeParamsLazyEvaluationTest::test_evaluation_error: ok")
