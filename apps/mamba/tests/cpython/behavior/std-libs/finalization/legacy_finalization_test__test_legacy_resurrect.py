...
# lib = "finalization"
# dimension = "behavior"
# case = "legacy_finalization_test__test_legacy_resurrect"
# subject = "cpython.test_finalization.LegacyFinalizationTest.test_legacy_resurrect"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_finalization.py::LegacyFinalizationTest::test_legacy_resurrect
"""Auto-ported test: LegacyFinalizationTest::test_legacy_resurrect (CPython 3.12 oracle)."""
...
with SimpleBase.test():
    ...
    gc.collect()
    assert_del_calls(ids)
    assert_tp_del_calls(ids * 2)
    assert_survivors(ids)

assert wr() is None
print("LegacyFinalizationTest::test_legacy_resurrect: ok")
