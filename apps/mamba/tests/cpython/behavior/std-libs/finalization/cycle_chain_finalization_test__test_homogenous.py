...
# lib = "finalization"
# dimension = "behavior"
# case = "cycle_chain_finalization_test__test_homogenous"
# subject = "cpython.test_finalization.CycleChainFinalizationTest.test_homogenous"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_finalization.py::CycleChainFinalizationTest::test_homogenous
"""Auto-ported test: CycleChainFinalizationTest::test_homogenous (CPython 3.12 oracle)."""
...
gc.garbage[:] = []
check_non_resurrecting_chain([SimpleChained] * 3)
print("CycleChainFinalizationTest::test_homogenous: ok")
