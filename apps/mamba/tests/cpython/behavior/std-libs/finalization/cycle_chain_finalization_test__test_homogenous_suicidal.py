...
# lib = "finalization"
# dimension = "behavior"
# case = "cycle_chain_finalization_test__test_homogenous_suicidal"
# subject = "cpython.test_finalization.CycleChainFinalizationTest.test_homogenous_suicidal"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_finalization.py::CycleChainFinalizationTest::test_homogenous_suicidal
"""Auto-ported test: CycleChainFinalizationTest::test_homogenous_suicidal (CPython 3.12 oracle)."""
...
gc.garbage[:] = []
check_non_resurrecting_chain([SuicidalChained] * 3)
print("CycleChainFinalizationTest::test_homogenous_suicidal: ok")
