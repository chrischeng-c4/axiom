...
# lib = "finalization"
# dimension = "behavior"
# case = "cycle_chain_finalization_test__test_heterogenous_suicidal_one"
# subject = "cpython.test_finalization.CycleChainFinalizationTest.test_heterogenous_suicidal_one"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_finalization.py::CycleChainFinalizationTest::test_heterogenous_suicidal_one
"""Auto-ported test: CycleChainFinalizationTest::test_heterogenous_suicidal_one (CPython 3.12 oracle)."""
...
gc.garbage[:] = []
check_non_resurrecting_chain([SuicidalChained, SimpleChained] * 2)
print("CycleChainFinalizationTest::test_heterogenous_suicidal_one: ok")
