...
# lib = "structures"
# dimension = "behavior"
# case = "structure_test_case__test_pass_by_value"
# subject = "cpython.test_structures.StructureTestCase.test_pass_by_value"
# kind = "semantic"
...
assert s.third == 195894762

print("StructureTestCase::test_pass_by_value: ok")
