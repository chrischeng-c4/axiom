...
# lib = "structures"
# dimension = "behavior"
# case = "structure_test_case__test_abstract_class"
# subject = "cpython.test_structures.StructureTestCase.test_abstract_class"
# kind = "semantic"
...
cls, msg = get_except(eval, 'X()', locals())
assert (cls, msg) == (TypeError, 'abstract class')

print("StructureTestCase::test_abstract_class: ok")
