...
# lib = "structures"
# dimension = "behavior"
# case = "structure_test_case__test_unions"
# subject = "cpython.test_structures.StructureTestCase.test_unions"
# kind = "semantic"
...
for code, tp in formats.items():
    ...
    assert (sizeof(X), code) == (calcsize('%c' % code), code)

print("StructureTestCase::test_unions: ok")
