...
# lib = "structures"
# dimension = "behavior"
# case = "structure_test_case__test_initializers"
# subject = "cpython.test_structures.StructureTestCase.test_initializers"
# kind = "semantic"
...
try:
    ...
    pass
assert Person(b'12345', 5).name == b'12345'
assert Person(b'123456', 5).name == b'123456'
try:
    Person(b'1234567', 5)
    raise AssertionError('assertRaises: no raise')
except ValueError:
...
print("StructureTestCase::test_initializers: ok")
