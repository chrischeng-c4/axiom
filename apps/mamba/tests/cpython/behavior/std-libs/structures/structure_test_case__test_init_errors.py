...
# lib = "structures"
# dimension = "behavior"
# case = "structure_test_case__test_init_errors"
# subject = "cpython.test_structures.StructureTestCase.test_init_errors"
# kind = "semantic"
...
cls, msg = get_except(Person, b'Someone', (1, 2))
assert cls == RuntimeError
assert msg == '(Phone) TypeError: expected bytes, int found'
cls, msg = get_except(Person, b'Someone', (b'a', b'b', b'c'))
assert cls == RuntimeError
assert msg == '(Phone) TypeError: too many initializers'

print("StructureTestCase::test_init_errors: ok")
