...
# lib = "tracemalloc"
# dimension = "behavior"
# case = "test_snapshot__test_statistic_diff_format"
# subject = "cpython.test_tracemalloc.TestSnapshot.test_statistic_diff_format"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tracemalloc.py::TestSnapshot::test_statistic_diff_format
"""Auto-ported test: TestSnapshot::test_statistic_diff_format (CPython 3.12 oracle)."""
...
assert str(stat) == 'a.py:5: size=5002 B (+5000 B), count=2 (+1), average=2501 B'
print("TestSnapshot::test_statistic_diff_format: ok")
