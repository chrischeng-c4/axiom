...
# lib = "tracemalloc"
# dimension = "behavior"
# case = "test_snapshot__test_format_traceback"
# subject = "cpython.test_tracemalloc.TestSnapshot.test_format_traceback"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tracemalloc.py::TestSnapshot::test_format_traceback
"""Auto-ported test: TestSnapshot::test_format_traceback (CPython 3.12 oracle)."""
...
with unittest.mock.patch('tracemalloc.linecache.getline', side_effect=getline):
    ...
    assert tb.format() == ['  File "b.py", line 4', '    <b.py, 4>', '  File "a.py", line 2', '    <a.py, 2>']

    assert tb.format(limit=1) == ['  File "a.py", line 2', '    <a.py, 2>']

    assert tb.format(limit=-1) == ['  File "b.py", line 4', '    <b.py, 4>']

    assert tb.format(most_recent_first=True) == ['  File "a.py", line 2', '    <a.py, 2>', '  File "b.py", line 4', '    <b.py, 4>']

    assert tb.format(limit=1, most_recent_first=True) == ['  File "a.py", line 2', '    <a.py, 2>']

    assert tb.format(limit=-1, most_recent_first=True) == ['  File "b.py", line 4', '    <b.py, 4>']
print("TestSnapshot::test_format_traceback: ok")
