...
# lib = "zlib"
# dimension = "behavior"
# case = "compress_object_test_case__test_flush_custom_length"
# subject = "cpython.test_zlib.CompressObjectTestCase.test_flush_custom_length"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_zlib.py::CompressObjectTestCase::test_flush_custom_length
"""Auto-ported test: CompressObjectTestCase::test_flush_custom_length (CPython 3.12 oracle)."""
...
assert dco.flush(CustomInt()) == input[1:]
print("CompressObjectTestCase::test_flush_custom_length: ok")
