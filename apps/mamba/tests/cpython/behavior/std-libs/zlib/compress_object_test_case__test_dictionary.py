...
# lib = "zlib"
# dimension = "behavior"
# case = "compress_object_test_case__test_dictionary"
# subject = "cpython.test_zlib.CompressObjectTestCase.test_dictionary"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_zlib.py::CompressObjectTestCase::test_dictionary
"""Auto-ported test: CompressObjectTestCase::test_dictionary (CPython 3.12 oracle)."""
...
assert dco.decompress(cd) + dco.flush() == h
...
try:
    ...
    pass
print("CompressObjectTestCase::test_dictionary: ok")
