...
# lib = "zlib"
# dimension = "behavior"
# case = "exception_test_case__test_overflow"
# subject = "cpython.test_zlib.ExceptionTestCase.test_overflow"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_zlib.py::ExceptionTestCase::test_overflow
"""Auto-ported test: ExceptionTestCase::test_overflow (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('int too large', str(_aR_e))
try:
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('int too large', str(_aR_e))
print("ExceptionTestCase::test_overflow: ok")
