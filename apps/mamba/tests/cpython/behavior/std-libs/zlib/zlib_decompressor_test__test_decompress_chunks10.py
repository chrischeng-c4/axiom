...
# lib = "zlib"
# dimension = "behavior"
# case = "zlib_decompressor_test__test_decompress_chunks10"
# subject = "cpython.test_zlib.ZlibDecompressorTest.testDecompressChunks10"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_zlib.py::ZlibDecompressorTest::testDecompressChunks10
"""Auto-ported test: ZlibDecompressorTest::testDecompressChunks10 (CPython 3.12 oracle)."""
...
assert text == TEXT
print("ZlibDecompressorTest::testDecompressChunks10: ok")
