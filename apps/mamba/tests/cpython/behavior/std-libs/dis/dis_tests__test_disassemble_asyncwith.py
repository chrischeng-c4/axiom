...
# lib = "dis"
# dimension = "behavior"
# case = "dis_tests__test_disassemble_asyncwith"
# subject = "cpython.test_dis.DisTests.test_disassemble_asyncwith"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisTests::test_disassemble_asyncwith
"""Auto-ported test: DisTests::test_disassemble_asyncwith (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
do_disassembly_test(_asyncwith, dis_asyncwith)
print("DisTests::test_disassemble_asyncwith: ok")
