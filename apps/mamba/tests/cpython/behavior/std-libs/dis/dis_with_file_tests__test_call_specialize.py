...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_call_specialize"
# subject = "cpython.test_dis.DisWithFileTests.test_call_specialize"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_call_specialize
"""Auto-ported test: DisWithFileTests::test_call_specialize (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
call_quicken = '  0        RESUME                   0\n\n  1        PUSH_NULL\n           LOAD_NAME                0 (str)\n           LOAD_CONST               0 (1)\n           CALL_NO_KW_STR_1         1\n           RETURN_VALUE\n'
co = compile('str(1)', '', 'eval')
code_quicken(lambda: exec(co, {}, {}))
got = get_disassembly(co, adaptive=True)
do_disassembly_compare(got, call_quicken)
print("DisWithFileTests::test_call_specialize: ok")
