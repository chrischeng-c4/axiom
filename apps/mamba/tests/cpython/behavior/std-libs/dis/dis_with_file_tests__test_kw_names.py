...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_kw_names"
# subject = "cpython.test_dis.DisWithFileTests.test_kw_names"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_kw_names
"""Auto-ported test: DisWithFileTests::test_kw_names (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
do_disassembly_test(wrap_func_w_kwargs, dis_kw_names)
print("DisWithFileTests::test_kw_names: ok")
