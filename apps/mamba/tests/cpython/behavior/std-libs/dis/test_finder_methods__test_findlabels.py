...
# lib = "dis"
# dimension = "behavior"
# case = "test_finder_methods__test_findlabels"
# subject = "cpython.test_dis.TestFinderMethods.test_findlabels"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::TestFinderMethods::test_findlabels
"""Auto-ported test: TestFinderMethods::test_findlabels (CPython 3.12 oracle)."""
...
jumps = [instr.offset for instr in expected_opinfo_jumpy if instr.is_jump_target]

assert sorted(labels) == sorted(jumps)
print("TestFinderMethods::test_findlabels: ok")
