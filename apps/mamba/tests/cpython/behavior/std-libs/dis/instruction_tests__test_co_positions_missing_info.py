...
# lib = "dis"
# dimension = "behavior"
# case = "instruction_tests__test_co_positions_missing_info"
# subject = "cpython.test_dis.InstructionTests.test_co_positions_missing_info"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::InstructionTests::test_co_positions_missing_info
"""Auto-ported test: InstructionTests::test_co_positions_missing_info (CPython 3.12 oracle)."""
...
for instruction in actual:
    ...
    assert positions.lineno is None

    assert positions.end_lineno is None

    assert positions.col_offset is None

    assert positions.end_col_offset is None
print("InstructionTests::test_co_positions_missing_info: ok")
