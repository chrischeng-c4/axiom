...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_disassemble_with"
# subject = "cpython.test_dis.DisWithFileTests.test_disassemble_with"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_disassemble_with
"""Auto-ported test: DisWithFileTests::test_disassemble_with (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
do_disassembly_test(_with, dis_with)
print("DisWithFileTests::test_disassemble_with: ok")
