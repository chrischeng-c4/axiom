...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_opmap"
# subject = "cpython.test_dis.DisWithFileTests.test_opmap"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_opmap
"""Auto-ported test: DisWithFileTests::test_opmap (CPython 3.12 oracle)."""
...
assert dis.opmap['NOP'] == 9

assert dis.opmap['LOAD_CONST'] in dis.hasconst

assert dis.opmap['STORE_NAME'] in dis.hasname
print("DisWithFileTests::test_opmap: ok")
