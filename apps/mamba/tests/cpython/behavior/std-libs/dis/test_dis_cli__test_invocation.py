...
# lib = "dis"
# dimension = "behavior"
# case = "test_dis_cli__test_invocation"
# subject = "cpython.test_dis.TestDisCLI.test_invocation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::TestDisCLI::test_invocation
"""Auto-ported test: TestDisCLI::test_invocation (CPython 3.12 oracle)."""
...
# --- test body ---
self_filename = tempfile.mktemp()
pass
try:
    with contextlib.redirect_stderr(io.StringIO()):
        dis.main(args=['--unknown', self_filename])
    raise AssertionError('expected SystemExit')
except SystemExit:
    pass
print("TestDisCLI::test_invocation: ok")
