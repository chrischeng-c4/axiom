...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_disassemble_coroutine"
# subject = "cpython.test_dis.DisWithFileTests.test_disassemble_coroutine"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_disassemble_coroutine
"""Auto-ported test: DisWithFileTests::test_disassemble_coroutine (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
coro_func_disas = get_disassembly(_co)
coro = _co(1)
coro.close()
coro_disas = get_disassembly(coro)

assert coro_disas == coro_func_disas
print("DisWithFileTests::test_disassemble_coroutine: ok")
