...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_disassemble_static_method"
# subject = "cpython.test_dis.DisWithFileTests.test_disassemble_static_method"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_disassemble_static_method
"""Auto-ported test: DisWithFileTests::test_disassemble_static_method (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
do_disassembly_test(_C.sm, dis_c_static_method)
print("DisWithFileTests::test_disassemble_static_method: ok")
