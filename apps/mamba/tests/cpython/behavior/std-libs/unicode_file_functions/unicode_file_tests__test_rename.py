...
# dimension = "behavior"
# case = "unicode_file_tests__test_rename"
# subject = "cpython.test_unicode_file_functions.UnicodeFileTests.test_rename"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_unicode_file_functions.py::UnicodeFileTests::test_rename
"""Auto-ported test: UnicodeFileTests::test_rename (CPython 3.12 oracle)."""
...
for name in files:
    os.rename(name, 'tmp')
    os.rename('tmp', name)
print("UnicodeFileTests::test_rename: ok")
