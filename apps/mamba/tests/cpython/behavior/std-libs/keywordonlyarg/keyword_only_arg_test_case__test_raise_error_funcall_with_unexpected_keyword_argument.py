...
# lib = "keywordonlyarg"
# dimension = "behavior"
# case = "keyword_only_arg_test_case__test_raise_error_funcall_with_unexpected_keyword_argument"
# subject = "cpython.test_keywordonlyarg.KeywordOnlyArgTestCase.testRaiseErrorFuncallWithUnexpectedKeywordArgument"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_keywordonlyarg.py::KeywordOnlyArgTestCase::testRaiseErrorFuncallWithUnexpectedKeywordArgument
"""Auto-ported test: KeywordOnlyArgTestCase::testRaiseErrorFuncallWithUnexpectedKeywordArgument (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("KeywordOnlyArgTestCase::testRaiseErrorFuncallWithUnexpectedKeywordArgument: ok")
