...
# lib = "keywordonlyarg"
# dimension = "behavior"
# case = "keyword_only_arg_test_case__test_syntax_error_for_function_call"
# subject = "cpython.test_keywordonlyarg.KeywordOnlyArgTestCase.testSyntaxErrorForFunctionCall"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_keywordonlyarg.py::KeywordOnlyArgTestCase::testSyntaxErrorForFunctionCall
"""Auto-ported test: KeywordOnlyArgTestCase::testSyntaxErrorForFunctionCall (CPython 3.12 oracle)."""
...
def assertRaisesSyntaxError(codestr):
    ...
    try:
        ...
        pass
assertRaisesSyntaxError('f(p, k=1, p2)')
assertRaisesSyntaxError('f(p, k1=50, *(1,2), k1=100)')
print("KeywordOnlyArgTestCase::testSyntaxErrorForFunctionCall: ok")
