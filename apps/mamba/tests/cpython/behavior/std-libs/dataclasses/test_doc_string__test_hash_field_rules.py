...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_doc_string__test_hash_field_rules"
# subject = "cpython.__init__.TestDocString.test_hash_field_rules"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestDocString::test_hash_field_rules
"""Auto-ported test: TestDocString::test_hash_field_rules (CPython 3.12 oracle)."""
...
print("TestDocString::test_hash_field_rules: ok")
