...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_hash__test_field_named_like_builtin_frozen"
# subject = "cpython.__init__.TestHash.test_field_named_like_builtin_frozen"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestHash::test_field_named_like_builtin_frozen
"""Auto-ported test: TestHash::test_field_named_like_builtin_frozen (CPython 3.12 oracle)."""
...
print("TestHash::test_field_named_like_builtin_frozen: ok")
