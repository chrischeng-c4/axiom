...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_case__test_overwrite_hash"
# subject = "cpython.__init__.TestCase.test_overwrite_hash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestCase::test_overwrite_hash
"""Auto-ported test: TestCase::test_overwrite_hash (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot overwrite attribute __hash__', str(_aR_e))
print("TestCase::test_overwrite_hash: ok")
