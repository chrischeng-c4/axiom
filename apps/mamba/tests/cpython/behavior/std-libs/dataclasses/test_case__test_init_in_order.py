...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_case__test_init_in_order"
# subject = "cpython.__init__.TestCase.test_init_in_order"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestCase::test_init_in_order
"""Auto-ported test: TestCase::test_init_in_order (CPython 3.12 oracle)."""
...
assert ('f', 4) == calls[4]
print("TestCase::test_init_in_order: ok")
