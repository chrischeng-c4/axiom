...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_eq__test_no_eq"
# subject = "cpython.__init__.TestEq.test_no_eq"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestEq::test_no_eq
"""Auto-ported test: TestEq::test_no_eq (CPython 3.12 oracle)."""
