...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_replace__test_field_repr"
# subject = "cpython.__init__.TestReplace.test_field_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestReplace::test_field_repr
"""Auto-ported test: TestReplace::test_field_repr (CPython 3.12 oracle)."""
...
print("TestReplace::test_field_repr: ok")
