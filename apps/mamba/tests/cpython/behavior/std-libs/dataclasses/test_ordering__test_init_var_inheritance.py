...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_ordering__test_init_var_inheritance"
# subject = "cpython.__init__.TestOrdering.test_init_var_inheritance"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestOrdering::test_init_var_inheritance
"""Auto-ported test: TestOrdering::test_init_var_inheritance (CPython 3.12 oracle)."""
...
print("TestOrdering::test_init_var_inheritance: ok")
