...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_ordering__test_field_named_like_builtin_frozen"
# subject = "cpython.__init__.TestOrdering.test_field_named_like_builtin_frozen"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestOrdering::test_field_named_like_builtin_frozen
"""Auto-ported test: TestOrdering::test_field_named_like_builtin_frozen (CPython 3.12 oracle)."""
...
print("TestOrdering::test_field_named_like_builtin_frozen: ok")
