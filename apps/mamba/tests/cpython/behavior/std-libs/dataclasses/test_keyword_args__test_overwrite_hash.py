...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_keyword_args__test_overwrite_hash"
# subject = "cpython.__init__.TestKeywordArgs.test_overwrite_hash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestKeywordArgs::test_overwrite_hash
"""Auto-ported test: TestKeywordArgs::test_overwrite_hash (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot overwrite attribute __hash__', str(_aR_e))
print("TestKeywordArgs::test_overwrite_hash: ok")
