...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_repr__test_no_unhashable_default"
# subject = "cpython.__init__.TestRepr.test_no_unhashable_default"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestRepr::test_no_unhashable_default
"""Auto-ported test: TestRepr::test_no_unhashable_default (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(unhashable_re, str(_aR_e))
print("TestRepr::test_no_unhashable_default: ok")
