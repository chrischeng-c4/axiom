...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_replace__test_field_named_like_builtin_frozen"
# subject = "cpython.__init__.TestReplace.test_field_named_like_builtin_frozen"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestReplace::test_field_named_like_builtin_frozen
"""Auto-ported test: TestReplace::test_field_named_like_builtin_frozen (CPython 3.12 oracle)."""
...
print("TestReplace::test_field_named_like_builtin_frozen: ok")
