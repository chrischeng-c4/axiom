...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_ordering__test_init_var"
# subject = "cpython.__init__.TestOrdering.test_init_var"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestOrdering::test_init_var
"""Auto-ported test: TestOrdering::test_init_var (CPython 3.12 oracle)."""
...
assert c.x == 20
print("TestOrdering::test_init_var: ok")
