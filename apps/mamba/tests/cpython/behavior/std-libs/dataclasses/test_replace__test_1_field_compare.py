...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_replace__test_1_field_compare"
# subject = "cpython.__init__.TestReplace.test_1_field_compare"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestReplace::test_1_field_compare
"""Auto-ported test: TestReplace::test_1_field_compare (CPython 3.12 oracle)."""
...
assert C(1) >= C(1)
print("TestReplace::test_1_field_compare: ok")
