...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_ordering__test_1_field_compare"
# subject = "cpython.__init__.TestOrdering.test_1_field_compare"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestOrdering::test_1_field_compare
"""Auto-ported test: TestOrdering::test_1_field_compare (CPython 3.12 oracle)."""
...
assert C(1) >= C(1)
print("TestOrdering::test_1_field_compare: ok")
