...
# lib = "socket"
# dimension = "behavior"
# case = "inheritance_test__test_set_inheritable"
# subject = "cpython.test_socket.InheritanceTest.test_set_inheritable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_socket.py::InheritanceTest::test_set_inheritable
"""Auto-ported test: InheritanceTest::test_set_inheritable (CPython 3.12 oracle)."""
...
with sock:
    ...
    assert sock.get_inheritable() == True
    sock.set_inheritable(False)

    assert sock.get_inheritable() == False
print("InheritanceTest::test_set_inheritable: ok")
