...
# lib = "telnetlib"
# dimension = "behavior"
# case = "read_tests__test_read_lazy"
# subject = "cpython.test_telnetlib.ReadTests.test_read_lazy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_telnetlib.py::ReadTests::test_read_lazy
"""Auto-ported test: ReadTests::test_read_lazy (CPython 3.12 oracle)."""
...
assert data == want
print("ReadTests::test_read_lazy: ok")
