...
# lib = "threading"
# dimension = "behavior"
# case = "atexit_tests__test_atexit_called_once"
# subject = "cpython.test_threading.AtexitTests.test_atexit_called_once"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::AtexitTests::test_atexit_called_once
"""Auto-ported test: AtexitTests::test_atexit_called_once (CPython 3.12 oracle)."""
...
assert not err
print("AtexitTests::test_atexit_called_once: ok")
