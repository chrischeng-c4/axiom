...
# lib = "threading"
# dimension = "behavior"
# case = "thread_tests__test_repr_stopped"
# subject = "cpython.test_threading.ThreadTests.test_repr_stopped"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::ThreadTests::test_repr_stopped
"""Auto-ported test: ThreadTests::test_repr_stopped (CPython 3.12 oracle)."""
...
assert LOOKING_FOR in repr(t)
t.join()
print("ThreadTests::test_repr_stopped: ok")
