...
# lib = "threading"
# dimension = "behavior"
# case = "subinterp_threading_tests__test_daemon_threads_not_allowed"
# subject = "cpython.test_threading.SubinterpThreadingTests.test_daemon_threads_not_allowed"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::SubinterpThreadingTests::test_daemon_threads_not_allowed
"""Auto-ported test: SubinterpThreadingTests::test_daemon_threads_not_allowed (CPython 3.12 oracle)."""
...
err = _check_allowed(allowed=True, daemon_allowed=False, daemon=True)

assert 'RuntimeError' in err
err = _check_allowed('t.daemon = True', allowed=True, daemon_allowed=False, daemon=False)

assert 'RuntimeError' in err
print("SubinterpThreadingTests::test_daemon_threads_not_allowed: ok")
