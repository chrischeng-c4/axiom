...
# lib = "threading"
# dimension = "behavior"
# case = "subinterp_threading_tests__test_daemon_threads_fatal_error"
# subject = "cpython.test_threading.SubinterpThreadingTests.test_daemon_threads_fatal_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::SubinterpThreadingTests::test_daemon_threads_fatal_error
"""Auto-ported test: SubinterpThreadingTests::test_daemon_threads_fatal_error (CPython 3.12 oracle)."""
...
assert 'Fatal Python error: Py_EndInterpreter: not the last thread' in err.decode()
print("SubinterpThreadingTests::test_daemon_threads_fatal_error: ok")
