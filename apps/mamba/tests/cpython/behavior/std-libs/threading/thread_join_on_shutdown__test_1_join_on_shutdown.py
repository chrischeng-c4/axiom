...
# lib = "threading"
# dimension = "behavior"
# case = "thread_join_on_shutdown__test_1_join_on_shutdown"
# subject = "cpython.test_threading.ThreadJoinOnShutdown.test_1_join_on_shutdown"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::ThreadJoinOnShutdown::test_1_join_on_shutdown
"""Auto-ported test: ThreadJoinOnShutdown::test_1_join_on_shutdown (CPython 3.12 oracle)."""
...
# --- test body ---
def _run_and_join(script):
    script = "if 1:\n            import sys, os, time, threading\n\n            # a thread, which waits for the main program to terminate\n            def joiningfunc(mainthread):\n                mainthread.join()\n                print('end of thread')\n                # stdout is fully buffered because not a tty, we have to flush\n                # before exit.\n                sys.stdout.flush()\n        \n" + script
    rc, out, err = assert_python_ok('-c', script)
    data = out.decode().replace('\r', '')

    assert data == 'end of main\nend of thread\n'
self__threads = threading_helper.threading_setup()
script = "if 1:\n            import os\n            t = threading.Thread(target=joiningfunc,\n                                 args=(threading.current_thread(),))\n            t.start()\n            time.sleep(0.1)\n            print('end of main')\n            "
_run_and_join(script)
print("ThreadJoinOnShutdown::test_1_join_on_shutdown: ok")
