...
# lib = "threading"
# dimension = "behavior"
# case = "thread_tests__test_gettrace"
# subject = "cpython.test_threading.ThreadTests.test_gettrace"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::ThreadTests::test_gettrace
"""Auto-ported test: ThreadTests::test_gettrace (CPython 3.12 oracle)."""
...
try:
    ...
    assert noop_trace == trace_func
finally:
    threading.settrace(old_trace)
print("ThreadTests::test_gettrace: ok")
