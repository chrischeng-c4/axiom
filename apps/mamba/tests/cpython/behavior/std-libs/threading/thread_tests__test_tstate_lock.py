...
# lib = "threading"
# dimension = "behavior"
# case = "thread_tests__test_tstate_lock"
# subject = "cpython.test_threading.ThreadTests.test_tstate_lock"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::ThreadTests::test_tstate_lock
"""Auto-ported test: ThreadTests::test_tstate_lock (CPython 3.12 oracle)."""
...
assert not tstate_lock.acquire(timeout=0)
finish.release()

assert tstate_lock.acquire(timeout=support.SHORT_TIMEOUT)
...
assert t._tstate_lock is None
t.join()
print("ThreadTests::test_tstate_lock: ok")
