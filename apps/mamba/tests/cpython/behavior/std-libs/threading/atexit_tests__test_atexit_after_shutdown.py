...
# lib = "threading"
# dimension = "behavior"
# case = "atexit_tests__test_atexit_after_shutdown"
# subject = "cpython.test_threading.AtexitTests.test_atexit_after_shutdown"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::AtexitTests::test_atexit_after_shutdown
"""Auto-ported test: AtexitTests::test_atexit_after_shutdown (CPython 3.12 oracle)."""
...
assert "RuntimeError: can't register atexit after shutdown" in err.decode()
print("AtexitTests::test_atexit_after_shutdown: ok")
