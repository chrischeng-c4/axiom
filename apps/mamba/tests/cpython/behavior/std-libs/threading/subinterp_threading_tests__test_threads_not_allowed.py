...
# lib = "threading"
# dimension = "behavior"
# case = "subinterp_threading_tests__test_threads_not_allowed"
# subject = "cpython.test_threading.SubinterpThreadingTests.test_threads_not_allowed"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::SubinterpThreadingTests::test_threads_not_allowed
"""Auto-ported test: SubinterpThreadingTests::test_threads_not_allowed (CPython 3.12 oracle)."""
...
err = _check_allowed(allowed=False, daemon_allowed=False, daemon=False)

assert 'RuntimeError' in err
print("SubinterpThreadingTests::test_threads_not_allowed: ok")
