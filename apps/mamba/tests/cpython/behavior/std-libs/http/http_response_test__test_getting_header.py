...
# lib = "http"
# dimension = "behavior"
# case = "http_response_test__test_getting_header"
# subject = "cpython.test_httplib.HTTPResponseTest.test_getting_header"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::HTTPResponseTest::test_getting_header
"""Auto-ported test: HTTPResponseTest::test_getting_header (CPython 3.12 oracle)."""
...
self_resp.begin()
header = self_resp.getheader('My-Header')

assert header == 'first-value, second-value'
header = self_resp.getheader('My-Header', 'some default')

assert header == 'first-value, second-value'
print("HTTPResponseTest::test_getting_header: ok")
