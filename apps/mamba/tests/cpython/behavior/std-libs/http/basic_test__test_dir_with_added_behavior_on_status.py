...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_dir_with_added_behavior_on_status"
# subject = "cpython.test_httplib.BasicTest.test_dir_with_added_behavior_on_status"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_dir_with_added_behavior_on_status
"""Auto-ported test: BasicTest::test_dir_with_added_behavior_on_status (CPython 3.12 oracle)."""
...
assert {'description', 'name', 'phrase', 'value'} <= set(dir(HTTPStatus(404)))
print("BasicTest::test_dir_with_added_behavior_on_status: ok")
