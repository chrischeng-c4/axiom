...
# lib = "http"
# dimension = "behavior"
# case = "persistence_test__test_reuse_reconnect"
# subject = "cpython.test_httplib.PersistenceTest.test_reuse_reconnect"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::PersistenceTest::test_reuse_reconnect
"""Auto-ported test: PersistenceTest::test_reuse_reconnect (CPython 3.12 oracle)."""
...
for version, header, reuse in tests:
    ...
    with conn.getresponse() as response:
        ...
        assert (conn.sock is None) == (not reuse)
        response.read()
    ...
    assert conn.connections == (1 if reuse else 2)
print("PersistenceTest::test_reuse_reconnect: ok")
