...
# lib = "http"
# dimension = "behavior"
# case = "http_method_tests__test_invalid_method_names"
# subject = "cpython.test_httplib.HttpMethodTests.test_invalid_method_names"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::HttpMethodTests::test_invalid_method_names
"""Auto-ported test: HttpMethodTests::test_invalid_method_names (CPython 3.12 oracle)."""
...
for method in methods:
    try:
        ...
        import re as _re_aR
        assert _re_aR.search("method can't contain control characters", str(_aR_e))
print("HttpMethodTests::test_invalid_method_names: ok")
