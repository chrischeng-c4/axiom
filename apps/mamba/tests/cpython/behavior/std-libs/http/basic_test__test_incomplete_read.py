...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_incomplete_read"
# subject = "cpython.test_httplib.BasicTest.test_incomplete_read"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_incomplete_read
"""Auto-ported test: BasicTest::test_incomplete_read (CPython 3.12 oracle)."""
...
try:
    ...
    assert i.partial == b'Hello\r\n'

    assert repr(i) == 'IncompleteRead(7 bytes read, 3 more expected)'

    assert str(i) == 'IncompleteRead(7 bytes read, 3 more expected)'

    assert resp.isclosed()
else:

    raise AssertionError('IncompleteRead expected')
print("BasicTest::test_incomplete_read: ok")
