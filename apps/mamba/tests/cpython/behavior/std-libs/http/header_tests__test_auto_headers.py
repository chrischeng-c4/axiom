...
# lib = "http"
# dimension = "behavior"
# case = "header_tests__test_auto_headers"
# subject = "cpython.test_httplib.HeaderTests.test_auto_headers"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::HeaderTests::test_auto_headers
"""Auto-ported test: HeaderTests::test_auto_headers (CPython 3.12 oracle)."""
...
for explicit_header in (True, False):
    for header in ('Content-length', 'Host', 'Accept-encoding'):
        ...
        assert conn._buffer.count[header.lower()] == 1
print("HeaderTests::test_auto_headers: ok")
