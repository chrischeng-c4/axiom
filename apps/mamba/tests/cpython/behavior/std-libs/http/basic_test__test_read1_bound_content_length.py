...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_read1_bound_content_length"
# subject = "cpython.test_httplib.BasicTest.test_read1_bound_content_length"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_read1_bound_content_length
"""Auto-ported test: BasicTest::test_read1_bound_content_length (CPython 3.12 oracle)."""
...
assert resp.read1(20) == expected * 2

assert resp.read() == expected

assert sock.file.read() == extradata
resp.close()
print("BasicTest::test_read1_bound_content_length: ok")
