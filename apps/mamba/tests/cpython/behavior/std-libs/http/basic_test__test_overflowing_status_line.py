...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_overflowing_status_line"
# subject = "cpython.test_httplib.BasicTest.test_overflowing_status_line"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_overflowing_status_line
"""Auto-ported test: BasicTest::test_overflowing_status_line (CPython 3.12 oracle)."""
...
try:
    resp.begin()
    raise AssertionError('expected (client.LineTooLong, client.BadStatusLine)')
except (client.LineTooLong, client.BadStatusLine):
    pass
print("BasicTest::test_overflowing_status_line: ok")
