...
# lib = "http"
# dimension = "behavior"
# case = "header_tests__test_headers_debuglevel"
# subject = "cpython.test_httplib.HeaderTests.test_headers_debuglevel"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::HeaderTests::test_headers_debuglevel
"""Auto-ported test: HeaderTests::test_headers_debuglevel (CPython 3.12 oracle)."""
...
assert lines[0] == "reply: 'HTTP/1.1 200 OK\\r\\n'"

assert lines[1] == 'header: First: val'

assert lines[2] == 'header: Second: val1'

assert lines[3] == 'header: Second: val2'
print("HeaderTests::test_headers_debuglevel: ok")
