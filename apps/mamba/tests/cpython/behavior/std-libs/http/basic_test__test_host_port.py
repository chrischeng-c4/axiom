...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_host_port"
# subject = "cpython.test_httplib.BasicTest.test_host_port"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_host_port
"""Auto-ported test: BasicTest::test_host_port (CPython 3.12 oracle)."""
...
for hp in ('www.python.org:abc', 'user:password@www.python.org'):
    ...
    try:
        client.HTTPConnection(hp)
        raise AssertionError('expected client.InvalidURL')
...
for hp, h, p in (('[fe80::207:e9ff:fe9b]:8000', 'fe80::207:e9ff:fe9b', 8000), ('www.python.org:80', 'www.python.org', 80), ('www.python.org:', 'www.python.org', 80), ('www.python.org', 'www.python.org', 80), ('[fe80::207:e9ff:fe9b]', 'fe80::207:e9ff:fe9b', 80), ('[fe80::207:e9ff:fe9b]:', 'fe80::207:e9ff:fe9b', 80)):
    ...
    assert p == c.port
print("BasicTest::test_host_port: ok")
