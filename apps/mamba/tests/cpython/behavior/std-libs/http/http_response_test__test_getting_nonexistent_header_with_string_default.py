...
# lib = "http"
# dimension = "behavior"
# case = "http_response_test__test_getting_nonexistent_header_with_string_default"
# subject = "cpython.test_httplib.HTTPResponseTest.test_getting_nonexistent_header_with_string_default"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::HTTPResponseTest::test_getting_nonexistent_header_with_string_default
"""Auto-ported test: HTTPResponseTest::test_getting_nonexistent_header_with_string_default (CPython 3.12 oracle)."""
...
self_resp = client.HTTPResponse(sock)
self_resp.begin()
header = self_resp.getheader('No-Such-Header', 'default-value')

assert header == 'default-value'
print("HTTPResponseTest::test_getting_nonexistent_header_with_string_default: ok")
