...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_blocksize_request"
# subject = "cpython.test_httplib.BasicTest.test_blocksize_request"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_blocksize_request
"""Auto-ported test: BasicTest::test_blocksize_request (CPython 3.12 oracle)."""
...
assert sock.sendall_calls == 3
body = sock.data.split(b'\r\n\r\n', 1)[1]

assert body == expected
print("BasicTest::test_blocksize_request: ok")
