...
# lib = "http"
# dimension = "behavior"
# case = "header_tests__test_invalid_headers"
# subject = "cpython.test_httplib.HeaderTests.test_invalid_headers"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::HeaderTests::test_invalid_headers
"""Auto-ported test: HeaderTests::test_invalid_headers (CPython 3.12 oracle)."""
...
for name, value in cases:
    try:
        ...
        import re as _re_aR
        assert _re_aR.search('Invalid header', str(_aR_e))
print("HeaderTests::test_invalid_headers: ok")
