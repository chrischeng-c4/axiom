...
# lib = "http"
# dimension = "behavior"
# case = "tunnel_tests__test_tunnel_debuglog"
# subject = "cpython.test_httplib.TunnelTests.test_tunnel_debuglog"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::TunnelTests::test_tunnel_debuglog
"""Auto-ported test: TunnelTests::test_tunnel_debuglog (CPython 3.12 oracle)."""
...
assert 'header: {}'.format(expected_header) in lines
print("TunnelTests::test_tunnel_debuglog: ok")
