...
# lib = "marshal"
# dimension = "behavior"
# case = "bugs_test_case__test_patch_873224"
# subject = "cpython.test_marshal.BugsTestCase.test_patch_873224"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::BugsTestCase::test_patch_873224
"""Auto-ported test: BugsTestCase::test_patch_873224 (CPython 3.12 oracle)."""
...
try:
    marshal.loads(marshal.dumps(2 ** 65)[:-1])
    raise AssertionError('expected Exception')
except Exception:
    pass
print("BugsTestCase::test_patch_873224: ok")
