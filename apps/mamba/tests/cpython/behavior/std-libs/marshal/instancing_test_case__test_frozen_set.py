...
# lib = "marshal"
# dimension = "behavior"
# case = "instancing_test_case__test_frozen_set"
# subject = "cpython.test_marshal.InstancingTestCase.testFrozenSet"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::InstancingTestCase::testFrozenSet
"""Auto-ported test: InstancingTestCase::testFrozenSet (CPython 3.12 oracle)."""
...
for obj in keys:
    ...
    helper(frozensetobj)
    helper3(frozensetobj)
print("InstancingTestCase::testFrozenSet: ok")
