...
# lib = "marshal"
# dimension = "behavior"
# case = "capi_test_case__test_write_long_to_file"
# subject = "cpython.test_marshal.CAPI_TestCase.test_write_long_to_file"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::CAPI_TestCase::test_write_long_to_file
"""Auto-ported test: CAPI_TestCase::test_write_long_to_file (CPython 3.12 oracle)."""
...
for v in range(marshal.version + 1):
    ...
    assert data == b'xV4\x12'
print("CAPI_TestCase::test_write_long_to_file: ok")
