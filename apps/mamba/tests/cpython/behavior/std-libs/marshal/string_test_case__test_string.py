...
# lib = "marshal"
# dimension = "behavior"
# case = "string_test_case__test_string"
# subject = "cpython.test_marshal.StringTestCase.test_string"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::StringTestCase::test_string
"""Auto-ported test: StringTestCase::test_string (CPython 3.12 oracle)."""
...
for s in ['', 'Andrè Previn', 'abc', ' ' * 10000]:
    helper(s)
print("StringTestCase::test_string: ok")
