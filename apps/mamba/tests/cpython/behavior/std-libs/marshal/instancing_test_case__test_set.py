...
# lib = "marshal"
# dimension = "behavior"
# case = "instancing_test_case__test_set"
# subject = "cpython.test_marshal.InstancingTestCase.testSet"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::InstancingTestCase::testSet
"""Auto-ported test: InstancingTestCase::testSet (CPython 3.12 oracle)."""
...
for obj in keys:
    ...
    helper(setobj)
    helper3(setobj)
print("InstancingTestCase::testSet: ok")
