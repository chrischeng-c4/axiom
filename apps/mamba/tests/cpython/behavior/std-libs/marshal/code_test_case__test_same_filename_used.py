...
# lib = "marshal"
# dimension = "behavior"
# case = "code_test_case__test_same_filename_used"
# subject = "cpython.test_marshal.CodeTestCase.test_same_filename_used"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::CodeTestCase::test_same_filename_used
"""Auto-ported test: CodeTestCase::test_same_filename_used (CPython 3.12 oracle)."""
...
for obj in co.co_consts:
    if isinstance(obj, types.CodeType):
        ...
        assert co.co_filename is obj.co_filename
print("CodeTestCase::test_same_filename_used: ok")
