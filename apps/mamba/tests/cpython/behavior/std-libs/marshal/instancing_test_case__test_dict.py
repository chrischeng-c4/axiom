...
# lib = "marshal"
# dimension = "behavior"
# case = "instancing_test_case__test_dict"
# subject = "cpython.test_marshal.InstancingTestCase.testDict"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::InstancingTestCase::testDict
"""Auto-ported test: InstancingTestCase::testDict (CPython 3.12 oracle)."""
...
for obj in keys:
    ...
    helper(dictobj)
    helper3(dictobj)
print("InstancingTestCase::testDict: ok")
