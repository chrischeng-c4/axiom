...
# lib = "marshal"
# dimension = "behavior"
# case = "bugs_test_case__test_recursion_limit"
# subject = "cpython.test_marshal.BugsTestCase.test_recursion_limit"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::BugsTestCase::test_recursion_limit
"""Auto-ported test: BugsTestCase::test_recursion_limit (CPython 3.12 oracle)."""
...
assert len(new_head) == len(head)

assert len(new_head[0]) == len(head[0])

assert len(new_head[-1]) == len(head[-1])
last.append([0])
...
try:
    ...
    pass
print("BugsTestCase::test_recursion_limit: ok")
