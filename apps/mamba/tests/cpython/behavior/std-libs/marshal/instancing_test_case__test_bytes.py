...
# lib = "marshal"
# dimension = "behavior"
# case = "instancing_test_case__test_bytes"
# subject = "cpython.test_marshal.InstancingTestCase.testBytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::InstancingTestCase::testBytes
"""Auto-ported test: InstancingTestCase::testBytes (CPython 3.12 oracle)."""
...
helper(bytesobj)
helper3(bytesobj)
print("InstancingTestCase::testBytes: ok")
