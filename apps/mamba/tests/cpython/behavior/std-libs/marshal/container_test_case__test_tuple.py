...
# lib = "marshal"
# dimension = "behavior"
# case = "container_test_case__test_tuple"
# subject = "cpython.test_marshal.ContainerTestCase.test_tuple"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::ContainerTestCase::test_tuple
"""Auto-ported test: ContainerTestCase::test_tuple (CPython 3.12 oracle)."""
...
def helper(sample, *extra):
    ...
    try:
        ...
        os_helper.unlink(os_helper.TESTFN)
helper(tuple(d.keys()))
print("ContainerTestCase::test_tuple: ok")
