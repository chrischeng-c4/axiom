...
# lib = "marshal"
# dimension = "behavior"
# case = "bugs_test_case__test_bad_reader"
# subject = "cpython.test_marshal.BugsTestCase.test_bad_reader"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::BugsTestCase::test_bad_reader
"""Auto-ported test: BugsTestCase::test_bad_reader (CPython 3.12 oracle)."""
...
for value in (1.0, 1j, b'0123456789', '0123456789'):
    ...
    try:
        marshal.load(BadReader(marshal.dumps(value)))
        raise AssertionError('expected ValueError')
    except ValueError:
        pass
print("BugsTestCase::test_bad_reader: ok")
