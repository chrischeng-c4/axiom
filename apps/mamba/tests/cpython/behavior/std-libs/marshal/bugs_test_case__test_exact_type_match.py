...
# lib = "marshal"
# dimension = "behavior"
# case = "bugs_test_case__test_exact_type_match"
# subject = "cpython.test_marshal.BugsTestCase.test_exact_type_match"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::BugsTestCase::test_exact_type_match
"""Auto-ported test: BugsTestCase::test_exact_type_match (CPython 3.12 oracle)."""
...
for typ in (int, float, complex, tuple, list, dict, set, frozenset):
    ...
    try:
        ...
        pass
print("BugsTestCase::test_exact_type_match: ok")
