...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_type_subclass_generic"
# subject = "cpython.test_genericalias.BaseTest.test_type_subclass_generic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_type_subclass_generic
"""Auto-ported test: BaseTest::test_type_subclass_generic (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('MyType', str(_aR_e))
print("BaseTest::test_type_subclass_generic: ok")
