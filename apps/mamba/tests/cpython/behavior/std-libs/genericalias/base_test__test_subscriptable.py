...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_subscriptable"
# subject = "cpython.test_genericalias.BaseTest.test_subscriptable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_subscriptable
"""Auto-ported test: BaseTest::test_subscriptable (CPython 3.12 oracle)."""
...
for t in generic_types:
    ...
    assert alias.__origin__ is t

    assert alias.__args__ == (int,)

    assert alias.__parameters__ == ()
print("BaseTest::test_subscriptable: ok")
