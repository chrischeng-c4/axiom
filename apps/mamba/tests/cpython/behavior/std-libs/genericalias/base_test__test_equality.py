...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_equality"
# subject = "cpython.test_genericalias.BaseTest.test_equality"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_equality
"""Auto-ported test: BaseTest::test_equality (CPython 3.12 oracle)."""
...
assert dict[str, int] == dict[str, int]

assert (*tuple[int],)[0] == (*tuple[int],)[0]

assert tuple[*tuple[int],] == tuple[*tuple[int],]

assert dict[str, int] != dict[str, str]
...
assert (*tuple[int],)[0] != tuple[int]
print("BaseTest::test_equality: ok")
