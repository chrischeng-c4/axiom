...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_iter_creates_starred_tuple"
# subject = "cpython.test_genericalias.BaseTest.test_iter_creates_starred_tuple"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_iter_creates_starred_tuple
"""Auto-ported test: BaseTest::test_iter_creates_starred_tuple (CPython 3.12 oracle)."""
...
assert repr(x) == '*tuple[int, str]'
print("BaseTest::test_iter_creates_starred_tuple: ok")
