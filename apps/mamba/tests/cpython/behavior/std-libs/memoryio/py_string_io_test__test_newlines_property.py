...
# lib = "memoryio"
# dimension = "behavior"
# case = "py_string_io_test__test_newlines_property"
# subject = "cpython.test_memoryio.PyStringIOTest.test_newlines_property"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::PyStringIOTest::test_newlines_property
"""Auto-ported test: PyStringIOTest::test_newlines_property (CPython 3.12 oracle)."""
...
def write_ops(f, t):
    ...
    assert f.tell() == 1
memio = ioclass(newline=None)

def force_decode():
    memio.seek(0)
    memio.read()

assert memio.newlines == None
memio.write('a\n')
force_decode()

assert memio.newlines == '\n'
memio.write('b\r\n')
force_decode()
...
assert memio.newlines == ('\r', '\n', '\r\n')
print("PyStringIOTest::test_newlines_property: ok")
