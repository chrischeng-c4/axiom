...
# lib = "memoryio"
# dimension = "behavior"
# case = "c_bytes_io_test__test_relative_seek"
# subject = "cpython.test_memoryio.CBytesIOTest.test_relative_seek"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::CBytesIOTest::test_relative_seek
"""Auto-ported test: CBytesIOTest::test_relative_seek (CPython 3.12 oracle)."""
...
assert memio.seek(-1, 1) == 0

assert memio.seek(3, 1) == 3

assert memio.seek(-4, 1) == 0

assert memio.seek(-1, 2) == 9

assert memio.seek(1, 1) == 10

assert memio.seek(1, 2) == 11
memio.seek(-3, 2)

assert memio.read() == buf[-3:]
memio.seek(0)
memio.seek(1, 1)

assert memio.read() == buf[1:]
print("CBytesIOTest::test_relative_seek: ok")
