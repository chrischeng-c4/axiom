...
# lib = "memoryio"
# dimension = "behavior"
# case = "c_string_io_test__test_setstate"
# subject = "cpython.test_memoryio.CStringIOTest.test_setstate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::CStringIOTest::test_setstate
"""Auto-ported test: CStringIOTest::test_setstate (CPython 3.12 oracle)."""
...
try:
    memio.__setstate__(('', 'f', 0, None))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    memio.__setstate__(('', '', -1, None))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    memio.__setstate__((b'', '', 0, None))
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
try:
    memio.__setstate__(('', '', 0.0, None))
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    memio.__setstate__(('', '', 0, 0))
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    memio.__setstate__(('len-test', 0))
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
try:
    memio.__setstate__(('closed', '', 0, None))
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("CStringIOTest::test_setstate: ok")
