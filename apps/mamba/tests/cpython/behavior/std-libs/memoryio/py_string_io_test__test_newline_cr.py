...
# lib = "memoryio"
# dimension = "behavior"
# case = "py_string_io_test__test_newline_cr"
# subject = "cpython.test_memoryio.PyStringIOTest.test_newline_cr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::PyStringIOTest::test_newline_cr
"""Auto-ported test: PyStringIOTest::test_newline_cr (CPython 3.12 oracle)."""
...
assert memio.read() == 'a\rb\r\rc\rd'
memio.seek(0)

assert list(memio) == ['a\r', 'b\r', '\r', 'c\r', 'd']

assert memio.getvalue() == 'a\rb\r\rc\rd'
memio = ioclass(newline='\r')

assert memio.write('a\nb\r\nc\rd') == 8
memio.seek(0)

assert list(memio) == ['a\r', 'b\r', '\r', 'c\r', 'd']
memio.seek(0)

assert memio.readlines() == ['a\r', 'b\r', '\r', 'c\r', 'd']

assert memio.getvalue() == 'a\rb\r\rc\rd'
print("PyStringIOTest::test_newline_cr: ok")
