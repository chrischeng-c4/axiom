...
# lib = "memoryio"
# dimension = "behavior"
# case = "py_string_io_test__test_init"
# subject = "cpython.test_memoryio.PyStringIOTest.test_init"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::PyStringIOTest::test_init
"""Auto-ported test: PyStringIOTest::test_init (CPython 3.12 oracle)."""
...
assert memio.getvalue() == EOF
memio.__init__(buf * 2)

assert memio.getvalue() == buf * 2
memio.__init__(buf)
...
try:
    ...
    pass
print("PyStringIOTest::test_init: ok")
