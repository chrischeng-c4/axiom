...
# lib = "memoryio"
# dimension = "behavior"
# case = "c_bytes_io_test__test_setstate"
# subject = "cpython.test_memoryio.CBytesIOTest.test_setstate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::CBytesIOTest::test_setstate
"""Auto-ported test: CBytesIOTest::test_setstate (CPython 3.12 oracle)."""
...
try:
    memio.__setstate__((b'', -1, None))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    memio.__setstate__(('unicode', 0, None))
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    memio.__setstate__((b'', 0.0, None))
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    memio.__setstate__((b'', 0, 0))
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    memio.__setstate__((b'len-test', 0))
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
try:
    memio.__setstate__((b'closed', 0, None))
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("CBytesIOTest::test_setstate: ok")
