...
# lib = "memoryio"
# dimension = "behavior"
# case = "c_bytes_io_test__test_cow_setstate"
# subject = "cpython.test_memoryio.CBytesIOTest.test_cow_setstate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::CBytesIOTest::test_cow_setstate
"""Auto-ported test: CBytesIOTest::test_cow_setstate (CPython 3.12 oracle)."""
...
def write_ops(f, t):
    ...
    assert f.tell() == 1
memio = ioclass(b'foooooo')
state = memio.__getstate__()

def mutation(memio):
    memio.__setstate__(state)
_test_cow_mutation(mutation)
print("CBytesIOTest::test_cow_setstate: ok")
