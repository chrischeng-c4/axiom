...
# lib = "memoryio"
# dimension = "behavior"
# case = "py_string_io_test__test_newline_none"
# subject = "cpython.test_memoryio.PyStringIOTest.test_newline_none"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::PyStringIOTest::test_newline_none
"""Auto-ported test: PyStringIOTest::test_newline_none (CPython 3.12 oracle)."""
...
assert 3 == memio.write('b\r\n')

assert 3 == memio.write('c\rd')
memio.seek(0)
...
assert memio.read(3) == 'a\nb'
print("PyStringIOTest::test_newline_none: ok")
