...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "xmlrpc_test_case__test_dump_bare_datetime"
# subject = "cpython.test_xmlrpc.XMLRPCTestCase.test_dump_bare_datetime"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::XMLRPCTestCase::test_dump_bare_datetime
"""Auto-ported test: XMLRPCTestCase::test_dump_bare_datetime (CPython 3.12 oracle)."""
...
assert dt == xmlrpclib.DateTime('20050210T11:41:23')
...
assert type(newdt) is datetime.datetime
...
assert type(newdt) is xmlrpclib.DateTime
...
assert m is None
print("XMLRPCTestCase::test_dump_bare_datetime: ok")
