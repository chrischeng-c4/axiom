...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "xmlrpc_test_case__test_dump_bytes"
# subject = "cpython.test_xmlrpc.XMLRPCTestCase.test_dump_bytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::XMLRPCTestCase::test_dump_bytes
"""Auto-ported test: XMLRPCTestCase::test_dump_bytes (CPython 3.12 oracle)."""
...
assert sample == xmlrpclib.Binary(sample)
for type_ in (bytes, bytearray, xmlrpclib.Binary):
    ...
    assert newvalue == sample

    assert type(newvalue) is bytes
    ...
    assert type(newvalue) is xmlrpclib.Binary

    assert m is None
print("XMLRPCTestCase::test_dump_bytes: ok")
