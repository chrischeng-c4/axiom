...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "xmlrpc_test_case__test_dump_bad_dict"
# subject = "cpython.test_xmlrpc.XMLRPCTestCase.test_dump_bad_dict"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::XMLRPCTestCase::test_dump_bad_dict
"""Auto-ported test: XMLRPCTestCase::test_dump_bad_dict (CPython 3.12 oracle)."""
...
try:
    xmlrpclib.dumps(({(1, 2, 3): 1},))
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("XMLRPCTestCase::test_dump_bad_dict: ok")
