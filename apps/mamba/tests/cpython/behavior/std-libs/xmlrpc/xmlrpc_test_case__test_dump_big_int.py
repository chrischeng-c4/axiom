...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "xmlrpc_test_case__test_dump_big_int"
# subject = "cpython.test_xmlrpc.XMLRPCTestCase.test_dump_big_int"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::XMLRPCTestCase::test_dump_big_int
"""Auto-ported test: XMLRPCTestCase::test_dump_big_int (CPython 3.12 oracle)."""
...
try:
    xmlrpclib.dumps((xmlrpclib.MAXINT + 1,))
    raise AssertionError('expected OverflowError')
except OverflowError:
    pass

try:
    xmlrpclib.dumps((xmlrpclib.MININT - 1,))
    raise AssertionError('expected OverflowError')
except OverflowError:
    pass
...
try:
    ...
    pass
print("XMLRPCTestCase::test_dump_big_int: ok")
