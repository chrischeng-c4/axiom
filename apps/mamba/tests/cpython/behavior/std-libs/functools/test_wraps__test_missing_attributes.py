...
# lib = "functools"
# dimension = "behavior"
# case = "test_wraps__test_missing_attributes"
# subject = "cpython.test_functools.TestWraps.test_missing_attributes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestWraps::test_missing_attributes
"""Auto-ported test: TestWraps::test_missing_attributes (CPython 3.12 oracle)."""
...
assert 'attr' not in wrapper.__dict__

assert wrapper.dict_attr == {}
...
try:
    ...
    pass
print("TestWraps::test_missing_attributes: ok")
