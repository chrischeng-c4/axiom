...
# lib = "functools"
# dimension = "behavior"
# case = "test_update_wrapper__test_update_type_wrapper"
# subject = "cpython.test_functools.TestUpdateWrapper.test_update_type_wrapper"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestUpdateWrapper::test_update_type_wrapper
"""Auto-ported test: TestUpdateWrapper::test_update_type_wrapper (CPython 3.12 oracle)."""
...
assert wrapper.__name__ == 'type'

assert wrapper.__annotations__ == {}

assert wrapper.__type_params__ == ()
print("TestUpdateWrapper::test_update_type_wrapper: ok")
