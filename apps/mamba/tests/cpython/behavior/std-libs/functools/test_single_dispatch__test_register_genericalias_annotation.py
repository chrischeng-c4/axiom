...
# lib = "functools"
# dimension = "behavior"
# case = "test_single_dispatch__test_register_genericalias_annotation"
# subject = "cpython.test_functools.TestSingleDispatch.test_register_genericalias_annotation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestSingleDispatch::test_register_genericalias_annotation
"""Auto-ported test: TestSingleDispatch::test_register_genericalias_annotation (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search("Invalid annotation for 'arg'", str(_aR_e))
try:
...
assert f(b'') == 'default'
print("TestSingleDispatch::test_register_genericalias_annotation: ok")
