...
# lib = "functools"
# dimension = "behavior"
# case = "test_partial_py_subclass__test_partial_genericalias"
# subject = "cpython.test_functools.TestPartialPySubclass.test_partial_genericalias"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestPartialPySubclass::test_partial_genericalias
"""Auto-ported test: TestPartialPySubclass::test_partial_genericalias (CPython 3.12 oracle)."""
...
assert alias.__origin__ is partial

assert alias.__args__ == (int,)

assert alias.__parameters__ == ()
print("TestPartialPySubclass::test_partial_genericalias: ok")
