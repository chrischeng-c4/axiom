...
# lib = "functools"
# dimension = "behavior"
# case = "test_cmp_to_key_py__test_cmp_to_key_arguments"
# subject = "cpython.test_functools.TestCmpToKeyPy.test_cmp_to_key_arguments"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestCmpToKeyPy::test_cmp_to_key_arguments
"""Auto-ported test: TestCmpToKeyPy::test_cmp_to_key_arguments (CPython 3.12 oracle)."""
...
def cmp1(x, y):
    return (x > y) - (x < y)
key = cmp_to_key(mycmp=cmp1)

assert key(obj=3) == key(obj=3)

assert key(obj=3) > key(obj=1)
try:
    key(3) > 1
...
try:
    ...
    pass
print("TestCmpToKeyPy::test_cmp_to_key_arguments: ok")
