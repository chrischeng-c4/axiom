...
# lib = "functools"
# dimension = "behavior"
# case = "test_cached_property__test_doc"
# subject = "cpython.test_functools.TestCachedProperty.test_doc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestCachedProperty::test_doc
"""Auto-ported test: TestCachedProperty::test_doc (CPython 3.12 oracle)."""
...
assert CachedCostItem.cost.__doc__ == ('The cost of the item.' if support.HAVE_DOCSTRINGS else None)
print("TestCachedProperty::test_doc: ok")
