...
# lib = "functools"
# dimension = "behavior"
# case = "test_single_dispatch__test_method_bad_hash"
# subject = "cpython.test_functools.TestSingleDispatch.test_method_bad_hash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestSingleDispatch::test_method_bad_hash
"""Auto-ported test: TestSingleDispatch::test_method_bad_hash (CPython 3.12 oracle)."""
...
hash(A().t)
A().t == A().t
print("TestSingleDispatch::test_method_bad_hash: ok")
