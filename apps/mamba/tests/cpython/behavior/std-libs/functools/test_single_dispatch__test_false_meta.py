...
# lib = "functools"
# dimension = "behavior"
# case = "test_single_dispatch__test_false_meta"
# subject = "cpython.test_functools.TestSingleDispatch.test_false_meta"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestSingleDispatch::test_false_meta
"""Auto-ported test: TestSingleDispatch::test_false_meta (CPython 3.12 oracle)."""
...
assert fun(aa) == 'fun A'
print("TestSingleDispatch::test_false_meta: ok")
