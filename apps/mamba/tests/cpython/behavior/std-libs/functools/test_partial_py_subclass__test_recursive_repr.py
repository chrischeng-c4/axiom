...
# lib = "functools"
# dimension = "behavior"
# case = "test_partial_py_subclass__test_recursive_repr"
# subject = "cpython.test_functools.TestPartialPySubclass.test_recursive_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestPartialPySubclass::test_recursive_repr
"""Auto-ported test: TestPartialPySubclass::test_recursive_repr (CPython 3.12 oracle)."""
...
try:
    ...
    assert repr(f) == '%s(%r, ...)' % (name, capture)
finally:
    f.__setstate__((capture, (), {}, {}))
f = partial(capture)
...
try:
    ...
    assert repr(f) == '%s(%r, a=...)' % (name, capture)
finally:
    f.__setstate__((capture, (), {}, {}))
print("TestPartialPySubclass::test_recursive_repr: ok")
