...
# lib = "functools"
# dimension = "behavior"
# case = "test_lru_py__test_common_signatures"
# subject = "cpython.test_functools.TestLRUPy.test_common_signatures"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestLRUPy::test_common_signatures
"""Auto-ported test: TestLRUPy::test_common_signatures (CPython 3.12 oracle)."""
...
def orig():
    ...
lru = module.lru_cache(1)(orig)

assert str(Signature.from_callable(lru.cache_info)) == '()'

assert str(Signature.from_callable(lru.cache_clear)) == '()'
print("TestLRUPy::test_common_signatures: ok")
