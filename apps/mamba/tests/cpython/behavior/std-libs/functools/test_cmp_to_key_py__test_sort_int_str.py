...
# lib = "functools"
# dimension = "behavior"
# case = "test_cmp_to_key_py__test_sort_int_str"
# subject = "cpython.test_functools.TestCmpToKeyPy.test_sort_int_str"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestCmpToKeyPy::test_sort_int_str
"""Auto-ported test: TestCmpToKeyPy::test_sort_int_str (CPython 3.12 oracle)."""
...
values = sorted(values, key=cmp_to_key(mycmp))

assert [int(value) for value in values] == [0, 1, 1, 2, 3, 4, 5, 7, 10]
print("TestCmpToKeyPy::test_sort_int_str: ok")
