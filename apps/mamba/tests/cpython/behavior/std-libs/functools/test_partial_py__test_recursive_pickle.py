...
# lib = "functools"
# dimension = "behavior"
# case = "test_partial_py__test_recursive_pickle"
# subject = "cpython.test_functools.TestPartialPy.test_recursive_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestPartialPy::test_recursive_pickle
"""Auto-ported test: TestPartialPy::test_recursive_pickle (CPython 3.12 oracle)."""
...
with replaced_module('functools', module):
    ...
    try:
        ...
        f.__setstate__((capture, (), {}, {}))
print("TestPartialPy::test_recursive_pickle: ok")
