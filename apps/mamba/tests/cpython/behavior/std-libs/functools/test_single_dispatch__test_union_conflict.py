...
# lib = "functools"
# dimension = "behavior"
# case = "test_single_dispatch__test_union_conflict"
# subject = "cpython.test_functools.TestSingleDispatch.test_union_conflict"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestSingleDispatch::test_union_conflict
"""Auto-ported test: TestSingleDispatch::test_union_conflict (CPython 3.12 oracle)."""
...
assert f('') == 'types.UnionType'

assert f(b'') == 'typing.Union'

assert f(1) == 'types.UnionType'
print("TestSingleDispatch::test_union_conflict: ok")
