...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_module_in_package"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_module_in_package"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_module_in_package
"""Auto-ported test: CmdLineTest::test_module_in_package (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir:
    ...
    _check_script(['-m', 'test_pkg.script'], script_name, script_name, script_dir, 'test_pkg', importlib.machinery.SourceFileLoader, cwd=script_dir)
print("CmdLineTest::test_module_in_package: ok")
