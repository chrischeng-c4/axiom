...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_script_abspath"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_script_abspath"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_script_abspath
"""Auto-ported test: CmdLineTest::test_script_abspath (CPython 3.12 oracle)."""
...
with os_helper.temp_cwd() as script_dir:
    ...
    _check_script(relative_name, script_name, relative_name, script_dir, None, importlib.machinery.SourceFileLoader)
print("CmdLineTest::test_script_abspath: ok")
