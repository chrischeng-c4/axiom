...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_zipfile_compiled_unchecked_hash"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_zipfile_compiled_unchecked_hash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_zipfile_compiled_unchecked_hash
"""Auto-ported test: CmdLineTest::test_zipfile_compiled_unchecked_hash (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir:
    ...
    _check_script(zip_name, run_name, zip_name, zip_name, '', zipimport.zipimporter)
print("CmdLineTest::test_zipfile_compiled_unchecked_hash: ok")
