...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_directory"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_directory"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_directory
"""Auto-ported test: CmdLineTest::test_directory (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir:
    ...
    _check_script(script_dir, script_name, script_dir, script_dir, '', importlib.machinery.SourceFileLoader)
print("CmdLineTest::test_directory: ok")
