...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_issue8202_dash_m_file_ignored"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_issue8202_dash_m_file_ignored"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_issue8202_dash_m_file_ignored
"""Auto-ported test: CmdLineTest::test_issue8202_dash_m_file_ignored (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir:
    ...
    with os_helper.change_cwd(path=script_dir):
        with open('-m', 'w', encoding='utf-8') as f:
            ...
            _check_output(script_name, rc, out, script_name, script_name, script_dir, '', importlib.machinery.SourceFileLoader)
print("CmdLineTest::test_issue8202_dash_m_file_ignored: ok")
