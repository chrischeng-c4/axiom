...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_syntaxerror_null_bytes_in_multiline_string"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_syntaxerror_null_bytes_in_multiline_string"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_syntaxerror_null_bytes_in_multiline_string
"""Auto-ported test: CmdLineTest::test_syntaxerror_null_bytes_in_multiline_string (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir:
    for script in scripts:
        ...
        assert stderr.splitlines()[-2:] == [b'    multilinestring', b'SyntaxError: source code cannot contain null bytes']
print("CmdLineTest::test_syntaxerror_null_bytes_in_multiline_string: ok")
