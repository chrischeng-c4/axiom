...
# lib = "genericpath"
# dimension = "behavior"
# case = "test_generic_test__test_sameopenfile"
# subject = "cpython.test_genericpath.TestGenericTest.test_sameopenfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericpath.py::TestGenericTest::test_sameopenfile
"""Auto-ported test: TestGenericTest::test_sameopenfile (CPython 3.12 oracle)."""
...
with open(filename, 'rb', 0) as fp1:
    ...
    with open(filename, 'rb', 0) as fp2:
        ...
        assert pathmodule.sameopenfile(fd1, fd2)
print("TestGenericTest::test_sameopenfile: ok")
