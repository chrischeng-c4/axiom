...
# lib = "genericpath"
# dimension = "behavior"
# case = "test_generic_test__test_samestat"
# subject = "cpython.test_genericpath.TestGenericTest.test_samestat"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericpath.py::TestGenericTest::test_samestat
"""Auto-ported test: TestGenericTest::test_samestat (CPython 3.12 oracle)."""
...
assert pathmodule.samestat(stat1, os.stat(test_fn1))
create_file(test_fn2)
stat2 = os.stat(test_fn2)

assert not pathmodule.samestat(stat1, stat2)
...
try:
    ...
    pass
print("TestGenericTest::test_samestat: ok")
