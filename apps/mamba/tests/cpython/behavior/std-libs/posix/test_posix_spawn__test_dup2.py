...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_spawn__test_dup2"
# subject = "cpython.test_posix.TestPosixSpawn.test_dup2"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixSpawn::test_dup2
"""Auto-ported test: TestPosixSpawn::test_dup2 (CPython 3.12 oracle)."""
...
with open(dupfile, encoding='utf-8') as f:
    ...
    assert f.read() == 'hello'
print("TestPosixSpawn::test_dup2: ok")
