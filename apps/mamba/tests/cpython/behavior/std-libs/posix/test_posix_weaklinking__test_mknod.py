...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_weaklinking__test_mknod"
# subject = "cpython.test_posix.TestPosixWeaklinking.test_mknod"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixWeaklinking::test_mknod
"""Auto-ported test: TestPosixWeaklinking::test_mknod (CPython 3.12 oracle)."""
...
_verify_available('HAVE_MKNODAT')
if self_mac_ver >= (13, 0):

    assert 'HAVE_MKNODAT' in posix._have_functions
else:

    assert 'HAVE_MKNODAT' not in posix._have_functions
    try:
...
print("TestPosixWeaklinking::test_mknod: ok")
