...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_weaklinking__test_stat"
# subject = "cpython.test_posix.TestPosixWeaklinking.test_stat"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixWeaklinking::test_stat
"""Auto-ported test: TestPosixWeaklinking::test_stat (CPython 3.12 oracle)."""
...
_verify_available('HAVE_FSTATAT')
if self_mac_ver >= (10, 10):

    assert 'HAVE_FSTATAT' in posix._have_functions
else:

    assert 'HAVE_FSTATAT' not in posix._have_functions
    try:
...
print("TestPosixWeaklinking::test_stat: ok")
