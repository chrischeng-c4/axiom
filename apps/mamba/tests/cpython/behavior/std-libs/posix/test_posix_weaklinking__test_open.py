...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_weaklinking__test_open"
# subject = "cpython.test_posix.TestPosixWeaklinking.test_open"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixWeaklinking::test_open
"""Auto-ported test: TestPosixWeaklinking::test_open (CPython 3.12 oracle)."""
...
_verify_available('HAVE_OPENAT')
if self_mac_ver >= (10, 10):

    assert 'HAVE_OPENAT' in posix._have_functions
else:

    assert 'HAVE_OPENAT' not in posix._have_functions
    try:
...
print("TestPosixWeaklinking::test_open: ok")
