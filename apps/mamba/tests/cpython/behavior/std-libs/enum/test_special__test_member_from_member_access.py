...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_member_from_member_access"
# subject = "cpython.test_enum.TestSpecial.test_member_from_member_access"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_member_from_member_access
"""Auto-ported test: TestSpecial::test_member_from_member_access (CPython 3.12 oracle)."""
...
assert warn is Di.NO

assert Di.name is Di['name']

assert Di.name.name == 'name'
print("TestSpecial::test_member_from_member_access: ok")
