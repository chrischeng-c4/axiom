...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_custom_flag_bitwise"
# subject = "cpython.test_enum.TestSpecial.test_custom_flag_bitwise"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_custom_flag_bitwise
"""Auto-ported test: TestSpecial::test_custom_flag_bitwise (CPython 3.12 oracle)."""
...
assert isinstance(MyIntFlag.ONE | MyIntFlag.TWO, MyIntFlag)

assert isinstance(MyIntFlag.ONE | 2, MyIntFlag)
print("TestSpecial::test_custom_flag_bitwise: ok")
