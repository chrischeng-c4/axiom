...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_reserved_sunder_error"
# subject = "cpython.test_enum.TestSpecial.test_reserved_sunder_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_reserved_sunder_error
"""Auto-ported test: TestSpecial::test_reserved_sunder_error (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('_sunder_ names, such as ._bad_., are reserved', str(_aR_e))
print("TestSpecial::test_reserved_sunder_error: ok")
