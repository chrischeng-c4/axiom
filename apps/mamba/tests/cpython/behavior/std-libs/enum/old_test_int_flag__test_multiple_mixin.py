...
# lib = "enum"
# dimension = "behavior"
# case = "old_test_int_flag__test_multiple_mixin"
# subject = "cpython.test_enum.OldTestIntFlag.test_multiple_mixin"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::OldTestIntFlag::test_multiple_mixin
"""Auto-ported test: OldTestIntFlag::test_multiple_mixin (CPython 3.12 oracle)."""
...
assert Color.ALL.value == 7

assert str(Color.BLUE) == '4'
...
assert str(Color.BLUE) == 'blue'
print("OldTestIntFlag::test_multiple_mixin: ok")
