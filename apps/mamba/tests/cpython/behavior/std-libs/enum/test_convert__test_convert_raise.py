...
# lib = "enum"
# dimension = "behavior"
# case = "test_convert__test_convert_raise"
# subject = "cpython.test_enum.TestConvert.test_convert_raise"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestConvert::test_convert_raise
"""Auto-ported test: TestConvert::test_convert_raise (CPython 3.12 oracle)."""
...
# --- test body ---
try:
    enum.IntEnum._convert('UnittestConvert', MODULE, filter=lambda x: x.startswith('CONVERT_TEST_'))
    raise AssertionError('expected AttributeError')
except AttributeError:
    pass
print("TestConvert::test_convert_raise: ok")
