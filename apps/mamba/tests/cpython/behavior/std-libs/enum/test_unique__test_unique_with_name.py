...
# lib = "enum"
# dimension = "behavior"
# case = "test_unique__test_unique_with_name"
# subject = "cpython.test_enum.TestUnique.test_unique_with_name"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestUnique::test_unique_with_name
"""Auto-ported test: TestUnique::test_unique_with_name (CPython 3.12 oracle)."""
...
class Sillier(IntEnum):
    ...
    triple = 3
    value = 4
print("TestUnique::test_unique_with_name: ok")
