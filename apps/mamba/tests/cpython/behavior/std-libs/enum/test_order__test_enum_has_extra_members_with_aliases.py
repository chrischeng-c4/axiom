...
# lib = "enum"
# dimension = "behavior"
# case = "test_order__test_enum_has_extra_members_with_aliases"
# subject = "cpython.test_enum.TestOrder.test_enum_has_extra_members_with_aliases"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestOrder::test_enum_has_extra_members_with_aliases
"""Auto-ported test: TestOrder::test_enum_has_extra_members_with_aliases (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('member order does not match _order_', str(_aR_e))
print("TestOrder::test_enum_has_extra_members_with_aliases: ok")
