...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_contains_name_and_value_overlap"
# subject = "cpython.test_enum.TestSpecial.test_contains_name_and_value_overlap"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_contains_name_and_value_overlap
"""Auto-ported test: TestSpecial::test_contains_name_and_value_overlap (CPython 3.12 oracle)."""
...
assert IntEnum1.X in IntEnum1

assert IntEnum1.X in IntEnum2

assert IntEnum1.X not in IntEnum3

assert IntEnum1.X in IntEnum4
print("TestSpecial::test_contains_name_and_value_overlap: ok")
