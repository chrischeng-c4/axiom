...
# lib = "enum"
# dimension = "behavior"
# case = "test_unique__test_unique_dirty"
# subject = "cpython.test_enum.TestUnique.test_unique_dirty"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestUnique::test_unique_dirty
"""Auto-ported test: TestUnique::test_unique_dirty (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('tres.*one', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search('double.*single.*turkey.*triple', str(_aR_e))
print("TestUnique::test_unique_dirty: ok")
