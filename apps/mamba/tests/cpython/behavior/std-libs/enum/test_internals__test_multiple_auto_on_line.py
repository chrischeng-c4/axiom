...
# lib = "enum"
# dimension = "behavior"
# case = "test_internals__test_multiple_auto_on_line"
# subject = "cpython.test_enum.TestInternals.test_multiple_auto_on_line"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestInternals::test_multiple_auto_on_line
"""Auto-ported test: TestInternals::test_multiple_auto_on_line (CPython 3.12 oracle)."""
...
assert Huh.ONE.value == 1

assert Huh.TWO.value == (2, 3)

assert Huh.THREE.value == (4, 5, 6)
...
assert Hah.MONDAY.value == 'MONDAY'

assert Hah.MONDAY.abbr == 'mon'

assert Hah.TUESDAY.value == 'TUESDAY'

assert Hah.TUESDAY.abbr == 'tue'

assert Hah.WEDNESDAY.value == 'WEDNESDAY'

assert Hah.WEDNESDAY.abbr == 'WED'

assert Hah.THURSDAY.value == 'THURSDAY'

assert Hah.THURSDAY.abbr == 'Thu'

assert Hah.FRIDAY.value == 'FRIDAY'

assert Hah.FRIDAY.abbr == 'fri'
...
assert Huh.TWO.value == (2, 2)

assert Huh.THREE.value == (3, 3, 3)
print("TestInternals::test_multiple_auto_on_line: ok")
