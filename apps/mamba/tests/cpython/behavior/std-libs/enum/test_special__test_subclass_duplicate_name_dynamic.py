...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_subclass_duplicate_name_dynamic"
# subject = "cpython.test_enum.TestSpecial.test_subclass_duplicate_name_dynamic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_subclass_duplicate_name_dynamic
"""Auto-ported test: TestSpecial::test_subclass_duplicate_name_dynamic (CPython 3.12 oracle)."""
...
assert Test.test.test == 'dynamic'

assert Test.test.value == 1
...
assert Test.flash.flash == 'flashy dynamic'

assert Test.flash.value == 1
print("TestSpecial::test_subclass_duplicate_name_dynamic: ok")
