...
# lib = "enum"
# dimension = "behavior"
# case = "test_order__test_same_members_with_aliases"
# subject = "cpython.test_enum.TestOrder.test_same_members_with_aliases"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestOrder::test_same_members_with_aliases
"""Auto-ported test: TestOrder::test_same_members_with_aliases (CPython 3.12 oracle)."""
...
class Color(Enum):
    ...
    blue = 3
    verde = green
print("TestOrder::test_same_members_with_aliases: ok")
