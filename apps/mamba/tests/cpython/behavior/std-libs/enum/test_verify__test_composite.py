...
# lib = "enum"
# dimension = "behavior"
# case = "test_verify__test_composite"
# subject = "cpython.test_enum.TestVerify.test_composite"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestVerify::test_composite
"""Auto-ported test: TestVerify::test_composite (CPython 3.12 oracle)."""
...
assert list(Bizarre) == [Bizarre.c]

assert Bizarre.b.value == 3

assert Bizarre.c.value == 4

assert Bizarre.d.value == 6
try:
    ...
    import re as _re_aR
    assert _re_aR.search("invalid Flag 'Bizarre': aliases b and d are missing combined values of 0x3 .use enum.show_flag_values.value. for details.", str(_aR_e))

assert enum.show_flag_values(3) == [1, 2]
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search("invalid Flag 'Bizarre': alias d is missing value 0x2 .use enum.show_flag_values.value. for details.", str(_aR_e))

assert enum.show_flag_values(2) == [2]
print("TestVerify::test_composite: ok")
