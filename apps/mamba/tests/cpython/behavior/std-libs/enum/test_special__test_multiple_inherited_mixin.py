...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_multiple_inherited_mixin"
# subject = "cpython.test_enum.TestSpecial.test_multiple_inherited_mixin"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_multiple_inherited_mixin
"""Auto-ported test: TestSpecial::test_multiple_inherited_mixin (CPython 3.12 oracle)."""
...
class Decision2(MyEnum):
    ...
    REVERT_ALL = 'REVERT_ALL'
    RETRY = 'RETRY'
print("TestSpecial::test_multiple_inherited_mixin: ok")
