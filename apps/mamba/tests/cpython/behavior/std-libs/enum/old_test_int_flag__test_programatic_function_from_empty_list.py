...
# lib = "enum"
# dimension = "behavior"
# case = "old_test_int_flag__test_programatic_function_from_empty_list"
# subject = "cpython.test_enum.OldTestIntFlag.test_programatic_function_from_empty_list"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::OldTestIntFlag::test_programatic_function_from_empty_list
"""Auto-ported test: OldTestIntFlag::test_programatic_function_from_empty_list (CPython 3.12 oracle)."""
...
assert len(lst) == len(Thing)

assert len(Thing) == 0
print("OldTestIntFlag::test_programatic_function_from_empty_list: ok")
