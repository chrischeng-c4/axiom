...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_custom_strenum"
# subject = "cpython.test_enum.TestSpecial.test_custom_strenum"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_custom_strenum
"""Auto-ported test: TestSpecial::test_custom_strenum (CPython 3.12 oracle)."""
...
assert OkayEnum.one == '1'

assert str(OkayEnum.one) == 'OkayEnum.one'

assert '{}'.format(OkayEnum.one) == 'OkayEnum.one'

assert repr(OkayEnum.one) == "<OkayEnum.one: '1'>"
...
assert str(HelloEnum.eight) == 'HelloEnum.eight'
...
assert str(GoodbyeEnum.nine) == 'GoodbyeEnum.nine'
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('.encoding. must be str, not ', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search('.errors. must be str, not ', str(_aR_e))
print("TestSpecial::test_custom_strenum: ok")
