...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_contains_different_types_same_members"
# subject = "cpython.test_enum.TestSpecial.test_contains_different_types_same_members"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_contains_different_types_same_members
"""Auto-ported test: TestSpecial::test_contains_different_types_same_members (CPython 3.12 oracle)."""
...
assert IntEnum1.X in IntFlag1

assert IntFlag1.X in IntEnum1
print("TestSpecial::test_contains_different_types_same_members: ok")
