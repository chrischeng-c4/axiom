...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_multiple_mixin_with_common_data_type"
# subject = "cpython.test_enum.TestSpecial.test_multiple_mixin_with_common_data_type"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_multiple_mixin_with_common_data_type
"""Auto-ported test: TestSpecial::test_multiple_mixin_with_common_data_type (CPython 3.12 oracle)."""
...
assert list(JobStatus) == [JS.ACTIVE, JS.PENDING, JS.TERMINATED]

assert JS.ACTIVE == 'active'

assert JS.ACTIVE.value == 'active'

assert JS('Active') is JS.ACTIVE

assert JS.ACTIVE.valid
missing = JS('missing')
...
assert isinstance(missing, JS)

assert not missing.valid
print("TestSpecial::test_multiple_mixin_with_common_data_type: ok")
