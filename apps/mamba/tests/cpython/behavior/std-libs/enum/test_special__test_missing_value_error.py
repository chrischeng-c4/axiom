...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_missing_value_error"
# subject = "cpython.test_enum.TestSpecial.test_missing_value_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_missing_value_error
"""Auto-ported test: TestSpecial::test_missing_value_error (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('_value_ not set in __new__', str(_aR_e))
print("TestSpecial::test_missing_value_error: ok")
