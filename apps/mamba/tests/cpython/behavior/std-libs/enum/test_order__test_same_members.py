...
# lib = "enum"
# dimension = "behavior"
# case = "test_order__test_same_members"
# subject = "cpython.test_enum.TestOrder.test_same_members"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestOrder::test_same_members
"""Auto-ported test: TestOrder::test_same_members (CPython 3.12 oracle)."""
...
class Color(Enum):
    ...
    green = 2
    blue = 3
print("TestOrder::test_same_members: ok")
