...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_raise_custom_error_on_creation"
# subject = "cpython.test_enum.TestSpecial.test_raise_custom_error_on_creation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_raise_custom_error_on_creation
"""Auto-ported test: TestSpecial::test_raise_custom_error_on_creation (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('expected InvalidRgbColorError')
except InvalidRgbColorError:
    pass
print("TestSpecial::test_raise_custom_error_on_creation: ok")
