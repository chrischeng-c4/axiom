...
# lib = "bufio"
# dimension = "behavior"
# case = "buffer_size_test__test_nullpat"
# subject = "cpython.test_bufio.BufferSizeTest.test_nullpat"
# kind = "semantic"
...
"""Auto-ported test: BufferSizeTest::test_nullpat (CPython 3.12 oracle)."""
...
for open_func in (io.open, pyio.open):
    drive_one(open_func, b"\0" * 1000)

print("BufferSizeTest::test_nullpat: ok")
