...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_userptr_memory_leak"
# subject = "cpython.test_curses.TestCurses.test_userptr_memory_leak"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_userptr_memory_leak
"""Auto-ported test: TestCurses::test_userptr_memory_leak (CPython 3.12 oracle)."""
...
assert sys.getrefcount(obj) == nrefs
print("TestCurses::test_userptr_memory_leak: ok")
