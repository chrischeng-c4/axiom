...
# lib = "curses"
# dimension = "behavior"
# case = "textbox_test__test_move_left"
# subject = "cpython.test_curses.TextboxTest.test_move_left"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TextboxTest::test_move_left
"""Auto-ported test: TextboxTest::test_move_left (CPython 3.12 oracle)."""
...
self_textbox.do_command(curses.KEY_LEFT)
self_mock_win.move.assert_called_with(1, 0)
self_mock_win.reset_mock()
print("TextboxTest::test_move_left: ok")
