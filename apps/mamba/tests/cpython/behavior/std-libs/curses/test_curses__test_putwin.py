...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_putwin"
# subject = "cpython.test_curses.TestCurses.test_putwin"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_putwin
"""Auto-ported test: TestCurses::test_putwin (CPython 3.12 oracle)."""
...
with tempfile.TemporaryFile() as f:
    ...
    assert win.getbegyx() == (1, 2)

    assert win.getmaxyx() == (5, 12)

    assert win.instr(2, 0) == b' Lorem ipsum'
print("TestCurses::test_putwin: ok")
