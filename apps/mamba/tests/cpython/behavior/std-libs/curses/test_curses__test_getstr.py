...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_getstr"
# subject = "cpython.test_curses.TestCurses.test_getstr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_getstr
"""Auto-ported test: TestCurses::test_getstr (CPython 3.12 oracle)."""
...
assert win.getstr(3, 1, 2) == b'Lo'

assert win.instr(3, 0) == b' Lo         '

assert win.getstr(3, 5, 10) == b'ipsum'

assert win.instr(3, 0) == b' Lo  ipsum  '

assert win.getstr(1, 5) == b'dolor'

assert win.instr(1, 0) == b'     dolor  '

assert win.getstr(2) == b'si'

assert win.instr(1, 0) == b'si   dolor  '

assert win.getstr() == b'amet'

assert win.instr(1, 0) == b'amet dolor  '
print("TestCurses::test_getstr: ok")
