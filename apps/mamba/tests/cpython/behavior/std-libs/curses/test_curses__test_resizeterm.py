...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_resizeterm"
# subject = "cpython.test_curses.TestCurses.test_resizeterm"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_resizeterm
"""Auto-ported test: TestCurses::test_resizeterm (CPython 3.12 oracle)."""
...
assert curses.LINES == new_lines

assert curses.COLS == new_cols
curses.resizeterm(lines, cols)

assert curses.LINES == lines

assert curses.COLS == cols
try:
...
tmp = curses.initscr()
tmp.erase()
print("TestCurses::test_resizeterm: ok")
