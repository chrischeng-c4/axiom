...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_borders_and_lines"
# subject = "cpython.test_curses.TestCurses.test_borders_and_lines"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_borders_and_lines
"""Auto-ported test: TestCurses::test_borders_and_lines (CPython 3.12 oracle)."""
...
assert win.instr(0, 0) == b'+--------\\'

assert win.instr(1, 0) == b'|        !'

assert win.instr(4, 0) == b'#________/'
...
try:
    win.border(65, 66, 67, 68, 69, 70, 71, 72, 73)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
assert win.instr(0, 1, 8) == b'~~~~~~~~'

assert win.instr(1, 0) == b':        :'

assert win.instr(4, 1, 8) == b'~~~~~~~~'
win.box(b':', b'~')
win.box(65, 67)
...
assert win.inch(1, 1) == b';'[0] | curses.A_STANDOUT

assert win.inch(2, 1) == b';'[0] | curses.A_STANDOUT

assert win.inch(3, 1) == b'a'[0]
print("TestCurses::test_borders_and_lines: ok")
