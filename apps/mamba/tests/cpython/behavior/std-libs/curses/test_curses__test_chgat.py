...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_chgat"
# subject = "cpython.test_curses.TestCurses.test_chgat"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_chgat
"""Auto-ported test: TestCurses::test_chgat (CPython 3.12 oracle)."""
...
assert win.inch(2, 7) == b'p'[0]

assert win.inch(2, 8) == b's'[0] | curses.A_BLINK

assert win.inch(2, 14) == b' '[0] | curses.A_BLINK
win.move(2, 1)
win.chgat(3, curses.A_BOLD)

assert win.inch(2, 0) == b'L'[0]

assert win.inch(2, 1) == b'o'[0] | curses.A_BOLD

assert win.inch(2, 3) == b'e'[0] | curses.A_BOLD

assert win.inch(2, 4) == b'm'[0]
win.chgat(3, 2, curses.A_UNDERLINE)

assert win.inch(3, 1) == b'o'[0]

assert win.inch(3, 2) == b'l'[0] | curses.A_UNDERLINE

assert win.inch(3, 14) == b' '[0] | curses.A_UNDERLINE
win.chgat(3, 4, 7, curses.A_BLINK)

assert win.inch(3, 3) == b'o'[0] | curses.A_UNDERLINE

assert win.inch(3, 4) == b'r'[0] | curses.A_BLINK

assert win.inch(3, 10) == b'a'[0] | curses.A_BLINK

assert win.inch(3, 11) == b'm'[0] | curses.A_UNDERLINE

assert win.inch(3, 14) == b' '[0] | curses.A_UNDERLINE
print("TestCurses::test_chgat: ok")
