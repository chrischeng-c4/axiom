...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_userptr_without_set"
# subject = "cpython.test_curses.TestCurses.test_userptr_without_set"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_userptr_without_set
"""Auto-ported test: TestCurses::test_userptr_without_set (CPython 3.12 oracle)."""
...
try:
    p.userptr()
    raise AssertionError('expected curses.panel.error')
except curses.panel.error:
    pass
print("TestCurses::test_userptr_without_set: ok")
