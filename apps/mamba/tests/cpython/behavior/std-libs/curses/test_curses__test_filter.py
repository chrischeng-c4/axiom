...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_filter"
# subject = "cpython.test_curses.TestCurses.test_filter"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_filter
"""Auto-ported test: TestCurses::test_filter (CPython 3.12 oracle)."""
...
self_stdscr.erase()
curses.filter()
print("TestCurses::test_filter: ok")
