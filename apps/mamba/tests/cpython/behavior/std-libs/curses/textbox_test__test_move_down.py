...
# lib = "curses"
# dimension = "behavior"
# case = "textbox_test__test_move_down"
# subject = "cpython.test_curses.TextboxTest.test_move_down"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TextboxTest::test_move_down
"""Auto-ported test: TextboxTest::test_move_down (CPython 3.12 oracle)."""
...
self_textbox.do_command(curses.KEY_DOWN)
self_mock_win.move.assert_called_with(2, 1)
self_mock_win.reset_mock()
print("TextboxTest::test_move_down: ok")
