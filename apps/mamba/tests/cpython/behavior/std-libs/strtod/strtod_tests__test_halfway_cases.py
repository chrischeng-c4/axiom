...
# lib = "strtod"
# dimension = "behavior"
# case = "strtod_tests__test_halfway_cases"
# subject = "cpython.test_strtod.StrtodTests.test_halfway_cases"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_strtod.py::StrtodTests::test_halfway_cases
"""Auto-ported test: StrtodTests::test_halfway_cases (CPython 3.12 oracle)."""
...
for i in range(100 * TEST_SIZE):
    ...
    check_strtod(s)
print("StrtodTests::test_halfway_cases: ok")
