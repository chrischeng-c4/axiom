...
# lib = "pathlib"
# dimension = "behavior"
# case = "walk_tests__test_walk_many_open_files"
# subject = "cpython.test_pathlib.WalkTests.test_walk_many_open_files"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pathlib.py::WalkTests::test_walk_many_open_files
"""Auto-ported test: WalkTests::test_walk_many_open_files (CPython 3.12 oracle)."""
...
for i in range(depth + 1):
    ...
    for it in iters:
        ...
        assert next(it) == expected
    path = path / 'd'
print("WalkTests::test_walk_many_open_files: ok")
