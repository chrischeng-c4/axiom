...
# lib = "pathlib"
# dimension = "behavior"
# case = "pure_posix_path_test__test_drive_root_parts"
# subject = "cpython.test_pathlib.PurePosixPathTest.test_drive_root_parts"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pathlib.py::PurePosixPathTest::test_drive_root_parts
"""Auto-ported test: PurePosixPathTest::test_drive_root_parts (CPython 3.12 oracle)."""
...
check(('c:\\a',), '', '', ('c:\\a',))
check(('\\a',), '', '', ('\\a',))
print("PurePosixPathTest::test_drive_root_parts: ok")
