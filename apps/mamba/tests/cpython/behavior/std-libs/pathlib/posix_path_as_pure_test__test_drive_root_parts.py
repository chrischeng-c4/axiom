...
# lib = "pathlib"
# dimension = "behavior"
# case = "posix_path_as_pure_test__test_drive_root_parts"
# subject = "cpython.test_pathlib.PosixPathAsPureTest.test_drive_root_parts"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pathlib.py::PosixPathAsPureTest::test_drive_root_parts
"""Auto-ported test: PosixPathAsPureTest::test_drive_root_parts (CPython 3.12 oracle)."""
...
check(('c:\\a',), '', '', ('c:\\a',))
check(('\\a',), '', '', ('\\a',))
print("PosixPathAsPureTest::test_drive_root_parts: ok")
