...
# lib = "hashlib"
# dimension = "behavior"
# case = "hash_lib_test_case__test_sha256_update_over_4gb"
# subject = "cpython.test_hashlib.HashLibTestCase.test_sha256_update_over_4gb"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_hashlib.py::HashLibTestCase::test_sha256_update_over_4gb
"""Auto-ported test: HashLibTestCase::test_sha256_update_over_4gb (CPython 3.12 oracle)."""
...
zero_1mb = b'\x00' * 1024 * 1024
h = hashlib.sha256()
for i in range(0, 4096):
    h.update(zero_1mb)
h.update(b'hello world')

assert h.hexdigest() == 'a5364f7a52ebe2e25f1838a4ca715a893b6fd7a23f2a0d9e9762120da8b1bf53'
print("HashLibTestCase::test_sha256_update_over_4gb: ok")
