...
# lib = "hashlib"
# dimension = "behavior"
# case = "kdf_tests__test_normalized_name"
# subject = "cpython.test_hashlib.KDFTests.test_normalized_name"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_hashlib.py::KDFTests::test_normalized_name
"""Auto-ported test: KDFTests::test_normalized_name (CPython 3.12 oracle)."""
...
assert 'blake2b512' not in hashlib.algorithms_available

assert 'sha3-512' not in hashlib.algorithms_available
print("KDFTests::test_normalized_name: ok")
