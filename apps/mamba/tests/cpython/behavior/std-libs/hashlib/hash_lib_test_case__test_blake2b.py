...
# lib = "hashlib"
# dimension = "behavior"
# case = "hash_lib_test_case__test_blake2b"
# subject = "cpython.test_hashlib.HashLibTestCase.test_blake2b"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_hashlib.py::HashLibTestCase::test_blake2b
"""Auto-ported test: HashLibTestCase::test_blake2b (CPython 3.12 oracle)."""
...
check_blake2(hashlib.blake2b, 16, 16, 64, 64, (1 << 64) - 1)
b2b_md_len = [20, 32, 48, 64]
b2b_in_len = [0, 3, 128, 129, 255, 1024]

assert blake2_rfc7693(hashlib.blake2b, b2b_md_len, b2b_in_len) == 'c23a7800d98123bd10f506c61e29da5603d763b8bbad2e737f5e765a7bccd475'
print("HashLibTestCase::test_blake2b: ok")
