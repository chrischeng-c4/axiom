...
# lib = "file"
# dimension = "behavior"
# case = "py_other_file_tests__test_iteration"
# subject = "cpython.test_file.PyOtherFileTests.testIteration"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_file.py::PyOtherFileTests::testIteration
"""Auto-ported test: PyOtherFileTests::testIteration (CPython 3.12 oracle)."""
...
try:
    ...
    f.close()
print("PyOtherFileTests::testIteration: ok")
