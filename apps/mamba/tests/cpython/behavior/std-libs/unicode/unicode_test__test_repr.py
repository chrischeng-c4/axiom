...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_repr"
# subject = "cpython.test_unicode.UnicodeTest.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_repr
"""Auto-ported test: UnicodeTest::test_repr (CPython 3.12 oracle)."""
...
assert repr('𐀀' * 39 + '\uffff' * 4096) == repr('𐀀' * 39 + '\uffff' * 4096)
assertTypedEqual(repr('🐍'), "'🐍'")
assertTypedEqual(repr(StrSubclass('abc')), "'abc'")
assertTypedEqual(repr(WithRepr('<abc>')), '<abc>')
assertTypedEqual(repr(WithRepr(StrSubclass('<abc>'))), StrSubclass('<abc>'))
assertTypedEqual(repr(WithRepr('<🐍>')), '<🐍>')
assertTypedEqual(repr(WithRepr(StrSubclass('<🐍>'))), StrSubclass('<🐍>'))

try:
    repr(WithRepr(b'byte-repr'))
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("UnicodeTest::test_repr: ok")
