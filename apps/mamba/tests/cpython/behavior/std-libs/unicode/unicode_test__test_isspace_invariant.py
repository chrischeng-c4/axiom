...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_isspace_invariant"
# subject = "cpython.test_unicode.UnicodeTest.test_isspace_invariant"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_isspace_invariant
"""Auto-ported test: UnicodeTest::test_isspace_invariant (CPython 3.12 oracle)."""
...
for codepoint in range(sys.maxunicode + 1):
    ...
    assert char.isspace() == (bidirectional in ('WS', 'B', 'S') or category == 'Zs')
print("UnicodeTest::test_isspace_invariant: ok")
