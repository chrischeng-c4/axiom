...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_isprintable_invariant"
# subject = "cpython.test_unicode.UnicodeTest.test_isprintable_invariant"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_isprintable_invariant
"""Auto-ported test: UnicodeTest::test_isprintable_invariant (CPython 3.12 oracle)."""
...
for codepoint in range(sys.maxunicode + 1):
    ...
    assert char.isprintable() == (category[0] not in ('C', 'Z') or char == ' ')
print("UnicodeTest::test_isprintable_invariant: ok")
