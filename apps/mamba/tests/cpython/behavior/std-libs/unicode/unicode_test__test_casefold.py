...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_casefold"
# subject = "cpython.test_unicode.UnicodeTest.test_casefold"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_casefold
"""Auto-ported test: UnicodeTest::test_casefold (CPython 3.12 oracle)."""
...
assert 'µ'.casefold() == 'μ'
print("UnicodeTest::test_casefold: ok")
