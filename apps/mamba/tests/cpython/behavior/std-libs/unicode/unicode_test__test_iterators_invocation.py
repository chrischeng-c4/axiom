...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_iterators_invocation"
# subject = "cpython.test_unicode.UnicodeTest.test_iterators_invocation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_iterators_invocation
"""Auto-ported test: UnicodeTest::test_iterators_invocation (CPython 3.12 oracle)."""
...
for cls in cases:
    ...
    try:
        ...
        pass
print("UnicodeTest::test_iterators_invocation: ok")
