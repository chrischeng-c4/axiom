...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_ascii"
# subject = "cpython.test_unicode.UnicodeTest.test_ascii"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_ascii
"""Auto-ported test: UnicodeTest::test_ascii (CPython 3.12 oracle)."""
...
assert testrepr == latin1repr

assert ascii('𐀀' * 39 + '\uffff' * 4096) == ascii('𐀀' * 39 + '\uffff' * 4096)
assertTypedEqual(ascii('🐍'), "'\\U0001f40d'")
assertTypedEqual(ascii(StrSubclass('abc')), "'abc'")
assertTypedEqual(ascii(WithRepr('<abc>')), '<abc>')
assertTypedEqual(ascii(WithRepr(StrSubclass('<abc>'))), StrSubclass('<abc>'))
assertTypedEqual(ascii(WithRepr('<🐍>')), '<\\U0001f40d>')
assertTypedEqual(ascii(WithRepr(StrSubclass('<🐍>'))), '<\\U0001f40d>')

try:
    ascii(WithRepr(b'byte-repr'))
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("UnicodeTest::test_ascii: ok")
