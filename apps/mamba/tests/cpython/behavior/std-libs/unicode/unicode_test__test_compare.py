...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_compare"
# subject = "cpython.test_unicode.UnicodeTest.test_compare"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_compare
"""Auto-ported test: UnicodeTest::test_compare (CPython 3.12 oracle)."""
...
assert not ascii >= ascii2

assert not ascii >= latin

assert not ascii >= bmp

assert not ascii >= astral

assert not latin < ascii
...
assert not latin >= latin2

assert not latin >= bmp

assert not latin >= astral

assert not bmp < ascii

assert not bmp < latin
...
assert not bmp >= astral

assert not astral < ascii

assert not astral < latin

assert not astral < bmp2

assert astral < astral2
...
assert not astral >= astral2
print("UnicodeTest::test_compare: ok")
