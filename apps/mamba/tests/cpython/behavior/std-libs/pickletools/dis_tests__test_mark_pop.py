...
# lib = "pickletools"
# dimension = "behavior"
# case = "dis_tests__test_mark_pop"
# subject = "cpython.test_pickletools.DisTests.test_mark_pop"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pickletools.py::DisTests::test_mark_pop
"""Auto-ported test: DisTests::test_mark_pop (CPython 3.12 oracle)."""
...
def check_dis_error(data, expected, expected_error, **kwargs):
    ...
    assert out.getvalue() == expected
check_dis(b'(N00N.', '    0: (    MARK\n    1: N        NONE\n    2: 0        POP\n    3: 0        POP        (MARK at 0)\n    4: N    NONE\n    5: .    STOP\nhighest protocol among opcodes = 0\n')
print("DisTests::test_mark_pop: ok")
