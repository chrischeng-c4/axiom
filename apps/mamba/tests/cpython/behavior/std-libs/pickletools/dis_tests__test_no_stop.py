...
# lib = "pickletools"
# dimension = "behavior"
# case = "dis_tests__test_no_stop"
# subject = "cpython.test_pickletools.DisTests.test_no_stop"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pickletools.py::DisTests::test_no_stop
"""Auto-ported test: DisTests::test_no_stop (CPython 3.12 oracle)."""
...
def check_dis_error(data, expected, expected_error, **kwargs):
    ...
    assert out.getvalue() == expected
check_dis_error(b'N', '    0: N    NONE\n', 'pickle exhausted before seeing STOP')
print("DisTests::test_no_stop: ok")
