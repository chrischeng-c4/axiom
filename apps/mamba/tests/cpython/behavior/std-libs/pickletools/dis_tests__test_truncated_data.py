...
# lib = "pickletools"
# dimension = "behavior"
# case = "dis_tests__test_truncated_data"
# subject = "cpython.test_pickletools.DisTests.test_truncated_data"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pickletools.py::DisTests::test_truncated_data
"""Auto-ported test: DisTests::test_truncated_data (CPython 3.12 oracle)."""
...
def check_dis_error(data, expected, expected_error, **kwargs):
    ...
    assert out.getvalue() == expected
check_dis_error(b'NI123', '    0: N    NONE\n', 'no newline found when trying to read stringnl')
check_dis_error(b'NJ\x124', '    0: N    NONE\n', 'not enough data in stream to read int4')
print("DisTests::test_truncated_data: ok")
