...
# lib = "httpservers"
# dimension = "behavior"
# case = "simple_http_request_handler_test_case__test_start_with_double_slash"
# subject = "cpython.test_httpservers.SimpleHTTPRequestHandlerTestCase.test_start_with_double_slash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httpservers.py::SimpleHTTPRequestHandlerTestCase::test_start_with_double_slash
"""Auto-ported test: SimpleHTTPRequestHandlerTestCase::test_start_with_double_slash (CPython 3.12 oracle)."""
...
assert path == self_translated_3
print("SimpleHTTPRequestHandlerTestCase::test_start_with_double_slash: ok")
