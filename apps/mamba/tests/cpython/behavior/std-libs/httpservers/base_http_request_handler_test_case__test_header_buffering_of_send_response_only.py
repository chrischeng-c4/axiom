...
# lib = "httpservers"
# dimension = "behavior"
# case = "base_http_request_handler_test_case__test_header_buffering_of_send_response_only"
# subject = "cpython.test_httpservers.BaseHTTPRequestHandlerTestCase.test_header_buffering_of_send_response_only"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httpservers.py::BaseHTTPRequestHandlerTestCase::test_header_buffering_of_send_response_only
"""Auto-ported test: BaseHTTPRequestHandlerTestCase::test_header_buffering_of_send_response_only (CPython 3.12 oracle)."""
...
assert output.numWrites == 0
handler.end_headers()

assert output.numWrites == 1
print("BaseHTTPRequestHandlerTestCase::test_header_buffering_of_send_response_only: ok")
