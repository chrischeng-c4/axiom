...
# lib = "httpservers"
# dimension = "behavior"
# case = "base_http_request_handler_test_case__test_http_0_9"
# subject = "cpython.test_httpservers.BaseHTTPRequestHandlerTestCase.test_http_0_9"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httpservers.py::BaseHTTPRequestHandlerTestCase::test_http_0_9
"""Auto-ported test: BaseHTTPRequestHandlerTestCase::test_http_0_9 (CPython 3.12 oracle)."""
...
result = send_typical_request(b'GET / HTTP/0.9\r\n\r\n')

assert len(result) == 1

assert result[0] == b'<html><body>Data</body></html>\r\n'
verify_get_called()
print("BaseHTTPRequestHandlerTestCase::test_http_0_9: ok")
