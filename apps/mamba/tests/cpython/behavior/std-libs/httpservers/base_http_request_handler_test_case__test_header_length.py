...
# lib = "httpservers"
# dimension = "behavior"
# case = "base_http_request_handler_test_case__test_header_length"
# subject = "cpython.test_httpservers.BaseHTTPRequestHandlerTestCase.test_header_length"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httpservers.py::BaseHTTPRequestHandlerTestCase::test_header_length
"""Auto-ported test: BaseHTTPRequestHandlerTestCase::test_header_length (CPython 3.12 oracle)."""
...
assert result[0] == b'HTTP/1.1 431 Line too long\r\n'

assert not self_handler.get_called

assert self_handler.requestline == 'GET / HTTP/1.1'
print("BaseHTTPRequestHandlerTestCase::test_header_length: ok")
