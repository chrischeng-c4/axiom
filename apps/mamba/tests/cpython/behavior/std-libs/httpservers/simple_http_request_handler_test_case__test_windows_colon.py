...
# lib = "httpservers"
# dimension = "behavior"
# case = "simple_http_request_handler_test_case__test_windows_colon"
# subject = "cpython.test_httpservers.SimpleHTTPRequestHandlerTestCase.test_windows_colon"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httpservers.py::SimpleHTTPRequestHandlerTestCase::test_windows_colon
"""Auto-ported test: SimpleHTTPRequestHandlerTestCase::test_windows_colon (CPython 3.12 oracle)."""
...
with support.swap_attr(server.os, 'path', ntpath):
    path = self_handler_1.translate_path('c:c:c:foo/filename')
    path = path.replace(ntpath.sep, os.sep)

    assert path == self_translated_1
    path = self_handler_2.translate_path('c:c:c:foo/filename')
    path = path.replace(ntpath.sep, os.sep)

    assert path == self_translated_2
    path = self_handler_3.translate_path('c:c:c:foo/filename')
    path = path.replace(ntpath.sep, os.sep)

    assert path == self_translated_3
    path = self_handler_1.translate_path('\\c:../filename')
    path = path.replace(ntpath.sep, os.sep)

    assert path == self_translated_1
    path = self_handler_2.translate_path('\\c:../filename')
    path = path.replace(ntpath.sep, os.sep)

    assert path == self_translated_2
    path = self_handler_3.translate_path('\\c:../filename')
    path = path.replace(ntpath.sep, os.sep)

    assert path == self_translated_3
    path = self_handler_1.translate_path('c:\\c:..\\foo/filename')
    path = path.replace(ntpath.sep, os.sep)

    assert path == self_translated_1
    path = self_handler_2.translate_path('c:\\c:..\\foo/filename')
    path = path.replace(ntpath.sep, os.sep)

    assert path == self_translated_2
    path = self_handler_3.translate_path('c:\\c:..\\foo/filename')
    path = path.replace(ntpath.sep, os.sep)

    assert path == self_translated_3
    path = self_handler_1.translate_path('c:c:foo\\c:c:bar/filename')
    path = path.replace(ntpath.sep, os.sep)

    assert path == self_translated_1
    path = self_handler_2.translate_path('c:c:foo\\c:c:bar/filename')
    path = path.replace(ntpath.sep, os.sep)

    assert path == self_translated_2
    path = self_handler_3.translate_path('c:c:foo\\c:c:bar/filename')
    path = path.replace(ntpath.sep, os.sep)

    assert path == self_translated_3
print("SimpleHTTPRequestHandlerTestCase::test_windows_colon: ok")
