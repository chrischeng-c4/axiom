...
# lib = "time"
# dimension = "behavior"
# case = "test_strftime4dyear__test_large_year"
# subject = "cpython.test_time.TestStrftime4dyear.test_large_year"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_time.py::TestStrftime4dyear::test_large_year
"""Auto-ported test: TestStrftime4dyear::test_large_year (CPython 3.12 oracle)."""
...
assert yearstr(12345).lstrip('+') == '12345'

assert yearstr(123456789).lstrip('+') == '123456789'

assert yearstr(TIME_MAXYEAR).lstrip('+') == str(TIME_MAXYEAR)

try:
    yearstr(TIME_MAXYEAR + 1)
    raise AssertionError('expected OverflowError')
except OverflowError:
    pass
print("TestStrftime4dyear::test_large_year: ok")
