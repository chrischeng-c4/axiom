...
# lib = "time"
# dimension = "behavior"
# case = "test_old_py_time__test_object_to_time_t"
# subject = "cpython.test_time.TestOldPyTime.test_object_to_time_t"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_time.py::TestOldPyTime::test_object_to_time_t
"""Auto-ported test: TestOldPyTime::test_object_to_time_t (CPython 3.12 oracle)."""
...
def create_converter(sec_to_unit):
...
check_int_rounding(pytime_object_to_time_t, lambda secs: secs, value_filter=time_t_filter)
check_float_rounding(pytime_object_to_time_t, decimal_round, value_filter=time_t_filter)
print("TestOldPyTime::test_object_to_time_t: ok")
