...
# lib = "time"
# dimension = "behavior"
# case = "time_test_case__test_strftime_invalid_format"
# subject = "cpython.test_time.TimeTestCase.test_strftime_invalid_format"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_time.py::TimeTestCase::test_strftime_invalid_format
"""Auto-ported test: TimeTestCase::test_strftime_invalid_format (CPython 3.12 oracle)."""
...
with SuppressCrashReport():
    for i in range(1, 128):
        ...
        try:
            ...
            assert str(exc) == 'Invalid format string'
print("TimeTestCase::test_strftime_invalid_format: ok")
