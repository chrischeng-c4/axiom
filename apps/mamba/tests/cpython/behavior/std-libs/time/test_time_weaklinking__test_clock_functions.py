...
# lib = "time"
# dimension = "behavior"
# case = "test_time_weaklinking__test_clock_functions"
# subject = "cpython.test_time.TestTimeWeaklinking.test_clock_functions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_time.py::TestTimeWeaklinking::test_clock_functions
"""Auto-ported test: TestTimeWeaklinking::test_clock_functions (CPython 3.12 oracle)."""
...
if mac_ver >= (10, 12):
    for name in clock_names:
        ...
        assert hasattr(time, name)
else:
    for name in clock_names:

        assert not hasattr(time, name)
print("TestTimeWeaklinking::test_clock_functions: ok")
