...
# lib = "time"
# dimension = "behavior"
# case = "time_test_case__test_get_clock_info"
# subject = "cpython.test_time.TimeTestCase.test_get_clock_info"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_time.py::TimeTestCase::test_get_clock_info
"""Auto-ported test: TimeTestCase::test_get_clock_info (CPython 3.12 oracle)."""
...
try:
    time.get_clock_info('xxx')
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("TimeTestCase::test_get_clock_info: ok")
