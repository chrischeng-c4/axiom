...
# subject = "cpython.test_posixpath.PathLikeTests.test_path_expandvars"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posixpath.py::PathLikeTests::test_path_expandvars
...
assertPathEqual(path.expandvars)
