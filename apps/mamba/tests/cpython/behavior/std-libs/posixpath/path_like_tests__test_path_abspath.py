...
# lib = "posixpath"
# dimension = "behavior"
# case = "path_like_tests__test_path_abspath"
# subject = "cpython.test_posixpath.PathLikeTests.test_path_abspath"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posixpath.py::PathLikeTests::test_path_abspath
"""Auto-ported test: PathLikeTests::test_path_abspath (CPython 3.12 oracle)."""
...
assertPathEqual(path.abspath)
print("PathLikeTests::test_path_abspath: ok")
