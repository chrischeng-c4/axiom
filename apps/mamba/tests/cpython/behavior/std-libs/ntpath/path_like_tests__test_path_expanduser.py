...
# subject = "cpython.test_ntpath.PathLikeTests.test_path_expanduser"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ntpath.py::PathLikeTests::test_path_expanduser
...
_check_function(path.expanduser)
