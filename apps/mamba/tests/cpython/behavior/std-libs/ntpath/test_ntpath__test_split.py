...
# lib = "ntpath"
# dimension = "behavior"
# case = "test_ntpath__test_split"
# subject = "cpython.test_ntpath.TestNtpath.test_split"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ntpath.py::TestNtpath::test_split
"""Auto-ported test: TestNtpath::test_split (CPython 3.12 oracle)."""
...
tester('ntpath.split("c:/")', ('c:/', ''))
tester('ntpath.split("//conky/mountpoint/")', ('//conky/mountpoint/', ''))
print("TestNtpath::test_split: ok")
