...
# subject = "cpython.test_ntpath.PathLikeTests.test_path_splitroot"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ntpath.py::PathLikeTests::test_path_splitroot
...
_check_function(path.splitroot)
