...
# lib = "ntpath"
# dimension = "behavior"
# case = "path_like_tests__test_path_join"
# subject = "cpython.test_ntpath.PathLikeTests.test_path_join"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ntpath.py::PathLikeTests::test_path_join
"""Auto-ported test: PathLikeTests::test_path_join (CPython 3.12 oracle)."""
...
assert path.join('a', FakePath('b'), 'c') == path.join('a', 'b', 'c')
print("PathLikeTests::test_path_join: ok")
