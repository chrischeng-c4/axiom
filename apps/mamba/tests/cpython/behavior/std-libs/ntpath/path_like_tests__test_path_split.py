...
# subject = "cpython.test_ntpath.PathLikeTests.test_path_split"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ntpath.py::PathLikeTests::test_path_split
