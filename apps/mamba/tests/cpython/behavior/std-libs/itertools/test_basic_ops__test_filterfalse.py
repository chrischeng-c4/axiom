...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_filterfalse"
# subject = "cpython.test_itertools.TestBasicOps.test_filterfalse"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_filterfalse
"""Auto-ported test: TestBasicOps::test_filterfalse (CPython 3.12 oracle)."""
...
assert list(filterfalse(None, [0, 1, 0, 2, 0])) == [0, 0, 0]

assert list(filterfalse(bool, [0, 1, 0, 2, 0])) == [0, 0, 0]
...
try:
    filterfalse(lambda x: x, range(6), 7)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    filterfalse(isEven, 3)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    next(filterfalse(range(6), range(6)))
    raise AssertionError('expected TypeError')
except TypeError:
    pass
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    pickletest(proto, filterfalse(isEven, range(6)))
print("TestBasicOps::test_filterfalse: ok")
