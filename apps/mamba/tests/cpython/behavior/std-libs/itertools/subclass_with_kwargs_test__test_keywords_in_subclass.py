...
# lib = "itertools"
# dimension = "behavior"
# case = "subclass_with_kwargs_test__test_keywords_in_subclass"
# subject = "cpython.test_itertools.SubclassWithKwargsTest.test_keywords_in_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::SubclassWithKwargsTest::test_keywords_in_subclass
"""Auto-ported test: SubclassWithKwargsTest::test_keywords_in_subclass (CPython 3.12 oracle)."""
...
# --- test body ---
testcases = [(repeat, (1, 2), [1, 1]), (zip, ([1, 2], 'ab'), [(1, 'a'), (2, 'b')]), (filter, (None, [0, 1]), [1]), (filterfalse, (None, [0, 1]), [0]), (chain, ([1, 2], [3, 4]), [1, 2, 3]), (map, (str, [1, 2]), ['1', '2']), (starmap, (operator.pow, ((2, 3), (3, 2))), [8, 9]), (islice, ([1, 2, 3, 4], 1, 3), [2, 3]), (takewhile, (isEven, [2, 3, 4]), [2]), (dropwhile, (isEven, [2, 3, 4]), [3, 4]), (cycle, ([1, 2],), [1, 2, 1]), (compress, ('ABC', [1, 0, 1]), ['A', 'C'])]
for cls, args, result in testcases:
    ...
    assert list(islice(u, 0, 3)) == result
    try:
...
for cls, args, result in testcases:
    ...
    assert u.newarg == 3
print("SubclassWithKwargsTest::test_keywords_in_subclass: ok")
