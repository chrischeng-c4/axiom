...
# lib = "itertools"
# dimension = "behavior"
# case = "test_gc__test_filterfalse"
# subject = "cpython.test_itertools.TestGC.test_filterfalse"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestGC::test_filterfalse
"""Auto-ported test: TestGC::test_filterfalse (CPython 3.12 oracle)."""
...
a = []
makecycle(filterfalse(lambda x: False, a), a)
print("TestGC::test_filterfalse: ok")
