...
# lib = "itertools"
# dimension = "behavior"
# case = "test_various_iterator_args__test_batched"
# subject = "cpython.test_itertools.TestVariousIteratorArgs.test_batched"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestVariousIteratorArgs::test_batched
"""Auto-ported test: TestVariousIteratorArgs::test_batched (CPython 3.12 oracle)."""
...
for g in (G, I, Ig, L, R):
    ...
    assert list(batched(g(s), n)) == r

assert list(batched(S(s), 2)) == []
...
try:
    ...
    pass
print("TestVariousIteratorArgs::test_batched: ok")
