...
# lib = "itertools"
# dimension = "behavior"
# case = "test_various_iterator_args__test_tee"
# subject = "cpython.test_itertools.TestVariousIteratorArgs.test_tee"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestVariousIteratorArgs::test_tee
"""Auto-ported test: TestVariousIteratorArgs::test_tee (CPython 3.12 oracle)."""
...
for s in ('123', '', range(1000), ('do', 1.2), range(2000, 2200, 5)):
    for g in (G, I, Ig, S, L, R):
        ...
        assert list(it1) == list(g(s))

        assert list(it2) == list(g(s))
    ...
    try:
        ...
        pass
print("TestVariousIteratorArgs::test_tee: ok")
