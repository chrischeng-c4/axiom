...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_combinations_with_replacement"
# subject = "cpython.test_itertools.TestBasicOps.test_combinations_with_replacement"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_combinations_with_replacement
"""Auto-ported test: TestBasicOps::test_combinations_with_replacement (CPython 3.12 oracle)."""
...
for op in [lambda a: a] + picklecopiers:
    ...
    assert list(op(cwr('ABC', 2))) == [('A', 'A'), ('A', 'B'), ('A', 'C'), ('B', 'B'), ('B', 'C'), ('C', 'C')]
    testIntermediate = cwr('ABC', 2)
    next(testIntermediate)

    assert list(op(testIntermediate)) == [('A', 'B'), ('A', 'C'), ('B', 'B'), ('B', 'C'), ('C', 'C')]
...
for n in range(7):
    ...
    for r in range(n + 2):
        ...
        for proto in range(pickle.HIGHEST_PROTOCOL + 1):
            pickletest(proto, cwr(values, r))
print("TestBasicOps::test_combinations_with_replacement: ok")
