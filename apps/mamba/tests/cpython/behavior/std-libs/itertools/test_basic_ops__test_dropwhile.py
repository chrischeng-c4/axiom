...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_dropwhile"
# subject = "cpython.test_itertools.TestBasicOps.test_dropwhile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_dropwhile
"""Auto-ported test: TestBasicOps::test_dropwhile (CPython 3.12 oracle)."""
...
assert list(dropwhile(underten, [])) == []
...
try:
    dropwhile(operator.pow)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    dropwhile(operator.pow, [(4, 5)], 'extra')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    next(dropwhile(10, [(4, 5)]))
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    next(dropwhile(errfunc, [(4, 5)]))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

assert list(copy.copy(dropwhile(underten, data))) == [20, 2, 4, 6, 8]

assert list(copy.deepcopy(dropwhile(underten, data))) == [20, 2, 4, 6, 8]
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    pickletest(proto, dropwhile(underten, data))
print("TestBasicOps::test_dropwhile: ok")
