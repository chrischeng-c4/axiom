...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_islice"
# subject = "cpython.test_itertools.TestBasicOps.test_islice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_islice
"""Auto-ported test: TestBasicOps::test_islice (CPython 3.12 oracle)."""
...
assert len(list(islice(count(), 1, 10, maxsize))) == 1
c = count()
...
for args in [(10, 20, 3), (10, 3, 20), (10, 20), (10, 3), (20,)]:
    ...
    assert list(copy.copy(islice(range(100), *args))) == list(range(*args))

    assert list(copy.deepcopy(islice(range(100), *args))) == list(range(*args))
    for proto in range(pickle.HIGHEST_PROTOCOL + 1):
        pickletest(proto, islice(range(100), *args))
it = (x for x in (1, 2))
wr = weakref.ref(it)
it = islice(it, 1)
...
assert list(islice(range(100), IntLike(10))) == list(range(10))

assert list(islice(range(100), IntLike(10), IntLike(50))) == list(range(10, 50))

assert list(islice(range(100), IntLike(10), IntLike(50), IntLike(5))) == list(range(10, 50, 5))
print("TestBasicOps::test_islice: ok")
