...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_stop_iteration"
# subject = "cpython.test_itertools.TestBasicOps.test_StopIteration"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_StopIteration
"""Auto-ported test: TestBasicOps::test_StopIteration (CPython 3.12 oracle)."""
...
for f in (filter, filterfalse, map, takewhile, dropwhile, starmap):
    ...
    try:
        next(f(lambda x: x, StopNow()))
        raise AssertionError('expected StopIteration')
    except StopIteration:
        pass
print("TestBasicOps::test_StopIteration: ok")
