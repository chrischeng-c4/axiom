...
# lib = "itertools"
# dimension = "behavior"
# case = "test_examples__test_count"
# subject = "cpython.test_itertools.TestExamples.test_count"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestExamples::test_count
"""Auto-ported test: TestExamples::test_count (CPython 3.12 oracle)."""
...
assert list(islice(count(10), 5)) == [10, 11, 12, 13, 14]
print("TestExamples::test_count: ok")
