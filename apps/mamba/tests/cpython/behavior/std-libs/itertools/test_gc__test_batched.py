...
# lib = "itertools"
# dimension = "behavior"
# case = "test_gc__test_batched"
# subject = "cpython.test_itertools.TestGC.test_batched"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestGC::test_batched
"""Auto-ported test: TestGC::test_batched (CPython 3.12 oracle)."""
...
a = []
makecycle(batched([1, 2, a, 3], 2), a)
print("TestGC::test_batched: ok")
