...
# lib = "itertools"
# dimension = "behavior"
# case = "test_various_iterator_args__test_takewhile"
# subject = "cpython.test_itertools.TestVariousIteratorArgs.test_takewhile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestVariousIteratorArgs::test_takewhile
"""Auto-ported test: TestVariousIteratorArgs::test_takewhile (CPython 3.12 oracle)."""
...
for s in (range(10), range(0), range(1000), (7, 11), range(2000, 2200, 5)):
    for g in (G, I, Ig, S, L, R):
        ...
        assert list(takewhile(isEven, g(s))) == tgt

    try:
        takewhile(isEven, X(s))
        raise AssertionError('expected TypeError')
    except TypeError:
        pass

    try:
        takewhile(isEven, N(s))
        raise AssertionError('expected TypeError')
    except TypeError:
        pass

    try:
        list(takewhile(isEven, E(s)))
        raise AssertionError('expected ZeroDivisionError')
    except ZeroDivisionError:
        pass
print("TestVariousIteratorArgs::test_takewhile: ok")
