...
# lib = "itertools"
# dimension = "behavior"
# case = "test_gc__test_groupby"
# subject = "cpython.test_itertools.TestGC.test_groupby"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestGC::test_groupby
"""Auto-ported test: TestGC::test_groupby (CPython 3.12 oracle)."""
...
a = []
makecycle(groupby([a] * 2, lambda x: x), a)
print("TestGC::test_groupby: ok")
