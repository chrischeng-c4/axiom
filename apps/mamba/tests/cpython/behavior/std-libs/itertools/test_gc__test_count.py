...
# lib = "itertools"
# dimension = "behavior"
# case = "test_gc__test_count"
# subject = "cpython.test_itertools.TestGC.test_count"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestGC::test_count
"""Auto-ported test: TestGC::test_count (CPython 3.12 oracle)."""
...
makecycle(count(Int(0), Int(1)), a)
print("TestGC::test_count: ok")
