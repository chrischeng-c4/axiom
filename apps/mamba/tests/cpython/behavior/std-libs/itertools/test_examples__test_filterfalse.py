...
# lib = "itertools"
# dimension = "behavior"
# case = "test_examples__test_filterfalse"
# subject = "cpython.test_itertools.TestExamples.test_filterfalse"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestExamples::test_filterfalse
"""Auto-ported test: TestExamples::test_filterfalse (CPython 3.12 oracle)."""
...
assert list(filterfalse(lambda x: x % 2, range(10))) == [0, 2, 4, 6, 8]
print("TestExamples::test_filterfalse: ok")
