...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_chain_setstate"
# subject = "cpython.test_itertools.TestBasicOps.test_chain_setstate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_chain_setstate
"""Auto-ported test: TestBasicOps::test_chain_setstate (CPython 3.12 oracle)."""
...
assert list(it) == ['ghi', 'a', 'b', 'c', 'd', 'e', 'f']
print("TestBasicOps::test_chain_setstate: ok")
