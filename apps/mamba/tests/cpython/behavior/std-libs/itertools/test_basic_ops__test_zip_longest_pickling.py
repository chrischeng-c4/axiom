...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_zip_longest_pickling"
# subject = "cpython.test_itertools.TestBasicOps.test_zip_longest_pickling"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_zip_longest_pickling
"""Auto-ported test: TestBasicOps::test_zip_longest_pickling (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    pickletest(proto, zip_longest('abc', 'def'))
    pickletest(proto, zip_longest('abc', 'defgh'))
    pickletest(proto, zip_longest('abc', 'defgh', fillvalue=1))
    pickletest(proto, zip_longest('', 'defgh'))
print("TestBasicOps::test_zip_longest_pickling: ok")
