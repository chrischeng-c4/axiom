...
# lib = "itertools"
# dimension = "behavior"
# case = "test_examples__test_groupby"
# subject = "cpython.test_itertools.TestExamples.test_groupby"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestExamples::test_groupby
"""Auto-ported test: TestExamples::test_groupby (CPython 3.12 oracle)."""
...
assert [k for k, g in groupby('AAAABBBCCDAABBB')] == list('ABCDAB')

assert [list(g) for k, g in groupby('AAAABBBCCD')] == [list('AAAA'), list('BBB'), list('CC'), list('D')]
print("TestExamples::test_groupby: ok")
