...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_zip"
# subject = "cpython.test_itertools.TestBasicOps.test_zip"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_zip
"""Auto-ported test: TestBasicOps::test_zip (CPython 3.12 oracle)."""
...
assert [tuple(list(pair)) for pair in zip('abc', 'def')] == lzip('abc', 'def')

assert [pair for pair in zip('abc', 'def')] == lzip('abc', 'def')
print("TestBasicOps::test_zip: ok")
