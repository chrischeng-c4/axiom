...
# lib = "itertools"
# dimension = "behavior"
# case = "test_various_iterator_args__test_accumulate"
# subject = "cpython.test_itertools.TestVariousIteratorArgs.test_accumulate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestVariousIteratorArgs::test_accumulate
"""Auto-ported test: TestVariousIteratorArgs::test_accumulate (CPython 3.12 oracle)."""
...
for g in (G, I, Ig, L, R):
    ...
    assert list(accumulate(g(s))) == r

assert list(accumulate(S(s))) == []
...
try:
    ...
    pass
print("TestVariousIteratorArgs::test_accumulate: ok")
