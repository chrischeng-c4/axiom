...
# lib = "itertools"
# dimension = "behavior"
# case = "test_examples__test_cycle"
# subject = "cpython.test_itertools.TestExamples.test_cycle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestExamples::test_cycle
"""Auto-ported test: TestExamples::test_cycle (CPython 3.12 oracle)."""
...
assert list(islice(cycle('ABCD'), 12)) == list('ABCDABCDABCD')
print("TestExamples::test_cycle: ok")
