...
# lib = "itertools"
# dimension = "behavior"
# case = "test_gc__test_zip_longest"
# subject = "cpython.test_itertools.TestGC.test_zip_longest"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestGC::test_zip_longest
"""Auto-ported test: TestGC::test_zip_longest (CPython 3.12 oracle)."""
...
a = []
makecycle(zip_longest([a] * 2, [a] * 3), a)
b = [a, None]
makecycle(zip_longest([a] * 2, [a] * 3, fillvalue=b), a)
print("TestGC::test_zip_longest: ok")
