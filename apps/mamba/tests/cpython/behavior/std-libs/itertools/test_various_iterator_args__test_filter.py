...
# lib = "itertools"
# dimension = "behavior"
# case = "test_various_iterator_args__test_filter"
# subject = "cpython.test_itertools.TestVariousIteratorArgs.test_filter"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestVariousIteratorArgs::test_filter
"""Auto-ported test: TestVariousIteratorArgs::test_filter (CPython 3.12 oracle)."""
...
for s in (range(10), range(0), range(1000), (7, 11), range(2000, 2200, 5)):
    for g in (G, I, Ig, S, L, R):
        ...
        assert list(filter(isEven, g(s))) == [x for x in g(s) if isEven(x)]
    ...
    try:
        list(filter(isEven, E(s)))
        raise AssertionError('expected ZeroDivisionError')
    except ZeroDivisionError:
        pass
print("TestVariousIteratorArgs::test_filter: ok")
