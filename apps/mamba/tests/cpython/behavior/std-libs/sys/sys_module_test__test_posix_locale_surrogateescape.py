...
# lib = "sys"
# dimension = "behavior"
# case = "sys_module_test__test_posix_locale_surrogateescape"
# subject = "cpython.test_sys.SysModuleTest.test_posix_locale_surrogateescape"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys.py::SysModuleTest::test_posix_locale_surrogateescape
"""Auto-ported test: SysModuleTest::test_posix_locale_surrogateescape (CPython 3.12 oracle)."""
...
def check_locale_surrogateescape(locale):
    ...
    assert out == 'stdin: surrogateescape\nstdout: surrogateescape\nstderr: backslashreplace\n'
check_locale_surrogateescape('POSIX')
print("SysModuleTest::test_posix_locale_surrogateescape: ok")
