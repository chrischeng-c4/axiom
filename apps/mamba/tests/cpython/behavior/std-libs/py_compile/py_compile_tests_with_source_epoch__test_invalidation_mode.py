...
# lib = "py_compile"
# dimension = "behavior"
# case = "py_compile_tests_with_source_epoch__test_invalidation_mode"
# subject = "cpython.test_py_compile.PyCompileTestsWithSourceEpoch.test_invalidation_mode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_py_compile.py::PyCompileTestsWithSourceEpoch::test_invalidation_mode
"""Auto-ported test: PyCompileTestsWithSourceEpoch::test_invalidation_mode (CPython 3.12 oracle)."""
...
assert flags == 1
print("PyCompileTestsWithSourceEpoch::test_invalidation_mode: ok")
