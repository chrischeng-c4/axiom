...
# lib = "py_compile"
# dimension = "behavior"
# case = "py_compile_cli_test_case__test_file_not_exists"
# subject = "cpython.test_py_compile.PyCompileCLITestCase.test_file_not_exists"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_py_compile.py::PyCompileCLITestCase::test_file_not_exists
"""Auto-ported test: PyCompileCLITestCase::test_file_not_exists (CPython 3.12 oracle)."""
...
rc, stdout, stderr = pycompilecmd_failure(self_source_path, should_not_exists)

assert rc == 1

assert stdout == b''

assert b'no such file or directory' in stderr.lower()
print("PyCompileCLITestCase::test_file_not_exists: ok")
