...
# lib = "py_compile"
# dimension = "behavior"
# case = "py_compile_tests_without_source_epoch__test_optimization_path"
# subject = "cpython.test_py_compile.PyCompileTestsWithoutSourceEpoch.test_optimization_path"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_py_compile.py::PyCompileTestsWithoutSourceEpoch::test_optimization_path
"""Auto-ported test: PyCompileTestsWithoutSourceEpoch::test_optimization_path (CPython 3.12 oracle)."""
...
assert 'opt-2' in py_compile.compile(self_source_path, optimize=2)
print("PyCompileTestsWithoutSourceEpoch::test_optimization_path: ok")
