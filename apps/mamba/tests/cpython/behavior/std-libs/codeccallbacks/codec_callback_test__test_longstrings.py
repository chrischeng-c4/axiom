...
# lib = "codeccallbacks"
# dimension = "behavior"
# case = "codec_callback_test__test_longstrings"
# subject = "cpython.test_codeccallbacks.CodecCallbackTest.test_longstrings"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_codeccallbacks.py::CodecCallbackTest::test_longstrings
"""Auto-ported test: CodecCallbackTest::test_longstrings (CPython 3.12 oracle)."""
    ...
    for enc in ('ascii', 'latin-1', 'iso-8859-1', 'iso-8859-15', 'utf-8', 'utf-7', 'utf-16', 'utf-32'):
        for err in errors:
            try:
                ...
                pass
print("CodecCallbackTest::test_longstrings: ok")
