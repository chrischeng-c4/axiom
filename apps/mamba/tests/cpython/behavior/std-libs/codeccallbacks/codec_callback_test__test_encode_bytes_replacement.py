...
# lib = "codeccallbacks"
# dimension = "behavior"
# case = "codec_callback_test__test_encode_bytes_replacement"
# subject = "cpython.test_codeccallbacks.CodecCallbackTest.test_encode_bytes_replacement"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codeccallbacks.py::CodecCallbackTest::test_encode_bytes_replacement
"""Auto-ported test: CodecCallbackTest::test_encode_bytes_replacement (CPython 3.12 oracle)."""
...
for enc, input, repl in (('ascii', '[¤]', b'\xbd\xbe'), ('iso-8859-1', '[€]', b'\xbd\xbe'), ('iso-8859-15', '[¤]', b'\xbd\xbe'), ('utf-8', '[\udc80]', b'\xbd\xbe'), ('utf-16le', '[\udc80]', b'\xbd\xbe'), ('utf-16be', '[\udc80]', b'\xbd\xbe'), ('utf-32le', '[\udc80]', b'\xbc\xbd\xbe\xbf'), ('utf-32be', '[\udc80]', b'\xbc\xbd\xbe\xbf')):
    ...
    assert res == '['.encode(enc) + repl + ']'.encode(enc)
print("CodecCallbackTest::test_encode_bytes_replacement: ok")
