...
# lib = "ssl"
# dimension = "behavior"
# case = "basic_socket_tests__test_purpose_enum"
# subject = "cpython.test_ssl.BasicSocketTests.test_purpose_enum"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::BasicSocketTests::test_purpose_enum
"""Auto-ported test: BasicSocketTests::test_purpose_enum (CPython 3.12 oracle)."""
...
assert isinstance(ssl.Purpose.SERVER_AUTH, ssl._ASN1Object)

assert ssl.Purpose.SERVER_AUTH == val

assert ssl.Purpose.SERVER_AUTH.nid == 129
...
assert isinstance(ssl.Purpose.CLIENT_AUTH, ssl._ASN1Object)

assert ssl.Purpose.CLIENT_AUTH == val

assert ssl.Purpose.CLIENT_AUTH.nid == 130

assert ssl.Purpose.CLIENT_AUTH.shortname == 'clientAuth'

assert ssl.Purpose.CLIENT_AUTH.oid == '1.3.6.1.5.5.7.3.2'
print("BasicSocketTests::test_purpose_enum: ok")
