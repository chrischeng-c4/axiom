...
# lib = "ssl"
# dimension = "behavior"
# case = "context_tests__test_ciphers"
# subject = "cpython.test_ssl.ContextTests.test_ciphers"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::ContextTests::test_ciphers
"""Auto-ported test: ContextTests::test_ciphers (CPython 3.12 oracle)."""
...
except ssl.SSLError as _aR_e:
    import re as _re_aR
    assert _re_aR.search('No cipher can be selected', str(_aR_e))
print("ContextTests::test_ciphers: ok")
