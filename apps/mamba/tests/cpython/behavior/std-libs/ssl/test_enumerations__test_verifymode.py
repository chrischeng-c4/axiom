...
# lib = "ssl"
# dimension = "behavior"
# case = "test_enumerations__test_verifymode"
# subject = "cpython.test_ssl.TestEnumerations.test_verifymode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::TestEnumerations::test_verifymode
"""Auto-ported test: TestEnumerations::test_verifymode (CPython 3.12 oracle)."""
...
# --- test body ---
CheckedVerifyMode = enum._old_convert_(enum.IntEnum, 'VerifyMode', 'ssl', lambda name: name.startswith('CERT_'), source=ssl._ssl)
enum._test_simple_enum(CheckedVerifyMode, ssl.VerifyMode)
print("TestEnumerations::test_verifymode: ok")
