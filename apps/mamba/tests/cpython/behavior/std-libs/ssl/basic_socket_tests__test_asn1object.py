...
# lib = "ssl"
# dimension = "behavior"
# case = "basic_socket_tests__test_asn1object"
# subject = "cpython.test_ssl.BasicSocketTests.test_asn1object"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::BasicSocketTests::test_asn1object
"""Auto-ported test: BasicSocketTests::test_asn1object (CPython 3.12 oracle)."""
...
assert val.shortname == 'serverAuth'

assert val.longname == 'TLS Web Server Authentication'

assert val.oid == '1.3.6.1.5.5.7.3.1'

assert isinstance(val, ssl._ASN1Object)

try:
    ssl._ASN1Object('serverAuth')
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('unknown NID 100000', str(_aR_e))
for i in range(1000):
    try:
        ...
        assert isinstance(obj.nid, int)

        assert isinstance(obj.shortname, str)

        assert isinstance(obj.longname, str)

        assert isinstance(obj.oid, (str, type(None)))
...
assert ssl._ASN1Object.fromname('serverAuth') == expected

assert ssl._ASN1Object.fromname('1.3.6.1.5.5.7.3.1') == expected
try:
    ssl._ASN1Object.fromname('serverauth')
    raise AssertionError('expected ValueError')
except ValueError as _aR_e:
    import re as _re_aR
    assert _re_aR.search("unknown object 'serverauth'", str(_aR_e))
print("BasicSocketTests::test_asn1object: ok")
