...
# lib = "ssl"
# dimension = "behavior"
# case = "test_enumerations__test_sslmethod"
# subject = "cpython.test_ssl.TestEnumerations.test_sslmethod"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::TestEnumerations::test_sslmethod
"""Auto-ported test: TestEnumerations::test_sslmethod (CPython 3.12 oracle)."""
...
# --- test body ---
Checked_SSLMethod = enum._old_convert_(enum.IntEnum, '_SSLMethod', 'ssl', lambda name: name.startswith('PROTOCOL_') and name != 'PROTOCOL_SSLv23', source=ssl._ssl)
Checked_SSLMethod.PROTOCOL_SSLv23 = Checked_SSLMethod.PROTOCOL_TLS
enum._test_simple_enum(Checked_SSLMethod, ssl._SSLMethod)
print("TestEnumerations::test_sslmethod: ok")
