...
# lib = "ssl"
# dimension = "behavior"
# case = "memory_bio_tests__test_buffer_types"
# subject = "cpython.test_ssl.MemoryBIOTests.test_buffer_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::MemoryBIOTests::test_buffer_types
"""Auto-ported test: MemoryBIOTests::test_buffer_types (CPython 3.12 oracle)."""
...
assert bio.read() == b'foo'
bio.write(bytearray(b'bar'))

assert bio.read() == b'bar'
bio.write(memoryview(b'baz'))

assert bio.read() == b'baz'
...
try:
    ...
    pass
print("MemoryBIOTests::test_buffer_types: ok")
