...
# lib = "ssl"
# dimension = "behavior"
# case = "basic_socket_tests__test_openssl_version"
# subject = "cpython.test_ssl.BasicSocketTests.test_openssl_version"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::BasicSocketTests::test_openssl_version
"""Auto-ported test: BasicSocketTests::test_openssl_version (CPython 3.12 oracle)."""
...
assert s.startswith((openssl_ver, libressl_ver, 'AWS-LC'))
print("BasicSocketTests::test_openssl_version: ok")
