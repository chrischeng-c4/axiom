...
# lib = "ssl"
# dimension = "behavior"
# case = "memory_bio_tests__test_pending"
# subject = "cpython.test_ssl.MemoryBIOTests.test_pending"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::MemoryBIOTests::test_pending
"""Auto-ported test: MemoryBIOTests::test_pending (CPython 3.12 oracle)."""
...
for i in range(3):
    ...
    assert bio.pending == 3 - i - 1
for i in range(3):
    bio.write(b'x')

    assert bio.pending == i + 1
bio.read()

assert bio.pending == 0
print("MemoryBIOTests::test_pending: ok")
