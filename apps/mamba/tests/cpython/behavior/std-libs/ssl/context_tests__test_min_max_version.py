...
# lib = "ssl"
# dimension = "behavior"
# case = "context_tests__test_min_max_version"
# subject = "cpython.test_ssl.ContextTests.test_min_max_version"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::ContextTests::test_min_max_version
"""Auto-ported test: ContextTests::test_min_max_version (CPython 3.12 oracle)."""
...
assert ctx.minimum_version in minimum_range

assert ctx.maximum_version in maximum_range
ctx.minimum_version = ssl.TLSVersion.TLSv1_1
ctx.maximum_version = ssl.TLSVersion.TLSv1_2

assert ctx.minimum_version == ssl.TLSVersion.TLSv1_1
...
assert ctx.maximum_version == ssl.TLSVersion.TLSv1
ctx.maximum_version = ssl.TLSVersion.MAXIMUM_SUPPORTED

assert ctx.maximum_version == ssl.TLSVersion.MAXIMUM_SUPPORTED
ctx.maximum_version = ssl.TLSVersion.MINIMUM_SUPPORTED

assert ctx.maximum_version in {ssl.TLSVersion.TLSv1, ssl.TLSVersion.TLSv1_1, ssl.TLSVersion.SSLv3}
...
if has_tls_protocol(ssl.PROTOCOL_TLSv1_1):
    ...
    try:
        ...
        pass
print("ContextTests::test_min_max_version: ok")
