...
# lib = "ssl"
# dimension = "behavior"
# case = "ssl_object_tests__test_private_init"
# subject = "cpython.test_ssl.SSLObjectTests.test_private_init"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::SSLObjectTests::test_private_init
"""Auto-ported test: SSLObjectTests::test_private_init (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('public constructor', str(_aR_e))
print("SSLObjectTests::test_private_init: ok")
