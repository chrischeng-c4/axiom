...
# lib = "ssl"
# dimension = "behavior"
# case = "context_tests__test_options"
# subject = "cpython.test_ssl.ContextTests.test_options"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::ContextTests::test_options
"""Auto-ported test: ContextTests::test_options (CPython 3.12 oracle)."""
...
assert default == ctx.options
with warnings_helper.check_warnings():
    ctx.options |= ssl.OP_NO_TLSv1

assert default | ssl.OP_NO_TLSv1 == ctx.options
with warnings_helper.check_warnings():
...
assert 0 == ctx.options & ~ssl.OP_NO_SSLv3
try:
    ctx.options = -1
...
try:
    ...
    pass
print("ContextTests::test_options: ok")
