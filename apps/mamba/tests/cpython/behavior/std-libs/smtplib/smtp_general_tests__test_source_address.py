...
# lib = "smtplib"
# dimension = "behavior"
# case = "smtp_general_tests__test_source_address"
# subject = "cpython.test_smtplib.SMTPGeneralTests.testSourceAddress"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_smtplib.py::SMTPGeneralTests::testSourceAddress
"""Auto-ported test: SMTPGeneralTests::testSourceAddress (CPython 3.12 oracle)."""
...
client = client(HOST, self_port, source_address=('127.0.0.1', 19876))

assert client.source_address == ('127.0.0.1', 19876)
client.close()
print("SMTPGeneralTests::testSourceAddress: ok")
