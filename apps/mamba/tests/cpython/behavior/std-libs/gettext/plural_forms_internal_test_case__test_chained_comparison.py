...
# lib = "gettext"
# dimension = "behavior"
# case = "plural_forms_internal_test_case__test_chained_comparison"
# subject = "cpython.test_gettext.PluralFormsInternalTestCase.test_chained_comparison"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_gettext.py::PluralFormsInternalTestCase::test_chained_comparison
"""Auto-ported test: PluralFormsInternalTestCase::test_chained_comparison (CPython 3.12 oracle)."""
...
assert ''.join((str(f(x)) for x in range(3))) == '010'
f = gettext.c2py('1 < n == n')

assert ''.join((str(f(x)) for x in range(3))) == '100'
f = gettext.c2py('n == n < 2')

assert ''.join((str(f(x)) for x in range(3))) == '010'
f = gettext.c2py('0 < n < 2')

assert ''.join((str(f(x)) for x in range(3))) == '111'
print("PluralFormsInternalTestCase::test_chained_comparison: ok")
