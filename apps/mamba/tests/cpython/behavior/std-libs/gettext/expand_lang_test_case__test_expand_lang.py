...
# lib = "gettext"
# dimension = "behavior"
# case = "expand_lang_test_case__test_expand_lang"
# subject = "cpython.test_gettext.ExpandLangTestCase.test_expand_lang"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_gettext.py::ExpandLangTestCase::test_expand_lang
"""Auto-ported test: ExpandLangTestCase::test_expand_lang (CPython 3.12 oracle)."""
...
# --- test body ---
locales = {'cs': ['cs'], 'cs_CZ': ['cs_CZ', 'cs'], 'cs.ISO8859-2': ['cs.ISO8859-2', 'cs'], 'cs@euro': ['cs@euro', 'cs'], 'cs_CZ.ISO8859-2': ['cs_CZ.ISO8859-2', 'cs_CZ', 'cs.ISO8859-2', 'cs'], 'cs_CZ@euro': ['cs_CZ@euro', 'cs@euro', 'cs_CZ', 'cs'], 'cs.ISO8859-2@euro': ['cs.ISO8859-2@euro', 'cs@euro', 'cs.ISO8859-2', 'cs'], 'cs_CZ.ISO8859-2@euro': ['cs_CZ.ISO8859-2@euro', 'cs_CZ@euro', 'cs.ISO8859-2@euro', 'cs@euro', 'cs_CZ.ISO8859-2', 'cs_CZ', 'cs.ISO8859-2', 'cs']}
for locale, expanded in locales.items():
    with unittest.mock.patch('locale.normalize', return_value=locale):

        assert gettext._expand_lang(locale) == expanded
print("ExpandLangTestCase::test_expand_lang: ok")
