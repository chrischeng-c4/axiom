...
# lib = "type_aliases"
# dimension = "behavior"
# case = "type_alias_type_test__test_module"
# subject = "cpython.test_type_aliases.TypeAliasTypeTest.test_module"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_aliases.py::TypeAliasTypeTest::test_module
"""Auto-ported test: TypeAliasTypeTest::test_module (CPython 3.12 oracle)."""
...
assert Alias.__module__ == __name__

assert mod_generics_cache.Alias.__module__ == mod_generics_cache.__name__

assert mod_generics_cache.OldStyle.__module__ == mod_generics_cache.__name__
print("TypeAliasTypeTest::test_module: ok")
