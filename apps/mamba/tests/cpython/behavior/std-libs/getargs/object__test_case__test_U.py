...
# lib = "getargs"
# dimension = "behavior"
# case = "object__test_case__test_U"
# subject = "cpython.test_getargs.Object_TestCase.test_U"
# kind = "semantic"
...
try:
    ...
    pass
try:
    getargs_U(bytearray(b'bytearray'))
    raise AssertionError('assertRaises: no raise')
except TypeError:
    pass
try:
...
print("Object_TestCase::test_U: ok")
