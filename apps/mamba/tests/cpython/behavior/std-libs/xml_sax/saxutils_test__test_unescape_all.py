...
# lib = "xml_sax"
# dimension = "behavior"
# case = "saxutils_test__test_unescape_all"
# subject = "cpython.test_sax.SaxutilsTest.test_unescape_all"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::SaxutilsTest::test_unescape_all
"""Auto-ported test: SaxutilsTest::test_unescape_all (CPython 3.12 oracle)."""
...
assert unescape('&lt;Donald Duck &amp; Co&gt;') == '<Donald Duck & Co>'
print("SaxutilsTest::test_unescape_all: ok")
