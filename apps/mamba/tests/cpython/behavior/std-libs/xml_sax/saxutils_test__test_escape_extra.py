...
# lib = "xml_sax"
# dimension = "behavior"
# case = "saxutils_test__test_escape_extra"
# subject = "cpython.test_sax.SaxutilsTest.test_escape_extra"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::SaxutilsTest::test_escape_extra
"""Auto-ported test: SaxutilsTest::test_escape_extra (CPython 3.12 oracle)."""
...
assert escape('Hei på deg', {'å': '&aring;'}) == 'Hei p&aring; deg'
print("SaxutilsTest::test_escape_extra: ok")
