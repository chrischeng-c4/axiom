...
# lib = "xml_sax"
# dimension = "behavior"
# case = "expat_reader_test__test_flush_reparse_deferral_disabled"
# subject = "cpython.test_sax.ExpatReaderTest.test_flush_reparse_deferral_disabled"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::ExpatReaderTest::test_flush_reparse_deferral_disabled
"""Auto-ported test: ExpatReaderTest::test_flush_reparse_deferral_disabled (CPython 3.12 oracle)."""
...
if pyexpat.version_info >= (2, 6, 0):
    ...
    assert result.getvalue() == start

assert not parser._parser.GetReparseDeferralEnabled()
parser.flush()

assert not parser._parser.GetReparseDeferralEnabled()

assert result.getvalue() == start + b'<doc>'
parser.feed('</doc>')
parser.close()

assert result.getvalue() == start + b'<doc></doc>'
print("ExpatReaderTest::test_flush_reparse_deferral_disabled: ok")
