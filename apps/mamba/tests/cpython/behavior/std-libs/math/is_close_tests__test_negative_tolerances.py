...
# lib = "math"
# dimension = "behavior"
# case = "is_close_tests__test_negative_tolerances"
# subject = "cpython.test_math.IsCloseTests.test_negative_tolerances"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_math.py::IsCloseTests::test_negative_tolerances
"""Auto-ported test: IsCloseTests::test_negative_tolerances (CPython 3.12 oracle)."""
...
def assertIsClose(a, b, *args, **kwargs):
    ...
    assert isclose(a, b, *args, **kwargs)

def assertIsNotClose(a, b, *args, **kwargs):

    assert not isclose(a, b, *args, **kwargs)
try:
    assertIsClose(1, 1, rel_tol=-1e-100)
    raise AssertionError('expected ValueError')
except ValueError:
    pass
try:
    assertIsClose(1, 1, rel_tol=1e-100, abs_tol=-10000000000.0)
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("IsCloseTests::test_negative_tolerances: ok")
