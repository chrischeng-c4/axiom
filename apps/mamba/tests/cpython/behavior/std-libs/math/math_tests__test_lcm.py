...
# lib = "math"
# dimension = "behavior"
# case = "math_tests__test_lcm"
# subject = "cpython.test_math.MathTests.test_lcm"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_math.py::MathTests::test_lcm
"""Auto-ported test: MathTests::test_lcm (CPython 3.12 oracle)."""
...
assert lcm(MyIndexable(120), MyIndexable(84)) == 840
print("MathTests::test_lcm: ok")
