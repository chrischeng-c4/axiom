...
# lib = "math"
# dimension = "behavior"
# case = "math_tests__test_trunc"
# subject = "cpython.test_math.MathTests.test_trunc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_math.py::MathTests::test_trunc
"""Auto-ported test: MathTests::test_trunc (CPython 3.12 oracle)."""
...
assert type(math.trunc(1)) == int

assert type(math.trunc(1.5)) == int
...
assert math.trunc(TestTrunc()) == 23

assert math.trunc(FloatTrunc()) == 23
...
try:
    math.trunc(FloatLike(23.5))
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    math.trunc(TestNoTrunc())
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    math.trunc(TestBadTrunc())
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("MathTests::test_trunc: ok")
