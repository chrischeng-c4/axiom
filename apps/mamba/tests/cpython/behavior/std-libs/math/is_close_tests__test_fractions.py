...
# lib = "math"
# dimension = "behavior"
# case = "is_close_tests__test_fractions"
# subject = "cpython.test_math.IsCloseTests.test_fractions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_math.py::IsCloseTests::test_fractions
"""Auto-ported test: IsCloseTests::test_fractions (CPython 3.12 oracle)."""
...
assertAllClose(fraction_examples, rel_tol=1e-08)
assertAllNotClose(fraction_examples, rel_tol=1e-09)
print("IsCloseTests::test_fractions: ok")
