...
# lib = "pipes"
# dimension = "behavior"
# case = "simple_pipe_tests__test_write_open_source"
# subject = "cpython.test_pipes.SimplePipeTests.testWriteOpenSource"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pipes.py::SimplePipeTests::testWriteOpenSource
"""Auto-ported test: SimplePipeTests::testWriteOpenSource (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("SimplePipeTests::testWriteOpenSource: ok")
