...
# lib = "statistics"
# dimension = "behavior"
# case = "test_modules__test_py_functions"
# subject = "cpython.test_statistics.TestModules.test_py_functions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::TestModules::test_py_functions
"""Auto-ported test: TestModules::test_py_functions (CPython 3.12 oracle)."""
...
for fname in func_names:
    ...
    assert getattr(py_statistics, fname).__module__ == 'statistics'
print("TestModules::test_py_functions: ok")
