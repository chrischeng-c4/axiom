...
# lib = "statistics"
# dimension = "behavior"
# case = "decimal_to_ratio_test__test_sign"
# subject = "cpython.test_statistics.DecimalToRatioTest.test_sign"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::DecimalToRatioTest::test_sign
"""Auto-ported test: DecimalToRatioTest::test_sign (CPython 3.12 oracle)."""
...
for d in numbers:
    ...
    assert den > 0
print("DecimalToRatioTest::test_sign: ok")
