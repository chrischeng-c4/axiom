...
# lib = "statistics"
# dimension = "behavior"
# case = "test_normal_dist_python__test_same_type_addition_and_subtraction"
# subject = "cpython.test_statistics.TestNormalDistPython.test_same_type_addition_and_subtraction"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::TestNormalDistPython::test_same_type_addition_and_subtraction
"""Auto-ported test: TestNormalDistPython::test_same_type_addition_and_subtraction (CPython 3.12 oracle)."""
...
assert X + Y == NormalDist(140, 13)

assert X - Y == NormalDist(60, 13)
print("TestNormalDistPython::test_same_type_addition_and_subtraction: ok")
