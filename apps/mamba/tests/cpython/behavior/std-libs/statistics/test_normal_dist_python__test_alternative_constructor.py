...
# lib = "statistics"
# dimension = "behavior"
# case = "test_normal_dist_python__test_alternative_constructor"
# subject = "cpython.test_statistics.TestNormalDistPython.test_alternative_constructor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::TestNormalDistPython::test_alternative_constructor
"""Auto-ported test: TestNormalDistPython::test_alternative_constructor (CPython 3.12 oracle)."""
...
NormalDist = module.NormalDist
data = [96, 107, 90, 92, 110]

assert NormalDist.from_samples(data) == NormalDist(99, 9)

assert NormalDist.from_samples(tuple(data)) == NormalDist(99, 9)

assert NormalDist.from_samples(iter(data)) == NormalDist(99, 9)
try:
    NormalDist.from_samples([])
    raise AssertionError('expected module.StatisticsError')
except module.StatisticsError:
    pass
try:
...
assert type(nnd) == NewNormalDist
print("TestNormalDistPython::test_alternative_constructor: ok")
