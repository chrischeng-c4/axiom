...
# lib = "statistics"
# dimension = "behavior"
# case = "exact_ratio_test__test_decimal_nan"
# subject = "cpython.test_statistics.ExactRatioTest.test_decimal_nan"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::ExactRatioTest::test_decimal_nan
"""Auto-ported test: ExactRatioTest::test_decimal_nan (CPython 3.12 oracle)."""
...
for nan in (NAN, MyDecimal(NAN), sNAN, MyDecimal(sNAN)):
    ...
    assert _nan_equal(ratio[0], nan)

    assert ratio[1] is None

    assert type(ratio[0]) == type(nan)
print("ExactRatioTest::test_decimal_nan: ok")
