...
# lib = "statistics"
# dimension = "behavior"
# case = "is_finite_test__test_infinity"
# subject = "cpython.test_statistics.IsFiniteTest.test_infinity"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::IsFiniteTest::test_infinity
"""Auto-ported test: IsFiniteTest::test_infinity (CPython 3.12 oracle)."""
...
for x in (float('inf'), Decimal('inf')):
    ...
    assert not statistics._isfinite(x)
print("IsFiniteTest::test_infinity: ok")
