...
# lib = "statistics"
# dimension = "behavior"
# case = "test_sqrt_helpers__test_float_sqrt_of_frac"
# subject = "cpython.test_statistics.TestSqrtHelpers.test_float_sqrt_of_frac"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::TestSqrtHelpers::test_float_sqrt_of_frac
"""Auto-ported test: TestSqrtHelpers::test_float_sqrt_of_frac (CPython 3.12 oracle)."""
...
for i in range(60000):
    ...
    assert is_root_correctly_rounded(x, root)

assert statistics._float_sqrt_of_frac(0, 1) == 0.0
try:
...
assert statistics._float_sqrt_of_frac(-2, -1) == statistics._float_sqrt_of_frac(2, 1)
print("TestSqrtHelpers::test_float_sqrt_of_frac: ok")
