...
# lib = "statistics"
# dimension = "behavior"
# case = "test_normal_dist_c__test_sample_generation"
# subject = "cpython.test_statistics.TestNormalDistC.test_sample_generation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::TestNormalDistC::test_sample_generation
"""Auto-ported test: TestNormalDistC::test_sample_generation (CPython 3.12 oracle)."""
...
assert set(map(type, data)) == {float}
xbar = module.mean(data)

assert mu - sigma * 8 <= xbar <= mu + sigma * 8
n = 100
...
assert data1 != data2
print("TestNormalDistC::test_sample_generation: ok")
