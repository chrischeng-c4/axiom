...
# lib = "statistics"
# dimension = "behavior"
# case = "decimal_to_ratio_test__test_infinity"
# subject = "cpython.test_statistics.DecimalToRatioTest.test_infinity"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::DecimalToRatioTest::test_infinity
"""Auto-ported test: DecimalToRatioTest::test_infinity (CPython 3.12 oracle)."""
...
assert statistics._exact_ratio(inf) == (inf, None)

assert statistics._exact_ratio(-inf) == (-inf, None)
print("DecimalToRatioTest::test_infinity: ok")
