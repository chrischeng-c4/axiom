...
# lib = "statistics"
# dimension = "behavior"
# case = "test_sqrt_helpers__test_integer_sqrt_of_frac_rto"
# subject = "cpython.test_statistics.TestSqrtHelpers.test_integer_sqrt_of_frac_rto"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::TestSqrtHelpers::test_integer_sqrt_of_frac_rto
"""Auto-ported test: TestSqrtHelpers::test_integer_sqrt_of_frac_rto (CPython 3.12 oracle)."""
...
for n, m in itertools.product(range(100), range(1, 1000)):
    ...
    assert m * (r - 1) ** 2 < n < m * (r + 1) ** 2
print("TestSqrtHelpers::test_integer_sqrt_of_frac_rto: ok")
