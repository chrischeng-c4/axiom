...
# lib = "statistics"
# dimension = "behavior"
# case = "is_finite_test__test_finite"
# subject = "cpython.test_statistics.IsFiniteTest.test_finite"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::IsFiniteTest::test_finite
"""Auto-ported test: IsFiniteTest::test_finite (CPython 3.12 oracle)."""
...
for x in (5, Fraction(1, 3), 2.5, Decimal('5.5')):
    ...
    assert statistics._isfinite(x)
print("IsFiniteTest::test_finite: ok")
