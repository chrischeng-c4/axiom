...
# lib = "statistics"
# dimension = "behavior"
# case = "approx_equal_specials_test__test_decimal_zeroes"
# subject = "cpython.test_statistics.ApproxEqualSpecialsTest.test_decimal_zeroes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::ApproxEqualSpecialsTest::test_decimal_zeroes
"""Auto-ported test: ApproxEqualSpecialsTest::test_decimal_zeroes (CPython 3.12 oracle)."""
...
assert approx_equal(nzero, Decimal(0), tol=0.1, rel=0.1)
print("ApproxEqualSpecialsTest::test_decimal_zeroes: ok")
