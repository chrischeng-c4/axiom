...
# lib = "statistics"
# dimension = "behavior"
# case = "exact_ratio_test__test_float_nan"
# subject = "cpython.test_statistics.ExactRatioTest.test_float_nan"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::ExactRatioTest::test_float_nan
"""Auto-ported test: ExactRatioTest::test_float_nan (CPython 3.12 oracle)."""
...
for nan in (NAN, MyFloat(NAN)):
    ...
    assert math.isnan(ratio[0])

    assert ratio[1] is None

    assert type(ratio[0]) == type(nan)
print("ExactRatioTest::test_float_nan: ok")
