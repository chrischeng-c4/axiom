...
# lib = "statistics"
# dimension = "behavior"
# case = "fail_neg_test__test_error_msg"
# subject = "cpython.test_statistics.FailNegTest.test_error_msg"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::FailNegTest::test_error_msg
"""Auto-ported test: FailNegTest::test_error_msg (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError("expected exception, but it didn't happen")

assert errmsg == msg
print("FailNegTest::test_error_msg: ok")
