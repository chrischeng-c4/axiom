...
# lib = "statistics"
# dimension = "behavior"
# case = "test_correlation_and_covariance__test_correlation_spearman"
# subject = "cpython.test_statistics.TestCorrelationAndCovariance.test_correlation_spearman"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_statistics.py::TestCorrelationAndCovariance::test_correlation_spearman
"""Auto-ported test: TestCorrelationAndCovariance::test_correlation_spearman (CPython 3.12 oracle)."""
...
assert abs(statistics.correlation(reading, mathematics, method='ranked') - 0.6686960980480712) < 1e-07
try:
    statistics.correlation(reading, mathematics, method='bad_method')
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("TestCorrelationAndCovariance::test_correlation_spearman: ok")
