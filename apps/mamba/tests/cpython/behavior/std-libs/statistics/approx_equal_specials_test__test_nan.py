...
# lib = "statistics"
# dimension = "behavior"
# case = "approx_equal_specials_test__test_nan"
# subject = "cpython.test_statistics.ApproxEqualSpecialsTest.test_nan"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::ApproxEqualSpecialsTest::test_nan
"""Auto-ported test: ApproxEqualSpecialsTest::test_nan (CPython 3.12 oracle)."""
...
for type_ in (float, Decimal):
    ...
    for other in (nan, type_('inf'), 1000):
        ...
        assert not approx_equal(nan, other)
print("ApproxEqualSpecialsTest::test_nan: ok")
