...
# lib = "statistics"
# dimension = "behavior"
# case = "test_sqrt_helpers__test_decimal_sqrt_of_frac"
# subject = "cpython.test_statistics.TestSqrtHelpers.test_decimal_sqrt_of_frac"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::TestSqrtHelpers::test_decimal_sqrt_of_frac
"""Auto-ported test: TestSqrtHelpers::test_decimal_sqrt_of_frac (CPython 3.12 oracle)."""
...
numerator: int
denominator: int
for root, numerator, denominator in [(Decimal('0.4481904599041192673635338663'), 200874688349065940678243576378, 1000000000000000000000000000000), (Decimal('0.7924949131383786609961759598'), 628048187350206338833590574929, 1000000000000000000000000000000), (Decimal('0.8500554152289934068192208727'), 722594208960136395984391238251, 1000000000000000000000000000000)]:
    with decimal.localcontext(decimal.DefaultContext):

        assert statistics._decimal_sqrt_of_frac(numerator, denominator) == root
...
assert statistics._decimal_sqrt_of_frac(0, 1) == 0.0
try:
...
assert statistics._decimal_sqrt_of_frac(-2, -1) == statistics._decimal_sqrt_of_frac(2, 1)
print("TestSqrtHelpers::test_decimal_sqrt_of_frac: ok")
