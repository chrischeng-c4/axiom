...
# lib = "statistics"
# dimension = "behavior"
# case = "exact_ratio_test__test_decimal"
# subject = "cpython.test_statistics.ExactRatioTest.test_decimal"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::ExactRatioTest::test_decimal
"""Auto-ported test: ExactRatioTest::test_decimal (CPython 3.12 oracle)."""
...
assert _exact_ratio(D('0.125')) == (1, 8)

assert _exact_ratio(D('12.345')) == (2469, 200)

assert _exact_ratio(D('-1.98')) == (-99, 50)
print("ExactRatioTest::test_decimal: ok")
