...
# lib = "cgi"
# dimension = "behavior"
# case = "cgi_tests__test_fieldstorage_invalid"
# subject = "cpython.test_cgi.CgiTests.test_fieldstorage_invalid"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cgi.py::CgiTests::test_fieldstorage_invalid
"""Auto-ported test: CgiTests::test_fieldstorage_invalid (CPython 3.12 oracle)."""
...
try:
    cgi.FieldStorage('not-a-file-obj', environ={'REQUEST_METHOD': 'PUT'})
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    cgi.FieldStorage('foo', 'bar')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
try:
    ...
    pass
print("CgiTests::test_fieldstorage_invalid: ok")
