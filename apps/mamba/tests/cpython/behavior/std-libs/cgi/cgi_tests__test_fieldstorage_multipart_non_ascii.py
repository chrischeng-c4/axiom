...
# lib = "cgi"
# dimension = "behavior"
# case = "cgi_tests__test_fieldstorage_multipart_non_ascii"
# subject = "cpython.test_cgi.CgiTests.test_fieldstorage_multipart_non_ascii"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cgi.py::CgiTests::test_fieldstorage_multipart_non_ascii
"""Auto-ported test: CgiTests::test_fieldstorage_multipart_non_ascii (CPython 3.12 oracle)."""
...
for encoding in ['iso-8859-1', 'utf-8']:
    ...
    for x in range(len(fs.list)):
        for k, exp in expect[x].items():
            ...
            assert got == exp
print("CgiTests::test_fieldstorage_multipart_non_ascii: ok")
