...
# lib = "cgi"
# dimension = "behavior"
# case = "cgi_tests__test_parse_multipart_invalid_encoding"
# subject = "cpython.test_cgi.CgiTests.test_parse_multipart_invalid_encoding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cgi.py::CgiTests::test_parse_multipart_invalid_encoding
"""Auto-ported test: CgiTests::test_parse_multipart_invalid_encoding (CPython 3.12 oracle)."""
...
assert '☃'.encode('utf8') == result['submit-name'][0].encode('utf8', 'surrogateescape')
print("CgiTests::test_parse_multipart_invalid_encoding: ok")
