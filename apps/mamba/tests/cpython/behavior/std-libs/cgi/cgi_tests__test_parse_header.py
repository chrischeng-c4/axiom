...
# lib = "cgi"
# dimension = "behavior"
# case = "cgi_tests__test_parse_header"
# subject = "cpython.test_cgi.CgiTests.test_parse_header"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cgi.py::CgiTests::test_parse_header
"""Auto-ported test: CgiTests::test_parse_header (CPython 3.12 oracle)."""
...
assert cgi.parse_header('text/plain') == ('text/plain', {})

assert cgi.parse_header('text/vnd.just.made.this.up ; ') == ('text/vnd.just.made.this.up', {})

assert cgi.parse_header('text/plain;charset=us-ascii') == ('text/plain', {'charset': 'us-ascii'})

assert cgi.parse_header('text/plain ; charset="us-ascii"') == ('text/plain', {'charset': 'us-ascii'})

assert cgi.parse_header('text/plain ; charset="us-ascii"; another=opt') == ('text/plain', {'charset': 'us-ascii', 'another': 'opt'})

assert cgi.parse_header('attachment; filename="silly.txt"') == ('attachment', {'filename': 'silly.txt'})

assert cgi.parse_header('attachment; filename="strange;name"') == ('attachment', {'filename': 'strange;name'})

assert cgi.parse_header('attachment; filename="strange;name";size=123;') == ('attachment', {'filename': 'strange;name', 'size': '123'})

assert cgi.parse_header('form-data; name="files"; filename="fo\\"o;bar"') == ('form-data', {'name': 'files', 'filename': 'fo"o;bar'})
print("CgiTests::test_parse_header: ok")
