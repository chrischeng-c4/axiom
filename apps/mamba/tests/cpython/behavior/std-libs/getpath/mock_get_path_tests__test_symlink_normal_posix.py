...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_symlink_normal_posix"
# subject = "cpython.test_getpath.MockGetPathTests.test_symlink_normal_posix"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_symlink_normal_posix
"""Auto-ported test: MockGetPathTests::test_symlink_normal_posix (CPython 3.12 oracle)."""
...
ns = MockPosixNamespace(PREFIX='/usr', argv0='/linkfrom/python')
...
print("MockGetPathTests::test_symlink_normal_posix: ok")
