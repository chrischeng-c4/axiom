...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_symlink_buildpath_macos"
# subject = "cpython.test_getpath.MockGetPathTests.test_symlink_buildpath_macos"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_symlink_buildpath_macos
"""Auto-ported test: MockGetPathTests::test_symlink_buildpath_macos (CPython 3.12 oracle)."""
...
expected = dict(executable='/linkfrom/python', prefix='/usr/local', exec_prefix='/usr/local', base_executable='/linkfrom/python', build_prefix='/home/cpython', _is_python_build=1, module_search_paths_set=1, module_search_paths=['/usr/local/lib/python98.zip', '/home/cpython/Lib', '/home/cpython/build/lib.macos-9.8'])
actual = getpath(ns, expected)

assert expected == actual
print("MockGetPathTests::test_symlink_buildpath_macos: ok")
