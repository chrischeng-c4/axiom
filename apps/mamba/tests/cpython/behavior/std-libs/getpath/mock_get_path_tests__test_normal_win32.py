...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_normal_win32"
# subject = "cpython.test_getpath.MockGetPathTests.test_normal_win32"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_normal_win32
"""Auto-ported test: MockGetPathTests::test_normal_win32 (CPython 3.12 oracle)."""
...
ns = MockNTNamespace(argv0='C:\\Python\\python.exe', real_executable='C:\\Python\\python.exe')
ns.add_known_xfile('C:\\Python\\python.exe')
ns.add_known_file('C:\\Python\\Lib\\os.py')
ns.add_known_dir('C:\\Python\\DLLs')
expected = dict(executable='C:\\Python\\python.exe', base_executable='C:\\Python\\python.exe', prefix='C:\\Python', exec_prefix='C:\\Python', module_search_paths_set=1, module_search_paths=['C:\\Python\\python98.zip', 'C:\\Python\\DLLs', 'C:\\Python\\Lib', 'C:\\Python'])
actual = getpath(ns, expected)

assert expected == actual
print("MockGetPathTests::test_normal_win32: ok")
