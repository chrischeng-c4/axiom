...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_venv_non_installed_zip_path_posix"
# subject = "cpython.test_getpath.MockGetPathTests.test_venv_non_installed_zip_path_posix"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_venv_non_installed_zip_path_posix
"""Auto-ported test: MockGetPathTests::test_venv_non_installed_zip_path_posix (CPython 3.12 oracle)."""
...
ns = MockPosixNamespace(argv0='/venv/bin/python', PREFIX='/usr', ENV_PATH='/venv/bin:/usr/bin')
...
ns.add_known_file('/venv/pyvenv.cfg', ['home = /path/to/non-installed'])
expected = dict(executable='/venv/bin/python', prefix='/path/to/non-installed', exec_prefix='/path/to/non-installed', base_executable='/path/to/non-installed/bin/python', base_prefix='/path/to/non-installed', base_exec_prefix='/path/to/non-installed', module_search_paths_set=1, module_search_paths=['/path/to/non-installed/lib/python98.zip', '/path/to/non-installed/lib/python9.8', '/path/to/non-installed/lib/python9.8/lib-dynload'])
actual = getpath(ns, expected)

assert expected == actual
print("MockGetPathTests::test_venv_non_installed_zip_path_posix: ok")
