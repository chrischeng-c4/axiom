...
# lib = "unparse"
# dimension = "behavior"
# case = "manual_ast_creation_test_case__test_function"
# subject = "cpython.test_unparse.ManualASTCreationTestCase.test_function"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unparse.py::ManualASTCreationTestCase::test_function
"""Auto-ported test: ManualASTCreationTestCase::test_function (CPython 3.12 oracle)."""
...
# --- test body ---
node = ast.FunctionDef(name='f', args=ast.arguments(posonlyargs=[], args=[], vararg=None, kwonlyargs=[], kw_defaults=[], kwarg=None, defaults=[]), body=[ast.Pass()], decorator_list=[], returns=None)
ast.fix_missing_locations(node)

assert ast.unparse(node) == 'def f():\n    pass'
print("ManualASTCreationTestCase::test_function: ok")
