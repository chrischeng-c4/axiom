...
# lib = "unparse"
# dimension = "behavior"
# case = "manual_ast_creation_test_case__test_function_with_type_params_and_bound"
# subject = "cpython.test_unparse.ManualASTCreationTestCase.test_function_with_type_params_and_bound"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unparse.py::ManualASTCreationTestCase::test_function_with_type_params_and_bound
"""Auto-ported test: ManualASTCreationTestCase::test_function_with_type_params_and_bound (CPython 3.12 oracle)."""
...
# --- test body ---
node = ast.FunctionDef(name='f', args=ast.arguments(posonlyargs=[], args=[], vararg=None, kwonlyargs=[], kw_defaults=[], kwarg=None, defaults=[]), body=[ast.Pass()], decorator_list=[], returns=None, type_params=[ast.TypeVar('T', bound=ast.Name('int'))])
ast.fix_missing_locations(node)

assert ast.unparse(node) == 'def f[T: int]():\n    pass'
print("ManualASTCreationTestCase::test_function_with_type_params_and_bound: ok")
