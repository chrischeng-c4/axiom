...
# lib = "type_comments"
# dimension = "behavior"
# case = "type_comment_tests__test_matmul"
# subject = "cpython.test_type_comments.TypeCommentTests.test_matmul"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_comments.py::TypeCommentTests::test_matmul
"""Auto-ported test: TypeCommentTests::test_matmul (CPython 3.12 oracle)."""
...
for tree in parse_all(matmul, minver=5):
    pass
print("TypeCommentTests::test_matmul: ok")
