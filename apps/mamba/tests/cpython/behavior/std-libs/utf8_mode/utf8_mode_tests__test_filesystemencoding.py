...
# lib = "utf8_mode"
# dimension = "behavior"
# case = "utf8_mode_tests__test_filesystemencoding"
# subject = "cpython.test_utf8_mode.UTF8ModeTests.test_filesystemencoding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_utf8_mode.py::UTF8ModeTests::test_filesystemencoding
"""Auto-ported test: UTF8ModeTests::test_filesystemencoding (CPython 3.12 oracle)."""
...
assert out == expected
if MS_WINDOWS:
    out = get_output('-X', 'utf8', '-c', code, PYTHONUTF8='strict', PYTHONLEGACYWINDOWSFSENCODING='1')

    assert out == 'mbcs/replace'
print("UTF8ModeTests::test_filesystemencoding: ok")
