...
# lib = "utf8_mode"
# dimension = "behavior"
# case = "utf8_mode_tests__test_stdio"
# subject = "cpython.test_utf8_mode.UTF8ModeTests.test_stdio"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_utf8_mode.py::UTF8ModeTests::test_stdio
"""Auto-ported test: UTF8ModeTests::test_stdio (CPython 3.12 oracle)."""
...
out = get_output('-X', 'utf8', '-c', code, PYTHONIOENCODING='')

assert out.splitlines() == ['stdin: utf-8/surrogateescape', 'stdout: utf-8/surrogateescape', 'stderr: utf-8/backslashreplace']
out = get_output('-X', 'utf8', '-c', code, PYTHONIOENCODING='latin1')

assert out.splitlines() == ['stdin: iso8859-1/strict', 'stdout: iso8859-1/strict', 'stderr: iso8859-1/backslashreplace']
out = get_output('-X', 'utf8', '-c', code, PYTHONIOENCODING=':namereplace')

assert out.splitlines() == ['stdin: utf-8/namereplace', 'stdout: utf-8/namereplace', 'stderr: utf-8/backslashreplace']
print("UTF8ModeTests::test_stdio: ok")
