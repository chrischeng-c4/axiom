...
# lib = "utf8_mode"
# dimension = "behavior"
# case = "utf8_mode_tests__test_locale_getpreferredencoding"
# subject = "cpython.test_utf8_mode.UTF8ModeTests.test_locale_getpreferredencoding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_utf8_mode.py::UTF8ModeTests::test_locale_getpreferredencoding
"""Auto-ported test: UTF8ModeTests::test_locale_getpreferredencoding (CPython 3.12 oracle)."""
...
assert out == 'utf-8 utf-8'
for loc in POSIX_LOCALES:
    out = get_output('-X', 'utf8', '-c', code, LC_ALL=loc)

    assert out == 'utf-8 utf-8'
print("UTF8ModeTests::test_locale_getpreferredencoding: ok")
