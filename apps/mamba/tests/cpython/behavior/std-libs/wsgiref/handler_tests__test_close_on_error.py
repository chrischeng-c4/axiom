...
# lib = "wsgiref"
# dimension = "behavior"
# case = "handler_tests__test_close_on_error"
# subject = "cpython.test_wsgiref.HandlerTests.testCloseOnError"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wsgiref.py::HandlerTests::testCloseOnError
"""Auto-ported test: HandlerTests::testCloseOnError (CPython 3.12 oracle)."""
...
assert side_effects['close_called'] == True
print("HandlerTests::testCloseOnError: ok")
