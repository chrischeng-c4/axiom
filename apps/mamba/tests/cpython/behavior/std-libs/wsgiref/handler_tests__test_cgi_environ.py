...
# lib = "wsgiref"
# dimension = "behavior"
# case = "handler_tests__test_cgi_environ"
# subject = "cpython.test_wsgiref.HandlerTests.testCGIEnviron"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wsgiref.py::HandlerTests::testCGIEnviron
"""Auto-ported test: HandlerTests::testCGIEnviron (CPython 3.12 oracle)."""
...
for key in ('wsgi.url_scheme', 'wsgi.input', 'wsgi.errors'):
    ...
    assert key in h.environ
print("HandlerTests::testCGIEnviron: ok")
