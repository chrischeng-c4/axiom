...
# lib = "wsgiref"
# dimension = "behavior"
# case = "integration_tests__test_status_validation_errors"
# subject = "cpython.test_wsgiref.IntegrationTests.test_status_validation_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wsgiref.py::IntegrationTests::test_status_validation_errors
"""Auto-ported test: IntegrationTests::test_status_validation_errors (CPython 3.12 oracle)."""
...
for status, exc_message in tests:
    ...
    assert err.splitlines()[-2] == exc_message
print("IntegrationTests::test_status_validation_errors: ok")
