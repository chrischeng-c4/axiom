...
# lib = "wsgiref"
# dimension = "behavior"
# case = "integration_tests__test_environ"
# subject = "cpython.test_wsgiref.IntegrationTests.test_environ"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wsgiref.py::IntegrationTests::test_environ
"""Auto-ported test: IntegrationTests::test_environ (CPython 3.12 oracle)."""
...
assert out.splitlines()[-1] == b'Python test,Python test 2;query=test;/path/'
print("IntegrationTests::test_environ: ok")
