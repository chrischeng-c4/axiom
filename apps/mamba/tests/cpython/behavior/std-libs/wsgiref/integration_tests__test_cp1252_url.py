...
# lib = "wsgiref"
# dimension = "behavior"
# case = "integration_tests__test_cp1252_url"
# subject = "cpython.test_wsgiref.IntegrationTests.test_cp1252_url"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wsgiref.py::IntegrationTests::test_cp1252_url
"""Auto-ported test: IntegrationTests::test_cp1252_url (CPython 3.12 oracle)."""
...
assert [b'HTTP/1.0 200 OK', mock.ANY, b'Content-Type: text/plain', b'Date: Wed, 24 Dec 2008 13:29:32 GMT', b'', b'/\x80\x80'] == out.splitlines()
print("IntegrationTests::test_cp1252_url: ok")
