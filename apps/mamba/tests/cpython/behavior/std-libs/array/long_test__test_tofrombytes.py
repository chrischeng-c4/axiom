...
# lib = "array"
# dimension = "behavior"
# case = "long_test__test_tofrombytes"
# subject = "cpython.test_array.LongTest.test_tofrombytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::LongTest::test_tofrombytes
"""Auto-ported test: LongTest::test_tofrombytes (CPython 3.12 oracle)."""
...
if a.itemsize > 1:
    ...
    try:
        ...
        pass
print("LongTest::test_tofrombytes: ok")
