...
# lib = "array"
# dimension = "behavior"
# case = "int_test__test_tofrombytes"
# subject = "cpython.test_array.IntTest.test_tofrombytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::IntTest::test_tofrombytes
"""Auto-ported test: IntTest::test_tofrombytes (CPython 3.12 oracle)."""
...
if a.itemsize > 1:
    ...
    try:
        ...
        pass
print("IntTest::test_tofrombytes: ok")
