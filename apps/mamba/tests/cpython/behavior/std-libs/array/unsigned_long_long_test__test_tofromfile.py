...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_long_test__test_tofromfile"
# subject = "cpython.test_array.UnsignedLongLongTest.test_tofromfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongLongTest::test_tofromfile
"""Auto-ported test: UnsignedLongLongTest::test_tofromfile (CPython 3.12 oracle)."""
...
try:
    ...
    try:
        ...
        pass
    b.fromfile(f, len(example))

    assert b == array.array(typecode, example)

    assert a != b

    try:
        b.fromfile(f, len(example) + 1)
    ...
    if not f.closed:
        f.close()
    os_helper.unlink(os_helper.TESTFN)
print("UnsignedLongLongTest::test_tofromfile: ok")
