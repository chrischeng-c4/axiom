...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_short_test__test_buffer"
# subject = "cpython.test_array.UnsignedShortTest.test_buffer"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedShortTest::test_buffer
"""Auto-ported test: UnsignedShortTest::test_buffer (CPython 3.12 oracle)."""
...
try:
    operator.setitem(a, slice(0, 0), a)
    raise AssertionError('expected BufferError')
except BufferError:
    pass
...
assert m.tobytes() == expected
print("UnsignedShortTest::test_buffer: ok")
