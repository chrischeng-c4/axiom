...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_int_test__test_tofrombytes"
# subject = "cpython.test_array.UnsignedIntTest.test_tofrombytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedIntTest::test_tofrombytes
"""Auto-ported test: UnsignedIntTest::test_tofrombytes (CPython 3.12 oracle)."""
...
if a.itemsize > 1:
    ...
    try:
        ...
        pass
print("UnsignedIntTest::test_tofrombytes: ok")
