...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_long_test__test_constructor"
# subject = "cpython.test_array.UnsignedLongLongTest.test_constructor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongLongTest::test_constructor
"""Auto-ported test: UnsignedLongLongTest::test_constructor (CPython 3.12 oracle)."""
...
assert a.typecode == typecode

assert a.itemsize >= minitemsize

try:
    array.array(typecode, None)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("UnsignedLongLongTest::test_constructor: ok")
