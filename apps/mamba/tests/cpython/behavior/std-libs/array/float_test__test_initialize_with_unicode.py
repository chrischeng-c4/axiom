...
# lib = "array"
# dimension = "behavior"
# case = "float_test__test_initialize_with_unicode"
# subject = "cpython.test_array.FloatTest.test_initialize_with_unicode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::FloatTest::test_initialize_with_unicode
"""Auto-ported test: FloatTest::test_initialize_with_unicode (CPython 3.12 oracle)."""
...
if typecode != 'u':
    ...
    a = array.array(typecode, 'foo')
    a = array.array(typecode, array.array('u', 'foo'))
print("FloatTest::test_initialize_with_unicode: ok")
