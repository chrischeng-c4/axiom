...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_int_test__test_tofromfile"
# subject = "cpython.test_array.UnsignedIntTest.test_tofromfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedIntTest::test_tofromfile
"""Auto-ported test: UnsignedIntTest::test_tofromfile (CPython 3.12 oracle)."""
...
try:
    ...
    if not f.closed:
        f.close()
    os_helper.unlink(os_helper.TESTFN)
print("UnsignedIntTest::test_tofromfile: ok")
