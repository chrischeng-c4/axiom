...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_long_test__test_extslice"
# subject = "cpython.test_array.UnsignedLongLongTest.test_extslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongLongTest::test_extslice
"""Auto-ported test: UnsignedLongLongTest::test_extslice (CPython 3.12 oracle)."""
...
assert a[-1000:-2000:-2] == array.array(typecode, [])
print("UnsignedLongLongTest::test_extslice: ok")
