...
# lib = "array"
# dimension = "behavior"
# case = "long_long_test__test_reverse_iterator_picking"
# subject = "cpython.test_array.LongLongTest.test_reverse_iterator_picking"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::LongLongTest::test_reverse_iterator_picking
"""Auto-ported test: LongLongTest::test_reverse_iterator_picking (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert list(a) == data2
print("LongLongTest::test_reverse_iterator_picking: ok")
