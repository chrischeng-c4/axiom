...
# lib = "array"
# dimension = "behavior"
# case = "long_long_test__test_tofrombytes"
# subject = "cpython.test_array.LongLongTest.test_tofrombytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::LongLongTest::test_tofrombytes
"""Auto-ported test: LongLongTest::test_tofrombytes (CPython 3.12 oracle)."""
...
if a.itemsize > 1:
    ...
    try:
        ...
        pass
print("LongLongTest::test_tofrombytes: ok")
