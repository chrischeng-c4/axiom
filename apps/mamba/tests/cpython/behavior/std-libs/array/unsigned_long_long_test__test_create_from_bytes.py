...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_long_test__test_create_from_bytes"
# subject = "cpython.test_array.UnsignedLongLongTest.test_create_from_bytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongLongTest::test_create_from_bytes
"""Auto-ported test: UnsignedLongLongTest::test_create_from_bytes (CPython 3.12 oracle)."""
...
assert len(a) * a.itemsize == 4
print("UnsignedLongLongTest::test_create_from_bytes: ok")
