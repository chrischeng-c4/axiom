...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_short_test__test_tofromfile"
# subject = "cpython.test_array.UnsignedShortTest.test_tofromfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedShortTest::test_tofromfile
"""Auto-ported test: UnsignedShortTest::test_tofromfile (CPython 3.12 oracle)."""
...
try:
    ...
    if not f.closed:
        f.close()
    os_helper.unlink(os_helper.TESTFN)
print("UnsignedShortTest::test_tofromfile: ok")
