...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_test__test_delslice"
# subject = "cpython.test_array.UnsignedLongTest.test_delslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongTest::test_delslice
"""Auto-ported test: UnsignedLongTest::test_delslice (CPython 3.12 oracle)."""
...
a = array.array(typecode, range(10))
del a[9::1 << 333]
print("UnsignedLongTest::test_delslice: ok")
