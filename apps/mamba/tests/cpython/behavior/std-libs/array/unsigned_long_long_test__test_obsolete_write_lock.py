...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_long_test__test_obsolete_write_lock"
# subject = "cpython.test_array.UnsignedLongLongTest.test_obsolete_write_lock"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongLongTest::test_obsolete_write_lock
"""Auto-ported test: UnsignedLongLongTest::test_obsolete_write_lock (CPython 3.12 oracle)."""
...
try:
    _testcapi.getbuffer_with_null_view(a)
    raise AssertionError('expected BufferError')
except BufferError:
    pass
print("UnsignedLongLongTest::test_obsolete_write_lock: ok")
