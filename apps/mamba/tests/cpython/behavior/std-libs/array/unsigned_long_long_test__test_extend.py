...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_long_test__test_extend"
# subject = "cpython.test_array.UnsignedLongLongTest.test_extend"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongLongTest::test_extend
"""Auto-ported test: UnsignedLongLongTest::test_extend (CPython 3.12 oracle)."""
...
assert a == array.array(typecode, example + example[::-1])
print("UnsignedLongLongTest::test_extend: ok")
