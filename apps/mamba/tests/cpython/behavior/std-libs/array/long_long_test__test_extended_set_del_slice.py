...
# lib = "array"
# dimension = "behavior"
# case = "long_long_test__test_extended_set_del_slice"
# subject = "cpython.test_array.LongLongTest.test_extended_set_del_slice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::LongLongTest::test_extended_set_del_slice
"""Auto-ported test: LongLongTest::test_extended_set_del_slice (CPython 3.12 oracle)."""
...
for start in indices:
    for stop in indices:
        for step in indices[1:]:
            ...
            assert a == array.array(typecode, L)
print("LongLongTest::test_extended_set_del_slice: ok")
