...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_long_test__test_pickle"
# subject = "cpython.test_array.UnsignedLongLongTest.test_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongLongTest::test_pickle
"""Auto-ported test: UnsignedLongLongTest::test_pickle (CPython 3.12 oracle)."""
...
for protocol in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert a == b
    a = ArraySubclass(typecode, example)
    a.x = 10
    b = pickle.loads(pickle.dumps(a, protocol))
...
print("UnsignedLongLongTest::test_pickle: ok")
