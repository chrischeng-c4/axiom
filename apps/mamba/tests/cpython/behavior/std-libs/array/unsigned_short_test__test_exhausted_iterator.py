...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_short_test__test_exhausted_iterator"
# subject = "cpython.test_array.UnsignedShortTest.test_exhausted_iterator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedShortTest::test_exhausted_iterator
"""Auto-ported test: UnsignedShortTest::test_exhausted_iterator (CPython 3.12 oracle)."""
...
assert list(empit) == [outside]

assert list(a) == list(example) + [outside]
print("UnsignedShortTest::test_exhausted_iterator: ok")
