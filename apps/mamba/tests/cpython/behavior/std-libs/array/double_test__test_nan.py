...
# lib = "array"
# dimension = "behavior"
# case = "double_test__test_nan"
# subject = "cpython.test_array.DoubleTest.test_nan"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::DoubleTest::test_nan
"""Auto-ported test: DoubleTest::test_nan (CPython 3.12 oracle)."""
...
def check_overflow(lower, upper):
    ...
    try:
        ...
        pass
a = array.array(typecode, [float('nan')])
b = array.array(typecode, [float('nan')])
