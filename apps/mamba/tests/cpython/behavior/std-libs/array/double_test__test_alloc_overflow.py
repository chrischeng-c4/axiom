...
# lib = "array"
# dimension = "behavior"
# case = "double_test__test_alloc_overflow"
# subject = "cpython.test_array.DoubleTest.test_alloc_overflow"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::DoubleTest::test_alloc_overflow
"""Auto-ported test: DoubleTest::test_alloc_overflow (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('Array of size > maxsize created - MemoryError expected')
...
try:
    ...
    raise AssertionError('Array of size > maxsize created - MemoryError expected')
print("DoubleTest::test_alloc_overflow: ok")
