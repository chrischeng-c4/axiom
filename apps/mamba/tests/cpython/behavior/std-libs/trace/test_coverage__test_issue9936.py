...
# lib = "trace"
# dimension = "behavior"
# case = "test_coverage__test_issue9936"
# subject = "cpython.test_trace.TestCoverage.test_issue9936"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestCoverage::test_issue9936
"""Auto-ported test: TestCoverage::test_issue9936 (CPython 3.12 oracle)."""
...
assert modname in coverage

assert coverage[modname] == (5, 100)
print("TestCoverage::test_issue9936: ok")
