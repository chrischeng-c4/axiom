...
# lib = "trace"
# dimension = "behavior"
# case = "test_line_counts__test_trace_func_generator"
# subject = "cpython.test_trace.TestLineCounts.test_trace_func_generator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestLineCounts::test_trace_func_generator
"""Auto-ported test: TestLineCounts::test_trace_func_generator (CPython 3.12 oracle)."""
...
self_tracer.runfunc(traced_func_calling_generator)
firstlineno_calling = get_firstlineno(traced_func_calling_generator)
firstlineno_gen = get_firstlineno(traced_func_generator)
expected = {(self_my_py_filename, firstlineno_calling + 1): 1, (self_my_py_filename, firstlineno_calling + 2): 11, (self_my_py_filename, firstlineno_calling + 3): 10, (self_my_py_filename, firstlineno_gen + 1): 1, (self_my_py_filename, firstlineno_gen + 2): 11, (self_my_py_filename, firstlineno_gen + 3): 10}

assert self_tracer.results().counts == expected
print("TestLineCounts::test_trace_func_generator: ok")
