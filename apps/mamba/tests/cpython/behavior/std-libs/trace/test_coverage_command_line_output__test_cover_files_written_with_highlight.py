...
# lib = "trace"
# dimension = "behavior"
# case = "test_coverage_command_line_output__test_cover_files_written_with_highlight"
# subject = "cpython.test_trace.TestCoverageCommandLineOutput.test_cover_files_written_with_highlight"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestCoverageCommandLineOutput::test_cover_files_written_with_highlight
"""Auto-ported test: TestCoverageCommandLineOutput::test_cover_files_written_with_highlight (CPython 3.12 oracle)."""
...
argv = '-m trace --count --missing'.split() + [codefile]
status, stdout, stderr = assert_python_ok(*argv)

assert os.path.exists(coverfile)
with open(coverfile, encoding='iso-8859-15') as f:

    assert f.read() == textwrap.dedent("                       # coding: iso-8859-15\n                    1: x = 'spœm'\n                    1: if []:\n                >>>>>>     print('unreachable')\n            ")
print("TestCoverageCommandLineOutput::test_cover_files_written_with_highlight: ok")
