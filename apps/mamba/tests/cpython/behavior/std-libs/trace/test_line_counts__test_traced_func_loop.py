...
# lib = "trace"
# dimension = "behavior"
# case = "test_line_counts__test_traced_func_loop"
# subject = "cpython.test_trace.TestLineCounts.test_traced_func_loop"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestLineCounts::test_traced_func_loop
"""Auto-ported test: TestLineCounts::test_traced_func_loop (CPython 3.12 oracle)."""
...
self_tracer.runfunc(traced_func_loop, 2, 3)
firstlineno = get_firstlineno(traced_func_loop)
expected = {(self_my_py_filename, firstlineno + 1): 1, (self_my_py_filename, firstlineno + 2): 6, (self_my_py_filename, firstlineno + 3): 5, (self_my_py_filename, firstlineno + 4): 1}

assert self_tracer.results().counts == expected
print("TestLineCounts::test_traced_func_loop: ok")
