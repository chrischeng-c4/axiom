...
# lib = "trace"
# dimension = "behavior"
# case = "test_command_line__test_count_and_summary"
# subject = "cpython.test_trace.TestCommandLine.test_count_and_summary"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestCommandLine::test_count_and_summary
"""Auto-ported test: TestCommandLine::test_count_and_summary (CPython 3.12 oracle)."""
...
assert 'lines   cov%   module   (path)' in stdout

assert f'6   100%   {modulename}   ({filename})' in stdout
print("TestCommandLine::test_count_and_summary: ok")
