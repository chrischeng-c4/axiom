...
# lib = "code"
# dimension = "behavior"
# case = "code_test__test_closure_injection"
# subject = "cpython.test_code.CodeTest.test_closure_injection"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_code.py::CodeTest::test_closure_injection
"""Auto-ported test: CodeTest::test_closure_injection (CPython 3.12 oracle)."""
...
assert class_ref is List
obj = List([1, 2, 3])

assert obj[0] == 'Foreign getitem: 1'
print("CodeTest::test_closure_injection: ok")
