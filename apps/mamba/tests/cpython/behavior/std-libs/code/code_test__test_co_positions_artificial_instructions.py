...
# lib = "code"
# dimension = "behavior"
# case = "code_test__test_co_positions_artificial_instructions"
# subject = "cpython.test_code.CodeTest.test_co_positions_artificial_instructions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_code.py::CodeTest::test_co_positions_artificial_instructions
"""Auto-ported test: CodeTest::test_co_positions_artificial_instructions (CPython 3.12 oracle)."""
...
import dis
namespace = {}
exec(textwrap.dedent('        try:\n            1/0\n        except Exception as e:\n            exc = e\n        '), namespace)
exc = namespace['exc']
traceback = exc.__traceback__
code = traceback.tb_frame.f_code
artificial_instructions = []
for instr, positions in zip(dis.get_instructions(code, show_caches=True), code.co_positions(), strict=True):

    assert positions.count(None) in [0, 3, 4]
    if not any(positions):
        artificial_instructions.append(instr)

assert [(instruction.opname, instruction.argval) for instruction in artificial_instructions] == [('PUSH_EXC_INFO', None), ('LOAD_CONST', None), ('STORE_NAME', 'e'), ('DELETE_NAME', 'e'), ('RERAISE', 1), ('COPY', 3), ('POP_EXCEPT', None), ('RERAISE', 1)]
print("CodeTest::test_co_positions_artificial_instructions: ok")
