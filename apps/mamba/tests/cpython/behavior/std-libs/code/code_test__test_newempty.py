...
# lib = "code"
# dimension = "behavior"
# case = "code_test__test_newempty"
# subject = "cpython.test_code.CodeTest.test_newempty"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_code.py::CodeTest::test_newempty
"""Auto-ported test: CodeTest::test_newempty (CPython 3.12 oracle)."""
...
assert co.co_filename == 'filename'

assert co.co_name == 'funcname'

assert co.co_firstlineno == 15
try:
    exec(co)
    raise AssertionError('expected Exception')
except Exception:
    pass
print("CodeTest::test_newempty: ok")
