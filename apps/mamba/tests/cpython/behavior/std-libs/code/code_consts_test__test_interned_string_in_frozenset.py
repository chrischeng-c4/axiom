...
# lib = "code"
# dimension = "behavior"
# case = "code_consts_test__test_interned_string_in_frozenset"
# subject = "cpython.test_code.CodeConstsTest.test_interned_string_in_frozenset"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_code.py::CodeConstsTest::test_interned_string_in_frozenset
"""Auto-ported test: CodeConstsTest::test_interned_string_in_frozenset (CPython 3.12 oracle)."""
...
v = find_const(co.co_consts, frozenset(('str_value',)))
assertIsInterned(tuple(v)[0])
print("CodeConstsTest::test_interned_string_in_frozenset: ok")
