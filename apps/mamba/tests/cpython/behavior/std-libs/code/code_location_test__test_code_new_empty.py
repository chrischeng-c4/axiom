...
# lib = "code"
# dimension = "behavior"
# case = "code_location_test__test_code_new_empty"
# subject = "cpython.test_code.CodeLocationTest.test_code_new_empty"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_code.py::CodeLocationTest::test_code_new_empty
"""Auto-ported test: CodeLocationTest::test_code_new_empty (CPython 3.12 oracle)."""
...
f.__code__ = f.__code__.replace(co_stacksize=1, co_firstlineno=42, co_code=bytes([dis.opmap['RESUME'], 0, dis.opmap['LOAD_ASSERTION_ERROR'], 0, dis.opmap['RAISE_VARARGS'], 1]), co_linetable=bytes([1 << 7 | PY_CODE_LOCATION_INFO_NO_COLUMNS << 3 | 3 - 1, 0]))
...
assert list(f.__code__.co_positions()) == 3 * [(42, 42, None, None)]
print("CodeLocationTest::test_code_new_empty: ok")
