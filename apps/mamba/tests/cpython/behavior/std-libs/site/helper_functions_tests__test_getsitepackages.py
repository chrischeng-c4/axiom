...
# lib = "site"
# dimension = "behavior"
# case = "helper_functions_tests__test_getsitepackages"
# subject = "cpython.test_site.HelperFunctionsTests.test_getsitepackages"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_site.py::HelperFunctionsTests::test_getsitepackages
"""Auto-ported test: HelperFunctionsTests::test_getsitepackages (CPython 3.12 oracle)."""
...
if os.sep == '/':
    ...
    assert os.path.normcase(dirs[1]) == os.path.normcase(wanted)
print("HelperFunctionsTests::test_getsitepackages: ok")
