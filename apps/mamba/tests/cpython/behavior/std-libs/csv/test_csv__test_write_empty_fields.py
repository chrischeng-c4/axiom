...
# lib = "csv"
# dimension = "behavior"
# case = "test_csv__test_write_empty_fields"
# subject = "cpython.test_csv.Test_Csv.test_write_empty_fields"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_csv.py::Test_Csv::test_write_empty_fields
"""Auto-ported test: Test_Csv::test_write_empty_fields (CPython 3.12 oracle)."""
...
_write_test((), '')
_write_test([''], '""')
_write_error_test(csv.Error, [''], quoting=csv.QUOTE_NONE)
_write_test([''], '""', quoting=csv.QUOTE_STRINGS)
_write_test([''], '""', quoting=csv.QUOTE_NOTNULL)
_write_test([None], '""')
_write_error_test(csv.Error, [None], quoting=csv.QUOTE_NONE)
_write_error_test(csv.Error, [None], quoting=csv.QUOTE_STRINGS)
_write_error_test(csv.Error, [None], quoting=csv.QUOTE_NOTNULL)
_write_test(['', ''], ',')
_write_test([None, None], ',')
print("Test_Csv::test_write_empty_fields: ok")
