...
# lib = "csv"
# dimension = "behavior"
# case = "test_csv__test_writer_dialect_attrs"
# subject = "cpython.test_csv.Test_Csv.test_writer_dialect_attrs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_csv.py::Test_Csv::test_writer_dialect_attrs
"""Auto-ported test: Test_Csv::test_writer_dialect_attrs (CPython 3.12 oracle)."""
...
_test_dialect_attrs(csv.writer, StringIO())
print("Test_Csv::test_writer_dialect_attrs: ok")
