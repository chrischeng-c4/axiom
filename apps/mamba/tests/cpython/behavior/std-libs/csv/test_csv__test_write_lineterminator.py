...
# lib = "csv"
# dimension = "behavior"
# case = "test_csv__test_write_lineterminator"
# subject = "cpython.test_csv.Test_Csv.test_write_lineterminator"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_csv.py::Test_Csv::test_write_lineterminator
"""Auto-ported test: Test_Csv::test_write_lineterminator (CPython 3.12 oracle)."""
...
for lineterminator in ('\r\n', '\n', '\r', '!@#', '\x00'):
    with StringIO() as sio:
        ...
        assert sio.getvalue() == f'a,b{lineterminator}1,2{lineterminator}"\r","\n"{lineterminator}'
print("Test_Csv::test_write_lineterminator: ok")
