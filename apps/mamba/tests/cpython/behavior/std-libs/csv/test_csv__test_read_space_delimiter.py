...
# lib = "csv"
# dimension = "behavior"
# case = "test_csv__test_read_space_delimiter"
# subject = "cpython.test_csv.Test_Csv.test_read_space_delimiter"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_csv.py::Test_Csv::test_read_space_delimiter
"""Auto-ported test: Test_Csv::test_read_space_delimiter (CPython 3.12 oracle)."""
...
_read_test(['a   b', '  a  ', '  ', ''], [['a', '', '', 'b'], ['', '', 'a', '', ''], ['', '', ''], []], delimiter=' ', skipinitialspace=False)
_read_test(['a   b', '  a  ', '  ', ''], [['a', 'b'], ['a', ''], [''], []], delimiter=' ', skipinitialspace=True)
print("Test_Csv::test_read_space_delimiter: ok")
