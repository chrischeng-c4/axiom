...
# lib = "csv"
# dimension = "behavior"
# case = "test_csv__test_writer_arg_valid"
# subject = "cpython.test_csv.Test_Csv.test_writer_arg_valid"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_csv.py::Test_Csv::test_writer_arg_valid
"""Auto-ported test: Test_Csv::test_writer_arg_valid (CPython 3.12 oracle)."""
...
_test_arg_valid(csv.writer, StringIO())
...
try:
    csv.writer(BadWriter())
    raise AssertionError('expected OSError')
except OSError:
    pass
print("Test_Csv::test_writer_arg_valid: ok")
