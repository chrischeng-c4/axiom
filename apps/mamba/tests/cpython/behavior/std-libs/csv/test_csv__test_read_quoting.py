...
# lib = "csv"
# dimension = "behavior"
# case = "test_csv__test_read_quoting"
# subject = "cpython.test_csv.Test_Csv.test_read_quoting"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_csv.py::Test_Csv::test_read_quoting
"""Auto-ported test: Test_Csv::test_read_quoting (CPython 3.12 oracle)."""
...
_read_test(['1,",3,",5'], [['1', '"', '3', '"', '5']], quotechar=None, escapechar='\\')
_read_test(['1,",3,",5'], [['1', '"', '3', '"', '5']], quoting=csv.QUOTE_NONE, escapechar='\\')
_read_test([',3,"5",7.3, 9'], [['', 3, '5', 7.3, 9]], quoting=csv.QUOTE_NONNUMERIC)
_read_test(['"a\nb", 7'], [['a\nb', ' 7']])

try:
    _read_test(['abc,3'], [[]], quoting=csv.QUOTE_NONNUMERIC)
    raise AssertionError('expected ValueError')
except ValueError:
    pass
_read_test(['1,@,3,@,5'], [['1', ',3,', '5']], quotechar='@')
_read_test(['1,\x00,3,\x00,5'], [['1', ',3,', '5']], quotechar='\x00')
_read_test(['1\\.5,\\.5,.5'], [[1.5, 0.5, 0.5]], quoting=csv.QUOTE_NONNUMERIC, escapechar='\\')
print("Test_Csv::test_read_quoting: ok")
