...
# lib = "fractions"
# dimension = "behavior"
# case = "fraction_test__test_as_integer_ratio"
# subject = "cpython.test_fractions.FractionTest.test_as_integer_ratio"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_fractions.py::FractionTest::test_as_integer_ratio
"""Auto-ported test: FractionTest::test_as_integer_ratio (CPython 3.12 oracle)."""
...
assert F(4, 6).as_integer_ratio() == (2, 3)

assert F(-4, 6).as_integer_ratio() == (-2, 3)

assert F(4, -6).as_integer_ratio() == (-2, 3)

assert F(0, 6).as_integer_ratio() == (0, 1)
print("FractionTest::test_as_integer_ratio: ok")
