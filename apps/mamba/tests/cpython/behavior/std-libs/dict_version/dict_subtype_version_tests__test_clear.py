...
# lib = "dict_version"
# dimension = "behavior"
# case = "dict_subtype_version_tests__test_clear"
# subject = "cpython.test_dict_version.DictSubtypeVersionTests.test_clear"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dict_version.py::DictSubtypeVersionTests::test_clear
"""Auto-ported test: DictSubtypeVersionTests::test_clear (CPython 3.12 oracle)."""
...
check_version_changed(d, d.clear)
check_version_dont_change(d, d.clear)
print("DictSubtypeVersionTests::test_clear: ok")
