...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_weak_destroy_while_iterating"
# subject = "cpython.test_weakset.TestWeakSet.test_weak_destroy_while_iterating"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_weak_destroy_while_iterating
"""Auto-ported test: TestWeakSet::test_weak_destroy_while_iterating (CPython 3.12 oracle)."""
...
assert len(list(it)) in [len(items), len(items) - 1]
del it

assert len(s) == len(items)
print("TestWeakSet::test_weak_destroy_while_iterating: ok")
