...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_init"
# subject = "cpython.test_weakset.TestWeakSet.test_init"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_init
"""Auto-ported test: TestWeakSet::test_init (CPython 3.12 oracle)."""
...
s = WeakSet()
s.__init__(self_items)

assert s == self_s
s.__init__(self_items2)

assert s == WeakSet(self_items2)
...
try:
    ...
    pass
print("TestWeakSet::test_init: ok")
