...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_isdisjoint"
# subject = "cpython.test_weakset.TestWeakSet.test_isdisjoint"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_isdisjoint
"""Auto-ported test: TestWeakSet::test_isdisjoint (CPython 3.12 oracle)."""
...
assert self_s.isdisjoint(WeakSet(self_items2))

assert not self_s.isdisjoint(WeakSet(self_letters))
print("TestWeakSet::test_isdisjoint: ok")
