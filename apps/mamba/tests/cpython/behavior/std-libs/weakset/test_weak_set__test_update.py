...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_update"
# subject = "cpython.test_weakset.TestWeakSet.test_update"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_update
"""Auto-ported test: TestWeakSet::test_update (CPython 3.12 oracle)."""
...
retval = self_s.update(self_items2)
...
try:
    ...
    pass
print("TestWeakSet::test_update: ok")
