...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_abc"
# subject = "cpython.test_weakset.TestWeakSet.test_abc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_abc
"""Auto-ported test: TestWeakSet::test_abc (CPython 3.12 oracle)."""
...
assert isinstance(self_s, Set)

assert isinstance(self_s, MutableSet)
print("TestWeakSet::test_abc: ok")
