...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_eq"
# subject = "cpython.test_weakset.TestWeakSet.test_eq"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_eq
"""Auto-ported test: TestWeakSet::test_eq (CPython 3.12 oracle)."""
...
assert self_s == self_s

assert self_s == WeakSet(self_items)

assert not self_s == set(self_items)

assert not self_s == list(self_items)

assert not self_s == tuple(self_items)

assert not self_s == WeakSet([Foo])

assert not self_s == 1
print("TestWeakSet::test_eq: ok")
