...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_symmetric_difference"
# subject = "cpython.test_weakset.TestWeakSet.test_symmetric_difference"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_symmetric_difference
"""Auto-ported test: TestWeakSet::test_symmetric_difference (CPython 3.12 oracle)."""
...
i = self_s.symmetric_difference(self_items2)
for c in self_letters:

    assert (c in i) == (c in self_d) ^ (c in self_items2)
...
assert len(i) == len(self_items) + len(self_items2)
self_items2.pop()
gc.collect()

assert len(i) == len(self_items) + len(self_items2)
print("TestWeakSet::test_symmetric_difference: ok")
