...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_add"
# subject = "cpython.test_weakset.TestWeakSet.test_add"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_add
"""Auto-ported test: TestWeakSet::test_add (CPython 3.12 oracle)."""
...
assert len(self_fs) == 1
self_fs.add(self_obj)

assert len(self_fs) == 1
print("TestWeakSet::test_add: ok")
