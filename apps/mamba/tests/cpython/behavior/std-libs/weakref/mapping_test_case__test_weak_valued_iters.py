...
# lib = "weakref"
# dimension = "behavior"
# case = "mapping_test_case__test_weak_valued_iters"
# subject = "cpython.test_weakref.MappingTestCase.test_weak_valued_iters"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakref.py::MappingTestCase::test_weak_valued_iters
"""Auto-ported test: MappingTestCase::test_weak_valued_iters (CPython 3.12 oracle)."""
...
for wr in refs:
    ...
    assert ob == dict[ob.arg]

    assert ob.arg == dict[ob.arg].arg
    objects2.remove(ob)

assert len(objects2) == 0
objects2 = list(objects)

assert len(list(dict.itervaluerefs())) == len(objects)
...
assert len(objects2) == 0
print("MappingTestCase::test_weak_valued_iters: ok")
