...
# lib = "weakref"
# dimension = "behavior"
# case = "mapping_test_case__test_weak_keyed_dict_popitem"
# subject = "cpython.test_weakref.MappingTestCase.test_weak_keyed_dict_popitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakref.py::MappingTestCase::test_weak_keyed_dict_popitem
"""Auto-ported test: MappingTestCase::test_weak_keyed_dict_popitem (CPython 3.12 oracle)."""
...
def make_weak_valued_dict():
    ...
    return (dict, objects)
self_cbcalled = 0
check_popitem(weakref.WeakKeyDictionary, C(), 'value 1', C(), 'value 2')
print("MappingTestCase::test_weak_keyed_dict_popitem: ok")
