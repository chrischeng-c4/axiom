...
# lib = "weakref"
# dimension = "behavior"
# case = "mapping_test_case__test_weak_values_destroy_while_iterating"
# subject = "cpython.test_weakref.MappingTestCase.test_weak_values_destroy_while_iterating"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakref.py::MappingTestCase::test_weak_values_destroy_while_iterating
"""Auto-ported test: MappingTestCase::test_weak_values_destroy_while_iterating (CPython 3.12 oracle)."""
...
def make_weak_valued_dict():
    ...
    return (dict, objects)
self_cbcalled = 0
dict, objects = make_weak_valued_dict()
check_weak_destroy_while_iterating(dict, objects, 'keys')
check_weak_destroy_while_iterating(dict, objects, 'items')
check_weak_destroy_while_iterating(dict, objects, 'values')
check_weak_destroy_while_iterating(dict, objects, 'itervaluerefs')
check_weak_destroy_while_iterating(dict, objects, 'valuerefs')
dict, objects = make_weak_valued_dict()
...
def testcontext():
    try:
        ...
        it = None
        gc.collect()
check_weak_destroy_and_mutate_while_iterating(dict, testcontext)
dict, objects = make_weak_valued_dict()
check_weak_del_and_len_while_iterating(dict, testcontext)
print("MappingTestCase::test_weak_values_destroy_while_iterating: ok")
