...
# lib = "http_cookiejar"
# dimension = "behavior"
# case = "lwp_cookie_tests__test_intranet_domains_2965"
# subject = "cpython.test_http_cookiejar.LWPCookieTests.test_intranet_domains_2965"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_http_cookiejar.py::LWPCookieTests::test_intranet_domains_2965
"""Auto-ported test: LWPCookieTests::test_intranet_domains_2965 (CPython 3.12 oracle)."""
...
assert 'foo1=bar' in cookie
interact_2965(c, 'http://example/', 'foo3=bar; Version=1')
cookie = interact_2965(c, 'http://example/')

assert 'foo2=bar' in cookie

assert len(c) == 3
print("LWPCookieTests::test_intranet_domains_2965: ok")
