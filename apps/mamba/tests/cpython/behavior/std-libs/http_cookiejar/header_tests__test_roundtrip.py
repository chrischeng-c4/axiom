...
# lib = "http_cookiejar"
# dimension = "behavior"
# case = "header_tests__test_roundtrip"
# subject = "cpython.test_http_cookiejar.HeaderTests.test_roundtrip"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_http_cookiejar.py::HeaderTests::test_roundtrip
"""Auto-ported test: HeaderTests::test_roundtrip (CPython 3.12 oracle)."""
...
for arg, expect in tests:
    ...
    assert res == expect
print("HeaderTests::test_roundtrip: ok")
