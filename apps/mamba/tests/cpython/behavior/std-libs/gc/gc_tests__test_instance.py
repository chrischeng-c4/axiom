...
# lib = "gc"
# dimension = "behavior"
# case = "gc_tests__test_instance"
# subject = "cpython.test_gc.GCTests.test_instance"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_gc.py::GCTests::test_instance
"""Auto-ported test: GCTests::test_instance (CPython 3.12 oracle)."""
...
assert gc.collect() != 0
print("GCTests::test_instance: ok")
