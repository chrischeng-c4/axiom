...
# lib = "gc"
# dimension = "behavior"
# case = "gc_tests__test_newstyleclass"
# subject = "cpython.test_gc.GCTests.test_newstyleclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_gc.py::GCTests::test_newstyleclass
"""Auto-ported test: GCTests::test_newstyleclass (CPython 3.12 oracle)."""
...
assert gc.collect() != 0
print("GCTests::test_newstyleclass: ok")
