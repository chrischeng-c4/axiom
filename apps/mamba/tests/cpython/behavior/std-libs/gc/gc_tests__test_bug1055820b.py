...
# lib = "gc"
# dimension = "behavior"
# case = "gc_tests__test_bug1055820b"
# subject = "cpython.test_gc.GCTests.test_bug1055820b"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_gc.py::GCTests::test_bug1055820b
"""Auto-ported test: GCTests::test_bug1055820b (CPython 3.12 oracle)."""
...
for x in ouch:
    ...
    assert x == None
print("GCTests::test_bug1055820b: ok")
