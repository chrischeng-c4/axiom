...
# lib = "runpy"
# dimension = "behavior"
# case = "run_module_test_case__test_explicit_relative_import"
# subject = "cpython.test_runpy.RunModuleTestCase.test_explicit_relative_import"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_runpy.py::RunModuleTestCase::test_explicit_relative_import
"""Auto-ported test: RunModuleTestCase::test_explicit_relative_import (CPython 3.12 oracle)."""
...
for depth in range(2, 5):
    ...
    _check_relative_imports(depth)
print("RunModuleTestCase::test_explicit_relative_import: ok")
