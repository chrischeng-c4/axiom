...
# lib = "runpy"
# dimension = "behavior"
# case = "run_module_test_case__test_run_package_in_namespace_package"
# subject = "cpython.test_runpy.RunModuleTestCase.test_run_package_in_namespace_package"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_runpy.py::RunModuleTestCase::test_run_package_in_namespace_package
"""Auto-ported test: RunModuleTestCase::test_run_package_in_namespace_package (CPython 3.12 oracle)."""
...
for depth in range(1, 4):
    ...
    _check_package(depth, parent_namespaces=True)
print("RunModuleTestCase::test_run_package_in_namespace_package: ok")
