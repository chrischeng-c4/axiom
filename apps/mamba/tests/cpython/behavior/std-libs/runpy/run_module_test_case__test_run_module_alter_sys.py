...
# lib = "runpy"
# dimension = "behavior"
# case = "run_module_test_case__test_run_module_alter_sys"
# subject = "cpython.test_runpy.RunModuleTestCase.test_run_module_alter_sys"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_runpy.py::RunModuleTestCase::test_run_module_alter_sys
"""Auto-ported test: RunModuleTestCase::test_run_module_alter_sys (CPython 3.12 oracle)."""
...
for depth in range(4):
    ...
    _check_module(depth, alter_sys=True)
print("RunModuleTestCase::test_run_module_alter_sys: ok")
