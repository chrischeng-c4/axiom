...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_bufsize_is_none"
# subject = "cpython.test_subprocess.ProcessTestCase.test_bufsize_is_none"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_bufsize_is_none
"""Auto-ported test: ProcessTestCase::test_bufsize_is_none (CPython 3.12 oracle)."""
...
assert p.wait() == 0
print("ProcessTestCase::test_bufsize_is_none: ok")
