...
# lib = "subprocess"
# dimension = "behavior"
# case = "run_func_test_case__test_capture_output"
# subject = "cpython.test_subprocess.RunFuncTestCase.test_capture_output"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::RunFuncTestCase::test_capture_output
"""Auto-ported test: RunFuncTestCase::test_capture_output (CPython 3.12 oracle)."""
...
cp = run_python("import sys;sys.stdout.write('BDFL'); sys.stderr.write('FLUFL')", capture_output=True)

assert b'BDFL' in cp.stdout

assert b'FLUFL' in cp.stderr
print("RunFuncTestCase::test_capture_output: ok")
