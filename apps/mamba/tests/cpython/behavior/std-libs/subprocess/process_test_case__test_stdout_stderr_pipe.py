...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_stdout_stderr_pipe"
# subject = "cpython.test_subprocess.ProcessTestCase.test_stdout_stderr_pipe"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_stdout_stderr_pipe
"""Auto-ported test: ProcessTestCase::test_stdout_stderr_pipe (CPython 3.12 oracle)."""
...
with p:
    ...
    assert p.stdout.read() == b'appleorange'
print("ProcessTestCase::test_stdout_stderr_pipe: ok")
