...
# lib = "subprocess"
# dimension = "behavior"
# case = "win32_process_test_case__test_shell_sequence"
# subject = "cpython.test_subprocess.Win32ProcessTestCase.test_shell_sequence"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::Win32ProcessTestCase::test_shell_sequence
"""Auto-ported test: Win32ProcessTestCase::test_shell_sequence (CPython 3.12 oracle)."""
...
with p:
    ...
    assert b'physalis' in p.stdout.read()
print("Win32ProcessTestCase::test_shell_sequence: ok")
