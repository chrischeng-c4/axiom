...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_communicate_returns"
# subject = "cpython.test_subprocess.ProcessTestCase.test_communicate_returns"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_communicate_returns
"""Auto-ported test: ProcessTestCase::test_communicate_returns (CPython 3.12 oracle)."""
...
assert stderr == None
print("ProcessTestCase::test_communicate_returns: ok")
