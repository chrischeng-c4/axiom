...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_bytes_executable"
# subject = "cpython.test_subprocess.ProcessTestCase.test_bytes_executable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_bytes_executable
"""Auto-ported test: ProcessTestCase::test_bytes_executable (CPython 3.12 oracle)."""
...
_assert_python([doesnotexist, '-c'], executable=os.fsencode(sys.executable))
print("ProcessTestCase::test_bytes_executable: ok")
