...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_communicate_stdout"
# subject = "cpython.test_subprocess.ProcessTestCase.test_communicate_stdout"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_communicate_stdout
"""Auto-ported test: ProcessTestCase::test_communicate_stdout (CPython 3.12 oracle)."""
...
assert stdout == b'pineapple'

assert stderr == None
print("ProcessTestCase::test_communicate_stdout: ok")
