...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_communicate"
# subject = "cpython.test_subprocess.ProcessTestCase.test_communicate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_communicate
"""Auto-ported test: ProcessTestCase::test_communicate (CPython 3.12 oracle)."""
...
assert stdout == b'banana'

assert stderr == b'pineapple'
print("ProcessTestCase::test_communicate: ok")
