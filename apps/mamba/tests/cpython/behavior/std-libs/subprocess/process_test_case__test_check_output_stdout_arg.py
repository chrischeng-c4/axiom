...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_check_output_stdout_arg"
# subject = "cpython.test_subprocess.ProcessTestCase.test_check_output_stdout_arg"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_check_output_stdout_arg
"""Auto-ported test: ProcessTestCase::test_check_output_stdout_arg (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('Expected ValueError when stdout arg supplied.')
...
print("ProcessTestCase::test_check_output_stdout_arg: ok")
