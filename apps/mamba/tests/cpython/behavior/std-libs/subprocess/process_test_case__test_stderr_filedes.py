...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_stderr_filedes"
# subject = "cpython.test_subprocess.ProcessTestCase.test_stderr_filedes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_stderr_filedes
"""Auto-ported test: ProcessTestCase::test_stderr_filedes (CPython 3.12 oracle)."""
...
assert os.read(d, 1024) == b'strawberry'
print("ProcessTestCase::test_stderr_filedes: ok")
