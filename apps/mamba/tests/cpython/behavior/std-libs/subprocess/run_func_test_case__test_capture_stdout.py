...
# lib = "subprocess"
# dimension = "behavior"
# case = "run_func_test_case__test_capture_stdout"
# subject = "cpython.test_subprocess.RunFuncTestCase.test_capture_stdout"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::RunFuncTestCase::test_capture_stdout
"""Auto-ported test: RunFuncTestCase::test_capture_stdout (CPython 3.12 oracle)."""
...
cp = run_python("print('BDFL')", stdout=subprocess.PIPE)

assert b'BDFL' in cp.stdout
print("RunFuncTestCase::test_capture_stdout: ok")
