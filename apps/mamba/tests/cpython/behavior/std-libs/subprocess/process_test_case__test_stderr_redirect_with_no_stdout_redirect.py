...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_stderr_redirect_with_no_stdout_redirect"
# subject = "cpython.test_subprocess.ProcessTestCase.test_stderr_redirect_with_no_stdout_redirect"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_stderr_redirect_with_no_stdout_redirect
"""Auto-ported test: ProcessTestCase::test_stderr_redirect_with_no_stdout_redirect (CPython 3.12 oracle)."""
...
assert p.returncode == 0
print("ProcessTestCase::test_stderr_redirect_with_no_stdout_redirect: ok")
