...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_universal_newlines_communicate_stdin"
# subject = "cpython.test_subprocess.ProcessTestCase.test_universal_newlines_communicate_stdin"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_universal_newlines_communicate_stdin
"""Auto-ported test: ProcessTestCase::test_universal_newlines_communicate_stdin (CPython 3.12 oracle)."""
...
assert p.returncode == 0
print("ProcessTestCase::test_universal_newlines_communicate_stdin: ok")
