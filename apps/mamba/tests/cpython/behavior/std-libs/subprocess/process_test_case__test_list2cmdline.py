...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_list2cmdline"
# subject = "cpython.test_subprocess.ProcessTestCase.test_list2cmdline"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_list2cmdline
"""Auto-ported test: ProcessTestCase::test_list2cmdline (CPython 3.12 oracle)."""
...
assert subprocess.list2cmdline(['ab"c', '\\', 'd']) == 'ab\\"c \\ d'

assert subprocess.list2cmdline(['ab"c', ' \\', 'd']) == 'ab\\"c " \\\\" d'

assert subprocess.list2cmdline(['a\\\\\\b', 'de fg', 'h']) == 'a\\\\\\b "de fg" h'

assert subprocess.list2cmdline(['a\\"b', 'c', 'd']) == 'a\\\\\\"b c d'

assert subprocess.list2cmdline(['a\\\\b c', 'd', 'e']) == '"a\\\\b c" d e'

assert subprocess.list2cmdline(['a\\\\b\\ c', 'd', 'e']) == '"a\\\\b\\ c" d e'

assert subprocess.list2cmdline(['ab', '']) == 'ab ""'
print("ProcessTestCase::test_list2cmdline: ok")
