...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_communicate_timeout"
# subject = "cpython.test_subprocess.ProcessTestCase.test_communicate_timeout"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_communicate_timeout
"""Auto-ported test: ProcessTestCase::test_communicate_timeout (CPython 3.12 oracle)."""
...
try:
    p.communicate('banana', timeout=0.3)
...
assert stderr.encode() == b'pineapple\npear\n'
print("ProcessTestCase::test_communicate_timeout: ok")
