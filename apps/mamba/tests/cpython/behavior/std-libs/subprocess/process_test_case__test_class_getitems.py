...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_class_getitems"
# subject = "cpython.test_subprocess.ProcessTestCase.test_class_getitems"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_class_getitems
"""Auto-ported test: ProcessTestCase::test_class_getitems (CPython 3.12 oracle)."""
...
assert isinstance(subprocess.Popen[bytes], types.GenericAlias)

assert isinstance(subprocess.CompletedProcess[str], types.GenericAlias)
print("ProcessTestCase::test_class_getitems: ok")
