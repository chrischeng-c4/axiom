...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_wait_timeout"
# subject = "cpython.test_subprocess.ProcessTestCase.test_wait_timeout"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_wait_timeout
"""Auto-ported test: ProcessTestCase::test_wait_timeout (CPython 3.12 oracle)."""
...
assert '0.0001' in str(c.exception)

assert p.wait(timeout=support.SHORT_TIMEOUT) == 0
print("ProcessTestCase::test_wait_timeout: ok")
