...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_stdout_stderr_file"
# subject = "cpython.test_subprocess.ProcessTestCase.test_stdout_stderr_file"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_stdout_stderr_file
"""Auto-ported test: ProcessTestCase::test_stdout_stderr_file (CPython 3.12 oracle)."""
...
assert tf.read() == b'appleorange'
print("ProcessTestCase::test_stdout_stderr_file: ok")
