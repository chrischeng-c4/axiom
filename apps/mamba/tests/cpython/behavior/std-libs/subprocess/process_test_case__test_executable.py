...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_executable"
# subject = "cpython.test_subprocess.ProcessTestCase.test_executable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_executable
"""Auto-ported test: ProcessTestCase::test_executable (CPython 3.12 oracle)."""
...
_assert_python([doesnotexist, '-c'], executable=sys.executable)
print("ProcessTestCase::test_executable: ok")
