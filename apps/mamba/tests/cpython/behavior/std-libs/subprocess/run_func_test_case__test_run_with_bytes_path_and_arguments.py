...
# lib = "subprocess"
# dimension = "behavior"
# case = "run_func_test_case__test_run_with_bytes_path_and_arguments"
# subject = "cpython.test_subprocess.RunFuncTestCase.test_run_with_bytes_path_and_arguments"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::RunFuncTestCase::test_run_with_bytes_path_and_arguments
"""Auto-ported test: RunFuncTestCase::test_run_with_bytes_path_and_arguments (CPython 3.12 oracle)."""
...
assert res.returncode == 57
print("RunFuncTestCase::test_run_with_bytes_path_and_arguments: ok")
