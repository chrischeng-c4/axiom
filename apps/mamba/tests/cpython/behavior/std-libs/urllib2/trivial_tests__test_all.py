...
# lib = "urllib2"
# dimension = "behavior"
# case = "trivial_tests__test_all"
# subject = "cpython.test_urllib2.TrivialTests.test___all__"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::TrivialTests::test___all__
"""Auto-ported test: TrivialTests::test___all__ (CPython 3.12 oracle)."""
...
for module in ('request', 'response', 'parse', 'error', 'robotparser'):
    ...
    if module == 'request' and os.name == 'nt':
        ...
        assert u.__module__ == 'nturl2path'

        assert p.__module__ == 'nturl2path'
    for k, v in context.items():

        assert v.__module__ == 'urllib.%s' % module
print("TrivialTests::test___all__: ok")
