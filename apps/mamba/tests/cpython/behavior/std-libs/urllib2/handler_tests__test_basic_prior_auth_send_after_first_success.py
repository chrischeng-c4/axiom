...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_basic_prior_auth_send_after_first_success"
# subject = "cpython.test_urllib2.HandlerTests.test_basic_prior_auth_send_after_first_success"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_basic_prior_auth_send_after_first_success
"""Auto-ported test: HandlerTests::test_basic_prior_auth_send_after_first_success (CPython 3.12 oracle)."""
...
assert not http_handler.has_auth_header
opener = OpenerDirector()
opener.add_handler(auth_prior_handler)
opener.add_handler(http_handler)
opener.open(request_url)
...
print("HandlerTests::test_basic_prior_auth_send_after_first_success: ok")
