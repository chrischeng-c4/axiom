...
# lib = "urllib2"
# dimension = "behavior"
# case = "request_hdrs_tests__test_password_manager_default_port"
# subject = "cpython.test_urllib2.RequestHdrsTests.test_password_manager_default_port"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::RequestHdrsTests::test_password_manager_default_port
"""Auto-ported test: RequestHdrsTests::test_password_manager_default_port (CPython 3.12 oracle)."""
...
assert find_user_pass('f', 'g.example.com:100') == (None, None)

assert find_user_pass('f', 'g.example.com:80') == ('10', 'j')

assert find_user_pass('f', 'g.example.com') == (None, None)

assert find_user_pass('f', 'http://g.example.com:100') == (None, None)

assert find_user_pass('f', 'http://g.example.com:80') == ('10', 'j')

assert find_user_pass('f', 'http://g.example.com') == ('10', 'j')

assert find_user_pass('g', 'h.example.com') == ('11', 'k')

assert find_user_pass('g', 'h.example.com:80') == ('11', 'k')

assert find_user_pass('g', 'http://h.example.com:80') == ('11', 'k')

assert find_user_pass('h', 'i.example.com') == (None, None)

assert find_user_pass('h', 'i.example.com:80') == ('12', 'l')

assert find_user_pass('h', 'http://i.example.com:80') == ('12', 'l')

assert find_user_pass('i', 'j.example.com') == ('13', 'm')

assert find_user_pass('i', 'j.example.com:80') == (None, None)

assert find_user_pass('i', 'http://j.example.com') == ('13', 'm')

assert find_user_pass('i', 'http://j.example.com:80') == (None, None)
print("RequestHdrsTests::test_password_manager_default_port: ok")
