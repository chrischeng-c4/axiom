...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_http_handler_global_debuglevel"
# subject = "cpython.test_urllib2.HandlerTests.test_http_handler_global_debuglevel"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_http_handler_global_debuglevel
"""Auto-ported test: HandlerTests::test_http_handler_global_debuglevel (CPython 3.12 oracle)."""
...
with mock.patch.object(http.client.HTTPConnection, 'debuglevel', 6):
    ...
    assert h._debuglevel == 6
print("HandlerTests::test_http_handler_global_debuglevel: ok")
