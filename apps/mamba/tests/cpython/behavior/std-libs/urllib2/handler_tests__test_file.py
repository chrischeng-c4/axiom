...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_file"
# subject = "cpython.test_urllib2.HandlerTests.test_file"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_file
"""Auto-ported test: HandlerTests::test_file (CPython 3.12 oracle)."""
...
for url, ftp in [('file://ftp.example.com//foo.txt', False), ('file://ftp.example.com///foo.txt', False), ('file://ftp.example.com/foo.txt', False), ('file://somehost//foo/something.txt', False), ('file://localhost//foo/something.txt', False)]:
    ...
    assert (req.type == 'ftp') == ftp
print("HandlerTests::test_file: ok")
