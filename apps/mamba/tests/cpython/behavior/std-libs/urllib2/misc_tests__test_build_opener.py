...
# lib = "urllib2"
# dimension = "behavior"
# case = "misc_tests__test_build_opener"
# subject = "cpython.test_urllib2.MiscTests.test_build_opener"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::MiscTests::test_build_opener
"""Auto-ported test: MiscTests::test_build_opener (CPython 3.12 oracle)."""
...
# --- test body ---
def opener_has_handler(opener, handler_class):

    assert any((h.__class__ == handler_class for h in opener.handlers))
...
opener_has_handler(o, FooHandler)
opener_has_handler(o, BarHandler)
o = build_opener(FooHandler, BarHandler())
opener_has_handler(o, FooHandler)
opener_has_handler(o, BarHandler)
o = build_opener(MyHTTPHandler)
opener_has_handler(o, MyHTTPHandler)
o = build_opener()
opener_has_handler(o, urllib.request.HTTPHandler)
...
opener_has_handler(o, MyHTTPHandler)
opener_has_handler(o, MyOtherHTTPHandler)
print("MiscTests::test_build_opener: ok")
