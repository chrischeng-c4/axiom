...
# lib = "urllib2"
# dimension = "behavior"
# case = "opener_director_tests__test_raise"
# subject = "cpython.test_urllib2.OpenerDirectorTests.test_raise"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::OpenerDirectorTests::test_raise
"""Auto-ported test: OpenerDirectorTests::test_raise (CPython 3.12 oracle)."""
...
assert o.calls == [(handlers[0], 'http_open', (req,), {})]
print("OpenerDirectorTests::test_raise: ok")
