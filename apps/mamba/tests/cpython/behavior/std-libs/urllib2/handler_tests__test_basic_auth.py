...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_basic_auth"
# subject = "cpython.test_urllib2.HandlerTests.test_basic_auth"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_basic_auth
"""Auto-ported test: HandlerTests::test_basic_auth (CPython 3.12 oracle)."""
...
for realm_str in (f'Basic realm="{realm}"', f"Basic realm='{realm}'", f'Basic realm="{realm}", charset="UTF-8"', f'{basic}, {basic2}', f'{basic}, {other_no_realm}', f'{other_no_realm}, {basic}', f'{basic}, {digest}', f'{digest}, {basic}'):
    ...
    check_basic_auth(headers, realm)
...
for challenges in ([basic, basic2], [basic, digest], [digest, basic]):
    ...
    check_basic_auth(headers, realm)
print("HandlerTests::test_basic_auth: ok")
