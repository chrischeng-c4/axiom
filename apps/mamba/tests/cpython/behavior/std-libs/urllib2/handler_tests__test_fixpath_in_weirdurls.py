...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_fixpath_in_weirdurls"
# subject = "cpython.test_urllib2.HandlerTests.test_fixpath_in_weirdurls"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_fixpath_in_weirdurls
"""Auto-ported test: HandlerTests::test_fixpath_in_weirdurls (CPython 3.12 oracle)."""
...
assert newreq.host == 'www.python.org'

assert newreq.selector == '/?getspam'
...
assert newreq.selector == ''
print("HandlerTests::test_fixpath_in_weirdurls: ok")
