...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_cookie_redirect"
# subject = "cpython.test_urllib2.HandlerTests.test_cookie_redirect"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_cookie_redirect
"""Auto-ported test: HandlerTests::test_cookie_redirect (CPython 3.12 oracle)."""
...
assert not hh.req.has_header('Cookie')
print("HandlerTests::test_cookie_redirect: ok")
