...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_errors"
# subject = "cpython.test_urllib2.HandlerTests.test_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_errors
"""Auto-ported test: HandlerTests::test_errors (CPython 3.12 oracle)."""
...
assert h.http_response(req, r) is None

assert o.proto == 'http'

assert o.args == (req, r, 502, 'Bad gateway', {})
print("HandlerTests::test_errors: ok")
