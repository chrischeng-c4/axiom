...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_basic_and_digest_auth_handlers"
# subject = "cpython.test_urllib2.HandlerTests.test_basic_and_digest_auth_handlers"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_basic_and_digest_auth_handlers
"""Auto-ported test: HandlerTests::test_basic_and_digest_auth_handlers (CPython 3.12 oracle)."""
...
opener.add_handler(http_handler)
_test_basic_auth(opener, basic_handler, 'Authorization', realm, http_handler, password_manager, 'http://acme.example.com/protected', 'http://acme.example.com/protected')

assert opener.recorded == ['digest', 'basic'] * 2
print("HandlerTests::test_basic_and_digest_auth_handlers: ok")
