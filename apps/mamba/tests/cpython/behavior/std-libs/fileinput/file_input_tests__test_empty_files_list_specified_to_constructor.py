...
# lib = "fileinput"
# dimension = "behavior"
# case = "file_input_tests__test_empty_files_list_specified_to_constructor"
# subject = "cpython.test_fileinput.FileInputTests.test_empty_files_list_specified_to_constructor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::FileInputTests::test_empty_files_list_specified_to_constructor
"""Auto-ported test: FileInputTests::test_empty_files_list_specified_to_constructor (CPython 3.12 oracle)."""
...
with FileInput(files=[], encoding='utf-8') as fi:
    ...
    assert fi._files == ('-',)
print("FileInputTests::test_empty_files_list_specified_to_constructor: ok")
