...
# lib = "fileinput"
# dimension = "behavior"
# case = "file_input_tests__test_nextfile_oserror_deleting_backup"
# subject = "cpython.test_fileinput.FileInputTests.test_nextfile_oserror_deleting_backup"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::FileInputTests::test_nextfile_oserror_deleting_backup
"""Auto-ported test: FileInputTests::test_nextfile_oserror_deleting_backup (CPython 3.12 oracle)."""
...
assert os_unlink_replacement.invoked
print("FileInputTests::test_nextfile_oserror_deleting_backup: ok")
