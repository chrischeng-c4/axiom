...
# lib = "fileinput"
# dimension = "behavior"
# case = "file_input_tests__test_readline_buffering"
# subject = "cpython.test_fileinput.FileInputTests.test_readline_buffering"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::FileInputTests::test_readline_buffering
"""Auto-ported test: FileInputTests::test_readline_buffering (CPython 3.12 oracle)."""
...
with FileInput(files=['line1\nline2', 'line3\n'], openhook=src.openhook) as fi:
    ...
    assert src.linesread == []

    assert fi.readline() == 'line1\n'

    assert src.linesread == ['line1\n']

    assert fi.readline() == 'line2'

    assert src.linesread == ['line2']

    assert fi.readline() == 'line3\n'

    assert src.linesread == ['', 'line3\n']
    ...
    assert src.linesread == []
print("FileInputTests::test_readline_buffering: ok")
