...
# lib = "fileinput"
# dimension = "behavior"
# case = "file_input_tests__test_zero_byte_files"
# subject = "cpython.test_fileinput.FileInputTests.test_zero_byte_files"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::FileInputTests::test_zero_byte_files
"""Auto-ported test: FileInputTests::test_zero_byte_files (CPython 3.12 oracle)."""
...
t1 = writeTmp('')
t2 = writeTmp('')
t3 = writeTmp('The only line there is.\n')
t4 = writeTmp('')
fi = FileInput(files=(t1, t2, t3, t4), encoding='utf-8')
line = fi.readline()

assert line == 'The only line there is.\n'

assert fi.lineno() == 1

assert fi.filelineno() == 1

assert fi.filename() == t3
line = fi.readline()
...
assert fi.filelineno() == 0

assert fi.filename() == t4
fi.close()
print("FileInputTests::test_zero_byte_files: ok")
