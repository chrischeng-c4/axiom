...
# lib = "fileinput"
# dimension = "behavior"
# case = "test_fileinput_input__test_state_is_not_none_and_state_file_is_not_none"
# subject = "cpython.test_fileinput.Test_fileinput_input.test_state_is_not_None_and_state_file_is_not_None"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::Test_fileinput_input::test_state_is_not_None_and_state_file_is_not_None
"""Auto-ported test: Test_fileinput_input::test_state_is_not_None_and_state_file_is_not_None (CPython 3.12 oracle)."""
...
assert ('input() already active',) == cm.exception.args

assert instance is fileinput._state
print("Test_fileinput_input::test_state_is_not_None_and_state_file_is_not_None: ok")
