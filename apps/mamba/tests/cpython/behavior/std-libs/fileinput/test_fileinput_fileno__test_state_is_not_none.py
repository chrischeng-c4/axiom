...
# lib = "fileinput"
# dimension = "behavior"
# case = "test_fileinput_fileno__test_state_is_not_none"
# subject = "cpython.test_fileinput.Test_fileinput_fileno.test_state_is_not_None"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::Test_fileinput_fileno::test_state_is_not_None
"""Auto-ported test: Test_fileinput_fileno::test_state_is_not_None (CPython 3.12 oracle)."""
...
assertExactlyOneInvocation(instance, 'fileno')

assert retval is fileno_retval

assert fileinput._state is instance
print("Test_fileinput_fileno::test_state_is_not_None: ok")
