...
# lib = "fileinput"
# dimension = "behavior"
# case = "test_fileinput_isstdin__test_state_is_not_none"
# subject = "cpython.test_fileinput.Test_fileinput_isstdin.test_state_is_not_None"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::Test_fileinput_isstdin::test_state_is_not_None
"""Auto-ported test: Test_fileinput_isstdin::test_state_is_not_None (CPython 3.12 oracle)."""
...
assertExactlyOneInvocation(instance, 'isstdin')

assert retval is isstdin_retval

assert fileinput._state is instance
print("Test_fileinput_isstdin::test_state_is_not_None: ok")
