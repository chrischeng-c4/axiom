...
# lib = "fileinput"
# dimension = "behavior"
# case = "test_hook_compressed__test_binary_mode_encoding"
# subject = "cpython.test_fileinput.Test_hook_compressed.test_binary_mode_encoding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::Test_hook_compressed::test_binary_mode_encoding
"""Auto-ported test: Test_hook_compressed::test_binary_mode_encoding (CPython 3.12 oracle)."""
...
do_test_use_builtin_open_binary('abcd', 'rb')
print("Test_hook_compressed::test_binary_mode_encoding: ok")
