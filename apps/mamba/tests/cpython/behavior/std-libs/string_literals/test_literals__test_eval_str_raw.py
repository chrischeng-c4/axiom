...
# lib = "string_literals"
# dimension = "behavior"
# case = "test_literals__test_eval_str_raw"
# subject = "cpython.test_string_literals.TestLiterals.test_eval_str_raw"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_string_literals.py::TestLiterals::test_eval_str_raw
"""Auto-ported test: TestLiterals::test_eval_str_raw (CPython 3.12 oracle)."""
...
assert eval(" r'\\x01' ") == '\\' + 'x01'

assert eval(" r'\x01' ") == chr(1)

assert eval(" r'\\x81' ") == '\\' + 'x81'

assert eval(" r'\x81' ") == chr(129)

assert eval(" r'\\u1881' ") == '\\' + 'u1881'

assert eval(" r'ᢁ' ") == chr(6273)

assert eval(" r'\\U0001d120' ") == '\\' + 'U0001d120'

assert eval(" r'𝄠' ") == chr(119072)
print("TestLiterals::test_eval_str_raw: ok")
