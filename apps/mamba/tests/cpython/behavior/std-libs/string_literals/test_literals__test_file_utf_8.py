...
# lib = "string_literals"
# dimension = "behavior"
# case = "test_literals__test_file_utf_8"
# subject = "cpython.test_string_literals.TestLiterals.test_file_utf_8"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_string_literals.py::TestLiterals::test_file_utf_8
"""Auto-ported test: TestLiterals::test_file_utf_8 (CPython 3.12 oracle)."""
...
# --- test body ---
def check_encoding(encoding, extra=''):
    modname = 'xx_' + encoding.replace('-', '_')
    fn = os.path.join(self_tmpdir, modname + '.py')
...
check_encoding('utf-8', extra)
print("TestLiterals::test_file_utf_8: ok")
