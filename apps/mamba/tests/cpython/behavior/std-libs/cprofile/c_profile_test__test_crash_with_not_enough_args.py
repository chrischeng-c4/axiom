...
# lib = "cprofile"
# dimension = "behavior"
# case = "c_profile_test__test_crash_with_not_enough_args"
# subject = "cpython.test_cprofile.CProfileTest.test_crash_with_not_enough_args"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cprofile.py::CProfileTest::test_crash_with_not_enough_args
"""Auto-ported test: CProfileTest::test_crash_with_not_enough_args (CPython 3.12 oracle)."""
...
for profile in [_lsprof.Profiler(), cProfile.Profile()]:
    for method in ['_pystart_callback', '_pyreturn_callback', '_ccall_callback', '_creturn_callback']:
        ...
        try:
            ...
            pass
print("CProfileTest::test_crash_with_not_enough_args: ok")
