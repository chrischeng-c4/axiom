...
# lib = "binop"
# dimension = "behavior"
# case = "rat_test_case__test_mul"
# subject = "cpython.test_binop.RatTestCase.test_mul"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_binop.py::RatTestCase::test_mul
"""Auto-ported test: RatTestCase::test_mul (CPython 3.12 oracle)."""
...
assert Rat(2, 3) * Rat(5, 7) == Rat(10, 21)

assert Rat(10, 3) * 3 == 10

assert 3 * Rat(10, 3) == 10

assert Rat(10, 5) * 0.5 == 1.0

assert 0.5 * Rat(10, 5) == 1.0
print("RatTestCase::test_mul: ok")
