...
# lib = "sunau"
# dimension = "behavior"
# case = "sunau_low_level_test__test_read_wrong_encoding"
# subject = "cpython.test_sunau.SunauLowLevelTest.test_read_wrong_encoding"
# kind = "semantic"
# xfail = "auto-ported CPython test; mamba promotion pending"
# mem_carveout = ""
# source = "Lib/test/test_sunau.py"
# status = "filled"
# ///
# mamba-xfail: auto-ported CPython test; mamba promotion pending
# Auto-ported from CPython 3.12 test_sunau.py::SunauLowLevelTest::test_read_wrong_encoding
"""Auto-ported test: SunauLowLevelTest::test_read_wrong_encoding (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('expected sunau.Error')
except sunau.Error as _aR_e:
    import re as _re_aR
    assert _re_aR.search('encoding not \\(yet\\) supported', str(_aR_e))
print("SunauLowLevelTest::test_read_wrong_encoding: ok")
