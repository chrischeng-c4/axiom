...
# lib = "fcntl"
# dimension = "behavior"
# case = "test_fcntl__test_fcntl_bad_file_overflow"
# subject = "cpython.test_fcntl.TestFcntl.test_fcntl_bad_file_overflow"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fcntl.py::TestFcntl::test_fcntl_bad_file_overflow
"""Auto-ported test: TestFcntl::test_fcntl_bad_file_overflow (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("TestFcntl::test_fcntl_bad_file_overflow: ok")
