...
# lib = "shutil"
# dimension = "behavior"
# case = "test_move__test_destinsrc_false_negative"
# subject = "cpython.test_shutil.TestMove.test_destinsrc_false_negative"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestMove::test_destinsrc_false_negative
"""Auto-ported test: TestMove::test_destinsrc_false_negative (CPython 3.12 oracle)."""
...
try:
    for src, dst in [('srcdir', 'srcdir/dest')]:
        ...
        assert shutil._destinsrc(src, dst)
finally:
    os_helper.rmtree(TESTFN)
print("TestMove::test_destinsrc_false_negative: ok")
