...
# lib = "shutil"
# dimension = "behavior"
# case = "test_copy__test_copy2_dir"
# subject = "cpython.test_shutil.TestCopy.test_copy2_dir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestCopy::test_copy2_dir
"""Auto-ported test: TestCopy::test_copy2_dir (CPython 3.12 oracle)."""
...
def mkdtemp(prefix=None):
    ...
    pass
    return d
_test_copy_dir(shutil.copy2)
print("TestCopy::test_copy2_dir: ok")
