...
# lib = "shutil"
# dimension = "behavior"
# case = "test_archives__test_make_tarfile_in_curdir"
# subject = "cpython.test_shutil.TestArchives.test_make_tarfile_in_curdir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestArchives::test_make_tarfile_in_curdir
"""Auto-ported test: TestArchives::test_make_tarfile_in_curdir (CPython 3.12 oracle)."""
...
with os_helper.change_cwd(root_dir), no_chdir:
    ...
    assert make_archive('test', 'tar') == 'test.tar'

    assert os.path.isfile('test.tar')
print("TestArchives::test_make_tarfile_in_curdir: ok")
