...
# lib = "shutil"
# dimension = "behavior"
# case = "test_move__test_move_dir_to_dir"
# subject = "cpython.test_shutil.TestMove.test_move_dir_to_dir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestMove::test_move_dir_to_dir
"""Auto-ported test: TestMove::test_move_dir_to_dir (CPython 3.12 oracle)."""
...
_check_move_dir(self_src_dir, self_dst_dir, os.path.join(self_dst_dir, os.path.basename(self_src_dir)))
print("TestMove::test_move_dir_to_dir: ok")
