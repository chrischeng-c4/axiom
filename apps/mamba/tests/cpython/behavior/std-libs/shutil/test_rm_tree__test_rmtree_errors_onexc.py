...
# lib = "shutil"
# dimension = "behavior"
# case = "test_rm_tree__test_rmtree_errors_onexc"
# subject = "cpython.test_shutil.TestRmTree.test_rmtree_errors_onexc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestRmTree::test_rmtree_errors_onexc
"""Auto-ported test: TestRmTree::test_rmtree_errors_onexc (CPython 3.12 oracle)."""
...
assert isinstance(errors[0][2], NotADirectoryError)

assert errors[0][2].filename == filename

assert errors[1][0] is os.rmdir

assert errors[1][1] == filename

assert isinstance(errors[1][2], NotADirectoryError)

assert errors[1][2].filename == filename
print("TestRmTree::test_rmtree_errors_onexc: ok")
