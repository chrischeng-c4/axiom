...
# lib = "shutil"
# dimension = "behavior"
# case = "test_move__test_move_dir_caseinsensitive"
# subject = "cpython.test_shutil.TestMove.test_move_dir_caseinsensitive"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestMove::test_move_dir_caseinsensitive
"""Auto-ported test: TestMove::test_move_dir_caseinsensitive (CPython 3.12 oracle)."""
...
self_src_dir = mkdtemp()
dst_dir = os.path.join(os.path.dirname(self_src_dir), os.path.basename(self_src_dir).upper())

assert self_src_dir != dst_dir
try:
    shutil.move(self_src_dir, dst_dir)

    assert os.path.isdir(dst_dir)
finally:
    os.rmdir(dst_dir)
print("TestMove::test_move_dir_caseinsensitive: ok")
