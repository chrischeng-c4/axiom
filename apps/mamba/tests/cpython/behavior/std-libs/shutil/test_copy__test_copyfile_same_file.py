...
# lib = "shutil"
# dimension = "behavior"
# case = "test_copy__test_copyfile_same_file"
# subject = "cpython.test_shutil.TestCopy.test_copyfile_same_file"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestCopy::test_copyfile_same_file
"""Auto-ported test: TestCopy::test_copyfile_same_file (CPython 3.12 oracle)."""
...
try:
    shutil.copyfile(src_file, src_file)
    raise AssertionError('expected SameFileError')
...
assert read_file(src_file) == 'foo'
print("TestCopy::test_copyfile_same_file: ok")
