...
# lib = "shutil"
# dimension = "behavior"
# case = "test_archives__test_unpack_archive_bztar"
# subject = "cpython.test_shutil.TestArchives.test_unpack_archive_bztar"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestArchives::test_unpack_archive_bztar
"""Auto-ported test: TestArchives::test_unpack_archive_bztar (CPython 3.12 oracle)."""
...
def mkdtemp(prefix=None):
    ...
    pass
    return d
check_unpack_tarball('bztar')
print("TestArchives::test_unpack_archive_bztar: ok")
