...
# lib = "shutil"
# dimension = "behavior"
# case = "test_copy_file__test_w_source_open_fails"
# subject = "cpython.test_shutil.TestCopyFile.test_w_source_open_fails"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestCopyFile::test_w_source_open_fails
"""Auto-ported test: TestCopyFile::test_w_source_open_fails (CPython 3.12 oracle)."""
...
with support.swap_attr(shutil, 'open', _open):
    try:
        ...
        pass
print("TestCopyFile::test_w_source_open_fails: ok")
