...
# lib = "shutil"
# dimension = "behavior"
# case = "public_api_tests__test_module_all_attribute"
# subject = "cpython.test_shutil.PublicAPITests.test_module_all_attribute"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::PublicAPITests::test_module_all_attribute
"""Auto-ported test: PublicAPITests::test_module_all_attribute (CPython 3.12 oracle)."""
...
assert set(shutil.__all__) == set(target_api)
print("PublicAPITests::test_module_all_attribute: ok")
