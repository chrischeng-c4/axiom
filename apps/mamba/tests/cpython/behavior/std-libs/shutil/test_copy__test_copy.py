...
# lib = "shutil"
# dimension = "behavior"
# case = "test_copy__test_copy"
# subject = "cpython.test_shutil.TestCopy.test_copy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestCopy::test_copy
"""Auto-ported test: TestCopy::test_copy (CPython 3.12 oracle)."""
...
def mkdtemp(prefix=None):
    ...
    pass
    return d
file1, file2 = _copy_file(shutil.copy)

assert os.path.exists(file2)

assert os.stat(file1).st_mode == os.stat(file2).st_mode
print("TestCopy::test_copy: ok")
