...
# lib = "shutil"
# dimension = "behavior"
# case = "test_move__test_existing_file_inside_dest_dir"
# subject = "cpython.test_shutil.TestMove.test_existing_file_inside_dest_dir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestMove::test_existing_file_inside_dest_dir
"""Auto-ported test: TestMove::test_existing_file_inside_dest_dir (CPython 3.12 oracle)."""
...
create_file(self_dst_file)

try:
    shutil.move(self_src_file, self_dst_dir)
    raise AssertionError('expected shutil.Error')
except shutil.Error:
    pass
print("TestMove::test_existing_file_inside_dest_dir: ok")
