...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_slash0_constructor"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testSlash0Constructor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testSlash0Constructor
"""Auto-ported test: IpaddrUnitTest::testSlash0Constructor (CPython 3.12 oracle)."""
...
print("IpaddrUnitTest::testSlash0Constructor: ok")
