...
# lib = "ipaddress"
# dimension = "behavior"
# case = "comparison_tests__test_mixed_type_ordering"
# subject = "cpython.test_ipaddress.ComparisonTests.test_mixed_type_ordering"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::ComparisonTests::test_mixed_type_ordering
"""Auto-ported test: ComparisonTests::test_mixed_type_ordering (CPython 3.12 oracle)."""
...
for lhs in objects_with_scoped:
    for rhs in objects_with_scoped:
        ...
        try:
            ...
            pass
print("ComparisonTests::test_mixed_type_ordering: ok")
