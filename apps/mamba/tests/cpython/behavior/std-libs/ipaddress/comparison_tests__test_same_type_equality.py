...
# lib = "ipaddress"
# dimension = "behavior"
# case = "comparison_tests__test_same_type_equality"
# subject = "cpython.test_ipaddress.ComparisonTests.test_same_type_equality"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::ComparisonTests::test_same_type_equality
"""Auto-ported test: ComparisonTests::test_same_type_equality (CPython 3.12 oracle)."""
...
for obj in objects_with_scoped:
    ...
    assert obj >= obj
print("ComparisonTests::test_same_type_equality: ok")
