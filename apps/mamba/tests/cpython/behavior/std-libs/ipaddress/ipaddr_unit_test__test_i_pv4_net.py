...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_i_pv4_net"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testIPv4Net"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testIPv4Net
"""Auto-ported test: IpaddrUnitTest::testIPv4Net (CPython 3.12 oracle)."""
...
print("IpaddrUnitTest::testIPv4Net: ok")
