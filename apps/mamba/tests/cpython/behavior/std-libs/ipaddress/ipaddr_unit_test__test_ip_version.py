...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_ip_version"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testIPVersion"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testIPVersion
"""Auto-ported test: IpaddrUnitTest::testIPVersion (CPython 3.12 oracle)."""
...
assert self_ipv4_address.version == 4

assert self_ipv6_address.version == 6

assert self_ipv6_scoped_address.version == 6

assert self_ipv6_with_ipv4_part.version == 6
print("IpaddrUnitTest::testIPVersion: ok")
