...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_get_subnets"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testGetSubnets"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testGetSubnets
"""Auto-ported test: IpaddrUnitTest::testGetSubnets (CPython 3.12 oracle)."""
...
assert list(self_ipv4_network.subnets())[0].prefixlen == 25

assert str(list(self_ipv4_network.subnets())[0].network_address) == '1.2.3.0'

assert str(list(self_ipv4_network.subnets())[1].network_address) == '1.2.3.128'

assert list(self_ipv6_network.subnets())[0].prefixlen == 65

assert list(self_ipv6_scoped_network.subnets())[0].prefixlen == 65
print("IpaddrUnitTest::testGetSubnets: ok")
