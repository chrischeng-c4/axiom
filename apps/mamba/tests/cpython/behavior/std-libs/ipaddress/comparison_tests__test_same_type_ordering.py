...
# lib = "ipaddress"
# dimension = "behavior"
# case = "comparison_tests__test_same_type_ordering"
# subject = "cpython.test_ipaddress.ComparisonTests.test_same_type_ordering"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::ComparisonTests::test_same_type_ordering
"""Auto-ported test: ComparisonTests::test_same_type_ordering (CPython 3.12 oracle)."""
...
for lhs, rhs in ((v4addr, v4addr2), (v4net, v4net2), (v4intf, v4intf2), (v6addr, v6addr2), (v6net, v6net2), (v6intf, v6intf2), (v6addr_scoped, v6addr2_scoped), (v6net_scoped, v6net2_scoped), (v6intf_scoped, v6intf2_scoped)):
    ...
    assert not rhs <= lhs
print("ComparisonTests::test_same_type_ordering: ok")
