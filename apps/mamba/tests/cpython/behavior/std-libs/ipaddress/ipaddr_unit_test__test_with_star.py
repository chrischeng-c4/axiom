...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_with_star"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testWithStar"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testWithStar
"""Auto-ported test: IpaddrUnitTest::testWithStar (CPython 3.12 oracle)."""
...
assert self_ipv4_interface.with_prefixlen == '1.2.3.4/24'

assert self_ipv4_interface.with_netmask == '1.2.3.4/255.255.255.0'

assert self_ipv4_interface.with_hostmask == '1.2.3.4/0.0.0.255'

assert self_ipv6_interface.with_prefixlen == '2001:658:22a:cafe:200::1/64'

assert self_ipv6_interface.with_netmask == '2001:658:22a:cafe:200::1/ffff:ffff:ffff:ffff::'

assert self_ipv6_interface.with_hostmask == '2001:658:22a:cafe:200::1/::ffff:ffff:ffff:ffff'
print("IpaddrUnitTest::testWithStar: ok")
