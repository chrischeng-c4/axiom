...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_subnet_fails_for_negative_cidr_diff"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testSubnetFailsForNegativeCidrDiff"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testSubnetFailsForNegativeCidrDiff
"""Auto-ported test: IpaddrUnitTest::testSubnetFailsForNegativeCidrDiff (CPython 3.12 oracle)."""
...
try:
    list(self_ipv4_interface.network.subnets(-1))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    list(self_ipv4_network.subnets(-1))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    list(self_ipv6_interface.network.subnets(-1))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    list(self_ipv6_network.subnets(-1))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    list(self_ipv6_scoped_interface.network.subnets(-1))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    list(self_ipv6_scoped_network.subnets(-1))
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("IpaddrUnitTest::testSubnetFailsForNegativeCidrDiff: ok")
