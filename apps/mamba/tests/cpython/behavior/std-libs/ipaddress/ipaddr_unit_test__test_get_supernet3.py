...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_get_supernet3"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testGetSupernet3"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testGetSupernet3
"""Auto-ported test: IpaddrUnitTest::testGetSupernet3 (CPython 3.12 oracle)."""
...
assert self_ipv4_network.supernet(3).prefixlen == 21

assert str(self_ipv4_network.supernet(3).network_address) == '1.2.0.0'

assert self_ipv6_network.supernet(3).prefixlen == 61

assert str(self_ipv6_network.supernet(3).network_address) == '2001:658:22a:caf8::'

assert self_ipv6_scoped_network.supernet(3).prefixlen == 61

assert str(self_ipv6_scoped_network.supernet(3).network_address) == '2001:658:22a:caf8::'
print("IpaddrUnitTest::testGetSupernet3: ok")
