...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_get_scope_id"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testGetScopeId"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testGetScopeId
"""Auto-ported test: IpaddrUnitTest::testGetScopeId (CPython 3.12 oracle)."""
...
assert self_ipv6_address.scope_id == None

assert str(self_ipv6_scoped_address.scope_id) == 'scope'

assert self_ipv6_interface.scope_id == None

assert str(self_ipv6_scoped_interface.scope_id) == 'scope'

assert self_ipv6_network.network_address.scope_id == None

assert str(self_ipv6_scoped_network.network_address.scope_id) == 'scope'
print("IpaddrUnitTest::testGetScopeId: ok")
