...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_network_v6_hash_collisions"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testNetworkV6HashCollisions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testNetworkV6HashCollisions
"""Auto-ported test: IpaddrUnitTest::testNetworkV6HashCollisions (CPython 3.12 oracle)."""
...
assert ipaddress.IPv6Network('fe80::/64').__hash__() != ipaddress.IPv6Network('fe80::ffff:ffff:ffff:0/112').__hash__()

assert ipaddress.IPv4Network('10.0.0.0/8').__hash__() != ipaddress.IPv6Network('ffff:ffff:ffff:ffff:ffff:ffff:aff:0/112').__hash__()
print("IpaddrUnitTest::testNetworkV6HashCollisions: ok")
