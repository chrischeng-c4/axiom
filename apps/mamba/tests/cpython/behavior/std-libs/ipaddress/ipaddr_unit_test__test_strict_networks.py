...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_strict_networks"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testStrictNetworks"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testStrictNetworks
"""Auto-ported test: IpaddrUnitTest::testStrictNetworks (CPython 3.12 oracle)."""
...
try:
    ipaddress.ip_network('::1%scope/120')
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("IpaddrUnitTest::testStrictNetworks: ok")
