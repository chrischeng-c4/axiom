...
# lib = "bdb"
# dimension = "behavior"
# case = "breakpoint_test_case__test_load_bps_from_previous_bdb_instance"
# subject = "cpython.test_bdb.BreakpointTestCase.test_load_bps_from_previous_Bdb_instance"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bdb.py::BreakpointTestCase::test_load_bps_from_previous_Bdb_instance
"""Auto-ported test: BreakpointTestCase::test_load_bps_from_previous_Bdb_instance (CPython 3.12 oracle)."""
...
assert db1.get_all_breaks() == {fname: [1]}
db2 = Bdb()
...
assert db2.get_all_breaks() == {fname: [1, 2, 3, 4]}
db2.clear_break(__file__, 1)

assert db1.get_all_breaks() == {fname: [1]}

assert db2.get_all_breaks() == {fname: [2, 3, 4]}
db3 = Bdb()
...
assert db3.get_all_breaks() == {fname: [2, 3, 4]}
db2.clear_break(__file__, 2)

assert db1.get_all_breaks() == {fname: [1]}

assert db2.get_all_breaks() == {fname: [3, 4]}
...
assert db4.get_all_breaks() == {fname: [3, 4, 5]}
reset_Breakpoint()
db5 = Bdb()
...
assert db5.get_all_breaks() == {fname: [6]}
print("BreakpointTestCase::test_load_bps_from_previous_Bdb_instance: ok")
