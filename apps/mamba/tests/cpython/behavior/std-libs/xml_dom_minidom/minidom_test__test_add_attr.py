...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_add_attr"
# subject = "cpython.test_minidom.MinidomTest.testAddAttr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testAddAttr
"""Auto-ported test: MinidomTest::testAddAttr (CPython 3.12 oracle)."""
...
confirm(len(child.attributes) == 2)
dom.unlink()
print("MinidomTest::testAddAttr: ok")
