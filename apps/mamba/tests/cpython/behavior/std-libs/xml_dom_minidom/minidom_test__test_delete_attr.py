...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_delete_attr"
# subject = "cpython.test_minidom.MinidomTest.testDeleteAttr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testDeleteAttr
"""Auto-ported test: MinidomTest::testDeleteAttr (CPython 3.12 oracle)."""
...
confirm(len(child.attributes) == 0)
dom.unlink()
print("MinidomTest::testDeleteAttr: ok")
