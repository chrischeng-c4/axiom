...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_schema_type"
# subject = "cpython.test_minidom.MinidomTest.testSchemaType"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testSchemaType
"""Auto-ported test: MinidomTest::testSchemaType (CPython 3.12 oracle)."""
...
t = elem.schemaType
confirm(t.name is None and t.namespace == xml.dom.EMPTY_NAMESPACE)
names = 'id notid text enum ref refs ent ents nm nms'.split()
for name in names:
    a = elem.getAttributeNode(name)
    t = a.schemaType
    confirm(hasattr(t, 'name') and t.namespace == xml.dom.EMPTY_NAMESPACE)
print("MinidomTest::testSchemaType: ok")
