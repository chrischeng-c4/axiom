...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_change_attr"
# subject = "cpython.test_minidom.MinidomTest.testChangeAttr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testChangeAttr
"""Auto-ported test: MinidomTest::testChangeAttr (CPython 3.12 oracle)."""
...
confirm(len(el.attributes) == 1 and el.attributes['spam'].value == 'bam' and (el.attributes['spam'].nodeValue == 'bam') and (el.getAttribute('spam') == 'bam') and el.getAttributeNode('spam').isId)
el.attributes['spam'] = 'ham'
confirm(len(el.attributes) == 1 and el.attributes['spam'].value == 'ham' and (el.attributes['spam'].nodeValue == 'ham') and (el.getAttribute('spam') == 'ham') and el.attributes['spam'].isId)
el.setAttribute('spam2', 'bam')
confirm(len(el.attributes) == 2 and el.attributes['spam'].value == 'ham' and (el.attributes['spam'].nodeValue == 'ham') and (el.getAttribute('spam') == 'ham') and (el.attributes['spam2'].value == 'bam') and (el.attributes['spam2'].nodeValue == 'bam') and (el.getAttribute('spam2') == 'bam'))
el.attributes['spam2'] = 'bam2'
confirm(len(el.attributes) == 2 and el.attributes['spam'].value == 'ham' and (el.attributes['spam'].nodeValue == 'ham') and (el.getAttribute('spam') == 'ham') and (el.attributes['spam2'].value == 'bam2') and (el.attributes['spam2'].nodeValue == 'bam2') and (el.getAttribute('spam2') == 'bam2'))
dom.unlink()
print("MinidomTest::testChangeAttr: ok")
