...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_import_document_type_shallow"
# subject = "cpython.test_minidom.MinidomTest.testImportDocumentTypeShallow"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testImportDocumentTypeShallow
"""Auto-ported test: MinidomTest::testImportDocumentTypeShallow (CPython 3.12 oracle)."""
...
try:
    target.importNode(src.doctype, 0)
    raise AssertionError('expected xml.dom.NotSupportedErr')
except xml.dom.NotSupportedErr:
    pass
print("MinidomTest::testImportDocumentTypeShallow: ok")
