...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_siblings"
# subject = "cpython.test_minidom.MinidomTest.testSiblings"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testSiblings
"""Auto-ported test: MinidomTest::testSiblings (CPython 3.12 oracle)."""
...
confirm(pi.nextSibling is text and pi.previousSibling is None and (text.nextSibling is elm) and (text.previousSibling is pi) and (elm.nextSibling is None) and (elm.previousSibling is text), 'testSiblings')
doc.unlink()
print("MinidomTest::testSiblings: ok")
