...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_normalize_delete_with_prev_sibling"
# subject = "cpython.test_minidom.MinidomTest.testNormalizeDeleteWithPrevSibling"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testNormalizeDeleteWithPrevSibling
"""Auto-ported test: MinidomTest::testNormalizeDeleteWithPrevSibling (CPython 3.12 oracle)."""
...
confirm(len(root.childNodes) == 2 and root.childNodes.length == 2, 'testNormalizeDeleteWithPrevSibling -- preparation')
doc.normalize()
confirm(len(root.childNodes) == 1 and root.childNodes.length == 1 and (root.firstChild.data == 'first') and (root.firstChild is root.lastChild) and (root.firstChild.nextSibling is None) and (root.firstChild.previousSibling is None), 'testNormalizeDeleteWithPrevSibling -- result')
doc.unlink()
print("MinidomTest::testNormalizeDeleteWithPrevSibling: ok")
