...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_get_attribute_ns"
# subject = "cpython.test_minidom.MinidomTest.testGetAttributeNS"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testGetAttributeNS
"""Auto-ported test: MinidomTest::testGetAttributeNS (CPython 3.12 oracle)."""
...
assert child.getAttributeNS('http://www.w3.org', 'python') == 'http://www.python.org'

assert child.getAttributeNS('http://www.w3.org', 'other') == ''
child2 = child.appendChild(dom.createElement('abc'))

assert child2.getAttributeNS('http://www.python.org', 'missing') == ''
print("MinidomTest::testGetAttributeNS: ok")
