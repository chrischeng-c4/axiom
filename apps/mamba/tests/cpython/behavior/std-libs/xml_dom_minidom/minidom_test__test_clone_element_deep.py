...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_clone_element_deep"
# subject = "cpython.test_minidom.MinidomTest.testCloneElementDeep"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testCloneElementDeep
"""Auto-ported test: MinidomTest::testCloneElementDeep (CPython 3.12 oracle)."""
...
confirm(len(clone.childNodes) == 1 and clone.childNodes.length == 1 and (clone.parentNode is None) and (clone.toxml() == '<doc attr="value"><foo/></doc>'), 'testCloneElementDeep')
dom.unlink()
print("MinidomTest::testCloneElementDeep: ok")
