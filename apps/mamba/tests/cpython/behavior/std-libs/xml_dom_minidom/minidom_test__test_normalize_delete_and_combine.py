...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_normalize_delete_and_combine"
# subject = "cpython.test_minidom.MinidomTest.testNormalizeDeleteAndCombine"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testNormalizeDeleteAndCombine
"""Auto-ported test: MinidomTest::testNormalizeDeleteAndCombine (CPython 3.12 oracle)."""
...
root.appendChild(doc.createTextNode(''))
confirm(len(root.childNodes) == 5 and root.childNodes.length == 5, 'testNormalizeDeleteAndCombine -- preparation')
doc.normalize()
confirm(len(root.childNodes) == 1 and root.childNodes.length == 1 and (root.firstChild is root.lastChild) and (root.firstChild.data == 'secondfourth') and (root.firstChild.previousSibling is None) and (root.firstChild.nextSibling is None), 'testNormalizeDeleteAndCombine -- result')
doc.unlink()
print("MinidomTest::testNormalizeDeleteAndCombine: ok")
