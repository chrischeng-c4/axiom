...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_encodings"
# subject = "cpython.test_minidom.MinidomTest.testEncodings"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testEncodings
"""Auto-ported test: MinidomTest::testEncodings (CPython 3.12 oracle)."""
...
assert doc.toxml() == '<?xml version="1.0" ?><foo>€</foo>'

assert doc.toxml('utf-8') == b'<?xml version="1.0" encoding="utf-8"?><foo>\xe2\x82\xac</foo>'

assert doc.toxml('iso-8859-15') == b'<?xml version="1.0" encoding="iso-8859-15"?><foo>\xa4</foo>'

assert doc.toxml('us-ascii') == b'<?xml version="1.0" encoding="us-ascii"?><foo>&#8364;</foo>'

assert doc.toxml('utf-16') == '<?xml version="1.0" encoding="utf-16"?><foo>€</foo>'.encode('utf-16')
try:
    parseString(b'<fran\xe7ais>Comment \xe7a va ? Tr\xe8s bien ?</fran\xe7ais>')
    raise AssertionError('expected (UnicodeDecodeError, ExpatError)')
except (UnicodeDecodeError, ExpatError):
    pass
doc.unlink()
print("MinidomTest::testEncodings: ok")
