...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_replace_whole_text"
# subject = "cpython.test_minidom.MinidomTest.testReplaceWholeText"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testReplaceWholeText
"""Auto-ported test: MinidomTest::testReplaceWholeText (CPython 3.12 oracle)."""
...
checkWholeText(text2, 'd')
confirm(text is None and len(elem.childNodes) == 2)
print("MinidomTest::testReplaceWholeText: ok")
