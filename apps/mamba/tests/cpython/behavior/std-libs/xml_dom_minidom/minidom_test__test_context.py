...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_context"
# subject = "cpython.test_minidom.MinidomTest.testContext"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testContext
"""Auto-ported test: MinidomTest::testContext (CPython 3.12 oracle)."""
...
with parse(tstfile) as dom:
    ...
    assert dom.childNodes

assert not dom.childNodes
print("MinidomTest::testContext: ok")
