...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_get_attribute"
# subject = "cpython.test_minidom.MinidomTest.testGetAttribute"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testGetAttribute
"""Auto-ported test: MinidomTest::testGetAttribute (CPython 3.12 oracle)."""
...
assert child.getAttribute('missing') == ''
print("MinidomTest::testGetAttribute: ok")
