...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_toprettyxml_with_adjacent_text_nodes"
# subject = "cpython.test_minidom.MinidomTest.test_toprettyxml_with_adjacent_text_nodes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::test_toprettyxml_with_adjacent_text_nodes
"""Auto-ported test: MinidomTest::test_toprettyxml_with_adjacent_text_nodes (CPython 3.12 oracle)."""
...
assert dom.toprettyxml() == decl + '<elem>\n\tTEXT\n\tTEXT\n</elem>\n'
print("MinidomTest::test_toprettyxml_with_adjacent_text_nodes: ok")
