...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_replace_child_fragment"
# subject = "cpython.test_minidom.MinidomTest.testReplaceChildFragment"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testReplaceChildFragment
"""Auto-ported test: MinidomTest::testReplaceChildFragment (CPython 3.12 oracle)."""
...
orig.unlink()
confirm(tuple(dom.documentElement.childNodes) == (c1, c2, c3), 'replaceChild(<fragment>)')
frag.unlink()
dom.unlink()
print("MinidomTest::testReplaceChildFragment: ok")
