...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_execute_param_sequence"
# subject = "cpython.test_dbapi.CursorTests.test_execute_param_sequence"
# kind = "semantic"
...
class L:
    ...
    def __getitem__(self, x):
        ...
        return 'foo'
self_cu.execute("insert into test(name) values ('foo')")
self_cu.execute('select name from test where name=?', L())
row = self_cu.fetchone()
assert row[0] == 'foo'

print("CursorTests::test_execute_param_sequence: ok")
