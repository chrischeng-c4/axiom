...
# lib = "dbapi"
# dimension = "behavior"
# case = "blob_tests__test_blob_read_at_offset"
# subject = "cpython.test_dbapi.BlobTests.test_blob_read_at_offset"
# kind = "semantic"
...
self_blob.seek(10)
assert self_blob.read(10) == self_data[10:20]

print("BlobTests::test_blob_read_at_offset: ok")
