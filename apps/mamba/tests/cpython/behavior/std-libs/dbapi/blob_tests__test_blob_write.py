...
# lib = "dbapi"
# dimension = "behavior"
# case = "blob_tests__test_blob_write"
# subject = "cpython.test_dbapi.BlobTests.test_blob_write"
# kind = "semantic"
...
self_blob.write(new_data)
row = self_cx.execute('select b from test').fetchone()
assert row[0] == new_data

print("BlobTests::test_blob_write: ok")
