...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_fetchmany_kw_arg"
# subject = "cpython.test_dbapi.CursorTests.test_fetchmany_kw_arg"
# kind = "semantic"
...
self_cu.execute('select name from test')
res = self_cu.fetchmany(size=100)
assert len(res) == 1

print("CursorTests::test_fetchmany_kw_arg: ok")
