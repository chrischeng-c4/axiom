...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_setoutputsize"
# subject = "cpython.test_dbapi.CursorTests.test_setoutputsize"
# kind = "semantic"
...
self_cu.setoutputsize(5, 0)

print("CursorTests::test_setoutputsize: ok")
