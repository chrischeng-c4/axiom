...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_rowcount_executemany"
# subject = "cpython.test_dbapi.CursorTests.test_rowcount_executemany"
# kind = "semantic"
...
self_cu.executemany('insert into test(name) values (?)', [(1,), (2,), (3,)])
assert self_cu.rowcount == 3

print("CursorTests::test_rowcount_executemany: ok")
