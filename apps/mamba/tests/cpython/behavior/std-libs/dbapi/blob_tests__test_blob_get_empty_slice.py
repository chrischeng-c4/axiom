...
# lib = "dbapi"
# dimension = "behavior"
# case = "blob_tests__test_blob_get_empty_slice"
# subject = "cpython.test_dbapi.BlobTests.test_blob_get_empty_slice"
# kind = "semantic"
...
assert self_blob[5:5] == b''

print("BlobTests::test_blob_get_empty_slice: ok")
