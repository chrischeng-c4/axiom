...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_execute_many_generator"
# subject = "cpython.test_dbapi.CursorTests.test_execute_many_generator"
# kind = "semantic"
...
def mygen():
    for i in range(5):
        yield (i,)
self_cu.executemany('insert into test(income) values (?)', mygen())

print("CursorTests::test_execute_many_generator: ok")
