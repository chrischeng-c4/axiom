...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_rowcount_vaccuum"
# subject = "cpython.test_dbapi.CursorTests.test_rowcount_vaccuum"
# kind = "semantic"
...
data = ((1,), (2,), (3,))
self_cu.executemany('insert into test(income) values(?)', data)
assert self_cu.rowcount == 3
self_cx.commit()
self_cu.execute('vacuum')
assert self_cu.rowcount == -1

print("CursorTests::test_rowcount_vaccuum: ok")
