...
# lib = "dbapi"
# dimension = "behavior"
# case = "blob_tests__test_blob_set_slice_with_skip"
# subject = "cpython.test_dbapi.BlobTests.test_blob_set_slice_with_skip"
# kind = "semantic"
...
self_blob[0:10:2] = b'12345'
actual = self_cx.execute('select b from test').fetchone()[0]
expected = b'1h2s3b4o5 ' + self_data[10:]
assert actual == expected

print("BlobTests::test_blob_set_slice_with_skip: ok")
