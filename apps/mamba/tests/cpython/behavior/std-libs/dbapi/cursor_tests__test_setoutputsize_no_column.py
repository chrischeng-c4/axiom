...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_setoutputsize_no_column"
# subject = "cpython.test_dbapi.CursorTests.test_setoutputsize_no_column"
# kind = "semantic"
...
self_cu.setoutputsize(42)

print("CursorTests::test_setoutputsize_no_column: ok")
