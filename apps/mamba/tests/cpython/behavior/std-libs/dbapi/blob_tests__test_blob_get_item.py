...
# lib = "dbapi"
# dimension = "behavior"
# case = "blob_tests__test_blob_get_item"
# subject = "cpython.test_dbapi.BlobTests.test_blob_get_item"
# kind = "semantic"
...
assert self_blob[5] == ord('b')
assert self_blob[6] == ord('l')
assert self_blob[7] == ord('o')
assert self_blob[8] == ord('b')
assert self_blob[-1] == ord('!')

print("BlobTests::test_blob_get_item: ok")
