...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_execute_many_sequence"
# subject = "cpython.test_dbapi.CursorTests.test_execute_many_sequence"
# kind = "semantic"
...
self_cu.executemany('insert into test(income) values (?)', [(x,) for x in range(100, 110)])

print("CursorTests::test_execute_many_sequence: ok")
