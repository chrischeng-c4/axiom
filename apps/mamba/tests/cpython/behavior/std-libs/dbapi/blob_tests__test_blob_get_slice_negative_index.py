...
# lib = "dbapi"
# dimension = "behavior"
# case = "blob_tests__test_blob_get_slice_negative_index"
# subject = "cpython.test_dbapi.BlobTests.test_blob_get_slice_negative_index"
# kind = "semantic"
...
assert self_blob[5:-5] == self_data[5:-5]

print("BlobTests::test_blob_get_slice_negative_index: ok")
