...
# lib = "dbapi"
# dimension = "behavior"
# case = "blob_tests__test_blob_is_a_blob"
# subject = "cpython.test_dbapi.BlobTests.test_blob_is_a_blob"
# kind = "semantic"
...
assert isinstance(self_blob, sqlite.Blob)

print("BlobTests::test_blob_is_a_blob: ok")
