...
# lib = "dbapi"
# dimension = "behavior"
# case = "blob_tests__test_blob_get_slice"
# subject = "cpython.test_dbapi.BlobTests.test_blob_get_slice"
# kind = "semantic"
...
assert self_blob[5:14] == b'blob data'

print("BlobTests::test_blob_get_slice: ok")
