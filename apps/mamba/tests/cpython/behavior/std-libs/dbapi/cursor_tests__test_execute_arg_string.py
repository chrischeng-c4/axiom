...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_execute_arg_string"
# subject = "cpython.test_dbapi.CursorTests.test_execute_arg_string"
# kind = "semantic"
...
self_cu.execute('insert into test(name) values (?)', ('Hugo',))

print("CursorTests::test_execute_arg_string: ok")
