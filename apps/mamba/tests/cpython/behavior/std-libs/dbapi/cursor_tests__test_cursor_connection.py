...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_cursor_connection"
# subject = "cpython.test_dbapi.CursorTests.test_cursor_connection"
# kind = "semantic"
...
assert self_cu.connection == self_cx

print("CursorTests::test_cursor_connection: ok")
