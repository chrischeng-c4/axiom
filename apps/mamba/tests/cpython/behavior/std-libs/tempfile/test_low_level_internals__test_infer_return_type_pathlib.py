...
# lib = "tempfile"
# dimension = "behavior"
# case = "test_low_level_internals__test_infer_return_type_pathlib"
# subject = "cpython.test_tempfile.TestLowLevelInternals.test_infer_return_type_pathlib"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tempfile.py::TestLowLevelInternals::test_infer_return_type_pathlib
"""Auto-ported test: TestLowLevelInternals::test_infer_return_type_pathlib (CPython 3.12 oracle)."""
...
assert str is tempfile._infer_return_type(os_helper.FakePath('/'))
print("TestLowLevelInternals::test_infer_return_type_pathlib: ok")
