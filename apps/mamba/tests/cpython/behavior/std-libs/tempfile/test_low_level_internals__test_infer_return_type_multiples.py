...
# lib = "tempfile"
# dimension = "behavior"
# case = "test_low_level_internals__test_infer_return_type_multiples"
# subject = "cpython.test_tempfile.TestLowLevelInternals.test_infer_return_type_multiples"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tempfile.py::TestLowLevelInternals::test_infer_return_type_multiples
"""Auto-ported test: TestLowLevelInternals::test_infer_return_type_multiples (CPython 3.12 oracle)."""
...
assert bytes is tempfile._infer_return_type(b'', b'')
try:
...
try:
    ...
    pass
print("TestLowLevelInternals::test_infer_return_type_multiples: ok")
