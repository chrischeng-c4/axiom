...
# lib = "profile"
# dimension = "behavior"
# case = "profile_test__test_runctx"
# subject = "cpython.test_profile.ProfileTest.test_runctx"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_profile.py::ProfileTest::test_runctx
"""Auto-ported test: ProfileTest::test_runctx (CPython 3.12 oracle)."""
...
with silent():
    profilermodule.runctx('testfunc()', globals(), locals())
profilermodule.runctx('testfunc()', globals(), locals(), filename=TESTFN)

assert os.path.exists(TESTFN)
print("ProfileTest::test_runctx: ok")
