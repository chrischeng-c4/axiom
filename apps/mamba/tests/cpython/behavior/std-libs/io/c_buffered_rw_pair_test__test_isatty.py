...
# lib = "io"
# dimension = "behavior"
# case = "c_buffered_rw_pair_test__test_isatty"
# subject = "cpython.test_io.CBufferedRWPairTest.test_isatty"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_io.py::CBufferedRWPairTest::test_isatty
"""Auto-ported test: CBufferedRWPairTest::test_isatty (CPython 3.12 oracle)."""
...
class SelectableIsAtty(MockRawIO):
    ...
    def isatty(self):
        return self._isatty
pair = tp(SelectableIsAtty(False), SelectableIsAtty(False))

assert not pair.isatty()
pair = tp(SelectableIsAtty(True), SelectableIsAtty(False))

assert pair.isatty()
pair = tp(SelectableIsAtty(False), SelectableIsAtty(True))

assert pair.isatty()
pair = tp(SelectableIsAtty(True), SelectableIsAtty(True))

assert pair.isatty()
print("CBufferedRWPairTest::test_isatty: ok")
