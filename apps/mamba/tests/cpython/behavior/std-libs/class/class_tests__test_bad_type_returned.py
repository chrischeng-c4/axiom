...
# lib = "class"
# dimension = "behavior"
# case = "class_tests__test_bad_type_returned"
# subject = "cpython.test_class.ClassTests.testBadTypeReturned"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_class.py::ClassTests::testBadTypeReturned
"""Auto-ported test: ClassTests::testBadTypeReturned (CPython 3.12 oracle)."""
...
for f in [float, complex, str, repr, bytes, bin, oct, hex, bool, index]:
    ...
    try:
        ...
        pass
print("ClassTests::testBadTypeReturned: ok")
