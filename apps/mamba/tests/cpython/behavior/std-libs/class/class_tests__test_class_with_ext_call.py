...
# lib = "class"
# dimension = "behavior"
# case = "class_tests__test_class_with_ext_call"
# subject = "cpython.test_class.ClassTests.testClassWithExtCall"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_class.py::ClassTests::testClassWithExtCall
"""Auto-ported test: ClassTests::testClassWithExtCall (CPython 3.12 oracle)."""
...
assert A == (tuple(range(8)), {'foo': 'bar'})
print("ClassTests::testClassWithExtCall: ok")
