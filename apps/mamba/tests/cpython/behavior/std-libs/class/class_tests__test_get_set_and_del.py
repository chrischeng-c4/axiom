...
# lib = "class"
# dimension = "behavior"
# case = "class_tests__test_get_set_and_del"
# subject = "cpython.test_class.ClassTests.testGetSetAndDel"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_class.py::ClassTests::testGetSetAndDel
"""Auto-ported test: ClassTests::testGetSetAndDel (CPython 3.12 oracle)."""
...
callLst[:] = []
testme.spam
assertCallStack([('__getattr__', (testme, 'spam'))])
callLst[:] = []
testme.eggs = 'spam, spam, spam and ham'
assertCallStack([('__setattr__', (testme, 'eggs', 'spam, spam, spam and ham'))])
callLst[:] = []
del testme.cardinal
assertCallStack([('__delattr__', (testme, 'cardinal'))])
print("ClassTests::testGetSetAndDel: ok")
