...
# lib = "class"
# dimension = "behavior"
# case = "class_tests__test_setattr_wrapper_name_intern"
# subject = "cpython.test_class.ClassTests.testSetattrWrapperNameIntern"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_class.py::ClassTests::testSetattrWrapperNameIntern
"""Auto-ported test: ClassTests::testSetattrWrapperNameIntern (CPython 3.12 oracle)."""
...
assert name is not '__add__'
type.__setattr__(A, name, add)

assert A() + 1 == 'summa'
name2 = str(b'__add__', 'ascii')

assert name2 is not '__add__'

assert name2 is not name
...
try:
    ...
    pass
print("ClassTests::testSetattrWrapperNameIntern: ok")
