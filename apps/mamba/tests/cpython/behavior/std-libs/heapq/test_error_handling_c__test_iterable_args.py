...
# lib = "heapq"
# dimension = "behavior"
# case = "test_error_handling_c__test_iterable_args"
# subject = "cpython.test_heapq.TestErrorHandlingC.test_iterable_args"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_heapq.py::TestErrorHandlingC::test_iterable_args
"""Auto-ported test: TestErrorHandlingC::test_iterable_args (CPython 3.12 oracle)."""
...
for f in (module.nlargest, module.nsmallest):
    for s in ('123', '', range(1000), (1, 1.2), range(2000, 2200, 5)):
        ...
        try:
            ...
            pass
print("TestErrorHandlingC::test_iterable_args: ok")
