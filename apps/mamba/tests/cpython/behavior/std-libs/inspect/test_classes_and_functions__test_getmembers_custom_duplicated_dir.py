...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_getmembers_custom_duplicated_dir"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_getmembers_custom_duplicated_dir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_getmembers_custom_duplicated_dir
"""Auto-ported test: TestClassesAndFunctions::test_getmembers_custom_duplicated_dir (CPython 3.12 oracle)."""
...
assert inspect.getmembers(dd) == [('attr', 1)]
print("TestClassesAndFunctions::test_getmembers_custom_duplicated_dir: ok")
