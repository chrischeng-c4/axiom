...
# lib = "inspect"
# dimension = "behavior"
# case = "test_retrieving_source_code__test_getfile_builtin_function_or_method"
# subject = "cpython.test_inspect.TestRetrievingSourceCode.test_getfile_builtin_function_or_method"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestRetrievingSourceCode::test_getfile_builtin_function_or_method
"""Auto-ported test: TestRetrievingSourceCode::test_getfile_builtin_function_or_method (CPython 3.12 oracle)."""
...
try:
    ...
    e_abs = _types_aR.SimpleNamespace(exception=_aR_e)

assert 'expected, got' in str(e_abs.exception)
try:
    inspect.getfile(list.append)
    raise AssertionError('expected TypeError')
except TypeError as _aR_e:
    import types as _types_aR
    e_append = _types_aR.SimpleNamespace(exception=_aR_e)

assert 'expected, got' in str(e_append.exception)
print("TestRetrievingSourceCode::test_getfile_builtin_function_or_method: ok")
