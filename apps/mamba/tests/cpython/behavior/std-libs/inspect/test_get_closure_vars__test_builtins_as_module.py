...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_closure_vars__test_builtins_as_module"
# subject = "cpython.test_inspect.TestGetClosureVars.test_builtins_as_module"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetClosureVars::test_builtins_as_module
"""Auto-ported test: TestGetClosureVars::test_builtins_as_module (CPython 3.12 oracle)."""
...
def _private_globals():
    ...
    exec(code, ns)
    return (ns['f'], ns)
f, ns = _private_globals()
ns['__builtins__'] = os
expected = inspect.ClosureVars({}, {}, {'path': os.path}, {'print'})

assert inspect.getclosurevars(f) == expected
print("TestGetClosureVars::test_builtins_as_module: ok")
