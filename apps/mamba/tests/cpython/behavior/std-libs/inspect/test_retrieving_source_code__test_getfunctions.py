...
# lib = "inspect"
# dimension = "behavior"
# case = "test_retrieving_source_code__test_getfunctions"
# subject = "cpython.test_inspect.TestRetrievingSourceCode.test_getfunctions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestRetrievingSourceCode::test_getfunctions
"""Auto-ported test: TestRetrievingSourceCode::test_getfunctions (CPython 3.12 oracle)."""
...
assert functions == [('after_closing', mod.after_closing), ('eggs', mod.eggs), ('lobbest', mod.lobbest), ('spam', mod.spam)]
print("TestRetrievingSourceCode::test_getfunctions: ok")
