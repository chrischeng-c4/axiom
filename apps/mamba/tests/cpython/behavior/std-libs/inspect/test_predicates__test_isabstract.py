...
# lib = "inspect"
# dimension = "behavior"
# case = "test_predicates__test_isabstract"
# subject = "cpython.test_inspect.TestPredicates.test_isabstract"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestPredicates::test_isabstract
"""Auto-ported test: TestPredicates::test_isabstract (CPython 3.12 oracle)."""
...
assert not inspect.isabstract(ClassExample)

assert not inspect.isabstract(a)

assert not inspect.isabstract(int)

assert not inspect.isabstract(5)
print("TestPredicates::test_isabstract: ok")
