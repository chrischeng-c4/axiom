...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_metaclass_dict_as_property"
# subject = "cpython.test_inspect.TestGetattrStatic.test_metaclass_dict_as_property"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_metaclass_dict_as_property
"""Auto-ported test: TestGetattrStatic::test_metaclass_dict_as_property (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(instance, 'spam') == 42

assert not Thing.executed
print("TestGetattrStatic::test_metaclass_dict_as_property: ok")
