...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_async_gen_state__test_easy_debugging"
# subject = "cpython.test_inspect.TestGetAsyncGenState.test_easy_debugging"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetAsyncGenState::test_easy_debugging
"""Auto-ported test: TestGetAsyncGenState::test_easy_debugging (CPython 3.12 oracle)."""
...
for name in names:
    ...
    assert name in str(state)
print("TestGetAsyncGenState::test_easy_debugging: ok")
