...
# lib = "inspect"
# dimension = "behavior"
# case = "test_format_annotation__test_typing_replacement"
# subject = "cpython.test_inspect.TestFormatAnnotation.test_typing_replacement"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestFormatAnnotation::test_typing_replacement
"""Auto-ported test: TestFormatAnnotation::test_typing_replacement (CPython 3.12 oracle)."""
...
assert inspect.formatannotation(ann) == 'Union[List[str], int]'

assert inspect.formatannotation(ann1) == 'Union[List[testModule.typing.A], int]'
print("TestFormatAnnotation::test_typing_replacement: ok")
