...
# lib = "inspect"
# dimension = "behavior"
# case = "test_oneliners__test_anonymous"
# subject = "cpython.test_inspect.TestOneliners.test_anonymous"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestOneliners::test_anonymous
"""Auto-ported test: TestOneliners::test_anonymous (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.anonymous, 55, 55)
print("TestOneliners::test_anonymous: ok")
