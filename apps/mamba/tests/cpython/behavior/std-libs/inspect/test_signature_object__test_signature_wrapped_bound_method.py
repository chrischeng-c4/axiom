...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_wrapped_bound_method"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_wrapped_bound_method"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_wrapped_bound_method
"""Auto-ported test: TestSignatureObject::test_signature_wrapped_bound_method (CPython 3.12 oracle)."""
...
assert signature(m1d) == ((('arg1', ..., ..., 'positional_or_keyword'), ('arg2', 1, ..., 'positional_or_keyword')), int)
print("TestSignatureObject::test_signature_wrapped_bound_method: ok")
