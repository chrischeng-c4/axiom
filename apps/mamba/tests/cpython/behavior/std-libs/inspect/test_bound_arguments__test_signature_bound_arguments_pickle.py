...
# lib = "inspect"
# dimension = "behavior"
# case = "test_bound_arguments__test_signature_bound_arguments_pickle"
# subject = "cpython.test_inspect.TestBoundArguments.test_signature_bound_arguments_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBoundArguments::test_signature_bound_arguments_pickle
"""Auto-ported test: TestBoundArguments::test_signature_bound_arguments_pickle (CPython 3.12 oracle)."""
...
for ver in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert ba == ba_pickled
print("TestBoundArguments::test_signature_bound_arguments_pickle: ok")
