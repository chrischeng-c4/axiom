...
# lib = "inspect"
# dimension = "behavior"
# case = "test_parameter_object__test_signature_parameter_implicit"
# subject = "cpython.test_inspect.TestParameterObject.test_signature_parameter_implicit"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestParameterObject::test_signature_parameter_implicit
"""Auto-ported test: TestParameterObject::test_signature_parameter_implicit (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('implicit arguments must be passed as positional or keyword arguments, not positional-only', str(_aR_e))
...
assert param.name == 'implicit0'
print("TestParameterObject::test_signature_parameter_implicit: ok")
