...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_one_liner_dedent_non_name"
# subject = "cpython.test_inspect.TestBuggyCases.test_one_liner_dedent_non_name"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_one_liner_dedent_non_name
"""Auto-ported test: TestBuggyCases::test_one_liner_dedent_non_name (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.cls82.func83, 83, 83)
print("TestBuggyCases::test_one_liner_dedent_non_name: ok")
