...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_staticmethod"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_staticmethod"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_staticmethod
"""Auto-ported test: TestSignatureObject::test_signature_on_staticmethod (CPython 3.12 oracle)."""
...
assert signature(meth) == ((('cls', ..., ..., 'positional_or_keyword'), ('arg', ..., ..., 'keyword_only')), ...)
meth = Test.foo

assert signature(meth) == ((('cls', ..., ..., 'positional_or_keyword'), ('arg', ..., ..., 'keyword_only')), ...)
print("TestSignatureObject::test_signature_on_staticmethod: ok")
