...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_lambdas"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_lambdas"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_lambdas
"""Auto-ported test: TestSignatureObject::test_signature_on_lambdas (CPython 3.12 oracle)."""
...
assert signature(lambda a=10: a) == ((('a', 10, ..., 'positional_or_keyword'),), ...)
print("TestSignatureObject::test_signature_on_lambdas: ok")
