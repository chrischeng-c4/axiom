...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_bind__test_signature_bind_just_kwargs"
# subject = "cpython.test_inspect.TestSignatureBind.test_signature_bind_just_kwargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureBind::test_signature_bind_just_kwargs
"""Auto-ported test: TestSignatureBind::test_signature_bind_just_kwargs (CPython 3.12 oracle)."""
...
assert call(test, foo='bar', spam='ham') == {'foo': 'bar', 'spam': 'ham'}
print("TestSignatureBind::test_signature_bind_just_kwargs: ok")
