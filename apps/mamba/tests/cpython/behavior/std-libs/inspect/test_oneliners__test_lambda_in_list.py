...
# lib = "inspect"
# dimension = "behavior"
# case = "test_oneliners__test_lambda_in_list"
# subject = "cpython.test_inspect.TestOneliners.test_lambda_in_list"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestOneliners::test_lambda_in_list
"""Auto-ported test: TestOneliners::test_lambda_in_list (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.a[1], 49, 49)
print("TestOneliners::test_lambda_in_list: ok")
