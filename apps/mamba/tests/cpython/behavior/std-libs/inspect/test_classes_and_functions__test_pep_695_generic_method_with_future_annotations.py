...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_pep_695_generic_method_with_future_annotations"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_pep_695_generic_method_with_future_annotations"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_pep_695_generic_method_with_future_annotations
"""Auto-ported test: TestClassesAndFunctions::test_pep_695_generic_method_with_future_annotations (CPython 3.12 oracle)."""
...
generic_method_annotations = inspect.get_annotations(ann_module695.D.generic_method, eval_str=True)
params = {param.__name__: param for param in ann_module695.D.generic_method.__type_params__}

assert generic_method_annotations == {'x': params['Foo'], 'y': params['Bar'], 'return': None}
print("TestClassesAndFunctions::test_pep_695_generic_method_with_future_annotations: ok")
