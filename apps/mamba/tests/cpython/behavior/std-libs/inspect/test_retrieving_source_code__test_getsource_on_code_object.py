...
# lib = "inspect"
# dimension = "behavior"
# case = "test_retrieving_source_code__test_getsource_on_code_object"
# subject = "cpython.test_inspect.TestRetrievingSourceCode.test_getsource_on_code_object"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestRetrievingSourceCode::test_getsource_on_code_object
"""Auto-ported test: TestRetrievingSourceCode::test_getsource_on_code_object (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod.eggs.__code__, 12, 18)
print("TestRetrievingSourceCode::test_getsource_on_code_object: ok")
