...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_class_definition_in_multiline_string_definition"
# subject = "cpython.test_inspect.TestBuggyCases.test_class_definition_in_multiline_string_definition"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_class_definition_in_multiline_string_definition
"""Auto-ported test: TestBuggyCases::test_class_definition_in_multiline_string_definition (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.cls149, 149, 152)
print("TestBuggyCases::test_class_definition_in_multiline_string_definition: ok")
