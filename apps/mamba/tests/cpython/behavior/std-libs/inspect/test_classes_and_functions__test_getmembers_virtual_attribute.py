...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_getmembers_virtual_attribute"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_getmembers_VirtualAttribute"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_getmembers_VirtualAttribute
"""Auto-ported test: TestClassesAndFunctions::test_getmembers_VirtualAttribute (CPython 3.12 oracle)."""
...
assert ('eggs', 'scrambled') in inspect.getmembers(A)

assert ('eggs', 'spam') in inspect.getmembers(A())
b = B()

assert ('__getattr__', b.__getattr__) in inspect.getmembers(b)
print("TestClassesAndFunctions::test_getmembers_VirtualAttribute: ok")
