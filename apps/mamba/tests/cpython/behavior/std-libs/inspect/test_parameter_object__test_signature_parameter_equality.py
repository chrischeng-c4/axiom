...
# lib = "inspect"
# dimension = "behavior"
# case = "test_parameter_object__test_signature_parameter_equality"
# subject = "cpython.test_inspect.TestParameterObject.test_signature_parameter_equality"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestParameterObject::test_signature_parameter_equality
"""Auto-ported test: TestParameterObject::test_signature_parameter_equality (CPython 3.12 oracle)."""
...
assert not p != ALWAYS_EQ

assert p == P('foo', default=42, kind=inspect.Parameter.KEYWORD_ONLY)

assert not p != P('foo', default=42, kind=inspect.Parameter.KEYWORD_ONLY)
print("TestParameterObject::test_signature_parameter_equality: ok")
