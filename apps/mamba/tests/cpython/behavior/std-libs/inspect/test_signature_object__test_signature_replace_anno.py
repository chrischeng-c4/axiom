...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_replace_anno"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_replace_anno"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_replace_anno
"""Auto-ported test: TestSignatureObject::test_signature_replace_anno (CPython 3.12 oracle)."""
...
assert sig.return_annotation is sig.empty
sig = sig.replace(return_annotation=42)

assert sig.return_annotation == 42

assert sig == inspect.signature(test)
print("TestSignatureObject::test_signature_replace_anno: ok")
