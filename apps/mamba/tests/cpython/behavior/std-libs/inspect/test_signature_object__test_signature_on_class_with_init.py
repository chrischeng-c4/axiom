...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_class_with_init"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_class_with_init"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_class_with_init
"""Auto-ported test: TestSignatureObject::test_signature_on_class_with_init (CPython 3.12 oracle)."""
...
assert signature(C) == ((('a', ..., ..., 'positional_or_keyword'),), ...)
print("TestSignatureObject::test_signature_on_class_with_init: ok")
