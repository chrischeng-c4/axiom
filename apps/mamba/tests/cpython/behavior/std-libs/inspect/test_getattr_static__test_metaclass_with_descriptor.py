...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_metaclass_with_descriptor"
# subject = "cpython.test_inspect.TestGetattrStatic.test_metaclass_with_descriptor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_metaclass_with_descriptor
"""Auto-ported test: TestGetattrStatic::test_metaclass_with_descriptor (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(Thing, 'd') == meta.__dict__['d']
print("TestGetattrStatic::test_metaclass_with_descriptor: ok")
