...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_classify_builtin_types"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_classify_builtin_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_classify_builtin_types
"""Auto-ported test: TestClassesAndFunctions::test_classify_builtin_types (CPython 3.12 oracle)."""
...
assert ('__new__', 'static method', bool) in attrs

assert ('from_bytes', 'class method', int) in attrs

assert ('to_bytes', 'method', int) in attrs

assert ('__add__', 'method', int) in attrs

assert ('__and__', 'method', bool) in attrs
print("TestClassesAndFunctions::test_classify_builtin_types: ok")
