...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_coroutine_state__test_suspended"
# subject = "cpython.test_inspect.TestGetCoroutineState.test_suspended"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetCoroutineState::test_suspended
"""Auto-ported test: TestGetCoroutineState::test_suspended (CPython 3.12 oracle)."""
...
assert _coroutinestate() == inspect.CORO_SUSPENDED
print("TestGetCoroutineState::test_suspended: ok")
