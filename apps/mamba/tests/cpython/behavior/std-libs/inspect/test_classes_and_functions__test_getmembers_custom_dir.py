...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_getmembers_custom_dir"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_getmembers_custom_dir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_getmembers_custom_dir
"""Auto-ported test: TestClassesAndFunctions::test_getmembers_custom_dir (CPython 3.12 oracle)."""
...
assert inspect.getmembers(cd) == [('attr', 5), ('method', cd.method)]

assert inspect.getmembers(cd, inspect.ismethod) == [('method', cd.method)]
print("TestClassesAndFunctions::test_getmembers_custom_dir: ok")
