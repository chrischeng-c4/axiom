...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_functionlike_class"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_functionlike_class"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_functionlike_class
"""Auto-ported test: TestSignatureObject::test_signature_functionlike_class (CPython 3.12 oracle)."""
...
assert str(inspect.signature(funclike)) == '(marker)'
print("TestSignatureObject::test_signature_functionlike_class: ok")
