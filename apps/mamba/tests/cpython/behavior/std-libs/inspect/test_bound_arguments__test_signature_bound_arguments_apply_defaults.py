...
# lib = "inspect"
# dimension = "behavior"
# case = "test_bound_arguments__test_signature_bound_arguments_apply_defaults"
# subject = "cpython.test_inspect.TestBoundArguments.test_signature_bound_arguments_apply_defaults"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBoundArguments::test_signature_bound_arguments_apply_defaults
"""Auto-ported test: TestBoundArguments::test_signature_bound_arguments_apply_defaults (CPython 3.12 oracle)."""
...
assert list(ba.arguments.items()) == [('a', 20), ('b', 1), ('args', ()), ('c', {}), ('kw', {})]
ba = sig.bind(10, 20, 30, d=1)
ba.apply_defaults()

assert list(ba.arguments.items()) == [('a', 10), ('b', 20), ('args', (30,)), ('c', {}), ('kw', {'d': 1})]
...
assert list(ba.arguments.items()) == [('a', 20)]
...
assert list(ba.arguments.items()) == []
...
assert list(ba.arguments.items()) == [('a', 'spam')]
print("TestBoundArguments::test_signature_bound_arguments_apply_defaults: ok")
