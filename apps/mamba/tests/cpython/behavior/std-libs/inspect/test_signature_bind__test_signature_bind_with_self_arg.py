...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_bind__test_signature_bind_with_self_arg"
# subject = "cpython.test_inspect.TestSignatureBind.test_signature_bind_with_self_arg"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureBind::test_signature_bind_with_self_arg
"""Auto-ported test: TestSignatureBind::test_signature_bind_with_self_arg (CPython 3.12 oracle)."""
...
assert ba.args == (1, 2, 3)
ba = sig.bind(1, self=2, b=3)

assert ba.args == (1, 2, 3)
print("TestSignatureBind::test_signature_bind_with_self_arg: ok")
