...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_coroutine_state__test_closed_after_immediate_exception"
# subject = "cpython.test_inspect.TestGetCoroutineState.test_closed_after_immediate_exception"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetCoroutineState::test_closed_after_immediate_exception
"""Auto-ported test: TestGetCoroutineState::test_closed_after_immediate_exception (CPython 3.12 oracle)."""
...
# --- test body ---
def _coroutinestate():
    return inspect.getcoroutinestate(self_coroutine)
...
self_coroutine = coroutine()
try:
    self_coroutine.throw(RuntimeError)
    raise AssertionError('expected RuntimeError')
except RuntimeError:
    pass

assert _coroutinestate() == inspect.CORO_CLOSED
print("TestGetCoroutineState::test_closed_after_immediate_exception: ok")
