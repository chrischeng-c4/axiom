...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_bind__test_signature_bind_args_and_kwargs"
# subject = "cpython.test_inspect.TestSignatureBind.test_signature_bind_args_and_kwargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureBind::test_signature_bind_args_and_kwargs
"""Auto-ported test: TestSignatureBind::test_signature_bind_args_and_kwargs (CPython 3.12 oracle)."""
...
assert call(test, 1, 2) == (1, 2, 3, {})

assert call(test, 1, 2, foo='bar', spam='ham') == (1, 2, 3, {'foo': 'bar', 'spam': 'ham'})

assert call(test, b=2, a=1, foo='bar', spam='ham') == (1, 2, 3, {'foo': 'bar', 'spam': 'ham'})

assert call(test, a=1, b=2, foo='bar', spam='ham') == (1, 2, 3, {'foo': 'bar', 'spam': 'ham'})

assert call(test, 1, b=2, foo='bar', spam='ham') == (1, 2, 3, {'foo': 'bar', 'spam': 'ham'})

assert call(test, 1, b=2, c=4, foo='bar', spam='ham') == (1, 2, 4, {'foo': 'bar', 'spam': 'ham'})

assert call(test, 1, 2, 4, foo='bar') == (1, 2, 4, {'foo': 'bar'})

assert call(test, c=5, a=4, b=3) == (4, 3, 5, {})
print("TestSignatureBind::test_signature_bind_args_and_kwargs: ok")
