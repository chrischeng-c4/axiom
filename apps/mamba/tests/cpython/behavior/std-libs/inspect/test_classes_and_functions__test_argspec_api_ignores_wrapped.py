...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_argspec_api_ignores_wrapped"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_argspec_api_ignores_wrapped"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_argspec_api_ignores_wrapped
"""Auto-ported test: TestClassesAndFunctions::test_argspec_api_ignores_wrapped (CPython 3.12 oracle)."""
...
def ham(x, y):
    pass
assertFullArgSpecEquals(ham, ['x', 'y'])
assertFullArgSpecEquals(functools.partial(ham), ['x', 'y'])
print("TestClassesAndFunctions::test_argspec_api_ignores_wrapped: ok")
