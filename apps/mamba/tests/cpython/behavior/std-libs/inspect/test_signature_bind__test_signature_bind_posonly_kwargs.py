...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_bind__test_signature_bind_posonly_kwargs"
# subject = "cpython.test_inspect.TestSignatureBind.test_signature_bind_posonly_kwargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureBind::test_signature_bind_posonly_kwargs
"""Auto-ported test: TestSignatureBind::test_signature_bind_posonly_kwargs (CPython 3.12 oracle)."""
...
assert result.kwargs == {'bar': 'keyword'}

assert ('bar', 'pos-only') in result.arguments.items()
print("TestSignatureBind::test_signature_bind_posonly_kwargs: ok")
