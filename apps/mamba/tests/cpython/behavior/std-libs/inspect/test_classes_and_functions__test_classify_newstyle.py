...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_classify_newstyle"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_classify_newstyle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_classify_newstyle
"""Auto-ported test: TestClassesAndFunctions::test_classify_newstyle (CPython 3.12 oracle)."""
...
assert ('__new__', 'static method', object) in attrs

assert ('__init__', 'method', object) in attrs

assert ('s', 'static method', A) in attrs

assert ('c', 'class method', A) in attrs

assert ('p', 'property', A) in attrs

assert ('m', 'method', A) in attrs

assert ('m1', 'method', A) in attrs

assert ('datablob', 'data', A) in attrs

assert ('md', 'method', A) in attrs

assert ('dd', 'data', A) in attrs
...
assert ('c', 'method', C) in attrs

assert ('p', 'property', A) in attrs

assert ('m', 'method', C) in attrs
...
assert ('dd', 'data', A) in attrs
print("TestClassesAndFunctions::test_classify_newstyle: ok")
