...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_getmembers_static"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_getmembers_static"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_getmembers_static
"""Auto-ported test: TestClassesAndFunctions::test_getmembers_static (CPython 3.12 oracle)."""
...
assert ('name', inspect.getattr_static(a, 'name')) in instance_members

assert ('eggs', inspect.getattr_static(a, 'eggs')) in instance_members

assert ('name', inspect.getattr_static(A, 'name')) in class_members

assert ('eggs', inspect.getattr_static(A, 'eggs')) in class_members
print("TestClassesAndFunctions::test_getmembers_static: ok")
