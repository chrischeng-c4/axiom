...
# lib = "inspect"
# dimension = "behavior"
# case = "test_parameter_object__test_signature_parameter_hashable"
# subject = "cpython.test_inspect.TestParameterObject.test_signature_parameter_hashable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestParameterObject::test_signature_parameter_hashable
"""Auto-ported test: TestParameterObject::test_signature_parameter_hashable (CPython 3.12 oracle)."""
...
assert hash(foo) == hash(P('foo', kind=P.POSITIONAL_ONLY))

assert hash(foo) != hash(P('foo', kind=P.POSITIONAL_ONLY, default=42))

assert hash(foo) != hash(foo.replace(kind=P.VAR_POSITIONAL))
print("TestParameterObject::test_signature_parameter_hashable: ok")
