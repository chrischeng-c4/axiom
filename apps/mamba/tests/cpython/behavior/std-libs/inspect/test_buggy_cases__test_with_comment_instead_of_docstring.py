...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_with_comment_instead_of_docstring"
# subject = "cpython.test_inspect.TestBuggyCases.test_with_comment_instead_of_docstring"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_with_comment_instead_of_docstring
"""Auto-ported test: TestBuggyCases::test_with_comment_instead_of_docstring (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.func88, 88, 90)
print("TestBuggyCases::test_with_comment_instead_of_docstring: ok")
