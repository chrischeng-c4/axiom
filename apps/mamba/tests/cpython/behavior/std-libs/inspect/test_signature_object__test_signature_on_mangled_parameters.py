...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_mangled_parameters"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_mangled_parameters"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_mangled_parameters
"""Auto-ported test: TestSignatureObject::test_signature_on_mangled_parameters (CPython 3.12 oracle)."""
...
assert signature(Spam.foo) == ((('self', ..., ..., 'positional_or_keyword'), ('_Spam__p1', 2, 1, 'positional_or_keyword'), ('_Spam__p2', 3, 2, 'keyword_only')), ...)

assert signature(Spam.foo) == signature(Ham.foo)
print("TestSignatureObject::test_signature_on_mangled_parameters: ok")
