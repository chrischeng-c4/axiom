...
# lib = "inspect"
# dimension = "behavior"
# case = "test_main__test_details"
# subject = "cpython.test_inspect.TestMain.test_details"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestMain::test_details
"""Auto-ported test: TestMain::test_details (CPython 3.12 oracle)."""
...
assert module.__spec__.name in output

assert module.__name__ in output

assert module.__spec__.origin in output

assert module.__file__ in output

assert module.__spec__.cached in output

assert module.__cached__ in output

assert err == b''
print("TestMain::test_details: ok")
