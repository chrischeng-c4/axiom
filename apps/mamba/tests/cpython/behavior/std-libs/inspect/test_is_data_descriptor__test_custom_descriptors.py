...
# lib = "inspect"
# dimension = "behavior"
# case = "test_is_data_descriptor__test_custom_descriptors"
# subject = "cpython.test_inspect.TestIsDataDescriptor.test_custom_descriptors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestIsDataDescriptor::test_custom_descriptors
"""Auto-ported test: TestIsDataDescriptor::test_custom_descriptors (CPython 3.12 oracle)."""
...
assert not inspect.isdatadescriptor(NonDataDescriptor())

assert inspect.isdatadescriptor(DataDescriptor0())

assert inspect.isdatadescriptor(DataDescriptor1())

assert inspect.isdatadescriptor(DataDescriptor2())
print("TestIsDataDescriptor::test_custom_descriptors: ok")
