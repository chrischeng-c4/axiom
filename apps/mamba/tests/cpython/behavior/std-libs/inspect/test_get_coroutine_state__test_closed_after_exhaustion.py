...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_coroutine_state__test_closed_after_exhaustion"
# subject = "cpython.test_inspect.TestGetCoroutineState.test_closed_after_exhaustion"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetCoroutineState::test_closed_after_exhaustion
"""Auto-ported test: TestGetCoroutineState::test_closed_after_exhaustion (CPython 3.12 oracle)."""
...
while True:
    try:
        self_coroutine.send(None)
    except StopIteration:
        break

assert _coroutinestate() == inspect.CORO_CLOSED
print("TestGetCoroutineState::test_closed_after_exhaustion: ok")
