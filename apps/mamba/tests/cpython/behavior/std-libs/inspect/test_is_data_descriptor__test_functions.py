...
# lib = "inspect"
# dimension = "behavior"
# case = "test_is_data_descriptor__test_functions"
# subject = "cpython.test_inspect.TestIsDataDescriptor.test_functions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestIsDataDescriptor::test_functions
"""Auto-ported test: TestIsDataDescriptor::test_functions (CPython 3.12 oracle)."""
...
assert not inspect.isdatadescriptor(Test().instance_method)

assert not inspect.isdatadescriptor(Test().class_method)

assert not inspect.isdatadescriptor(Test().static_method)

assert not inspect.isdatadescriptor(function)

assert not inspect.isdatadescriptor(a_lambda)
print("TestIsDataDescriptor::test_functions: ok")
