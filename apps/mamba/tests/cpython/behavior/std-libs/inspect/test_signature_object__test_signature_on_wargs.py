...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_wargs"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_wargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_wargs
"""Auto-ported test: TestSignatureObject::test_signature_on_wargs (CPython 3.12 oracle)."""
...
assert signature(test) == ((('a', ..., ..., 'positional_or_keyword'), ('b', ..., 'foo', 'positional_or_keyword')), 123)
print("TestSignatureObject::test_signature_on_wargs: ok")
