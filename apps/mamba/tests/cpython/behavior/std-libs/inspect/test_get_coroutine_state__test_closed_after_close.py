...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_coroutine_state__test_closed_after_close"
# subject = "cpython.test_inspect.TestGetCoroutineState.test_closed_after_close"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetCoroutineState::test_closed_after_close
"""Auto-ported test: TestGetCoroutineState::test_closed_after_close (CPython 3.12 oracle)."""
...
self_coroutine.close()

assert _coroutinestate() == inspect.CORO_CLOSED
print("TestGetCoroutineState::test_closed_after_close: ok")
