...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_no_dict_no_slots"
# subject = "cpython.test_inspect.TestGetattrStatic.test_no_dict_no_slots"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_no_dict_no_slots
"""Auto-ported test: TestGetattrStatic::test_no_dict_no_slots (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(1, 'foo', None) == None

assert inspect.getattr_static('foo', 'lower') != None
print("TestGetattrStatic::test_no_dict_no_slots: ok")
