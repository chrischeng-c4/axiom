...
# lib = "inspect"
# dimension = "behavior"
# case = "test_oneliners__test_twoline_indented_lambda"
# subject = "cpython.test_inspect.TestOneliners.test_twoline_indented_lambda"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestOneliners::test_twoline_indented_lambda
"""Auto-ported test: TestOneliners::test_twoline_indented_lambda (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.tlli, 33, 34)
print("TestOneliners::test_twoline_indented_lambda: ok")
