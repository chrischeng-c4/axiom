...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_findsource_without_filename"
# subject = "cpython.test_inspect.TestBuggyCases.test_findsource_without_filename"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_findsource_without_filename
"""Auto-ported test: TestBuggyCases::test_findsource_without_filename (CPython 3.12 oracle)."""
...
for fname in ['', '<string>']:
    ...
    try:
        ...
        pass
print("TestBuggyCases::test_findsource_without_filename: ok")
