...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_nested_class"
# subject = "cpython.test_inspect.TestBuggyCases.test_nested_class"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_nested_class
"""Auto-ported test: TestBuggyCases::test_nested_class (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.func69().func71, 71, 72)
print("TestBuggyCases::test_nested_class: ok")
