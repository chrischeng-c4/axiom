...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_bind__test_signature_bind_implicit_arg"
# subject = "cpython.test_inspect.TestSignatureBind.test_signature_bind_implicit_arg"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureBind::test_signature_bind_implicit_arg
"""Auto-ported test: TestSignatureBind::test_signature_bind_implicit_arg (CPython 3.12 oracle)."""
...
assert set(call(gencomp_func, iterator)) == {0, 1, 4, 9, 16}
print("TestSignatureBind::test_signature_bind_implicit_arg: ok")
