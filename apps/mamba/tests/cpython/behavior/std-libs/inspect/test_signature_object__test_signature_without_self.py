...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_without_self"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_without_self"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_without_self
"""Auto-ported test: TestSignatureObject::test_signature_without_self (CPython 3.12 oracle)."""
...
assert signature(test_args_only) == ((('args', ..., ..., 'var_positional'),), ...)

assert signature(test_args_kwargs_only) == ((('args', ..., ..., 'var_positional'), ('kwargs', ..., ..., 'var_keyword')), ...)

assert signature(A.f1) == ((('args', ..., ..., 'var_positional'),), ...)

assert signature(A.f2) == ((('args', ..., ..., 'var_positional'),), ...)

assert signature(A.f3) == ((('args', ..., ..., 'var_positional'),), ...)

assert signature(A.f4) == ((('args', ..., ..., 'var_positional'), ('kwargs', ..., ..., 'var_keyword')), ...)
print("TestSignatureObject::test_signature_without_self: ok")
