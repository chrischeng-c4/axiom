...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_multiple_children_classes"
# subject = "cpython.test_inspect.TestBuggyCases.test_multiple_children_classes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_multiple_children_classes
"""Auto-ported test: TestBuggyCases::test_multiple_children_classes (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.cls203, 203, 209)
assertSourceEqual(mod2.cls203.cls204, 204, 206)
assertSourceEqual(mod2.cls203.cls204.cls205, 205, 206)
assertSourceEqual(mod2.cls203.cls207, 207, 209)
assertSourceEqual(mod2.cls203.cls207.cls205, 208, 209)
print("TestBuggyCases::test_multiple_children_classes: ok")
