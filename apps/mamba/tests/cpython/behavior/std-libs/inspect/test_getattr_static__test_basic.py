...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_basic"
# subject = "cpython.test_inspect.TestGetattrStatic.test_basic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_basic
"""Auto-ported test: TestGetattrStatic::test_basic (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(thing, 'x', None) == Thing.x
try:
...
assert inspect.getattr_static(thing, 'y', 3) == 3
print("TestGetattrStatic::test_basic: ok")
