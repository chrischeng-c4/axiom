...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_coroutine_state__test_created"
# subject = "cpython.test_inspect.TestGetCoroutineState.test_created"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetCoroutineState::test_created
"""Auto-ported test: TestGetCoroutineState::test_created (CPython 3.12 oracle)."""
...
assert _coroutinestate() == inspect.CORO_CREATED
print("TestGetCoroutineState::test_created: ok")
