...
# lib = "inspect"
# dimension = "behavior"
# case = "test_retrieving_source_code__test_getmodule_file_not_found"
# subject = "cpython.test_inspect.TestRetrievingSourceCode.test_getmodule_file_not_found"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestRetrievingSourceCode::test_getmodule_file_not_found
"""Auto-ported test: TestRetrievingSourceCode::test_getmodule_file_not_found (CPython 3.12 oracle)."""
...
with unittest.mock.patch('inspect.getabsfile', _getabsfile):
    ...
    assert inspect.getmodule(f) is None
    inspect.getouterframes(f)
print("TestRetrievingSourceCode::test_getmodule_file_not_found: ok")
