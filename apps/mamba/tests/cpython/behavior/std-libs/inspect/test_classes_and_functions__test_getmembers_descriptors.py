...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_getmembers_descriptors"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_getmembers_descriptors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_getmembers_descriptors
"""Auto-ported test: TestClassesAndFunctions::test_getmembers_descriptors (CPython 3.12 oracle)."""
...
assert inspect.getmembers(A, ismethoddescriptor) == [('md', A.__dict__['md'])]

assert inspect.getmembers(A, isdatadescriptor) == [('dd', A.__dict__['dd'])]

class B(A):
    pass

assert inspect.getmembers(B, ismethoddescriptor) == [('md', A.__dict__['md'])]

assert inspect.getmembers(B, isdatadescriptor) == [('dd', A.__dict__['dd'])]
print("TestClassesAndFunctions::test_getmembers_descriptors: ok")
