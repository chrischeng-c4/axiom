...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_bind__test_signature_bind_var"
# subject = "cpython.test_inspect.TestSignatureBind.test_signature_bind_var"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureBind::test_signature_bind_var
"""Auto-ported test: TestSignatureBind::test_signature_bind_var (CPython 3.12 oracle)."""
...
assert call(test, args=10) == ((), {'args': 10})

assert call(test, 1, 2, foo='bar') == ((1, 2), {'foo': 'bar'})
print("TestSignatureBind::test_signature_bind_var: ok")
