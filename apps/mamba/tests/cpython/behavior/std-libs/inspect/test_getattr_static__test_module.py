...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_module"
# subject = "cpython.test_inspect.TestGetattrStatic.test_module"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_module
"""Auto-ported test: TestGetattrStatic::test_module (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(sys, 'version', sentinel) is not sentinel
print("TestGetattrStatic::test_module: ok")
