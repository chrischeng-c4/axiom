...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_method_in_dynamic_class"
# subject = "cpython.test_inspect.TestBuggyCases.test_method_in_dynamic_class"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_method_in_dynamic_class
"""Auto-ported test: TestBuggyCases::test_method_in_dynamic_class (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.method_in_dynamic_class, 95, 97)
print("TestBuggyCases::test_method_in_dynamic_class: ok")
