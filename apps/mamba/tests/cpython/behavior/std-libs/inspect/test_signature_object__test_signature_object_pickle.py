...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_object_pickle"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_object_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_object_pickle
"""Auto-ported test: TestSignatureObject::test_signature_object_pickle (CPython 3.12 oracle)."""
...
assert isinstance(mysig, MySignature)

assert isinstance(mysig.parameters['z'], MyParameter)
for ver in range(pickle.HIGHEST_PROTOCOL + 1):
    sig_pickled = pickle.loads(pickle.dumps(mysig, ver))

    assert mysig == sig_pickled

    assert isinstance(sig_pickled, MySignature)

    assert isinstance(sig_pickled.parameters['z'], MyParameter)
print("TestSignatureObject::test_signature_object_pickle: ok")
