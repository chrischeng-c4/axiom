...
# lib = "inspect"
# dimension = "behavior"
# case = "test_retrieving_source_code__test_cleandoc"
# subject = "cpython.test_inspect.TestRetrievingSourceCode.test_cleandoc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestRetrievingSourceCode::test_cleandoc
"""Auto-ported test: TestRetrievingSourceCode::test_cleandoc (CPython 3.12 oracle)."""
...
assert inspect.cleandoc('An\n    indented\n    docstring.') == 'An\nindented\ndocstring.'
print("TestRetrievingSourceCode::test_cleandoc: ok")
