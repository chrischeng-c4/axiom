...
# lib = "inspect"
# dimension = "behavior"
# case = "test_decorators__test_getsource_unwrap"
# subject = "cpython.test_inspect.TestDecorators.test_getsource_unwrap"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestDecorators::test_getsource_unwrap
"""Auto-ported test: TestDecorators::test_getsource_unwrap (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.real, 130, 132)
print("TestDecorators::test_getsource_unwrap: ok")
