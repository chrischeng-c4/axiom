...
# lib = "uuid"
# dimension = "behavior"
# case = "test_uuid_with_ext_module__test_uuid1_time"
# subject = "cpython.test_uuid.TestUUIDWithExtModule.test_uuid1_time"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_uuid.py::TestUUIDWithExtModule::test_uuid1_time
"""Auto-ported test: TestUUIDWithExtModule::test_uuid1_time (CPython 3.12 oracle)."""
...
with mock.patch.object(uuid, '_has_uuid_generate_time_safe', False), mock.patch.object(uuid, '_generate_time_safe', None), mock.patch.object(uuid, '_last_timestamp', None), mock.patch('time.time_ns', return_value=1545052026752910643):
    ...
    assert u == uuid.UUID('a7a55b92-01fc-11e9-94c5-54e1acf6da7f')
print("TestUUIDWithExtModule::test_uuid1_time: ok")
