...
# lib = "typing"
# dimension = "behavior"
# case = "collections_callable_tests__test_repr"
# subject = "cpython.test_typing.CollectionsCallableTests.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::CollectionsCallableTests::test_repr
"""Auto-ported test: CollectionsCallableTests::test_repr (CPython 3.12 oracle)."""
...
assert repr(ct0) == f'{fullname}[[], bool]'
ct2 = Callable[[str, float], int]

assert repr(ct2) == f'{fullname}[[str, float], int]'
ctv = Callable[..., str]

assert repr(ctv) == f'{fullname}[..., str]'
ct3 = Callable[[str, float], list[int]]

assert repr(ct3) == f'{fullname}[[str, float], list[int]]'
print("CollectionsCallableTests::test_repr: ok")
