...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_no_type_check_no_bases"
# subject = "cpython.test_typing.ForwardRefTests.test_no_type_check_no_bases"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_no_type_check_no_bases
"""Auto-ported test: ForwardRefTests::test_no_type_check_no_bases (CPython 3.12 oracle)."""
...
assert get_type_hints(C.meth) == {'x': int}
...
assert get_type_hints(Child.foo) == {'x': int}
print("ForwardRefTests::test_no_type_check_no_bases: ok")
