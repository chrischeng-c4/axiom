...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_function_implements_protocol"
# subject = "cpython.test_typing.ProtocolTests.test_function_implements_protocol"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_function_implements_protocol
"""Auto-ported test: ProtocolTests::test_function_implements_protocol (CPython 3.12 oracle)."""
...
assert isinstance(f, HasCallProtocol)
print("ProtocolTests::test_function_implements_protocol: ok")
