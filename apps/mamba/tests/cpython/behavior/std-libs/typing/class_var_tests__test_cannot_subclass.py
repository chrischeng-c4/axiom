...
# lib = "typing"
# dimension = "behavior"
# case = "class_var_tests__test_cannot_subclass"
# subject = "cpython.test_typing.ClassVarTests.test_cannot_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ClassVarTests::test_cannot_subclass
"""Auto-ported test: ClassVarTests::test_cannot_subclass (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.ClassVar', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.ClassVar\\[int\\]', str(_aR_e))
print("ClassVarTests::test_cannot_subclass: ok")
