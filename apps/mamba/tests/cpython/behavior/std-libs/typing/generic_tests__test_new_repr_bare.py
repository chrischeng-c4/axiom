...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_new_repr_bare"
# subject = "cpython.test_typing.GenericTests.test_new_repr_bare"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_new_repr_bare
"""Auto-ported test: GenericTests::test_new_repr_bare (CPython 3.12 oracle)."""
...
assert repr(Generic[T]) == 'typing.Generic[~T]'

assert repr(typing.Protocol[T]) == 'typing.Protocol[~T]'

class C(typing.Dict[Any, Any]):
    ...
repr(C.__mro__)
print("GenericTests::test_new_repr_bare: ok")
