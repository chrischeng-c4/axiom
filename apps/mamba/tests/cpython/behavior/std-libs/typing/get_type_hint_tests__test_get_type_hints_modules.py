...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_get_type_hints_modules"
# subject = "cpython.test_typing.GetTypeHintTests.test_get_type_hints_modules"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_get_type_hints_modules
"""Auto-ported test: GetTypeHintTests::test_get_type_hints_modules (CPython 3.12 oracle)."""
...
assert gth(ann_module) == ann_module_type_hints

assert gth(ann_module2) == {}

assert gth(ann_module3) == {}
print("GetTypeHintTests::test_get_type_hints_modules: ok")
