...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_no_type_check_type_error"
# subject = "cpython.test_typing.ForwardRefTests.test_no_type_check_TypeError"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_no_type_check_TypeError
"""Auto-ported test: ForwardRefTests::test_no_type_check_TypeError (CPython 3.12 oracle)."""
...
def clear_caches():
    for f in typing._cleanups:
        f()
no_type_check(dict)
print("ForwardRefTests::test_no_type_check_TypeError: ok")
