...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_generic_protocols_special_from_protocol"
# subject = "cpython.test_typing.ProtocolTests.test_generic_protocols_special_from_protocol"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_generic_protocols_special_from_protocol
"""Auto-ported test: ProtocolTests::test_generic_protocols_special_from_protocol (CPython 3.12 oracle)."""
...
assert P._is_protocol

assert PR._is_protocol

assert PG._is_protocol

assert not P._is_runtime_protocol

assert PR._is_runtime_protocol

assert PG[int]._is_protocol

assert typing._get_protocol_attrs(P) == {'meth'}

assert typing._get_protocol_attrs(PR) == {'x'}

assert frozenset(typing._get_protocol_attrs(PG)) == frozenset({'x', 'meth'})
print("ProtocolTests::test_generic_protocols_special_from_protocol: ok")
