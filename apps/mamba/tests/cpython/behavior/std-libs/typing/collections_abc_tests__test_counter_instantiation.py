...
# lib = "typing"
# dimension = "behavior"
# case = "collections_abc_tests__test_counter_instantiation"
# subject = "cpython.test_typing.CollectionsAbcTests.test_counter_instantiation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::CollectionsAbcTests::test_counter_instantiation
"""Auto-ported test: CollectionsAbcTests::test_counter_instantiation (CPython 3.12 oracle)."""
...
assert type(typing.Counter()) is collections.Counter

assert type(typing.Counter[T]()) is collections.Counter

assert type(typing.Counter[int]()) is collections.Counter

class C(typing.Counter[T]):
    ...

assert type(C[int]()) is C
print("CollectionsAbcTests::test_counter_instantiation: ok")
