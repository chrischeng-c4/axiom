...
# lib = "typing"
# dimension = "behavior"
# case = "self_tests__test_alias"
# subject = "cpython.test_typing.SelfTests.test_alias"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::SelfTests::test_alias
"""Auto-ported test: SelfTests::test_alias (CPython 3.12 oracle)."""
...
assert get_args(alias_1) == (Self, Self)

assert get_args(alias_2) == (Self,)

assert get_args(alias_3) == (Self,)
print("SelfTests::test_alias: ok")
