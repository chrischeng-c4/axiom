...
# lib = "typing"
# dimension = "behavior"
# case = "collections_abc_tests__test_deque_instantiation"
# subject = "cpython.test_typing.CollectionsAbcTests.test_deque_instantiation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::CollectionsAbcTests::test_deque_instantiation
"""Auto-ported test: CollectionsAbcTests::test_deque_instantiation (CPython 3.12 oracle)."""
...
assert type(typing.Deque()) is collections.deque

assert type(typing.Deque[T]()) is collections.deque

assert type(typing.Deque[int]()) is collections.deque

class D(typing.Deque[T]):
    ...

assert type(D[int]()) is D
print("CollectionsAbcTests::test_deque_instantiation: ok")
