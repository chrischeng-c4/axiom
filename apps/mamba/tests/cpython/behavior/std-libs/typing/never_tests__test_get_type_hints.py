...
# lib = "typing"
# dimension = "behavior"
# case = "never_tests__test_get_type_hints"
# subject = "cpython.test_typing.NeverTests.test_get_type_hints"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NeverTests::test_get_type_hints
"""Auto-ported test: NeverTests::test_get_type_hints (CPython 3.12 oracle)."""
...
for target in [some, some_str]:
    ...
    assert gth(target) == expected
print("NeverTests::test_get_type_hints: ok")
