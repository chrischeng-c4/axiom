...
# lib = "typing"
# dimension = "behavior"
# case = "named_tuple_tests__test_orig_bases"
# subject = "cpython.test_typing.NamedTupleTests.test_orig_bases"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NamedTupleTests::test_orig_bases
"""Auto-ported test: NamedTupleTests::test_orig_bases (CPython 3.12 oracle)."""
...
assert SimpleNamedTuple.__orig_bases__ == (NamedTuple,)

assert GenericNamedTuple.__orig_bases__ == (NamedTuple, Generic[T])
CallNamedTuple = NamedTuple('CallNamedTuple', [])

assert CallNamedTuple.__orig_bases__ == (NamedTuple,)
print("NamedTupleTests::test_orig_bases: ok")
