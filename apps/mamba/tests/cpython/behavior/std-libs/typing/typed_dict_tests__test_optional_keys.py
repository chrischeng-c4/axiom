...
# lib = "typing"
# dimension = "behavior"
# case = "typed_dict_tests__test_optional_keys"
# subject = "cpython.test_typing.TypedDictTests.test_optional_keys"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypedDictTests::test_optional_keys
"""Auto-ported test: TypedDictTests::test_optional_keys (CPython 3.12 oracle)."""
...
assert isinstance(Point2Dor3D.__required_keys__, frozenset)

assert Point2Dor3D.__optional_keys__ == frozenset(['z'])

assert isinstance(Point2Dor3D.__optional_keys__, frozenset)
print("TypedDictTests::test_optional_keys: ok")
