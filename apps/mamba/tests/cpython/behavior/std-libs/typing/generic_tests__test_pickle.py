...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_pickle"
# subject = "cpython.test_typing.GenericTests.test_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_pickle
"""Auto-ported test: GenericTests::test_pickle (CPython 3.12 oracle)."""
...
for thing in [PP.args, PP.kwargs]:
    for proto in range(pickle.HIGHEST_PROTOCOL + 1):
        ...
        assert pickle.loads(pickle.dumps(thing, proto)) == thing
del PP
print("GenericTests::test_pickle: ok")
