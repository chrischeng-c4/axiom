...
# lib = "typing"
# dimension = "behavior"
# case = "literal_tests__test_equal"
# subject = "cpython.test_typing.LiteralTests.test_equal"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::LiteralTests::test_equal
"""Auto-ported test: LiteralTests::test_equal (CPython 3.12 oracle)."""
...
assert Literal[1, True] != Literal[1]

assert Literal[1, True] != Literal[1, 1]

assert Literal[1, 2] != Literal[True, 2]
...
print("LiteralTests::test_equal: ok")
