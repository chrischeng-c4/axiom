...
# lib = "typing"
# dimension = "behavior"
# case = "collections_abc_tests__test_counter_subclass_instantiation"
# subject = "cpython.test_typing.CollectionsAbcTests.test_counter_subclass_instantiation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::CollectionsAbcTests::test_counter_subclass_instantiation
"""Auto-ported test: CollectionsAbcTests::test_counter_subclass_instantiation (CPython 3.12 oracle)."""
...
assert isinstance(d, MyCounter)

assert isinstance(d, typing.Counter)

assert isinstance(d, collections.Counter)
print("CollectionsAbcTests::test_counter_subclass_instantiation: ok")
