...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_protocols_isinstance_py36"
# subject = "cpython.test_typing.ProtocolTests.test_protocols_isinstance_py36"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_protocols_isinstance_py36
"""Auto-ported test: ProtocolTests::test_protocols_isinstance_py36 (CPython 3.12 oracle)."""
...
assert isinstance(APoint(1, 2, 'A'), Point)

assert isinstance(BPoint(1, 2), Point)

assert not isinstance(MyPoint(), Point)

assert isinstance(BPoint(1, 2), Position)

assert isinstance(Other(), Proto)

assert isinstance(Concrete(), Proto)

assert isinstance(C(42), Proto)

assert not isinstance(Bad(), Proto)

assert not isinstance(Bad(), Point)

assert not isinstance(Bad(), Position)

assert not isinstance(Bad(), Concrete)

assert not isinstance(Other(), Concrete)

assert isinstance(NT(1, 2), Position)
print("ProtocolTests::test_protocols_isinstance_py36: ok")
