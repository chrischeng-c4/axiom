...
# lib = "typing"
# dimension = "behavior"
# case = "typed_dict_tests__test_implicit_any_inheritance"
# subject = "cpython.test_typing.TypedDictTests.test_implicit_any_inheritance"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypedDictTests::test_implicit_any_inheritance
"""Auto-ported test: TypedDictTests::test_implicit_any_inheritance (CPython 3.12 oracle)."""
...
assert WithImplicitAny.__bases__ == (Generic, dict)

assert WithImplicitAny.__mro__ == (WithImplicitAny, Generic, dict, object)

assert WithImplicitAny.__parameters__ == ()

assert WithImplicitAny.__total__ == True

assert WithImplicitAny.__optional_keys__ == frozenset(['b'])

assert WithImplicitAny.__required_keys__ == frozenset(['a', 'c'])

assert WithImplicitAny.__annotations__ == {'a': T, 'b': KT, 'c': int}
try:
    WithImplicitAny[str]
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("TypedDictTests::test_implicit_any_inheritance: ok")
