...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_protocols_isinstance_properties_and_descriptors"
# subject = "cpython.test_typing.ProtocolTests.test_protocols_isinstance_properties_and_descriptors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_protocols_isinstance_properties_and_descriptors
"""Auto-ported test: ProtocolTests::test_protocols_isinstance_properties_and_descriptors (CPython 3.12 oracle)."""
...
for protocol_class in (P, P1, PG, PG1, MethodP, MethodPG):
    ...
    assert not isinstance(Empty(), protocol_class)
...
for obj in cases:
    for klass in (C, D, E, F, Empty):
        try:
            ...
            pass
print("ProtocolTests::test_protocols_isinstance_properties_and_descriptors: ok")
