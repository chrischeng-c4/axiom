...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_generic_protocols_repr"
# subject = "cpython.test_typing.ProtocolTests.test_generic_protocols_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_generic_protocols_repr
"""Auto-ported test: ProtocolTests::test_generic_protocols_repr (CPython 3.12 oracle)."""
...
assert repr(P[T, S]).endswith('P[~T, ~S]')

assert repr(P[int, str]).endswith('P[int, str]')
print("ProtocolTests::test_generic_protocols_repr: ok")
