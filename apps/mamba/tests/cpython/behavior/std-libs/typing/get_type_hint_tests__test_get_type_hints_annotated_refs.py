...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_get_type_hints_annotated_refs"
# subject = "cpython.test_typing.GetTypeHintTests.test_get_type_hints_annotated_refs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_get_type_hints_annotated_refs
"""Auto-ported test: GetTypeHintTests::test_get_type_hints_annotated_refs (CPython 3.12 oracle)."""
...
assert get_type_hints(MySet.__iand__, globals(), locals()) == {'other': MySet[T], 'return': MySet[T]}

assert get_type_hints(MySet.__iand__, globals(), locals(), include_extras=True) == {'other': Const[MySet[T]], 'return': MySet[T]}

assert get_type_hints(MySet.__ior__, globals(), locals()) == {'other': MySet[T], 'return': MySet[T]}
print("GetTypeHintTests::test_get_type_hints_annotated_refs: ok")
