...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tests__test_many_weakrefs"
# subject = "cpython.test_typing.TypeVarTests.test_many_weakrefs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTests::test_many_weakrefs
"""Auto-ported test: TypeVarTests::test_many_weakrefs (CPython 3.12 oracle)."""
...
for cls in (ParamSpec, TypeVarTuple, TypeVar):
    ...
    for x in range(10):
        vals[x] = cls(str(x))
    del vals
print("TypeVarTests::test_many_weakrefs: ok")
