...
# lib = "typing"
# dimension = "behavior"
# case = "named_tuple_tests__test_annotation_usage_with_methods"
# subject = "cpython.test_typing.NamedTupleTests.test_annotation_usage_with_methods"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NamedTupleTests::test_annotation_usage_with_methods
"""Auto-ported test: NamedTupleTests::test_annotation_usage_with_methods (CPython 3.12 oracle)."""
...
assert XMeth(1).double() == 2

assert XMeth(42).x == XMeth(42)[0]

assert str(XRepr(42)) == '42 -> 1'

assert XRepr(1, 2) + XRepr(3) == 0
try:
...
try:
    ...
    pass
print("NamedTupleTests::test_annotation_usage_with_methods: ok")
