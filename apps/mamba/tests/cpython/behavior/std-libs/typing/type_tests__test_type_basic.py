...
# lib = "typing"
# dimension = "behavior"
# case = "type_tests__test_type_basic"
# subject = "cpython.test_typing.TypeTests.test_type_basic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeTests::test_type_basic
"""Auto-ported test: TypeTests::test_type_basic (CPython 3.12 oracle)."""
...
def new_user(user_class: Type[User]) -> User:
    return user_class()
new_user(BasicUser)
print("TypeTests::test_type_basic: ok")
