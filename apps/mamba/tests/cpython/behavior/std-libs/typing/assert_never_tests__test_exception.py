...
# lib = "typing"
# dimension = "behavior"
# case = "assert_never_tests__test_exception"
# subject = "cpython.test_typing.AssertNeverTests.test_exception"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AssertNeverTests::test_exception
"""Auto-ported test: AssertNeverTests::test_exception (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(value, str(_aR_e))
huge_value = 'a' * 10000
try:
...
assert len(cm.exception.args[0]) < typing._ASSERT_NEVER_REPR_MAX_LENGTH * 2
print("AssertNeverTests::test_exception: ok")
