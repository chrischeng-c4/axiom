...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tests__test_cannot_subclass"
# subject = "cpython.test_typing.TypeVarTests.test_cannot_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTests::test_cannot_subclass
"""Auto-ported test: TypeVarTests::test_cannot_subclass (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(NOT_A_BASE_TYPE % 'TypeVar', str(_aR_e))
T = TypeVar('T')
try:
    ...
    import re as _re_aR
    assert _re_aR.search(CANNOT_SUBCLASS_INSTANCE % 'TypeVar', str(_aR_e))
print("TypeVarTests::test_cannot_subclass: ok")
