...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tuple_tests__test_repr_is_correct"
# subject = "cpython.test_typing.TypeVarTupleTests.test_repr_is_correct"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTupleTests::test_repr_is_correct
"""Auto-ported test: TypeVarTupleTests::test_repr_is_correct (CPython 3.12 oracle)."""
...
assert repr((*Ts,)[0]) == 'typing.Unpack[Ts]'

assert repr(Unpack[Ts]) == 'typing.Unpack[Ts]'

assert repr(tuple[*Ts,]) == 'tuple[typing.Unpack[Ts]]'

assert repr(Tuple[Unpack[Ts]]) == 'typing.Tuple[typing.Unpack[Ts]]'

assert repr(*tuple[*Ts,]) == '*tuple[typing.Unpack[Ts]]'

assert repr(Unpack[Tuple[Unpack[Ts]]]) == 'typing.Unpack[typing.Tuple[typing.Unpack[Ts]]]'
print("TypeVarTupleTests::test_repr_is_correct: ok")
