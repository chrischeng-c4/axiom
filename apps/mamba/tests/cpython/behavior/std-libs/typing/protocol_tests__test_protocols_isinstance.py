...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_protocols_isinstance"
# subject = "cpython.test_typing.ProtocolTests.test_protocols_isinstance"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_protocols_isinstance
"""Auto-ported test: ProtocolTests::test_protocols_isinstance (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(no_subscripted_generics, str(_aR_e))
try:
    isinstance(C(), PG[C])
    raise AssertionError('expected TypeError')
except TypeError as _aR_e:
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(only_runtime_checkable_msg, str(_aR_e))
try:
    isinstance(C(), BadPG)
    raise AssertionError('expected TypeError')
except TypeError as _aR_e:
    import re as _re_aR
    assert _re_aR.search(only_runtime_checkable_msg, str(_aR_e))
print("ProtocolTests::test_protocols_isinstance: ok")
