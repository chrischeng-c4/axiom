...
# lib = "typing"
# dimension = "behavior"
# case = "re_tests__test_repr"
# subject = "cpython.test_typing.RETests.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::RETests::test_repr
"""Auto-ported test: RETests::test_repr (CPython 3.12 oracle)."""
...
assert repr(Pattern) == 'typing.Pattern'

assert repr(Pattern[str]) == 'typing.Pattern[str]'

assert repr(Pattern[bytes]) == 'typing.Pattern[bytes]'

assert repr(Match) == 'typing.Match'

assert repr(Match[str]) == 'typing.Match[str]'

assert repr(Match[bytes]) == 'typing.Match[bytes]'
print("RETests::test_repr: ok")
