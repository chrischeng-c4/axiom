...
# lib = "typing"
# dimension = "behavior"
# case = "literal_tests__test_cannot_init"
# subject = "cpython.test_typing.LiteralTests.test_cannot_init"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::LiteralTests::test_cannot_init
"""Auto-ported test: LiteralTests::test_cannot_init (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("LiteralTests::test_cannot_init: ok")
