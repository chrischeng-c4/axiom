...
# lib = "typing"
# dimension = "behavior"
# case = "tuple_tests__test_repr"
# subject = "cpython.test_typing.TupleTests.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TupleTests::test_repr
"""Auto-ported test: TupleTests::test_repr (CPython 3.12 oracle)."""
...
assert repr(Tuple) == 'typing.Tuple'

assert repr(Tuple[()]) == 'typing.Tuple[()]'

assert repr(Tuple[int, float]) == 'typing.Tuple[int, float]'

assert repr(Tuple[int, ...]) == 'typing.Tuple[int, ...]'

assert repr(Tuple[list[int]]) == 'typing.Tuple[list[int]]'
print("TupleTests::test_repr: ok")
