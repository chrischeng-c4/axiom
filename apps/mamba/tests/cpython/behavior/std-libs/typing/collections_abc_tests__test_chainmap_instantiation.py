...
# lib = "typing"
# dimension = "behavior"
# case = "collections_abc_tests__test_chainmap_instantiation"
# subject = "cpython.test_typing.CollectionsAbcTests.test_chainmap_instantiation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::CollectionsAbcTests::test_chainmap_instantiation
"""Auto-ported test: CollectionsAbcTests::test_chainmap_instantiation (CPython 3.12 oracle)."""
...
assert type(typing.ChainMap()) is collections.ChainMap

assert type(typing.ChainMap[KT, VT]()) is collections.ChainMap

assert type(typing.ChainMap[str, int]()) is collections.ChainMap

class CM(typing.ChainMap[KT, VT]):
    ...

assert type(CM[int, str]()) is CM
print("CollectionsAbcTests::test_chainmap_instantiation: ok")
