...
# lib = "typing"
# dimension = "behavior"
# case = "collections_abc_tests__test_dict_subscribe"
# subject = "cpython.test_typing.CollectionsAbcTests.test_dict_subscribe"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::CollectionsAbcTests::test_dict_subscribe
"""Auto-ported test: CollectionsAbcTests::test_dict_subscribe (CPython 3.12 oracle)."""
...
assert Dict[K, int][str] == Dict[str, int]

assert Dict[str, V][int] == Dict[str, int]

assert Dict[K, List[V]][str, int] == Dict[str, List[int]]

assert Dict[K, List[int]][str] == Dict[str, List[int]]

assert Dict[K, list[V]][str, int] == Dict[str, list[int]]

assert Dict[K, list[int]][str] == Dict[str, list[int]]
print("CollectionsAbcTests::test_dict_subscribe: ok")
