...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tuple_tests__test_parameterised_tuple_is_equal_to_itself"
# subject = "cpython.test_typing.TypeVarTupleTests.test_parameterised_tuple_is_equal_to_itself"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTupleTests::test_parameterised_tuple_is_equal_to_itself
"""Auto-ported test: TypeVarTupleTests::test_parameterised_tuple_is_equal_to_itself (CPython 3.12 oracle)."""
...
assert tuple[*Ts,] == tuple[*Ts,]

assert Tuple[Unpack[Ts]] == Tuple[Unpack[Ts]]
print("TypeVarTupleTests::test_parameterised_tuple_is_equal_to_itself: ok")
