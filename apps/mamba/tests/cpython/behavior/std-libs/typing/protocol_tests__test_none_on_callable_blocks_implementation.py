...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_none_on_callable_blocks_implementation"
# subject = "cpython.test_typing.ProtocolTests.test_none_on_callable_blocks_implementation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_none_on_callable_blocks_implementation
"""Auto-ported test: ProtocolTests::test_none_on_callable_blocks_implementation (CPython 3.12 oracle)."""
...
assert not isinstance(C(), P)
print("ProtocolTests::test_none_on_callable_blocks_implementation: ok")
