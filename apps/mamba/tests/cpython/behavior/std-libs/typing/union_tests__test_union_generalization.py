...
# lib = "typing"
# dimension = "behavior"
# case = "union_tests__test_union_generalization"
# subject = "cpython.test_typing.UnionTests.test_union_generalization"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnionTests::test_union_generalization
"""Auto-ported test: UnionTests::test_union_generalization (CPython 3.12 oracle)."""
...
assert not Union[str, typing.Iterable[int]] == str

assert not Union[str, typing.Iterable[int]] == typing.Iterable[int]

assert str in Union[str, typing.Iterable[int]].__args__

assert typing.Iterable[int] in Union[str, typing.Iterable[int]].__args__
print("UnionTests::test_union_generalization: ok")
