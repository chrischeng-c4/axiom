...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_abc_registry_kept"
# subject = "cpython.test_typing.GenericTests.test_abc_registry_kept"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_abc_registry_kept
"""Auto-ported test: GenericTests::test_abc_registry_kept (CPython 3.12 oracle)."""
...
assert isinstance(1, C)
C[int]

assert isinstance(1, C)
C._abc_registry_clear()
C._abc_caches_clear()
print("GenericTests::test_abc_registry_kept: ok")
