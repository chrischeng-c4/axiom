...
# lib = "typing"
# dimension = "behavior"
# case = "union_tests__test_optional_isinstance"
# subject = "cpython.test_typing.UnionTests.test_optional_isinstance"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnionTests::test_optional_isinstance
"""Auto-ported test: UnionTests::test_optional_isinstance (CPython 3.12 oracle)."""
...
assert isinstance(42, Optional[int])

assert isinstance(None, Optional[int])

assert not isinstance('abc', Optional[int])
print("UnionTests::test_optional_isinstance: ok")
