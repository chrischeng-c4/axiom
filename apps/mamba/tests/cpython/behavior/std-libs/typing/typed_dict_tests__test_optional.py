...
# lib = "typing"
# dimension = "behavior"
# case = "typed_dict_tests__test_optional"
# subject = "cpython.test_typing.TypedDictTests.test_optional"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypedDictTests::test_optional
"""Auto-ported test: TypedDictTests::test_optional (CPython 3.12 oracle)."""
...
assert typing.Optional[EmpD] == typing.Union[None, EmpD]

assert typing.List[EmpD] != typing.Tuple[EmpD]
print("TypedDictTests::test_optional: ok")
