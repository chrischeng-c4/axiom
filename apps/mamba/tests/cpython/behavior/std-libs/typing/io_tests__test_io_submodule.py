...
# lib = "typing"
# dimension = "behavior"
# case = "io_tests__test_io_submodule"
# subject = "cpython.test_typing.IOTests.test_io_submodule"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::IOTests::test_io_submodule
"""Auto-ported test: IOTests::test_io_submodule (CPython 3.12 oracle)."""
...
with warnings.catch_warnings(record=True) as w:
    ...
    assert len(w) == 1
print("IOTests::test_io_submodule: ok")
