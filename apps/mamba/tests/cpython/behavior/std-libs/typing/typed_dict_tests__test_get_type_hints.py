...
# lib = "typing"
# dimension = "behavior"
# case = "typed_dict_tests__test_get_type_hints"
# subject = "cpython.test_typing.TypedDictTests.test_get_type_hints"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypedDictTests::test_get_type_hints
"""Auto-ported test: TypedDictTests::test_get_type_hints (CPython 3.12 oracle)."""
...
assert get_type_hints(Bar) == {'a': typing.Optional[int], 'b': int}
print("TypedDictTests::test_get_type_hints: ok")
