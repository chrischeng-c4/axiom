...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_no_type_check_other_module"
# subject = "cpython.test_typing.ForwardRefTests.test_no_type_check_other_module"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_no_type_check_other_module
"""Auto-ported test: ForwardRefTests::test_no_type_check_other_module (CPython 3.12 oracle)."""
...
assert NoTypeCheck_Outer.__no_type_check__
try:
...
assert NoTypeCheck_WithFunction.__no_type_check__
try:
    ann_module8.NoTypeCheck_function.__no_type_check__
    raise AssertionError('expected AttributeError')
except AttributeError:
    pass
print("ForwardRefTests::test_no_type_check_other_module: ok")
