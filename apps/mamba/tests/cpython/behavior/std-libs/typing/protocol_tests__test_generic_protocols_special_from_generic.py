...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_generic_protocols_special_from_generic"
# subject = "cpython.test_typing.ProtocolTests.test_generic_protocols_special_from_generic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_generic_protocols_special_from_generic
"""Auto-ported test: ProtocolTests::test_generic_protocols_special_from_generic (CPython 3.12 oracle)."""
...
assert P.__parameters__ == (T,)

assert P[int].__parameters__ == ()

assert P[int].__args__ == (int,)

assert P[int].__origin__ is P
print("ProtocolTests::test_generic_protocols_special_from_generic: ok")
