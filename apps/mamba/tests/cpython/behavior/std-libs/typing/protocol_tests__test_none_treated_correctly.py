...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_none_treated_correctly"
# subject = "cpython.test_typing.ProtocolTests.test_none_treated_correctly"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_none_treated_correctly
"""Auto-ported test: ProtocolTests::test_none_treated_correctly (CPython 3.12 oracle)."""
...
assert isinstance(CI(), P)

assert isinstance(DI(), P)
print("ProtocolTests::test_none_treated_correctly: ok")
