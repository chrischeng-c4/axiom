...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_typevar_subst"
# subject = "cpython.test_typing.AnnotatedTests.test_typevar_subst"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_typevar_subst
"""Auto-ported test: AnnotatedTests::test_typevar_subst (CPython 3.12 oracle)."""
...
assert A[int] == Annotated[tuple[int], dec]

assert A[str, int] == Annotated[tuple[str, int], dec]
try:
    Annotated[*Ts, dec]
...
assert B[int] == Annotated[Tuple[int], dec]

assert B[str, int] == Annotated[Tuple[str, int], dec]
try:
...
assert C[int] == Annotated[tuple[int], dec]

assert C[int, str] == Annotated[tuple[int, str], dec]

assert C[int, str, float] == Annotated[tuple[int, str, float], dec]
try:
    C[()]
    raise AssertionError('expected TypeError')
except TypeError:
...
assert D[int] == Annotated[Tuple[int], dec]

assert D[int, str] == Annotated[Tuple[int, str], dec]

assert D[int, str, float] == Annotated[Tuple[int, str, float], dec]
try:
    D[()]
    raise AssertionError('expected TypeError')
except TypeError:
...
assert E[int] == Annotated[tuple[int], dec]

assert E[int, str] == Annotated[tuple[int, str], dec]

assert E[int, str, float] == Annotated[tuple[int, str, float], dec]
try:
    E[()]
    raise AssertionError('expected TypeError')
except TypeError:
...
assert F[int] == Annotated[Tuple[int], dec]

assert F[int, str] == Annotated[Tuple[int, str], dec]

assert F[int, str, float] == Annotated[Tuple[int, str, float], dec]
try:
    F[()]
    raise AssertionError('expected TypeError')
except TypeError:
...
assert G[int, str] == Annotated[tuple[int, str], dec]

assert G[int, str, float] == Annotated[tuple[int, str, float], dec]

assert G[int, str, bool, float] == Annotated[tuple[int, str, bool, float], dec]
try:
    G[int]
    raise AssertionError('expected TypeError')
except TypeError:
...
assert H[int, str] == Annotated[Tuple[int, str], dec]

assert H[int, str, float] == Annotated[Tuple[int, str, float], dec]

assert H[int, str, bool, float] == Annotated[Tuple[int, str, bool, float], dec]
try:
    H[int]
    raise AssertionError('expected TypeError')
except TypeError:
...
for x, y in [(I, Annotated[tuple[T3, *Ts2, T4], dec]), (J, Annotated[tuple[T3, Unpack[Ts2], T4], dec]), (I[int, str], Annotated[tuple[int, str], dec]), (J[int, str], Annotated[tuple[int, str], dec]), (I[int, str, float], Annotated[tuple[int, str, float], dec]), (J[int, str, float], Annotated[tuple[int, str, float], dec]), (I[int, str, bool, float], Annotated[tuple[int, str, bool, float], dec]), (J[int, str, bool, float], Annotated[tuple[int, str, bool, float], dec])]:
...
try:
    ...
    pass
print("AnnotatedTests::test_typevar_subst: ok")
