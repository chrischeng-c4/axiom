...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_protocols_bad_subscripts"
# subject = "cpython.test_typing.ProtocolTests.test_protocols_bad_subscripts"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_protocols_bad_subscripts
"""Auto-ported test: ProtocolTests::test_protocols_bad_subscripts (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("ProtocolTests::test_protocols_bad_subscripts: ok")
