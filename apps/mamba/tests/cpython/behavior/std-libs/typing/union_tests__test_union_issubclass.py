...
# lib = "typing"
# dimension = "behavior"
# case = "union_tests__test_union_issubclass"
# subject = "cpython.test_typing.UnionTests.test_union_issubclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnionTests::test_union_issubclass
"""Auto-ported test: UnionTests::test_union_issubclass (CPython 3.12 oracle)."""
...
assert issubclass(str, Union[int, str])

assert not issubclass(float, Union[int, str])

assert issubclass(int, Union[int, list[int]])

assert issubclass(int, Union[int, Any])

assert not issubclass(int, Union[str, Any])

assert issubclass(int, Union[Any, int])

assert not issubclass(int, Union[Any, str])
print("UnionTests::test_union_issubclass: ok")
