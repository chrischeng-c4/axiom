...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_multi_subscr_base"
# subject = "cpython.test_typing.GenericTests.test_multi_subscr_base"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_multi_subscr_base
"""Auto-ported test: GenericTests::test_multi_subscr_base (CPython 3.12 oracle)."""
...
assert C.__parameters__ == (V,)

assert D.__parameters__ == (V,)

assert C[int].__parameters__ == ()

assert D[int].__parameters__ == ()

assert C[int].__args__ == (int,)

assert D[int].__args__ == (int,)

assert C.__bases__ == (list, Generic)

assert D.__bases__ == (C, list, Generic)

assert C.__orig_bases__ == (List[T][U][V],)

assert D.__orig_bases__ == (C, List[T][U][V])
print("GenericTests::test_multi_subscr_base: ok")
