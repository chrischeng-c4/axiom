...
# lib = "typing"
# dimension = "behavior"
# case = "literal_tests__test_flatten"
# subject = "cpython.test_typing.LiteralTests.test_flatten"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::LiteralTests::test_flatten
"""Auto-ported test: LiteralTests::test_flatten (CPython 3.12 oracle)."""
...
for l in (l1, l2, l3):
    ...
    assert l == Literal[1, 2, 3]

    assert l.__args__ == (1, 2, 3)
print("LiteralTests::test_flatten: ok")
