...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_tuple_forward"
# subject = "cpython.test_typing.ForwardRefTests.test_tuple_forward"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_tuple_forward
"""Auto-ported test: ForwardRefTests::test_tuple_forward (CPython 3.12 oracle)."""
...
assert get_type_hints(foo, globals(), locals()) == {'a': Tuple[T]}

def foo(a: tuple[ForwardRef('T')]):
    pass

assert get_type_hints(foo, globals(), locals()) == {'a': tuple[T]}
print("ForwardRefTests::test_tuple_forward: ok")
