...
# lib = "typing"
# dimension = "behavior"
# case = "union_tests__test_union_union"
# subject = "cpython.test_typing.UnionTests.test_union_union"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnionTests::test_union_union
"""Auto-ported test: UnionTests::test_union_union (CPython 3.12 oracle)."""
...
assert v == Union[int, float, Employee]
print("UnionTests::test_union_union: ok")
