...
# lib = "typing"
# dimension = "behavior"
# case = "named_tuple_tests__test_empty_namedtuple"
# subject = "cpython.test_typing.NamedTupleTests.test_empty_namedtuple"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NamedTupleTests::test_empty_namedtuple
"""Auto-ported test: NamedTupleTests::test_empty_namedtuple (CPython 3.12 oracle)."""
...
for struct in [NT, CNT]:
    ...
    assert struct._field_defaults == {}

    assert struct.__annotations__ == {}

    assert isinstance(struct(), struct)
print("NamedTupleTests::test_empty_namedtuple: ok")
