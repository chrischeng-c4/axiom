...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_builtin_protocol_allowlist"
# subject = "cpython.test_typing.ProtocolTests.test_builtin_protocol_allowlist"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_builtin_protocol_allowlist
"""Auto-ported test: ProtocolTests::test_builtin_protocol_allowlist (CPython 3.12 oracle)."""
...
class CustomAsyncIterator(typing.AsyncIterator, Protocol):
    pass
print("ProtocolTests::test_builtin_protocol_allowlist: ok")
