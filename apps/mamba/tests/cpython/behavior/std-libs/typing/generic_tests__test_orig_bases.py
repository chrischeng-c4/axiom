...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_orig_bases"
# subject = "cpython.test_typing.GenericTests.test_orig_bases"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_orig_bases
"""Auto-ported test: GenericTests::test_orig_bases (CPython 3.12 oracle)."""
...
assert C.__orig_bases__ == (typing.Dict[str, T],)
print("GenericTests::test_orig_bases: ok")
