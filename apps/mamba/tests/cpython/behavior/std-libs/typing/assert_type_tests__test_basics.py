...
# lib = "typing"
# dimension = "behavior"
# case = "assert_type_tests__test_basics"
# subject = "cpython.test_typing.AssertTypeTests.test_basics"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AssertTypeTests::test_basics
"""Auto-ported test: AssertTypeTests::test_basics (CPython 3.12 oracle)."""
...
assert assert_type(arg, int) is arg

assert assert_type(arg, str | float) is arg

assert assert_type(arg, AnyStr) is arg

assert assert_type(arg, None) is arg
print("AssertTypeTests::test_basics: ok")
