...
# lib = "typing"
# dimension = "behavior"
# case = "collections_abc_tests__test_defaultdict_instantiation"
# subject = "cpython.test_typing.CollectionsAbcTests.test_defaultdict_instantiation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::CollectionsAbcTests::test_defaultdict_instantiation
"""Auto-ported test: CollectionsAbcTests::test_defaultdict_instantiation (CPython 3.12 oracle)."""
...
assert type(typing.DefaultDict()) is collections.defaultdict

assert type(typing.DefaultDict[KT, VT]()) is collections.defaultdict

assert type(typing.DefaultDict[str, int]()) is collections.defaultdict
print("CollectionsAbcTests::test_defaultdict_instantiation: ok")
