...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_previous_behavior"
# subject = "cpython.test_typing.GetTypeHintTests.test_previous_behavior"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_previous_behavior
"""Auto-ported test: GetTypeHintTests::test_previous_behavior (CPython 3.12 oracle)."""
...
assert gth(testf) == {'x': int}

def testg(x: None):
    ...

assert gth(testg) == {'x': type(None)}
print("GetTypeHintTests::test_previous_behavior: ok")
