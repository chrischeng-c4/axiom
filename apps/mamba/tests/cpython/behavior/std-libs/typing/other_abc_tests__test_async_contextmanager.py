...
# lib = "typing"
# dimension = "behavior"
# case = "other_abc_tests__test_async_contextmanager"
# subject = "cpython.test_typing.OtherABCTests.test_async_contextmanager"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::OtherABCTests::test_async_contextmanager
"""Auto-ported test: OtherABCTests::test_async_contextmanager (CPython 3.12 oracle)."""
...
assert isinstance(ACM(), typing.AsyncContextManager)

assert not isinstance(NotACM(), typing.AsyncContextManager)
...
assert not isinstance(cm, typing.AsyncContextManager)

assert typing.AsyncContextManager[int].__args__ == (int,)
try:
...
try:
    ...
    pass
print("OtherABCTests::test_async_contextmanager: ok")
