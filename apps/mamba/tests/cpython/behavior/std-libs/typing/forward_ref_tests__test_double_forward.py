...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_double_forward"
# subject = "cpython.test_typing.ForwardRefTests.test_double_forward"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_double_forward
"""Auto-ported test: ForwardRefTests::test_double_forward (CPython 3.12 oracle)."""
...
assert get_type_hints(foo, globals(), locals()) == {'a': List[int]}
print("ForwardRefTests::test_double_forward: ok")
