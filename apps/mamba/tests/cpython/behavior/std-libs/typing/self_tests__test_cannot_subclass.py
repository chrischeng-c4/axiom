...
# lib = "typing"
# dimension = "behavior"
# case = "self_tests__test_cannot_subclass"
# subject = "cpython.test_typing.SelfTests.test_cannot_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::SelfTests::test_cannot_subclass
"""Auto-ported test: SelfTests::test_cannot_subclass (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.Self', str(_aR_e))
print("SelfTests::test_cannot_subclass: ok")
