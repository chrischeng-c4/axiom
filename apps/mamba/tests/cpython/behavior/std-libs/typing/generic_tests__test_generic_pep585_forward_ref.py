...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_generic_pep585_forward_ref"
# subject = "cpython.test_typing.GenericTests.test_generic_pep585_forward_ref"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_generic_pep585_forward_ref
"""Auto-ported test: GenericTests::test_generic_pep585_forward_ref (CPython 3.12 oracle)."""
...
assert get_type_hints(C1, globals(), locals()) == {'a': list[C1]}

class C2:
    a: dict['C1', list[List[list['C2']]]]

assert get_type_hints(C2, globals(), locals()) == {'a': dict[C1, list[List[list[C2]]]]}
scope = {}
...
assert get_type_hints(C3, globals(), locals()) == {'a': List[list[C2]]}
X = list['X']

def f(x: X):
    ...

assert get_type_hints(f, globals(), locals()) == {'x': list[list[ForwardRef('X')]]}
print("GenericTests::test_generic_pep585_forward_ref: ok")
