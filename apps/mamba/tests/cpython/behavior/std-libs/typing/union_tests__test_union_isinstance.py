...
# lib = "typing"
# dimension = "behavior"
# case = "union_tests__test_union_isinstance"
# subject = "cpython.test_typing.UnionTests.test_union_isinstance"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnionTests::test_union_isinstance
"""Auto-ported test: UnionTests::test_union_isinstance (CPython 3.12 oracle)."""
...
assert isinstance(42, Union[int, str])

assert isinstance('abc', Union[int, str])

assert not isinstance(3.14, Union[int, str])

assert isinstance(42, Union[int, list[int]])

assert isinstance(42, Union[int, Any])
print("UnionTests::test_union_isinstance: ok")
