...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_union_forward_recursion"
# subject = "cpython.test_typing.ForwardRefTests.test_union_forward_recursion"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_union_forward_recursion
"""Auto-ported test: ForwardRefTests::test_union_forward_recursion (CPython 3.12 oracle)."""
...
assert get_type_hints(C, globals(), locals()) == get_type_hints(C, globals(), locals())

assert get_type_hints(C, globals(), locals()) == {'foo': List[Union[str, List[Union[str, List['Value']]]]]}

assert get_type_hints(D, globals(), locals()) == {'foo': Union[str, List[Union[str, List['Value']]]]}

assert get_type_hints(E, globals(), locals()) == {'foo': Union[List[Union[str, List[Union[str, List['Value']]]]], List[Union[str, List['Value']]]]}

assert get_type_hints(F, globals(), locals()) == {'foo': Union[str, List[Union[str, List['Value']]], List[Union[str, List[Union[str, List['Value']]]]]]}
print("ForwardRefTests::test_union_forward_recursion: ok")
