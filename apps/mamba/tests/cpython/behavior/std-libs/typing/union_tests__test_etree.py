...
# lib = "typing"
# dimension = "behavior"
# case = "union_tests__test_etree"
# subject = "cpython.test_typing.UnionTests.test_etree"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnionTests::test_etree
"""Auto-ported test: UnionTests::test_etree (CPython 3.12 oracle)."""
...
def Elem(*args):
    return Element(*args)
Union[Elem, str]
print("UnionTests::test_etree: ok")
