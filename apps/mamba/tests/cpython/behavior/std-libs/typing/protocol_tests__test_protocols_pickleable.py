...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_protocols_pickleable"
# subject = "cpython.test_typing.ProtocolTests.test_protocols_pickleable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_protocols_pickleable
"""Auto-ported test: ProtocolTests::test_protocols_pickleable (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert x.__dict__ == {'foo': 42, 'bar': 'abc'}
...
print("ProtocolTests::test_protocols_pickleable: ok")
