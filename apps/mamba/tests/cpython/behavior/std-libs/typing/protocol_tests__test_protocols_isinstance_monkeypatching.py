...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_protocols_isinstance_monkeypatching"
# subject = "cpython.test_typing.ProtocolTests.test_protocols_isinstance_monkeypatching"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_protocols_isinstance_monkeypatching
"""Auto-ported test: ProtocolTests::test_protocols_isinstance_monkeypatching (CPython 3.12 oracle)."""
...
assert not isinstance(f, HasX)
f.x = 42

assert isinstance(f, HasX)
del f.x

assert not isinstance(f, HasX)
print("ProtocolTests::test_protocols_isinstance_monkeypatching: ok")
