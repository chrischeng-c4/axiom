...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_get_type_hints_wrapped_decoratored_func"
# subject = "cpython.test_typing.GetTypeHintTests.test_get_type_hints_wrapped_decoratored_func"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_get_type_hints_wrapped_decoratored_func
"""Auto-ported test: GetTypeHintTests::test_get_type_hints_wrapped_decoratored_func (CPython 3.12 oracle)."""
...
assert gth(ForRefExample.func) == expects

assert gth(ForRefExample.nested) == expects
print("GetTypeHintTests::test_get_type_hints_wrapped_decoratored_func: ok")
