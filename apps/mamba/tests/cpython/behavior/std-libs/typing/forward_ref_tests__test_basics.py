...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_basics"
# subject = "cpython.test_typing.ForwardRefTests.test_basics"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_basics
"""Auto-ported test: ForwardRefTests::test_basics (CPython 3.12 oracle)."""
...
assert both_hints['left'] == Optional[Node[T]]

assert both_hints['right'] == Node[T]

assert both_hints['stuff'] == int
...
assert right_hints['node'] == Node[T]
print("ForwardRefTests::test_basics: ok")
