...
# lib = "typing"
# dimension = "behavior"
# case = "named_tuple_tests__test_namedtuple_special_keyword_names"
# subject = "cpython.test_typing.NamedTupleTests.test_namedtuple_special_keyword_names"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NamedTupleTests::test_namedtuple_special_keyword_names
"""Auto-ported test: NamedTupleTests::test_namedtuple_special_keyword_names (CPython 3.12 oracle)."""
...
assert NT.__name__ == 'NT'

assert NT._fields == ('cls', 'self', 'typename', 'fields')
...
assert a.typename == 'foo'

assert a.fields == [('bar', tuple)]
print("NamedTupleTests::test_namedtuple_special_keyword_names: ok")
