...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_non_runtime_protocol_isinstance_check"
# subject = "cpython.test_typing.ProtocolTests.test_non_runtime_protocol_isinstance_check"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_non_runtime_protocol_isinstance_check
"""Auto-ported test: ProtocolTests::test_non_runtime_protocol_isinstance_check (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('@runtime_checkable', str(_aR_e))
print("ProtocolTests::test_non_runtime_protocol_isinstance_check: ok")
