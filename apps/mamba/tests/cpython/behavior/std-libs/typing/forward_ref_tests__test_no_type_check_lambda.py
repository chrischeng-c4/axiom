...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_no_type_check_lambda"
# subject = "cpython.test_typing.ForwardRefTests.test_no_type_check_lambda"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_no_type_check_lambda
"""Auto-ported test: ForwardRefTests::test_no_type_check_lambda (CPython 3.12 oracle)."""
...
assert A.bar.__no_type_check__

assert get_type_hints(A.bar) == {}
print("ForwardRefTests::test_no_type_check_lambda: ok")
