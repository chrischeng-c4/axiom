...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_forward_equality_gth"
# subject = "cpython.test_typing.ForwardRefTests.test_forward_equality_gth"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_forward_equality_gth
"""Auto-ported test: ForwardRefTests::test_forward_equality_gth (CPython 3.12 oracle)."""
...
assert get_type_hints(foo, globals(), locals()) == {'a': C, 'b': C}

assert c1 == c2

assert c1 == c1_gth

assert c1_gth == c2_gth

assert List[c1] == List[c1_gth]

assert List[c1] != List[C]

assert List[c1_gth] != List[C]

assert Union[c1, c1_gth] == Union[c1]

assert Union[c1, c1_gth, int] == Union[c1, int]
print("ForwardRefTests::test_forward_equality_gth: ok")
