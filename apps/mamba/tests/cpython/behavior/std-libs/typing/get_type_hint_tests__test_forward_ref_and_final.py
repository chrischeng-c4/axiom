...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_forward_ref_and_final"
# subject = "cpython.test_typing.GetTypeHintTests.test_forward_ref_and_final"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_forward_ref_and_final
"""Auto-ported test: GetTypeHintTests::test_forward_ref_and_final (CPython 3.12 oracle)."""
...
assert hints == {'name': Final[str]}
hints = get_type_hints(ann_module5.MyClass)

assert hints == {'value': Final}
print("GetTypeHintTests::test_forward_ref_and_final: ok")
