...
# lib = "typing"
# dimension = "behavior"
# case = "union_tests__test_union_compare_other"
# subject = "cpython.test_typing.UnionTests.test_union_compare_other"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnionTests::test_union_compare_other
"""Auto-ported test: UnionTests::test_union_compare_other (CPython 3.12 oracle)."""
...
assert ClassVar != Union

assert Optional != Union

assert [None] != Optional

assert Optional != typing.Mapping

assert Optional[typing.MutableMapping] != Union
print("UnionTests::test_union_compare_other: ok")
