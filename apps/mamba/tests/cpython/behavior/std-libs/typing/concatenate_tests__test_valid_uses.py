...
# lib = "typing"
# dimension = "behavior"
# case = "concatenate_tests__test_valid_uses"
# subject = "cpython.test_typing.ConcatenateTests.test_valid_uses"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ConcatenateTests::test_valid_uses
"""Auto-ported test: ConcatenateTests::test_valid_uses (CPython 3.12 oracle)."""
...
assert C1.__args__ == (Concatenate[int, P], int)

assert C1.__parameters__ == (P,)
C2 = Callable[Concatenate[int, T, P], T]

assert C2.__args__ == (Concatenate[int, T, P], T)

assert C2.__parameters__ == (T, P)
C3 = collections.abc.Callable[Concatenate[int, P], int]

assert C3.__args__ == (Concatenate[int, P], int)

assert C3.__parameters__ == (P,)
C4 = collections.abc.Callable[Concatenate[int, T, P], T]

assert C4.__args__ == (Concatenate[int, T, P], T)

assert C4.__parameters__ == (T, P)
print("ConcatenateTests::test_valid_uses: ok")
