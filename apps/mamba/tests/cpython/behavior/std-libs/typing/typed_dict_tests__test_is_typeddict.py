...
# lib = "typing"
# dimension = "behavior"
# case = "typed_dict_tests__test_is_typeddict"
# subject = "cpython.test_typing.TypedDictTests.test_is_typeddict"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypedDictTests::test_is_typeddict
"""Auto-ported test: TypedDictTests::test_is_typeddict (CPython 3.12 oracle)."""
...
assert is_typeddict(call_based) is True

assert is_typeddict(call_based()) is False
T = TypeVar('T')

class BarGeneric(TypedDict, Generic[T]):
    a: T

assert is_typeddict(BarGeneric) is True

assert is_typeddict(BarGeneric[int]) is False

assert is_typeddict(BarGeneric()) is False

class NewGeneric[T](TypedDict):
    a: T

assert is_typeddict(NewGeneric) is True

assert is_typeddict(NewGeneric[int]) is False

assert is_typeddict(NewGeneric()) is False

assert is_typeddict(TypedDict) is False
print("TypedDictTests::test_is_typeddict: ok")
