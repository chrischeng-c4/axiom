...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_protocols_isinstance_not_fooled_by_custom_dir"
# subject = "cpython.test_typing.ProtocolTests.test_protocols_isinstance_not_fooled_by_custom_dir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_protocols_isinstance_not_fooled_by_custom_dir
"""Auto-ported test: ProtocolTests::test_protocols_isinstance_not_fooled_by_custom_dir (CPython 3.12 oracle)."""
...
assert isinstance(CustomDirWithX(), HasX)

assert not isinstance(CustomDirWithoutX(), HasX)
print("ProtocolTests::test_protocols_isinstance_not_fooled_by_custom_dir: ok")
