...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tuple_tests__test_different_instances_are_different"
# subject = "cpython.test_typing.TypeVarTupleTests.test_different_instances_are_different"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTupleTests::test_different_instances_are_different
"""Auto-ported test: TypeVarTupleTests::test_different_instances_are_different (CPython 3.12 oracle)."""
...
assert TypeVarTuple('Ts') != TypeVarTuple('Ts')
print("TypeVarTupleTests::test_different_instances_are_different: ok")
