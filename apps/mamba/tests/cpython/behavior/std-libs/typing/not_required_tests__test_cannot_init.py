...
# lib = "typing"
# dimension = "behavior"
# case = "not_required_tests__test_cannot_init"
# subject = "cpython.test_typing.NotRequiredTests.test_cannot_init"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NotRequiredTests::test_cannot_init
"""Auto-ported test: NotRequiredTests::test_cannot_init (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("NotRequiredTests::test_cannot_init: ok")
