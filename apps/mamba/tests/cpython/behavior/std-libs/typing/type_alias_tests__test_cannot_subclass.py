...
# lib = "typing"
# dimension = "behavior"
# case = "type_alias_tests__test_cannot_subclass"
# subject = "cpython.test_typing.TypeAliasTests.test_cannot_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeAliasTests::test_cannot_subclass
"""Auto-ported test: TypeAliasTests::test_cannot_subclass (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.TypeAlias', str(_aR_e))
try:
    ...
    pass
print("TypeAliasTests::test_cannot_subclass: ok")
