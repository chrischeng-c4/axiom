...
# lib = "typing"
# dimension = "behavior"
# case = "overload_tests__test_overload_on_compiled_functions"
# subject = "cpython.test_typing.OverloadTests.test_overload_on_compiled_functions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::OverloadTests::test_overload_on_compiled_functions
"""Auto-ported test: OverloadTests::test_overload_on_compiled_functions (CPython 3.12 oracle)."""
...
with patch('typing._overload_registry', defaultdict(lambda: defaultdict(dict))):
    ...
    assert typing.get_overloads(sum) == []

    assert typing.get_overloads(print) == []
print("OverloadTests::test_overload_on_compiled_functions: ok")
