...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tests__test_bad_var_substitution"
# subject = "cpython.test_typing.TypeVarTests.test_bad_var_substitution"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTests::test_bad_var_substitution
"""Auto-ported test: TypeVarTests::test_bad_var_substitution (CPython 3.12 oracle)."""
...
def clear_caches():
    for f in typing._cleanups:
        f()
T = TypeVar('T')
bad_args = ((), (int, str), Union, Generic, Generic[T], Protocol, Protocol[T], Final, Final[int], ClassVar, ClassVar[int])
for arg in bad_args:
    try:
    ...
    try:
        ...
        pass
print("TypeVarTests::test_bad_var_substitution: ok")
