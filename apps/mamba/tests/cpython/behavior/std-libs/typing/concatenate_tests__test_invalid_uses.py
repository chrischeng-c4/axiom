...
# lib = "typing"
# dimension = "behavior"
# case = "concatenate_tests__test_invalid_uses"
# subject = "cpython.test_typing.ConcatenateTests.test_invalid_uses"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ConcatenateTests::test_invalid_uses
"""Auto-ported test: ConcatenateTests::test_invalid_uses (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Concatenate of no types', str(_aR_e))
try:
    Concatenate[int]
    raise AssertionError('expected TypeError')
except TypeError as _aR_e:
    import re as _re_aR
    assert _re_aR.search('The last parameter to Concatenate should be a ParamSpec variable or ellipsis', str(_aR_e))
print("ConcatenateTests::test_invalid_uses: ok")
