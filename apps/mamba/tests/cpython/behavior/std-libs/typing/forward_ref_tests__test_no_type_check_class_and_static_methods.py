...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_no_type_check_class_and_static_methods"
# subject = "cpython.test_typing.ForwardRefTests.test_no_type_check_class_and_static_methods"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_no_type_check_class_and_static_methods
"""Auto-ported test: ForwardRefTests::test_no_type_check_class_and_static_methods (CPython 3.12 oracle)."""
...
assert Some.st.__no_type_check__

assert get_type_hints(Some.st) == {}

assert Some.cl.__no_type_check__

assert get_type_hints(Some.cl) == {}
print("ForwardRefTests::test_no_type_check_class_and_static_methods: ok")
