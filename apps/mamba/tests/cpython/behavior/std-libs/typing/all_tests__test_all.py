...
# lib = "typing"
# dimension = "behavior"
# case = "all_tests__test_all"
# subject = "cpython.test_typing.AllTests.test_all"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AllTests::test_all
"""Auto-ported test: AllTests::test_all (CPython 3.12 oracle)."""
...
assert 'AsyncContextManager' in a
...
assert 'SupportsBytes' in a

assert 'SupportsComplex' in a
print("AllTests::test_all: ok")
