...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tests__test_missing_name"
# subject = "cpython.test_typing.TypeVarTests.test_missing__name__"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTests::test_missing__name__
"""Auto-ported test: TypeVarTests::test_missing__name__ (CPython 3.12 oracle)."""
...
code = "import typing\nT = typing.TypeVar('T')\n"
exec(code, {})
print("TypeVarTests::test_missing__name__: ok")
