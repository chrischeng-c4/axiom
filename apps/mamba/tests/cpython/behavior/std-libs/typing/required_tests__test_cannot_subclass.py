...
# lib = "typing"
# dimension = "behavior"
# case = "required_tests__test_cannot_subclass"
# subject = "cpython.test_typing.RequiredTests.test_cannot_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::RequiredTests::test_cannot_subclass
"""Auto-ported test: RequiredTests::test_cannot_subclass (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.Required', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.Required\\[int\\]', str(_aR_e))
print("RequiredTests::test_cannot_subclass: ok")
