...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_issubclass_fails_correctly"
# subject = "cpython.test_typing.ProtocolTests.test_issubclass_fails_correctly"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_issubclass_fails_correctly
"""Auto-ported test: ProtocolTests::test_issubclass_fails_correctly (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('issubclass\\(\\) arg 1 must be a class', str(_aR_e))
print("ProtocolTests::test_issubclass_fails_correctly: ok")
