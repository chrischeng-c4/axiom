...
# lib = "typing"
# dimension = "behavior"
# case = "param_spec_tests__test_typevartuple_and_paramspecs_in_user_generics"
# subject = "cpython.test_typing.ParamSpecTests.test_typevartuple_and_paramspecs_in_user_generics"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ParamSpecTests::test_typevartuple_and_paramspecs_in_user_generics
"""Auto-ported test: ParamSpecTests::test_typevartuple_and_paramspecs_in_user_generics (CPython 3.12 oracle)."""
...
assert G1.__args__ == (int, (bytes,))
G2 = X[int, str, [bytes]]

assert G2.__args__ == (int, str, (bytes,))
G3 = X[[bytes]]

assert G3.__args__ == ((bytes,),)
G4 = X[[]]
...
assert G1.__args__ == ((bytes,), int)
G2 = Y[[bytes], int, str]

assert G2.__args__ == ((bytes,), int, str)
G3 = Y[[bytes]]
...
try:
    ...
    pass
print("ParamSpecTests::test_typevartuple_and_paramspecs_in_user_generics: ok")
