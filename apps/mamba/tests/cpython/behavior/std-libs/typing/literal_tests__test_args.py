...
# lib = "typing"
# dimension = "behavior"
# case = "literal_tests__test_args"
# subject = "cpython.test_typing.LiteralTests.test_args"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::LiteralTests::test_args
"""Auto-ported test: LiteralTests::test_args (CPython 3.12 oracle)."""
...
assert Literal[1, 2, 3].__args__ == (1, 2, 3)

assert Literal[1, 2, 3, 3].__args__ == (1, 2, 3)

assert Literal[1, Literal[2], Literal[3, 4]].__args__ == (1, 2, 3, 4)

assert Literal[[], []].__args__ == ([], [])
print("LiteralTests::test_args: ok")
