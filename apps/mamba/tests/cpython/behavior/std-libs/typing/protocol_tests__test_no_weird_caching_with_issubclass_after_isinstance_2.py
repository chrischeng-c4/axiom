...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_no_weird_caching_with_issubclass_after_isinstance_2"
# subject = "cpython.test_typing.ProtocolTests.test_no_weird_caching_with_issubclass_after_isinstance_2"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_no_weird_caching_with_issubclass_after_isinstance_2
"""Auto-ported test: ProtocolTests::test_no_weird_caching_with_issubclass_after_isinstance_2 (CPython 3.12 oracle)."""
...
assert not isinstance(Eggs(), Spam)
try:
    issubclass(Eggs, Spam)
    raise AssertionError('expected TypeError')
except TypeError as _aR_e:
    import re as _re_aR
    assert _re_aR.search("Protocols with non-method members don't support issubclass()", str(_aR_e))
print("ProtocolTests::test_no_weird_caching_with_issubclass_after_isinstance_2: ok")
