...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_pep_695_generic_function_with_future_annotations"
# subject = "cpython.test_typing.GenericTests.test_pep_695_generic_function_with_future_annotations"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_pep_695_generic_function_with_future_annotations
"""Auto-ported test: GenericTests::test_pep_695_generic_function_with_future_annotations (CPython 3.12 oracle)."""
...
assert hints_for_generic_function.keys() == {'x', 'y', 'z', 'zz', 'return'}

assert hints_for_generic_function['x'] is func_t_params[0]

assert hints_for_generic_function['y'] == Unpack[func_t_params[1]]

assert hints_for_generic_function['z'].__origin__ is func_t_params[2]

assert hints_for_generic_function['zz'].__origin__ is func_t_params[2]
print("GenericTests::test_pep_695_generic_function_with_future_annotations: ok")
