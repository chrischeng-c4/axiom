...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_order_in_union"
# subject = "cpython.test_typing.AnnotatedTests.test_order_in_union"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_order_in_union
"""Auto-ported test: AnnotatedTests::test_order_in_union (CPython 3.12 oracle)."""
...
for args in itertools.permutations(get_args(expr1)):
    ...
    assert expr1 == reduce(operator.or_, args)
expr2 = Union[Annotated[int, 1], str, Annotated[str, {}], int]
for args in itertools.permutations(get_args(expr2)):

    assert expr2 == Union[args]
print("AnnotatedTests::test_order_in_union: ok")
