...
# lib = "tokenize"
# dimension = "behavior"
# case = "test_detect_encoding__test_no_bom_no_encoding_cookie"
# subject = "cpython.test_tokenize.TestDetectEncoding.test_no_bom_no_encoding_cookie"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TestDetectEncoding::test_no_bom_no_encoding_cookie
"""Auto-ported test: TestDetectEncoding::test_no_bom_no_encoding_cookie (CPython 3.12 oracle)."""
...
assert consumed_lines == list(lines[:2])
print("TestDetectEncoding::test_no_bom_no_encoding_cookie: ok")
