...
# lib = "tokenize"
# dimension = "behavior"
# case = "untokenize_test__test_bad_input_order"
# subject = "cpython.test_tokenize.UntokenizeTest.test_bad_input_order"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::UntokenizeTest::test_bad_input_order
"""Auto-ported test: UntokenizeTest::test_bad_input_order (CPython 3.12 oracle)."""
...
assert cm.exception.args[0] == 'start (1,3) precedes previous end (2,2)'
...
try:
    ...
    pass
print("UntokenizeTest::test_bad_input_order: ok")
