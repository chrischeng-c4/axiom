...
# lib = "tokenize"
# dimension = "behavior"
# case = "c_tokenize_test__test_unary"
# subject = "cpython.test_tokenize.CTokenizeTest.test_unary"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::CTokenizeTest::test_unary
"""Auto-ported test: CTokenizeTest::test_unary (CPython 3.12 oracle)."""
...
check_tokenize('~1 ^ 1 & 1 |1 ^ -1', "    TILDE      '~'           (1, 0) (1, 1)\n    NUMBER     '1'           (1, 1) (1, 2)\n    CIRCUMFLEX '^'           (1, 3) (1, 4)\n    NUMBER     '1'           (1, 5) (1, 6)\n    AMPER      '&'           (1, 7) (1, 8)\n    NUMBER     '1'           (1, 9) (1, 10)\n    VBAR       '|'           (1, 11) (1, 12)\n    NUMBER     '1'           (1, 12) (1, 13)\n    CIRCUMFLEX '^'           (1, 14) (1, 15)\n    MINUS      '-'           (1, 16) (1, 17)\n    NUMBER     '1'           (1, 17) (1, 18)\n    ")
check_tokenize('-1*1/1+1*1//1 - ---1**1', "    MINUS      '-'           (1, 0) (1, 1)\n    NUMBER     '1'           (1, 1) (1, 2)\n    STAR       '*'           (1, 2) (1, 3)\n    NUMBER     '1'           (1, 3) (1, 4)\n    SLASH      '/'           (1, 4) (1, 5)\n    NUMBER     '1'           (1, 5) (1, 6)\n    PLUS       '+'           (1, 6) (1, 7)\n    NUMBER     '1'           (1, 7) (1, 8)\n    STAR       '*'           (1, 8) (1, 9)\n    NUMBER     '1'           (1, 9) (1, 10)\n    DOUBLESLASH '//'          (1, 10) (1, 12)\n    NUMBER     '1'           (1, 12) (1, 13)\n    MINUS      '-'           (1, 14) (1, 15)\n    MINUS      '-'           (1, 16) (1, 17)\n    MINUS      '-'           (1, 17) (1, 18)\n    MINUS      '-'           (1, 18) (1, 19)\n    NUMBER     '1'           (1, 19) (1, 20)\n    DOUBLESTAR '**'          (1, 20) (1, 22)\n    NUMBER     '1'           (1, 22) (1, 23)\n    ")
print("CTokenizeTest::test_unary: ok")
