...
# lib = "tokenize"
# dimension = "behavior"
# case = "generate_tokens_test__test_underscore_literals"
# subject = "cpython.test_tokenize.GenerateTokensTest.test_underscore_literals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::GenerateTokensTest::test_underscore_literals
"""Auto-ported test: GenerateTokensTest::test_underscore_literals (CPython 3.12 oracle)."""
...
for lit in INVALID_UNDERSCORE_LITERALS:
    ...
    assert number_token(lit) != lit
print("GenerateTokensTest::test_underscore_literals: ok")
