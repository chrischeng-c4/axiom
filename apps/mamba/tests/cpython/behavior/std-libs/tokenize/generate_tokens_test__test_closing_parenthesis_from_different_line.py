...
# lib = "tokenize"
# dimension = "behavior"
# case = "generate_tokens_test__test_closing_parenthesis_from_different_line"
# subject = "cpython.test_tokenize.GenerateTokensTest.test_closing_parenthesis_from_different_line"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::GenerateTokensTest::test_closing_parenthesis_from_different_line
"""Auto-ported test: GenerateTokensTest::test_closing_parenthesis_from_different_line (CPython 3.12 oracle)."""
...
check_tokenize('); x', "    OP         ')'           (1, 0) (1, 1)\n    OP         ';'           (1, 1) (1, 2)\n    NAME       'x'           (1, 3) (1, 4)\n    ")
print("GenerateTokensTest::test_closing_parenthesis_from_different_line: ok")
