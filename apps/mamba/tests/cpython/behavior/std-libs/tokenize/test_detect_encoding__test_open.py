...
# lib = "tokenize"
# dimension = "behavior"
# case = "test_detect_encoding__test_open"
# subject = "cpython.test_tokenize.TestDetectEncoding.test_open"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TestDetectEncoding::test_open
"""Auto-ported test: TestDetectEncoding::test_open (CPython 3.12 oracle)."""
...
with tokenize_open(filename) as fp:
    ...
    assert fp.mode == 'r'
print("TestDetectEncoding::test_open: ok")
