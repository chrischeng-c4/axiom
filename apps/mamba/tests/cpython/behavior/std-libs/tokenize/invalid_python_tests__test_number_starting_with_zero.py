...
# lib = "tokenize"
# dimension = "behavior"
# case = "invalid_python_tests__test_number_starting_with_zero"
# subject = "cpython.test_tokenize.InvalidPythonTests.test_number_starting_with_zero"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::InvalidPythonTests::test_number_starting_with_zero
"""Auto-ported test: InvalidPythonTests::test_number_starting_with_zero (CPython 3.12 oracle)."""
...
# --- test body ---
source = '01234'
expected_tokens = [TokenInfo(type=token.NUMBER, string='01234', start=(1, 0), end=(1, 5), line='01234'), TokenInfo(type=token.NEWLINE, string='', start=(1, 5), end=(1, 6), line='01234'), TokenInfo(type=token.ENDMARKER, string='', start=(2, 0), end=(2, 0), line='')]
tokens = list(generate_tokens(StringIO(source).readline))

assert tokens == expected_tokens
print("InvalidPythonTests::test_number_starting_with_zero: ok")
