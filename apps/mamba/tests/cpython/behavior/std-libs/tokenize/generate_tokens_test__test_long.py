...
# lib = "tokenize"
# dimension = "behavior"
# case = "generate_tokens_test__test_long"
# subject = "cpython.test_tokenize.GenerateTokensTest.test_long"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::GenerateTokensTest::test_long
"""Auto-ported test: GenerateTokensTest::test_long (CPython 3.12 oracle)."""
...
check_tokenize('x = 0', "    NAME       'x'           (1, 0) (1, 1)\n    OP         '='           (1, 2) (1, 3)\n    NUMBER     '0'           (1, 4) (1, 5)\n    ")
check_tokenize('x = 0xfffffffffff', "    NAME       'x'           (1, 0) (1, 1)\n    OP         '='           (1, 2) (1, 3)\n    NUMBER     '0xfffffffffff' (1, 4) (1, 17)\n    ")
check_tokenize('x = 123141242151251616110', "    NAME       'x'           (1, 0) (1, 1)\n    OP         '='           (1, 2) (1, 3)\n    NUMBER     '123141242151251616110' (1, 4) (1, 25)\n    ")
check_tokenize('x = -15921590215012591', "    NAME       'x'           (1, 0) (1, 1)\n    OP         '='           (1, 2) (1, 3)\n    OP         '-'           (1, 4) (1, 5)\n    NUMBER     '15921590215012591' (1, 5) (1, 22)\n    ")
print("GenerateTokensTest::test_long: ok")
