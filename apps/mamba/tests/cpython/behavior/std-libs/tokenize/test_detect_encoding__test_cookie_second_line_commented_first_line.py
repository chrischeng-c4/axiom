...
# lib = "tokenize"
# dimension = "behavior"
# case = "test_detect_encoding__test_cookie_second_line_commented_first_line"
# subject = "cpython.test_tokenize.TestDetectEncoding.test_cookie_second_line_commented_first_line"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TestDetectEncoding::test_cookie_second_line_commented_first_line
"""Auto-ported test: TestDetectEncoding::test_cookie_second_line_commented_first_line (CPython 3.12 oracle)."""
...
assert encoding == 'iso8859-15'
expected = [b"#print('\xc2\xa3')\n", b'# vim: set fileencoding=iso8859-15 :\n']

assert consumed_lines == expected
print("TestDetectEncoding::test_cookie_second_line_commented_first_line: ok")
