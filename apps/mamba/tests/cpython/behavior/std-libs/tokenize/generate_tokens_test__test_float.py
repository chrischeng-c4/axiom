...
# lib = "tokenize"
# dimension = "behavior"
# case = "generate_tokens_test__test_float"
# subject = "cpython.test_tokenize.GenerateTokensTest.test_float"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::GenerateTokensTest::test_float
"""Auto-ported test: GenerateTokensTest::test_float (CPython 3.12 oracle)."""
...
check_tokenize('x = 3.14159', "    NAME       'x'           (1, 0) (1, 1)\n    OP         '='           (1, 2) (1, 3)\n    NUMBER     '3.14159'     (1, 4) (1, 11)\n    ")
check_tokenize('x = 314159.', "    NAME       'x'           (1, 0) (1, 1)\n    OP         '='           (1, 2) (1, 3)\n    NUMBER     '314159.'     (1, 4) (1, 11)\n    ")
check_tokenize('x = .314159', "    NAME       'x'           (1, 0) (1, 1)\n    OP         '='           (1, 2) (1, 3)\n    NUMBER     '.314159'     (1, 4) (1, 11)\n    ")
check_tokenize('x = 3e14159', "    NAME       'x'           (1, 0) (1, 1)\n    OP         '='           (1, 2) (1, 3)\n    NUMBER     '3e14159'     (1, 4) (1, 11)\n    ")
check_tokenize('x = 3E123', "    NAME       'x'           (1, 0) (1, 1)\n    OP         '='           (1, 2) (1, 3)\n    NUMBER     '3E123'       (1, 4) (1, 9)\n    ")
check_tokenize('x+y = 3e-1230', "    NAME       'x'           (1, 0) (1, 1)\n    OP         '+'           (1, 1) (1, 2)\n    NAME       'y'           (1, 2) (1, 3)\n    OP         '='           (1, 4) (1, 5)\n    NUMBER     '3e-1230'     (1, 6) (1, 13)\n    ")
check_tokenize('x = 3.14e159', "    NAME       'x'           (1, 0) (1, 1)\n    OP         '='           (1, 2) (1, 3)\n    NUMBER     '3.14e159'    (1, 4) (1, 12)\n    ")
print("GenerateTokensTest::test_float: ok")
