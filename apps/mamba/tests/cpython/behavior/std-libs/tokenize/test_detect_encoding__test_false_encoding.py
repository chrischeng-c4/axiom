...
# lib = "tokenize"
# dimension = "behavior"
# case = "test_detect_encoding__test_false_encoding"
# subject = "cpython.test_tokenize.TestDetectEncoding.test_false_encoding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TestDetectEncoding::test_false_encoding
"""Auto-ported test: TestDetectEncoding::test_false_encoding (CPython 3.12 oracle)."""
...
def get_readline(lines):
    ...
    def readline():
        ...
        return line
    return readline
readline = get_readline((b'print("#coding=fake")',))
encoding, consumed_lines = detect_encoding(readline)

assert encoding == 'utf-8'

assert consumed_lines == [b'print("#coding=fake")']
print("TestDetectEncoding::test_false_encoding: ok")
