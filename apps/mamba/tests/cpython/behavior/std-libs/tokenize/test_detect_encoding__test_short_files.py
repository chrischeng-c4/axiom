...
# lib = "tokenize"
# dimension = "behavior"
# case = "test_detect_encoding__test_short_files"
# subject = "cpython.test_tokenize.TestDetectEncoding.test_short_files"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TestDetectEncoding::test_short_files
"""Auto-ported test: TestDetectEncoding::test_short_files (CPython 3.12 oracle)."""
...
def get_readline(lines):
    ...
    def readline():
        ...
        return line
    return readline
readline = get_readline((b'print(something)\n',))
encoding, consumed_lines = detect_encoding(readline)

assert encoding == 'utf-8'

assert consumed_lines == [b'print(something)\n']
encoding, consumed_lines = detect_encoding(get_readline(()))

assert encoding == 'utf-8'

assert consumed_lines == []
readline = get_readline((b'\xef\xbb\xbfprint(something)\n',))
encoding, consumed_lines = detect_encoding(readline)

assert encoding == 'utf-8-sig'

assert consumed_lines == [b'print(something)\n']
readline = get_readline((b'\xef\xbb\xbf',))
encoding, consumed_lines = detect_encoding(readline)

assert encoding == 'utf-8-sig'

assert consumed_lines == []
readline = get_readline((b'# coding: bad\n',))
...
try:
    ...
    pass
print("TestDetectEncoding::test_short_files: ok")
