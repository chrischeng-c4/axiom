...
# lib = "tokenize"
# dimension = "behavior"
# case = "test_roundtrip__test_indentation_semantics_retained"
# subject = "cpython.test_tokenize.TestRoundtrip.test_indentation_semantics_retained"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TestRoundtrip::test_indentation_semantics_retained
"""Auto-ported test: TestRoundtrip::test_indentation_semantics_retained (CPython 3.12 oracle)."""
...
assert codelines[1] == codelines[2]
check_roundtrip(code)
print("TestRoundtrip::test_indentation_semantics_retained: ok")
