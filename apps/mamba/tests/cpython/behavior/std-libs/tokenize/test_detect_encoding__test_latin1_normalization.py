...
# lib = "tokenize"
# dimension = "behavior"
# case = "test_detect_encoding__test_latin1_normalization"
# subject = "cpython.test_tokenize.TestDetectEncoding.test_latin1_normalization"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TestDetectEncoding::test_latin1_normalization
"""Auto-ported test: TestDetectEncoding::test_latin1_normalization (CPython 3.12 oracle)."""
...
for encoding in encodings:
    for rep in ('-', '_'):
        ...
        rl = get_readline(lines)
        found, consumed_lines = detect_encoding(rl)

        assert found == 'iso-8859-1'
print("TestDetectEncoding::test_latin1_normalization: ok")
