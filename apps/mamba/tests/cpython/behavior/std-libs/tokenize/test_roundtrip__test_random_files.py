...
# lib = "tokenize"
# dimension = "behavior"
# case = "test_roundtrip__test_random_files"
# subject = "cpython.test_tokenize.TestRoundtrip.test_random_files"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TestRoundtrip::test_random_files
"""Auto-ported test: TestRoundtrip::test_random_files (CPython 3.12 oracle)."""
...
for testfile in testfiles:
    ...
    with open(testfile, 'rb') as f:
        check_roundtrip(f)
        check_line_extraction(f)
print("TestRoundtrip::test_random_files: ok")
