...
# lib = "tokenize"
# dimension = "behavior"
# case = "untokenize_test__test_iter_compat"
# subject = "cpython.test_tokenize.UntokenizeTest.test_iter_compat"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::UntokenizeTest::test_iter_compat
"""Auto-ported test: UntokenizeTest::test_iter_compat (CPython 3.12 oracle)."""
...
assert u.untokenize(iter([token])) == 'Hello '
u = Untokenizer()

assert u.untokenize(iter(tokens)) == 'Hello '

assert u.encoding == 'utf-8'

assert untokenize(iter(tokens)) == b'Hello '
print("UntokenizeTest::test_iter_compat: ok")
