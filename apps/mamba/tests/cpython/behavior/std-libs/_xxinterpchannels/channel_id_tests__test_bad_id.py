...
# dimension = "behavior"
# case = "channel_id_tests__test_bad_id"
# subject = "cpython.test__xxinterpchannels.ChannelIDTests.test_bad_id"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelIDTests::test_bad_id
"""Auto-ported test: ChannelIDTests::test_bad_id (CPython 3.12 oracle)."""
...
try:
    channels._channel_id(object())
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    channels._channel_id(10.0)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    channels._channel_id('10')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    channels._channel_id(b'10')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    channels._channel_id(-1)
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    channels._channel_id(2 ** 64)
    raise AssertionError('expected OverflowError')
except OverflowError:
    pass
print("ChannelIDTests::test_bad_id: ok")
