...
# dimension = "behavior"
# case = "channel_id_tests__test_does_not_exist"
# subject = "cpython.test__xxinterpchannels.ChannelIDTests.test_does_not_exist"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelIDTests::test_does_not_exist
"""Auto-ported test: ChannelIDTests::test_does_not_exist (CPython 3.12 oracle)."""
...
cid = channels.create()
try:
    channels._channel_id(int(cid) + 1)
    raise AssertionError('expected channels.ChannelNotFoundError')
except channels.ChannelNotFoundError:
    pass
print("ChannelIDTests::test_does_not_exist: ok")
