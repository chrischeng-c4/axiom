...
# dimension = "behavior"
# case = "channel_tests__test_close_multiple_users"
# subject = "cpython.test__xxinterpchannels.ChannelTests.test_close_multiple_users"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelTests::test_close_multiple_users
"""Auto-ported test: ChannelTests::test_close_multiple_users (CPython 3.12 oracle)."""
...
try:
    interpreters.run_string(id1, dedent(f"\n                _channels.send({cid}, b'spam')\n                "))
    raise AssertionError('expected interpreters.RunFailedError')
except interpreters.RunFailedError as _aR_e:
    import types as _types_aR
    cm = _types_aR.SimpleNamespace(exception=_aR_e)

assert 'ChannelClosedError' in str(cm.exception)
try:
    interpreters.run_string(id2, dedent(f"\n                _channels.send({cid}, b'spam')\n                "))
    raise AssertionError('expected interpreters.RunFailedError')
except interpreters.RunFailedError as _aR_e:
...
assert 'ChannelClosedError' in str(cm.exception)
print("ChannelTests::test_close_multiple_users: ok")
