...
# dimension = "behavior"
# case = "channel_tests__test_ids_global"
# subject = "cpython.test__xxinterpchannels.ChannelTests.test_ids_global"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelTests::test_ids_global
"""Auto-ported test: ChannelTests::test_ids_global (CPython 3.12 oracle)."""
...
assert cid2 == int(cid1) + 1
print("ChannelTests::test_ids_global: ok")
