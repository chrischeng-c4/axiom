...
# dimension = "behavior"
# case = "channel_id_tests__test_coerce_id"
# subject = "cpython.test__xxinterpchannels.ChannelIDTests.test_coerce_id"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelIDTests::test_coerce_id
"""Auto-ported test: ChannelIDTests::test_coerce_id (CPython 3.12 oracle)."""
...
assert int(cid) == 10
print("ChannelIDTests::test_coerce_id: ok")
