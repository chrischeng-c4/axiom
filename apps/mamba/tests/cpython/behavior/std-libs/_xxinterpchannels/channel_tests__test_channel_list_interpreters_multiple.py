...
# dimension = "behavior"
# case = "channel_tests__test_channel_list_interpreters_multiple"
# subject = "cpython.test__xxinterpchannels.ChannelTests.test_channel_list_interpreters_multiple"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelTests::test_channel_list_interpreters_multiple
"""Auto-ported test: ChannelTests::test_channel_list_interpreters_multiple (CPython 3.12 oracle)."""
...
assert set(send_interps) == {interp0, interp1}

assert set(recv_interps) == {interp2, interp3}
print("ChannelTests::test_channel_list_interpreters_multiple: ok")
