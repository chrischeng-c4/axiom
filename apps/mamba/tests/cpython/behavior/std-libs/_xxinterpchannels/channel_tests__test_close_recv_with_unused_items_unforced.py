...
# dimension = "behavior"
# case = "channel_tests__test_close_recv_with_unused_items_unforced"
# subject = "cpython.test__xxinterpchannels.ChannelTests.test_close_recv_with_unused_items_unforced"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelTests::test_close_recv_with_unused_items_unforced
"""Auto-ported test: ChannelTests::test_close_recv_with_unused_items_unforced (CPython 3.12 oracle)."""
...
channels.recv(cid)
channels.close(cid, recv=True)
print("ChannelTests::test_close_recv_with_unused_items_unforced: ok")
