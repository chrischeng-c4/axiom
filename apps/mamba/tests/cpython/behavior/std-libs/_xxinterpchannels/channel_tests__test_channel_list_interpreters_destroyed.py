...
# dimension = "behavior"
# case = "channel_tests__test_channel_list_interpreters_destroyed"
# subject = "cpython.test__xxinterpchannels.ChannelTests.test_channel_list_interpreters_destroyed"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelTests::test_channel_list_interpreters_destroyed
"""Auto-ported test: ChannelTests::test_channel_list_interpreters_destroyed (CPython 3.12 oracle)."""
...
assert recv_interps == []
print("ChannelTests::test_channel_list_interpreters_destroyed: ok")
