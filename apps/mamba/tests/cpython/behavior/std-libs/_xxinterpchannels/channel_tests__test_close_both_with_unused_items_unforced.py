...
# dimension = "behavior"
# case = "channel_tests__test_close_both_with_unused_items_unforced"
# subject = "cpython.test__xxinterpchannels.ChannelTests.test_close_both_with_unused_items_unforced"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelTests::test_close_both_with_unused_items_unforced
"""Auto-ported test: ChannelTests::test_close_both_with_unused_items_unforced (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('expected channels.ChannelNotEmptyError')
except channels.ChannelNotEmptyError:
    pass
channels.recv(cid)
...
print("ChannelTests::test_close_both_with_unused_items_unforced: ok")
