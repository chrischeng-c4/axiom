...
# dimension = "behavior"
# case = "channel_tests__test_recv_sending_interp_destroyed"
# subject = "cpython.test__xxinterpchannels.ChannelTests.test_recv_sending_interp_destroyed"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelTests::test_recv_sending_interp_destroyed
"""Auto-ported test: ChannelTests::test_recv_sending_interp_destroyed (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(f'channel {cid1} is closed', str(_aR_e))
del cid1
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(f'channel {cid2} is empty', str(_aR_e))
del cid2
print("ChannelTests::test_recv_sending_interp_destroyed: ok")
