...
# dimension = "behavior"
# case = "channel_id_tests__test_str"
# subject = "cpython.test__xxinterpchannels.ChannelIDTests.test_str"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelIDTests::test_str
"""Auto-ported test: ChannelIDTests::test_str (CPython 3.12 oracle)."""
...
assert str(cid) == '10'
print("ChannelIDTests::test_str: ok")
