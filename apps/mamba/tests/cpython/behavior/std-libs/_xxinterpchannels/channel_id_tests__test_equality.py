...
# dimension = "behavior"
# case = "channel_id_tests__test_equality"
# subject = "cpython.test__xxinterpchannels.ChannelIDTests.test_equality"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelIDTests::test_equality
"""Auto-ported test: ChannelIDTests::test_equality (CPython 3.12 oracle)."""
...
assert cid1 == int(cid1)

assert int(cid1) == cid1

assert cid1 == float(int(cid1))

assert float(int(cid1)) == cid1

assert not cid1 == float(int(cid1)) + 0.1

assert not cid1 == str(int(cid1))

assert not cid1 == 2 ** 1000

assert not cid1 == float('inf')

assert not cid1 == 'spam'

assert not cid1 == cid3

assert not cid1 != cid1

assert not cid1 != cid2

assert cid1 != cid3
print("ChannelIDTests::test_equality: ok")
