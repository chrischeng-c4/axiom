...
# subject = "cpython.test_sys_setprofile.TestEdgeCases.test_reentrancy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_setprofile.py::TestEdgeCases::test_reentrancy
