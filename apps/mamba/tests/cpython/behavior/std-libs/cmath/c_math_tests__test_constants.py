...
# lib = "cmath"
# dimension = "behavior"
# case = "c_math_tests__test_constants"
# subject = "cpython.test_cmath.CMathTests.test_constants"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmath.py::CMathTests::test_constants
"""Auto-ported test: CMathTests::test_constants (CPython 3.12 oracle)."""
...
assert abs(cmath.pi - pi_expected) < 1e-07

assert abs(cmath.e - e_expected) < 1e-07
print("CMathTests::test_constants: ok")
