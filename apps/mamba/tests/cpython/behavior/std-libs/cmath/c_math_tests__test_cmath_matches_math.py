...
# lib = "cmath"
# dimension = "behavior"
# case = "c_math_tests__test_cmath_matches_math"
# subject = "cpython.test_cmath.CMathTests.test_cmath_matches_math"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmath.py::CMathTests::test_cmath_matches_math
"""Auto-ported test: CMathTests::test_cmath_matches_math (CPython 3.12 oracle)."""
...
for fn, values in test_functions.items():
    ...
    for v in values:
        z = complex_fn(v)
        rAssertAlmostEqual(float_fn(v), z.real)

        assert 0.0 == z.imag
for base in [0.5, 2.0, 10.0]:
    for v in positive:
        z = cmath.log(v, base)
        rAssertAlmostEqual(math.log(v, base), z.real)

        assert 0.0 == z.imag
print("CMathTests::test_cmath_matches_math: ok")
