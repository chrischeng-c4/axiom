...
# lib = "locale"
# dimension = "behavior"
# case = "test_miscellaneous__test_setlocale_category"
# subject = "cpython.test_locale.TestMiscellaneous.test_setlocale_category"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_locale.py::TestMiscellaneous::test_setlocale_category
"""Auto-ported test: TestMiscellaneous::test_setlocale_category (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('expected locale.Error')
except locale.Error:
    pass
print("TestMiscellaneous::test_setlocale_category: ok")
