...
# lib = "locale"
# dimension = "behavior"
# case = "test_fr_fr_number_formatting__test_grouping"
# subject = "cpython.test_locale.TestFrFRNumberFormatting.test_grouping"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_locale.py::TestFrFRNumberFormatting::test_grouping
"""Auto-ported test: TestFrFRNumberFormatting::test_grouping (CPython 3.12 oracle)."""
...
_test_format_string('%.2f', 345.67, grouping=True, out='345,67')
_test_format_string('%.2f', 12345.67, grouping=True, out='12 345,67')
print("TestFrFRNumberFormatting::test_grouping: ok")
