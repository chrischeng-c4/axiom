...
# lib = "strptime"
# dimension = "behavior"
# case = "strptime_tests__test_weekday_locale"
# subject = "cpython.test_strptime.StrptimeTests.test_weekday_locale"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_strptime.py::StrptimeTests::test_weekday_locale
"""Auto-ported test: StrptimeTests::test_weekday_locale (CPython 3.12 oracle)."""
...
roundtrip('%A', 6)
roundtrip('%a', 6)
print("StrptimeTests::test_weekday_locale: ok")
