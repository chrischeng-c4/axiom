...
# lib = "strptime"
# dimension = "behavior"
# case = "strptime_tests__test_day"
# subject = "cpython.test_strptime.StrptimeTests.test_day"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_strptime.py::StrptimeTests::test_day
"""Auto-ported test: StrptimeTests::test_day (CPython 3.12 oracle)."""
...
roundtrip('%d %Y', 2)
print("StrptimeTests::test_day: ok")
