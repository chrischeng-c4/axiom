...
# lib = "ensurepip"
# dimension = "behavior"
# case = "test_bootstrapping_main_function__test_basic_bootstrapping"
# subject = "cpython.test_ensurepip.TestBootstrappingMainFunction.test_basic_bootstrapping"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ensurepip.py::TestBootstrappingMainFunction::test_basic_bootstrapping
"""Auto-ported test: TestBootstrappingMainFunction::test_basic_bootstrapping (CPython 3.12 oracle)."""
...
assert exit_code == 0
print("TestBootstrappingMainFunction::test_basic_bootstrapping: ok")
