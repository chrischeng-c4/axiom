...
# subject = "cpython.test_dynamicclassattribute.PropertyTests.test_property_decorator_doc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dynamicclassattribute.py::PropertyTests::test_property_decorator_doc
...
assert base.__class__.__dict__['spam'].__doc__ == 'spam spam spam'

assert sub.__class__.__dict__['spam'].__doc__ == 'spam spam spam'
