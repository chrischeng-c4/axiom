...
# subject = "cpython.test_dynamicclassattribute.PropertyTests.test_property_decorator_baseclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dynamicclassattribute.py::PropertyTests::test_property_decorator_baseclass
