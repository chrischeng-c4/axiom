...
# lib = "collections"
# dimension = "behavior"
# case = "test_counter__test_multiset_operations_equivalent_to_set_operations"
# subject = "cpython.test_collections.TestCounter.test_multiset_operations_equivalent_to_set_operations"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestCounter::test_multiset_operations_equivalent_to_set_operations
"""Auto-ported test: TestCounter::test_multiset_operations_equivalent_to_set_operations (CPython 3.12 oracle)."""
...
for cp, cq in product(counters, repeat=2):
    ...
    assert (cp > cq) == (sp > sq)
print("TestCounter::test_multiset_operations_equivalent_to_set_operations: ok")
