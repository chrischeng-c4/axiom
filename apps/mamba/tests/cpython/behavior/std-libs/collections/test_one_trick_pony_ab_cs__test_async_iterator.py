...
# lib = "collections"
# dimension = "behavior"
# case = "test_one_trick_pony_ab_cs__test_async_iterator"
# subject = "cpython.test_collections.TestOneTrickPonyABCs.test_AsyncIterator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestOneTrickPonyABCs::test_AsyncIterator
"""Auto-ported test: TestOneTrickPonyABCs::test_AsyncIterator (CPython 3.12 oracle)."""
...
assert issubclass(AI, AsyncIterator)
non_samples = [None, object, []]
for x in non_samples:

    assert not isinstance(x, AsyncIterator)

    assert not issubclass(type(x), AsyncIterator)
...
assert not isinstance(AnextOnly(), AsyncIterator)
validate_abstract_methods(AsyncIterator, '__anext__', '__aiter__')
print("TestOneTrickPonyABCs::test_AsyncIterator: ok")
