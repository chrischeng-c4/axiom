...
# lib = "collections"
# dimension = "behavior"
# case = "test_counter__test_gt"
# subject = "cpython.test_collections.TestCounter.test_gt"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestCounter::test_gt
"""Auto-ported test: TestCounter::test_gt (CPython 3.12 oracle)."""
...
assert Counter(a=3, b=2, c=0) > Counter('aab')

assert not Counter(a=2, b=1, c=0) > Counter('aab')
print("TestCounter::test_gt: ok")
