...
# lib = "collections"
# dimension = "behavior"
# case = "test_counter__test_invariant_for_the_in_operator"
# subject = "cpython.test_collections.TestCounter.test_invariant_for_the_in_operator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestCounter::test_invariant_for_the_in_operator
"""Auto-ported test: TestCounter::test_invariant_for_the_in_operator (CPython 3.12 oracle)."""
...
for elem in c:
    ...
    assert elem in c
print("TestCounter::test_invariant_for_the_in_operator: ok")
