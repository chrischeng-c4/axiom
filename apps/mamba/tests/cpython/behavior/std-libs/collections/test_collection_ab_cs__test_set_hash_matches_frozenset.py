...
# lib = "collections"
# dimension = "behavior"
# case = "test_collection_ab_cs__test_set_hash_matches_frozenset"
# subject = "cpython.test_collections.TestCollectionABCs.test_Set_hash_matches_frozenset"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestCollectionABCs::test_Set_hash_matches_frozenset
"""Auto-ported test: TestCollectionABCs::test_Set_hash_matches_frozenset (CPython 3.12 oracle)."""
...
for s in sets:
    ...
    assert hash(fs) == Set._hash(fs)
print("TestCollectionABCs::test_Set_hash_matches_frozenset: ok")
