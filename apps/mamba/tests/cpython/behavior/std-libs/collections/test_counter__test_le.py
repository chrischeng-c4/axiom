...
# lib = "collections"
# dimension = "behavior"
# case = "test_counter__test_le"
# subject = "cpython.test_collections.TestCounter.test_le"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestCounter::test_le
"""Auto-ported test: TestCounter::test_le (CPython 3.12 oracle)."""
...
assert Counter(a=3, b=2, c=0) <= Counter('ababa')

assert not Counter(a=3, b=2) <= Counter('babab')
print("TestCounter::test_le: ok")
