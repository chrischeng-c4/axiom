...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_maildir_message__test_date"
# subject = "cpython.test_mailbox.TestMaildirMessage.test_date"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMaildirMessage::test_date
"""Auto-ported test: TestMaildirMessage::test_date (CPython 3.12 oracle)."""
...
assert abs(msg.get_date() - time.time()) < 60
msg.set_date(0.0)

assert msg.get_date() == 0.0
print("TestMaildirMessage::test_date: ok")
