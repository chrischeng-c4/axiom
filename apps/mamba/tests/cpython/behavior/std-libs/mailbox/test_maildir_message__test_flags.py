...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_maildir_message__test_flags"
# subject = "cpython.test_mailbox.TestMaildirMessage.test_flags"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMaildirMessage::test_flags
"""Auto-ported test: TestMaildirMessage::test_flags (CPython 3.12 oracle)."""
...
assert msg.get_flags() == 'DPST'
msg.add_flag('FT')

assert msg.get_flags() == 'DFPST'
...
assert msg.get_subdir() == 'new'
_check_sample(msg)
print("TestMaildirMessage::test_flags: ok")
