...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_mboxmmdf_to_mh"
# subject = "cpython.test_mailbox.TestMessageConversion.test_mboxmmdf_to_mh"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_mboxmmdf_to_mh
"""Auto-ported test: TestMessageConversion::test_mboxmmdf_to_mh (CPython 3.12 oracle)."""
...
for class_ in (mailbox.mboxMessage, mailbox.MMDFMessage):
    ...
    for setting, result in pairs:
        ...
        assert mailbox.MHMessage(msg_mboxMMDF).get_sequences() == result
print("TestMessageConversion::test_mboxmmdf_to_mh: ok")
