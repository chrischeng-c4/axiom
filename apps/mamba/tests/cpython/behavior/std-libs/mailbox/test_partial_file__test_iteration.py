...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_partial_file__test_iteration"
# subject = "cpython.test_mailbox.TestPartialFile.test_iteration"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestPartialFile::test_iteration
"""Auto-ported test: TestPartialFile::test_iteration (CPython 3.12 oracle)."""
...
self__file.write(bytes('____foo%sbar%sfred%sbob####' % (os.linesep, os.linesep, os.linesep), 'ascii'))
_test_iteration(mailbox._PartialFile(self__file, 4, 17 + 3 * len(os.linesep)))
print("TestPartialFile::test_iteration: ok")
