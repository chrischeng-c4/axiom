...
# lib = "mailbox"
# dimension = "behavior"
# case = "maildir_test_case__test_empty_maildir"
# subject = "cpython.test_mailbox.MaildirTestCase.test_empty_maildir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::MaildirTestCase::test_empty_maildir
"""Auto-ported test: MaildirTestCase::test_empty_maildir (CPython 3.12 oracle)."""
...
# --- test body ---
self__dir = os_helper.TESTFN
if os.path.isdir(self__dir):
    os_helper.rmtree(self__dir)
elif os.path.isfile(self__dir):
    os_helper.unlink(self__dir)
os.mkdir(self__dir)
os.mkdir(os.path.join(self__dir, 'cur'))
os.mkdir(os.path.join(self__dir, 'tmp'))
os.mkdir(os.path.join(self__dir, 'new'))
self__counter = 1
self__msgfiles = []
'Test an empty maildir mailbox'
self_mbox = mailbox.Maildir(os_helper.TESTFN)

assert self_mbox.next() is None

assert self_mbox.next() is None
print("MaildirTestCase::test_empty_maildir: ok")
