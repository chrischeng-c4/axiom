...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_mh_to_mboxmmdf"
# subject = "cpython.test_mailbox.TestMessageConversion.test_mh_to_mboxmmdf"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_mh_to_mboxmmdf
"""Auto-ported test: TestMessageConversion::test_mh_to_mboxmmdf (CPython 3.12 oracle)."""
...
for class_ in (mailbox.mboxMessage, mailbox.MMDFMessage):
    ...
    assert class_(msg).get_flags() == 'OFA'
print("TestMessageConversion::test_mh_to_mboxmmdf: ok")
