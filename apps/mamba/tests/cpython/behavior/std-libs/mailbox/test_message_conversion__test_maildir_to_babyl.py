...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_maildir_to_babyl"
# subject = "cpython.test_mailbox.TestMessageConversion.test_maildir_to_babyl"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_maildir_to_babyl
"""Auto-ported test: TestMessageConversion::test_maildir_to_babyl (CPython 3.12 oracle)."""
...
for setting, result in pairs:
    ...
    assert mailbox.BabylMessage(msg_maildir).get_labels() == result
print("TestMessageConversion::test_maildir_to_babyl: ok")
