...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_type_specific_attributes_removed_on_conversion"
# subject = "cpython.test_mailbox.TestMessageConversion.test_type_specific_attributes_removed_on_conversion"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_type_specific_attributes_removed_on_conversion
"""Auto-ported test: TestMessageConversion::test_type_specific_attributes_removed_on_conversion (CPython 3.12 oracle)."""
...
reference = {class_: class_(_sample_message).__dict__ for class_ in all_mailbox_types}
for class1 in all_mailbox_types:
    for class2 in all_mailbox_types:
        if class1 is class2:
            continue
        ...
        for attr in type_specific:
            ...
            assert attr not in target.__dict__
print("TestMessageConversion::test_type_specific_attributes_removed_on_conversion: ok")
