...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_maildir_to_maildir"
# subject = "cpython.test_mailbox.TestMessageConversion.test_maildir_to_maildir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_maildir_to_maildir
"""Auto-ported test: TestMessageConversion::test_maildir_to_maildir (CPython 3.12 oracle)."""
...
assert msg.get_flags() == 'DFPRST'

assert msg.get_subdir() == 'cur'

assert msg.get_date() == date
print("TestMessageConversion::test_maildir_to_maildir: ok")
