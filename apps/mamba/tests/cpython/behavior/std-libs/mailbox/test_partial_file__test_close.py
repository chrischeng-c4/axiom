...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_partial_file__test_close"
# subject = "cpython.test_mailbox.TestPartialFile.test_close"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestPartialFile::test_close
"""Auto-ported test: TestPartialFile::test_close (CPython 3.12 oracle)."""
...
_test_close(mailbox._PartialFile(self__file, 1, 6 + 3 * len(os.linesep)))
print("TestPartialFile::test_close: ok")
