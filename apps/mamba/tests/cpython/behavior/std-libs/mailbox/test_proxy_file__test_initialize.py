...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_proxy_file__test_initialize"
# subject = "cpython.test_mailbox.TestProxyFile.test_initialize"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestProxyFile::test_initialize
"""Auto-ported test: TestProxyFile::test_initialize (CPython 3.12 oracle)."""
...
self__file.write(b'foo')
pos = self__file.tell()
proxy0 = mailbox._ProxyFile(self__file)

assert proxy0.tell() == pos

assert self__file.tell() == pos
proxy1 = mailbox._ProxyFile(self__file, 0)

assert proxy1.tell() == 0

assert self__file.tell() == pos
print("TestProxyFile::test_initialize: ok")
