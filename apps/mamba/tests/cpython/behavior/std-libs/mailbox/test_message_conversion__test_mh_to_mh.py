...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_mh_to_mh"
# subject = "cpython.test_mailbox.TestMessageConversion.test_mh_to_mh"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_mh_to_mh
"""Auto-ported test: TestMessageConversion::test_mh_to_mh (CPython 3.12 oracle)."""
...
assert mailbox.MHMessage(msg).get_sequences() == ['unseen', 'replied', 'flagged']
print("TestMessageConversion::test_mh_to_mh: ok")
