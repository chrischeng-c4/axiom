...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_maildir_to_mboxmmdf"
# subject = "cpython.test_mailbox.TestMessageConversion.test_maildir_to_mboxmmdf"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_maildir_to_mboxmmdf
"""Auto-ported test: TestMessageConversion::test_maildir_to_mboxmmdf (CPython 3.12 oracle)."""
...
for class_ in (mailbox.mboxMessage, mailbox.MMDFMessage):
    ...
    for setting, result in pairs:
        ...
        assert msg.get_flags() == result

        assert msg.get_from() == 'MAILER-DAEMON %s' % time.asctime(time.gmtime(0.0))

        assert msg.get_unixfrom() is None
    msg_maildir.set_subdir('cur')

    assert class_(msg_maildir).get_flags() == 'RODFA'
print("TestMessageConversion::test_maildir_to_mboxmmdf: ok")
