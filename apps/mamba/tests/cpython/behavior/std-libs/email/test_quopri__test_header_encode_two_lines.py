...
# lib = "email"
# dimension = "behavior"
# case = "test_quopri__test_header_encode_two_lines"
# subject = "cpython.test_email.TestQuopri.test_header_encode_two_lines"
# kind = "semantic"
...
_test_header_encode(b'hello\nworld', '=?iso-8859-1?q?hello=0Aworld?=')

print("TestQuopri::test_header_encode_two_lines: ok")
