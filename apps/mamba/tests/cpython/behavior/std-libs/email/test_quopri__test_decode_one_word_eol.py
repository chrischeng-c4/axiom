...
# lib = "email"
# dimension = "behavior"
# case = "test_quopri__test_decode_one_word_eol"
# subject = "cpython.test_email.TestQuopri.test_decode_one_word_eol"
# kind = "semantic"
...
_test_decode('hello', 'hello', eol='X')

print("TestQuopri::test_decode_one_word_eol: ok")
