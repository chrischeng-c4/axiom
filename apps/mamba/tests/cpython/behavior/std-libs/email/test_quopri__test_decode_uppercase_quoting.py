...
# lib = "email"
# dimension = "behavior"
# case = "test_quopri__test_decode_uppercase_quoting"
# subject = "cpython.test_email.TestQuopri.test_decode_uppercase_quoting"
# kind = "semantic"
...
_test_decode('ab=CD=EF', 'abÍï')

print("TestQuopri::test_decode_uppercase_quoting: ok")
