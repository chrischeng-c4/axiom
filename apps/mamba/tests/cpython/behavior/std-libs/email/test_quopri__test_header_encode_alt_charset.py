...
# lib = "email"
# dimension = "behavior"
# case = "test_quopri__test_header_encode_alt_charset"
# subject = "cpython.test_email.TestQuopri.test_header_encode_alt_charset"
# kind = "semantic"
...
_test_header_encode(b'hello', '=?iso-8859-2?q?hello?=', charset='iso-8859-2')

print("TestQuopri::test_header_encode_alt_charset: ok")
