...
# lib = "email"
# dimension = "behavior"
# case = "test_quopri__test_quopri_header_check"
# subject = "cpython.test_email.TestQuopri.test_quopri_header_check"
# kind = "semantic"
...
for c in self_hlit:
    assert not quoprimime.header_check(c)
for c in self_hnon:
    assert quoprimime.header_check(c)

print("TestQuopri::test_quopri_header_check: ok")
