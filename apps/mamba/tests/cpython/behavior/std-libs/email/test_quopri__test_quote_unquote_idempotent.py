...
# lib = "email"
# dimension = "behavior"
# case = "test_quopri__test_quote_unquote_idempotent"
# subject = "cpython.test_email.TestQuopri.test_quote_unquote_idempotent"
# kind = "semantic"
...
for x in range(256):
    c = chr(x)
    assert quoprimime.unquote(quoprimime.quote(c)) == c

print("TestQuopri::test_quote_unquote_idempotent: ok")
