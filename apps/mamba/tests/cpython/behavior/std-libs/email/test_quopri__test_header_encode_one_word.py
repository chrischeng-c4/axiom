...
# lib = "email"
# dimension = "behavior"
# case = "test_quopri__test_header_encode_one_word"
# subject = "cpython.test_email.TestQuopri.test_header_encode_one_word"
# kind = "semantic"
...
_test_header_encode(b'hello', '=?iso-8859-1?q?hello?=')

print("TestQuopri::test_header_encode_one_word: ok")
