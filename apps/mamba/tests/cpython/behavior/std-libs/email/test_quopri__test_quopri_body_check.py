...
# lib = "email"
# dimension = "behavior"
# case = "test_quopri__test_quopri_body_check"
# subject = "cpython.test_email.TestQuopri.test_quopri_body_check"
# kind = "semantic"
...
for c in self_blit:
    assert not quoprimime.body_check(c)
for c in self_bnon:
    assert quoprimime.body_check(c)

print("TestQuopri::test_quopri_body_check: ok")
