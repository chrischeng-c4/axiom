...
# lib = "email"
# dimension = "behavior"
# case = "test_quopri__test_encode_quoted_equals"
# subject = "cpython.test_email.TestQuopri.test_encode_quoted_equals"
# kind = "semantic"
...
_test_encode('a = b', 'a =3D b')

print("TestQuopri::test_encode_quoted_equals: ok")
