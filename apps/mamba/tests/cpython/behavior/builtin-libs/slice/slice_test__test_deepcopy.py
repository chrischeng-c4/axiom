...
# lib = "slice"
# dimension = "behavior"
# case = "slice_test__test_deepcopy"
# subject = "cpython.test_slice.SliceTest.test_deepcopy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_slice.py::SliceTest::test_deepcopy
"""Auto-ported test: SliceTest::test_deepcopy (CPython 3.12 oracle)."""
...
assert s.start is not c.start

assert s.stop is not c.stop

assert s.step is not c.step
print("SliceTest::test_deepcopy: ok")
