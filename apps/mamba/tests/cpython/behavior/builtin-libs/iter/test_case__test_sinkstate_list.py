...
# lib = "iter"
# dimension = "behavior"
# case = "test_case__test_sinkstate_list"
# subject = "cpython.test_iter.TestCase.test_sinkstate_list"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_iter.py::TestCase::test_sinkstate_list
"""Auto-ported test: TestCase::test_sinkstate_list (CPython 3.12 oracle)."""
...
assert list(b) == []
print("TestCase::test_sinkstate_list: ok")
