...
# lib = "iter"
# dimension = "behavior"
# case = "test_case__test_builtin_max_min"
# subject = "cpython.test_iter.TestCase.test_builtin_max_min"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_iter.py::TestCase::test_builtin_max_min
"""Auto-ported test: TestCase::test_builtin_max_min (CPython 3.12 oracle)."""
...
assert max(SequenceClass(5)) == 4

assert min(SequenceClass(5)) == 0
...
try:
    ...
    assert min(f) == 'itty-bitty line\n'
    f.seek(0, 0)

    assert max(f) == 'xtra large line\n'
finally:
    f.close()
    try:
        unlink(TESTFN)
        ...
        pass
print("TestCase::test_builtin_max_min: ok")
