...
# lib = "iter"
# dimension = "behavior"
# case = "test_case__test_iter_function"
# subject = "cpython.test_iter.TestCase.test_iter_function"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_iter.py::TestCase::test_iter_function
"""Auto-ported test: TestCase::test_iter_function (CPython 3.12 oracle)."""
...
def spam(state=[0]):
    ...
    state[0] = i + 1
    return i
check_iterator(iter(spam, 10), list(range(10)), pickle=False)
print("TestCase::test_iter_function: ok")
