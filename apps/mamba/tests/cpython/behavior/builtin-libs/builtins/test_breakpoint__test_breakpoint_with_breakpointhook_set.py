...
# lib = "builtins"
# dimension = "behavior"
# case = "test_breakpoint__test_breakpoint_with_breakpointhook_set"
# subject = "cpython.test_builtin.TestBreakpoint.test_breakpoint_with_breakpointhook_set"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_builtin.py::TestBreakpoint::test_breakpoint_with_breakpointhook_set
"""Auto-ported test: TestBreakpoint::test_breakpoint_with_breakpointhook_set (CPython 3.12 oracle)."""
...
# --- test body ---
self_resources = ExitStack()
pass
self_env = self_resources.enter_context(EnvironmentVarGuard())
del self_env['PYTHONBREAKPOINT']
self_resources.enter_context(swap_attr(sys, 'breakpointhook', sys.__breakpointhook__))
my_breakpointhook = MagicMock()
sys.breakpointhook = my_breakpointhook
breakpoint()
my_breakpointhook.assert_called_once_with()
print("TestBreakpoint::test_breakpoint_with_breakpointhook_set: ok")
