...
# lib = "builtins"
# dimension = "behavior"
# case = "builtin_test__test_bytearray_translate"
# subject = "cpython.test_builtin.BuiltinTest.test_bytearray_translate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::BuiltinTest::test_bytearray_translate
"""Auto-ported test: BuiltinTest::test_bytearray_translate (CPython 3.12 oracle)."""
...
try:
    x.translate(b'1' * 256, 1)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("BuiltinTest::test_bytearray_translate: ok")
