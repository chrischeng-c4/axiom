...
# lib = "builtins"
# dimension = "behavior"
# case = "test_breakpoint__test_envar_good_path_empty_string"
# subject = "cpython.test_builtin.TestBreakpoint.test_envar_good_path_empty_string"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::TestBreakpoint::test_envar_good_path_empty_string
"""Auto-ported test: TestBreakpoint::test_envar_good_path_empty_string (CPython 3.12 oracle)."""
...
self_env['PYTHONBREAKPOINT'] = ''
with patch('pdb.set_trace') as mock:
    breakpoint()
    mock.assert_called_once_with()
print("TestBreakpoint::test_envar_good_path_empty_string: ok")
