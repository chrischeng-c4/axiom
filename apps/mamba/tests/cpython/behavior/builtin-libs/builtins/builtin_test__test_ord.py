...
# lib = "builtins"
# dimension = "behavior"
# case = "builtin_test__test_ord"
# subject = "cpython.test_builtin.BuiltinTest.test_ord"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::BuiltinTest::test_ord
"""Auto-ported test: BuiltinTest::test_ord (CPython 3.12 oracle)."""
...
assert ord(chr(sys.maxunicode)) == sys.maxunicode
...
assert ord('\U000ffffe') == 1048574

assert ord('\U000fffff') == 1048575

assert ord('\U00100000') == 1048576

assert ord('\U00100001') == 1048577

assert ord('\U0010fffe') == 1114110

assert ord('\U0010ffff') == 1114111
print("BuiltinTest::test_ord: ok")
