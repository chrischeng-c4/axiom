...
# lib = "bytes"
# dimension = "behavior"
# case = "byte_array_test__test_ord"
# subject = "cpython.test_bytes.ByteArrayTest.test_ord"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bytes.py::ByteArrayTest::test_ord
"""Auto-ported test: ByteArrayTest::test_ord (CPython 3.12 oracle)."""
...
b = type2test(b'\x00A\x7f\x80\xff')

assert [ord(b[i:i + 1]) for i in range(len(b))] == [0, 65, 127, 128, 255]
print("ByteArrayTest::test_ord: ok")
