...
# lib = "bytes"
# dimension = "behavior"
# case = "byte_array_test__test_endswith"
# subject = "cpython.test_bytes.ByteArrayTest.test_endswith"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bytes.py::ByteArrayTest::test_endswith
"""Auto-ported test: ByteArrayTest::test_endswith (CPython 3.12 oracle)."""
...
assert not bytearray().endswith(b'anything')
...
assert 'tuple' in exc
print("ByteArrayTest::test_endswith: ok")
