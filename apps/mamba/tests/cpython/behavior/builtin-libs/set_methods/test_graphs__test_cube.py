...
# lib = "set_methods"
# dimension = "behavior"
# case = "test_graphs__test_cube"
# subject = "cpython.test_set.TestGraphs.test_cube"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_set.py::TestGraphs::test_cube
"""Auto-ported test: TestGraphs::test_cube (CPython 3.12 oracle)."""
...
assert len(cubefaces) == 6
for face in cubefaces:

    assert len(face) == 4
print("TestGraphs::test_cube: ok")
