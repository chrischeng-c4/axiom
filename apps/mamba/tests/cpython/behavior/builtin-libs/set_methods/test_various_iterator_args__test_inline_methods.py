...
# lib = "set_methods"
# dimension = "behavior"
# case = "test_various_iterator_args__test_inline_methods"
# subject = "cpython.test_set.TestVariousIteratorArgs.test_inline_methods"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_set.py::TestVariousIteratorArgs::test_inline_methods
"""Auto-ported test: TestVariousIteratorArgs::test_inline_methods (CPython 3.12 oracle)."""
...
for data in ('123', '', range(1000), ('do', 1.2), range(2000, 2200, 5), 'december'):
    for meth in (s.union, s.intersection, s.difference, s.symmetric_difference, s.isdisjoint):
        ...
        try:
            ...
            pass
print("TestVariousIteratorArgs::test_inline_methods: ok")
