...
# lib = "dict_methods"
# dimension = "behavior"
# case = "dict_test__test_track_literals"
# subject = "cpython.test_dict.DictTest.test_track_literals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dict.py::DictTest::test_track_literals
"""Auto-ported test: DictTest::test_track_literals (CPython 3.12 oracle)."""
...
_not_tracked({})
_not_tracked({x: (), y: x, z: 1})
_not_tracked({1: 'a', 'b': 2})
_not_tracked({1: 2, (None, True, False, ()): int})
_not_tracked({1: object()})
_tracked({1: []})
_tracked({1: ([],)})
_tracked({1: {}})
_tracked({1: set()})
print("DictTest::test_track_literals: ok")
