...
struct ImplHolder;
impl ImplHolder {
    fn impl_conversion(&self, value: MbValue) -> MbValue {
        let raw = 7;
...
impl ImplHolder {
    fn second_impl_conversion(&self, value: MbValue) -> MbValue {
        let raw = 8;
        MbValue::from_int(raw as i64)
    }
}
trait SecondConversionTrait {
    fn second_trait_conversion(&self, value: MbValue) -> MbValue {
        let raw = 9;
        MbValue::from_int(raw as i64)
    }
}
