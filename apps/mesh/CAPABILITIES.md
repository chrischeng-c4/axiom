...
Machine-readable capability contract for Mesh, the relationship/property-graph
service in the Axiom service stack.

## Capabilities

Markdown capability headings and tables below are machine-readable input for
