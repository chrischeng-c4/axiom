// SPEC-MANAGED: apps/arena/tech-design/semantic/source/projects-arena-src-engine-rs.md#rust-source-unit
// CODEGEN-BEGIN
...
/// @spec apps/arena/tech-design/semantic/source/projects-arena-src-engine-rs.md#source
pub struct RunOpts {
