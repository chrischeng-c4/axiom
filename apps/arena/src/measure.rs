// SPEC-MANAGED: apps/arena/tech-design/semantic/source/projects-arena-src-measure-rs.md#rust-source-unit
// CODEGEN-BEGIN
...
/// @spec apps/arena/tech-design/semantic/source/projects-arena-src-measure-rs.md#source
pub fn measure(
    target: &TargetSpec,
    cell: &CellTarget,
    load: &LoadShape,
