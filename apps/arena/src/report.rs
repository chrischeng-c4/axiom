// SPEC-MANAGED: apps/arena/tech-design/semantic/source/projects-arena-src-report-rs.md#rust-source-unit
// CODEGEN-BEGIN
...
/// @spec apps/arena/tech-design/semantic/source/projects-arena-src-report-rs.md#source
pub struct PeerCell {
    pub target: String,
