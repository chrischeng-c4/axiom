// SPEC-MANAGED: apps/arena/tech-design/semantic/source/projects-arena-src-spec-rs.md#rust-source-unit
// CODEGEN-BEGIN
...
/// @spec apps/arena/tech-design/semantic/source/projects-arena-src-spec-rs.md#source
pub struct Spec {
