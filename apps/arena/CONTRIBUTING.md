...
How to change `apps/arena`. What it promises and the work roots it owns live in
...
`arena-qa` runs the declared complete gate. The controller owns Git, tracker,
...
| Gate | Command |
|---|---|
| unit + colocated tests | `cargo test -p arena` |
