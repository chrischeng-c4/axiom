...
summary: Source coverage for apps/cap/src/resident_shell.rs resident command-string execution.
...
# Source TD: apps/cap/src/resident_shell.rs
...
changes:
  - path: "apps/cap/src/resident_shell.rs"
    action: modify
    section: source
    description: |
