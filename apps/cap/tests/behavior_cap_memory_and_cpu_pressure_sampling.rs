// SPEC-MANAGED: apps/cap/tech-design/logic/external-contracts.md#cap-memory-and-cpu-pressure-sampling
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
fn cap_memory_and_cpu_pressure_sampling() {
    let command = "cargo test -p cap --lib sampler -- --nocapture";
