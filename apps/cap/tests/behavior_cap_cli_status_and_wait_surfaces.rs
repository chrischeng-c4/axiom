// SPEC-MANAGED: apps/cap/tech-design/logic/external-contracts.md#cap-cli-status-and-wait-surfaces
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
fn cap_cli_status_and_wait_surfaces() {
    let command = "cargo test -p cap --lib cli -- --nocapture";
