// SPEC-MANAGED: apps/cap/tech-design/logic/external-contracts.md#cap-hook-payload-rewrite-adapters
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
fn cap_hook_payload_rewrite_adapters() {
    let command = "cargo test -p cap --lib hook -- --nocapture";
