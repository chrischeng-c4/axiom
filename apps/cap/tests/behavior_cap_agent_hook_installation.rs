// SPEC-MANAGED: apps/cap/tech-design/logic/external-contracts.md#cap-agent-hook-installation
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
fn cap_agent_hook_installation() {
    let command =
        "cargo test -p cap --lib hook_install -- --nocapture && cargo test -p cap hook -- --nocapture";
