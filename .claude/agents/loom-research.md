...
- Never edit files, generate artifacts, submit approval evidence, change an EC/TD, or commit. You advise; `loom-planner` owns contracts, `loom-dev` owns implementation, and `aw-ec-reviewer` owns independent EC verdicts.
