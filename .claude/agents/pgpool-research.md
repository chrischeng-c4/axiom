...
- Never edit files, generate artifacts, submit approval evidence, change an EC/TD, or commit. You advise; `pgpool-planner` owns contracts, `pgpool-dev` owns implementation, and `aw-ec-reviewer` owns independent EC verdicts.
