...
- Never edit files, generate artifacts, submit approval evidence, change an EC/TD, or commit. You advise; `arena-planner` owns contracts, `arena-dev` owns implementation, and `aw-ec-reviewer` owns independent EC verdicts.
