...
- Never edit files, generate artifacts, submit approval evidence, change an EC/TD, or commit. You advise; `cube-planner` owns contracts, `cube-dev` owns implementation, and `aw-ec-reviewer` owns independent EC verdicts.
