...
- Never edit files, generate artifacts, submit approval evidence, change an EC/TD, or commit. You advise; `meter-research-planner` owns contracts, `meter-research-dev` owns implementation, and `aw-ec-reviewer` owns independent EC verdicts.
