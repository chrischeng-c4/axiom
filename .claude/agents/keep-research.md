...
- Never edit files, generate artifacts, submit approval evidence, change an EC/TD, or commit. You advise; `keep-planner` owns contracts, `keep-dev` owns implementation, and `aw-ec-reviewer` owns independent EC verdicts.
