...
|---|---:|---|---|---|---|
| package-manager | #3779 | auditing | Jet can replace npm/pnpm/Bun package-management flows. | smoke, conformance, corpus, negative | projects/jet/validation/pkg-manager.toml |
