---
id: cap-source-cli
summary: Source replay payload for projects/cap/src/cli.rs
...
# Source TD: projects/cap/src/cli.rs
...
| Symbol | Coverage |
|---|---|
| `AgentArg` | public Rust symbol in `projects/cap/src/cli.rs` |
| `Cli` | public Rust symbol in `projects/cap/src/cli.rs` |
| `Cmd` | public Rust symbol in `projects/cap/src/cli.rs` |
| `ConfigCmd` | public Rust symbol in `projects/cap/src/cli.rs` |
| `DaemonCmd` | public Rust symbol in `projects/cap/src/cli.rs` |
| `HookCmd` | public Rust symbol in `projects/cap/src/cli.rs` |
| `RunArgs` | public Rust symbol in `projects/cap/src/cli.rs` |
| `run` | public Rust symbol in `projects/cap/src/cli.rs` |
...
changes:
  - path: "projects/cap/src/cli.rs"
    ...
    replaces:
      - "<handwrite-tracker:projects-cap-src-cli-rs-source-replay-superseded>"
```
