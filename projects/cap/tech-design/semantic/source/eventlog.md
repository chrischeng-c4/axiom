...
summary: Source replay payload for projects/cap/src/eventlog.rs
...
# Source TD: projects/cap/src/eventlog.rs
...
| Symbol | Coverage |
|---|---|
| `EventLog` | public Rust symbol in `projects/cap/src/eventlog.rs` |
| `RunRecord` | public Rust symbol in `projects/cap/src/eventlog.rs` |
| `append` | public Rust symbol in `projects/cap/src/eventlog.rs` |
| `new` | public Rust symbol in `projects/cap/src/eventlog.rs` |
