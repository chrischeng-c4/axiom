---
id: projects-cap-benches-command_resources-rs
summary: Lossless rust-source-unit coverage for `projects/cap/benches/command_resources.rs`.
capability_refs:
  - id: agent-hook-installation
    role: primary
    claim: hook-payload-rewrite-adapters
    coverage: full
    rationale: "The resource benchmark verifies cap hook command replacements against original-command CPU and RSS contracts."
fill_sections: [overview, rust-source-unit, changes]
---

# Standardized projects/cap/benches/command_resources.rs

## Overview
<!-- type: overview lang: markdown -->

Lossless rust-source-unit coverage for `projects/cap/benches/command_resources.rs`.
...
changes:
  - path: "projects/cap/benches/command_resources.rs"
    ...
    impl_mode: codegen
    description: |
      Lossless rust-source-unit ownership for the cap command resource benchmark.
```
