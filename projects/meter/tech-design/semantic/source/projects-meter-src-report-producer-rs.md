---
id: projects-meter-src-report-producer-rs
...
# Standardized projects/meter/src/report/producer.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/meter/src/report/producer.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `InjectionHit` | projects/meter/src/report/producer.rs | struct | pub | 364 |  |
| `fuzz_crash_finding` | projects/meter/src/report/producer.rs | function | pub | 383 | fuzz_crash_finding(     target: &str,     crash: &crate::security::FuzzCrash,     strategy: &str,     seed: u64, ) -> Finding |
| `generic_test_failure` | projects/meter/src/report/producer.rs | function | pub | 91 | generic_test_failure(target: &str, exit_code: i32) -> Finding |
| `hash8` | projects/meter/src/report/producer.rs | function | pub | 350 | hash8(bytes: &[u8]) -> String |
