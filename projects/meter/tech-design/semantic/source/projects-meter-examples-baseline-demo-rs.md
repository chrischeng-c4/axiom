...
# Standardized projects/meter/examples/baseline_demo.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/meter/examples/baseline_demo.rs` generated from AST during Score force-regeneration standardization.
