...
# Standardized projects/meter/src/capture/run.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/meter/src/capture/run.rs` generated from AST during Score force-regeneration standardization.
