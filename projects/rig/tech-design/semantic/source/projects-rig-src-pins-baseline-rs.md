...
# Standardized projects/rig/src/pins/baseline.rs
...
```yaml
changes:
  - path: projects/rig/src/pins/baseline.rs
    action: modify
    section: rust-source-unit
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `projects/rig/src/pins/baseline.rs` captured during rig
