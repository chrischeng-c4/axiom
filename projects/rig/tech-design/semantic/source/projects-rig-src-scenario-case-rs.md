---
id: projects-rig-src-scenario-case-rs
capability_refs:
  - id: scenario-engine
    role: primary
...
# Standardized projects/rig/src/scenario/case.rs

## Overview
<!-- type: overview lang: markdown -->

Rust source-unit TD for `projects/rig/src/scenario/case.rs`, captured during #39 rig traceability closure.
...
changes:
  - path: projects/rig/src/scenario/case.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `projects/rig/src/scenario/case.rs` captured during #39 rig standardization.
```
