...
# Standardized projects/rig/src/discovery.rs
...
```yaml
changes:
  - path: projects/rig/src/discovery.rs
    action: modify
    section: rust-source-unit
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `projects/rig/src/discovery.rs` captured during rig
