...
Public API manifest for `projects/rig/src/engine/exec.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ExecOutcome` | projects/rig/src/engine/exec.rs | struct | pub | 15 |  |
| `execute` | projects/rig/src/engine/exec.rs | function | pub | 24 | execute(step: &ExecStep, vars: &VarStore) -> Result<ExecOutcome, String> |
## Source
