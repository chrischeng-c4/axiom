...
`projects/tape/install.sh` downloads a `tape@*` release asset for the detected
...
---
flowchart TD
    start["projects/tape/install.sh"] --> target["detect target from uname"]
