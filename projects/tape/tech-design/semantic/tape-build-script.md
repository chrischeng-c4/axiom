...
`projects/tape/build.sh` provides the project-local debug/release build and
...
---
flowchart TD
    mode["projects/tape/build.sh <debug|release>"] --> debug{"debug?"}
