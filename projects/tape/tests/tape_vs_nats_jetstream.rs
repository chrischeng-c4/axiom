// SPEC-MANAGED: projects/tape/tech-design/semantic/source/projects-tape-tests-tape-vs-nats-jetstream-rs.md#unit-test
...
async fn tape_beats_nats_jetstream_on_local_backlog_replay() {
    ...
    let report = tape::bench::external_replay_win(
        ...
        "projects/tape/tests/tape_vs_nats_jetstream.rs starts real nats-server -js and compares JetStream replay to Tape zero-copy replay_refs",
    );
