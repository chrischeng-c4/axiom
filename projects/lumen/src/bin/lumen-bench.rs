// HANDWRITE-BEGIN gap="missing-generator:logic:c169f844" tracker="pending-tracker" reason="Implement `lumen-bench run --types sorted_page_deep` with keyset deep-page p50/p99 reporting."
