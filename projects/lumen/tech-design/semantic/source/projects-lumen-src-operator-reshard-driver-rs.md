...
|------|--------|------|------------|------|-----------|
| `DriveOutcome` | projects/lumen/src/operator/reshard_driver.rs | enum | pub | 401 |  |
| `KubeClusterControl` | projects/lumen/src/operator/reshard_driver.rs | struct | pub | 283 |  |
| `compute_target_map` | projects/lumen/src/operator/reshard_driver.rs | function | pub | 507 | compute_target_map(current: &VirtualBucketShardMap) -> Result<VirtualBucketShardMap> |
| `current_shard_map` | projects/lumen/src/operator/reshard_driver.rs | function | pub | 492 | current_shard_map(lumen: &Lumen) -> Result<VirtualBucketShardMap> |
...
| `drive_tick` | projects/lumen/src/operator/reshard_driver.rs | function | pub | 1303 | drive_tick(     control: &dyn ClusterControl,     http: &reqwest::Client,     lumen: &Lumen, ) -> DriveOutcome |
| `new` | projects/lumen/src/operator/reshard_driver.rs | function | pub | 289 | new(client: Client) -> Self |
| `run_migration_pass` | projects/lumen/src/operator/reshard_driver.rs | function | pub | 794 | run_migration_pass(     control: &dyn ClusterControl,     http: &reqwest::Client,     namespace: &str,     name: &str,     lumen: &Lumen, ) -> Result<usize> |
| `should_start_split` | projects/lumen/src/operator/reshard_driver.rs | function | pub | 429 | #1396 R5: also requires `status.reshard.usage_measured_at_map_version == spec.shardMap.version` — a lagging/stale status subresource can never start a split. should_start_split(lumen: &Lumen) -> bool |
| `spawn_reshard_driver_loop` | projects/lumen/src/operator/reshard_driver.rs | function | pub | 1340 | spawn_reshard_driver_loop(client: Client) |
