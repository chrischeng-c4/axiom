...
capability_refs:
  - id: long-running-stability
    ...
    coverage: partial
    rationale: "Relay-backed WalLog source-unit for log fan-out and rebuild-from-log."
---
...
changes:
  - path: projects/lumen/src/wal_relay.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `projects/lumen/src/wal_relay.rs` captured during #39 lumen standardization.
```
