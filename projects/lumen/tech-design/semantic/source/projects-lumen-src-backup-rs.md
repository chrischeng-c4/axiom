...
# Standardized projects/lumen/src/backup.rs
...
|------|--------|------|------------|------|-----------|
| `run_backup` | projects/lumen/src/backup.rs | function | pub async | 21 | run_backup(base_url: &str, token: Option<&str>, dest: &BackupDestination, retention: &RetentionPolicy) -> Result<BackupRunResult> |
