---
id: lumen-long-running-stability-meta-api-ec
summary: Long-running stability meta API — liveness, readiness (drain-aware), Prometheus metrics, and version are exposed, auth-bypassed, and k8s-probe aligned.
...
```yaml
e2e_tests:
  - id: lumen-long-running-stability-meta-api
