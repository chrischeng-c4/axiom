...
// Contract: A late or second node can replay the published write stream and converge with live writes; shard-group raft bootstrap receives dedicated follow-up proof under issue #1181.
#[test]
