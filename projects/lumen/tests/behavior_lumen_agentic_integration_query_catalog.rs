// SPEC-MANAGED: projects/lumen/external-contracts/behavior/agentic-integration.md#lumen-agentic-integration-query-catalog
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
fn lumen_agentic_integration_query_catalog() {
    panic!("AW EC placeholder for lumen-agentic-integration-query-catalog");
}
// CODEGEN-END
