// SPEC-MANAGED: projects/lumen/external-contracts/agentic-integration/behavior/agentic-integration.md#lumen-agentic-integration-offline-cli
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
fn lumen_agentic_integration_offline_cli() {
    panic!("AW EC placeholder for lumen-agentic-integration-offline-cli");
}
// CODEGEN-END
