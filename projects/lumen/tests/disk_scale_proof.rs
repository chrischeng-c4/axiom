// <HANDWRITE gap="standardize:claim-code" tracker="projects-lumen-tests-disk-scale-proof-rs" reason="Existing code claimed during Score standardization until deterministic generator coverage lands.">
