...
summary: Source replay payload for projects/vat/src/commands/snapshot.rs
...
# Source TD: projects/vat/src/commands/snapshot.rs
...
changes:
  - path: "projects/vat/src/commands/snapshot.rs"
    ...
    replaces:
      - "<handwrite-tracker:projects-vat-src-commands-snapshot-rs-source-replay-superseded>"
```
