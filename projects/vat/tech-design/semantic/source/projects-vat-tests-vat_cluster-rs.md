---
id: projects-vat-tests-vat_cluster-rs
summary: >
  rust-source-unit TD AST payload for projects/vat/tests/vat_cluster.rs.
...
# Standardized projects/vat/tests/vat_cluster.rs
...
changes:
  - path: projects/vat/tests/vat_cluster.rs
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `projects/vat/tests/vat_cluster.rs` captured during #39 vat standardization.
```
