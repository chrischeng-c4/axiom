...
// HANDWRITE-BEGIN gap="standardize:projects-jet-src-codegen-client-emit-rs" tracker="pending-tracker" reason="Existing hand-written code in projects/jet/src/codegen/client_emit.rs requires tracked generator coverage."
