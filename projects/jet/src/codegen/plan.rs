...
// HANDWRITE-BEGIN gap="standardize:projects-jet-src-codegen-plan-rs" tracker="pending-tracker" reason="Existing hand-written code in projects/jet/src/codegen/plan.rs requires tracked generator coverage."
