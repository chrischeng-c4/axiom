...
|------|--------|------|------------|------|-----------|
| `PolicyProfile` | projects/guard/src/scan.rs | enum | pub | 14 |  |
| `ScanOptions` | projects/guard/src/scan.rs | struct | pub | 43 |  |
| `as_str` | projects/guard/src/scan.rs | function | pub | 22 | as_str(self) -> &'static str |
| `default_languages` | projects/guard/src/scan.rs | function | pub | 68 | default_languages() -> Vec<Language> |
| `from_config_str` | projects/guard/src/scan.rs | function | pub | 31 | from_config_str(value: &str) -> Option<Self> |
| `scan_path` | projects/guard/src/scan.rs | function | pub | 87 | scan_path(path: impl AsRef<Path>) -> GuardReport |
| `scan_path_with_options` | projects/guard/src/scan.rs | function | pub | 92 | scan_path_with_options(path: impl AsRef<Path>, options: ScanOptions) -> GuardReport |
| `scan_paths` | projects/guard/src/scan.rs | function | pub | 97 | scan_paths(paths: &[PathBuf]) -> GuardReport |
| `scan_paths_with_options` | projects/guard/src/scan.rs | function | pub | 102 | scan_paths_with_options(targets: &[PathBuf], options: ScanOptions) -> GuardReport |
## Source
