...
|------|--------|------|------------|------|-----------|
| `GuardCommand` | projects/guard/guard-cli/src/dispatch.rs | struct | pub | 18 |  |
| `OutputOpts` | projects/guard/guard-cli/src/dispatch.rs | struct | pub | 27 |  |
| `ProfileArg` | projects/guard/guard-cli/src/dispatch.rs | enum | pub | 65 |  |
| `ScanArgs` | projects/guard/guard-cli/src/dispatch.rs | struct | pub | 51 |  |
| `Verb` | projects/guard/guard-cli/src/dispatch.rs | enum | pub | 38 |  |
| `dispatch` | projects/guard/guard-cli/src/dispatch.rs | function | pub | 83 | dispatch(cmd: GuardCommand) -> GuardReport |
| `print_report` | projects/guard/guard-cli/src/dispatch.rs | function | pub | 136 | print_report(report: &GuardReport, out: &OutputOpts) |
## Source
