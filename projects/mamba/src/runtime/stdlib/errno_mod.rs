...
pub fn register() {
    ...
    attrs.insert("EBADMACHO".into(), MbValue::from_int(88));
    attrs.insert("EBADRPC".into(), MbValue::from_int(72));
    attrs.insert("EDEVERR".into(), MbValue::from_int(83));
    attrs.insert("EDQUOT".into(), MbValue::from_int(69));
    attrs.insert("EFTYPE".into(), MbValue::from_int(79));
    attrs.insert("ENEEDAUTH".into(), MbValue::from_int(81));
    attrs.insert("ENOATTR".into(), MbValue::from_int(93));
    attrs.insert("ENOPOLICY".into(), MbValue::from_int(103));
    attrs.insert("ENOTBLK".into(), MbValue::from_int(15));
    attrs.insert("ENOTSUP".into(), MbValue::from_int(45));
    attrs.insert("EPFNOSUPPORT".into(), MbValue::from_int(46));
    attrs.insert("EPROCLIM".into(), MbValue::from_int(67));
    attrs.insert("EPROCUNAVAIL".into(), MbValue::from_int(76));
    attrs.insert("EPROGMISMATCH".into(), MbValue::from_int(75));
    attrs.insert("EPROGUNAVAIL".into(), MbValue::from_int(74));
    attrs.insert("EPWROFF".into(), MbValue::from_int(82));
    attrs.insert("EQFULL".into(), MbValue::from_int(106));
