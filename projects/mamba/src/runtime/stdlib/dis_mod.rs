...
pub fn register() {
    ...
    attrs.insert("specialized".into(), MbValue::from_ptr(MbObject::new_str("SEND_GEN".to_string())));
    ...
    attrs.insert(
        ...
        MbValue::from_ptr(MbObject::new_tuple(vec![
            mk_str("defaults"), mk_str("kwdefaults"),
            mk_str("annotations"), mk_str("closure"),
        ])),
    );
    ...
    attrs.insert(
        ...
        MbValue::from_ptr(MbObject::new_tuple(vec![
            mk_str(""), mk_str("str"), mk_str("repr"), mk_str("ascii"),
        ])),
    );
    ...
    attrs.insert(
        ...
        mk_int_list(&[
            ...
            147, 149, 150, 151, 152, 155, 156, 157, 162, 163, 164, 165, 171,
            172, 173, 174, 175, 176, 237, 238, 239, 240, 241, 242, 243, 244,
            245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 260, 261, 262,
            263, 264, 265, 266,
        ]),
    );
    ...
    attrs.insert("hasfree".into(), mk_int_list(&[135, 136, 137, 138, 139, 148, 176]));
    attrs.insert("hasjabs".into(), mk_int_list(&[]));
    attrs.insert(
        "hasjrel".into(),
        mk_int_list(&[93, 110, 114, 115, 123, 128, 129, 134, 140, 260, 261]),
    );
    attrs.insert("haslocal".into(), mk_int_list(&[124, 125, 126, 127, 143, 266]));
    attrs.insert(
        "hasname".into(),
        mk_int_list(&[90, 91, 95, 96, 97, 98, 101, 106, 108, 109, 116, 141, 175, 262, 263, 264, 265]),
    );
    ...
    // COMPILER_FLAG_NAMES: dict {flag_int: name}
    {
        ...
        unsafe {
            ...
            if let ObjData::Dict(ref lock) = (*d).data {
                ...
                for (flag, name) in &[
                    (1i64, "OPTIMIZED"), (2, "NEWLOCALS"), (4, "VARARGS"),
                    (8, "VARKEYWORDS"), (16, "NESTED"), (32, "GENERATOR"),
                    (64, "NOFREE"), (128, "COROUTINE"), (256, "ITERABLE_COROUTINE"),
                    (512, "ASYNC_GENERATOR"),
                ] {
...
pub fn mb_dis_get_instructions(obj: MbValue) -> MbValue {
    ...
    let instrs = vec![
        make_instruction("RESUME",       151, 0, MbValue::from_int(0),  "0",    0, MbValue::from_int(1), false),
        make_instruction("LOAD_CONST",   100, 0, MbValue::none(),       "None", 2, MbValue::none(), false),
        make_instruction("RETURN_VALUE",  83, 0, MbValue::none(),       "",     4, MbValue::none(), false),
    ];
