...
fn register_with(
    ...
    for (n, v) in consts_str {
        attrs.insert((*n).into(), MbValue::from_ptr(MbObject::new_str((*v).to_string())));
    }
...
fn register_distutils() {
    ...
    register_with("distutils",
        &[],
        &[],
        &[("__version__", 0)],
        &[("__version__", "3.12.0")]);
    register_with("distutils.core",
    ...
    register_with("distutils.command",
        ...
        &[],
        &[], &[]);
    register_with("distutils.errors",
        &["DistutilsError","DistutilsModuleError","DistutilsClassError",
          ...
          "DistutilsByteCompileError","CCompilerError","PreprocessError",
          "CompileError","LibError","LinkError","UnknownFileError"],
        &[], &[], &[]);
    register_with("distutils.util",
        &[],
        ...
        &[], &[]);
    register_with("distutils.dir_util",
        &[],
        ...
        &[], &[]);
    register_with("distutils.file_util",
        &[],
        ...
        &[], &[]);
    register_with("distutils.archive_util",
        &[],
        ...
        &[], &[]);
    register_with("distutils.sysconfig",
        &[],
        &[("get_python_version", dispatch_empty_str as *const () as usize),
          ...
          ("get_config_h_filename", dispatch_empty_str as *const () as usize),
          ("get_makefile_filename", dispatch_empty_str as *const () as usize),
    ...
    register_with("distutils.dep_util",
        ...
        &[], &[]);
    register_with("distutils.dist",
        &["Distribution","DistributionMetadata"],
        &[("fix_help_options", dispatch_empty_list as *const () as usize)],
        &[], &[]);
    register_with("distutils.extension",
        &["Extension","read_setup_file"],
        &[], &[], &[]);
    register_with("distutils.ccompiler",
        &["CCompiler"],
        &[("get_default_compiler", dispatch_empty_str as *const () as usize),
          ...
          ("gen_preprocess_options", dispatch_empty_list as *const () as usize),
          ("get_versions",         dispatch_empty_list as *const () as usize)],
        &[], &[]);
    register_with("distutils.unixccompiler",
        &["UnixCCompiler"],
        &[], &[], &[]);
    register_with("distutils.msvccompiler",
        &["MSVCCompiler","get_build_version","get_build_architecture"],
        &[], &[], &[]);
}

fn register_ctypes() {
    register_with("ctypes",
        &[
            "CDLL","PyDLL","WinDLL","OleDLL","LibraryLoader","Structure","Union",
            "Array","BigEndianStructure","LittleEndianStructure","c_byte",
            "c_ubyte","c_char","c_char_p","c_double","c_longdouble","c_float",
            "c_int","c_uint","c_int8","c_uint8","c_int16","c_uint16","c_int32",
            "c_uint32","c_int64","c_uint64","c_long","c_ulong","c_longlong",
            "c_ulonglong","c_short","c_ushort","c_size_t","c_ssize_t",
            "c_void_p","c_wchar","c_wchar_p","c_bool","POINTER","pointer",
            "byref","cast","addressof","alignment","sizeof","string_at",
            "wstring_at","memmove","memset","CFUNCTYPE","WINFUNCTYPE",
            "PYFUNCTYPE","HRESULT","ArgumentError","Error",
            "ARRAY","BigEndianUnion","LittleEndianUnion","SetPointerType",
            "c_buffer","c_time_t","c_voidp","create_string_buffer",
            "create_unicode_buffer","py_object","resize","pythonapi",
        ],
        ...
        &[("DEFAULT_MODE",0),("RTLD_LOCAL",0),("RTLD_GLOBAL",256),
          ("FUNCFLAG_CDECL",1),("FUNCFLAG_HRESULT",2),("FUNCFLAG_PYTHONAPI",4),
          ("FUNCFLAG_USE_ERRNO",8),("FUNCFLAG_USE_LASTERROR",16),
          ("SIZEOF_TIME_T",8)],
        &[]);
    register_with("ctypes.util",
        &[],
        &[("find_library",      dispatch_noop      as *const () as usize),
          ("find_msvcrt",       dispatch_noop      as *const () as usize)],
        &[], &[]);
    register_with("ctypes.wintypes",
        &["BOOL","BYTE","WORD","DWORD","UINT","INT","FLOAT","LPVOID","LPCVOID",
          "HANDLE","HWND","HMODULE","HINSTANCE","HKEY","HMENU","HRESULT","LPCWSTR",
          "LPWSTR","LPCSTR","LPSTR","LARGE_INTEGER","ULARGE_INTEGER","SIZE",
          "POINT","RECT","FILETIME","SYSTEMTIME","MSG","BSTR"],
        &[], &[], &[]);
}

fn register_html_entities() {
    let mut attrs = HashMap::new();
    attrs.insert("name2codepoint".into(), MbValue::from_ptr(MbObject::new_dict()));
    attrs.insert("html5".into(),          MbValue::from_ptr(MbObject::new_dict()));
    attrs.insert("codepoint2name".into(), MbValue::from_ptr(MbObject::new_dict()));
...
fn register_xml_subs() {
    register_with("xml.dom",
        &["DOMException","DomstringSizeErr","HierarchyRequestErr","IndexSizeErr",
          "InuseAttributeErr","InvalidAccessErr","InvalidCharacterErr",
          "InvalidModificationErr","InvalidStateErr","NamespaceErr","NoDataAllowedErr",
          "NoModificationAllowedErr","NotFoundErr","NotSupportedErr","SyntaxErr",
          "TypeMismatchErr","UnspecifiedEventTypeErr","ValidationErr","WrongDocumentErr",
          "Node","NodeList","Document","Element","Attr","Text","Comment",
          "CDATASection","ProcessingInstruction","DocumentFragment","DocumentType",
          "EmptyNodeList","UserDataHandler"],
        &[("getDOMImplementation", dispatch_class_shell as *const () as usize),
          ("registerDOMImplementation", dispatch_noop as *const () as usize)],
    ...
    register_with("xml.dom.domreg",
        &[],
        &[("getDOMImplementation",     dispatch_class_shell as *const () as usize),
          ("registerDOMImplementation", dispatch_noop        as *const () as usize)],
        &[],
        &[]);
    register_with("xml.dom.minidom",
        &["Node","Document","Element","Attr","Text","Comment","CDATASection",
          "ProcessingInstruction","DocumentFragment","DocumentType","DOMImplementation",
          "AttributeList","CharacterData","Childless","DOMImplementationLS","DocumentLS",
          "ElementInfo","EmptyNodeList","Entity","Identified","NamedNodeMap","NodeList",
          "Notation","ReadOnlySequentialNamedNodeMap","TypeInfo"],
        ...
        &[("XMLNS_NAMESPACE","http://www.w3.org/2000/xmlns/"),
          ...
          ("io",""),
          ("xml","")]);
    register_with("xml.dom.pulldom",
        &["PullDOM","DOMEventStream","SAX2DOM","ErrorHandler"],
        &[("parse",        dispatch_class_shell as *const () as usize),
          ("parseString",  dispatch_class_shell as *const () as usize)],
        &[("START_ELEMENT",1),("END_ELEMENT",2),("COMMENT",3),
          ("START_DOCUMENT",4),("END_DOCUMENT",5),
          ("PROCESSING_INSTRUCTION",6),("IGNORABLE_WHITESPACE",7),("CHARACTERS",8)],
        &[]);
    register_with("xml.parsers", &[], &[], &[], &[]);
    register_with("xml.parsers.expat",
        &["ExpatError","XMLParserType","ParserCreate","ErrorString","error","model",
          "errors"],
    ...
    register_with("xml.sax.handler",
        &["ContentHandler","DTDHandler","EntityResolver","ErrorHandler",
          "LexicalHandler"],
        &[],
        &[("feature_namespaces",0),("feature_namespace_prefixes",0),
          ("feature_string_interning",0),("feature_validation",0),
          ("feature_external_ges",0),("feature_external_pes",0),
          ("property_lexical_handler",0),("property_declaration_handler",0),
          ("property_dom_node",0),("property_xml_string",0),
          ("property_encoding",0),("property_interning_dict",0)],
        &[]);
    register_with("xml.sax.saxutils",
        ...
        &[("escape",     dispatch_empty_str as *const () as usize),
          ...
          ("prepare_input_source", dispatch_class_shell as *const () as usize)],
        &[], &[]);
    register_with("xml.sax.xmlreader",
        &["XMLReader","IncrementalParser","Locator","InputSource",
...
fn register_zoneinfo() {
    ...
    attrs.insert("ZoneInfoNotFoundError".to_string(), MbValue::from_func(shell));
    attrs.insert("InvalidTZPathWarning".to_string(),  MbValue::from_func(shell));
    attrs.insert("available_timezones".to_string(),
        MbValue::from_func(dispatch_empty_list as *const () as usize));
    attrs.insert("reset_tzpath".to_string(),
        MbValue::from_func(dispatch_noop as *const () as usize));
    attrs.insert("TZPATH".to_string(),
        MbValue::from_ptr(MbObject::new_str(String::new())));
...
fn register_unittest_subs() {
    ...
    register_with("unittest.case",
        ...
        &[("skip",         dispatch_class_shell as *const () as usize),
          ...
          ("expectedFailure", dispatch_class_shell as *const () as usize),
          ("addModuleCleanup", dispatch_noop     as *const () as usize),
          ("doModuleCleanups", dispatch_noop     as *const () as usize)],
        &[], &[]);
    register_with("unittest.result",
        &["TestResult"],
        &[], &[], &[]);
    register_with("unittest.signals",
        &[],
        ...
        &[], &[]);
    register_with("unittest.suite",
        &["BaseTestSuite","TestSuite","_DebugResult","_ErrorHolder"],
        &[], &[], &[]);
    register_with("unittest.util",
        &[],
        &[("strclass",          dispatch_empty_str as *const () as usize),
          ("safe_repr",          dispatch_empty_str as *const () as usize),
          ("sorted_list_difference", dispatch_empty_list as *const () as usize),
          ("unorderable_list_difference", dispatch_empty_list as *const () as usize),
          ("three_way_cmp",      dispatch_int_zero as *const () as usize)],
        &[("_MAX_LENGTH",80),("_PLACEHOLDER_LEN",12),
          ("_MIN_BEGIN_LEN",5),("_MIN_END_LEN",5),
          ("_MIN_COMMON_LEN",5),("_MIN_DIFF_LEN",80)],
        &[]);
}

fn register_importlib_subs() {
    register_with("importlib.abc",
        &["MetaPathFinder","PathEntryFinder","Loader","ResourceLoader",
          "InspectLoader","ExecutionLoader","FileLoader","SourceLoader",
          "Finder","ResourceReader","Traversable","TraversableResources"],
        &[], &[], &[]);
    register_with("importlib.machinery",
        &["BuiltinImporter","FrozenImporter","SourceFileLoader",
          "SourcelessFileLoader","ExtensionFileLoader","PathFinder",
          "ModuleSpec","FileFinder","SOURCE_SUFFIXES","DEBUG_BYTECODE_SUFFIXES",
          "OPTIMIZED_BYTECODE_SUFFIXES","BYTECODE_SUFFIXES","EXTENSION_SUFFIXES",
          "all_suffixes","WindowsRegistryFinder","NamespaceLoader",
          "AppleFrameworkLoader"],
        &[("all_suffixes", dispatch_empty_list as *const () as usize)],
        &[], &[]);
    register_with("importlib.metadata",
        &["Distribution","DistributionFinder","PackageNotFoundError",
          "EntryPoint","EntryPoints","SelectableGroups","PackagePath",
          "PathDistribution","MetadataPathFinder","FreezableDefaultDict",
          "Sectioned","Pair","Prepared"],
        &[("distribution",      dispatch_class_shell as *const () as usize),
          ...
          ("packages_distributions", dispatch_empty_dict as *const () as usize),
          ("requires",          dispatch_empty_list  as *const () as usize),
          ("version",           dispatch_empty_str   as *const () as usize)],
        &[], &[]);
    register_with("importlib.resources",
        ...
        &[], &[]);
    register_with("importlib.util",
        &["LazyLoader","_LazyModule"],
        &[("module_from_spec",       dispatch_class_shell as *const () as usize),
          ("spec_from_file_location",dispatch_class_shell as *const () as usize),
          ("spec_from_loader",       dispatch_class_shell as *const () as usize),
          ("find_spec",              dispatch_class_shell as *const () as usize),
          ("resolve_name",           dispatch_empty_str   as *const () as usize),
          ("source_from_cache",      dispatch_empty_str   as *const () as usize),
          ("cache_from_source",      dispatch_empty_str   as *const () as usize),
...
fn register_collections_abc() {
    ...
    register_type_module("collections.abc",
        &["Container","Hashable","Iterable","Iterator","Reversible","Generator",
          ...
          "AsyncIterator","AsyncGenerator","Buffer"]);
}

fn register_email_subs() {
    register_with("email.charset",
        &["Charset"],
    ...
    register_with("email.encoders",
        ...
        &[], &[]);
    register_with("email.errors",
        &["MessageError","MessageParseError","HeaderParseError","BoundaryError",
          "MultipartConversionError","CharsetError","MessageDefect",
          "NoBoundaryInMultipartDefect","StartBoundaryNotFoundDefect",
          ...
          "MultipartInvariantViolationDefect","InvalidMultipartContentTransferEncodingDefect",
          "UndecodableBytesDefect","InvalidBase64PaddingDefect",
          "InvalidBase64CharactersDefect","InvalidBase64LengthDefect",
          "InvalidHeaderDefect","HeaderDefect","NonPrintableDefect",
          "ObsoleteHeaderDefect"],
        &[], &[], &[]);
    register_with("email.feedparser",
        &["FeedParser","BytesFeedParser"],
        &[], &[], &[]);
    register_with("email.iterators",
        &[],
        &[("body_line_iterator",    dispatch_empty_list as *const () as usize),
          ("typed_subpart_iterator",dispatch_empty_list as *const () as usize),
          ("walk",                  dispatch_empty_list as *const () as usize)],
        &[], &[]);
    register_with("email.generator",
        &["Generator","BytesGenerator","DecodedGenerator"],
        &[], &[], &[]);
    register_with("email.contentmanager",
        &["ContentManager","raw_data_manager"],
        &[], &[], &[]);
    register_with("email.headerregistry",
        &["BaseHeader","UnstructuredHeader","DateHeader","AddressHeader",
          "SingleAddressHeader","UniqueSingleAddressHeader","MIMEVersionHeader",
          "ParameterizedMIMEHeader","ContentTypeHeader","ContentDispositionHeader",
          "ContentTransferEncodingHeader","HeaderRegistry","Address","Group"],
        &[], &[], &[]);
}
...
fn register_internals() {
    ...
    register_with("_collections_abc",
        &["Container","Hashable","Iterable","Iterator","Reversible","Generator",
          "Sized","Callable","Collection","Sequence","MutableSequence","ByteString",
          "Set","MutableSet","Mapping","MutableMapping","MappingView","KeysView",
          "ItemsView","ValuesView","Awaitable","Coroutine","AsyncIterable",
        ...
        &[], &[], &[]);
    register_with("_ast",
        &["AST","Module","Interactive","Expression","FunctionType","stmt","expr",
          "FunctionDef","AsyncFunctionDef","ClassDef","Return","Delete","Assign",
          "AugAssign","AnnAssign","For","AsyncFor","While","If","With","AsyncWith",
          "Match","Raise","Try","TryStar","Assert","Import","ImportFrom","Global",
          "Nonlocal","Expr","Pass","Break","Continue","BoolOp","NamedExpr","BinOp",
          "UnaryOp","Lambda","IfExp","Dict","Set","ListComp","SetComp","DictComp",
          "GeneratorExp","Await","Yield","YieldFrom","Compare","Call","FormattedValue",
          "JoinedStr","Constant","Attribute","Subscript","Starred","Name","List","Tuple",
          "Slice","Load","Store","Del","AugLoad","AugStore","Param","And","Or","Add",
          "Sub","Mult","MatMult","Div","Mod","Pow","LShift","RShift","BitOr","BitXor",
          "BitAnd","FloorDiv","Invert","Not","UAdd","USub","Eq","NotEq","Lt","LtE","Gt",
          "GtE","Is","IsNot","In","NotIn","comprehension","excepthandler","ExceptHandler",
          "arguments","arg","keyword","alias","withitem","match_case","pattern",
          "MatchValue","MatchSingleton","MatchSequence","MatchMapping","MatchClass",
          "MatchStar","MatchAs","MatchOr","type_ignore","TypeIgnore"],
        &[],
    ...
    register_with("_compat_pickle",
        ...
        &[],
        &[]);
    register_with("_compression",
        &["BaseStream","DecompressReader"],
        &[],
        &[("BUFFER_SIZE",8192)],
        &[]);
    register_with("_markupbase",
        &["ParserBase"],
        &[], &[], &[]);
    register_with("_osx_support",
        &[],
        &[("compiler_fixup",          dispatch_empty_list as *const () as usize),
          ("customize_compiler",      dispatch_noop      as *const () as usize),
          ("customize_config_vars",   dispatch_empty_dict as *const () as usize),
          ("get_platform_osx",        dispatch_empty_str  as *const () as usize)],
        &[], &[]);
    register_with("_py_abc",
        &["ABCMeta"],
        &[("get_cache_token", dispatch_int_zero as *const () as usize)],
        &[], &[]);
    register_with("_pydecimal",
        &["Decimal","Context","DecimalException","Clamped","DivisionByZero",
          "InvalidOperation","Overflow","Rounded","Subnormal","Underflow",
          "Inexact","FloatOperation"],
        &[],
        &[("ROUND_HALF_EVEN",0),("ROUND_HALF_DOWN",1),("ROUND_HALF_UP",2),
          ("ROUND_FLOOR",3),("ROUND_CEILING",4),("ROUND_DOWN",5),("ROUND_UP",6),
          ("ROUND_05UP",7),("MAX_PREC",425000000),("MAX_EMAX",425000000),
          ("MIN_EMIN",-425000000),("MIN_ETINY",-425000000)],
        &[]);
    register_with("_pyio",
        &["IOBase","RawIOBase","BufferedIOBase","TextIOBase","FileIO",
          "BytesIO","StringIO","BufferedReader","BufferedWriter","BufferedRWPair",
          "BufferedRandom","TextIOWrapper","IncrementalNewlineDecoder",
        ...
        &[]);
    register_with("_sitebuiltins",
        &["Quitter","_Printer","_Helper"],
        &[], &[], &[]);
    register_with("_threading_local",
        &["local"],
        &[], &[], &[]);
    register_with("_weakrefset",
