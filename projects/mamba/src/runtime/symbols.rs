...
pub fn runtime_symbols() -> Vec<RuntimeSymbol> {
    ...
    vec![
        ...
        rt_sym!(
            "mb_func_prime_name",
            closure::mb_func_prime_name as fn(super::MbValue, super::MbValue),
            [I64, I64],
            Void
        ),
        rt_sym!(
        ...
        rt_sym!(
            "mb_func_set_flags",
            closure::mb_func_set_flags as fn(super::MbValue, super::MbValue),
            [I64, I64],
            Void
        ),
        rt_sym!(
        ...
        rt_sym!(
            "mb_traceback_note_propagation",
            traceback_mod::mb_traceback_note_propagation as fn(super::MbValue),
            [I64],
            Void
        ),
        rt_sym!(
