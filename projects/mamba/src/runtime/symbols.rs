...
pub fn runtime_symbols() -> Vec<RuntimeSymbol> {
    ...
    vec![
        ...
        rt_sym!(
            "mb_logging_debug",
            super::stdlib::logging_mod::mb_logging_debug as fn(super::MbValue) -> super::MbValue,
            [I64],
            I64
        ),
        rt_sym!(
            "mb_logging_info",
            super::stdlib::logging_mod::mb_logging_info as fn(super::MbValue) -> super::MbValue,
            [I64],
            I64
        ),
        rt_sym!(
            "mb_logging_warning",
            super::stdlib::logging_mod::mb_logging_warning as fn(super::MbValue) -> super::MbValue,
            [I64],
            I64
        ),
        rt_sym!(
            "mb_logging_error",
            super::stdlib::logging_mod::mb_logging_error as fn(super::MbValue) -> super::MbValue,
            [I64],
            I64
        ),
        rt_sym!(
            "mb_logging_critical",
            super::stdlib::logging_mod::mb_logging_critical as fn(super::MbValue) -> super::MbValue,
            [I64],
            I64
        ),
        rt_sym!(
            "mb_logging_getlogger",
            super::stdlib::logging_mod::mb_logging_getlogger
                as fn(super::MbValue) -> super::MbValue,
            [I64],
            I64
        ),
        rt_sym!(
            "mb_logging_basicconfig",
            super::stdlib::logging_mod::mb_logging_basicconfig
                as fn(super::MbValue) -> super::MbValue,
            [I64],
            I64
        ),
        ...
        rt_sym!(
            ...
            super::stdlib::linecache_mod::mb_linecache_checkcache as fn() -> super::MbValue,
            [],
            I64
        ),
