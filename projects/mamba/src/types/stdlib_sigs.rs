...
pub const STDLIB_SIGS: &[StdlibSig] = &[
    ...
    StdlibSig {
        module: "logging.handlers",
        qualifier: "SMTPHandler",
        name: "__init__",
        kind: SigKind::Method,
        params: &[
            p("mailhost", CoreTy::Typed),
            p("fromaddr", CoreTy::Str),
            p("toaddrs", CoreTy::Unknown),
            p("subject", CoreTy::Str),
            p("credentials", CoreTy::Unknown),
            p("secure", CoreTy::Unknown),
            p("timeout", CoreTy::Float),
        ],
        enforceable: true,
        ret: CoreTy::Unknown,
    ...
    StdlibSig {
        ...
        kind: SigKind::Method,
        params: &[
            p("address", CoreTy::Typed),
            p("facility", CoreTy::Typed),
    ...
    StdlibSig {
        ...
        kind: SigKind::Method,
        params: &[
            p("registry", CoreTy::Dict),
            p("address", CoreTy::Typed),
            p("authkey", CoreTy::Typed),
    ...
    StdlibSig {
        ...
        kind: SigKind::ModuleFn,
        params: &[
            p("typecode", CoreTy::Unknown),
            p("sequence", CoreTy::Typed),
            p("lock", CoreTy::Unknown),
        ],
        enforceable: true,
        ret: CoreTy::Unknown,
    ...
    StdlibSig {
        module: "multiprocessing.dummy",
        qualifier: "DummyProcess",
        name: "__init__",
        kind: SigKind::Method,
        params: &[
            p("group", CoreTy::Unknown),
            p("target", CoreTy::Typed),
            p("name", CoreTy::Unknown),
            p("args", CoreTy::Unknown),
