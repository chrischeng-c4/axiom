...
|---|---:|---|---|---|---|---|
| Agent Runtime Core | - | implemented | verified | smoke | not_ready | Rust agent runtime facade for provider, tool, event, storage, integration, and protocol contracts |
| Structured Schema And Derive | - | implemented | verified | conformance | not_ready | Schema builder, validator, and `#[derive(AgentSchema)]` typed I/O contract |
| Stateful Graph Runtime | - | implemented | verified | smoke | not_ready | Typed graph runtime with event stream and checkpointing surface |
| Mamba Agent Binding | - | implemented | verified | smoke | not_ready | `mambalibs.agent` runtime module plus `cclab.agent` compatibility alias |
| MCP Tool Integration | - | implemented | verified | smoke | not_ready | MCP JSON-RPC client/server and reusable tool integration crate |
...
|---|---|---:|---|---|---|---|
| Agent event stream contract | epic | - | implemented | verified | smoke | `cargo test -p agent --test agent_events` |
...
| Work Root | Kind | WI | Impl | Verification | Maturity | Gate / Evidence |
|---|---|---:|---|---|---|---|
| Schema derive and validation contract | epic | - | implemented | verified | conformance | `cargo test -p agent-derive --test derive_smoke` |
...
| Work Root | Kind | WI | Impl | Verification | Maturity | Gate / Evidence |
|---|---|---:|---|---|---|---|
| Graph event and failure contract | epic | - | implemented | verified | smoke | `cargo test -p agentkit-graph --test graph_events` |
...
| Work Root | Kind | WI | Impl | Verification | Maturity | Gate / Evidence |
|---|---|---:|---|---|---|---|
| Mamba namespace registration | epic | - | implemented | verified | smoke | `cargo test -p agentkit-binding --test registry_test`; `cargo test -p agentkit-binding --test methods_test` |
| Mamba exported method contract | epic | - | implemented | verified | smoke | `cargo test -p agentkit-binding --test methods_test` |
...
| Work Root | Kind | WI | Impl | Verification | Maturity | Gate / Evidence |
|---|---|---:|---|---|---|---|
| MCP client/server dispatch contract | epic | - | implemented | verified | smoke | `cargo test -p agentkit-tools --lib` |
