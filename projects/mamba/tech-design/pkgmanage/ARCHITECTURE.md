...
Scope: `projects/mamba/src/pkgmanage/` — the C4 (uv-like package manager) bounded context.
All refs relative to `projects/mamba/`. Fix TDs in this directory are cross-referenced by filename, not restated.
