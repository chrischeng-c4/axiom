...
`projects/mamba/src/runtime/registry_bridge.rs::ATTRIBUTE_GETTERS`

The one discarded process-immutable candidate is:

`projects/mamba/src/runtime/registry_bridge.rs::REAL_OPS`
...
- `projects/mamba/src/runtime/registry_bridge.rs`
