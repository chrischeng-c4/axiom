...
- Parser acceptance: `cargo test -p mamba --release --test conformance_cpython_grammar` — 62 fixtures, xfail manifest `projects/mamba/cpython_known_failures.toml`, xpass warns on stderr.
