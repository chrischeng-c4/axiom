...
// Contract: Timeouts, crash or signal termination, nonzero exit without complete terminal accounting, output truncation, revision/manifest/toolchain/environment drift, missing baseline, or parse errors are hard failures.
