...
def generate_rows(repo_root: pathlib.Path, git_sha: str, binary_sha: str, platform: str) -> list[dict]:
    diag_file = (
        repo_root
        / "projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/oracles/force_typed_expected_diagnostics.json"
    )
    if not diag_file.is_file():
        raise FileNotFoundError(f"Missing force_typed_expected_diagnostics.json at {diag_file}")

    verify_diag_script = (
        "projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/oracles/verify_force_typed_expected_diagnostic.py"
    )
    ...
    raw_rows = [
        # 1. Behavior green
        {
            ...
            "fixture_or_probe_path": "projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_behavior_green.py",
            "oracle_kind": "cpython312_identity",
            "oracle_executable": cpython312_bin,
            "oracle_version": "Python 3.12",
            "oracle_command": f"{cpython312_bin} projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_behavior_green.py",
            "sut_command": "target/release/mamba run projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_behavior_green.py",
        ...
        # 2. Stability green
        {
            ...
            "fixture_or_probe_path": "projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_stability_green.py",
            "oracle_kind": "property",
            "oracle_executable": cpython313t_bin,
            "oracle_version": "Python 3.13",
            "oracle_command": f"{cpython313t_bin} projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_stability_green.py",
            "sut_command": "target/release/mamba run projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_stability_green.py",
            "expected_outcome_kind": "ok",
            "expected_divergence_class": "none",
        ...
        # 3. Efficiency green
        {
            ...
            "fixture_or_probe_path": "projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_efficiency_green.py",
            "oracle_kind": "property",
            "oracle_executable": cpython313t_bin,
            "oracle_version": "Python 3.13",
            "oracle_command": f"{cpython313t_bin} projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_efficiency_green.py",
            "sut_command": "target/release/mamba run projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_efficiency_green.py",
            "expected_outcome_kind": "ok",
            "expected_divergence_class": "none",
        ...
        # 4. Behavior intentional-red (ord)
        {
            ...
            "probe_id": "ord(42)",
            "source_identity": "projects/mamba/tests/cpython/behavior/builtin-libs/builtins/builtin_test__test_ord.py",
            "fixture_or_probe_path": "projects/mamba/tests/cpython/behavior/builtin-libs/builtins/builtin_test__test_ord.py",
            ...
            "oracle_executable": cpython312_bin,
            "oracle_version": "Python 3.12",
            "oracle_command": f"{cpython312_bin} {verify_diag_script} projects/mamba/tests/cpython/behavior/builtin-libs/builtins/builtin_test__test_ord.py",
            "sut_command": "target/release/mamba check projects/mamba/tests/cpython/behavior/builtin-libs/builtins/builtin_test__test_ord.py",
            ...
            "diagnostic_class": diag_data["projects/mamba/tests/cpython/behavior/builtin-libs/builtins/builtin_test__test_ord.py"]["diagnostic_class"],
            "diagnostic_span": diag_data["projects/mamba/tests/cpython/behavior/builtin-libs/builtins/builtin_test__test_ord.py"]["diagnostic_span"],
            "expected_probe_anchor": diag_data["projects/mamba/tests/cpython/behavior/builtin-libs/builtins/builtin_test__test_ord.py"]["message_anchor"],
        },
        # 5. Behavior intentional-red (input)
        {
            "case_id": "builtin_test__test_input",
            "probe_id": "input(42,42)",
            "source_identity": "projects/mamba/tests/cpython/behavior/builtin-libs/builtins/builtin_test__test_input.py",
            "fixture_or_probe_path": "projects/mamba/tests/cpython/behavior/builtin-libs/builtins/builtin_test__test_input.py",
            "source_set": "ordinary_parity_corpus",
            "tier1_dimension": "behavior",
            "channel": "compile",
            "expected_result_channel": "compile",
            ...
            "oracle_executable": cpython312_bin,
            "oracle_version": "Python 3.12",
            "oracle_command": f"{cpython312_bin} {verify_diag_script} projects/mamba/tests/cpython/behavior/builtin-libs/builtins/builtin_test__test_input.py",
            "sut_command": "target/release/mamba check projects/mamba/tests/cpython/behavior/builtin-libs/builtins/builtin_test__test_input.py",
            "expected_outcome_kind": "compile_error",
            "expected_divergence_class": "force_typed_compile_reject",
            "expected_terminal_classification": "intentional_red",
            "sample_role": "intentional_red",
            "diagnostic_class": diag_data["projects/mamba/tests/cpython/behavior/builtin-libs/builtins/builtin_test__test_input.py"]["diagnostic_class"],
            "diagnostic_span": diag_data["projects/mamba/tests/cpython/behavior/builtin-libs/builtins/builtin_test__test_input.py"]["diagnostic_span"],
            "expected_probe_anchor": diag_data["projects/mamba/tests/cpython/behavior/builtin-libs/builtins/builtin_test__test_input.py"]["message_anchor"],
        },
        # 6. Behavior intentional-red (invalid context)
        {
            "case_id": "py_context_input_validation__test_invalid_context",
            "probe_id": "getattr(c,9)",
            "source_identity": "projects/mamba/tests/cpython/behavior/std-libs/decimal/py_context_input_validation__test_invalid_context.py",
            "fixture_or_probe_path": "projects/mamba/tests/cpython/behavior/std-libs/decimal/py_context_input_validation__test_invalid_context.py",
            "source_set": "ordinary_parity_corpus",
            "tier1_dimension": "behavior",
            "channel": "compile",
            "expected_result_channel": "compile",
            ...
            "oracle_executable": cpython312_bin,
            "oracle_version": "Python 3.12",
            "oracle_command": f"{cpython312_bin} {verify_diag_script} projects/mamba/tests/cpython/behavior/std-libs/decimal/py_context_input_validation__test_invalid_context.py",
            "sut_command": "target/release/mamba check projects/mamba/tests/cpython/behavior/std-libs/decimal/py_context_input_validation__test_invalid_context.py",
            "expected_outcome_kind": "compile_error",
            "expected_divergence_class": "force_typed_compile_reject",
            "expected_terminal_classification": "intentional_red",
            "sample_role": "intentional_red",
            "diagnostic_class": diag_data["projects/mamba/tests/cpython/behavior/std-libs/decimal/py_context_input_validation__test_invalid_context.py"]["diagnostic_class"],
            "diagnostic_span": diag_data["projects/mamba/tests/cpython/behavior/std-libs/decimal/py_context_input_validation__test_invalid_context.py"]["diagnostic_span"],
            "expected_probe_anchor": diag_data["projects/mamba/tests/cpython/behavior/std-libs/decimal/py_context_input_validation__test_invalid_context.py"]["message_anchor"],
        },
        # 7. Stability intentional-red
        {
            ...
            "channel": "concurrency",
            "expected_result_channel": "concurrency",
            "fixture_or_probe_path": "projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_stability_intentional_red.py",
            "oracle_kind": "property",
            "oracle_executable": cpython313t_bin,
            "oracle_version": "Python 3.13",
            "oracle_command": f"{cpython313t_bin} projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_stability_intentional_red.py",
            "sut_command": "target/release/mamba run projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_stability_intentional_red.py",
        ...
        # 8. Efficiency intentional-red
        {
            ...
            "channel": "performance",
            "expected_result_channel": "performance",
            "fixture_or_probe_path": "projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_efficiency_intentional_red.py",
            "oracle_kind": "property",
            "oracle_executable": cpython313t_bin,
            "oracle_version": "Python 3.13",
            "oracle_command": f"{cpython313t_bin} projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_efficiency_intentional_red.py",
            "sut_command": "target/release/mamba run projects/mamba/tests/governance/gates/t1_oracle_hierarchy_inventory/probes/to_thread_gather_efficiency_intentional_red.py",
            "expected_outcome_kind": "property_red",
