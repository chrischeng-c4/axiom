...
# subject = "encodings.utf_8.IncrementalDecoder._buffer_decode(data: ReadableBuffer)"
# kind = "semantic"
...
"""Type wall: encodings.utf_8.IncrementalDecoder._buffer_decode(data: ReadableBuffer); call it with the wrong type.
