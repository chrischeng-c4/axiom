...
# lib = "_curses"
# dimension = "type"
# case = "window__idcok__flag_as_bool_wrong"
# subject = "_curses.window.idcok(flag: bool)"
# kind = "semantic"
...
"""Type wall: _curses.window.idcok(flag: bool); call it with the wrong type.
...
try:
    obj.idcok("not_a_bool")  # flag: bool <- wrong-typed
