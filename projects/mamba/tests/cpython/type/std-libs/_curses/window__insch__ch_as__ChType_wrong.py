...
# lib = "_curses"
# dimension = "type"
# case = "window__insch__ch_as__ChType_wrong"
# subject = "_curses.window.insch(ch: _ChType)"
# kind = "semantic"
...
"""Type wall: _curses.window.insch(ch: _ChType); call it with the wrong type.
...
try:
    obj.insch(_W())  # ch: _ChType <- wrong-typed
