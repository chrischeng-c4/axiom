...
# lib = "_curses"
# dimension = "type"
# case = "window__getstr__n_as_int_wrong"
# subject = "_curses.window.getstr(n: int)"
# kind = "semantic"
...
"""Type wall: _curses.window.getstr(n: int); call it with the wrong type.
...
try:
    obj.getstr("not_an_int")  # n: int <- wrong-typed
