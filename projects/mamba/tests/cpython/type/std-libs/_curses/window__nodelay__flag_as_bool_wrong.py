...
# lib = "_curses"
# dimension = "type"
# case = "window__nodelay__flag_as_bool_wrong"
# subject = "_curses.window.nodelay(flag: bool)"
# kind = "semantic"
...
"""Type wall: _curses.window.nodelay(flag: bool); call it with the wrong type.
...
try:
    obj.nodelay("not_a_bool")  # flag: bool <- wrong-typed
