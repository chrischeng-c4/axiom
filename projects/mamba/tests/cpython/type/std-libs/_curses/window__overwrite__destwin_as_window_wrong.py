...
# lib = "_curses"
# dimension = "type"
# case = "window__overwrite__destwin_as_window_wrong"
# subject = "_curses.window.overwrite(destwin: window)"
# kind = "semantic"
...
"""Type wall: _curses.window.overwrite(destwin: window); call it with the wrong type.
...
try:
    obj.overwrite(_W())  # destwin: window <- wrong-typed
