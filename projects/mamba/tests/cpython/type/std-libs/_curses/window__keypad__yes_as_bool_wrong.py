...
# lib = "_curses"
# dimension = "type"
# case = "window__keypad__yes_as_bool_wrong"
# subject = "_curses.window.keypad(yes: bool)"
# kind = "semantic"
...
"""Type wall: _curses.window.keypad(yes: bool); call it with the wrong type.
...
try:
    obj.keypad("not_a_bool")  # yes: bool <- wrong-typed
