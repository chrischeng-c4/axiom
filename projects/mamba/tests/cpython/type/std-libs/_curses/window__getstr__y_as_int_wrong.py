...
# lib = "_curses"
# dimension = "type"
# case = "window__getstr__y_as_int_wrong"
# subject = "_curses.window.getstr(y: int)"
# kind = "semantic"
...
"""Type wall: _curses.window.getstr(y: int); call it with the wrong type.
...
try:
    obj.getstr("not_an_int", 0)  # y: int <- wrong-typed
