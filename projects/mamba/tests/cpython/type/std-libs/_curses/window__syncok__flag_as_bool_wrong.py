...
# lib = "_curses"
# dimension = "type"
# case = "window__syncok__flag_as_bool_wrong"
# subject = "_curses.window.syncok(flag: bool)"
# kind = "semantic"
...
"""Type wall: _curses.window.syncok(flag: bool); call it with the wrong type.
...
try:
    obj.syncok("not_a_bool")  # flag: bool <- wrong-typed
