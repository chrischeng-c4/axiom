...
# lib = "_curses"
# dimension = "type"
# case = "window__addch__y_as_int_wrong"
# subject = "_curses.window.addch(y: int)"
# kind = "semantic"
...
"""Type wall: _curses.window.addch(y: int); call it with the wrong type.
...
try:
    obj.addch("not_an_int", 0, None)  # y: int <- wrong-typed
