...
# lib = "_curses"
# dimension = "type"
# case = "window__clearok__flag_as_bool_wrong"
# subject = "_curses.window.clearok(flag: bool)"
# kind = "semantic"
...
"""Type wall: _curses.window.clearok(flag: bool); call it with the wrong type.
...
try:
    obj.clearok("not_a_bool")  # flag: bool <- wrong-typed
