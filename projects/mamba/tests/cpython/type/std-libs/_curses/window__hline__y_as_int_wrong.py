...
# lib = "_curses"
# dimension = "type"
# case = "window__hline__y_as_int_wrong"
# subject = "_curses.window.hline(y: int)"
# kind = "semantic"
...
"""Type wall: _curses.window.hline(y: int); call it with the wrong type.
...
try:
    obj.hline("not_an_int", 0, None, 0)  # y: int <- wrong-typed
