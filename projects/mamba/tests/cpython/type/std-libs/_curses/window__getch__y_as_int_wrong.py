...
# lib = "_curses"
# dimension = "type"
# case = "window__getch__y_as_int_wrong"
# subject = "_curses.window.getch(y: int)"
# kind = "semantic"
...
"""Type wall: _curses.window.getch(y: int); call it with the wrong type.
...
try:
    obj.getch("not_an_int", 0)  # y: int <- wrong-typed
