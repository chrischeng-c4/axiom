...
# lib = "_curses"
# dimension = "type"
# case = "window__nodelay__yes_as_bool_wrong"
# subject = "_curses.window.nodelay(yes: bool)"
# kind = "semantic"
...
"""Type wall: _curses.window.nodelay(yes: bool); call it with the wrong type.
...
try:
    obj.nodelay("not_a_bool")  # yes: bool <- wrong-typed
