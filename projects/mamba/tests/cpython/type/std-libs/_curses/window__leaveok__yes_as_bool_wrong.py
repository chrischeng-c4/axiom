...
# lib = "_curses"
# dimension = "type"
# case = "window__leaveok__yes_as_bool_wrong"
# subject = "_curses.window.leaveok(yes: bool)"
# kind = "semantic"
...
"""Type wall: _curses.window.leaveok(yes: bool); call it with the wrong type.
...
try:
    obj.leaveok("not_a_bool")  # yes: bool <- wrong-typed
