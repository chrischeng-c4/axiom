...
# lib = "_curses"
# dimension = "type"
# case = "window__insnstr__y_as_int_wrong"
# subject = "_curses.window.insnstr(y: int)"
# kind = "semantic"
...
"""Type wall: _curses.window.insnstr(y: int); call it with the wrong type.
...
try:
    obj.insnstr("not_an_int", 0, "", 0)  # y: int <- wrong-typed
