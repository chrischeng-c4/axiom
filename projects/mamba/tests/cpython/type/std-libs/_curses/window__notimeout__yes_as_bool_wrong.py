...
# lib = "_curses"
# dimension = "type"
# case = "window__notimeout__yes_as_bool_wrong"
# subject = "_curses.window.notimeout(yes: bool)"
# kind = "semantic"
...
"""Type wall: _curses.window.notimeout(yes: bool); call it with the wrong type.
...
try:
    obj.notimeout("not_a_bool")  # yes: bool <- wrong-typed
