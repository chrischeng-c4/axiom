...
# lib = "_curses"
# dimension = "type"
# case = "window__keypad__flag_as_bool_wrong"
# subject = "_curses.window.keypad(flag: bool)"
# kind = "semantic"
...
"""Type wall: _curses.window.keypad(flag: bool); call it with the wrong type.
...
try:
    obj.keypad("not_a_bool")  # flag: bool <- wrong-typed
