...
# lib = "_curses"
# dimension = "type"
# case = "window__insstr__y_as_int_wrong"
# subject = "_curses.window.insstr(y: int)"
# kind = "semantic"
...
"""Type wall: _curses.window.insstr(y: int); call it with the wrong type.
...
try:
    obj.insstr("not_an_int", 0, "")  # y: int <- wrong-typed
