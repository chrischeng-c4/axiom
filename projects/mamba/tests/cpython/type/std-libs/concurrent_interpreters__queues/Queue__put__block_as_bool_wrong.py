...
# dimension = "type"
# case = "Queue__put__block_as_bool_wrong"
# subject = "concurrent.interpreters._queues.Queue.put(block: bool)"
# kind = "semantic"
...
"""Type wall: concurrent.interpreters._queues.Queue.put(block: bool); call it with the wrong type.
...
try:
    obj.put(None, "not_a_bool")  # block: bool <- wrong-typed
