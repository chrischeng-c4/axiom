...
# dimension = "type"
# case = "Queue__get__timeout_as_typed_wrong"
# subject = "concurrent.interpreters._queues.Queue.get(timeout: typed)"
# kind = "semantic"
...
"""Type wall: concurrent.interpreters._queues.Queue.get(timeout: typed); call it with the wrong type.
