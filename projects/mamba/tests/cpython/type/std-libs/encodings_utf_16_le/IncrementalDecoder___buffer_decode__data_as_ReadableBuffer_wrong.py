...
# subject = "encodings.utf_16_le.IncrementalDecoder._buffer_decode(data: ReadableBuffer)"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
"""Type wall: encodings.utf_16_le.IncrementalDecoder._buffer_decode(data: ReadableBuffer); call it with the wrong type.
...
from encodings.utf_16_le import IncrementalDecoder
try:
