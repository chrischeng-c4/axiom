...
# lib = "xmlrpc_server"
# dimension = "type"
# case = "MultiPathXMLRPCServer__init__addr_as_tuple_wrong"
# subject = "xmlrpc.server.MultiPathXMLRPCServer.__init__(addr: tuple)"
# kind = "semantic"
...
"""Type wall: xmlrpc.server.MultiPathXMLRPCServer.__init__(addr: tuple); call it with the wrong type.
...
try:
    MultiPathXMLRPCServer(12345)  # addr: tuple <- wrong-typed
