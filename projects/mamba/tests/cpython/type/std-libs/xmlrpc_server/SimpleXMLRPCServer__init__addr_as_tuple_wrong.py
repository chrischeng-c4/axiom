...
# lib = "xmlrpc_server"
# dimension = "type"
# case = "SimpleXMLRPCServer__init__addr_as_tuple_wrong"
# subject = "xmlrpc.server.SimpleXMLRPCServer.__init__(addr: tuple)"
# kind = "semantic"
...
"""Type wall: xmlrpc.server.SimpleXMLRPCServer.__init__(addr: tuple); call it with the wrong type.
...
try:
    SimpleXMLRPCServer(12345)  # addr: tuple <- wrong-typed
