...
# lib = "sys"
# dimension = "type"
# case = "call_tracing__func_as_Callable_wrong"
# subject = "sys.call_tracing(func: Callable)"
# kind = "semantic"
...
"""Type wall: sys.call_tracing(func: Callable); call it with the wrong type.
...
try:
    call_tracing(_W(), None)  # func: Callable <- wrong-typed
