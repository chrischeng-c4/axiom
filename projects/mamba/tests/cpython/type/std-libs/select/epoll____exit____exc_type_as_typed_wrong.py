...
# lib = "select"
# dimension = "type"
# case = "epoll____exit____exc_type_as_typed_wrong"
# subject = "select.epoll.__exit__(exc_type: typed)"
# kind = "semantic"
...
"""Type wall: select.epoll.__exit__(exc_type: typed); call it with the wrong type.
...
try:
    obj.__exit__(_W())  # exc_type: typed <- wrong-typed
