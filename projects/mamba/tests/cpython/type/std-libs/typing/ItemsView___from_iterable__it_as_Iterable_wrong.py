...
# lib = "typing"
# dimension = "type"
# case = "ItemsView___from_iterable__it_as_Iterable_wrong"
# subject = "typing.ItemsView._from_iterable(it: Iterable)"
# kind = "semantic"
...
"""Type wall: typing.ItemsView._from_iterable(it: Iterable); call it with the wrong type.
...
try:
    ItemsView._from_iterable(_W())  # it: Iterable <- wrong-typed
