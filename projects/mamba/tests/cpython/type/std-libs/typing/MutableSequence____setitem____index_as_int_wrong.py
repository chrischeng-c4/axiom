...
# lib = "typing"
# dimension = "type"
# case = "MutableSequence____setitem____index_as_int_wrong"
# subject = "typing.MutableSequence.__setitem__(index: int)"
# kind = "semantic"
...
"""Type wall: typing.MutableSequence.__setitem__(index: int); call it with the wrong type.
...
try:
    obj.__setitem__("not_an_int", None)  # index: int <- wrong-typed
