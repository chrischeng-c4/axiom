...
# lib = "typing"
# dimension = "type"
# case = "MutableSequence____delitem____index_as_slice_wrong"
# subject = "typing.MutableSequence.__delitem__(index: slice)"
# kind = "semantic"
...
"""Type wall: typing.MutableSequence.__delitem__(index: slice); call it with the wrong type.
...
try:
    obj.__delitem__(_W())  # index: slice <- wrong-typed
