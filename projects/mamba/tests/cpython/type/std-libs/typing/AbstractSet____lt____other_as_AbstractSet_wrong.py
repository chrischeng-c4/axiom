...
# lib = "typing"
# dimension = "type"
# case = "AbstractSet____lt____other_as_AbstractSet_wrong"
# subject = "typing.AbstractSet.__lt__(other: AbstractSet)"
# kind = "semantic"
...
"""Type wall: typing.AbstractSet.__lt__(other: AbstractSet); call it with the wrong type.
...
try:
    obj.__lt__(_W())  # other: AbstractSet <- wrong-typed
