...
# lib = "typing"
# dimension = "type"
# case = "MutableSequence__append__value_as__T_wrong"
# subject = "typing.MutableSequence.append(value: _T)"
# kind = "semantic"
...
"""Type wall: typing.MutableSequence.append(value: _T); call it with the wrong type.
...
try:
    obj.append(_W())  # value: _T <- wrong-typed
