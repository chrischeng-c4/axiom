...
# lib = "typing"
# dimension = "type"
# case = "AbstractSet____sub____other_as_AbstractSet_wrong"
# subject = "typing.AbstractSet.__sub__(other: AbstractSet)"
# kind = "semantic"
...
"""Type wall: typing.AbstractSet.__sub__(other: AbstractSet); call it with the wrong type.
...
try:
    obj.__sub__(_W())  # other: AbstractSet <- wrong-typed
