...
# lib = "typing"
# dimension = "type"
# case = "MutableSet__discard__value_as__T_wrong"
# subject = "typing.MutableSet.discard(value: _T)"
# kind = "semantic"
...
"""Type wall: typing.MutableSet.discard(value: _T); call it with the wrong type.
...
try:
    obj.discard(_W())  # value: _T <- wrong-typed
