...
# lib = "typing"
# dimension = "type"
# case = "MutableSet____isub____it_as_AbstractSet_wrong"
# subject = "typing.MutableSet.__isub__(it: AbstractSet)"
# kind = "semantic"
...
"""Type wall: typing.MutableSet.__isub__(it: AbstractSet); call it with the wrong type.
...
try:
    obj.__isub__(_W())  # it: AbstractSet <- wrong-typed
