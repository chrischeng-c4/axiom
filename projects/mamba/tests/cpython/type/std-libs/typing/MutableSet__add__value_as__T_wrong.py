...
# lib = "typing"
# dimension = "type"
# case = "MutableSet__add__value_as__T_wrong"
# subject = "typing.MutableSet.add(value: _T)"
# kind = "semantic"
...
"""Type wall: typing.MutableSet.add(value: _T); call it with the wrong type.
...
try:
    obj.add(_W())  # value: _T <- wrong-typed
