...
# lib = "typing"
# dimension = "type"
# case = "MutableSet____ior____it_as_AbstractSet_wrong"
# subject = "typing.MutableSet.__ior__(it: AbstractSet)"
# kind = "semantic"
...
"""Type wall: typing.MutableSet.__ior__(it: AbstractSet); call it with the wrong type.
...
try:
    obj.__ior__(_W())  # it: AbstractSet <- wrong-typed
