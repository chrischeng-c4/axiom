...
# lib = "typing"
# dimension = "type"
# case = "KeysView___from_iterable__it_as_Iterable_wrong"
# subject = "typing.KeysView._from_iterable(it: Iterable)"
# kind = "semantic"
...
"""Type wall: typing.KeysView._from_iterable(it: Iterable); call it with the wrong type.
...
try:
    KeysView._from_iterable(_W())  # it: Iterable <- wrong-typed
