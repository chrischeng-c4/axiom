...
# lib = "typing"
# dimension = "type"
# case = "AbstractSet____ge____other_as_AbstractSet_wrong"
# subject = "typing.AbstractSet.__ge__(other: AbstractSet)"
# kind = "semantic"
...
"""Type wall: typing.AbstractSet.__ge__(other: AbstractSet); call it with the wrong type.
...
try:
    obj.__ge__(_W())  # other: AbstractSet <- wrong-typed
