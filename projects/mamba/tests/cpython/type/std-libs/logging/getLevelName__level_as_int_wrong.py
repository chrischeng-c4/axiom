...
# lib = "logging"
# dimension = "type"
# case = "getLevelName__level_as_int_wrong"
# subject = "logging.getLevelName(level: int)"
# kind = "semantic"
...
"""Type wall: logging.getLevelName(level: int); call it with the wrong type.
...
try:
    getLevelName("not_an_int")  # level: int <- wrong-typed
