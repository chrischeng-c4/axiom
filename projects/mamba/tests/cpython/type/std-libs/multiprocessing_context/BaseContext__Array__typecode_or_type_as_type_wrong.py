...
# dimension = "type"
# case = "BaseContext__Array__typecode_or_type_as_type_wrong"
# subject = "multiprocessing.context.BaseContext.Array(typecode_or_type: type)"
# kind = "semantic"
...
"""Type wall: multiprocessing.context.BaseContext.Array(typecode_or_type: type); call it with the wrong type.
...
try:
    obj.Array(_W(), None)  # typecode_or_type: type <- wrong-typed
