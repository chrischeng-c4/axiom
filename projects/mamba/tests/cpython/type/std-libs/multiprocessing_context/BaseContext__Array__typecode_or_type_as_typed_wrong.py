...
# dimension = "type"
# case = "BaseContext__Array__typecode_or_type_as_typed_wrong"
# subject = "multiprocessing.context.BaseContext.Array(typecode_or_type: typed)"
# kind = "semantic"
...
"""Type wall: multiprocessing.context.BaseContext.Array(typecode_or_type: typed); call it with the wrong type.
...
try:
    obj.Array(_W(), None)  # typecode_or_type: typed <- wrong-typed
