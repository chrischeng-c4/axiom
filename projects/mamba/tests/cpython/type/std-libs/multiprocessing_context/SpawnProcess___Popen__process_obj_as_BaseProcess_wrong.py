...
# dimension = "type"
# case = "SpawnProcess___Popen__process_obj_as_BaseProcess_wrong"
# subject = "multiprocessing.context.SpawnProcess._Popen(process_obj: BaseProcess)"
# kind = "semantic"
...
"""Type wall: multiprocessing.context.SpawnProcess._Popen(process_obj: BaseProcess); call it with the wrong type.
...
try:
    SpawnProcess._Popen(_W())  # process_obj: BaseProcess <- wrong-typed
