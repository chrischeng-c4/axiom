...
# lib = "threading"
# dimension = "type"
# case = "Thread__init__group_as_typed_wrong"
# subject = "threading.Thread.__init__(group: typed)"
# kind = "semantic"
...
"""Type wall: threading.Thread.__init__(group: typed); call it with the wrong type.
...
try:
    Thread(_W())  # group: typed <- wrong-typed
