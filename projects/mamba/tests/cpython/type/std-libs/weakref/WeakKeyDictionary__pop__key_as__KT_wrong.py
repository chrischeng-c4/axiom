...
# lib = "weakref"
# dimension = "type"
# case = "WeakKeyDictionary__pop__key_as__KT_wrong"
# subject = "weakref.WeakKeyDictionary.pop(key: _KT)"
# kind = "semantic"
...
"""Type wall: weakref.WeakKeyDictionary.pop(key: _KT); call it with the wrong type.
