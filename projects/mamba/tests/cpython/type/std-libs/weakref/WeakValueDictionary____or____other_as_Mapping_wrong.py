...
# lib = "weakref"
# dimension = "type"
# case = "WeakValueDictionary____or____other_as_Mapping_wrong"
# subject = "weakref.WeakValueDictionary.__or__(other: Mapping)"
# kind = "semantic"
...
"""Type wall: weakref.WeakValueDictionary.__or__(other: Mapping); call it with the wrong type.
