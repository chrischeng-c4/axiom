...
# lib = "weakref"
# dimension = "type"
# case = "WeakKeyDictionary__setdefault__key_as__KT_wrong"
# subject = "weakref.WeakKeyDictionary.setdefault(key: _KT)"
# kind = "semantic"
...
"""Type wall: weakref.WeakKeyDictionary.setdefault(key: _KT); call it with the wrong type.
...
try:
    obj.setdefault(_W())  # key: _KT <- wrong-typed
