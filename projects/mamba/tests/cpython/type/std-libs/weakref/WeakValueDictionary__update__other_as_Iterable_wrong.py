...
# lib = "weakref"
# dimension = "type"
# case = "WeakValueDictionary__update__other_as_Iterable_wrong"
# subject = "weakref.WeakValueDictionary.update(other: Iterable)"
# kind = "semantic"
...
"""Type wall: weakref.WeakValueDictionary.update(other: Iterable); call it with the wrong type.
