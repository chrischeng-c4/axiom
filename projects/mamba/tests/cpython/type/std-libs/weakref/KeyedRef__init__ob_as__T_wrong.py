...
# lib = "weakref"
# dimension = "type"
# case = "KeyedRef__init__ob_as__T_wrong"
# subject = "weakref.KeyedRef.__init__(ob: _T)"
# kind = "semantic"
...
"""Type wall: weakref.KeyedRef.__init__(ob: _T); call it with the wrong type.
...
try:
    KeyedRef(_W(), None, None)  # ob: _T <- wrong-typed
