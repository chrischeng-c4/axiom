...
# lib = "weakref"
# dimension = "type"
# case = "WeakKeyDictionary____ior____other_as_SupportsKeysAndGetItem_wrong"
# subject = "weakref.WeakKeyDictionary.__ior__(other: SupportsKeysAndGetItem)"
# kind = "semantic"
...
"""Type wall: weakref.WeakKeyDictionary.__ior__(other: SupportsKeysAndGetItem); call it with the wrong type.
