...
# lib = "weakref"
# dimension = "type"
# case = "WeakKeyDictionary____or____other_as_Mapping_wrong"
# subject = "weakref.WeakKeyDictionary.__or__(other: Mapping)"
# kind = "semantic"
...
"""Type wall: weakref.WeakKeyDictionary.__or__(other: Mapping); call it with the wrong type.
