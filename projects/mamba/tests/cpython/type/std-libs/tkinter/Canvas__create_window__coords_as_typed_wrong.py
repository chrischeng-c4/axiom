...
# lib = "tkinter"
# dimension = "type"
# case = "Canvas__create_window__coords_as_typed_wrong"
# subject = "tkinter.Canvas.create_window(coords: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Canvas.create_window(coords: typed); call it with the wrong type.
...
try:
    obj.create_window(_W())  # coords: typed <- wrong-typed
