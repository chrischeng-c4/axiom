...
# lib = "tkinter"
# dimension = "type"
# case = "Canvas__configure__cnf_as_typed_wrong"
# subject = "tkinter.Canvas.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Canvas.configure(cnf: typed); call it with the wrong type.
