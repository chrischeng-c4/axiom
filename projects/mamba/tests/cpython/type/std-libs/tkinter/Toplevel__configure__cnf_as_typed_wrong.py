...
# lib = "tkinter"
# dimension = "type"
# case = "Toplevel__configure__cnf_as_typed_wrong"
# subject = "tkinter.Toplevel.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Toplevel.configure(cnf: typed); call it with the wrong type.
