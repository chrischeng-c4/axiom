...
# lib = "tkinter"
# dimension = "type"
# case = "Grid__grid_configure__cnf_as_typed_wrong"
# subject = "tkinter.Grid.grid_configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Grid.grid_configure(cnf: typed); call it with the wrong type.
...
try:
    obj.grid_configure(_W())  # cnf: typed <- wrong-typed
