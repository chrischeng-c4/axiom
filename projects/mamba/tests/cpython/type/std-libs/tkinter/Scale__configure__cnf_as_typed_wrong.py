...
# lib = "tkinter"
# dimension = "type"
# case = "Scale__configure__cnf_as_typed_wrong"
# subject = "tkinter.Scale.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Scale.configure(cnf: typed); call it with the wrong type.
