...
# lib = "tkinter"
# dimension = "type"
# case = "Place__place_configure__cnf_as_typed_wrong"
# subject = "tkinter.Place.place_configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Place.place_configure(cnf: typed); call it with the wrong type.
...
obj = object.__new__(Place)
try:
    obj.place_configure(_W())  # cnf: typed <- wrong-typed
