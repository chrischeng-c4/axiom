...
# lib = "tkinter"
# dimension = "type"
# case = "Wm__wm_overrideredirect__boolean_as_bool_wrong"
# subject = "tkinter.Wm.wm_overrideredirect(boolean: bool)"
# kind = "semantic"
...
"""Type wall: tkinter.Wm.wm_overrideredirect(boolean: bool); call it with the wrong type.
...
try:
    obj.wm_overrideredirect("not_a_bool")  # boolean: bool <- wrong-typed
