...
# lib = "tkinter"
# dimension = "type"
# case = "Message__configure__cnf_as_typed_wrong"
# subject = "tkinter.Message.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Message.configure(cnf: typed); call it with the wrong type.
