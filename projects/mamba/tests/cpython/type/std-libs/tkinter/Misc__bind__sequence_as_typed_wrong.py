...
# lib = "tkinter"
# dimension = "type"
# case = "Misc__bind__sequence_as_typed_wrong"
# subject = "tkinter.Misc.bind(sequence: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Misc.bind(sequence: typed); call it with the wrong type.
