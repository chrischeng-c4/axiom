...
# lib = "tkinter"
# dimension = "type"
# case = "Text__window_configure__index_as_typed_wrong"
# subject = "tkinter.Text.window_configure(index: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Text.window_configure(index: typed); call it with the wrong type.
...
try:
    obj.window_configure(_W(), "")  # index: typed <- wrong-typed
