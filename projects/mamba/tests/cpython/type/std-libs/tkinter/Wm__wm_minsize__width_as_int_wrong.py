...
# lib = "tkinter"
# dimension = "type"
# case = "Wm__wm_minsize__width_as_int_wrong"
# subject = "tkinter.Wm.wm_minsize(width: int)"
# kind = "semantic"
...
"""Type wall: tkinter.Wm.wm_minsize(width: int); call it with the wrong type.
...
try:
    obj.wm_minsize("not_an_int", 0)  # width: int <- wrong-typed
