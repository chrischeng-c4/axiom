...
# lib = "tkinter"
# dimension = "type"
# case = "Menu__add_separator__cnf_as_typed_wrong"
# subject = "tkinter.Menu.add_separator(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Menu.add_separator(cnf: typed); call it with the wrong type.
...
try:
    obj.add_separator(_W())  # cnf: typed <- wrong-typed
