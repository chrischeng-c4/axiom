...
# lib = "tkinter"
# dimension = "type"
# case = "Scrollbar__configure__cnf_as_typed_wrong"
# subject = "tkinter.Scrollbar.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Scrollbar.configure(cnf: typed); call it with the wrong type.
