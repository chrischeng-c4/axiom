...
# lib = "tkinter"
# dimension = "type"
# case = "Misc__grid_rowconfigure__index_as_typed_wrong"
# subject = "tkinter.Misc.grid_rowconfigure(index: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Misc.grid_rowconfigure(index: typed); call it with the wrong type.
...
try:
    obj.grid_rowconfigure(_W())  # index: typed <- wrong-typed
