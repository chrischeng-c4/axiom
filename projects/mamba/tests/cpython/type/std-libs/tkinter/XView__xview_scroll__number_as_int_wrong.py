...
# lib = "tkinter"
# dimension = "type"
# case = "XView__xview_scroll__number_as_int_wrong"
# subject = "tkinter.XView.xview_scroll(number: int)"
# kind = "semantic"
...
"""Type wall: tkinter.XView.xview_scroll(number: int); call it with the wrong type.
...
try:
    obj.xview_scroll("not_an_int", None)  # number: int <- wrong-typed
