...
# lib = "tkinter"
# dimension = "type"
# case = "Canvas__create_rectangle__xy_pair_0_as_tuple_wrong"
# subject = "tkinter.Canvas.create_rectangle(xy_pair_0: tuple)"
# kind = "semantic"
...
"""Type wall: tkinter.Canvas.create_rectangle(xy_pair_0: tuple); call it with the wrong type.
...
try:
    obj.create_rectangle(12345, None)  # xy_pair_0: tuple <- wrong-typed
