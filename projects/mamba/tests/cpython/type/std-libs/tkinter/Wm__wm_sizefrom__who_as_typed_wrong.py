...
# lib = "tkinter"
# dimension = "type"
# case = "Wm__wm_sizefrom__who_as_typed_wrong"
# subject = "tkinter.Wm.wm_sizefrom(who: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Wm.wm_sizefrom(who: typed); call it with the wrong type.
...
try:
    obj.wm_sizefrom(_W())  # who: typed <- wrong-typed
