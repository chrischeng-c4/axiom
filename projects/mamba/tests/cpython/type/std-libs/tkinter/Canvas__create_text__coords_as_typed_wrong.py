...
# lib = "tkinter"
# dimension = "type"
# case = "Canvas__create_text__coords_as_typed_wrong"
# subject = "tkinter.Canvas.create_text(coords: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Canvas.create_text(coords: typed); call it with the wrong type.
...
try:
    obj.create_text(_W())  # coords: typed <- wrong-typed
