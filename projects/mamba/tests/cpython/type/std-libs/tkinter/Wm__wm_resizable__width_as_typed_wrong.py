...
# lib = "tkinter"
# dimension = "type"
# case = "Wm__wm_resizable__width_as_typed_wrong"
# subject = "tkinter.Wm.wm_resizable(width: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Wm.wm_resizable(width: typed); call it with the wrong type.
...
try:
    obj.wm_resizable(_W())  # width: typed <- wrong-typed
