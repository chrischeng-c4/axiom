...
# lib = "tkinter"
# dimension = "type"
# case = "Misc__after_idle__func_as_Callable_wrong"
# subject = "tkinter.Misc.after_idle(func: Callable)"
# kind = "semantic"
...
"""Type wall: tkinter.Misc.after_idle(func: Callable); call it with the wrong type.
...
try:
    obj.after_idle(_W())  # func: Callable <- wrong-typed
