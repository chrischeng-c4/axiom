...
# lib = "tkinter"
# dimension = "type"
# case = "Misc__grid_columnconfigure__index_as_typed_wrong"
# subject = "tkinter.Misc.grid_columnconfigure(index: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Misc.grid_columnconfigure(index: typed); call it with the wrong type.
...
try:
    obj.grid_columnconfigure(_W())  # index: typed <- wrong-typed
