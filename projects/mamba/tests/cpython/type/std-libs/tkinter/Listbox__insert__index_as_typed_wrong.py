...
# lib = "tkinter"
# dimension = "type"
# case = "Listbox__insert__index_as_typed_wrong"
# subject = "tkinter.Listbox.insert(index: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Listbox.insert(index: typed); call it with the wrong type.
