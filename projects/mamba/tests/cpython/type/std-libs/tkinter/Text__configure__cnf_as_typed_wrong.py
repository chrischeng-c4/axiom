...
# lib = "tkinter"
# dimension = "type"
# case = "Text__configure__cnf_as_typed_wrong"
# subject = "tkinter.Text.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Text.configure(cnf: typed); call it with the wrong type.
