...
# lib = "tkinter"
# dimension = "type"
# case = "Wm__wm_maxsize__width_as_typed_wrong"
# subject = "tkinter.Wm.wm_maxsize(width: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Wm.wm_maxsize(width: typed); call it with the wrong type.
...
try:
    obj.wm_maxsize(_W())  # width: typed <- wrong-typed
