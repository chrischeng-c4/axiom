...
# lib = "tkinter"
# dimension = "type"
# case = "Message__configure__cnf_as_str_wrong"
# subject = "tkinter.Message.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.Message.configure(cnf: str); call it with the wrong type.
