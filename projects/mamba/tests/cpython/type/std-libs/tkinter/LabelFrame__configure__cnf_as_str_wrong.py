...
# lib = "tkinter"
# dimension = "type"
# case = "LabelFrame__configure__cnf_as_str_wrong"
# subject = "tkinter.LabelFrame.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.LabelFrame.configure(cnf: str); call it with the wrong type.
