...
# lib = "tkinter"
# dimension = "type"
# case = "Wm__wm_protocol__name_as_str_wrong"
# subject = "tkinter.Wm.wm_protocol(name: str)"
# kind = "semantic"
...
"""Type wall: tkinter.Wm.wm_protocol(name: str); call it with the wrong type.
...
try:
    obj.wm_protocol(12345, None)  # name: str <- wrong-typed
