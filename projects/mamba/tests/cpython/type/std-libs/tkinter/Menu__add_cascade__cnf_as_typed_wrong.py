...
# lib = "tkinter"
# dimension = "type"
# case = "Menu__add_cascade__cnf_as_typed_wrong"
# subject = "tkinter.Menu.add_cascade(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Menu.add_cascade(cnf: typed); call it with the wrong type.
...
try:
    obj.add_cascade(_W())  # cnf: typed <- wrong-typed
