...
# lib = "tkinter"
# dimension = "type"
# case = "Misc__bell__displayof_as_typed_wrong"
# subject = "tkinter.Misc.bell(displayof: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.Misc.bell(displayof: typed); call it with the wrong type.
...
try:
    obj.bell(_W())  # displayof: typed <- wrong-typed
