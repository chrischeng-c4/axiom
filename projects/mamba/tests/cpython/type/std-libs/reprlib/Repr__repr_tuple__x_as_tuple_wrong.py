...
# lib = "reprlib"
# dimension = "type"
# case = "Repr__repr_tuple__x_as_tuple_wrong"
# subject = "reprlib.Repr.repr_tuple(x: tuple)"
# kind = "semantic"
...
"""Type wall: reprlib.Repr.repr_tuple(x: tuple); call it with the wrong type.
...
try:
    obj.repr_tuple(12345, 0)  # x: tuple <- wrong-typed
