...
# lib = "tomllib"
# dimension = "type"
# case = "TOMLDecodeError__init__msg_as_str_wrong"
# subject = "tomllib.TOMLDecodeError.__init__(msg: str)"
# kind = "semantic"
...
"""Type wall: tomllib.TOMLDecodeError.__init__(msg: str); call it with the wrong type.
...
try:
    TOMLDecodeError(12345, "", 0)  # msg: str <- wrong-typed
