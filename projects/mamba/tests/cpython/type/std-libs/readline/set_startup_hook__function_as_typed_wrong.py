...
# lib = "readline"
# dimension = "type"
# case = "set_startup_hook__function_as_typed_wrong"
# subject = "readline.set_startup_hook(function: typed)"
# kind = "semantic"
...
"""Type wall: readline.set_startup_hook(function: typed); call it with the wrong type.
...
try:
    set_startup_hook(_W())  # function: typed <- wrong-typed
