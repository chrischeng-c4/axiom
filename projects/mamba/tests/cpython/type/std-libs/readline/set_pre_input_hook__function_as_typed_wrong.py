...
# lib = "readline"
# dimension = "type"
# case = "set_pre_input_hook__function_as_typed_wrong"
# subject = "readline.set_pre_input_hook(function: typed)"
# kind = "semantic"
...
"""Type wall: readline.set_pre_input_hook(function: typed); call it with the wrong type.
...
try:
    set_pre_input_hook(_W())  # function: typed <- wrong-typed
