...
# lib = "xmlrpc_client"
# dimension = "type"
# case = "ServerProxy____exit____exc_type_as_typed_wrong"
# subject = "xmlrpc.client.ServerProxy.__exit__(exc_type: typed)"
# kind = "semantic"
...
"""Type wall: xmlrpc.client.ServerProxy.__exit__(exc_type: typed); call it with the wrong type.
