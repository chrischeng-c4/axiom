...
# lib = "xmlrpc_client"
# dimension = "type"
# case = "Marshaller__dump_struct__value_as_Mapping_wrong"
# subject = "xmlrpc.client.Marshaller.dump_struct(value: Mapping)"
# kind = "semantic"
...
"""Type wall: xmlrpc.client.Marshaller.dump_struct(value: Mapping); call it with the wrong type.
...
try:
    obj.dump_struct(_W(), None)  # value: Mapping <- wrong-typed
