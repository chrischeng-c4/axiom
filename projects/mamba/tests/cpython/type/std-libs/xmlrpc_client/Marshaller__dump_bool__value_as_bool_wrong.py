...
# lib = "xmlrpc_client"
# dimension = "type"
# case = "Marshaller__dump_bool__value_as_bool_wrong"
# subject = "xmlrpc.client.Marshaller.dump_bool(value: bool)"
# kind = "semantic"
...
"""Type wall: xmlrpc.client.Marshaller.dump_bool(value: bool); call it with the wrong type.
...
try:
    obj.dump_bool("not_a_bool", None)  # value: bool <- wrong-typed
