...
# lib = "xmlrpc_client"
# dimension = "type"
# case = "SafeTransport__init__use_datetime_as_bool_wrong"
# subject = "xmlrpc.client.SafeTransport.__init__(use_datetime: bool)"
# kind = "semantic"
...
"""Type wall: xmlrpc.client.SafeTransport.__init__(use_datetime: bool); call it with the wrong type.
...
try:
    SafeTransport("not_a_bool")  # use_datetime: bool <- wrong-typed
