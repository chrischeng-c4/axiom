...
# lib = "xmlrpc_client"
# dimension = "type"
# case = "Transport__init__use_datetime_as_bool_wrong"
# subject = "xmlrpc.client.Transport.__init__(use_datetime: bool)"
# kind = "semantic"
...
"""Type wall: xmlrpc.client.Transport.__init__(use_datetime: bool); call it with the wrong type.
...
try:
    Transport("not_a_bool")  # use_datetime: bool <- wrong-typed
