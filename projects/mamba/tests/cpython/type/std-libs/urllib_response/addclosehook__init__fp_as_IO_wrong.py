...
# lib = "urllib_response"
# dimension = "type"
# case = "addclosehook__init__fp_as_IO_wrong"
# subject = "urllib.response.addclosehook.__init__(fp: IO)"
# kind = "semantic"
...
"""Type wall: urllib.response.addclosehook.__init__(fp: IO); call it with the wrong type.
...
try:
    addclosehook(_W(), None)  # fp: IO <- wrong-typed
