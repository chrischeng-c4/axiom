...
# subject = "encodings.utf_7.IncrementalDecoder._buffer_decode(data: ReadableBuffer)"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
"""Type wall: encodings.utf_7.IncrementalDecoder._buffer_decode(data: ReadableBuffer); call it with the wrong type.
...
from encodings.utf_7 import IncrementalDecoder
try:
