...
# dimension = "type"
# case = "Interpreter__call__callable_as_Callable_wrong"
# subject = "concurrent.interpreters.Interpreter.call(callable: Callable)"
# kind = "semantic"
...
"""Type wall: concurrent.interpreters.Interpreter.call(callable: Callable); call it with the wrong type.
...
try:
    obj.call(_W())  # callable: Callable <- wrong-typed
