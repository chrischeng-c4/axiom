...
# lib = "unittest_loader"
# dimension = "type"
# case = "TestLoader__loadTestsFromTestCase__testCaseClass_as_type_wrong"
# subject = "unittest.loader.TestLoader.loadTestsFromTestCase(testCaseClass: type)"
# kind = "semantic"
...
"""Type wall: unittest.loader.TestLoader.loadTestsFromTestCase(testCaseClass: type); call it with the wrong type.
...
try:
    obj.loadTestsFromTestCase(_W())  # testCaseClass: type <- wrong-typed
