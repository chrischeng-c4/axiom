...
# lib = "unittest_loader"
# dimension = "type"
# case = "getTestCaseNames__testCaseClass_as_type_wrong"
# subject = "unittest.loader.getTestCaseNames(testCaseClass: type)"
# kind = "semantic"
...
"""Type wall: unittest.loader.getTestCaseNames(testCaseClass: type); call it with the wrong type.
...
try:
    getTestCaseNames(_W(), "")  # testCaseClass: type <- wrong-typed
