...
# lib = "enum"
# dimension = "type"
# case = "nonmember__init__value_as__EnumMemberT_wrong"
# subject = "enum.nonmember.__init__(value: _EnumMemberT)"
# kind = "semantic"
...
"""Type wall: enum.nonmember.__init__(value: _EnumMemberT); call it with the wrong type.
...
try:
    nonmember(_W())  # value: _EnumMemberT <- wrong-typed
