...
# lib = "unittest_mock"
# dimension = "type"
# case = "NonCallableMock____new____spec_as_typed_wrong"
# subject = "unittest.mock.NonCallableMock.__new__(spec: typed)"
# kind = "semantic"
...
"""Type wall: unittest.mock.NonCallableMock.__new__(spec: typed); call it with the wrong type.
...
try:
    obj.__new__(_W())  # spec: typed <- wrong-typed
