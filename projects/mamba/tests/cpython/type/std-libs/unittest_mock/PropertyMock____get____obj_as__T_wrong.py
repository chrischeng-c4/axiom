...
# lib = "unittest_mock"
# dimension = "type"
# case = "PropertyMock____get____obj_as__T_wrong"
# subject = "unittest.mock.PropertyMock.__get__(obj: _T)"
# kind = "semantic"
...
"""Type wall: unittest.mock.PropertyMock.__get__(obj: _T); call it with the wrong type.
...
obj = object.__new__(PropertyMock)
try:
    obj.__get__(_W())  # obj: _T <- wrong-typed
