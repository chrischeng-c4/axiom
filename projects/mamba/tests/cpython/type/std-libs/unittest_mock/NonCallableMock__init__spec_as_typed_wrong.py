...
# lib = "unittest_mock"
# dimension = "type"
# case = "NonCallableMock__init__spec_as_typed_wrong"
# subject = "unittest.mock.NonCallableMock.__init__(spec: typed)"
# kind = "semantic"
...
"""Type wall: unittest.mock.NonCallableMock.__init__(spec: typed); call it with the wrong type.
...
try:
    NonCallableMock(_W())  # spec: typed <- wrong-typed
