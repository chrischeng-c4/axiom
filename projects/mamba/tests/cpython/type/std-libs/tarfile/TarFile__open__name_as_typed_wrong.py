...
# lib = "tarfile"
# dimension = "type"
# case = "TarFile__open__name_as_typed_wrong"
# subject = "tarfile.TarFile.open(name: typed)"
# kind = "semantic"
...
"""Type wall: tarfile.TarFile.open(name: typed); call it with the wrong type.
...
try:
    TarFile.open(_W())  # name: typed <- wrong-typed
