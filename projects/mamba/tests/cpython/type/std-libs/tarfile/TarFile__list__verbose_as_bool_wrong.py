...
# lib = "tarfile"
# dimension = "type"
# case = "TarFile__list__verbose_as_bool_wrong"
# subject = "tarfile.TarFile.list(verbose: bool)"
# kind = "semantic"
...
"""Type wall: tarfile.TarFile.list(verbose: bool); call it with the wrong type.
...
try:
    obj.list("not_a_bool")  # verbose: bool <- wrong-typed
