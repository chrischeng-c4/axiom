...
# lib = "tarfile"
# dimension = "type"
# case = "TarFile__bz2open__name_as_typed_wrong"
# subject = "tarfile.TarFile.bz2open(name: typed)"
# kind = "semantic"
...
"""Type wall: tarfile.TarFile.bz2open(name: typed); call it with the wrong type.
...
try:
    TarFile.bz2open(_W(), None)  # name: typed <- wrong-typed
