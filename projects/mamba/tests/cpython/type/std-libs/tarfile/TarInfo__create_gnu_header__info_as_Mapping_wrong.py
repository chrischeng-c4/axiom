...
# lib = "tarfile"
# dimension = "type"
# case = "TarInfo__create_gnu_header__info_as_Mapping_wrong"
# subject = "tarfile.TarInfo.create_gnu_header(info: Mapping)"
# kind = "semantic"
...
"""Type wall: tarfile.TarInfo.create_gnu_header(info: Mapping); call it with the wrong type.
...
try:
    obj.create_gnu_header(_W(), "", "")  # info: Mapping <- wrong-typed
