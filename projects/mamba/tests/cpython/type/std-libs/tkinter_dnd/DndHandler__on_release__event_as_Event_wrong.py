...
# lib = "tkinter_dnd"
# dimension = "type"
# case = "DndHandler__on_release__event_as_Event_wrong"
# subject = "tkinter.dnd.DndHandler.on_release(event: Event)"
# kind = "semantic"
...
"""Type wall: tkinter.dnd.DndHandler.on_release(event: Event); call it with the wrong type.
...
try:
    obj.on_release(_W())  # event: Event <- wrong-typed
