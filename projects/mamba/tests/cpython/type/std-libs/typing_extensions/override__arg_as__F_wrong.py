...
# dimension = "type"
# case = "override__arg_as__F_wrong"
# subject = "typing_extensions.override(arg: _F)"
# kind = "semantic"
...
"""Type wall: typing_extensions.override(arg: _F); call it with the wrong type.
...
try:
    override(_W())  # arg: _F <- wrong-typed
