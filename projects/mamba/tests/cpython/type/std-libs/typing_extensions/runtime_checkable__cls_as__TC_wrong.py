...
# dimension = "type"
# case = "runtime_checkable__cls_as__TC_wrong"
# subject = "typing_extensions.runtime_checkable(cls: _TC)"
# kind = "semantic"
...
"""Type wall: typing_extensions.runtime_checkable(cls: _TC); call it with the wrong type.
...
try:
    runtime_checkable(_W())  # cls: _TC <- wrong-typed
