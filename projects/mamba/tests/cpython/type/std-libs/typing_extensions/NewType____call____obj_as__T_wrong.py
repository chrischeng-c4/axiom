...
# dimension = "type"
# case = "NewType____call____obj_as__T_wrong"
# subject = "typing_extensions.NewType.__call__(obj: _T)"
# kind = "semantic"
...
"""Type wall: typing_extensions.NewType.__call__(obj: _T); call it with the wrong type.
...
obj = object.__new__(NewType)
try:
    obj.__call__(_W())  # obj: _T <- wrong-typed
