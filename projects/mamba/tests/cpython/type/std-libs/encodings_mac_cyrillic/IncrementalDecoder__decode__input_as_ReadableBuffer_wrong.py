...
# subject = "encodings.mac_cyrillic.IncrementalDecoder.decode(input: ReadableBuffer)"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
"""Type wall: encodings.mac_cyrillic.IncrementalDecoder.decode(input: ReadableBuffer); call it with the wrong type.
...
from encodings.mac_cyrillic import IncrementalDecoder
