...
# lib = "site"
# dimension = "type"
# case = "venv__known_paths_as_typed_wrong"
# subject = "site.venv(known_paths: typed)"
# kind = "semantic"
...
"""Type wall: site.venv(known_paths: typed); call it with the wrong type.
...
try:
    venv(_W())  # known_paths: typed <- wrong-typed
