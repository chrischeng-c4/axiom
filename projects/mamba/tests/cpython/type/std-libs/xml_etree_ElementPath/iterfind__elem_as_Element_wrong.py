...
# dimension = "type"
# case = "iterfind__elem_as_Element_wrong"
# subject = "xml.etree.ElementPath.iterfind(elem: Element)"
# kind = "semantic"
...
"""Type wall: xml.etree.ElementPath.iterfind(elem: Element); call it with the wrong type.
...
try:
    iterfind(_W(), None)  # elem: Element <- wrong-typed
