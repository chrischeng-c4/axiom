...
# dimension = "type"
# case = "ExpatParser__getProperty__name_as_str_wrong"
# subject = "xml.sax.expatreader.ExpatParser.getProperty(name: str)"
# kind = "semantic"
...
"""Type wall: xml.sax.expatreader.ExpatParser.getProperty(name: str); call it with the wrong type.
