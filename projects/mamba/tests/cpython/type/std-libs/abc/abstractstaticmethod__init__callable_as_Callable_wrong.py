...
# lib = "abc"
# dimension = "type"
# case = "abstractstaticmethod__init__callable_as_Callable_wrong"
# subject = "abc.abstractstaticmethod.__init__(callable: Callable)"
# kind = "semantic"
...
"""Type wall: abc.abstractstaticmethod.__init__(callable: Callable); call it with the wrong type.
...
try:
    abstractstaticmethod(_W())  # callable: Callable <- wrong-typed
