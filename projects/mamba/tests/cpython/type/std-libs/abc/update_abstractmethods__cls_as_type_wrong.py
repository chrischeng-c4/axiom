...
# lib = "abc"
# dimension = "type"
# case = "update_abstractmethods__cls_as_type_wrong"
# subject = "abc.update_abstractmethods(cls: type)"
# kind = "semantic"
...
"""Type wall: abc.update_abstractmethods(cls: type); call it with the wrong type.
...
try:
    update_abstractmethods(_W())  # cls: type <- wrong-typed
