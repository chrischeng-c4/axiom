...
# subject = "encodings.cp860.IncrementalDecoder.decode(input: ReadableBuffer)"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
"""Type wall: encodings.cp860.IncrementalDecoder.decode(input: ReadableBuffer); call it with the wrong type.
...
from encodings.cp860 import IncrementalDecoder
