...
# lib = "asynchat"
# dimension = "type"
# case = "async_chat__collect_incoming_data__data_as_bytes_wrong"
# subject = "asynchat.async_chat.collect_incoming_data(data: bytes)"
# kind = "semantic"
...
"""Type wall: asynchat.async_chat.collect_incoming_data(data: bytes); call it with the wrong type.
