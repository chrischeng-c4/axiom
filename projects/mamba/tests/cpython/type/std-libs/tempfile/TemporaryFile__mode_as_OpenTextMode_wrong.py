...
# lib = "tempfile"
# dimension = "type"
# case = "TemporaryFile__mode_as_OpenTextMode_wrong"
# subject = "tempfile.TemporaryFile(mode: OpenTextMode)"
# kind = "semantic"
...
"""Type wall: tempfile.TemporaryFile(mode: OpenTextMode); call it with the wrong type.
...
try:
    TemporaryFile(_W())  # mode: OpenTextMode <- wrong-typed
