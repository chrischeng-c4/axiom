...
# lib = "tempfile"
# dimension = "type"
# case = "SpooledTemporaryFile__writelines__iterable_as_Iterable_wrong"
# subject = "tempfile.SpooledTemporaryFile.writelines(iterable: Iterable)"
# kind = "semantic"
...
"""Type wall: tempfile.SpooledTemporaryFile.writelines(iterable: Iterable); call it with the wrong type.
...
try:
    obj.writelines(_W())  # iterable: Iterable <- wrong-typed
