...
# lib = "tempfile"
# dimension = "type"
# case = "TemporaryFile__mode_as_str_wrong"
# subject = "tempfile.TemporaryFile(mode: str)"
# kind = "semantic"
...
"""Type wall: tempfile.TemporaryFile(mode: str); call it with the wrong type.
...
try:
    TemporaryFile(12345)  # mode: str <- wrong-typed
