...
# lib = "tempfile"
# dimension = "type"
# case = "TemporaryFile__mode_as_OpenBinaryMode_wrong"
# subject = "tempfile.TemporaryFile(mode: OpenBinaryMode)"
# kind = "semantic"
...
"""Type wall: tempfile.TemporaryFile(mode: OpenBinaryMode); call it with the wrong type.
...
try:
    TemporaryFile(_W(), None)  # mode: OpenBinaryMode <- wrong-typed
