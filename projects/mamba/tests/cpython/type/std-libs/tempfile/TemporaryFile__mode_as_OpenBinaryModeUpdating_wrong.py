...
# lib = "tempfile"
# dimension = "type"
# case = "TemporaryFile__mode_as_OpenBinaryModeUpdating_wrong"
# subject = "tempfile.TemporaryFile(mode: OpenBinaryModeUpdating)"
# kind = "semantic"
...
"""Type wall: tempfile.TemporaryFile(mode: OpenBinaryModeUpdating); call it with the wrong type.
...
try:
    TemporaryFile(_W())  # mode: OpenBinaryModeUpdating <- wrong-typed
