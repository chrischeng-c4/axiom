...
# lib = "fractions"
# dimension = "type"
# case = "Fraction____rmul____a_as_float_wrong"
# subject = "fractions.Fraction.__rmul__(a: float)"
# kind = "semantic"
...
"""Type wall: fractions.Fraction.__rmul__(a: float); call it with the wrong type.
...
try:
    obj.__rmul__("not_a_float")  # a: float <- wrong-typed
