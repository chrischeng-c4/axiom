...
# lib = "fractions"
# dimension = "type"
# case = "Fraction____truediv____b_as_complex_wrong"
# subject = "fractions.Fraction.__truediv__(b: complex)"
# kind = "semantic"
...
"""Type wall: fractions.Fraction.__truediv__(b: complex); call it with the wrong type.
...
try:
    obj.__truediv__("not_a_complex")  # b: complex <- wrong-typed
