...
# lib = "fractions"
# dimension = "type"
# case = "Fraction____mul____b_as_float_wrong"
# subject = "fractions.Fraction.__mul__(b: float)"
# kind = "semantic"
...
"""Type wall: fractions.Fraction.__mul__(b: float); call it with the wrong type.
...
try:
    obj.__mul__("not_a_float")  # b: float <- wrong-typed
