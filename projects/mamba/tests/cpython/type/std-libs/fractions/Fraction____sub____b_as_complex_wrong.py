...
# lib = "fractions"
# dimension = "type"
# case = "Fraction____sub____b_as_complex_wrong"
# subject = "fractions.Fraction.__sub__(b: complex)"
# kind = "semantic"
...
"""Type wall: fractions.Fraction.__sub__(b: complex); call it with the wrong type.
...
try:
    obj.__sub__("not_a_complex")  # b: complex <- wrong-typed
