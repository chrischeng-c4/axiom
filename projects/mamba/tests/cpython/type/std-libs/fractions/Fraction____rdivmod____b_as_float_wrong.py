...
# lib = "fractions"
# dimension = "type"
# case = "Fraction____rdivmod____b_as_float_wrong"
# subject = "fractions.Fraction.__rdivmod__(b: float)"
# kind = "semantic"
...
"""Type wall: fractions.Fraction.__rdivmod__(b: float); call it with the wrong type.
...
try:
    obj.__rdivmod__("not_a_float")  # b: float <- wrong-typed
