...
# lib = "_weakrefset"
# dimension = "type"
# case = "WeakSet__discard__item_as__T_wrong"
# subject = "_weakrefset.WeakSet.discard(item: _T)"
# kind = "semantic"
...
"""Type wall: _weakrefset.WeakSet.discard(item: _T); call it with the wrong type.
...
try:
    obj.discard(_W())  # item: _T <- wrong-typed
