...
# lib = "_weakrefset"
# dimension = "type"
# case = "WeakSet__add__item_as__T_wrong"
# subject = "_weakrefset.WeakSet.add(item: _T)"
# kind = "semantic"
...
"""Type wall: _weakrefset.WeakSet.add(item: _T); call it with the wrong type.
...
try:
    obj.add(_W())  # item: _T <- wrong-typed
