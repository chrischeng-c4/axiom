...
# lib = "inspect"
# dimension = "type"
# case = "getclasstree__classes_as_list_wrong"
# subject = "inspect.getclasstree(classes: list)"
# kind = "semantic"
...
"""Type wall: inspect.getclasstree(classes: list); call it with the wrong type.
...
try:
    getclasstree(12345)  # classes: list <- wrong-typed
