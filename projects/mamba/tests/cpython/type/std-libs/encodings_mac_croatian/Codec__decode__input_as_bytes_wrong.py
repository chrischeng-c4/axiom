...
# subject = "encodings.mac_croatian.Codec.decode(input: bytes)"
# kind = "semantic"
...
"""Type wall: encodings.mac_croatian.Codec.decode(input: bytes); call it with the wrong type.

typeshed contract: input is bytes. mamba is force-typed, so a wrong-typed
argument MUST raise TypeError (CPython may accept or raise — mamba's to enforce)."""

from encodings.mac_croatian import Codec
