...
# dimension = "type"
# case = "GeckoCollector__collect__stack_frames_as_typed_wrong"
# subject = "profiling.sampling.gecko_collector.GeckoCollector.collect(stack_frames: typed)"
# kind = "semantic"
...
"""Type wall: profiling.sampling.gecko_collector.GeckoCollector.collect(stack_frames: typed); call it with the wrong type.
