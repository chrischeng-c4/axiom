...
# lib = "posixpath"
# dimension = "type"
# case = "splitroot__path_as_PathLike_wrong"
# subject = "posixpath.splitroot(path: PathLike)"
# kind = "semantic"
...
"""Type wall: posixpath.splitroot(path: PathLike); call it with the wrong type.
...
try:
    splitroot(_W())  # path: PathLike <- wrong-typed
