...
# dimension = "type"
# case = "Queue__put__obj_as__T_wrong"
# subject = "multiprocessing.queues.Queue.put(obj: _T)"
# kind = "semantic"
...
"""Type wall: multiprocessing.queues.Queue.put(obj: _T); call it with the wrong type.
