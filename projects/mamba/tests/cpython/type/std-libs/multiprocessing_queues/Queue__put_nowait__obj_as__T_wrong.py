...
# dimension = "type"
# case = "Queue__put_nowait__obj_as__T_wrong"
# subject = "multiprocessing.queues.Queue.put_nowait(obj: _T)"
# kind = "semantic"
...
"""Type wall: multiprocessing.queues.Queue.put_nowait(obj: _T); call it with the wrong type.
...
try:
    obj.put_nowait(_W())  # obj: _T <- wrong-typed
