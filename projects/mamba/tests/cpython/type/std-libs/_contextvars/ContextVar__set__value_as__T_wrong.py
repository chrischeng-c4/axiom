...
# lib = "_contextvars"
# dimension = "type"
# case = "ContextVar__set__value_as__T_wrong"
# subject = "_contextvars.ContextVar.set(value: _T)"
# kind = "semantic"
...
"""Type wall: _contextvars.ContextVar.set(value: _T); call it with the wrong type.
