...
# dimension = "type"
# case = "XMLGenerator__startElementNS__name_as_tuple_wrong"
# subject = "xml.sax.saxutils.XMLGenerator.startElementNS(name: tuple)"
# kind = "semantic"
...
"""Type wall: xml.sax.saxutils.XMLGenerator.startElementNS(name: tuple); call it with the wrong type.
