...
# lib = "asyncio_graph"
# dimension = "type"
# case = "format_call_graph__future_as_typed_wrong"
# subject = "asyncio.graph.format_call_graph(future: typed)"
# kind = "semantic"
...
"""Type wall: asyncio.graph.format_call_graph(future: typed); call it with the wrong type.
...
from asyncio.graph import format_call_graph
try:
    format_call_graph(_W())  # future: typed <- wrong-typed
