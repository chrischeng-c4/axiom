...
# subject = "encodings.utf_32_be.IncrementalDecoder._buffer_decode(data: ReadableBuffer)"
# kind = "semantic"
...
"""Type wall: encodings.utf_32_be.IncrementalDecoder._buffer_decode(data: ReadableBuffer); call it with the wrong type.
...
from encodings.utf_32_be import IncrementalDecoder
try:
