...
# lib = "difflib"
# dimension = "type"
# case = "context_diff__a_as_Sequence_wrong"
# subject = "difflib.context_diff(a: Sequence)"
# kind = "semantic"
...
"""Type wall: difflib.context_diff(a: Sequence); call it with the wrong type.
...
try:
    context_diff(_W(), None)  # a: Sequence <- wrong-typed
