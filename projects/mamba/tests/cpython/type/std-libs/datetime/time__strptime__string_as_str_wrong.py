...
# lib = "datetime"
# dimension = "type"
# case = "time__strptime__string_as_str_wrong"
# subject = "datetime.time.strptime(string: str)"
# kind = "semantic"
...
"""Type wall: datetime.time.strptime(string: str); call it with the wrong type.
...
try:
    time.strptime(12345, "")  # string: str <- wrong-typed
