...
# lib = "datetime"
# dimension = "type"
# case = "date__strptime__string_as_str_wrong"
# subject = "datetime.date.strptime(string: str)"
# kind = "semantic"
...
"""Type wall: datetime.date.strptime(string: str); call it with the wrong type.
...
try:
    date.strptime(12345, "")  # string: str <- wrong-typed
