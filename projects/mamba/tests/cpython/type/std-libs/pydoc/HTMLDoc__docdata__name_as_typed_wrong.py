...
# lib = "pydoc"
# dimension = "type"
# case = "HTMLDoc__docdata__name_as_typed_wrong"
# subject = "pydoc.HTMLDoc.docdata(name: typed)"
# kind = "semantic"
...
"""Type wall: pydoc.HTMLDoc.docdata(name: typed); call it with the wrong type.
...
try:
    obj.docdata(None, _W())  # name: typed <- wrong-typed
