...
# lib = "pydoc"
# dimension = "type"
# case = "HTMLRepr__repr_instance__level_as_complex_wrong"
# subject = "pydoc.HTMLRepr.repr_instance(level: complex)"
# kind = "semantic"
...
"""Type wall: pydoc.HTMLRepr.repr_instance(level: complex); call it with the wrong type.
