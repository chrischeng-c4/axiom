...
# lib = "pydoc"
# dimension = "type"
# case = "writedoc__thing_as_typed_wrong"
# subject = "pydoc.writedoc(thing: typed)"
# kind = "semantic"
...
"""Type wall: pydoc.writedoc(thing: typed); call it with the wrong type.
...
try:
    writedoc(_W())  # thing: typed <- wrong-typed
