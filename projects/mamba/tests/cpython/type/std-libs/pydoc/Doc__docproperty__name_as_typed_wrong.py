...
# lib = "pydoc"
# dimension = "type"
# case = "Doc__docproperty__name_as_typed_wrong"
# subject = "pydoc.Doc.docproperty(name: typed)"
# kind = "semantic"
...
"""Type wall: pydoc.Doc.docproperty(name: typed); call it with the wrong type.
