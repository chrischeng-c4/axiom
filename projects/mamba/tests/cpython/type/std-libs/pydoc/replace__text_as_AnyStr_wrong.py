...
# lib = "pydoc"
# dimension = "type"
# case = "replace__text_as_AnyStr_wrong"
# subject = "pydoc.replace(text: AnyStr)"
# kind = "semantic"
...
"""Type wall: pydoc.replace(text: AnyStr); call it with the wrong type.
...
try:
    replace(_W())  # text: AnyStr <- wrong-typed
