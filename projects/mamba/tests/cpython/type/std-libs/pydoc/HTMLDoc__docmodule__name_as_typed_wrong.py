...
# lib = "pydoc"
# dimension = "type"
# case = "HTMLDoc__docmodule__name_as_typed_wrong"
# subject = "pydoc.HTMLDoc.docmodule(name: typed)"
# kind = "semantic"
...
"""Type wall: pydoc.HTMLDoc.docmodule(name: typed); call it with the wrong type.
...
try:
    obj.docmodule(None, _W())  # name: typed <- wrong-typed
