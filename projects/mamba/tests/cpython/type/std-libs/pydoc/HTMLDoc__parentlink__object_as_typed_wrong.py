...
# lib = "pydoc"
# dimension = "type"
# case = "HTMLDoc__parentlink__object_as_typed_wrong"
# subject = "pydoc.HTMLDoc.parentlink(object: typed)"
# kind = "semantic"
...
"""Type wall: pydoc.HTMLDoc.parentlink(object: typed); call it with the wrong type.
...
try:
    obj.parentlink(_W(), "")  # object: typed <- wrong-typed
