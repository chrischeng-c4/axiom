...
# lib = "pydoc"
# dimension = "type"
# case = "TextDoc__docproperty__name_as_typed_wrong"
# subject = "pydoc.TextDoc.docproperty(name: typed)"
# kind = "semantic"
...
"""Type wall: pydoc.TextDoc.docproperty(name: typed); call it with the wrong type.
...
try:
    obj.docproperty(None, _W())  # name: typed <- wrong-typed
