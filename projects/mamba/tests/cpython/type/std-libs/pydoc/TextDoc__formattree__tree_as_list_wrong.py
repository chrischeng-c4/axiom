...
# lib = "pydoc"
# dimension = "type"
# case = "TextDoc__formattree__tree_as_list_wrong"
# subject = "pydoc.TextDoc.formattree(tree: list)"
# kind = "semantic"
...
"""Type wall: pydoc.TextDoc.formattree(tree: list); call it with the wrong type.
