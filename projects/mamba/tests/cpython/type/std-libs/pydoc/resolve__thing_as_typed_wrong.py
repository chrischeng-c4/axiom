...
# lib = "pydoc"
# dimension = "type"
# case = "resolve__thing_as_typed_wrong"
# subject = "pydoc.resolve(thing: typed)"
# kind = "semantic"
...
"""Type wall: pydoc.resolve(thing: typed); call it with the wrong type.
...
try:
    resolve(_W())  # thing: typed <- wrong-typed
