...
# lib = "pydoc"
# dimension = "type"
# case = "Doc__fail__name_as_typed_wrong"
# subject = "pydoc.Doc.fail(name: typed)"
# kind = "semantic"
...
"""Type wall: pydoc.Doc.fail(name: typed); call it with the wrong type.
...
try:
    obj.fail(None, _W())  # name: typed <- wrong-typed
