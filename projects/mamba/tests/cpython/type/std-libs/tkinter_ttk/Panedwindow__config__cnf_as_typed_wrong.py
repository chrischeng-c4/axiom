...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Panedwindow__config__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Panedwindow.config(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Panedwindow.config(cnf: typed); call it with the wrong type.
