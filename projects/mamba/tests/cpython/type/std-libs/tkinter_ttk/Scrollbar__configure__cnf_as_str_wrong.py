...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Scrollbar__configure__cnf_as_str_wrong"
# subject = "tkinter.ttk.Scrollbar.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Scrollbar.configure(cnf: str); call it with the wrong type.
