...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Radiobutton__configure__cnf_as_str_wrong"
# subject = "tkinter.ttk.Radiobutton.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Radiobutton.configure(cnf: str); call it with the wrong type.
