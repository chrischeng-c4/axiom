...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Menubutton__configure__cnf_as_str_wrong"
# subject = "tkinter.ttk.Menubutton.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Menubutton.configure(cnf: str); call it with the wrong type.
