...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Treeview__item__item_as_typed_wrong"
# subject = "tkinter.ttk.Treeview.item(item: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Treeview.item(item: typed); call it with the wrong type.
...
try:
    obj.item(_W(), None)  # item: typed <- wrong-typed
