...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Entry__config__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Entry.config(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Entry.config(cnf: typed); call it with the wrong type.
