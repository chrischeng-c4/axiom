...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Frame__configure__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Frame.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Frame.configure(cnf: typed); call it with the wrong type.
