...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Treeview__selection_toggle__items_as_typed_wrong"
# subject = "tkinter.ttk.Treeview.selection_toggle(items: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Treeview.selection_toggle(items: typed); call it with the wrong type.
...
try:
    obj.selection_toggle(_W())  # items: typed <- wrong-typed
