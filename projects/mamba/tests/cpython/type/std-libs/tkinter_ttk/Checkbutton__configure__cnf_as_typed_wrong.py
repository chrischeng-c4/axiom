...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Checkbutton__configure__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Checkbutton.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Checkbutton.configure(cnf: typed); call it with the wrong type.
