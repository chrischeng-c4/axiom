...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Panedwindow__configure__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Panedwindow.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Panedwindow.configure(cnf: typed); call it with the wrong type.
