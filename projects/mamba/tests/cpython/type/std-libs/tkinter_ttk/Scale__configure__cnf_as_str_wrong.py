...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Scale__configure__cnf_as_str_wrong"
# subject = "tkinter.ttk.Scale.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Scale.configure(cnf: str); call it with the wrong type.
