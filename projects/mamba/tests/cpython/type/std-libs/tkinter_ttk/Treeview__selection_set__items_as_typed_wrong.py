...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Treeview__selection_set__items_as_typed_wrong"
# subject = "tkinter.ttk.Treeview.selection_set(items: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Treeview.selection_set(items: typed); call it with the wrong type.
...
try:
    obj.selection_set(_W())  # items: typed <- wrong-typed
