...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Spinbox__configure__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Spinbox.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Spinbox.configure(cnf: typed); call it with the wrong type.
