...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Treeview__set_children__item_as_typed_wrong"
# subject = "tkinter.ttk.Treeview.set_children(item: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Treeview.set_children(item: typed); call it with the wrong type.
...
try:
    obj.set_children(_W())  # item: typed <- wrong-typed
