...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Treeview__configure__cnf_as_str_wrong"
# subject = "tkinter.ttk.Treeview.configure(cnf: str)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Treeview.configure(cnf: str); call it with the wrong type.
