...
# lib = "tkinter_ttk"
# dimension = "type"
# case = "Combobox__configure__cnf_as_typed_wrong"
# subject = "tkinter.ttk.Combobox.configure(cnf: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.ttk.Combobox.configure(cnf: typed); call it with the wrong type.
