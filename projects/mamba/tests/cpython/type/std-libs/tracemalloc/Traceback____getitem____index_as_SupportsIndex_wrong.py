...
# lib = "tracemalloc"
# dimension = "type"
# case = "Traceback____getitem____index_as_SupportsIndex_wrong"
# subject = "tracemalloc.Traceback.__getitem__(index: SupportsIndex)"
# kind = "semantic"
...
"""Type wall: tracemalloc.Traceback.__getitem__(index: SupportsIndex); call it with the wrong type.
...
try:
    obj.__getitem__(_W())  # index: SupportsIndex <- wrong-typed
