...
# dimension = "type"
# case = "PidfdChildWatcher__add_child_handler__pid_as_int_wrong"
# subject = "asyncio.unix_events.PidfdChildWatcher.add_child_handler(pid: int)"
# kind = "semantic"
...
"""Type wall: asyncio.unix_events.PidfdChildWatcher.add_child_handler(pid: int); call it with the wrong type.
