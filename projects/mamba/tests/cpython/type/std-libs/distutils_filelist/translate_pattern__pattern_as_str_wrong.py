...
# dimension = "type"
# case = "translate_pattern__pattern_as_str_wrong"
# subject = "distutils.filelist.translate_pattern(pattern: str)"
# kind = "semantic"
...
"""Type wall: distutils.filelist.translate_pattern(pattern: str); call it with the wrong type.
...
try:
    translate_pattern(12345)  # pattern: str <- wrong-typed
