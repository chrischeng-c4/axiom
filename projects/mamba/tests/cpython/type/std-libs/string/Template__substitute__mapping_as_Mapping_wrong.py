...
# lib = "string"
# dimension = "type"
# case = "Template__substitute__mapping_as_Mapping_wrong"
# subject = "string.Template.substitute(mapping: Mapping)"
# kind = "semantic"
...
"""Type wall: string.Template.substitute(mapping: Mapping); call it with the wrong type.
...
try:
    obj.substitute(_W())  # mapping: Mapping <- wrong-typed
