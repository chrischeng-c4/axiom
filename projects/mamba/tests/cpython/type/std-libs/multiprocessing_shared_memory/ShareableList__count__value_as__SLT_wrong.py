...
# dimension = "type"
# case = "ShareableList__count__value_as__SLT_wrong"
# subject = "multiprocessing.shared_memory.ShareableList.count(value: _SLT)"
# kind = "semantic"
...
"""Type wall: multiprocessing.shared_memory.ShareableList.count(value: _SLT); call it with the wrong type.
...
try:
    obj.count(_W())  # value: _SLT <- wrong-typed
