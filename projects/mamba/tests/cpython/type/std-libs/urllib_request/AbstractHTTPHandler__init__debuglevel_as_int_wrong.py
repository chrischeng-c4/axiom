...
# lib = "urllib_request"
# dimension = "type"
# case = "AbstractHTTPHandler__init__debuglevel_as_int_wrong"
# subject = "urllib.request.AbstractHTTPHandler.__init__(debuglevel: int)"
# kind = "semantic"
...
"""Type wall: urllib.request.AbstractHTTPHandler.__init__(debuglevel: int); call it with the wrong type.
...
try:
    AbstractHTTPHandler("not_an_int")  # debuglevel: int <- wrong-typed
