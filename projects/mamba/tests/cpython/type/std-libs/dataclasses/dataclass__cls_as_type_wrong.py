...
# lib = "dataclasses"
# dimension = "type"
# case = "dataclass__cls_as_type_wrong"
# subject = "dataclasses.dataclass(cls: type)"
# kind = "semantic"
...
"""Type wall: dataclasses.dataclass(cls: type); call it with the wrong type.
...
try:
    dataclass(_W())  # cls: type <- wrong-typed
