...
# lib = "dataclasses"
# dimension = "type"
# case = "InitVar__init__type_as_Type_wrong"
# subject = "dataclasses.InitVar.__init__(type: Type)"
# kind = "semantic"
...
"""Type wall: dataclasses.InitVar.__init__(type: Type); call it with the wrong type.
...
try:
    InitVar(_W())  # type: Type <- wrong-typed
