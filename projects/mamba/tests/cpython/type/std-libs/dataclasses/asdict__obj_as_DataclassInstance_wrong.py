...
# lib = "dataclasses"
# dimension = "type"
# case = "asdict__obj_as_DataclassInstance_wrong"
# subject = "dataclasses.asdict(obj: DataclassInstance)"
# kind = "semantic"
...
"""Type wall: dataclasses.asdict(obj: DataclassInstance); call it with the wrong type.
...
try:
    asdict(_W())  # obj: DataclassInstance <- wrong-typed
