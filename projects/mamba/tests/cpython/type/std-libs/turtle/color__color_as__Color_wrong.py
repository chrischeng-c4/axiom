...
# lib = "turtle"
# dimension = "type"
# case = "color__color_as__Color_wrong"
# subject = "turtle.color(color: _Color)"
# kind = "semantic"
...
"""Type wall: turtle.color(color: _Color); call it with the wrong type.
...
try:
    color(_W())  # color: _Color <- wrong-typed
