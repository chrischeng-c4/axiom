...
# lib = "turtle"
# dimension = "type"
# case = "TPen__pencolor__r_as_float_wrong"
# subject = "turtle.TPen.pencolor(r: float)"
# kind = "semantic"
...
"""Type wall: turtle.TPen.pencolor(r: float); call it with the wrong type.
...
try:
    obj.pencolor("not_a_float", 0.0, 0.0)  # r: float <- wrong-typed
