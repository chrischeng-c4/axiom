...
# lib = "turtle"
# dimension = "type"
# case = "delay__delay_as_typed_wrong"
# subject = "turtle.delay(delay: typed)"
# kind = "semantic"
...
"""Type wall: turtle.delay(delay: typed); call it with the wrong type.
...
try:
    delay(_W())  # delay: typed <- wrong-typed
