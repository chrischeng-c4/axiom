...
# lib = "turtle"
# dimension = "type"
# case = "colormode__cmode_as_float_wrong"
# subject = "turtle.colormode(cmode: float)"
# kind = "semantic"
...
"""Type wall: turtle.colormode(cmode: float); call it with the wrong type.
...
try:
    colormode("not_a_float")  # cmode: float <- wrong-typed
