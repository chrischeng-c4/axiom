...
# lib = "turtle"
# dimension = "type"
# case = "RawTurtle__onclick__fun_as_Callable_wrong"
# subject = "turtle.RawTurtle.onclick(fun: Callable)"
# kind = "semantic"
...
"""Type wall: turtle.RawTurtle.onclick(fun: Callable); call it with the wrong type.
