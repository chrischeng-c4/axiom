...
# lib = "turtle"
# dimension = "type"
# case = "TPen__pensize__width_as_int_wrong"
# subject = "turtle.TPen.pensize(width: int)"
# kind = "semantic"
...
"""Type wall: turtle.TPen.pensize(width: int); call it with the wrong type.
...
try:
    obj.pensize("not_an_int")  # width: int <- wrong-typed
