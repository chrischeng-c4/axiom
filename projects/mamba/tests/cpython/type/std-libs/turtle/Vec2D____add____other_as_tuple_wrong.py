...
# lib = "turtle"
# dimension = "type"
# case = "Vec2D____add____other_as_tuple_wrong"
# subject = "turtle.Vec2D.__add__(other: tuple)"
# kind = "semantic"
...
"""Type wall: turtle.Vec2D.__add__(other: tuple); call it with the wrong type.
...
try:
    obj.__add__(12345)  # other: tuple <- wrong-typed
