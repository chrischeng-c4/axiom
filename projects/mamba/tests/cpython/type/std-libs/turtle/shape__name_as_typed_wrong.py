...
# lib = "turtle"
# dimension = "type"
# case = "shape__name_as_typed_wrong"
# subject = "turtle.shape(name: typed)"
# kind = "semantic"
...
"""Type wall: turtle.shape(name: typed); call it with the wrong type.
...
try:
    shape(_W())  # name: typed <- wrong-typed
