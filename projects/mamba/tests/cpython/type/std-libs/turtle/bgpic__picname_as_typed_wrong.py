...
# lib = "turtle"
# dimension = "type"
# case = "bgpic__picname_as_typed_wrong"
# subject = "turtle.bgpic(picname: typed)"
# kind = "semantic"
...
"""Type wall: turtle.bgpic(picname: typed); call it with the wrong type.
...
try:
    bgpic(_W())  # picname: typed <- wrong-typed
