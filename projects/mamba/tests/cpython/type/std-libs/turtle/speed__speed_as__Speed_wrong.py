...
# lib = "turtle"
# dimension = "type"
# case = "speed__speed_as__Speed_wrong"
# subject = "turtle.speed(speed: _Speed)"
# kind = "semantic"
...
"""Type wall: turtle.speed(speed: _Speed); call it with the wrong type.
...
try:
    speed(_W())  # speed: _Speed <- wrong-typed
