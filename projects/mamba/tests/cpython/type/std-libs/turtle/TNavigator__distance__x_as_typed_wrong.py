...
# lib = "turtle"
# dimension = "type"
# case = "TNavigator__distance__x_as_typed_wrong"
# subject = "turtle.TNavigator.distance(x: typed)"
# kind = "semantic"
...
"""Type wall: turtle.TNavigator.distance(x: typed); call it with the wrong type.
...
try:
    obj.distance(_W())  # x: typed <- wrong-typed
