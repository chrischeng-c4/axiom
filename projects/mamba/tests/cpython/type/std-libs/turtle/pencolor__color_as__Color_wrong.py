...
# lib = "turtle"
# dimension = "type"
# case = "pencolor__color_as__Color_wrong"
# subject = "turtle.pencolor(color: _Color)"
# kind = "semantic"
...
"""Type wall: turtle.pencolor(color: _Color); call it with the wrong type.
...
try:
    pencolor(_W())  # color: _Color <- wrong-typed
