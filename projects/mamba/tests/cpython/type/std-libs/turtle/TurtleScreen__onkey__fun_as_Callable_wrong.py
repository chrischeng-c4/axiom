...
# lib = "turtle"
# dimension = "type"
# case = "TurtleScreen__onkey__fun_as_Callable_wrong"
# subject = "turtle.TurtleScreen.onkey(fun: Callable)"
# kind = "semantic"
...
"""Type wall: turtle.TurtleScreen.onkey(fun: Callable); call it with the wrong type.
...
try:
    obj.onkey(_W(), "")  # fun: Callable <- wrong-typed
