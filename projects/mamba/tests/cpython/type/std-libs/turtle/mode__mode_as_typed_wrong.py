...
# lib = "turtle"
# dimension = "type"
# case = "mode__mode_as_typed_wrong"
# subject = "turtle.mode(mode: typed)"
# kind = "semantic"
...
"""Type wall: turtle.mode(mode: typed); call it with the wrong type.
...
try:
    mode(_W())  # mode: typed <- wrong-typed
