...
# lib = "turtle"
# dimension = "type"
# case = "RawTurtle__shape__name_as_typed_wrong"
# subject = "turtle.RawTurtle.shape(name: typed)"
# kind = "semantic"
...
"""Type wall: turtle.RawTurtle.shape(name: typed); call it with the wrong type.
...
try:
    obj.shape(_W())  # name: typed <- wrong-typed
