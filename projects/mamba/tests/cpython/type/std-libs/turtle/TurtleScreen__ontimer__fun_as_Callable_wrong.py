...
# lib = "turtle"
# dimension = "type"
# case = "TurtleScreen__ontimer__fun_as_Callable_wrong"
# subject = "turtle.TurtleScreen.ontimer(fun: Callable)"
# kind = "semantic"
...
"""Type wall: turtle.TurtleScreen.ontimer(fun: Callable); call it with the wrong type.
...
try:
    obj.ontimer(_W())  # fun: Callable <- wrong-typed
