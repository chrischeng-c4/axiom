...
# lib = "turtle"
# dimension = "type"
# case = "bgcolor__color_as__Color_wrong"
# subject = "turtle.bgcolor(color: _Color)"
# kind = "semantic"
...
"""Type wall: turtle.bgcolor(color: _Color); call it with the wrong type.
...
try:
    bgcolor(_W())  # color: _Color <- wrong-typed
