...
# lib = "turtle"
# dimension = "type"
# case = "bgpic__picname_as_str_wrong"
# subject = "turtle.bgpic(picname: str)"
# kind = "semantic"
...
"""Type wall: turtle.bgpic(picname: str); call it with the wrong type.
...
try:
    bgpic(12345)  # picname: str <- wrong-typed
