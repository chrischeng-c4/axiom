...
# lib = "turtle"
# dimension = "type"
# case = "pencolor__r_as_float_wrong"
# subject = "turtle.pencolor(r: float)"
# kind = "semantic"
...
"""Type wall: turtle.pencolor(r: float); call it with the wrong type.
...
try:
    pencolor("not_a_float", 0.0, 0.0)  # r: float <- wrong-typed
