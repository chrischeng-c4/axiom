...
# lib = "turtle"
# dimension = "type"
# case = "RawTurtle__ondrag__fun_as_Callable_wrong"
# subject = "turtle.RawTurtle.ondrag(fun: Callable)"
# kind = "semantic"
...
"""Type wall: turtle.RawTurtle.ondrag(fun: Callable); call it with the wrong type.
...
try:
    obj.ondrag(_W())  # fun: Callable <- wrong-typed
