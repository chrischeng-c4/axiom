...
# lib = "turtle"
# dimension = "type"
# case = "pensize__width_as_typed_wrong"
# subject = "turtle.pensize(width: typed)"
# kind = "semantic"
...
"""Type wall: turtle.pensize(width: typed); call it with the wrong type.
...
try:
    pensize(_W())  # width: typed <- wrong-typed
