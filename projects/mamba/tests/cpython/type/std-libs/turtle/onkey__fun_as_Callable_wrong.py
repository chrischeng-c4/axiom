...
# lib = "turtle"
# dimension = "type"
# case = "onkey__fun_as_Callable_wrong"
# subject = "turtle.onkey(fun: Callable)"
# kind = "semantic"
...
"""Type wall: turtle.onkey(fun: Callable); call it with the wrong type.
...
try:
    onkey(_W(), "")  # fun: Callable <- wrong-typed
