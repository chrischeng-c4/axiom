...
# lib = "turtle"
# dimension = "type"
# case = "fillcolor__r_as_float_wrong"
# subject = "turtle.fillcolor(r: float)"
# kind = "semantic"
...
"""Type wall: turtle.fillcolor(r: float); call it with the wrong type.
...
try:
    fillcolor("not_a_float", 0.0, 0.0)  # r: float <- wrong-typed
