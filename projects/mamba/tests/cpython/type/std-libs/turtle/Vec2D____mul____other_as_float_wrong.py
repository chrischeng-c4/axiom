...
# lib = "turtle"
# dimension = "type"
# case = "Vec2D____mul____other_as_float_wrong"
# subject = "turtle.Vec2D.__mul__(other: float)"
# kind = "semantic"
...
"""Type wall: turtle.Vec2D.__mul__(other: float); call it with the wrong type.
...
try:
    obj.__mul__("not_a_float")  # other: float <- wrong-typed
