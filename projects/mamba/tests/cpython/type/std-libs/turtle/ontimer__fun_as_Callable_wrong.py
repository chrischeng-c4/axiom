...
# lib = "turtle"
# dimension = "type"
# case = "ontimer__fun_as_Callable_wrong"
# subject = "turtle.ontimer(fun: Callable)"
# kind = "semantic"
...
"""Type wall: turtle.ontimer(fun: Callable); call it with the wrong type.
...
try:
    ontimer(_W())  # fun: Callable <- wrong-typed
