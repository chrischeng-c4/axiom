...
# lib = "turtle"
# dimension = "type"
# case = "goto__x_as_float_wrong"
# subject = "turtle.goto(x: float)"
# kind = "semantic"
...
"""Type wall: turtle.goto(x: float); call it with the wrong type.
...
try:
    goto("not_a_float", 0.0)  # x: float <- wrong-typed
