...
# lib = "turtle"
# dimension = "type"
# case = "TurtleScreen__onkeypress__fun_as_Callable_wrong"
# subject = "turtle.TurtleScreen.onkeypress(fun: Callable)"
# kind = "semantic"
...
"""Type wall: turtle.TurtleScreen.onkeypress(fun: Callable); call it with the wrong type.
...
try:
    obj.onkeypress(_W())  # fun: Callable <- wrong-typed
