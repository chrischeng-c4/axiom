...
# lib = "turtle"
# dimension = "type"
# case = "RawTurtle__shape__name_as_str_wrong"
# subject = "turtle.RawTurtle.shape(name: str)"
# kind = "semantic"
...
"""Type wall: turtle.RawTurtle.shape(name: str); call it with the wrong type.
...
try:
    obj.shape(12345)  # name: str <- wrong-typed
