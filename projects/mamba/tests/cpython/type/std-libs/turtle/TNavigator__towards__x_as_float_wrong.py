...
# lib = "turtle"
# dimension = "type"
# case = "TNavigator__towards__x_as_float_wrong"
# subject = "turtle.TNavigator.towards(x: float)"
# kind = "semantic"
...
"""Type wall: turtle.TNavigator.towards(x: float); call it with the wrong type.
...
try:
    obj.towards("not_a_float", 0.0)  # x: float <- wrong-typed
