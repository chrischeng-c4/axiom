...
# lib = "turtle"
# dimension = "type"
# case = "bgcolor__r_as_float_wrong"
# subject = "turtle.bgcolor(r: float)"
# kind = "semantic"
...
"""Type wall: turtle.bgcolor(r: float); call it with the wrong type.
...
try:
    bgcolor("not_a_float", 0.0, 0.0)  # r: float <- wrong-typed
