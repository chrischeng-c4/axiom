...
# lib = "turtle"
# dimension = "type"
# case = "onkeypress__fun_as_Callable_wrong"
# subject = "turtle.onkeypress(fun: Callable)"
# kind = "semantic"
...
"""Type wall: turtle.onkeypress(fun: Callable); call it with the wrong type.
...
try:
    onkeypress(_W())  # fun: Callable <- wrong-typed
