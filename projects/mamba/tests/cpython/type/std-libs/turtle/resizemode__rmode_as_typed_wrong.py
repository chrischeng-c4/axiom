...
# lib = "turtle"
# dimension = "type"
# case = "resizemode__rmode_as_typed_wrong"
# subject = "turtle.resizemode(rmode: typed)"
# kind = "semantic"
...
"""Type wall: turtle.resizemode(rmode: typed); call it with the wrong type.
...
try:
    resizemode(_W())  # rmode: typed <- wrong-typed
