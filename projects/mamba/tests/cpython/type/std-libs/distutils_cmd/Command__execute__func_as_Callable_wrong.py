...
# lib = "distutils_cmd"
# dimension = "type"
# case = "Command__execute__func_as_Callable_wrong"
# subject = "distutils.cmd.Command.execute(func: Callable)"
# kind = "semantic"
...
"""Type wall: distutils.cmd.Command.execute(func: Callable); call it with the wrong type.
