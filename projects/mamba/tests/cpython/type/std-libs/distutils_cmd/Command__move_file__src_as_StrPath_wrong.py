...
# lib = "distutils_cmd"
# dimension = "type"
# case = "Command__move_file__src_as_StrPath_wrong"
# subject = "distutils.cmd.Command.move_file(src: StrPath)"
# kind = "semantic"
...
"""Type wall: distutils.cmd.Command.move_file(src: StrPath); call it with the wrong type.
