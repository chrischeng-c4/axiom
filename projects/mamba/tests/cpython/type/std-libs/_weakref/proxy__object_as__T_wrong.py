...
# lib = "_weakref"
# dimension = "type"
# case = "proxy__object_as__T_wrong"
# subject = "_weakref.proxy(object: _T)"
# kind = "semantic"
...
"""Type wall: _weakref.proxy(object: _T); call it with the wrong type.
...
try:
    proxy(_W())  # object: _T <- wrong-typed
