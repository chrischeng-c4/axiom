...
# lib = "urllib_parse"
# dimension = "type"
# case = "urlsplit__url_as_typed_wrong"
# subject = "urllib.parse.urlsplit(url: typed)"
# kind = "semantic"
...
"""Type wall: urllib.parse.urlsplit(url: typed); call it with the wrong type.
...
try:
    urlsplit(_W())  # url: typed <- wrong-typed
