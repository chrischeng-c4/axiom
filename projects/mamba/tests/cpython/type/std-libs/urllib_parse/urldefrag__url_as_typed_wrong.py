...
# lib = "urllib_parse"
# dimension = "type"
# case = "urldefrag__url_as_typed_wrong"
# subject = "urllib.parse.urldefrag(url: typed)"
# kind = "semantic"
...
"""Type wall: urllib.parse.urldefrag(url: typed); call it with the wrong type.
...
try:
    urldefrag(_W())  # url: typed <- wrong-typed
