...
# lib = "urllib_parse"
# dimension = "type"
# case = "quote__string_as_typed_wrong"
# subject = "urllib.parse.quote(string: typed)"
# kind = "semantic"
...
"""Type wall: urllib.parse.quote(string: typed); call it with the wrong type.
...
try:
    quote(_W())  # string: typed <- wrong-typed
