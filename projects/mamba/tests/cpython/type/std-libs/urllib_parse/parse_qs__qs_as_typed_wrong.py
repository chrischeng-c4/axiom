...
# lib = "urllib_parse"
# dimension = "type"
# case = "parse_qs__qs_as_typed_wrong"
# subject = "urllib.parse.parse_qs(qs: typed)"
# kind = "semantic"
...
"""Type wall: urllib.parse.parse_qs(qs: typed); call it with the wrong type.
...
try:
    parse_qs(_W())  # qs: typed <- wrong-typed
