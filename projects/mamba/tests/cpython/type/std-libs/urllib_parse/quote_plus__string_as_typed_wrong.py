...
# lib = "urllib_parse"
# dimension = "type"
# case = "quote_plus__string_as_typed_wrong"
# subject = "urllib.parse.quote_plus(string: typed)"
# kind = "semantic"
...
"""Type wall: urllib.parse.quote_plus(string: typed); call it with the wrong type.
...
try:
    quote_plus(_W())  # string: typed <- wrong-typed
