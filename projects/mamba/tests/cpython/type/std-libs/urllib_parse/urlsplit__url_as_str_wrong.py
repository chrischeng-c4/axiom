...
# lib = "urllib_parse"
# dimension = "type"
# case = "urlsplit__url_as_str_wrong"
# subject = "urllib.parse.urlsplit(url: str)"
# kind = "semantic"
...
"""Type wall: urllib.parse.urlsplit(url: str); call it with the wrong type.
...
try:
    urlsplit(12345)  # url: str <- wrong-typed
