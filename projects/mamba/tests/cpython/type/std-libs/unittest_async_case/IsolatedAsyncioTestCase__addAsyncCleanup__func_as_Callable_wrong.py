...
# dimension = "type"
# case = "IsolatedAsyncioTestCase__addAsyncCleanup__func_as_Callable_wrong"
# subject = "unittest.async_case.IsolatedAsyncioTestCase.addAsyncCleanup(func: Callable)"
# kind = "semantic"
...
"""Type wall: unittest.async_case.IsolatedAsyncioTestCase.addAsyncCleanup(func: Callable); call it with the wrong type.
...
try:
    obj.addAsyncCleanup(_W())  # func: Callable <- wrong-typed
