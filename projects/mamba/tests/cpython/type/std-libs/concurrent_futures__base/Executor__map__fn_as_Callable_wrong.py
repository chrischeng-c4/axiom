...
# dimension = "type"
# case = "Executor__map__fn_as_Callable_wrong"
# subject = "concurrent.futures._base.Executor.map(fn: Callable)"
# kind = "semantic"
...
"""Type wall: concurrent.futures._base.Executor.map(fn: Callable); call it with the wrong type.
...
try:
    obj.map(_W())  # fn: Callable <- wrong-typed
