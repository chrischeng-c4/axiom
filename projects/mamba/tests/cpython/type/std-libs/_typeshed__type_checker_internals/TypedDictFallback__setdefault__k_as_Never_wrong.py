...
# dimension = "type"
# case = "TypedDictFallback__setdefault__k_as_Never_wrong"
# subject = "_typeshed._type_checker_internals.TypedDictFallback.setdefault(k: Never)"
# kind = "semantic"
...
"""Type wall: _typeshed._type_checker_internals.TypedDictFallback.setdefault(k: Never); call it with the wrong type.
...
try:
    obj.setdefault(_W(), None)  # k: Never <- wrong-typed
