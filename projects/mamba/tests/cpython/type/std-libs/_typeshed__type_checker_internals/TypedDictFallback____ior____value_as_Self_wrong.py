...
# dimension = "type"
# case = "TypedDictFallback____ior____value_as_Self_wrong"
# subject = "_typeshed._type_checker_internals.TypedDictFallback.__ior__(value: Self)"
# kind = "semantic"
...
"""Type wall: _typeshed._type_checker_internals.TypedDictFallback.__ior__(value: Self); call it with the wrong type.
...
try:
    obj.__ior__(_W())  # value: Self <- wrong-typed
