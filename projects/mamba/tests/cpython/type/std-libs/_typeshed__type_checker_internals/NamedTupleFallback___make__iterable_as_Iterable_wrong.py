...
# dimension = "type"
# case = "NamedTupleFallback___make__iterable_as_Iterable_wrong"
# subject = "_typeshed._type_checker_internals.NamedTupleFallback._make(iterable: Iterable)"
# kind = "semantic"
...
"""Type wall: _typeshed._type_checker_internals.NamedTupleFallback._make(iterable: Iterable); call it with the wrong type.
...
try:
    NamedTupleFallback._make(_W())  # iterable: Iterable <- wrong-typed
