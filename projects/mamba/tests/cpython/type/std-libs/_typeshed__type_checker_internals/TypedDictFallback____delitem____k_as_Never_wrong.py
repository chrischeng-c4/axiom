...
# dimension = "type"
# case = "TypedDictFallback____delitem____k_as_Never_wrong"
# subject = "_typeshed._type_checker_internals.TypedDictFallback.__delitem__(k: Never)"
# kind = "semantic"
...
"""Type wall: _typeshed._type_checker_internals.TypedDictFallback.__delitem__(k: Never); call it with the wrong type.
...
try:
    obj.__delitem__(_W())  # k: Never <- wrong-typed
