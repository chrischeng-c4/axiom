...
# dimension = "type"
# case = "RefactoringTool__log_debug__msg_as_str_wrong"
# subject = "lib2to3.refactor.RefactoringTool.log_debug(msg: str)"
# kind = "semantic"
...
"""Type wall: lib2to3.refactor.RefactoringTool.log_debug(msg: str); call it with the wrong type.
...
try:
    obj.log_debug(12345)  # msg: str <- wrong-typed
