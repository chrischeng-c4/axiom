...
# lib = "tkinter_font"
# dimension = "type"
# case = "Font__cget__option_as_Literal_wrong"
# subject = "tkinter.font.Font.cget(option: Literal)"
# kind = "semantic"
...
"""Type wall: tkinter.font.Font.cget(option: Literal); call it with the wrong type.
...
try:
    obj.cget(_W())  # option: Literal <- wrong-typed
