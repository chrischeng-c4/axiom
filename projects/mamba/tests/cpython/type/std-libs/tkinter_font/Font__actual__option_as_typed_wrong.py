...
# lib = "tkinter_font"
# dimension = "type"
# case = "Font__actual__option_as_typed_wrong"
# subject = "tkinter.font.Font.actual(option: typed)"
# kind = "semantic"
...
"""Type wall: tkinter.font.Font.actual(option: typed); call it with the wrong type.
...
try:
    obj.actual(_W())  # option: typed <- wrong-typed
