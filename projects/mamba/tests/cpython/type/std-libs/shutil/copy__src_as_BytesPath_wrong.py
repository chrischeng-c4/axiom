...
# lib = "shutil"
# dimension = "type"
# case = "copy__src_as_BytesPath_wrong"
# subject = "shutil.copy(src: BytesPath)"
# kind = "semantic"
...
"""Type wall: shutil.copy(src: BytesPath); call it with the wrong type.
...
try:
    copy(_W(), None)  # src: BytesPath <- wrong-typed
