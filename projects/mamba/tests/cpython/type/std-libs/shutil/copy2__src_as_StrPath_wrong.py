...
# lib = "shutil"
# dimension = "type"
# case = "copy2__src_as_StrPath_wrong"
# subject = "shutil.copy2(src: StrPath)"
# kind = "semantic"
...
"""Type wall: shutil.copy2(src: StrPath); call it with the wrong type.
...
try:
    copy2(_W(), None)  # src: StrPath <- wrong-typed
