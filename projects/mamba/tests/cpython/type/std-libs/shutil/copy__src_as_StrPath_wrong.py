...
# lib = "shutil"
# dimension = "type"
# case = "copy__src_as_StrPath_wrong"
# subject = "shutil.copy(src: StrPath)"
# kind = "semantic"
...
"""Type wall: shutil.copy(src: StrPath); call it with the wrong type.
...
try:
    copy(_W(), None)  # src: StrPath <- wrong-typed
