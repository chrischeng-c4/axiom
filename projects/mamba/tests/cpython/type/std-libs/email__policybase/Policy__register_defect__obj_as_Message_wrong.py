...
# dimension = "type"
# case = "Policy__register_defect__obj_as_Message_wrong"
# subject = "email._policybase.Policy.register_defect(obj: Message)"
# kind = "semantic"
...
"""Type wall: email._policybase.Policy.register_defect(obj: Message); call it with the wrong type.
...
try:
    obj.register_defect(_W(), None)  # obj: Message <- wrong-typed
