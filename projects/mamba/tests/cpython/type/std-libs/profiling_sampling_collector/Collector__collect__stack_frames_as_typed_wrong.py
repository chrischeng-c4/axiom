...
# dimension = "type"
# case = "Collector__collect__stack_frames_as_typed_wrong"
# subject = "profiling.sampling.collector.Collector.collect(stack_frames: typed)"
# kind = "semantic"
...
"""Type wall: profiling.sampling.collector.Collector.collect(stack_frames: typed); call it with the wrong type.
