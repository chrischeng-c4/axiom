...
# lib = "_typeshed"
# dimension = "type"
# case = "SupportsItemAccess____delitem____key_as__KT_contra_wrong"
# subject = "_typeshed.SupportsItemAccess.__delitem__(key: _KT_contra)"
# kind = "semantic"
...
"""Type wall: _typeshed.SupportsItemAccess.__delitem__(key: _KT_contra); call it with the wrong type.
...
try:
    obj.__delitem__(_W())  # key: _KT_contra <- wrong-typed
