...
# lib = "_typeshed"
# dimension = "type"
# case = "SupportsRSub____rsub____x_as__T_contra_wrong"
# subject = "_typeshed.SupportsRSub.__rsub__(x: _T_contra)"
# kind = "semantic"
...
"""Type wall: _typeshed.SupportsRSub.__rsub__(x: _T_contra); call it with the wrong type.
...
from _typeshed import SupportsRSub
obj = object.__new__(SupportsRSub)
try:
    obj.__rsub__(_W())  # x: _T_contra <- wrong-typed
