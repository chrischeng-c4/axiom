...
# lib = "_typeshed"
# dimension = "type"
# case = "SupportsDunderGT____gt____other_as__T_contra_wrong"
# subject = "_typeshed.SupportsDunderGT.__gt__(other: _T_contra)"
# kind = "semantic"
...
"""Type wall: _typeshed.SupportsDunderGT.__gt__(other: _T_contra); call it with the wrong type.
...
obj = object.__new__(SupportsDunderGT)
try:
    obj.__gt__(_W())  # other: _T_contra <- wrong-typed
