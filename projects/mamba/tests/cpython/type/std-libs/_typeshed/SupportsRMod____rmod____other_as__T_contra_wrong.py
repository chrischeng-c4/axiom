...
# lib = "_typeshed"
# dimension = "type"
# case = "SupportsRMod____rmod____other_as__T_contra_wrong"
# subject = "_typeshed.SupportsRMod.__rmod__(other: _T_contra)"
# kind = "semantic"
...
"""Type wall: _typeshed.SupportsRMod.__rmod__(other: _T_contra); call it with the wrong type.
...
from _typeshed import SupportsRMod
obj = object.__new__(SupportsRMod)
try:
    obj.__rmod__(_W())  # other: _T_contra <- wrong-typed
