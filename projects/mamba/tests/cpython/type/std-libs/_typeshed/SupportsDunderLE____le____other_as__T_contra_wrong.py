...
# lib = "_typeshed"
# dimension = "type"
# case = "SupportsDunderLE____le____other_as__T_contra_wrong"
# subject = "_typeshed.SupportsDunderLE.__le__(other: _T_contra)"
# kind = "semantic"
...
"""Type wall: _typeshed.SupportsDunderLE.__le__(other: _T_contra); call it with the wrong type.
...
obj = object.__new__(SupportsDunderLE)
try:
    obj.__le__(_W())  # other: _T_contra <- wrong-typed
