...
# lib = "_typeshed"
# dimension = "type"
# case = "SupportsDivMod____divmod____other_as__T_contra_wrong"
# subject = "_typeshed.SupportsDivMod.__divmod__(other: _T_contra)"
# kind = "semantic"
...
"""Type wall: _typeshed.SupportsDivMod.__divmod__(other: _T_contra); call it with the wrong type.
...
obj = object.__new__(SupportsDivMod)
try:
    obj.__divmod__(_W())  # other: _T_contra <- wrong-typed
