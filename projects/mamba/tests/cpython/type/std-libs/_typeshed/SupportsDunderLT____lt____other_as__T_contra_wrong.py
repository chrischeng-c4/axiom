...
# lib = "_typeshed"
# dimension = "type"
# case = "SupportsDunderLT____lt____other_as__T_contra_wrong"
# subject = "_typeshed.SupportsDunderLT.__lt__(other: _T_contra)"
# kind = "semantic"
...
"""Type wall: _typeshed.SupportsDunderLT.__lt__(other: _T_contra); call it with the wrong type.
...
obj = object.__new__(SupportsDunderLT)
try:
    obj.__lt__(_W())  # other: _T_contra <- wrong-typed
