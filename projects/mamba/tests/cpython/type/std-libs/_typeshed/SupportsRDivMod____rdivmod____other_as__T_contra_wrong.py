...
# lib = "_typeshed"
# dimension = "type"
# case = "SupportsRDivMod____rdivmod____other_as__T_contra_wrong"
# subject = "_typeshed.SupportsRDivMod.__rdivmod__(other: _T_contra)"
# kind = "semantic"
...
"""Type wall: _typeshed.SupportsRDivMod.__rdivmod__(other: _T_contra); call it with the wrong type.
...
obj = object.__new__(SupportsRDivMod)
try:
    obj.__rdivmod__(_W())  # other: _T_contra <- wrong-typed
