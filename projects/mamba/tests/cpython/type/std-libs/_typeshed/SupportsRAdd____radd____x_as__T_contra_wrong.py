...
# lib = "_typeshed"
# dimension = "type"
# case = "SupportsRAdd____radd____x_as__T_contra_wrong"
# subject = "_typeshed.SupportsRAdd.__radd__(x: _T_contra)"
# kind = "semantic"
...
"""Type wall: _typeshed.SupportsRAdd.__radd__(x: _T_contra); call it with the wrong type.
...
obj = object.__new__(SupportsRAdd)
try:
    obj.__radd__(_W())  # x: _T_contra <- wrong-typed
