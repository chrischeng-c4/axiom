...
# lib = "_typeshed"
# dimension = "type"
# case = "SliceableBuffer____getitem____slice_as_slice_wrong"
# subject = "_typeshed.SliceableBuffer.__getitem__(slice: slice)"
# kind = "semantic"
...
"""Type wall: _typeshed.SliceableBuffer.__getitem__(slice: slice); call it with the wrong type.
...
obj = object.__new__(SliceableBuffer)
try:
