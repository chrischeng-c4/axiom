...
# lib = "_typeshed"
# dimension = "type"
# case = "SupportsSub____sub____x_as__T_contra_wrong"
# subject = "_typeshed.SupportsSub.__sub__(x: _T_contra)"
# kind = "semantic"
...
"""Type wall: _typeshed.SupportsSub.__sub__(x: _T_contra); call it with the wrong type.
...
obj = object.__new__(SupportsSub)
try:
    obj.__sub__(_W())  # x: _T_contra <- wrong-typed
