...
# lib = "_typeshed"
# dimension = "type"
# case = "SupportsRMul____rmul____x_as__T_contra_wrong"
# subject = "_typeshed.SupportsRMul.__rmul__(x: _T_contra)"
# kind = "semantic"
...
"""Type wall: _typeshed.SupportsRMul.__rmul__(x: _T_contra); call it with the wrong type.
...
obj = object.__new__(SupportsRMul)
try:
    obj.__rmul__(_W())  # x: _T_contra <- wrong-typed
