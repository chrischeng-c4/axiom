...
# lib = "ossaudiodev"
# dimension = "type"
# case = "open__mode_as_Literal_wrong"
# subject = "ossaudiodev.open(mode: Literal)"
# kind = "semantic"
...
"""Type wall: ossaudiodev.open(mode: Literal); call it with the wrong type.
...
try:
    open(_W())  # mode: Literal <- wrong-typed
