...
# lib = "ctypes"
# dimension = "type"
# case = "ARRAY__typ_as__CT_wrong"
# subject = "ctypes.ARRAY(typ: _CT)"
# kind = "semantic"
...
"""Type wall: ctypes.ARRAY(typ: _CT); call it with the wrong type.

typeshed contract: typ is _CT. mamba is force-typed, so a wrong-typed
...
try:
    ARRAY(_W(), 0)  # typ: _CT <- wrong-typed
