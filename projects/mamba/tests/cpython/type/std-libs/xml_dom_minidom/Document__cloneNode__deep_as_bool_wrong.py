...
# lib = "xml_dom_minidom"
# dimension = "type"
# case = "Document__cloneNode__deep_as_bool_wrong"
# subject = "xml.dom.minidom.Document.cloneNode(deep: bool)"
# kind = "semantic"
...
"""Type wall: xml.dom.minidom.Document.cloneNode(deep: bool); call it with the wrong type.
