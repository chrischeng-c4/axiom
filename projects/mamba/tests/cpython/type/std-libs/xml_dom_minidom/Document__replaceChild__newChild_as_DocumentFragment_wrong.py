...
# lib = "xml_dom_minidom"
# dimension = "type"
# case = "Document__replaceChild__newChild_as_DocumentFragment_wrong"
# subject = "xml.dom.minidom.Document.replaceChild(newChild: DocumentFragment)"
# kind = "semantic"
...
"""Type wall: xml.dom.minidom.Document.replaceChild(newChild: DocumentFragment); call it with the wrong type.
