...
# lib = "xml_dom_minidom"
# dimension = "type"
# case = "TypeInfo__init__namespace_as_typed_wrong"
# subject = "xml.dom.minidom.TypeInfo.__init__(namespace: typed)"
# kind = "semantic"
...
"""Type wall: xml.dom.minidom.TypeInfo.__init__(namespace: typed); call it with the wrong type.
...
try:
    TypeInfo(_W(), None)  # namespace: typed <- wrong-typed
