...
# lib = "xml_dom_minidom"
# dimension = "type"
# case = "Document__renameNode__n_as_typed_wrong"
# subject = "xml.dom.minidom.Document.renameNode(n: typed)"
# kind = "semantic"
...
"""Type wall: xml.dom.minidom.Document.renameNode(n: typed); call it with the wrong type.
...
try:
    obj.renameNode(_W(), "", "")  # n: typed <- wrong-typed
