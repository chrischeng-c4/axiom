...
# lib = "argparse"
# dimension = "type"
# case = "Action__init__option_strings_as_Sequence_wrong"
# subject = "argparse.Action.__init__(option_strings: Sequence)"
# kind = "semantic"
...
"""Type wall: argparse.Action.__init__(option_strings: Sequence); call it with the wrong type.
...
try:
    Action(_W(), "")  # option_strings: Sequence <- wrong-typed
