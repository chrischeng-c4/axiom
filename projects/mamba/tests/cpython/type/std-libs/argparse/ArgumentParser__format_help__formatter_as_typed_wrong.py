...
# lib = "argparse"
# dimension = "type"
# case = "ArgumentParser__format_help__formatter_as_typed_wrong"
# subject = "argparse.ArgumentParser.format_help(formatter: typed)"
# kind = "semantic"
...
"""Type wall: argparse.ArgumentParser.format_help(formatter: typed); call it with the wrong type.
