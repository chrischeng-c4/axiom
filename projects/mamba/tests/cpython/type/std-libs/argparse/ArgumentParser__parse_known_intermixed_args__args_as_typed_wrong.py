...
# lib = "argparse"
# dimension = "type"
# case = "ArgumentParser__parse_known_intermixed_args__args_as_typed_wrong"
# subject = "argparse.ArgumentParser.parse_known_intermixed_args(args: typed)"
# kind = "semantic"
...
"""Type wall: argparse.ArgumentParser.parse_known_intermixed_args(args: typed); call it with the wrong type.
...
try:
    obj.parse_known_intermixed_args(_W())  # args: typed <- wrong-typed
