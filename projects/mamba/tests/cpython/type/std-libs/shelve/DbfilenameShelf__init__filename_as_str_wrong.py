...
# lib = "shelve"
# dimension = "type"
# case = "DbfilenameShelf__init__filename_as_str_wrong"
# subject = "shelve.DbfilenameShelf.__init__(filename: str)"
# kind = "semantic"
...
"""Type wall: shelve.DbfilenameShelf.__init__(filename: str); call it with the wrong type.
...
try:
    DbfilenameShelf(12345)  # filename: str <- wrong-typed
