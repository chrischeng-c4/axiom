...
# lib = "ssl"
# dimension = "type"
# case = "SSLSocket__sendto__data_as_ReadableBuffer_wrong"
# subject = "ssl.SSLSocket.sendto(data: ReadableBuffer)"
# kind = "semantic"
...
"""Type wall: ssl.SSLSocket.sendto(data: ReadableBuffer); call it with the wrong type.
