...
# lib = "ssl"
# dimension = "type"
# case = "SSLContext__get_ca_certs__binary_form_as_Literal_wrong"
# subject = "ssl.SSLContext.get_ca_certs(binary_form: Literal)"
# kind = "semantic"
...
"""Type wall: ssl.SSLContext.get_ca_certs(binary_form: Literal); call it with the wrong type.
...
try:
    obj.get_ca_certs(_W())  # binary_form: Literal <- wrong-typed
