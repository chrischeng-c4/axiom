...
# lib = "distutils_dist"
# dimension = "type"
# case = "Distribution__get_command_obj__command_as_str_wrong"
# subject = "distutils.dist.Distribution.get_command_obj(command: str)"
# kind = "semantic"
...
"""Type wall: distutils.dist.Distribution.get_command_obj(command: str); call it with the wrong type.
...
try:
    obj.get_command_obj(12345)  # command: str <- wrong-typed
