...
# dimension = "type"
# case = "AttributesImpl__get__name_as__AttrKey_wrong"
# subject = "xml.sax.xmlreader.AttributesImpl.get(name: _AttrKey)"
# kind = "semantic"
...
"""Type wall: xml.sax.xmlreader.AttributesImpl.get(name: _AttrKey); call it with the wrong type.
...
try:
    obj.get(_W())  # name: _AttrKey <- wrong-typed
