...
# dimension = "type"
# case = "AttributesImpl____contains____name_as__AttrKey_wrong"
# subject = "xml.sax.xmlreader.AttributesImpl.__contains__(name: _AttrKey)"
# kind = "semantic"
...
"""Type wall: xml.sax.xmlreader.AttributesImpl.__contains__(name: _AttrKey); call it with the wrong type.
...
try:
    obj.__contains__(_W())  # name: _AttrKey <- wrong-typed
