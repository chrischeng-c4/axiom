...
# lib = "re"
# dimension = "type"
# case = "Pattern__finditer__string_as_str_wrong"
# subject = "re.Pattern.finditer(string: str)"
# kind = "semantic"
...
"""Type wall: re.Pattern.finditer(string: str); call it with the wrong type.
...
try:
    obj.finditer(12345)  # string: str <- wrong-typed
