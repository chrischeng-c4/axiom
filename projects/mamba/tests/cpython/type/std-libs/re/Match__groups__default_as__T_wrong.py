...
# lib = "re"
# dimension = "type"
# case = "Match__groups__default_as__T_wrong"
# subject = "re.Match.groups(default: _T)"
# kind = "semantic"
...
"""Type wall: re.Match.groups(default: _T); call it with the wrong type.
...
try:
    obj.groups(_W())  # default: _T <- wrong-typed
