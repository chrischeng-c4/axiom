...
# lib = "re"
# dimension = "type"
# case = "Pattern__fullmatch__string_as_str_wrong"
# subject = "re.Pattern.fullmatch(string: str)"
# kind = "semantic"
...
"""Type wall: re.Pattern.fullmatch(string: str); call it with the wrong type.
...
try:
    obj.fullmatch(12345)  # string: str <- wrong-typed
