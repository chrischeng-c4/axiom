...
# lib = "re"
# dimension = "type"
# case = "split__pattern_as_typed_wrong"
# subject = "re.split(pattern: typed)"
# kind = "semantic"
...
"""Type wall: re.split(pattern: typed); call it with the wrong type.
...
try:
    split(_W(), "")  # pattern: typed <- wrong-typed
