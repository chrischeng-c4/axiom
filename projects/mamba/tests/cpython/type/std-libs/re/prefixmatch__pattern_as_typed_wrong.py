...
# lib = "re"
# dimension = "type"
# case = "prefixmatch__pattern_as_typed_wrong"
# subject = "re.prefixmatch(pattern: typed)"
# kind = "semantic"
...
"""Type wall: re.prefixmatch(pattern: typed); call it with the wrong type.
...
from re import prefixmatch
try:
    prefixmatch(_W(), "")  # pattern: typed <- wrong-typed
