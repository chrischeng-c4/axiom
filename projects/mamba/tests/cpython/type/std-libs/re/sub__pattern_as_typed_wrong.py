...
# lib = "re"
# dimension = "type"
# case = "sub__pattern_as_typed_wrong"
# subject = "re.sub(pattern: typed)"
# kind = "semantic"
...
"""Type wall: re.sub(pattern: typed); call it with the wrong type.
...
from re import sub
try:
    sub(_W(), None, "")  # pattern: typed <- wrong-typed
