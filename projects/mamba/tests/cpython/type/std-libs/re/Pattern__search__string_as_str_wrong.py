...
# lib = "re"
# dimension = "type"
# case = "Pattern__search__string_as_str_wrong"
# subject = "re.Pattern.search(string: str)"
# kind = "semantic"
...
"""Type wall: re.Pattern.search(string: str); call it with the wrong type.
...
try:
    obj.search(12345)  # string: str <- wrong-typed
