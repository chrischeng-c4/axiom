...
# lib = "re"
# dimension = "type"
# case = "Pattern__subn__repl_as_typed_wrong"
# subject = "re.Pattern.subn(repl: typed)"
# kind = "semantic"
...
"""Type wall: re.Pattern.subn(repl: typed); call it with the wrong type.
...
try:
    obj.subn(_W(), "")  # repl: typed <- wrong-typed
