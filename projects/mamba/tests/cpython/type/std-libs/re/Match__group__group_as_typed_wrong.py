...
# lib = "re"
# dimension = "type"
# case = "Match__group__group_as_typed_wrong"
# subject = "re.Match.group(group: typed)"
# kind = "semantic"
...
"""Type wall: re.Match.group(group: typed); call it with the wrong type.
...
try:
    obj.group(_W())  # group: typed <- wrong-typed
