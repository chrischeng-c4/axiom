...
# lib = "re"
# dimension = "type"
# case = "Pattern__split__string_as_ReadableBuffer_wrong"
# subject = "re.Pattern.split(string: ReadableBuffer)"
# kind = "semantic"
...
"""Type wall: re.Pattern.split(string: ReadableBuffer); call it with the wrong type.
...
try:
    obj.split(_W())  # string: ReadableBuffer <- wrong-typed
