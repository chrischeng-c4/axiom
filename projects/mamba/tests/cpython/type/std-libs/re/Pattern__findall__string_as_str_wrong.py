...
# lib = "re"
# dimension = "type"
# case = "Pattern__findall__string_as_str_wrong"
# subject = "re.Pattern.findall(string: str)"
# kind = "semantic"
...
"""Type wall: re.Pattern.findall(string: str); call it with the wrong type.
...
try:
    obj.findall(12345)  # string: str <- wrong-typed
