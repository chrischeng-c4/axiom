...
# lib = "array"
# dimension = "type"
# case = "array__index__v_as__T_wrong"
# subject = "array.array.index(v: _T)"
# kind = "semantic"
...
"""Type wall: array.array.index(v: _T); call it with the wrong type.
