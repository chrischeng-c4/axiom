...
# lib = "array"
# dimension = "type"
# case = "array____delitem____key_as_typed_wrong"
# subject = "array.array.__delitem__(key: typed)"
# kind = "semantic"
...
"""Type wall: array.array.__delitem__(key: typed); call it with the wrong type.
