...
# lib = "array"
# dimension = "type"
# case = "array__count__v_as__T_wrong"
# subject = "array.array.count(v: _T)"
# kind = "semantic"
...
"""Type wall: array.array.count(v: _T); call it with the wrong type.
