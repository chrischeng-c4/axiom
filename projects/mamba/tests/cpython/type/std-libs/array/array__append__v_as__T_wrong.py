...
# lib = "array"
# dimension = "type"
# case = "array__append__v_as__T_wrong"
# subject = "array.array.append(v: _T)"
# kind = "semantic"
...
"""Type wall: array.array.append(v: _T); call it with the wrong type.
...
try:
    obj.append(_W())  # v: _T <- wrong-typed
