...
# lib = "traceback"
# dimension = "type"
# case = "format_exception__exc_as_BaseException_wrong"
# subject = "traceback.format_exception(exc: BaseException)"
# kind = "semantic"
...
"""Type wall: traceback.format_exception(exc: BaseException); call it with the wrong type.
...
try:
    format_exception(_W())  # exc: BaseException <- wrong-typed
