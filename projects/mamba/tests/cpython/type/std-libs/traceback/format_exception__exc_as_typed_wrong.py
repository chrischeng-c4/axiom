...
# lib = "traceback"
# dimension = "type"
# case = "format_exception__exc_as_typed_wrong"
# subject = "traceback.format_exception(exc: typed)"
# kind = "semantic"
...
"""Type wall: traceback.format_exception(exc: typed); call it with the wrong type.
...
try:
    format_exception(_W())  # exc: typed <- wrong-typed
