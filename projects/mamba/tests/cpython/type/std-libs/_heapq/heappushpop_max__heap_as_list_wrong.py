...
# lib = "_heapq"
# dimension = "type"
# case = "heappushpop_max__heap_as_list_wrong"
# subject = "_heapq.heappushpop_max(heap: list)"
# kind = "semantic"
...
"""Type wall: _heapq.heappushpop_max(heap: list); call it with the wrong type.

typeshed contract: heap is list. mamba is force-typed, so a wrong-typed
argument MUST raise TypeError (CPython may accept or raise — mamba's to enforce)."""

from _heapq import heappushpop_max
try:
    heappushpop_max(12345, None)  # heap: list <- wrong-typed
