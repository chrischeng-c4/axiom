...
# lib = "_heapq"
# dimension = "type"
# case = "heappop_max__heap_as_list_wrong"
# subject = "_heapq.heappop_max(heap: list)"
# kind = "semantic"
...
"""Type wall: _heapq.heappop_max(heap: list); call it with the wrong type.
...
try:
    heappop_max(12345)  # heap: list <- wrong-typed
