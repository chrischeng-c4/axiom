...
# lib = "_heapq"
# dimension = "type"
# case = "heapreplace_max__heap_as_list_wrong"
# subject = "_heapq.heapreplace_max(heap: list)"
# kind = "semantic"
...
"""Type wall: _heapq.heapreplace_max(heap: list); call it with the wrong type.
...
try:
    heapreplace_max(12345, None)  # heap: list <- wrong-typed
