...
# lib = "builtins"
# dimension = "type"
# case = "str____mod____value_as_typed_wrong"
# subject = "builtins.str.__mod__(value: typed)"
# kind = "semantic"
...
"""Type wall: builtins.str.__mod__(value: typed); call it with the wrong type.
...
obj = str.__new__(str)
try:
    obj.__mod__(_W())  # value: typed <- wrong-typed
