...
# lib = "iter"
# dimension = "behavior"
# case = "test_case__test_ref_counting_behavior"
# subject = "cpython.test_iter.TestCase.test_ref_counting_behavior"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_iter.py::TestCase::test_ref_counting_behavior
"""Auto-ported test: TestCase::test_ref_counting_behavior (CPython 3.12 oracle)."""
...
assert C.count == 0
print("TestCase::test_ref_counting_behavior: ok")
