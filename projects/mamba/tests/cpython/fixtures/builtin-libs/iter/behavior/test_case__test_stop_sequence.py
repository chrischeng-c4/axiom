...
# lib = "iter"
# dimension = "behavior"
# case = "test_case__test_stop_sequence"
# subject = "cpython.test_iter.TestCase.test_stop_sequence"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_iter.py::TestCase::test_stop_sequence
"""Auto-ported test: TestCase::test_stop_sequence (CPython 3.12 oracle)."""
...
check_for_loop(MySequenceClass(20), list(range(10)), pickle=False)
print("TestCase::test_stop_sequence: ok")
