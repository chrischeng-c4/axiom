...
# lib = "iter"
# dimension = "behavior"
# case = "test_case__test_iter_neg_setstate"
# subject = "cpython.test_iter.TestCase.test_iter_neg_setstate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_iter.py::TestCase::test_iter_neg_setstate
"""Auto-ported test: TestCase::test_iter_neg_setstate (CPython 3.12 oracle)."""
...
assert next(it) == 1
print("TestCase::test_iter_neg_setstate: ok")
