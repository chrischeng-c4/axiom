...
# lib = "dict_methods"
# dimension = "behavior"
# case = "dict_test__test_splittable_popitem"
# subject = "cpython.test_dict.DictTest.test_splittable_popitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dict.py::DictTest::test_splittable_popitem
"""Auto-ported test: DictTest::test_splittable_popitem (CPython 3.12 oracle)."""
...
assert sys.getsizeof(a) > orig_size

assert list(a) == ['x', 'y']

assert list(b) == ['x', 'y', 'z']
print("DictTest::test_splittable_popitem: ok")
