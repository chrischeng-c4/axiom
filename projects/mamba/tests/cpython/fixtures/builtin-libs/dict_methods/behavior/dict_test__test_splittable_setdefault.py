...
# lib = "dict_methods"
# dimension = "behavior"
# case = "dict_test__test_splittable_setdefault"
# subject = "cpython.test_dict.DictTest.test_splittable_setdefault"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dict.py::DictTest::test_splittable_setdefault
"""Auto-ported test: DictTest::test_splittable_setdefault (CPython 3.12 oracle)."""
...
assert list(a) == ['x', 'y', 'z', 'a', 'b']

assert list(b) == ['x', 'y', 'z', 'b', 'a']
print("DictTest::test_splittable_setdefault: ok")
