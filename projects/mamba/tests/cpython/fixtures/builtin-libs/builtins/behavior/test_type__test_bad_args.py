...
# lib = "builtins"
# dimension = "behavior"
# case = "test_type__test_bad_args"
# subject = "cpython.test_builtin.TestType.test_bad_args"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::TestType::test_bad_args
"""Auto-ported test: TestType::test_bad_args (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("TestType::test_bad_args: ok")
