...
# lib = "builtins"
# dimension = "behavior"
# case = "test_breakpoint__test_envar_ignored_when_hook_is_set"
# subject = "cpython.test_builtin.TestBreakpoint.test_envar_ignored_when_hook_is_set"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::TestBreakpoint::test_envar_ignored_when_hook_is_set
"""Auto-ported test: TestBreakpoint::test_envar_ignored_when_hook_is_set (CPython 3.12 oracle)."""
...
self_env['PYTHONBREAKPOINT'] = 'sys.exit'
with patch('sys.exit') as mock:
    sys.breakpointhook = int
    breakpoint()
    mock.assert_not_called()
print("TestBreakpoint::test_envar_ignored_when_hook_is_set: ok")
