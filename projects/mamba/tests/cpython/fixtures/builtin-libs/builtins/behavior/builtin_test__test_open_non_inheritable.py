...
# lib = "builtins"
# dimension = "behavior"
# case = "builtin_test__test_open_non_inheritable"
# subject = "cpython.test_builtin.BuiltinTest.test_open_non_inheritable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::BuiltinTest::test_open_non_inheritable
"""Auto-ported test: BuiltinTest::test_open_non_inheritable (CPython 3.12 oracle)."""
...
with fileobj:
    ...
    assert not os.get_inheritable(fileobj.fileno())
print("BuiltinTest::test_open_non_inheritable: ok")
