...
# lib = "builtins"
# dimension = "behavior"
# case = "shutdown_test__test_cleanup"
# subject = "cpython.test_builtin.ShutdownTest.test_cleanup"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::ShutdownTest::test_cleanup
"""Auto-ported test: ShutdownTest::test_cleanup (CPython 3.12 oracle)."""
...
assert ['before', 'after'] == out.decode().splitlines()
print("ShutdownTest::test_cleanup: ok")
