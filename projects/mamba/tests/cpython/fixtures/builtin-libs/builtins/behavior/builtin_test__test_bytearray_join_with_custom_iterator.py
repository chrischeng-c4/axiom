...
# lib = "builtins"
# dimension = "behavior"
# case = "builtin_test__test_bytearray_join_with_custom_iterator"
# subject = "cpython.test_builtin.BuiltinTest.test_bytearray_join_with_custom_iterator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::BuiltinTest::test_bytearray_join_with_custom_iterator
"""Auto-ported test: BuiltinTest::test_bytearray_join_with_custom_iterator (CPython 3.12 oracle)."""
...
assert bytearray(b'A,B') == array.join(iterator())
print("BuiltinTest::test_bytearray_join_with_custom_iterator: ok")
