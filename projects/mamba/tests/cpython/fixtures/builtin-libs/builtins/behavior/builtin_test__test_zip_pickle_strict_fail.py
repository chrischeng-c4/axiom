...
# lib = "builtins"
# dimension = "behavior"
# case = "builtin_test__test_zip_pickle_strict_fail"
# subject = "cpython.test_builtin.BuiltinTest.test_zip_pickle_strict_fail"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::BuiltinTest::test_zip_pickle_strict_fail
"""Auto-ported test: BuiltinTest::test_zip_pickle_strict_fail (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert iter_error(z1, ValueError) == t

    assert iter_error(z2, ValueError) == t
print("BuiltinTest::test_zip_pickle_strict_fail: ok")
