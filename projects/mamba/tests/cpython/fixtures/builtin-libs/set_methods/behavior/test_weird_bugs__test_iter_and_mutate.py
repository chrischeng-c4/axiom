...
# lib = "set_methods"
# dimension = "behavior"
# case = "test_weird_bugs__test_iter_and_mutate"
# subject = "cpython.test_set.TestWeirdBugs.test_iter_and_mutate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_set.py::TestWeirdBugs::test_iter_and_mutate
"""Auto-ported test: TestWeirdBugs::test_iter_and_mutate (CPython 3.12 oracle)."""
...
s.update(range(100))
list(si)
print("TestWeirdBugs::test_iter_and_mutate: ok")
