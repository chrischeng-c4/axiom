...
# lib = "set_methods"
# dimension = "behavior"
# case = "test_only_sets_tuple__test_union"
# subject = "cpython.test_set.TestOnlySetsTuple.test_union"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_set.py::TestOnlySetsTuple::test_union
"""Auto-ported test: TestOnlySetsTuple::test_union (CPython 3.12 oracle)."""
...
if self_otherIsIterable:
    ...
    try:
        ...
        pass
print("TestOnlySetsTuple::test_union: ok")
