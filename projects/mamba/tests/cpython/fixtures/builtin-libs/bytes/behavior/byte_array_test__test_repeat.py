...
# lib = "bytes"
# dimension = "behavior"
# case = "byte_array_test__test_repeat"
# subject = "cpython.test_bytes.ByteArrayTest.test_repeat"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bytes.py::ByteArrayTest::test_repeat
"""Auto-ported test: ByteArrayTest::test_repeat (CPython 3.12 oracle)."""
...
for b in (b'abc', type2test(b'abc')):
    ...
    try:
        ...
        pass
print("ByteArrayTest::test_repeat: ok")
