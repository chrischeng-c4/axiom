...
# lib = "sys_settrace"
# dimension = "behavior"
# case = "test_lines_after_trace_started__test_no_tracing_of_named_except_cleanup"
# subject = "cpython.test.test_sys_settrace.TestLinesAfterTraceStarted.test_no_tracing_of_named_except_cleanup"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_settrace.py::TestLinesAfterTraceStarted::test_no_tracing_of_named_except_cleanup
"""Auto-ported test: TestLinesAfterTraceStarted::test_no_tracing_of_named_except_cleanup (CPython 3.12 oracle)."""
...
def func():
    ...
    try:
        ...
        if x:
            raise
    return 'done'
run_and_compare(func, [(0, 'call'), (1, 'line'), (2, 'line'), (3, 'line'), (3, 'exception'), (4, 'line'), (5, 'line'), (7, 'line'), (7, 'return')])
print("TestLinesAfterTraceStarted::test_no_tracing_of_named_except_cleanup: ok")
