...
# lib = "sys_settrace"
# dimension = "behavior"
# case = "test_set_local_trace__test_break_to_break"
# subject = "cpython.test.test_sys_settrace.TestSetLocalTrace.test_break_to_break"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_settrace.py::TestSetLocalTrace::test_break_to_break
"""Auto-ported test: TestSetLocalTrace::test_break_to_break (CPython 3.12 oracle)."""
...
def func():
    ...
    while TRUE:
        while TRUE:
            break
        break
run_and_compare(func, [(0, 'call'), (1, 'line'), (2, 'line'), (3, 'line'), (4, 'line'), (5, 'line'), (5, 'return')])
print("TestSetLocalTrace::test_break_to_break: ok")
