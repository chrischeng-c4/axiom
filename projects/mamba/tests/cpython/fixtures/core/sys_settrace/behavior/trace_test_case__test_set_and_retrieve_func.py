...
# lib = "sys_settrace"
# dimension = "behavior"
# case = "trace_test_case__test_set_and_retrieve_func"
# subject = "cpython.test.test_sys_settrace.TraceTestCase.test_set_and_retrieve_func"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_settrace.py::TraceTestCase::test_set_and_retrieve_func
"""Auto-ported test: TraceTestCase::test_set_and_retrieve_func (CPython 3.12 oracle)."""
...
try:
    ...
    sys.settrace(None)
print("TraceTestCase::test_set_and_retrieve_func: ok")
