...
# lib = "sys_settrace"
# dimension = "behavior"
# case = "test_lines_after_trace_started__test_19_except_with_finally"
# subject = "cpython.test.test_sys_settrace.TestLinesAfterTraceStarted.test_19_except_with_finally"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_settrace.py::TestLinesAfterTraceStarted::test_19_except_with_finally
"""Auto-ported test: TestLinesAfterTraceStarted::test_19_except_with_finally (CPython 3.12 oracle)."""
...
def func():
    try:
        ...
        b = 23
run_and_compare(func, [(0, 'call'), (1, 'line'), (2, 'line'), (3, 'line'), (3, 'exception'), (5, 'line'), (6, 'line'), (7, 'line'), (7, 'return')])
print("TestLinesAfterTraceStarted::test_19_except_with_finally: ok")
