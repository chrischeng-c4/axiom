...
# lib = "sys_settrace"
# dimension = "behavior"
# case = "test_lines_after_trace_started__test_break_to_continue1"
# subject = "cpython.test.test_sys_settrace.TestLinesAfterTraceStarted.test_break_to_continue1"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_settrace.py::TestLinesAfterTraceStarted::test_break_to_continue1
"""Auto-ported test: TestLinesAfterTraceStarted::test_break_to_continue1 (CPython 3.12 oracle)."""
...
def func():
    ...
    while x:
        ...
        while TRUE:
            break
        continue
run_and_compare(func, [(0, 'call'), (1, 'line'), (2, 'line'), (3, 'line'), (4, 'line'), (5, 'line'), (6, 'line'), (7, 'line'), (3, 'line'), (3, 'return')])
print("TestLinesAfterTraceStarted::test_break_to_continue1: ok")
