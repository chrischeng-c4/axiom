...
# lib = "import"
# dimension = "behavior"
# case = "circular_import_tests__test_subpackage"
# subject = "cpython.__init__.CircularImportTests.test_subpackage"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::CircularImportTests::test_subpackage
"""Auto-ported test: CircularImportTests::test_subpackage (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('circular import involving a subpackage failed')
print("CircularImportTests::test_subpackage: ok")
