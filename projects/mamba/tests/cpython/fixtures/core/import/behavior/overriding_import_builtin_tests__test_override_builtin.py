...
# lib = "import"
# dimension = "behavior"
# case = "overriding_import_builtin_tests__test_override_builtin"
# subject = "cpython.__init__.OverridingImportBuiltinTests.test_override_builtin"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::OverridingImportBuiltinTests::test_override_builtin
"""Auto-ported test: OverridingImportBuiltinTests::test_override_builtin (CPython 3.12 oracle)."""
...
with swap_item(globals(), '__import__', lambda *x: 5):
    ...
    assert foo() == os
print("OverridingImportBuiltinTests::test_override_builtin: ok")
