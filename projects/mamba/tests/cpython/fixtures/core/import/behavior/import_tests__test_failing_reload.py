...
# lib = "import"
# dimension = "behavior"
# case = "import_tests__test_failing_reload"
# subject = "cpython.__init__.ImportTests.test_failing_reload"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTests::test_failing_reload
"""Auto-ported test: ImportTests::test_failing_reload (CPython 3.12 oracle)."""
...
try:
    ...
    remove_files(TESTFN)
    unload(TESTFN)
print("ImportTests::test_failing_reload: ok")
