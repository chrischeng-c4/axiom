...
# lib = "import"
# dimension = "behavior"
# case = "import_tests__test_from_import_attribute_error"
# subject = "cpython.__init__.ImportTests.test_from_import_AttributeError"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTests::test_from_import_AttributeError
"""Auto-ported test: ImportTests::test_from_import_AttributeError (CPython 3.12 oracle)."""
...
assert str(cm.exception) == "cannot import name 'does_not_exist' from '<unknown module name>' (unknown location)"
print("ImportTests::test_from_import_AttributeError: ok")
