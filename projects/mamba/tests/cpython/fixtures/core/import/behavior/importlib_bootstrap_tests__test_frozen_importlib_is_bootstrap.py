...
# lib = "import"
# dimension = "behavior"
# case = "importlib_bootstrap_tests__test_frozen_importlib_is_bootstrap"
# subject = "cpython.__init__.ImportlibBootstrapTests.test_frozen_importlib_is_bootstrap"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportlibBootstrapTests::test_frozen_importlib_is_bootstrap
"""Auto-ported test: ImportlibBootstrapTests::test_frozen_importlib_is_bootstrap (CPython 3.12 oracle)."""
...
assert mod is _bootstrap

assert mod.__name__ == 'importlib._bootstrap'

assert mod.__package__ == 'importlib'

assert mod.__file__.endswith('_bootstrap.py')
print("ImportlibBootstrapTests::test_frozen_importlib_is_bootstrap: ok")
