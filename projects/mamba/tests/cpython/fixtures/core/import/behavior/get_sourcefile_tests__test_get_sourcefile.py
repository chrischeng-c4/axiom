...
# lib = "import"
# dimension = "behavior"
# case = "get_sourcefile_tests__test_get_sourcefile"
# subject = "cpython.__init__.GetSourcefileTests.test_get_sourcefile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::GetSourcefileTests::test_get_sourcefile
"""Auto-ported test: GetSourcefileTests::test_get_sourcefile (CPython 3.12 oracle)."""
...
with mock.patch('importlib._bootstrap_external._path_isfile') as _path_isfile:
    ...
    assert _get_sourcefile(path) == expect
print("GetSourcefileTests::test_get_sourcefile: ok")
