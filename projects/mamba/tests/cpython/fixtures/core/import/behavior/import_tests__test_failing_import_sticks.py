...
# lib = "import"
# dimension = "behavior"
# case = "import_tests__test_failing_import_sticks"
# subject = "cpython.__init__.ImportTests.test_failing_import_sticks"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTests::test_failing_import_sticks
"""Auto-ported test: ImportTests::test_failing_import_sticks (CPython 3.12 oracle)."""
...
try:
    ...
    del sys.path[0]
    remove_files(TESTFN)
print("ImportTests::test_failing_import_sticks: ok")
