...
# lib = "import"
# dimension = "behavior"
# case = "import_traceback_tests__test_broken_parent_from"
# subject = "cpython.__init__.ImportTracebackTests.test_broken_parent_from"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTracebackTests::test_broken_parent_from
"""Auto-ported test: ImportTracebackTests::test_broken_parent_from (CPython 3.12 oracle)."""
...
init_path, bar_path = _setup_broken_package('1/0', '')
try:
...
assert_traceback(tb, [__file__, init_path])
print("ImportTracebackTests::test_broken_parent_from: ok")
