...
# lib = "import"
# dimension = "behavior"
# case = "import_tests__test_create_dynamic_null"
# subject = "cpython.__init__.ImportTests.test_create_dynamic_null"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTests::test_create_dynamic_null
"""Auto-ported test: ImportTests::test_create_dynamic_null (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('embedded null character', str(_aR_e))
print("ImportTests::test_create_dynamic_null: ok")
