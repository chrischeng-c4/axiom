...
# lib = "import"
# dimension = "behavior"
# case = "pycache_tests__test_recompute_pyc_same_second"
# subject = "cpython.__init__.PycacheTests.test_recompute_pyc_same_second"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::PycacheTests::test_recompute_pyc_same_second
"""Auto-ported test: PycacheTests::test_recompute_pyc_same_second (CPython 3.12 oracle)."""
...
__import__(TESTFN)
unload(TESTFN)
with open(self_source, 'a', encoding='utf-8') as fp:
    print('x = 5', file=fp)
m = __import__(TESTFN)

assert m.x == 5
print("PycacheTests::test_recompute_pyc_same_second: ok")
