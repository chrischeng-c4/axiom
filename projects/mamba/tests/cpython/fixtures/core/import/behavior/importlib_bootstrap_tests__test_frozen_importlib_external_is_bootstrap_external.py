...
# lib = "import"
# dimension = "behavior"
# case = "importlib_bootstrap_tests__test_frozen_importlib_external_is_bootstrap_external"
# subject = "cpython.__init__.ImportlibBootstrapTests.test_frozen_importlib_external_is_bootstrap_external"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportlibBootstrapTests::test_frozen_importlib_external_is_bootstrap_external
"""Auto-ported test: ImportlibBootstrapTests::test_frozen_importlib_external_is_bootstrap_external (CPython 3.12 oracle)."""
...
assert mod is _bootstrap_external

assert mod.__name__ == 'importlib._bootstrap_external'

assert mod.__package__ == 'importlib'

assert mod.__file__.endswith('_bootstrap_external.py')
print("ImportlibBootstrapTests::test_frozen_importlib_external_is_bootstrap_external: ok")
