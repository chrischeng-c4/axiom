...
# lib = "with"
# dimension = "behavior"
# case = "nonexceptional_test_case__test_inline_generator_bound_to_dotted_variable"
# subject = "cpython.test_with.NonexceptionalTestCase.testInlineGeneratorBoundToDottedVariable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_with.py::NonexceptionalTestCase::testInlineGeneratorBoundToDottedVariable
"""Auto-ported test: NonexceptionalTestCase::testInlineGeneratorBoundToDottedVariable (CPython 3.12 oracle)."""
...
with mock_contextmanager_generator() as self_foo:
    assertInWithGeneratorInvariants(self_foo)
assertAfterWithGeneratorInvariantsNoError(self_foo)
print("NonexceptionalTestCase::testInlineGeneratorBoundToDottedVariable: ok")
