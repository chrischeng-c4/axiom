...
# lib = "with"
# dimension = "behavior"
# case = "assignment_target_test_case__test_with_extended_targets"
# subject = "cpython.test_with.AssignmentTargetTestCase.testWithExtendedTargets"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_with.py::AssignmentTargetTestCase::testWithExtendedTargets
"""Auto-ported test: AssignmentTargetTestCase::testWithExtendedTargets (CPython 3.12 oracle)."""
...
with nullcontext(range(1, 5)) as (a, *b, c):
    ...
    assert c == 4
print("AssignmentTargetTestCase::testWithExtendedTargets: ok")
