...
# lib = "with"
# dimension = "behavior"
# case = "exceptional_test_case__test_raised_stop_iteration1"
# subject = "cpython.test_with.ExceptionalTestCase.testRaisedStopIteration1"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_with.py::ExceptionalTestCase::testRaisedStopIteration1
"""Auto-ported test: ExceptionalTestCase::testRaisedStopIteration1 (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('from with', str(_aR_e))
print("ExceptionalTestCase::testRaisedStopIteration1: ok")
