...
# lib = "grammar"
# dimension = "behavior"
# case = "token_tests__test_plain_integers"
# subject = "cpython.test_grammar.TokenTests.test_plain_integers"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::TokenTests::test_plain_integers
"""Auto-ported test: TokenTests::test_plain_integers (CPython 3.12 oracle)."""
...
if maxsize == 2147483647:
    ...
    for s in ('2147483648', '0o40000000000', '0x100000000', '0b10000000000000000000000000000000'):
        try:
            ...
            raise AssertionError('OverflowError on huge integer literal %r' % s)
    ...
    raise AssertionError('Weird maxsize value %r' % maxsize)
print("TokenTests::test_plain_integers: ok")
