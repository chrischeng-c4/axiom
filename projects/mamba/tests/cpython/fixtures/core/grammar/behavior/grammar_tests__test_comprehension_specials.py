...
# lib = "grammar"
# dimension = "behavior"
# case = "grammar_tests__test_comprehension_specials"
# subject = "cpython.test_grammar.GrammarTests.test_comprehension_specials"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::GrammarTests::test_comprehension_specials
"""Auto-ported test: GrammarTests::test_comprehension_specials (CPython 3.12 oracle)."""
...
assert list((x for x in range(10) if x % 2 if x % 3)) == [1, 5, 7]

assert [x for x, in [(4,), (5,), (6,)]] == [4, 5, 6]

assert list((x for x, in [(7,), (8,), (9,)])) == [7, 8, 9]
print("GrammarTests::test_comprehension_specials: ok")
