...
# lib = "grammar"
# dimension = "behavior"
# case = "grammar_tests__test_continue_stmt"
# subject = "cpython.test_grammar.GrammarTests.test_continue_stmt"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::GrammarTests::test_continue_stmt
"""Auto-ported test: GrammarTests::test_continue_stmt (CPython 3.12 oracle)."""
...
if msg != 'ok':
    ...
    raise AssertionError(msg)
print("GrammarTests::test_continue_stmt: ok")
