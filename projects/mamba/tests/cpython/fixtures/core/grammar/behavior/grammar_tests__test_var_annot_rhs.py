...
# lib = "grammar"
# dimension = "behavior"
# case = "grammar_tests__test_var_annot_rhs"
# subject = "cpython.test_grammar.GrammarTests.test_var_annot_rhs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::GrammarTests::test_var_annot_rhs
"""Auto-ported test: GrammarTests::test_var_annot_rhs (CPython 3.12 oracle)."""
...
assert list(ns['f']()) == [None]
ns = {'a': 1, 'b': (2, 3, 4), 'c': 5, 'Tuple': typing.Tuple}
exec('x: Tuple[int, ...] = a,*b,c', ns)

assert ns['x'] == (1, 2, 3, 4, 5)
print("GrammarTests::test_var_annot_rhs: ok")
