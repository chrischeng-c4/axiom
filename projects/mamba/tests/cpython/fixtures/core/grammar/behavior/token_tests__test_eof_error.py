...
# lib = "grammar"
# dimension = "behavior"
# case = "token_tests__test_eof_error"
# subject = "cpython.test_grammar.TokenTests.test_eof_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::TokenTests::test_eof_error
"""Auto-ported test: TokenTests::test_eof_error (CPython 3.12 oracle)."""
...
for s in samples:
    ...
    assert 'was never closed' in str(cm.exception)
print("TokenTests::test_eof_error: ok")
