...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_assign_to_comp_iter_var_in_outer_function"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_assign_to_comp_iter_var_in_outer_function"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_assign_to_comp_iter_var_in_outer_function
"""Auto-ported test: ListComprehensionTest::test_assign_to_comp_iter_var_in_outer_function (CPython 3.12 oracle)."""
...
def _replacing_exec(code_string, ns):
    ...
    exec(co, ns)
code = '\n            a = [1 for a in [0]]\n        '
_check_in_scopes(code, {'a': [1]}, scopes=['function'])
print("ListComprehensionTest::test_assign_to_comp_iter_var_in_outer_function: ok")
