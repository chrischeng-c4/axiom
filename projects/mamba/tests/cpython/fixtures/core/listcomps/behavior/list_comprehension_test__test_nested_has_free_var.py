...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_nested_has_free_var"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_nested_has_free_var"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_nested_has_free_var
"""Auto-ported test: ListComprehensionTest::test_nested_has_free_var (CPython 3.12 oracle)."""
...
outputs = {'items': [1]}
_check_in_scopes(code, outputs, scopes=['class'])
print("ListComprehensionTest::test_nested_has_free_var: ok")
