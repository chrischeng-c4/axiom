...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_iter_var_available_in_locals"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_iter_var_available_in_locals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_iter_var_available_in_locals
"""Auto-ported test: ListComprehensionTest::test_iter_var_available_in_locals (CPython 3.12 oracle)."""
...
_check_in_scopes(code, {'items': [1, 2], 'items2': [1, 2], 'items3': [True, True], 'items4': [1, 2], 'y': 0})
print("ListComprehensionTest::test_iter_var_available_in_locals: ok")
