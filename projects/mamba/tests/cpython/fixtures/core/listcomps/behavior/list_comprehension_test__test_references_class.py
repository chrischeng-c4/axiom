...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_references_class"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_references___class__"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_references___class__
"""Auto-ported test: ListComprehensionTest::test_references___class__ (CPython 3.12 oracle)."""
...
_check_in_scopes(code, raises=NameError)
print("ListComprehensionTest::test_references___class__: ok")
