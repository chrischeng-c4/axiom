...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_code_replace_extended_arg"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_code_replace_extended_arg"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_code_replace_extended_arg
"""Auto-ported test: ListComprehensionTest::test_code_replace_extended_arg (CPython 3.12 oracle)."""
...
expected = {'y': list(range(num_names)), **{f'x{i}': i for i in range(num_names)}}
code = f'\n            {assignments}\n            [({name_list}) for {name_list} in (range(300),)]\n            dir()\n            y = [{name_list}]\n        '
_check_in_scopes(code, expected)
_check_in_scopes(code, expected, exec_func=_replacing_exec)
print("ListComprehensionTest::test_code_replace_extended_arg: ok")
