...
# lib = "compile"
# dimension = "behavior"
# case = "test_stack_size_stability__test_try_except_qualified"
# subject = "cpython.test_compile.TestStackSizeStability.test_try_except_qualified"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestStackSizeStability::test_try_except_qualified
"""Auto-ported test: TestStackSizeStability::test_try_except_qualified (CPython 3.12 oracle)."""
...
print("TestStackSizeStability::test_try_except_qualified: ok")
