...
# lib = "compile"
# dimension = "behavior"
# case = "test_stack_size_stability__test_if"
# subject = "cpython.test_compile.TestStackSizeStability.test_if"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestStackSizeStability::test_if
"""Auto-ported test: TestStackSizeStability::test_if (CPython 3.12 oracle)."""
...
print("TestStackSizeStability::test_if: ok")
