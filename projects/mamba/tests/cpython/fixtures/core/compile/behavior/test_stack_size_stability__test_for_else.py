...
# lib = "compile"
# dimension = "behavior"
# case = "test_stack_size_stability__test_for_else"
# subject = "cpython.test_compile.TestStackSizeStability.test_for_else"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestStackSizeStability::test_for_else
"""Auto-ported test: TestStackSizeStability::test_for_else (CPython 3.12 oracle)."""
...
print("TestStackSizeStability::test_for_else: ok")
