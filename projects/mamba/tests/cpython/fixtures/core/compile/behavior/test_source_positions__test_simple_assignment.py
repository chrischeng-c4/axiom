...
# lib = "compile"
# dimension = "behavior"
# case = "test_source_positions__test_simple_assignment"
# subject = "cpython.test_compile.TestSourcePositions.test_simple_assignment"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestSourcePositions::test_simple_assignment
"""Auto-ported test: TestSourcePositions::test_simple_assignment (CPython 3.12 oracle)."""
...
snippet = 'x = 1'
check_positions_against_ast(snippet)
print("TestSourcePositions::test_simple_assignment: ok")
