...
# lib = "compile"
# dimension = "behavior"
# case = "test_source_positions__test_multiline_async_list_comprehension"
# subject = "cpython.test_compile.TestSourcePositions.test_multiline_async_list_comprehension"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestSourcePositions::test_multiline_async_list_comprehension
"""Auto-ported test: TestSourcePositions::test_multiline_async_list_comprehension (CPython 3.12 oracle)."""
...
snippet = textwrap.dedent('            async def f():\n                [(x,\n                    2*x)\n                    async for x\n                    in [1,2,3] if (x > 0\n                                   and x < 100\n                                   and x != 50)]\n            ')
...
assertOpcodeSourcePositionIs(compiled_code, 'LIST_APPEND', line=2, end_line=3, column=5, end_column=12, occurrence=1)
assertOpcodeSourcePositionIs(compiled_code, 'JUMP_BACKWARD', line=2, end_line=3, column=5, end_column=12, occurrence=1)
assertOpcodeSourcePositionIs(compiled_code, 'RETURN_CONST', line=2, end_line=7, column=4, end_column=36, occurrence=1)
print("TestSourcePositions::test_multiline_async_list_comprehension: ok")
