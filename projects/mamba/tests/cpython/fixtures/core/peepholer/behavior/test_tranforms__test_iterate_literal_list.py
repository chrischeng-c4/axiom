...
# lib = "peepholer"
# dimension = "behavior"
# case = "test_tranforms__test_iterate_literal_list"
# subject = "cpython.test_peepholer.TestTranforms.test_iterate_literal_list"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_peepholer.py::TestTranforms::test_iterate_literal_list
"""Auto-ported test: TestTranforms::test_iterate_literal_list (CPython 3.12 oracle)."""
...
assert count_instr_recursively(forloop, 'BUILD_LIST') == 0
check_lnotab(forloop)
print("TestTranforms::test_iterate_literal_list: ok")
