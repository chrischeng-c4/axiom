...
# lib = "exception_group"
# dimension = "behavior"
# case = "str_and_repr_tests__test_base_exception_group"
# subject = "cpython.test_exception_group.StrAndReprTests.test_BaseExceptionGroup"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exception_group.py::StrAndReprTests::test_BaseExceptionGroup
"""Auto-ported test: StrAndReprTests::test_BaseExceptionGroup (CPython 3.12 oracle)."""
...
assert repr(eg) == "BaseExceptionGroup('flat', [ValueError(1), KeyboardInterrupt(2)])"
eg = BaseExceptionGroup('nested', [eg, ValueError(1), eg])

assert str(eg) == 'nested (3 sub-exceptions)'

assert repr(eg) == "BaseExceptionGroup('nested', [BaseExceptionGroup('flat', [ValueError(1), KeyboardInterrupt(2)]), ValueError(1), BaseExceptionGroup('flat', [ValueError(1), KeyboardInterrupt(2)])])"
print("StrAndReprTests::test_BaseExceptionGroup: ok")
