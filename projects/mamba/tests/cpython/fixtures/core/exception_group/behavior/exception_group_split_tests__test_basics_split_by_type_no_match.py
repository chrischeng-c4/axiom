...
# lib = "exception_group"
# dimension = "behavior"
# case = "exception_group_split_tests__test_basics_split_by_type_no_match"
# subject = "cpython.test_exception_group.ExceptionGroupSplitTests.test_basics_split_by_type__no_match"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exception_group.py::ExceptionGroupSplitTests::test_basics_split_by_type__no_match
"""Auto-ported test: ExceptionGroupSplitTests::test_basics_split_by_type__no_match (CPython 3.12 oracle)."""
...
match, rest = self_eg.split(OSError)

assert match is None
assertMatchesTemplate(rest, ExceptionGroup, self_eg_template)
print("ExceptionGroupSplitTests::test_basics_split_by_type__no_match: ok")
