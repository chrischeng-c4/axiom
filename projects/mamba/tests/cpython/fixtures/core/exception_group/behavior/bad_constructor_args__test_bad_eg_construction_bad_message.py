...
# lib = "exception_group"
# dimension = "behavior"
# case = "bad_constructor_args__test_bad_eg_construction_bad_message"
# subject = "cpython.test_exception_group.BadConstructorArgs.test_bad_EG_construction__bad_message"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exception_group.py::BadConstructorArgs::test_bad_EG_construction__bad_message
"""Auto-ported test: BadConstructorArgs::test_bad_EG_construction__bad_message (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(MSG, str(_aR_e))
print("BadConstructorArgs::test_bad_EG_construction__bad_message: ok")
