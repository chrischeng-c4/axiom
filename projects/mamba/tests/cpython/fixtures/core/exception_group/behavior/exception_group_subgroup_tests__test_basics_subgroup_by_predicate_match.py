...
# lib = "exception_group"
# dimension = "behavior"
# case = "exception_group_subgroup_tests__test_basics_subgroup_by_predicate_match"
# subject = "cpython.test_exception_group.ExceptionGroupSubgroupTests.test_basics_subgroup_by_predicate__match"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exception_group.py::ExceptionGroupSubgroupTests::test_basics_subgroup_by_predicate__match
"""Auto-ported test: ExceptionGroupSubgroupTests::test_basics_subgroup_by_predicate__match (CPython 3.12 oracle)."""
...
eg = self_eg
testcases = [(ValueError, [ValueError(1), ValueError(2)]), (TypeError, [TypeError(int)]), ((ValueError, TypeError), self_eg_template)]
for match_type, template in testcases:
    subeg = eg.subgroup(lambda e: isinstance(e, match_type))

    assert subeg.message == eg.message
    assertMatchesTemplate(subeg, ExceptionGroup, template)
print("ExceptionGroupSubgroupTests::test_basics_subgroup_by_predicate__match: ok")
