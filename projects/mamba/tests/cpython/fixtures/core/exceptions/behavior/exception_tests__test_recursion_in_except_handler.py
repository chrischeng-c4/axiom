...
# lib = "exceptions"
# dimension = "behavior"
# case = "exception_tests__test_recursion_in_except_handler"
# subject = "cpython.test_exceptions.ExceptionTests.test_recursion_in_except_handler"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::ExceptionTests::test_recursion_in_except_handler
"""Auto-ported test: ExceptionTests::test_recursion_in_except_handler (CPython 3.12 oracle)."""
...
try:
    ...
    for func in (recurse_in_except, recurse_after_except, recurse_in_body_and_except):
        try:
            ...
            raise AssertionError('Should have raised a RecursionError')
finally:
    sys.setrecursionlimit(recursionlimit)
print("ExceptionTests::test_recursion_in_except_handler: ok")
