...
# lib = "exceptions"
# dimension = "behavior"
# case = "pep626_tests__test_lineno_in_try"
# subject = "cpython.test_exceptions.PEP626Tests.test_lineno_in_try"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::PEP626Tests::test_lineno_in_try
"""Auto-ported test: PEP626Tests::test_lineno_in_try (CPython 3.12 oracle)."""
...
def in_try():
    try:
        ...
        pass
lineno_after_raise(in_try, 4)
print("PEP626Tests::test_lineno_in_try: ok")
