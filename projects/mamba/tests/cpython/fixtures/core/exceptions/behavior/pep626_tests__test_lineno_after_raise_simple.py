...
# lib = "exceptions"
# dimension = "behavior"
# case = "pep626_tests__test_lineno_after_raise_simple"
# subject = "cpython.test_exceptions.PEP626Tests.test_lineno_after_raise_simple"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::PEP626Tests::test_lineno_after_raise_simple
"""Auto-ported test: PEP626Tests::test_lineno_after_raise_simple (CPython 3.12 oracle)."""
...
def simple():
    1 / 0
    pass
lineno_after_raise(simple, 1)
print("PEP626Tests::test_lineno_after_raise_simple: ok")
