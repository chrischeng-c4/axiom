...
# lib = "exceptions"
# dimension = "behavior"
# case = "exception_tests__test_chaining_descriptors"
# subject = "cpython.test_exceptions.ExceptionTests.testChainingDescriptors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::ExceptionTests::testChainingDescriptors
"""Auto-ported test: ExceptionTests::testChainingDescriptors (CPython 3.12 oracle)."""
...
assert not e.__suppress_context__
print("ExceptionTests::testChainingDescriptors: ok")
