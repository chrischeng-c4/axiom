...
# lib = "exceptions"
# dimension = "behavior"
# case = "exception_tests__test_unicode_error_str_does_not_crash"
# subject = "cpython.test_exceptions.ExceptionTests.test_unicode_error_str_does_not_crash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::ExceptionTests::test_unicode_error_str_does_not_crash
"""Auto-ported test: ExceptionTests::test_unicode_error_str_does_not_crash (CPython 3.12 oracle)."""
...
for start, end, objlen in product(range(-5, 5), range(-5, 5), range(7)):
    ...
    assert isinstance(str(exc), str)
print("ExceptionTests::test_unicode_error_str_does_not_crash: ok")
