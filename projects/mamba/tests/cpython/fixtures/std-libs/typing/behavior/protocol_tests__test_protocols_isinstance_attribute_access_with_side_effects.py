...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_protocols_isinstance_attribute_access_with_side_effects"
# subject = "cpython.test_typing.ProtocolTests.test_protocols_isinstance_attribute_access_with_side_effects"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_protocols_isinstance_attribute_access_with_side_effects
"""Auto-ported test: ProtocolTests::test_protocols_isinstance_attribute_access_with_side_effects (CPython 3.12 oracle)."""
...
for protocol_class in (P, P1, PG, PG1, MethodP, MethodPG):
    for klass in (C, D, E, F):
        ...
        assert isinstance(klass(), protocol_class)

    assert not isinstance(WhyWouldYouDoThis(), protocol_class)
print("ProtocolTests::test_protocols_isinstance_attribute_access_with_side_effects: ok")
