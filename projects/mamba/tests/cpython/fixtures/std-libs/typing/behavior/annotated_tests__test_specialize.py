...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_specialize"
# subject = "cpython.test_typing.AnnotatedTests.test_specialize"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_specialize
"""Auto-ported test: AnnotatedTests::test_specialize (CPython 3.12 oracle)."""
...
assert L[int] == Annotated[List[int], 'my decoration']

assert L[int].__metadata__ == ('my decoration',)

assert L[int].__origin__ == List[int]
try:
    LI[int]
...
try:
    ...
    pass
print("AnnotatedTests::test_specialize: ok")
