...
# lib = "typing"
# dimension = "behavior"
# case = "typed_dict_tests__test_total"
# subject = "cpython.test_typing.TypedDictTests.test_total"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypedDictTests::test_total
"""Auto-ported test: TypedDictTests::test_total (CPython 3.12 oracle)."""
...
assert D.__total__ == False

assert D.__required_keys__ == frozenset()

assert isinstance(D.__required_keys__, frozenset)

assert D.__optional_keys__ == {'x'}

assert isinstance(D.__optional_keys__, frozenset)

assert Options() == {}

assert Options(log_level=2) == {'log_level': 2}

assert Options.__total__ == False

assert Options.__required_keys__ == frozenset()

assert Options.__optional_keys__ == {'log_level', 'log_path'}
print("TypedDictTests::test_total: ok")
