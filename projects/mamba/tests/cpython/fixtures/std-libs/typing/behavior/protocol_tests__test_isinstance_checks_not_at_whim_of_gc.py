...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_isinstance_checks_not_at_whim_of_gc"
# subject = "cpython.test_typing.ProtocolTests.test_isinstance_checks_not_at_whim_of_gc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_isinstance_checks_not_at_whim_of_gc
"""Auto-ported test: ProtocolTests::test_isinstance_checks_not_at_whim_of_gc (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Protocols can only inherit from other protocols', str(_aR_e))

assert not isinstance([], collections.abc.Mapping)
print("ProtocolTests::test_isinstance_checks_not_at_whim_of_gc: ok")
