...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_generic_protocols_eq"
# subject = "cpython.test_typing.ProtocolTests.test_generic_protocols_eq"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_generic_protocols_eq
"""Auto-ported test: ProtocolTests::test_generic_protocols_eq (CPython 3.12 oracle)."""
...
assert P[int, T] == P[int, T]

assert P[T, T][Tuple[T, S]][int, str] == P[Tuple[int, str], Tuple[int, str]]
print("ProtocolTests::test_generic_protocols_eq: ok")
