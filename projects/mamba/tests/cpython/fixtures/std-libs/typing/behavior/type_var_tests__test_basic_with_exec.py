...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tests__test_basic_with_exec"
# subject = "cpython.test_typing.TypeVarTests.test_basic_with_exec"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTests::test_basic_with_exec
"""Auto-ported test: TypeVarTests::test_basic_with_exec (CPython 3.12 oracle)."""
...
assert T.__bound__ is float

assert T.__covariant__ is False

assert T.__contravariant__ is False

assert T.__infer_variance__ is False

assert T.__module__ is None
print("TypeVarTests::test_basic_with_exec: ok")
