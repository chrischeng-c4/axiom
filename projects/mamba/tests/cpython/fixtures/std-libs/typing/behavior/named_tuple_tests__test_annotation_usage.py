...
# lib = "typing"
# dimension = "behavior"
# case = "named_tuple_tests__test_annotation_usage"
# subject = "cpython.test_typing.NamedTupleTests.test_annotation_usage"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NamedTupleTests::test_annotation_usage
"""Auto-ported test: NamedTupleTests::test_annotation_usage (CPython 3.12 oracle)."""
...
assert isinstance(tim, CoolEmployee)

assert isinstance(tim, tuple)

assert tim.name == 'Tim'

assert tim.cool == 9000

assert CoolEmployee.__name__ == 'CoolEmployee'

assert CoolEmployee._fields == ('name', 'cool')

assert CoolEmployee.__annotations__ == collections.OrderedDict(name=str, cool=int)
print("NamedTupleTests::test_annotation_usage: ok")
