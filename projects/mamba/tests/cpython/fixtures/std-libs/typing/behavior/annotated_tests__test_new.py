...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_new"
# subject = "cpython.test_typing.AnnotatedTests.test_new"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_new
"""Auto-ported test: AnnotatedTests::test_new (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Type Annotated cannot be instantiated', str(_aR_e))
print("AnnotatedTests::test_new: ok")
