...
# lib = "typing"
# dimension = "behavior"
# case = "named_tuple_tests__test_annotation_usage_with_default"
# subject = "cpython.test_typing.NamedTupleTests.test_annotation_usage_with_default"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NamedTupleTests::test_annotation_usage_with_default
"""Auto-ported test: NamedTupleTests::test_annotation_usage_with_default (CPython 3.12 oracle)."""
...
assert isinstance(jelle, CoolEmployeeWithDefault)

assert isinstance(jelle, tuple)

assert jelle.name == 'Jelle'

assert jelle.cool == 0
cooler_employee = CoolEmployeeWithDefault('Sjoerd', 1)

assert cooler_employee.cool == 1

assert CoolEmployeeWithDefault.__name__ == 'CoolEmployeeWithDefault'

assert CoolEmployeeWithDefault._fields == ('name', 'cool')

assert CoolEmployeeWithDefault.__annotations__ == dict(name=str, cool=int)

assert CoolEmployeeWithDefault._field_defaults == dict(cool=0)
try:
    ...
    pass
print("NamedTupleTests::test_annotation_usage_with_default: ok")
