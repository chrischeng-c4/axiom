...
# lib = "typing"
# dimension = "behavior"
# case = "re_tests__test_alias_equality"
# subject = "cpython.test_typing.RETests.test_alias_equality"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::RETests::test_alias_equality
"""Auto-ported test: RETests::test_alias_equality (CPython 3.12 oracle)."""
...
assert Pattern[str] == Pattern[str]

assert Pattern[str] != Pattern[bytes]

assert Pattern[str] != Match[str]

assert Pattern[str] != str
print("RETests::test_alias_equality: ok")
