...
# lib = "typing"
# dimension = "behavior"
# case = "no_return_tests__test_equality"
# subject = "cpython.test_typing.NoReturnTests.test_equality"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NoReturnTests::test_equality
"""Auto-ported test: NoReturnTests::test_equality (CPython 3.12 oracle)."""
...
assert bottom_type == bottom_type

assert bottom_type is bottom_type

assert bottom_type != None
print("NoReturnTests::test_equality: ok")
