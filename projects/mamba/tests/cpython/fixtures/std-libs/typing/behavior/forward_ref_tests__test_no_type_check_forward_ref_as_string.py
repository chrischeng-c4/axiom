...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_no_type_check_forward_ref_as_string"
# subject = "cpython.test_typing.ForwardRefTests.test_no_type_check_forward_ref_as_string"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_no_type_check_forward_ref_as_string
"""Auto-ported test: ForwardRefTests::test_no_type_check_forward_ref_as_string (CPython 3.12 oracle)."""
...
for clazz in [C, D, E, F]:
    ...
    assert get_type_hints(clazz) == expected_result
print("ForwardRefTests::test_no_type_check_forward_ref_as_string: ok")
