...
# lib = "typing"
# dimension = "behavior"
# case = "override_decorator_tests__test_property"
# subject = "cpython.test_typing.OverrideDecoratorTests.test_property"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::OverrideDecoratorTests::test_property
"""Auto-ported test: OverrideDecoratorTests::test_property (CPython 3.12 oracle)."""
...
assert instance.correct == 2

assert Child.correct.fget.__override__

assert instance.wrong == 2

assert not hasattr(Child.wrong, '__override__')

assert not hasattr(Child.wrong.fset, '__override__')
print("OverrideDecoratorTests::test_property: ok")
