...
# lib = "typing"
# dimension = "behavior"
# case = "literal_tests__test_repr"
# subject = "cpython.test_typing.LiteralTests.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::LiteralTests::test_repr
"""Auto-ported test: LiteralTests::test_repr (CPython 3.12 oracle)."""
...
assert repr(Literal[1]) == 'typing.Literal[1]'

assert repr(Literal[1, True, 'foo']) == "typing.Literal[1, True, 'foo']"

assert repr(Literal[int]) == 'typing.Literal[int]'

assert repr(Literal) == 'typing.Literal'

assert repr(Literal[None]) == 'typing.Literal[None]'

assert repr(Literal[1, 2, 3, 3]) == 'typing.Literal[1, 2, 3]'
print("LiteralTests::test_repr: ok")
