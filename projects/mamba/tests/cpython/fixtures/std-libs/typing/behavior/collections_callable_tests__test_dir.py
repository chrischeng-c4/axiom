...
# lib = "typing"
# dimension = "behavior"
# case = "collections_callable_tests__test_dir"
# subject = "cpython.test_typing.CollectionsCallableTests.test_dir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::CollectionsCallableTests::test_dir
"""Auto-ported test: CollectionsCallableTests::test_dir (CPython 3.12 oracle)."""
...
for required_item in ['__args__', '__parameters__', '__origin__']:

    assert required_item in dir_items
print("CollectionsCallableTests::test_dir: ok")
