...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_subscripted_generics_as_proxies"
# subject = "cpython.test_typing.GenericTests.test_subscripted_generics_as_proxies"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_subscripted_generics_as_proxies
"""Auto-ported test: GenericTests::test_subscripted_generics_as_proxies (CPython 3.12 oracle)."""
...
assert C[C[int]].x == 'def'
C[C[int]].x = 'changed'

assert C.x == 'changed'

assert C[str].x == 'changed'
C[List[str]].z = 'new'

assert C.z == 'new'

assert C[Tuple[int]].z == 'new'

assert C().x == 'changed'

assert C[Tuple[str]]().z == 'new'

class D(C[T]):
    pass

assert D[int].x == 'changed'
...
assert D.x == 'from derived x'

assert D[str].z == 'from derived z'
print("GenericTests::test_subscripted_generics_as_proxies: ok")
