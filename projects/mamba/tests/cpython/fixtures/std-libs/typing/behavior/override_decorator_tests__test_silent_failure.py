...
# lib = "typing"
# dimension = "behavior"
# case = "override_decorator_tests__test_silent_failure"
# subject = "cpython.test_typing.OverrideDecoratorTests.test_silent_failure"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::OverrideDecoratorTests::test_silent_failure
"""Auto-ported test: OverrideDecoratorTests::test_silent_failure (CPython 3.12 oracle)."""
...
assert WithOverride.some == 1

assert not hasattr(WithOverride.some, '__override__')
print("OverrideDecoratorTests::test_silent_failure: ok")
