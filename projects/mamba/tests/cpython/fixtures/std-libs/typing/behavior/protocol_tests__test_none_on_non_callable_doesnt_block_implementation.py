...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_none_on_non_callable_doesnt_block_implementation"
# subject = "cpython.test_typing.ProtocolTests.test_none_on_non_callable_doesnt_block_implementation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_none_on_non_callable_doesnt_block_implementation
"""Auto-ported test: ProtocolTests::test_none_on_non_callable_doesnt_block_implementation (CPython 3.12 oracle)."""
...
assert isinstance(B(), P)

assert isinstance(C(), P)
print("ProtocolTests::test_none_on_non_callable_doesnt_block_implementation: ok")
