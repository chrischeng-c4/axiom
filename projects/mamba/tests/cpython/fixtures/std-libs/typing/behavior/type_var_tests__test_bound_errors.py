...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tests__test_bound_errors"
# subject = "cpython.test_typing.TypeVarTests.test_bound_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTests::test_bound_errors
"""Auto-ported test: TypeVarTests::test_bound_errors (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Bound must be a type\\. Got \\(1, 2\\)\\.', str(_aR_e))
print("TypeVarTests::test_bound_errors: ok")
