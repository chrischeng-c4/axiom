...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_dir"
# subject = "cpython.test_typing.AnnotatedTests.test_dir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_dir
"""Auto-ported test: AnnotatedTests::test_dir (CPython 3.12 oracle)."""
...
for required_item in ['__args__', '__parameters__', '__origin__', '__metadata__']:

    assert required_item in dir_items
print("AnnotatedTests::test_dir: ok")
