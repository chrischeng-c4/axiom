...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_protocol_defining_init_does_not_get_overridden"
# subject = "cpython.test_typing.ProtocolTests.test_protocol_defining_init_does_not_get_overridden"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_protocol_defining_init_does_not_get_overridden
"""Auto-ported test: ProtocolTests::test_protocol_defining_init_does_not_get_overridden (CPython 3.12 oracle)."""
...
assert c.x == 1
print("ProtocolTests::test_protocol_defining_init_does_not_get_overridden: ok")
