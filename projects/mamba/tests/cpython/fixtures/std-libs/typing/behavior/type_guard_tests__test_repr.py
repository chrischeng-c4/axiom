...
# lib = "typing"
# dimension = "behavior"
# case = "type_guard_tests__test_repr"
# subject = "cpython.test_typing.TypeGuardTests.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeGuardTests::test_repr
"""Auto-ported test: TypeGuardTests::test_repr (CPython 3.12 oracle)."""
...
assert repr(TypeGuard) == 'typing.TypeGuard'
cv = TypeGuard[int]

assert repr(cv) == 'typing.TypeGuard[int]'
cv = TypeGuard[Employee]

assert repr(cv) == 'typing.TypeGuard[%s.Employee]' % __name__
cv = TypeGuard[tuple[int]]

assert repr(cv) == 'typing.TypeGuard[tuple[int]]'
print("TypeGuardTests::test_repr: ok")
