...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_get_type_hints_for_builtins"
# subject = "cpython.test_typing.GetTypeHintTests.test_get_type_hints_for_builtins"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_get_type_hints_for_builtins
"""Auto-ported test: GetTypeHintTests::test_get_type_hints_for_builtins (CPython 3.12 oracle)."""
...
assert gth(object.__str__) == {}

assert gth(object().__str__) == {}

assert gth(str.join) == {}
print("GetTypeHintTests::test_get_type_hints_for_builtins: ok")
