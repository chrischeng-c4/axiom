...
# lib = "typing"
# dimension = "behavior"
# case = "required_tests__test_cannot_init"
# subject = "cpython.test_typing.RequiredTests.test_cannot_init"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::RequiredTests::test_cannot_init
"""Auto-ported test: RequiredTests::test_cannot_init (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("RequiredTests::test_cannot_init: ok")
