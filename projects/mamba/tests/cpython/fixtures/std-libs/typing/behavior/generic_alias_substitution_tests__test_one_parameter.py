...
# lib = "typing"
# dimension = "behavior"
# case = "generic_alias_substitution_tests__test_one_parameter"
# subject = "cpython.test_typing.GenericAliasSubstitutionTests.test_one_parameter"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericAliasSubstitutionTests::test_one_parameter
"""Auto-ported test: GenericAliasSubstitutionTests::test_one_parameter (CPython 3.12 oracle)."""
...
tests = [('generic[T]', '[()]', 'TypeError'), ('generic[T]', '[int]', 'generic[int]'), ('generic[T]', '[int, str]', 'TypeError'), ('generic[T]', '[tuple_type[int, ...]]', 'generic[tuple_type[int, ...]]'), ('generic[T]', '[*tuple_type[int]]', 'generic[int]'), ('generic[T]', '[*tuple_type[()]]', 'TypeError'), ('generic[T]', '[*tuple_type[int, str]]', 'TypeError'), ('generic[T]', '[*tuple_type[int, ...]]', 'TypeError'), ('generic[T]', '[*Ts]', 'TypeError'), ('generic[T]', '[T, *Ts]', 'TypeError'), ('generic[T]', '[*Ts, T]', 'TypeError'), ('C[T, *tuple_type[int, ...]]', '[int]', 'TypeError'), ('list[T, *tuple_type[int, ...]]', '[int]', 'list[int, *tuple_type[int, ...]]'), ('List[T, *tuple_type[int, ...]]', '[int]', 'TypeError'), ('generic[*Ts, *Ts2]', '[int]', 'TypeError')]
...
print("GenericAliasSubstitutionTests::test_one_parameter: ok")
