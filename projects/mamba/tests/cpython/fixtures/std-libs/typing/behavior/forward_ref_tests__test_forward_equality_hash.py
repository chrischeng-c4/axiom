...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_forward_equality_hash"
# subject = "cpython.test_typing.ForwardRefTests.test_forward_equality_hash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_forward_equality_hash
"""Auto-ported test: ForwardRefTests::test_forward_equality_hash (CPython 3.12 oracle)."""
...
assert hash(c1_gth) == hash(c2_gth)

assert hash(c1) == hash(c1_gth)
c3 = typing.ForwardRef('int', module=__name__)
c4 = typing.ForwardRef('int', module='__other_name__')

assert hash(c3) != hash(c1)

assert hash(c3) != hash(c1_gth)

assert hash(c3) != hash(c4)

assert hash(c3) == hash(typing.ForwardRef('int', module=__name__))
print("ForwardRefTests::test_forward_equality_hash: ok")
