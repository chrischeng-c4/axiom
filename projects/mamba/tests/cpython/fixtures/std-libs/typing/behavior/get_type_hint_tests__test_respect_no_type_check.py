...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_respect_no_type_check"
# subject = "cpython.test_typing.GetTypeHintTests.test_respect_no_type_check"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_respect_no_type_check
"""Auto-ported test: GetTypeHintTests::test_respect_no_type_check (CPython 3.12 oracle)."""
...
assert NoTpCheck.__no_type_check__

assert NoTpCheck.Inn.__init__.__no_type_check__

assert gth(ann_module2.NTC.meth) == {}
...
assert gth(ABase.meth) == {'x': int}
print("GetTypeHintTests::test_respect_no_type_check: ok")
