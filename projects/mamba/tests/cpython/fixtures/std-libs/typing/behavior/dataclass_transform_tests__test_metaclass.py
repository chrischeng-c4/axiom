...
# lib = "typing"
# dimension = "behavior"
# case = "dataclass_transform_tests__test_metaclass"
# subject = "cpython.test_typing.DataclassTransformTests.test_metaclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::DataclassTransformTests::test_metaclass
"""Auto-ported test: DataclassTransformTests::test_metaclass (CPython 3.12 oracle)."""
...
class ModelMeta(type):
    ...
    def __new__(cls, name, bases, namespace, *, init: bool=True):
...
assert Decorated is ModelMeta

assert Decorated.__dataclass_transform__ == {'eq_default': True, 'order_default': True, 'kw_only_default': False, 'frozen_default': True, 'field_specifiers': (Field,), 'kwargs': {}}

assert isinstance(CustomerModel, Decorated)
print("DataclassTransformTests::test_metaclass: ok")
