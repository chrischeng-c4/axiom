...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_protocols_isinstance_init"
# subject = "cpython.test_typing.ProtocolTests.test_protocols_isinstance_init"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_protocols_isinstance_init
"""Auto-ported test: ProtocolTests::test_protocols_isinstance_init (CPython 3.12 oracle)."""
...
assert isinstance(C(1), P)

assert isinstance(C(1), PG)
print("ProtocolTests::test_protocols_isinstance_init: ok")
