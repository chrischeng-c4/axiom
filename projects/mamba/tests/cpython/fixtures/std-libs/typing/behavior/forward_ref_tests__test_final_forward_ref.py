...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_final_forward_ref"
# subject = "cpython.test_typing.ForwardRefTests.test_final_forward_ref"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_final_forward_ref
"""Auto-ported test: ForwardRefTests::test_final_forward_ref (CPython 3.12 oracle)."""
...
assert gth(Loop, globals())['attr'] == Final[Loop]

assert gth(Loop, globals())['attr'] != Final[int]

assert gth(Loop, globals())['attr'] != Final
print("ForwardRefTests::test_final_forward_ref: ok")
