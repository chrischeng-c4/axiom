...
# lib = "typing"
# dimension = "behavior"
# case = "template_replacement_tests__test_no_duplicates_if_replacement_not_in_templates"
# subject = "cpython.test_typing.TemplateReplacementTests.test_no_duplicates_if_replacement_not_in_templates"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TemplateReplacementTests::test_no_duplicates_if_replacement_not_in_templates
"""Auto-ported test: TemplateReplacementTests::test_no_duplicates_if_replacement_not_in_templates (CPython 3.12 oracle)."""
...
def clear_caches():
    for f in typing._cleanups:
        f()
actual = template_replace(templates=['Cats are word1', 'Dogs!'], replacements={'word1': ['small', 'cute'], 'word2': ['big', 'fluffy']})
expected = [('Cats are small', 'Dogs!'), ('Cats are cute', 'Dogs!')]

assert actual == expected
print("TemplateReplacementTests::test_no_duplicates_if_replacement_not_in_templates: ok")
