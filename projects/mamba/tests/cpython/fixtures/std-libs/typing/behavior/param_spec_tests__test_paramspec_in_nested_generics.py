...
# lib = "typing"
# dimension = "behavior"
# case = "param_spec_tests__test_paramspec_in_nested_generics"
# subject = "cpython.test_typing.ParamSpecTests.test_paramspec_in_nested_generics"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ParamSpecTests::test_paramspec_in_nested_generics
"""Auto-ported test: ParamSpecTests::test_paramspec_in_nested_generics (CPython 3.12 oracle)."""
...
assert G1.__parameters__ == (P, T)

assert G2.__parameters__ == (P, T)

assert G3.__parameters__ == (P, T)
C = Callable[[int, str], float]

assert G1[[int, str], float] == List[C]

assert G2[[int, str], float] == list[C]

assert G3[[int, str], float] == list[C] | int
print("ParamSpecTests::test_paramspec_in_nested_generics: ok")
