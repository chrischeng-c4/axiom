...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_protocols_isinstance_slots"
# subject = "cpython.test_typing.ProtocolTests.test_protocols_isinstance___slots__"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_protocols_isinstance___slots__
"""Auto-ported test: ProtocolTests::test_protocols_isinstance___slots__ (CPython 3.12 oracle)."""
...
assert isinstance(HasNothingButSlots(), HasX)
print("ProtocolTests::test_protocols_isinstance___slots__: ok")
