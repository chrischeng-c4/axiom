...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_get_type_hints_for_object_with_annotations"
# subject = "cpython.test_typing.GetTypeHintTests.test_get_type_hints_for_object_with_annotations"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_get_type_hints_for_object_with_annotations
"""Auto-ported test: GetTypeHintTests::test_get_type_hints_for_object_with_annotations (CPython 3.12 oracle)."""
...
assert gth(b, locals()) == {'x': A}
print("GetTypeHintTests::test_get_type_hints_for_object_with_annotations: ok")
