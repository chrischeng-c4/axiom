...
# lib = "typing"
# dimension = "behavior"
# case = "collections_callable_tests__test_type_erasure"
# subject = "cpython.test_typing.CollectionsCallableTests.test_type_erasure"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::CollectionsCallableTests::test_type_erasure
"""Auto-ported test: CollectionsCallableTests::test_type_erasure (CPython 3.12 oracle)."""
...
assert a().__class__ is C1

assert a().__orig_class__ == C1[[int], T]
print("CollectionsCallableTests::test_type_erasure: ok")
