...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_basics"
# subject = "cpython.test_typing.GenericTests.test_basics"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_basics
"""Auto-ported test: GenericTests::test_basics (CPython 3.12 oracle)."""
...
assert isinstance(SM1(), SimpleMapping)
T = TypeVar('T')

assert List[list[T] | float].__parameters__ == (T,)
print("GenericTests::test_basics: ok")
