...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_subclass_special_form"
# subject = "cpython.test_typing.GenericTests.test_subclass_special_form"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_subclass_special_form
"""Auto-ported test: GenericTests::test_subclass_special_form (CPython 3.12 oracle)."""
...
for obj in (ClassVar[int], Final[int], Union[int, float], Optional[int], Literal[1, 2], Concatenate[int, ParamSpec('P')], TypeGuard[int]):
    try:
        ...
        import re as _re_aR
        assert _re_aR.search(f"^{re.escape(f'Cannot subclass {obj!r}')}$", str(_aR_e))
print("GenericTests::test_subclass_special_form: ok")
