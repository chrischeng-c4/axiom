...
# lib = "typing"
# dimension = "behavior"
# case = "override_decorator_tests__test_multiple_decorators"
# subject = "cpython.test_typing.OverrideDecoratorTests.test_multiple_decorators"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::OverrideDecoratorTests::test_multiple_decorators
"""Auto-ported test: OverrideDecoratorTests::test_multiple_decorators (CPython 3.12 oracle)."""
...
assert instance.on_top(1) == 2

assert instance.on_top.__override__

assert instance.on_bottom(1) == 3

assert instance.on_bottom.__override__
print("OverrideDecoratorTests::test_multiple_decorators: ok")
