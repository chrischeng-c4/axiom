...
# lib = "typing"
# dimension = "behavior"
# case = "param_spec_tests__test_bad_var_substitution"
# subject = "cpython.test_typing.ParamSpecTests.test_bad_var_substitution"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ParamSpecTests::test_bad_var_substitution
"""Auto-ported test: ParamSpecTests::test_bad_var_substitution (CPython 3.12 oracle)."""
...
for arg in bad_args:
    ...
    try:
        ...
        pass
print("ParamSpecTests::test_bad_var_substitution: ok")
