...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_union_forward"
# subject = "cpython.test_typing.ForwardRefTests.test_union_forward"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_union_forward
"""Auto-ported test: ForwardRefTests::test_union_forward (CPython 3.12 oracle)."""
...
assert get_type_hints(foo, globals(), locals()) == {'a': Union[T]}

def foo(a: tuple[ForwardRef('T')] | int):
    pass

assert get_type_hints(foo, globals(), locals()) == {'a': tuple[T] | int}
print("ForwardRefTests::test_union_forward: ok")
