...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_runtime_protocol_interaction_with_evil_classproperty"
# subject = "cpython.test_typing.ProtocolTests.test_runtime_protocol_interaction_with_evil_classproperty"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_runtime_protocol_interaction_with_evil_classproperty
"""Auto-ported test: ProtocolTests::test_runtime_protocol_interaction_with_evil_classproperty (CPython 3.12 oracle)."""
...
assert exc.args[0] == "Failed to determine whether protocol member 'evil' is a method member"

assert type(exc.__cause__) is CustomError
print("ProtocolTests::test_runtime_protocol_interaction_with_evil_classproperty: ok")
