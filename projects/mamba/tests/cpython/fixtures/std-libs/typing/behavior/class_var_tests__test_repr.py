...
# lib = "typing"
# dimension = "behavior"
# case = "class_var_tests__test_repr"
# subject = "cpython.test_typing.ClassVarTests.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ClassVarTests::test_repr
"""Auto-ported test: ClassVarTests::test_repr (CPython 3.12 oracle)."""
...
assert repr(ClassVar) == 'typing.ClassVar'
cv = ClassVar[int]

assert repr(cv) == 'typing.ClassVar[int]'
cv = ClassVar[Employee]

assert repr(cv) == 'typing.ClassVar[%s.Employee]' % __name__
print("ClassVarTests::test_repr: ok")
