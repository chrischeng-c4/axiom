...
# lib = "typing"
# dimension = "behavior"
# case = "any_tests__test_subclassing_with_custom_constructor"
# subject = "cpython.test_typing.AnyTests.test_subclassing_with_custom_constructor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnyTests::test_subclassing_with_custom_constructor
"""Auto-ported test: AnyTests::test_subclassing_with_custom_constructor (CPython 3.12 oracle)."""
...
class Sub(Any):
    ...
    def __init__(self, *args, **kwargs):
        pass
Sub(0, s='')
print("AnyTests::test_subclassing_with_custom_constructor: ok")
