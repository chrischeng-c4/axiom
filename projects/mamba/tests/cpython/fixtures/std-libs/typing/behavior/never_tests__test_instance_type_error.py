...
# lib = "typing"
# dimension = "behavior"
# case = "never_tests__test_instance_type_error"
# subject = "cpython.test_typing.NeverTests.test_instance_type_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NeverTests::test_instance_type_error
"""Auto-ported test: NeverTests::test_instance_type_error (CPython 3.12 oracle)."""
...
def clear_caches():
    for f in typing._cleanups:
        f()
try:
    isinstance(42, bottom_type)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("NeverTests::test_instance_type_error: ok")
