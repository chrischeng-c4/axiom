...
# lib = "typing"
# dimension = "behavior"
# case = "collections_abc_tests__test_ordereddict_instantiation"
# subject = "cpython.test_typing.CollectionsAbcTests.test_ordereddict_instantiation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::CollectionsAbcTests::test_ordereddict_instantiation
"""Auto-ported test: CollectionsAbcTests::test_ordereddict_instantiation (CPython 3.12 oracle)."""
...
assert type(typing.OrderedDict()) is collections.OrderedDict

assert type(typing.OrderedDict[KT, VT]()) is collections.OrderedDict

assert type(typing.OrderedDict[str, int]()) is collections.OrderedDict
print("CollectionsAbcTests::test_ordereddict_instantiation: ok")
