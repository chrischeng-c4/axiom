...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_or"
# subject = "cpython.test_typing.ForwardRefTests.test_or"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_or
"""Auto-ported test: ForwardRefTests::test_or (CPython 3.12 oracle)."""
...
assert 'x' | X == Union['x', X]
print("ForwardRefTests::test_or: ok")
