...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tuple_tests__test_variadic_class_origin_is_correct"
# subject = "cpython.test_typing.TypeVarTupleTests.test_variadic_class_origin_is_correct"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTupleTests::test_variadic_class_origin_is_correct
"""Auto-ported test: TypeVarTupleTests::test_variadic_class_origin_is_correct (CPython 3.12 oracle)."""
...
assert C[int].__origin__ is C

assert C[T].__origin__ is C

assert C[Unpack[Ts]].__origin__ is C

class D(Generic[Unpack[Ts]]):
    pass

assert D[int].__origin__ is D

assert D[T].__origin__ is D

assert D[Unpack[Ts]].__origin__ is D
print("TypeVarTupleTests::test_variadic_class_origin_is_correct: ok")
