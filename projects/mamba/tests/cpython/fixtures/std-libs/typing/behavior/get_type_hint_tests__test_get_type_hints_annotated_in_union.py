...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_get_type_hints_annotated_in_union"
# subject = "cpython.test_typing.GetTypeHintTests.test_get_type_hints_annotated_in_union"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_get_type_hints_annotated_in_union
"""Auto-ported test: GetTypeHintTests::test_get_type_hints_annotated_in_union (CPython 3.12 oracle)."""
...
assert get_type_hints(with_union) == {'x': int | list[str]}

assert get_type_hints(with_union, include_extras=True) == {'x': int | list[Annotated[str, 'meta']]}
print("GetTypeHintTests::test_get_type_hints_annotated_in_union: ok")
