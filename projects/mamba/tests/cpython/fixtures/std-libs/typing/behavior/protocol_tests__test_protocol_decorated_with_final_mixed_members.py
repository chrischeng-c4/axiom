...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_protocol_decorated_with_final_mixed_members"
# subject = "cpython.test_typing.ProtocolTests.test_protocol_decorated_with_final_mixed_members"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_protocol_decorated_with_final_mixed_members
"""Auto-ported test: ProtocolTests::test_protocol_decorated_with_final_mixed_members (CPython 3.12 oracle)."""
...
assert isinstance(Foo(), ProtocolWithMixedMembers)

assert not isinstance(42, ProtocolWithMixedMembers)
print("ProtocolTests::test_protocol_decorated_with_final_mixed_members: ok")
