...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tests__test_repr"
# subject = "cpython.test_typing.TypeVarTests.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTests::test_repr
"""Auto-ported test: TypeVarTests::test_repr (CPython 3.12 oracle)."""
...
assert repr(AnyStr) == '~AnyStr'
T_co = TypeVar('T_co', covariant=True)

assert repr(T_co) == '+T_co'
T_contra = TypeVar('T_contra', contravariant=True)

assert repr(T_contra) == '-T_contra'
print("TypeVarTests::test_repr: ok")
