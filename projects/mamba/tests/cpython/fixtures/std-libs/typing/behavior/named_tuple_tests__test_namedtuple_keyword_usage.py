...
# lib = "typing"
# dimension = "behavior"
# case = "named_tuple_tests__test_namedtuple_keyword_usage"
# subject = "cpython.test_typing.NamedTupleTests.test_namedtuple_keyword_usage"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NamedTupleTests::test_namedtuple_keyword_usage
"""Auto-ported test: NamedTupleTests::test_namedtuple_keyword_usage (CPython 3.12 oracle)."""
...
assert isinstance(nick, tuple)

assert nick.name == 'Nick'

assert LocalEmployee.__name__ == 'LocalEmployee'

assert LocalEmployee._fields == ('name', 'age')

assert LocalEmployee.__annotations__ == dict(name=str, age=int)
try:
    NamedTuple('Name', [('x', int)], y=str)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("NamedTupleTests::test_namedtuple_keyword_usage: ok")
