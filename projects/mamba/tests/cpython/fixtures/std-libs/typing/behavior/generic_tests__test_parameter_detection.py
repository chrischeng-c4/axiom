...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_parameter_detection"
# subject = "cpython.test_typing.GenericTests.test_parameter_detection"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_parameter_detection
"""Auto-ported test: GenericTests::test_parameter_detection (CPython 3.12 oracle)."""
...
assert List[List[T]].__parameters__ == (T,)
...
assert List[A()].__parameters__ == (T,)

assert list[A()].__parameters__ == (T,)
print("GenericTests::test_parameter_detection: ok")
