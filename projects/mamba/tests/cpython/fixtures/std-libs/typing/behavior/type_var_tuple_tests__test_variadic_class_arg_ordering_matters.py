...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tuple_tests__test_variadic_class_arg_ordering_matters"
# subject = "cpython.test_typing.TypeVarTupleTests.test_variadic_class_arg_ordering_matters"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTupleTests::test_variadic_class_arg_ordering_matters
"""Auto-ported test: TypeVarTupleTests::test_variadic_class_arg_ordering_matters (CPython 3.12 oracle)."""
...
assert C[int, str] != C[str, int]

assert D[int, str] != D[str, int]
Ts1 = TypeVarTuple('Ts1')
Ts2 = TypeVarTuple('Ts2')

assert C[*Ts1, *Ts2] != C[*Ts2, *Ts1]

assert D[Unpack[Ts1], Unpack[Ts2]] != D[Unpack[Ts2], Unpack[Ts1]]
print("TypeVarTupleTests::test_variadic_class_arg_ordering_matters: ok")
