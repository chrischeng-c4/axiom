...
# lib = "typing"
# dimension = "behavior"
# case = "type_alias_tests__test_canonical_usage_with_type_comment"
# subject = "cpython.test_typing.TypeAliasTests.test_canonical_usage_with_type_comment"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeAliasTests::test_canonical_usage_with_type_comment
"""Auto-ported test: TypeAliasTests::test_canonical_usage_with_type_comment (CPython 3.12 oracle)."""
...
def clear_caches():
    for f in typing._cleanups:
        f()
Alias = Employee
print("TypeAliasTests::test_canonical_usage_with_type_comment: ok")
