...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_get_type_hints_annotated_with_none_default"
# subject = "cpython.test_typing.GetTypeHintTests.test_get_type_hints_annotated_with_none_default"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_get_type_hints_annotated_with_none_default
"""Auto-ported test: GetTypeHintTests::test_get_type_hints_annotated_with_none_default (CPython 3.12 oracle)."""
...
assert get_type_hints(annotated_with_none_default) == {'x': int}

assert get_type_hints(annotated_with_none_default, include_extras=True) == {'x': Annotated[int, 'data']}
print("GetTypeHintTests::test_get_type_hints_annotated_with_none_default: ok")
