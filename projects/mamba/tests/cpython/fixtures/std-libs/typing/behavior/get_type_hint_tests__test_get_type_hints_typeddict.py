...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_get_type_hints_typeddict"
# subject = "cpython.test_typing.GetTypeHintTests.test_get_type_hints_typeddict"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_get_type_hints_typeddict
"""Auto-ported test: GetTypeHintTests::test_get_type_hints_typeddict (CPython 3.12 oracle)."""
...
assert get_type_hints(TotalMovie, include_extras=True) == {'title': str, 'year': NotRequired[int]}

assert get_type_hints(AnnotatedMovie) == {'title': str, 'year': int}

assert get_type_hints(AnnotatedMovie, include_extras=True) == {'title': Annotated[Required[str], 'foobar'], 'year': NotRequired[Annotated[int, 2000]]}

assert get_type_hints(DeeplyAnnotatedMovie) == {'title': str, 'year': int}

assert get_type_hints(DeeplyAnnotatedMovie, include_extras=True) == {'title': Annotated[Required[str], 'foobar', 'another level'], 'year': NotRequired[Annotated[int, 2000]]}

assert get_type_hints(WeirdlyQuotedMovie) == {'title': str, 'year': int}

assert get_type_hints(WeirdlyQuotedMovie, include_extras=True) == {'title': Annotated[Required[str], 'foobar', 'another level'], 'year': NotRequired[Annotated[int, 2000]]}

assert get_type_hints(_typed_dict_helper.VeryAnnotated) == {'a': int}

assert get_type_hints(_typed_dict_helper.VeryAnnotated, include_extras=True) == {'a': Annotated[Required[int], 'a', 'b', 'c']}

assert get_type_hints(ChildTotalMovie) == {'title': str, 'year': int}

assert get_type_hints(ChildTotalMovie, include_extras=True) == {'title': Required[str], 'year': NotRequired[int]}

assert get_type_hints(ChildDeeplyAnnotatedMovie) == {'title': str, 'year': int}

assert get_type_hints(ChildDeeplyAnnotatedMovie, include_extras=True) == {'title': Annotated[Required[str], 'foobar', 'another level'], 'year': NotRequired[Annotated[int, 2000]]}
print("GetTypeHintTests::test_get_type_hints_typeddict: ok")
