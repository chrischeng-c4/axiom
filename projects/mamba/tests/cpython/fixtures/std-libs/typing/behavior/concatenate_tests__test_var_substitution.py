...
# lib = "typing"
# dimension = "behavior"
# case = "concatenate_tests__test_var_substitution"
# subject = "cpython.test_typing.ConcatenateTests.test_var_substitution"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ConcatenateTests::test_var_substitution
"""Auto-ported test: ConcatenateTests::test_var_substitution (CPython 3.12 oracle)."""
...
assert C[int, P2] == Concatenate[int, P2]

assert C[int, [str, float]] == (int, str, float)

assert C[int, []] == (int,)

assert C[int, Concatenate[str, P2]] == Concatenate[int, str, P2]

assert C[int, ...] == Concatenate[int, ...]
C = Concatenate[int, P]

assert C[P2] == Concatenate[int, P2]

assert C[[str, float]] == (int, str, float)

assert C[str, float] == (int, str, float)

assert C[[]] == (int,)

assert C[Concatenate[str, P2]] == Concatenate[int, str, P2]

assert C[...] == Concatenate[int, ...]
print("ConcatenateTests::test_var_substitution: ok")
