...
# lib = "typing"
# dimension = "behavior"
# case = "unpack_tests__test_builtin_tuple"
# subject = "cpython.test_typing.UnpackTests.test_builtin_tuple"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnpackTests::test_builtin_tuple
"""Auto-ported test: UnpackTests::test_builtin_tuple (CPython 3.12 oracle)."""
...
assert PartOld[str].__args__ == (int, str)

assert PartOld[*tuple[str],].__args__ == (int, str)

assert PartOld[*Tuple[str],].__args__ == (int, str)

assert PartOld[Unpack[tuple[str]]].__args__ == (int, str)

assert PartOld[Unpack[Tuple[str]]].__args__ == (int, str)
PartNew = New[int, *Ts]

assert PartNew[str].__args__ == (int, str)

assert PartNew[*tuple[str],].__args__ == (int, str)

assert PartNew[*Tuple[str],].__args__ == (int, str)

assert PartNew[Unpack[tuple[str]]].__args__ == (int, str)

assert PartNew[Unpack[Tuple[str]]].__args__ == (int, str)
print("UnpackTests::test_builtin_tuple: ok")
