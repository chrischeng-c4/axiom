...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_get_type_hints_annotated_bad_module"
# subject = "cpython.test_typing.GetTypeHintTests.test_get_type_hints_annotated_bad_module"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_get_type_hints_annotated_bad_module
"""Auto-ported test: GetTypeHintTests::test_get_type_hints_annotated_bad_module (CPython 3.12 oracle)."""
...
assert get_type_hints(BadType) == {'foo': tuple, 'bar': list}
print("GetTypeHintTests::test_get_type_hints_annotated_bad_module: ok")
