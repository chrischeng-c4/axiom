...
# lib = "typing"
# dimension = "behavior"
# case = "type_guard_tests__test_basics"
# subject = "cpython.test_typing.TypeGuardTests.test_basics"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeGuardTests::test_basics
"""Auto-ported test: TypeGuardTests::test_basics (CPython 3.12 oracle)."""
...
assert gth(foo) == {'return': TypeGuard[int]}
try:
    TypeGuard[int, str]
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("TypeGuardTests::test_basics: ok")
