...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_chain_repr"
# subject = "cpython.test_typing.GenericTests.test_chain_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_chain_repr
"""Auto-ported test: GenericTests::test_chain_repr (CPython 3.12 oracle)."""
...
assert str(Z).endswith('.C[typing.Tuple[str, int]]')
print("GenericTests::test_chain_repr: ok")
