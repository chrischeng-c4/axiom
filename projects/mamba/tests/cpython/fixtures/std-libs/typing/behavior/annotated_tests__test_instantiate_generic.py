...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_instantiate_generic"
# subject = "cpython.test_typing.AnnotatedTests.test_instantiate_generic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_instantiate_generic
"""Auto-ported test: AnnotatedTests::test_instantiate_generic (CPython 3.12 oracle)."""
...
assert MyCount([4, 4, 5]) == {4: 2, 5: 1}

assert MyCount[int]([4, 4, 5]) == {4: 2, 5: 1}
print("AnnotatedTests::test_instantiate_generic: ok")
