...
# lib = "typing"
# dimension = "behavior"
# case = "generic_alias_substitution_tests__test_three_parameters"
# subject = "cpython.test_typing.GenericAliasSubstitutionTests.test_three_parameters"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericAliasSubstitutionTests::test_three_parameters
"""Auto-ported test: GenericAliasSubstitutionTests::test_three_parameters (CPython 3.12 oracle)."""
...
tests = [('generic[T1, bool, T2]', '[int, str]', 'generic[int, bool, str]'), ('generic[T1, bool, T2]', '[*tuple_type[int, str]]', 'generic[int, bool, str]')]
...
print("GenericAliasSubstitutionTests::test_three_parameters: ok")
