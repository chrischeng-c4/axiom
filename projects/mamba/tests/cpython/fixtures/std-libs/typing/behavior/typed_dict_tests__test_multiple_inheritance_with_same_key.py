...
# lib = "typing"
# dimension = "behavior"
# case = "typed_dict_tests__test_multiple_inheritance_with_same_key"
# subject = "cpython.test_typing.TypedDictTests.test_multiple_inheritance_with_same_key"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypedDictTests::test_multiple_inheritance_with_same_key
"""Auto-ported test: TypedDictTests::test_multiple_inheritance_with_same_key (CPython 3.12 oracle)."""
...
assert Child.__annotations__ == {'a': Required[str]}

assert Child.__required_keys__ == frozenset(['a'])

assert Child.__optional_keys__ == frozenset()
print("TypedDictTests::test_multiple_inheritance_with_same_key: ok")
