...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_pep_695_generics_with_future_annotations_nested_in_function"
# subject = "cpython.test_typing.GenericTests.test_pep_695_generics_with_future_annotations_nested_in_function"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_pep_695_generics_with_future_annotations_nested_in_function
"""Auto-ported test: GenericTests::test_pep_695_generics_with_future_annotations_nested_in_function (CPython 3.12 oracle)."""
...
assert set(results.hints_for_E.values()) == set(results.E.__type_params__)

assert set(results.hints_for_E_meth.values()) == set(results.E.generic_method.__type_params__)

assert set(results.hints_for_E_meth.values()) != set(results.E.__type_params__)

assert set(results.hints_for_E_meth.values()).intersection(results.E.__type_params__) == set()

assert set(results.hints_for_generic_func.values()) == set(results.generic_func.__type_params__)
print("GenericTests::test_pep_695_generics_with_future_annotations_nested_in_function: ok")
