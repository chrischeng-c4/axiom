...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_no_type_check_nested_types"
# subject = "cpython.test_typing.ForwardRefTests.test_no_type_check_nested_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_no_type_check_nested_types
"""Auto-ported test: ForwardRefTests::test_no_type_check_nested_types (CPython 3.12 oracle)."""
...
for klass in [A, A.B, A.B.C, A.D]:
    ...
    assert klass.__no_type_check__

    assert get_type_hints(klass) == {}
for not_modified in [Other, B]:
    ...
    assert get_type_hints(not_modified) != {}
print("ForwardRefTests::test_no_type_check_nested_types: ok")
