...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_special_forms_forward"
# subject = "cpython.test_typing.ForwardRefTests.test_special_forms_forward"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_special_forms_forward
"""Auto-ported test: ForwardRefTests::test_special_forms_forward (CPython 3.12 oracle)."""
...
assert get_type_hints(C, globals())['a'] == ClassVar[int]

assert get_type_hints(C, globals())['b'] == Final[int]

assert get_type_hints(C, globals())['x'] == ClassVar

assert get_type_hints(C, globals())['y'] == Final
try:
    (get_type_hints(CF, globals()),)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("ForwardRefTests::test_special_forms_forward: ok")
