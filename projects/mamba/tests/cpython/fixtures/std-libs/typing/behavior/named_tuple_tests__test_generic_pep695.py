...
# lib = "typing"
# dimension = "behavior"
# case = "named_tuple_tests__test_generic_pep695"
# subject = "cpython.test_typing.NamedTupleTests.test_generic_pep695"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NamedTupleTests::test_generic_pep695
"""Auto-ported test: NamedTupleTests::test_generic_pep695 (CPython 3.12 oracle)."""
...
assert X.__parameters__ == (T,)

assert X[str].__args__ == (str,)

assert X[str].__parameters__ == ()
print("NamedTupleTests::test_generic_pep695: ok")
