...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_protocol_decorated_with_final_noncallable_members"
# subject = "cpython.test_typing.ProtocolTests.test_protocol_decorated_with_final_noncallable_members"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_protocol_decorated_with_final_noncallable_members
"""Auto-ported test: ProtocolTests::test_protocol_decorated_with_final_noncallable_members (CPython 3.12 oracle)."""
...
class Foo:
    x = 42
only_callable_members_please = "Protocols with non-method members don't support issubclass()"
try:
    issubclass(Foo, ProtocolWithNonCallableMember)
    raise AssertionError('expected TypeError')
except TypeError as _aR_e:
    import re as _re_aR
    assert _re_aR.search(only_callable_members_please, str(_aR_e))
try:
...
assert isinstance(Foo(), ProtocolWithNonCallableMember)

assert not isinstance(42, ProtocolWithNonCallableMember)
print("ProtocolTests::test_protocol_decorated_with_final_noncallable_members: ok")
