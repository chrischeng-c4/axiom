...
# lib = "typing"
# dimension = "behavior"
# case = "union_tests__test_function_repr_union"
# subject = "cpython.test_typing.UnionTests.test_function_repr_union"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnionTests::test_function_repr_union
"""Auto-ported test: UnionTests::test_function_repr_union (CPython 3.12 oracle)."""
...
assert repr(Union[fun, int]) == 'typing.Union[fun, int]'
print("UnionTests::test_function_repr_union: ok")
