...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_repr"
# subject = "cpython.test_typing.GenericTests.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_repr
"""Auto-ported test: GenericTests::test_repr (CPython 3.12 oracle)."""
...
assert repr(SimpleMapping) == f"<class '{__name__}.SimpleMapping'>"

assert repr(MySimpleMapping) == f"<class '{__name__}.MySimpleMapping'>"
print("GenericTests::test_repr: ok")
