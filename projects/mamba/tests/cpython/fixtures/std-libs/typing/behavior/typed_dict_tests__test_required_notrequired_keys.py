...
# lib = "typing"
# dimension = "behavior"
# case = "typed_dict_tests__test_required_notrequired_keys"
# subject = "cpython.test_typing.TypedDictTests.test_required_notrequired_keys"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypedDictTests::test_required_notrequired_keys
"""Auto-ported test: TypedDictTests::test_required_notrequired_keys (CPython 3.12 oracle)."""
...
assert _typed_dict_helper.VeryAnnotated.__required_keys__ == frozenset()

assert _typed_dict_helper.VeryAnnotated.__optional_keys__ == frozenset({'a'})

assert AnnotatedMovie.__required_keys__ == frozenset({'title'})

assert AnnotatedMovie.__optional_keys__ == frozenset({'year'})

assert WeirdlyQuotedMovie.__required_keys__ == frozenset({'title'})

assert WeirdlyQuotedMovie.__optional_keys__ == frozenset({'year'})

assert ChildTotalMovie.__required_keys__ == frozenset({'title'})

assert ChildTotalMovie.__optional_keys__ == frozenset({'year'})

assert ChildDeeplyAnnotatedMovie.__required_keys__ == frozenset({'title'})

assert ChildDeeplyAnnotatedMovie.__optional_keys__ == frozenset({'year'})
print("TypedDictTests::test_required_notrequired_keys: ok")
