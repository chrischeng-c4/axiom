...
# lib = "typing"
# dimension = "behavior"
# case = "any_tests__test_can_subclass"
# subject = "cpython.test_typing.AnyTests.test_can_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnyTests::test_can_subclass
"""Auto-ported test: AnyTests::test_can_subclass (CPython 3.12 oracle)."""
...
assert not issubclass(Something, Any)

assert not isinstance(Something(), Mock)

class MockSomething(Something, Mock):
    pass

assert issubclass(MockSomething, Any)

assert issubclass(MockSomething, MockSomething)

assert issubclass(MockSomething, Something)

assert issubclass(MockSomething, Mock)
ms = MockSomething()

assert isinstance(ms, MockSomething)

assert isinstance(ms, Something)

assert isinstance(ms, Mock)
print("AnyTests::test_can_subclass: ok")
