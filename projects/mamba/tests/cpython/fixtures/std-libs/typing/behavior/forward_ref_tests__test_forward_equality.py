...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_forward_equality"
# subject = "cpython.test_typing.ForwardRefTests.test_forward_equality"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_forward_equality
"""Auto-ported test: ForwardRefTests::test_forward_equality (CPython 3.12 oracle)."""
...
assert fr == typing.ForwardRef('int')

assert List['int'] != List[int]

assert fr != typing.ForwardRef('int', module=__name__)
frm = typing.ForwardRef('int', module=__name__)

assert frm == typing.ForwardRef('int', module=__name__)

assert frm != typing.ForwardRef('int', module='__other_name__')
print("ForwardRefTests::test_forward_equality: ok")
