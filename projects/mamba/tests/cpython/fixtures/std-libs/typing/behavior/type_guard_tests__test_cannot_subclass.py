...
# lib = "typing"
# dimension = "behavior"
# case = "type_guard_tests__test_cannot_subclass"
# subject = "cpython.test_typing.TypeGuardTests.test_cannot_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeGuardTests::test_cannot_subclass
"""Auto-ported test: TypeGuardTests::test_cannot_subclass (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.TypeGuard', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.TypeGuard\\[int\\]', str(_aR_e))
print("TypeGuardTests::test_cannot_subclass: ok")
