...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tests__test_var_substitution"
# subject = "cpython.test_typing.TypeVarTests.test_var_substitution"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTests::test_var_substitution
"""Auto-ported test: TypeVarTests::test_var_substitution (CPython 3.12 oracle)."""
...
assert subst(int) is int

assert subst(list[int]) == list[int]

assert subst(List[int]) == List[int]

assert subst(List) == List

assert subst(Any) is Any

assert subst(None) is type(None)

assert subst(T) is T

assert subst(int | str) == int | str

assert subst(Union[int, str]) == Union[int, str]
print("TypeVarTests::test_var_substitution: ok")
