...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_top_level_class_var"
# subject = "cpython.test_typing.GetTypeHintTests.test_top_level_class_var"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_top_level_class_var
"""Auto-ported test: GetTypeHintTests::test_top_level_class_var (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('typing.ClassVar\\[int\\] is not valid as type argument', str(_aR_e))
print("GetTypeHintTests::test_top_level_class_var: ok")
