...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_new_repr_complex"
# subject = "cpython.test_typing.GenericTests.test_new_repr_complex"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_new_repr_complex
"""Auto-ported test: GenericTests::test_new_repr_complex (CPython 3.12 oracle)."""
...
assert repr(typing.Mapping[T, TS][TS, T]) == 'typing.Mapping[~TS, ~T]'

assert repr(List[Tuple[T, TS]][int, T]) == 'typing.List[typing.Tuple[int, ~T]]'

assert repr(List[Tuple[T, T]][List[int]]) == 'typing.List[typing.Tuple[typing.List[int], typing.List[int]]]'
print("GenericTests::test_new_repr_complex: ok")
