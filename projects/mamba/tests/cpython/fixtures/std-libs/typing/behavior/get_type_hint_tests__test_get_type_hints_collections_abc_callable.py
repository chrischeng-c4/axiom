...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_get_type_hints_collections_abc_callable"
# subject = "cpython.test_typing.GetTypeHintTests.test_get_type_hints_collections_abc_callable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_get_type_hints_collections_abc_callable
"""Auto-ported test: GetTypeHintTests::test_get_type_hints_collections_abc_callable (CPython 3.12 oracle)."""
...
assert get_type_hints(f) == {'x': collections.abc.Callable[[int], int]}

assert get_type_hints(g) == {'x': collections.abc.Callable[..., int]}

assert get_type_hints(h) == {'x': collections.abc.Callable[P, int]}
print("GetTypeHintTests::test_get_type_hints_collections_abc_callable: ok")
