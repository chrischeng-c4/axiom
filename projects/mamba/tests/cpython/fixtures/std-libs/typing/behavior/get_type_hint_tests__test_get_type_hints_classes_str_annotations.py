...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_get_type_hints_classes_str_annotations"
# subject = "cpython.test_typing.GetTypeHintTests.test_get_type_hints_classes_str_annotations"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_get_type_hints_classes_str_annotations
"""Auto-ported test: GetTypeHintTests::test_get_type_hints_classes_str_annotations (CPython 3.12 oracle)."""
...
assert get_type_hints(Foo) == {'x': str}
print("GetTypeHintTests::test_get_type_hints_classes_str_annotations: ok")
