...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_bundled_protocol_instance_works"
# subject = "cpython.test_typing.ProtocolTests.test_bundled_protocol_instance_works"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_bundled_protocol_instance_works
"""Auto-ported test: ProtocolTests::test_bundled_protocol_instance_works (CPython 3.12 oracle)."""
...
assert isinstance(0, typing.SupportsAbs)
...
print("ProtocolTests::test_bundled_protocol_instance_works: ok")
