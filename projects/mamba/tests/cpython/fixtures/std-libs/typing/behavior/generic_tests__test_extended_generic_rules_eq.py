...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_extended_generic_rules_eq"
# subject = "cpython.test_typing.GenericTests.test_extended_generic_rules_eq"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_extended_generic_rules_eq
"""Auto-ported test: GenericTests::test_extended_generic_rules_eq (CPython 3.12 oracle)."""
...
assert Tuple[T, T][int] == Tuple[int, int]

assert typing.Iterable[Tuple[T, T]][T] == typing.Iterable[Tuple[T, T]]
try:
    Tuple[T, int][()]
...
assert Union[T, int][int] == int

assert Union[T, U][int, Union[int, str]] == Union[int, str]
...
assert Union[T, Base][Union[Base, Derived]] == Union[Base, Derived]

assert Callable[[T], T][KT] == Callable[[KT], KT]

assert Callable[..., List[T]][int] == Callable[..., List[int]]
print("GenericTests::test_extended_generic_rules_eq: ok")
