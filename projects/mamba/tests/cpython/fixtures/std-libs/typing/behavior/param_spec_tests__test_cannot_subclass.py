...
# lib = "typing"
# dimension = "behavior"
# case = "param_spec_tests__test_cannot_subclass"
# subject = "cpython.test_typing.ParamSpecTests.test_cannot_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ParamSpecTests::test_cannot_subclass
"""Auto-ported test: ParamSpecTests::test_cannot_subclass (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(NOT_A_BASE_TYPE % 'ParamSpec', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search(NOT_A_BASE_TYPE % 'ParamSpecArgs', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search(NOT_A_BASE_TYPE % 'ParamSpecKwargs', str(_aR_e))
P = ParamSpec('P')
try:
    ...
    import re as _re_aR
    assert _re_aR.search(CANNOT_SUBCLASS_INSTANCE % 'ParamSpec', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search(CANNOT_SUBCLASS_INSTANCE % 'ParamSpecArgs', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search(CANNOT_SUBCLASS_INSTANCE % 'ParamSpecKwargs', str(_aR_e))
print("ParamSpecTests::test_cannot_subclass: ok")
