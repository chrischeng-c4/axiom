...
# lib = "typing"
# dimension = "behavior"
# case = "re_tests__test_re_submodule"
# subject = "cpython.test_typing.RETests.test_re_submodule"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::RETests::test_re_submodule
"""Auto-ported test: RETests::test_re_submodule (CPython 3.12 oracle)."""
...
with warnings.catch_warnings(record=True) as w:
    ...
    assert len(w) == 1
print("RETests::test_re_submodule: ok")
