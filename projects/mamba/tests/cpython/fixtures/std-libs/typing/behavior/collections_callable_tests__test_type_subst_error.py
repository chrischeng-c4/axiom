...
# lib = "typing"
# dimension = "behavior"
# case = "collections_callable_tests__test_type_subst_error"
# subject = "cpython.test_typing.CollectionsCallableTests.test_type_subst_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::CollectionsCallableTests::test_type_subst_error
"""Auto-ported test: CollectionsCallableTests::test_type_subst_error (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(pat, str(_aR_e))
print("CollectionsCallableTests::test_type_subst_error: ok")
