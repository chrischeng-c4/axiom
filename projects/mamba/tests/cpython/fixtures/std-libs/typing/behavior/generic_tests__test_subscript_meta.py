...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_subscript_meta"
# subject = "cpython.test_typing.GenericTests.test_subscript_meta"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_subscript_meta
"""Auto-ported test: GenericTests::test_subscript_meta (CPython 3.12 oracle)."""
...
assert Type[Meta] == Type[Meta]

assert Union[T, int][Meta] == Union[Meta, int]

assert Callable[..., Meta].__args__ == (Ellipsis, Meta)
print("GenericTests::test_subscript_meta: ok")
