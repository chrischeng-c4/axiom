...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_deduplicate_from_union"
# subject = "cpython.test_typing.AnnotatedTests.test_deduplicate_from_union"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_deduplicate_from_union
"""Auto-ported test: AnnotatedTests::test_deduplicate_from_union (CPython 3.12 oracle)."""
...
assert get_args(Annotated[int, 1] | int) == (Annotated[int, 1], int)

assert get_args(Union[Annotated[int, 1], int]) == (Annotated[int, 1], int)

assert get_args(Annotated[int, 1] | Annotated[int, 2] | int) == (Annotated[int, 1], Annotated[int, 2], int)

assert get_args(Union[Annotated[int, 1], Annotated[int, 2], int]) == (Annotated[int, 1], Annotated[int, 2], int)

assert get_args(Annotated[int, 1] | Annotated[str, 1] | int) == (Annotated[int, 1], Annotated[str, 1], int)

assert get_args(Union[Annotated[int, 1], Annotated[str, 1], int]) == (Annotated[int, 1], Annotated[str, 1], int)

assert Annotated[int, 1] | Annotated[int, 1] | int == Annotated[int, 1] | int

assert Union[Annotated[int, 1], Annotated[int, 1], int] == Union[Annotated[int, 1], int]

assert get_args(str | Annotated[int, {}] | Annotated[int, set()] | int) == (str, Annotated[int, {}], Annotated[int, set()], int)

assert get_args(Union[str, Annotated[int, {}], Annotated[int, set()], int]) == (str, Annotated[int, {}], Annotated[int, set()], int)

assert get_args(str | Annotated[int, {}] | Annotated[str, {}] | int) == (str, Annotated[int, {}], Annotated[str, {}], int)

assert get_args(Union[str, Annotated[int, {}], Annotated[str, {}], int]) == (str, Annotated[int, {}], Annotated[str, {}], int)

assert get_args(Annotated[int, 1] | str | Annotated[str, {}] | int) == (Annotated[int, 1], str, Annotated[str, {}], int)

assert get_args(Union[Annotated[int, 1], str, Annotated[str, {}], int]) == (Annotated[int, 1], str, Annotated[str, {}], int)
import dataclasses
...
assert get_args(Annotated[int, v] | None) == (Annotated[int, v], types.NoneType)

assert get_args(Union[Annotated[int, v], None]) == (Annotated[int, v], types.NoneType)

assert get_args(Optional[Annotated[int, v]]) == (Annotated[int, v], types.NoneType)

assert Annotated[int, {}] | Annotated[int, {}] | int == Annotated[int, {}] | int

assert Annotated[int, {}] | Annotated[int, {}] | int == int | Annotated[int, {}]

assert Union[Annotated[int, {}], Annotated[int, {}], int] == Union[Annotated[int, {}], int]

assert Union[Annotated[int, {}], Annotated[int, {}], int] == Union[int, Annotated[int, {}]]
print("AnnotatedTests::test_deduplicate_from_union: ok")
