...
# lib = "typing"
# dimension = "behavior"
# case = "literal_tests__test_does_not_flatten_enum"
# subject = "cpython.test_typing.LiteralTests.test_does_not_flatten_enum"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::LiteralTests::test_does_not_flatten_enum
"""Auto-ported test: LiteralTests::test_does_not_flatten_enum (CPython 3.12 oracle)."""
...
class Ints(enum.IntEnum):
    A = 1
    B = 2
l = Literal[Literal[Ints.A], Literal[Ints.B], Literal[1], Literal[2]]

assert l.__args__ == (Ints.A, Ints.B, 1, 2)
print("LiteralTests::test_does_not_flatten_enum: ok")
