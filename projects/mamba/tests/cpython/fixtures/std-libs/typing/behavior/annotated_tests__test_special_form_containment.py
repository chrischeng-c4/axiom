...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_special_form_containment"
# subject = "cpython.test_typing.AnnotatedTests.test_special_form_containment"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_special_form_containment
"""Auto-ported test: AnnotatedTests::test_special_form_containment (CPython 3.12 oracle)."""
...
assert get_type_hints(C, globals())['classvar'] == ClassVar[int]

assert get_type_hints(C, globals())['const'] == Final[int]
print("AnnotatedTests::test_special_form_containment: ok")
