...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_no_type_check_foreign_functions"
# subject = "cpython.test_typing.ForwardRefTests.test_no_type_check_foreign_functions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_no_type_check_foreign_functions
"""Auto-ported test: ForwardRefTests::test_no_type_check_foreign_functions (CPython 3.12 oracle)."""
...
assert get_type_hints(some) == {'args': int, 'return': int}
print("ForwardRefTests::test_no_type_check_foreign_functions: ok")
