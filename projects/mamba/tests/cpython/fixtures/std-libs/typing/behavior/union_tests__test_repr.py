...
# lib = "typing"
# dimension = "behavior"
# case = "union_tests__test_repr"
# subject = "cpython.test_typing.UnionTests.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnionTests::test_repr
"""Auto-ported test: UnionTests::test_repr (CPython 3.12 oracle)."""
...
assert repr(Union) == 'typing.Union'
u = Union[Employee, int]

assert repr(u) == 'typing.Union[%s.Employee, int]' % __name__
u = Union[int, Employee]

assert repr(u) == 'typing.Union[int, %s.Employee]' % __name__
T = TypeVar('T')
u = Union[T, int][int]

assert repr(u) == repr(int)
u = Union[List[int], int]

assert repr(u) == 'typing.Union[typing.List[int], int]'
u = Union[list[int], dict[str, float]]

assert repr(u) == 'typing.Union[list[int], dict[str, float]]'
u = Union[int | float]

assert repr(u) == 'typing.Union[int, float]'
u = Union[None, str]

assert repr(u) == 'typing.Optional[str]'
u = Union[str, None]

assert repr(u) == 'typing.Optional[str]'
u = Union[None, str, int]

assert repr(u) == 'typing.Union[NoneType, str, int]'
u = Optional[str]

assert repr(u) == 'typing.Optional[str]'
print("UnionTests::test_repr: ok")
