...
# lib = "type_aliases"
# dimension = "behavior"
# case = "type_alias_constructor_test__test_generic"
# subject = "cpython.test_type_aliases.TypeAliasConstructorTest.test_generic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_aliases.py::TypeAliasConstructorTest::test_generic
"""Auto-ported test: TypeAliasConstructorTest::test_generic (CPython 3.12 oracle)."""
...
assert TA.__value__ == list[T]

assert TA.__type_params__ == (T,)

assert TA.__module__ == __name__

assert type(TA[int]) is types.GenericAlias
print("TypeAliasConstructorTest::test_generic: ok")
