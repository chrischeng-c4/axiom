...
# lib = "type_aliases"
# dimension = "behavior"
# case = "type_params_alias_value_test__test_alias_value_03"
# subject = "cpython.test_type_aliases.TypeParamsAliasValueTest.test_alias_value_03"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_aliases.py::TypeParamsAliasValueTest::test_alias_value_03
"""Auto-ported test: TypeParamsAliasValueTest::test_alias_value_03 (CPython 3.12 oracle)."""
...
assert isinstance(o, TypeAliasType)

assert len(o.__parameters__) == 1

assert len(outer.__type_params__) == 1
b = o.__parameters__[0]

assert o.__type_params__ == (b,)
print("TypeParamsAliasValueTest::test_alias_value_03: ok")
