...
# lib = "sys"
# dimension = "behavior"
# case = "sys_module_test__test_current_exceptions"
# subject = "cpython.test_sys.SysModuleTest.test_current_exceptions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys.py::SysModuleTest::test_current_exceptions
"""Auto-ported test: SysModuleTest::test_current_exceptions (CPython 3.12 oracle)."""
...
try:
    ...
    assert sourceline.startswith('if leave_g.wait(')
finally:
    leave_g.set()
    t.join()
print("SysModuleTest::test_current_exceptions: ok")
