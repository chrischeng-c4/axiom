...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_logical_or"
# subject = "cpython.test_decimal.PyContextAPItests.test_logical_or"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_logical_or
"""Auto-ported test: PyContextAPItests::test_logical_or (CPython 3.12 oracle)."""
...
assert c.logical_or(1, 1) == d

assert c.logical_or(Decimal(1), 1) == d

assert c.logical_or(1, Decimal(1)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_logical_or: ok")
