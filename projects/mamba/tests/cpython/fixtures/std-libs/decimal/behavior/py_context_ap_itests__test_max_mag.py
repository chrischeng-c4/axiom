...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_max_mag"
# subject = "cpython.test_decimal.PyContextAPItests.test_max_mag"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_max_mag
"""Auto-ported test: PyContextAPItests::test_max_mag (CPython 3.12 oracle)."""
...
assert c.max_mag(1, 2) == d

assert c.max_mag(Decimal(1), 2) == d

assert c.max_mag(1, Decimal(2)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_max_mag: ok")
