...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_input_validation__test_invalid_context"
# subject = "cpython.test_decimal.PyContextInputValidation.test_invalid_context"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextInputValidation::test_invalid_context
"""Auto-ported test: PyContextInputValidation::test_invalid_context (CPython 3.12 oracle)."""
...
DefaultContext = decimal.DefaultContext
c = DefaultContext.copy()
for attr in ['prec', 'Emax']:
    setattr(c, attr, 999999)

    assert getattr(c, attr) == 999999
...
try:
    setattr(c, 'Emin', (1, 2, 3))
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    setattr(c, 'rounding', -1)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    setattr(c, 'rounding', 9)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    setattr(c, 'rounding', 1.0)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    setattr(c, 'rounding', 'xyz')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
try:
    setattr(c, 'traps', {'InvalidOperation': 0})
    raise AssertionError('expected KeyError')
except KeyError:
    pass
...
try:
    Context(rounding=999999)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    Context(rounding='xyz')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
try:
    ...
    pass
print("PyContextInputValidation::test_invalid_context: ok")
