...
# lib = "decimal"
# dimension = "behavior"
# case = "c_context_ap_itests__test_scaleb"
# subject = "cpython.test_decimal.CContextAPItests.test_scaleb"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CContextAPItests::test_scaleb
"""Auto-ported test: CContextAPItests::test_scaleb (CPython 3.12 oracle)."""
...
assert c.scaleb(1, 2) == d

assert c.scaleb(Decimal(1), 2) == d

assert c.scaleb(1, Decimal(2)) == d
...
try:
    ...
    pass
print("CContextAPItests::test_scaleb: ok")
