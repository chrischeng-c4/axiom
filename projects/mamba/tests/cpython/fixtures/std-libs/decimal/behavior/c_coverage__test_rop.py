...
# lib = "decimal"
# dimension = "behavior"
# case = "c_coverage__test_rop"
# subject = "cpython.test_decimal.CCoverage.test_rop"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CCoverage::test_rop
"""Auto-ported test: CCoverage::test_rop (CPython 3.12 oracle)."""
...
for attr in ('__radd__', '__rsub__', '__rmul__', '__rtruediv__', '__rdivmod__', '__rmod__', '__rfloordiv__', '__rpow__'):
    ...
    assert getattr(Decimal('1'), attr)('xyz') is NotImplemented
print("CCoverage::test_rop: ok")
