...
# lib = "decimal"
# dimension = "behavior"
# case = "py_format_test__test_negative_zero_bad_format"
# subject = "cpython.test_decimal.PyFormatTest.test_negative_zero_bad_format"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyFormatTest::test_negative_zero_bad_format
"""Auto-ported test: PyFormatTest::test_negative_zero_bad_format (CPython 3.12 oracle)."""
...
try:
    format(decimal.Decimal('1.23'), 'fz')
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("PyFormatTest::test_negative_zero_bad_format: ok")
