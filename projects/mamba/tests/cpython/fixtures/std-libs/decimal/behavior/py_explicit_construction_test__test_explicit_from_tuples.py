...
# lib = "decimal"
# dimension = "behavior"
# case = "py_explicit_construction_test__test_explicit_from_tuples"
# subject = "cpython.test_decimal.PyExplicitConstructionTest.test_explicit_from_tuples"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyExplicitConstructionTest::test_explicit_from_tuples
"""Auto-ported test: PyExplicitConstructionTest::test_explicit_from_tuples (CPython 3.12 oracle)."""
...
try:
    Decimal((8, (4, 3, 4, 9, 1), 2))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    Decimal((0.0, (4, 3, 4, 9, 1), 2))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    Decimal((Decimal(1), (4, 3, 4, 9, 1), 2))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    Decimal((1, (4, 3, 4, 9, 1), 'wrong!'))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    Decimal((1, (4, 3, 4, 9, 1), 0.0))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    Decimal((1, (4, 3, 4, 9, 1), '1'))
    raise AssertionError('expected ValueError')
except ValueError:
    pass
...
try:
    Decimal((1, (4, 3, 4, None, 1), 2))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    Decimal((1, (4, -3, 4, 9, 1), 2))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    Decimal((1, (4, 10, 4, 9, 1), 2))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    Decimal((1, (4, 3, 4, 'a', 1), 2))
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("PyExplicitConstructionTest::test_explicit_from_tuples: ok")
