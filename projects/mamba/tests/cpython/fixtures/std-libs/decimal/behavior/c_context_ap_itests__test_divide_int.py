...
# lib = "decimal"
# dimension = "behavior"
# case = "c_context_ap_itests__test_divide_int"
# subject = "cpython.test_decimal.CContextAPItests.test_divide_int"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CContextAPItests::test_divide_int
"""Auto-ported test: CContextAPItests::test_divide_int (CPython 3.12 oracle)."""
...
assert c.divide_int(1, 2) == d

assert c.divide_int(Decimal(1), 2) == d

assert c.divide_int(1, Decimal(2)) == d
...
try:
    ...
    pass
print("CContextAPItests::test_divide_int: ok")
