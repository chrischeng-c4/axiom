...
# lib = "decimal"
# dimension = "behavior"
# case = "c_context_ap_itests__test_compare_signal"
# subject = "cpython.test_decimal.CContextAPItests.test_compare_signal"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CContextAPItests::test_compare_signal
"""Auto-ported test: CContextAPItests::test_compare_signal (CPython 3.12 oracle)."""
...
assert c.compare_signal(1, 1) == d

assert c.compare_signal(Decimal(1), 1) == d

assert c.compare_signal(1, Decimal(1)) == d

try:
    c.compare_signal('1', 1)
...
try:
    ...
    pass
print("CContextAPItests::test_compare_signal: ok")
