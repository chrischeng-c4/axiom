...
# lib = "decimal"
# dimension = "behavior"
# case = "py_python_ap_itests__test_create_decimal_from_float"
# subject = "cpython.test_decimal.PyPythonAPItests.test_create_decimal_from_float"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyPythonAPItests::test_create_decimal_from_float
"""Auto-ported test: PyPythonAPItests::test_create_decimal_from_float (CPython 3.12 oracle)."""
...
assert context.create_decimal_from_float(math.pi) == Decimal('3.1415')
context = Context(prec=5, rounding=ROUND_UP)

assert context.create_decimal_from_float(math.pi) == Decimal('3.1416')
context = Context(prec=5, traps=[Inexact])

try:
    context.create_decimal_from_float(math.pi)
    raise AssertionError('expected Inexact')
except Inexact:
    pass

assert repr(context.create_decimal_from_float(-0.0)) == "Decimal('-0')"

assert repr(context.create_decimal_from_float(1.0)) == "Decimal('1')"

assert repr(context.create_decimal_from_float(10)) == "Decimal('10')"
print("PyPythonAPItests::test_create_decimal_from_float: ok")
