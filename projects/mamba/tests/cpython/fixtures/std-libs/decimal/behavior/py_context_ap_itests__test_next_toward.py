...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_next_toward"
# subject = "cpython.test_decimal.PyContextAPItests.test_next_toward"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_next_toward
"""Auto-ported test: PyContextAPItests::test_next_toward (CPython 3.12 oracle)."""
...
assert c.next_toward(1, 2) == d

assert c.next_toward(Decimal(1), 2) == d

assert c.next_toward(1, Decimal(2)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_next_toward: ok")
