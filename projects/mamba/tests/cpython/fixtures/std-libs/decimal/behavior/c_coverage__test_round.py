...
# lib = "decimal"
# dimension = "behavior"
# case = "c_coverage__test_round"
# subject = "cpython.test_decimal.CCoverage.test_round"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CCoverage::test_round
"""Auto-ported test: CCoverage::test_round (CPython 3.12 oracle)."""
...
with localcontext() as c:
    ...
    assert str(Decimal('9.99').__round__()) == '10'

    assert str(Decimal('9.99e-5').__round__()) == '0'

    assert str(Decimal('1.23456789').__round__(5)) == '1.23457'

    assert str(Decimal('1.2345').__round__(10)) == '1.2345000000'

    assert str(Decimal('1.2345').__round__(-10)) == '0E+10'

    try:
        Decimal('1.23').__round__('5')
        raise AssertionError('expected TypeError')
    except TypeError:
        pass

    try:
        Decimal('1.23').__round__(5, 8)
        raise AssertionError('expected TypeError')
    except TypeError:
        pass
print("CCoverage::test_round: ok")
