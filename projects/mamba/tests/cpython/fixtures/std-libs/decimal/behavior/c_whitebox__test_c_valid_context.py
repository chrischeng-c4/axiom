...
# lib = "decimal"
# dimension = "behavior"
# case = "c_whitebox__test_c_valid_context"
# subject = "cpython.test_decimal.CWhitebox.test_c_valid_context"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CWhitebox::test_c_valid_context
"""Auto-ported test: CWhitebox::test_c_valid_context (CPython 3.12 oracle)."""
...
if C.MAX_PREC == 425000000:
    ...
    assert c.prec == 999999999

    assert c.Emax == 999999999

    assert c.Emin == -999999999
print("CWhitebox::test_c_valid_context: ok")
