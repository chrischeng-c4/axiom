...
# lib = "decimal"
# dimension = "behavior"
# case = "c_usability_test__test_min_and_max_methods"
# subject = "cpython.test_decimal.CUsabilityTest.test_min_and_max_methods"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CUsabilityTest::test_min_and_max_methods
"""Auto-ported test: CUsabilityTest::test_min_and_max_methods (CPython 3.12 oracle)."""
...
assert min(d1, d2) is d1

assert min(d2, d1) is d1

assert max(d1, d2) is d2

assert max(d2, d1) is d2

assert min(d1, l2) is d1

assert min(l2, d1) is d1

assert max(l1, d2) is d2

assert max(d2, l1) is d2
print("CUsabilityTest::test_min_and_max_methods: ok")
