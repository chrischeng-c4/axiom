...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_rotate"
# subject = "cpython.test_decimal.PyContextAPItests.test_rotate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_rotate
"""Auto-ported test: PyContextAPItests::test_rotate (CPython 3.12 oracle)."""
...
assert c.rotate(1, 2) == d

assert c.rotate(Decimal(1), 2) == d

assert c.rotate(1, Decimal(2)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_rotate: ok")
