...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_with_statement__test_with_statements_gc2"
# subject = "cpython.test_decimal.PyContextWithStatement.test_with_statements_gc2"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextWithStatement::test_with_statements_gc2
"""Auto-ported test: PyContextWithStatement::test_with_statements_gc2 (CPython 3.12 oracle)."""
    ...
    with localcontext(c1) as c2:
        ...
        with localcontext(c2) as c3:
            ...
            with localcontext(c3) as c4:
                del c3
                del c4
print("PyContextWithStatement::test_with_statements_gc2: ok")
