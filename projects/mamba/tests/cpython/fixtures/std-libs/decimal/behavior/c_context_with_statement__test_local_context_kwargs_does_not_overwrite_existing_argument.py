...
# lib = "decimal"
# dimension = "behavior"
# case = "c_context_with_statement__test_local_context_kwargs_does_not_overwrite_existing_argument"
# subject = "cpython.test_decimal.CContextWithStatement.test_local_context_kwargs_does_not_overwrite_existing_argument"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CContextWithStatement::test_local_context_kwargs_does_not_overwrite_existing_argument
"""Auto-ported test: CContextWithStatement::test_local_context_kwargs_does_not_overwrite_existing_argument (CPython 3.12 oracle)."""
...
with decimal.localcontext(prec=20) as ctx2:
    ...
    assert ctx.prec == orig_prec
print("CContextWithStatement::test_local_context_kwargs_does_not_overwrite_existing_argument: ok")
