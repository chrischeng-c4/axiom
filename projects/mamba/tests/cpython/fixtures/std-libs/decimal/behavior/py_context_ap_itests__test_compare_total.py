...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_compare_total"
# subject = "cpython.test_decimal.PyContextAPItests.test_compare_total"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_compare_total
"""Auto-ported test: PyContextAPItests::test_compare_total (CPython 3.12 oracle)."""
...
assert c.compare_total(1, 1) == d

assert c.compare_total(Decimal(1), 1) == d

assert c.compare_total(1, Decimal(1)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_compare_total: ok")
