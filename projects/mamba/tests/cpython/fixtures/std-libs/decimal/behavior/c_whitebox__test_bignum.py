...
# lib = "decimal"
# dimension = "behavior"
# case = "c_whitebox__test_bignum"
# subject = "cpython.test_decimal.CWhitebox.test_bignum"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CWhitebox::test_bignum
"""Auto-ported test: CWhitebox::test_bignum (CPython 3.12 oracle)."""
...
with localcontext() as c:
    ...
    for i in range(5):
        ...
        assert x == y
print("CWhitebox::test_bignum: ok")
