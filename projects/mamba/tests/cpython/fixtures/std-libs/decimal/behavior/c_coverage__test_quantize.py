...
# lib = "decimal"
# dimension = "behavior"
# case = "c_coverage__test_quantize"
# subject = "cpython.test_decimal.CCoverage.test_quantize"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CCoverage::test_quantize
"""Auto-ported test: CCoverage::test_quantize (CPython 3.12 oracle)."""
...
with localcontext() as c:
    ...
    assert x.is_nan()
print("CCoverage::test_quantize: ok")
