...
# lib = "decimal"
# dimension = "behavior"
# case = "c_usability_test__test_as_integer_ratio"
# subject = "cpython.test_decimal.CUsabilityTest.test_as_integer_ratio"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CUsabilityTest::test_as_integer_ratio
"""Auto-ported test: CUsabilityTest::test_as_integer_ratio (CPython 3.12 oracle)."""
...
for exp in range(-4, 2):
    for coeff in range(1000):
        for sign in ('+', '-'):
            ...
            assert Decimal(p) / Decimal(q) == d
print("CUsabilityTest::test_as_integer_ratio: ok")
