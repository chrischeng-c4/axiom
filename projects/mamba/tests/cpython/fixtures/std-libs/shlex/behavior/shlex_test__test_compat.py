...
# lib = "shlex"
# dimension = "behavior"
# case = "shlex_test__test_compat"
# subject = "cpython.test_shlex.ShlexTest.testCompat"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shlex.py::ShlexTest::testCompat
"""Auto-ported test: ShlexTest::testCompat (CPython 3.12 oracle)."""
...
for i in range(len(self_data)):
    l = oldSplit(self_data[i][0])

    assert l == self_data[i][1:]
print("ShlexTest::testCompat: ok")
