...
# lib = "shlex"
# dimension = "behavior"
# case = "shlex_test__test_syntax_split_ampersand_and_pipe"
# subject = "cpython.test_shlex.ShlexTest.testSyntaxSplitAmpersandAndPipe"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shlex.py::ShlexTest::testSyntaxSplitAmpersandAndPipe
"""Auto-ported test: ShlexTest::testSyntaxSplitAmpersandAndPipe (CPython 3.12 oracle)."""
...
for delimiter in ('&&', '&', '|&', ';&', ';;&', '||', '|', '&|', ';|', ';;|'):
    ...
    for ss, ws in itertools.product(src, (False, True)):
        ...
        assert ref == result
print("ShlexTest::testSyntaxSplitAmpersandAndPipe: ok")
