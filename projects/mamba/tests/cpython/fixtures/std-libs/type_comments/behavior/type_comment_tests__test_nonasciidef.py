...
# lib = "type_comments"
# dimension = "behavior"
# case = "type_comment_tests__test_nonasciidef"
# subject = "cpython.test_type_comments.TypeCommentTests.test_nonasciidef"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_comments.py::TypeCommentTests::test_nonasciidef
"""Auto-ported test: TypeCommentTests::test_nonasciidef (CPython 3.12 oracle)."""
...
for tree in parse_all(nonasciidef):

    assert tree.body[0].type_comment == '() -> àçčéñt'
print("TypeCommentTests::test_nonasciidef: ok")
