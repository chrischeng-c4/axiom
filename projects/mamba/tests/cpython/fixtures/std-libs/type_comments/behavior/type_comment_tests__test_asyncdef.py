...
# lib = "type_comments"
# dimension = "behavior"
# case = "type_comment_tests__test_asyncdef"
# subject = "cpython.test_type_comments.TypeCommentTests.test_asyncdef"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_comments.py::TypeCommentTests::test_asyncdef
"""Auto-ported test: TypeCommentTests::test_asyncdef (CPython 3.12 oracle)."""
...
for tree in parse_all(asyncdef, minver=5):

    assert tree.body[0].type_comment == '() -> int'

    assert tree.body[1].type_comment == '() -> int'
tree = classic_parse(asyncdef)

assert tree.body[0].type_comment == None

assert tree.body[1].type_comment == None
print("TypeCommentTests::test_asyncdef: ok")
