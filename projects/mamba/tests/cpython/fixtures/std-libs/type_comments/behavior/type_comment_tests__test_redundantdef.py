...
# lib = "type_comments"
# dimension = "behavior"
# case = "type_comment_tests__test_redundantdef"
# subject = "cpython.test_type_comments.TypeCommentTests.test_redundantdef"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_comments.py::TypeCommentTests::test_redundantdef
"""Auto-ported test: TypeCommentTests::test_redundantdef (CPython 3.12 oracle)."""
...
for tree in parse_all(redundantdef, maxver=0, expected_regex='^Cannot have two type comments on def'):
    pass
print("TypeCommentTests::test_redundantdef: ok")
