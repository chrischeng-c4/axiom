...
# lib = "type_comments"
# dimension = "behavior"
# case = "type_comment_tests__test_ignores"
# subject = "cpython.test_type_comments.TypeCommentTests.test_ignores"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_comments.py::TypeCommentTests::test_ignores
"""Auto-ported test: TypeCommentTests::test_ignores (CPython 3.12 oracle)."""
...
for tree in parse_all(ignores):

    assert [(ti.lineno, ti.tag) for ti in tree.type_ignores] == [(2, ''), (5, ''), (8, '[excuse]'), (9, '=excuse'), (10, ' [excuse]'), (11, ' whatever')]
tree = classic_parse(ignores)

assert tree.type_ignores == []
print("TypeCommentTests::test_ignores: ok")
