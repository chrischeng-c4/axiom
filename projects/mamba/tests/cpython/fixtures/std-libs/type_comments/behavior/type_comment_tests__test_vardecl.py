...
# lib = "type_comments"
# dimension = "behavior"
# case = "type_comment_tests__test_vardecl"
# subject = "cpython.test_type_comments.TypeCommentTests.test_vardecl"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_comments.py::TypeCommentTests::test_vardecl
"""Auto-ported test: TypeCommentTests::test_vardecl (CPython 3.12 oracle)."""
...
for tree in parse_all(vardecl):

    assert tree.body[0].type_comment == 'int'
tree = classic_parse(vardecl)

assert tree.body[0].type_comment == None
print("TypeCommentTests::test_vardecl: ok")
