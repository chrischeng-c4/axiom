...
# lib = "sys_setprofile"
# dimension = "behavior"
# case = "profile_hook_test_case__test_stop_iteration"
# subject = "cpython.test_sys_setprofile.ProfileHookTestCase.test_stop_iteration"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_setprofile.py::ProfileHookTestCase::test_stop_iteration
"""Auto-ported test: ProfileHookTestCase::test_stop_iteration (CPython 3.12 oracle)."""
...
f_ident = ident(f)
g_ident = ident(g)
check_events(g, [(1, 'call', g_ident), (2, 'call', f_ident), (2, 'return', f_ident), (2, 'call', f_ident), (2, 'return', f_ident), (2, 'call', f_ident), (2, 'return', f_ident), (1, 'return', g_ident)])
print("ProfileHookTestCase::test_stop_iteration: ok")
