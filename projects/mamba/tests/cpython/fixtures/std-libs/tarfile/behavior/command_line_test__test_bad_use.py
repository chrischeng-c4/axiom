...
# lib = "tarfile"
# dimension = "behavior"
# case = "command_line_test__test_bad_use"
# subject = "cpython.test_tarfile.CommandLineTest.test_bad_use"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tarfile.py::CommandLineTest::test_bad_use
"""Auto-ported test: CommandLineTest::test_bad_use (CPython 3.12 oracle)."""
...
rc, out, err = tarfilecmd_failure()

assert out == b''

assert b'usage' in err.lower()

assert b'error' in err.lower()

assert b'required' in err.lower()
rc, out, err = tarfilecmd_failure('-l', '')

assert out == b''

assert err.strip() != b''
print("CommandLineTest::test_bad_use: ok")
