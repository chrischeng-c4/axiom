...
# lib = "tarfile"
# dimension = "behavior"
# case = "command_line_test__test_list_command_invalid_file"
# subject = "cpython.test_tarfile.CommandLineTest.test_list_command_invalid_file"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tarfile.py::CommandLineTest::test_list_command_invalid_file
"""Auto-ported test: CommandLineTest::test_list_command_invalid_file (CPython 3.12 oracle)."""
...
rc, out, err = tarfilecmd_failure('-l', zipname)
...
assert rc == 1
print("CommandLineTest::test_list_command_invalid_file: ok")
