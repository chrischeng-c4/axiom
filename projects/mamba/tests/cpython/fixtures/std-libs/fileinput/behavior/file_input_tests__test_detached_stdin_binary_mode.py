...
# lib = "fileinput"
# dimension = "behavior"
# case = "file_input_tests__test_detached_stdin_binary_mode"
# subject = "cpython.test_fileinput.FileInputTests.test_detached_stdin_binary_mode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::FileInputTests::test_detached_stdin_binary_mode
"""Auto-ported test: FileInputTests::test_detached_stdin_binary_mode (CPython 3.12 oracle)."""
...
try:
    ...
    assert not hasattr(sys.stdin, 'buffer')
...
print("FileInputTests::test_detached_stdin_binary_mode: ok")
