...
# lib = "fileinput"
# dimension = "behavior"
# case = "file_input_tests__test_fileno_when_value_error_raised"
# subject = "cpython.test_fileinput.FileInputTests.test_fileno_when_ValueError_raised"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::FileInputTests::test_fileno_when_ValueError_raised
"""Auto-ported test: FileInputTests::test_fileno_when_ValueError_raised (CPython 3.12 oracle)."""
...
assert unconditionally_raise_ValueError.invoked

assert result == -1
print("FileInputTests::test_fileno_when_ValueError_raised: ok")
