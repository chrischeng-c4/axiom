...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_check_output_stdin_with_input_arg"
# subject = "cpython.test_subprocess.ProcessTestCase.test_check_output_stdin_with_input_arg"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_check_output_stdin_with_input_arg
"""Auto-ported test: ProcessTestCase::test_check_output_stdin_with_input_arg (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('Expected ValueError when stdin and input args supplied.')
    raise AssertionError('expected ValueError')
except ValueError as _aR_e:
    import types as _types_aR
    c = _types_aR.SimpleNamespace(exception=_aR_e)

assert 'stdin' in c.exception.args[0]

assert 'input' in c.exception.args[0]
print("ProcessTestCase::test_check_output_stdin_with_input_arg: ok")
