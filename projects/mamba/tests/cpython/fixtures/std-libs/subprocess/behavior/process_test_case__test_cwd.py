...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_cwd"
# subject = "cpython.test_subprocess.ProcessTestCase.test_cwd"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_cwd
"""Auto-ported test: ProcessTestCase::test_cwd (CPython 3.12 oracle)."""
...
_assert_cwd(temp_dir, sys.executable, cwd=temp_dir)
print("ProcessTestCase::test_cwd: ok")
