...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_wait"
# subject = "cpython.test_subprocess.ProcessTestCase.test_wait"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_wait
"""Auto-ported test: ProcessTestCase::test_wait (CPython 3.12 oracle)."""
...
assert p.wait() == 0
print("ProcessTestCase::test_wait: ok")
