...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_communicate_errors"
# subject = "cpython.test_subprocess.ProcessTestCase.test_communicate_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_communicate_errors
"""Auto-ported test: ProcessTestCase::test_communicate_errors (CPython 3.12 oracle)."""
...
for errors, expected in [('ignore', ''), ('replace', '��'), ('surrogateescape', '\udc80\udc80'), ('backslashreplace', '\\x80\\x80')]:
    ...
    assert stdout == '[{}]'.format(expected)
print("ProcessTestCase::test_communicate_errors: ok")
