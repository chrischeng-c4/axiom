...
# lib = "subprocess"
# dimension = "behavior"
# case = "run_func_test_case__test_check"
# subject = "cpython.test_subprocess.RunFuncTestCase.test_check"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::RunFuncTestCase::test_check
"""Auto-ported test: RunFuncTestCase::test_check (CPython 3.12 oracle)."""
...
try:
    run_python('import sys; sys.exit(47)', check=True)
...
print("RunFuncTestCase::test_check: ok")
