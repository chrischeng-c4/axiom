...
# lib = "subprocess"
# dimension = "behavior"
# case = "run_func_test_case__test_run_kwargs"
# subject = "cpython.test_subprocess.RunFuncTestCase.test_run_kwargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::RunFuncTestCase::test_run_kwargs
"""Auto-ported test: RunFuncTestCase::test_run_kwargs (CPython 3.12 oracle)."""
...
newenv['FRUIT'] = 'banana'
cp = run_python('import sys, os;sys.exit(33 if os.getenv("FRUIT")=="banana" else 31)', env=newenv)

assert cp.returncode == 33
print("RunFuncTestCase::test_run_kwargs: ok")
