...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_writes_before_communicate"
# subject = "cpython.test_subprocess.ProcessTestCase.test_writes_before_communicate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_writes_before_communicate
"""Auto-ported test: ProcessTestCase::test_writes_before_communicate (CPython 3.12 oracle)."""
...
assert stdout == b'bananasplit'

assert stderr == b''
print("ProcessTestCase::test_writes_before_communicate: ok")
