...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_universal_newlines_communicate_stdin_stdout_stderr"
# subject = "cpython.test_subprocess.ProcessTestCase.test_universal_newlines_communicate_stdin_stdout_stderr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_universal_newlines_communicate_stdin_stdout_stderr
"""Auto-ported test: ProcessTestCase::test_universal_newlines_communicate_stdin_stdout_stderr (CPython 3.12 oracle)."""
...
assert stderr.startswith('eline2\neline6\neline7\n')
print("ProcessTestCase::test_universal_newlines_communicate_stdin_stdout_stderr: ok")
