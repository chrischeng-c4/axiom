...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_cwd_with_absolute_arg"
# subject = "cpython.test_subprocess.ProcessTestCase.test_cwd_with_absolute_arg"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_cwd_with_absolute_arg
"""Auto-ported test: ProcessTestCase::test_cwd_with_absolute_arg (CPython 3.12 oracle)."""
...
python_dir, python_base = _split_python_path()
abs_python = os.path.join(python_dir, python_base)
rel_python = os.path.join(os.curdir, python_base)
with os_helper.temp_dir() as wrong_dir:

    try:
        subprocess.Popen([rel_python], cwd=wrong_dir)
        raise AssertionError('expected FileNotFoundError')
    except FileNotFoundError:
        pass
    wrong_dir = _normalize_cwd(wrong_dir)
    _assert_cwd(wrong_dir, abs_python, cwd=wrong_dir)
print("ProcessTestCase::test_cwd_with_absolute_arg: ok")
