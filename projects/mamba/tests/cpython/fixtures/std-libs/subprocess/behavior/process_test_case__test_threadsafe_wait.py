...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_threadsafe_wait"
# subject = "cpython.test_subprocess.ProcessTestCase.test_threadsafe_wait"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_threadsafe_wait
"""Auto-ported test: ProcessTestCase::test_threadsafe_wait (CPython 3.12 oracle)."""
...
assert proc.returncode == expected_errorcode
proc.wait()

assert proc.returncode == expected_errorcode
t.join()

assert [('thread-start-poll-result', None), ('thread-after-kill-and-wait', expected_errorcode), ('thread-after-second-wait', expected_errorcode)] == results
print("ProcessTestCase::test_threadsafe_wait: ok")
