...
# lib = "subprocess"
# dimension = "behavior"
# case = "run_func_test_case__test_timeout"
# subject = "cpython.test_subprocess.RunFuncTestCase.test_timeout"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::RunFuncTestCase::test_timeout
"""Auto-ported test: RunFuncTestCase::test_timeout (CPython 3.12 oracle)."""
...
try:
    run_python('while True: pass', timeout=0.0001)
    raise AssertionError('expected subprocess.TimeoutExpired')
except subprocess.TimeoutExpired:
    pass
print("RunFuncTestCase::test_timeout: ok")
