...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_stdout_fileobj"
# subject = "cpython.test_subprocess.ProcessTestCase.test_stdout_fileobj"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_stdout_fileobj
"""Auto-ported test: ProcessTestCase::test_stdout_fileobj (CPython 3.12 oracle)."""
...
assert tf.read() == b'orange'
print("ProcessTestCase::test_stdout_fileobj: ok")
