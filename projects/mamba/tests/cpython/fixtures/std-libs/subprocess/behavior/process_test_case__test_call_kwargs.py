...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_call_kwargs"
# subject = "cpython.test_subprocess.ProcessTestCase.test_call_kwargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_call_kwargs
"""Auto-ported test: ProcessTestCase::test_call_kwargs (CPython 3.12 oracle)."""
...
assert rc == 1
print("ProcessTestCase::test_call_kwargs: ok")
