...
# lib = "subprocess"
# dimension = "behavior"
# case = "run_func_test_case__test_check_output_timeout"
# subject = "cpython.test_subprocess.RunFuncTestCase.test_check_output_timeout"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::RunFuncTestCase::test_check_output_timeout
"""Auto-ported test: RunFuncTestCase::test_check_output_timeout (CPython 3.12 oracle)."""
...
try:
    cp = run_python('import time; time.sleep(3600)', timeout=0.1, stdout=subprocess.PIPE)
...
print("RunFuncTestCase::test_check_output_timeout: ok")
