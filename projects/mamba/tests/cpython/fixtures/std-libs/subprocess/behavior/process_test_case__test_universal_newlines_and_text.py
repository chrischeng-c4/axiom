...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_universal_newlines_and_text"
# subject = "cpython.test_subprocess.ProcessTestCase.test_universal_newlines_and_text"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_universal_newlines_and_text
"""Auto-ported test: ProcessTestCase::test_universal_newlines_and_text (CPython 3.12 oracle)."""
...
for extra_kwarg in ('universal_newlines', 'text'):
    ...
    with p:
        ...
        assert p.stdout.readline() == 'line1\n'
        p.stdin.write('line3\n')
        p.stdin.close()
        pass

        assert p.stdout.readline() == 'line2\n'

        assert p.stdout.read(6) == 'line3\n'

        assert p.stdout.read() == 'line4\nline5\nline6\nline7\nline8'
print("ProcessTestCase::test_universal_newlines_and_text: ok")
