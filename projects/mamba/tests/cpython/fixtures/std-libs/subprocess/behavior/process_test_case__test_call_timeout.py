...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_call_timeout"
# subject = "cpython.test_subprocess.ProcessTestCase.test_call_timeout"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_call_timeout
"""Auto-ported test: ProcessTestCase::test_call_timeout (CPython 3.12 oracle)."""
...
try:
    subprocess.call([sys.executable, '-c', 'while True: pass'], timeout=0.1)
    raise AssertionError('expected subprocess.TimeoutExpired')
except subprocess.TimeoutExpired:
    pass
print("ProcessTestCase::test_call_timeout: ok")
