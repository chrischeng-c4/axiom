...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_cwd_with_bytes"
# subject = "cpython.test_subprocess.ProcessTestCase.test_cwd_with_bytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_cwd_with_bytes
"""Auto-ported test: ProcessTestCase::test_cwd_with_bytes (CPython 3.12 oracle)."""
...
_assert_cwd(temp_dir, sys.executable, cwd=os.fsencode(temp_dir))
print("ProcessTestCase::test_cwd_with_bytes: ok")
