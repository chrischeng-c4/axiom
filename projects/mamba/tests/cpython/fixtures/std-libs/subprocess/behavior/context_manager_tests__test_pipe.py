...
# lib = "subprocess"
# dimension = "behavior"
# case = "context_manager_tests__test_pipe"
# subject = "cpython.test_subprocess.ContextManagerTests.test_pipe"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ContextManagerTests::test_pipe
"""Auto-ported test: ContextManagerTests::test_pipe (CPython 3.12 oracle)."""
...
with subprocess.Popen([sys.executable, '-c', "import sys;sys.stdout.write('stdout');sys.stderr.write('stderr');"], stdout=subprocess.PIPE, stderr=subprocess.PIPE) as proc:
    ...
    assert proc.stdout.read() == b'stdout'

    assert proc.stderr.read() == b'stderr'

assert proc.stdout.closed

assert proc.stderr.closed
print("ContextManagerTests::test_pipe: ok")
