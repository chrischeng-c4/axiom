...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_executable_takes_precedence"
# subject = "cpython.test_subprocess.ProcessTestCase.test_executable_takes_precedence"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_executable_takes_precedence
"""Auto-ported test: ProcessTestCase::test_executable_takes_precedence (CPython 3.12 oracle)."""
...
_assert_python(pre_args)

try:
    _assert_python(pre_args, executable=NONEXISTING_CMD[0])
    raise AssertionError('expected NONEXISTING_ERRORS')
except NONEXISTING_ERRORS:
    pass
print("ProcessTestCase::test_executable_takes_precedence: ok")
