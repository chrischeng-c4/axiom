...
# lib = "subprocess"
# dimension = "behavior"
# case = "run_func_test_case__test_capture_stderr"
# subject = "cpython.test_subprocess.RunFuncTestCase.test_capture_stderr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::RunFuncTestCase::test_capture_stderr
"""Auto-ported test: RunFuncTestCase::test_capture_stderr (CPython 3.12 oracle)."""
...
cp = run_python("import sys; sys.stderr.write('BDFL')", stderr=subprocess.PIPE)

assert b'BDFL' in cp.stderr
print("RunFuncTestCase::test_capture_stderr: ok")
