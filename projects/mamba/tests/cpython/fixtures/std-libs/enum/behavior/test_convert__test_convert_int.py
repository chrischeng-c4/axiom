...
# lib = "enum"
# dimension = "behavior"
# case = "test_convert__test_convert_int"
# subject = "cpython.test_enum.TestConvert.test_convert_int"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestConvert::test_convert_int
"""Auto-ported test: TestConvert::test_convert_int (CPython 3.12 oracle)."""
...
# --- test body ---
test_type = enum.IntEnum._convert_('UnittestConvert', MODULE, filter=lambda x: x.startswith('CONVERT_TEST_'))
...
print("TestConvert::test_convert_int: ok")
