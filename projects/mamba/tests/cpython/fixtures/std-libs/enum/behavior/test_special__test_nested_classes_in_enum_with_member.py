...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_nested_classes_in_enum_with_member"
# subject = "cpython.test_enum.TestSpecial.test_nested_classes_in_enum_with_member"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_nested_classes_in_enum_with_member
"""Auto-ported test: TestSpecial::test_nested_classes_in_enum_with_member (CPython 3.12 oracle)."""
...
assert isinstance(Outer.Inner, Outer)

assert Outer.a.value == 1

assert Outer.Inner.value.foo.value == 10

assert list(Outer.Inner.value) == [Outer.Inner.value.foo, Outer.Inner.value.bar]

assert list(Outer) == [Outer.a, Outer.b, Outer.Inner]
print("TestSpecial::test_nested_classes_in_enum_with_member: ok")
