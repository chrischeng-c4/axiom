...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_value_backup_assign"
# subject = "cpython.test_enum.TestSpecial.test_value_backup_assign"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_value_backup_assign
"""Auto-ported test: TestSpecial::test_value_backup_assign (CPython 3.12 oracle)."""
...
assert Some.x.value == 1

assert Some.y.value == 2
print("TestSpecial::test_value_backup_assign: ok")
