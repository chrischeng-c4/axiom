...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_enum_of_types_with_nonmember"
# subject = "cpython.test_enum.TestSpecial.test_enum_of_types_with_nonmember"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_enum_of_types_with_nonmember
"""Auto-ported test: TestSpecial::test_enum_of_types_with_nonmember (CPython 3.12 oracle)."""
...
assert MyTypes.i.value == int

assert MyTypes.f is float

assert MyTypes.s.value == str
...
assert MyTypes2.a.value == Foo

assert MyTypes2.b is Bar
...
assert SpamEnum.spam is SpamEnumIsInner
print("TestSpecial::test_enum_of_types_with_nonmember: ok")
