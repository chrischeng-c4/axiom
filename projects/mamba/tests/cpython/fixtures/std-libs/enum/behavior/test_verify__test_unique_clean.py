...
# lib = "enum"
# dimension = "behavior"
# case = "test_verify__test_unique_clean"
# subject = "cpython.test_enum.TestVerify.test_unique_clean"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestVerify::test_unique_clean
"""Auto-ported test: TestVerify::test_unique_clean (CPython 3.12 oracle)."""
...
class Cleaner(IntEnum):
    ...
    double = 2
    triple = 3
print("TestVerify::test_unique_clean: ok")
