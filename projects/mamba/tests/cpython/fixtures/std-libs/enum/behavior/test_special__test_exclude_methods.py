...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_exclude_methods"
# subject = "cpython.test_enum.TestSpecial.test_exclude_methods"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_exclude_methods
"""Auto-ported test: TestSpecial::test_exclude_methods (CPython 3.12 oracle)."""
...
assert type(whatever.really) is not whatever

assert whatever.this.really() == 'no, not that'
print("TestSpecial::test_exclude_methods: ok")
