...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_multiple_mixin"
# subject = "cpython.test_enum.TestSpecial.test_multiple_mixin"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_multiple_mixin
"""Auto-ported test: TestSpecial::test_multiple_mixin (CPython 3.12 oracle)."""
...
assert CoolColor.RED.value == 1

assert CoolColor.GREEN.value == 2

assert CoolColor.BLUE.value == 3

assert str(CoolColor.BLUE) == 'blue'

assert CoolColor.RED.behavior() == 'booyah'
...
assert CoolerColor.RED.value == 1

assert CoolerColor.GREEN.value == 2

assert CoolerColor.BLUE.value == 3

assert str(CoolerColor.BLUE) == 'blue'

assert CoolerColor.RED.behavior() == 'nuhuh!'

assert CoolerColor.RED.social() == "what's up?"
...
assert CoolestColor.RED.value == 1

assert CoolestColor.GREEN.value == 2

assert CoolestColor.BLUE.value == 3

assert str(CoolestColor.BLUE) == 'blue'

assert CoolestColor.RED.behavior() == 'booyah'

assert CoolestColor.RED.social() == "what's up?"
...
assert ConfusedColor.RED.value == 1

assert ConfusedColor.GREEN.value == 2

assert ConfusedColor.BLUE.value == 3

assert str(ConfusedColor.BLUE) == 'blue'

assert ConfusedColor.RED.behavior() == 'nuhuh!'

assert ConfusedColor.RED.social() == "what's up?"
...
assert ReformedColor.RED.value == 1

assert ReformedColor.GREEN.value == 2

assert ReformedColor.BLUE.value == 3

assert str(ReformedColor.BLUE) == 'blue'

assert ReformedColor.RED.behavior() == 'booyah'

assert ConfusedColor.RED.social() == "what's up?"

assert issubclass(ReformedColor, int)
print("TestSpecial::test_multiple_mixin: ok")
