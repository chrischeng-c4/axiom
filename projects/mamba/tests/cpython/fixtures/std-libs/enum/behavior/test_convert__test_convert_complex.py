...
# lib = "enum"
# dimension = "behavior"
# case = "test_convert__test_convert_complex"
# subject = "cpython.test_enum.TestConvert.test_convert_complex"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestConvert::test_convert_complex
"""Auto-ported test: TestConvert::test_convert_complex (CPython 3.12 oracle)."""
...
# --- test body ---
uncomp = enum.Enum._convert_('Uncomparable', MODULE, filter=lambda x: x.startswith('COMPLEX_'))

assert list(uncomp) == [uncomp.COMPLEX_A, uncomp.COMPLEX_B, uncomp.COMPLEX_C]
print("TestConvert::test_convert_complex: ok")
