...
# lib = "enum"
# dimension = "behavior"
# case = "old_test_int_flag__test_global_repr_keep"
# subject = "cpython.test_enum.OldTestIntFlag.test_global_repr_keep"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::OldTestIntFlag::test_global_repr_keep
"""Auto-ported test: OldTestIntFlag::test_global_repr_keep (CPython 3.12 oracle)."""
...
assert repr(HeadlightsK(0)) == '%s.OFF_K' % SHORT_MODULE

assert repr(HeadlightsK(2 ** 0 + 2 ** 2 + 2 ** 3)) == '%(m)s.LOW_BEAM_K|%(m)s.FOG_K|8' % {'m': SHORT_MODULE}

assert repr(HeadlightsK(2 ** 3)) == '%(m)s.HeadlightsK(8)' % {'m': SHORT_MODULE}
print("OldTestIntFlag::test_global_repr_keep: ok")
