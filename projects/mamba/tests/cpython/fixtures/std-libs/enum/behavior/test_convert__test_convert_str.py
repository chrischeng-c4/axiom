...
# lib = "enum"
# dimension = "behavior"
# case = "test_convert__test_convert_str"
# subject = "cpython.test_enum.TestConvert.test_convert_str"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestConvert::test_convert_str
"""Auto-ported test: TestConvert::test_convert_str (CPython 3.12 oracle)."""
...
# --- test body ---
test_type = enum.StrEnum._convert_('UnittestConvert', MODULE, filter=lambda x: x.startswith('CONVERT_STR_'), as_global=True)

assert test_type.CONVERT_STR_TEST_1 == 'hello'

assert test_type.CONVERT_STR_TEST_2 == 'goodbye'
...
assert repr(test_type.CONVERT_STR_TEST_1) == '%s.CONVERT_STR_TEST_1' % SHORT_MODULE

assert str(test_type.CONVERT_STR_TEST_2) == 'goodbye'

assert format(test_type.CONVERT_STR_TEST_1) == 'hello'
print("TestConvert::test_convert_str: ok")
