...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_second_tuple_item_is_falsey"
# subject = "cpython.test_enum.TestSpecial.test_second_tuple_item_is_falsey"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_second_tuple_item_is_falsey
"""Auto-ported test: TestSpecial::test_second_tuple_item_is_falsey (CPython 3.12 oracle)."""
...
assert Cardinal(1, 0) is Cardinal.RIGHT

assert Cardinal(-1, 0) is Cardinal.LEFT
print("TestSpecial::test_second_tuple_item_is_falsey: ok")
