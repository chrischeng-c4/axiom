...
# lib = "enum"
# dimension = "behavior"
# case = "test_internals__test_is_private"
# subject = "cpython.test_enum.TestInternals.test_is_private"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestInternals::test_is_private
"""Auto-ported test: TestInternals::test_is_private (CPython 3.12 oracle)."""
...
for name in private_names + private_and_sunder_names:

    assert enum._is_private('MyEnum', name)
for name in sunder_names + dunder_names + random_names:

    assert not enum._is_private('MyEnum', name)
print("TestInternals::test_is_private: ok")
