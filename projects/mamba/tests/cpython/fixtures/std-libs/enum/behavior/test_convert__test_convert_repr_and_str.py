...
# lib = "enum"
# dimension = "behavior"
# case = "test_convert__test_convert_repr_and_str"
# subject = "cpython.test_enum.TestConvert.test_convert_repr_and_str"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestConvert::test_convert_repr_and_str
"""Auto-ported test: TestConvert::test_convert_repr_and_str (CPython 3.12 oracle)."""
...
# --- test body ---
test_type = enum.IntEnum._convert_('UnittestConvert', MODULE, filter=lambda x: x.startswith('CONVERT_STRING_TEST_'), as_global=True)

assert repr(test_type.CONVERT_STRING_TEST_NAME_A) == '%s.CONVERT_STRING_TEST_NAME_A' % SHORT_MODULE

assert str(test_type.CONVERT_STRING_TEST_NAME_A) == '5'

assert format(test_type.CONVERT_STRING_TEST_NAME_A) == '5'
print("TestConvert::test_convert_repr_and_str: ok")
