...
# lib = "enum"
# dimension = "behavior"
# case = "test_empty_and_non_latin_strings__test_non_latin_character_string"
# subject = "cpython.test_enum.TestEmptyAndNonLatinStrings.test_non_latin_character_string"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestEmptyAndNonLatinStrings::test_non_latin_character_string
"""Auto-ported test: TestEmptyAndNonLatinStrings::test_non_latin_character_string (CPython 3.12 oracle)."""
...
assert item.value == 1
print("TestEmptyAndNonLatinStrings::test_non_latin_character_string: ok")
