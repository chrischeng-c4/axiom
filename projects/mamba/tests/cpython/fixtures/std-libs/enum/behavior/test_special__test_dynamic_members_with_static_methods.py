...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_dynamic_members_with_static_methods"
# subject = "cpython.test_enum.TestSpecial.test_dynamic_members_with_static_methods"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_dynamic_members_with_static_methods
"""Auto-ported test: TestSpecial::test_dynamic_members_with_static_methods (CPython 3.12 oracle)."""
...
try:
    ...
    class FooBar(Enum):
        vars().update({k: v for k, v in foo_defines.items() if k.startswith('FOO_')}, **{'FOO_CAT': 'small'})
    ...
    import re as _re_aR
    assert _re_aR.search("'FOO_CAT' already defined as 'aloof'", str(_aR_e))
print("TestSpecial::test_dynamic_members_with_static_methods: ok")
