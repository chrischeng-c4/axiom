...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_ignore"
# subject = "cpython.test_enum.TestSpecial.test_ignore"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_ignore
"""Auto-ported test: TestSpecial::test_ignore (CPython 3.12 oracle)."""
...
assert not hasattr(Period, '_ignore_')

assert not hasattr(Period, 'Period')

assert not hasattr(Period, 'i')

assert isinstance(Period.day_1, timedelta)

assert Period.month_1 is Period.day_30

assert Period.week_4 is Period.day_28
print("TestSpecial::test_ignore: ok")
