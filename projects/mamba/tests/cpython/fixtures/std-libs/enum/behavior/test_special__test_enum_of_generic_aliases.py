...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_enum_of_generic_aliases"
# subject = "cpython.test_enum.TestSpecial.test_enum_of_generic_aliases"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_enum_of_generic_aliases
"""Auto-ported test: TestSpecial::test_enum_of_generic_aliases (CPython 3.12 oracle)."""
...
assert E.a.value == typing.List[int]

assert E.b.value == list[int]

assert repr(E.a) == '<E.a: typing.List[int]>'

assert repr(E.b) == '<E.b: list[int]>'
print("TestSpecial::test_enum_of_generic_aliases: ok")
