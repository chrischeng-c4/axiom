...
# lib = "enum"
# dimension = "behavior"
# case = "old_test_int_flag__test_programatic_function_from_empty_tuple"
# subject = "cpython.test_enum.OldTestIntFlag.test_programatic_function_from_empty_tuple"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::OldTestIntFlag::test_programatic_function_from_empty_tuple
"""Auto-ported test: OldTestIntFlag::test_programatic_function_from_empty_tuple (CPython 3.12 oracle)."""
...
assert len(Thing) == 0
print("OldTestIntFlag::test_programatic_function_from_empty_tuple: ok")
