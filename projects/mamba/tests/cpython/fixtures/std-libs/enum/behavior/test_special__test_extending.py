...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_extending"
# subject = "cpython.test_enum.TestSpecial.test_extending"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_extending
"""Auto-ported test: TestSpecial::test_extending (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('<enum .EvenMoreColor.> cannot extend <enum .Color.>', str(_aR_e))
try:
    Color('Foo', ('pink', 'black'))
    raise AssertionError('expected ValueError')
except ValueError as _aR_e:
    import re as _re_aR
    assert _re_aR.search('\\(.Foo., \\(.pink., .black.\\)\\) is not a valid .*Color', str(_aR_e))
print("TestSpecial::test_extending: ok")
