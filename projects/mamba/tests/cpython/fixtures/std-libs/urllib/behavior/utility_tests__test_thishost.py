...
# lib = "urllib"
# dimension = "behavior"
# case = "utility_tests__test_thishost"
# subject = "cpython.test_urllib.Utility_Tests.test_thishost"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::Utility_Tests::test_thishost
"""Auto-ported test: Utility_Tests::test_thishost (CPython 3.12 oracle)."""
...
assert isinstance(urllib.request.thishost(), tuple)
print("Utility_Tests::test_thishost: ok")
