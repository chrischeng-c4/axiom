...
# lib = "urllib"
# dimension = "behavior"
# case = "urlopen_http_tests__test_missing_localfile"
# subject = "cpython.test_urllib.urlopen_HttpTests.test_missing_localfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::urlopen_HttpTests::test_missing_localfile
"""Auto-ported test: urlopen_HttpTests::test_missing_localfile (CPython 3.12 oracle)."""
...
except urllib.error.URLError as _aR_e:
    import types as _types_aR
    e = _types_aR.SimpleNamespace(exception=_aR_e)

assert e.exception.filename

assert e.exception.reason
print("urlopen_HttpTests::test_missing_localfile: ok")
