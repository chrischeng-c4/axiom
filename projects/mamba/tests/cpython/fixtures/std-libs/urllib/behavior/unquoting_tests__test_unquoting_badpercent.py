...
# lib = "urllib"
# dimension = "behavior"
# case = "unquoting_tests__test_unquoting_badpercent"
# subject = "cpython.test_urllib.UnquotingTests.test_unquoting_badpercent"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::UnquotingTests::test_unquoting_badpercent
"""Auto-ported test: UnquotingTests::test_unquoting_badpercent (CPython 3.12 oracle)."""
...
try:
    urllib.parse.unquote_to_bytes(None)
...
try:
    ...
    pass
print("UnquotingTests::test_unquoting_badpercent: ok")
