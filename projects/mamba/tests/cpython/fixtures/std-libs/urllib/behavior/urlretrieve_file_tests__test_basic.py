...
# lib = "urllib"
# dimension = "behavior"
# case = "urlretrieve_file_tests__test_basic"
# subject = "cpython.test_urllib.urlretrieve_FileTests.test_basic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::urlretrieve_FileTests::test_basic
"""Auto-ported test: urlretrieve_FileTests::test_basic (CPython 3.12 oracle)."""
...
assert result[0] == os_helper.TESTFN

assert isinstance(result[1], email.message.Message)
print("urlretrieve_FileTests::test_basic: ok")
