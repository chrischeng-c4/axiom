...
# lib = "urllib"
# dimension = "behavior"
# case = "urlretrieve_file_tests__test_copy"
# subject = "cpython.test_urllib.urlretrieve_FileTests.test_copy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::urlretrieve_FileTests::test_copy
"""Auto-ported test: urlretrieve_FileTests::test_copy (CPython 3.12 oracle)."""
...
result = urllib.request.urlretrieve(constructLocalFileUrl(os_helper.TESTFN), second_temp)

assert second_temp == result[0]

assert os.path.exists(second_temp)
...
assert self_text == text
print("urlretrieve_FileTests::test_copy: ok")
