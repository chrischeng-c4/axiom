...
# lib = "urllib"
# dimension = "behavior"
# case = "urlencode_tests__test_urlencode_encoding_safe_parameter"
# subject = "cpython.test_urllib.urlencode_Tests.test_urlencode_encoding_safe_parameter"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::urlencode_Tests::test_urlencode_encoding_safe_parameter
"""Auto-ported test: urlencode_Tests::test_urlencode_encoding_safe_parameter (CPython 3.12 oracle)."""
...
assert expect == result
print("urlencode_Tests::test_urlencode_encoding_safe_parameter: ok")
