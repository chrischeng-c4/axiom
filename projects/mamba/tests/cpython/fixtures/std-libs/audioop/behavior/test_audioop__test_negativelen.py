...
# lib = "audioop"
# dimension = "behavior"
# case = "test_audioop__test_negativelen"
# subject = "cpython.test_audioop.TestAudioop.test_negativelen"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audioop.py::TestAudioop::test_negativelen
"""Auto-ported test: TestAudioop::test_negativelen (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("TestAudioop::test_negativelen: ok")
