...
# lib = "audioop"
# dimension = "behavior"
# case = "test_audioop__test_findmax"
# subject = "cpython.test_audioop.TestAudioop.test_findmax"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audioop.py::TestAudioop::test_findmax
"""Auto-ported test: TestAudioop::test_findmax (CPython 3.12 oracle)."""
...
assert audioop.findmax(datas[2], 1) == 5

assert audioop.findmax(bytearray(datas[2]), 1) == 5

assert audioop.findmax(memoryview(datas[2]), 1) == 5
print("TestAudioop::test_findmax: ok")
