...
# lib = "tracemalloc"
# dimension = "behavior"
# case = "test_filters__test_filter_match_filename"
# subject = "cpython.test_tracemalloc.TestFilters.test_filter_match_filename"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tracemalloc.py::TestFilters::test_filter_match_filename
"""Auto-ported test: TestFilters::test_filter_match_filename (CPython 3.12 oracle)."""
...
assert fnmatch(True, 'abc', 'abc')

assert not fnmatch(True, '12356', 'abc')

assert not fnmatch(True, '<unknown>', 'abc')

assert not fnmatch(False, 'abc', 'abc')

assert fnmatch(False, '12356', 'abc')

assert fnmatch(False, '<unknown>', 'abc')
print("TestFilters::test_filter_match_filename: ok")
