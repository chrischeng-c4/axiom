...
# lib = "tracemalloc"
# dimension = "behavior"
# case = "test_snapshot__test_filter_traces_domain_filter"
# subject = "cpython.test_tracemalloc.TestSnapshot.test_filter_traces_domain_filter"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tracemalloc.py::TestSnapshot::test_filter_traces_domain_filter
"""Auto-ported test: TestSnapshot::test_filter_traces_domain_filter (CPython 3.12 oracle)."""
...
assert snapshot3.traces._traces == [(0, 10, (('a.py', 2), ('b.py', 4)), 3), (0, 10, (('a.py', 2), ('b.py', 4)), 3), (0, 10, (('a.py', 2), ('b.py', 4)), 3), (1, 2, (('a.py', 5), ('b.py', 4)), 3), (2, 66, (('b.py', 1),), 1)]
snapshot3 = snapshot.filter_traces((filter2,))

assert snapshot3.traces._traces == [(3, 7, (('<unknown>', 0),), 1)]
print("TestSnapshot::test_filter_traces_domain_filter: ok")
