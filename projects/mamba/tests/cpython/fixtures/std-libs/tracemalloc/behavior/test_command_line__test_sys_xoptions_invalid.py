...
# lib = "tracemalloc"
# dimension = "behavior"
# case = "test_command_line__test_sys_xoptions_invalid"
# subject = "cpython.test_tracemalloc.TestCommandLine.test_sys_xoptions_invalid"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tracemalloc.py::TestCommandLine::test_sys_xoptions_invalid
"""Auto-ported test: TestCommandLine::test_sys_xoptions_invalid (CPython 3.12 oracle)."""
...
for nframe in INVALID_NFRAME:
    check_sys_xoptions_invalid(nframe)
print("TestCommandLine::test_sys_xoptions_invalid: ok")
