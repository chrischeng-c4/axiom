...
# lib = "tracemalloc"
# dimension = "behavior"
# case = "test_snapshot__test_trace_format"
# subject = "cpython.test_tracemalloc.TestSnapshot.test_trace_format"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tracemalloc.py::TestSnapshot::test_trace_format
"""Auto-ported test: TestSnapshot::test_trace_format (CPython 3.12 oracle)."""
...
assert str(trace) == 'b.py:4: 10 B'
traceback = trace.traceback

assert str(traceback) == 'b.py:4'
frame = traceback[0]

assert str(frame) == 'b.py:4'
print("TestSnapshot::test_trace_format: ok")
