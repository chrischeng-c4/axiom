...
# lib = "array"
# dimension = "behavior"
# case = "long_long_test__test_tofromfile"
# subject = "cpython.test_array.LongLongTest.test_tofromfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::LongLongTest::test_tofromfile
"""Auto-ported test: LongLongTest::test_tofromfile (CPython 3.12 oracle)."""
...
try:
    ...
    if not f.closed:
        f.close()
    os_helper.unlink(os_helper.TESTFN)
print("LongLongTest::test_tofromfile: ok")
