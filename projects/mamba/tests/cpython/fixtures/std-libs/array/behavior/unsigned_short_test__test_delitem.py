...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_short_test__test_delitem"
# subject = "cpython.test_array.UnsignedShortTest.test_delitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedShortTest::test_delitem
"""Auto-ported test: UnsignedShortTest::test_delitem (CPython 3.12 oracle)."""
...
assert a == array.array(typecode, example[1:])
a = array.array(typecode, example)
del a[-1]
...
try:
    a.__delitem__(len(example))
    raise AssertionError('expected IndexError')
except IndexError:
    pass

try:
    a.__delitem__(-len(example) - 1)
    raise AssertionError('expected IndexError')
except IndexError:
    pass
print("UnsignedShortTest::test_delitem: ok")
