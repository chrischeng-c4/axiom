...
# lib = "array"
# dimension = "behavior"
# case = "double_test__test_reverse_iterator_picking"
# subject = "cpython.test_array.DoubleTest.test_reverse_iterator_picking"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::DoubleTest::test_reverse_iterator_picking
"""Auto-ported test: DoubleTest::test_reverse_iterator_picking (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert list(a) == data2
print("DoubleTest::test_reverse_iterator_picking: ok")
