...
# lib = "array"
# dimension = "behavior"
# case = "int_test__test_tofromfile"
# subject = "cpython.test_array.IntTest.test_tofromfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::IntTest::test_tofromfile
"""Auto-ported test: IntTest::test_tofromfile (CPython 3.12 oracle)."""
...
try:
    ...
    if not f.closed:
        f.close()
    os_helper.unlink(os_helper.TESTFN)
print("IntTest::test_tofromfile: ok")
