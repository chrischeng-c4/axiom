...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_test__test_extslice"
# subject = "cpython.test_array.UnsignedLongTest.test_extslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongTest::test_extslice
"""Auto-ported test: UnsignedLongTest::test_extslice (CPython 3.12 oracle)."""
...
assert a[-1000:-2000:-2] == array.array(typecode, [])
print("UnsignedLongTest::test_extslice: ok")
