...
# lib = "array"
# dimension = "behavior"
# case = "float_test__test_tofromfile"
# subject = "cpython.test_array.FloatTest.test_tofromfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::FloatTest::test_tofromfile
"""Auto-ported test: FloatTest::test_tofromfile (CPython 3.12 oracle)."""
...
try:
    ...
    if not f.closed:
        f.close()
    os_helper.unlink(os_helper.TESTFN)
print("FloatTest::test_tofromfile: ok")
