...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_long_test__test_extended_set_del_slice"
# subject = "cpython.test_array.UnsignedLongLongTest.test_extended_set_del_slice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongLongTest::test_extended_set_del_slice
"""Auto-ported test: UnsignedLongLongTest::test_extended_set_del_slice (CPython 3.12 oracle)."""
...
for start in indices:
    for stop in indices:
        for step in indices[1:]:
            ...
            a[start:stop:step] = array.array(typecode, data)

            assert a == array.array(typecode, L)
            del L[start:stop:step]
            del a[start:stop:step]

            assert a == array.array(typecode, L)
print("UnsignedLongLongTest::test_extended_set_del_slice: ok")
