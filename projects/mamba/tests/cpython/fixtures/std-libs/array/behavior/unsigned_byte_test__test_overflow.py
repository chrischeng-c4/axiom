...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_byte_test__test_overflow"
# subject = "cpython.test_array.UnsignedByteTest.test_overflow"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedByteTest::test_overflow
"""Auto-ported test: UnsignedByteTest::test_overflow (CPython 3.12 oracle)."""
...
check_overflow(lower, upper)
check_overflow(Intable(lower), Intable(upper))
print("UnsignedByteTest::test_overflow: ok")
