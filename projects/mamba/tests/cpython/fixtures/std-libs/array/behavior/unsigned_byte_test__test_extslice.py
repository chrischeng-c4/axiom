...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_byte_test__test_extslice"
# subject = "cpython.test_array.UnsignedByteTest.test_extslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedByteTest::test_extslice
"""Auto-ported test: UnsignedByteTest::test_extslice (CPython 3.12 oracle)."""
...
assert a[-1000:-2000:-2] == array.array(typecode, [])
print("UnsignedByteTest::test_extslice: ok")
