...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_short_test__test_extended_getslice"
# subject = "cpython.test_array.UnsignedShortTest.test_extended_getslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedShortTest::test_extended_getslice
"""Auto-ported test: UnsignedShortTest::test_extended_getslice (CPython 3.12 oracle)."""
...
for start in indices:
    for stop in indices:
        for step in indices[1:]:
            ...
            assert list(a[start:stop:step]) == list(a)[start:stop:step]
print("UnsignedShortTest::test_extended_getslice: ok")
