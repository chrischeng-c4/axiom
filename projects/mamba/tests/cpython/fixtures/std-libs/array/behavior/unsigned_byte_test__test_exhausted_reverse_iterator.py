...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_byte_test__test_exhausted_reverse_iterator"
# subject = "cpython.test_array.UnsignedByteTest.test_exhausted_reverse_iterator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedByteTest::test_exhausted_reverse_iterator
"""Auto-ported test: UnsignedByteTest::test_exhausted_reverse_iterator (CPython 3.12 oracle)."""
...
assert list(a) == [outside] + list(example)
print("UnsignedByteTest::test_exhausted_reverse_iterator: ok")
