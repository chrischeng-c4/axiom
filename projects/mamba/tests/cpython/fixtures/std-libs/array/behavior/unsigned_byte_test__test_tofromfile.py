...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_byte_test__test_tofromfile"
# subject = "cpython.test_array.UnsignedByteTest.test_tofromfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedByteTest::test_tofromfile
"""Auto-ported test: UnsignedByteTest::test_tofromfile (CPython 3.12 oracle)."""
...
try:
    ...
    if not f.closed:
        f.close()
    os_helper.unlink(os_helper.TESTFN)
print("UnsignedByteTest::test_tofromfile: ok")
