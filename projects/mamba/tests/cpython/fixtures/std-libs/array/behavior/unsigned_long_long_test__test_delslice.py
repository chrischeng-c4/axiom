...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_long_test__test_delslice"
# subject = "cpython.test_array.UnsignedLongLongTest.test_delslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongLongTest::test_delslice
"""Auto-ported test: UnsignedLongLongTest::test_delslice (CPython 3.12 oracle)."""
...
assert a == array.array(typecode, [1, 3])
a = array.array(typecode, range(5))
del a[1::2]

assert a == array.array(typecode, [0, 2, 4])
a = array.array(typecode, range(5))
del a[1::-2]

assert a == array.array(typecode, [0, 2, 3, 4])
a = array.array(typecode, range(10))
del a[::1000]

assert a == array.array(typecode, [1, 2, 3, 4, 5, 6, 7, 8, 9])
a = array.array(typecode, range(10))
del a[9::1 << 333]
print("UnsignedLongLongTest::test_delslice: ok")
