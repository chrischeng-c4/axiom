...
# lib = "array"
# dimension = "behavior"
# case = "int_test__test_delslice"
# subject = "cpython.test_array.IntTest.test_delslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::IntTest::test_delslice
"""Auto-ported test: IntTest::test_delslice (CPython 3.12 oracle)."""
...
a = array.array(typecode, range(10))
del a[9::1 << 333]
print("IntTest::test_delslice: ok")
