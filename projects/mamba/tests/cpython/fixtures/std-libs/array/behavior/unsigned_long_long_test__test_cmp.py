...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_long_test__test_cmp"
# subject = "cpython.test_array.UnsignedLongLongTest.test_cmp"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongLongTest::test_cmp
"""Auto-ported test: UnsignedLongLongTest::test_cmp (CPython 3.12 oracle)."""
...
assert (a >= a) is True
al = array.array(typecode, smallerexample)
ab = array.array(typecode, biggerexample)

assert (a == 2 * a) is False

assert (a != 2 * a) is True
...
assert (a >= ab) is False
print("UnsignedLongLongTest::test_cmp: ok")
