...
# lib = "array"
# dimension = "behavior"
# case = "int_test__test_extended_set_del_slice"
# subject = "cpython.test_array.IntTest.test_extended_set_del_slice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::IntTest::test_extended_set_del_slice
"""Auto-ported test: IntTest::test_extended_set_del_slice (CPython 3.12 oracle)."""
...
for start in indices:
    for stop in indices:
        for step in indices[1:]:
            ...
            assert a == array.array(typecode, L)
print("IntTest::test_extended_set_del_slice: ok")
