...
# lib = "array"
# dimension = "behavior"
# case = "double_test__test_initialize_with_unicode"
# subject = "cpython.test_array.DoubleTest.test_initialize_with_unicode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::DoubleTest::test_initialize_with_unicode
"""Auto-ported test: DoubleTest::test_initialize_with_unicode (CPython 3.12 oracle)."""
...
if typecode != 'u':
    ...
    a = array.array(typecode, 'foo')
    a = array.array(typecode, array.array('u', 'foo'))
print("DoubleTest::test_initialize_with_unicode: ok")
