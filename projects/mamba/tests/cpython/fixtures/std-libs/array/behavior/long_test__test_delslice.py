...
# lib = "array"
# dimension = "behavior"
# case = "long_test__test_delslice"
# subject = "cpython.test_array.LongTest.test_delslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::LongTest::test_delslice
"""Auto-ported test: LongTest::test_delslice (CPython 3.12 oracle)."""
...
a = array.array(typecode, range(10))
del a[9::1 << 333]
print("LongTest::test_delslice: ok")
