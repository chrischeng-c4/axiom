...
# lib = "array"
# dimension = "behavior"
# case = "byte_test__test_tofromfile"
# subject = "cpython.test_array.ByteTest.test_tofromfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::ByteTest::test_tofromfile
"""Auto-ported test: ByteTest::test_tofromfile (CPython 3.12 oracle)."""
...
try:
    ...
    if not f.closed:
        f.close()
    os_helper.unlink(os_helper.TESTFN)
print("ByteTest::test_tofromfile: ok")
