...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_short_test__test_delslice"
# subject = "cpython.test_array.UnsignedShortTest.test_delslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedShortTest::test_delslice
"""Auto-ported test: UnsignedShortTest::test_delslice (CPython 3.12 oracle)."""
...
a = array.array(typecode, range(10))
del a[9::1 << 333]
print("UnsignedShortTest::test_delslice: ok")
