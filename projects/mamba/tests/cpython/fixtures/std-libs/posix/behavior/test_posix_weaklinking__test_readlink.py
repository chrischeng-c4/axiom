...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_weaklinking__test_readlink"
# subject = "cpython.test_posix.TestPosixWeaklinking.test_readlink"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixWeaklinking::test_readlink
"""Auto-ported test: TestPosixWeaklinking::test_readlink (CPython 3.12 oracle)."""
...
_verify_available('HAVE_READLINKAT')
if self_mac_ver >= (10, 10):

    assert 'HAVE_READLINKAT' in posix._have_functions
else:

    assert 'HAVE_READLINKAT' not in posix._have_functions
    try:
...
print("TestPosixWeaklinking::test_readlink: ok")
