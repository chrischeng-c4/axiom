...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_weaklinking__test_symlink"
# subject = "cpython.test_posix.TestPosixWeaklinking.test_symlink"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixWeaklinking::test_symlink
"""Auto-ported test: TestPosixWeaklinking::test_symlink (CPython 3.12 oracle)."""
...
_verify_available('HAVE_SYMLINKAT')
if self_mac_ver >= (10, 10):

    assert 'HAVE_SYMLINKAT' in posix._have_functions
else:

    assert 'HAVE_SYMLINKAT' not in posix._have_functions
    try:
...
print("TestPosixWeaklinking::test_symlink: ok")
