...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_spawn__test_setpgroup_wrong_type"
# subject = "cpython.test_posix.TestPosixSpawn.test_setpgroup_wrong_type"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixSpawn::test_setpgroup_wrong_type
"""Auto-ported test: TestPosixSpawn::test_setpgroup_wrong_type (CPython 3.12 oracle)."""
...
try:
    spawn_func(sys.executable, [sys.executable, '-c', 'pass'], os.environ, setpgroup='023')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("TestPosixSpawn::test_setpgroup_wrong_type: ok")
