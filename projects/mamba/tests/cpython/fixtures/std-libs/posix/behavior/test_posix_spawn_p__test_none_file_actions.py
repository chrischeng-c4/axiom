...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_spawn_p__test_none_file_actions"
# subject = "cpython.test_posix.TestPosixSpawnP.test_none_file_actions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixSpawnP::test_none_file_actions
"""Auto-ported test: TestPosixSpawnP::test_none_file_actions (CPython 3.12 oracle)."""
...
pid = spawn_func(NOOP_PROGRAM[0], NOOP_PROGRAM, os.environ, file_actions=None)
support.wait_process(pid, exitcode=0)
print("TestPosixSpawnP::test_none_file_actions: ok")
