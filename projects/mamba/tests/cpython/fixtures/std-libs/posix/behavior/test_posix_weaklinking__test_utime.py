...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_weaklinking__test_utime"
# subject = "cpython.test_posix.TestPosixWeaklinking.test_utime"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixWeaklinking::test_utime
"""Auto-ported test: TestPosixWeaklinking::test_utime (CPython 3.12 oracle)."""
...
_verify_available('HAVE_FUTIMENS')
_verify_available('HAVE_UTIMENSAT')
if self_mac_ver >= (10, 13):

    assert 'HAVE_FUTIMENS' in posix._have_functions

    assert 'HAVE_UTIMENSAT' in posix._have_functions
else:

    assert 'HAVE_FUTIMENS' not in posix._have_functions

    assert 'HAVE_UTIMENSAT' not in posix._have_functions
    try:
...
print("TestPosixWeaklinking::test_utime: ok")
