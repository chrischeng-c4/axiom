...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_spawn__test_resetids"
# subject = "cpython.test_posix.TestPosixSpawn.test_resetids"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixSpawn::test_resetids
"""Auto-ported test: TestPosixSpawn::test_resetids (CPython 3.12 oracle)."""
...
pid = spawn_func(sys.executable, [sys.executable, '-c', 'pass'], os.environ, resetids=True)
support.wait_process(pid, exitcode=0)
print("TestPosixSpawn::test_resetids: ok")
