...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_spawn__test_no_such_executable"
# subject = "cpython.test_posix.TestPosixSpawn.test_no_such_executable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixSpawn::test_no_such_executable
"""Auto-ported test: TestPosixSpawn::test_no_such_executable (CPython 3.12 oracle)."""
...
try:
    pid = spawn_func(no_such_executable, [no_such_executable], os.environ)
except (FileNotFoundError, PermissionError) as exc:

    assert exc.filename == no_such_executable
else:
    ...
    assert status != 0
print("TestPosixSpawn::test_no_such_executable: ok")
