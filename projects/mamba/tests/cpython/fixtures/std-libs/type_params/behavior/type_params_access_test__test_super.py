...
# lib = "type_params"
# dimension = "behavior"
# case = "type_params_access_test__test_super"
# subject = "cpython.test_type_params.TypeParamsAccessTest.test_super"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_params.py::TypeParamsAccessTest::test_super
"""Auto-ported test: TypeParamsAccessTest::test_super (CPython 3.12 oracle)."""
...
assert c.meth(1) == 'basechild'
print("TypeParamsAccessTest::test_super: ok")
