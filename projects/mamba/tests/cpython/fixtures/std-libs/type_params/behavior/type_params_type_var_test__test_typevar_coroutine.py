...
# lib = "type_params"
# dimension = "behavior"
# case = "type_params_type_var_test__test_typevar_coroutine"
# subject = "cpython.test_type_params.TypeParamsTypeVarTest.test_typevar_coroutine"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_params.py::TypeParamsTypeVarTest::test_typevar_coroutine
"""Auto-ported test: TypeParamsTypeVarTest::test_typevar_coroutine (CPython 3.12 oracle)."""
...
assert b.__name__ == 'B'
print("TypeParamsTypeVarTest::test_typevar_coroutine: ok")
