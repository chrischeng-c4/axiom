...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_syntaxerror_unindented_caret_position"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_syntaxerror_unindented_caret_position"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_syntaxerror_unindented_caret_position
"""Auto-ported test: CmdLineTest::test_syntaxerror_unindented_caret_position (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir:
    ...
    assert '\n    ^^^^^\n' in text
print("CmdLineTest::test_syntaxerror_unindented_caret_position: ok")
