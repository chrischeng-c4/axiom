...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_package_recursion"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_package_recursion"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_package_recursion
"""Auto-ported test: CmdLineTest::test_package_recursion (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir:
    ...
    _check_import_error(['-m', 'test_pkg'], msg, cwd=script_dir)
print("CmdLineTest::test_package_recursion: ok")
