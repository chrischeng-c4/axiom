...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_syntaxerror_invalid_escape_sequence_multi_line"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_syntaxerror_invalid_escape_sequence_multi_line"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_syntaxerror_invalid_escape_sequence_multi_line
"""Auto-ported test: CmdLineTest::test_syntaxerror_invalid_escape_sequence_multi_line (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir:
    ...
    assert stderr.splitlines()[-3:] == [b'    foo = """\\q"""', b'             ^^', b"SyntaxError: invalid escape sequence '\\q'"]
print("CmdLineTest::test_syntaxerror_invalid_escape_sequence_multi_line: ok")
