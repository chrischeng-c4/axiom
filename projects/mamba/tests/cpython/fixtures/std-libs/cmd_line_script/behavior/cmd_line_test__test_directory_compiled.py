...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_directory_compiled"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_directory_compiled"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_directory_compiled
"""Auto-ported test: CmdLineTest::test_directory_compiled (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir:
    ...
    _check_script(script_dir, pyc_file, script_dir, script_dir, '', importlib.machinery.SourcelessFileLoader)
print("CmdLineTest::test_directory_compiled: ok")
