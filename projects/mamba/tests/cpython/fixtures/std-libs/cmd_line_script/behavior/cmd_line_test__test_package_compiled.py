...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_package_compiled"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_package_compiled"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_package_compiled
"""Auto-ported test: CmdLineTest::test_package_compiled (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir:
    ...
    _check_script(['-m', 'test_pkg'], pyc_file, pyc_file, script_dir, 'test_pkg', importlib.machinery.SourcelessFileLoader, cwd=script_dir)
print("CmdLineTest::test_package_compiled: ok")
