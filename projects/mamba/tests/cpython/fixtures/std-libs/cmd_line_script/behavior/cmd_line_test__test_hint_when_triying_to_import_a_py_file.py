...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_hint_when_triying_to_import_a_py_file"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_hint_when_triying_to_import_a_py_file"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_hint_when_triying_to_import_a_py_file
"""Auto-ported test: CmdLineTest::test_hint_when_triying_to_import_a_py_file (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir, os_helper.change_cwd(path=script_dir):
    with open('asyncio.py', 'wb'):
        pass
    err = check_dash_m_failure('asyncio.py')

    assert b"Try using 'asyncio' instead of 'asyncio.py' as the module name" in err
print("CmdLineTest::test_hint_when_triying_to_import_a_py_file: ok")
