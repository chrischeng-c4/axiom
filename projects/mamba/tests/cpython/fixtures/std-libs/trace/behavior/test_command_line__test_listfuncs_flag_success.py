...
# lib = "trace"
# dimension = "behavior"
# case = "test_command_line__test_listfuncs_flag_success"
# subject = "cpython.test_trace.TestCommandLine.test_listfuncs_flag_success"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestCommandLine::test_listfuncs_flag_success
"""Auto-ported test: TestCommandLine::test_listfuncs_flag_success (CPython 3.12 oracle)."""
...
with open(filename, 'w', encoding='utf-8') as fd:
    ...
    assert b'functions called:' in stdout
    expected = f'filename: {filename}, modulename: {modulename}, funcname: <module>'

    assert expected.encode() in stdout
print("TestCommandLine::test_listfuncs_flag_success: ok")
