...
# lib = "trace"
# dimension = "behavior"
# case = "test_line_counts__test_traced_func_importing"
# subject = "cpython.test_trace.TestLineCounts.test_traced_func_importing"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestLineCounts::test_traced_func_importing
"""Auto-ported test: TestLineCounts::test_traced_func_importing (CPython 3.12 oracle)."""
...
self_tracer.runfunc(traced_func_importing, 2, 5)
firstlineno = get_firstlineno(traced_func_importing)
expected = {(self_my_py_filename, firstlineno + 1): 1, (fix_ext_py(testmod.__file__), 2): 1, (fix_ext_py(testmod.__file__), 3): 1}

assert self_tracer.results().counts == expected
print("TestLineCounts::test_traced_func_importing: ok")
