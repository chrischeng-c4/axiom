...
# lib = "trace"
# dimension = "behavior"
# case = "test_coverage__test_coverage"
# subject = "cpython.test_trace.TestCoverage.test_coverage"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestCoverage::test_coverage
"""Auto-ported test: TestCoverage::test_coverage (CPython 3.12 oracle)."""
...
assert 'pprint.py' in stdout

assert 'case.py' in stdout
files = os.listdir(TESTFN)

assert 'pprint.cover' in files

assert 'unittest.case.cover' in files
print("TestCoverage::test_coverage: ok")
