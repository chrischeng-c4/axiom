...
# lib = "trace"
# dimension = "behavior"
# case = "test_run_exec_counts__test_exec_counts"
# subject = "cpython.test_trace.TestRunExecCounts.test_exec_counts"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestRunExecCounts::test_exec_counts
"""Auto-ported test: TestRunExecCounts::test_exec_counts (CPython 3.12 oracle)."""
...
self_tracer.runctx(code, globals(), vars())
...
for k in expected.keys():
    ...
    assert self_tracer.results().counts[k] == expected[k]
print("TestRunExecCounts::test_exec_counts: ok")
