...
# lib = "trace"
# dimension = "behavior"
# case = "test_coverage__test_coverage_ignore"
# subject = "cpython.test_trace.TestCoverage.test_coverage_ignore"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestCoverage::test_coverage_ignore
"""Auto-ported test: TestCoverage::test_coverage_ignore (CPython 3.12 oracle)."""
...
tracer = trace.Trace(ignoredirs=[sys.base_prefix, sys.base_exec_prefix, libpath] + sys.path, trace=0, count=1)
with captured_stdout() as stdout:
    _coverage(tracer)
if os.path.exists(TESTFN):
    files = os.listdir(TESTFN)

    assert files == ['_importlib.cover']
print("TestCoverage::test_coverage_ignore: ok")
