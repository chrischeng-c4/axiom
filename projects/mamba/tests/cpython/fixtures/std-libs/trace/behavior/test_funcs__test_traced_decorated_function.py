...
# lib = "trace"
# dimension = "behavior"
# case = "test_funcs__test_traced_decorated_function"
# subject = "cpython.test_trace.TestFuncs.test_traced_decorated_function"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestFuncs::test_traced_decorated_function
"""Auto-ported test: TestFuncs::test_traced_decorated_function (CPython 3.12 oracle)."""
...
self_tracer.runfunc(traced_decorated_function)
expected = {self_filemod + ('traced_decorated_function',): 1, self_filemod + ('decorator_fabric',): 1, self_filemod + ('decorator2',): 1, self_filemod + ('decorator1',): 1, self_filemod + ('func',): 1}

assert self_tracer.results().calledfuncs == expected
print("TestFuncs::test_traced_decorated_function: ok")
