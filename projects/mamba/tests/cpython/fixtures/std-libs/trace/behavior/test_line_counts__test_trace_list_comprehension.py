...
# lib = "trace"
# dimension = "behavior"
# case = "test_line_counts__test_trace_list_comprehension"
# subject = "cpython.test_trace.TestLineCounts.test_trace_list_comprehension"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestLineCounts::test_trace_list_comprehension
"""Auto-ported test: TestLineCounts::test_trace_list_comprehension (CPython 3.12 oracle)."""
...
self_tracer.runfunc(traced_caller_list_comprehension)
firstlineno_calling = get_firstlineno(traced_caller_list_comprehension)
firstlineno_called = get_firstlineno(traced_doubler)
expected = {(self_my_py_filename, firstlineno_calling + 1): 1, (self_my_py_filename, firstlineno_calling + 2): 11, (self_my_py_filename, firstlineno_calling + 3): 1, (self_my_py_filename, firstlineno_called + 1): 10}

assert self_tracer.results().counts == expected
print("TestLineCounts::test_trace_list_comprehension: ok")
