...
# lib = "trace"
# dimension = "behavior"
# case = "test_line_counts__test_traced_func_linear"
# subject = "cpython.test_trace.TestLineCounts.test_traced_func_linear"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestLineCounts::test_traced_func_linear
"""Auto-ported test: TestLineCounts::test_traced_func_linear (CPython 3.12 oracle)."""
...
result = self_tracer.runfunc(traced_func_linear, 2, 5)

assert result == 7
expected = {}
firstlineno = get_firstlineno(traced_func_linear)
for i in range(1, 5):
    expected[self_my_py_filename, firstlineno + i] = 1

assert self_tracer.results().counts == expected
print("TestLineCounts::test_traced_func_linear: ok")
