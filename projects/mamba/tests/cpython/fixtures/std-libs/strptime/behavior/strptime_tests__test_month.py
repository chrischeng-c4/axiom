...
# lib = "strptime"
# dimension = "behavior"
# case = "strptime_tests__test_month"
# subject = "cpython.test_strptime.StrptimeTests.test_month"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_strptime.py::StrptimeTests::test_month
"""Auto-ported test: StrptimeTests::test_month (CPython 3.12 oracle)."""
...
roundtrip('%m', 1)
print("StrptimeTests::test_month: ok")
