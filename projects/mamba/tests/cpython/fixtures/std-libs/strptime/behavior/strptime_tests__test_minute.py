...
# lib = "strptime"
# dimension = "behavior"
# case = "strptime_tests__test_minute"
# subject = "cpython.test_strptime.StrptimeTests.test_minute"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_strptime.py::StrptimeTests::test_minute
"""Auto-ported test: StrptimeTests::test_minute (CPython 3.12 oracle)."""
...
roundtrip('%M', 4)
print("StrptimeTests::test_minute: ok")
