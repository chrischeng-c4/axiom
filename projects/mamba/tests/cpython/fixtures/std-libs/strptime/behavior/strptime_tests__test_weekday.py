...
# lib = "strptime"
# dimension = "behavior"
# case = "strptime_tests__test_weekday"
# subject = "cpython.test_strptime.StrptimeTests.test_weekday"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_strptime.py::StrptimeTests::test_weekday
"""Auto-ported test: StrptimeTests::test_weekday (CPython 3.12 oracle)."""
...
roundtrip('%w', 6)
roundtrip('%u', 6)
print("StrptimeTests::test_weekday: ok")
