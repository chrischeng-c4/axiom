...
# lib = "strptime"
# dimension = "behavior"
# case = "strptime_tests__test_hour"
# subject = "cpython.test_strptime.StrptimeTests.test_hour"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_strptime.py::StrptimeTests::test_hour
"""Auto-ported test: StrptimeTests::test_hour (CPython 3.12 oracle)."""
...
roundtrip('%H', 3)
print("StrptimeTests::test_hour: ok")
