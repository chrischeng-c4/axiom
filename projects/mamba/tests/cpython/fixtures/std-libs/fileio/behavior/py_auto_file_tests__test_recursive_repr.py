...
# lib = "fileio"
# dimension = "behavior"
# case = "py_auto_file_tests__test_recursive_repr"
# subject = "cpython.test_fileio.PyAutoFileTests.testRecursiveRepr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileio.py::PyAutoFileTests::testRecursiveRepr
"""Auto-ported test: PyAutoFileTests::testRecursiveRepr (CPython 3.12 oracle)."""
...
with swap_attr(self_f, 'name', self_f):
    try:
        ...
        pass
print("PyAutoFileTests::testRecursiveRepr: ok")
