...
# lib = "statistics"
# dimension = "behavior"
# case = "approx_equal_symmetry_test__test_relative_symmetry"
# subject = "cpython.test_statistics.ApproxEqualSymmetryTest.test_relative_symmetry"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::ApproxEqualSymmetryTest::test_relative_symmetry
"""Auto-ported test: ApproxEqualSymmetryTest::test_relative_symmetry (CPython 3.12 oracle)."""
...
def do_relative_symmetry(a, b):
    ...
    assert approx_equal(a, b, tol=0, rel=rel)

    assert approx_equal(b, a, tol=0, rel=rel)
...
print("ApproxEqualSymmetryTest::test_relative_symmetry: ok")
