...
# lib = "statistics"
# dimension = "behavior"
# case = "coerce_test__test_incompatible_types"
# subject = "cpython.test_statistics.CoerceTest.test_incompatible_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::CoerceTest::test_incompatible_types
"""Auto-ported test: CoerceTest::test_incompatible_types (CPython 3.12 oracle)."""
...
def assertCoerceRaises(A, B):
    ...
    try:
        statistics._coerce((A, B))
        raise AssertionError('expected TypeError')
    except TypeError:
        pass

    try:
        statistics._coerce((B, A))
        raise AssertionError('expected TypeError')
    except TypeError:
        pass
...
def assertCoerceTo(A, B):
    ...
    assert statistics._coerce(A, B) is B

    assert statistics._coerce(B, A) is B
...
def check_type_coercions(T):
    ...
    assert statistics._coerce(T, T) is T
...
print("CoerceTest::test_incompatible_types: ok")
