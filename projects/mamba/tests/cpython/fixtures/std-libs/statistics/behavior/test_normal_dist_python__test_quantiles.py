...
# lib = "statistics"
# dimension = "behavior"
# case = "test_normal_dist_python__test_quantiles"
# subject = "cpython.test_statistics.TestNormalDistPython.test_quantiles"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::TestNormalDistPython::test_quantiles
"""Auto-ported test: TestNormalDistPython::test_quantiles (CPython 3.12 oracle)."""
...
for n, expected in [(1, []), (2, [0.0]), (3, [-0.4307, 0.4307]), (4, [-0.6745, 0.0, 0.6745])]:
    ...
    assert all((math.isclose(e, a, abs_tol=0.0001) for e, a in zip(expected, actual)))
print("TestNormalDistPython::test_quantiles: ok")
