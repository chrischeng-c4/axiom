...
# lib = "statistics"
# dimension = "behavior"
# case = "approx_equal_inexact_test__test_approx_equal_absolute_decimals"
# subject = "cpython.test_statistics.ApproxEqualInexactTest.test_approx_equal_absolute_decimals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::ApproxEqualInexactTest::test_approx_equal_absolute_decimals
"""Auto-ported test: ApproxEqualInexactTest::test_approx_equal_absolute_decimals (CPython 3.12 oracle)."""
...
for d in map(Decimal, '1.0 3.5 36.08 61.79 7912.3648'.split()):
    ...
    do_approx_equal_abs_test(-d, delta)
print("ApproxEqualInexactTest::test_approx_equal_absolute_decimals: ok")
