...
# lib = "statistics"
# dimension = "behavior"
# case = "test_normal_dist_python__test_zscore"
# subject = "cpython.test_statistics.TestNormalDistPython.test_zscore"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::TestNormalDistPython::test_zscore
"""Auto-ported test: TestNormalDistPython::test_zscore (CPython 3.12 oracle)."""
...
assert X.zscore(142) == 2.8

assert X.zscore(58) == -2.8

assert X.zscore(100) == 0.0
try:
    X.zscore()
...
try:
    ...
    pass
print("TestNormalDistPython::test_zscore: ok")
