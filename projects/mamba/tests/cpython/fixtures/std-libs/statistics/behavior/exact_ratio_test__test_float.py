...
# lib = "statistics"
# dimension = "behavior"
# case = "exact_ratio_test__test_float"
# subject = "cpython.test_statistics.ExactRatioTest.test_float"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::ExactRatioTest::test_float
"""Auto-ported test: ExactRatioTest::test_float (CPython 3.12 oracle)."""
...
assert statistics._exact_ratio(0.125) == (1, 8)

assert statistics._exact_ratio(1.125) == (9, 8)
data = [random.uniform(-100, 100) for _ in range(100)]
for x in data:
    num, den = statistics._exact_ratio(x)

    assert x == num / den
print("ExactRatioTest::test_float: ok")
