...
# lib = "statistics"
# dimension = "behavior"
# case = "fail_neg_test__test_pass_through"
# subject = "cpython.test_statistics.FailNegTest.test_pass_through"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::FailNegTest::test_pass_through
"""Auto-ported test: FailNegTest::test_pass_through (CPython 3.12 oracle)."""
...
assert values == new
print("FailNegTest::test_pass_through: ok")
