...
# lib = "statistics"
# dimension = "behavior"
# case = "test_normal_dist_c__test_translation_and_scaling"
# subject = "cpython.test_statistics.TestNormalDistC.test_translation_and_scaling"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::TestNormalDistC::test_translation_and_scaling
"""Auto-ported test: TestNormalDistC::test_translation_and_scaling (CPython 3.12 oracle)."""
...
assert +X == NormalDist(100, 15)

assert -X == NormalDist(-100, 15)

assert X + y == NormalDist(110, 15)

assert y + X == NormalDist(110, 15)

assert X - y == NormalDist(90, 15)

assert y - X == NormalDist(-90, 15)

assert X * y == NormalDist(1000, 150)

assert y * X == NormalDist(1000, 150)

assert X / y == NormalDist(10, 1.5)
try:
    y / X
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("TestNormalDistC::test_translation_and_scaling: ok")
