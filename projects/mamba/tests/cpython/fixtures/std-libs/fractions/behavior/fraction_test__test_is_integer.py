...
# lib = "fractions"
# dimension = "behavior"
# case = "fraction_test__test_is_integer"
# subject = "cpython.test_fractions.FractionTest.test_is_integer"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fractions.py::FractionTest::test_is_integer
"""Auto-ported test: FractionTest::test_is_integer (CPython 3.12 oracle)."""
...
assert F(1, 1).is_integer()

assert F(-1, 1).is_integer()

assert F(1, -1).is_integer()

assert F(2, 2).is_integer()

assert F(-2, 2).is_integer()

assert F(2, -2).is_integer()

assert not F(1, 2).is_integer()
...
assert not F(-1, -2).is_integer()
print("FractionTest::test_is_integer: ok")
