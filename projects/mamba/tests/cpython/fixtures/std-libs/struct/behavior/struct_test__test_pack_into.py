...
# lib = "struct"
# dimension = "behavior"
# case = "struct_test__test_pack_into"
# subject = "cpython.test_struct.StructTest.test_pack_into"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_struct.py::StructTest::test_pack_into
"""Auto-ported test: StructTest::test_pack_into (CPython 3.12 oracle)."""
...
try:
    struct.pack_into(b'', sb, None)
    raise AssertionError('expected (TypeError, struct.error)')
except (TypeError, struct.error):
    pass
print("StructTest::test_pack_into: ok")
