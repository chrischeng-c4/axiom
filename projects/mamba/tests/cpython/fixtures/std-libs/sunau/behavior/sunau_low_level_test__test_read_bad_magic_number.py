...
# lib = "sunau"
# dimension = "behavior"
# case = "sunau_low_level_test__test_read_bad_magic_number"
# subject = "cpython.test_sunau.SunauLowLevelTest.test_read_bad_magic_number"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sunau.py::SunauLowLevelTest::test_read_bad_magic_number
"""Auto-ported test: SunauLowLevelTest::test_read_bad_magic_number (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('bad magic number', str(_aR_e))
print("SunauLowLevelTest::test_read_bad_magic_number: ok")
