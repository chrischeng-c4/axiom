...
# lib = "sunau"
# dimension = "behavior"
# case = "sunau_low_level_test__test_read_too_small_header"
# subject = "cpython.test_sunau.SunauLowLevelTest.test_read_too_small_header"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sunau.py::SunauLowLevelTest::test_read_too_small_header
"""Auto-ported test: SunauLowLevelTest::test_read_too_small_header (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('header size too small', str(_aR_e))
print("SunauLowLevelTest::test_read_too_small_header: ok")
