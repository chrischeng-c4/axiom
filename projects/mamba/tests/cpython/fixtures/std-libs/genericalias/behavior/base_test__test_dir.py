...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_dir"
# subject = "cpython.test_genericalias.BaseTest.test_dir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_dir
"""Auto-ported test: BaseTest::test_dir (CPython 3.12 oracle)."""
...
assert dir_of_gen_alias.issuperset(dir(list))
for generic_alias_property in ('__origin__', '__args__', '__parameters__'):

    assert generic_alias_property in dir_of_gen_alias
print("BaseTest::test_dir: ok")
