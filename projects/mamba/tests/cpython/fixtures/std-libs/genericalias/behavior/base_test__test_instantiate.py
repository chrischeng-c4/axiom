...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_instantiate"
# subject = "cpython.test_genericalias.BaseTest.test_instantiate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_instantiate
"""Auto-ported test: BaseTest::test_instantiate (CPython 3.12 oracle)."""
...
for t in (tuple, list, dict, set, frozenset, defaultdict, deque):
    ...
    if t is dict:
        ...
        assert alias(iter([('a', 1), ('b', 2)])) == dict(a=1, b=2)

        assert alias(a=1, b=2) == dict(a=1, b=2)
        ...
        assert a['test'] == d['test']
    else:

        assert alias(iter((1, 2, 3))) == t((1, 2, 3))
print("BaseTest::test_instantiate: ok")
