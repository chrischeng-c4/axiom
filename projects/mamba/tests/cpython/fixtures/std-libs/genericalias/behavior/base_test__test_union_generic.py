...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_union_generic"
# subject = "cpython.test_genericalias.BaseTest.test_union_generic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_union_generic
"""Auto-ported test: BaseTest::test_union_generic (CPython 3.12 oracle)."""
...
assert a.__args__ == (list[T], tuple[T, ...])

assert a.__parameters__ == (T,)
print("BaseTest::test_union_generic: ok")
