...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_union"
# subject = "cpython.test_genericalias.BaseTest.test_union"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_union
"""Auto-ported test: BaseTest::test_union (CPython 3.12 oracle)."""
...
assert a.__args__ == (list[int], list[str])

assert a.__parameters__ == ()
print("BaseTest::test_union: ok")
