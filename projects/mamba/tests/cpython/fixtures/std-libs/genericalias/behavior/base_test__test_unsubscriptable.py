...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_unsubscriptable"
# subject = "cpython.test_genericalias.BaseTest.test_unsubscriptable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_unsubscriptable
"""Auto-ported test: BaseTest::test_unsubscriptable (CPython 3.12 oracle)."""
...
for t in (int, str, float, Sized, Hashable):
    ...
    try:
        ...
        import re as _re_aR
        assert _re_aR.search(tname, str(_aR_e))
print("BaseTest::test_unsubscriptable: ok")
