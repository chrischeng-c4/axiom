...
# subject = "cpython.test_property.PropertyTests.test_property_decorator_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_property.py::PropertyTests::test_property_decorator_subclass
