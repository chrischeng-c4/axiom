...
# lib = "cprofile"
# dimension = "behavior"
# case = "c_profile_test__test_bad_counter_during_dealloc"
# subject = "cpython.test_cprofile.CProfileTest.test_bad_counter_during_dealloc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cprofile.py::CProfileTest::test_bad_counter_during_dealloc
"""Auto-ported test: CProfileTest::test_bad_counter_during_dealloc (CPython 3.12 oracle)."""
...
with support.catch_unraisable_exception() as cm:
    ...
    assert cm.unraisable.exc_type == TypeError
print("CProfileTest::test_bad_counter_during_dealloc: ok")
