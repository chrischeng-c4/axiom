...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_non_standard_default_section__test_add_section_default"
# subject = "cpython.test_configparser.ConfigParserTestCaseNonStandardDefaultSection.test_add_section_default"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNonStandardDefaultSection::test_add_section_default
"""Auto-ported test: ConfigParserTestCaseNonStandardDefaultSection::test_add_section_default (CPython 3.12 oracle)."""
...
try:
    cf.add_section(default_section)
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("ConfigParserTestCaseNonStandardDefaultSection::test_add_section_default: ok")
