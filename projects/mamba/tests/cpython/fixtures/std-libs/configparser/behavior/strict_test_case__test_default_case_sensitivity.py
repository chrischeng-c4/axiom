...
# lib = "configparser"
# dimension = "behavior"
# case = "strict_test_case__test_default_case_sensitivity"
# subject = "cpython.test_configparser.StrictTestCase.test_default_case_sensitivity"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::StrictTestCase::test_default_case_sensitivity
"""Auto-ported test: StrictTestCase::test_default_case_sensitivity (CPython 3.12 oracle)."""
...
assert cf.get(default_section, 'Foo') == 'Bar'
print("StrictTestCase::test_default_case_sensitivity: ok")
