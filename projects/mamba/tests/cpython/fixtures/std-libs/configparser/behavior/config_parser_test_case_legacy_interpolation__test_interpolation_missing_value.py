...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_legacy_interpolation__test_interpolation_missing_value"
# subject = "cpython.test_configparser.ConfigParserTestCaseLegacyInterpolation.test_interpolation_missing_value"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseLegacyInterpolation::test_interpolation_missing_value
"""Auto-ported test: ConfigParserTestCaseLegacyInterpolation::test_interpolation_missing_value (CPython 3.12 oracle)."""
...
if interpolation == configparser._UNSET:
    ...
    assert e.args == ('name', 'Interpolation Error', '%(reference)s', 'reference')
print("ConfigParserTestCaseLegacyInterpolation::test_interpolation_missing_value: ok")
