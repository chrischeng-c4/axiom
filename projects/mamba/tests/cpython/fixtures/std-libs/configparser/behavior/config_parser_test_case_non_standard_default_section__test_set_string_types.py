...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_non_standard_default_section__test_set_string_types"
# subject = "cpython.test_configparser.ConfigParserTestCaseNonStandardDefaultSection.test_set_string_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNonStandardDefaultSection::test_set_string_types
"""Auto-ported test: ConfigParserTestCaseNonStandardDefaultSection::test_set_string_types (CPython 3.12 oracle)."""
...
cf.set('sect', 'option1', 'splat')
cf.set('sect', 'option2', 'splat')
print("ConfigParserTestCaseNonStandardDefaultSection::test_set_string_types: ok")
