...
# lib = "configparser"
# dimension = "behavior"
# case = "strict_test_case__test_set_string_types"
# subject = "cpython.test_configparser.StrictTestCase.test_set_string_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::StrictTestCase::test_set_string_types
"""Auto-ported test: StrictTestCase::test_set_string_types (CPython 3.12 oracle)."""
...
cf.set('sect', 'option1', 'splat')
cf.set('sect', 'option2', 'splat')
print("StrictTestCase::test_set_string_types: ok")
