...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_extended_interpolation__test_strange_options"
# subject = "cpython.test_configparser.ConfigParserTestCaseExtendedInterpolation.test_strange_options"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseExtendedInterpolation::test_strange_options
"""Auto-ported test: ConfigParserTestCaseExtendedInterpolation::test_strange_options (CPython 3.12 oracle)."""
...
assert cf['dollars']['$var'] == '$value'

assert cf['interpolated']['$other'] == '$value'

assert cf['dollars']['${sick}'] == 'cannot interpolate me'
exception_class = configparser.InterpolationMissingOptionError
try:
    cf['interpolated']['$trying']
    raise AssertionError('expected exception_class')
except exception_class as _aR_e:
    import types as _types_aR
    cm = _types_aR.SimpleNamespace(exception=_aR_e)

assert cm.exception.reference == 'dollars:${sick'

assert cm.exception.args[2] == '${dollars:${sick}}'
print("ConfigParserTestCaseExtendedInterpolation::test_strange_options: ok")
