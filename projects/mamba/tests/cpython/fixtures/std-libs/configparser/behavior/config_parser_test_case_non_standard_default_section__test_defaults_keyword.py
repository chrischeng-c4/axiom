...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_non_standard_default_section__test_defaults_keyword"
# subject = "cpython.test_configparser.ConfigParserTestCaseNonStandardDefaultSection.test_defaults_keyword"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNonStandardDefaultSection::test_defaults_keyword
"""Auto-ported test: ConfigParserTestCaseNonStandardDefaultSection::test_defaults_keyword (CPython 3.12 oracle)."""
...
cf = newconfig(defaults={1: 2.4})

assert cf[default_section]['1'] == '2.4'

assert abs(cf[default_section].getfloat('1') - 2.4) < 1e-07
cf = newconfig(defaults={'A': 5.2})

assert cf[default_section]['a'] == '5.2'

assert abs(cf[default_section].getfloat('a') - 5.2) < 1e-07
print("ConfigParserTestCaseNonStandardDefaultSection::test_defaults_keyword: ok")
