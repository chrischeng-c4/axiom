...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_no_interpolation__test_clear"
# subject = "cpython.test_configparser.ConfigParserTestCaseNoInterpolation.test_clear"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNoInterpolation::test_clear
"""Auto-ported test: ConfigParserTestCaseNoInterpolation::test_clear (CPython 3.12 oracle)."""
...
assert cf.sections() == ['zing']

assert set(cf['zing'].keys()) == {'option1', 'option2', 'foo'}
cf.clear()

assert set(cf.sections()) == set()

assert set(cf[default_section].keys()) == {'foo'}
print("ConfigParserTestCaseNoInterpolation::test_clear: ok")
