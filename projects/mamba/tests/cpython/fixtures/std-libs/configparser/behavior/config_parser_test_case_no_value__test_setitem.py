...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_no_value__test_setitem"
# subject = "cpython.test_configparser.ConfigParserTestCaseNoValue.test_setitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNoValue::test_setitem
"""Auto-ported test: ConfigParserTestCaseNoValue::test_setitem (CPython 3.12 oracle)."""
...
assert set(cf['section2'].keys()) == {'name22'}
print("ConfigParserTestCaseNoValue::test_setitem: ok")
