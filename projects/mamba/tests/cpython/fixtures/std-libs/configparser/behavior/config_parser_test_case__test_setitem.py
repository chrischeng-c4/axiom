...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case__test_setitem"
# subject = "cpython.test_configparser.ConfigParserTestCase.test_setitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCase::test_setitem
"""Auto-ported test: ConfigParserTestCase::test_setitem (CPython 3.12 oracle)."""
...
assert set(cf['section2'].keys()) == {'name22'}
print("ConfigParserTestCase::test_setitem: ok")
