...
# lib = "configparser"
# dimension = "behavior"
# case = "raw_config_parser_test_case_non_standard_delimiters__test_set_string_types"
# subject = "cpython.test_configparser.RawConfigParserTestCaseNonStandardDelimiters.test_set_string_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::RawConfigParserTestCaseNonStandardDelimiters::test_set_string_types
"""Auto-ported test: RawConfigParserTestCaseNonStandardDelimiters::test_set_string_types (CPython 3.12 oracle)."""
...
cf.set('sect', 'option1', 'splat')
cf.set('sect', 'option2', 'splat')
print("RawConfigParserTestCaseNonStandardDelimiters::test_set_string_types: ok")
