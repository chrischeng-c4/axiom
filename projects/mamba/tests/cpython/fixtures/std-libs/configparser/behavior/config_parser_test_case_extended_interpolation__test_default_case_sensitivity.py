...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_extended_interpolation__test_default_case_sensitivity"
# subject = "cpython.test_configparser.ConfigParserTestCaseExtendedInterpolation.test_default_case_sensitivity"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseExtendedInterpolation::test_default_case_sensitivity
"""Auto-ported test: ConfigParserTestCaseExtendedInterpolation::test_default_case_sensitivity (CPython 3.12 oracle)."""
...
assert cf.get(default_section, 'Foo') == 'Bar'
print("ConfigParserTestCaseExtendedInterpolation::test_default_case_sensitivity: ok")
