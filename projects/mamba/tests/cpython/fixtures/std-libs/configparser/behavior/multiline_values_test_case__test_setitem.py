...
# lib = "configparser"
# dimension = "behavior"
# case = "multiline_values_test_case__test_setitem"
# subject = "cpython.test_configparser.MultilineValuesTestCase.test_setitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::MultilineValuesTestCase::test_setitem
"""Auto-ported test: MultilineValuesTestCase::test_setitem (CPython 3.12 oracle)."""
...
for i in range(100):
    ...
    cf.add_section(s)
    for j in range(10):
        cf.set(s, 'lovely_spam{}'.format(j), wonderful_spam)
...
assert set(cf['section2'].keys()) == {'name22'}
print("MultilineValuesTestCase::test_setitem: ok")
