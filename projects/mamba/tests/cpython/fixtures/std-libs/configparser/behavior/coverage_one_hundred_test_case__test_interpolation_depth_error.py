...
# lib = "configparser"
# dimension = "behavior"
# case = "coverage_one_hundred_test_case__test_interpolation_depth_error"
# subject = "cpython.test_configparser.CoverageOneHundredTestCase.test_interpolation_depth_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::CoverageOneHundredTestCase::test_interpolation_depth_error
"""Auto-ported test: CoverageOneHundredTestCase::test_interpolation_depth_error (CPython 3.12 oracle)."""
...
assert error.args == ('option', 'section', 'rawval')

assert error.option == 'option'

assert error.section == 'section'
print("CoverageOneHundredTestCase::test_interpolation_depth_error: ok")
