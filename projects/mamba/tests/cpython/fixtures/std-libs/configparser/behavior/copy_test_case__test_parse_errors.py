...
# lib = "configparser"
# dimension = "behavior"
# case = "copy_test_case__test_parse_errors"
# subject = "cpython.test_configparser.CopyTestCase.test_parse_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::CopyTestCase::test_parse_errors
"""Auto-ported test: CopyTestCase::test_parse_errors (CPython 3.12 oracle)."""
...
def fromstring(string, defaults=None):
    ...
    for section in cf_copy.values():
        if section.name == default_section:
            continue
        for default, value in cf[default_section].items():
...
print("CopyTestCase::test_parse_errors: ok")
