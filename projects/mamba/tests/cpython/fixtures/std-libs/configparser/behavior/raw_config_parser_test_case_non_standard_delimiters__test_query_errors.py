...
# lib = "configparser"
# dimension = "behavior"
# case = "raw_config_parser_test_case_non_standard_delimiters__test_query_errors"
# subject = "cpython.test_configparser.RawConfigParserTestCaseNonStandardDelimiters.test_query_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::RawConfigParserTestCaseNonStandardDelimiters::test_query_errors
"""Auto-ported test: RawConfigParserTestCaseNonStandardDelimiters::test_query_errors (CPython 3.12 oracle)."""
...
try:
    ...
    pass
e = get_error(cf, configparser.NoSectionError, 'foo', 'bar')

assert e.args == ('foo',)
cf.add_section('foo')
e = get_error(cf, configparser.NoOptionError, 'foo', 'bar')

assert e.args == ('bar', 'foo')
print("RawConfigParserTestCaseNonStandardDelimiters::test_query_errors: ok")
