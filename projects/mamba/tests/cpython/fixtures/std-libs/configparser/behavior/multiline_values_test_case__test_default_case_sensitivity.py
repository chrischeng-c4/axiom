...
# lib = "configparser"
# dimension = "behavior"
# case = "multiline_values_test_case__test_default_case_sensitivity"
# subject = "cpython.test_configparser.MultilineValuesTestCase.test_default_case_sensitivity"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::MultilineValuesTestCase::test_default_case_sensitivity
"""Auto-ported test: MultilineValuesTestCase::test_default_case_sensitivity (CPython 3.12 oracle)."""
...
assert cf.get(default_section, 'Foo') == 'Bar'
print("MultilineValuesTestCase::test_default_case_sensitivity: ok")
