...
# lib = "configparser"
# dimension = "behavior"
# case = "coverage_one_hundred_test_case__test_parsing_error"
# subject = "cpython.test_configparser.CoverageOneHundredTestCase.test_parsing_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::CoverageOneHundredTestCase::test_parsing_error
"""Auto-ported test: CoverageOneHundredTestCase::test_parsing_error (CPython 3.12 oracle)."""
...
assert error.source == 'source'
print("CoverageOneHundredTestCase::test_parsing_error: ok")
