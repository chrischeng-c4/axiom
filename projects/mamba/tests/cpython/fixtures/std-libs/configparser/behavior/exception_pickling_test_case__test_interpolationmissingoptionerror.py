...
# lib = "configparser"
# dimension = "behavior"
# case = "exception_pickling_test_case__test_interpolationmissingoptionerror"
# subject = "cpython.test_configparser.ExceptionPicklingTestCase.test_interpolationmissingoptionerror"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ExceptionPicklingTestCase::test_interpolationmissingoptionerror
"""Auto-ported test: ExceptionPicklingTestCase::test_interpolationmissingoptionerror (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert e1.section == e2.section

    assert e1.option == e2.option

    assert e1.reference == e2.reference

    assert repr(e1) == repr(e2)
print("ExceptionPicklingTestCase::test_interpolationmissingoptionerror: ok")
