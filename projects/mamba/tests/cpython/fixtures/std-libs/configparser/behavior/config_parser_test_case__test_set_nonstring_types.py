...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case__test_set_nonstring_types"
# subject = "cpython.test_configparser.ConfigParserTestCase.test_set_nonstring_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCase::test_set_nonstring_types
"""Auto-ported test: ConfigParserTestCase::test_set_nonstring_types (CPython 3.12 oracle)."""
...
try:
    cf.set('sect', 'option1', 1)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    cf.set('sect', 'option1', 1.0)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    cf.set('sect', 'option1', object())
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    cf.set('sect', 'option2', 1)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    cf.set('sect', 'option2', 1.0)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    cf.set('sect', 'option2', object())
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    cf.set('sect', 123, 'invalid opt name!')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
try:
    ...
    pass
print("ConfigParserTestCase::test_set_nonstring_types: ok")
