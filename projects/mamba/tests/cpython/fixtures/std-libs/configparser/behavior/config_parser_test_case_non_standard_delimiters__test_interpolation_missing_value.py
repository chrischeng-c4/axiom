...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_non_standard_delimiters__test_interpolation_missing_value"
# subject = "cpython.test_configparser.ConfigParserTestCaseNonStandardDelimiters.test_interpolation_missing_value"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNonStandardDelimiters::test_interpolation_missing_value
"""Auto-ported test: ConfigParserTestCaseNonStandardDelimiters::test_interpolation_missing_value (CPython 3.12 oracle)."""
...
if interpolation == configparser._UNSET:
    ...
    assert e.args == ('name', 'Interpolation Error', '%(reference)s', 'reference')
print("ConfigParserTestCaseNonStandardDelimiters::test_interpolation_missing_value: ok")
