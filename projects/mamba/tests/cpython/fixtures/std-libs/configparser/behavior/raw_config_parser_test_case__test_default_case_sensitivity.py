...
# lib = "configparser"
# dimension = "behavior"
# case = "raw_config_parser_test_case__test_default_case_sensitivity"
# subject = "cpython.test_configparser.RawConfigParserTestCase.test_default_case_sensitivity"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::RawConfigParserTestCase::test_default_case_sensitivity
"""Auto-ported test: RawConfigParserTestCase::test_default_case_sensitivity (CPython 3.12 oracle)."""
...
assert cf.get(default_section, 'Foo') == 'Bar'
print("RawConfigParserTestCase::test_default_case_sensitivity: ok")
