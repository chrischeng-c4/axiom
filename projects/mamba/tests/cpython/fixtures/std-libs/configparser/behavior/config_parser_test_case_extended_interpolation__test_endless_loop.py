...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_extended_interpolation__test_endless_loop"
# subject = "cpython.test_configparser.ConfigParserTestCaseExtendedInterpolation.test_endless_loop"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseExtendedInterpolation::test_endless_loop
"""Auto-ported test: ConfigParserTestCaseExtendedInterpolation::test_endless_loop (CPython 3.12 oracle)."""
...
def parse_error(cf, exc, src):
    ...
    try:
        ...
        cm = _types_aR.SimpleNamespace(exception=_aR_e)
    return cm.exception
cf = fromstring(textwrap.dedent('\n            [one for you]\n            ping = ${one for me:pong}\n\n            [one for me]\n            pong = ${one for you:ping}\n\n            [selfish]\n            me = ${me}\n        ').strip())
try:
    cf['one for you']['ping']
    raise AssertionError('expected configparser.InterpolationDepthError')
...
try:
    ...
    pass
print("ConfigParserTestCaseExtendedInterpolation::test_endless_loop: ok")
