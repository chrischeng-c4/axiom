...
# lib = "htmlparser"
# dimension = "behavior"
# case = "attributes_test_case__test_attr_syntax"
# subject = "cpython.test_htmlparser.AttributesTestCase.test_attr_syntax"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_htmlparser.py::AttributesTestCase::test_attr_syntax
"""Auto-ported test: AttributesTestCase::test_attr_syntax (CPython 3.12 oracle)."""
...
_run_check('<a b=\'v\' c="v" d=v e>', output)
_run_check('<a  b = \'v\' c = "v" d = v e>', output)
_run_check('<a\nb\n=\n\'v\'\nc\n=\n"v"\nd\n=\nv\ne>', output)
_run_check('<a\tb\t=\t\'v\'\tc\t=\t"v"\td\t=\tv\te>', output)
print("AttributesTestCase::test_attr_syntax: ok")
