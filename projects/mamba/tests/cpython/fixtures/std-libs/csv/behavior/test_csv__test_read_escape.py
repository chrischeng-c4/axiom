...
# lib = "csv"
# dimension = "behavior"
# case = "test_csv__test_read_escape"
# subject = "cpython.test_csv.Test_Csv.test_read_escape"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_csv.py::Test_Csv::test_read_escape
"""Auto-ported test: Test_Csv::test_read_escape (CPython 3.12 oracle)."""
...
_read_test(['a,"b,c"\\'], [['a', 'b,c\\']], escapechar='\\')
_read_test(['a,^b,c'], [['a', 'b', 'c']], escapechar='^')
_read_test(['a,\x00b,c'], [['a', 'b', 'c']], escapechar='\x00')
_read_test(['a,\\b,c'], [['a', '\\b', 'c']], escapechar=None)
_read_test(['a,\\b,c'], [['a', '\\b', 'c']])
print("Test_Csv::test_read_escape: ok")
