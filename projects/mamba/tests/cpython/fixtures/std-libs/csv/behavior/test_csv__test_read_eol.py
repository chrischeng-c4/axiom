...
# lib = "csv"
# dimension = "behavior"
# case = "test_csv__test_read_eol"
# subject = "cpython.test_csv.Test_Csv.test_read_eol"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_csv.py::Test_Csv::test_read_eol
"""Auto-ported test: Test_Csv::test_read_eol (CPython 3.12 oracle)."""
...
_read_test(['a,b', 'c,d'], [['a', 'b'], ['c', 'd']])
_read_test(['a,b\n', 'c,d\n'], [['a', 'b'], ['c', 'd']])
_read_test(['a,b\r\n', 'c,d\r\n'], [['a', 'b'], ['c', 'd']])
_read_test(['a,b\r', 'c,d\r'], [['a', 'b'], ['c', 'd']])
errmsg = "with newline=''"
try:
    ...
    import re as _re_aR
    assert _re_aR.search(errmsg, str(_aR_e))
try:
    next(csv.reader(['a,b\nc,d']))
    raise AssertionError('expected csv.Error')
except csv.Error as _aR_e:
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(errmsg, str(_aR_e))
print("Test_Csv::test_read_eol: ok")
