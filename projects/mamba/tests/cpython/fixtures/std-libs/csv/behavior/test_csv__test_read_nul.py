...
# lib = "csv"
# dimension = "behavior"
# case = "test_csv__test_read_nul"
# subject = "cpython.test_csv.Test_Csv.test_read_nul"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_csv.py::Test_Csv::test_read_nul
"""Auto-ported test: Test_Csv::test_read_nul (CPython 3.12 oracle)."""
...
_read_test(['\x00'], [['\x00']])
_read_test(['a,\x00b,c'], [['a', '\x00b', 'c']])
_read_test(['a,b\x00,c'], [['a', 'b\x00', 'c']])
_read_test(['a,b\\\x00,c'], [['a', 'b\x00', 'c']], escapechar='\\')
_read_test(['a,"\x00b",c'], [['a', '\x00b', 'c']])
print("Test_Csv::test_read_nul: ok")
