...
# lib = "csv"
# dimension = "behavior"
# case = "test_csv__test_read_bigfield"
# subject = "cpython.test_csv.Test_Csv.test_read_bigfield"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_csv.py::Test_Csv::test_read_bigfield
"""Auto-ported test: Test_Csv::test_read_bigfield (CPython 3.12 oracle)."""
...
try:
    ...
    _read_test([bigline], [[bigstring, bigstring]])
    ...
    try:
        csv.field_size_limit(None)
        raise AssertionError('expected TypeError')
    except TypeError:
        pass

    try:
        csv.field_size_limit(1, None)
        raise AssertionError('expected TypeError')
    except TypeError:
        pass
finally:
    csv.field_size_limit(limit)
print("Test_Csv::test_read_bigfield: ok")
