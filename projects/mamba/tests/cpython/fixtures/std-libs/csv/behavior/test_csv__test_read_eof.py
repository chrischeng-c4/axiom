...
# lib = "csv"
# dimension = "behavior"
# case = "test_csv__test_read_eof"
# subject = "cpython.test_csv.Test_Csv.test_read_eof"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_csv.py::Test_Csv::test_read_eof
"""Auto-ported test: Test_Csv::test_read_eof (CPython 3.12 oracle)."""
...
try:
    _read_test(['^'], [], escapechar='^', strict=True)
    raise AssertionError('expected csv.Error')
except csv.Error:
    pass
print("Test_Csv::test_read_eof: ok")
