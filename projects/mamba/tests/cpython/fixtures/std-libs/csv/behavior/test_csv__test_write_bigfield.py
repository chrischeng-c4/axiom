...
# lib = "csv"
# dimension = "behavior"
# case = "test_csv__test_write_bigfield"
# subject = "cpython.test_csv.Test_Csv.test_write_bigfield"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_csv.py::Test_Csv::test_write_bigfield
"""Auto-ported test: Test_Csv::test_write_bigfield (CPython 3.12 oracle)."""
...
bigstring = 'X' * 50000
_write_test([bigstring, bigstring], '%s,%s' % (bigstring, bigstring))
print("Test_Csv::test_write_bigfield: ok")
