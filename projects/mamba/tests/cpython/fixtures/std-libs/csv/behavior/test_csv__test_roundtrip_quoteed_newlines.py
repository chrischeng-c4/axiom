...
# lib = "csv"
# dimension = "behavior"
# case = "test_csv__test_roundtrip_quoteed_newlines"
# subject = "cpython.test_csv.Test_Csv.test_roundtrip_quoteed_newlines"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_csv.py::Test_Csv::test_roundtrip_quoteed_newlines
"""Auto-ported test: Test_Csv::test_roundtrip_quoteed_newlines (CPython 3.12 oracle)."""
...
for lineterminator in ('\r\n', '\n', '\r'):
    with TemporaryFile('w+', encoding='utf-8', newline='') as fileobj:
        ...
        for i, row in enumerate(csv.reader(fileobj)):
            ...
            assert row == rows[i]
print("Test_Csv::test_roundtrip_quoteed_newlines: ok")
