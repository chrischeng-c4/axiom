...
# lib = "context"
# dimension = "behavior"
# case = "context_test__test_context_var_new_1"
# subject = "cpython.test_context.ContextTest.test_context_var_new_1"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_context.py::ContextTest::test_context_var_new_1
"""Auto-ported test: ContextTest::test_context_var_new_1 (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('takes exactly 1', str(_aR_e))
try:
    contextvars.ContextVar(1)
    raise AssertionError('expected TypeError')
except TypeError as _aR_e:
    import re as _re_aR
    assert _re_aR.search('must be a str', str(_aR_e))
...
assert hash(c) != hash('aaa')
print("ContextTest::test_context_var_new_1: ok")
