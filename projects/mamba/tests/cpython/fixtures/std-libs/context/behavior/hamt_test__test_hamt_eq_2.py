...
# lib = "context"
# dimension = "behavior"
# case = "hamt_test__test_hamt_eq_2"
# subject = "cpython.test_context.HamtTest.test_hamt_eq_2"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_context.py::HamtTest::test_hamt_eq_2
"""Auto-ported test: HamtTest::test_hamt_eq_2 (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('cannot compare', str(_aR_e))
print("HamtTest::test_hamt_eq_2: ok")
