...
# lib = "gc"
# dimension = "behavior"
# case = "gc_tests__test_boom"
# subject = "cpython.test_gc.GCTests.test_boom"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_gc.py::GCTests::test_boom
"""Auto-ported test: GCTests::test_boom (CPython 3.12 oracle)."""
...
assert len(gc.garbage) == garbagelen
print("GCTests::test_boom: ok")
