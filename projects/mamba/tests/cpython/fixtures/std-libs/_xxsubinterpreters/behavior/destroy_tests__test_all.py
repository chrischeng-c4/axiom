...
# dimension = "behavior"
# case = "destroy_tests__test_all"
# subject = "cpython.test__xxsubinterpreters.DestroyTests.test_all"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxsubinterpreters.py::DestroyTests::test_all
"""Auto-ported test: DestroyTests::test_all (CPython 3.12 oracle)."""
...
assert set(interpreters.list_all()) == before | ids
for id in ids:
    interpreters.destroy(id)

assert set(interpreters.list_all()) == before
print("DestroyTests::test_all: ok")
