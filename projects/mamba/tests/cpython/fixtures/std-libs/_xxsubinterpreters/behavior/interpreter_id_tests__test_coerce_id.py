...
# dimension = "behavior"
# case = "interpreter_id_tests__test_coerce_id"
# subject = "cpython.test__xxsubinterpreters.InterpreterIDTests.test_coerce_id"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxsubinterpreters.py::InterpreterIDTests::test_coerce_id
"""Auto-ported test: InterpreterIDTests::test_coerce_id (CPython 3.12 oracle)."""
...
assert int(id) == 10
print("InterpreterIDTests::test_coerce_id: ok")
