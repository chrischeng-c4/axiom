...
# dimension = "behavior"
# case = "interpreter_id_tests__test_repr"
# subject = "cpython.test__xxsubinterpreters.InterpreterIDTests.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxsubinterpreters.py::InterpreterIDTests::test_repr
"""Auto-ported test: InterpreterIDTests::test_repr (CPython 3.12 oracle)."""
...
assert repr(id) == 'InterpreterID(10)'
print("InterpreterIDTests::test_repr: ok")
