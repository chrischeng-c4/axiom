...
# dimension = "behavior"
# case = "shareable_type_tests__test_strs"
# subject = "cpython.test__xxsubinterpreters.ShareableTypeTests.test_strs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxsubinterpreters.py::ShareableTypeTests::test_strs
"""Auto-ported test: ShareableTypeTests::test_strs (CPython 3.12 oracle)."""
...
_assert_values(['hello world', '你好世界', ''])
print("ShareableTypeTests::test_strs: ok")
