...
# lib = "urllib2"
# dimension = "behavior"
# case = "misc_tests__test_http_error_interface"
# subject = "cpython.test_urllib2.MiscTests.test_HTTPError_interface"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::MiscTests::test_HTTPError_interface
"""Auto-ported test: MiscTests::test_HTTPError_interface (CPython 3.12 oracle)."""
...
assert err.reason == 'something bad happened'

assert hasattr(err, 'headers')

assert err.headers == 'Content-Length: 42'
expected_errmsg = 'HTTP Error %s: %s' % (err.code, err.msg)

assert str(err) == expected_errmsg
expected_errmsg = '<HTTPError %s: %r>' % (err.code, err.msg)

assert repr(err) == expected_errmsg
err.close()
print("MiscTests::test_HTTPError_interface: ok")
