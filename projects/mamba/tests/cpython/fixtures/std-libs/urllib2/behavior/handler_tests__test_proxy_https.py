...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_proxy_https"
# subject = "cpython.test_urllib2.HandlerTests.test_proxy_https"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_proxy_https
"""Auto-ported test: HandlerTests::test_proxy_https (CPython 3.12 oracle)."""
...
assert req.host == 'proxy.example.com:3128'

assert [(handlers[0], 'https_open')] == [tup[0:2] for tup in o.calls]
print("HandlerTests::test_proxy_https: ok")
