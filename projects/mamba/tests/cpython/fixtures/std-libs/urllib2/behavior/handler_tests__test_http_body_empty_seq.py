...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_http_body_empty_seq"
# subject = "cpython.test_urllib2.HandlerTests.test_http_body_empty_seq"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_http_body_empty_seq
"""Auto-ported test: HandlerTests::test_http_body_empty_seq (CPython 3.12 oracle)."""
...
assert req.get_header('Transfer-encoding') == 'chunked'

assert not req.has_header('Content-length')
print("HandlerTests::test_http_body_empty_seq: ok")
