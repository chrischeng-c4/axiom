...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_invalid_closed"
# subject = "cpython.test_urllib2.HandlerTests.test_invalid_closed"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_invalid_closed
"""Auto-ported test: HandlerTests::test_invalid_closed (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('expected http.client.BadStatusLine')
except http.client.BadStatusLine:
    pass

assert conn.fakesock.closed
print("HandlerTests::test_invalid_closed: ok")
