...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_invalid_redirect"
# subject = "cpython.test_urllib2.HandlerTests.test_invalid_redirect"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_invalid_redirect
"""Auto-ported test: HandlerTests::test_invalid_redirect (CPython 3.12 oracle)."""
...
for scheme in invalid_schemes:
    ...
    try:
        h.http_error_302(req, MockFile(), 302, 'Security Loophole', MockHeaders({'location': invalid_url}))
        raise AssertionError('expected urllib.error.HTTPError')
    except urllib.error.HTTPError as _aR_e:
...
print("HandlerTests::test_invalid_redirect: ok")
