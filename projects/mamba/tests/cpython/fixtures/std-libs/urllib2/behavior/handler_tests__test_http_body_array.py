...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_http_body_array"
# subject = "cpython.test_urllib2.HandlerTests.test_http_body_array"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_http_body_array
"""Auto-ported test: HandlerTests::test_http_body_array (CPython 3.12 oracle)."""
...
for headers in ({}, {'Content-Length': 16}):
    ...
    assert int(newreq.get_header('Content-length')) == 16
print("HandlerTests::test_http_body_array: ok")
