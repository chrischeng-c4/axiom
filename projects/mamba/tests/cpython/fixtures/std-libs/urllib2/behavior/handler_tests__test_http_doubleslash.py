...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_http_doubleslash"
# subject = "cpython.test_urllib2.HandlerTests.test_http_doubleslash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_http_doubleslash
"""Auto-ported test: HandlerTests::test_http_doubleslash (CPython 3.12 oracle)."""
...
for ds_url in ds_urls:
    ...
    assert np_ds_req.unredirected_hdrs['Host'] == 'example.com'
    ds_req.set_proxy('someproxy:3128', None)
    p_ds_req = h.do_request_(ds_req)

    assert p_ds_req.unredirected_hdrs['Host'] == 'example.com'
print("HandlerTests::test_http_doubleslash: ok")
