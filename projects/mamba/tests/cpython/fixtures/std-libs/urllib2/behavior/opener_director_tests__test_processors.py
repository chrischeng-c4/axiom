...
# lib = "urllib2"
# dimension = "behavior"
# case = "opener_director_tests__test_processors"
# subject = "cpython.test_urllib2.OpenerDirectorTests.test_processors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::OpenerDirectorTests::test_processors
"""Auto-ported test: OpenerDirectorTests::test_processors (CPython 3.12 oracle)."""
...
for i, (handler, name, args, kwds) in enumerate(o.calls):
    if i < 2:
        ...
        if args[1] is not None:
            ...
            assert isinstance(args[1], MockResponse)
print("OpenerDirectorTests::test_processors: ok")
