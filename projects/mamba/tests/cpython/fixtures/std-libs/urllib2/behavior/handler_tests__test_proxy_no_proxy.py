...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_proxy_no_proxy"
# subject = "cpython.test_urllib2.HandlerTests.test_proxy_no_proxy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_proxy_no_proxy
"""Auto-ported test: HandlerTests::test_proxy_no_proxy (CPython 3.12 oracle)."""
...
assert req.host == 'www.perl.org'
o.open(req)

assert req.host == 'proxy.example.com'
req = Request('http://www.python.org')

assert req.host == 'www.python.org'
o.open(req)

assert req.host == 'www.python.org'
del os.environ['no_proxy']
print("HandlerTests::test_proxy_no_proxy: ok")
