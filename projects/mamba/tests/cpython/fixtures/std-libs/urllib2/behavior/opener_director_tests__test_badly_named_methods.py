...
# lib = "urllib2"
# dimension = "behavior"
# case = "opener_director_tests__test_badly_named_methods"
# subject = "cpython.test_urllib2.OpenerDirectorTests.test_badly_named_methods"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::OpenerDirectorTests::test_badly_named_methods
"""Auto-ported test: OpenerDirectorTests::test_badly_named_methods (CPython 3.12 oracle)."""
...
for scheme in ('do', 'proxy', 'redirect'):
    ...
    try:
        o.open(scheme + '://example.com/')
        raise AssertionError('expected URLError')
    except URLError:
        pass
print("OpenerDirectorTests::test_badly_named_methods: ok")
