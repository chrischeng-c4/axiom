...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_proxy"
# subject = "cpython.test_urllib2.HandlerTests.test_proxy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_proxy
"""Auto-ported test: HandlerTests::test_proxy (CPython 3.12 oracle)."""
...
for d in (dict(http=u), dict(HTTP=u)):
    ...
    assert req.host == 'acme.example.com'
    o.open(req)

    assert req.host == u

    assert [(handlers[0], 'http_open')] == [tup[0:2] for tup in o.calls]
print("HandlerTests::test_proxy: ok")
