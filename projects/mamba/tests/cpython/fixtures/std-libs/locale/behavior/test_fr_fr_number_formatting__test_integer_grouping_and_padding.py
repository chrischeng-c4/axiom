...
# lib = "locale"
# dimension = "behavior"
# case = "test_fr_fr_number_formatting__test_integer_grouping_and_padding"
# subject = "cpython.test_locale.TestFrFRNumberFormatting.test_integer_grouping_and_padding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_locale.py::TestFrFRNumberFormatting::test_integer_grouping_and_padding
"""Auto-ported test: TestFrFRNumberFormatting::test_integer_grouping_and_padding (CPython 3.12 oracle)."""
...
_test_format_string('%4d', 4200, grouping=True, out='4 200')
_test_format_string('%5d', 4200, grouping=True, out='4 200')
_test_format_string('%10d', 4200, grouping=True, out='4 200'.rjust(10))
_test_format_string('%-4d', 4200, grouping=True, out='4 200')
_test_format_string('%-5d', 4200, grouping=True, out='4 200')
_test_format_string('%-10d', 4200, grouping=True, out='4 200'.ljust(10))
print("TestFrFRNumberFormatting::test_integer_grouping_and_padding: ok")
