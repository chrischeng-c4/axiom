...
# lib = "locale"
# dimension = "behavior"
# case = "test_collation__test_strcoll"
# subject = "cpython.test_locale.TestCollation.test_strcoll"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_locale.py::TestCollation::test_strcoll
"""Auto-ported test: TestCollation::test_strcoll (CPython 3.12 oracle)."""
...
assert locale.strcoll('a', 'a') == 0

assert locale.strcoll('b', 'a') > 0
...
try:
    ...
    pass
print("TestCollation::test_strcoll: ok")
