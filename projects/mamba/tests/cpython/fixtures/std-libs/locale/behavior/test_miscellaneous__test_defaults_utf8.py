...
# lib = "locale"
# dimension = "behavior"
# case = "test_miscellaneous__test_defaults_utf8"
# subject = "cpython.test_locale.TestMiscellaneous.test_defaults_UTF8"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_locale.py::TestMiscellaneous::test_defaults_UTF8
"""Auto-ported test: TestMiscellaneous::test_defaults_UTF8 (CPython 3.12 oracle)."""
...
assert locale._parse_localename('UTF-8') == (None, 'UTF-8')
...
try:
    ...
    with check_warnings(('', DeprecationWarning)):
        ...
        assert locale.getdefaultlocale() == (None, 'UTF-8')
finally:
    for k in orig_env:
...
print("TestMiscellaneous::test_defaults_UTF8: ok")
