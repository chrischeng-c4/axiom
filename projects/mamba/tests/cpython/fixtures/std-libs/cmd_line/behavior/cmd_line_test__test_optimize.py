...
# lib = "cmd_line"
# dimension = "behavior"
# case = "cmd_line_test__test_optimize"
# subject = "cpython.test_cmd_line.CmdLineTest.test_optimize"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line.py::CmdLineTest::test_optimize
"""Auto-ported test: CmdLineTest::test_optimize (CPython 3.12 oracle)."""
...
def verify_valid_flag(cmd_line):
    ...
    return out
verify_valid_flag('-O')
verify_valid_flag('-OO')
print("CmdLineTest::test_optimize: ok")
