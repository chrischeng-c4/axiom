...
# lib = "cmd_line"
# dimension = "behavior"
# case = "cmd_line_test__test_no_std_streams"
# subject = "cpython.test_cmd_line.CmdLineTest.test_no_std_streams"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line.py::CmdLineTest::test_no_std_streams
"""Auto-ported test: CmdLineTest::test_no_std_streams (CPython 3.12 oracle)."""
...
def verify_valid_flag(cmd_line):
    ...
    return out
_test_no_stdio(['stdin', 'stdout', 'stderr'])
print("CmdLineTest::test_no_std_streams: ok")
