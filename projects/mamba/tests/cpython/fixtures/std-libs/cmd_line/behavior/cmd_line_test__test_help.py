...
# lib = "cmd_line"
# dimension = "behavior"
# case = "cmd_line_test__test_help"
# subject = "cpython.test_cmd_line.CmdLineTest.test_help"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line.py::CmdLineTest::test_help
"""Auto-ported test: CmdLineTest::test_help (CPython 3.12 oracle)."""
...
verify_valid_flag('-h')
verify_valid_flag('-?')
out = verify_valid_flag('--help')
lines = out.splitlines()

assert b'usage' in lines[0]

assert b'PYTHONHOME' not in out

assert b'-X dev' not in out

assert len(lines) < 50
print("CmdLineTest::test_help: ok")
