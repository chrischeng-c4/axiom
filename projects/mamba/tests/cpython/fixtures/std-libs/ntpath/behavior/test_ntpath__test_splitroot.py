...
# lib = "ntpath"
# dimension = "behavior"
# case = "test_ntpath__test_splitroot"
# subject = "cpython.test_ntpath.TestNtpath.test_splitroot"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ntpath.py::TestNtpath::test_splitroot
"""Auto-ported test: TestNtpath::test_splitroot (CPython 3.12 oracle)."""
...
tester("ntpath.splitroot('\\\\')", ('\\\\', '', ''))
tester("ntpath.splitroot('//')", ('//', '', ''))
tester('ntpath.splitroot("\\\\conky\\mountpoint\\foo\\bar")', ('\\\\conky\\mountpoint', '\\', 'foo\\bar'))
tester('ntpath.splitroot("//conky/mountpoint/foo/bar")', ('//conky/mountpoint', '/', 'foo/bar'))
tester('ntpath.splitroot("\\\\\\conky\\mountpoint\\foo\\bar")', ('\\\\\\conky', '\\', 'mountpoint\\foo\\bar'))
tester('ntpath.splitroot("///conky/mountpoint/foo/bar")', ('///conky', '/', 'mountpoint/foo/bar'))
tester('ntpath.splitroot("\\\\conky\\\\mountpoint\\foo\\bar")', ('\\\\conky\\', '\\', 'mountpoint\\foo\\bar'))
...
assert ntpath.splitroot('//conky/MOUNTPOİNT/foo/bar') == ('//conky/MOUNTPOİNT', '/', 'foo/bar')
tester('ntpath.splitroot("//?/c:")', ('//?/c:', '', ''))
tester('ntpath.splitroot("//./c:")', ('//./c:', '', ''))
tester('ntpath.splitroot("//?/c:/")', ('//?/c:', '/', ''))
...
tester('ntpath.splitroot("//?/VOLUME{00000000-0000-0000-0000-000000000000}/spam")', ('//?/VOLUME{00000000-0000-0000-0000-000000000000}', '/', 'spam'))
...
tester('ntpath.splitroot("//")', ('//', '', ''))
tester('ntpath.splitroot("///")', ('///', '', ''))
tester('ntpath.splitroot("///y")', ('///y', '', ''))
tester('ntpath.splitroot("//x")', ('//x', '', ''))
tester('ntpath.splitroot("//x/")', ('//x/', '', ''))
tester('ntpath.splitroot(" :/foo")', (' :', '/', 'foo'))
tester('ntpath.splitroot("/:/foo")', ('', '/', ':/foo'))
print("TestNtpath::test_splitroot: ok")
