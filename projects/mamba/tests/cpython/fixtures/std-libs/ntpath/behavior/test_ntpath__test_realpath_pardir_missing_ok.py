...
# lib = "ntpath"
# dimension = "behavior"
# case = "test_ntpath__test_realpath_pardir_missing_ok"
# subject = "cpython.test_ntpath.TestNtpath.test_realpath_pardir_missing_ok"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ntpath.py::TestNtpath::test_realpath_pardir_missing_ok
"""Auto-ported test: TestNtpath::test_realpath_pardir_missing_ok (CPython 3.12 oracle)."""
...
tester("ntpath.realpath('..', strict=ALLOW_MISSING)", ntpath.dirname(expected))
tester("ntpath.realpath('../..', strict=ALLOW_MISSING)", ntpath.dirname(ntpath.dirname(expected)))
tester("ntpath.realpath('/'.join(['..'] * 50), strict=ALLOW_MISSING)", ntpath.splitdrive(expected)[0] + '\\')
tester("ntpath.realpath('..\\..', strict=ALLOW_MISSING)", ntpath.dirname(ntpath.dirname(expected)))
tester("ntpath.realpath('\\'.join(['..'] * 50), strict=ALLOW_MISSING)", ntpath.splitdrive(expected)[0] + '\\')
print("TestNtpath::test_realpath_pardir_missing_ok: ok")
