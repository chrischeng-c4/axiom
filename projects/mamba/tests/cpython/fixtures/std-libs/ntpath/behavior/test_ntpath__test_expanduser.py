...
# lib = "ntpath"
# dimension = "behavior"
# case = "test_ntpath__test_expanduser"
# subject = "cpython.test_ntpath.TestNtpath.test_expanduser"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ntpath.py::TestNtpath::test_expanduser
"""Auto-ported test: TestNtpath::test_expanduser (CPython 3.12 oracle)."""
...
with os_helper.EnvironmentVarGuard() as env:
    ...
    tester('ntpath.expanduser("~test")', '~test')
    tester('ntpath.expanduser("~")', 'C:\\Users\\eric')
print("TestNtpath::test_expanduser: ok")
