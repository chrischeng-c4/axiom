...
# subject = "cpython.test_ntpath.PathLikeTests.test_path_commonpath"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ntpath.py::PathLikeTests::test_path_commonpath
...
assertPathEqual(common_path, self_file_name)
