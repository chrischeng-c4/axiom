...
# lib = "ntpath"
# dimension = "behavior"
# case = "path_like_tests__test_path_isdir"
# subject = "cpython.test_ntpath.PathLikeTests.test_path_isdir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ntpath.py::PathLikeTests::test_path_isdir
"""Auto-ported test: PathLikeTests::test_path_isdir (CPython 3.12 oracle)."""
...
_check_function(path.isdir)
print("PathLikeTests::test_path_isdir: ok")
