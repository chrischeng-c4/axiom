...
# lib = "ntpath"
# dimension = "behavior"
# case = "test_ntpath__test_realpath_curdir_strict"
# subject = "cpython.test_ntpath.TestNtpath.test_realpath_curdir_strict"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ntpath.py::TestNtpath::test_realpath_curdir_strict
"""Auto-ported test: TestNtpath::test_realpath_curdir_strict (CPython 3.12 oracle)."""
...
tester("ntpath.realpath('.\\.', strict=True)", expected)
tester("ntpath.realpath('\\'.join(['.'] * 100), strict=True)", expected)
print("TestNtpath::test_realpath_curdir_strict: ok")
