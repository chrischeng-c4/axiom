...
# lib = "ntpath"
# dimension = "behavior"
# case = "test_ntpath__test_realpath_pardir"
# subject = "cpython.test_ntpath.TestNtpath.test_realpath_pardir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ntpath.py::TestNtpath::test_realpath_pardir
"""Auto-ported test: TestNtpath::test_realpath_pardir (CPython 3.12 oracle)."""
...
tester("ntpath.realpath('..\\..')", ntpath.dirname(ntpath.dirname(expected)))
tester("ntpath.realpath('\\'.join(['..'] * 50))", ntpath.splitdrive(expected)[0] + '\\')
print("TestNtpath::test_realpath_pardir: ok")
