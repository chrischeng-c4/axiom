...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_class_inside_conditional"
# subject = "cpython.test_inspect.TestBuggyCases.test_class_inside_conditional"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_class_inside_conditional
"""Auto-ported test: TestBuggyCases::test_class_inside_conditional (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.cls238, 238, 240)
assertSourceEqual(mod2.cls238.cls239, 239, 240)
print("TestBuggyCases::test_class_inside_conditional: ok")
