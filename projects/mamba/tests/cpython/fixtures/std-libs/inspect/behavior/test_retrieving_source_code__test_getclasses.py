...
# lib = "inspect"
# dimension = "behavior"
# case = "test_retrieving_source_code__test_getclasses"
# subject = "cpython.test_inspect.TestRetrievingSourceCode.test_getclasses"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestRetrievingSourceCode::test_getclasses
"""Auto-ported test: TestRetrievingSourceCode::test_getclasses (CPython 3.12 oracle)."""
...
assert classes == [('FesteringGob', mod.FesteringGob), ('MalodorousPervert', mod.MalodorousPervert), ('ParrotDroppings', mod.ParrotDroppings), ('StupidGit', mod.StupidGit), ('Tit', mod.MalodorousPervert), ('WhichComments', mod.WhichComments)]
tree = inspect.getclasstree([cls[1] for cls in classes])

assert tree == [(object, ()), [(mod.ParrotDroppings, (object,)), [(mod.FesteringGob, (mod.MalodorousPervert, mod.ParrotDroppings))], (mod.StupidGit, (object,)), [(mod.MalodorousPervert, (mod.StupidGit,)), [(mod.FesteringGob, (mod.MalodorousPervert, mod.ParrotDroppings))]], (mod.WhichComments, (object,))]]
tree = inspect.getclasstree([cls[1] for cls in classes], True)

assert tree == [(object, ()), [(mod.ParrotDroppings, (object,)), (mod.StupidGit, (object,)), [(mod.MalodorousPervert, (mod.StupidGit,)), [(mod.FesteringGob, (mod.MalodorousPervert, mod.ParrotDroppings))]], (mod.WhichComments, (object,))]]
print("TestRetrievingSourceCode::test_getclasses: ok")
