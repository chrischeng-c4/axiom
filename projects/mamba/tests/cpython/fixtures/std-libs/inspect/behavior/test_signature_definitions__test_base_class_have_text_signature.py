...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_definitions__test_base_class_have_text_signature"
# subject = "cpython.test_inspect.TestSignatureDefinitions.test_base_class_have_text_signature"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureDefinitions::test_base_class_have_text_signature
"""Auto-ported test: TestSignatureDefinitions::test_base_class_have_text_signature (CPython 3.12 oracle)."""
...
assert text_signature == '(raw, buffer_size=DEFAULT_BUFFER_SIZE)'
sig = inspect.signature(MyBufferedReader)

assert str(sig) == '(raw, buffer_size=8192)'
print("TestSignatureDefinitions::test_base_class_have_text_signature: ok")
