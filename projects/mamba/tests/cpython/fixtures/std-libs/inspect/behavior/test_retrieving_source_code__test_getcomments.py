...
# lib = "inspect"
# dimension = "behavior"
# case = "test_retrieving_source_code__test_getcomments"
# subject = "cpython.test_inspect.TestRetrievingSourceCode.test_getcomments"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestRetrievingSourceCode::test_getcomments
"""Auto-ported test: TestRetrievingSourceCode::test_getcomments (CPython 3.12 oracle)."""
...
assert inspect.getcomments(mod) == '# line 1\n'

assert inspect.getcomments(mod.StupidGit) == '# line 20\n'

assert inspect.getcomments(mod2.cls160) == '# line 159\n'
co = compile('x=1', '_non_existing_filename.py', 'exec')

assert inspect.getcomments(co) is None

assert inspect.getcomments(list) is None
print("TestRetrievingSourceCode::test_getcomments: ok")
