...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_closure_vars__test_getclosurevars_empty"
# subject = "cpython.test_inspect.TestGetClosureVars.test_getclosurevars_empty"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetClosureVars::test_getclosurevars_empty
"""Auto-ported test: TestGetClosureVars::test_getclosurevars_empty (CPython 3.12 oracle)."""
...
assert inspect.getclosurevars(lambda: True) == _empty

assert inspect.getclosurevars(foo) == _empty
print("TestGetClosureVars::test_getclosurevars_empty: ok")
