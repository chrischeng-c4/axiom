...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_from_functionlike_object"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_from_functionlike_object"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_from_functionlike_object
"""Auto-ported test: TestSignatureObject::test_signature_from_functionlike_object (CPython 3.12 oracle)."""
...
assert signature(fl) == ((('args', ..., ..., 'var_positional'), ('kwargs', ..., ..., 'var_keyword')), ...)
...
with unittest.mock.patch('inspect.ismethoddescriptor', _isdesc):
    ...
    assert not inspect.ismethoddescriptor(builtin_func)
    builtin_func._builtinmock = True

    assert inspect.ismethoddescriptor(builtin_func)

    assert inspect.signature(builtin_func) == sig_func
print("TestSignatureObject::test_signature_from_functionlike_object: ok")
