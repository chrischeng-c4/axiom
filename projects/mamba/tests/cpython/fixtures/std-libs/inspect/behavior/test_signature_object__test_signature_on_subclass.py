...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_subclass"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_subclass
"""Auto-ported test: TestSignatureObject::test_signature_on_subclass (CPython 3.12 oracle)."""
...
assert signature(B) == ((('b', ..., ..., 'positional_or_keyword'),), ...)

assert signature(C) == ((('a', 1, ..., 'positional_or_keyword'), ('b', 2, ..., 'positional_or_keyword'), ('args', ..., ..., 'var_positional'), ('kwargs', ..., ..., 'var_keyword')), ...)

assert signature(D) == ((('a', 1, ..., 'positional_or_keyword'), ('args', ..., ..., 'var_positional'), ('kwargs', ..., ..., 'var_keyword')), ...)
print("TestSignatureObject::test_signature_on_subclass: ok")
