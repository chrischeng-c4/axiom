...
# lib = "inspect"
# dimension = "behavior"
# case = "test_oneliners__test_nested_lambda"
# subject = "cpython.test_inspect.TestOneliners.test_nested_lambda"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestOneliners::test_nested_lambda
"""Auto-ported test: TestOneliners::test_nested_lambda (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.nested_lambda, 291, 292)
print("TestOneliners::test_nested_lambda: ok")
