...
# lib = "inspect"
# dimension = "behavior"
# case = "test_retrieving_source_code__test_getmodule"
# subject = "cpython.test_inspect.TestRetrievingSourceCode.test_getmodule"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestRetrievingSourceCode::test_getmodule
"""Auto-ported test: TestRetrievingSourceCode::test_getmodule (CPython 3.12 oracle)."""
...
assert inspect.getmodule(mod) == mod

assert inspect.getmodule(mod.StupidGit) == mod

assert inspect.getmodule(mod.StupidGit.abuse) == mod

assert inspect.getmodule(mod.StupidGit.abuse) == mod

assert inspect.getmodule(str) == sys.modules['builtins']

assert inspect.getmodule(None, modfile) == mod
print("TestRetrievingSourceCode::test_getmodule: ok")
