...
# lib = "inspect"
# dimension = "behavior"
# case = "test_oneliners__test_twolinefunc"
# subject = "cpython.test_inspect.TestOneliners.test_twolinefunc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestOneliners::test_twolinefunc
"""Auto-ported test: TestOneliners::test_twolinefunc (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.twolinefunc, 44, 45)
print("TestOneliners::test_twolinefunc: ok")
