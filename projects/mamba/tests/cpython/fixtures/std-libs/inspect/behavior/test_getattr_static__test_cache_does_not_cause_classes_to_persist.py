...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_cache_does_not_cause_classes_to_persist"
# subject = "cpython.test_inspect.TestGetattrStatic.test_cache_does_not_cause_classes_to_persist"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_cache_does_not_cause_classes_to_persist
"""Auto-ported test: TestGetattrStatic::test_cache_does_not_cause_classes_to_persist (CPython 3.12 oracle)."""
...
assert weakref_to_class() is None
print("TestGetattrStatic::test_cache_does_not_cause_classes_to_persist: ok")
