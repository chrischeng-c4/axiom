...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_complex_args"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_complex_args"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_complex_args
"""Auto-ported test: TestSignatureObject::test_signature_on_complex_args (CPython 3.12 oracle)."""
...
assert signature(test) == ((('a', ..., ..., 'positional_or_keyword'), ('b', 10, 'foo', 'positional_or_keyword'), ('args', ..., 'bar', 'var_positional'), ('spam', ..., 'baz', 'keyword_only'), ('ham', 123, ..., 'keyword_only'), ('kwargs', ..., int, 'var_keyword')), ...)
print("TestSignatureObject::test_signature_on_complex_args: ok")
