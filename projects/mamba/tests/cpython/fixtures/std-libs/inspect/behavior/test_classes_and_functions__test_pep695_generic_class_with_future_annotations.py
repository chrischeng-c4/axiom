...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_pep695_generic_class_with_future_annotations"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_pep695_generic_class_with_future_annotations"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_pep695_generic_class_with_future_annotations
"""Auto-ported test: TestClassesAndFunctions::test_pep695_generic_class_with_future_annotations (CPython 3.12 oracle)."""
...
assert A_annotations['x'] is A_type_params[0]

assert A_annotations['y'].__args__[0] == Unpack[A_type_params[1]]

assert A_annotations['z'].__args__[0] is A_type_params[2]
print("TestClassesAndFunctions::test_pep695_generic_class_with_future_annotations: ok")
