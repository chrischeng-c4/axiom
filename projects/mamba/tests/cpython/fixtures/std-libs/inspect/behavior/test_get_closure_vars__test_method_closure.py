...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_closure_vars__test_method_closure"
# subject = "cpython.test_inspect.TestGetClosureVars.test_method_closure"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetClosureVars::test_method_closure
"""Auto-ported test: TestGetClosureVars::test_method_closure (CPython 3.12 oracle)."""
...
assert inspect.getclosurevars(C().f(_arg)) == expected
print("TestGetClosureVars::test_method_closure: ok")
