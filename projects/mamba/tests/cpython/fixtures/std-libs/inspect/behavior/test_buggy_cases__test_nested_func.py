...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_nested_func"
# subject = "cpython.test_inspect.TestBuggyCases.test_nested_func"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_nested_func
"""Auto-ported test: TestBuggyCases::test_nested_func (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.cls135.func136, 136, 139)
print("TestBuggyCases::test_nested_func: ok")
