...
# lib = "inspect"
# dimension = "behavior"
# case = "test_oneliners__test_threeline_lambda"
# subject = "cpython.test_inspect.TestOneliners.test_threeline_lambda"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestOneliners::test_threeline_lambda
"""Auto-ported test: TestOneliners::test_threeline_lambda (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.tll, 28, 30)
print("TestOneliners::test_threeline_lambda: ok")
