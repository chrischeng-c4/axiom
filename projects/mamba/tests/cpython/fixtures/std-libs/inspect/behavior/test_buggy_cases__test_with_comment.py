...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_with_comment"
# subject = "cpython.test_inspect.TestBuggyCases.test_with_comment"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_with_comment
"""Auto-ported test: TestBuggyCases::test_with_comment (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.with_comment, 58, 59)
print("TestBuggyCases::test_with_comment: ok")
