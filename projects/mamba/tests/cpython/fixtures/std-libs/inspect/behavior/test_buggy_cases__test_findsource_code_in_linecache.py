...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_findsource_code_in_linecache"
# subject = "cpython.test_inspect.TestBuggyCases.test_findsource_code_in_linecache"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_findsource_code_in_linecache
"""Auto-ported test: TestBuggyCases::test_findsource_code_in_linecache (CPython 3.12 oracle)."""
...
try:
    inspect.findsource(co)
    raise AssertionError('expected OSError')
except OSError:
    pass

try:
    inspect.getsource(co)
    raise AssertionError('expected OSError')
except OSError:
    pass
...
try:
    ...
    assert inspect.findsource(co) == (lines, 0)

    assert inspect.getsource(co) == lines[0]
finally:
    del linecache.cache[co.co_filename]
print("TestBuggyCases::test_findsource_code_in_linecache: ok")
