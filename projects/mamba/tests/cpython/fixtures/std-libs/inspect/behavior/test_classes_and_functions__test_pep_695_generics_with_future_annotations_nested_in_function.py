...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_pep_695_generics_with_future_annotations_nested_in_function"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_pep_695_generics_with_future_annotations_nested_in_function"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_pep_695_generics_with_future_annotations_nested_in_function
"""Auto-ported test: TestClassesAndFunctions::test_pep_695_generics_with_future_annotations_nested_in_function (CPython 3.12 oracle)."""
...
assert set(results.F_annotations.values()) == set(results.F.__type_params__)

assert set(results.F_meth_annotations.values()) == set(results.F.generic_method.__type_params__)

assert set(results.F_meth_annotations.values()) != set(results.F.__type_params__)

assert set(results.F_meth_annotations.values()).intersection(results.F.__type_params__) == set()

assert results.G_annotations == {'x': str}

assert set(results.generic_func_annotations.values()) == set(results.generic_func.__type_params__)
print("TestClassesAndFunctions::test_pep_695_generics_with_future_annotations_nested_in_function: ok")
