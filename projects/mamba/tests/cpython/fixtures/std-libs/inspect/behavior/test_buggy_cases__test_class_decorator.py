...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_class_decorator"
# subject = "cpython.test_inspect.TestBuggyCases.test_class_decorator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_class_decorator
"""Auto-ported test: TestBuggyCases::test_class_decorator (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.cls196, 194, 201)
assertSourceEqual(mod2.cls196.cls200, 198, 201)
print("TestBuggyCases::test_class_decorator: ok")
