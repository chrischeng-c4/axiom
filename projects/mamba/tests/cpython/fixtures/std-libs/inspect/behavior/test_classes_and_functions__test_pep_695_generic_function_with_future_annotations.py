...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_pep_695_generic_function_with_future_annotations"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_pep_695_generic_function_with_future_annotations"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_pep_695_generic_function_with_future_annotations
"""Auto-ported test: TestClassesAndFunctions::test_pep_695_generic_function_with_future_annotations (CPython 3.12 oracle)."""
...
generic_func_annotations = inspect.get_annotations(ann_module695.generic_function, eval_str=True)
func_t_params = ann_module695.generic_function.__type_params__

assert generic_func_annotations.keys() == {'x', 'y', 'z', 'zz', 'return'}

assert generic_func_annotations['x'] is func_t_params[0]

assert generic_func_annotations['y'] == Unpack[func_t_params[1]]

assert generic_func_annotations['z'].__origin__ is func_t_params[2]

assert generic_func_annotations['zz'].__origin__ is func_t_params[2]
print("TestClassesAndFunctions::test_pep_695_generic_function_with_future_annotations: ok")
