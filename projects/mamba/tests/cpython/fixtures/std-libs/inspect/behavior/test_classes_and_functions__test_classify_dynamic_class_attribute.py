...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_classify_dynamic_class_attribute"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_classify_DynamicClassAttribute"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_classify_DynamicClassAttribute
"""Auto-ported test: TestClassesAndFunctions::test_classify_DynamicClassAttribute (CPython 3.12 oracle)."""
...
assert should_find_dca in inspect.classify_class_attrs(VA)
should_find_ga = inspect.Attribute('ham', 'data', Meta, 'spam')

assert should_find_ga in inspect.classify_class_attrs(VA)
print("TestClassesAndFunctions::test_classify_DynamicClassAttribute: ok")
