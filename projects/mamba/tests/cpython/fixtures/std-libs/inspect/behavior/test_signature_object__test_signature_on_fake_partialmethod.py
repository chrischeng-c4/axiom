...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_fake_partialmethod"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_fake_partialmethod"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_fake_partialmethod
"""Auto-ported test: TestSignatureObject::test_signature_on_fake_partialmethod (CPython 3.12 oracle)."""
...
assert str(inspect.signature(foo)) == '(a)'
print("TestSignatureObject::test_signature_on_fake_partialmethod: ok")
