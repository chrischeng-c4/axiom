...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_classify_overrides_bool"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_classify_overrides_bool"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_classify_overrides_bool
"""Auto-ported test: TestClassesAndFunctions::test_classify_overrides_bool (CPython 3.12 oracle)."""
...
assert should_find_attr in inspect.classify_class_attrs(HasNB)
print("TestClassesAndFunctions::test_classify_overrides_bool: ok")
