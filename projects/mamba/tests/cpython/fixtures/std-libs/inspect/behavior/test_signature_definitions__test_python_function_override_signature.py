...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_definitions__test_python_function_override_signature"
# subject = "cpython.test_inspect.TestSignatureDefinitions.test_python_function_override_signature"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureDefinitions::test_python_function_override_signature
"""Auto-ported test: TestSignatureDefinitions::test_python_function_override_signature (CPython 3.12 oracle)."""
...
assert str(sig) == '(self, /, a, b=1, *args, c, d=2, **kwargs)'
func.__text_signature__ = '($self, a, b=1, /, *args, c, d=2, **kwargs)'
sig = inspect.signature(func)
...
assert str(sig) == '(self, a=3, b=1, c=19)'
func.__text_signature__ = '(self, a=1,\nb=2,\n\n\n   c=3)'
sig = inspect.signature(func)

assert str(sig) == '(self, a=1, b=2, c=3)'
...
try:
    ...
    pass
print("TestSignatureDefinitions::test_python_function_override_signature: ok")
