...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_closure_vars__test_name_resolution"
# subject = "cpython.test_inspect.TestGetClosureVars.test_name_resolution"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetClosureVars::test_name_resolution
"""Auto-ported test: TestGetClosureVars::test_name_resolution (CPython 3.12 oracle)."""
...
assert inspect.getclosurevars(f(_arg)) == expected
print("TestGetClosureVars::test_name_resolution: ok")
