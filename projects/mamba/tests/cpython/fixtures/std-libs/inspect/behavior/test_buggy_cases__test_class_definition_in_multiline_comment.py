...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_class_definition_in_multiline_comment"
# subject = "cpython.test_inspect.TestBuggyCases.test_class_definition_in_multiline_comment"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_class_definition_in_multiline_comment
"""Auto-ported test: TestBuggyCases::test_class_definition_in_multiline_comment (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.cls160, 160, 163)
print("TestBuggyCases::test_class_definition_in_multiline_comment: ok")
