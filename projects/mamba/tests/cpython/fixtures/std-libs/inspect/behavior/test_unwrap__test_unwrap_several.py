...
# lib = "inspect"
# dimension = "behavior"
# case = "test_unwrap__test_unwrap_several"
# subject = "cpython.test_inspect.TestUnwrap.test_unwrap_several"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestUnwrap::test_unwrap_several
"""Auto-ported test: TestUnwrap::test_unwrap_several (CPython 3.12 oracle)."""
...
assert wrapper.__wrapped__ is not func

assert inspect.unwrap(wrapper) is func
print("TestUnwrap::test_unwrap_several: ok")
