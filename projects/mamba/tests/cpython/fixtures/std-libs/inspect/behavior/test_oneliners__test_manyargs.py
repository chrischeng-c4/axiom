...
# lib = "inspect"
# dimension = "behavior"
# case = "test_oneliners__test_manyargs"
# subject = "cpython.test_inspect.TestOneliners.test_manyargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestOneliners::test_manyargs
"""Auto-ported test: TestOneliners::test_manyargs (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.manyargs, 40, 41)
print("TestOneliners::test_manyargs: ok")
