...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_slots"
# subject = "cpython.test_inspect.TestGetattrStatic.test_slots"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_slots
"""Auto-ported test: TestGetattrStatic::test_slots (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(thing, 'y') == 'bar'
del thing.x

assert inspect.getattr_static(thing, 'x') == Thing.x
print("TestGetattrStatic::test_slots: ok")
