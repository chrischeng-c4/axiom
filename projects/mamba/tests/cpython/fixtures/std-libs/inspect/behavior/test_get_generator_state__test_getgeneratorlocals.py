...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_generator_state__test_getgeneratorlocals"
# subject = "cpython.test_inspect.TestGetGeneratorState.test_getgeneratorlocals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetGeneratorState::test_getgeneratorlocals
"""Auto-ported test: TestGetGeneratorState::test_getgeneratorlocals (CPython 3.12 oracle)."""
...
assert inspect.getgeneratorlocals(numbers) == {'a': None, 'lst': [1, 2, 3]}
next(numbers)

assert inspect.getgeneratorlocals(numbers) == {'a': None, 'lst': [1, 2, 3], 'v': 1, 'b': (1, 2, 3)}
next(numbers)

assert inspect.getgeneratorlocals(numbers) == {'a': None, 'lst': [1, 2, 3], 'v': 2, 'b': (1, 2, 3)}
next(numbers)

assert inspect.getgeneratorlocals(numbers) == {'a': None, 'lst': [1, 2, 3], 'v': 3, 'b': (1, 2, 3), 'c': 12}
try:
    next(numbers)
except StopIteration:
    pass

assert inspect.getgeneratorlocals(numbers) == {}
print("TestGetGeneratorState::test_getgeneratorlocals: ok")
