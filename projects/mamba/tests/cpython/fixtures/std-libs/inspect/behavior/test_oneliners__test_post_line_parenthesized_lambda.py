...
# lib = "inspect"
# dimension = "behavior"
# case = "test_oneliners__test_post_line_parenthesized_lambda"
# subject = "cpython.test_inspect.TestOneliners.test_post_line_parenthesized_lambda"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestOneliners::test_post_line_parenthesized_lambda
"""Auto-ported test: TestOneliners::test_post_line_parenthesized_lambda (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.post_line_parenthesized_lambda1, 286, 287)
print("TestOneliners::test_post_line_parenthesized_lambda: ok")
