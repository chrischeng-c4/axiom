...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_property"
# subject = "cpython.test_inspect.TestGetattrStatic.test_property"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_property
"""Auto-ported test: TestGetattrStatic::test_property (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(thing, 'x') == Thing.x
print("TestGetattrStatic::test_property: ok")
