...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_bind__test_signature_bind_vararg_name"
# subject = "cpython.test_inspect.TestSignatureBind.test_signature_bind_vararg_name"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureBind::test_signature_bind_vararg_name
"""Auto-ported test: TestSignatureBind::test_signature_bind_vararg_name (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search("got an unexpected keyword argument 'args'", str(_aR_e))

def test(*args, **kwargs):
    return (args, kwargs)

assert call(test, args=1) == ((), {'args': 1})
sig = inspect.signature(test)
ba = sig.bind(args=1)

assert ba.arguments == {'kwargs': {'args': 1}}
print("TestSignatureBind::test_signature_bind_vararg_name: ok")
