...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_builtins_no_signature"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_builtins_no_signature"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_builtins_no_signature
"""Auto-ported test: TestSignatureObject::test_signature_on_builtins_no_signature (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('no signature found for builtin', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search('no signature found for builtin', str(_aR_e))
print("TestSignatureObject::test_signature_on_builtins_no_signature: ok")
