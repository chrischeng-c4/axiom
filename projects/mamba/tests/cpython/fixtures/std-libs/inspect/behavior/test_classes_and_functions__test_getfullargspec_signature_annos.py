...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_getfullargspec_signature_annos"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_getfullargspec_signature_annos"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_getfullargspec_signature_annos
"""Auto-ported test: TestClassesAndFunctions::test_getfullargspec_signature_annos (CPython 3.12 oracle)."""
...
assert test.__annotations__ == spec.annotations
...
assert test.__annotations__ == spec.annotations
print("TestClassesAndFunctions::test_getfullargspec_signature_annos: ok")
