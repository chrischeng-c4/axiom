...
# lib = "inspect"
# dimension = "behavior"
# case = "test_decorators__test_decorator_with_lambda"
# subject = "cpython.test_inspect.TestDecorators.test_decorator_with_lambda"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestDecorators::test_decorator_with_lambda
"""Auto-ported test: TestDecorators::test_decorator_with_lambda (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.func114, 113, 115)
print("TestDecorators::test_decorator_with_lambda: ok")
