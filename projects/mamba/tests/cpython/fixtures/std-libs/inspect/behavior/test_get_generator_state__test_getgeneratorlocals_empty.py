...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_generator_state__test_getgeneratorlocals_empty"
# subject = "cpython.test_inspect.TestGetGeneratorState.test_getgeneratorlocals_empty"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetGeneratorState::test_getgeneratorlocals_empty
"""Auto-ported test: TestGetGeneratorState::test_getgeneratorlocals_empty (CPython 3.12 oracle)."""
...
assert inspect.getgeneratorlocals(one) == {}
try:
    next(one)
...
assert inspect.getgeneratorlocals(one) == {}
print("TestGetGeneratorState::test_getgeneratorlocals_empty: ok")
