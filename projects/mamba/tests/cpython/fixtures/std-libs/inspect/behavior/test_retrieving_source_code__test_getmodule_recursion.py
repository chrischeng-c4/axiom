...
# lib = "inspect"
# dimension = "behavior"
# case = "test_retrieving_source_code__test_getmodule_recursion"
# subject = "cpython.test_inspect.TestRetrievingSourceCode.test_getmodule_recursion"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestRetrievingSourceCode::test_getmodule_recursion
"""Auto-ported test: TestRetrievingSourceCode::test_getmodule_recursion (CPython 3.12 oracle)."""
...
assert inspect.getsourcefile(m.x.__code__) == '<string>'
del sys.modules[name]
inspect.getmodule(compile('a=10', '', 'single'))
print("TestRetrievingSourceCode::test_getmodule_recursion: ok")
