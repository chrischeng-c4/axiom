...
# lib = "inspect"
# dimension = "behavior"
# case = "test_retrieving_source_code__test_getfile_builtin_module"
# subject = "cpython.test_inspect.TestRetrievingSourceCode.test_getfile_builtin_module"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestRetrievingSourceCode::test_getfile_builtin_module
"""Auto-ported test: TestRetrievingSourceCode::test_getfile_builtin_module (CPython 3.12 oracle)."""
...
assert str(e.exception).startswith('<module')
print("TestRetrievingSourceCode::test_getfile_builtin_module: ok")
