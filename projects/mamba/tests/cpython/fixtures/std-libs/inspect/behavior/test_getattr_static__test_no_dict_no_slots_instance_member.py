...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_no_dict_no_slots_instance_member"
# subject = "cpython.test_inspect.TestGetattrStatic.test_no_dict_no_slots_instance_member"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_no_dict_no_slots_instance_member
"""Auto-ported test: TestGetattrStatic::test_no_dict_no_slots_instance_member (CPython 3.12 oracle)."""
...
with open(__file__, encoding='utf-8') as handle:
    ...
    assert inspect.getattr_static(handle, 'name') == type(handle).name
print("TestGetattrStatic::test_no_dict_no_slots_instance_member: ok")
