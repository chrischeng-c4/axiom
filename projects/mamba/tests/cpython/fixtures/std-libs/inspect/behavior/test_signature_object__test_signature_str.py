...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_str"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_str"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_str
"""Auto-ported test: TestSignatureObject::test_signature_str (CPython 3.12 oracle)."""
...
assert str(inspect.signature(foo)) == '(a: int = 1, *, b, c=None, **kwargs) -> 42'

def foo(a: int=1, *args, b, c=None, **kwargs) -> 42:
    pass

assert str(inspect.signature(foo)) == '(a: int = 1, *args, b, c=None, **kwargs) -> 42'

def foo():
    pass

assert str(inspect.signature(foo)) == '()'

def foo(a: list[str]) -> tuple[str, float]:
    pass

assert str(inspect.signature(foo)) == '(a: list[str]) -> tuple[str, float]'
...
assert str(inspect.signature(foo)) == '(a: list[str]) -> Tuple[str, float]'
print("TestSignatureObject::test_signature_str: ok")
