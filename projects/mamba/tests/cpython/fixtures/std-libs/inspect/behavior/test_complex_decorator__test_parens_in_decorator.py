...
# lib = "inspect"
# dimension = "behavior"
# case = "test_complex_decorator__test_parens_in_decorator"
# subject = "cpython.test_inspect.TestComplexDecorator.test_parens_in_decorator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestComplexDecorator::test_parens_in_decorator
"""Auto-ported test: TestComplexDecorator::test_parens_in_decorator (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(fodderModule.complex_decorated, 273, 275)
print("TestComplexDecorator::test_parens_in_decorator: ok")
