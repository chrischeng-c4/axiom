...
# lib = "inspect"
# dimension = "behavior"
# case = "test_main__test_only_source"
# subject = "cpython.test_inspect.TestMain.test_only_source"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestMain::test_only_source
"""Auto-ported test: TestMain::test_only_source (CPython 3.12 oracle)."""
...
assert lines[:-1] == inspect.getsource(module).splitlines()

assert err == b''
print("TestMain::test_only_source: ok")
