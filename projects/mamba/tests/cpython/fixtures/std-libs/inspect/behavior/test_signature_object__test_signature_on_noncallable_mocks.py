...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_noncallable_mocks"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_noncallable_mocks"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_noncallable_mocks
"""Auto-ported test: TestSignatureObject::test_signature_on_noncallable_mocks (CPython 3.12 oracle)."""
...
for mock in (unittest.mock.NonCallableMock(), unittest.mock.NonCallableMagicMock()):
    try:
        inspect.signature(mock)
        raise AssertionError('expected TypeError')
    except TypeError:
        pass
print("TestSignatureObject::test_signature_on_noncallable_mocks: ok")
