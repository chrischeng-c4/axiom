...
# lib = "inspect"
# dimension = "behavior"
# case = "test_block_comments__test_class_async_method"
# subject = "cpython.test_inspect.TestBlockComments.test_class_async_method"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBlockComments::test_class_async_method
"""Auto-ported test: TestBlockComments::test_class_async_method (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod.WhichComments.asyncf, 109, 112)
print("TestBlockComments::test_class_async_method: ok")
