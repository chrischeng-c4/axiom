...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_async_gen_state__test_getasyncgenlocals_error"
# subject = "cpython.test_inspect.TestGetAsyncGenState.test_getasyncgenlocals_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetAsyncGenState::test_getasyncgenlocals_error
"""Auto-ported test: TestGetAsyncGenState::test_getasyncgenlocals_error (CPython 3.12 oracle)."""
...
# --- test body ---
def _asyncgenstate():
    return inspect.getasyncgenstate(self_asyncgen)

async def number_asyncgen():
    for number in range(5):
        yield number
self_asyncgen = number_asyncgen()

try:
    inspect.getasyncgenlocals(1)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    inspect.getasyncgenlocals(lambda x: True)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    inspect.getasyncgenlocals(set)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    inspect.getasyncgenlocals((2, 3))
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("TestGetAsyncGenState::test_getasyncgenlocals_error: ok")
