...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_generator_state__test_suspended"
# subject = "cpython.test_inspect.TestGetGeneratorState.test_suspended"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetGeneratorState::test_suspended
"""Auto-ported test: TestGetGeneratorState::test_suspended (CPython 3.12 oracle)."""
...
assert _generatorstate() == inspect.GEN_SUSPENDED
print("TestGetGeneratorState::test_suspended: ok")
