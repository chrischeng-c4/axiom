...
# lib = "http"
# dimension = "behavior"
# case = "tunnel_tests__test_proxy_response_headers"
# subject = "cpython.test_httplib.TunnelTests.test_proxy_response_headers"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::TunnelTests::test_proxy_response_headers
"""Auto-ported test: TunnelTests::test_proxy_response_headers (CPython 3.12 oracle)."""
...
headers = self_conn.get_proxy_response_headers()

assert expected_header in headers.items()
print("TunnelTests::test_proxy_response_headers: ok")
