...
# lib = "http"
# dimension = "behavior"
# case = "transfer_encoding_test__test_request"
# subject = "cpython.test_httplib.TransferEncodingTest.test_request"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::TransferEncodingTest::test_request
"""Auto-ported test: TransferEncodingTest::test_request (CPython 3.12 oracle)."""
...
for empty_lines in (False, True):
    ...
    conn.request('POST', '/', _make_body(empty_lines=empty_lines))
...
print("TransferEncodingTest::test_request: ok")
