...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_overflowing_header_limit_after_100"
# subject = "cpython.test_httplib.BasicTest.test_overflowing_header_limit_after_100"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_overflowing_header_limit_after_100
"""Auto-ported test: BasicTest::test_overflowing_header_limit_after_100 (CPython 3.12 oracle)."""
...
try:
    resp.begin()
    raise AssertionError('expected client.HTTPException')
except client.HTTPException as _aR_e:
    import types as _types_aR
    cm = _types_aR.SimpleNamespace(exception=_aR_e)

assert 'got more than ' in str(cm.exception)

assert 'headers' in str(cm.exception)
print("BasicTest::test_overflowing_header_limit_after_100: ok")
