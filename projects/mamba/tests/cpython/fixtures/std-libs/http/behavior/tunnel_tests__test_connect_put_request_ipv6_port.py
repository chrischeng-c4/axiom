...
# lib = "http"
# dimension = "behavior"
# case = "tunnel_tests__test_connect_put_request_ipv6_port"
# subject = "cpython.test_httplib.TunnelTests.test_connect_put_request_ipv6_port"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::TunnelTests::test_connect_put_request_ipv6_port
"""Auto-ported test: TunnelTests::test_connect_put_request_ipv6_port (CPython 3.12 oracle)."""
...
self_conn.set_tunnel('[1:2:3::4]:1234')
self_conn.request('PUT', '/', '')

assert self_conn.sock.host == self_host

assert self_conn.sock.port == client.HTTP_PORT

assert b'CONNECT [1:2:3::4]:1234' in self_conn.sock.data

assert b'Host: [1:2:3::4]:1234' in self_conn.sock.data
print("TunnelTests::test_connect_put_request_ipv6_port: ok")
