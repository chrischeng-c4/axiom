...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_chunked_sync"
# subject = "cpython.test_httplib.BasicTest.test_chunked_sync"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_chunked_sync
"""Auto-ported test: BasicTest::test_chunked_sync (CPython 3.12 oracle)."""
...
assert sock.file.read() == extradata.encode('ascii')
resp.close()
print("BasicTest::test_chunked_sync: ok")
