...
# lib = "http"
# dimension = "behavior"
# case = "request_body_test__test_latin1_body"
# subject = "cpython.test_httplib.RequestBodyTest.test_latin1_body"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::RequestBodyTest::test_latin1_body
"""Auto-ported test: RequestBodyTest::test_latin1_body (CPython 3.12 oracle)."""
...
self_conn.request('PUT', '/url', 'bodyÁ')
...
assert '5' == message.get('content-length')

assert b'body\xc1' == f.read()
print("RequestBodyTest::test_latin1_body: ok")
