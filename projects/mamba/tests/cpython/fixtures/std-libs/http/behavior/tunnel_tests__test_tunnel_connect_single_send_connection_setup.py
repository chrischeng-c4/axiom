...
# lib = "http"
# dimension = "behavior"
# case = "tunnel_tests__test_tunnel_connect_single_send_connection_setup"
# subject = "cpython.test_httplib.TunnelTests.test_tunnel_connect_single_send_connection_setup"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::TunnelTests::test_tunnel_connect_single_send_connection_setup
"""Auto-ported test: TunnelTests::test_tunnel_connect_single_send_connection_setup (CPython 3.12 oracle)."""
...
with mock.patch.object(self_conn, 'send') as mock_send:
    self_conn.set_tunnel('destination.com')
    self_conn.connect()
    self_conn.request('GET', '/')
mock_send.assert_called()

assert len(mock_send.mock_calls) > 1
proxy_setup_data_sent = mock_send.mock_calls[0][1][0]

assert b'CONNECT destination.com' in proxy_setup_data_sent

assert proxy_setup_data_sent.endswith(b'\r\n\r\n')
print("TunnelTests::test_tunnel_connect_single_send_connection_setup: ok")
