...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_mixed_reads"
# subject = "cpython.test_httplib.BasicTest.test_mixed_reads"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_mixed_reads
"""Auto-ported test: BasicTest::test_mixed_reads (CPython 3.12 oracle)."""
...
assert resp.readline() == b'Text\r\n'

assert not resp.isclosed()

assert resp.read() == b'Another'
...
assert resp.closed
print("BasicTest::test_mixed_reads: ok")
