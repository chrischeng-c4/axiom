...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_chunked_trailers"
# subject = "cpython.test_httplib.BasicTest.test_chunked_trailers"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_chunked_trailers
"""Auto-ported test: BasicTest::test_chunked_trailers (CPython 3.12 oracle)."""
...
assert sock.file.read() == b''
resp.close()
print("BasicTest::test_chunked_trailers: ok")
