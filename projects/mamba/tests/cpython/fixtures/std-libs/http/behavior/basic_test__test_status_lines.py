...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_status_lines"
# subject = "cpython.test_httplib.BasicTest.test_status_lines"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_status_lines
"""Auto-ported test: BasicTest::test_status_lines (CPython 3.12 oracle)."""
...
try:
    resp.begin()
    raise AssertionError('expected client.BadStatusLine')
except client.BadStatusLine:
    pass
print("BasicTest::test_status_lines: ok")
