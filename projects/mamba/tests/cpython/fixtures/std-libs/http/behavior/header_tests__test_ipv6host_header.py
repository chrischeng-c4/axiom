...
# lib = "http"
# dimension = "behavior"
# case = "header_tests__test_ipv6host_header"
# subject = "cpython.test_httplib.HeaderTests.test_ipv6host_header"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::HeaderTests::test_ipv6host_header
"""Auto-ported test: HeaderTests::test_ipv6host_header (CPython 3.12 oracle)."""
...
assert sock.data.startswith(expected)
expected = b'GET /foo HTTP/1.1\r\nHost: [2001:102A::]\r\nAccept-Encoding: identity\r\n\r\n'
...
assert sock.data.startswith(expected)
print("HeaderTests::test_ipv6host_header: ok")
