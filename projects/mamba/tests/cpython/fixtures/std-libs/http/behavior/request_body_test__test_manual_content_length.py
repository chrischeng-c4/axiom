...
# lib = "http"
# dimension = "behavior"
# case = "request_body_test__test_manual_content_length"
# subject = "cpython.test_httplib.RequestBodyTest.test_manual_content_length"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::RequestBodyTest::test_manual_content_length
"""Auto-ported test: RequestBodyTest::test_manual_content_length (CPython 3.12 oracle)."""
...
self_conn.request('PUT', '/url', 'body', {'Content-Length': '42'})
message, f = get_headers_and_fp()

assert '42' == message.get('content-length')

assert 4 == len(f.read())
print("RequestBodyTest::test_manual_content_length: ok")
