...
# lib = "http"
# dimension = "behavior"
# case = "tunnel_tests__test_connect_put_request"
# subject = "cpython.test_httplib.TunnelTests.test_connect_put_request"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::TunnelTests::test_connect_put_request
"""Auto-ported test: TunnelTests::test_connect_put_request (CPython 3.12 oracle)."""
...
self_conn.set_tunnel(d[b'host'].decode('ascii'))
...
assert b'PUT / HTTP/1.1\r\nHost: %(host)s\r\n' % d in self_conn.sock.data
print("TunnelTests::test_connect_put_request: ok")
