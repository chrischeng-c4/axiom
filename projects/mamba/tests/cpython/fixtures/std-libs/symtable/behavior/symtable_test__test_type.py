...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_type"
# subject = "cpython.test_symtable.SymtableTest.test_type"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_type
"""Auto-ported test: SymtableTest::test_type (CPython 3.12 oracle)."""
...
assert top.get_type() == 'module'

assert Mine.get_type() == 'class'

assert a_method.get_type() == 'function'

assert spam.get_type() == 'function'

assert internal.get_type() == 'function'

assert foo.get_type() == 'function'

assert Alias.get_type() == 'type alias'

assert GenericAlias.get_type() == 'type parameter'

assert GenericAlias_inner.get_type() == 'type alias'

assert generic_spam.get_type() == 'type parameter'

assert generic_spam_inner.get_type() == 'function'

assert GenericMine.get_type() == 'type parameter'

assert GenericMine_inner.get_type() == 'class'

assert T.get_type() == 'TypeVar bound'
print("SymtableTest::test_type: ok")
