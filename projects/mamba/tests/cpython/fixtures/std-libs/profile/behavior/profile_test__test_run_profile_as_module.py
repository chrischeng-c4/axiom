...
# lib = "profile"
# dimension = "behavior"
# case = "profile_test__test_run_profile_as_module"
# subject = "cpython.test_profile.ProfileTest.test_run_profile_as_module"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_profile.py::ProfileTest::test_run_profile_as_module
"""Auto-ported test: ProfileTest::test_run_profile_as_module (CPython 3.12 oracle)."""
...
assert_python_failure('-m', profilermodule.__name__, '-m')
assert_python_failure('-m', profilermodule.__name__, '-m', 'random_module_xyz')
assert_python_ok('-m', profilermodule.__name__, '-m', 'timeit', '-n', '1')
print("ProfileTest::test_run_profile_as_module: ok")
