...
# lib = "profile"
# dimension = "behavior"
# case = "profile_test__test_run"
# subject = "cpython.test_profile.ProfileTest.test_run"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_profile.py::ProfileTest::test_run
"""Auto-ported test: ProfileTest::test_run (CPython 3.12 oracle)."""
...
with silent():
    profilermodule.run("int('1')")
profilermodule.run("int('1')", filename=TESTFN)

assert os.path.exists(TESTFN)
print("ProfileTest::test_run: ok")
