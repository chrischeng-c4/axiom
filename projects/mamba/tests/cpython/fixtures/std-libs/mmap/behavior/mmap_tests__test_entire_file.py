...
# lib = "mmap"
# dimension = "behavior"
# case = "mmap_tests__test_entire_file"
# subject = "cpython.test_mmap.MmapTests.test_entire_file"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mmap.py::MmapTests::test_entire_file
"""Auto-ported test: MmapTests::test_entire_file (CPython 3.12 oracle)."""
...
with open(TESTFN, 'rb+') as f, mmap.mmap(f.fileno(), 0) as mf:
    ...
    assert mf.read(2 ** 16) == 2 ** 16 * b'm'
print("MmapTests::test_entire_file: ok")
