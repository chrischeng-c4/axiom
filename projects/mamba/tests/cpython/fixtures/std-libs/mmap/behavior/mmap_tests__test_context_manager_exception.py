...
# lib = "mmap"
# dimension = "behavior"
# case = "mmap_tests__test_context_manager_exception"
# subject = "cpython.test_mmap.MmapTests.test_context_manager_exception"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mmap.py::MmapTests::test_context_manager_exception
"""Auto-ported test: MmapTests::test_context_manager_exception (CPython 3.12 oracle)."""
...
assert isinstance(exc.exception, OSError)

assert m.closed
print("MmapTests::test_context_manager_exception: ok")
