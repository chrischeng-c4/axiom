...
# lib = "gettext"
# dimension = "behavior"
# case = "plural_forms_internal_test_case__test_invalid_syntax"
# subject = "cpython.test_gettext.PluralFormsInternalTestCase.test_invalid_syntax"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_gettext.py::PluralFormsInternalTestCase::test_invalid_syntax
"""Auto-ported test: PluralFormsInternalTestCase::test_invalid_syntax (CPython 3.12 oracle)."""
...
# --- test body ---
invalid_expressions = ['x>1', '(n>1', 'n>1)', '42**42**42', '0xa', '1.0', '1e2', 'n>0x1', '+n', '-n', 'n()', 'n(1)', '1+', 'nn', 'n n', 'n ? 1 2']
for expr in invalid_expressions:
    try:
        ...
        pass
print("PluralFormsInternalTestCase::test_invalid_syntax: ok")
