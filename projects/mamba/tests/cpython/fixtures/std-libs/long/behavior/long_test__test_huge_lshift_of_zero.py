...
# lib = "long"
# dimension = "behavior"
# case = "long_test__test_huge_lshift_of_zero"
# subject = "cpython.test_long.LongTest.test_huge_lshift_of_zero"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_long.py::LongTest::test_huge_lshift_of_zero
"""Auto-ported test: LongTest::test_huge_lshift_of_zero (CPython 3.12 oracle)."""
...
assert 0 << sys.maxsize == 0

assert 0 << sys.maxsize + 1 == 0
print("LongTest::test_huge_lshift_of_zero: ok")
