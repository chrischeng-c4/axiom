...
# lib = "xml_sax"
# dimension = "behavior"
# case = "prepare_input_source_test__test_byte_stream"
# subject = "cpython.test_sax.PrepareInputSourceTest.test_byte_stream"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::PrepareInputSourceTest::test_byte_stream
"""Auto-ported test: PrepareInputSourceTest::test_byte_stream (CPython 3.12 oracle)."""
...
src.setByteStream(make_byte_stream())
prep = prepare_input_source(src)

assert prep.getCharacterStream() is None
checkContent(prep.getByteStream(), b'This is a byte stream.')
print("PrepareInputSourceTest::test_byte_stream: ok")
