...
# lib = "xml_sax"
# dimension = "behavior"
# case = "stream_reader_writer_xmlgen_test__test_xmlgen_ignorable"
# subject = "cpython.test_sax.StreamReaderWriterXmlgenTest.test_xmlgen_ignorable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::StreamReaderWriterXmlgenTest::test_xmlgen_ignorable
"""Auto-ported test: StreamReaderWriterXmlgenTest::test_xmlgen_ignorable (CPython 3.12 oracle)."""
...
assert result.getvalue() == xml('<doc> </doc>')
print("StreamReaderWriterXmlgenTest::test_xmlgen_ignorable: ok")
