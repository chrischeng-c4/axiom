...
# lib = "xml_sax"
# dimension = "behavior"
# case = "stream_reader_writer_xmlgen_test__test_xmlgen_ns_empty"
# subject = "cpython.test_sax.StreamReaderWriterXmlgenTest.test_xmlgen_ns_empty"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::StreamReaderWriterXmlgenTest::test_xmlgen_ns_empty
"""Auto-ported test: StreamReaderWriterXmlgenTest::test_xmlgen_ns_empty (CPython 3.12 oracle)."""
...
def ioclass():
    writer = codecs.open(fname, 'w', encoding='ascii', errors='xmlcharrefreplace', buffering=0)
...
def xml(doc, encoding='iso-8859-1'):
...
assert result.getvalue() == xml('<ns1:doc xmlns:ns1="%s"><udoc/></ns1:doc>' % ns_uri)
print("StreamReaderWriterXmlgenTest::test_xmlgen_ns_empty: ok")
