...
# lib = "xml_sax"
# dimension = "behavior"
# case = "stream_reader_writer_xmlgen_test__test_xmlgen_ns"
# subject = "cpython.test_sax.StreamReaderWriterXmlgenTest.test_xmlgen_ns"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::StreamReaderWriterXmlgenTest::test_xmlgen_ns
"""Auto-ported test: StreamReaderWriterXmlgenTest::test_xmlgen_ns (CPython 3.12 oracle)."""
...
assert result.getvalue() == xml('<ns1:doc xmlns:ns1="%s"><udoc></udoc></ns1:doc>' % ns_uri)
print("StreamReaderWriterXmlgenTest::test_xmlgen_ns: ok")
