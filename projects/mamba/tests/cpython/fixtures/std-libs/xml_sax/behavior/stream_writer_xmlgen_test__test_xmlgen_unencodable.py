...
# lib = "xml_sax"
# dimension = "behavior"
# case = "stream_writer_xmlgen_test__test_xmlgen_unencodable"
# subject = "cpython.test_sax.StreamWriterXmlgenTest.test_xmlgen_unencodable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::StreamWriterXmlgenTest::test_xmlgen_unencodable
"""Auto-ported test: StreamWriterXmlgenTest::test_xmlgen_unencodable (CPython 3.12 oracle)."""
...
assert result.getvalue() == xml('<doc a="&#8364;">&#8364;</doc>', encoding='ascii')
print("StreamWriterXmlgenTest::test_xmlgen_unencodable: ok")
