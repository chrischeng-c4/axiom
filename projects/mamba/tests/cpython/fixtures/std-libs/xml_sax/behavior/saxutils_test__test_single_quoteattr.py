...
# lib = "xml_sax"
# dimension = "behavior"
# case = "saxutils_test__test_single_quoteattr"
# subject = "cpython.test_sax.SaxutilsTest.test_single_quoteattr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::SaxutilsTest::test_single_quoteattr
"""Auto-ported test: SaxutilsTest::test_single_quoteattr (CPython 3.12 oracle)."""
...
assert quoteattr('Includes "double" quotes') == '\'Includes "double" quotes\''
print("SaxutilsTest::test_single_quoteattr: ok")
