...
# lib = "xml_sax"
# dimension = "behavior"
# case = "expat_reader_test__test_expat_locator_withinfo_nonascii"
# subject = "cpython.test_sax.ExpatReaderTest.test_expat_locator_withinfo_nonascii"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::ExpatReaderTest::test_expat_locator_withinfo_nonascii
"""Auto-ported test: ExpatReaderTest::test_expat_locator_withinfo_nonascii (CPython 3.12 oracle)."""
...
assert parser.getSystemId() == fname

assert parser.getPublicId() == None
print("ExpatReaderTest::test_expat_locator_withinfo_nonascii: ok")
