...
# lib = "ssl"
# dimension = "behavior"
# case = "context_tests__test_sni_callback"
# subject = "cpython.test_ssl.ContextTests.test_sni_callback"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::ContextTests::test_sni_callback
"""Auto-ported test: ContextTests::test_sni_callback (CPython 3.12 oracle)."""
...
try:
    ctx.set_servername_callback(ctx)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
print("ContextTests::test_sni_callback: ok")
