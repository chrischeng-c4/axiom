...
# lib = "ssl"
# dimension = "behavior"
# case = "test_enumerations__test_verifyflags"
# subject = "cpython.test_ssl.TestEnumerations.test_verifyflags"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::TestEnumerations::test_verifyflags
"""Auto-ported test: TestEnumerations::test_verifyflags (CPython 3.12 oracle)."""
...
# --- test body ---
CheckedVerifyFlags = enum._old_convert_(enum.IntFlag, 'VerifyFlags', 'ssl', lambda name: name.startswith('VERIFY_'), source=ssl._ssl)
enum._test_simple_enum(CheckedVerifyFlags, ssl.VerifyFlags)
print("TestEnumerations::test_verifyflags: ok")
