...
# lib = "ssl"
# dimension = "behavior"
# case = "context_tests__test_num_tickest"
# subject = "cpython.test_ssl.ContextTests.test_num_tickest"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::ContextTests::test_num_tickest
"""Auto-ported test: ContextTests::test_num_tickest (CPython 3.12 oracle)."""
...
assert ctx.num_tickets == 2
ctx.num_tickets = 1

assert ctx.num_tickets == 1
ctx.num_tickets = 0
...
try:
    ...
    pass
print("ContextTests::test_num_tickest: ok")
