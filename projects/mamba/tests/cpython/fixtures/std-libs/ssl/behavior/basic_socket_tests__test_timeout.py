...
# lib = "ssl"
# dimension = "behavior"
# case = "basic_socket_tests__test_timeout"
# subject = "cpython.test_ssl.BasicSocketTests.test_timeout"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::BasicSocketTests::test_timeout
"""Auto-ported test: BasicSocketTests::test_timeout (CPython 3.12 oracle)."""
...
for timeout in (None, 0.0, 5.0):
    ...
    with test_wrap_socket(s) as ss:
        ...
        assert timeout == ss.gettimeout()
print("BasicSocketTests::test_timeout: ok")
