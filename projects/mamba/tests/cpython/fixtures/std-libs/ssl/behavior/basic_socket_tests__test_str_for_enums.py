...
# lib = "ssl"
# dimension = "behavior"
# case = "basic_socket_tests__test_str_for_enums"
# subject = "cpython.test_ssl.BasicSocketTests.test_str_for_enums"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::BasicSocketTests::test_str_for_enums
"""Auto-ported test: BasicSocketTests::test_str_for_enums (CPython 3.12 oracle)."""
...
assert repr(proto) == '<_SSLMethod.PROTOCOL_TLS_CLIENT: %r>' % proto.value

assert str(proto) == str(proto.value)
ctx = ssl.SSLContext(proto)

assert ctx.protocol is proto
print("BasicSocketTests::test_str_for_enums: ok")
