...
# lib = "ssl"
# dimension = "behavior"
# case = "basic_socket_tests__test_wrapped_unconnected"
# subject = "cpython.test_ssl.BasicSocketTests.test_wrapped_unconnected"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::BasicSocketTests::test_wrapped_unconnected
"""Auto-ported test: BasicSocketTests::test_wrapped_unconnected (CPython 3.12 oracle)."""
...
with test_wrap_socket(s) as ss:
    ...
    try:
        ss.recvfrom_into(bytearray(b'x'), 1)
        raise AssertionError('expected OSError')
    except OSError:
        pass
    ...
    try:
        ss.recvmsg_into([bytearray(100)])
        raise AssertionError('expected NotImplementedError')
    except NotImplementedError:
        pass
print("BasicSocketTests::test_wrapped_unconnected: ok")
