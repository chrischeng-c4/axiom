...
# lib = "ssl"
# dimension = "behavior"
# case = "context_tests__test_load_default_certs"
# subject = "cpython.test_ssl.ContextTests.test_load_default_certs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::ContextTests::test_load_default_certs
"""Auto-ported test: ContextTests::test_load_default_certs (CPython 3.12 oracle)."""
...
try:
    ctx.load_default_certs(None)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    ctx.load_default_certs('SERVER_AUTH')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("ContextTests::test_load_default_certs: ok")
