...
# lib = "ssl"
# dimension = "behavior"
# case = "test_enumerations__test_options"
# subject = "cpython.test_ssl.TestEnumerations.test_options"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::TestEnumerations::test_options
"""Auto-ported test: TestEnumerations::test_options (CPython 3.12 oracle)."""
...
# --- test body ---
CheckedOptions = enum._old_convert_(enum.IntFlag, 'Options', 'ssl', lambda name: name.startswith('OP_'), source=ssl._ssl)
enum._test_simple_enum(CheckedOptions, ssl.Options)
print("TestEnumerations::test_options: ok")
