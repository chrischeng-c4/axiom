...
# lib = "ssl"
# dimension = "behavior"
# case = "test_enumerations__test_alertdescription"
# subject = "cpython.test_ssl.TestEnumerations.test_alertdescription"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::TestEnumerations::test_alertdescription
"""Auto-ported test: TestEnumerations::test_alertdescription (CPython 3.12 oracle)."""
...
# --- test body ---
CheckedAlertDescription = enum._old_convert_(enum.IntEnum, 'AlertDescription', 'ssl', lambda name: name.startswith('ALERT_DESCRIPTION_'), source=ssl._ssl)
enum._test_simple_enum(CheckedAlertDescription, ssl.AlertDescription)
print("TestEnumerations::test_alertdescription: ok")
