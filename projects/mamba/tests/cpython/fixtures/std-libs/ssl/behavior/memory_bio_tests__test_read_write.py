...
# lib = "ssl"
# dimension = "behavior"
# case = "memory_bio_tests__test_read_write"
# subject = "cpython.test_ssl.MemoryBIOTests.test_read_write"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::MemoryBIOTests::test_read_write
"""Auto-ported test: MemoryBIOTests::test_read_write (CPython 3.12 oracle)."""
...
assert bio.read() == b'foobar'

assert bio.read() == b''
bio.write(b'baz')

assert bio.read(2) == b'ba'

assert bio.read(1) == b'z'

assert bio.read(1) == b''
print("MemoryBIOTests::test_read_write: ok")
