...
# lib = "weakref"
# dimension = "behavior"
# case = "mapping_test_case__test_weak_keyed_len_race"
# subject = "cpython.test_weakref.MappingTestCase.test_weak_keyed_len_race"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakref.py::MappingTestCase::test_weak_keyed_len_race
"""Auto-ported test: MappingTestCase::test_weak_keyed_len_race (CPython 3.12 oracle)."""
...
def make_weak_valued_dict():
    ...
    return (dict, objects)
self_cbcalled = 0
check_len_race(weakref.WeakKeyDictionary, lambda k: (k, 1))
print("MappingTestCase::test_weak_keyed_len_race: ok")
