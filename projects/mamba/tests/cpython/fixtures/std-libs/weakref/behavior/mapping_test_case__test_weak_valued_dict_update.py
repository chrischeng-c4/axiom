...
# lib = "weakref"
# dimension = "behavior"
# case = "mapping_test_case__test_weak_valued_dict_update"
# subject = "cpython.test_weakref.MappingTestCase.test_weak_valued_dict_update"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakref.py::MappingTestCase::test_weak_valued_dict_update
"""Auto-ported test: MappingTestCase::test_weak_valued_dict_update (CPython 3.12 oracle)."""
...
def make_weak_valued_dict():
    ...
    return (dict, objects)
self_cbcalled = 0
check_update(weakref.WeakValueDictionary, {1: C(), 'a': C(), C(): C()})
...
for kw in ('self', 'dict', 'other', 'iterable'):
    ...
    assert list(d.keys()) == [kw]

    assert d[kw] == o
print("MappingTestCase::test_weak_valued_dict_update: ok")
