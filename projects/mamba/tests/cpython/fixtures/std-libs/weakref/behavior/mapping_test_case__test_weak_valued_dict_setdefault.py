...
# lib = "weakref"
# dimension = "behavior"
# case = "mapping_test_case__test_weak_valued_dict_setdefault"
# subject = "cpython.test_weakref.MappingTestCase.test_weak_valued_dict_setdefault"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakref.py::MappingTestCase::test_weak_valued_dict_setdefault
"""Auto-ported test: MappingTestCase::test_weak_valued_dict_setdefault (CPython 3.12 oracle)."""
...
def make_weak_valued_dict():
    ...
    return (dict, objects)
self_cbcalled = 0
check_setdefault(weakref.WeakValueDictionary, 'key', C(), C())
print("MappingTestCase::test_weak_valued_dict_setdefault: ok")
