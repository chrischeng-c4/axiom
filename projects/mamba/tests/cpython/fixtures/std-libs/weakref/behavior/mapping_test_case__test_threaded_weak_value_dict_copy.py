...
# lib = "weakref"
# dimension = "behavior"
# case = "mapping_test_case__test_threaded_weak_value_dict_copy"
# subject = "cpython.test_weakref.MappingTestCase.test_threaded_weak_value_dict_copy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakref.py::MappingTestCase::test_threaded_weak_value_dict_copy
"""Auto-ported test: MappingTestCase::test_threaded_weak_value_dict_copy (CPython 3.12 oracle)."""
...
def make_weak_valued_dict():
    ...
    return (dict, objects)
self_cbcalled = 0
check_threaded_weak_dict_copy(weakref.WeakValueDictionary, False)
print("MappingTestCase::test_threaded_weak_value_dict_copy: ok")
