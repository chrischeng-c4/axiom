...
# lib = "itertools"
# dimension = "behavior"
# case = "test_various_iterator_args__test_map"
# subject = "cpython.test_itertools.TestVariousIteratorArgs.test_map"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestVariousIteratorArgs::test_map
"""Auto-ported test: TestVariousIteratorArgs::test_map (CPython 3.12 oracle)."""
...
for s in (range(10), range(0), range(100), (7, 11), range(20, 50, 5)):
    for g in (G, I, Ig, S, L, R):
        ...
        assert list(map(onearg, g(s))) == [onearg(x) for x in g(s)]

        assert list(map(operator.pow, g(s), g(s))) == [x ** x for x in g(s)]
    ...
    try:
        ...
        pass
print("TestVariousIteratorArgs::test_map: ok")
