...
# lib = "itertools"
# dimension = "behavior"
# case = "test_various_iterator_args__test_chain"
# subject = "cpython.test_itertools.TestVariousIteratorArgs.test_chain"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestVariousIteratorArgs::test_chain
"""Auto-ported test: TestVariousIteratorArgs::test_chain (CPython 3.12 oracle)."""
...
for s in ('123', '', range(1000), ('do', 1.2), range(2000, 2200, 5)):
    for g in (G, I, Ig, S, L, R):
        ...
        assert list(chain(g(s))) == list(g(s))

        assert list(chain(g(s), g(s))) == list(g(s)) + list(g(s))
    ...
    try:
        ...
        pass
print("TestVariousIteratorArgs::test_chain: ok")
