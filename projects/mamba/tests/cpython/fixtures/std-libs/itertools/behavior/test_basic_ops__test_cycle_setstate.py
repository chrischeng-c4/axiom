...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_cycle_setstate"
# subject = "cpython.test_itertools.TestBasicOps.test_cycle_setstate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_cycle_setstate
"""Auto-ported test: TestBasicOps::test_cycle_setstate (CPython 3.12 oracle)."""
...
assert take(20, c) == list('defgabcdefgabcdefgab')
c = cycle('defg')
...
try:
    ...
    pass
print("TestBasicOps::test_cycle_setstate: ok")
