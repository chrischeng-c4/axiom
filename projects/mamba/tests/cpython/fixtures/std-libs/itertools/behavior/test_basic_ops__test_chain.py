...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_chain"
# subject = "cpython.test_itertools.TestBasicOps.test_chain"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_chain
"""Auto-ported test: TestBasicOps::test_chain (CPython 3.12 oracle)."""
...
for c in (chain, chain2):
    ...
    assert list(c('abc', 'def')) == list('abcdef')

    assert list(c('abc')) == list('abc')

    assert list(c('')) == []

    assert take(4, c('abc', 'def')) == list('abcd')
    ...
    try:
        ...
        pass
print("TestBasicOps::test_chain: ok")
