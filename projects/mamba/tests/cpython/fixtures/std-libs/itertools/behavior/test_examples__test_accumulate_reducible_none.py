...
# lib = "itertools"
# dimension = "behavior"
# case = "test_examples__test_accumulate_reducible_none"
# subject = "cpython.test_itertools.TestExamples.test_accumulate_reducible_none"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestExamples::test_accumulate_reducible_none
"""Auto-ported test: TestExamples::test_accumulate_reducible_none (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert list(it_copy) == [True, False]

assert list(copy.deepcopy(it)) == [True, False]

assert list(copy.copy(it)) == [True, False]
print("TestExamples::test_accumulate_reducible_none: ok")
