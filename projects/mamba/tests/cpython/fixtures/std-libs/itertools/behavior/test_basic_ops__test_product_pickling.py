...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_product_pickling"
# subject = "cpython.test_itertools.TestBasicOps.test_product_pickling"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_product_pickling
"""Auto-ported test: TestBasicOps::test_product_pickling (CPython 3.12 oracle)."""
...
for args, result in [([], [()]), (['ab'], [('a',), ('b',)]), ([range(2), range(3)], [(0, 0), (0, 1), (0, 2), (1, 0), (1, 1), (1, 2)]), ([range(0), range(2), range(3)], []), ([range(2), range(0), range(3)], []), ([range(2), range(3), range(0)], [])]:
    ...
    assert list(copy.copy(product(*args))) == result

    assert list(copy.deepcopy(product(*args))) == result
    for proto in range(pickle.HIGHEST_PROTOCOL + 1):
        pickletest(proto, product(*args))
print("TestBasicOps::test_product_pickling: ok")
