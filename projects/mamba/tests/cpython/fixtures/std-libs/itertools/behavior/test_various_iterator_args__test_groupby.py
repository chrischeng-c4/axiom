...
# lib = "itertools"
# dimension = "behavior"
# case = "test_various_iterator_args__test_groupby"
# subject = "cpython.test_itertools.TestVariousIteratorArgs.test_groupby"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestVariousIteratorArgs::test_groupby
"""Auto-ported test: TestVariousIteratorArgs::test_groupby (CPython 3.12 oracle)."""
...
for s in (range(10), range(0), range(1000), (7, 11), range(2000, 2200, 5)):
    for g in (G, I, Ig, S, L, R):
        ...
        assert [k for k, sb in groupby(g(s))] == list(g(s))
    ...
    try:
        ...
        pass
print("TestVariousIteratorArgs::test_groupby: ok")
