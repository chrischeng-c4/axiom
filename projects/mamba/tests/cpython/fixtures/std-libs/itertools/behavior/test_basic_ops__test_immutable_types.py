...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_immutable_types"
# subject = "cpython.test_itertools.TestBasicOps.test_immutable_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_immutable_types
"""Auto-ported test: TestBasicOps::test_immutable_types (CPython 3.12 oracle)."""
...
dataset = (accumulate, batched, chain, combinations, combinations_with_replacement, compress, count, cycle, dropwhile, filterfalse, groupby, _grouper, islice, pairwise, permutations, product, repeat, starmap, takewhile, _tee, _tee_dataobject, zip_longest)
for tp in dataset:
    try:
        tp.foobar = 1
...
print("TestBasicOps::test_immutable_types: ok")
