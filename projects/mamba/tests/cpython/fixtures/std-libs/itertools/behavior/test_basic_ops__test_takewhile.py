...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_takewhile"
# subject = "cpython.test_itertools.TestBasicOps.test_takewhile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_takewhile
"""Auto-ported test: TestBasicOps::test_takewhile (CPython 3.12 oracle)."""
...
assert list(takewhile(underten, [])) == []
...
try:
    takewhile(operator.pow)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    takewhile(operator.pow, [(4, 5)], 'extra')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    next(takewhile(10, [(4, 5)]))
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    next(takewhile(errfunc, [(4, 5)]))
...
assert list(copy.copy(takewhile(underten, data))) == [1, 3, 5]

assert list(copy.deepcopy(takewhile(underten, data))) == [1, 3, 5]
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    pickletest(proto, takewhile(underten, data))
print("TestBasicOps::test_takewhile: ok")
