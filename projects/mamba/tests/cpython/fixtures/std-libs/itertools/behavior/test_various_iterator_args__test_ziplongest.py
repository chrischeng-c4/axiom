...
# lib = "itertools"
# dimension = "behavior"
# case = "test_various_iterator_args__test_ziplongest"
# subject = "cpython.test_itertools.TestVariousIteratorArgs.test_ziplongest"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestVariousIteratorArgs::test_ziplongest
"""Auto-ported test: TestVariousIteratorArgs::test_ziplongest (CPython 3.12 oracle)."""
...
for s in ('123', '', range(1000), ('do', 1.2), range(2000, 2200, 5)):
    for g in (G, I, Ig, S, L, R):
        ...
        assert list(zip_longest(g(s))) == list(zip(g(s)))

        assert list(zip_longest(g(s), g(s))) == list(zip(g(s), g(s)))
    ...
    try:
        list(zip_longest(E(s)))
        raise AssertionError('expected ZeroDivisionError')
    except ZeroDivisionError:
        pass
print("TestVariousIteratorArgs::test_ziplongest: ok")
