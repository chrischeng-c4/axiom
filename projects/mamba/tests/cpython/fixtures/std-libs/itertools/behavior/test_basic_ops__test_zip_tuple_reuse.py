...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_zip_tuple_reuse"
# subject = "cpython.test_itertools.TestBasicOps.test_zip_tuple_reuse"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_zip_tuple_reuse
"""Auto-ported test: TestBasicOps::test_zip_tuple_reuse (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert ans == [('b', 1), ('c', 2)]
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    pickletest(proto, zip('abc', count()))
print("TestBasicOps::test_zip_tuple_reuse: ok")
