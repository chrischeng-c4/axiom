...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_product_tuple_reuse"
# subject = "cpython.test_itertools.TestBasicOps.test_product_tuple_reuse"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_product_tuple_reuse
"""Auto-ported test: TestBasicOps::test_product_tuple_reuse (CPython 3.12 oracle)."""
...
assert len(set(map(id, product('abc', 'def')))) == 1

assert len(set(map(id, list(product('abc', 'def'))))) != 1
print("TestBasicOps::test_product_tuple_reuse: ok")
