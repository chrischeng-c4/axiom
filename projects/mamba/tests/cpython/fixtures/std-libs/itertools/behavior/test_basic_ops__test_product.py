...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_product"
# subject = "cpython.test_itertools.TestBasicOps.test_product"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_product
"""Auto-ported test: TestBasicOps::test_product (CPython 3.12 oracle)."""
...
for args, result in [([], [()]), (['ab'], [('a',), ('b',)]), ([range(2), range(3)], [(0, 0), (0, 1), (0, 2), (1, 0), (1, 1), (1, 2)]), ([range(0), range(2), range(3)], []), ([range(2), range(0), range(3)], []), ([range(2), range(3), range(0)], [])]:
    ...
    for r in range(4):
        ...
        assert list(product(*args * r)) == list(product(*args, **dict(repeat=r)))
...
for i in range(100):
    ...
    assert len(list(product(*args))) == expected_len
print("TestBasicOps::test_product: ok")
