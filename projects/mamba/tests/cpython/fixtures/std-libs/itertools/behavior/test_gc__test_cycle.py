...
# lib = "itertools"
# dimension = "behavior"
# case = "test_gc__test_cycle"
# subject = "cpython.test_itertools.TestGC.test_cycle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestGC::test_cycle
"""Auto-ported test: TestGC::test_cycle (CPython 3.12 oracle)."""
...
a = []
makecycle(cycle([a] * 2), a)
print("TestGC::test_cycle: ok")
