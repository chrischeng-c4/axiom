...
# lib = "itertools"
# dimension = "behavior"
# case = "test_various_iterator_args__test_islice"
# subject = "cpython.test_itertools.TestVariousIteratorArgs.test_islice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestVariousIteratorArgs::test_islice
"""Auto-ported test: TestVariousIteratorArgs::test_islice (CPython 3.12 oracle)."""
...
for s in ('12345', '', range(1000), ('do', 1.2), range(2000, 2200, 5)):
    for g in (G, I, Ig, S, L, R):
        ...
        assert list(islice(g(s), 1, None, 2)) == list(g(s))[1::2]
    ...
    try:
        ...
        pass
print("TestVariousIteratorArgs::test_islice: ok")
