...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_chain_from_iterable"
# subject = "cpython.test_itertools.TestBasicOps.test_chain_from_iterable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_chain_from_iterable
"""Auto-ported test: TestBasicOps::test_chain_from_iterable (CPython 3.12 oracle)."""
...
try:
    list(chain.from_iterable([2, 3]))
    raise AssertionError('expected TypeError')
except TypeError:
    pass

assert list(islice(chain.from_iterable(repeat(range(5))), 2)) == [0, 1]
print("TestBasicOps::test_chain_from_iterable: ok")
