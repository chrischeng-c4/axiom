...
# lib = "wsgiref"
# dimension = "behavior"
# case = "utility_tests__test_defaults"
# subject = "cpython.test_wsgiref.UtilityTests.testDefaults"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wsgiref.py::UtilityTests::testDefaults
"""Auto-ported test: UtilityTests::testDefaults (CPython 3.12 oracle)."""
...
for key, value in [('SERVER_NAME', '127.0.0.1'), ('SERVER_PORT', '80'), ('SERVER_PROTOCOL', 'HTTP/1.0'), ('HTTP_HOST', '127.0.0.1'), ('REQUEST_METHOD', 'GET'), ('SCRIPT_NAME', ''), ('PATH_INFO', '/'), ('wsgi.version', (1, 0)), ('wsgi.run_once', 0), ('wsgi.multithread', 0), ('wsgi.multiprocess', 0), ('wsgi.input', BytesIO()), ('wsgi.errors', StringIO()), ('wsgi.url_scheme', 'http')]:
    checkDefault(key, value)
print("UtilityTests::testDefaults: ok")
