...
# lib = "wsgiref"
# dimension = "behavior"
# case = "utility_tests__test_req_ur_is"
# subject = "cpython.test_wsgiref.UtilityTests.testReqURIs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wsgiref.py::UtilityTests::testReqURIs
"""Auto-ported test: UtilityTests::testReqURIs (CPython 3.12 oracle)."""
...
checkReqURI('http://127.0.0.1/spam', SCRIPT_NAME='/spam')
checkReqURI('http://127.0.0.1/sp%E4m', SCRIPT_NAME='/späm')
checkReqURI('http://127.0.0.1/spammity/spam', SCRIPT_NAME='/spammity', PATH_INFO='/spam')
checkReqURI('http://127.0.0.1/spammity/sp%E4m', SCRIPT_NAME='/spammity', PATH_INFO='/späm')
checkReqURI('http://127.0.0.1/spammity/spam;ham', SCRIPT_NAME='/spammity', PATH_INFO='/spam;ham')
checkReqURI('http://127.0.0.1/spammity/spam;cookie=1234,5678', SCRIPT_NAME='/spammity', PATH_INFO='/spam;cookie=1234,5678')
checkReqURI('http://127.0.0.1/spammity/spam?say=ni', SCRIPT_NAME='/spammity', PATH_INFO='/spam', QUERY_STRING='say=ni')
checkReqURI('http://127.0.0.1/spammity/spam?s%E4y=ni', SCRIPT_NAME='/spammity', PATH_INFO='/spam', QUERY_STRING='s%E4y=ni')
checkReqURI('http://127.0.0.1/spammity/spam', 0, SCRIPT_NAME='/spammity', PATH_INFO='/spam', QUERY_STRING='say=ni')
print("UtilityTests::testReqURIs: ok")
