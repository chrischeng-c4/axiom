...
# lib = "wsgiref"
# dimension = "behavior"
# case = "integration_tests__test_simple_validation_error"
# subject = "cpython.test_wsgiref.IntegrationTests.test_simple_validation_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wsgiref.py::IntegrationTests::test_simple_validation_error
"""Auto-ported test: IntegrationTests::test_simple_validation_error (CPython 3.12 oracle)."""
...
assert out.endswith(b'A server error occurred.  Please contact the administrator.')

assert err.splitlines()[-2] == "AssertionError: Headers (('Content-Type', 'text/plain')) must be of type list: <class 'tuple'>"
print("IntegrationTests::test_simple_validation_error: ok")
