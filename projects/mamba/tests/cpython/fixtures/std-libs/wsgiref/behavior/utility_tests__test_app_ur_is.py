...
# lib = "wsgiref"
# dimension = "behavior"
# case = "utility_tests__test_app_ur_is"
# subject = "cpython.test_wsgiref.UtilityTests.testAppURIs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wsgiref.py::UtilityTests::testAppURIs
"""Auto-ported test: UtilityTests::testAppURIs (CPython 3.12 oracle)."""
...
checkAppURI('http://127.0.0.1/spam', SCRIPT_NAME='/spam')
checkAppURI('http://127.0.0.1/sp%E4m', SCRIPT_NAME='/späm')
checkAppURI('http://spam.example.com:2071/', HTTP_HOST='spam.example.com:2071', SERVER_PORT='2071')
checkAppURI('http://spam.example.com/', SERVER_NAME='spam.example.com')
checkAppURI('http://127.0.0.1/', HTTP_HOST='127.0.0.1', SERVER_NAME='spam.example.com')
checkAppURI('https://127.0.0.1/', HTTPS='on')
checkAppURI('http://127.0.0.1:8000/', SERVER_PORT='8000', HTTP_HOST=None)
print("UtilityTests::testAppURIs: ok")
