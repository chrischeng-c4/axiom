...
# lib = "io"
# dimension = "behavior"
# case = "stateful_incremental_decoder_test__test_decoder"
# subject = "cpython.test_io.StatefulIncrementalDecoderTest.test_decoder"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_io.py::StatefulIncrementalDecoderTest::test_decoder
"""Auto-ported test: StatefulIncrementalDecoderTest::test_decoder (CPython 3.12 oracle)."""
...
for input, eof, output in test_cases:
    d = StatefulIncrementalDecoder()

    assert d.decode(input, eof) == output
d = StatefulIncrementalDecoder()

assert d.decode(b'oiabcd') == ''

assert d.decode(b'', 1) == 'abcd.'
print("StatefulIncrementalDecoderTest::test_decoder: ok")
