...
# lib = "io"
# dimension = "behavior"
# case = "py_text_io_wrapper_test__test_create_at_shutdown_with_encoding"
# subject = "cpython.test_io.PyTextIOWrapperTest.test_create_at_shutdown_with_encoding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_io.py::PyTextIOWrapperTest::test_create_at_shutdown_with_encoding
"""Auto-ported test: PyTextIOWrapperTest::test_create_at_shutdown_with_encoding (CPython 3.12 oracle)."""
...
pass
rc, out, err = _check_create_at_shutdown(encoding='utf-8', errors='strict')

assert not err

assert 'ok' == out.decode().strip()
print("PyTextIOWrapperTest::test_create_at_shutdown_with_encoding: ok")
