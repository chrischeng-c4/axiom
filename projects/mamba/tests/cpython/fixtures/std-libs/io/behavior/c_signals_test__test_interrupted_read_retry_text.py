...
# lib = "io"
# dimension = "behavior"
# case = "c_signals_test__test_interrupted_read_retry_text"
# subject = "cpython.test_io.CSignalsTest.test_interrupted_read_retry_text"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_io.py::CSignalsTest::test_interrupted_read_retry_text
"""Auto-ported test: CSignalsTest::test_interrupted_read_retry_text (CPython 3.12 oracle)."""
...
check_interrupted_read_retry(lambda x: x, mode='r', encoding='latin1')
print("CSignalsTest::test_interrupted_read_retry_text: ok")
