...
# lib = "smtplib"
# dimension = "behavior"
# case = "lmtp_general_tests__test_local_host_name"
# subject = "cpython.test_smtplib.LMTPGeneralTests.testLocalHostName"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_smtplib.py::LMTPGeneralTests::testLocalHostName
"""Auto-ported test: LMTPGeneralTests::testLocalHostName (CPython 3.12 oracle)."""
...
client = client(HOST, self_port, local_hostname='testhost')

assert client.local_hostname == 'testhost'
client.close()
print("LMTPGeneralTests::testLocalHostName: ok")
