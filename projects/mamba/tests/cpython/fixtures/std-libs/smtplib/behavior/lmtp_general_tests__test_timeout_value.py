...
# lib = "smtplib"
# dimension = "behavior"
# case = "lmtp_general_tests__test_timeout_value"
# subject = "cpython.test_smtplib.LMTPGeneralTests.testTimeoutValue"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_smtplib.py::LMTPGeneralTests::testTimeoutValue
"""Auto-ported test: LMTPGeneralTests::testTimeoutValue (CPython 3.12 oracle)."""
...
client = client(HOST, self_port, timeout=30)

assert client.sock.gettimeout() == 30
client.close()
print("LMTPGeneralTests::testTimeoutValue: ok")
