...
# lib = "smtplib"
# dimension = "behavior"
# case = "non_connecting_tests__test_not_connected"
# subject = "cpython.test_smtplib.NonConnectingTests.testNotConnected"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_smtplib.py::NonConnectingTests::testNotConnected
"""Auto-ported test: NonConnectingTests::testNotConnected (CPython 3.12 oracle)."""
...
try:
    smtp.ehlo()
    raise AssertionError('expected smtplib.SMTPServerDisconnected')
...
try:
    ...
    pass
print("NonConnectingTests::testNotConnected: ok")
