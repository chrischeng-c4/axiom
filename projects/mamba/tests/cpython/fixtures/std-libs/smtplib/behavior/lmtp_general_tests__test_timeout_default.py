...
# lib = "smtplib"
# dimension = "behavior"
# case = "lmtp_general_tests__test_timeout_default"
# subject = "cpython.test_smtplib.LMTPGeneralTests.testTimeoutDefault"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_smtplib.py::LMTPGeneralTests::testTimeoutDefault
"""Auto-ported test: LMTPGeneralTests::testTimeoutDefault (CPython 3.12 oracle)."""
...
assert mock_socket.getdefaulttimeout() is None
mock_socket.setdefaulttimeout(30)

assert mock_socket.getdefaulttimeout() == 30
try:
    client = client(HOST, self_port)
finally:
    mock_socket.setdefaulttimeout(None)

assert client.sock.gettimeout() == 30
client.close()
print("LMTPGeneralTests::testTimeoutDefault: ok")
