...
# lib = "smtplib"
# dimension = "behavior"
# case = "lmtp_general_tests__test_timeout_none"
# subject = "cpython.test_smtplib.LMTPGeneralTests.testTimeoutNone"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_smtplib.py::LMTPGeneralTests::testTimeoutNone
"""Auto-ported test: LMTPGeneralTests::testTimeoutNone (CPython 3.12 oracle)."""
...
try:
    client = client(HOST, self_port, timeout=None)
finally:
    socket.setdefaulttimeout(None)

assert client.sock.gettimeout() is None
client.close()
print("LMTPGeneralTests::testTimeoutNone: ok")
