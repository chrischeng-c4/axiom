...
# lib = "smtplib"
# dimension = "behavior"
# case = "default_arguments_tests__test_send_message_with_mail_options"
# subject = "cpython.test_smtplib.DefaultArgumentsTests.testSendMessageWithMailOptions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_smtplib.py::DefaultArgumentsTests::testSendMessageWithMailOptions
"""Auto-ported test: DefaultArgumentsTests::testSendMessageWithMailOptions (CPython 3.12 oracle)."""
...
self_smtp.send_message(self_msg, None, None, mail_options)

assert mail_options == ['STARTTLS']

assert self_smtp.sendmail.call_args_list[0][0][3] == expected_mail_options
print("DefaultArgumentsTests::testSendMessageWithMailOptions: ok")
