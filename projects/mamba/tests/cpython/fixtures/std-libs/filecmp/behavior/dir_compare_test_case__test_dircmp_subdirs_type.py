...
# lib = "filecmp"
# dimension = "behavior"
# case = "dir_compare_test_case__test_dircmp_subdirs_type"
# subject = "cpython.test_filecmp.DirCompareTestCase.test_dircmp_subdirs_type"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_filecmp.py::DirCompareTestCase::test_dircmp_subdirs_type
"""Auto-ported test: DirCompareTestCase::test_dircmp_subdirs_type (CPython 3.12 oracle)."""
...
class MyDirCmp(filecmp.dircmp):
    pass
d = MyDirCmp(self_dir, self_dir_diff)
sub_dirs = d.subdirs
...
print("DirCompareTestCase::test_dircmp_subdirs_type: ok")
