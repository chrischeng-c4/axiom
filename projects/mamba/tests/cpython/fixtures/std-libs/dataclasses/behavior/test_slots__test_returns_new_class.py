...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_slots__test_returns_new_class"
# subject = "cpython.__init__.TestSlots.test_returns_new_class"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestSlots::test_returns_new_class
"""Auto-ported test: TestSlots::test_returns_new_class (CPython 3.12 oracle)."""
...
print("TestSlots::test_returns_new_class: ok")
