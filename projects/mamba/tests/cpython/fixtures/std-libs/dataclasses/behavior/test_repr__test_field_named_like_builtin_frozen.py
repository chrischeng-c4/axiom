...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_repr__test_field_named_like_builtin_frozen"
# subject = "cpython.__init__.TestRepr.test_field_named_like_builtin_frozen"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestRepr::test_field_named_like_builtin_frozen
"""Auto-ported test: TestRepr::test_field_named_like_builtin_frozen (CPython 3.12 oracle)."""
...
print("TestRepr::test_field_named_like_builtin_frozen: ok")
