...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_ordering__test_is_dataclass"
# subject = "cpython.__init__.TestOrdering.test_is_dataclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestOrdering::test_is_dataclass
"""Auto-ported test: TestOrdering::test_is_dataclass (CPython 3.12 oracle)."""
...
print("TestOrdering::test_is_dataclass: ok")
