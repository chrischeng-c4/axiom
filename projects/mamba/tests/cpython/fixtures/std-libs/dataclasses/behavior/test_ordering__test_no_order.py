...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_ordering__test_no_order"
# subject = "cpython.__init__.TestOrdering.test_no_order"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestOrdering::test_no_order
"""Auto-ported test: TestOrdering::test_no_order (CPython 3.12 oracle)."""
...
assert '__gt__' not in C.__dict__
print("TestOrdering::test_no_order: ok")
