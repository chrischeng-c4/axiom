...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_string_annotations__test_isnt_classvar"
# subject = "cpython.__init__.TestStringAnnotations.test_isnt_classvar"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestStringAnnotations::test_isnt_classvar
"""Auto-ported test: TestStringAnnotations::test_isnt_classvar (CPython 3.12 oracle)."""
...
for typestr in ('CV', 't.ClassVar', 't.ClassVar[int]', 'typing..ClassVar[int]', 'Classvar', 'Classvar[int]', 'typing.ClassVarx[int]', 'typong.ClassVar[int]', 'dataclasses.ClassVar[int]', 'typingxClassVar[str]'):
    ...
    assert C(10).x == 10
print("TestStringAnnotations::test_isnt_classvar: ok")
