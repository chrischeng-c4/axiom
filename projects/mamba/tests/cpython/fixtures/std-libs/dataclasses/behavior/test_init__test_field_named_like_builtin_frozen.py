...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_init__test_field_named_like_builtin_frozen"
# subject = "cpython.__init__.TestInit.test_field_named_like_builtin_frozen"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestInit::test_field_named_like_builtin_frozen
"""Auto-ported test: TestInit::test_field_named_like_builtin_frozen (CPython 3.12 oracle)."""
...
print("TestInit::test_field_named_like_builtin_frozen: ok")
