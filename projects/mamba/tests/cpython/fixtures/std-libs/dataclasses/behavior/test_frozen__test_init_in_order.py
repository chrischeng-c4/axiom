...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_frozen__test_init_in_order"
# subject = "cpython.__init__.TestFrozen.test_init_in_order"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestFrozen::test_init_in_order
"""Auto-ported test: TestFrozen::test_init_in_order (CPython 3.12 oracle)."""
...
assert ('f', 4) == calls[4]
print("TestFrozen::test_init_in_order: ok")
