...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_case__test_1_field_compare"
# subject = "cpython.__init__.TestCase.test_1_field_compare"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestCase::test_1_field_compare
"""Auto-ported test: TestCase::test_1_field_compare (CPython 3.12 oracle)."""
...
assert C(1) >= C(1)
print("TestCase::test_1_field_compare: ok")
