...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_frozen__test_1_field_compare"
# subject = "cpython.__init__.TestFrozen.test_1_field_compare"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestFrozen::test_1_field_compare
"""Auto-ported test: TestFrozen::test_1_field_compare (CPython 3.12 oracle)."""
...
assert C(1) >= C(1)
print("TestFrozen::test_1_field_compare: ok")
