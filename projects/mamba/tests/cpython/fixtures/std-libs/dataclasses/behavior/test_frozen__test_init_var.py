...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_frozen__test_init_var"
# subject = "cpython.__init__.TestFrozen.test_init_var"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestFrozen::test_init_var
"""Auto-ported test: TestFrozen::test_init_var (CPython 3.12 oracle)."""
...
assert c.x == 20
print("TestFrozen::test_init_var: ok")
