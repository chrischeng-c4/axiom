...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_eq__test_init_in_order"
# subject = "cpython.__init__.TestEq.test_init_in_order"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestEq::test_init_in_order
"""Auto-ported test: TestEq::test_init_in_order (CPython 3.12 oracle)."""
...
assert ('f', 4) == calls[4]
print("TestEq::test_init_in_order: ok")
