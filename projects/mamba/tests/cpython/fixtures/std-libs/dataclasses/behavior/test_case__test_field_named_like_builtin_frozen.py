...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_case__test_field_named_like_builtin_frozen"
# subject = "cpython.__init__.TestCase.test_field_named_like_builtin_frozen"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestCase::test_field_named_like_builtin_frozen
"""Auto-ported test: TestCase::test_field_named_like_builtin_frozen (CPython 3.12 oracle)."""
...
print("TestCase::test_field_named_like_builtin_frozen: ok")
