...
# lib = "optparse"
# dimension = "behavior"
# case = "test_parse_number__test_parse_num_ok"
# subject = "cpython.test_optparse.TestParseNumber.test_parse_num_ok"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_optparse.py::TestParseNumber::test_parse_num_ok
"""Auto-ported test: TestParseNumber::test_parse_num_ok (CPython 3.12 oracle)."""
...
# --- test body ---
self_parser = InterceptingOptionParser()
self_parser.add_option('-n', type=int)
self_parser.add_option('-l', type=int)

assert _parse_num('0', int) == 0

assert _parse_num('0x10', int) == 16

assert _parse_num('0XA', int) == 10

assert _parse_num('010', int) == 8

assert _parse_num('0b11', int) == 3

assert _parse_num('0b', int) == 0
print("TestParseNumber::test_parse_num_ok: ok")
