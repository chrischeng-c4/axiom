...
# lib = "optparse"
# dimension = "behavior"
# case = "test_option_parser__test_get_option_equals"
# subject = "cpython.test_optparse.TestOptionParser.test_get_option_equals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_optparse.py::TestOptionParser::test_get_option_equals
"""Auto-ported test: TestOptionParser::test_get_option_equals (CPython 3.12 oracle)."""
...
opt1 = self_parser.get_option('-v')
opt2 = self_parser.get_option('--verbose')
opt3 = self_parser.get_option('-n')
opt4 = self_parser.get_option('--noisy')

assert opt1 is opt2 is opt3 is opt4
print("TestOptionParser::test_get_option_equals: ok")
