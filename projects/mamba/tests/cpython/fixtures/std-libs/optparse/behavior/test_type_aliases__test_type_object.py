...
# lib = "optparse"
# dimension = "behavior"
# case = "test_type_aliases__test_type_object"
# subject = "cpython.test_optparse.TestTypeAliases.test_type_object"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_optparse.py::TestTypeAliases::test_type_object
"""Auto-ported test: TestTypeAliases::test_type_object (CPython 3.12 oracle)."""
...
self_parser.add_option('-s', type=str)

assert self_parser.get_option('-s').type == 'string'
self_parser.add_option('-x', type=int)

assert self_parser.get_option('-x').type == 'int'
print("TestTypeAliases::test_type_object: ok")
