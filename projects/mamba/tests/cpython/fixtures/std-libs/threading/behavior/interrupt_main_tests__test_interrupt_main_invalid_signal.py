...
# lib = "threading"
# dimension = "behavior"
# case = "interrupt_main_tests__test_interrupt_main_invalid_signal"
# subject = "cpython.test_threading.InterruptMainTests.test_interrupt_main_invalid_signal"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::InterruptMainTests::test_interrupt_main_invalid_signal
"""Auto-ported test: InterruptMainTests::test_interrupt_main_invalid_signal (CPython 3.12 oracle)."""
...
try:
    _thread.interrupt_main(signal.NSIG)
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    _thread.interrupt_main(1000000)
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("InterruptMainTests::test_interrupt_main_invalid_signal: ok")
