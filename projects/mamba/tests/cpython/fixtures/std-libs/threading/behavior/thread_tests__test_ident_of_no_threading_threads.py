...
# lib = "threading"
# dimension = "behavior"
# case = "thread_tests__test_ident_of_no_threading_threads"
# subject = "cpython.test_threading.ThreadTests.test_ident_of_no_threading_threads"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::ThreadTests::test_ident_of_no_threading_threads
"""Auto-ported test: ThreadTests::test_ident_of_no_threading_threads (CPython 3.12 oracle)."""
...
assert threading.current_thread().ident is not None
...
print("ThreadTests::test_ident_of_no_threading_threads: ok")
