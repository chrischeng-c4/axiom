...
# lib = "threading"
# dimension = "behavior"
# case = "thread_tests__test_getprofile_all_threads"
# subject = "cpython.test_threading.ThreadTests.test_getprofile_all_threads"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::ThreadTests::test_getprofile_all_threads
"""Auto-ported test: ThreadTests::test_getprofile_all_threads (CPython 3.12 oracle)."""
...
try:
    ...
    assert profile_funcs == [None, fn]

    assert threading.getprofile() == fn

    assert sys.getprofile() == fn
finally:
    threading.setprofile_all_threads(old_profile)

assert threading.getprofile() == old_profile

assert sys.getprofile() == old_profile
print("ThreadTests::test_getprofile_all_threads: ok")
