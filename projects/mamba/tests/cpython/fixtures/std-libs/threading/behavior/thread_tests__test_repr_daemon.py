...
# lib = "threading"
# dimension = "behavior"
# case = "thread_tests__test_repr_daemon"
# subject = "cpython.test_threading.ThreadTests.test_repr_daemon"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::ThreadTests::test_repr_daemon
"""Auto-ported test: ThreadTests::test_repr_daemon (CPython 3.12 oracle)."""
...
assert 'daemon' not in repr(t)
t.daemon = True

assert 'daemon' in repr(t)
print("ThreadTests::test_repr_daemon: ok")
