...
# lib = "threading"
# dimension = "behavior"
# case = "threading_exception_tests__test_multithread_modify_file_noerror"
# subject = "cpython.test_threading.ThreadingExceptionTests.test_multithread_modify_file_noerror"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::ThreadingExceptionTests::test_multithread_modify_file_noerror
"""Auto-ported test: ThreadingExceptionTests::test_multithread_modify_file_noerror (CPython 3.12 oracle)."""
...
for t in threads:
    t.start()
    t.join()
print("ThreadingExceptionTests::test_multithread_modify_file_noerror: ok")
