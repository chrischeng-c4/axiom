...
# lib = "threading"
# dimension = "behavior"
# case = "interrupt_main_tests__test_interrupt_main_subthread"
# subject = "cpython.test_threading.InterruptMainTests.test_interrupt_main_subthread"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::InterruptMainTests::test_interrupt_main_subthread
"""Auto-ported test: InterruptMainTests::test_interrupt_main_subthread (CPython 3.12 oracle)."""
...
try:
    ...
    pass
t.join()
print("InterruptMainTests::test_interrupt_main_subthread: ok")
