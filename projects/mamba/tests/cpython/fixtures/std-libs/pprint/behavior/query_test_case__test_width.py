...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_width"
# subject = "cpython.test_pprint.QueryTestCase.test_width"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_width
"""Auto-ported test: QueryTestCase::test_width (CPython 3.12 oracle)."""
...
assert pprint.pformat(o, width=15) == expected

assert pprint.pformat(o, width=16) == expected

assert pprint.pformat(o, width=25) == expected

assert pprint.pformat(o, width=14) == "[[[[[[1,\n      2,\n      3],\n     '1 '\n     '2']]]],\n {1: [1,\n      2,\n      3],\n  2: [12,\n      34]},\n 'abc def '\n 'ghi',\n ('ab cd '\n  'ef',),\n set2({1,\n       23}),\n [[[[[1,\n      2,\n      3],\n     '1 '\n     '2']]]]]"
print("QueryTestCase::test_width: ok")
