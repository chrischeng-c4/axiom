...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_default_dict"
# subject = "cpython.test_pprint.QueryTestCase.test_default_dict"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_default_dict
"""Auto-ported test: QueryTestCase::test_default_dict (CPython 3.12 oracle)."""
...
assert pprint.pformat(d, width=1) == "defaultdict(<class 'int'>, {})"
words = 'the quick brown fox jumped over a lazy dog'.split()
d = collections.defaultdict(int, zip(words, itertools.count()))

assert pprint.pformat(d) == "defaultdict(<class 'int'>,\n            {'a': 6,\n             'brown': 2,\n             'dog': 8,\n             'fox': 3,\n             'jumped': 4,\n             'lazy': 7,\n             'over': 5,\n             'quick': 1,\n             'the': 0})"
print("QueryTestCase::test_default_dict: ok")
