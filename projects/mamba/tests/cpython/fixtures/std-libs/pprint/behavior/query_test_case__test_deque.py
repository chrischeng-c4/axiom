...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_deque"
# subject = "cpython.test_pprint.QueryTestCase.test_deque"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_deque
"""Auto-ported test: QueryTestCase::test_deque (CPython 3.12 oracle)."""
...
assert pprint.pformat(d, width=1) == 'deque([])'
d = collections.deque(maxlen=7)

assert pprint.pformat(d, width=1) == 'deque([], maxlen=7)'
words = 'the quick brown fox jumped over a lazy dog'.split()
d = collections.deque(zip(words, itertools.count()))

assert pprint.pformat(d) == "deque([('the', 0),\n       ('quick', 1),\n       ('brown', 2),\n       ('fox', 3),\n       ('jumped', 4),\n       ('over', 5),\n       ('a', 6),\n       ('lazy', 7),\n       ('dog', 8)])"
d = collections.deque(zip(words, itertools.count()), maxlen=7)

assert pprint.pformat(d) == "deque([('brown', 2),\n       ('fox', 3),\n       ('jumped', 4),\n       ('over', 5),\n       ('a', 6),\n       ('lazy', 7),\n       ('dog', 8)],\n      maxlen=7)"
print("QueryTestCase::test_deque: ok")
