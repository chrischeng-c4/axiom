...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_dataclass_with_repr"
# subject = "cpython.test_pprint.QueryTestCase.test_dataclass_with_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_dataclass_with_repr
"""Auto-ported test: QueryTestCase::test_dataclass_with_repr (CPython 3.12 oracle)."""
...
assert formatted == "custom repr that doesn't fit within pprint width"
print("QueryTestCase::test_dataclass_with_repr: ok")
