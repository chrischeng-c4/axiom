...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_user_string"
# subject = "cpython.test_pprint.QueryTestCase.test_user_string"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_user_string
"""Auto-ported test: QueryTestCase::test_user_string (CPython 3.12 oracle)."""
...
assert pprint.pformat(d, width=1) == "''"
d = collections.UserString('the quick brown fox jumped over a lazy dog')

assert pprint.pformat(d, width=20) == "('the quick brown '\n 'fox jumped over '\n 'a lazy dog')"

assert pprint.pformat({1: d}, width=20) == "{1: 'the quick '\n    'brown fox '\n    'jumped over a '\n    'lazy dog'}"
print("QueryTestCase::test_user_string: ok")
