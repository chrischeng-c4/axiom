...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_knotted"
# subject = "cpython.test_pprint.QueryTestCase.test_knotted"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_knotted
"""Auto-ported test: QueryTestCase::test_knotted (CPython 3.12 oracle)."""
...
self_b[67] = self_a
self_d = {}
self_d[0] = self_d[1] = self_d[2] = self_d
pp = pprint.PrettyPrinter()
for icky in (self_a, self_b, self_d, (self_d, self_d)):
...
del self_a[:]
del self_b[:]
for safe in (self_a, self_b, self_d, (self_d, self_d)):
...
print("QueryTestCase::test_knotted: ok")
