...
# lib = "pyexpat"
# dimension = "behavior"
# case = "parse_test__test_parse_again"
# subject = "cpython.test_pyexpat.ParseTest.test_parse_again"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pyexpat.py::ParseTest::test_parse_again
"""Auto-ported test: ParseTest::test_parse_again (CPython 3.12 oracle)."""
...
try:
    parser.ParseFile(file)
    raise AssertionError('expected expat.error')
except expat.error as _aR_e:
    import types as _types_aR
    cm = _types_aR.SimpleNamespace(exception=_aR_e)

assert expat.ErrorString(cm.exception.code) == expat.errors.XML_ERROR_FINISHED
print("ParseTest::test_parse_again: ok")
