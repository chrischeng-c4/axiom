...
# lib = "pyexpat"
# dimension = "behavior"
# case = "foreign_dtd_tests__test_use_foreign_dtd"
# subject = "cpython.test_pyexpat.ForeignDTDTests.test_use_foreign_dtd"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pyexpat.py::ForeignDTDTests::test_use_foreign_dtd
"""Auto-ported test: ForeignDTDTests::test_use_foreign_dtd (CPython 3.12 oracle)."""
...
assert handler_call_args == [(None, None)]
handler_call_args[:] = []
parser = expat.ParserCreate()
...
assert handler_call_args == [(None, None)]
print("ForeignDTDTests::test_use_foreign_dtd: ok")
