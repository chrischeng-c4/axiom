...
# lib = "pyexpat"
# dimension = "behavior"
# case = "set_attribute_test__test_ordered_attributes"
# subject = "cpython.test_pyexpat.SetAttributeTest.test_ordered_attributes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pyexpat.py::SetAttributeTest::test_ordered_attributes
"""Auto-ported test: SetAttributeTest::test_ordered_attributes (CPython 3.12 oracle)."""
...
assert self_parser.ordered_attributes is False
for x in (0, 1, 2, 0):
    self_parser.ordered_attributes = x

    assert self_parser.ordered_attributes is bool(x)
print("SetAttributeTest::test_ordered_attributes: ok")
