...
# lib = "pyexpat"
# dimension = "behavior"
# case = "error_message_test__test_expaterror"
# subject = "cpython.test_pyexpat.ErrorMessageTest.test_expaterror"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pyexpat.py::ErrorMessageTest::test_expaterror
"""Auto-ported test: ErrorMessageTest::test_expaterror (CPython 3.12 oracle)."""
...
try:
    ...
    assert e.code == errors.codes[errors.XML_ERROR_UNCLOSED_TOKEN]
print("ErrorMessageTest::test_expaterror: ok")
