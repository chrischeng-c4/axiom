...
# lib = "dict_version"
# dimension = "behavior"
# case = "dict_version_tests__test_update"
# subject = "cpython.test_dict_version.DictVersionTests.test_update"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dict_version.py::DictVersionTests::test_update
"""Auto-ported test: DictVersionTests::test_update (CPython 3.12 oracle)."""
...
check_version_dont_change(d, d.update)
check_version_changed(d, d.update, key='new value')
d2 = new_dict(key='value 3')
check_version_changed(d, d.update, d2)
print("DictVersionTests::test_update: ok")
