...
# lib = "dict_version"
# dimension = "behavior"
# case = "dict_version_tests__test_copy"
# subject = "cpython.test_dict_version.DictVersionTests.test_copy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dict_version.py::DictVersionTests::test_copy
"""Auto-ported test: DictVersionTests::test_copy (CPython 3.12 oracle)."""
...
print("DictVersionTests::test_copy: ok")
