...
# dimension = "behavior"
# case = "unicode_nfkc_file_tests__test_open"
# subject = "cpython.test_unicode_file_functions.UnicodeNFKCFileTests.test_open"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode_file_functions.py::UnicodeNFKCFileTests::test_open
"""Auto-ported test: UnicodeNFKCFileTests::test_open (CPython 3.12 oracle)."""
...
for name in files:
    ...
    f.close()
    os.stat(name)
    _apply_failure(os.listdir, name, self__listdir_failure)
print("UnicodeNFKCFileTests::test_open: ok")
