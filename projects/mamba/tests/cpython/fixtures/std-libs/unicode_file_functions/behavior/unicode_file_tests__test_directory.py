...
# dimension = "behavior"
# case = "unicode_file_tests__test_directory"
# subject = "cpython.test_unicode_file_functions.UnicodeFileTests.test_directory"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode_file_functions.py::UnicodeFileTests::test_directory
"""Auto-ported test: UnicodeFileTests::test_directory (CPython 3.12 oracle)."""
...
with os_helper.temp_cwd(dirname):
    ...
    os.remove(filename)
print("UnicodeFileTests::test_directory: ok")
