...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_partial_file__test_readlines"
# subject = "cpython.test_mailbox.TestPartialFile.test_readlines"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestPartialFile::test_readlines
"""Auto-ported test: TestPartialFile::test_readlines (CPython 3.12 oracle)."""
...
self__file.write(bytes('foo%sbar%sfred%sbob?????' % (os.linesep, os.linesep, os.linesep), 'ascii'))
_test_readlines(mailbox._PartialFile(self__file, 0, 13 + 3 * len(os.linesep)))
print("TestPartialFile::test_readlines: ok")
