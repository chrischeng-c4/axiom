...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_maildir_message__test_info_and_flags"
# subject = "cpython.test_mailbox.TestMaildirMessage.test_info_and_flags"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMaildirMessage::test_info_and_flags
"""Auto-ported test: TestMaildirMessage::test_info_and_flags (CPython 3.12 oracle)."""
...
assert msg.get_flags() == 'FS'

assert msg.get_info() == '2,FS'
msg.set_info('1,')

assert msg.get_flags() == ''

assert msg.get_info() == '1,'
msg.remove_flag('RPT')
...
assert msg.get_flags() == 'D'

assert msg.get_info() == '2,D'
_check_sample(msg)
print("TestMaildirMessage::test_info_and_flags: ok")
