...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_mmdf_message__test_flags"
# subject = "cpython.test_mailbox.TestMMDFMessage.test_flags"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMMDFMessage::test_flags
"""Auto-ported test: TestMMDFMessage::test_flags (CPython 3.12 oracle)."""
...
assert msg.get_flags() == 'F'
msg.set_flags('XODR')

assert msg.get_flags() == 'RODX'
msg.add_flag('FA')

assert msg.get_flags() == 'RODFAX'
msg.remove_flag('FDXA')

assert msg.get_flags() == 'RO'
_check_sample(msg)
print("TestMMDFMessage::test_flags: ok")
