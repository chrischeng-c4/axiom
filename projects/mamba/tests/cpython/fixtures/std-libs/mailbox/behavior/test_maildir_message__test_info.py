...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_maildir_message__test_info"
# subject = "cpython.test_mailbox.TestMaildirMessage.test_info"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMaildirMessage::test_info
"""Auto-ported test: TestMaildirMessage::test_info (CPython 3.12 oracle)."""
...
assert msg.get_info() == '1,foo=bar'

try:
    (lambda: msg.set_info(None))()
    raise AssertionError('expected TypeError')
except TypeError:
    pass
_check_sample(msg)
print("TestMaildirMessage::test_info: ok")
