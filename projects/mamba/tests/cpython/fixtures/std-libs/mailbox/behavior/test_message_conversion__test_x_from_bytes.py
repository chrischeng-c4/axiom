...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_x_from_bytes"
# subject = "cpython.test_mailbox.TestMessageConversion.test_x_from_bytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_x_from_bytes
"""Auto-ported test: TestMessageConversion::test_x_from_bytes (CPython 3.12 oracle)."""
...
for class_ in all_mailbox_types:
    msg = class_(_bytes_sample_message)
    _check_sample(msg)
print("TestMessageConversion::test_x_from_bytes: ok")
