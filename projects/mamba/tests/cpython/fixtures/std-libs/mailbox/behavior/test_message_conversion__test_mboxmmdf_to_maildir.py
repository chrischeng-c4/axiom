...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_mboxmmdf_to_maildir"
# subject = "cpython.test_mailbox.TestMessageConversion.test_mboxmmdf_to_maildir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_mboxmmdf_to_maildir
"""Auto-ported test: TestMessageConversion::test_mboxmmdf_to_maildir (CPython 3.12 oracle)."""
...
for class_ in (mailbox.mboxMessage, mailbox.MMDFMessage):
    ...
    assert mailbox.MaildirMessage(msg_mboxMMDF).get_subdir() == 'cur'
print("TestMessageConversion::test_mboxmmdf_to_maildir: ok")
