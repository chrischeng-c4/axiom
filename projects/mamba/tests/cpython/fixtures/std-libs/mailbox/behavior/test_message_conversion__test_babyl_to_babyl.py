...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_babyl_to_babyl"
# subject = "cpython.test_mailbox.TestMessageConversion.test_babyl_to_babyl"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_babyl_to_babyl
"""Auto-ported test: TestMessageConversion::test_babyl_to_babyl (CPython 3.12 oracle)."""
...
assert msg2.get_labels() == ['unseen', 'deleted', 'filed', 'answered', 'forwarded', 'edited', 'resent']

assert msg.get_visible().keys() == msg2.get_visible().keys()
for key in msg.get_visible().keys():

    assert msg.get_visible()[key] == msg2.get_visible()[key]
print("TestMessageConversion::test_babyl_to_babyl: ok")
