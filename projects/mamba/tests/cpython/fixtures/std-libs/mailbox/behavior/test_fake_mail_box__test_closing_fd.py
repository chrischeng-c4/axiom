...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_fake_mail_box__test_closing_fd"
# subject = "cpython.test_mailbox.TestFakeMailBox.test_closing_fd"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestFakeMailBox::test_closing_fd
"""Auto-ported test: TestFakeMailBox::test_closing_fd (CPython 3.12 oracle)."""
...
for i in range(10):
    ...
    assert not box.files[i].closed
for i in range(10):
    box[i]
for i in range(10):

    assert box.files[i].closed
print("TestFakeMailBox::test_closing_fd: ok")
