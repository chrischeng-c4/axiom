...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_partial_file__test_readline"
# subject = "cpython.test_mailbox.TestPartialFile.test_readline"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestPartialFile::test_readline
"""Auto-ported test: TestPartialFile::test_readline (CPython 3.12 oracle)."""
...
_test_readline(mailbox._PartialFile(self__file, 5, 18 + 3 * len(os.linesep)))
print("TestPartialFile::test_readline: ok")
