...
# lib = "pathlib"
# dimension = "behavior"
# case = "pure_posix_path_test__test_repr_roundtrips"
# subject = "cpython.test_pathlib.PurePosixPathTest.test_repr_roundtrips"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pathlib.py::PurePosixPathTest::test_repr_roundtrips
"""Auto-ported test: PurePosixPathTest::test_repr_roundtrips (CPython 3.12 oracle)."""
...
for pathstr in ('a', 'a/b', 'a/b/c', '/', '/a/b', '/a/b/c'):
    ...
    assert repr(q) == r
print("PurePosixPathTest::test_repr_roundtrips: ok")
