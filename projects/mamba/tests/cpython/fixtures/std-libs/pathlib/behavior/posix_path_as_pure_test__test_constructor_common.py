...
# lib = "pathlib"
# dimension = "behavior"
# case = "posix_path_as_pure_test__test_constructor_common"
# subject = "cpython.test_pathlib.PosixPathAsPureTest.test_constructor_common"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pathlib.py::PosixPathAsPureTest::test_constructor_common
"""Auto-ported test: PosixPathAsPureTest::test_constructor_common (CPython 3.12 oracle)."""
...
assert P(P('./a:b')) == P('./a:b')
print("PosixPathAsPureTest::test_constructor_common: ok")
