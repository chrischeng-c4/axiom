...
# lib = "pathlib"
# dimension = "behavior"
# case = "pure_posix_path_test__test_constructor_common"
# subject = "cpython.test_pathlib.PurePosixPathTest.test_constructor_common"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pathlib.py::PurePosixPathTest::test_constructor_common
"""Auto-ported test: PurePosixPathTest::test_constructor_common (CPython 3.12 oracle)."""
...
assert P(P('./a:b')) == P('./a:b')
print("PurePosixPathTest::test_constructor_common: ok")
