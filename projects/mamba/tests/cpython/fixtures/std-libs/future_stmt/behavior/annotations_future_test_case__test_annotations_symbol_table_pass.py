...
# lib = "future_stmt"
# dimension = "behavior"
# case = "annotations_future_test_case__test_annotations_symbol_table_pass"
# subject = "cpython.test.test_future_stmt.test_future.AnnotationsFutureTestCase.test_annotations_symbol_table_pass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_future.py::AnnotationsFutureTestCase::test_annotations_symbol_table_pass
"""Auto-ported test: AnnotationsFutureTestCase::test_annotations_symbol_table_pass (CPython 3.12 oracle)."""
...
def getActual(annotation):
    ...
    return func_ret_ann
namespace = _exec_future(dedent('\n        from __future__ import annotations\n\n        def foo():\n            outer = 1\n            def bar():\n                inner: outer = 1\n            return bar\n        '))
foo = namespace.pop('foo')

assert foo().__closure__ is None

assert foo.__code__.co_cellvars == ()

assert foo().__code__.co_freevars == ()
print("AnnotationsFutureTestCase::test_annotations_symbol_table_pass: ok")
