...
# lib = "multibytecodec"
# dimension = "behavior"
# case = "test_incremental_encoder__test_stateful"
# subject = "cpython.test_multibytecodec.Test_IncrementalEncoder.test_stateful"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_multibytecodec.py::Test_IncrementalEncoder::test_stateful
"""Auto-ported test: Test_IncrementalEncoder::test_stateful (CPython 3.12 oracle)."""
...
assert encoder.encode('æ', True) == b'\xa9\xdc'
...
print("Test_IncrementalEncoder::test_stateful: ok")
