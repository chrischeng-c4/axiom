...
# lib = "multibytecodec"
# dimension = "behavior"
# case = "test_incremental_encoder__test_state_methods_with_buffer_state"
# subject = "cpython.test_multibytecodec.Test_IncrementalEncoder.test_state_methods_with_buffer_state"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_multibytecodec.py::Test_IncrementalEncoder::test_state_methods_with_buffer_state
"""Auto-ported test: Test_IncrementalEncoder::test_state_methods_with_buffer_state (CPython 3.12 oracle)."""
...
assert encoder.encode('̀') == b'\xab\xc4'
print("Test_IncrementalEncoder::test_state_methods_with_buffer_state: ok")
