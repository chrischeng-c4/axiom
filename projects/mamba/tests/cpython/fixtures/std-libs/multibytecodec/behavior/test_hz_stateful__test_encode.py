...
# lib = "multibytecodec"
# dimension = "behavior"
# case = "test_hz_stateful__test_encode"
# subject = "cpython.test_multibytecodec.TestHZStateful.test_encode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_multibytecodec.py::TestHZStateful::test_encode
"""Auto-ported test: TestHZStateful::test_encode (CPython 3.12 oracle)."""
...
assert text.encode(encoding) == expected_reset
print("TestHZStateful::test_encode: ok")
