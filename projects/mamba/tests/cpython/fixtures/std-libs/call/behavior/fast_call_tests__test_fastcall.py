...
# lib = "call"
# dimension = "behavior"
# case = "fast_call_tests__test_fastcall"
# subject = "cpython.test_call.FastCallTests.test_fastcall"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_call.py::FastCallTests::test_fastcall
"""Auto-ported test: FastCallTests::test_fastcall (CPython 3.12 oracle)."""
...
for func, args, expected in CALLS_POSARGS:
    ...
    if not args:
        ...
        check_result(result, expected)
print("FastCallTests::test_fastcall: ok")
