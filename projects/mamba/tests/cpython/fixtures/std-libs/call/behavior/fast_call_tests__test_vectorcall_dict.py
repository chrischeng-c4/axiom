...
# lib = "call"
# dimension = "behavior"
# case = "fast_call_tests__test_vectorcall_dict"
# subject = "cpython.test_call.FastCallTests.test_vectorcall_dict"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_call.py::FastCallTests::test_vectorcall_dict
"""Auto-ported test: FastCallTests::test_vectorcall_dict (CPython 3.12 oracle)."""
...
for func, args, kwargs, expected in CALLS_KWARGS:
    ...
    check_result(result, expected)
print("FastCallTests::test_vectorcall_dict: ok")
