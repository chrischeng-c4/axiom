...
# lib = "audit"
# dimension = "behavior"
# case = "audit_test__test_not_in_gc"
# subject = "cpython.test_audit.AuditTest.test_not_in_gc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audit.py::AuditTest::test_not_in_gc
"""Auto-ported test: AuditTest::test_not_in_gc (CPython 3.12 oracle)."""
...
returncode, _, stderr = run_python('test_not_in_gc')
if returncode:

    raise AssertionError(stderr)
print("AuditTest::test_not_in_gc: ok")
