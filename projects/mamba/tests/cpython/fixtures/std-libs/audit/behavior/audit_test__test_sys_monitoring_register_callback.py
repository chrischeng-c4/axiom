...
# lib = "audit"
# dimension = "behavior"
# case = "audit_test__test_sys_monitoring_register_callback"
# subject = "cpython.test_audit.AuditTest.test_sys_monitoring_register_callback"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audit.py::AuditTest::test_sys_monitoring_register_callback
"""Auto-ported test: AuditTest::test_sys_monitoring_register_callback (CPython 3.12 oracle)."""
...
returncode, events, stderr = run_python('test_sys_monitoring_register_callback')
if returncode:
...
print("AuditTest::test_sys_monitoring_register_callback: ok")
