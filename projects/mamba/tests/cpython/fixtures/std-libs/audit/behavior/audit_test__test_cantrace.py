...
# lib = "audit"
# dimension = "behavior"
# case = "audit_test__test_cantrace"
# subject = "cpython.test_audit.AuditTest.test_cantrace"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audit.py::AuditTest::test_cantrace
"""Auto-ported test: AuditTest::test_cantrace (CPython 3.12 oracle)."""
...
do_test('test_cantrace')
print("AuditTest::test_cantrace: ok")
