...
# lib = "audit"
# dimension = "behavior"
# case = "audit_test__test_unraisablehook"
# subject = "cpython.test_audit.AuditTest.test_unraisablehook"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audit.py::AuditTest::test_unraisablehook
"""Auto-ported test: AuditTest::test_unraisablehook (CPython 3.12 oracle)."""
...
returncode, events, stderr = run_python('test_unraisablehook')
if returncode:

    raise AssertionError(stderr)

assert events[0][0] == 'sys.unraisablehook'

assert events[0][2] == "RuntimeError('nonfatal-error') Exception ignored for audit hook test"
print("AuditTest::test_unraisablehook: ok")
