...
# lib = "audit"
# dimension = "behavior"
# case = "audit_test__test_monkeypatch"
# subject = "cpython.test_audit.AuditTest.test_monkeypatch"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audit.py::AuditTest::test_monkeypatch
"""Auto-ported test: AuditTest::test_monkeypatch (CPython 3.12 oracle)."""
...
do_test('test_monkeypatch')
print("AuditTest::test_monkeypatch: ok")
