...
# lib = "audit"
# dimension = "behavior"
# case = "audit_test__test_block_add_hook_baseexception"
# subject = "cpython.test_audit.AuditTest.test_block_add_hook_baseexception"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audit.py::AuditTest::test_block_add_hook_baseexception
"""Auto-ported test: AuditTest::test_block_add_hook_baseexception (CPython 3.12 oracle)."""
...
do_test('test_block_add_hook_baseexception')
print("AuditTest::test_block_add_hook_baseexception: ok")
