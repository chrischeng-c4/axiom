...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_intersection_update"
# subject = "cpython.test_weakset.TestWeakSet.test_intersection_update"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_intersection_update
"""Auto-ported test: TestWeakSet::test_intersection_update (CPython 3.12 oracle)."""
...
retval = self_s.intersection_update(self_items2)
...
try:
    self_s.intersection_update([[]])
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("TestWeakSet::test_intersection_update: ok")
