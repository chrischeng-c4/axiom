...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_update_set"
# subject = "cpython.test_weakset.TestWeakSet.test_update_set"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_update_set
"""Auto-ported test: TestWeakSet::test_update_set (CPython 3.12 oracle)."""
...
self_s.update(set(self_items2))
for c in self_items + self_items2:

    assert c in self_s
print("TestWeakSet::test_update_set: ok")
