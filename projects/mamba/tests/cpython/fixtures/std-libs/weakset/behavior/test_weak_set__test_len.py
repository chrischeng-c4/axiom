...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_len"
# subject = "cpython.test_weakset.TestWeakSet.test_len"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_len
"""Auto-ported test: TestWeakSet::test_len (CPython 3.12 oracle)."""
...
assert len(self_fs) == 0
print("TestWeakSet::test_len: ok")
