...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_sub_and_super"
# subject = "cpython.test_weakset.TestWeakSet.test_sub_and_super"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_sub_and_super
"""Auto-ported test: TestWeakSet::test_sub_and_super (CPython 3.12 oracle)."""
...
assert self_ab_weakset <= self_abcde_weakset

assert self_abcde_weakset <= self_abcde_weakset

assert self_abcde_weakset >= self_ab_weakset

assert not self_abcde_weakset <= self_def_weakset
...
print("TestWeakSet::test_sub_and_super: ok")
