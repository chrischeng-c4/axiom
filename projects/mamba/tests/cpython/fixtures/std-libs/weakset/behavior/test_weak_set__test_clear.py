...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_clear"
# subject = "cpython.test_weakset.TestWeakSet.test_clear"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_clear
"""Auto-ported test: TestWeakSet::test_clear (CPython 3.12 oracle)."""
...
assert self_s == WeakSet([])

assert len(self_s) == 0
print("TestWeakSet::test_clear: ok")
