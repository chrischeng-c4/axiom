...
# lib = "site"
# dimension = "behavior"
# case = "import_side_effect_tests__test_setting_help"
# subject = "cpython.test_site.ImportSideEffectTests.test_setting_help"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_site.py::ImportSideEffectTests::test_setting_help
"""Auto-ported test: ImportSideEffectTests::test_setting_help (CPython 3.12 oracle)."""
...
assert hasattr(builtins, 'help')
print("ImportSideEffectTests::test_setting_help: ok")
