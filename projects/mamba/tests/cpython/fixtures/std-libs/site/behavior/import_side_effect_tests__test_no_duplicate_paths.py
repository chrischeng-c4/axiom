...
# lib = "site"
# dimension = "behavior"
# case = "import_side_effect_tests__test_no_duplicate_paths"
# subject = "cpython.test_site.ImportSideEffectTests.test_no_duplicate_paths"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_site.py::ImportSideEffectTests::test_no_duplicate_paths
"""Auto-ported test: ImportSideEffectTests::test_no_duplicate_paths (CPython 3.12 oracle)."""
...
for path in sys.path:
    ...
    seen_paths.add(path)
print("ImportSideEffectTests::test_no_duplicate_paths: ok")
