...
# lib = "site"
# dimension = "behavior"
# case = "import_side_effect_tests__test_abs_paths_cached_none"
# subject = "cpython.test_site.ImportSideEffectTests.test_abs_paths_cached_None"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_site.py::ImportSideEffectTests::test_abs_paths_cached_None
"""Auto-ported test: ImportSideEffectTests::test_abs_paths_cached_None (CPython 3.12 oracle)."""
...
assert sys.modules['test'].__cached__ is None
print("ImportSideEffectTests::test_abs_paths_cached_None: ok")
