...
# dimension = "behavior"
# case = "spawn_cmd_line_test__test_basic_script"
# subject = "cpython.test_multiprocessing_main_handling.SpawnCmdLineTest.test_basic_script"
# kind = "semantic"
...
"""Multiprocessing spawn can run a normal script and expose __main__ functions."""
...
with tempfile.TemporaryDirectory(prefix="mamba-cpython-mp-main-") as tmpdir:
    ...
    os.chdir(tmpdir)
    try:
        suite = unittest.TestSuite([tmh.SpawnCmdLineTest("test_basic_script")])
...
if result.skipped:
    print("spawn_cmd_line_test__test_basic_script skipped:", result.skipped[0][1])
else:
    print("spawn_cmd_line_test__test_basic_script OK")
