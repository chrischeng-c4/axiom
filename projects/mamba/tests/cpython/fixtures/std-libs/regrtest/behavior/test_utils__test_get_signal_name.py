...
# lib = "regrtest"
# dimension = "behavior"
# case = "test_utils__test_get_signal_name"
# subject = "cpython.test_regrtest.TestUtils.test_get_signal_name"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_regrtest.py::TestUtils::test_get_signal_name
"""Auto-ported test: TestUtils::test_get_signal_name (CPython 3.12 oracle)."""
...
# --- test body ---
for exitcode, expected in ((-int(signal.SIGINT), 'SIGINT'), (-int(signal.SIGSEGV), 'SIGSEGV'), (3221225477, 'STATUS_ACCESS_VIOLATION'), (3221225725, 'STATUS_STACK_OVERFLOW')):

    assert utils.get_signal_name(exitcode) == expected
print("TestUtils::test_get_signal_name: ok")
