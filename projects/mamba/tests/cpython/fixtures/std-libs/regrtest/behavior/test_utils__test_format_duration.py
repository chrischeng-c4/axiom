...
# lib = "regrtest"
# dimension = "behavior"
# case = "test_utils__test_format_duration"
# subject = "cpython.test_regrtest.TestUtils.test_format_duration"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_regrtest.py::TestUtils::test_format_duration
"""Auto-ported test: TestUtils::test_format_duration (CPython 3.12 oracle)."""
...
assert utils.format_duration(0) == '0 ms'

assert utils.format_duration(1e-09) == '1 ms'

assert utils.format_duration(0.01) == '10 ms'

assert utils.format_duration(1.5) == '1.5 sec'

assert utils.format_duration(1) == '1.0 sec'

assert utils.format_duration(2 * 60) == '2 min'

assert utils.format_duration(2 * 60 + 1) == '2 min 1 sec'

assert utils.format_duration(3 * 3600) == '3 hour'

assert utils.format_duration(3 * 3600 + 2 * 60 + 1) == '3 hour 2 min'

assert utils.format_duration(3 * 3600 + 1) == '3 hour 1 sec'
print("TestUtils::test_format_duration: ok")
