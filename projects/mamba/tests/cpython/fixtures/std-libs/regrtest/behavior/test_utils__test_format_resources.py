...
# lib = "regrtest"
# dimension = "behavior"
# case = "test_utils__test_format_resources"
# subject = "cpython.test_regrtest.TestUtils.test_format_resources"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_regrtest.py::TestUtils::test_format_resources
"""Auto-ported test: TestUtils::test_format_resources (CPython 3.12 oracle)."""
...
assert format_resources(('network',)) == 'resources (1): network'

assert format_resources(('audio', 'decimal', 'network')) == 'resources (3): audio,decimal,network'

assert format_resources(ALL_RESOURCES) == 'resources: all'

assert format_resources(tuple((name for name in ALL_RESOURCES if name != 'cpu'))) == 'resources: all,-cpu'

assert format_resources((*ALL_RESOURCES, 'tzdata')) == 'resources: all,tzdata'
print("TestUtils::test_format_resources: ok")
