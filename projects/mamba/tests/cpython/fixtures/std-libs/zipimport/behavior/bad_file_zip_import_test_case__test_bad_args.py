...
# lib = "zipimport"
# dimension = "behavior"
# case = "bad_file_zip_import_test_case__test_bad_args"
# subject = "cpython.test_zipimport.BadFileZipImportTestCase.testBadArgs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_zipimport.py::BadFileZipImportTestCase::testBadArgs
"""Auto-ported test: BadFileZipImportTestCase::testBadArgs (CPython 3.12 oracle)."""
...
try:
    zipimport.zipimporter(TESTMOD, kwd=None)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    zipimport.zipimporter(list(os.fsencode(TESTMOD)))
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("BadFileZipImportTestCase::testBadArgs: ok")
