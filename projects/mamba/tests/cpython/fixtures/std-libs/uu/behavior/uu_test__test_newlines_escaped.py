...
# lib = "uu"
# dimension = "behavior"
# case = "uu_test__test_newlines_escaped"
# subject = "cpython.test_uu.UUTest.test_newlines_escaped"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_uu.py::UUTest::test_newlines_escaped
"""Auto-ported test: UUTest::test_newlines_escaped (CPython 3.12 oracle)."""
...
assert safefilename in out.getvalue()
print("UUTest::test_newlines_escaped: ok")
