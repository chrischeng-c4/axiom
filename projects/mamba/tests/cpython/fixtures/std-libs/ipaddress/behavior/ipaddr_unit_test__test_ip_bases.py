...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_ip_bases"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testIPBases"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testIPBases
"""Auto-ported test: IpaddrUnitTest::testIPBases (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("IpaddrUnitTest::testIPBases: ok")
