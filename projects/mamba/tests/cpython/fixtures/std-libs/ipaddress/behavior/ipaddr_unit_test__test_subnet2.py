...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_subnet2"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testSubnet2"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testSubnet2
"""Auto-ported test: IpaddrUnitTest::testSubnet2 (CPython 3.12 oracle)."""
...
ips = [str(x) for x in self_ipv4_network.subnets(2)]

assert ips == ['1.2.3.0/26', '1.2.3.64/26', '1.2.3.128/26', '1.2.3.192/26']
ipsv6 = [str(x) for x in self_ipv6_network.subnets(2)]

assert ipsv6 == ['2001:658:22a:cafe::/66', '2001:658:22a:cafe:4000::/66', '2001:658:22a:cafe:8000::/66', '2001:658:22a:cafe:c000::/66']
print("IpaddrUnitTest::testSubnet2: ok")
