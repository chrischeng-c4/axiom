...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_slash32_constructor"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testSlash32Constructor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testSlash32Constructor
"""Auto-ported test: IpaddrUnitTest::testSlash32Constructor (CPython 3.12 oracle)."""
...
print("IpaddrUnitTest::testSlash32Constructor: ok")
