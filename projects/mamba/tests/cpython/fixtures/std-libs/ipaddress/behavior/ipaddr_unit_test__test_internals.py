...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_internals"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testInternals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testInternals
"""Auto-ported test: IpaddrUnitTest::testInternals (CPython 3.12 oracle)."""
...
assert "IPv4Network('1.2.3.0/24')" == repr(self_ipv4_network)
print("IpaddrUnitTest::testInternals: ok")
