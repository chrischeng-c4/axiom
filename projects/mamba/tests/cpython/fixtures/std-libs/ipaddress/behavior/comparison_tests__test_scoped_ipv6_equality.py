...
# lib = "ipaddress"
# dimension = "behavior"
# case = "comparison_tests__test_scoped_ipv6_equality"
# subject = "cpython.test_ipaddress.ComparisonTests.test_scoped_ipv6_equality"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::ComparisonTests::test_scoped_ipv6_equality
"""Auto-ported test: ComparisonTests::test_scoped_ipv6_equality (CPython 3.12 oracle)."""
...
for lhs, rhs in zip(v6_objects, v6_scoped_objects):
    ...
    assert lhs != rhs
print("ComparisonTests::test_scoped_ipv6_equality: ok")
