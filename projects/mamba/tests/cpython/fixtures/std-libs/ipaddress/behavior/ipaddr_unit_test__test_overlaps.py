...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_overlaps"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testOverlaps"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testOverlaps
"""Auto-ported test: IpaddrUnitTest::testOverlaps (CPython 3.12 oracle)."""
...
assert self_ipv4_network.overlaps(other)

assert not self_ipv4_network.overlaps(other2)

assert other2.overlaps(other3)
print("IpaddrUnitTest::testOverlaps: ok")
