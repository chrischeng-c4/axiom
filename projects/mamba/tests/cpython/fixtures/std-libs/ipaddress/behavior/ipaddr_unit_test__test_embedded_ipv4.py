...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_embedded_ipv4"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testEmbeddedIpv4"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testEmbeddedIpv4
"""Auto-ported test: IpaddrUnitTest::testEmbeddedIpv4 (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('expected ipaddress.AddressValueError')
except ipaddress.AddressValueError:
    pass
print("IpaddrUnitTest::testEmbeddedIpv4: ok")
