...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_get_ip"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testGetIp"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testGetIp
"""Auto-ported test: IpaddrUnitTest::testGetIp (CPython 3.12 oracle)."""
...
assert int(self_ipv4_interface.ip) == 16909060

assert str(self_ipv4_interface.ip) == '1.2.3.4'

assert int(self_ipv6_interface.ip) == 42540616829182469433547762482097946625

assert str(self_ipv6_interface.ip) == '2001:658:22a:cafe:200::1'

assert int(self_ipv6_scoped_interface.ip) == 42540616829182469433547762482097946625

assert str(self_ipv6_scoped_interface.ip) == '2001:658:22a:cafe:200::1'
print("IpaddrUnitTest::testGetIp: ok")
