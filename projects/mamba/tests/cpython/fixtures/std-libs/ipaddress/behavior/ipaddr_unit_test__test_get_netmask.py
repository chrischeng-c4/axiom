...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_get_netmask"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testGetNetmask"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testGetNetmask
"""Auto-ported test: IpaddrUnitTest::testGetNetmask (CPython 3.12 oracle)."""
...
assert int(self_ipv4_network.netmask) == 4294967040

assert str(self_ipv4_network.netmask) == '255.255.255.0'

assert int(self_ipv6_network.netmask) == 340282366920938463444927863358058659840

assert self_ipv6_network.prefixlen == 64

assert int(self_ipv6_scoped_network.netmask) == 340282366920938463444927863358058659840

assert self_ipv6_scoped_network.prefixlen == 64
print("IpaddrUnitTest::testGetNetmask: ok")
