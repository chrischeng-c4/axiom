...
# lib = "keywordonlyarg"
# dimension = "behavior"
# case = "keyword_only_arg_test_case__test_kwonly_methods"
# subject = "cpython.test_keywordonlyarg.KeywordOnlyArgTestCase.test_kwonly_methods"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_keywordonlyarg.py::KeywordOnlyArgTestCase::test_kwonly_methods
"""Auto-ported test: KeywordOnlyArgTestCase::test_kwonly_methods (CPython 3.12 oracle)."""
...
assert Example().f(k1=1, k2=2) == (1, 2)

assert Example.f(Example(), k1=1, k2=2) == (1, 2)
...
try:
    ...
    pass
print("KeywordOnlyArgTestCase::test_kwonly_methods: ok")
