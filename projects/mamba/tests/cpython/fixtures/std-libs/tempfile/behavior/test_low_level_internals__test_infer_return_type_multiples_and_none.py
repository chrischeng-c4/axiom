...
# lib = "tempfile"
# dimension = "behavior"
# case = "test_low_level_internals__test_infer_return_type_multiples_and_none"
# subject = "cpython.test_tempfile.TestLowLevelInternals.test_infer_return_type_multiples_and_none"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tempfile.py::TestLowLevelInternals::test_infer_return_type_multiples_and_none
"""Auto-ported test: TestLowLevelInternals::test_infer_return_type_multiples_and_none (CPython 3.12 oracle)."""
...
assert str is tempfile._infer_return_type(None, None)

assert bytes is tempfile._infer_return_type(b'', None)

assert bytes is tempfile._infer_return_type(None, b'')
try:
...
try:
    ...
    pass
print("TestLowLevelInternals::test_infer_return_type_multiples_and_none: ok")
