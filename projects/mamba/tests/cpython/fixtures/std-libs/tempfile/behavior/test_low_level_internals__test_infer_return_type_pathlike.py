...
# lib = "tempfile"
# dimension = "behavior"
# case = "test_low_level_internals__test_infer_return_type_pathlike"
# subject = "cpython.test_tempfile.TestLowLevelInternals.test_infer_return_type_pathlike"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tempfile.py::TestLowLevelInternals::test_infer_return_type_pathlike
"""Auto-ported test: TestLowLevelInternals::test_infer_return_type_pathlike (CPython 3.12 oracle)."""
...
assert str is tempfile._infer_return_type(Path('/'))

assert bytes is tempfile._infer_return_type(Path(b'/'))

assert str is tempfile._infer_return_type('', Path(''))

assert bytes is tempfile._infer_return_type(b'', Path(b''))

assert bytes is tempfile._infer_return_type(None, Path(b''))

assert str is tempfile._infer_return_type(None, Path(''))
try:
...
try:
    ...
    pass
print("TestLowLevelInternals::test_infer_return_type_pathlike: ok")
