...
# lib = "posixpath"
# dimension = "behavior"
# case = "path_like_tests__test_path_basename"
# subject = "cpython.test_posixpath.PathLikeTests.test_path_basename"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posixpath.py::PathLikeTests::test_path_basename
"""Auto-ported test: PathLikeTests::test_path_basename (CPython 3.12 oracle)."""
...
assertPathEqual(path.basename)
print("PathLikeTests::test_path_basename: ok")
