...
# subject = "cpython.test_zlib.ChecksumBigBufferTestCase.test_big_buffer"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_zlib.py::ChecksumBigBufferTestCase::test_big_buffer
...
assert zlib.crc32(data) == 1044521549

assert zlib.adler32(data) == 2256789997
