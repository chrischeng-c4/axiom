...
# lib = "heapq"
# dimension = "behavior"
# case = "test_heap_c__test_merge_stability"
# subject = "cpython.test_heapq.TestHeapC.test_merge_stability"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_heapq.py::TestHeapC::test_merge_stability
"""Auto-ported test: TestHeapC::test_merge_stability (CPython 3.12 oracle)."""
...
for stream in inputs:
    stream.sort()
result = [i.pair for i in module.merge(*inputs)]

assert result == sorted(result)
print("TestHeapC::test_merge_stability: ok")
