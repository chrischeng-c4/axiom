...
# lib = "heapq"
# dimension = "behavior"
# case = "test_error_handling_python__test_iterable_args"
# subject = "cpython.test_heapq.TestErrorHandlingPython.test_iterable_args"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_heapq.py::TestErrorHandlingPython::test_iterable_args
"""Auto-ported test: TestErrorHandlingPython::test_iterable_args (CPython 3.12 oracle)."""
...
for f in (module.nlargest, module.nsmallest):
    for s in ('123', '', range(1000), (1, 1.2), range(2000, 2200, 5)):
        for g in (G, I, Ig, L, R):
            ...
            assert list(f(2, g(s))) == list(f(2, s))
        ...
        try:
            ...
            pass
print("TestErrorHandlingPython::test_iterable_args: ok")
