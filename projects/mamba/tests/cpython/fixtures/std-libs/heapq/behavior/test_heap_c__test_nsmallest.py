...
# lib = "heapq"
# dimension = "behavior"
# case = "test_heap_c__test_nsmallest"
# subject = "cpython.test_heapq.TestHeapC.test_nsmallest"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_heapq.py::TestHeapC::test_nsmallest
"""Auto-ported test: TestHeapC::test_nsmallest (CPython 3.12 oracle)."""
...
for f in (None, lambda x: x[0] * 547 % 2000):
    for n in (0, 1, 2, 10, 100, 400, 999, 1000, 1100):
        ...
        assert list(module.nsmallest(n, data)) == sorted(data)[:n]

        assert list(module.nsmallest(n, data, key=f)) == sorted(data, key=f)[:n]
print("TestHeapC::test_nsmallest: ok")
