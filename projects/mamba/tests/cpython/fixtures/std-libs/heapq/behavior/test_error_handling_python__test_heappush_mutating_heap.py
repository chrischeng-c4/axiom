...
# lib = "heapq"
# dimension = "behavior"
# case = "test_error_handling_python__test_heappush_mutating_heap"
# subject = "cpython.test_heapq.TestErrorHandlingPython.test_heappush_mutating_heap"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_heapq.py::TestErrorHandlingPython::test_heappush_mutating_heap
"""Auto-ported test: TestErrorHandlingPython::test_heappush_mutating_heap (CPython 3.12 oracle)."""
...
try:
    module.heappush(heap, SideEffectLT(5, heap))
    raise AssertionError('expected (IndexError, RuntimeError)')
except (IndexError, RuntimeError):
    pass
print("TestErrorHandlingPython::test_heappush_mutating_heap: ok")
