...
# subject = "cpython.test_heapq.TestModules.test_py_functions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_heapq.py::TestModules::test_py_functions
...
for fname in func_names:
    ...
    assert getattr(py_heapq, fname).__module__ == 'heapq'
