...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_open_file_with_name"
# subject = "cpython.test_bz2.BZ2FileTest.testOpenFileWithName"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::testOpenFileWithName
"""Auto-ported test: BZ2FileTest::testOpenFileWithName (CPython 3.12 oracle)."""
...
os.close(fd)
with open(self_filename, 'wb') as raw:
    ...
    try:
        ...
        pass
with open(self_filename, 'ab') as raw:
    ...
    try:
        ...
        pass
with open(self_filename, 'rb') as raw:
    with BZ2File(raw, 'rb') as f:

        assert f.read() == b'contentappendix'
    ...
    try:
        ...
        pass
print("BZ2FileTest::testOpenFileWithName: ok")
