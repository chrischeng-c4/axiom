...
# lib = "bz2"
# dimension = "behavior"
# case = "compress_decompress_test__test_decompress_incomplete"
# subject = "cpython.test_bz2.CompressDecompressTest.testDecompressIncomplete"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::CompressDecompressTest::testDecompressIncomplete
"""Auto-ported test: CompressDecompressTest::testDecompressIncomplete (CPython 3.12 oracle)."""
...
try:
    bz2.decompress(DATA[:-10])
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("CompressDecompressTest::testDecompressIncomplete: ok")
