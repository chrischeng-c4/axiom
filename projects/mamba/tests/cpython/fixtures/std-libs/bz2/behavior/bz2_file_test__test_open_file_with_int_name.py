...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_open_file_with_int_name"
# subject = "cpython.test_bz2.BZ2FileTest.testOpenFileWithIntName"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::testOpenFileWithIntName
"""Auto-ported test: BZ2FileTest::testOpenFileWithIntName (CPython 3.12 oracle)."""
...
os.close(fd)
fd = os.open(self_filename, os.O_WRONLY | os.O_CREAT | os.O_TRUNC)
with open(fd, 'wb') as raw:
    ...
    try:
        ...
        pass
fd = os.open(self_filename, os.O_WRONLY | os.O_CREAT | os.O_APPEND)
with open(fd, 'ab') as raw:
    ...
    try:
        ...
        pass
fd = os.open(self_filename, os.O_RDONLY)
with open(fd, 'rb') as raw:
    ...
    try:
        ...
        pass
print("BZ2FileTest::testOpenFileWithIntName: ok")
