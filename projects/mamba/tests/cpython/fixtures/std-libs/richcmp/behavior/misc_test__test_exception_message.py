...
# lib = "richcmp"
# dimension = "behavior"
# case = "misc_test__test_exception_message"
# subject = "cpython.test_richcmp.MiscTest.test_exception_message"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_richcmp.py::MiscTest::test_exception_message
"""Auto-ported test: MiscTest::test_exception_message (CPython 3.12 oracle)."""
...
for i, test in enumerate(tests):
    try:
        ...
        import re as _re_aR
        assert _re_aR.search(test[1], str(_aR_e))
print("MiscTest::test_exception_message: ok")
