...
# dimension = "behavior"
# case = "channel_tests__test_send_recv_different_interpreters"
# subject = "cpython.test__xxinterpchannels.ChannelTests.test_send_recv_different_interpreters"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelTests::test_send_recv_different_interpreters
"""Auto-ported test: ChannelTests::test_send_recv_different_interpreters (CPython 3.12 oracle)."""
...
assert obj == b'spam'
print("ChannelTests::test_send_recv_different_interpreters: ok")
