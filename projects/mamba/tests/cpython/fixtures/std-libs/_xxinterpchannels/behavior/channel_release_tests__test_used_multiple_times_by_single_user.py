...
# dimension = "behavior"
# case = "channel_release_tests__test_used_multiple_times_by_single_user"
# subject = "cpython.test__xxinterpchannels.ChannelReleaseTests.test_used_multiple_times_by_single_user"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelReleaseTests::test_used_multiple_times_by_single_user
"""Auto-ported test: ChannelReleaseTests::test_used_multiple_times_by_single_user (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('expected channels.ChannelClosedError')
except channels.ChannelClosedError:
    pass
try:
    channels.recv(cid)
    ...
    pass
print("ChannelReleaseTests::test_used_multiple_times_by_single_user: ok")
