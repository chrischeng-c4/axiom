...
# dimension = "behavior"
# case = "channel_id_tests__test_bad_kwargs"
# subject = "cpython.test__xxinterpchannels.ChannelIDTests.test_bad_kwargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelIDTests::test_bad_kwargs
"""Auto-ported test: ChannelIDTests::test_bad_kwargs (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("ChannelIDTests::test_bad_kwargs: ok")
