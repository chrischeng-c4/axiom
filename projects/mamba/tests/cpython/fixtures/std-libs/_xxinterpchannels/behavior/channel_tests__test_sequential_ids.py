...
# dimension = "behavior"
# case = "channel_tests__test_sequential_ids"
# subject = "cpython.test__xxinterpchannels.ChannelTests.test_sequential_ids"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelTests::test_sequential_ids
"""Auto-ported test: ChannelTests::test_sequential_ids (CPython 3.12 oracle)."""
...
assert id2 == int(id1) + 1

assert id3 == int(id2) + 1

assert set(after) - set(before) == {id1, id2, id3}
print("ChannelTests::test_sequential_ids: ok")
