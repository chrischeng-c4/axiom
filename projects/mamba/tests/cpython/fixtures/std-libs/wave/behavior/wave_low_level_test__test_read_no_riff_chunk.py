...
# lib = "wave"
# dimension = "behavior"
# case = "wave_low_level_test__test_read_no_riff_chunk"
# subject = "cpython.test_wave.WaveLowLevelTest.test_read_no_riff_chunk"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wave.py::WaveLowLevelTest::test_read_no_riff_chunk
"""Auto-ported test: WaveLowLevelTest::test_read_no_riff_chunk (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('file does not start with RIFF id', str(_aR_e))
print("WaveLowLevelTest::test_read_no_riff_chunk: ok")
