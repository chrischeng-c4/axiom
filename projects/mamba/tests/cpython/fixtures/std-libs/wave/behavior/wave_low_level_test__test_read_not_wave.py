...
# lib = "wave"
# dimension = "behavior"
# case = "wave_low_level_test__test_read_not_wave"
# subject = "cpython.test_wave.WaveLowLevelTest.test_read_not_wave"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wave.py::WaveLowLevelTest::test_read_not_wave
"""Auto-ported test: WaveLowLevelTest::test_read_not_wave (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('not a WAVE file', str(_aR_e))
print("WaveLowLevelTest::test_read_not_wave: ok")
