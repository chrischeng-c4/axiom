...
# lib = "wave"
# dimension = "behavior"
# case = "wave_low_level_test__test_read_wrong_number_of_channels"
# subject = "cpython.test_wave.WaveLowLevelTest.test_read_wrong_number_of_channels"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wave.py::WaveLowLevelTest::test_read_wrong_number_of_channels
"""Auto-ported test: WaveLowLevelTest::test_read_wrong_number_of_channels (CPython 3.12 oracle)."""
...
class WavePCM8Test(WaveTest, unittest.TestCase):
    ...
    frames = bytes.fromhex('      827F CB80 B184 0088 4B86 C883 3F81 837E 387A 3473 A96B 9A66       6D64 4662 8E60 6F60 D762 7B68 936F 5877 177B 757C 887B 5F7B       917A BE7B 3C7C E67F 4F84 C389 418E D192 6E97 0296 FF94 0092       C98E D28D 6F8F 4E8F 648C E38A 888A AB8B D18E 0B91 368E C48A       ')
...
except wave.Error as _aR_e:
    import re as _re_aR
    assert _re_aR.search('bad # of channels', str(_aR_e))
print("WaveLowLevelTest::test_read_wrong_number_of_channels: ok")
