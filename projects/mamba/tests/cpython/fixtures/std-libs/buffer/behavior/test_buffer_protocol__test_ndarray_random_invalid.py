...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_random_invalid"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_random_invalid"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_random_invalid
"""Auto-ported test: TestBufferProtocol::test_ndarray_random_invalid (CPython 3.12 oracle)."""
    ...
    for fmt in fmtdict['@']:
        ...
        if numpy_array:
            ...
            if 0:
                ...
                assert numpy_err
print("TestBufferProtocol::test_ndarray_random_invalid: ok")
