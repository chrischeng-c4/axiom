...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_exceptions"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_exceptions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_exceptions
"""Auto-ported test: TestBufferProtocol::test_ndarray_exceptions (CPython 3.12 oracle)."""
...
for c in (ndarray, nd.push, ndm.push):
    ...
    try:
        c([1, 2, 3], shape=[3], strides={1})
        raise AssertionError('expected TypeError')
    except TypeError:
        pass

    try:
        c([1, 2, 3], shape=[3], offset=[])
        raise AssertionError('expected TypeError')
    except TypeError:
        pass
    ...
    try:
        c([1], shape=[1], strides=[1], flags=ND_FORTRAN)
        raise AssertionError('expected TypeError')
    except TypeError:
        pass

    try:
        c([1], shape=[], flags=ND_PIL)
        raise AssertionError('expected TypeError')
    except TypeError:
        pass
    ...
    try:
        c(['XXX'], shape=[1], format='L')
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        c([1000], shape=[1], format='B')
        raise AssertionError('expected struct.error')
    except struct.error:
        pass

    try:
        c([1, (2, 3)], shape=[2], format='B')
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        c([1, 2, 3], shape=[3], format='QL')
        raise AssertionError('expected ValueError')
    except ValueError:
        pass
    n = ND_MAX_NDIM + 1
    ...
    try:
        c([1, 2, 3, 4, 5], shape=[2, 2], offset=3)
        raise AssertionError('expected ValueError')
    except ValueError:
        pass
    ...
    try:
        c([1], shape=[1], strides=[2 ** 128])
        raise AssertionError('expected OverflowError')
    except OverflowError:
        pass

    try:
        c([1, 2], shape=[2, 1], strides=[1])
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        c([1, 2, 3, 4], shape=[2], strides=[3], format='L')
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        c([1, 2, 3], shape=[3], offset=4)
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        c([1, 2, 3], shape=[1], offset=3, format='L')
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        c([1, 2, 3], shape=[3], format='')
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        c([(1, 2, 3)], shape=[1], format='@#$')
        raise AssertionError('expected struct.error')
    except struct.error:
        pass
    ...
    try:
        c(items, shape=[2, 3], strides=[-3, -2], offset=5)
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        c(bytearray(), format='Q')
        raise AssertionError('expected TypeError')
    except TypeError:
        pass

    try:
        c([1], shape=[1], getbuf=PyBUF_FULL)
        raise AssertionError('expected TypeError')
    except TypeError:
        pass
...
try:
    nd.push([1], [1], flags=ND_VAREXPORT)
    raise AssertionError('expected ValueError')
except ValueError:
    pass
nd = ndarray(b'123')
...
try:
    get_contiguous(1, 2, 3, 4, 5)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    get_contiguous(nd, 'xyz', 'C')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    get_contiguous(nd, 2 ** 64, 'C')
    raise AssertionError('expected OverflowError')
except OverflowError:
    pass

try:
    get_contiguous(nd, PyBUF_READ, 961)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    get_contiguous(nd, PyBUF_READ, '\u2007')
    raise AssertionError('expected UnicodeEncodeError')
except UnicodeEncodeError:
    pass

try:
    get_contiguous(nd, PyBUF_READ, 'Z')
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    get_contiguous(nd, 255, 'A')
    raise AssertionError('expected ValueError')
except ValueError:
    pass
nd = ndarray([1], shape=[1])
...
try:
    is_contiguous(nd, 201)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("TestBufferProtocol::test_ndarray_exceptions: ok")
