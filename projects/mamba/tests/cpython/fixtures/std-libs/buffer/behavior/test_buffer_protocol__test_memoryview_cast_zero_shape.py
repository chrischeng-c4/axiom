...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_cast_zero_shape"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_cast_zero_shape"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_cast_zero_shape
"""Auto-ported test: TestBufferProtocol::test_memoryview_cast_zero_shape (CPython 3.12 oracle)."""
...
for fmt, _, _ in iter_format(1, 'memoryview'):
    ...
    assert m.tolist() == []
print("TestBufferProtocol::test_memoryview_cast_zero_shape: ok")
