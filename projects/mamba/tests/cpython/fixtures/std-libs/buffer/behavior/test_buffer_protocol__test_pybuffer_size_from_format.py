...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_pybuffer_size_from_format"
# subject = "cpython.test_buffer.TestBufferProtocol.test_pybuffer_size_from_format"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_pybuffer_size_from_format
"""Auto-ported test: TestBufferProtocol::test_pybuffer_size_from_format (CPython 3.12 oracle)."""
...
for format in ('', 'ii', '3s'):
    ...
    assert _testcapi.PyBuffer_SizeFromFormat(format) == struct.calcsize(format)
print("TestBufferProtocol::test_pybuffer_size_from_format: ok")
