...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_get_pointer"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_get_pointer"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_get_pointer
"""Auto-ported test: TestBufferProtocol::test_ndarray_get_pointer (CPython 3.12 oracle)."""
...
for flags in (0, ND_PIL):
    ...
    for i in range(3):
        ...
        assert nd[i] == get_pointer(nd, [i])
print("TestBufferProtocol::test_ndarray_get_pointer: ok")
