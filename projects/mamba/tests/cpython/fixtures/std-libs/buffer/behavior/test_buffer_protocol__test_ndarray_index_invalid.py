...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_index_invalid"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_index_invalid"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_index_invalid
"""Auto-ported test: TestBufferProtocol::test_ndarray_index_invalid (CPython 3.12 oracle)."""
...
try:
    nd.__setitem__(2, 300)
    raise AssertionError('expected struct.error')
except struct.error:
    pass

try:
    nd.__setitem__(1, (100, 200))
...
try:
    mv.__setitem__(2, 300)
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    mv.__setitem__(1, (100, 200))
    raise AssertionError('expected TypeError')
except TypeError:
    pass
items = [(1, 2), (3, 4), (5, 6)]
...
try:
    nd.__setitem__(1, (b'\x001', 200))
    raise AssertionError('expected struct.error')
except struct.error:
    pass
print("TestBufferProtocol::test_ndarray_index_invalid: ok")
