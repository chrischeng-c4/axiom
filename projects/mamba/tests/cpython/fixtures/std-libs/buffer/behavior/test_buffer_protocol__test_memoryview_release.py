...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_release"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_release"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_release
"""Auto-ported test: TestBufferProtocol::test_memoryview_release (CPython 3.12 oracle)."""
...
assert x.tolist() == m1.tolist()
y = memoryview(m2)

assert y.tolist() == m2.tolist()

assert y.tolist() == nd.tolist()
m2.release()
y.release()
nd.pop()

assert x.tolist() == nd.tolist()
del nd
m1.release()
x.release()
...
with memoryview(z) as m:
    ...
    assert m[0:1].tolist() == [[[0, 1, 2], [3, 4, 5]]]
...
try:
    ...
    pass
print("TestBufferProtocol::test_memoryview_release: ok")
