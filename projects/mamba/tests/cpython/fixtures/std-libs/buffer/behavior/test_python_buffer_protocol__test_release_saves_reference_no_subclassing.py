...
# lib = "buffer"
# dimension = "behavior"
# case = "test_python_buffer_protocol__test_release_saves_reference_no_subclassing"
# subject = "cpython.test_buffer.TestPythonBufferProtocol.test_release_saves_reference_no_subclassing"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestPythonBufferProtocol::test_release_saves_reference_no_subclassing
"""Auto-ported test: TestPythonBufferProtocol::test_release_saves_reference_no_subclassing (CPython 3.12 oracle)."""
...
c.buffer.release()
ba.clear()
print("TestPythonBufferProtocol::test_release_saves_reference_no_subclassing: ok")
