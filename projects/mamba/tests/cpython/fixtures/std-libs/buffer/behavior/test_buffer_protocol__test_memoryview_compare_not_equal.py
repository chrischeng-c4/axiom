...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_compare_not_equal"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_compare_not_equal"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_compare_not_equal
"""Auto-ported test: TestBufferProtocol::test_memoryview_compare_not_equal (CPython 3.12 oracle)."""
...
for byteorder in ['=', '<', '>', '!']:
    ...
    assert b != x
print("TestBufferProtocol::test_memoryview_compare_not_equal: ok")
