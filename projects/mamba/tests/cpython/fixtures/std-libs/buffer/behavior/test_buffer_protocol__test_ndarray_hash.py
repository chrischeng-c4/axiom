...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_hash"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_hash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_hash
"""Auto-ported test: TestBufferProtocol::test_ndarray_hash (CPython 3.12 oracle)."""
...
assert hash(nd) == hash(nd.tobytes())
print("TestBufferProtocol::test_ndarray_hash: ok")
