...
# lib = "file"
# dimension = "behavior"
# case = "py_other_file_tests__test_truncate_on_windows"
# subject = "cpython.test_file.PyOtherFileTests.testTruncateOnWindows"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_file.py::PyOtherFileTests::testTruncateOnWindows
"""Auto-ported test: PyOtherFileTests::testTruncateOnWindows (CPython 3.12 oracle)."""
...
try:
    ...
    f.close()
print("PyOtherFileTests::testTruncateOnWindows: ok")
