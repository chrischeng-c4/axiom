...
# lib = "functools"
# dimension = "behavior"
# case = "test_single_dispatch__test_simple_overloads"
# subject = "cpython.test_functools.TestSingleDispatch.test_simple_overloads"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestSingleDispatch::test_simple_overloads
"""Auto-ported test: TestSingleDispatch::test_simple_overloads (CPython 3.12 oracle)."""
...
assert g([1, 2, 3]) == 'base'
print("TestSingleDispatch::test_simple_overloads: ok")
