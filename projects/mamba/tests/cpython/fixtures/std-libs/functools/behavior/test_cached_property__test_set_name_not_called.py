...
# lib = "functools"
# dimension = "behavior"
# case = "test_cached_property__test_set_name_not_called"
# subject = "cpython.test_functools.TestCachedProperty.test_set_name_not_called"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestCachedProperty::test_set_name_not_called
"""Auto-ported test: TestCachedProperty::test_set_name_not_called (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot use cached_property instance without calling __set_name__ on it.', str(_aR_e))
print("TestCachedProperty::test_set_name_not_called: ok")
