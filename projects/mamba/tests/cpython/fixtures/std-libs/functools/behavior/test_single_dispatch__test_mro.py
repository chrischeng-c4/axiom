...
# lib = "functools"
# dimension = "behavior"
# case = "test_single_dispatch__test_mro"
# subject = "cpython.test_functools.TestSingleDispatch.test_mro"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestSingleDispatch::test_mro
"""Auto-ported test: TestSingleDispatch::test_mro (CPython 3.12 oracle)."""
...
assert g(D()) == 'B'
print("TestSingleDispatch::test_mro: ok")
