...
# lib = "functools"
# dimension = "behavior"
# case = "test_cached_property__test_access_from_class"
# subject = "cpython.test_functools.TestCachedProperty.test_access_from_class"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestCachedProperty::test_access_from_class
"""Auto-ported test: TestCachedProperty::test_access_from_class (CPython 3.12 oracle)."""
...
assert isinstance(CachedCostItem.cost, py_functools.cached_property)
print("TestCachedProperty::test_access_from_class: ok")
