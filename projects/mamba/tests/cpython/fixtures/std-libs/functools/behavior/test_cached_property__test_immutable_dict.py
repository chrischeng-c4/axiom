...
# lib = "functools"
# dimension = "behavior"
# case = "test_cached_property__test_immutable_dict"
# subject = "cpython.test_functools.TestCachedProperty.test_immutable_dict"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestCachedProperty::test_immutable_dict
"""Auto-ported test: TestCachedProperty::test_immutable_dict (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search("The '__dict__' attribute on 'MyMeta' instance does not support item assignment for caching 'prop' property.", str(_aR_e))
print("TestCachedProperty::test_immutable_dict: ok")
