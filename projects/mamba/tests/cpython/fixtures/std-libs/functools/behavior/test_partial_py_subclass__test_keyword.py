...
# lib = "functools"
# dimension = "behavior"
# case = "test_partial_py_subclass__test_keyword"
# subject = "cpython.test_functools.TestPartialPySubclass.test_keyword"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestPartialPySubclass::test_keyword
"""Auto-ported test: TestPartialPySubclass::test_keyword (CPython 3.12 oracle)."""
...
for a in ['a', 0, None, 3.5]:
    p = partial(capture, a=a)
    expected = {'a': a, 'x': None}
    empty, got = p(x=None)

    assert expected == got and empty == ()
print("TestPartialPySubclass::test_keyword: ok")
