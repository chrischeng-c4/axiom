...
# lib = "py_compile"
# dimension = "behavior"
# case = "py_compile_tests_without_source_epoch__test_relative_path"
# subject = "cpython.test_py_compile.PyCompileTestsWithoutSourceEpoch.test_relative_path"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_py_compile.py::PyCompileTestsWithoutSourceEpoch::test_relative_path
"""Auto-ported test: PyCompileTestsWithoutSourceEpoch::test_relative_path (CPython 3.12 oracle)."""
...
with open(self_source_path, 'w') as file:
    file.write('x = 123\n')
py_compile.compile(os.path.relpath(self_source_path), os.path.relpath(self_pyc_path))

assert os.path.exists(self_pyc_path)

assert not os.path.exists(self_cache_path)
print("PyCompileTestsWithoutSourceEpoch::test_relative_path: ok")
