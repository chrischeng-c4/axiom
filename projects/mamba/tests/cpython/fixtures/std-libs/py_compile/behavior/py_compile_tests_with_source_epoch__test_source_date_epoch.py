...
# lib = "py_compile"
# dimension = "behavior"
# case = "py_compile_tests_with_source_epoch__test_source_date_epoch"
# subject = "cpython.test_py_compile.PyCompileTestsWithSourceEpoch.test_source_date_epoch"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_py_compile.py::PyCompileTestsWithSourceEpoch::test_source_date_epoch
"""Auto-ported test: PyCompileTestsWithSourceEpoch::test_source_date_epoch (CPython 3.12 oracle)."""
...
with open(self_source_path, 'w') as file:
    file.write('x = 123\n')
py_compile.compile(self_source_path, self_pyc_path)

assert os.path.exists(self_pyc_path)

assert not os.path.exists(self_cache_path)
with open(self_pyc_path, 'rb') as fp:
...
print("PyCompileTestsWithSourceEpoch::test_source_date_epoch: ok")
