...
# lib = "py_compile"
# dimension = "behavior"
# case = "py_compile_cli_test_case__test_file_not_exists_with_quiet"
# subject = "cpython.test_py_compile.PyCompileCLITestCase.test_file_not_exists_with_quiet"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_py_compile.py::PyCompileCLITestCase::test_file_not_exists_with_quiet
"""Auto-ported test: PyCompileCLITestCase::test_file_not_exists_with_quiet (CPython 3.12 oracle)."""
...
rc, stdout, stderr = pycompilecmd_failure('-q', self_source_path, should_not_exists)
...
assert stderr == b''
print("PyCompileCLITestCase::test_file_not_exists_with_quiet: ok")
