...
# lib = "dis"
# dimension = "behavior"
# case = "dis_tests__test_disassemble_try_finally"
# subject = "cpython.test_dis.DisTests.test_disassemble_try_finally"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisTests::test_disassemble_try_finally
"""Auto-ported test: DisTests::test_disassemble_try_finally (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
do_disassembly_test(_tryfinally, dis_tryfinally)
do_disassembly_test(_tryfinallyconst, dis_tryfinallyconst)
print("DisTests::test_disassemble_try_finally: ok")
