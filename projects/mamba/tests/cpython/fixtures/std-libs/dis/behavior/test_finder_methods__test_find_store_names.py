...
# lib = "dis"
# dimension = "behavior"
# case = "test_finder_methods__test_find_store_names"
# subject = "cpython.test_dis.TestFinderMethods.test__find_store_names"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::TestFinderMethods::test__find_store_names
"""Auto-ported test: TestFinderMethods::test__find_store_names (CPython 3.12 oracle)."""
...
# --- test body ---
cases = [('x+y', ()), ('x=y=1', ('x', 'y')), ('x+=y', ('x',)), ('global x\nx=y=1', ('x', 'y')), ('global x\nz=x', ('z',))]
for src, expected in cases:
    code = compile(src, '<string>', 'exec')
    res = tuple(dis._find_store_names(code))

    assert res == expected
print("TestFinderMethods::test__find_store_names: ok")
