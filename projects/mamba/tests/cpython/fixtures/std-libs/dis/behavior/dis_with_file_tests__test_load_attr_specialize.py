...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_load_attr_specialize"
# subject = "cpython.test_dis.DisWithFileTests.test_load_attr_specialize"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_load_attr_specialize
"""Auto-ported test: DisWithFileTests::test_load_attr_specialize (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
load_attr_quicken = "  0           0 RESUME                   0\n\n  1           2 LOAD_CONST               0 ('a')\n              4 LOAD_ATTR_SLOT           0 (__class__)\n             24 RETURN_VALUE\n"
co = compile("'a'.__class__", '', 'eval')
code_quicken(lambda: exec(co, {}, {}))
got = get_disassembly(co, adaptive=True)
do_disassembly_compare(got, load_attr_quicken, True)
print("DisWithFileTests::test_load_attr_specialize: ok")
