...
# lib = "dis"
# dimension = "behavior"
# case = "dis_tests__test_loop_quicken"
# subject = "cpython.test_dis.DisTests.test_loop_quicken"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisTests::test_loop_quicken
"""Auto-ported test: DisTests::test_loop_quicken (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
code_quicken(loop_test, 1)
got = get_disassembly(loop_test, adaptive=True)
do_disassembly_compare(got, dis_loop_test_quickened_code)
print("DisTests::test_loop_quicken: ok")
