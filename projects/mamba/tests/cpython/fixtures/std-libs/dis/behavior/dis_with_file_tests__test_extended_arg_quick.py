...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_extended_arg_quick"
# subject = "cpython.test_dis.DisWithFileTests.test_extended_arg_quick"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_extended_arg_quick
"""Auto-ported test: DisWithFileTests::test_extended_arg_quick (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
got = get_disassembly(extended_arg_quick)
do_disassembly_compare(got, dis_extended_arg_quick_code, True)
print("DisWithFileTests::test_extended_arg_quick: ok")
