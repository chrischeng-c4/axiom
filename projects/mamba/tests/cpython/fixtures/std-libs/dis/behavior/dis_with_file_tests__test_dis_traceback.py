...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_dis_traceback"
# subject = "cpython.test_dis.DisWithFileTests.test_dis_traceback"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_dis_traceback
"""Auto-ported test: DisWithFileTests::test_dis_traceback (CPython 3.12 oracle)."""
...
try:
    ...
    tb = e.__traceback__
    sys.last_exc = e
tb_dis = get_disassemble_as_string(tb.tb_frame.f_code, tb.tb_lasti)
do_disassembly_test(None, tb_dis, True)
print("DisWithFileTests::test_dis_traceback: ok")
