...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_widths"
# subject = "cpython.test_dis.DisWithFileTests.test_widths"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_widths
"""Auto-ported test: DisWithFileTests::test_widths (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
long_opcodes = set(['JUMP_BACKWARD_NO_INTERRUPT', 'INSTRUMENTED_CALL_FUNCTION_EX'])
for opcode, opname in enumerate(dis.opname):
    ...
    assert len(opname) <= width
print("DisWithFileTests::test_widths: ok")
