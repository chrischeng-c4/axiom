...
# lib = "dis"
# dimension = "behavior"
# case = "dis_tests__test_dis"
# subject = "cpython.test_dis.DisTests.test_dis"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisTests::test_dis
"""Auto-ported test: DisTests::test_dis (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
do_disassembly_test(_f, dis_f)
print("DisTests::test_dis: ok")
