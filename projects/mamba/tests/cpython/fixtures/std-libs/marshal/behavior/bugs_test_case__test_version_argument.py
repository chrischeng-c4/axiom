...
# lib = "marshal"
# dimension = "behavior"
# case = "bugs_test_case__test_version_argument"
# subject = "cpython.test_marshal.BugsTestCase.test_version_argument"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::BugsTestCase::test_version_argument
"""Auto-ported test: BugsTestCase::test_version_argument (CPython 3.12 oracle)."""
...
assert marshal.loads(marshal.dumps(5, 0)) == 5

assert marshal.loads(marshal.dumps(5, 1)) == 5
print("BugsTestCase::test_version_argument: ok")
