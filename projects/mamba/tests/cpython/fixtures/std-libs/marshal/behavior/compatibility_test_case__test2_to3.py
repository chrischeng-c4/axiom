...
# lib = "marshal"
# dimension = "behavior"
# case = "compatibility_test_case__test2_to3"
# subject = "cpython.test_marshal.CompatibilityTestCase.test2To3"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::CompatibilityTestCase::test2To3
"""Auto-ported test: CompatibilityTestCase::test2To3 (CPython 3.12 oracle)."""
...
def _test(version):
    ...
    marshal.loads(data)
_test(2)
print("CompatibilityTestCase::test2To3: ok")
