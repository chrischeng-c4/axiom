...
# lib = "marshal"
# dimension = "behavior"
# case = "code_test_case__test_different_filenames"
# subject = "cpython.test_marshal.CodeTestCase.test_different_filenames"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::CodeTestCase::test_different_filenames
"""Auto-ported test: CodeTestCase::test_different_filenames (CPython 3.12 oracle)."""
...
assert co1.co_filename == 'f1'

assert co2.co_filename == 'f2'
print("CodeTestCase::test_different_filenames: ok")
