...
# lib = "marshal"
# dimension = "behavior"
# case = "bugs_test_case__test_eof"
# subject = "cpython.test_marshal.BugsTestCase.test_eof"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::BugsTestCase::test_eof
"""Auto-ported test: BugsTestCase::test_eof (CPython 3.12 oracle)."""
...
for i in range(len(data)):
    ...
    try:
        marshal.loads(data[0:i])
        raise AssertionError('expected EOFError')
    except EOFError:
        pass
print("BugsTestCase::test_eof: ok")
