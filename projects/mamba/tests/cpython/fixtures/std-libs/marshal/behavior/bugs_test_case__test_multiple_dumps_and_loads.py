...
# lib = "marshal"
# dimension = "behavior"
# case = "bugs_test_case__test_multiple_dumps_and_loads"
# subject = "cpython.test_marshal.BugsTestCase.test_multiple_dumps_and_loads"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::BugsTestCase::test_multiple_dumps_and_loads
"""Auto-ported test: BugsTestCase::test_multiple_dumps_and_loads (CPython 3.12 oracle)."""
    ...
    try:
        ...
        with open(os_helper.TESTFN, 'rb') as f:
            for i, d in enumerate(data):
                ...
                assert d == marshal.load(f)
                if ilen:
                    f.read(ilen)

                assert positions[i] == f.tell()
    finally:
        os_helper.unlink(os_helper.TESTFN)
print("BugsTestCase::test_multiple_dumps_and_loads: ok")
