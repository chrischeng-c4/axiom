...
# lib = "marshal"
# dimension = "behavior"
# case = "bugs_test_case__test_loads_reject_unicode_strings"
# subject = "cpython.test_marshal.BugsTestCase.test_loads_reject_unicode_strings"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::BugsTestCase::test_loads_reject_unicode_strings
"""Auto-ported test: BugsTestCase::test_loads_reject_unicode_strings (CPython 3.12 oracle)."""
...
try:
    marshal.loads(unicode_string)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("BugsTestCase::test_loads_reject_unicode_strings: ok")
