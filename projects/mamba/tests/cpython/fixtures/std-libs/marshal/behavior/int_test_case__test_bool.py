...
# lib = "marshal"
# dimension = "behavior"
# case = "int_test_case__test_bool"
# subject = "cpython.test_marshal.IntTestCase.test_bool"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::IntTestCase::test_bool
"""Auto-ported test: IntTestCase::test_bool (CPython 3.12 oracle)."""
...
for b in (True, False):
    helper(b)
print("IntTestCase::test_bool: ok")
