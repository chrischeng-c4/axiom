...
# lib = "time"
# dimension = "behavior"
# case = "time_test_case__test_conversions"
# subject = "cpython.test_time.TimeTestCase.test_conversions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_time.py::TimeTestCase::test_conversions
"""Auto-ported test: TimeTestCase::test_conversions (CPython 3.12 oracle)."""
...
assert time.ctime(self_t) == time.asctime(time.localtime(self_t))

assert int(time.mktime(time.localtime(self_t))) == int(self_t)
print("TimeTestCase::test_conversions: ok")
