...
# lib = "time"
# dimension = "behavior"
# case = "time_test_case__test_strftime"
# subject = "cpython.test_time.TimeTestCase.test_strftime"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_time.py::TimeTestCase::test_strftime
"""Auto-ported test: TimeTestCase::test_strftime (CPython 3.12 oracle)."""
...
for directive in ('a', 'A', 'b', 'B', 'c', 'd', 'H', 'I', 'j', 'm', 'M', 'p', 'S', 'U', 'w', 'W', 'x', 'X', 'y', 'Y', 'Z', '%'):
    ...
    try:
        ...
        raise AssertionError('conversion specifier: %r failed.' % format)

try:
    time.strftime(b'%S', tt)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("TimeTestCase::test_strftime: ok")
