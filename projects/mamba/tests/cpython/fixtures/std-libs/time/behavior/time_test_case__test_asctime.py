...
# lib = "time"
# dimension = "behavior"
# case = "time_test_case__test_asctime"
# subject = "cpython.test_time.TimeTestCase.test_asctime"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_time.py::TimeTestCase::test_asctime
"""Auto-ported test: TimeTestCase::test_asctime (CPython 3.12 oracle)."""
...
# --- test body ---
self_t = time.time()
time.asctime(time.gmtime(self_t))
...
try:
    time.asctime((TIME_MAXYEAR + 1,) + (0,) * 8)
    raise AssertionError('expected OverflowError')
except OverflowError:
    pass

try:
    time.asctime((TIME_MINYEAR - 1,) + (0,) * 8)
    raise AssertionError('expected OverflowError')
except OverflowError:
    pass
...
try:
    ...
    pass
print("TimeTestCase::test_asctime: ok")
