...
# lib = "time"
# dimension = "behavior"
# case = "time_test_case__test_sleep"
# subject = "cpython.test_time.TimeTestCase.test_sleep"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_time.py::TimeTestCase::test_sleep
"""Auto-ported test: TimeTestCase::test_sleep (CPython 3.12 oracle)."""
...
def _bounds_checking(func):
    ...
    try:
        ...
        pass
self_t = time.time()
for value in [-0.0, 0, 0.0, 1e-100, 1e-09, 1e-06, 1, 1.2]:
    time.sleep(value)
print("TimeTestCase::test_sleep: ok")
