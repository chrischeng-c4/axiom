...
# lib = "class"
# dimension = "behavior"
# case = "class_tests__test_has_attr_string"
# subject = "cpython.test_class.ClassTests.testHasAttrString"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_class.py::ClassTests::testHasAttrString
"""Auto-ported test: ClassTests::testHasAttrString (CPython 3.12 oracle)."""
...
assert _testcapi.object_hasattrstring(a, b'attr') == 1

assert _testcapi.object_hasattrstring(a, b'noattr') == 0

assert sys.exception() is None
print("ClassTests::testHasAttrString: ok")
