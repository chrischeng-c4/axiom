...
# lib = "class"
# dimension = "behavior"
# case = "class_tests__test_sf_bug532646"
# subject = "cpython.test_class.ClassTests.testSFBug532646"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_class.py::ClassTests::testSFBug532646
"""Auto-ported test: ClassTests::testSFBug532646 (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('Failed to raise RecursionError')
print("ClassTests::testSFBug532646: ok")
