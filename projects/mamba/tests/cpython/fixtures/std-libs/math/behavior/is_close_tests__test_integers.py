...
# lib = "math"
# dimension = "behavior"
# case = "is_close_tests__test_integers"
# subject = "cpython.test_math.IsCloseTests.test_integers"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_math.py::IsCloseTests::test_integers
"""Auto-ported test: IsCloseTests::test_integers (CPython 3.12 oracle)."""
...
assertAllClose(integer_examples, rel_tol=1e-08)
assertAllNotClose(integer_examples, rel_tol=1e-09)
print("IsCloseTests::test_integers: ok")
