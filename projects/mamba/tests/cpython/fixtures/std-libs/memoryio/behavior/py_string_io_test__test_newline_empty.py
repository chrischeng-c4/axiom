...
# lib = "memoryio"
# dimension = "behavior"
# case = "py_string_io_test__test_newline_empty"
# subject = "cpython.test_memoryio.PyStringIOTest.test_newline_empty"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::PyStringIOTest::test_newline_empty
"""Auto-ported test: PyStringIOTest::test_newline_empty (CPython 3.12 oracle)."""
...
assert memio.read(4) == 'a\nb\r'

assert memio.read(2) == '\nc'

assert memio.read(1) == '\r'

assert memio.getvalue() == 'a\nb\r\nc\rd'
memio = ioclass(newline='')

assert 2 == memio.write('a\n')

assert 2 == memio.write('b\r')

assert 2 == memio.write('\nc')

assert 2 == memio.write('\rd')
memio.seek(0)

assert list(memio) == ['a\n', 'b\r\n', 'c\r', 'd']

assert memio.getvalue() == 'a\nb\r\nc\rd'
print("PyStringIOTest::test_newline_empty: ok")
