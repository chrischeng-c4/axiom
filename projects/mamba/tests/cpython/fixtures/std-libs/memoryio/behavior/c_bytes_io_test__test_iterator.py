...
# lib = "memoryio"
# dimension = "behavior"
# case = "c_bytes_io_test__test_iterator"
# subject = "cpython.test_memoryio.CBytesIOTest.test_iterator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::CBytesIOTest::test_iterator
"""Auto-ported test: CBytesIOTest::test_iterator (CPython 3.12 oracle)."""
...
assert iter(memio) == memio

assert hasattr(memio, '__iter__')

assert hasattr(memio, '__next__')
i = 0
for line in memio:
...
try:
    ...
    pass
print("CBytesIOTest::test_iterator: ok")
