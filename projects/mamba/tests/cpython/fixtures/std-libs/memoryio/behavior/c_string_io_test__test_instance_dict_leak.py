...
# lib = "memoryio"
# dimension = "behavior"
# case = "c_string_io_test__test_instance_dict_leak"
# subject = "cpython.test_memoryio.CStringIOTest.test_instance_dict_leak"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::CStringIOTest::test_instance_dict_leak
"""Auto-ported test: CStringIOTest::test_instance_dict_leak (CPython 3.12 oracle)."""
...
for _ in range(100):
    memio = ioclass()
    memio.foo = 1
print("CStringIOTest::test_instance_dict_leak: ok")
