...
# lib = "memoryio"
# dimension = "behavior"
# case = "c_bytes_io_test__test_instance_dict_leak"
# subject = "cpython.test_memoryio.CBytesIOTest.test_instance_dict_leak"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::CBytesIOTest::test_instance_dict_leak
"""Auto-ported test: CBytesIOTest::test_instance_dict_leak (CPython 3.12 oracle)."""
...
for _ in range(100):
    memio = ioclass()
    memio.foo = 1
print("CBytesIOTest::test_instance_dict_leak: ok")
