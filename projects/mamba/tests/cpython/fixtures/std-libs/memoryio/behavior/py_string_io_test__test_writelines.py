...
# lib = "memoryio"
# dimension = "behavior"
# case = "py_string_io_test__test_writelines"
# subject = "cpython.test_memoryio.PyStringIOTest.test_writelines"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::PyStringIOTest::test_writelines
"""Auto-ported test: PyStringIOTest::test_writelines (CPython 3.12 oracle)."""
...
assert memio.writelines([buf] * 100) == None

assert memio.getvalue() == buf * 100
memio.writelines([])
...
try:
    ...
    pass
print("PyStringIOTest::test_writelines: ok")
