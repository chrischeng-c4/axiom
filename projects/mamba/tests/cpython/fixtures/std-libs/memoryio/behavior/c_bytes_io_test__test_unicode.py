...
# lib = "memoryio"
# dimension = "behavior"
# case = "c_bytes_io_test__test_unicode"
# subject = "cpython.test_memoryio.CBytesIOTest.test_unicode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::CBytesIOTest::test_unicode
"""Auto-ported test: CBytesIOTest::test_unicode (CPython 3.12 oracle)."""
...
try:
    memio.write('1234567890')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    memio.writelines(['1234567890'])
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("CBytesIOTest::test_unicode: ok")
