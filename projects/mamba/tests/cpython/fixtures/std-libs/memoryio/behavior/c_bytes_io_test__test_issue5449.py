...
# lib = "memoryio"
# dimension = "behavior"
# case = "c_bytes_io_test__test_issue5449"
# subject = "cpython.test_memoryio.CBytesIOTest.test_issue5449"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::CBytesIOTest::test_issue5449
"""Auto-ported test: CBytesIOTest::test_issue5449 (CPython 3.12 oracle)."""
...
def write_ops(f, t):
    ...
    assert f.tell() == 1
buf = buftype('1234567890')
ioclass(initial_bytes=buf)

try:
    ioclass(buf, foo=None)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("CBytesIOTest::test_issue5449: ok")
