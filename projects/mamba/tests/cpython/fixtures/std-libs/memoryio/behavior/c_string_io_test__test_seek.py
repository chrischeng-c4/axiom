...
# lib = "memoryio"
# dimension = "behavior"
# case = "c_string_io_test__test_seek"
# subject = "cpython.test_memoryio.CStringIOTest.test_seek"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::CStringIOTest::test_seek
"""Auto-ported test: CStringIOTest::test_seek (CPython 3.12 oracle)."""
...
assert memio.seek(0) == 0

assert memio.seek(0, 0) == 0

assert memio.read() == buf

assert memio.seek(3) == 3

assert memio.seek(0, 1) == 3

assert memio.read() == buf[3:]

assert memio.seek(len(buf)) == len(buf)
...
try:
    ...
    pass
print("CStringIOTest::test_seek: ok")
