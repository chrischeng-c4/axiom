...
# lib = "memoryio"
# dimension = "behavior"
# case = "py_string_io_test__test_getvalue"
# subject = "cpython.test_memoryio.PyStringIOTest.test_getvalue"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::PyStringIOTest::test_getvalue
"""Auto-ported test: PyStringIOTest::test_getvalue (CPython 3.12 oracle)."""
...
assert type(memio.getvalue()) == type(buf)
memio = ioclass(buf * 1000)

assert memio.getvalue()[-3:] == buftype('890')
memio = ioclass(buf)
memio.close()
...
try:
    ...
    pass
print("PyStringIOTest::test_getvalue: ok")
