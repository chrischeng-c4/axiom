...
# lib = "httpservers"
# dimension = "behavior"
# case = "base_http_request_handler_test_case__test_header_buffering_of_send_error"
# subject = "cpython.test_httpservers.BaseHTTPRequestHandlerTestCase.test_header_buffering_of_send_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httpservers.py::BaseHTTPRequestHandlerTestCase::test_header_buffering_of_send_error
"""Auto-ported test: BaseHTTPRequestHandlerTestCase::test_header_buffering_of_send_error (CPython 3.12 oracle)."""
...
assert output.numWrites == 2
print("BaseHTTPRequestHandlerTestCase::test_header_buffering_of_send_error: ok")
