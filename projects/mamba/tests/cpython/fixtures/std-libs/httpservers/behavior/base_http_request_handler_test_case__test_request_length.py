...
# lib = "httpservers"
# dimension = "behavior"
# case = "base_http_request_handler_test_case__test_request_length"
# subject = "cpython.test_httpservers.BaseHTTPRequestHandlerTestCase.test_request_length"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httpservers.py::BaseHTTPRequestHandlerTestCase::test_request_length
"""Auto-ported test: BaseHTTPRequestHandlerTestCase::test_request_length (CPython 3.12 oracle)."""
...
result = send_typical_request(b'GET ' + b'x' * 65537)

assert result[0] == b'HTTP/1.1 414 Request-URI Too Long\r\n'

assert not self_handler.get_called

assert isinstance(self_handler.requestline, str)
print("BaseHTTPRequestHandlerTestCase::test_request_length: ok")
