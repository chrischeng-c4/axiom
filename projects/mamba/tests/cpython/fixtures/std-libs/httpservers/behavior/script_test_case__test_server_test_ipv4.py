...
# lib = "httpservers"
# dimension = "behavior"
# case = "script_test_case__test_server_test_ipv4"
# subject = "cpython.test_httpservers.ScriptTestCase.test_server_test_ipv4"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httpservers.py::ScriptTestCase::test_server_test_ipv4
"""Auto-ported test: ScriptTestCase::test_server_test_ipv4 (CPython 3.12 oracle)."""
...
for bind in ipv4_addrs:
    mock_server = mock_server_class()
    server.test(ServerClass=mock_server, bind=bind)

    assert mock_server.address_family == socket.AF_INET
print("ScriptTestCase::test_server_test_ipv4: ok")
