...
# lib = "httpservers"
# dimension = "behavior"
# case = "base_http_request_handler_test_case__test_extra_space"
# subject = "cpython.test_httpservers.BaseHTTPRequestHandlerTestCase.test_extra_space"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httpservers.py::BaseHTTPRequestHandlerTestCase::test_extra_space
"""Auto-ported test: BaseHTTPRequestHandlerTestCase::test_extra_space (CPython 3.12 oracle)."""
...
result = send_typical_request(b'GET /spaced out HTTP/1.1\r\nHost: dummy\r\n\r\n')

assert result[0].startswith(b'HTTP/1.1 400 ')
verify_expected_headers(result[1:result.index(b'\r\n')])

assert not self_handler.get_called
print("BaseHTTPRequestHandlerTestCase::test_extra_space: ok")
