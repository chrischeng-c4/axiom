...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_urldefrag"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_urldefrag"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_urldefrag
"""Auto-ported test: UrlParseTestCase::test_urldefrag (CPython 3.12 oracle)."""
...
for url, defrag, frag in str_cases + bytes_cases:
    ...
    assert result == (defrag, frag)

    assert result.url == defrag

    assert result.fragment == frag
print("UrlParseTestCase::test_urldefrag: ok")
