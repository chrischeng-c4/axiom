...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_portseparator"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_portseparator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_portseparator
"""Auto-ported test: UrlParseTestCase::test_portseparator (CPython 3.12 oracle)."""
...
assert urllib.parse.urlparse('http:80') == ('http', '', '80', '', '', '')

assert urllib.parse.urlparse('https:80') == ('https', '', '80', '', '', '')

assert urllib.parse.urlparse('path:80') == ('path', '', '80', '', '', '')

assert urllib.parse.urlparse('http:') == ('http', '', '', '', '', '')

assert urllib.parse.urlparse('https:') == ('https', '', '', '', '', '')

assert urllib.parse.urlparse('http://www.python.org:80') == ('http', 'www.python.org:80', '', '', '', '')

assert urllib.parse.urlparse(b'http:80') == (b'http', b'', b'80', b'', b'', b'')

assert urllib.parse.urlparse(b'https:80') == (b'https', b'', b'80', b'', b'', b'')

assert urllib.parse.urlparse(b'path:80') == (b'path', b'', b'80', b'', b'', b'')

assert urllib.parse.urlparse(b'http:') == (b'http', b'', b'', b'', b'', b'')

assert urllib.parse.urlparse(b'https:') == (b'https', b'', b'', b'', b'', b'')

assert urllib.parse.urlparse(b'http://www.python.org:80') == (b'http', b'www.python.org:80', b'', b'', b'', b'')
print("UrlParseTestCase::test_portseparator: ok")
