...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_anyscheme"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_anyscheme"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_anyscheme
"""Auto-ported test: UrlParseTestCase::test_anyscheme (CPython 3.12 oracle)."""
...
assert urllib.parse.urlparse('s3://foo.com/stuff') == ('s3', 'foo.com', '/stuff', '', '', '')

assert urllib.parse.urlparse('x-newscheme://foo.com/stuff') == ('x-newscheme', 'foo.com', '/stuff', '', '', '')

assert urllib.parse.urlparse('x-newscheme://foo.com/stuff?query#fragment') == ('x-newscheme', 'foo.com', '/stuff', '', 'query', 'fragment')

assert urllib.parse.urlparse('x-newscheme://foo.com/stuff?query') == ('x-newscheme', 'foo.com', '/stuff', '', 'query', '')

assert urllib.parse.urlparse(b's3://foo.com/stuff') == (b's3', b'foo.com', b'/stuff', b'', b'', b'')

assert urllib.parse.urlparse(b'x-newscheme://foo.com/stuff') == (b'x-newscheme', b'foo.com', b'/stuff', b'', b'', b'')

assert urllib.parse.urlparse(b'x-newscheme://foo.com/stuff?query#fragment') == (b'x-newscheme', b'foo.com', b'/stuff', b'', b'query', b'fragment')

assert urllib.parse.urlparse(b'x-newscheme://foo.com/stuff?query') == (b'x-newscheme', b'foo.com', b'/stuff', b'', b'query', b'')
print("UrlParseTestCase::test_anyscheme: ok")
