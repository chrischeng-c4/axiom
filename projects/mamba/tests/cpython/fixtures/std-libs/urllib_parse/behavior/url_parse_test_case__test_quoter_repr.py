...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_quoter_repr"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_Quoter_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_Quoter_repr
"""Auto-ported test: UrlParseTestCase::test_Quoter_repr (CPython 3.12 oracle)."""
...
assert 'Quoter' in repr(quoter)
print("UrlParseTestCase::test_Quoter_repr: ok")
