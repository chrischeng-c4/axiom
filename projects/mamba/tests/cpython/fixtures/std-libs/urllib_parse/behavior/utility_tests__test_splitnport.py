...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "utility_tests__test_splitnport"
# subject = "cpython.test_urlparse.Utility_Tests.test_splitnport"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::Utility_Tests::test_splitnport
"""Auto-ported test: Utility_Tests::test_splitnport (CPython 3.12 oracle)."""
...
assert splitnport('parrot:88') == ('parrot', 88)

assert splitnport('parrot') == ('parrot', -1)

assert splitnport('parrot', 55) == ('parrot', 55)

assert splitnport('parrot:') == ('parrot', -1)

assert splitnport('parrot:', 55) == ('parrot', 55)

assert splitnport('127.0.0.1') == ('127.0.0.1', -1)

assert splitnport('127.0.0.1', 55) == ('127.0.0.1', 55)

assert splitnport('parrot:cheese') == ('parrot', None)

assert splitnport('parrot:cheese', 55) == ('parrot', None)

assert splitnport('parrot: +1_0 ') == ('parrot', None)
print("Utility_Tests::test_splitnport: ok")
