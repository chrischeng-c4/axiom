...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "utility_tests__test_splitvalue"
# subject = "cpython.test_urlparse.Utility_Tests.test_splitvalue"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::Utility_Tests::test_splitvalue
"""Auto-ported test: Utility_Tests::test_splitvalue (CPython 3.12 oracle)."""
...
assert splitvalue('foo=bar') == ('foo', 'bar')

assert splitvalue('foo=') == ('foo', '')

assert splitvalue('=bar') == ('', 'bar')

assert splitvalue('foobar') == ('foobar', None)

assert splitvalue('foo=bar=baz') == ('foo', 'bar=baz')
print("Utility_Tests::test_splitvalue: ok")
