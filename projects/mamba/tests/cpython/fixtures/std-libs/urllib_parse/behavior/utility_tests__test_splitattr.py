...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "utility_tests__test_splitattr"
# subject = "cpython.test_urlparse.Utility_Tests.test_splitattr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::Utility_Tests::test_splitattr
"""Auto-ported test: Utility_Tests::test_splitattr (CPython 3.12 oracle)."""
...
assert splitattr('/path;attr1=value1;attr2=value2') == ('/path', ['attr1=value1', 'attr2=value2'])

assert splitattr('/path;') == ('/path', [''])

assert splitattr(';attr1=value1;attr2=value2') == ('', ['attr1=value1', 'attr2=value2'])

assert splitattr('/path') == ('/path', [])
print("Utility_Tests::test_splitattr: ok")
