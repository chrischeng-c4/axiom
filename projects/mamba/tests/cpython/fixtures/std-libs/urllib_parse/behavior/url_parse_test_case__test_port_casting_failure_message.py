...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_port_casting_failure_message"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_port_casting_failure_message"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_port_casting_failure_message
"""Auto-ported test: UrlParseTestCase::test_port_casting_failure_message (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(message, str(_aR_e))
print("UrlParseTestCase::test_port_casting_failure_message: ok")
