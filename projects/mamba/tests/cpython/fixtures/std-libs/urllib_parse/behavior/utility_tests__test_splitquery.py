...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "utility_tests__test_splitquery"
# subject = "cpython.test_urlparse.Utility_Tests.test_splitquery"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::Utility_Tests::test_splitquery
"""Auto-ported test: Utility_Tests::test_splitquery (CPython 3.12 oracle)."""
...
assert splitquery('http://python.org/fake?foo=bar') == ('http://python.org/fake', 'foo=bar')

assert splitquery('http://python.org/fake?foo=bar?') == ('http://python.org/fake?foo=bar', '')

assert splitquery('http://python.org/fake') == ('http://python.org/fake', None)

assert splitquery('?foo=bar') == ('', 'foo=bar')
print("Utility_Tests::test_splitquery: ok")
