...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_attributes_without_netloc"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_attributes_without_netloc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_attributes_without_netloc
"""Auto-ported test: UrlParseTestCase::test_attributes_without_netloc (CPython 3.12 oracle)."""
...
assert p.geturl() == uri
print("UrlParseTestCase::test_attributes_without_netloc: ok")
