...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_getset_descriptor"
# subject = "cpython.test_pydoc.TestDescriptions.test_getset_descriptor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_getset_descriptor
"""Auto-ported test: TestDescriptions::test_getset_descriptor (CPython 3.12 oracle)."""
...
assert _get_summary_line(int.numerator) == 'numerator'

assert _get_summary_line(float.real) == 'real'

assert _get_summary_line(Exception.args) == 'args'

assert _get_summary_line(memoryview.obj) == 'obj'
print("TestDescriptions::test_getset_descriptor: ok")
