...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_doc_test__test_method_aliases"
# subject = "cpython.test_pydoc.PydocDocTest.test_method_aliases"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocDocTest::test_method_aliases
"""Auto-ported test: PydocDocTest::test_method_aliases (CPython 3.12 oracle)."""
...
assert doc == 'Python Library Documentation: class B in module %s\n\nclass B(A)\n |  Method resolution order:\n |      B\n |      A\n |      builtins.object\n |\n |  Methods defined here:\n |\n |  b_size = a_size(self)\n |\n |  itemconfig = itemconfigure(self, tagOrId, cnf=None, **kw)\n |\n |  itemconfigure(self, tagOrId, cnf=None, **kw)\n |      Configure resources of an item TAGORID.\n |\n |  ----------------------------------------------------------------------\n |  Methods inherited from A:\n |\n |  a_size(self)\n |      Return size\n |\n |  lift = tkraise(self, aboveThis=None)\n |\n |  tkraise(self, aboveThis=None)\n |      Raise this widget in the stacking order.\n |\n |  ----------------------------------------------------------------------\n |  Data descriptors inherited from A:\n |\n |  __dict__\n |      dictionary for instance variables\n |\n |  __weakref__\n |      list of weak references to the object\n' % __name__
...
for expected_line in expected_lines:
    ...
    assert expected_line in as_text
print("PydocDocTest::test_method_aliases: ok")
