...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_async_generator_annotation"
# subject = "cpython.test_pydoc.TestDescriptions.test_async_generator_annotation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_async_generator_annotation
"""Auto-ported test: TestDescriptions::test_async_generator_annotation (CPython 3.12 oracle)."""
...
assert 'async an_async_generator' in text
html = pydoc.HTMLDoc().document(an_async_generator)

assert 'async <a name="-an_async_generator"><strong>an_async_generator' in html
print("TestDescriptions::test_async_generator_annotation: ok")
