...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_module_level_callable"
# subject = "cpython.test_pydoc.TestDescriptions.test_module_level_callable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_module_level_callable
"""Auto-ported test: TestDescriptions::test_module_level_callable (CPython 3.12 oracle)."""
...
assert _get_summary_line(os.stat) == 'stat(path, *, dir_fd=None, follow_symlinks=True)'
print("TestDescriptions::test_module_level_callable: ok")
