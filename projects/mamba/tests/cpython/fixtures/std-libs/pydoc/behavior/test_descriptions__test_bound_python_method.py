...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_bound_python_method"
# subject = "cpython.test_pydoc.TestDescriptions.test_bound_python_method"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_bound_python_method
"""Auto-ported test: TestDescriptions::test_bound_python_method (CPython 3.12 oracle)."""
...
assert _get_summary_line(t.wrap) == 'wrap(text) method of textwrap.TextWrapper instance'
print("TestDescriptions::test_bound_python_method: ok")
