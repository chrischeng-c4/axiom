...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_doc_test__test_fail_showtopic"
# subject = "cpython.test_pydoc.PydocDocTest.test_fail_showtopic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocDocTest::test_fail_showtopic
"""Auto-ported test: PydocDocTest::test_fail_showtopic (CPython 3.12 oracle)."""
...
with captured_stdout() as showtopic_io:
    ...
    assert expected == showtopic_io.getvalue().strip()
print("PydocDocTest::test_fail_showtopic: ok")
