...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_staticmethod"
# subject = "cpython.test_pydoc.TestDescriptions.test_staticmethod"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_staticmethod
"""Auto-ported test: TestDescriptions::test_staticmethod (CPython 3.12 oracle)."""
...
assert _get_summary_lines(X.__dict__['sm']) == 'sm(x, y)\n    A static method\n'

assert _get_summary_lines(X.sm) == 'sm(x, y)\n    A static method\n'

assert '\n |  Static methods defined here:\n |\n |  sm(x, y)\n |      A static method\n' in pydoc.plain(pydoc.render_doc(X))
print("TestDescriptions::test_staticmethod: ok")
