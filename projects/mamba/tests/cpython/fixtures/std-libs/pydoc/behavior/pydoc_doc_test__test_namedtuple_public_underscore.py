...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_doc_test__test_namedtuple_public_underscore"
# subject = "cpython.test_pydoc.PydocDocTest.test_namedtuple_public_underscore"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocDocTest::test_namedtuple_public_underscore
"""Auto-ported test: PydocDocTest::test_namedtuple_public_underscore (CPython 3.12 oracle)."""
...
assert '_1' in helptext

assert '_replace' in helptext

assert '_asdict' in helptext
print("PydocDocTest::test_namedtuple_public_underscore: ok")
