...
# lib = "finalization"
# dimension = "behavior"
# case = "legacy_finalization_test__test_legacy"
# subject = "cpython.test_finalization.LegacyFinalizationTest.test_legacy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_finalization.py::LegacyFinalizationTest::test_legacy
"""Auto-ported test: LegacyFinalizationTest::test_legacy (CPython 3.12 oracle)."""
...
with SimpleBase.test():
    ...
    assert_del_calls(ids)
    assert_tp_del_calls(ids)
print("LegacyFinalizationTest::test_legacy: ok")
