...
# lib = "finalization"
# dimension = "behavior"
# case = "cycle_chain_finalization_test__test_homogenous_resurrect"
# subject = "cpython.test_finalization.CycleChainFinalizationTest.test_homogenous_resurrect"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_finalization.py::CycleChainFinalizationTest::test_homogenous_resurrect
"""Auto-ported test: CycleChainFinalizationTest::test_homogenous_resurrect (CPython 3.12 oracle)."""
...
gc.garbage[:] = []
check_resurrecting_chain([ChainedResurrector] * 3)
print("CycleChainFinalizationTest::test_homogenous_resurrect: ok")
