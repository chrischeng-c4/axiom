...
# lib = "finalization"
# dimension = "behavior"
# case = "cycle_chain_finalization_test__test_heterogenous_suicidal_two"
# subject = "cpython.test_finalization.CycleChainFinalizationTest.test_heterogenous_suicidal_two"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_finalization.py::CycleChainFinalizationTest::test_heterogenous_suicidal_two
"""Auto-ported test: CycleChainFinalizationTest::test_heterogenous_suicidal_two (CPython 3.12 oracle)."""
...
gc.garbage[:] = []
check_non_resurrecting_chain([SuicidalChained] * 2 + [SimpleChained] * 2)
print("CycleChainFinalizationTest::test_heterogenous_suicidal_two: ok")
