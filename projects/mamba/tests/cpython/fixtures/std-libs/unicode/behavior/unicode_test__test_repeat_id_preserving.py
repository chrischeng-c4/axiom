...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_repeat_id_preserving"
# subject = "cpython.test_unicode.UnicodeTest.test_repeat_id_preserving"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_repeat_id_preserving
"""Auto-ported test: UnicodeTest::test_repeat_id_preserving (CPython 3.12 oracle)."""
...
assert id(s) != id(s * 2)
print("UnicodeTest::test_repeat_id_preserving: ok")
