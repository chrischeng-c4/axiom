...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_isnumeric"
# subject = "cpython.test_unicode.UnicodeTest.test_isnumeric"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_isnumeric
"""Auto-ported test: UnicodeTest::test_isnumeric (CPython 3.12 oracle)."""
...
pass
checkequalnofix(False, '', 'isnumeric')
checkequalnofix(False, 'a', 'isnumeric')
checkequalnofix(True, '0', 'isnumeric')
checkequalnofix(True, '①', 'isnumeric')
checkequalnofix(True, '¼', 'isnumeric')
checkequalnofix(True, '٠', 'isnumeric')
checkequalnofix(True, '0123456789', 'isnumeric')
checkequalnofix(False, '0123456789a', 'isnumeric')
...
for ch in ['𐐁', '𐐧', '𐐩', '𐑎', '🐍', '👯']:
    ...
    assert not ch.isnumeric()
for ch in ['𑁥', '𝟶', '𑁦', '𐒠', '🄇']:

    assert ch.isnumeric()
print("UnicodeTest::test_isnumeric: ok")
