...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_unexpected_end_of_data"
# subject = "cpython.test_unicode.UnicodeTest.test_unexpected_end_of_data"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_unexpected_end_of_data
"""Auto-ported test: UnicodeTest::test_unexpected_end_of_data (CPython 3.12 oracle)."""
...
for seq in sequences:
    assertCorrectUTF8Decoding(bytes.fromhex(seq), '�', 'unexpected end of data')
print("UnicodeTest::test_unexpected_end_of_data: ok")
