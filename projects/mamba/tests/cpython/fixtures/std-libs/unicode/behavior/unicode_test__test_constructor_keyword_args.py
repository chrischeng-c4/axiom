...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_constructor_keyword_args"
# subject = "cpython.test_unicode.UnicodeTest.test_constructor_keyword_args"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_constructor_keyword_args
"""Auto-ported test: UnicodeTest::test_constructor_keyword_args (CPython 3.12 oracle)."""
...
assert str(object='foo') == 'foo'

assert str(object=b'foo', encoding='utf-8') == 'foo'

assert str(b'foo', errors='strict') == 'foo'

assert str(object=b'foo', errors='strict') == 'foo'
print("UnicodeTest::test_constructor_keyword_args: ok")
