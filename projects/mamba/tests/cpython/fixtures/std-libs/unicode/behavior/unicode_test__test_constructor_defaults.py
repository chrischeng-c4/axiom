...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_constructor_defaults"
# subject = "cpython.test_unicode.UnicodeTest.test_constructor_defaults"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_constructor_defaults
"""Auto-ported test: UnicodeTest::test_constructor_defaults (CPython 3.12 oracle)."""
...
assert str(utf8_cent, errors='strict') == '¢'

try:
    str(utf8_cent, encoding='ascii')
    raise AssertionError('expected UnicodeDecodeError')
except UnicodeDecodeError:
    pass
print("UnicodeTest::test_constructor_defaults: ok")
