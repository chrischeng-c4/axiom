...
# lib = "string_literals"
# dimension = "behavior"
# case = "test_literals__test_uppercase_prefixes"
# subject = "cpython.test_string_literals.TestLiterals.test_uppercase_prefixes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_string_literals.py::TestLiterals::test_uppercase_prefixes
"""Auto-ported test: TestLiterals::test_uppercase_prefixes (CPython 3.12 oracle)."""
...
assert eval(" BR'\\x01' ") == b'\\x01'

assert eval(" F'{1+1}' ") == f'{1 + 1}'

assert eval(" U'\\U0001d120' ") == u'𝄠'
print("TestLiterals::test_uppercase_prefixes: ok")
