...
# lib = "http_cookiejar"
# dimension = "behavior"
# case = "cookie_tests__test_path_prefix_match"
# subject = "cpython.test_http_cookiejar.CookieTests.test_path_prefix_match"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_http_cookiejar.py::CookieTests::test_path_prefix_match
"""Auto-ported test: CookieTests::test_path_prefix_match (CPython 3.12 oracle)."""
...
for path, ok in [('/foo', True), ('/foo/', True), ('/foo/bar', True), ('/', False), ('/foobad/foo', False)]:
    ...
    if ok:
        ...
        assert 'spam=eggs' in h

        assert strict_ns_path_pol.set_ok_path(cookie, req)
    else:

        assert 'spam=eggs' not in h

        assert not strict_ns_path_pol.set_ok_path(cookie, req)
print("CookieTests::test_path_prefix_match: ok")
