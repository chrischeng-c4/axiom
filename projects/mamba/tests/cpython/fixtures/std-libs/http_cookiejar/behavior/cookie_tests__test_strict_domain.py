...
# lib = "http_cookiejar"
# dimension = "behavior"
# case = "cookie_tests__test_strict_domain"
# subject = "cpython.test_http_cookiejar.CookieTests.test_strict_domain"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_http_cookiejar.py::CookieTests::test_strict_domain
"""Auto-ported test: CookieTests::test_strict_domain (CPython 3.12 oracle)."""
...
for pseudo_tld in ['.co.uk', '.org.za', '.tx.us', '.name.us']:
    ...
    assert len(cj) == 2
print("CookieTests::test_strict_domain: ok")
