...
# lib = "http_cookiejar"
# dimension = "behavior"
# case = "date_time_tests__test_iso2time_garbage"
# subject = "cpython.test_http_cookiejar.DateTimeTests.test_iso2time_garbage"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_http_cookiejar.py::DateTimeTests::test_iso2time_garbage
"""Auto-ported test: DateTimeTests::test_iso2time_garbage (CPython 3.12 oracle)."""
...
for test in ['', 'Garbage', 'Thursday, 03-Feb-94 00:00:00 GMT', '1980-00-01', '1980-13-01', '1980-01-00', '1980-01-32', '1980-01-01 25:00:00', '1980-01-01 00:61:00', '01-01-1980 00:00:62', '01-01-1980T00:00:62', '19800101T250000Z']:
    ...
    assert iso2time(test) is None
print("DateTimeTests::test_iso2time_garbage: ok")
