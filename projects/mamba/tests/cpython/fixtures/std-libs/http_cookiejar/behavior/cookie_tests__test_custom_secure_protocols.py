...
# lib = "http_cookiejar"
# dimension = "behavior"
# case = "cookie_tests__test_custom_secure_protocols"
# subject = "cpython.test_http_cookiejar.CookieTests.test_custom_secure_protocols"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_http_cookiejar.py::CookieTests::test_custom_secure_protocols
"""Auto-ported test: CookieTests::test_custom_secure_protocols (CPython 3.12 oracle)."""
...
assert not req.has_header('Cookie')
print("CookieTests::test_custom_secure_protocols: ok")
