...
# lib = "unparse"
# dimension = "behavior"
# case = "manual_ast_creation_test_case__test_class_with_type_params"
# subject = "cpython.test_unparse.ManualASTCreationTestCase.test_class_with_type_params"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unparse.py::ManualASTCreationTestCase::test_class_with_type_params
"""Auto-ported test: ManualASTCreationTestCase::test_class_with_type_params (CPython 3.12 oracle)."""
...
# --- test body ---
node = ast.ClassDef(name='X', bases=[], keywords=[], body=[ast.Pass()], decorator_list=[], type_params=[ast.TypeVar('T')])
ast.fix_missing_locations(node)

assert ast.unparse(node) == 'class X[T]:\n    pass'
print("ManualASTCreationTestCase::test_class_with_type_params: ok")
