...
# lib = "unparse"
# dimension = "behavior"
# case = "unparse_test_case__test_fstring_backslash"
# subject = "cpython.test_unparse.UnparseTestCase.test_fstring_backslash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unparse.py::UnparseTestCase::test_fstring_backslash
"""Auto-ported test: UnparseTestCase::test_fstring_backslash (CPython 3.12 oracle)."""
...
assert ast.unparse(ast.FormattedValue(value=ast.Constant(value='\\\\'), conversion=-1, format_spec=None)) == "{'\\\\\\\\'}"
print("UnparseTestCase::test_fstring_backslash: ok")
