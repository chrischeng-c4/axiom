...
# lib = "unparse"
# dimension = "behavior"
# case = "unparse_test_case__test_import_from_level_none"
# subject = "cpython.test_unparse.UnparseTestCase.test_import_from_level_none"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unparse.py::UnparseTestCase::test_import_from_level_none
"""Auto-ported test: UnparseTestCase::test_import_from_level_none (CPython 3.12 oracle)."""
...
assert ast.unparse(tree) == 'from mod import x'
tree = ast.ImportFrom(module='mod', names=[ast.alias(name='x')], level=None)

assert ast.unparse(tree) == 'from mod import x'
print("UnparseTestCase::test_import_from_level_none: ok")
