...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "gzip_util_test_case__test_gzip_decode_limit"
# subject = "cpython.test_xmlrpc.GzipUtilTestCase.test_gzip_decode_limit"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::GzipUtilTestCase::test_gzip_decode_limit
"""Auto-ported test: GzipUtilTestCase::test_gzip_decode_limit (CPython 3.12 oracle)."""
...
assert len(decoded) == max_gzip_decode
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('max gzipped payload length exceeded', str(_aR_e))
xmlrpclib.gzip_decode(encoded, max_decode=-1)
print("GzipUtilTestCase::test_gzip_decode_limit: ok")
