...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "xmlrpc_test_case__test_dump_encoding"
# subject = "cpython.test_xmlrpc.XMLRPCTestCase.test_dump_encoding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::XMLRPCTestCase::test_dump_encoding
"""Auto-ported test: XMLRPCTestCase::test_dump_encoding (CPython 3.12 oracle)."""
...
assert xmlrpclib.loads(strg)[0][0] == value
...
assert xmlrpclib.loads(strg)[1] == methodname
print("XMLRPCTestCase::test_dump_encoding: ok")
