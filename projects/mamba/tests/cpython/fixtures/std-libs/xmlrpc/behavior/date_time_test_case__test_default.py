...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "date_time_test_case__test_default"
# subject = "cpython.test_xmlrpc.DateTimeTestCase.test_default"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::DateTimeTestCase::test_default
"""Auto-ported test: DateTimeTestCase::test_default (CPython 3.12 oracle)."""
...
with mock.patch('time.localtime') as localtime_mock:
    ...
    assert str(t) == time.strftime('%Y%m%dT%H:%M:%S', localtime)
print("DateTimeTestCase::test_default: ok")
