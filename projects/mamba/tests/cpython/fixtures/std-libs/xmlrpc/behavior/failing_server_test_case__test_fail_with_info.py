...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "failing_server_test_case__test_fail_with_info"
# subject = "cpython.test_xmlrpc.FailingServerTestCase.test_fail_with_info"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::FailingServerTestCase::test_fail_with_info
"""Auto-ported test: FailingServerTestCase::test_fail_with_info (CPython 3.12 oracle)."""
...
# --- test body ---
self_evt = threading.Event()
serv_args = (self_evt, 1)
...
try:
    ...
    if not is_unavailable_exception(e) and hasattr(e, 'headers'):
        ...
        assert e.headers.get('X-exception') == expected_err

        assert e.headers.get('X-traceback') is not None
else:

    raise AssertionError('ProtocolError not raised')
print("FailingServerTestCase::test_fail_with_info: ok")
