...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "helper_test_case__test_escape"
# subject = "cpython.test_xmlrpc.HelperTestCase.test_escape"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::HelperTestCase::test_escape
"""Auto-ported test: HelperTestCase::test_escape (CPython 3.12 oracle)."""
...
assert xmlrpclib.escape('a&b') == 'a&amp;b'

assert xmlrpclib.escape('a<b') == 'a&lt;b'

assert xmlrpclib.escape('a>b') == 'a&gt;b'
print("HelperTestCase::test_escape: ok")
