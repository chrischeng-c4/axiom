...
# lib = "univnewlines"
# dimension = "behavior"
# case = "py_test_mixed_newlines__test_seek"
# subject = "cpython.test_univnewlines.PyTestMixedNewlines.test_seek"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_univnewlines.py::PyTestMixedNewlines::test_seek
"""Auto-ported test: PyTestMixedNewlines::test_seek (CPython 3.12 oracle)."""
...
assert data == DATA_SPLIT[1:]
print("PyTestMixedNewlines::test_seek: ok")
