...
# lib = "collections"
# dimension = "behavior"
# case = "test_collection_ab_cs__test_issue26915"
# subject = "cpython.test_collections.TestCollectionABCs.test_issue26915"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestCollectionABCs::test_issue26915
"""Auto-ported test: TestCollectionABCs::test_issue26915 (CPython 3.12 oracle)."""
...
assert seq.index(obj) == 1

assert seq.count(nan) == 2

assert seq.count(obj) == 1
print("TestCollectionABCs::test_issue26915: ok")
