...
# lib = "collections"
# dimension = "behavior"
# case = "test_named_tuple__test_name_fixer"
# subject = "cpython.test_collections.TestNamedTuple.test_name_fixer"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestNamedTuple::test_name_fixer
"""Auto-ported test: TestNamedTuple::test_name_fixer (CPython 3.12 oracle)."""
...
for spec, renamed in [[('efg', 'g%hi'), ('efg', '_1')], [('abc', 'class'), ('abc', '_1')], [('8efg', '9ghi'), ('_0', '_1')], [('abc', '_efg'), ('abc', '_1')], [('abc', 'efg', 'efg', 'ghi'), ('abc', 'efg', '_2', 'ghi')], [('abc', '', 'x'), ('abc', '_1', 'x')]]:
    ...
    assert namedtuple('NT', spec, rename=True)._fields == renamed
print("TestNamedTuple::test_name_fixer: ok")
