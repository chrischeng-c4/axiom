...
# lib = "collections"
# dimension = "behavior"
# case = "test_named_tuple__test_non_generic_subscript"
# subject = "cpython.test_collections.TestNamedTuple.test_non_generic_subscript"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestNamedTuple::test_non_generic_subscript
"""Auto-ported test: TestNamedTuple::test_non_generic_subscript (CPython 3.12 oracle)."""
...
assert A.__origin__ == Group

assert A.__parameters__ == ()

assert A.__args__ == (int, list[int])
a = A(1, [2])

assert type(a) is Group

assert a == (1, [2])
print("TestNamedTuple::test_non_generic_subscript: ok")
