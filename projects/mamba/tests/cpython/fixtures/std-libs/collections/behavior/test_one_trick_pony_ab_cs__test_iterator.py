...
# lib = "collections"
# dimension = "behavior"
# case = "test_one_trick_pony_ab_cs__test_iterator"
# subject = "cpython.test_collections.TestOneTrickPonyABCs.test_Iterator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestOneTrickPonyABCs::test_Iterator
"""Auto-ported test: TestOneTrickPonyABCs::test_Iterator (CPython 3.12 oracle)."""
...
for x in non_samples:
    ...
    assert not isinstance(x, Iterator)

    assert not issubclass(type(x), Iterator)
...
for x in samples:
    ...
    assert issubclass(type(x), Iterator)
validate_abstract_methods(Iterator, '__next__', '__iter__')
...
assert not isinstance(NextOnly(), Iterator)
print("TestOneTrickPonyABCs::test_Iterator: ok")
