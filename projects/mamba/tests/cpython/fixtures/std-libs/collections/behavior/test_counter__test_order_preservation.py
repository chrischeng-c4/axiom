...
# lib = "collections"
# dimension = "behavior"
# case = "test_counter__test_order_preservation"
# subject = "cpython.test_collections.TestCounter.test_order_preservation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestCounter::test_order_preservation
"""Auto-ported test: TestCounter::test_order_preservation (CPython 3.12 oracle)."""
...
assert list(Counter('abracadabra').items()) == [('a', 5), ('b', 2), ('r', 2), ('c', 1), ('d', 1)]

assert list(Counter('xyzpdqqdpzyx').items()) == [('x', 2), ('y', 2), ('z', 2), ('p', 2), ('d', 2), ('q', 2)]

assert list(Counter('abracadabra simsalabim').elements()) == ['a', 'a', 'a', 'a', 'a', 'a', 'a', 'b', 'b', 'b', 'r', 'r', 'c', 'd', ' ', 's', 's', 'i', 'i', 'm', 'm', 'l']
...
assert correctly_ordered(p)
print("TestCounter::test_order_preservation: ok")
