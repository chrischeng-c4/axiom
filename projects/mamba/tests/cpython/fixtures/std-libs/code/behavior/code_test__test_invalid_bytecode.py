...
# lib = "code"
# dimension = "behavior"
# case = "code_test__test_invalid_bytecode"
# subject = "cpython.test_code.CodeTest.test_invalid_bytecode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_code.py::CodeTest::test_invalid_bytecode
"""Auto-ported test: CodeTest::test_invalid_bytecode (CPython 3.12 oracle)."""
...
except SystemError as _aR_e:
    import re as _re_aR
    assert _re_aR.search(msg, str(_aR_e))
print("CodeTest::test_invalid_bytecode: ok")
