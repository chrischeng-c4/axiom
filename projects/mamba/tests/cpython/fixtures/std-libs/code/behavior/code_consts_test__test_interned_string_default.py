...
# lib = "code"
# dimension = "behavior"
# case = "code_consts_test__test_interned_string_default"
# subject = "cpython.test_code.CodeConstsTest.test_interned_string_default"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_code.py::CodeConstsTest::test_interned_string_default
"""Auto-ported test: CodeConstsTest::test_interned_string_default (CPython 3.12 oracle)."""
...
def f(a='str_value'):
    return a
assertIsInterned(f())
print("CodeConstsTest::test_interned_string_default: ok")
