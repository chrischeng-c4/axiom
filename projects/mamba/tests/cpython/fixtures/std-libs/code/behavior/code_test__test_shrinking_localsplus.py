...
# lib = "code"
# dimension = "behavior"
# case = "code_test__test_shrinking_localsplus"
# subject = "cpython.test_code.CodeTest.test_shrinking_localsplus"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_code.py::CodeTest::test_shrinking_localsplus
"""Auto-ported test: CodeTest::test_shrinking_localsplus (CPython 3.12 oracle)."""
...
def func(arg):
    return lambda: arg
code = func.__code__
newcode = code.replace(co_name='func')

assert code == newcode
print("CodeTest::test_shrinking_localsplus: ok")
