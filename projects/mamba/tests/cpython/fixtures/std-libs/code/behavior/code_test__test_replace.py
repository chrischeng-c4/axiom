...
# lib = "code"
# dimension = "behavior"
# case = "code_test__test_replace"
# subject = "cpython.test_code.CodeTest.test_replace"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_code.py::CodeTest::test_replace
"""Auto-ported test: CodeTest::test_replace (CPython 3.12 oracle)."""
...
for attr, value in (('co_argcount', 0), ('co_posonlyargcount', 0), ('co_kwonlyargcount', 0), ('co_nlocals', 1), ('co_stacksize', 0), ('co_flags', code.co_flags | inspect.CO_COROUTINE), ('co_firstlineno', 100), ('co_code', code2.co_code), ('co_consts', code2.co_consts), ('co_names', ('myname',)), ('co_varnames', ('spam',)), ('co_freevars', ('freevar',)), ('co_cellvars', ('cellvar',)), ('co_filename', 'newfilename'), ('co_name', 'newname'), ('co_linetable', code2.co_linetable)):
    new_code = code.replace(**{attr: value})

    assert getattr(new_code, attr) == value
new_code = code.replace(co_varnames=code2.co_varnames, co_nlocals=code2.co_nlocals)

assert new_code.co_varnames == code2.co_varnames

assert new_code.co_nlocals == code2.co_nlocals
print("CodeTest::test_replace: ok")
