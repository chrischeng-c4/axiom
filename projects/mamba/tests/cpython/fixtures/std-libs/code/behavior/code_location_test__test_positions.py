...
# lib = "code"
# dimension = "behavior"
# case = "code_location_test__test_positions"
# subject = "cpython.test_code.CodeLocationTest.test_positions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_code.py::CodeLocationTest::test_positions
"""Auto-ported test: CodeLocationTest::test_positions (CPython 3.12 oracle)."""
...
def check_lines(func):
    ...
    assert lines1 == list(dedup(lines1))
...
check_positions(parse_location_table)
check_positions(misshappen)
check_positions(bug93662)
print("CodeLocationTest::test_positions: ok")
