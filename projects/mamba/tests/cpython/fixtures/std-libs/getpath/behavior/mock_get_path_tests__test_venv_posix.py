...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_venv_posix"
# subject = "cpython.test_getpath.MockGetPathTests.test_venv_posix"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_venv_posix
"""Auto-ported test: MockGetPathTests::test_venv_posix (CPython 3.12 oracle)."""
...
expected = dict(executable='/venv/bin/python', prefix='/usr', exec_prefix='/usr', base_executable='/usr/bin/python', base_prefix='/usr', base_exec_prefix='/usr', module_search_paths_set=1, module_search_paths=['/usr/lib/python98.zip', '/usr/lib/python9.8', '/usr/lib/python9.8/lib-dynload'])
actual = getpath(ns, expected)

assert expected == actual
print("MockGetPathTests::test_venv_posix: ok")
