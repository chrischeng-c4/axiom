...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_no_dlls_win32"
# subject = "cpython.test_getpath.MockGetPathTests.test_no_dlls_win32"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_no_dlls_win32
"""Auto-ported test: MockGetPathTests::test_no_dlls_win32 (CPython 3.12 oracle)."""
...
expected = dict(executable='C:\\Python\\python.exe', base_executable='C:\\Python\\python.exe', prefix='C:\\Python', exec_prefix='C:\\Python', module_search_paths_set=1, module_search_paths=['C:\\Python\\python98.zip', 'C:\\Python', 'C:\\Python\\Lib'])
actual = getpath(ns, expected)

assert expected == actual
print("MockGetPathTests::test_no_dlls_win32: ok")
