...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_venv_framework_macos"
# subject = "cpython.test_getpath.MockGetPathTests.test_venv_framework_macos"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_venv_framework_macos
"""Auto-ported test: MockGetPathTests::test_venv_framework_macos (CPython 3.12 oracle)."""
...
ns = MockPosixNamespace(os_name='darwin', argv0='/Library/Frameworks/Python.framework/Versions/9.8/Resources/Python.app/Contents/MacOS/Python', WITH_NEXT_FRAMEWORK=1, PREFIX='/Library/Frameworks/Python.framework/Versions/9.8', EXEC_PREFIX='/Library/Frameworks/Python.framework/Versions/9.8', ENV___PYVENV_LAUNCHER__=f'{venv_path}/bin/python', real_executable='/Library/Frameworks/Python.framework/Versions/9.8/Resources/Python.app/Contents/MacOS/Python', library='/Library/Frameworks/Python.framework/Versions/9.8/Python')
...
ns.add_known_file(f'{venv_path}/pyvenv.cfg', ['home = /Library/Frameworks/Python.framework/Versions/9.8/bin'])
expected = dict(executable=f'{venv_path}/bin/python', prefix='/Library/Frameworks/Python.framework/Versions/9.8', exec_prefix='/Library/Frameworks/Python.framework/Versions/9.8', base_executable='/Library/Frameworks/Python.framework/Versions/9.8/bin/python9.8', base_prefix='/Library/Frameworks/Python.framework/Versions/9.8', base_exec_prefix='/Library/Frameworks/Python.framework/Versions/9.8', module_search_paths_set=1, module_search_paths=['/Library/Frameworks/Python.framework/Versions/9.8/lib/python98.zip', '/Library/Frameworks/Python.framework/Versions/9.8/lib/python9.8', '/Library/Frameworks/Python.framework/Versions/9.8/lib/python9.8/lib-dynload'])
actual = getpath(ns, expected)

assert expected == actual
print("MockGetPathTests::test_venv_framework_macos: ok")
