...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_symlink_normal_macos"
# subject = "cpython.test_getpath.MockGetPathTests.test_symlink_normal_macos"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_symlink_normal_macos
"""Auto-ported test: MockGetPathTests::test_symlink_normal_macos (CPython 3.12 oracle)."""
...
ns = MockPosixNamespace(os_name='darwin', PREFIX='/usr', argv0='python', ENV_PATH='/linkfrom:/usr/bin', real_executable='/linkfrom/python')
...
expected = dict(executable='/linkfrom/python', base_executable='/linkfrom/python', prefix='/usr', exec_prefix='/usr', module_search_paths_set=1, module_search_paths=['/usr/lib/python98.zip', '/usr/lib/python9.8', '/usr/lib/python9.8/lib-dynload'])
actual = getpath(ns, expected)

assert expected == actual
print("MockGetPathTests::test_symlink_normal_macos: ok")
