...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_symlink_buildtree_win32"
# subject = "cpython.test_getpath.MockGetPathTests.test_symlink_buildtree_win32"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_symlink_buildtree_win32
"""Auto-ported test: MockGetPathTests::test_symlink_buildtree_win32 (CPython 3.12 oracle)."""
...
ns = MockNTNamespace(argv0='C:\\LinkedFrom\\python.exe', real_executable='C:\\CPython\\PCbuild\\amd64\\python.exe')
ns.add_known_xfile('C:\\LinkedFrom\\python.exe')
ns.add_known_xfile('C:\\CPython\\PCbuild\\amd64\\python.exe')
ns.add_known_link('C:\\LinkedFrom\\python.exe', 'C:\\CPython\\PCbuild\\amd64\\python.exe')
ns.add_known_file('C:\\CPython\\Lib\\os.py')
ns.add_known_file('C:\\CPython\\PCbuild\\amd64\\pybuilddir.txt', [''])
expected = dict(executable='C:\\LinkedFrom\\python.exe', base_executable='C:\\LinkedFrom\\python.exe', prefix='C:\\CPython', exec_prefix='C:\\CPython', build_prefix='C:\\CPython', _is_python_build=1, module_search_paths_set=1, module_search_paths=['C:\\CPython\\PCbuild\\amd64\\python98.zip', 'C:\\CPython\\PCbuild\\amd64', 'C:\\CPython\\Lib'])
actual = getpath(ns, expected)

assert expected == actual
print("MockGetPathTests::test_symlink_buildtree_win32: ok")
