...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_registry_win32"
# subject = "cpython.test_getpath.MockGetPathTests.test_registry_win32"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_registry_win32
"""Auto-ported test: MockGetPathTests::test_registry_win32 (CPython 3.12 oracle)."""
...
"""Test registry lookup on Windows.
        ...
        """
hkey = f'HKLM\\Software\\Python\\PythonCore\\9.8-XY\\PythonPath'
winreg = MockWinreg({hkey: None, f'{hkey}\\Path1': 'path1-dir', f'{hkey}\\Path1\\Subdir': 'not-subdirs'})
ns = MockNTNamespace(argv0='C:\\Python\\python.exe', real_executable='C:\\Python\\python.exe', winreg=winreg)
ns.add_known_xfile('C:\\Python\\python.exe')
ns.add_known_file('C:\\Python\\Lib\\os.py')
ns.add_known_dir('C:\\Python\\DLLs')
expected = dict(module_search_paths_set=1, module_search_paths=['C:\\Python\\python98.zip', 'path1-dir', 'C:\\Python\\DLLs', 'C:\\Python\\Lib', 'C:\\Python'])
...
expected = dict(module_search_paths_set=1, module_search_paths=['C:\\Python\\python98.zip', 'C:\\Python\\DLLs', 'C:\\Python\\Lib', 'C:\\Python'])
actual = getpath(ns, expected)

assert expected == actual
print("MockGetPathTests::test_registry_win32: ok")
