...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_normal_posix"
# subject = "cpython.test_getpath.MockGetPathTests.test_normal_posix"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_normal_posix
"""Auto-ported test: MockGetPathTests::test_normal_posix (CPython 3.12 oracle)."""
...
ns = MockPosixNamespace(PREFIX='/usr', argv0='python', ENV_PATH='/usr/bin')
ns.add_known_xfile('/usr/bin/python')
ns.add_known_file('/usr/lib/python9.8/os.py')
ns.add_known_dir('/usr/lib/python9.8/lib-dynload')
expected = dict(executable='/usr/bin/python', base_executable='/usr/bin/python', prefix='/usr', exec_prefix='/usr', module_search_paths_set=1, module_search_paths=['/usr/lib/python98.zip', '/usr/lib/python9.8', '/usr/lib/python9.8/lib-dynload'])
actual = getpath(ns, expected)

assert expected == actual
print("MockGetPathTests::test_normal_posix: ok")
