...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_node_list_item"
# subject = "cpython.test_minidom.MinidomTest.testNodeListItem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testNodeListItem
"""Auto-ported test: MinidomTest::testNodeListItem (CPython 3.12 oracle)."""
...
docelem = children[0]
confirm(children[0] is children.item(0) and children.item(1) is None and (docelem.childNodes.item(0) is docelem.childNodes[0]) and (docelem.childNodes.item(1) is docelem.childNodes[1]) and (docelem.childNodes.item(0).childNodes.item(0) is None), 'test NodeList.item()')
doc.unlink()
print("MinidomTest::testNodeListItem: ok")
