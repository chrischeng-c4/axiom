...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_remove_attribute_node"
# subject = "cpython.test_minidom.MinidomTest.testRemoveAttributeNode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testRemoveAttributeNode
"""Auto-ported test: MinidomTest::testRemoveAttributeNode (CPython 3.12 oracle)."""
...
try:
    child.removeAttributeNode(None)
    raise AssertionError('expected xml.dom.NotFoundErr')
except xml.dom.NotFoundErr:
    pass

assert node is child.removeAttributeNode(node)
confirm(len(child.attributes) == 0 and child.getAttributeNode('spam') is None)
dom2 = Document()
child2 = dom2.appendChild(dom2.createElement('foo'))
node2 = child2.getAttributeNode('spam')

try:
    child2.removeAttributeNode(node2)
    raise AssertionError('expected xml.dom.NotFoundErr')
except xml.dom.NotFoundErr:
    pass
dom.unlink()
print("MinidomTest::testRemoveAttributeNode: ok")
