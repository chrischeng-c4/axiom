...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_exception_on_spaces_in_xmlns_value"
# subject = "cpython.test_minidom.MinidomTest.testExceptionOnSpacesInXMLNSValue"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testExceptionOnSpacesInXMLNSValue
"""Auto-ported test: MinidomTest::testExceptionOnSpacesInXMLNSValue (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('expected (ValueError, ExpatError)')
except (ValueError, ExpatError):
    pass
print("MinidomTest::testExceptionOnSpacesInXMLNSValue: ok")
