...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_clone_element_shallow"
# subject = "cpython.test_minidom.MinidomTest.testCloneElementShallow"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testCloneElementShallow
"""Auto-ported test: MinidomTest::testCloneElementShallow (CPython 3.12 oracle)."""
...
confirm(len(clone.childNodes) == 0 and clone.childNodes.length == 0 and (clone.parentNode is None) and (clone.toxml() == '<doc attr="value"/>'), 'testCloneElementShallow')
dom.unlink()
print("MinidomTest::testCloneElementShallow: ok")
