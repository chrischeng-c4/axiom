...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_aaa"
# subject = "cpython.test_minidom.MinidomTest.testAAA"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testAAA
"""Auto-ported test: MinidomTest::testAAA (CPython 3.12 oracle)."""
...
confirm(a.ownerElement is dom.documentElement, 'setAttribute() sets ownerElement')
dom.unlink()
print("MinidomTest::testAAA: ok")
