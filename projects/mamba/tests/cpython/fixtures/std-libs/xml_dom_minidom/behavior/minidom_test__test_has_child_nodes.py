...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_has_child_nodes"
# subject = "cpython.test_minidom.MinidomTest.testHasChildNodes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testHasChildNodes
"""Auto-ported test: MinidomTest::testHasChildNodes (CPython 3.12 oracle)."""
...
assert doc.hasChildNodes()
dom2 = parseString('<doc/>')
doc2 = dom2.documentElement

assert not doc2.hasChildNodes()
print("MinidomTest::testHasChildNodes: ok")
