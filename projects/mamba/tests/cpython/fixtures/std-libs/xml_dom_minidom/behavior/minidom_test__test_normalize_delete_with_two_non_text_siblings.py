...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_normalize_delete_with_two_non_text_siblings"
# subject = "cpython.test_minidom.MinidomTest.testNormalizeDeleteWithTwoNonTextSiblings"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testNormalizeDeleteWithTwoNonTextSiblings
"""Auto-ported test: MinidomTest::testNormalizeDeleteWithTwoNonTextSiblings (CPython 3.12 oracle)."""
...
root.appendChild(doc.createElement('i'))
confirm(len(root.childNodes) == 3 and root.childNodes.length == 3, 'testNormalizeDeleteWithTwoSiblings -- preparation')
doc.normalize()
confirm(len(root.childNodes) == 2 and root.childNodes.length == 2 and (root.firstChild is not root.lastChild) and (root.firstChild.nextSibling is root.lastChild) and (root.firstChild.previousSibling is None) and (root.lastChild.previousSibling is root.firstChild) and (root.lastChild.nextSibling is None), 'testNormalizeDeleteWithTwoSiblings -- result')
doc.unlink()
print("MinidomTest::testNormalizeDeleteWithTwoNonTextSiblings: ok")
