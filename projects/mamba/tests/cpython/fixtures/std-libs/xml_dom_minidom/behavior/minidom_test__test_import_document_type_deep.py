...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_import_document_type_deep"
# subject = "cpython.test_minidom.MinidomTest.testImportDocumentTypeDeep"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testImportDocumentTypeDeep
"""Auto-ported test: MinidomTest::testImportDocumentTypeDeep (CPython 3.12 oracle)."""
...
try:
    target.importNode(src.doctype, 1)
    raise AssertionError('expected xml.dom.NotSupportedErr')
except xml.dom.NotSupportedErr:
    pass
print("MinidomTest::testImportDocumentTypeDeep: ok")
