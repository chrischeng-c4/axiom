...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_legal_children"
# subject = "cpython.test_minidom.MinidomTest.testLegalChildren"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testLegalChildren
"""Auto-ported test: MinidomTest::testLegalChildren (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('expected xml.dom.HierarchyRequestErr')
...
dom.unlink()
print("MinidomTest::testLegalChildren: ok")
