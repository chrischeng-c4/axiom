...
# lib = "tokenize"
# dimension = "behavior"
# case = "generate_tokens_test__test_selector"
# subject = "cpython.test_tokenize.GenerateTokensTest.test_selector"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::GenerateTokensTest::test_selector
"""Auto-ported test: GenerateTokensTest::test_selector (CPython 3.12 oracle)."""
...
check_tokenize("import sys, time\nx = sys.modules['time'].time()", '    NAME       \'import\'      (1, 0) (1, 6)\n    NAME       \'sys\'         (1, 7) (1, 10)\n    OP         \',\'           (1, 10) (1, 11)\n    NAME       \'time\'        (1, 12) (1, 16)\n    NEWLINE    \'\\n\'          (1, 16) (1, 17)\n    NAME       \'x\'           (2, 0) (2, 1)\n    OP         \'=\'           (2, 2) (2, 3)\n    NAME       \'sys\'         (2, 4) (2, 7)\n    OP         \'.\'           (2, 7) (2, 8)\n    NAME       \'modules\'     (2, 8) (2, 15)\n    OP         \'[\'           (2, 15) (2, 16)\n    STRING     "\'time\'"      (2, 16) (2, 22)\n    OP         \']\'           (2, 22) (2, 23)\n    OP         \'.\'           (2, 23) (2, 24)\n    NAME       \'time\'        (2, 24) (2, 28)\n    OP         \'(\'           (2, 28) (2, 29)\n    OP         \')\'           (2, 29) (2, 30)\n    ')
print("GenerateTokensTest::test_selector: ok")
