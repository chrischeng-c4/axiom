...
# lib = "tokenize"
# dimension = "behavior"
# case = "c_tokenize_test__test_method"
# subject = "cpython.test_tokenize.CTokenizeTest.test_method"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::CTokenizeTest::test_method
"""Auto-ported test: CTokenizeTest::test_method (CPython 3.12 oracle)."""
...
check_tokenize('@staticmethod\ndef foo(x,y): pass', "    AT         '@'           (1, 0) (1, 1)\n    NAME       'staticmethod' (1, 1) (1, 13)\n    NEWLINE    ''            (1, 13) (1, 13)\n    NAME       'def'         (2, 0) (2, 3)\n    NAME       'foo'         (2, 4) (2, 7)\n    LPAR       '('           (2, 7) (2, 8)\n    NAME       'x'           (2, 8) (2, 9)\n    COMMA      ','           (2, 9) (2, 10)\n    NAME       'y'           (2, 10) (2, 11)\n    RPAR       ')'           (2, 11) (2, 12)\n    COLON      ':'           (2, 12) (2, 13)\n    NAME       'pass'        (2, 14) (2, 18)\n    ")
print("CTokenizeTest::test_method: ok")
