...
# lib = "tokenize"
# dimension = "behavior"
# case = "generate_tokens_test__test_non_ascii_identifiers"
# subject = "cpython.test_tokenize.GenerateTokensTest.test_non_ascii_identifiers"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::GenerateTokensTest::test_non_ascii_identifiers
"""Auto-ported test: GenerateTokensTest::test_non_ascii_identifiers (CPython 3.12 oracle)."""
...
check_tokenize("Örter = 'places'\ngrün = 'green'", '    NAME       \'Örter\'       (1, 0) (1, 5)\n    OP         \'=\'           (1, 6) (1, 7)\n    STRING     "\'places\'"    (1, 8) (1, 16)\n    NEWLINE    \'\\n\'          (1, 16) (1, 17)\n    NAME       \'grün\'        (2, 0) (2, 4)\n    OP         \'=\'           (2, 5) (2, 6)\n    STRING     "\'green\'"     (2, 7) (2, 14)\n    ')
print("GenerateTokensTest::test_non_ascii_identifiers: ok")
