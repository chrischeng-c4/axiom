...
# lib = "tokenize"
# dimension = "behavior"
# case = "generate_tokens_test__test_multiline_non_ascii_fstring"
# subject = "cpython.test_tokenize.GenerateTokensTest.test_multiline_non_ascii_fstring"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::GenerateTokensTest::test_multiline_non_ascii_fstring
"""Auto-ported test: GenerateTokensTest::test_multiline_non_ascii_fstring (CPython 3.12 oracle)."""
...
check_tokenize("a = f'''\n    Autorzy, którzy tą jednostkę mają wpisani jako AKTUALNA -- czyli'''", '    NAME       \'a\'           (1, 0) (1, 1)\n    OP         \'=\'           (1, 2) (1, 3)\n    FSTRING_START "f\'\'\'"        (1, 4) (1, 8)\n    FSTRING_MIDDLE \'\\n    Autorzy, którzy tą jednostkę mają wpisani jako AKTUALNA -- czyli\' (1, 8) (2, 68)\n    FSTRING_END "\'\'\'"         (2, 68) (2, 71)\n    ')
print("GenerateTokensTest::test_multiline_non_ascii_fstring: ok")
