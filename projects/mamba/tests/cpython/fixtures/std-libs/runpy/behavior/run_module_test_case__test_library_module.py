...
# lib = "runpy"
# dimension = "behavior"
# case = "run_module_test_case__test_library_module"
# subject = "cpython.test_runpy.RunModuleTestCase.test_library_module"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_runpy.py::RunModuleTestCase::test_library_module
"""Auto-ported test: RunModuleTestCase::test_library_module (CPython 3.12 oracle)."""
...
assert run_module('runpy')['__name__'] == 'runpy'
print("RunModuleTestCase::test_library_module: ok")
