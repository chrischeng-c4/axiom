...
# lib = "runpy"
# dimension = "behavior"
# case = "run_module_test_case__test_run_name"
# subject = "cpython.test_runpy.RunModuleTestCase.test_run_name"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_runpy.py::RunModuleTestCase::test_run_name
"""Auto-ported test: RunModuleTestCase::test_run_name (CPython 3.12 oracle)."""
...
pkg_dir, mod_fname, mod_name, mod_spec = _make_pkg(example_source, depth)
forget(mod_name)
expected_ns = example_namespace.copy()
...
try:
    ...
    _del_pkg(pkg_dir)
print("RunModuleTestCase::test_run_name: ok")
