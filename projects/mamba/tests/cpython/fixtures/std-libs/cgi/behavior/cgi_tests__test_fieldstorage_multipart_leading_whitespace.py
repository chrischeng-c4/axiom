...
# lib = "cgi"
# dimension = "behavior"
# case = "cgi_tests__test_fieldstorage_multipart_leading_whitespace"
# subject = "cpython.test_cgi.CgiTests.test_fieldstorage_multipart_leading_whitespace"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cgi.py::CgiTests::test_fieldstorage_multipart_leading_whitespace
"""Auto-ported test: CgiTests::test_fieldstorage_multipart_leading_whitespace (CPython 3.12 oracle)."""
...
for x in range(len(fs.list)):
    for k, exp in expect[x].items():
        ...
        assert got == exp
print("CgiTests::test_fieldstorage_multipart_leading_whitespace: ok")
