...
# lib = "cgi"
# dimension = "behavior"
# case = "cgi_tests__test_fieldstorage_multipart"
# subject = "cpython.test_cgi.CgiTests.test_fieldstorage_multipart"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cgi.py::CgiTests::test_fieldstorage_multipart
"""Auto-ported test: CgiTests::test_fieldstorage_multipart (CPython 3.12 oracle)."""
...
for x in range(len(fs.list)):
    for k, exp in expect[x].items():
        ...
        assert got == exp
print("CgiTests::test_fieldstorage_multipart: ok")
