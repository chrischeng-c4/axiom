...
# lib = "shutil"
# dimension = "behavior"
# case = "test_copy_tree__test_copytree_dirs_exist_ok"
# subject = "cpython.test_shutil.TestCopyTree.test_copytree_dirs_exist_ok"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestCopyTree::test_copytree_dirs_exist_ok
"""Auto-ported test: TestCopyTree::test_copytree_dirs_exist_ok (CPython 3.12 oracle)."""
...
assert os.path.isfile(os.path.join(dst_dir, 'nonexisting.txt'))

assert os.path.isdir(os.path.join(dst_dir, 'existing_dir'))

assert os.path.isfile(os.path.join(dst_dir, 'existing_dir', 'existing.txt'))
actual = read_file((dst_dir, 'nonexisting.txt'))

assert actual == '123'
actual = read_file((dst_dir, 'existing_dir', 'existing.txt'))

assert actual == 'has been replaced'
try:
    shutil.copytree(src_dir, dst_dir, dirs_exist_ok=False)
    raise AssertionError('expected FileExistsError')
except FileExistsError:
    pass
print("TestCopyTree::test_copytree_dirs_exist_ok: ok")
