...
# lib = "shutil"
# dimension = "behavior"
# case = "test_archives__test_register_archive_format"
# subject = "cpython.test_shutil.TestArchives.test_register_archive_format"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestArchives::test_register_archive_format
"""Auto-ported test: TestArchives::test_register_archive_format (CPython 3.12 oracle)."""
...
try:
    register_archive_format('xxx', lambda: x, 1)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    register_archive_format('xxx', lambda: x, [(1, 2), (1, 2, 3)])
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
print("TestArchives::test_register_archive_format: ok")
