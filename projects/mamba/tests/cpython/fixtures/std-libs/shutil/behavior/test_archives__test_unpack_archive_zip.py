...
# lib = "shutil"
# dimension = "behavior"
# case = "test_archives__test_unpack_archive_zip"
# subject = "cpython.test_shutil.TestArchives.test_unpack_archive_zip"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestArchives::test_unpack_archive_zip
"""Auto-ported test: TestArchives::test_unpack_archive_zip (CPython 3.12 oracle)."""
...
def mkdtemp(prefix=None):
    ...
    pass
    return d
check_unpack_archive('zip')
try:
    check_unpack_archive('zip', filter='data')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("TestArchives::test_unpack_archive_zip: ok")
