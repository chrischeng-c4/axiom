...
# lib = "shutil"
# dimension = "behavior"
# case = "test_zero_copy_macos__test_non_existent_src"
# subject = "cpython.test_shutil.TestZeroCopyMACOS.test_non_existent_src"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestZeroCopyMACOS::test_non_existent_src
"""Auto-ported test: TestZeroCopyMACOS::test_non_existent_src (CPython 3.12 oracle)."""
...
print("TestZeroCopyMACOS::test_non_existent_src: ok")
