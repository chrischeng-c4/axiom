...
# lib = "shutil"
# dimension = "behavior"
# case = "test_rm_tree__test_rmtree_errors_onerror"
# subject = "cpython.test_shutil.TestRmTree.test_rmtree_errors_onerror"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestRmTree::test_rmtree_errors_onerror
"""Auto-ported test: TestRmTree::test_rmtree_errors_onerror (CPython 3.12 oracle)."""
...
def mkdtemp(prefix=None):
    ...
    pass
    return d
filename = tempfile.mktemp(dir=mkdtemp())
...
assert cm.exception.filename == filename
...
assert errors[0][0] is os.scandir

assert errors[0][1] == filename

assert isinstance(errors[0][2][1], NotADirectoryError)

assert errors[0][2][1].filename == filename

assert errors[1][0] is os.rmdir

assert errors[1][1] == filename

assert isinstance(errors[1][2][1], NotADirectoryError)

assert errors[1][2][1].filename == filename
print("TestRmTree::test_rmtree_errors_onerror: ok")
