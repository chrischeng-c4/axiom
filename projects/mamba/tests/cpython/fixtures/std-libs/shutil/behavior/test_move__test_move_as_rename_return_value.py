...
# lib = "shutil"
# dimension = "behavior"
# case = "test_move__test_move_as_rename_return_value"
# subject = "cpython.test_shutil.TestMove.test_move_as_rename_return_value"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestMove::test_move_as_rename_return_value
"""Auto-ported test: TestMove::test_move_as_rename_return_value (CPython 3.12 oracle)."""
...
rv = shutil.move(self_src_file, os.path.join(self_dst_dir, 'bar'))

assert rv == os.path.join(self_dst_dir, 'bar')
print("TestMove::test_move_as_rename_return_value: ok")
