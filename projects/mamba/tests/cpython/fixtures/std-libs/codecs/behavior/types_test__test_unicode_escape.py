...
# lib = "codecs"
# dimension = "behavior"
# case = "types_test__test_unicode_escape"
# subject = "cpython.test_codecs.TypesTest.test_unicode_escape"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::TypesTest::test_unicode_escape
"""Auto-ported test: TypesTest::test_unicode_escape (CPython 3.12 oracle)."""
...
assert codecs.unicode_escape_decode('\\u1234') == ('ሴ', 6)

assert codecs.unicode_escape_decode(b'\\u1234') == ('ሴ', 6)

assert codecs.raw_unicode_escape_decode('\\u1234') == ('ሴ', 6)

assert codecs.raw_unicode_escape_decode(b'\\u1234') == ('ሴ', 6)

try:
    codecs.unicode_escape_decode(b'\\U00110000')
    raise AssertionError('expected UnicodeDecodeError')
except UnicodeDecodeError:
    pass

assert codecs.unicode_escape_decode('\\U00110000', 'replace') == ('�', 10)

assert codecs.unicode_escape_decode('\\U00110000', 'backslashreplace') == ('\\x5c\\x55\\x30\\x30\\x31\\x31\\x30\\x30\\x30\\x30', 10)

try:
    codecs.raw_unicode_escape_decode(b'\\U00110000')
    raise AssertionError('expected UnicodeDecodeError')
except UnicodeDecodeError:
    pass

assert codecs.raw_unicode_escape_decode('\\U00110000', 'replace') == ('�', 10)

assert codecs.raw_unicode_escape_decode('\\U00110000', 'backslashreplace') == ('\\x5c\\x55\\x30\\x30\\x31\\x31\\x30\\x30\\x30\\x30', 10)
print("TypesTest::test_unicode_escape: ok")
