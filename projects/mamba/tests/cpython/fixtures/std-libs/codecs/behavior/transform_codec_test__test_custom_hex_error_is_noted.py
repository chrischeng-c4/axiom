...
# lib = "codecs"
# dimension = "behavior"
# case = "transform_codec_test__test_custom_hex_error_is_noted"
# subject = "cpython.test_codecs.TransformCodecTest.test_custom_hex_error_is_noted"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::TransformCodecTest::test_custom_hex_error_is_noted
"""Auto-ported test: TransformCodecTest::test_custom_hex_error_is_noted (CPython 3.12 oracle)."""
...
except binascii.Error as _aR_e:
    import types as _types_aR
    failure = _types_aR.SimpleNamespace(exception=_aR_e)

assert msg == failure.exception.__notes__[0]
print("TransformCodecTest::test_custom_hex_error_is_noted: ok")
