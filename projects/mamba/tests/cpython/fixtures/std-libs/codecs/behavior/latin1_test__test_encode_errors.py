...
# lib = "codecs"
# dimension = "behavior"
# case = "latin1_test__test_encode_errors"
# subject = "cpython.test_codecs.Latin1Test.test_encode_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::Latin1Test::test_encode_errors
"""Auto-ported test: Latin1Test::test_encode_errors (CPython 3.12 oracle)."""
...
for data, error_handler, expected in (('[€\udc80]', 'ignore', b'[]'), ('[€\udc80]', 'replace', b'[??]'), ('[€\U000abcde]', 'backslashreplace', b'[\\u20ac\\U000abcde]'), ('[€\udc80]', 'xmlcharrefreplace', b'[&#8364;&#56448;]'), ('[\udc80\udcff]', 'surrogateescape', b'[\x80\xff]')):
    ...
    assert data.encode('latin1', error_handler) == expected
print("Latin1Test::test_encode_errors: ok")
