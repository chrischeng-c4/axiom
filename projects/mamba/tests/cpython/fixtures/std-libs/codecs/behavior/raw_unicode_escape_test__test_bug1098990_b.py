...
# lib = "codecs"
# dimension = "behavior"
# case = "raw_unicode_escape_test__test_bug1098990_b"
# subject = "cpython.test_codecs.RawUnicodeEscapeTest.test_bug1098990_b"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::RawUnicodeEscapeTest::test_bug1098990_b
"""Auto-ported test: RawUnicodeEscapeTest::test_bug1098990_b (CPython 3.12 oracle)."""
...
s4 = 'broken!!!!badbad\r\n'
s5 = 'againokay.\r\n'
s = (s1 + s2 + s3 + s4 + s5).encode(encoding)
stream = io.BytesIO(s)
...
print("RawUnicodeEscapeTest::test_bug1098990_b: ok")
