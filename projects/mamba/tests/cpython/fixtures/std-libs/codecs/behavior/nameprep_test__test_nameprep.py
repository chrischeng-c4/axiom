...
# lib = "codecs"
# dimension = "behavior"
# case = "nameprep_test__test_nameprep"
# subject = "cpython.test_codecs.NameprepTest.test_nameprep"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::NameprepTest::test_nameprep
"""Auto-ported test: NameprepTest::test_nameprep (CPython 3.12 oracle)."""
...
for pos, (orig, prepped) in enumerate(nameprep_tests):
    ...
    if prepped is None:
        ...
        try:
            ...
            assert nameprep(orig) == prepped
        except Exception as e:
            raise support.TestFailed('Test 3.%d: %s' % (pos + 1, str(e)))
print("NameprepTest::test_nameprep: ok")
