...
# lib = "codecs"
# dimension = "behavior"
# case = "stream_reader_writer_test__test_copy"
# subject = "cpython.test_codecs.StreamReaderWriterTest.test_copy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::StreamReaderWriterTest::test_copy
"""Auto-ported test: StreamReaderWriterTest::test_copy (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('StreamReaderWriter', str(_aR_e))
print("StreamReaderWriterTest::test_copy: ok")
