...
# lib = "codecs"
# dimension = "behavior"
# case = "punycode_test__test_decode_invalid"
# subject = "cpython.test_codecs.PunycodeTest.test_decode_invalid"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::PunycodeTest::test_decode_invalid
"""Auto-ported test: PunycodeTest::test_decode_invalid (CPython 3.12 oracle)."""
...
for puny, errors, expected in testcases:
    if isinstance(expected, Exception):
        ...
        assert puny.decode('punycode', errors) == expected
print("PunycodeTest::test_decode_invalid: ok")
