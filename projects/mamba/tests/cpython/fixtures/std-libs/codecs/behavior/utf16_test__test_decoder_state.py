...
# lib = "codecs"
# dimension = "behavior"
# case = "utf16_test__test_decoder_state"
# subject = "cpython.test_codecs.UTF16Test.test_decoder_state"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF16Test::test_decoder_state
"""Auto-ported test: UTF16Test::test_decoder_state (CPython 3.12 oracle)."""
...
check_state_handling_decode(encoding, 'spamspam', spamle)
check_state_handling_decode(encoding, 'spamspam', spambe)
print("UTF16Test::test_decoder_state: ok")
