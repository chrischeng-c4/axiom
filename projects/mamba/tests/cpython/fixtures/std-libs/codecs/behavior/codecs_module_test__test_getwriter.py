...
# lib = "codecs"
# dimension = "behavior"
# case = "codecs_module_test__test_getwriter"
# subject = "cpython.test_codecs.CodecsModuleTest.test_getwriter"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::CodecsModuleTest::test_getwriter
"""Auto-ported test: CodecsModuleTest::test_getwriter (CPython 3.12 oracle)."""
...
try:
    codecs.getwriter('__spam__')
    raise AssertionError('expected LookupError')
except LookupError:
    pass
print("CodecsModuleTest::test_getwriter: ok")
