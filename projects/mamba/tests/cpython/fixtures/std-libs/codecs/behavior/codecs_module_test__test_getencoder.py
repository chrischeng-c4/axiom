...
# lib = "codecs"
# dimension = "behavior"
# case = "codecs_module_test__test_getencoder"
# subject = "cpython.test_codecs.CodecsModuleTest.test_getencoder"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::CodecsModuleTest::test_getencoder
"""Auto-ported test: CodecsModuleTest::test_getencoder (CPython 3.12 oracle)."""
...
try:
    codecs.getencoder('__spam__')
    raise AssertionError('expected LookupError')
except LookupError:
    pass
print("CodecsModuleTest::test_getencoder: ok")
