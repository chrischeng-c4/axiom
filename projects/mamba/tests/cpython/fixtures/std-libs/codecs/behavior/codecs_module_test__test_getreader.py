...
# lib = "codecs"
# dimension = "behavior"
# case = "codecs_module_test__test_getreader"
# subject = "cpython.test_codecs.CodecsModuleTest.test_getreader"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::CodecsModuleTest::test_getreader
"""Auto-ported test: CodecsModuleTest::test_getreader (CPython 3.12 oracle)."""
...
try:
    codecs.getreader('__spam__')
    raise AssertionError('expected LookupError')
except LookupError:
    pass
print("CodecsModuleTest::test_getreader: ok")
