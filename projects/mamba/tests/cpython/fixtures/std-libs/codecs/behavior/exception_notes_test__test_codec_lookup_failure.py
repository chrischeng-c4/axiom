...
# lib = "codecs"
# dimension = "behavior"
# case = "exception_notes_test__test_codec_lookup_failure"
# subject = "cpython.test_codecs.ExceptionNotesTest.test_codec_lookup_failure"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::ExceptionNotesTest::test_codec_lookup_failure
"""Auto-ported test: ExceptionNotesTest::test_codec_lookup_failure (CPython 3.12 oracle)."""
...
msg = '^unknown encoding: {}$'.format(self_codec_name)
try:
    'str input'.encode(self_codec_name)
    raise AssertionError('expected LookupError')
except LookupError as _aR_e:
    import re as _re_aR
    assert _re_aR.search(msg, str(_aR_e))
try:
    codecs.encode('str input', self_codec_name)
    raise AssertionError('expected LookupError')
except LookupError as _aR_e:
    import re as _re_aR
    assert _re_aR.search(msg, str(_aR_e))
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(msg, str(_aR_e))
print("ExceptionNotesTest::test_codec_lookup_failure: ok")
