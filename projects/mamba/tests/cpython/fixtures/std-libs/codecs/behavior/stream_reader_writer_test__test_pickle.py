...
# lib = "codecs"
# dimension = "behavior"
# case = "stream_reader_writer_test__test_pickle"
# subject = "cpython.test_codecs.StreamReaderWriterTest.test_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::StreamReaderWriterTest::test_pickle
"""Auto-ported test: StreamReaderWriterTest::test_pickle (CPython 3.12 oracle)."""
...
# --- test body ---
self_reader = codecs.getreader('latin1')
self_writer = codecs.getwriter('utf-8')
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    f = codecs.StreamReaderWriter(Queue(b''), self_reader, self_writer)
    try:
        pickle.dumps(f, proto)
        raise AssertionError('expected TypeError')
    except TypeError as _aR_e:
        import re as _re_aR
        assert _re_aR.search('StreamReaderWriter', str(_aR_e))
print("StreamReaderWriterTest::test_pickle: ok")
