...
# lib = "codecs"
# dimension = "behavior"
# case = "idna_codec_test__test_builtin_decode_length_limit"
# subject = "cpython.test_codecs.IDNACodecTest.test_builtin_decode_length_limit"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::IDNACodecTest::test_builtin_decode_length_limit
"""Auto-ported test: IDNACodecTest::test_builtin_decode_length_limit (CPython 3.12 oracle)."""
...
except UnicodeError as _aR_e:
    import re as _re_aR
    assert _re_aR.search('way too long', str(_aR_e))
try:
    (b'xn--016c' + b'a' * 70).decode('idna')
    raise AssertionError('expected UnicodeError')
except UnicodeError as _aR_e:
    import re as _re_aR
    assert _re_aR.search('too long', str(_aR_e))
print("IDNACodecTest::test_builtin_decode_length_limit: ok")
