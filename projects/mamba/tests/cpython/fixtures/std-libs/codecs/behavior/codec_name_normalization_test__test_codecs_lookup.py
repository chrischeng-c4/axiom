...
# lib = "codecs"
# dimension = "behavior"
# case = "codec_name_normalization_test__test_codecs_lookup"
# subject = "cpython.test_codecs.CodecNameNormalizationTest.test_codecs_lookup"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::CodecNameNormalizationTest::test_codecs_lookup
"""Auto-ported test: CodecNameNormalizationTest::test_codecs_lookup (CPython 3.12 oracle)."""
...
assert FOUND == codecs.lookup('aaa_8')

assert FOUND == codecs.lookup('AAA-8')

assert FOUND == codecs.lookup('AAA---8')

assert FOUND == codecs.lookup('AAA   8')

assert FOUND == codecs.lookup('aaaé€-8')

assert NOT_FOUND == codecs.lookup('AAA.8')

assert NOT_FOUND == codecs.lookup('AAA...8')

assert NOT_FOUND == codecs.lookup('BBB-8')

assert NOT_FOUND == codecs.lookup('BBB.8')

assert NOT_FOUND == codecs.lookup('aé€-8')
print("CodecNameNormalizationTest::test_codecs_lookup: ok")
