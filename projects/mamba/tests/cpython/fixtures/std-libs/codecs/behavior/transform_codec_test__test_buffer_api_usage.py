...
# lib = "codecs"
# dimension = "behavior"
# case = "transform_codec_test__test_buffer_api_usage"
# subject = "cpython.test_codecs.TransformCodecTest.test_buffer_api_usage"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::TransformCodecTest::test_buffer_api_usage
"""Auto-ported test: TransformCodecTest::test_buffer_api_usage (CPython 3.12 oracle)."""
...
for encoding in bytes_transform_encodings:
    ...
    assert view_decoded == data
print("TransformCodecTest::test_buffer_api_usage: ok")
