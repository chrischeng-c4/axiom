...
# lib = "codecs"
# dimension = "behavior"
# case = "utf16_test__test_partial"
# subject = "cpython.test_codecs.UTF16Test.test_partial"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF16Test::test_partial
"""Auto-ported test: UTF16Test::test_partial (CPython 3.12 oracle)."""
...
check_partial('\x00ÿĀ\uffff𐀀', ['', '', '', '\x00', '\x00', '\x00ÿ', '\x00ÿ', '\x00ÿĀ', '\x00ÿĀ', '\x00ÿĀ\uffff', '\x00ÿĀ\uffff', '\x00ÿĀ\uffff', '\x00ÿĀ\uffff', '\x00ÿĀ\uffff𐀀'])
print("UTF16Test::test_partial: ok")
