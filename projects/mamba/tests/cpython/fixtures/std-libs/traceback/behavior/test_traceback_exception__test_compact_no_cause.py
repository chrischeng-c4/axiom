...
# lib = "traceback"
# dimension = "behavior"
# case = "test_traceback_exception__test_compact_no_cause"
# subject = "cpython.test_traceback.TestTracebackException.test_compact_no_cause"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_traceback.py::TestTracebackException::test_compact_no_cause
"""Auto-ported test: TestTracebackException::test_compact_no_cause (CPython 3.12 oracle)."""
...
try:
    ...
    expected_stack = traceback.StackSummary.extract(traceback.walk_tb(exc_obj.__traceback__))

assert None == exc.__cause__

assert exc_context == exc.__context__

assert False == exc.__suppress_context__

assert expected_stack == exc.stack

assert type(exc_obj) == exc.exc_type

assert str(exc_obj) == str(exc)
print("TestTracebackException::test_compact_no_cause: ok")
