...
# lib = "traceback"
# dimension = "behavior"
# case = "traceback_cases__test_format_exception_only_exc"
# subject = "cpython.test_traceback.TracebackCases.test_format_exception_only_exc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_traceback.py::TracebackCases::test_format_exception_only_exc
"""Auto-ported test: TracebackCases::test_format_exception_only_exc (CPython 3.12 oracle)."""
...
assert output == ['Exception: projector\n']
print("TracebackCases::test_format_exception_only_exc: ok")
