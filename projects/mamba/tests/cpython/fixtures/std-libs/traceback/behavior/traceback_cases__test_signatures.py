...
# lib = "traceback"
# dimension = "behavior"
# case = "traceback_cases__test_signatures"
# subject = "cpython.test_traceback.TracebackCases.test_signatures"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_traceback.py::TracebackCases::test_signatures
"""Auto-ported test: TracebackCases::test_signatures (CPython 3.12 oracle)."""
...
assert str(inspect.signature(traceback.print_exception)) == '(exc, /, value=<implicit>, tb=<implicit>, limit=None, file=None, chain=True)'

assert str(inspect.signature(traceback.format_exception)) == '(exc, /, value=<implicit>, tb=<implicit>, limit=None, chain=True)'

assert str(inspect.signature(traceback.format_exception_only)) == '(exc, /, value=<implicit>)'
print("TracebackCases::test_signatures: ok")
