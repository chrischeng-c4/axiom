...
# lib = "traceback"
# dimension = "behavior"
# case = "traceback_cases__test_print_exception"
# subject = "cpython.test_traceback.TracebackCases.test_print_exception"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_traceback.py::TracebackCases::test_print_exception
"""Auto-ported test: TracebackCases::test_print_exception (CPython 3.12 oracle)."""
...
assert output.getvalue() == 'Exception: projector\n'
print("TracebackCases::test_print_exception: ok")
