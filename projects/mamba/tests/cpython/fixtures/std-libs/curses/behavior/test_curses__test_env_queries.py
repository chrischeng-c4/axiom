...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_env_queries"
# subject = "cpython.test_curses.TestCurses.test_env_queries"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_env_queries
"""Auto-ported test: TestCurses::test_env_queries (CPython 3.12 oracle)."""
...
assert isinstance(curses.termname(), bytes)

assert isinstance(curses.longname(), bytes)

assert isinstance(curses.baudrate(), int)

assert isinstance(curses.has_ic(), bool)

assert isinstance(curses.has_il(), bool)

assert isinstance(curses.termattrs(), int)
c = curses.killchar()
...
assert len(c) == 1
print("TestCurses::test_env_queries: ok")
