...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_escdelay"
# subject = "cpython.test_curses.TestCurses.test_escdelay"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_escdelay
"""Auto-ported test: TestCurses::test_escdelay (CPython 3.12 oracle)."""
...
assert isinstance(escdelay, int)
curses.set_escdelay(25)

assert curses.get_escdelay() == 25
curses.set_escdelay(escdelay)
print("TestCurses::test_escdelay: ok")
