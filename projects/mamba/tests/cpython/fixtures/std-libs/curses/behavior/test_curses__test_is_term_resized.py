...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_is_term_resized"
# subject = "cpython.test_curses.TestCurses.test_is_term_resized"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_is_term_resized
"""Auto-ported test: TestCurses::test_is_term_resized (CPython 3.12 oracle)."""
...
assert curses.is_term_resized(lines, cols) is False

assert curses.is_term_resized(lines - 1, cols - 1) is True
print("TestCurses::test_is_term_resized: ok")
