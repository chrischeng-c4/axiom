...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_keyname"
# subject = "cpython.test_curses.TestCurses.test_keyname"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_keyname
"""Auto-ported test: TestCurses::test_keyname (CPython 3.12 oracle)."""
...
assert curses.keyname(65) == b'A'

assert curses.keyname(13) == b'^M'

assert curses.keyname(127) == b'^?'

assert curses.keyname(0) == b'^@'
...
assert isinstance(curses.keyname(256), bytes)
print("TestCurses::test_keyname: ok")
