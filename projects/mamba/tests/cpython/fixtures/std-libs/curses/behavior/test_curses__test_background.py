...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_background"
# subject = "cpython.test_curses.TestCurses.test_background"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_background
"""Auto-ported test: TestCurses::test_background (CPython 3.12 oracle)."""
...
assert win.getbkgd() in (0, 32)
win.bkgdset('_')

assert win.getbkgd() == b'_'[0]
win.bkgdset(b'#')

assert win.getbkgd() == b'#'[0]
win.bkgdset(65)

assert win.getbkgd() == 65
win.bkgdset(0)

assert win.getbkgd() == 32
win.bkgdset('#', curses.A_REVERSE)

assert win.getbkgd() == b'#'[0] | curses.A_REVERSE

assert win.inch(0, 0) == b'L'[0]

assert win.inch(0, 5) == b' '[0]
win.bkgdset(0)
win.bkgd('_')
...
assert win.inch(0, 5) == b'_'[0]
win.bkgd('#', curses.A_REVERSE)

assert win.getbkgd() == b'#'[0] | curses.A_REVERSE

assert win.inch(0, 0) == b'L'[0] | curses.A_REVERSE

assert win.inch(0, 5) == b'#'[0] | curses.A_REVERSE
print("TestCurses::test_background: ok")
