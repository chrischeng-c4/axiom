...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_getch"
# subject = "cpython.test_curses.TestCurses.test_getch"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_getch
"""Auto-ported test: TestCurses::test_getch (CPython 3.12 oracle)."""
...
assert win.getch(3, 1) == b's'[0]

assert win.getyx() == (3, 1)

assert win.getch(3, 4) == b'p'[0]

assert win.getyx() == (3, 4)

assert win.getch() == b'a'[0]

assert win.getyx() == (3, 4)

assert win.getch() == b'm'[0]

assert win.getch() == b'\n'[0]
print("TestCurses::test_getch: ok")
