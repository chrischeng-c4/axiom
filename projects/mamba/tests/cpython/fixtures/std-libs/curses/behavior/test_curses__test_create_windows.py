...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_create_windows"
# subject = "cpython.test_curses.TestCurses.test_create_windows"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_create_windows
"""Auto-ported test: TestCurses::test_create_windows (CPython 3.12 oracle)."""
...
assert win.getbegyx() == (2, 5)

assert win.getparyx() == (-1, -1)

assert win.getmaxyx() == (10, 15)
win2 = win.subwin(3, 7)

assert win2.getbegyx() == (3, 7)

assert win2.getparyx() == (1, 2)

assert win2.getmaxyx() == (9, 13)
...
assert win2.getmaxyx() == (5, 10)
win3 = win.derwin(2, 3)

assert win3.getbegyx() == (4, 8)

assert win3.getparyx() == (2, 3)

assert win3.getmaxyx() == (8, 12)
...
assert win3.getmaxyx() == (6, 11)
win.mvwin(0, 1)

assert win.getbegyx() == (0, 1)
...
assert win3.getparyx() == (2, 1)

assert win3.getmaxyx() == (6, 11)
print("TestCurses::test_create_windows: ok")
