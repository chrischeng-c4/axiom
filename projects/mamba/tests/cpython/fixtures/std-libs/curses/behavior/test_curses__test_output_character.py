...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_output_character"
# subject = "cpython.test_curses.TestCurses.test_output_character"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_output_character
"""Auto-ported test: TestCurses::test_output_character (CPython 3.12 oracle)."""
...
try:
    stdscr.echochar('Ĕ')
    raise AssertionError('expected (UnicodeEncodeError, OverflowError)')
except (UnicodeEncodeError, OverflowError):
    pass
stdscr.echochar('A', curses.A_BOLD)

assert stdscr.is_wintouched() is False
print("TestCurses::test_output_character: ok")
