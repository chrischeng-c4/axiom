...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_userptr_segfault"
# subject = "cpython.test_curses.TestCurses.test_userptr_segfault"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_userptr_segfault
"""Auto-ported test: TestCurses::test_userptr_segfault (CPython 3.12 oracle)."""
...
panel.set_userptr(A())
panel.set_userptr(None)
print("TestCurses::test_userptr_segfault: ok")
