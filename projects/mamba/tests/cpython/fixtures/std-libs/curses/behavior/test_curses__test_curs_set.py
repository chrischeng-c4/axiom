...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_curs_set"
# subject = "cpython.test_curses.TestCurses.test_curs_set"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_curs_set
"""Auto-ported test: TestCurses::test_curs_set (CPython 3.12 oracle)."""
...
for vis, cap in [(0, 'civis'), (2, 'cvvis'), (1, 'cnorm')]:
    if curses.tigetstr(cap) is not None:
        ...
        try:
            ...
            pass
print("TestCurses::test_curs_set: ok")
