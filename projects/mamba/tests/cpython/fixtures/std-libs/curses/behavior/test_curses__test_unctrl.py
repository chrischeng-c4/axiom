...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_unctrl"
# subject = "cpython.test_curses.TestCurses.test_unctrl"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_unctrl
"""Auto-ported test: TestCurses::test_unctrl (CPython 3.12 oracle)."""
...
assert curses.unctrl(b'A') == b'A'

assert curses.unctrl('A') == b'A'

assert curses.unctrl(65) == b'A'

assert curses.unctrl(b'\n') == b'^J'

assert curses.unctrl('\n') == b'^J'

assert curses.unctrl(10) == b'^J'
...
try:
    ...
    pass
print("TestCurses::test_unctrl: ok")
