...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_enclose"
# subject = "cpython.test_curses.TestCurses.test_enclose"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_enclose
"""Auto-ported test: TestCurses::test_enclose (CPython 3.12 oracle)."""
...
assert win.enclose(2, 5) is True

assert win.enclose(1, 5) is False

assert win.enclose(2, 4) is False

assert win.enclose(6, 19) is True

assert win.enclose(7, 19) is False

assert win.enclose(6, 20) is False
print("TestCurses::test_enclose: ok")
