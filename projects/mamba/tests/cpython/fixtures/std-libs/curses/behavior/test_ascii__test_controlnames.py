...
# lib = "curses"
# dimension = "behavior"
# case = "test_ascii__test_controlnames"
# subject = "cpython.test_curses.TestAscii.test_controlnames"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestAscii::test_controlnames
"""Auto-ported test: TestAscii::test_controlnames (CPython 3.12 oracle)."""
...
for name in curses.ascii.controlnames:
    ...
    assert hasattr(curses.ascii, name)
print("TestAscii::test_controlnames: ok")
