...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_insert_delete"
# subject = "cpython.test_curses.TestCurses.test_insert_delete"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_insert_delete
"""Auto-ported test: TestCurses::test_insert_delete (CPython 3.12 oracle)."""
...
assert win.instr(0, 0) == b'Loem ipsum     '
win.delch(0, 7)

assert win.instr(0, 0) == b'Loem ipum      '
win.move(1, 5)
win.deleteln()

assert win.instr(0, 0) == b'Loem ipum      '

assert win.instr(1, 0) == b'consectetur    '

assert win.instr(2, 0) == b'adipiscing elit'

assert win.instr(3, 0) == b'sed do eiusmod '

assert win.instr(4, 0) == b'               '
win.move(1, 5)
win.insertln()
...
assert win.instr(2, 0) == b'consectetur    '
win.clear()
lorem_ipsum(win)
win.move(1, 5)
win.insdelln(2)

assert win.instr(0, 0) == b'Lorem ipsum    '

assert win.instr(1, 0) == b'               '

assert win.instr(2, 0) == b'               '

assert win.instr(3, 0) == b'dolor sit amet,'
win.clear()
lorem_ipsum(win)
win.move(1, 5)
win.insdelln(-2)
...
assert win.instr(1, 0) == b'adipiscing elit'

assert win.instr(2, 0) == b'sed do eiusmod '

assert win.instr(3, 0) == b'               '
print("TestCurses::test_insert_delete: ok")
