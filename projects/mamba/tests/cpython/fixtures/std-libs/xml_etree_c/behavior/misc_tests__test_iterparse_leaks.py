...
# lib = "xml_etree_c"
# dimension = "behavior"
# case = "misc_tests__test_iterparse_leaks"
# subject = "cpython.test_xml_etree_c.MiscTests.test_iterparse_leaks"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xml_etree_c.py::MiscTests::test_iterparse_leaks
"""Auto-ported test: MiscTests::test_iterparse_leaks (CPython 3.12 oracle)."""
...
del parser
support.gc_collect()
print("MiscTests::test_iterparse_leaks: ok")
