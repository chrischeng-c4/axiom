...
# lib = "xml_etree_c"
# dimension = "behavior"
# case = "misc_tests__test_trashcan"
# subject = "cpython.test_xml_etree_c.MiscTests.test_trashcan"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xml_etree_c.py::MiscTests::test_trashcan
"""Auto-ported test: MiscTests::test_trashcan (CPython 3.12 oracle)."""
...
del root
support.gc_collect()
print("MiscTests::test_trashcan: ok")
