...
# lib = "re"
# dimension = "behavior"
# case = "re_tests__test_other_escapes"
# subject = "cpython.test_re.ReTests.test_other_escapes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_re.py::ReTests::test_other_escapes
"""Auto-ported test: ReTests::test_other_escapes (CPython 3.12 oracle)."""
...
assert re.match('[a\\-c]', '-').group() == '-'

assert re.match('[a\\-c]', 'b') is None

assert re.match('[\\^a]+', 'a^').group() == 'a^'

assert re.match('[\\^a]+', 'b') is None
re.purge()
...
for c in 'ceghijklmopqyzABCEFGHIJKLMNOPQRTVXYZ':
    ...
    try:
        ...
        pass
print("ReTests::test_other_escapes: ok")
