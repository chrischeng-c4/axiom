...
# lib = "re"
# dimension = "behavior"
# case = "re_tests__test_backref_group_name_in_exception"
# subject = "cpython.test_re.ReTests.test_backref_group_name_in_exception"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_re.py::ReTests::test_backref_group_name_in_exception
"""Auto-ported test: ReTests::test_backref_group_name_in_exception (CPython 3.12 oracle)."""
...
checkPatternError('(?P=<foo>)', "bad character in group name '<foo>'", 4)
print("ReTests::test_backref_group_name_in_exception: ok")
