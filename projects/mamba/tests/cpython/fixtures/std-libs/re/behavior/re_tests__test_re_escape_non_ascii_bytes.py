...
# lib = "re"
# dimension = "behavior"
# case = "re_tests__test_re_escape_non_ascii_bytes"
# subject = "cpython.test_re.ReTests.test_re_escape_non_ascii_bytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_re.py::ReTests::test_re_escape_non_ascii_bytes
"""Auto-ported test: ReTests::test_re_escape_non_ascii_bytes (CPython 3.12 oracle)."""
...
assert len(res) == 2
print("ReTests::test_re_escape_non_ascii_bytes: ok")
