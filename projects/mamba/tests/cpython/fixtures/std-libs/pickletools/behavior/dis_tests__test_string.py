...
# lib = "pickletools"
# dimension = "behavior"
# case = "dis_tests__test_string"
# subject = "cpython.test_pickletools.DisTests.test_string"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pickletools.py::DisTests::test_string
"""Auto-ported test: DisTests::test_string (CPython 3.12 oracle)."""
...
check_dis(b'S"abc"\n.', "    0: S    STRING     'abc'\n    7: .    STOP\nhighest protocol among opcodes = 0\n")
check_dis(b"S'\xc3\xb5'\n.", "    0: S    STRING     '\\xc3\\xb5'\n    6: .    STOP\nhighest protocol among opcodes = 0\n")
print("DisTests::test_string: ok")
