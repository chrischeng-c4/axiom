...
# lib = "pickletools"
# dimension = "behavior"
# case = "dis_tests__test_global"
# subject = "cpython.test_pickletools.DisTests.test_global"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pickletools.py::DisTests::test_global
"""Auto-ported test: DisTests::test_global (CPython 3.12 oracle)."""
...
check_dis(b'cm\xc3\xb6dule\nn\xc3\xa4me\n.', "    0: c    GLOBAL     'mödule näme'\n   15: .    STOP\nhighest protocol among opcodes = 0\n")
print("DisTests::test_global: ok")
