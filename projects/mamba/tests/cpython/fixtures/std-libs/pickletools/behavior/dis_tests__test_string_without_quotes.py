...
# lib = "pickletools"
# dimension = "behavior"
# case = "dis_tests__test_string_without_quotes"
# subject = "cpython.test_pickletools.DisTests.test_string_without_quotes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pickletools.py::DisTests::test_string_without_quotes
"""Auto-ported test: DisTests::test_string_without_quotes (CPython 3.12 oracle)."""
...
def check_dis_error(data, expected, expected_error, **kwargs):
    ...
    assert out.getvalue() == expected
check_dis_error(b"Sabc'\n.", '', 'no string quotes around b"abc\'"')
check_dis_error(b'Sabc"\n.', '', 'no string quotes around b\'abc"\'')
check_dis_error(b"S'abc\n.", '', 'strinq quote b"\'" not found at both ends of b"\'abc"')
check_dis_error(b'S"abc\n.', '', 'strinq quote b\'"\' not found at both ends of b\'"abc\'')
check_dis_error(b'S\'abc"\n.', '', 'strinq quote b"\'" not found at both ends of b\'\\\\\'abc"\'')
check_dis_error(b'S"abc\'\n.', '', 'strinq quote b\'"\' not found at both ends of b\'"abc\\\\\'\'')
print("DisTests::test_string_without_quotes: ok")
