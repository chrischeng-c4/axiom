...
# lib = "iterlen"
# dimension = "behavior"
# case = "test_deque__test_invariant"
# subject = "cpython.test_iterlen.TestDeque.test_invariant"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_iterlen.py::TestDeque::test_invariant
"""Auto-ported test: TestDeque::test_invariant (CPython 3.12 oracle)."""
...
assert length_hint(it) == 0
print("TestDeque::test_invariant: ok")
