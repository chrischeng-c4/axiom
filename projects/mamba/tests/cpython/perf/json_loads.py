...
# dimension = "perf"
# case = "json_loads"
# subject = "pyperformance json_loads"
# kind = "bench"
# xfail = "mamba must run the pyperformance json_loads workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_json_loads/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance json_loads workload faster than CPython on CPU+RSS
