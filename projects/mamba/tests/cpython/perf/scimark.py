...
# dimension = "perf"
# case = "scimark"
# subject = "pyperformance scimark"
# kind = "bench"
# xfail = "mamba must run the pyperformance scimark workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_scimark/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance scimark workload faster than CPython on CPU+RSS
