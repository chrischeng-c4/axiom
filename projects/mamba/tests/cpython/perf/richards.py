...
# dimension = "perf"
# case = "richards"
# subject = "pyperformance richards"
# kind = "bench"
# xfail = "mamba must run the pyperformance richards workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_richards/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance richards workload faster than CPython on CPU+RSS
