...
# [tool.mamba]
# bucket = "perf"
# lib = "async_generators"
# dimension = "perf"
# case = "async_generators"
# subject = "pyperformance async_generators"
# kind = "bench"
# xfail = "mamba must run the pyperformance async_generators workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_async_generators/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance async_generators workload faster than CPython on CPU+RSS
