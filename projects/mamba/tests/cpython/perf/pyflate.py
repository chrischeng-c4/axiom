...
# dimension = "perf"
# case = "pyflate"
# subject = "pyperformance pyflate"
# kind = "bench"
# xfail = "mamba must run the pyperformance pyflate workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_pyflate/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance pyflate workload faster than CPython on CPU+RSS
