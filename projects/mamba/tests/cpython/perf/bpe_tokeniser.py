...
# dimension = "perf"
# case = "bpe_tokeniser"
# subject = "pyperformance bpe_tokeniser"
# kind = "bench"
# xfail = "mamba must run the pyperformance bpe_tokeniser workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_bpe_tokeniser/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance bpe_tokeniser workload faster than CPython on CPU+RSS
