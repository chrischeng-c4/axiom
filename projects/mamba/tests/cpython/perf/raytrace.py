...
# dimension = "perf"
# case = "raytrace"
# subject = "pyperformance raytrace"
# kind = "bench"
# xfail = "mamba must run the pyperformance raytrace workload faster than CPython on CPU+RSS"
# mem_carveout = ""
# source = "pyperformance/data-files/benchmarks/bm_raytrace/run_benchmark.py"
# status = "filled"
# ///
# mamba-xfail: mamba must run the pyperformance raytrace workload faster than CPython on CPU+RSS
