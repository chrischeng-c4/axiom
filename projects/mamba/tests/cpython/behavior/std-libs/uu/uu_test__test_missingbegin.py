...
# lib = "uu"
# dimension = "behavior"
# case = "uu_test__test_missingbegin"
# subject = "cpython.test_uu.UUTest.test_missingbegin"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_uu.py::UUTest::test_missingbegin
"""Auto-ported test: UUTest::test_missingbegin (CPython 3.12 oracle)."""
...
try:
    ...
    assert str(e) == 'No valid begin line found in input file'
print("UUTest::test_missingbegin: ok")
