...
# lib = "marshal"
# dimension = "behavior"
# case = "container_test_case__test_list"
# subject = "cpython.test_marshal.ContainerTestCase.test_list"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::ContainerTestCase::test_list
"""Auto-ported test: ContainerTestCase::test_list (CPython 3.12 oracle)."""
...
def helper(sample, *extra):
    ...
    try:
        ...
        os_helper.unlink(os_helper.TESTFN)
helper(list(d.items()))
print("ContainerTestCase::test_list: ok")
