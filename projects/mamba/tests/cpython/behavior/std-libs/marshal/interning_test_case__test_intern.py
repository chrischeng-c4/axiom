...
# lib = "marshal"
# dimension = "behavior"
# case = "interning_test_case__test_intern"
# subject = "cpython.test_marshal.InterningTestCase.testIntern"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::InterningTestCase::testIntern
"""Auto-ported test: InterningTestCase::testIntern (CPython 3.12 oracle)."""
...
assert id(s2) == id(s)
print("InterningTestCase::testIntern: ok")
