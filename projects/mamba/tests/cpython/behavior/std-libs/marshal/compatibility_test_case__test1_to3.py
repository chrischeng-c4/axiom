...
# lib = "marshal"
# dimension = "behavior"
# case = "compatibility_test_case__test1_to3"
# subject = "cpython.test_marshal.CompatibilityTestCase.test1To3"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::CompatibilityTestCase::test1To3
"""Auto-ported test: CompatibilityTestCase::test1To3 (CPython 3.12 oracle)."""
...
def _test(version):
    ...
    marshal.loads(data)
_test(1)
print("CompatibilityTestCase::test1To3: ok")
