...
# lib = "marshal"
# dimension = "behavior"
# case = "string_test_case__test_bytes"
# subject = "cpython.test_marshal.StringTestCase.test_bytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::StringTestCase::test_bytes
"""Auto-ported test: StringTestCase::test_bytes (CPython 3.12 oracle)."""
...
for s in [b'', b'Andr\xe8 Previn', b'abc', b' ' * 10000]:
    helper(s)
print("StringTestCase::test_bytes: ok")
