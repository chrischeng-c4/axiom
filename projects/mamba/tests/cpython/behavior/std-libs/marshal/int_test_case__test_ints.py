...
# lib = "marshal"
# dimension = "behavior"
# case = "int_test_case__test_ints"
# subject = "cpython.test_marshal.IntTestCase.test_ints"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::IntTestCase::test_ints
"""Auto-ported test: IntTestCase::test_ints (CPython 3.12 oracle)."""
...
while n:
    for expected in (-n, n):
        helper(expected)
    n = n >> 1
print("IntTestCase::test_ints: ok")
