...
# lib = "marshal"
# dimension = "behavior"
# case = "bugs_test_case__test_invalid_longs"
# subject = "cpython.test_marshal.BugsTestCase.test_invalid_longs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::BugsTestCase::test_invalid_longs
"""Auto-ported test: BugsTestCase::test_invalid_longs (CPython 3.12 oracle)."""
...
try:
    marshal.loads(invalid_string)
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("BugsTestCase::test_invalid_longs: ok")
