...
# lib = "marshal"
# dimension = "behavior"
# case = "interning_test_case__test_no_intern"
# subject = "cpython.test_marshal.InterningTestCase.testNoIntern"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::InterningTestCase::testNoIntern
"""Auto-ported test: InterningTestCase::testNoIntern (CPython 3.12 oracle)."""
...
def helper(sample, *extra):
    ...
    try:
        ...
        os_helper.unlink(os_helper.TESTFN)
s = marshal.loads(marshal.dumps(strobj, 2))

assert s == strobj

assert id(s) != id(strobj)
s2 = sys.intern(s)

assert id(s2) != id(s)
print("InterningTestCase::testNoIntern: ok")
