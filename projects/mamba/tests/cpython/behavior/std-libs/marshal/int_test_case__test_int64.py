...
# lib = "marshal"
# dimension = "behavior"
# case = "int_test_case__test_int64"
# subject = "cpython.test_marshal.IntTestCase.test_int64"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::IntTestCase::test_int64
"""Auto-ported test: IntTestCase::test_int64 (CPython 3.12 oracle)."""
...
assert got == 1167088121787636990
got = marshal.loads(b'I\x01#Eg\x89\xab\xcd\xef')

assert got == -1167088121787636991
got = marshal.loads(b'I\x08\x19*;L]n\x7f')

assert got == 9182379272246532360
got = marshal.loads(b'I\xf7\xe6\xd5\xc4\xb3\xa2\x91\x80')

assert got == -9182379272246532361
print("IntTestCase::test_int64: ok")
