...
# lib = "marshal"
# dimension = "behavior"
# case = "bugs_test_case__test_fuzz"
# subject = "cpython.test_marshal.BugsTestCase.test_fuzz"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::BugsTestCase::test_fuzz
"""Auto-ported test: BugsTestCase::test_fuzz (CPython 3.12 oracle)."""
...
for i in range(256):
    ...
    try:
        ...
        pass
print("BugsTestCase::test_fuzz: ok")
