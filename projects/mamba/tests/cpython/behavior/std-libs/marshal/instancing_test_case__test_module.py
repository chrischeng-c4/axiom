...
# lib = "marshal"
# dimension = "behavior"
# case = "instancing_test_case__test_module"
# subject = "cpython.test_marshal.InstancingTestCase.testModule"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::InstancingTestCase::testModule
"""Auto-ported test: InstancingTestCase::testModule (CPython 3.12 oracle)."""
...
helper(code)
helper3(code)
print("InstancingTestCase::testModule: ok")
