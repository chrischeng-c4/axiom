...
# lib = "marshal"
# dimension = "behavior"
# case = "container_test_case__test_sets"
# subject = "cpython.test_marshal.ContainerTestCase.test_sets"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::ContainerTestCase::test_sets
"""Auto-ported test: ContainerTestCase::test_sets (CPython 3.12 oracle)."""
...
for constructor in (set, frozenset):
    helper(constructor(d.keys()))
print("ContainerTestCase::test_sets: ok")
