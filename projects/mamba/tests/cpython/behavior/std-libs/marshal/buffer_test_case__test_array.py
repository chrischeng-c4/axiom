...
# lib = "marshal"
# dimension = "behavior"
# case = "buffer_test_case__test_array"
# subject = "cpython.test_marshal.BufferTestCase.test_array"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::BufferTestCase::test_array
"""Auto-ported test: BufferTestCase::test_array (CPython 3.12 oracle)."""
...
assert new == b'abc'
print("BufferTestCase::test_array: ok")
