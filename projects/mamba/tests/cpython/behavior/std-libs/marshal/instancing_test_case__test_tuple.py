...
# lib = "marshal"
# dimension = "behavior"
# case = "instancing_test_case__test_tuple"
# subject = "cpython.test_marshal.InstancingTestCase.testTuple"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::InstancingTestCase::testTuple
"""Auto-ported test: InstancingTestCase::testTuple (CPython 3.12 oracle)."""
...
for obj in keys:
    ...
    helper(tupleobj)
    helper3(tupleobj)
print("InstancingTestCase::testTuple: ok")
