...
# lib = "marshal"
# dimension = "behavior"
# case = "instancing_test_case__test_recursion"
# subject = "cpython.test_marshal.InstancingTestCase.testRecursion"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_marshal.py::InstancingTestCase::testRecursion
"""Auto-ported test: InstancingTestCase::testRecursion (CPython 3.12 oracle)."""
...
d['self'] = d
helper3(d, recursive=True)
l = [obj, obj]
l.append(l)
helper3(l, recursive=True)
print("InstancingTestCase::testRecursion: ok")
