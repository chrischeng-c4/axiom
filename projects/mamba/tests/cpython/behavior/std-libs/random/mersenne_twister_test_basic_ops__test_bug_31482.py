...
# lib = "random"
# dimension = "behavior"
# case = "mersenne_twister_test_basic_ops__test_bug_31482"
# subject = "cpython.test_random.MersenneTwister_TestBasicOps.test_bug_31482"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_random.py::MersenneTwister_TestBasicOps::test_bug_31482
"""Auto-ported test: MersenneTwister_TestBasicOps::test_bug_31482 (CPython 3.12 oracle)."""
...
assert [gen.random().hex() for i in range(4)] == ['0x1.52c2fde444d23p-1', '0x1.875174f0daea4p-2', '0x1.9e9b2c50e5cd2p-1', '0x1.fa57768bd321cp-2']
print("MersenneTwister_TestBasicOps::test_bug_31482: ok")
