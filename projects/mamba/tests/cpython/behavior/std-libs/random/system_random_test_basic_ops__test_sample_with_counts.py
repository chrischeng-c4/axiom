...
# lib = "random"
# dimension = "behavior"
# case = "system_random_test_basic_ops__test_sample_with_counts"
# subject = "cpython.test_random.SystemRandom_TestBasicOps.test_sample_with_counts"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_random.py::SystemRandom_TestBasicOps::test_sample_with_counts
"""Auto-ported test: SystemRandom_TestBasicOps::test_sample_with_counts (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("SystemRandom_TestBasicOps::test_sample_with_counts: ok")
