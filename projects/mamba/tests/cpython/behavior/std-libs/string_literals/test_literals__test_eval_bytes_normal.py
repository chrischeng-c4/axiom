...
# lib = "string_literals"
# dimension = "behavior"
# case = "test_literals__test_eval_bytes_normal"
# subject = "cpython.test_string_literals.TestLiterals.test_eval_bytes_normal"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_string_literals.py::TestLiterals::test_eval_bytes_normal
"""Auto-ported test: TestLiterals::test_eval_bytes_normal (CPython 3.12 oracle)."""
...
assert eval(" b'\\x01' ") == byte(1)

assert eval(" b'\x01' ") == byte(1)

assert eval(" b'\\x81' ") == byte(129)
...
try:
    ...
    pass
print("TestLiterals::test_eval_bytes_normal: ok")
