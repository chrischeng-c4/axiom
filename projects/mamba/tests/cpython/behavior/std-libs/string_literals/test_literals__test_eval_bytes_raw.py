...
# lib = "string_literals"
# dimension = "behavior"
# case = "test_literals__test_eval_bytes_raw"
# subject = "cpython.test_string_literals.TestLiterals.test_eval_bytes_raw"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_string_literals.py::TestLiterals::test_eval_bytes_raw
"""Auto-ported test: TestLiterals::test_eval_bytes_raw (CPython 3.12 oracle)."""
...
assert eval(" br'x' ") == b'x'

assert eval(" rb'x' ") == b'x'

assert eval(" br'\\x01' ") == b'\\' + b'x01'

assert eval(" rb'\\x01' ") == b'\\' + b'x01'

assert eval(" br'\x01' ") == byte(1)

assert eval(" rb'\x01' ") == byte(1)

assert eval(" br'\\x81' ") == b'\\' + b'x81'

assert eval(" rb'\\x81' ") == b'\\' + b'x81'
...
assert eval(" br'\\u1881' ") == b'\\' + b'u1881'

assert eval(" rb'\\u1881' ") == b'\\' + b'u1881'
...
assert eval(" br'\\U0001d120' ") == b'\\' + b'U0001d120'

assert eval(" rb'\\U0001d120' ") == b'\\' + b'U0001d120'
...
try:
    ...
    pass
print("TestLiterals::test_eval_bytes_raw: ok")
