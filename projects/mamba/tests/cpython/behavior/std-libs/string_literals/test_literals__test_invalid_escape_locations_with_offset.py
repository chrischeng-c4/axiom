...
# lib = "string_literals"
# dimension = "behavior"
# case = "test_literals__test_invalid_escape_locations_with_offset"
# subject = "cpython.test_string_literals.TestLiterals.test_invalid_escape_locations_with_offset"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_string_literals.py::TestLiterals::test_invalid_escape_locations_with_offset
"""Auto-ported test: TestLiterals::test_invalid_escape_locations_with_offset (CPython 3.12 oracle)."""
...
assert exc.msg == "invalid escape sequence '\\ '"

assert exc.filename == '<string>'

assert exc.lineno == 1

assert exc.offset == 30
with warnings.catch_warnings(record=True) as w:
    warnings.simplefilter('error', category=SyntaxWarning)
    try:
...
print("TestLiterals::test_invalid_escape_locations_with_offset: ok")
