...
# lib = "string_literals"
# dimension = "behavior"
# case = "test_literals__test_template"
# subject = "cpython.test_string_literals.TestLiterals.test_template"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_string_literals.py::TestLiterals::test_template
"""Auto-ported test: TestLiterals::test_template (CPython 3.12 oracle)."""
...
for c in TEMPLATE:
    assert c == '\n' or ' ' <= c <= '~', repr(c)
print("TestLiterals::test_template: ok")
