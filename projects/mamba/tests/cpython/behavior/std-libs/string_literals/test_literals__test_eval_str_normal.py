...
# lib = "string_literals"
# dimension = "behavior"
# case = "test_literals__test_eval_str_normal"
# subject = "cpython.test_string_literals.TestLiterals.test_eval_str_normal"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_string_literals.py::TestLiterals::test_eval_str_normal
"""Auto-ported test: TestLiterals::test_eval_str_normal (CPython 3.12 oracle)."""
...
assert eval(" '\\x01' ") == chr(1)

assert eval(" '\x01' ") == chr(1)

assert eval(" '\\x81' ") == chr(129)

assert eval(" '\x81' ") == chr(129)

assert eval(" '\\u1881' ") == chr(6273)

assert eval(" 'ᢁ' ") == chr(6273)

assert eval(" '\\U0001d120' ") == chr(119072)

assert eval(" '𝄠' ") == chr(119072)
print("TestLiterals::test_eval_str_normal: ok")
