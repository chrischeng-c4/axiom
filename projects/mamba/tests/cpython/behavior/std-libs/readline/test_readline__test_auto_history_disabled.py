...
# lib = "readline"
# dimension = "behavior"
# case = "test_readline__test_auto_history_disabled"
# subject = "cpython.test_readline.TestReadline.test_auto_history_disabled"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_readline.py::TestReadline::test_auto_history_disabled
"""Auto-ported test: TestReadline::test_auto_history_disabled (CPython 3.12 oracle)."""
...
output = run_pty(auto_history_script.format(False))

assert b'History length: 0' in output
print("TestReadline::test_auto_history_disabled: ok")
