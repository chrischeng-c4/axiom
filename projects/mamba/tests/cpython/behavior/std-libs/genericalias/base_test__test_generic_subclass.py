...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_generic_subclass"
# subject = "cpython.test_genericalias.BaseTest.test_generic_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_generic_subclass
"""Auto-ported test: BaseTest::test_generic_subclass (CPython 3.12 oracle)."""
...
assert t.__origin__ is MyList

assert t.__args__ == (int,)

assert t.__parameters__ == ()
print("BaseTest::test_generic_subclass: ok")
