...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_pickle"
# subject = "cpython.test_genericalias.BaseTest.test_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_pickle
"""Auto-ported test: BaseTest::test_pickle (CPython 3.12 oracle)."""
...
for alias in aliases:
    for proto in range(pickle.HIGHEST_PROTOCOL + 1):
        ...
        assert loaded.__origin__ == alias.__origin__

        assert loaded.__args__ == alias.__args__

        assert loaded.__parameters__ == alias.__parameters__

        assert type(loaded) == type(alias)
print("BaseTest::test_pickle: ok")
