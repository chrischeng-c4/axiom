...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_class_methods"
# subject = "cpython.test_genericalias.BaseTest.test_class_methods"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_class_methods
"""Auto-ported test: BaseTest::test_class_methods (CPython 3.12 oracle)."""
...
assert dict.fromkeys(range(2)) == {0: None, 1: None}

assert t.fromkeys(range(2)) == {0: None, 1: None}
print("BaseTest::test_class_methods: ok")
