...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_unpack"
# subject = "cpython.test_genericalias.BaseTest.test_unpack"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_unpack
"""Auto-ported test: BaseTest::test_unpack (CPython 3.12 oracle)."""
...
assert alias.__unpacked__ is False
unpacked = (*alias,)[0]

assert unpacked.__unpacked__ is True
print("BaseTest::test_unpack: ok")
