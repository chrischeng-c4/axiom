...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_subclassing"
# subject = "cpython.test_genericalias.BaseTest.test_subclassing"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_subclassing
"""Auto-ported test: BaseTest::test_subclassing (CPython 3.12 oracle)."""
...
assert C.__bases__ == (list,)

assert C.__class__ == type
print("BaseTest::test_subclassing: ok")
