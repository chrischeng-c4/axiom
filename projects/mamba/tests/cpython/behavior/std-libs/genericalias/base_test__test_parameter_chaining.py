...
# lib = "genericalias"
# dimension = "behavior"
# case = "base_test__test_parameter_chaining"
# subject = "cpython.test_genericalias.BaseTest.test_parameter_chaining"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_genericalias.py::BaseTest::test_parameter_chaining
"""Auto-ported test: BaseTest::test_parameter_chaining (CPython 3.12 oracle)."""
...
assert dict[str, T][int] == dict[str, int]

assert dict[T, int][str] == dict[str, int]

assert dict[K, V][str, int] == dict[str, int]

assert dict[T, T][int] == dict[int, int]

assert list[list[T]][int] == list[list[int]]

assert list[dict[T, int]][str] == list[dict[str, int]]

assert list[dict[str, T]][int] == list[dict[str, int]]

assert list[dict[K, V]][str, int] == list[dict[str, int]]
...
assert list[Union[K, V]][str, int] == list[Union[str, int]]

assert list[Callable[[K, V], K]][str, int] == list[Callable[[str, int], str]]
...
try:
    ...
    pass
print("BaseTest::test_parameter_chaining: ok")
