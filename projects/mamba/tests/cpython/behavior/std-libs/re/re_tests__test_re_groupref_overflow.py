...
# lib = "re"
# dimension = "behavior"
# case = "re_tests__test_re_groupref_overflow"
# subject = "cpython.test_re.ReTests.test_re_groupref_overflow"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_re.py::ReTests::test_re_groupref_overflow
"""Auto-ported test: ReTests::test_re_groupref_overflow (CPython 3.12 oracle)."""
...
checkTemplateError('()', '\\g<%s>' % MAXGROUPS, 'xx', 'invalid group reference %d' % MAXGROUPS, 3)
checkPatternError('(?P<a>)(?(%d))' % MAXGROUPS, 'invalid group reference %d' % MAXGROUPS, 10)
print("ReTests::test_re_groupref_overflow: ok")
