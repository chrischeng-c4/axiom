...
# lib = "re"
# dimension = "behavior"
# case = "re_tests__test_re_groupref"
# subject = "cpython.test_re.ReTests.test_re_groupref"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_re.py::ReTests::test_re_groupref
"""Auto-ported test: ReTests::test_re_groupref (CPython 3.12 oracle)."""
...
assert re.match('^(?:(a)|c)(\\1)$', 'aa').groups() == ('a', 'a')

assert re.match('^(?:(a)|c)(\\1)?$', 'c').groups() == (None, None)
checkPatternError('(abc\\1)', 'cannot refer to an open group', 4)
print("ReTests::test_re_groupref: ok")
