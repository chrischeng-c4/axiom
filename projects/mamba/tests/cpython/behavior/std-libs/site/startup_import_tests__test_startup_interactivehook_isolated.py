...
# lib = "site"
# dimension = "behavior"
# case = "startup_import_tests__test_startup_interactivehook_isolated"
# subject = "cpython.test_site.StartupImportTests.test_startup_interactivehook_isolated"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_site.py::StartupImportTests::test_startup_interactivehook_isolated
"""Auto-ported test: StartupImportTests::test_startup_interactivehook_isolated (CPython 3.12 oracle)."""
...
assert not r
print("StartupImportTests::test_startup_interactivehook_isolated: ok")
