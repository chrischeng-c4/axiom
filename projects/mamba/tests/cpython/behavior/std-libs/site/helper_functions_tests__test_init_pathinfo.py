...
# lib = "site"
# dimension = "behavior"
# case = "helper_functions_tests__test_init_pathinfo"
# subject = "cpython.test_site.HelperFunctionsTests.test_init_pathinfo"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_site.py::HelperFunctionsTests::test_init_pathinfo
"""Auto-ported test: HelperFunctionsTests::test_init_pathinfo (CPython 3.12 oracle)."""
...
for entry in [site.makepath(path)[1] for path in sys.path if path and os.path.exists(path)]:
    ...
    assert entry in dir_set
print("HelperFunctionsTests::test_init_pathinfo: ok")
