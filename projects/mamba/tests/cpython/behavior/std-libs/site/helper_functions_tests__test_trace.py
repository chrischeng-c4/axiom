...
# lib = "site"
# dimension = "behavior"
# case = "helper_functions_tests__test_trace"
# subject = "cpython.test_site.HelperFunctionsTests.test_trace"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_site.py::HelperFunctionsTests::test_trace
"""Auto-ported test: HelperFunctionsTests::test_trace (CPython 3.12 oracle)."""
...
for verbose, out in ((True, message + '\n'), (False, '')):
    with mock.patch('sys.flags', mock.Mock(verbose=verbose)), mock.patch('sys.stderr', io.StringIO()):
        ...
        assert sys.stderr.getvalue() == out
print("HelperFunctionsTests::test_trace: ok")
