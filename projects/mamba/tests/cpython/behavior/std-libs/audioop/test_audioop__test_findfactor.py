...
# lib = "audioop"
# dimension = "behavior"
# case = "test_audioop__test_findfactor"
# subject = "cpython.test_audioop.TestAudioop.test_findfactor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audioop.py::TestAudioop::test_findfactor
"""Auto-ported test: TestAudioop::test_findfactor (CPython 3.12 oracle)."""
...
assert audioop.findfactor(datas[2], datas[2]) == 1.0

assert audioop.findfactor(bytearray(datas[2]), bytearray(datas[2])) == 1.0

assert audioop.findfactor(memoryview(datas[2]), memoryview(datas[2])) == 1.0

assert audioop.findfactor(b'\x00' * len(datas[2]), datas[2]) == 0.0
print("TestAudioop::test_findfactor: ok")
