...
# lib = "tracemalloc"
# dimension = "behavior"
# case = "test_traceback__test_repr"
# subject = "cpython.test_tracemalloc.TestTraceback.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tracemalloc.py::TestTraceback::test_repr
"""Auto-ported test: TestTraceback::test_repr (CPython 3.12 oracle)."""
...
assert get_repr(()) == '<Traceback ()>'

assert get_repr((), 0) == '<Traceback () total_nframe=0>'
frames = (('f1', 1), ('f2', 2))
exp_repr_frames = "(<Frame filename='f2' lineno=2>, <Frame filename='f1' lineno=1>)"

assert get_repr(frames) == f'<Traceback {exp_repr_frames}>'

assert get_repr(frames, 2) == f'<Traceback {exp_repr_frames} total_nframe=2>'
print("TestTraceback::test_repr: ok")
