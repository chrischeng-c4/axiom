...
# lib = "tracemalloc"
# dimension = "behavior"
# case = "test_snapshot__test_slices"
# subject = "cpython.test_tracemalloc.TestSnapshot.test_slices"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tracemalloc.py::TestSnapshot::test_slices
"""Auto-ported test: TestSnapshot::test_slices (CPython 3.12 oracle)."""
...
assert snapshot.traces[:2] == (snapshot.traces[0], snapshot.traces[1])
traceback = snapshot.traces[0].traceback

assert traceback[:2] == (traceback[0], traceback[1])
print("TestSnapshot::test_slices: ok")
