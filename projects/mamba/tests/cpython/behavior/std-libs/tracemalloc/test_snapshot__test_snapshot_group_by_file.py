...
# lib = "tracemalloc"
# dimension = "behavior"
# case = "test_snapshot__test_snapshot_group_by_file"
# subject = "cpython.test_tracemalloc.TestSnapshot.test_snapshot_group_by_file"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tracemalloc.py::TestSnapshot::test_snapshot_group_by_file
"""Auto-ported test: TestSnapshot::test_snapshot_group_by_file (CPython 3.12 oracle)."""
...
assert stats1 == [tracemalloc.Statistic(tb_b, 66, 1), tracemalloc.Statistic(tb_a, 32, 4), tracemalloc.Statistic(tb_0, 7, 1)]
stats2 = snapshot2.statistics('filename')

assert stats2 == [tracemalloc.Statistic(tb_a, 5032, 5), tracemalloc.Statistic(tb_c, 400, 1)]
diff = snapshot2.compare_to(snapshot, 'filename')

assert diff == [tracemalloc.StatisticDiff(tb_a, 5032, 5000, 5, 1), tracemalloc.StatisticDiff(tb_c, 400, 400, 1, 1), tracemalloc.StatisticDiff(tb_b, 0, -66, 0, -1), tracemalloc.StatisticDiff(tb_0, 0, -7, 0, -1)]
print("TestSnapshot::test_snapshot_group_by_file: ok")
