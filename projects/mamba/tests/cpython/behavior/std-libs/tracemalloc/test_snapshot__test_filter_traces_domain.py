...
# lib = "tracemalloc"
# dimension = "behavior"
# case = "test_snapshot__test_filter_traces_domain"
# subject = "cpython.test_tracemalloc.TestSnapshot.test_filter_traces_domain"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tracemalloc.py::TestSnapshot::test_filter_traces_domain
"""Auto-ported test: TestSnapshot::test_filter_traces_domain (CPython 3.12 oracle)."""
...
assert snapshot3.traces._traces == [(0, 10, (('a.py', 2), ('b.py', 4)), 3), (0, 10, (('a.py', 2), ('b.py', 4)), 3), (0, 10, (('a.py', 2), ('b.py', 4)), 3), (2, 66, (('b.py', 1),), 1), (3, 7, (('<unknown>', 0),), 1)]
snapshot3 = snapshot.filter_traces((filter1,))

assert snapshot3.traces._traces == [(0, 10, (('a.py', 2), ('b.py', 4)), 3), (0, 10, (('a.py', 2), ('b.py', 4)), 3), (0, 10, (('a.py', 2), ('b.py', 4)), 3), (2, 66, (('b.py', 1),), 1), (3, 7, (('<unknown>', 0),), 1)]
print("TestSnapshot::test_filter_traces_domain: ok")
