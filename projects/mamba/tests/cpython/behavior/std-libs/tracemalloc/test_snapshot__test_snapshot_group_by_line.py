...
# lib = "tracemalloc"
# dimension = "behavior"
# case = "test_snapshot__test_snapshot_group_by_line"
# subject = "cpython.test_tracemalloc.TestSnapshot.test_snapshot_group_by_line"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tracemalloc.py::TestSnapshot::test_snapshot_group_by_line
"""Auto-ported test: TestSnapshot::test_snapshot_group_by_line (CPython 3.12 oracle)."""
...
assert stats1 == [tracemalloc.Statistic(tb_b_1, 66, 1), tracemalloc.Statistic(tb_a_2, 30, 3), tracemalloc.Statistic(tb_0, 7, 1), tracemalloc.Statistic(tb_a_5, 2, 1)]
stats2 = snapshot2.statistics('lineno')

assert stats2 == [tracemalloc.Statistic(tb_a_5, 5002, 2), tracemalloc.Statistic(tb_c_578, 400, 1), tracemalloc.Statistic(tb_a_2, 30, 3)]
statistics = snapshot2.compare_to(snapshot, 'lineno')

assert statistics == [tracemalloc.StatisticDiff(tb_a_5, 5002, 5000, 2, 1), tracemalloc.StatisticDiff(tb_c_578, 400, 400, 1, 1), tracemalloc.StatisticDiff(tb_b_1, 0, -66, 0, -1), tracemalloc.StatisticDiff(tb_0, 0, -7, 0, -1), tracemalloc.StatisticDiff(tb_a_2, 30, 0, 3, 0)]
print("TestSnapshot::test_snapshot_group_by_line: ok")
