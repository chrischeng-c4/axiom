...
# lib = "tracemalloc"
# dimension = "behavior"
# case = "test_command_line__test_env_limit"
# subject = "cpython.test_tracemalloc.TestCommandLine.test_env_limit"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tracemalloc.py::TestCommandLine::test_env_limit
"""Auto-ported test: TestCommandLine::test_env_limit (CPython 3.12 oracle)."""
...
assert stdout == b'10'
print("TestCommandLine::test_env_limit: ok")
