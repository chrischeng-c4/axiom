...
# lib = "cgi"
# dimension = "behavior"
# case = "cgi_tests__test_fieldstorage_readline"
# subject = "cpython.test_cgi.CgiTests.test_fieldstorage_readline"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cgi.py::CgiTests::test_fieldstorage_readline
"""Auto-ported test: CgiTests::test_fieldstorage_readline (CPython 3.12 oracle)."""
...
def testQSAndFormData():
    ...
    assert self__qs_result == v

def testQSAndFormDataFile():
    data = '---123\nContent-Disposition: form-data; name="key2"\n\nvalue2y\n---123\nContent-Disposition: form-data; name="key3"\n\nvalue3\n---123\nContent-Disposition: form-data; name="key4"\n\nvalue4\n---123\nContent-Disposition: form-data; name="upload"; filename="fake.txt"\nContent-Type: text/plain\n\nthis is the content of the fake file\n\n---123--\n'
    environ = {'CONTENT_LENGTH': str(len(data)), 'CONTENT_TYPE': 'multipart/form-data; boundary=-123', 'QUERY_STRING': 'key1=value1&key2=value2x', 'REQUEST_METHOD': 'POST'}
    result = self__qs_result.copy()
...
assert f.numcalls > 2
f.close()
print("CgiTests::test_fieldstorage_readline: ok")
