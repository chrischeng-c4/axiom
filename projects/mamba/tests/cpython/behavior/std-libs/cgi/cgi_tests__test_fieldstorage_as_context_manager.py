...
# lib = "cgi"
# dimension = "behavior"
# case = "cgi_tests__test_fieldstorage_as_context_manager"
# subject = "cpython.test_cgi.CgiTests.test_fieldstorage_as_context_manager"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cgi.py::CgiTests::test_fieldstorage_as_context_manager
"""Auto-ported test: CgiTests::test_fieldstorage_as_context_manager (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('I/O operation on closed file', str(_aR_e))
print("CgiTests::test_fieldstorage_as_context_manager: ok")
