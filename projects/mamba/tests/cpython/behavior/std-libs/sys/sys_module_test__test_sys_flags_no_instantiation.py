...
# lib = "sys"
# dimension = "behavior"
# case = "sys_module_test__test_sys_flags_no_instantiation"
# subject = "cpython.test_sys.SysModuleTest.test_sys_flags_no_instantiation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys.py::SysModuleTest::test_sys_flags_no_instantiation
"""Auto-ported test: SysModuleTest::test_sys_flags_no_instantiation (CPython 3.12 oracle)."""
...
def check_locale_surrogateescape(locale):
    ...
    assert out == 'stdin: surrogateescape\nstdout: surrogateescape\nstderr: backslashreplace\n'
assert_raise_on_new_sys_type(sys.flags)
print("SysModuleTest::test_sys_flags_no_instantiation: ok")
