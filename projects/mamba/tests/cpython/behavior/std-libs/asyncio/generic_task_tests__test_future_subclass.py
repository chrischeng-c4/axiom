...
# lib = "asyncio"
# dimension = "behavior"
# case = "generic_task_tests__test_future_subclass"
# subject = "cpython.test_tasks.GenericTaskTests.test_future_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tasks.py::GenericTaskTests::test_future_subclass
"""Auto-ported test: GenericTaskTests::test_future_subclass (CPython 3.12 oracle)."""
...
assert issubclass(asyncio.Task, asyncio.Future)
print("GenericTaskTests::test_future_subclass: ok")
