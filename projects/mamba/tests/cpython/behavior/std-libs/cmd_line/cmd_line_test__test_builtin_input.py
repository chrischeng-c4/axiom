...
# lib = "cmd_line"
# dimension = "behavior"
# case = "cmd_line_test__test_builtin_input"
# subject = "cpython.test_cmd_line.CmdLineTest.test_builtin_input"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line.py::CmdLineTest::test_builtin_input
"""Auto-ported test: CmdLineTest::test_builtin_input (CPython 3.12 oracle)."""
...
def verify_valid_flag(cmd_line):
    ...
    return out
check_input('print(repr(input()))', b"'abc'")
print("CmdLineTest::test_builtin_input: ok")
