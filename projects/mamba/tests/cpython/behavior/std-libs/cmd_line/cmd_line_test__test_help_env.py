...
# lib = "cmd_line"
# dimension = "behavior"
# case = "cmd_line_test__test_help_env"
# subject = "cpython.test_cmd_line.CmdLineTest.test_help_env"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line.py::CmdLineTest::test_help_env
"""Auto-ported test: CmdLineTest::test_help_env (CPython 3.12 oracle)."""
...
def verify_valid_flag(cmd_line):
    ...
    return out
out = verify_valid_flag('--help-env')

assert b'PYTHONHOME' in out
print("CmdLineTest::test_help_env: ok")
