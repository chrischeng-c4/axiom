...
# lib = "cmd_line"
# dimension = "behavior"
# case = "cmd_line_test__test_help_xoptions"
# subject = "cpython.test_cmd_line.CmdLineTest.test_help_xoptions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line.py::CmdLineTest::test_help_xoptions
"""Auto-ported test: CmdLineTest::test_help_xoptions (CPython 3.12 oracle)."""
...
def verify_valid_flag(cmd_line):
    ...
    return out
out = verify_valid_flag('--help-xoptions')

assert b'-X dev' in out
print("CmdLineTest::test_help_xoptions: ok")
