...
# lib = "cmd_line"
# dimension = "behavior"
# case = "cmd_line_test__test_pythonmalloc"
# subject = "cpython.test_cmd_line.CmdLineTest.test_pythonmalloc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line.py::CmdLineTest::test_pythonmalloc
"""Auto-ported test: CmdLineTest::test_pythonmalloc (CPython 3.12 oracle)."""
...
for env_var, name in tests:
    check_pythonmalloc(env_var, name)
print("CmdLineTest::test_pythonmalloc: ok")
