...
# lib = "cmd_line"
# dimension = "behavior"
# case = "cmd_line_test__test_stdin_readline"
# subject = "cpython.test_cmd_line.CmdLineTest.test_stdin_readline"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line.py::CmdLineTest::test_stdin_readline
"""Auto-ported test: CmdLineTest::test_stdin_readline (CPython 3.12 oracle)."""
...
def verify_valid_flag(cmd_line):
    ...
    return out
check_input('import sys; print(repr(sys.stdin.readline()))', b"'abc\\n'")
print("CmdLineTest::test_stdin_readline: ok")
