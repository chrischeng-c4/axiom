...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "xmlrpc_test_case__test_dump_none"
# subject = "cpython.test_xmlrpc.XMLRPCTestCase.test_dump_none"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::XMLRPCTestCase::test_dump_none
"""Auto-ported test: XMLRPCTestCase::test_dump_none (CPython 3.12 oracle)."""
...
assert value == xmlrpclib.loads(strg)[0][0]

try:
    xmlrpclib.dumps((arg1,))
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("XMLRPCTestCase::test_dump_none: ok")
