...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "xmlrpc_test_case__test_dump_big_long"
# subject = "cpython.test_xmlrpc.XMLRPCTestCase.test_dump_big_long"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::XMLRPCTestCase::test_dump_big_long
"""Auto-ported test: XMLRPCTestCase::test_dump_big_long (CPython 3.12 oracle)."""
...
try:
    xmlrpclib.dumps((2 ** 99,))
    raise AssertionError('expected OverflowError')
except OverflowError:
    pass
print("XMLRPCTestCase::test_dump_big_long: ok")
