...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "fault_test_case__test_repr"
# subject = "cpython.test_xmlrpc.FaultTestCase.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::FaultTestCase::test_repr
"""Auto-ported test: FaultTestCase::test_repr (CPython 3.12 oracle)."""
...
assert repr(f) == str(f)
print("FaultTestCase::test_repr: ok")
