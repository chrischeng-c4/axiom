...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "simple_xmlrpc_dispatcher_test_case__test_registered_func_is_none"
# subject = "cpython.test_xmlrpc.SimpleXMLRPCDispatcherTestCase.test_registered_func_is_none"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::SimpleXMLRPCDispatcherTestCase::test_registered_func_is_none
"""Auto-ported test: SimpleXMLRPCDispatcherTestCase::test_registered_func_is_none (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('method', str(_aR_e))
print("SimpleXMLRPCDispatcherTestCase::test_registered_func_is_none: ok")
