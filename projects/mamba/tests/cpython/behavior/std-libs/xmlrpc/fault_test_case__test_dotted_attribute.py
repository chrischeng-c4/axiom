...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "fault_test_case__test_dotted_attribute"
# subject = "cpython.test_xmlrpc.FaultTestCase.test_dotted_attribute"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::FaultTestCase::test_dotted_attribute
"""Auto-ported test: FaultTestCase::test_dotted_attribute (CPython 3.12 oracle)."""
...
assert xmlrpc.server.resolve_dotted_attribute(str, 'title')
print("FaultTestCase::test_dotted_attribute: ok")
