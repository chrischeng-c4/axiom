...
# lib = "xmlrpc"
# dimension = "behavior"
# case = "cgi_handler_test_case__test_cgi_get"
# subject = "cpython.test_xmlrpc.CGIHandlerTestCase.test_cgi_get"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xmlrpc.py::CGIHandlerTestCase::test_cgi_get
"""Auto-ported test: CGIHandlerTestCase::test_cgi_get (CPython 3.12 oracle)."""
...
with os_helper.EnvironmentVarGuard() as env:
    ...
    with captured_stdout(encoding=self_cgi.encoding) as data_out:
...
print("CGIHandlerTestCase::test_cgi_get: ok")
