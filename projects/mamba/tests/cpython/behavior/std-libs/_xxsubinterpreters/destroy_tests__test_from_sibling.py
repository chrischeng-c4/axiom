...
# dimension = "behavior"
# case = "destroy_tests__test_from_sibling"
# subject = "cpython.test__xxsubinterpreters.DestroyTests.test_from_sibling"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxsubinterpreters.py::DestroyTests::test_from_sibling
"""Auto-ported test: DestroyTests::test_from_sibling (CPython 3.12 oracle)."""
...
assert set(interpreters.list_all()) == {main, id1}
print("DestroyTests::test_from_sibling: ok")
