...
# dimension = "behavior"
# case = "is_shareable_tests__test_not_shareable"
# subject = "cpython.test__xxsubinterpreters.IsShareableTests.test_not_shareable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxsubinterpreters.py::IsShareableTests::test_not_shareable
"""Auto-ported test: IsShareableTests::test_not_shareable (CPython 3.12 oracle)."""
...
for obj in not_shareables:
    ...
    assert not interpreters.is_shareable(obj)
print("IsShareableTests::test_not_shareable: ok")
