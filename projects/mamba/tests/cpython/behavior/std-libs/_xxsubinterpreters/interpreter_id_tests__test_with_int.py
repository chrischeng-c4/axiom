...
# dimension = "behavior"
# case = "interpreter_id_tests__test_with_int"
# subject = "cpython.test__xxsubinterpreters.InterpreterIDTests.test_with_int"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxsubinterpreters.py::InterpreterIDTests::test_with_int
"""Auto-ported test: InterpreterIDTests::test_with_int (CPython 3.12 oracle)."""
...
assert int(id) == 10
print("InterpreterIDTests::test_with_int: ok")
