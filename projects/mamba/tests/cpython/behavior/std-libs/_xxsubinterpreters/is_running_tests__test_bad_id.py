...
# dimension = "behavior"
# case = "is_running_tests__test_bad_id"
# subject = "cpython.test__xxsubinterpreters.IsRunningTests.test_bad_id"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxsubinterpreters.py::IsRunningTests::test_bad_id
"""Auto-ported test: IsRunningTests::test_bad_id (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("IsRunningTests::test_bad_id: ok")
