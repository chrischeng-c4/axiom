...
# dimension = "behavior"
# case = "shareable_type_tests__test_int"
# subject = "cpython.test__xxsubinterpreters.ShareableTypeTests.test_int"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxsubinterpreters.py::ShareableTypeTests::test_int
"""Auto-ported test: ShareableTypeTests::test_int (CPython 3.12 oracle)."""
...
_assert_values(itertools.chain(range(-1, 258), [sys.maxsize, -sys.maxsize - 1]))
print("ShareableTypeTests::test_int: ok")
