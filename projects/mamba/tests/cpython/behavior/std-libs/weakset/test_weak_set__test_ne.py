...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_ne"
# subject = "cpython.test_weakset.TestWeakSet.test_ne"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_ne
"""Auto-ported test: TestWeakSet::test_ne (CPython 3.12 oracle)."""
...
assert self_s != set(self_items)
s1 = WeakSet()
s2 = WeakSet()

assert not s1 != s2
print("TestWeakSet::test_ne: ok")
