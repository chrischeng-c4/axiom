...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_repr"
# subject = "cpython.test_weakset.TestWeakSet.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_repr
"""Auto-ported test: TestWeakSet::test_repr (CPython 3.12 oracle)."""
...
assert repr(self_s) == repr(self_s.data)
print("TestWeakSet::test_repr: ok")
