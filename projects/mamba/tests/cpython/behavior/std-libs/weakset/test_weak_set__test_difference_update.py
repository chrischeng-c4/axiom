...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_difference_update"
# subject = "cpython.test_weakset.TestWeakSet.test_difference_update"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_difference_update
"""Auto-ported test: TestWeakSet::test_difference_update (CPython 3.12 oracle)."""
...
retval = self_s.difference_update(self_items2)

assert retval == None
for c in self_items + self_items2:
    if c in self_items and c not in self_items2:
...
try:
    ...
    pass
print("TestWeakSet::test_difference_update: ok")
