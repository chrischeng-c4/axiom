...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_gt"
# subject = "cpython.test_weakset.TestWeakSet.test_gt"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_gt
"""Auto-ported test: TestWeakSet::test_gt (CPython 3.12 oracle)."""
...
assert not self_ab_weakset > self_ab_weakset

assert not WeakSet() > WeakSet()
print("TestWeakSet::test_gt: ok")
