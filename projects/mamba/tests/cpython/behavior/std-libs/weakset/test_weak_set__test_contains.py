...
# lib = "weakset"
# dimension = "behavior"
# case = "test_weak_set__test_contains"
# subject = "cpython.test_weakset.TestWeakSet.test_contains"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakset.py::TestWeakSet::test_contains
"""Auto-ported test: TestWeakSet::test_contains (CPython 3.12 oracle)."""
...
assert 1 not in self_s

assert self_obj in self_fs
del self_obj
support.gc_collect()

assert ustr('F') not in self_fs
print("TestWeakSet::test_contains: ok")
