...
# lib = "aifc"
# dimension = "behavior"
# case = "aifc_low_level_test__test_read_no_ssnd_chunk"
# subject = "cpython.test_aifc.AIFCLowLevelTest.test_read_no_ssnd_chunk"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_aifc.py::AIFCLowLevelTest::test_read_no_ssnd_chunk
"""Auto-ported test: AIFCLowLevelTest::test_read_no_ssnd_chunk (CPython 3.12 oracle)."""
...
except aifc.Error as _aR_e:
    import re as _re_aR
    assert _re_aR.search('COMM chunk and/or SSND chunk missing', str(_aR_e))
print("AIFCLowLevelTest::test_read_no_ssnd_chunk: ok")
