...
# lib = "aifc"
# dimension = "behavior"
# case = "aifc_misc_test__test_write_header_comptype_sampwidth"
# subject = "cpython.test_aifc.AifcMiscTest.test_write_header_comptype_sampwidth"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_aifc.py::AifcMiscTest::test_write_header_comptype_sampwidth
"""Auto-ported test: AifcMiscTest::test_write_header_comptype_sampwidth (CPython 3.12 oracle)."""
...
for comptype in (b'ULAW', b'ulaw', b'ALAW', b'alaw', b'G722'):
    ...
    assert fout.getsampwidth() == 2
    fout.initfp(None)
print("AifcMiscTest::test_write_header_comptype_sampwidth: ok")
