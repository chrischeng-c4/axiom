...
# lib = "aifc"
# dimension = "behavior"
# case = "aifc_low_level_test__test_write_params_singles"
# subject = "cpython.test_aifc.AIFCLowLevelTest.test_write_params_singles"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_aifc.py::AIFCLowLevelTest::test_write_params_singles
"""Auto-ported test: AIFCLowLevelTest::test_write_params_singles (CPython 3.12 oracle)."""
...
assert fout.getnchannels() == 1

assert fout.getsampwidth() == 2

assert fout.getframerate() == 3

assert fout.getnframes() == 0

assert fout.tell() == 0

assert fout.getcomptype() == b'NONE'

assert fout.getcompname() == b'name'
fout.writeframes(b'\x00' * 4 * fout.getsampwidth() * fout.getnchannels())

assert fout.getnframes() == 4

assert fout.tell() == 4
print("AIFCLowLevelTest::test_write_params_singles: ok")
