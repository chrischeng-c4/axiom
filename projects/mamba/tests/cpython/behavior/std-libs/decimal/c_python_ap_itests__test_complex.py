...
# lib = "decimal"
# dimension = "behavior"
# case = "c_python_ap_itests__test_complex"
# subject = "cpython.test_decimal.CPythonAPItests.test_complex"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CPythonAPItests::test_complex
"""Auto-ported test: CPythonAPItests::test_complex (CPython 3.12 oracle)."""
...
assert x.conjugate() == x
x = Decimal('1')

assert complex(x) == complex(float(1))
...
try:
    setattr(x, 'conjugate', 100)
    raise AssertionError('expected AttributeError')
except AttributeError:
    pass

try:
    setattr(x, '__complex__', 100)
    raise AssertionError('expected AttributeError')
except AttributeError:
    pass
print("CPythonAPItests::test_complex: ok")
