...
# lib = "decimal"
# dimension = "behavior"
# case = "py_python_ap_itests__test_trunc"
# subject = "cpython.test_decimal.PyPythonAPItests.test_trunc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyPythonAPItests::test_trunc
"""Auto-ported test: PyPythonAPItests::test_trunc (CPython 3.12 oracle)."""
...
for x in range(-250, 250):
    ...
    assert int(Decimal(s)) == int(float(s))
    d = Decimal(s)
    r = d.to_integral(ROUND_DOWN)

    assert Decimal(math.trunc(d)) == r
print("PyPythonAPItests::test_trunc: ok")
