...
# lib = "decimal"
# dimension = "behavior"
# case = "py_arithmetic_operators_test__test_copy_sign"
# subject = "cpython.test_decimal.PyArithmeticOperatorsTest.test_copy_sign"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyArithmeticOperatorsTest::test_copy_sign
"""Auto-ported test: PyArithmeticOperatorsTest::test_copy_sign (CPython 3.12 oracle)."""
...
try:
    Decimal(1).copy_sign('-2')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("PyArithmeticOperatorsTest::test_copy_sign: ok")
