...
# lib = "decimal"
# dimension = "behavior"
# case = "py_implicit_construction_test__test_implicit_from_string"
# subject = "cpython.test_decimal.PyImplicitConstructionTest.test_implicit_from_string"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyImplicitConstructionTest::test_implicit_from_string
"""Auto-ported test: PyImplicitConstructionTest::test_implicit_from_string (CPython 3.12 oracle)."""
...
try:
    eval('Decimal(5) + "3"', locals())
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("PyImplicitConstructionTest::test_implicit_from_string: ok")
