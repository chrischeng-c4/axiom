...
# lib = "decimal"
# dimension = "behavior"
# case = "py_python_ap_itests__test_quantize"
# subject = "cpython.test_decimal.PyPythonAPItests.test_quantize"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyPythonAPItests::test_quantize
"""Auto-ported test: PyPythonAPItests::test_quantize (CPython 3.12 oracle)."""
...
assert Decimal('7.335').quantize(Decimal('.01')) == Decimal('7.34')

assert Decimal('7.335').quantize(Decimal('.01'), rounding=ROUND_DOWN) == Decimal('7.33')
...
assert x == Decimal('8.71E+799')
print("PyPythonAPItests::test_quantize: ok")
