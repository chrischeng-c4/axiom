...
# lib = "decimal"
# dimension = "behavior"
# case = "c_whitebox__test_c_context_errors"
# subject = "cpython.test_decimal.CWhitebox.test_c_context_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CWhitebox::test_c_context_errors
"""Auto-ported test: CWhitebox::test_c_context_errors (CPython 3.12 oracle)."""
...
try:
    c.flags.__setitem__(801, 0)
    raise AssertionError('expected KeyError')
except KeyError:
    pass

try:
    c.traps.__setitem__(801, 0)
    raise AssertionError('expected KeyError')
except KeyError:
    pass

try:
    c.flags.__delitem__(Overflow)
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    c.traps.__delitem__(InvalidOperation)
    raise AssertionError('expected ValueError')
except ValueError:
    pass
...
for attr in ['prec', 'Emax']:
    ...
    try:
        setattr(c, attr, gt_max_emax)
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

try:
    setattr(c, 'Emin', -gt_max_emax)
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    Context(prec=gt_max_emax)
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    Context(Emax=gt_max_emax)
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    Context(Emin=-gt_max_emax)
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    Context(prec=int_max + 1)
    raise AssertionError('expected OverflowError')
except OverflowError:
    pass

try:
    Context(Emax=int_max + 1)
    raise AssertionError('expected OverflowError')
except OverflowError:
    pass

try:
    Context(Emin=-int_max - 2)
    raise AssertionError('expected OverflowError')
except OverflowError:
    pass

try:
    Context(clamp=int_max + 1)
    raise AssertionError('expected OverflowError')
except OverflowError:
    pass
...
for attr in ('prec', 'Emin', 'Emax', 'capitals', 'clamp'):
    ...
    try:
        setattr(c, attr, int_max + 1)
        raise AssertionError('expected OverflowError')
    except OverflowError:
        pass

    try:
        setattr(c, attr, -int_max - 2)
        raise AssertionError('expected OverflowError')
    except OverflowError:
        pass
...
if C.MAX_PREC == 425000000:
    ...
    try:
        getattr(c, '_unsafe_setprec')(int_max + 1)
        raise AssertionError('expected OverflowError')
    except OverflowError:
        pass

    try:
        getattr(c, '_unsafe_setemax')(int_max + 1)
        raise AssertionError('expected OverflowError')
    except OverflowError:
        pass

    try:
        getattr(c, '_unsafe_setemin')(-int_max - 2)
        raise AssertionError('expected OverflowError')
    except OverflowError:
        pass
if C.MAX_PREC == 425000000:
    ...
    try:
        getattr(c, '_unsafe_setprec')(0)
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        getattr(c, '_unsafe_setprec')(1070000001)
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        getattr(c, '_unsafe_setemax')(-1)
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        getattr(c, '_unsafe_setemax')(1070000001)
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        getattr(c, '_unsafe_setemin')(-1070000001)
        raise AssertionError('expected ValueError')
    except ValueError:
        pass

    try:
        getattr(c, '_unsafe_setemin')(1)
        raise AssertionError('expected ValueError')
    except ValueError:
        pass
for attr in ['capitals', 'clamp']:
    ...
    if HAVE_CONFIG_64:
        ...
        try:
            setattr(c, attr, 2 ** 32 + 1)
            raise AssertionError('expected ValueError')
        except ValueError:
            pass

try:
    exec('with localcontext("xyz"): pass', locals())
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    exec('with localcontext(context=getcontext()): pass', locals())
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
print("CWhitebox::test_c_context_errors: ok")
