...
# lib = "decimal"
# dimension = "behavior"
# case = "c_context_flags__test_float_operation_default"
# subject = "cpython.test_decimal.CContextFlags.test_float_operation_default"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CContextFlags::test_float_operation_default
"""Auto-ported test: CContextFlags::test_float_operation_default (CPython 3.12 oracle)."""
...
assert not context.traps[FloatOperation]
context.clear_traps()
context.traps[Inexact] = True
context.traps[FloatOperation] = True

assert context.traps[FloatOperation]

assert context.traps[Inexact]
print("CContextFlags::test_float_operation_default: ok")
