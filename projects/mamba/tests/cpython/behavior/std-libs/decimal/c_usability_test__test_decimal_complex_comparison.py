...
# lib = "decimal"
# dimension = "behavior"
# case = "c_usability_test__test_decimal_complex_comparison"
# subject = "cpython.test_decimal.CUsabilityTest.test_decimal_complex_comparison"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CUsabilityTest::test_decimal_complex_comparison
"""Auto-ported test: CUsabilityTest::test_decimal_complex_comparison (CPython 3.12 oracle)."""
...
assert db.__lt__(3.0 + 0j) is NotImplemented

assert db.__le__(3.0 + 0j) is NotImplemented

assert db.__gt__(3.0 + 0j) is NotImplemented

assert db.__le__(3.0 + 0j) is NotImplemented
print("CUsabilityTest::test_decimal_complex_comparison: ok")
