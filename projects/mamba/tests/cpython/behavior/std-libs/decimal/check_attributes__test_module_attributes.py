...
# lib = "decimal"
# dimension = "behavior"
# case = "check_attributes__test_module_attributes"
# subject = "cpython.test_decimal.CheckAttributes.test_module_attributes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CheckAttributes::test_module_attributes
"""Auto-ported test: CheckAttributes::test_module_attributes (CPython 3.12 oracle)."""
...
assert C.MAX_PREC == P.MAX_PREC

assert C.MAX_EMAX == P.MAX_EMAX

assert C.MIN_EMIN == P.MIN_EMIN

assert C.MIN_ETINY == P.MIN_ETINY

assert C.HAVE_THREADS is True or C.HAVE_THREADS is False

assert P.HAVE_THREADS is True or P.HAVE_THREADS is False

assert C.__version__ == P.__version__

assert dir(C) == dir(P)
print("CheckAttributes::test_module_attributes: ok")
