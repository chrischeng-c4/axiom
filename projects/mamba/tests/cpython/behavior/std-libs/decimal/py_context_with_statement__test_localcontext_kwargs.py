...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_with_statement__test_localcontext_kwargs"
# subject = "cpython.test_decimal.PyContextWithStatement.test_localcontext_kwargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextWithStatement::test_localcontext_kwargs
"""Auto-ported test: PyContextWithStatement::test_localcontext_kwargs (CPython 3.12 oracle)."""
...
# --- test body ---
decimal = P
with decimal.localcontext(prec=10, rounding=ROUND_HALF_DOWN, Emin=-20, Emax=20, capitals=0, clamp=1) as ctx:

    assert ctx.prec == 10

    assert ctx.rounding == decimal.ROUND_HALF_DOWN

    assert ctx.Emin == -20

    assert ctx.Emax == 20

    assert ctx.capitals == 0

    assert ctx.clamp == 1

try:
    decimal.localcontext(precision=10)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    decimal.localcontext(Emin=1)
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    decimal.localcontext(Emax=-1)
    raise AssertionError('expected ValueError')
except ValueError:
    pass
...
try:
    decimal.localcontext(clamp=2)
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    decimal.localcontext(rounding='')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    decimal.localcontext(rounding=1)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    decimal.localcontext(flags='')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    decimal.localcontext(traps='')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    decimal.localcontext(Emin='')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    decimal.localcontext(Emax='')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("PyContextWithStatement::test_localcontext_kwargs: ok")
