...
# lib = "decimal"
# dimension = "behavior"
# case = "c_context_ap_itests__test_number_class"
# subject = "cpython.test_decimal.CContextAPItests.test_number_class"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CContextAPItests::test_number_class
"""Auto-ported test: CContextAPItests::test_number_class (CPython 3.12 oracle)."""
...
assert c.number_class(123) == c.number_class(Decimal(123))

assert c.number_class(0) == c.number_class(Decimal(0))

assert c.number_class(-45) == c.number_class(Decimal(-45))
print("CContextAPItests::test_number_class: ok")
