...
# lib = "decimal"
# dimension = "behavior"
# case = "c_coverage__test_radix"
# subject = "cpython.test_decimal.CCoverage.test_radix"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CCoverage::test_radix
"""Auto-ported test: CCoverage::test_radix (CPython 3.12 oracle)."""
...
assert Decimal('1').radix() == 10

assert c.radix() == 10
print("CCoverage::test_radix: ok")
