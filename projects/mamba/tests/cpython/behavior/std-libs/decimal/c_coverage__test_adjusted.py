...
# lib = "decimal"
# dimension = "behavior"
# case = "c_coverage__test_adjusted"
# subject = "cpython.test_decimal.CCoverage.test_adjusted"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CCoverage::test_adjusted
"""Auto-ported test: CCoverage::test_adjusted (CPython 3.12 oracle)."""
...
assert Decimal('1234e9999').adjusted() == 10002

assert Decimal('nan').adjusted() == 0

assert Decimal('inf').adjusted() == 0
print("CCoverage::test_adjusted: ok")
