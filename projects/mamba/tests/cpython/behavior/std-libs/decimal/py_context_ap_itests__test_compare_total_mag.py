...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_compare_total_mag"
# subject = "cpython.test_decimal.PyContextAPItests.test_compare_total_mag"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_compare_total_mag
"""Auto-ported test: PyContextAPItests::test_compare_total_mag (CPython 3.12 oracle)."""
...
assert c.compare_total_mag(1, 1) == d

assert c.compare_total_mag(Decimal(1), 1) == d

assert c.compare_total_mag(1, Decimal(1)) == d

try:
    c.compare_total_mag('1', 1)
...
try:
    ...
    pass
print("PyContextAPItests::test_compare_total_mag: ok")
