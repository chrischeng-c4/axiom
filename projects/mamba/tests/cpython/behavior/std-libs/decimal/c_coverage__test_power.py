...
# lib = "decimal"
# dimension = "behavior"
# case = "c_coverage__test_power"
# subject = "cpython.test_decimal.CCoverage.test_power"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CCoverage::test_power
"""Auto-ported test: CCoverage::test_power (CPython 3.12 oracle)."""
...
with localcontext() as c:
    ...
    assert Decimal('1.0') ** 100 == Decimal('1.00')
    ...
    assert Decimal(10000) ** Decimal('0.5') == Decimal('inf')

    assert c.flags[Overflow]
print("CCoverage::test_power: ok")
