...
# lib = "decimal"
# dimension = "behavior"
# case = "c_usability_test__test_implicit_context"
# subject = "cpython.test_decimal.CUsabilityTest.test_implicit_context"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CUsabilityTest::test_implicit_context
"""Auto-ported test: CUsabilityTest::test_implicit_context (CPython 3.12 oracle)."""
...
assert str(Decimal(0).sqrt()) == str(c.sqrt(Decimal(0)))
print("CUsabilityTest::test_implicit_context: ok")
