...
# lib = "decimal"
# dimension = "behavior"
# case = "c_context_with_statement__test_with_statements_gc3"
# subject = "cpython.test_decimal.CContextWithStatement.test_with_statements_gc3"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CContextWithStatement::test_with_statements_gc3
"""Auto-ported test: CContextWithStatement::test_with_statements_gc3 (CPython 3.12 oracle)."""
    ...
    with localcontext(n1) as c2:
        ...
        with localcontext(n3) as c3:
            ...
            with localcontext() as c4:
                ...
                assert c4.prec == 4
                del c4
print("CContextWithStatement::test_with_statements_gc3: ok")
