...
# lib = "decimal"
# dimension = "behavior"
# case = "c_whitebox__test_c_integral"
# subject = "cpython.test_decimal.CWhitebox.test_c_integral"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CWhitebox::test_c_integral
"""Auto-ported test: CWhitebox::test_c_integral (CPython 3.12 oracle)."""
...
try:
    x.to_integral_value('10')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    x.to_integral_value(10, 'x')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
try:
    x.to_integral_exact('10')
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    x.to_integral_exact(10, 'x')
    raise AssertionError('expected TypeError')
except TypeError:
    pass
...
with localcontext() as c:
    ...
    try:
        Decimal('999.9').to_integral_exact(ROUND_UP)
        raise AssertionError('expected Inexact')
    except Inexact:
        pass
print("CWhitebox::test_c_integral: ok")
