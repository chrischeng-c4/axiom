...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_with_statement__test_local_context_kwargs_does_not_overwrite_existing_argument"
# subject = "cpython.test_decimal.PyContextWithStatement.test_local_context_kwargs_does_not_overwrite_existing_argument"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextWithStatement::test_local_context_kwargs_does_not_overwrite_existing_argument
"""Auto-ported test: PyContextWithStatement::test_local_context_kwargs_does_not_overwrite_existing_argument (CPython 3.12 oracle)."""
...
orig_prec = ctx.prec
with decimal.localcontext(prec=10) as ctx2:

    assert ctx2.prec == 10

    assert ctx.prec == orig_prec
with decimal.localcontext(prec=20) as ctx2:

    assert ctx2.prec == 20

    assert ctx.prec == orig_prec
print("PyContextWithStatement::test_local_context_kwargs_does_not_overwrite_existing_argument: ok")
