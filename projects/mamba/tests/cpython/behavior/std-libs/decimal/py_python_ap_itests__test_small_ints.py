...
# lib = "decimal"
# dimension = "behavior"
# case = "py_python_ap_itests__test_small_ints"
# subject = "cpython.test_decimal.PyPythonAPItests.test_small_ints"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyPythonAPItests::test_small_ints
"""Auto-ported test: PyPythonAPItests::test_small_ints (CPython 3.12 oracle)."""
...
for x in range(-5, 257):
    ...
    assert int(Decimal(x)) is x
print("PyPythonAPItests::test_small_ints: ok")
