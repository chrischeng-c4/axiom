...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_copy_sign"
# subject = "cpython.test_decimal.PyContextAPItests.test_copy_sign"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_copy_sign
"""Auto-ported test: PyContextAPItests::test_copy_sign (CPython 3.12 oracle)."""
...
assert c.copy_sign(1, -2) == d

assert c.copy_sign(Decimal(1), -2) == d

assert c.copy_sign(1, Decimal(-2)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_copy_sign: ok")
