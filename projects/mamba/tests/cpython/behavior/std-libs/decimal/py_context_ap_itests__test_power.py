...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_power"
# subject = "cpython.test_decimal.PyContextAPItests.test_power"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_power
"""Auto-ported test: PyContextAPItests::test_power (CPython 3.12 oracle)."""
...
assert c.power(1, 4) == d

assert c.power(Decimal(1), 4) == d

assert c.power(1, Decimal(4)) == d

assert c.power(Decimal(1), Decimal(4)) == d
...
assert c.power(modulo=5, b=8, a=2) == 1
print("PyContextAPItests::test_power: ok")
