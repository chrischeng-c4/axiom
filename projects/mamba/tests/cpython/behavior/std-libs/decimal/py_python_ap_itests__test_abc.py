...
# lib = "decimal"
# dimension = "behavior"
# case = "py_python_ap_itests__test_abc"
# subject = "cpython.test_decimal.PyPythonAPItests.test_abc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyPythonAPItests::test_abc
"""Auto-ported test: PyPythonAPItests::test_abc (CPython 3.12 oracle)."""
...
assert issubclass(Decimal, numbers.Number)

assert not issubclass(Decimal, numbers.Real)

assert isinstance(Decimal(0), numbers.Number)

assert not isinstance(Decimal(0), numbers.Real)
print("PyPythonAPItests::test_abc: ok")
