...
# lib = "decimal"
# dimension = "behavior"
# case = "c_whitebox__test_format_fallback_rounding"
# subject = "cpython.test_decimal.CWhitebox.test_format_fallback_rounding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CWhitebox::test_format_fallback_rounding
"""Auto-ported test: CWhitebox::test_format_fallback_rounding (CPython 3.12 oracle)."""
...
assert format(y, '#.1f') == '6.1'
with C.localcontext(rounding=C.ROUND_DOWN):

    assert format(y, '#.1f') == '6.0'
print("CWhitebox::test_format_fallback_rounding: ok")
