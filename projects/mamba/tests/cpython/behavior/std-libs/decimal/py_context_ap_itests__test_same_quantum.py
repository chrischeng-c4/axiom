...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_same_quantum"
# subject = "cpython.test_decimal.PyContextAPItests.test_same_quantum"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_same_quantum
"""Auto-ported test: PyContextAPItests::test_same_quantum (CPython 3.12 oracle)."""
...
assert c.same_quantum(1, 2) == d

assert c.same_quantum(Decimal(1), 2) == d

assert c.same_quantum(1, Decimal(2)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_same_quantum: ok")
