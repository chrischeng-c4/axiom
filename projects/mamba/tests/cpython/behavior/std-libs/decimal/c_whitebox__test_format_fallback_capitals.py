...
# lib = "decimal"
# dimension = "behavior"
# case = "c_whitebox__test_format_fallback_capitals"
# subject = "cpython.test_decimal.CWhitebox.test_format_fallback_capitals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CWhitebox::test_format_fallback_capitals
"""Auto-ported test: CWhitebox::test_format_fallback_capitals (CPython 3.12 oracle)."""
...
assert format(x, '#') == '6.09E+23'
with C.localcontext(capitals=0):

    assert format(x, '#') == '6.09e+23'
print("CWhitebox::test_format_fallback_capitals: ok")
