...
# lib = "decimal"
# dimension = "behavior"
# case = "py_implicit_construction_test__test_implicit_from_float"
# subject = "cpython.test_decimal.PyImplicitConstructionTest.test_implicit_from_float"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyImplicitConstructionTest::test_implicit_from_float
"""Auto-ported test: PyImplicitConstructionTest::test_implicit_from_float (CPython 3.12 oracle)."""
...
try:
    eval('Decimal(5) + 2.2', locals())
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("PyImplicitConstructionTest::test_implicit_from_float: ok")
