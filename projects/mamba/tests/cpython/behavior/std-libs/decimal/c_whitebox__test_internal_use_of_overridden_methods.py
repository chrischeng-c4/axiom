...
# lib = "decimal"
# dimension = "behavior"
# case = "c_whitebox__test_internal_use_of_overridden_methods"
# subject = "cpython.test_decimal.CWhitebox.test_internal_use_of_overridden_methods"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CWhitebox::test_internal_use_of_overridden_methods
"""Auto-ported test: CWhitebox::test_internal_use_of_overridden_methods (CPython 3.12 oracle)."""
...
for cls in (X, Y, Z):
    ...
    assert Decimal.from_float(cls(101.1)) == Decimal.from_float(101.1)
print("CWhitebox::test_internal_use_of_overridden_methods: ok")
