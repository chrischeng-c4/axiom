...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_remainder"
# subject = "cpython.test_decimal.PyContextAPItests.test_remainder"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_remainder
"""Auto-ported test: PyContextAPItests::test_remainder (CPython 3.12 oracle)."""
...
assert c.remainder(1, 2) == d

assert c.remainder(Decimal(1), 2) == d

assert c.remainder(1, Decimal(2)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_remainder: ok")
