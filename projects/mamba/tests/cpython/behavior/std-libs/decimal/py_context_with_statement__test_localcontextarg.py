...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_with_statement__test_localcontextarg"
# subject = "cpython.test_decimal.PyContextWithStatement.test_localcontextarg"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextWithStatement::test_localcontextarg
"""Auto-ported test: PyContextWithStatement::test_localcontextarg (CPython 3.12 oracle)."""
...
assert orig_ctx is final_ctx

assert set_ctx.prec == new_ctx.prec

assert new_ctx is not set_ctx

assert set_ctx is enter_ctx
print("PyContextWithStatement::test_localcontextarg: ok")
