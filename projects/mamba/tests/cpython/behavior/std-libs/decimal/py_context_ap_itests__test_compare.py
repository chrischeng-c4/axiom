...
# lib = "decimal"
# dimension = "behavior"
# case = "py_context_ap_itests__test_compare"
# subject = "cpython.test_decimal.PyContextAPItests.test_compare"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyContextAPItests::test_compare
"""Auto-ported test: PyContextAPItests::test_compare (CPython 3.12 oracle)."""
...
assert c.compare(1, 1) == d

assert c.compare(Decimal(1), 1) == d

assert c.compare(1, Decimal(1)) == d
...
try:
    ...
    pass
print("PyContextAPItests::test_compare: ok")
