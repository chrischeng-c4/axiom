...
# lib = "decimal"
# dimension = "behavior"
# case = "py_explicit_construction_test__test_explicit_from_int"
# subject = "cpython.test_decimal.PyExplicitConstructionTest.test_explicit_from_int"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyExplicitConstructionTest::test_explicit_from_int
"""Auto-ported test: PyExplicitConstructionTest::test_explicit_from_int (CPython 3.12 oracle)."""
...
for n in range(0, 32):
    for sign in (-1, 1):
        for x in range(-5, 5):
            ...
            assert str(d) == str(i)
print("PyExplicitConstructionTest::test_explicit_from_int: ok")
