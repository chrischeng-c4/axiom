...
# lib = "decimal"
# dimension = "behavior"
# case = "c_usability_test__test_conversions_from_int"
# subject = "cpython.test_decimal.CUsabilityTest.test_conversions_from_int"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::CUsabilityTest::test_conversions_from_int
"""Auto-ported test: CUsabilityTest::test_conversions_from_int (CPython 3.12 oracle)."""
...
assert Decimal(4).compare(3) == Decimal(4).compare(Decimal(3))

assert Decimal(4).compare_signal(3) == Decimal(4).compare_signal(Decimal(3))

assert Decimal(4).compare_total(3) == Decimal(4).compare_total(Decimal(3))

assert Decimal(4).compare_total_mag(3) == Decimal(4).compare_total_mag(Decimal(3))

assert Decimal(10101).logical_and(1001) == Decimal(10101).logical_and(Decimal(1001))

assert Decimal(10101).logical_or(1001) == Decimal(10101).logical_or(Decimal(1001))

assert Decimal(10101).logical_xor(1001) == Decimal(10101).logical_xor(Decimal(1001))

assert Decimal(567).max(123) == Decimal(567).max(Decimal(123))

assert Decimal(567).max_mag(123) == Decimal(567).max_mag(Decimal(123))

assert Decimal(567).min(123) == Decimal(567).min(Decimal(123))

assert Decimal(567).min_mag(123) == Decimal(567).min_mag(Decimal(123))

assert Decimal(567).next_toward(123) == Decimal(567).next_toward(Decimal(123))

assert Decimal(1234).quantize(100) == Decimal(1234).quantize(Decimal(100))

assert Decimal(768).remainder_near(1234) == Decimal(768).remainder_near(Decimal(1234))

assert Decimal(123).rotate(1) == Decimal(123).rotate(Decimal(1))

assert Decimal(1234).same_quantum(1000) == Decimal(1234).same_quantum(Decimal(1000))

assert Decimal('9.123').scaleb(-100) == Decimal('9.123').scaleb(Decimal(-100))

assert Decimal(456).shift(-1) == Decimal(456).shift(Decimal(-1))

assert Decimal(-12).fma(Decimal(45), 67) == Decimal(-12).fma(Decimal(45), Decimal(67))

assert Decimal(-12).fma(45, 67) == Decimal(-12).fma(Decimal(45), Decimal(67))

assert Decimal(-12).fma(45, Decimal(67)) == Decimal(-12).fma(Decimal(45), Decimal(67))
print("CUsabilityTest::test_conversions_from_int: ok")
