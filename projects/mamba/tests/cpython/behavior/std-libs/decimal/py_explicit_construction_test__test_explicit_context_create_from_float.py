...
# lib = "decimal"
# dimension = "behavior"
# case = "py_explicit_construction_test__test_explicit_context_create_from_float"
# subject = "cpython.test_decimal.PyExplicitConstructionTest.test_explicit_context_create_from_float"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyExplicitConstructionTest::test_explicit_context_create_from_float
"""Auto-ported test: PyExplicitConstructionTest::test_explicit_context_create_from_float (CPython 3.12 oracle)."""
...
assert str(nc.create_decimal(float('nan'))) == str(nc.create_decimal('NaN'))

assert str(nc.create_decimal(float('inf'))) == str(nc.create_decimal('Infinity'))

assert str(nc.create_decimal(float('-inf'))) == str(nc.create_decimal('-Infinity'))

assert str(nc.create_decimal(float('-0.0'))) == str(nc.create_decimal('-0'))
nc.prec = 100
for i in range(200):
    x = random.expovariate(0.01) * (random.random() * 2.0 - 1.0)

    assert x == float(nc.create_decimal(x))
print("PyExplicitConstructionTest::test_explicit_context_create_from_float: ok")
