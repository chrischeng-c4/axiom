...
# lib = "decimal"
# dimension = "behavior"
# case = "py_format_test__test_negative_zero_format_directed_rounding"
# subject = "cpython.test_decimal.PyFormatTest.test_negative_zero_format_directed_rounding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decimal.py::PyFormatTest::test_negative_zero_format_directed_rounding
"""Auto-ported test: PyFormatTest::test_negative_zero_format_directed_rounding (CPython 3.12 oracle)."""
...
with decimal.localcontext() as ctx:
    ...
    assert format(decimal.Decimal('-0.001'), 'z.2f') == '0.00'
print("PyFormatTest::test_negative_zero_format_directed_rounding: ok")
