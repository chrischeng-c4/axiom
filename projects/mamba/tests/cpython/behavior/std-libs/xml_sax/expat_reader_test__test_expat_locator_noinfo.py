...
# lib = "xml_sax"
# dimension = "behavior"
# case = "expat_reader_test__test_expat_locator_noinfo"
# subject = "cpython.test_sax.ExpatReaderTest.test_expat_locator_noinfo"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::ExpatReaderTest::test_expat_locator_noinfo
"""Auto-ported test: ExpatReaderTest::test_expat_locator_noinfo (CPython 3.12 oracle)."""
...
assert parser.getSystemId() == None

assert parser.getPublicId() == None

assert parser.getLineNumber() == 1
print("ExpatReaderTest::test_expat_locator_noinfo: ok")
