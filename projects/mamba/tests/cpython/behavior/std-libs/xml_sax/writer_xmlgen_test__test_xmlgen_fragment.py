...
# lib = "xml_sax"
# dimension = "behavior"
# case = "writer_xmlgen_test__test_xmlgen_fragment"
# subject = "cpython.test_sax.WriterXmlgenTest.test_xmlgen_fragment"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::WriterXmlgenTest::test_xmlgen_fragment
"""Auto-ported test: WriterXmlgenTest::test_xmlgen_fragment (CPython 3.12 oracle)."""
...
assert result.getvalue() == xml('<foo a="1.0">Hello</foo><bar b="2.0"></bar>')[len(xml('')):]
print("WriterXmlgenTest::test_xmlgen_fragment: ok")
