...
# lib = "xml_sax"
# dimension = "behavior"
# case = "stream_reader_writer_xmlgen_test__test_xmlgen_encoding"
# subject = "cpython.test_sax.StreamReaderWriterXmlgenTest.test_xmlgen_encoding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::StreamReaderWriterXmlgenTest::test_xmlgen_encoding
"""Auto-ported test: StreamReaderWriterXmlgenTest::test_xmlgen_encoding (CPython 3.12 oracle)."""
...
for encoding in encodings:
    ...
    assert result.getvalue() == xml('<doc a="€">€</doc>', encoding=encoding)
print("StreamReaderWriterXmlgenTest::test_xmlgen_encoding: ok")
