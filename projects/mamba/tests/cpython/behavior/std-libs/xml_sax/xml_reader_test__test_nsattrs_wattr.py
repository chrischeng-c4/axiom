...
# lib = "xml_sax"
# dimension = "behavior"
# case = "xml_reader_test__test_nsattrs_wattr"
# subject = "cpython.test_sax.XmlReaderTest.test_nsattrs_wattr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::XmlReaderTest::test_nsattrs_wattr
"""Auto-ported test: XmlReaderTest::test_nsattrs_wattr (CPython 3.12 oracle)."""
...
assert attrs.getNames() == [(ns_uri, 'attr')]

assert attrs.getQNames() == ['ns:attr']

assert len(attrs) == 1

assert (ns_uri, 'attr') in attrs

assert list(attrs.keys()) == [(ns_uri, 'attr')]

assert attrs.get((ns_uri, 'attr')) == 'val'

assert attrs.get((ns_uri, 'attr'), 25) == 'val'

assert list(attrs.items()) == [((ns_uri, 'attr'), 'val')]

assert list(attrs.values()) == ['val']

assert attrs.getValue((ns_uri, 'attr')) == 'val'

assert attrs.getValueByQName('ns:attr') == 'val'

assert attrs.getNameByQName('ns:attr') == (ns_uri, 'attr')

assert attrs[ns_uri, 'attr'] == 'val'

assert attrs.getQNameByName((ns_uri, 'attr')) == 'ns:attr'
print("XmlReaderTest::test_nsattrs_wattr: ok")
