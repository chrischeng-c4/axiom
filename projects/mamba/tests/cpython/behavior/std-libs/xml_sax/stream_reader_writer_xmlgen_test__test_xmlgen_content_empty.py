...
# lib = "xml_sax"
# dimension = "behavior"
# case = "stream_reader_writer_xmlgen_test__test_xmlgen_content_empty"
# subject = "cpython.test_sax.StreamReaderWriterXmlgenTest.test_xmlgen_content_empty"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::StreamReaderWriterXmlgenTest::test_xmlgen_content_empty
"""Auto-ported test: StreamReaderWriterXmlgenTest::test_xmlgen_content_empty (CPython 3.12 oracle)."""
...
assert result.getvalue() == xml('<doc>huhei</doc>')
print("StreamReaderWriterXmlgenTest::test_xmlgen_content_empty: ok")
