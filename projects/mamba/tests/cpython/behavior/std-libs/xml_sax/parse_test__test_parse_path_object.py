...
# lib = "xml_sax"
# dimension = "behavior"
# case = "parse_test__test_parse_path_object"
# subject = "cpython.test_sax.ParseTest.test_parse_path_object"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::ParseTest::test_parse_path_object
"""Auto-ported test: ParseTest::test_parse_path_object (CPython 3.12 oracle)."""
...
def check_parseString(s):
    ...
    assert result.getvalue() == xml_str(data, 'utf-8')
make_xml_file(data, 'utf-8', None)
check_parse(FakePath(TESTFN))
print("ParseTest::test_parse_path_object: ok")
