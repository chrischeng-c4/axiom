...
# lib = "xml_sax"
# dimension = "behavior"
# case = "stream_reader_writer_xmlgen_test__test_xmlgen_pi"
# subject = "cpython.test_sax.StreamReaderWriterXmlgenTest.test_xmlgen_pi"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::StreamReaderWriterXmlgenTest::test_xmlgen_pi
"""Auto-ported test: StreamReaderWriterXmlgenTest::test_xmlgen_pi (CPython 3.12 oracle)."""
...
assert result.getvalue() == xml('<?test data?><doc></doc>')
print("StreamReaderWriterXmlgenTest::test_xmlgen_pi: ok")
