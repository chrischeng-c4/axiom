...
# lib = "xml_sax"
# dimension = "behavior"
# case = "prepare_input_source_test__test_character_stream"
# subject = "cpython.test_sax.PrepareInputSourceTest.test_character_stream"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::PrepareInputSourceTest::test_character_stream
"""Auto-ported test: PrepareInputSourceTest::test_character_stream (CPython 3.12 oracle)."""
...
# --- test body ---
def checkContent(stream, content):
...
def make_byte_stream():
    return BytesIO(b'This is a byte stream.')

def make_character_stream():
    return StringIO('This is a character stream.')
self_file = os_helper.TESTFN
with open(self_file, 'w') as tmp:
    tmp.write('This was read from a file.')
src = InputSource(self_file)
src.setCharacterStream(make_character_stream())
prep = prepare_input_source(src)

assert prep.getByteStream() is None
checkContent(prep.getCharacterStream(), 'This is a character stream.')
print("PrepareInputSourceTest::test_character_stream: ok")
