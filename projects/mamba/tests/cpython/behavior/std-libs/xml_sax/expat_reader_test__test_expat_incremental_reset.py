...
# lib = "xml_sax"
# dimension = "behavior"
# case = "expat_reader_test__test_expat_incremental_reset"
# subject = "cpython.test_sax.ExpatReaderTest.test_expat_incremental_reset"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::ExpatReaderTest::test_expat_incremental_reset
"""Auto-ported test: ExpatReaderTest::test_expat_incremental_reset (CPython 3.12 oracle)."""
...
assert result.getvalue() == start + b'<doc>text</doc>'
print("ExpatReaderTest::test_expat_incremental_reset: ok")
