...
# lib = "xml_sax"
# dimension = "behavior"
# case = "error_reporting_test__test_expat_inpsource_location"
# subject = "cpython.test_sax.ErrorReportingTest.test_expat_inpsource_location"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::ErrorReportingTest::test_expat_inpsource_location
"""Auto-ported test: ErrorReportingTest::test_expat_inpsource_location (CPython 3.12 oracle)."""
...
try:
    ...
    assert e.getSystemId() == name
print("ErrorReportingTest::test_expat_inpsource_location: ok")
