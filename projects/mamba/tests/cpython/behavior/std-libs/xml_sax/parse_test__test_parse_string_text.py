...
# lib = "xml_sax"
# dimension = "behavior"
# case = "parse_test__test_parse_string_text"
# subject = "cpython.test_sax.ParseTest.test_parseString_text"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sax.py::ParseTest::test_parseString_text
"""Auto-ported test: ParseTest::test_parseString_text (CPython 3.12 oracle)."""
...
for encoding in encodings:
    check_parseString(xml_str(data, encoding))
check_parseString(data)
print("ParseTest::test_parseString_text: ok")
