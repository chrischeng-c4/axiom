...
# lib = "context"
# dimension = "behavior"
# case = "context_test__test_context_getset_2"
# subject = "cpython.test_context.ContextTest.test_context_getset_2"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_context.py::ContextTest::test_context_getset_2
"""Auto-ported test: ContextTest::test_context_getset_2 (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('by a different', str(_aR_e))
print("ContextTest::test_context_getset_2: ok")
