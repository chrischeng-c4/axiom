...
# lib = "context"
# dimension = "behavior"
# case = "context_test__test_context_subclassing_1"
# subject = "cpython.test_context.ContextTest.test_context_subclassing_1"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_context.py::ContextTest::test_context_subclassing_1
"""Auto-ported test: ContextTest::test_context_subclassing_1 (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('not an acceptable base type', str(_aR_e))
print("ContextTest::test_context_subclassing_1: ok")
