...
# lib = "context"
# dimension = "behavior"
# case = "hamt_test__test_hamt_collision_3"
# subject = "cpython.test_context.HamtTest.test_hamt_collision_3"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_context.py::HamtTest::test_hamt_collision_3
"""Auto-ported test: HamtTest::test_hamt_collision_3 (CPython 3.12 oracle)."""
...
assert {k.name for k in h.keys()} == {'C', 'D', 'E'}
print("HamtTest::test_hamt_collision_3: ok")
