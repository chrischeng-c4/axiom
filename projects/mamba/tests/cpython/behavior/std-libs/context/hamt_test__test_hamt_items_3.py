...
# lib = "context"
# dimension = "behavior"
# case = "hamt_test__test_hamt_items_3"
# subject = "cpython.test_context.HamtTest.test_hamt_items_3"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_context.py::HamtTest::test_hamt_items_3
"""Auto-ported test: HamtTest::test_hamt_items_3 (CPython 3.12 oracle)."""
...
assert list(h.items()) == []
print("HamtTest::test_hamt_items_3: ok")
