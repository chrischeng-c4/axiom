...
# lib = "context"
# dimension = "behavior"
# case = "context_test__test_context_run_2"
# subject = "cpython.test_context.ContextTest.test_context_run_2"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_context.py::ContextTest::test_context_run_2
"""Auto-ported test: ContextTest::test_context_run_2 (CPython 3.12 oracle)."""
...
for f in (func, functools.partial(func)):
    ...
    assert a == {}
print("ContextTest::test_context_run_2: ok")
