...
# lib = "pyexpat"
# dimension = "behavior"
# case = "reparse_deferral_test__test_getter_setter_round_trip"
# subject = "cpython.test_pyexpat.ReparseDeferralTest.test_getter_setter_round_trip"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pyexpat.py::ReparseDeferralTest::test_getter_setter_round_trip
"""Auto-ported test: ReparseDeferralTest::test_getter_setter_round_trip (CPython 3.12 oracle)."""
...
assert parser.GetReparseDeferralEnabled() is enabled
...
assert parser.GetReparseDeferralEnabled() is enabled
print("ReparseDeferralTest::test_getter_setter_round_trip: ok")
