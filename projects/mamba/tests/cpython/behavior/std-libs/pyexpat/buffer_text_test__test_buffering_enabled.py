...
# lib = "pyexpat"
# dimension = "behavior"
# case = "buffer_text_test__test_buffering_enabled"
# subject = "cpython.test_pyexpat.BufferTextTest.test_buffering_enabled"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pyexpat.py::BufferTextTest::test_buffering_enabled
"""Auto-ported test: BufferTextTest::test_buffering_enabled (CPython 3.12 oracle)."""
...
assert self_parser.buffer_text
self_parser.Parse(b'<a>1<b/>2<c/>3</a>', True)

assert self_stuff == ['123']
print("BufferTextTest::test_buffering_enabled: ok")
