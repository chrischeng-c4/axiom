...
# lib = "pyexpat"
# dimension = "behavior"
# case = "namespace_separator_test__test_illegal"
# subject = "cpython.test_pyexpat.NamespaceSeparatorTest.test_illegal"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pyexpat.py::NamespaceSeparatorTest::test_illegal
"""Auto-ported test: NamespaceSeparatorTest::test_illegal (CPython 3.12 oracle)."""
...
try:
    ...
    assert str(e) == "ParserCreate() argument 'namespace_separator' must be str or None, not int"
try:
    ...
    assert str(e) == 'namespace_separator must be at most one character, omitted, or None'
print("NamespaceSeparatorTest::test_illegal: ok")
