...
# lib = "pyexpat"
# dimension = "behavior"
# case = "foreign_dtd_tests__test_ignore_use_foreign_dtd"
# subject = "cpython.test_pyexpat.ForeignDTDTests.test_ignore_use_foreign_dtd"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pyexpat.py::ForeignDTDTests::test_ignore_use_foreign_dtd
"""Auto-ported test: ForeignDTDTests::test_ignore_use_foreign_dtd (CPython 3.12 oracle)."""
...
assert handler_call_args == [('bar', 'baz')]
print("ForeignDTDTests::test_ignore_use_foreign_dtd: ok")
