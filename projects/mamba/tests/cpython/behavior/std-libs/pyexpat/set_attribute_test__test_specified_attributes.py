...
# lib = "pyexpat"
# dimension = "behavior"
# case = "set_attribute_test__test_specified_attributes"
# subject = "cpython.test_pyexpat.SetAttributeTest.test_specified_attributes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pyexpat.py::SetAttributeTest::test_specified_attributes
"""Auto-ported test: SetAttributeTest::test_specified_attributes (CPython 3.12 oracle)."""
...
assert self_parser.specified_attributes is False
for x in (0, 1, 2, 0):
    self_parser.specified_attributes = x

    assert self_parser.specified_attributes is bool(x)
print("SetAttributeTest::test_specified_attributes: ok")
