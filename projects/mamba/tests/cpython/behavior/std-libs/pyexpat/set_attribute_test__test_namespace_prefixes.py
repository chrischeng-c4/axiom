...
# lib = "pyexpat"
# dimension = "behavior"
# case = "set_attribute_test__test_namespace_prefixes"
# subject = "cpython.test_pyexpat.SetAttributeTest.test_namespace_prefixes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pyexpat.py::SetAttributeTest::test_namespace_prefixes
"""Auto-ported test: SetAttributeTest::test_namespace_prefixes (CPython 3.12 oracle)."""
...
assert self_parser.namespace_prefixes is False
for x in (0, 1, 2, 0):
    self_parser.namespace_prefixes = x

    assert self_parser.namespace_prefixes is bool(x)
print("SetAttributeTest::test_namespace_prefixes: ok")
