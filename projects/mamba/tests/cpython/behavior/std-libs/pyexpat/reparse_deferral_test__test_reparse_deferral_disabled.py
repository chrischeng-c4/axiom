...
# lib = "pyexpat"
# dimension = "behavior"
# case = "reparse_deferral_test__test_reparse_deferral_disabled"
# subject = "cpython.test_pyexpat.ReparseDeferralTest.test_reparse_deferral_disabled"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pyexpat.py::ReparseDeferralTest::test_reparse_deferral_disabled
"""Auto-ported test: ReparseDeferralTest::test_reparse_deferral_disabled (CPython 3.12 oracle)."""
...
assert not parser.GetReparseDeferralEnabled()
for chunk in (b'<doc', b'/>'):
    parser.Parse(chunk, False)

assert started == ['doc']
print("ReparseDeferralTest::test_reparse_deferral_disabled: ok")
