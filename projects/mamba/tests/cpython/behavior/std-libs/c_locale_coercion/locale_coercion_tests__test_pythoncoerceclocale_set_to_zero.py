...
# dimension = "behavior"
# case = "locale_coercion_tests__test_pythoncoerceclocale_set_to_zero"
# subject = "cpython.test_c_locale_coercion.LocaleCoercionTests.test_PYTHONCOERCECLOCALE_set_to_zero"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_c_locale_coercion.py::LocaleCoercionTests::test_PYTHONCOERCECLOCALE_set_to_zero
"""Auto-ported test: LocaleCoercionTests::test_PYTHONCOERCECLOCALE_set_to_zero (CPython 3.12 oracle)."""
...
_check_c_locale_coercion(EXPECTED_C_LOCALE_FS_ENCODING, EXPECTED_C_LOCALE_STREAM_ENCODING, coerce_c_locale='0', coercion_expected=False)
_check_c_locale_coercion(EXPECTED_C_LOCALE_FS_ENCODING, EXPECTED_C_LOCALE_STREAM_ENCODING, coerce_c_locale='0', LC_ALL='C', coercion_expected=False)
print("LocaleCoercionTests::test_PYTHONCOERCECLOCALE_set_to_zero: ok")
