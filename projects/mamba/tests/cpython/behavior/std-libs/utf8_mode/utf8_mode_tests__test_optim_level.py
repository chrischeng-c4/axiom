...
# lib = "utf8_mode"
# dimension = "behavior"
# case = "utf8_mode_tests__test_optim_level"
# subject = "cpython.test_utf8_mode.UTF8ModeTests.test_optim_level"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_utf8_mode.py::UTF8ModeTests::test_optim_level
"""Auto-ported test: UTF8ModeTests::test_optim_level (CPython 3.12 oracle)."""
...
out = get_output('-X', 'utf8', '-O', '-c', code)

assert out == '1'
out = get_output('-X', 'utf8', '-OO', '-c', code)

assert out == '2'
code = 'import sys; print(sys.flags.ignore_environment)'
out = get_output('-X', 'utf8', '-E', '-c', code)

assert out == '1'
print("UTF8ModeTests::test_optim_level: ok")
