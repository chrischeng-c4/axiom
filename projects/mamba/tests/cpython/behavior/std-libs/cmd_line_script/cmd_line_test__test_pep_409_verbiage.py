...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_pep_409_verbiage"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_pep_409_verbiage"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_pep_409_verbiage
"""Auto-ported test: CmdLineTest::test_pep_409_verbiage (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir:
    ...
    assert text[0].startswith('Traceback')

    assert text[1].startswith('  File ')

    assert text[3].startswith('NameError')
print("CmdLineTest::test_pep_409_verbiage: ok")
