...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_script_compiled"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_script_compiled"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_script_compiled
"""Auto-ported test: CmdLineTest::test_script_compiled (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir:
    ...
    _check_script(pyc_file, pyc_file, pyc_file, script_dir, None, importlib.machinery.SourcelessFileLoader)
print("CmdLineTest::test_script_compiled: ok")
