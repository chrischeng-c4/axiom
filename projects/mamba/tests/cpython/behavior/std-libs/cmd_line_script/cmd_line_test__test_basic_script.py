...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_basic_script"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_basic_script"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_basic_script
"""Auto-ported test: CmdLineTest::test_basic_script (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir:
    ...
    _check_script(script_name, script_name, script_name, script_dir, None, importlib.machinery.SourceFileLoader, expected_cwd=script_dir)
print("CmdLineTest::test_basic_script: ok")
