...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_module_in_subpackage_in_zipfile"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_module_in_subpackage_in_zipfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_module_in_subpackage_in_zipfile
"""Auto-ported test: CmdLineTest::test_module_in_subpackage_in_zipfile (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as script_dir:
    ...
    _check_script(['-m', 'test_pkg.test_pkg.script'], run_name, run_name, script_dir, 'test_pkg.test_pkg', zipimport.zipimporter, PYTHONPATH=zip_name, cwd=script_dir)
print("CmdLineTest::test_module_in_subpackage_in_zipfile: ok")
