...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_syntaxerror_null_bytes"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_syntaxerror_null_bytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_syntaxerror_null_bytes
"""Auto-ported test: CmdLineTest::test_syntaxerror_null_bytes (CPython 3.12 oracle)."""
...
# --- test body ---
script = "x = '\x00' nothing to see here\n';import os;os.system('echo pwnd')\n"
with os_helper.temp_dir() as script_dir:
    script_name = _make_test_script(script_dir, 'script', script)
    exitcode, stdout, stderr = assert_python_failure(script_name)

    assert stderr.splitlines()[-2:] == [b"    x = '", b'SyntaxError: source code cannot contain null bytes']
print("CmdLineTest::test_syntaxerror_null_bytes: ok")
