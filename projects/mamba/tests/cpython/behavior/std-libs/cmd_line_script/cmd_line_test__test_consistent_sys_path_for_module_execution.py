...
# lib = "cmd_line_script"
# dimension = "behavior"
# case = "cmd_line_test__test_consistent_sys_path_for_module_execution"
# subject = "cpython.test_cmd_line_script.CmdLineTest.test_consistent_sys_path_for_module_execution"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cmd_line_script.py::CmdLineTest::test_consistent_sys_path_for_module_execution
"""Auto-ported test: CmdLineTest::test_consistent_sys_path_for_module_execution (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as work_dir:
    ...
    assert out_by_module[0] == work_dir
    ...
    assert out_by_package == out_by_module
...
print("CmdLineTest::test_consistent_sys_path_for_module_execution: ok")
