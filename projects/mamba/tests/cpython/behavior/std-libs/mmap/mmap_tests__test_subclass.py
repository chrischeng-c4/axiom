...
# lib = "mmap"
# dimension = "behavior"
# case = "mmap_tests__test_subclass"
# subject = "cpython.test_mmap.MmapTests.test_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mmap.py::MmapTests::test_subclass
"""Auto-ported test: MmapTests::test_subclass (CPython 3.12 oracle)."""
...
anon_mmap(PAGESIZE)
print("MmapTests::test_subclass: ok")
