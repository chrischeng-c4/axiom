...
# lib = "mmap"
# dimension = "behavior"
# case = "mmap_tests__test_extended_getslice"
# subject = "cpython.test_mmap.MmapTests.test_extended_getslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mmap.py::MmapTests::test_extended_getslice
"""Auto-ported test: MmapTests::test_extended_getslice (CPython 3.12 oracle)."""
...
for start in indices:
    for stop in indices:
        for step in indices[1:]:
            ...
            assert m[start:stop:step] == s[start:stop:step]
print("MmapTests::test_extended_getslice: ok")
