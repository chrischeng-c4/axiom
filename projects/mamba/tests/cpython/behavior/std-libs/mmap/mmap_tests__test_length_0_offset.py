...
# lib = "mmap"
# dimension = "behavior"
# case = "mmap_tests__test_length_0_offset"
# subject = "cpython.test_mmap.MmapTests.test_length_0_offset"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mmap.py::MmapTests::test_length_0_offset
"""Auto-ported test: MmapTests::test_length_0_offset (CPython 3.12 oracle)."""
...
with open(TESTFN, 'rb') as f:
    with mmap.mmap(f.fileno(), 0, offset=65536, access=mmap.ACCESS_READ) as mf:
        ...
        try:
            mf.__getitem__(80000)
            raise AssertionError('expected IndexError')
        except IndexError:
            pass
print("MmapTests::test_length_0_offset: ok")
