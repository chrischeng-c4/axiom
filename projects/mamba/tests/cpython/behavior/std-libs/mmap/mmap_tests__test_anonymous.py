...
# lib = "mmap"
# dimension = "behavior"
# case = "mmap_tests__test_anonymous"
# subject = "cpython.test_mmap.MmapTests.test_anonymous"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mmap.py::MmapTests::test_anonymous
"""Auto-ported test: MmapTests::test_anonymous (CPython 3.12 oracle)."""
...
for x in range(PAGESIZE):
    ...
    assert m[x] == b
print("MmapTests::test_anonymous: ok")
