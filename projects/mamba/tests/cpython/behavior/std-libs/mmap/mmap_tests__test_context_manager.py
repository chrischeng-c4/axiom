...
# lib = "mmap"
# dimension = "behavior"
# case = "mmap_tests__test_context_manager"
# subject = "cpython.test_mmap.MmapTests.test_context_manager"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mmap.py::MmapTests::test_context_manager
"""Auto-ported test: MmapTests::test_context_manager (CPython 3.12 oracle)."""
...
assert m.closed
print("MmapTests::test_context_manager: ok")
