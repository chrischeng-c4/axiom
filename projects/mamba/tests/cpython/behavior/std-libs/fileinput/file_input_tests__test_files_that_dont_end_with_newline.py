...
# lib = "fileinput"
# dimension = "behavior"
# case = "file_input_tests__test_files_that_dont_end_with_newline"
# subject = "cpython.test_fileinput.FileInputTests.test_files_that_dont_end_with_newline"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::FileInputTests::test_files_that_dont_end_with_newline
"""Auto-ported test: FileInputTests::test_files_that_dont_end_with_newline (CPython 3.12 oracle)."""
...
assert fi.filelineno() == 3

assert fi.lineno() == 6
print("FileInputTests::test_files_that_dont_end_with_newline: ok")
