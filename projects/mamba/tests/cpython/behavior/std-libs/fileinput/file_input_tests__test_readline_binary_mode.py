...
# lib = "fileinput"
# dimension = "behavior"
# case = "file_input_tests__test_readline_binary_mode"
# subject = "cpython.test_fileinput.FileInputTests.test_readline_binary_mode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::FileInputTests::test_readline_binary_mode
"""Auto-ported test: FileInputTests::test_readline_binary_mode (CPython 3.12 oracle)."""
...
with FileInput(files=TESTFN, mode='rb') as fi:
    ...
    assert fi.readline() == b'A\n'

    assert fi.readline() == b'B\r\n'

    assert fi.readline() == b'C\rD'

    assert fi.readline() == b''

    assert fi.readline() == b''
print("FileInputTests::test_readline_binary_mode: ok")
