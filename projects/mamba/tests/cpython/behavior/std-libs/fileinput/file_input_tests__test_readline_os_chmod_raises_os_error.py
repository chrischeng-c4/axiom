...
# lib = "fileinput"
# dimension = "behavior"
# case = "file_input_tests__test_readline_os_chmod_raises_os_error"
# subject = "cpython.test_fileinput.FileInputTests.test_readline_os_chmod_raises_OSError"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::FileInputTests::test_readline_os_chmod_raises_OSError
"""Auto-ported test: FileInputTests::test_readline_os_chmod_raises_OSError (CPython 3.12 oracle)."""
...
assert os_chmod_replacement.invoked
print("FileInputTests::test_readline_os_chmod_raises_OSError: ok")
