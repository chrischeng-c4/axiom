...
# lib = "fileinput"
# dimension = "behavior"
# case = "file_input_tests__test_iteration_buffering"
# subject = "cpython.test_fileinput.FileInputTests.test_iteration_buffering"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::FileInputTests::test_iteration_buffering
"""Auto-ported test: FileInputTests::test_iteration_buffering (CPython 3.12 oracle)."""
...
with FileInput(files=['line1\nline2', 'line3\n'], openhook=src.openhook) as fi:
    ...
    assert next(fi) == 'line1\n'

    assert src.linesread == ['line1\n']

    assert next(fi) == 'line2'

    assert src.linesread == ['line2']

    assert next(fi) == 'line3\n'
    ...
    assert src.linesread == []
print("FileInputTests::test_iteration_buffering: ok")
