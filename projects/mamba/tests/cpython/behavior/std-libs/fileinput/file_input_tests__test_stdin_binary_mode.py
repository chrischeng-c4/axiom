...
# lib = "fileinput"
# dimension = "behavior"
# case = "file_input_tests__test_stdin_binary_mode"
# subject = "cpython.test_fileinput.FileInputTests.test_stdin_binary_mode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::FileInputTests::test_stdin_binary_mode
"""Auto-ported test: FileInputTests::test_stdin_binary_mode (CPython 3.12 oracle)."""
...
with mock.patch('sys.stdin') as m_stdin:
    ...
    assert lines == [b'spam, bacon, sausage, and spam']
print("FileInputTests::test_stdin_binary_mode: ok")
