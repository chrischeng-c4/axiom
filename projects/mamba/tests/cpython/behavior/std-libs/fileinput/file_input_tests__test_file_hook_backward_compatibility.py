...
# lib = "fileinput"
# dimension = "behavior"
# case = "file_input_tests__test_file_hook_backward_compatibility"
# subject = "cpython.test_fileinput.FileInputTests.test_file_hook_backward_compatibility"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::FileInputTests::test_file_hook_backward_compatibility
"""Auto-ported test: FileInputTests::test_file_hook_backward_compatibility (CPython 3.12 oracle)."""
...
assert result == 'I used to receive only filename and mode'
print("FileInputTests::test_file_hook_backward_compatibility: ok")
