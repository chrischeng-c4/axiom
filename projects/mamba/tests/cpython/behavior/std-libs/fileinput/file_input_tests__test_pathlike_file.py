...
# lib = "fileinput"
# dimension = "behavior"
# case = "file_input_tests__test_pathlike_file"
# subject = "cpython.test_fileinput.FileInputTests.test_pathlike_file"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::FileInputTests::test_pathlike_file
"""Auto-ported test: FileInputTests::test_pathlike_file (CPython 3.12 oracle)."""
...
with FileInput(t1, encoding='utf-8') as fi:
    ...
    assert fi.filename() == os.fspath(t1)
print("FileInputTests::test_pathlike_file: ok")
