...
# lib = "fileinput"
# dimension = "behavior"
# case = "test_fileinput_input__test_state_is_none"
# subject = "cpython.test_fileinput.Test_fileinput_input.test_state_is_None"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileinput.py::Test_fileinput_input::test_state_is_None
"""Auto-ported test: Test_fileinput_input::test_state_is_None (CPython 3.12 oracle)."""
...
def do_test_call_input():
    ...
    assert result is fileinput._state

    assert files is result.files

    assert inplace is result.inplace

    assert backup is result.backup

    assert mode is result.mode

    assert openhook is result.openhook
...
do_test_call_input()
print("Test_fileinput_input::test_state_is_None: ok")
