...
# lib = "fileinput"
# dimension = "behavior"
# case = "file_input_tests__test_invalid_opening_mode"
# subject = "cpython.test_fileinput.FileInputTests.test_invalid_opening_mode"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_fileinput.py::FileInputTests::test_invalid_opening_mode
"""Auto-ported test: FileInputTests::test_invalid_opening_mode (CPython 3.12 oracle)."""
...
for mode in ('w', 'rU', 'U'):
    try:
        ...
        pass
print("FileInputTests::test_invalid_opening_mode: ok")
