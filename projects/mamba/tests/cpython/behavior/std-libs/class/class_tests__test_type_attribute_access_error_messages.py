...
# lib = "class"
# dimension = "behavior"
# case = "class_tests__test_type_attribute_access_error_messages"
# subject = "cpython.test_class.ClassTests.testTypeAttributeAccessErrorMessages"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_class.py::ClassTests::testTypeAttributeAccessErrorMessages
"""Auto-ported test: ClassTests::testTypeAttributeAccessErrorMessages (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(error_msg, str(_aR_e))
print("ClassTests::testTypeAttributeAccessErrorMessages: ok")
