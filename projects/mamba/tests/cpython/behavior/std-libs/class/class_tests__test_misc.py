...
# lib = "class"
# dimension = "behavior"
# case = "class_tests__test_misc"
# subject = "cpython.test_class.ClassTests.testMisc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_class.py::ClassTests::testMisc
"""Auto-ported test: ClassTests::testMisc (CPython 3.12 oracle)."""
...
callLst[:] = []
testme == 1
assertCallStack([('__eq__', (testme, 1))])
callLst[:] = []
testme < 1
assertCallStack([('__lt__', (testme, 1))])
callLst[:] = []
testme > 1
assertCallStack([('__gt__', (testme, 1))])
callLst[:] = []
testme != 1
assertCallStack([('__ne__', (testme, 1))])
callLst[:] = []
1 == testme
