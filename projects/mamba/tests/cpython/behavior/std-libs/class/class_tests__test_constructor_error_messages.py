...
# lib = "class"
# dimension = "behavior"
# case = "class_tests__test_constructor_error_messages"
# subject = "cpython.test_class.ClassTests.testConstructorErrorMessages"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_class.py::ClassTests::testConstructorErrorMessages
"""Auto-ported test: ClassTests::testConstructorErrorMessages (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('C\\(\\) takes no arguments', str(_aR_e))
try:
    C.__new__(C, 42)
    raise AssertionError('expected TypeError')
except TypeError as _aR_e:
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(error_msg, str(_aR_e))
print("ClassTests::testConstructorErrorMessages: ok")
