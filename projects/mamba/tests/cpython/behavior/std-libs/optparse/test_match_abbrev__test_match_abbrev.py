...
# lib = "optparse"
# dimension = "behavior"
# case = "test_match_abbrev__test_match_abbrev"
# subject = "cpython.test_optparse.TestMatchAbbrev.test_match_abbrev"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_optparse.py::TestMatchAbbrev::test_match_abbrev
"""Auto-ported test: TestMatchAbbrev::test_match_abbrev (CPython 3.12 oracle)."""
...
assert _match_abbrev('--f', {'--foz': None, '--foo': None, '--fie': None, '--f': None}) == '--f'
print("TestMatchAbbrev::test_match_abbrev: ok")
