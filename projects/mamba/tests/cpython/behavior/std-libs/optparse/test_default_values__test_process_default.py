...
# lib = "optparse"
# dimension = "behavior"
# case = "test_default_values__test_process_default"
# subject = "cpython.test_optparse.TestDefaultValues.test_process_default"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_optparse.py::TestDefaultValues::test_process_default
"""Auto-ported test: TestDefaultValues::test_process_default (CPython 3.12 oracle)."""
...
self_parser.add_option('-v', '--verbose', default=True)
self_parser.add_option('-q', '--quiet', dest='verbose')
self_parser.add_option('-n', type='int', default=37)
self_parser.add_option('-m', type='int')
self_parser.add_option('-s', default='foo')
self_parser.add_option('-t')
self_parser.add_option('-u', default=None)
self_expected = {'verbose': True, 'n': 37, 'm': None, 's': 'foo', 't': None, 'u': None}
self_parser.option_class = DurationOption
self_parser.add_option('-d', type='duration', default=300)
self_parser.add_option('-e', type='duration', default='6m')
self_parser.set_defaults(n='42')
self_expected.update({'d': 300, 'e': 360, 'n': 42})

assert self_parser.get_default_values() == self_expected
self_parser.set_process_default_values(False)
self_expected.update({'d': 300, 'e': '6m', 'n': '42'})

assert self_parser.get_default_values() == self_expected
print("TestDefaultValues::test_process_default: ok")
