...
# lib = "optparse"
# dimension = "behavior"
# case = "test_option_group__test_group_manipulate"
# subject = "cpython.test_optparse.TestOptionGroup.test_group_manipulate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_optparse.py::TestOptionGroup::test_group_manipulate
"""Auto-ported test: TestOptionGroup::test_group_manipulate (CPython 3.12 oracle)."""
...
# --- test body ---
self_parser = OptionParser(usage=SUPPRESS_USAGE)
group = self_parser.add_option_group('Group 2', description='Some more options')
group.set_title('Bacon')
group.add_option('--bacon', type='int')

assert self_parser.get_option_group('--bacon')
print("TestOptionGroup::test_group_manipulate: ok")
