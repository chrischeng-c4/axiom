...
# lib = "optparse"
# dimension = "behavior"
# case = "test_default_values__test_mixed_defaults_post"
# subject = "cpython.test_optparse.TestDefaultValues.test_mixed_defaults_post"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_optparse.py::TestDefaultValues::test_mixed_defaults_post
"""Auto-ported test: TestDefaultValues::test_mixed_defaults_post (CPython 3.12 oracle)."""
...
self_parser.set_defaults(n=42, m=-100)
self_expected.update({'n': 42, 'm': -100})

assert self_parser.get_default_values() == self_expected
print("TestDefaultValues::test_mixed_defaults_post: ok")
