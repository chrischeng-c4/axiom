...
# lib = "optparse"
# dimension = "behavior"
# case = "test_choice__test_add_choice_option"
# subject = "cpython.test_optparse.TestChoice.test_add_choice_option"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_optparse.py::TestChoice::test_add_choice_option
"""Auto-ported test: TestChoice::test_add_choice_option (CPython 3.12 oracle)."""
...
self_parser.add_option('-c', action='store', type='choice', dest='choice', choices=['one', 'two', 'three'])
self_parser.add_option('-d', '--default', choices=['four', 'five', 'six'])
opt = self_parser.get_option('-d')

assert opt.type == 'choice'

assert opt.action == 'store'
print("TestChoice::test_add_choice_option: ok")
