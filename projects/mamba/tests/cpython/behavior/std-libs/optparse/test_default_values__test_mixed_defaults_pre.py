...
# lib = "optparse"
# dimension = "behavior"
# case = "test_default_values__test_mixed_defaults_pre"
# subject = "cpython.test_optparse.TestDefaultValues.test_mixed_defaults_pre"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_optparse.py::TestDefaultValues::test_mixed_defaults_pre
"""Auto-ported test: TestDefaultValues::test_mixed_defaults_pre (CPython 3.12 oracle)."""
...
self_parser.set_defaults(x='barf', y='blah')
self_parser.add_option('-x', default='frob')
self_parser.add_option('-y')
self_expected.update({'x': 'frob', 'y': 'blah'})

assert self_parser.get_default_values() == self_expected
self_parser.remove_option('-y')
self_parser.add_option('-y', default=None)
self_expected.update({'y': None})

assert self_parser.get_default_values() == self_expected
print("TestDefaultValues::test_mixed_defaults_pre: ok")
