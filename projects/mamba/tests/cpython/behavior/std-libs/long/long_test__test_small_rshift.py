...
# lib = "long"
# dimension = "behavior"
# case = "long_test__test_small_rshift"
# subject = "cpython.test_long.LongTest.test_small_rshift"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_long.py::LongTest::test_small_rshift
"""Auto-ported test: LongTest::test_small_rshift (CPython 3.12 oracle)."""
...
assert 2 ** 128 >> 1 == 2 ** 127

assert -2 ** 128 >> 1 == -2 ** 127

assert 2 ** 128 + 1 >> 1 == 2 ** 127

assert -(2 ** 128 + 1) >> 1 == -2 ** 127 - 1
print("LongTest::test_small_rshift: ok")
