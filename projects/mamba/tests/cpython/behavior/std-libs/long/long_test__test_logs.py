...
# lib = "long"
# dimension = "behavior"
# case = "long_test__test_logs"
# subject = "cpython.test_long.LongTest.test_logs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_long.py::LongTest::test_logs
"""Auto-ported test: LongTest::test_logs (CPython 3.12 oracle)."""
...
for exp in list(range(10)) + [100, 1000, 10000]:
    ...
    assert abs(log10 - exp) < 1e-07
    expected = exp / LOG10E
    log = math.log(value)

    assert abs(log - expected) < 1e-07
