...
# lib = "long"
# dimension = "behavior"
# case = "long_test__test_float_overflow"
# subject = "cpython.test_long.LongTest.test_float_overflow"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_long.py::LongTest::test_float_overflow
"""Auto-ported test: LongTest::test_float_overflow (CPython 3.12 oracle)."""
...
assert float(shuge) != int(shuge)
print("LongTest::test_float_overflow: ok")
