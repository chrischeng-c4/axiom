...
# lib = "long"
# dimension = "behavior"
# case = "long_test__test_pow_uses_cached_small_ints"
# subject = "cpython.test_long.LongTest.test_pow_uses_cached_small_ints"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_long.py::LongTest::test_pow_uses_cached_small_ints
"""Auto-ported test: LongTest::test_pow_uses_cached_small_ints (CPython 3.12 oracle)."""
...
assert pow(10, 3, 998) is 2

assert 10 ** 3 % 998 is 2
a, p, m = (10, 3, 998)

assert a ** p % m is 2

assert pow(2, 31, 2 ** 31 - 1) is 1

assert 2 ** 31 % (2 ** 31 - 1) is 1
a, p, m = (2, 31, 2 ** 31 - 1)

assert a ** p % m is 1

assert pow(2, 100, 2 ** 100 - 3) is 3

assert 2 ** 100 % (2 ** 100 - 3) is 3
a, p, m = (2, 100, 2 ** 100 - 3)

assert a ** p % m is 3
print("LongTest::test_pow_uses_cached_small_ints: ok")
