...
# lib = "csv"
# dimension = "behavior"
# case = "test_csv__test_read_oddinputs"
# subject = "cpython.test_csv.Test_Csv.test_read_oddinputs"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_csv.py::Test_Csv::test_read_oddinputs
"""Auto-ported test: Test_Csv::test_read_oddinputs (CPython 3.12 oracle)."""
...
try:
    _read_test([b'abc'], None)
    raise AssertionError('expected csv.Error')
except csv.Error:
    pass
print("Test_Csv::test_read_oddinputs: ok")
