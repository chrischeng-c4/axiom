...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_mh_to_babyl"
# subject = "cpython.test_mailbox.TestMessageConversion.test_mh_to_babyl"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_mh_to_babyl
"""Auto-ported test: TestMessageConversion::test_mh_to_babyl (CPython 3.12 oracle)."""
...
for setting, result in pairs:
    ...
    assert mailbox.BabylMessage(msg).get_labels() == result
msg = mailbox.MHMessage(_sample_message)
msg.add_sequence('unseen')
msg.add_sequence('replied')
msg.add_sequence('flagged')

assert mailbox.BabylMessage(msg).get_labels() == ['unseen', 'answered']
print("TestMessageConversion::test_mh_to_babyl: ok")
