...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_babyl_to_mboxmmdf"
# subject = "cpython.test_mailbox.TestMessageConversion.test_babyl_to_mboxmmdf"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_babyl_to_mboxmmdf
"""Auto-ported test: TestMessageConversion::test_babyl_to_mboxmmdf (CPython 3.12 oracle)."""
...
for setting, result in pairs:
    for class_ in (mailbox.mboxMessage, mailbox.MMDFMessage):
        ...
        assert class_(msg).get_flags() == result
msg = mailbox.BabylMessage(_sample_message)
for label in ('unseen', 'deleted', 'filed', 'answered', 'forwarded', 'edited', 'resent'):
    msg.add_label(label)
for class_ in (mailbox.mboxMessage, mailbox.MMDFMessage):

    assert class_(msg).get_flags() == 'ODA'
print("TestMessageConversion::test_babyl_to_mboxmmdf: ok")
