...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_mbox_message__test_initialize_with_unixfrom"
# subject = "cpython.test_mailbox.TestMboxMessage.test_initialize_with_unixfrom"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMboxMessage::test_initialize_with_unixfrom
"""Auto-ported test: TestMboxMessage::test_initialize_with_unixfrom (CPython 3.12 oracle)."""
...
assert msg.get_from() == 'foo@bar blah'

assert msg.get_unixfrom() == 'From foo@bar blah'
print("TestMboxMessage::test_initialize_with_unixfrom: ok")
