...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_mh_to_maildir"
# subject = "cpython.test_mailbox.TestMessageConversion.test_mh_to_maildir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_mh_to_maildir
"""Auto-ported test: TestMessageConversion::test_mh_to_maildir (CPython 3.12 oracle)."""
...
for setting, result in pairs:
    ...
    assert mailbox.MaildirMessage(msg).get_flags() == result

    assert mailbox.MaildirMessage(msg).get_subdir() == 'cur'
msg = mailbox.MHMessage(_sample_message)
msg.add_sequence('unseen')
msg.add_sequence('replied')
msg.add_sequence('flagged')

assert mailbox.MaildirMessage(msg).get_flags() == 'FR'

assert mailbox.MaildirMessage(msg).get_subdir() == 'cur'
print("TestMessageConversion::test_mh_to_maildir: ok")
