...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_mailbox_superclass__test_notimplemented"
# subject = "cpython.test_mailbox.TestMailboxSuperclass.test_notimplemented"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMailboxSuperclass::test_notimplemented
"""Auto-ported test: TestMailboxSuperclass::test_notimplemented (CPython 3.12 oracle)."""
...
try:
    (lambda: box.itervalues().__next__())()
    raise AssertionError('expected NotImplementedError')
except NotImplementedError:
    pass

try:
    (lambda: box.__iter__().__next__())()
    raise AssertionError('expected NotImplementedError')
except NotImplementedError:
    pass
...
try:
    (lambda: box.__getitem__(''))()
    raise AssertionError('expected NotImplementedError')
except NotImplementedError:
    pass

try:
    (lambda: box.get_message(''))()
    raise AssertionError('expected NotImplementedError')
except NotImplementedError:
    pass

try:
    (lambda: box.get_string(''))()
    raise AssertionError('expected NotImplementedError')
except NotImplementedError:
    pass

try:
    (lambda: box.get_bytes(''))()
    raise AssertionError('expected NotImplementedError')
except NotImplementedError:
    pass
...
try:
    ...
    pass
print("TestMailboxSuperclass::test_notimplemented: ok")
