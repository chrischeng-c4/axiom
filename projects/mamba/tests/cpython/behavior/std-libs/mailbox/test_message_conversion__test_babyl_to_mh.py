...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_babyl_to_mh"
# subject = "cpython.test_mailbox.TestMessageConversion.test_babyl_to_mh"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_babyl_to_mh
"""Auto-ported test: TestMessageConversion::test_babyl_to_mh (CPython 3.12 oracle)."""
...
for setting, result in pairs:
    ...
    assert mailbox.MHMessage(msg).get_sequences() == result
msg = mailbox.BabylMessage(_sample_message)
for label in ('unseen', 'deleted', 'filed', 'answered', 'forwarded', 'edited', 'resent'):
    msg.add_label(label)

assert mailbox.MHMessage(msg).get_sequences() == ['unseen', 'replied']
print("TestMessageConversion::test_babyl_to_mh: ok")
