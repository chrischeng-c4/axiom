...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_mboxmmdf_to_mboxmmdf"
# subject = "cpython.test_mailbox.TestMessageConversion.test_mboxmmdf_to_mboxmmdf"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_mboxmmdf_to_mboxmmdf
"""Auto-ported test: TestMessageConversion::test_mboxmmdf_to_mboxmmdf (CPython 3.12 oracle)."""
...
for class_ in (mailbox.mboxMessage, mailbox.MMDFMessage):
    ...
    assert msg_mboxMMDF.get_unixfrom() is None
    for class2_ in (mailbox.mboxMessage, mailbox.MMDFMessage):
        msg2 = class2_(msg_mboxMMDF)

        assert msg2.get_flags() == 'RODFA'

        assert msg2.get_from() == 'foo@bar'

        assert msg2.get_unixfrom() is None
print("TestMessageConversion::test_mboxmmdf_to_mboxmmdf: ok")
