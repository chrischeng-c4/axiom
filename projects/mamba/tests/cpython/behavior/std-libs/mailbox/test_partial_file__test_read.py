...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_partial_file__test_read"
# subject = "cpython.test_mailbox.TestPartialFile.test_read"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestPartialFile::test_read
"""Auto-ported test: TestPartialFile::test_read (CPython 3.12 oracle)."""
...
self__file.write(bytes('***bar***', 'ascii'))
_test_read(mailbox._PartialFile(self__file, 3, 6))
print("TestPartialFile::test_read: ok")
