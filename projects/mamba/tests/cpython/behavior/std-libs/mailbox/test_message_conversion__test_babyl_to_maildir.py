...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_message_conversion__test_babyl_to_maildir"
# subject = "cpython.test_mailbox.TestMessageConversion.test_babyl_to_maildir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestMessageConversion::test_babyl_to_maildir
"""Auto-ported test: TestMessageConversion::test_babyl_to_maildir (CPython 3.12 oracle)."""
...
assert mailbox.MaildirMessage(msg).get_flags() == 'PRT'

assert mailbox.MaildirMessage(msg).get_subdir() == 'cur'
print("TestMessageConversion::test_babyl_to_maildir: ok")
