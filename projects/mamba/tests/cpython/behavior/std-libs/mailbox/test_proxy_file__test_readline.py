...
# lib = "mailbox"
# dimension = "behavior"
# case = "test_proxy_file__test_readline"
# subject = "cpython.test_mailbox.TestProxyFile.test_readline"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_mailbox.py::TestProxyFile::test_readline
"""Auto-ported test: TestProxyFile::test_readline (CPython 3.12 oracle)."""
...
_test_readline(mailbox._ProxyFile(self__file))
print("TestProxyFile::test_readline: ok")
