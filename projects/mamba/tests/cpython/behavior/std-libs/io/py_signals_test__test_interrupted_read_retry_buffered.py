...
# lib = "io"
# dimension = "behavior"
# case = "py_signals_test__test_interrupted_read_retry_buffered"
# subject = "cpython.test_io.PySignalsTest.test_interrupted_read_retry_buffered"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_io.py::PySignalsTest::test_interrupted_read_retry_buffered
"""Auto-ported test: PySignalsTest::test_interrupted_read_retry_buffered (CPython 3.12 oracle)."""
...
check_interrupted_read_retry(lambda x: x.decode('latin1'), mode='rb')
print("PySignalsTest::test_interrupted_read_retry_buffered: ok")
