...
# lib = "io"
# dimension = "behavior"
# case = "test_ioc_types__test_stringio_setstate"
# subject = "cpython.test_io.TestIOCTypes.test_stringio_setstate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_io.py::TestIOCTypes::test_stringio_setstate
"""Auto-ported test: TestIOCTypes::test_stringio_setstate (CPython 3.12 oracle)."""
...
self_types = [_io.BufferedRWPair, _io.BufferedRandom, _io.BufferedReader, _io.BufferedWriter, _io.BytesIO, _io.FileIO, _io.IncrementalNewlineDecoder, _io.StringIO, _io.TextIOWrapper, _io._BufferedIOBase, _io._BytesIOBuffer, _io._IOBase, _io._RawIOBase, _io._TextIOBase]
if sys.platform == 'win32':
    self_types.append(_io._WindowsConsoleIO)
self__io = _io
obj = self__io.StringIO()
try:
    obj.__setstate__((1, '', 0, {}))
    raise AssertionError('expected TypeError')
except TypeError as _aR_e:
    import re as _re_aR
    assert _re_aR.search('initial_value must be str or None, not int', str(_aR_e))
obj.__setstate__((None, '', 0, {}))

assert obj.getvalue() == ''
obj.__setstate__(('', '', 0, {}))

assert obj.getvalue() == ''
print("TestIOCTypes::test_stringio_setstate: ok")
