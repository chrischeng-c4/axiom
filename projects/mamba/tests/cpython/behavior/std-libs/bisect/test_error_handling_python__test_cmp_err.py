...
# lib = "bisect"
# dimension = "behavior"
# case = "test_error_handling_python__test_cmp_err"
# subject = "cpython.test_bisect.TestErrorHandlingPython.test_cmp_err"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bisect.py::TestErrorHandlingPython::test_cmp_err
"""Auto-ported test: TestErrorHandlingPython::test_cmp_err (CPython 3.12 oracle)."""
...
for f in (module.bisect_left, module.bisect_right, module.insort_left, module.insort_right):
    ...
    try:
        ...
        pass
print("TestErrorHandlingPython::test_cmp_err: ok")
