...
# lib = "strptime"
# dimension = "behavior"
# case = "locale_time_tests__test_weekday"
# subject = "cpython.test_strptime.LocaleTime_Tests.test_weekday"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_strptime.py::LocaleTime_Tests::test_weekday
"""Auto-ported test: LocaleTime_Tests::test_weekday (CPython 3.12 oracle)."""
...
compare_against_time(self_LT_ins.f_weekday, '%A', 6, 'Testing of full weekday name failed')
compare_against_time(self_LT_ins.a_weekday, '%a', 6, 'Testing of abbreviated weekday name failed')
print("LocaleTime_Tests::test_weekday: ok")
