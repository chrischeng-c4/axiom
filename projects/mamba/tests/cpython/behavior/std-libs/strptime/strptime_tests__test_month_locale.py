...
# lib = "strptime"
# dimension = "behavior"
# case = "strptime_tests__test_month_locale"
# subject = "cpython.test_strptime.StrptimeTests.test_month_locale"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_strptime.py::StrptimeTests::test_month_locale
"""Auto-ported test: StrptimeTests::test_month_locale (CPython 3.12 oracle)."""
...
roundtrip('%b', 1)
for m in range(1, 13):
    roundtrip('%B', 1, (1900, m, 1, 0, 0, 0, 0, 1, 0))
    roundtrip('%b', 1, (1900, m, 1, 0, 0, 0, 0, 1, 0))
print("StrptimeTests::test_month_locale: ok")
