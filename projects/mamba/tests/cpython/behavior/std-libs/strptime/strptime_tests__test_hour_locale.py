...
# lib = "strptime"
# dimension = "behavior"
# case = "strptime_tests__test_hour_locale"
# subject = "cpython.test_strptime.StrptimeTests.test_hour_locale"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_strptime.py::StrptimeTests::test_hour_locale
"""Auto-ported test: StrptimeTests::test_hour_locale (CPython 3.12 oracle)."""
...
roundtrip('%I %p', 3)
print("StrptimeTests::test_hour_locale: ok")
