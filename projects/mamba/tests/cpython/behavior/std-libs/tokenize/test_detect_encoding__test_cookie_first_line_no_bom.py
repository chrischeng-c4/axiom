...
# lib = "tokenize"
# dimension = "behavior"
# case = "test_detect_encoding__test_cookie_first_line_no_bom"
# subject = "cpython.test_tokenize.TestDetectEncoding.test_cookie_first_line_no_bom"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TestDetectEncoding::test_cookie_first_line_no_bom
"""Auto-ported test: TestDetectEncoding::test_cookie_first_line_no_bom (CPython 3.12 oracle)."""
...
assert consumed_lines == [b'# -*- coding: latin-1 -*-\n']
print("TestDetectEncoding::test_cookie_first_line_no_bom: ok")
