...
# lib = "tokenize"
# dimension = "behavior"
# case = "c_tokenize_test__test_encoding"
# subject = "cpython.test_tokenize.CTokenizeTest.test_encoding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::CTokenizeTest::test_encoding
"""Auto-ported test: CTokenizeTest::test_encoding (CPython 3.12 oracle)."""
...
expected = [TokenInfo(type=NUMBER, string='1', start=(1, 0), end=(1, 1), line='1+1'), TokenInfo(type=OP, string='+', start=(1, 1), end=(1, 2), line='1+1'), TokenInfo(type=NUMBER, string='1', start=(1, 2), end=(1, 3), line='1+1'), TokenInfo(type=NEWLINE, string='', start=(1, 3), end=(1, 4), line='1+1'), TokenInfo(type=ENDMARKER, string='', start=(2, 0), end=(2, 0), line='')]
for encoding in ['utf-8', 'latin-1', 'utf-16']:
    tokens = list(_generate_tokens_from_c_tokenizer(readline(encoding).__next__, extra_tokens=True, encoding=encoding))

    assert tokens == expected
print("CTokenizeTest::test_encoding: ok")
