...
# lib = "tokenize"
# dimension = "behavior"
# case = "test_detect_encoding__test_open_error"
# subject = "cpython.test_tokenize.TestDetectEncoding.test_open_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TestDetectEncoding::test_open_error
"""Auto-ported test: TestDetectEncoding::test_open_error (CPython 3.12 oracle)."""
...
with mock.patch('tokenize._builtin_open', return_value=m):
    ...
    try:
        tokenize_open('foobar')
        raise AssertionError('expected SyntaxError')
    except SyntaxError:
        pass

assert m.closed
print("TestDetectEncoding::test_open_error: ok")
