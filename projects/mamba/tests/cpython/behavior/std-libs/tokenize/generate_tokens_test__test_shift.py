...
# lib = "tokenize"
# dimension = "behavior"
# case = "generate_tokens_test__test_shift"
# subject = "cpython.test_tokenize.GenerateTokensTest.test_shift"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::GenerateTokensTest::test_shift
"""Auto-ported test: GenerateTokensTest::test_shift (CPython 3.12 oracle)."""
...
check_tokenize('x = 1 << 1 >> 5', "    NAME       'x'           (1, 0) (1, 1)\n    OP         '='           (1, 2) (1, 3)\n    NUMBER     '1'           (1, 4) (1, 5)\n    OP         '<<'          (1, 6) (1, 8)\n    NUMBER     '1'           (1, 9) (1, 10)\n    OP         '>>'          (1, 11) (1, 13)\n    NUMBER     '5'           (1, 14) (1, 15)\n    ")
print("GenerateTokensTest::test_shift: ok")
