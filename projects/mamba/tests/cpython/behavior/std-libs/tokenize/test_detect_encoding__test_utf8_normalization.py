...
# lib = "tokenize"
# dimension = "behavior"
# case = "test_detect_encoding__test_utf8_normalization"
# subject = "cpython.test_tokenize.TestDetectEncoding.test_utf8_normalization"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TestDetectEncoding::test_utf8_normalization
"""Auto-ported test: TestDetectEncoding::test_utf8_normalization (CPython 3.12 oracle)."""
...
for encoding in encodings:
    for rep in ('-', '_'):
        ...
        assert found == 'utf-8'
print("TestDetectEncoding::test_utf8_normalization: ok")
