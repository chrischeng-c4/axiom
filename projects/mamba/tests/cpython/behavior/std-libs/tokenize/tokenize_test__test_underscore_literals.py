...
# lib = "tokenize"
# dimension = "behavior"
# case = "tokenize_test__test_underscore_literals"
# subject = "cpython.test_tokenize.TokenizeTest.test_underscore_literals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TokenizeTest::test_underscore_literals
"""Auto-ported test: TokenizeTest::test_underscore_literals (CPython 3.12 oracle)."""
...
for lit in INVALID_UNDERSCORE_LITERALS:
    ...
    assert number_token(lit) != lit
print("TokenizeTest::test_underscore_literals: ok")
