...
# lib = "tokenize"
# dimension = "behavior"
# case = "c_tokenize_test__test_async"
# subject = "cpython.test_tokenize.CTokenizeTest.test_async"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::CTokenizeTest::test_async
"""Auto-ported test: CTokenizeTest::test_async (CPython 3.12 oracle)."""
...
check_tokenize('async = 1', "    ASYNC      'async'       (1, 0) (1, 5)\n    EQUAL      '='           (1, 6) (1, 7)\n    NUMBER     '1'           (1, 8) (1, 9)\n    ")
check_tokenize('a = (async = 1)', "    NAME       'a'           (1, 0) (1, 1)\n    EQUAL      '='           (1, 2) (1, 3)\n    LPAR       '('           (1, 4) (1, 5)\n    ASYNC      'async'       (1, 5) (1, 10)\n    EQUAL      '='           (1, 11) (1, 12)\n    NUMBER     '1'           (1, 13) (1, 14)\n    RPAR       ')'           (1, 14) (1, 15)\n    ")
check_tokenize('async()', "    ASYNC      'async'       (1, 0) (1, 5)\n    LPAR       '('           (1, 5) (1, 6)\n    RPAR       ')'           (1, 6) (1, 7)\n    ")
...
check_tokenize('await = 1', "    AWAIT      'await'       (1, 0) (1, 5)\n    EQUAL      '='           (1, 6) (1, 7)\n    NUMBER     '1'           (1, 8) (1, 9)\n    ")
check_tokenize('foo.async', "    NAME       'foo'         (1, 0) (1, 3)\n    DOT        '.'           (1, 3) (1, 4)\n    ASYNC      'async'       (1, 4) (1, 9)\n    ")
check_tokenize('async for a in b: pass', "    ASYNC      'async'       (1, 0) (1, 5)\n    NAME       'for'         (1, 6) (1, 9)\n    NAME       'a'           (1, 10) (1, 11)\n    NAME       'in'          (1, 12) (1, 14)\n    NAME       'b'           (1, 15) (1, 16)\n    COLON      ':'           (1, 16) (1, 17)\n    NAME       'pass'        (1, 18) (1, 22)\n    ")
check_tokenize('async with a as b: pass', "    ASYNC      'async'       (1, 0) (1, 5)\n    NAME       'with'        (1, 6) (1, 10)\n    NAME       'a'           (1, 11) (1, 12)\n    NAME       'as'          (1, 13) (1, 15)\n    NAME       'b'           (1, 16) (1, 17)\n    COLON      ':'           (1, 17) (1, 18)\n    NAME       'pass'        (1, 19) (1, 23)\n    ")
check_tokenize('async.foo', "    ASYNC      'async'       (1, 0) (1, 5)\n    DOT        '.'           (1, 5) (1, 6)\n    NAME       'foo'         (1, 6) (1, 9)\n    ")
check_tokenize('async', "    ASYNC      'async'       (1, 0) (1, 5)\n    ")
check_tokenize('async\n#comment\nawait', "    ASYNC      'async'       (1, 0) (1, 5)\n    NEWLINE    ''            (1, 5) (1, 5)\n    AWAIT      'await'       (3, 0) (3, 5)\n    ")
check_tokenize('async\n...\nawait', "    ASYNC      'async'       (1, 0) (1, 5)\n    NEWLINE    ''            (1, 5) (1, 5)\n    ELLIPSIS   '...'         (2, 0) (2, 3)\n    NEWLINE    ''            (2, 3) (2, 3)\n    AWAIT      'await'       (3, 0) (3, 5)\n    ")
check_tokenize('async\nawait', "    ASYNC      'async'       (1, 0) (1, 5)\n    NEWLINE    ''            (1, 5) (1, 5)\n    AWAIT      'await'       (2, 0) (2, 5)\n    ")
check_tokenize('foo.async + 1', "    NAME       'foo'         (1, 0) (1, 3)\n    DOT        '.'           (1, 3) (1, 4)\n    ASYNC      'async'       (1, 4) (1, 9)\n    PLUS       '+'           (1, 10) (1, 11)\n    NUMBER     '1'           (1, 12) (1, 13)\n    ")
check_tokenize('async def foo(): pass', "    ASYNC      'async'       (1, 0) (1, 5)\n    NAME       'def'         (1, 6) (1, 9)\n    NAME       'foo'         (1, 10) (1, 13)\n    LPAR       '('           (1, 13) (1, 14)\n    RPAR       ')'           (1, 14) (1, 15)\n    COLON      ':'           (1, 15) (1, 16)\n    NAME       'pass'        (1, 17) (1, 21)\n    ")
check_tokenize('async def foo():\n  def foo(await):\n    await = 1\n  if 1:\n    await\nasync += 1\n', "    ASYNC      'async'       (1, 0) (1, 5)\n    NAME       'def'         (1, 6) (1, 9)\n    NAME       'foo'         (1, 10) (1, 13)\n    LPAR       '('           (1, 13) (1, 14)\n    RPAR       ')'           (1, 14) (1, 15)\n    COLON      ':'           (1, 15) (1, 16)\n    NEWLINE    ''            (1, 16) (1, 16)\n    INDENT     ''            (2, -1) (2, -1)\n    NAME       'def'         (2, 2) (2, 5)\n    NAME       'foo'         (2, 6) (2, 9)\n    LPAR       '('           (2, 9) (2, 10)\n    AWAIT      'await'       (2, 10) (2, 15)\n    RPAR       ')'           (2, 15) (2, 16)\n    COLON      ':'           (2, 16) (2, 17)\n    NEWLINE    ''            (2, 17) (2, 17)\n    INDENT     ''            (3, -1) (3, -1)\n    AWAIT      'await'       (3, 4) (3, 9)\n    EQUAL      '='           (3, 10) (3, 11)\n    NUMBER     '1'           (3, 12) (3, 13)\n    NEWLINE    ''            (3, 13) (3, 13)\n    DEDENT     ''            (4, -1) (4, -1)\n    NAME       'if'          (4, 2) (4, 4)\n    NUMBER     '1'           (4, 5) (4, 6)\n    COLON      ':'           (4, 6) (4, 7)\n    NEWLINE    ''            (4, 7) (4, 7)\n    INDENT     ''            (5, -1) (5, -1)\n    AWAIT      'await'       (5, 4) (5, 9)\n    NEWLINE    ''            (5, 9) (5, 9)\n    DEDENT     ''            (6, -1) (6, -1)\n    DEDENT     ''            (6, -1) (6, -1)\n    ASYNC      'async'       (6, 0) (6, 5)\n    PLUSEQUAL  '+='          (6, 6) (6, 8)\n    NUMBER     '1'           (6, 9) (6, 10)\n    NEWLINE    ''            (6, 10) (6, 10)\n    ")
check_tokenize('async def foo():\n  async for i in 1: pass', "    ASYNC      'async'       (1, 0) (1, 5)\n    NAME       'def'         (1, 6) (1, 9)\n    NAME       'foo'         (1, 10) (1, 13)\n    LPAR       '('           (1, 13) (1, 14)\n    RPAR       ')'           (1, 14) (1, 15)\n    COLON      ':'           (1, 15) (1, 16)\n    NEWLINE    ''            (1, 16) (1, 16)\n    INDENT     ''            (2, -1) (2, -1)\n    ASYNC      'async'       (2, 2) (2, 7)\n    NAME       'for'         (2, 8) (2, 11)\n    NAME       'i'           (2, 12) (2, 13)\n    NAME       'in'          (2, 14) (2, 16)\n    NUMBER     '1'           (2, 17) (2, 18)\n    COLON      ':'           (2, 18) (2, 19)\n    NAME       'pass'        (2, 20) (2, 24)\n    DEDENT     ''            (2, -1) (2, -1)\n    ")
check_tokenize('async def foo(async): await', "    ASYNC      'async'       (1, 0) (1, 5)\n    NAME       'def'         (1, 6) (1, 9)\n    NAME       'foo'         (1, 10) (1, 13)\n    LPAR       '('           (1, 13) (1, 14)\n    ASYNC      'async'       (1, 14) (1, 19)\n    RPAR       ')'           (1, 19) (1, 20)\n    COLON      ':'           (1, 20) (1, 21)\n    AWAIT      'await'       (1, 22) (1, 27)\n    ")
check_tokenize('def f():\n\n  def baz(): pass\n  async def bar(): pass\n\n  await = 2', "    NAME       'def'         (1, 0) (1, 3)\n    NAME       'f'           (1, 4) (1, 5)\n    LPAR       '('           (1, 5) (1, 6)\n    RPAR       ')'           (1, 6) (1, 7)\n    COLON      ':'           (1, 7) (1, 8)\n    NEWLINE    ''            (1, 8) (1, 8)\n    INDENT     ''            (3, -1) (3, -1)\n    NAME       'def'         (3, 2) (3, 5)\n    NAME       'baz'         (3, 6) (3, 9)\n    LPAR       '('           (3, 9) (3, 10)\n    RPAR       ')'           (3, 10) (3, 11)\n    COLON      ':'           (3, 11) (3, 12)\n    NAME       'pass'        (3, 13) (3, 17)\n    NEWLINE    ''            (3, 17) (3, 17)\n    ASYNC      'async'       (4, 2) (4, 7)\n    NAME       'def'         (4, 8) (4, 11)\n    NAME       'bar'         (4, 12) (4, 15)\n    LPAR       '('           (4, 15) (4, 16)\n    RPAR       ')'           (4, 16) (4, 17)\n    COLON      ':'           (4, 17) (4, 18)\n    NAME       'pass'        (4, 19) (4, 23)\n    NEWLINE    ''            (4, 23) (4, 23)\n    AWAIT      'await'       (6, 2) (6, 7)\n    EQUAL      '='           (6, 8) (6, 9)\n    NUMBER     '2'           (6, 10) (6, 11)\n    DEDENT     ''            (6, -1) (6, -1)\n    ")
check_tokenize('async def f():\n\n  def baz(): pass\n  async def bar(): pass\n\n  await = 2', "    ASYNC      'async'       (1, 0) (1, 5)\n    NAME       'def'         (1, 6) (1, 9)\n    NAME       'f'           (1, 10) (1, 11)\n    LPAR       '('           (1, 11) (1, 12)\n    RPAR       ')'           (1, 12) (1, 13)\n    COLON      ':'           (1, 13) (1, 14)\n    NEWLINE    ''            (1, 14) (1, 14)\n    INDENT     ''            (3, -1) (3, -1)\n    NAME       'def'         (3, 2) (3, 5)\n    NAME       'baz'         (3, 6) (3, 9)\n    LPAR       '('           (3, 9) (3, 10)\n    RPAR       ')'           (3, 10) (3, 11)\n    COLON      ':'           (3, 11) (3, 12)\n    NAME       'pass'        (3, 13) (3, 17)\n    NEWLINE    ''            (3, 17) (3, 17)\n    ASYNC      'async'       (4, 2) (4, 7)\n    NAME       'def'         (4, 8) (4, 11)\n    NAME       'bar'         (4, 12) (4, 15)\n    LPAR       '('           (4, 15) (4, 16)\n    RPAR       ')'           (4, 16) (4, 17)\n    COLON      ':'           (4, 17) (4, 18)\n    NAME       'pass'        (4, 19) (4, 23)\n    NEWLINE    ''            (4, 23) (4, 23)\n    AWAIT      'await'       (6, 2) (6, 7)\n    EQUAL      '='           (6, 8) (6, 9)\n    NUMBER     '2'           (6, 10) (6, 11)\n    DEDENT     ''            (6, -1) (6, -1)\n    ")
print("CTokenizeTest::test_async: ok")
