...
# lib = "tokenize"
# dimension = "behavior"
# case = "c_tokenize_test__test_string"
# subject = "cpython.test_tokenize.CTokenizeTest.test_string"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::CTokenizeTest::test_string
"""Auto-ported test: CTokenizeTest::test_string (CPython 3.12 oracle)."""
...
check_tokenize('f"{\na}"', '    FSTRING_START \'f"\'          (1, 0) (1, 2)\n    LBRACE     \'{\'           (1, 2) (1, 3)\n    NAME       \'a\'           (2, 0) (2, 1)\n    RBRACE     \'}\'           (2, 1) (2, 2)\n    FSTRING_END \'"\'           (2, 2) (2, 3)\n    ')
check_tokenize('Rf"abc\\\ndef"', '    FSTRING_START \'Rf"\'         (1, 0) (1, 3)\n    FSTRING_MIDDLE \'abc\\\\\\ndef\'  (1, 3) (2, 3)\n    FSTRING_END \'"\'           (2, 3) (2, 4)\n    ')
check_tokenize('f"hola\\\\\\r\\ndfgf"', '    FSTRING_START \'f"\'          (1, 0) (1, 2)\n    FSTRING_MIDDLE \'hola\\\\\\\\\\\\r\\\\ndfgf\' (1, 2) (1, 16)\n    FSTRING_END \'"\'           (1, 16) (1, 17)\n    ')
...
print("CTokenizeTest::test_string: ok")
