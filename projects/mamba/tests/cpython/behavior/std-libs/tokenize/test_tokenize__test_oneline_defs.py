...
# lib = "tokenize"
# dimension = "behavior"
# case = "test_tokenize__test_oneline_defs"
# subject = "cpython.test_tokenize.TestTokenize.test_oneline_defs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TestTokenize::test_oneline_defs
"""Auto-ported test: TestTokenize::test_oneline_defs (CPython 3.12 oracle)."""
...
assert toks[-3].string == 'OK'
print("TestTokenize::test_oneline_defs: ok")
