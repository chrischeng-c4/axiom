...
# lib = "tokenize"
# dimension = "behavior"
# case = "test_roundtrip__test_backslash_continuation"
# subject = "cpython.test_tokenize.TestRoundtrip.test_backslash_continuation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TestRoundtrip::test_backslash_continuation
"""Auto-ported test: TestRoundtrip::test_backslash_continuation (CPython 3.12 oracle)."""
...
check_roundtrip('x=1+\\\n1\n# This is a comment\\\n# This also\n')
check_roundtrip('# Comment \\\nx = 0')
print("TestRoundtrip::test_backslash_continuation: ok")
