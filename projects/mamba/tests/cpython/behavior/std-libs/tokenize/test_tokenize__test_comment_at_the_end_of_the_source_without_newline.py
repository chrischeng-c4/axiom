...
# lib = "tokenize"
# dimension = "behavior"
# case = "test_tokenize__test_comment_at_the_end_of_the_source_without_newline"
# subject = "cpython.test_tokenize.TestTokenize.test_comment_at_the_end_of_the_source_without_newline"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::TestTokenize::test_comment_at_the_end_of_the_source_without_newline
"""Auto-ported test: TestTokenize::test_comment_at_the_end_of_the_source_without_newline (CPython 3.12 oracle)."""
...
source = 'b = 1\n\n#test'
expected_tokens = [TokenInfo(type=token.ENCODING, string='utf-8', start=(0, 0), end=(0, 0), line=''), TokenInfo(type=token.NAME, string='b', start=(1, 0), end=(1, 1), line='b = 1\n'), TokenInfo(type=token.OP, string='=', start=(1, 2), end=(1, 3), line='b = 1\n'), TokenInfo(type=token.NUMBER, string='1', start=(1, 4), end=(1, 5), line='b = 1\n'), TokenInfo(type=token.NEWLINE, string='\n', start=(1, 5), end=(1, 6), line='b = 1\n'), TokenInfo(type=token.NL, string='\n', start=(2, 0), end=(2, 1), line='\n'), TokenInfo(type=token.COMMENT, string='#test', start=(3, 0), end=(3, 5), line='#test'), TokenInfo(type=token.NL, string='', start=(3, 5), end=(3, 6), line='#test'), TokenInfo(type=token.ENDMARKER, string='', start=(4, 0), end=(4, 0), line='')]
tokens = list(tokenize(BytesIO(source.encode('utf-8')).readline))

assert tokens == expected_tokens
print("TestTokenize::test_comment_at_the_end_of_the_source_without_newline: ok")
