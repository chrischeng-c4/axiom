...
# lib = "tokenize"
# dimension = "behavior"
# case = "c_tokenize_test__test_int"
# subject = "cpython.test_tokenize.CTokenizeTest.test_int"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tokenize.py::CTokenizeTest::test_int
"""Auto-ported test: CTokenizeTest::test_int (CPython 3.12 oracle)."""
...
check_tokenize('(-124561-1) & 200000000', "    LPAR       '('           (1, 0) (1, 1)\n    MINUS      '-'           (1, 1) (1, 2)\n    NUMBER     '124561'      (1, 2) (1, 8)\n    MINUS      '-'           (1, 8) (1, 9)\n    NUMBER     '1'           (1, 9) (1, 10)\n    RPAR       ')'           (1, 10) (1, 11)\n    AMPER      '&'           (1, 12) (1, 13)\n    NUMBER     '200000000'   (1, 14) (1, 23)\n    ")
...
print("CTokenizeTest::test_int: ok")
