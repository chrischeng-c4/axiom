...
# lib = "statistics"
# dimension = "behavior"
# case = "exact_ratio_test__test_fraction"
# subject = "cpython.test_statistics.ExactRatioTest.test_fraction"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::ExactRatioTest::test_fraction
"""Auto-ported test: ExactRatioTest::test_fraction (CPython 3.12 oracle)."""
...
for n in numerators:
    ...
    assert statistics._exact_ratio(f) == (n, 37)
print("ExactRatioTest::test_fraction: ok")
