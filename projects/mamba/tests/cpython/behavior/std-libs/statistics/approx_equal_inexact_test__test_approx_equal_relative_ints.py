...
# lib = "statistics"
# dimension = "behavior"
# case = "approx_equal_inexact_test__test_approx_equal_relative_ints"
# subject = "cpython.test_statistics.ApproxEqualInexactTest.test_approx_equal_relative_ints"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::ApproxEqualInexactTest::test_approx_equal_relative_ints
"""Auto-ported test: ApproxEqualInexactTest::test_approx_equal_relative_ints (CPython 3.12 oracle)."""
...
assert approx_equal(64, 47, tol=0, rel=0.36)

assert approx_equal(64, 47, tol=0, rel=0.37)

assert approx_equal(449, 512, tol=0, rel=0.125)

assert approx_equal(448, 512, tol=0, rel=0.125)

assert not approx_equal(447, 512, tol=0, rel=0.125)
print("ApproxEqualInexactTest::test_approx_equal_relative_ints: ok")
