...
# lib = "statistics"
# dimension = "behavior"
# case = "decimal_to_ratio_test__test_nan"
# subject = "cpython.test_statistics.DecimalToRatioTest.test_nan"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::DecimalToRatioTest::test_nan
"""Auto-ported test: DecimalToRatioTest::test_nan (CPython 3.12 oracle)."""
...
for nan in (Decimal('NAN'), Decimal('sNAN')):
    ...
    assert _nan_equal(num, nan)

    assert den is None
print("DecimalToRatioTest::test_nan: ok")
