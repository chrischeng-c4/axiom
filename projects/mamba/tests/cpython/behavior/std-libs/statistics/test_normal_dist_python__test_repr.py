...
# lib = "statistics"
# dimension = "behavior"
# case = "test_normal_dist_python__test_repr"
# subject = "cpython.test_statistics.TestNormalDistPython.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::TestNormalDistPython::test_repr
"""Auto-ported test: TestNormalDistPython::test_repr (CPython 3.12 oracle)."""
...
assert repr(nd) == 'NormalDist(mu=37.5, sigma=5.625)'
print("TestNormalDistPython::test_repr: ok")
