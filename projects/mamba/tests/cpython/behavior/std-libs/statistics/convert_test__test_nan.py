...
# lib = "statistics"
# dimension = "behavior"
# case = "convert_test__test_nan"
# subject = "cpython.test_statistics.ConvertTest.test_nan"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::ConvertTest::test_nan
"""Auto-ported test: ConvertTest::test_nan (CPython 3.12 oracle)."""
...
for nan in (float('nan'), Decimal('NAN'), Decimal('sNAN')):
    ...
    assert _nan_equal(x, nan)
print("ConvertTest::test_nan: ok")
