...
# lib = "statistics"
# dimension = "behavior"
# case = "exact_ratio_test__test_int"
# subject = "cpython.test_statistics.ExactRatioTest.test_int"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::ExactRatioTest::test_int
"""Auto-ported test: ExactRatioTest::test_int (CPython 3.12 oracle)."""
...
for i in (-20, -3, 0, 5, 99, 10 ** 20):
    ...
    assert statistics._exact_ratio(i) == (i, 1)
print("ExactRatioTest::test_int: ok")
