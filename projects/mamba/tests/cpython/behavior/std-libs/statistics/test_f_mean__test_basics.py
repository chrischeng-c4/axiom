...
# lib = "statistics"
# dimension = "behavior"
# case = "test_f_mean__test_basics"
# subject = "cpython.test_statistics.TestFMean.test_basics"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::TestFMean::test_basics
"""Auto-ported test: TestFMean::test_basics (CPython 3.12 oracle)."""
...
for data, expected_mean, kind in [([3.5, 4.0, 5.25], 4.25, 'floats'), ([D('3.5'), D('4.0'), D('5.25')], 4.25, 'decimals'), ([F(7, 2), F(4, 1), F(21, 4)], 4.25, 'fractions'), ([True, False, True, True, False], 0.6, 'booleans'), ([3.5, 4, F(21, 4)], 4.25, 'mixed types'), ((3.5, 4.0, 5.25), 4.25, 'tuple'), (iter([3.5, 4.0, 5.25]), 4.25, 'iterator')]:
    ...
    assert type(actual_mean) is float

    assert actual_mean == expected_mean
print("TestFMean::test_basics: ok")
