...
# lib = "statistics"
# dimension = "behavior"
# case = "coerce_test__test_bool"
# subject = "cpython.test_statistics.CoerceTest.test_bool"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::CoerceTest::test_bool
"""Auto-ported test: CoerceTest::test_bool (CPython 3.12 oracle)."""
...
for T in (int, float, Fraction, Decimal):
    ...
    assert statistics._coerce(T, bool) is T

    class MyClass(T):
        pass

    assert statistics._coerce(MyClass, bool) is MyClass
print("CoerceTest::test_bool: ok")
