...
# lib = "statistics"
# dimension = "behavior"
# case = "test_sum__test_mixed_sum"
# subject = "cpython.test_statistics.TestSum.test_mixed_sum"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::TestSum::test_mixed_sum
"""Auto-ported test: TestSum::test_mixed_sum (CPython 3.12 oracle)."""
...
# --- test body ---
self_func = statistics._sum

try:
    self_func([1, 2.0, Decimal(1)])
...
try:
    ...
    pass
print("TestSum::test_mixed_sum: ok")
