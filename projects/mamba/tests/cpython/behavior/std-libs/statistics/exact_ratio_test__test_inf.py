...
# lib = "statistics"
# dimension = "behavior"
# case = "exact_ratio_test__test_inf"
# subject = "cpython.test_statistics.ExactRatioTest.test_inf"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::ExactRatioTest::test_inf
"""Auto-ported test: ExactRatioTest::test_inf (CPython 3.12 oracle)."""
...
for inf in (INF, -INF):
    for type_ in (float, MyFloat, Decimal, MyDecimal):
        ...
        assert type(ratio[0]) == type_

        assert math.isinf(ratio[0])
print("ExactRatioTest::test_inf: ok")
