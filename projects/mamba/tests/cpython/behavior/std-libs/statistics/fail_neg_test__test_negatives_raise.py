...
# lib = "statistics"
# dimension = "behavior"
# case = "fail_neg_test__test_negatives_raise"
# subject = "cpython.test_statistics.FailNegTest.test_negatives_raise"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::FailNegTest::test_negatives_raise
"""Auto-ported test: FailNegTest::test_negatives_raise (CPython 3.12 oracle)."""
...
for x in [1, 2.0, Fraction(3), Decimal(4)]:
    ...
    try:
        ...
        pass
print("FailNegTest::test_negatives_raise: ok")
