...
# lib = "statistics"
# dimension = "behavior"
# case = "approx_equal_specials_test__test_inf"
# subject = "cpython.test_statistics.ApproxEqualSpecialsTest.test_inf"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::ApproxEqualSpecialsTest::test_inf
"""Auto-ported test: ApproxEqualSpecialsTest::test_inf (CPython 3.12 oracle)."""
...
for type_ in (float, Decimal):
    ...
    assert approx_equal(inf, inf)

    assert approx_equal(inf, inf, 0, 0)

    assert approx_equal(inf, inf, 1, 0.01)

    assert approx_equal(-inf, -inf)

    assert not approx_equal(inf, -inf)

    assert not approx_equal(inf, 1000)
print("ApproxEqualSpecialsTest::test_inf: ok")
