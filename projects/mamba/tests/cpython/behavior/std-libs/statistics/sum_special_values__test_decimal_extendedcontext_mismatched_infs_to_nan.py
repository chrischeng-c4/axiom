...
# lib = "statistics"
# dimension = "behavior"
# case = "sum_special_values__test_decimal_extendedcontext_mismatched_infs_to_nan"
# subject = "cpython.test_statistics.SumSpecialValues.test_decimal_extendedcontext_mismatched_infs_to_nan"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_statistics.py::SumSpecialValues::test_decimal_extendedcontext_mismatched_infs_to_nan
"""Auto-ported test: SumSpecialValues::test_decimal_extendedcontext_mismatched_infs_to_nan (CPython 3.12 oracle)."""
...
with decimal.localcontext(decimal.ExtendedContext):
    ...
    assert math.isnan(statistics._sum(data)[1])
print("SumSpecialValues::test_decimal_extendedcontext_mismatched_infs_to_nan: ok")
