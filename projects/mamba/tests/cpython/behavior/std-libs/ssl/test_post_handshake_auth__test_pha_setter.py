...
# lib = "ssl"
# dimension = "behavior"
# case = "test_post_handshake_auth__test_pha_setter"
# subject = "cpython.test_ssl.TestPostHandshakeAuth.test_pha_setter"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::TestPostHandshakeAuth::test_pha_setter
"""Auto-ported test: TestPostHandshakeAuth::test_pha_setter (CPython 3.12 oracle)."""
...
for protocol in protocols:
    ...
    assert ctx.post_handshake_auth == False
    ctx.post_handshake_auth = True

    assert ctx.post_handshake_auth == True
    ...
    assert ctx.post_handshake_auth == True
print("TestPostHandshakeAuth::test_pha_setter: ok")
