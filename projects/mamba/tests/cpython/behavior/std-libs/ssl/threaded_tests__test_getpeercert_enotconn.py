...
# lib = "ssl"
# dimension = "behavior"
# case = "threaded_tests__test_getpeercert_enotconn"
# subject = "cpython.test_ssl.ThreadedTests.test_getpeercert_enotconn"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::ThreadedTests::test_getpeercert_enotconn
"""Auto-ported test: ThreadedTests::test_getpeercert_enotconn (CPython 3.12 oracle)."""
...
with context.wrap_socket(socket.socket()) as sock:
    ...
    assert cm.exception.errno == errno.ENOTCONN
print("ThreadedTests::test_getpeercert_enotconn: ok")
