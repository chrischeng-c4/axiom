...
# lib = "ssl"
# dimension = "behavior"
# case = "test_enumerations__test_sslerrornumber"
# subject = "cpython.test_ssl.TestEnumerations.test_sslerrornumber"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::TestEnumerations::test_sslerrornumber
"""Auto-ported test: TestEnumerations::test_sslerrornumber (CPython 3.12 oracle)."""
...
# --- test body ---
Checked_SSLErrorNumber = enum._old_convert_(enum.IntEnum, 'SSLErrorNumber', 'ssl', lambda name: name.startswith('SSL_ERROR_'), source=ssl._ssl)
enum._test_simple_enum(Checked_SSLErrorNumber, ssl.SSLErrorNumber)
print("TestEnumerations::test_sslerrornumber: ok")
