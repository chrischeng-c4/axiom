...
# lib = "ssl"
# dimension = "behavior"
# case = "context_tests__test_verify_flags"
# subject = "cpython.test_ssl.ContextTests.test_verify_flags"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::ContextTests::test_verify_flags
"""Auto-ported test: ContextTests::test_verify_flags (CPython 3.12 oracle)."""
...
assert ctx.verify_flags == ssl.VERIFY_DEFAULT | tf
...
assert ctx.verify_flags == ssl.VERIFY_ALLOW_PROXY_CERTS
ctx.verify_flags = ssl.VERIFY_CRL_CHECK_LEAF | ssl.VERIFY_X509_STRICT

assert ctx.verify_flags == ssl.VERIFY_CRL_CHECK_LEAF | ssl.VERIFY_X509_STRICT
try:
    ctx.verify_flags = None
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("ContextTests::test_verify_flags: ok")
