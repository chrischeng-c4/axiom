...
# lib = "ssl"
# dimension = "behavior"
# case = "basic_socket_tests__test_options"
# subject = "cpython.test_ssl.BasicSocketTests.test_options"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::BasicSocketTests::test_options
"""Auto-ported test: BasicSocketTests::test_options (CPython 3.12 oracle)."""
...
for name in dir(ssl):
    ...
    assert value >= 0
print("BasicSocketTests::test_options: ok")
