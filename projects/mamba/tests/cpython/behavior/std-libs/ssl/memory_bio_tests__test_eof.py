...
# lib = "ssl"
# dimension = "behavior"
# case = "memory_bio_tests__test_eof"
# subject = "cpython.test_ssl.MemoryBIOTests.test_eof"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::MemoryBIOTests::test_eof
"""Auto-ported test: MemoryBIOTests::test_eof (CPython 3.12 oracle)."""
...
assert bio.read(2) == b'fo'

assert not bio.eof

assert bio.read(1) == b'o'
...
assert bio.eof
print("MemoryBIOTests::test_eof: ok")
