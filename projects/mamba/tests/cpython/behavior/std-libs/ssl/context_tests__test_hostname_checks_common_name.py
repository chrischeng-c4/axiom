...
# lib = "ssl"
# dimension = "behavior"
# case = "context_tests__test_hostname_checks_common_name"
# subject = "cpython.test_ssl.ContextTests.test_hostname_checks_common_name"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::ContextTests::test_hostname_checks_common_name
"""Auto-ported test: ContextTests::test_hostname_checks_common_name (CPython 3.12 oracle)."""
...
assert ctx.hostname_checks_common_name
if ssl.HAS_NEVER_CHECK_COMMON_NAME:
    ...
    assert not ctx.hostname_checks_common_name
    ctx.hostname_checks_common_name = True
    ...
    try:
        ...
        pass
print("ContextTests::test_hostname_checks_common_name: ok")
