...
# lib = "ssl"
# dimension = "behavior"
# case = "context_tests__test_session_stats"
# subject = "cpython.test_ssl.ContextTests.test_session_stats"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::ContextTests::test_session_stats
"""Auto-ported test: ContextTests::test_session_stats (CPython 3.12 oracle)."""
...
for proto in {ssl.PROTOCOL_TLS_CLIENT, ssl.PROTOCOL_TLS_SERVER}:
    ...
    assert ctx.session_stats() == {'number': 0, 'connect': 0, 'connect_good': 0, 'connect_renegotiate': 0, 'accept': 0, 'accept_good': 0, 'accept_renegotiate': 0, 'hits': 0, 'misses': 0, 'timeouts': 0, 'cache_full': 0}
print("ContextTests::test_session_stats: ok")
