...
# lib = "ssl"
# dimension = "behavior"
# case = "basic_socket_tests__test_unsupported_dtls"
# subject = "cpython.test_ssl.BasicSocketTests.test_unsupported_dtls"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::BasicSocketTests::test_unsupported_dtls
"""Auto-ported test: BasicSocketTests::test_unsupported_dtls (CPython 3.12 oracle)."""
...
assert str(cx.exception) == 'only stream sockets are supported'
ctx = ssl.SSLContext(ssl.PROTOCOL_TLS_CLIENT)
try:
    ctx.wrap_socket(s)
    raise AssertionError('expected NotImplementedError')
...
assert str(cx.exception) == 'only stream sockets are supported'
print("BasicSocketTests::test_unsupported_dtls: ok")
