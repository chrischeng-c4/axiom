...
# lib = "ssl"
# dimension = "behavior"
# case = "basic_socket_tests__test_cert_time_to_seconds"
# subject = "cpython.test_ssl.BasicSocketTests.test_cert_time_to_seconds"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::BasicSocketTests::test_cert_time_to_seconds
"""Auto-ported test: BasicSocketTests::test_cert_time_to_seconds (CPython 3.12 oracle)."""
...
def bad_cert_test(certfile):
    ...
    certfile = os.path.join(os.path.dirname(__file__) or os.curdir, 'certdata', certfile)
    sock = socket.socket()
    pass
    try:
        test_wrap_socket(sock, certfile=certfile)
        raise AssertionError('expected ssl.SSLError')
    except ssl.SSLError:
        pass

def cert_time_fail(timestring):
    try:
...
def cert_time_ok(timestring, timestamp):

    assert ssl.cert_time_to_seconds(timestring) == timestamp
timestring = 'Jan  5 09:34:43 2018 GMT'
ts = 1515144883.0
cert_time_ok(timestring, ts)

assert ssl.cert_time_to_seconds(cert_time=timestring) == ts
cert_time_ok('Jan 05 09:34:43 2018 GMT', ts)
cert_time_ok('JaN  5 09:34:43 2018 GmT', ts)
cert_time_fail('Jan  5 09:34 2018 GMT')
cert_time_fail('Jan  5 09:34:43 2018')
cert_time_fail('Jan  5 09:34:43 2018 UTC')
cert_time_fail('Jan 35 09:34:43 2018 GMT')
cert_time_fail('Jon  5 09:34:43 2018 GMT')
cert_time_fail('Jan  5 24:00:00 2018 GMT')
cert_time_fail('Jan  5 09:60:43 2018 GMT')
newyear_ts = 1230768000.0
cert_time_ok('Dec 31 23:59:60 2008 GMT', newyear_ts)
cert_time_ok('Jan  1 00:00:00 2009 GMT', newyear_ts)
cert_time_ok('Jan  5 09:34:59 2018 GMT', 1515144899)
cert_time_ok('Jan  5 09:34:60 2018 GMT', 1515144900)
cert_time_ok('Jan  5 09:34:61 2018 GMT', 1515144901)
cert_time_fail('Jan  5 09:34:62 2018 GMT')
cert_time_ok('Dec 31 23:59:59 9999 GMT', 253402300799.0)
print("BasicSocketTests::test_cert_time_to_seconds: ok")
