...
# lib = "ssl"
# dimension = "behavior"
# case = "basic_socket_tests__test_server_side"
# subject = "cpython.test_ssl.BasicSocketTests.test_server_side"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ssl.py::BasicSocketTests::test_server_side
"""Auto-ported test: BasicSocketTests::test_server_side (CPython 3.12 oracle)."""
...
with socket.socket() as sock:
    ...
    try:
        ctx.wrap_socket(sock, True, server_hostname='some.hostname')
        raise AssertionError('expected ValueError')
    except ValueError:
        pass
print("BasicSocketTests::test_server_side: ok")
