...
# lib = "functools"
# dimension = "behavior"
# case = "test_single_dispatch__test_abstractmethod_register"
# subject = "cpython.test_functools.TestSingleDispatch.test_abstractmethod_register"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestSingleDispatch::test_abstractmethod_register
"""Auto-ported test: TestSingleDispatch::test_abstractmethod_register (CPython 3.12 oracle)."""
...
assert Abstract.__dict__['add'].__isabstractmethod__
try:
    Abstract()
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("TestSingleDispatch::test_abstractmethod_register: ok")
