...
# lib = "functools"
# dimension = "behavior"
# case = "test_single_dispatch__test_staticmethod_type_ann_register"
# subject = "cpython.test_functools.TestSingleDispatch.test_staticmethod_type_ann_register"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestSingleDispatch::test_staticmethod_type_ann_register
"""Auto-ported test: TestSingleDispatch::test_staticmethod_type_ann_register (CPython 3.12 oracle)."""
...
assert A.t(0.0) == 0.0
print("TestSingleDispatch::test_staticmethod_type_ann_register: ok")
