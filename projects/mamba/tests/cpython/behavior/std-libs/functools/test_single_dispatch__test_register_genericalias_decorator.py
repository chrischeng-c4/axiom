...
# lib = "functools"
# dimension = "behavior"
# case = "test_single_dispatch__test_register_genericalias_decorator"
# subject = "cpython.test_functools.TestSingleDispatch.test_register_genericalias_decorator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestSingleDispatch::test_register_genericalias_decorator
"""Auto-ported test: TestSingleDispatch::test_register_genericalias_decorator (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Invalid first argument to ', str(_aR_e))
try:
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Invalid first argument to ', str(_aR_e))
print("TestSingleDispatch::test_register_genericalias_decorator: ok")
