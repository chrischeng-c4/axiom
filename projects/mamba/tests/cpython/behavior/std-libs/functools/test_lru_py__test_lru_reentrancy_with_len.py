...
# lib = "functools"
# dimension = "behavior"
# case = "test_lru_py__test_lru_reentrancy_with_len"
# subject = "cpython.test_functools.TestLRUPy.test_lru_reentrancy_with_len"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestLRUPy::test_lru_reentrancy_with_len
"""Auto-ported test: TestLRUPy::test_lru_reentrancy_with_len (CPython 3.12 oracle)."""
...
try:
    builtins.len = module.lru_cache(4)(len)
    for i in [0, 0, 1, 2, 3, 3, 4, 5, 6, 1, 7, 2, 1]:

        assert len('abcdefghijklmn'[:i]) == i
finally:
    builtins.len = old_len
print("TestLRUPy::test_lru_reentrancy_with_len: ok")
