...
# lib = "functools"
# dimension = "behavior"
# case = "test_single_dispatch__test_register_genericalias"
# subject = "cpython.test_functools.TestSingleDispatch.test_register_genericalias"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestSingleDispatch::test_register_genericalias
"""Auto-ported test: TestSingleDispatch::test_register_genericalias (CPython 3.12 oracle)."""
...
assert f(b'') == 'default'
print("TestSingleDispatch::test_register_genericalias: ok")
