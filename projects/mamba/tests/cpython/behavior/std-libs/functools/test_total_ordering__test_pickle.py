...
# lib = "functools"
# dimension = "behavior"
# case = "test_total_ordering__test_pickle"
# subject = "cpython.test_functools.TestTotalOrdering.test_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestTotalOrdering::test_pickle
"""Auto-ported test: TestTotalOrdering::test_pickle (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    for name in ('__lt__', '__gt__', '__le__', '__ge__'):
        ...
        assert method_copy is method
print("TestTotalOrdering::test_pickle: ok")
