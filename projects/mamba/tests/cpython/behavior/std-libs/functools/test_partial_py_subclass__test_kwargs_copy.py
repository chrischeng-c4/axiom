...
# lib = "functools"
# dimension = "behavior"
# case = "test_partial_py_subclass__test_kwargs_copy"
# subject = "cpython.test_functools.TestPartialPySubclass.test_kwargs_copy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestPartialPySubclass::test_kwargs_copy
"""Auto-ported test: TestPartialPySubclass::test_kwargs_copy (CPython 3.12 oracle)."""
...
assert p() == ((), {'a': 3})
print("TestPartialPySubclass::test_kwargs_copy: ok")
