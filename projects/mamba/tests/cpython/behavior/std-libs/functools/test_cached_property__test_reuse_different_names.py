...
# lib = "functools"
# dimension = "behavior"
# case = "test_cached_property__test_reuse_different_names"
# subject = "cpython.test_functools.TestCachedProperty.test_reuse_different_names"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestCachedProperty::test_reuse_different_names
"""Auto-ported test: TestCachedProperty::test_reuse_different_names (CPython 3.12 oracle)."""
...
assert str(ctx.exception) == str(TypeError("Cannot assign the same cached_property to two different names ('a' and 'b')."))
print("TestCachedProperty::test_reuse_different_names: ok")
