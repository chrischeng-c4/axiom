...
# lib = "functools"
# dimension = "behavior"
# case = "test_total_ordering__test_total_ordering_no_overwrite"
# subject = "cpython.test_functools.TestTotalOrdering.test_total_ordering_no_overwrite"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestTotalOrdering::test_total_ordering_no_overwrite
"""Auto-ported test: TestTotalOrdering::test_total_ordering_no_overwrite (CPython 3.12 oracle)."""
...
assert A(2) >= A(2)
print("TestTotalOrdering::test_total_ordering_no_overwrite: ok")
