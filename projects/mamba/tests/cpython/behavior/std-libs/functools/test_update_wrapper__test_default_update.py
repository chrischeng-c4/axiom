...
# lib = "functools"
# dimension = "behavior"
# case = "test_update_wrapper__test_default_update"
# subject = "cpython.test_functools.TestUpdateWrapper.test_default_update"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestUpdateWrapper::test_default_update
"""Auto-ported test: TestUpdateWrapper::test_default_update (CPython 3.12 oracle)."""
...
wrapper, f = _default_update()
check_wrapper(wrapper, f)
T, = f.__type_params__

assert wrapper.__wrapped__ is f
...
assert wrapper.__annotations__['a'] == 'This is a new annotation'

assert 'b' not in wrapper.__annotations__

assert wrapper.__type_params__ == (T,)
print("TestUpdateWrapper::test_default_update: ok")
