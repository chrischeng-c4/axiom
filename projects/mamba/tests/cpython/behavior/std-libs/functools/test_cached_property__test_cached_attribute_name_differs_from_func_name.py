...
# lib = "functools"
# dimension = "behavior"
# case = "test_cached_property__test_cached_attribute_name_differs_from_func_name"
# subject = "cpython.test_functools.TestCachedProperty.test_cached_attribute_name_differs_from_func_name"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestCachedProperty::test_cached_attribute_name_differs_from_func_name
"""Auto-ported test: TestCachedProperty::test_cached_attribute_name_differs_from_func_name (CPython 3.12 oracle)."""
...
assert item.cached_cost == 3
print("TestCachedProperty::test_cached_attribute_name_differs_from_func_name: ok")
