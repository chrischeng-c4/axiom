...
# lib = "functools"
# dimension = "behavior"
# case = "test_lru_py__test_lru_cache_decoration"
# subject = "cpython.test_functools.TestLRUPy.test_lru_cache_decoration"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestLRUPy::test_lru_cache_decoration
"""Auto-ported test: TestLRUPy::test_lru_cache_decoration (CPython 3.12 oracle)."""
...
def f(zomg: 'zomg_annotation'):
    """f doc string"""
    return 42
g = module.lru_cache()(f)
for attr in module.WRAPPER_ASSIGNMENTS:

    assert getattr(g, attr) == getattr(f, attr)
print("TestLRUPy::test_lru_cache_decoration: ok")
