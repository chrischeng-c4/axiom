...
# lib = "functools"
# dimension = "behavior"
# case = "test_partial_py_subclass__test_recursive_pickle"
# subject = "cpython.test_functools.TestPartialPySubclass.test_recursive_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestPartialPySubclass::test_recursive_pickle
"""Auto-ported test: TestPartialPySubclass::test_recursive_pickle (CPython 3.12 oracle)."""
...
with replaced_module('functools', module):
    f = partial(capture)
    f.__setstate__((f, (), {}, {}))
    try:
    ...
    try:
        ...
        f.__setstate__((capture, (), {}, {}))
print("TestPartialPySubclass::test_recursive_pickle: ok")
