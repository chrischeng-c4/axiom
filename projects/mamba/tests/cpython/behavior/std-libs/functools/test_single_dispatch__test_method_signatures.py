...
# lib = "functools"
# dimension = "behavior"
# case = "test_single_dispatch__test_method_signatures"
# subject = "cpython.test_functools.TestSingleDispatch.test_method_signatures"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestSingleDispatch::test_method_signatures
"""Auto-ported test: TestSingleDispatch::test_method_signatures (CPython 3.12 oracle)."""
...
assert str(Signature.from_callable(A.func)) == '(self, item, arg: int) -> str'

assert str(Signature.from_callable(A().func)) == '(self, item, arg: int) -> str'

assert str(Signature.from_callable(A.cls_func)) == '(cls, item, arg: int) -> str'

assert str(Signature.from_callable(A.static_func)) == '(item, arg: int) -> str'
print("TestSingleDispatch::test_method_signatures: ok")
