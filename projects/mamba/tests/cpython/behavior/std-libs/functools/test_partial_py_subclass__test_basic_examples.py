...
# lib = "functools"
# dimension = "behavior"
# case = "test_partial_py_subclass__test_basic_examples"
# subject = "cpython.test_functools.TestPartialPySubclass.test_basic_examples"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestPartialPySubclass::test_basic_examples
"""Auto-ported test: TestPartialPySubclass::test_basic_examples (CPython 3.12 oracle)."""
...
assert p(3, 4, b=30, c=40) == ((1, 2, 3, 4), dict(a=10, b=30, c=40))
p = partial(map, lambda x: x * 10)

assert list(p([1, 2, 3, 4])) == [10, 20, 30, 40]
print("TestPartialPySubclass::test_basic_examples: ok")
