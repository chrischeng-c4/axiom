...
# lib = "functools"
# dimension = "behavior"
# case = "test_cached_property__test_object_with_slots"
# subject = "cpython.test_functools.TestCachedProperty.test_object_with_slots"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestCachedProperty::test_object_with_slots
"""Auto-ported test: TestCachedProperty::test_object_with_slots (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search("No '__dict__' attribute on 'CachedCostItemWithSlots' instance to cache 'cost' property.", str(_aR_e))
print("TestCachedProperty::test_object_with_slots: ok")
