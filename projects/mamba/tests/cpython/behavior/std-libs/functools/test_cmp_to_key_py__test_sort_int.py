...
# lib = "functools"
# dimension = "behavior"
# case = "test_cmp_to_key_py__test_sort_int"
# subject = "cpython.test_functools.TestCmpToKeyPy.test_sort_int"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_functools.py::TestCmpToKeyPy::test_sort_int
"""Auto-ported test: TestCmpToKeyPy::test_sort_int (CPython 3.12 oracle)."""
...
assert sorted(range(5), key=cmp_to_key(mycmp)) == [4, 3, 2, 1, 0]
print("TestCmpToKeyPy::test_sort_int: ok")
