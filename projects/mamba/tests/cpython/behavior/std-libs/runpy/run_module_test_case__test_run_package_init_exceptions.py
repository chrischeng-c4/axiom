...
# lib = "runpy"
# dimension = "behavior"
# case = "run_module_test_case__test_run_package_init_exceptions"
# subject = "cpython.test_runpy.RunModuleTestCase.test_run_package_init_exceptions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_runpy.py::RunModuleTestCase::test_run_package_init_exceptions
"""Auto-ported test: RunModuleTestCase::test_run_package_init_exceptions (CPython 3.12 oracle)."""
...
for exception in exceptions:
    ...
    try:
        ...
        assert 'finding spec' not in format(err)
    else:

        raise AssertionError('Nothing raised; expected {}'.format(name))
    try:
        ...
        raise AssertionError('Nothing raised; expected {}'.format(name))
print("RunModuleTestCase::test_run_package_init_exceptions: ok")
