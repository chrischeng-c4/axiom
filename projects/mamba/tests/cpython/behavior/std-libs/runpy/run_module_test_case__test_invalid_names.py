...
# lib = "runpy"
# dimension = "behavior"
# case = "run_module_test_case__test_invalid_names"
# subject = "cpython.test_runpy.RunModuleTestCase.test_invalid_names"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_runpy.py::RunModuleTestCase::test_invalid_names
"""Auto-ported test: RunModuleTestCase::test_invalid_names (CPython 3.12 oracle)."""
...
expect_import_error('.test_runpy')
expect_import_error('.unittest')
expect_import_error('multiprocessing')
print("RunModuleTestCase::test_invalid_names: ok")
