...
# lib = "trace"
# dimension = "behavior"
# case = "test_coverage_command_line_output__test_cover_files_written_no_highlight"
# subject = "cpython.test_trace.TestCoverageCommandLineOutput.test_cover_files_written_no_highlight"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestCoverageCommandLineOutput::test_cover_files_written_no_highlight
"""Auto-ported test: TestCoverageCommandLineOutput::test_cover_files_written_no_highlight (CPython 3.12 oracle)."""
...
codefile = 'tmp.py'
coverfile = 'tmp.cover'
with open(codefile, 'w', encoding='iso-8859-15') as f:
    f.write(textwrap.dedent("                # coding: iso-8859-15\n                x = 'spœm'\n                if []:\n                    print('unreachable')\n            "))
...
argv = '-m trace --count'.split() + [codefile]
status, stdout, stderr = assert_python_ok(*argv)

assert stderr == b''

assert not os.path.exists(tracecoverpath)

assert os.path.exists(coverfile)
with open(coverfile, encoding='iso-8859-15') as f:

    assert f.read() == "       # coding: iso-8859-15\n    1: x = 'spœm'\n    1: if []:\n           print('unreachable')\n"
print("TestCoverageCommandLineOutput::test_cover_files_written_no_highlight: ok")
