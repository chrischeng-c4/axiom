...
# lib = "trace"
# dimension = "behavior"
# case = "test_funcs__test_arg_errors"
# subject = "cpython.test_trace.TestFuncs.test_arg_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestFuncs::test_arg_errors
"""Auto-ported test: TestFuncs::test_arg_errors (CPython 3.12 oracle)."""
...
res = self_tracer.runfunc(traced_capturer, 1, 2, self=3, func=4)

assert res == ((1, 2), {'self': 3, 'func': 4})
try:
    self_tracer.runfunc(func=traced_capturer, arg=1)
...
try:
    ...
    pass
print("TestFuncs::test_arg_errors: ok")
