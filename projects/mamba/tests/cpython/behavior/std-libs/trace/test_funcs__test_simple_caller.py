...
# lib = "trace"
# dimension = "behavior"
# case = "test_funcs__test_simple_caller"
# subject = "cpython.test_trace.TestFuncs.test_simple_caller"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestFuncs::test_simple_caller
"""Auto-ported test: TestFuncs::test_simple_caller (CPython 3.12 oracle)."""
...
self_tracer.runfunc(traced_func_simple_caller, 1)
expected = {self_filemod + ('traced_func_simple_caller',): 1, self_filemod + ('traced_func_linear',): 1}

assert self_tracer.results().calledfuncs == expected
print("TestFuncs::test_simple_caller: ok")
