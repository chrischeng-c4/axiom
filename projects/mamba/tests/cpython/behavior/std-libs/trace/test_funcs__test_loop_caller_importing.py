...
# lib = "trace"
# dimension = "behavior"
# case = "test_funcs__test_loop_caller_importing"
# subject = "cpython.test_trace.TestFuncs.test_loop_caller_importing"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_trace.py::TestFuncs::test_loop_caller_importing
"""Auto-ported test: TestFuncs::test_loop_caller_importing (CPython 3.12 oracle)."""
...
# --- test body ---
pass
self_tracer = Trace(count=0, trace=0, countfuncs=1)
self_filemod = my_file_and_modname()
self__saved_tracefunc = sys.gettrace()
self_tracer.runfunc(traced_func_importing_caller, 1)
expected = {self_filemod + ('traced_func_simple_caller',): 1, self_filemod + ('traced_func_linear',): 1, self_filemod + ('traced_func_importing_caller',): 1, self_filemod + ('traced_func_importing',): 1, (fix_ext_py(testmod.__file__), 'testmod', 'func'): 1}

assert self_tracer.results().calledfuncs == expected
print("TestFuncs::test_loop_caller_importing: ok")
