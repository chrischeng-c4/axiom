...
# lib = "traceback"
# dimension = "behavior"
# case = "test_traceback_exception__test_cause"
# subject = "cpython.test_traceback.TestTracebackException.test_cause"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_traceback.py::TestTracebackException::test_cause
"""Auto-ported test: TestTracebackException::test_cause (CPython 3.12 oracle)."""
...
assert exc_cause == exc.__cause__

assert exc_context == exc.__context__

assert True == exc.__suppress_context__
...
print("TestTracebackException::test_cause: ok")
