...
# lib = "traceback"
# dimension = "behavior"
# case = "test_traceback_exception__test_limit"
# subject = "cpython.test_traceback.TestTracebackException.test_limit"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_traceback.py::TestTracebackException::test_limit
"""Auto-ported test: TestTracebackException::test_limit (CPython 3.12 oracle)."""
...
try:
    ...
    expected_stack = traceback.StackSummary.extract(traceback.walk_tb(e.__traceback__), limit=5)

assert expected_stack == exc.stack
print("TestTracebackException::test_limit: ok")
