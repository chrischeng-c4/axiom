...
assert sys.getrefcount(exc_obj) == refcnt1

assert sys.getrefcount(exc_obj.__traceback__) == refcnt2
print("TestTracebackException::test_no_refs_to_exception_and_traceback_objects: ok")
