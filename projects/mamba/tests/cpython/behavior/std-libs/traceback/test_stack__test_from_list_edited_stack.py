...
# lib = "traceback"
# dimension = "behavior"
# case = "test_stack__test_from_list_edited_stack"
# subject = "cpython.test_traceback.TestStack.test_from_list_edited_stack"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_traceback.py::TestStack::test_from_list_edited_stack
"""Auto-ported test: TestStack::test_from_list_edited_stack (CPython 3.12 oracle)."""
...
assert ['  File "foo.py", line 2, in fred\n    line\n'] == s2.format()
print("TestStack::test_from_list_edited_stack: ok")
