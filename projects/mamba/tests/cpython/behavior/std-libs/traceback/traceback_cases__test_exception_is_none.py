...
assert excfile.getvalue() == NONE_EXC_STRING
excfile = StringIO()
...
assert traceback.format_exc(None) == NONE_EXC_STRING

assert traceback.format_exception(None) == [NONE_EXC_STRING]

assert traceback.format_exception(None, None, None) == [NONE_EXC_STRING]

assert traceback.format_exception_only(None) == [NONE_EXC_STRING]

assert traceback.format_exception_only(None, None) == [NONE_EXC_STRING]
print("TracebackCases::test_exception_is_None: ok")
