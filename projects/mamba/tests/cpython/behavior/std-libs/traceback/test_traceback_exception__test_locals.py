...
# lib = "traceback"
# dimension = "behavior"
# case = "test_traceback_exception__test_locals"
# subject = "cpython.test_traceback.TestTracebackException.test_locals"
# kind = "semantic"
# mem_carveout = ""
# source = "Lib/test/test_traceback.py"
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_traceback.py::TestTracebackException::test_locals
"""Auto-ported test: TestTracebackException::test_locals (CPython 3.12 oracle)."""
...
assert exc.stack[0].locals == {'something': '1', 'other': "'string'", 'unrepresentable': '<local repr() failed>'}
print("TestTracebackException::test_locals: ok")
