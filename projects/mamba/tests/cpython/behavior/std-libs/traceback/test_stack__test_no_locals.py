...
# lib = "traceback"
# dimension = "behavior"
# case = "test_stack__test_no_locals"
# subject = "cpython.test_traceback.TestStack.test_no_locals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_traceback.py::TestStack::test_no_locals
"""Auto-ported test: TestStack::test_no_locals (CPython 3.12 oracle)."""
...
assert s[0].locals == None
print("TestStack::test_no_locals: ok")
