...
# lib = "traceback"
# dimension = "behavior"
# case = "test_traceback_exception__test_comparison_equivalent_exceptions_are_equal"
# subject = "cpython.test_traceback.TestTracebackException.test_comparison_equivalent_exceptions_are_equal"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_traceback.py::TestTracebackException::test_comparison_equivalent_exceptions_are_equal
"""Auto-ported test: TestTracebackException::test_comparison_equivalent_exceptions_are_equal (CPython 3.12 oracle)."""
...
assert list(excs[0].format()) == list(excs[1].format())
print("TestTracebackException::test_comparison_equivalent_exceptions_are_equal: ok")
