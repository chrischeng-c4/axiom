...
# lib = "traceback"
# dimension = "behavior"
# case = "traceback_cases__test_print_last"
# subject = "cpython.test_traceback.TracebackCases.test_print_last"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_traceback.py::TracebackCases::test_print_last
"""Auto-ported test: TracebackCases::test_print_last (CPython 3.12 oracle)."""
...
with support.swap_attr(sys, 'last_exc', ValueError(42)):
    ...
    assert output.getvalue() == 'ValueError: 42\n'
print("TracebackCases::test_print_last: ok")
