...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tuple_tests__test_tuple_args_and_parameters_are_correct"
# subject = "cpython.test_typing.TypeVarTupleTests.test_tuple_args_and_parameters_are_correct"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTupleTests::test_tuple_args_and_parameters_are_correct
"""Auto-ported test: TypeVarTupleTests::test_tuple_args_and_parameters_are_correct (CPython 3.12 oracle)."""
...
assert t1.__args__ == (*Ts,)

assert t1.__parameters__ == (Ts,)
t2 = Tuple[Unpack[Ts]]

assert t2.__args__ == (Unpack[Ts],)

assert t2.__parameters__ == (Ts,)
print("TypeVarTupleTests::test_tuple_args_and_parameters_are_correct: ok")
