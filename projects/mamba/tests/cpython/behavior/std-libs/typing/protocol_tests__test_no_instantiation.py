...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_no_instantiation"
# subject = "cpython.test_typing.ProtocolTests.test_no_instantiation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_no_instantiation
"""Auto-ported test: ProtocolTests::test_no_instantiation (CPython 3.12 oracle)."""
...
assert isinstance(CG[int](), CG)
try:
    CG[int](42)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("ProtocolTests::test_no_instantiation: ok")
