...
# lib = "typing"
# dimension = "behavior"
# case = "union_tests__test_union_of_literals"
# subject = "cpython.test_typing.UnionTests.test_union_of_literals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnionTests::test_union_of_literals
"""Auto-ported test: UnionTests::test_union_of_literals (CPython 3.12 oracle)."""
...
assert Union[Literal[1], Literal[2]].__args__ == (Literal[1], Literal[2])

assert Union[Literal[1], Literal[1]] == Literal[1]

assert Union[Literal[False], Literal[0]].__args__ == (Literal[False], Literal[0])

assert Union[Literal[True], Literal[1]].__args__ == (Literal[True], Literal[1])
import enum
...
assert Union[Literal[Ints.A], Literal[Ints.A]] == Literal[Ints.A]

assert Union[Literal[Ints.B], Literal[Ints.B]] == Literal[Ints.B]

assert Union[Literal[Ints.A], Literal[Ints.B]].__args__ == (Literal[Ints.A], Literal[Ints.B])

assert Union[Literal[0], Literal[Ints.A], Literal[False]].__args__ == (Literal[0], Literal[Ints.A], Literal[False])

assert Union[Literal[1], Literal[Ints.B], Literal[True]].__args__ == (Literal[1], Literal[Ints.B], Literal[True])
print("UnionTests::test_union_of_literals: ok")
