...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_annotated_mro"
# subject = "cpython.test_typing.AnnotatedTests.test_annotated_mro"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_annotated_mro
"""Auto-ported test: AnnotatedTests::test_annotated_mro (CPython 3.12 oracle)."""
...
assert X.__mro__ == (X, int, object)
print("AnnotatedTests::test_annotated_mro: ok")
