...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_runtime_checkable_generic_non_protocol"
# subject = "cpython.test_typing.ProtocolTests.test_runtime_checkable_generic_non_protocol"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_runtime_checkable_generic_non_protocol
"""Auto-ported test: ProtocolTests::test_runtime_checkable_generic_non_protocol (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('@runtime_checkable can be only applied to protocol classes', str(_aR_e))
print("ProtocolTests::test_runtime_checkable_generic_non_protocol: ok")
