...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_generic_forward_ref"
# subject = "cpython.test_typing.GenericTests.test_generic_forward_ref"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_generic_forward_ref
"""Auto-ported test: GenericTests::test_generic_forward_ref (CPython 3.12 oracle)."""
...
assert get_type_hints(foobar, globals(), locals()) == {'x': List[List[CC]]}

assert get_type_hints(foobar2, globals(), locals()) == {'x': list[list[CC]]}

assert get_type_hints(foobar3, globals(), locals()) == {'x': list[CC | int] | int}
T = TypeVar('T')
AT = Tuple[T, ...]
...
assert get_type_hints(barfoo, globals(), locals())['x'] is AT
CT = Callable[..., List[T]]

def barfoo2(x: CT):
    ...

assert get_type_hints(barfoo2, globals(), locals())['x'] is CT
print("GenericTests::test_generic_forward_ref: ok")
