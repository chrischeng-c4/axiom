...
# lib = "typing"
# dimension = "behavior"
# case = "unpack_tests__test_unpack_wrong_type"
# subject = "cpython.test_typing.UnpackTests.test_unpack_wrong_type"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnpackTests::test_unpack_wrong_type
"""Auto-ported test: UnpackTests::test_unpack_wrong_type (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(bad_unpack_param, str(_aR_e))
try:
    PartGen[Unpack[List[int]]]
    raise AssertionError('expected TypeError')
except TypeError as _aR_e:
    import re as _re_aR
    assert _re_aR.search(bad_unpack_param, str(_aR_e))
print("UnpackTests::test_unpack_wrong_type: ok")
