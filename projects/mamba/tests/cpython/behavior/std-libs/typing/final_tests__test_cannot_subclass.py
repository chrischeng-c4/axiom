...
# lib = "typing"
# dimension = "behavior"
# case = "final_tests__test_cannot_subclass"
# subject = "cpython.test_typing.FinalTests.test_cannot_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::FinalTests::test_cannot_subclass
"""Auto-ported test: FinalTests::test_cannot_subclass (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.Final', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.Final\\[int\\]', str(_aR_e))
print("FinalTests::test_cannot_subclass: ok")
