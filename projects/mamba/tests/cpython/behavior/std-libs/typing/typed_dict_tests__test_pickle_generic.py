...
# lib = "typing"
# dimension = "behavior"
# case = "typed_dict_tests__test_pickle_generic"
# subject = "cpython.test_typing.TypedDictTests.test_pickle_generic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypedDictTests::test_pickle_generic
"""Auto-ported test: TypedDictTests::test_pickle_generic (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert point2 == {'a': 5.0, 'b': 3.0}
    ZZ = pickle.dumps(Point2DGeneric, proto)
    Point2DGenericNew = pickle.loads(ZZ)

    assert Point2DGenericNew({'a': 5.0, 'b': 3.0}) == point
print("TypedDictTests::test_pickle_generic: ok")
