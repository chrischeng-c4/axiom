...
# lib = "typing"
# dimension = "behavior"
# case = "re_tests__test_cannot_subclass"
# subject = "cpython.test_typing.RETests.test_cannot_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::RETests::test_cannot_subclass
"""Auto-ported test: RETests::test_cannot_subclass (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search("type 're\\.Match' is not an acceptable base type", str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search("type 're\\.Pattern' is not an acceptable base type", str(_aR_e))
print("RETests::test_cannot_subclass: ok")
