...
# lib = "typing"
# dimension = "behavior"
# case = "required_tests__test_repr"
# subject = "cpython.test_typing.RequiredTests.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::RequiredTests::test_repr
"""Auto-ported test: RequiredTests::test_repr (CPython 3.12 oracle)."""
...
assert repr(Required) == 'typing.Required'
cv = Required[int]

assert repr(cv) == 'typing.Required[int]'
cv = Required[Employee]

assert repr(cv) == f'typing.Required[{__name__}.Employee]'
print("RequiredTests::test_repr: ok")
