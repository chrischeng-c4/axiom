...
# lib = "typing"
# dimension = "behavior"
# case = "param_spec_tests__test_var_substitution"
# subject = "cpython.test_typing.ParamSpecTests.test_var_substitution"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ParamSpecTests::test_var_substitution
"""Auto-ported test: ParamSpecTests::test_var_substitution (CPython 3.12 oracle)."""
...
assert subst((int, str)) == (int, str)

assert subst([int, str]) == (int, str)

assert subst([None]) == (type(None),)

assert subst(...) is ...

assert subst(P) is P

assert subst(Concatenate[int, P]) == Concatenate[int, P]
print("ParamSpecTests::test_var_substitution: ok")
