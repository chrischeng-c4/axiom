...
# lib = "typing"
# dimension = "behavior"
# case = "assert_type_tests__test_errors"
# subject = "cpython.test_typing.AssertTypeTests.test_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AssertTypeTests::test_errors
"""Auto-ported test: AssertTypeTests::test_errors (CPython 3.12 oracle)."""
...
assert assert_type(arg, 42) is arg

assert assert_type(arg, 'hello') is arg
print("AssertTypeTests::test_errors: ok")
