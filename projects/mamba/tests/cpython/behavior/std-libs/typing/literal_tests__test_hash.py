...
# lib = "typing"
# dimension = "behavior"
# case = "literal_tests__test_hash"
# subject = "cpython.test_typing.LiteralTests.test_hash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::LiteralTests::test_hash
"""Auto-ported test: LiteralTests::test_hash (CPython 3.12 oracle)."""
...
assert hash(Literal[1, 2]) == hash(Literal[2, 1])

assert hash(Literal[1, 2, 3]) == hash(Literal[1, 2, 3, 3])
print("LiteralTests::test_hash: ok")
