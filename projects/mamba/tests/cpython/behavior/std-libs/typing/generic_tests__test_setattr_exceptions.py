...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_setattr_exceptions"
# subject = "cpython.test_typing.GenericTests.test_setattr_exceptions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_setattr_exceptions
"""Auto-ported test: GenericTests::test_setattr_exceptions (CPython 3.12 oracle)."""
...
assert isinstance(Immutable[int](), Immutable)
print("GenericTests::test_setattr_exceptions: ok")
