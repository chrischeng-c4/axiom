...
# lib = "typing"
# dimension = "behavior"
# case = "collections_callable_tests__test_basic"
# subject = "cpython.test_typing.CollectionsCallableTests.test_basic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::CollectionsCallableTests::test_basic
"""Auto-ported test: CollectionsCallableTests::test_basic (CPython 3.12 oracle)."""
...
assert alias.__origin__ is collections.abc.Callable

assert alias.__args__ == (int, str, float)

assert alias.__parameters__ == ()
print("CollectionsCallableTests::test_basic: ok")
