...
# lib = "typing"
# dimension = "behavior"
# case = "not_required_tests__test_repr"
# subject = "cpython.test_typing.NotRequiredTests.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NotRequiredTests::test_repr
"""Auto-ported test: NotRequiredTests::test_repr (CPython 3.12 oracle)."""
...
assert repr(NotRequired) == 'typing.NotRequired'
cv = NotRequired[int]

assert repr(cv) == 'typing.NotRequired[int]'
cv = NotRequired[Employee]

assert repr(cv) == f'typing.NotRequired[{__name__}.Employee]'
print("NotRequiredTests::test_repr: ok")
