...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_no_inheritance_from_nominal"
# subject = "cpython.test_typing.ProtocolTests.test_no_inheritance_from_nominal"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_no_inheritance_from_nominal
"""Auto-ported test: ProtocolTests::test_no_inheritance_from_nominal (CPython 3.12 oracle)."""
...
assert not isinstance(D(), E)

assert not isinstance(E(), D)
print("ProtocolTests::test_no_inheritance_from_nominal: ok")
