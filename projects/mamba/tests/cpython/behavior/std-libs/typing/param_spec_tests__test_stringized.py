...
# lib = "typing"
# dimension = "behavior"
# case = "param_spec_tests__test_stringized"
# subject = "cpython.test_typing.ParamSpecTests.test_stringized"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ParamSpecTests::test_stringized
"""Auto-ported test: ParamSpecTests::test_stringized (CPython 3.12 oracle)."""
...
assert gth(C, globals(), locals()) == {'func': Callable[P, int]}

assert gth(C.foo, globals(), locals()) == {'args': P.args, 'kwargs': P.kwargs}
print("ParamSpecTests::test_stringized: ok")
