...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tuple_tests__test_variadic_args_with_ellipsis_annotations_are_correct"
# subject = "cpython.test_typing.TypeVarTupleTests.test_variadic_args_with_ellipsis_annotations_are_correct"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTupleTests::test_variadic_args_with_ellipsis_annotations_are_correct
"""Auto-ported test: TypeVarTupleTests::test_variadic_args_with_ellipsis_annotations_are_correct (CPython 3.12 oracle)."""
...
assert a.__annotations__ == {'args': (*tuple[int, ...],)[0]}

def b(*args: Unpack[Tuple[int, ...]]):
    pass

assert b.__annotations__ == {'args': Unpack[Tuple[int, ...]]}
print("TypeVarTupleTests::test_variadic_args_with_ellipsis_annotations_are_correct: ok")
