...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_meta_no_type_check"
# subject = "cpython.test_typing.ForwardRefTests.test_meta_no_type_check"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_meta_no_type_check
"""Auto-ported test: ForwardRefTests::test_meta_no_type_check (CPython 3.12 oracle)."""
...
assert magic_decorator.__name__ == 'magic_decorator'
...
assert ith == {}
print("ForwardRefTests::test_meta_no_type_check: ok")
