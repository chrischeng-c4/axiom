...
# lib = "typing"
# dimension = "behavior"
# case = "union_tests__test_optional_issubclass"
# subject = "cpython.test_typing.UnionTests.test_optional_issubclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnionTests::test_optional_issubclass
"""Auto-ported test: UnionTests::test_optional_issubclass (CPython 3.12 oracle)."""
...
assert issubclass(int, Optional[int])

assert issubclass(type(None), Optional[int])

assert not issubclass(str, Optional[int])

assert issubclass(Any, Optional[Any])

assert issubclass(type(None), Optional[Any])

assert not issubclass(int, Optional[Any])
print("UnionTests::test_optional_issubclass: ok")
