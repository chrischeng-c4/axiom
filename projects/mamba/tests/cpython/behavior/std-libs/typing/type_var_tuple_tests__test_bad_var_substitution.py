...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tuple_tests__test_bad_var_substitution"
# subject = "cpython.test_typing.TypeVarTupleTests.test_bad_var_substitution"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTupleTests::test_bad_var_substitution
"""Auto-ported test: TypeVarTupleTests::test_bad_var_substitution (CPython 3.12 oracle)."""
...
for A in (G1, G2, Tuple, tuple):
    ...
    try:
        ...
        pass
print("TypeVarTupleTests::test_bad_var_substitution: ok")
