...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_new_with_args"
# subject = "cpython.test_typing.GenericTests.test_new_with_args"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_new_with_args
"""Auto-ported test: GenericTests::test_new_with_args (CPython 3.12 oracle)."""
...
assert c.arg == 'foo'
print("GenericTests::test_new_with_args: ok")
