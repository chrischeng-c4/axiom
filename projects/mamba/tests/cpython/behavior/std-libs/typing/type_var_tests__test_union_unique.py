...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tests__test_union_unique"
# subject = "cpython.test_typing.TypeVarTests.test_union_unique"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTests::test_union_unique
"""Auto-ported test: TypeVarTests::test_union_unique (CPython 3.12 oracle)."""
...
assert Union[X, int].__args__ == (X, int)

assert Union[X, int].__parameters__ == (X,)

assert Union[X, int].__origin__ is Union
print("TypeVarTests::test_union_unique: ok")
