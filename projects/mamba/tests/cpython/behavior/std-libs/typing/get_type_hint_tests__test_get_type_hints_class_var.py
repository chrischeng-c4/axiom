...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_get_type_hints_class_var"
# subject = "cpython.test_typing.GetTypeHintTests.test_get_type_hints_ClassVar"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_get_type_hints_ClassVar
"""Auto-ported test: GetTypeHintTests::test_get_type_hints_ClassVar (CPython 3.12 oracle)."""
...
assert gth(ann_module2.CV, ann_module2.__dict__) == {'var': typing.ClassVar[ann_module2.CV]}

assert gth(B, globals()) == {'y': int, 'x': ClassVar[Optional[B]], 'b': int}

assert gth(CSub, globals()) == {'z': ClassVar[CSub], 'y': int, 'b': int, 'x': ClassVar[Optional[B]]}

assert gth(G) == {'lst': ClassVar[List[T]]}
print("GetTypeHintTests::test_get_type_hints_ClassVar: ok")
