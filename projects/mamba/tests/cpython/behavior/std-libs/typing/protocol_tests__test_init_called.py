...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_init_called"
# subject = "cpython.test_typing.ProtocolTests.test_init_called"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_init_called
"""Auto-ported test: ProtocolTests::test_init_called (CPython 3.12 oracle)."""
...
assert D1[int]().test == 'OK'

class D2(P[T], B):
    pass

assert D2[int]().test == 'OK'
print("ProtocolTests::test_init_called: ok")
