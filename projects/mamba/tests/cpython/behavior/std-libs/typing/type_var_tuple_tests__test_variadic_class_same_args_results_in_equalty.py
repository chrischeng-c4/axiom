...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tuple_tests__test_variadic_class_same_args_results_in_equalty"
# subject = "cpython.test_typing.TypeVarTupleTests.test_variadic_class_same_args_results_in_equalty"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTupleTests::test_variadic_class_same_args_results_in_equalty
"""Auto-ported test: TypeVarTupleTests::test_variadic_class_same_args_results_in_equalty (CPython 3.12 oracle)."""
...
assert D[Unpack[Ts1]] == D[Unpack[Ts1]]

assert C[*Ts1, *Ts2] == C[*Ts1, *Ts2]

assert D[Unpack[Ts1], Unpack[Ts2]] == D[Unpack[Ts1], Unpack[Ts2]]

assert C[int, *Ts1, *Ts2] == C[int, *Ts1, *Ts2]

assert D[int, Unpack[Ts1], Unpack[Ts2]] == D[int, Unpack[Ts1], Unpack[Ts2]]
print("TypeVarTupleTests::test_variadic_class_same_args_results_in_equalty: ok")
