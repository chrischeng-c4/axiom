...
# lib = "typing"
# dimension = "behavior"
# case = "unpack_tests__test_usage_with_kwargs"
# subject = "cpython.test_typing.UnpackTests.test_usage_with_kwargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnpackTests::test_usage_with_kwargs
"""Auto-ported test: UnpackTests::test_usage_with_kwargs (CPython 3.12 oracle)."""
...
assert repr(foo.__annotations__['kwargs']) == f'typing.Unpack[{__name__}.Movie]'
print("UnpackTests::test_usage_with_kwargs: ok")
