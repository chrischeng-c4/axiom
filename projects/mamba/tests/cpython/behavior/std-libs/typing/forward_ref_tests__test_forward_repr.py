...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_forward_repr"
# subject = "cpython.test_typing.ForwardRefTests.test_forward_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_forward_repr
"""Auto-ported test: ForwardRefTests::test_forward_repr (CPython 3.12 oracle)."""
...
assert repr(List['int']) == "typing.List[ForwardRef('int')]"

assert repr(List[ForwardRef('int', module='mod')]) == "typing.List[ForwardRef('int', module='mod')]"
print("ForwardRefTests::test_forward_repr: ok")
