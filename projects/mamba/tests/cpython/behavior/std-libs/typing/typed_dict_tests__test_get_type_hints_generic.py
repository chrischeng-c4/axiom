...
# lib = "typing"
# dimension = "behavior"
# case = "typed_dict_tests__test_get_type_hints_generic"
# subject = "cpython.test_typing.TypedDictTests.test_get_type_hints_generic"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypedDictTests::test_get_type_hints_generic
"""Auto-ported test: TypedDictTests::test_get_type_hints_generic (CPython 3.12 oracle)."""
...
assert get_type_hints(BarGeneric) == {'a': typing.Optional[T], 'b': int}

class FooBarGeneric(BarGeneric[int]):
    c: str

assert get_type_hints(FooBarGeneric) == {'a': typing.Optional[T], 'b': int, 'c': str}
print("TypedDictTests::test_get_type_hints_generic: ok")
