...
# subject = "cpython.test_typing.UnionTests.test_union_of_unhashable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnionTests::test_union_of_unhashable
