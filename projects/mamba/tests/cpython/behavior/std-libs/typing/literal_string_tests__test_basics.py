...
# lib = "typing"
# dimension = "behavior"
# case = "literal_string_tests__test_basics"
# subject = "cpython.test_typing.LiteralStringTests.test_basics"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::LiteralStringTests::test_basics
"""Auto-ported test: LiteralStringTests::test_basics (CPython 3.12 oracle)."""
...
for target in [Foo, FooStr, FooStrTyping]:
    ...
    assert gth(target.bar) == {'return': LiteralString}

assert get_origin(LiteralString) is None
print("LiteralStringTests::test_basics: ok")
