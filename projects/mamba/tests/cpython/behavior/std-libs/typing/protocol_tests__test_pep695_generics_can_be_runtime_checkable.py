...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_pep695_generics_can_be_runtime_checkable"
# subject = "cpython.test_typing.ProtocolTests.test_pep695_generics_can_be_runtime_checkable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_pep695_generics_can_be_runtime_checkable
"""Auto-ported test: ProtocolTests::test_pep695_generics_can_be_runtime_checkable (CPython 3.12 oracle)."""
...
assert isinstance(Bar(1), HasX)

assert not isinstance(Capybara('a'), HasX)
print("ProtocolTests::test_pep695_generics_can_be_runtime_checkable: ok")
