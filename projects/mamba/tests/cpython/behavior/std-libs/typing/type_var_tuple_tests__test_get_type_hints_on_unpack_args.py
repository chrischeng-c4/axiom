...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tuple_tests__test_get_type_hints_on_unpack_args"
# subject = "cpython.test_typing.TypeVarTupleTests.test_get_type_hints_on_unpack_args"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTupleTests::test_get_type_hints_on_unpack_args
"""Auto-ported test: TypeVarTupleTests::test_get_type_hints_on_unpack_args (CPython 3.12 oracle)."""
...
assert gth(func1) == {'args': Unpack[Ts]}

def func2(*args: *tuple[int, str]):
    pass

assert gth(func2) == {'args': Unpack[tuple[int, str]]}
...
assert gth(func3) == {'args': Unpack[CustomVariadic[int, str]]}
print("TypeVarTupleTests::test_get_type_hints_on_unpack_args: ok")
