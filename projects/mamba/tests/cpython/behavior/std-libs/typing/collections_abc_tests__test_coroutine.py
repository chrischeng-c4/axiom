...
# lib = "typing"
# dimension = "behavior"
# case = "collections_abc_tests__test_coroutine"
# subject = "cpython.test_typing.CollectionsAbcTests.test_coroutine"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::CollectionsAbcTests::test_coroutine
"""Auto-ported test: CollectionsAbcTests::test_coroutine (CPython 3.12 oracle)."""
...
assert isinstance(g, typing.Coroutine)
try:
...
assert not isinstance(foo, typing.Coroutine)
try:
    g.send(None)
except StopIteration:
    pass
print("CollectionsAbcTests::test_coroutine: ok")
