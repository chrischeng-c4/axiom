...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_subst"
# subject = "cpython.test_typing.AnnotatedTests.test_subst"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_subst
"""Auto-ported test: AnnotatedTests::test_subst (CPython 3.12 oracle)."""
...
assert S[int] == Annotated[int, dec2]

assert S[Annotated[int, dec]] == Annotated[int, dec, dec2]
L = Annotated[List[T], dec]

assert L[int] == Annotated[List[int], dec]
try:
    L[int, int]
...
assert S[L[int]] == Annotated[List[int], dec, dec2]
D = Annotated[typing.Dict[KT, VT], dec]

assert D[str, int] == Annotated[typing.Dict[str, int], dec]
try:
    D[int]
    raise AssertionError('expected TypeError')
except TypeError:
...
try:
    ...
    pass
print("AnnotatedTests::test_subst: ok")
