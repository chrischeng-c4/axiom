...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_multiple_inheritance_special"
# subject = "cpython.test_typing.GenericTests.test_multiple_inheritance_special"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_multiple_inheritance_special
"""Auto-ported test: GenericTests::test_multiple_inheritance_special (CPython 3.12 oracle)."""
...
assert C.__mro__ == (C, list, B, Generic, object)
print("GenericTests::test_multiple_inheritance_special: ok")
