...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_cannot_subclass"
# subject = "cpython.test_typing.AnnotatedTests.test_cannot_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_cannot_subclass
"""Auto-ported test: AnnotatedTests::test_cannot_subclass (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass .*Annotated', str(_aR_e))
print("AnnotatedTests::test_cannot_subclass: ok")
