...
# lib = "typing"
# dimension = "behavior"
# case = "typed_dict_tests__test_pickle"
# subject = "cpython.test_typing.TypedDictTests.test_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypedDictTests::test_pickle
"""Auto-ported test: TypedDictTests::test_pickle (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert jane2 == {'name': 'jane', 'id': 37}
    ZZ = pickle.dumps(EmpD, proto)
    EmpDnew = pickle.loads(ZZ)

    assert EmpDnew({'name': 'jane', 'id': 37}) == jane
print("TypedDictTests::test_pickle: ok")
