...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_type_erasure_special"
# subject = "cpython.test_typing.GenericTests.test_type_erasure_special"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_type_erasure_special
"""Auto-ported test: GenericTests::test_type_erasure_special (CPython 3.12 oracle)."""
...
assert MyTup[int]().__class__ is MyTup

assert MyTup[int]().__orig_class__ == MyTup[int]

class MyDict(typing.Dict[T, T]):
    ...

assert MyDict[int]().__class__ is MyDict

assert MyDict[int]().__orig_class__ == MyDict[int]

class MyDef(typing.DefaultDict[str, T]):
    ...

assert MyDef[int]().__class__ is MyDef

assert MyDef[int]().__orig_class__ == MyDef[int]

class MyChain(typing.ChainMap[str, T]):
    ...

assert MyChain[int]().__class__ is MyChain

assert MyChain[int]().__orig_class__ == MyChain[int]
print("GenericTests::test_type_erasure_special: ok")
