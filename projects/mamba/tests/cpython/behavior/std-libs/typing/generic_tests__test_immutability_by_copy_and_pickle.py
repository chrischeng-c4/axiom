...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_immutability_by_copy_and_pickle"
# subject = "cpython.test_typing.GenericTests.test_immutability_by_copy_and_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_immutability_by_copy_and_pickle
"""Auto-ported test: GenericTests::test_immutability_by_copy_and_pickle (CPython 3.12 oracle)."""
...
for X in [TP, TPB, TPV, PP, List, typing.Mapping, ClassVar, typing.Iterable, Union, Any, Tuple, Callable]:
    ...
    for proto in range(pickle.HIGHEST_PROTOCOL + 1):
        ...
        assert pickle.loads(pickle.dumps(X, proto)) is X
del TP, TPB, TPV, PP
TL = TypeVar('TL')
...
for X in [TL, TLB, TLV, PL]:
    ...
    assert deepcopy(X) is X
print("GenericTests::test_immutability_by_copy_and_pickle: ok")
