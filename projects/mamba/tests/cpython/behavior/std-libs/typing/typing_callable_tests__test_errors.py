...
# lib = "typing"
# dimension = "behavior"
# case = "typing_callable_tests__test_errors"
# subject = "cpython.test_typing.TypingCallableTests.test_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypingCallableTests::test_errors
"""Auto-ported test: TypingCallableTests::test_errors (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('is not a generic class', str(_aR_e))
P = ParamSpec('P')
C1 = Callable[P, T]
try:
    C1[int, str, str]
...
print("TypingCallableTests::test_errors: ok")
