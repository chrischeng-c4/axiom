...
# lib = "typing"
# dimension = "behavior"
# case = "param_spec_tests__test_valid_uses"
# subject = "cpython.test_typing.ParamSpecTests.test_valid_uses"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ParamSpecTests::test_valid_uses
"""Auto-ported test: ParamSpecTests::test_valid_uses (CPython 3.12 oracle)."""
...
assert C1.__args__ == (P, int)

assert C1.__parameters__ == (P,)
C2 = Callable[P, T]

assert C2.__args__ == (P, T)

assert C2.__parameters__ == (P, T)
C3 = collections.abc.Callable[P, int]

assert C3.__args__ == (P, int)

assert C3.__parameters__ == (P,)
C4 = collections.abc.Callable[P, T]

assert C4.__args__ == (P, T)

assert C4.__parameters__ == (P, T)
print("ParamSpecTests::test_valid_uses: ok")
