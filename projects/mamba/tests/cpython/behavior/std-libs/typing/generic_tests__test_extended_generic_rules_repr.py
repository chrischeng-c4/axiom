...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_extended_generic_rules_repr"
# subject = "cpython.test_typing.GenericTests.test_extended_generic_rules_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_extended_generic_rules_repr
"""Auto-ported test: GenericTests::test_extended_generic_rules_repr (CPython 3.12 oracle)."""
...
assert repr(Union[Tuple, Callable]).replace('typing.', '') == 'Union[Tuple, Callable]'

assert repr(Union[Tuple, Tuple[int]]).replace('typing.', '') == 'Union[Tuple, Tuple[int]]'

assert repr(Callable[..., Optional[T]][int]).replace('typing.', '') == 'Callable[..., Optional[int]]'

assert repr(Callable[[], List[T]][int]).replace('typing.', '') == 'Callable[[], List[int]]'
print("GenericTests::test_extended_generic_rules_repr: ok")
