...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_parameterized_slots"
# subject = "cpython.test_typing.GenericTests.test_parameterized_slots"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_parameterized_slots
"""Auto-ported test: GenericTests::test_parameterized_slots (CPython 3.12 oracle)."""
...
assert get_type_hints(foo, globals(), locals())['x'] == C[C]

assert copy(C[int]) == deepcopy(C[int])
print("GenericTests::test_parameterized_slots: ok")
