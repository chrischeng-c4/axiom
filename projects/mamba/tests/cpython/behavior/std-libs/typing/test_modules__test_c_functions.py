...
# subject = "cpython.test_typing.TestModules.test_c_functions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TestModules::test_c_functions
"""Auto-ported test: TestModules::test_c_functions (CPython 3.12 oracle)."""
...
for fname in func_names:
    ...
    assert getattr(typing, fname).__module__ == '_typing'
