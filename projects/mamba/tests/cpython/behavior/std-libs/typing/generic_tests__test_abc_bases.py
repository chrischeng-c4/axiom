...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_abc_bases"
# subject = "cpython.test_typing.GenericTests.test_abc_bases"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_abc_bases
"""Auto-ported test: GenericTests::test_abc_bases (CPython 3.12 oracle)."""
...
assert isinstance(MM(), collections.abc.MutableMapping)

assert isinstance(MM(), MutableMapping)

assert not isinstance(MM(), List)

assert not isinstance({}, MM)
print("GenericTests::test_abc_bases: ok")
