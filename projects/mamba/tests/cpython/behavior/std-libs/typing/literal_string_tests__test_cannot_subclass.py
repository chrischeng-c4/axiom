...
# lib = "typing"
# dimension = "behavior"
# case = "literal_string_tests__test_cannot_subclass"
# subject = "cpython.test_typing.LiteralStringTests.test_cannot_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::LiteralStringTests::test_cannot_subclass
"""Auto-ported test: LiteralStringTests::test_cannot_subclass (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.LiteralString', str(_aR_e))
print("LiteralStringTests::test_cannot_subclass: ok")
