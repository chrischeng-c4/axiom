...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_repr"
# subject = "cpython.test_typing.AnnotatedTests.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_repr
"""Auto-ported test: AnnotatedTests::test_repr (CPython 3.12 oracle)."""
...
assert repr(Annotated[int, 4, 5]) == 'typing.Annotated[int, 4, 5]'

assert repr(Annotated[List[int], 4, 5]) == 'typing.Annotated[typing.List[int], 4, 5]'
print("AnnotatedTests::test_repr: ok")
