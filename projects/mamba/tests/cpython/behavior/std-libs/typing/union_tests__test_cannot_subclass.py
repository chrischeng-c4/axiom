...
# lib = "typing"
# dimension = "behavior"
# case = "union_tests__test_cannot_subclass"
# subject = "cpython.test_typing.UnionTests.test_cannot_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::UnionTests::test_cannot_subclass
"""Auto-ported test: UnionTests::test_cannot_subclass (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.Union', str(_aR_e))
try:
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.Union\\[int, str\\]', str(_aR_e))
print("UnionTests::test_cannot_subclass: ok")
