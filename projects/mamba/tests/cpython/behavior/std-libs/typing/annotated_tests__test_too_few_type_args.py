...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_too_few_type_args"
# subject = "cpython.test_typing.AnnotatedTests.test_too_few_type_args"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_too_few_type_args
"""Auto-ported test: AnnotatedTests::test_too_few_type_args (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('at least two arguments', str(_aR_e))
print("AnnotatedTests::test_too_few_type_args: ok")
