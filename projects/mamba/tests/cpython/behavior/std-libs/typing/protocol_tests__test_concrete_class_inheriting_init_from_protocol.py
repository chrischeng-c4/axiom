...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_concrete_class_inheriting_init_from_protocol"
# subject = "cpython.test_typing.ProtocolTests.test_concrete_class_inheriting_init_from_protocol"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_concrete_class_inheriting_init_from_protocol
"""Auto-ported test: ProtocolTests::test_concrete_class_inheriting_init_from_protocol (CPython 3.12 oracle)."""
...
assert c.x == 1
print("ProtocolTests::test_concrete_class_inheriting_init_from_protocol: ok")
