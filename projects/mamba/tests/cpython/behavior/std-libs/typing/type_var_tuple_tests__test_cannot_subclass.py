...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tuple_tests__test_cannot_subclass"
# subject = "cpython.test_typing.TypeVarTupleTests.test_cannot_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTupleTests::test_cannot_subclass
"""Auto-ported test: TypeVarTupleTests::test_cannot_subclass (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(NOT_A_BASE_TYPE % 'TypeVarTuple', str(_aR_e))
Ts = TypeVarTuple('Ts')
try:
    ...
    import re as _re_aR
    assert _re_aR.search(CANNOT_SUBCLASS_INSTANCE % 'TypeVarTuple', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search(CANNOT_SUBCLASS_TYPE, str(_aR_e))
try:
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.Unpack', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing.Unpack\\[Ts\\]', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing.Unpack\\[Ts\\]', str(_aR_e))
print("TypeVarTupleTests::test_cannot_subclass: ok")
