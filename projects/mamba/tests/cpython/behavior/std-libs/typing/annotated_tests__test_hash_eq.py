...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_hash_eq"
# subject = "cpython.test_typing.AnnotatedTests.test_hash_eq"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_hash_eq
"""Auto-ported test: AnnotatedTests::test_hash_eq (CPython 3.12 oracle)."""
...
assert Annotated[int, 4, 5] != Annotated[str, 4, 5]

assert Annotated[int, 4] != Annotated[int, 4, 4]

assert {Annotated[int, 4, 5], Annotated[int, 4, 5], Annotated[T, 4, 5]} == {Annotated[int, 4, 5], Annotated[T, 4, 5]}
a1 = Annotated[int, []]
try:
    hash(a1)
...
try:
    ...
    pass
print("AnnotatedTests::test_hash_eq: ok")
