...
# lib = "typing"
# dimension = "behavior"
# case = "param_spec_tests__test_paramspec_gets_copied"
# subject = "cpython.test_typing.ParamSpecTests.test_paramspec_gets_copied"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ParamSpecTests::test_paramspec_gets_copied
"""Auto-ported test: ParamSpecTests::test_paramspec_gets_copied (CPython 3.12 oracle)."""
...
assert C1.__parameters__ == (P,)

assert C1[P2].__parameters__ == (P2,)

assert C1[str].__parameters__ == ()

assert C1[str, T].__parameters__ == (T,)

assert C1[Concatenate[str, P2]].__parameters__ == (P2,)

assert C1[Concatenate[T, P2]].__parameters__ == (T, P2)

assert C1[...].__parameters__ == ()
C2 = Callable[Concatenate[str, P], int]

assert C2.__parameters__ == (P,)

assert C2[P2].__parameters__ == (P2,)

assert C2[str].__parameters__ == ()

assert C2[str, T].__parameters__ == (T,)

assert C2[Concatenate[str, P2]].__parameters__ == (P2,)

assert C2[Concatenate[T, P2]].__parameters__ == (T, P2)
print("ParamSpecTests::test_paramspec_gets_copied: ok")
