...
# lib = "typing"
# dimension = "behavior"
# case = "dataclass_transform_tests__test_decorator"
# subject = "cpython.test_typing.DataclassTransformTests.test_decorator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::DataclassTransformTests::test_decorator
"""Auto-ported test: DataclassTransformTests::test_decorator (CPython 3.12 oracle)."""
...
assert decorated is create_model

assert decorated.__dataclass_transform__ == {'eq_default': True, 'order_default': False, 'kw_only_default': True, 'frozen_default': False, 'field_specifiers': (), 'kwargs': {}}

assert decorated(frozen=True, kw_only=False)(CustomerModel) is CustomerModel
print("DataclassTransformTests::test_decorator: ok")
