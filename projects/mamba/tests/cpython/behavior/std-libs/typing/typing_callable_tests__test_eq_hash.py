...
# lib = "typing"
# dimension = "behavior"
# case = "typing_callable_tests__test_eq_hash"
# subject = "cpython.test_typing.TypingCallableTests.test_eq_hash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypingCallableTests::test_eq_hash
"""Auto-ported test: TypingCallableTests::test_eq_hash (CPython 3.12 oracle)."""
...
assert C == Callable[[int], int]

assert len({C, Callable[[int], int]}) == 1

assert C != Callable[[int], str]

assert C != Callable[[str], int]

assert C != Callable[[int, int], int]

assert C != Callable[[], int]

assert C != Callable[..., int]

assert C != Callable
print("TypingCallableTests::test_eq_hash: ok")
