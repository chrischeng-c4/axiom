...
# lib = "typing"
# dimension = "behavior"
# case = "literal_string_tests__test_alias"
# subject = "cpython.test_typing.LiteralStringTests.test_alias"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::LiteralStringTests::test_alias
"""Auto-ported test: LiteralStringTests::test_alias (CPython 3.12 oracle)."""
...
assert get_args(alias_1) == (LiteralString, LiteralString)

assert get_args(alias_2) == (LiteralString,)

assert get_args(alias_3) == (LiteralString,)
print("LiteralStringTests::test_alias: ok")
