...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tests__test_no_redefinition"
# subject = "cpython.test_typing.TypeVarTests.test_no_redefinition"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTests::test_no_redefinition
"""Auto-ported test: TypeVarTests::test_no_redefinition (CPython 3.12 oracle)."""
...
assert TypeVar('T', int, str) != TypeVar('T', int, str)
print("TypeVarTests::test_no_redefinition: ok")
