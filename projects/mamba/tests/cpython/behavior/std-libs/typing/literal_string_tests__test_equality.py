...
# lib = "typing"
# dimension = "behavior"
# case = "literal_string_tests__test_equality"
# subject = "cpython.test_typing.LiteralStringTests.test_equality"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::LiteralStringTests::test_equality
"""Auto-ported test: LiteralStringTests::test_equality (CPython 3.12 oracle)."""
...
assert LiteralString == LiteralString

assert LiteralString is LiteralString

assert LiteralString != None
print("LiteralStringTests::test_equality: ok")
