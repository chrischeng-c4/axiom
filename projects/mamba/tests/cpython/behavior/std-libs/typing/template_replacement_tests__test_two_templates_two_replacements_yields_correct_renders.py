...
# lib = "typing"
# dimension = "behavior"
# case = "template_replacement_tests__test_two_templates_two_replacements_yields_correct_renders"
# subject = "cpython.test_typing.TemplateReplacementTests.test_two_templates_two_replacements_yields_correct_renders"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TemplateReplacementTests::test_two_templates_two_replacements_yields_correct_renders
"""Auto-ported test: TemplateReplacementTests::test_two_templates_two_replacements_yields_correct_renders (CPython 3.12 oracle)."""
...
def clear_caches():
    for f in typing._cleanups:
        f()
actual = template_replace(templates=['Cats are word1', 'Dogs are word2'], replacements={'word1': ['small', 'cute'], 'word2': ['big', 'fluffy']})
expected = [('Cats are small', 'Dogs are big'), ('Cats are small', 'Dogs are fluffy'), ('Cats are cute', 'Dogs are big'), ('Cats are cute', 'Dogs are fluffy')]

assert actual == expected
print("TemplateReplacementTests::test_two_templates_two_replacements_yields_correct_renders: ok")
