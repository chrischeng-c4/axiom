...
# lib = "typing"
# dimension = "behavior"
# case = "get_type_hint_tests__test_get_type_hints_annotated"
# subject = "cpython.test_typing.GetTypeHintTests.test_get_type_hints_annotated"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GetTypeHintTests::test_get_type_hints_annotated
"""Auto-ported test: GetTypeHintTests::test_get_type_hints_annotated (CPython 3.12 oracle)."""
...
assert get_type_hints(foobar, globals(), locals()) == {'x': List[int]}

assert get_type_hints(foobar, globals(), locals(), include_extras=True) == {'x': List[Annotated[int, (1, 10)]]}
...
assert get_type_hints(barfoo, globals(), locals())['x'] == Tuple[T, ...]

assert get_type_hints(barfoo, globals(), locals(), include_extras=True)['x'] == BA
BA = tuple[Annotated[T, (1, 0)], ...]
...
assert get_type_hints(barfoo2, globals(), locals()) == {'x': typing.Callable[..., List[T]], 'y': typing.Union[int, T]}
BA2 = typing.Callable[..., List[T]]

def barfoo3(x: BA2):
    ...

assert get_type_hints(barfoo3, globals(), locals(), include_extras=True)['x'] is BA2
BA3 = typing.Annotated[int | float, 'const']

def barfoo4(x: BA3):
    ...

assert get_type_hints(barfoo4, globals(), locals()) == {'x': int | float}

assert get_type_hints(barfoo4, globals(), locals(), include_extras=True) == {'x': typing.Annotated[int | float, 'const']}
print("GetTypeHintTests::test_get_type_hints_annotated: ok")
