...
# lib = "typing"
# dimension = "behavior"
# case = "param_spec_tests__test_typevartuple_and_paramspecs_in_generic_aliases"
# subject = "cpython.test_typing.ParamSpecTests.test_typevartuple_and_paramspecs_in_generic_aliases"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ParamSpecTests::test_typevartuple_and_paramspecs_in_generic_aliases
"""Auto-ported test: ParamSpecTests::test_typevartuple_and_paramspecs_in_generic_aliases (CPython 3.12 oracle)."""
...
for C in (Callable, collections.abc.Callable):
    ...
    assert B.__args__ == (int, str, Tuple[bytes, float])
...
assert B.__args__ == (Tuple[bytes, float], (int, str))
...
assert B.__args__ == ((int, str), Tuple[bytes, float])
print("ParamSpecTests::test_typevartuple_and_paramspecs_in_generic_aliases: ok")
