...
# lib = "typing"
# dimension = "behavior"
# case = "not_required_tests__test_cannot_subclass"
# subject = "cpython.test_typing.NotRequiredTests.test_cannot_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NotRequiredTests::test_cannot_subclass
"""Auto-ported test: NotRequiredTests::test_cannot_subclass (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.NotRequired', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot subclass typing\\.NotRequired\\[int\\]', str(_aR_e))
print("NotRequiredTests::test_cannot_subclass: ok")
