...
# lib = "typing"
# dimension = "behavior"
# case = "tuple_tests__test_equality"
# subject = "cpython.test_typing.TupleTests.test_equality"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TupleTests::test_equality
"""Auto-ported test: TupleTests::test_equality (CPython 3.12 oracle)."""
...
assert Tuple[int] != Tuple[int, ...]
print("TupleTests::test_equality: ok")
