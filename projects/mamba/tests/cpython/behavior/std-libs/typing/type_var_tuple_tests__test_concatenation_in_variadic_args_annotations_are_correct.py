...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tuple_tests__test_concatenation_in_variadic_args_annotations_are_correct"
# subject = "cpython.test_typing.TypeVarTupleTests.test_concatenation_in_variadic_args_annotations_are_correct"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTupleTests::test_concatenation_in_variadic_args_annotations_are_correct
"""Auto-ported test: TypeVarTupleTests::test_concatenation_in_variadic_args_annotations_are_correct (CPython 3.12 oracle)."""
...
assert a.__annotations__ == {'args': (*tuple[int, *Ts],)[0]}

def b(*args: *tuple[*Ts, int]):
    pass

assert b.__annotations__ == {'args': (*tuple[*Ts, int],)[0]}

def c(*args: *tuple[str, *Ts, int]):
    pass

assert c.__annotations__ == {'args': (*tuple[str, *Ts, int],)[0]}

def d(*args: *tuple[int, bool, *Ts, float, str]):
    pass

assert d.__annotations__ == {'args': (*tuple[int, bool, *Ts, float, str],)[0]}

def e(*args: Unpack[Tuple[int, Unpack[Ts]]]):
    pass

assert e.__annotations__ == {'args': Unpack[Tuple[int, Unpack[Ts]]]}

def f(*args: Unpack[Tuple[Unpack[Ts], int]]):
    pass

assert f.__annotations__ == {'args': Unpack[Tuple[Unpack[Ts], int]]}

def g(*args: Unpack[Tuple[str, Unpack[Ts], int]]):
    pass

assert g.__annotations__ == {'args': Unpack[Tuple[str, Unpack[Ts], int]]}

def h(*args: Unpack[Tuple[int, bool, Unpack[Ts], float, str]]):
    pass

assert h.__annotations__ == {'args': Unpack[Tuple[int, bool, Unpack[Ts], float, str]]}
print("TypeVarTupleTests::test_concatenation_in_variadic_args_annotations_are_correct: ok")
