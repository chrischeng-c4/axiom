...
# lib = "typing"
# dimension = "behavior"
# case = "self_tests__test_basics"
# subject = "cpython.test_typing.SelfTests.test_basics"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::SelfTests::test_basics
"""Auto-ported test: SelfTests::test_basics (CPython 3.12 oracle)."""
...
for target in [Foo, FooStr, FooStrTyping]:
    ...
    assert gth(target.bar) == {'return': Self}

assert get_origin(Self) is None
print("SelfTests::test_basics: ok")
