...
# lib = "typing"
# dimension = "behavior"
# case = "overload_tests__test_overload_registry"
# subject = "cpython.test_typing.OverloadTests.test_overload_registry"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::OverloadTests::test_overload_registry
"""Auto-ported test: OverloadTests::test_overload_registry (CPython 3.12 oracle)."""
...
assert typing._overload_registry == {}
impl, overloads = set_up_overloads()

assert typing._overload_registry != {}

assert list(get_overloads(impl)) == overloads
...
assert list(get_overloads(some_other_func)) == [other_overload]

def not_overloaded():
    pass

assert list(get_overloads(not_overloaded)) == []
clear_overloads()

assert typing._overload_registry == {}

assert get_overloads(impl) == []

def the_only_one():
    pass

assert get_overloads(the_only_one) == []

assert typing._overload_registry == {}
print("OverloadTests::test_overload_registry: ok")
