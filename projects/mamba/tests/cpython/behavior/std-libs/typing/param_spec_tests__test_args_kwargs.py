...
# lib = "typing"
# dimension = "behavior"
# case = "param_spec_tests__test_args_kwargs"
# subject = "cpython.test_typing.ParamSpecTests.test_args_kwargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ParamSpecTests::test_args_kwargs
"""Auto-ported test: ParamSpecTests::test_args_kwargs (CPython 3.12 oracle)."""
...
assert 'args' in dir(P)

assert 'kwargs' in dir(P)

assert isinstance(P.args, ParamSpecArgs)

assert isinstance(P.kwargs, ParamSpecKwargs)

assert P.args.__origin__ is P

assert P.kwargs.__origin__ is P

assert P.args == P.args

assert P.kwargs == P.kwargs

assert P.args != P_2.args

assert P.kwargs != P_2.kwargs

assert P.args != P.kwargs

assert P.kwargs != P.args

assert P.args != P_2.kwargs

assert repr(P.args) == 'P.args'

assert repr(P.kwargs) == 'P.kwargs'
print("ParamSpecTests::test_args_kwargs: ok")
