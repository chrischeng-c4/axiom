...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_init_subclass_super_called"
# subject = "cpython.test_typing.GenericTests.test_init_subclass_super_called"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_init_subclass_super_called
"""Auto-ported test: GenericTests::test_init_subclass_super_called (CPython 3.12 oracle)."""
...
try:
    ...
    class Subclass(Test):
        pass
    raise AssertionError('expected FinalException')
...
try:
    ...
    pass
print("GenericTests::test_init_subclass_super_called: ok")
