...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tests__test_or"
# subject = "cpython.test_typing.TypeVarTests.test_or"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTests::test_or
"""Auto-ported test: TypeVarTests::test_or (CPython 3.12 oracle)."""
...
assert X | 'x' == Union[X, 'x']

assert 'x' | X == Union['x', X]

assert get_args(X | 'x') == (X, ForwardRef('x'))

assert get_args('x' | X) == (ForwardRef('x'), X)
print("TypeVarTests::test_or: ok")
