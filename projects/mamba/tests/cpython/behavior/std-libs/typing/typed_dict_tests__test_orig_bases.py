...
# lib = "typing"
# dimension = "behavior"
# case = "typed_dict_tests__test_orig_bases"
# subject = "cpython.test_typing.TypedDictTests.test_orig_bases"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypedDictTests::test_orig_bases
"""Auto-ported test: TypedDictTests::test_orig_bases (CPython 3.12 oracle)."""
...
assert Parent.__orig_bases__ == (TypedDict,)

assert Child.__orig_bases__ == (Parent,)

assert OtherChild.__orig_bases__ == (Parent,)

assert MixedChild.__orig_bases__ == (Child, OtherChild, Parent)

assert GenericParent.__orig_bases__ == (TypedDict, Generic[T])

assert GenericChild.__orig_bases__ == (GenericParent[int],)

assert OtherGenericChild.__orig_bases__ == (GenericParent[str],)

assert MixedGenericChild.__orig_bases__ == (GenericChild, OtherGenericChild, GenericParent[float])

assert MultipleGenericBases.__orig_bases__ == (GenericParent[int], GenericParent[float])

assert CallTypedDict.__orig_bases__ == (TypedDict,)
print("TypedDictTests::test_orig_bases: ok")
