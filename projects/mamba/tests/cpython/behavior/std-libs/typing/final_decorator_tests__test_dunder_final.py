...
# lib = "typing"
# dimension = "behavior"
# case = "final_decorator_tests__test_dunder_final"
# subject = "cpython.test_typing.FinalDecoratorTests.test_dunder_final"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::FinalDecoratorTests::test_dunder_final
"""Auto-ported test: FinalDecoratorTests::test_dunder_final (CPython 3.12 oracle)."""
...
assert True is func.__final__

assert True is Cls.__final__
...
assert False is hasattr(wrapped, '__final__')
...
assert WithMeta.__final__ == "can't set me"
final(int)

assert False is hasattr(int, '__final__')
...
assert True is inspect.getattr_static(Methods, 'clsmethod').__final__

assert True is inspect.getattr_static(Methods, 'stmethod').__final__

assert True is Methods.prop.fget.__final__

assert True is Methods.cached.__final__
print("FinalDecoratorTests::test_dunder_final: ok")
