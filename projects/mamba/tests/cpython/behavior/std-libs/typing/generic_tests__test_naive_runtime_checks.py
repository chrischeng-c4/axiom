...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_naive_runtime_checks"
# subject = "cpython.test_typing.GenericTests.test_naive_runtime_checks"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_naive_runtime_checks
"""Auto-ported test: GenericTests::test_naive_runtime_checks (CPython 3.12 oracle)."""
...
assert naive_dict_check({'x': 1}, typing.Dict[str, int])

assert not naive_dict_check({1: 'x'}, typing.Dict[str, int])
try:
...
assert naive_generic_check(Node[int](), Node[int])

assert not naive_generic_check(Node[str](), Node[int])

assert not naive_generic_check(Node[str](), List)
try:
...
assert naive_list_base_check([1, 2, 3], C)

assert not naive_list_base_check(['a', 'b'], C)
print("GenericTests::test_naive_runtime_checks: ok")
