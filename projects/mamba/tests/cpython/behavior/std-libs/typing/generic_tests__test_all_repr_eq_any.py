...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_all_repr_eq_any"
# subject = "cpython.test_typing.GenericTests.test_all_repr_eq_any"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_all_repr_eq_any
"""Auto-ported test: GenericTests::test_all_repr_eq_any (CPython 3.12 oracle)."""
...
for obj in objs:
    ...
    assert obj == obj
    if getattr(obj, '__parameters__', None) and (not isinstance(obj, typing.TypeVar)) and isinstance(obj.__parameters__, tuple) and (len(obj.__parameters__) == 1):

        assert obj[Any].__args__ == (Any,)
    if isinstance(obj, type):
        for base in obj.__mro__:
            ...
            assert base == base
print("GenericTests::test_all_repr_eq_any: ok")
