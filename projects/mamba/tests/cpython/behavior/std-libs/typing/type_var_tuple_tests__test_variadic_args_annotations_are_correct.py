...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tuple_tests__test_variadic_args_annotations_are_correct"
# subject = "cpython.test_typing.TypeVarTupleTests.test_variadic_args_annotations_are_correct"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTupleTests::test_variadic_args_annotations_are_correct
"""Auto-ported test: TypeVarTupleTests::test_variadic_args_annotations_are_correct (CPython 3.12 oracle)."""
...
assert f.__annotations__ == {'args': Unpack[Ts]}

assert g.__annotations__ == {'args': (*Ts,)[0]}
print("TypeVarTupleTests::test_variadic_args_annotations_are_correct: ok")
