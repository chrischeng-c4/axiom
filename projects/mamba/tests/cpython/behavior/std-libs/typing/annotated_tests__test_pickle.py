...
# lib = "typing"
# dimension = "behavior"
# case = "annotated_tests__test_pickle"
# subject = "cpython.test_typing.AnnotatedTests.test_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::AnnotatedTests::test_pickle
"""Auto-ported test: AnnotatedTests::test_pickle (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert x.x == 1
print("AnnotatedTests::test_pickle: ok")
