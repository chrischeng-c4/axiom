...
# lib = "typing"
# dimension = "behavior"
# case = "protocol_tests__test_super_call_init"
# subject = "cpython.test_typing.ProtocolTests.test_super_call_init"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ProtocolTests::test_super_call_init
"""Auto-ported test: ProtocolTests::test_super_call_init (CPython 3.12 oracle)."""
...
class Foo(P):
    ...
    def __init__(self):
        super().__init__()
Foo()
print("ProtocolTests::test_super_call_init: ok")
