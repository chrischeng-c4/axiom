...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_weakref_all"
# subject = "cpython.test_typing.GenericTests.test_weakref_all"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_weakref_all
"""Auto-ported test: GenericTests::test_weakref_all (CPython 3.12 oracle)."""
...
for t in things:
    ...
    assert weakref.ref(t)() == t
print("GenericTests::test_weakref_all: ok")
