...
# lib = "typing"
# dimension = "behavior"
# case = "generic_tests__test_pep695_generic_class_with_future_annotations"
# subject = "cpython.test_typing.GenericTests.test_pep695_generic_class_with_future_annotations"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::GenericTests::test_pep695_generic_class_with_future_annotations
"""Auto-ported test: GenericTests::test_pep695_generic_class_with_future_annotations (CPython 3.12 oracle)."""
...
assert hints_for_A['x'] is A_type_params[0]

assert hints_for_A['y'].__args__[0] == Unpack[A_type_params[1]]

assert hints_for_A['z'].__args__[0] is A_type_params[2]

assert ann_module695.__dict__ == original_globals
print("GenericTests::test_pep695_generic_class_with_future_annotations: ok")
