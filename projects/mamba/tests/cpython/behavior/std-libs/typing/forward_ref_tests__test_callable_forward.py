...
# lib = "typing"
# dimension = "behavior"
# case = "forward_ref_tests__test_callable_forward"
# subject = "cpython.test_typing.ForwardRefTests.test_callable_forward"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::ForwardRefTests::test_callable_forward
"""Auto-ported test: ForwardRefTests::test_callable_forward (CPython 3.12 oracle)."""
...
assert get_type_hints(foo, globals(), locals()) == {'a': Callable[[T], T]}
print("ForwardRefTests::test_callable_forward: ok")
