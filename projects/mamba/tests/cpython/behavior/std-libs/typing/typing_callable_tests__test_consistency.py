...
# lib = "typing"
# dimension = "behavior"
# case = "typing_callable_tests__test_consistency"
# subject = "cpython.test_typing.TypingCallableTests.test_consistency"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypingCallableTests::test_consistency
"""Auto-ported test: TypingCallableTests::test_consistency (CPython 3.12 oracle)."""
...
assert c1.__args__ == c2.__args__

assert hash(c1.__args__) == hash(c2.__args__)
print("TypingCallableTests::test_consistency: ok")
