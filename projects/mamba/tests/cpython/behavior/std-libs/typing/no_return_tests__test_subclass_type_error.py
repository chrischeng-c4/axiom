...
# lib = "typing"
# dimension = "behavior"
# case = "no_return_tests__test_subclass_type_error"
# subject = "cpython.test_typing.NoReturnTests.test_subclass_type_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::NoReturnTests::test_subclass_type_error
"""Auto-ported test: NoReturnTests::test_subclass_type_error (CPython 3.12 oracle)."""
...
def clear_caches():
    for f in typing._cleanups:
        f()
try:
    issubclass(Employee, bottom_type)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
try:
    issubclass(NoReturn, bottom_type)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("NoReturnTests::test_subclass_type_error: ok")
