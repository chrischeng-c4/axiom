...
# lib = "typing"
# dimension = "behavior"
# case = "special_attrs_tests__test_genericalias_dir"
# subject = "cpython.test_typing.SpecialAttrsTests.test_genericalias_dir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::SpecialAttrsTests::test_genericalias_dir
"""Auto-ported test: SpecialAttrsTests::test_genericalias_dir (CPython 3.12 oracle)."""
...
for required_item in ['bar', 'baz', '__args__', '__parameters__', '__origin__']:

    assert required_item in dir_items

assert '__magic__' not in dir_items
print("SpecialAttrsTests::test_genericalias_dir: ok")
