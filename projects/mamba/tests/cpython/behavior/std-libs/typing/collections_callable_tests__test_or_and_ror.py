...
# lib = "typing"
# dimension = "behavior"
# case = "collections_callable_tests__test_or_and_ror"
# subject = "cpython.test_typing.CollectionsCallableTests.test_or_and_ror"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::CollectionsCallableTests::test_or_and_ror
"""Auto-ported test: CollectionsCallableTests::test_or_and_ror (CPython 3.12 oracle)."""
...
assert Callable | Tuple == Union[Callable, Tuple]

assert Tuple | Callable == Union[Tuple, Callable]
print("CollectionsCallableTests::test_or_and_ror: ok")
