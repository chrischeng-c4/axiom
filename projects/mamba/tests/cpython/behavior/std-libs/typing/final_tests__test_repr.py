...
# lib = "typing"
# dimension = "behavior"
# case = "final_tests__test_repr"
# subject = "cpython.test_typing.FinalTests.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::FinalTests::test_repr
"""Auto-ported test: FinalTests::test_repr (CPython 3.12 oracle)."""
...
assert repr(Final) == 'typing.Final'
cv = Final[int]

assert repr(cv) == 'typing.Final[int]'
cv = Final[Employee]

assert repr(cv) == 'typing.Final[%s.Employee]' % __name__
cv = Final[tuple[int]]

assert repr(cv) == 'typing.Final[tuple[int]]'
print("FinalTests::test_repr: ok")
