...
# lib = "typing"
# dimension = "behavior"
# case = "type_var_tuple_tests__test_tuple_args_are_correct"
# subject = "cpython.test_typing.TypeVarTupleTests.test_tuple_args_are_correct"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_typing.py::TypeVarTupleTests::test_tuple_args_are_correct
"""Auto-ported test: TypeVarTupleTests::test_tuple_args_are_correct (CPython 3.12 oracle)."""
...
assert tuple[*Ts,].__args__ == (*Ts,)

assert Tuple[Unpack[Ts]].__args__ == (Unpack[Ts],)

assert tuple[*Ts, int].__args__ == (*Ts, int)

assert Tuple[Unpack[Ts], int].__args__ == (Unpack[Ts], int)

assert tuple[int, *Ts].__args__ == (int, *Ts)

assert Tuple[int, Unpack[Ts]].__args__ == (int, Unpack[Ts])

assert tuple[int, *Ts, str].__args__ == (int, *Ts, str)

assert Tuple[int, Unpack[Ts], str].__args__ == (int, Unpack[Ts], str)

assert tuple[*Ts, int].__args__ == (*Ts, int)

assert Tuple[Unpack[Ts]].__args__ == (Unpack[Ts],)
print("TypeVarTupleTests::test_tuple_args_are_correct: ok")
