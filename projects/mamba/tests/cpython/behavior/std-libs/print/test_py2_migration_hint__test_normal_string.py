...
# lib = "print"
# dimension = "behavior"
# case = "test_py2_migration_hint__test_normal_string"
# subject = "cpython.test_print.TestPy2MigrationHint.test_normal_string"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_print.py::TestPy2MigrationHint::test_normal_string
"""Auto-ported test: TestPy2MigrationHint::test_normal_string (CPython 3.12 oracle)."""
...
print("TestPy2MigrationHint::test_normal_string: ok")
