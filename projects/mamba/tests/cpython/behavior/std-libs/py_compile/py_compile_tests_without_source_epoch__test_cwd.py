...
# lib = "py_compile"
# dimension = "behavior"
# case = "py_compile_tests_without_source_epoch__test_cwd"
# subject = "cpython.test_py_compile.PyCompileTestsWithoutSourceEpoch.test_cwd"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_py_compile.py::PyCompileTestsWithoutSourceEpoch::test_cwd
"""Auto-ported test: PyCompileTestsWithoutSourceEpoch::test_cwd (CPython 3.12 oracle)."""
...
with open(self_source_path, 'w') as file:
    file.write('x = 123\n')
with os_helper.change_cwd(self_directory):
    py_compile.compile(os.path.basename(self_source_path), os.path.basename(self_pyc_path))

assert os.path.exists(self_pyc_path)

assert not os.path.exists(self_cache_path)
print("PyCompileTestsWithoutSourceEpoch::test_cwd: ok")
