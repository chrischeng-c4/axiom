...
# lib = "py_compile"
# dimension = "behavior"
# case = "py_compile_tests_without_source_epoch__test_invalidation_mode"
# subject = "cpython.test_py_compile.PyCompileTestsWithoutSourceEpoch.test_invalidation_mode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_py_compile.py::PyCompileTestsWithoutSourceEpoch::test_invalidation_mode
"""Auto-ported test: PyCompileTestsWithoutSourceEpoch::test_invalidation_mode (CPython 3.12 oracle)."""
...
with open(self_source_path, 'w') as file:
    file.write('x = 123\n')
py_compile.compile(self_source_path, invalidation_mode=py_compile.PycInvalidationMode.CHECKED_HASH)
with open(self_cache_path, 'rb') as fp:
    flags = importlib._bootstrap_external._classify_pyc(fp.read(), 'test', {})

assert flags == 3
py_compile.compile(self_source_path, invalidation_mode=py_compile.PycInvalidationMode.UNCHECKED_HASH)
with open(self_cache_path, 'rb') as fp:
    flags = importlib._bootstrap_external._classify_pyc(fp.read(), 'test', {})

assert flags == 1
print("PyCompileTestsWithoutSourceEpoch::test_invalidation_mode: ok")
