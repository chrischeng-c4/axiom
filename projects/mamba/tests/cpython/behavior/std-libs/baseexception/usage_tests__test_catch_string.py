...
# lib = "baseexception"
# dimension = "behavior"
# case = "usage_tests__test_catch_string"
# subject = "cpython.test_baseexception.UsageTests.test_catch_string"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_baseexception.py::UsageTests::test_catch_string
"""Auto-ported test: UsageTests::test_catch_string (CPython 3.12 oracle)."""
...
catch_fails('spam')
print("UsageTests::test_catch_string: ok")
