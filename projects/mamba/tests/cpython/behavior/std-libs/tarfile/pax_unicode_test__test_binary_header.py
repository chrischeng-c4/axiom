...
# lib = "tarfile"
# dimension = "behavior"
# case = "pax_unicode_test__test_binary_header"
# subject = "cpython.test_tarfile.PAXUnicodeTest.test_binary_header"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tarfile.py::PAXUnicodeTest::test_binary_header
"""Auto-ported test: PAXUnicodeTest::test_binary_header (CPython 3.12 oracle)."""
...
for encoding, name in (('utf-8', 'pax/hdrcharset-\udce4\udcf6\udcfc'), ('iso8859-1', 'pax/hdrcharset-äöü')):
    with tarfile.open(tarname, encoding=encoding, errors='surrogateescape') as tar:
        try:
            ...
            raise AssertionError('unable to read POSIX.1-2008 binary header')
print("PAXUnicodeTest::test_binary_header: ok")
