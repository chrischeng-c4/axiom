...
# lib = "tarfile"
# dimension = "behavior"
# case = "bz2_partial_read_test__test_partial_input_bz2"
# subject = "cpython.test_tarfile.Bz2PartialReadTest.test_partial_input_bz2"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tarfile.py::Bz2PartialReadTest::test_partial_input_bz2
"""Auto-ported test: Bz2PartialReadTest::test_partial_input_bz2 (CPython 3.12 oracle)."""
...
def _test_partial_input(mode):
    ...
    for x in range(len(data) + 1):
        try:
            ...
            pass
_test_partial_input('r:bz2')
print("Bz2PartialReadTest::test_partial_input_bz2: ok")
