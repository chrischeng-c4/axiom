...
# lib = "tarfile"
# dimension = "behavior"
# case = "bz2_partial_read_test__test_partial_input"
# subject = "cpython.test_tarfile.Bz2PartialReadTest.test_partial_input"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tarfile.py::Bz2PartialReadTest::test_partial_input
"""Auto-ported test: Bz2PartialReadTest::test_partial_input (CPython 3.12 oracle)."""
...
def _test_partial_input(mode):
    ...
    for x in range(len(data) + 1):
        try:
            ...
            pass
_test_partial_input('r')
print("Bz2PartialReadTest::test_partial_input: ok")
