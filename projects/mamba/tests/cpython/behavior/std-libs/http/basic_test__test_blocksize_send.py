...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_blocksize_send"
# subject = "cpython.test_httplib.BasicTest.test_blocksize_send"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_blocksize_send
"""Auto-ported test: BasicTest::test_blocksize_send (CPython 3.12 oracle)."""
...
assert sock.sendall_calls == 2

assert sock.data == expected
print("BasicTest::test_blocksize_send: ok")
