...
# lib = "http"
# dimension = "behavior"
# case = "http_response_test__test_getting_header_defaultint"
# subject = "cpython.test_httplib.HTTPResponseTest.test_getting_header_defaultint"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::HTTPResponseTest::test_getting_header_defaultint
"""Auto-ported test: HTTPResponseTest::test_getting_header_defaultint (CPython 3.12 oracle)."""
...
self_resp.begin()
header = self_resp.getheader('No-Such-Header', default=42)

assert header == 42
print("HTTPResponseTest::test_getting_header_defaultint: ok")
