...
# lib = "http"
# dimension = "behavior"
# case = "tunnel_tests__test_set_tunnel_host_port_headers_set_host_identical"
# subject = "cpython.test_httplib.TunnelTests.test_set_tunnel_host_port_headers_set_host_identical"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::TunnelTests::test_set_tunnel_host_port_headers_set_host_identical
"""Auto-ported test: TunnelTests::test_set_tunnel_host_port_headers_set_host_identical (CPython 3.12 oracle)."""
...
tunnel_port = 8888
tunnel_headers = {'User-Agent': 'Mozilla/5.0 (compatible, MSIE 11)', 'Host': '%s:%d' % (tunnel_host, tunnel_port)}
...
assert self_conn._tunnel_headers == tunnel_headers
print("TunnelTests::test_set_tunnel_host_port_headers_set_host_identical: ok")
