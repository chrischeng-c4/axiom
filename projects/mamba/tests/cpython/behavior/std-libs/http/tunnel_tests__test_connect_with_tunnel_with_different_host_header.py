...
# lib = "http"
# dimension = "behavior"
# case = "tunnel_tests__test_connect_with_tunnel_with_different_host_header"
# subject = "cpython.test_httplib.TunnelTests.test_connect_with_tunnel_with_different_host_header"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::TunnelTests::test_connect_with_tunnel_with_different_host_header
"""Auto-ported test: TunnelTests::test_connect_with_tunnel_with_different_host_header (CPython 3.12 oracle)."""
...
d = {b'host': b'destination.com', b'tunnel_host_header': b'example.com:9876', b'port': client.HTTP_PORT}
self_conn.set_tunnel(d[b'host'].decode('ascii'), headers={'HOST': d[b'tunnel_host_header'].decode('ascii')})
...
print("TunnelTests::test_connect_with_tunnel_with_different_host_header: ok")
