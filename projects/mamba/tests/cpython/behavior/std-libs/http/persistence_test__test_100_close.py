...
# lib = "http"
# dimension = "behavior"
# case = "persistence_test__test_100_close"
# subject = "cpython.test_httplib.PersistenceTest.test_100_close"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::PersistenceTest::test_100_close
"""Auto-ported test: PersistenceTest::test_100_close (CPython 3.12 oracle)."""
...
try:
    conn.getresponse()
    raise AssertionError('expected client.RemoteDisconnected')
...
assert conn.connections == 2
print("PersistenceTest::test_100_close: ok")
