...
# lib = "http"
# dimension = "behavior"
# case = "http_response_test__test_getting_nonexistent_header_without_default"
# subject = "cpython.test_httplib.HTTPResponseTest.test_getting_nonexistent_header_without_default"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::HTTPResponseTest::test_getting_nonexistent_header_without_default
"""Auto-ported test: HTTPResponseTest::test_getting_nonexistent_header_without_default (CPython 3.12 oracle)."""
...
self_resp.begin()
header = self_resp.getheader('No-Such-Header')

assert header == None
print("HTTPResponseTest::test_getting_nonexistent_header_without_default: ok")
