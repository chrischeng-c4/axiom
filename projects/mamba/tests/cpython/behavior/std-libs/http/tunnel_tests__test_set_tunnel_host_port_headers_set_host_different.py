...
# lib = "http"
# dimension = "behavior"
# case = "tunnel_tests__test_set_tunnel_host_port_headers_set_host_different"
# subject = "cpython.test_httplib.TunnelTests.test_set_tunnel_host_port_headers_set_host_different"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::TunnelTests::test_set_tunnel_host_port_headers_set_host_different
"""Auto-ported test: TunnelTests::test_set_tunnel_host_port_headers_set_host_different (CPython 3.12 oracle)."""
...
tunnel_port = 8888
tunnel_headers = {'User-Agent': 'Mozilla/5.0 (compatible, MSIE 11)', 'Host': '%s:%d' % ('example.com', 4200)}
...
print("TunnelTests::test_set_tunnel_host_port_headers_set_host_different: ok")
