...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_epipe"
# subject = "cpython.test_httplib.BasicTest.test_epipe"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_epipe
"""Auto-ported test: BasicTest::test_epipe (CPython 3.12 oracle)."""
...
assert 'Basic realm="example"' == resp.getheader('www-authenticate')
print("BasicTest::test_epipe: ok")
