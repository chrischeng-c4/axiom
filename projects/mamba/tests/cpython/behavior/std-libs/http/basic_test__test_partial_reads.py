...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_partial_reads"
# subject = "cpython.test_httplib.BasicTest.test_partial_reads"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_partial_reads
"""Auto-ported test: BasicTest::test_partial_reads (CPython 3.12 oracle)."""
...
assert resp.read(2) == b'Te'

assert not resp.isclosed()

assert resp.read(2) == b'xt'
...
assert resp.closed
print("BasicTest::test_partial_reads: ok")
