...
# lib = "http"
# dimension = "behavior"
# case = "header_tests__test_malformed_headers_coped_with"
# subject = "cpython.test_httplib.HeaderTests.test_malformed_headers_coped_with"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::HeaderTests::test_malformed_headers_coped_with
"""Auto-ported test: HeaderTests::test_malformed_headers_coped_with (CPython 3.12 oracle)."""
...
assert resp.getheader('First') == 'val'

assert resp.getheader('Second') == 'val'
print("HeaderTests::test_malformed_headers_coped_with: ok")
