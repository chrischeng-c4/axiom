...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_overflowing_chunked_line"
# subject = "cpython.test_httplib.BasicTest.test_overflowing_chunked_line"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_overflowing_chunked_line
"""Auto-ported test: BasicTest::test_overflowing_chunked_line (CPython 3.12 oracle)."""
...
try:
    resp.read()
    raise AssertionError('expected client.LineTooLong')
except client.LineTooLong:
    pass
print("BasicTest::test_overflowing_chunked_line: ok")
