...
# lib = "http"
# dimension = "behavior"
# case = "basic_test__test_readinto_chunked"
# subject = "cpython.test_httplib.BasicTest.test_readinto_chunked"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::BasicTest::test_readinto_chunked
"""Auto-ported test: BasicTest::test_readinto_chunked (CPython 3.12 oracle)."""
...
for x in ('', 'foo\r\n'):
    ...
    try:
        ...
        resp.close()
print("BasicTest::test_readinto_chunked: ok")
