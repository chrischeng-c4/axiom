...
# lib = "http"
# dimension = "behavior"
# case = "request_body_test__test_ascii_body"
# subject = "cpython.test_httplib.RequestBodyTest.test_ascii_body"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::RequestBodyTest::test_ascii_body
"""Auto-ported test: RequestBodyTest::test_ascii_body (CPython 3.12 oracle)."""
...
assert '4' == message.get('content-length')

assert b'body' == f.read()
print("RequestBodyTest::test_ascii_body: ok")
