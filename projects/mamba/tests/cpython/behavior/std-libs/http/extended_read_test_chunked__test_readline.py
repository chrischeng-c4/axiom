...
# lib = "http"
# dimension = "behavior"
# case = "extended_read_test_chunked__test_readline"
# subject = "cpython.test_httplib.ExtendedReadTestChunked.test_readline"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::ExtendedReadTestChunked::test_readline
"""Auto-ported test: ExtendedReadTestChunked::test_readline (CPython 3.12 oracle)."""
...
self_resp = resp
resp = self_resp
_verify_readline(self_resp.readline, lines_expected)
print("ExtendedReadTestChunked::test_readline: ok")
