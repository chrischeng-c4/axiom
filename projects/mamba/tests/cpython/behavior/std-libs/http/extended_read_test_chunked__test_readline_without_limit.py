...
# lib = "http"
# dimension = "behavior"
# case = "extended_read_test_chunked__test_readline_without_limit"
# subject = "cpython.test_httplib.ExtendedReadTestChunked.test_readline_without_limit"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::ExtendedReadTestChunked::test_readline_without_limit
"""Auto-ported test: ExtendedReadTestChunked::test_readline_without_limit (CPython 3.12 oracle)."""
...
self_resp = resp
_verify_readline(self_resp.readline, lines_expected, limit=-1)
print("ExtendedReadTestChunked::test_readline_without_limit: ok")
