...
# lib = "http"
# dimension = "behavior"
# case = "tunnel_tests__test_connect_with_tunnel_with_default_port"
# subject = "cpython.test_httplib.TunnelTests.test_connect_with_tunnel_with_default_port"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::TunnelTests::test_connect_with_tunnel_with_default_port
"""Auto-ported test: TunnelTests::test_connect_with_tunnel_with_default_port (CPython 3.12 oracle)."""
...
d = {b'host': b'destination.com', b'port': client.HTTP_PORT}
self_conn.set_tunnel(d[b'host'].decode('ascii'), port=d[b'port'])
...
assert b'CONNECT %(host)s:%(port)d HTTP/1.1\r\nHost: %(host)s:%(port)d\r\n\r\n' % d in self_conn.sock.data

assert b'HEAD / HTTP/1.1\r\nHost: %(host)s\r\n' % d in self_conn.sock.data
print("TunnelTests::test_connect_with_tunnel_with_default_port: ok")
