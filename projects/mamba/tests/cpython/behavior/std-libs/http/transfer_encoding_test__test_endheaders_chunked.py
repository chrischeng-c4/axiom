...
# lib = "http"
# dimension = "behavior"
# case = "transfer_encoding_test__test_endheaders_chunked"
# subject = "cpython.test_httplib.TransferEncodingTest.test_endheaders_chunked"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httplib.py::TransferEncodingTest::test_endheaders_chunked
"""Auto-ported test: TransferEncodingTest::test_endheaders_chunked (CPython 3.12 oracle)."""
...
conn.endheaders(_make_body(), encode_chunked=True)
_, _, body = _parse_request(conn.sock.data)
body = _parse_chunked(body)

assert body == expected_body
print("TransferEncodingTest::test_endheaders_chunked: ok")
