...
# lib = "pathlib"
# dimension = "behavior"
# case = "pure_path_test__test_concrete_class"
# subject = "cpython.test_pathlib.PurePathTest.test_concrete_class"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pathlib.py::PurePathTest::test_concrete_class
"""Auto-ported test: PurePathTest::test_concrete_class (CPython 3.12 oracle)."""
...
assert type(p) is (pathlib.PureWindowsPath if os.name == 'nt' else pathlib.PurePosixPath)
print("PurePathTest::test_concrete_class: ok")
