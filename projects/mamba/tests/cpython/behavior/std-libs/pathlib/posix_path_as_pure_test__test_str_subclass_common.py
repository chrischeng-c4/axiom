...
# lib = "pathlib"
# dimension = "behavior"
# case = "posix_path_as_pure_test__test_str_subclass_common"
# subject = "cpython.test_pathlib.PosixPathAsPureTest.test_str_subclass_common"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pathlib.py::PosixPathAsPureTest::test_str_subclass_common
"""Auto-ported test: PosixPathAsPureTest::test_str_subclass_common (CPython 3.12 oracle)."""
...
_check_str_subclass('')
_check_str_subclass('.')
_check_str_subclass('a')
_check_str_subclass('a/b.txt')
_check_str_subclass('/a/b.txt')
print("PosixPathAsPureTest::test_str_subclass_common: ok")
