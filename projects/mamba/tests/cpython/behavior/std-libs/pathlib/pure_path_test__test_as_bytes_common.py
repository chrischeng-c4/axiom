...
# lib = "pathlib"
# dimension = "behavior"
# case = "pure_path_test__test_as_bytes_common"
# subject = "cpython.test_pathlib.PurePathTest.test_as_bytes_common"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pathlib.py::PurePathTest::test_as_bytes_common
"""Auto-ported test: PurePathTest::test_as_bytes_common (CPython 3.12 oracle)."""
...
sep = os.fsencode(self_sep)
P = cls

assert bytes(P('a/b')) == b'a' + sep + b'b'
print("PurePathTest::test_as_bytes_common: ok")
