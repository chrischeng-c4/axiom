...
# lib = "pathlib"
# dimension = "behavior"
# case = "posix_path_as_pure_test__test_repr_roundtrips"
# subject = "cpython.test_pathlib.PosixPathAsPureTest.test_repr_roundtrips"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pathlib.py::PosixPathAsPureTest::test_repr_roundtrips
"""Auto-ported test: PosixPathAsPureTest::test_repr_roundtrips (CPython 3.12 oracle)."""
...
for pathstr in ('a', 'a/b', 'a/b/c', '/', '/a/b', '/a/b/c'):
    ...
    assert repr(q) == r
print("PosixPathAsPureTest::test_repr_roundtrips: ok")
