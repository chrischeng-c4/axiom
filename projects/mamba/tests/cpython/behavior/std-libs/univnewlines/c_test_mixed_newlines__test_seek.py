...
# lib = "univnewlines"
# dimension = "behavior"
# case = "c_test_mixed_newlines__test_seek"
# subject = "cpython.test_univnewlines.CTestMixedNewlines.test_seek"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_univnewlines.py::CTestMixedNewlines::test_seek
"""Auto-ported test: CTestMixedNewlines::test_seek (CPython 3.12 oracle)."""
...
assert data == DATA_SPLIT[1:]
print("CTestMixedNewlines::test_seek: ok")
