...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_execute_arg_int"
# subject = "cpython.test_dbapi.CursorTests.test_execute_arg_int"
# kind = "semantic"
...
self_cu.execute('insert into test(id) values (?)', (42,))

print("CursorTests::test_execute_arg_int: ok")
