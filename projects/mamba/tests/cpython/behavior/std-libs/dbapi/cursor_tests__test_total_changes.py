...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_total_changes"
# subject = "cpython.test_dbapi.CursorTests.test_total_changes"
# kind = "semantic"
...
self_cu.execute("insert into test(name) values ('foo')")
self_cu.execute("insert into test(name) values ('foo')")
assert 2 < self_cx.total_changes

print("CursorTests::test_total_changes: ok")
