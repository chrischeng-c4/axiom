...
# lib = "dbapi"
# dimension = "behavior"
# case = "blob_tests__test_blob_read_oversized"
# subject = "cpython.test_dbapi.BlobTests.test_blob_read_oversized"
# kind = "semantic"
...
buf = self_blob.read(len(self_data) * 2)
assert buf == self_data

print("BlobTests::test_blob_read_oversized: ok")
