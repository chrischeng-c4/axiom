...
# lib = "dbapi"
# dimension = "behavior"
# case = "blob_tests__test_blob_set_item_negative_index"
# subject = "cpython.test_dbapi.BlobTests.test_blob_set_item_negative_index"
# kind = "semantic"
...
self_blob[-1] = 255
assert self_blob[-1] == 255

print("BlobTests::test_blob_set_item_negative_index: ok")
