...
# lib = "dbapi"
# dimension = "behavior"
# case = "blob_tests__test_blob_set_empty_slice"
# subject = "cpython.test_dbapi.BlobTests.test_blob_set_empty_slice"
# kind = "semantic"
...
self_blob[0:0] = b''
assert self_blob[:] == self_data

print("BlobTests::test_blob_set_empty_slice: ok")
