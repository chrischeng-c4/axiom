...
# lib = "dbapi"
# dimension = "behavior"
# case = "blob_tests__test_blob_write_advance_offset"
# subject = "cpython.test_dbapi.BlobTests.test_blob_write_advance_offset"
# kind = "semantic"
...
self_blob.write(b'd' * 10)
assert self_blob.tell() == 10

print("BlobTests::test_blob_write_advance_offset: ok")
