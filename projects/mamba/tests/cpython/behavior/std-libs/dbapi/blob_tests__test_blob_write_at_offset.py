...
# lib = "dbapi"
# dimension = "behavior"
# case = "blob_tests__test_blob_write_at_offset"
# subject = "cpython.test_dbapi.BlobTests.test_blob_write_at_offset"
# kind = "semantic"
...
assert row[0] == self_data[:25] + new_data

print("BlobTests::test_blob_write_at_offset: ok")
