...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_rowcount_execute"
# subject = "cpython.test_dbapi.CursorTests.test_rowcount_execute"
# kind = "semantic"
...
self_cu.execute("insert into test(name) values ('foo')")
self_cu.execute("insert into test(name) values ('foo')")
self_cu.execute("update test set name='bar'")
assert self_cu.rowcount == 2

print("CursorTests::test_rowcount_execute: ok")
