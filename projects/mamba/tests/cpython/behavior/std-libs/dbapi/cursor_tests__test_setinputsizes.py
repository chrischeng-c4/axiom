...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_setinputsizes"
# subject = "cpython.test_dbapi.CursorTests.test_setinputsizes"
# kind = "semantic"
...
self_cu.setinputsizes([3, 4, 5])

print("CursorTests::test_setinputsizes: ok")
