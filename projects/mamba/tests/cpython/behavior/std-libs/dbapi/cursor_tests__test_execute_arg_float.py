...
# lib = "dbapi"
# dimension = "behavior"
# case = "cursor_tests__test_execute_arg_float"
# subject = "cpython.test_dbapi.CursorTests.test_execute_arg_float"
# kind = "semantic"
...
self_cu.execute('insert into test(income) values (?)', (2500.32,))

print("CursorTests::test_execute_arg_float: ok")
