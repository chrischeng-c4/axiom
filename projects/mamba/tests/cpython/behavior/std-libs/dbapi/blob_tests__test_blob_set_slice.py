...
# lib = "dbapi"
# dimension = "behavior"
# case = "blob_tests__test_blob_set_slice"
# subject = "cpython.test_dbapi.BlobTests.test_blob_set_slice"
# kind = "semantic"
...
self_blob[0:5] = b'12345'
expected = b'12345' + self_data[5:]
actual = self_cx.execute('select b from test').fetchone()[0]
assert actual == expected

print("BlobTests::test_blob_set_slice: ok")
