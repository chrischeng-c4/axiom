...
# lib = "pipes"
# dimension = "behavior"
# case = "simple_pipe_tests__test_empty_pipeline3"
# subject = "cpython.test_pipes.SimplePipeTests.testEmptyPipeline3"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pipes.py::SimplePipeTests::testEmptyPipeline3
"""Auto-ported test: SimplePipeTests::testEmptyPipeline3 (CPython 3.12 oracle)."""
...
with open(TESTFN) as f:
    ...
    assert f.read() == d
print("SimplePipeTests::testEmptyPipeline3: ok")
