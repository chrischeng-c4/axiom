...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_weaklinking__test_chown"
# subject = "cpython.test_posix.TestPosixWeaklinking.test_chown"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixWeaklinking::test_chown
"""Auto-ported test: TestPosixWeaklinking::test_chown (CPython 3.12 oracle)."""
...
_verify_available('HAVE_FCHOWNAT')
if self_mac_ver >= (10, 10):

    assert 'HAVE_FCHOWNAT' in posix._have_functions
else:

    assert 'HAVE_FCHOWNAT' not in posix._have_functions

    assert 'HAVE_LCHOWN' in posix._have_functions
    try:
...
print("TestPosixWeaklinking::test_chown: ok")
