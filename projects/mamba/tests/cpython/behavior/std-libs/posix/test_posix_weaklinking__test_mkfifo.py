...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_weaklinking__test_mkfifo"
# subject = "cpython.test_posix.TestPosixWeaklinking.test_mkfifo"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixWeaklinking::test_mkfifo
"""Auto-ported test: TestPosixWeaklinking::test_mkfifo (CPython 3.12 oracle)."""
...
_verify_available('HAVE_MKFIFOAT')
if self_mac_ver >= (13, 0):

    assert 'HAVE_MKFIFOAT' in posix._have_functions
else:

    assert 'HAVE_MKFIFOAT' not in posix._have_functions
    try:
...
print("TestPosixWeaklinking::test_mkfifo: ok")
