...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_spawn__test_specify_environment"
# subject = "cpython.test_posix.TestPosixSpawn.test_specify_environment"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixSpawn::test_specify_environment
"""Auto-ported test: TestPosixSpawn::test_specify_environment (CPython 3.12 oracle)."""
...
with open(envfile, encoding='utf-8') as f:
    ...
    assert f.read() == 'bar'
print("TestPosixSpawn::test_specify_environment: ok")
