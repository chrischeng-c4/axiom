...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_spawn_p__test_returns_pid"
# subject = "cpython.test_posix.TestPosixSpawnP.test_returns_pid"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixSpawnP::test_returns_pid
"""Auto-ported test: TestPosixSpawnP::test_returns_pid (CPython 3.12 oracle)."""
...
with open(pidfile, encoding='utf-8') as f:
    ...
    assert f.read() == str(pid)
print("TestPosixSpawnP::test_returns_pid: ok")
