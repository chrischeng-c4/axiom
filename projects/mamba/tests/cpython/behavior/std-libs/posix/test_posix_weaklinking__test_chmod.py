...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_weaklinking__test_chmod"
# subject = "cpython.test_posix.TestPosixWeaklinking.test_chmod"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixWeaklinking::test_chmod
"""Auto-ported test: TestPosixWeaklinking::test_chmod (CPython 3.12 oracle)."""
...
_verify_available('HAVE_FCHMODAT')
if self_mac_ver >= (10, 10):

    assert 'HAVE_FCHMODAT' in posix._have_functions
else:

    assert 'HAVE_FCHMODAT' not in posix._have_functions

    assert 'HAVE_LCHMOD' in posix._have_functions
    try:
...
print("TestPosixWeaklinking::test_chmod: ok")
