...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_spawn_p__test_no_such_executable"
# subject = "cpython.test_posix.TestPosixSpawnP.test_no_such_executable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixSpawnP::test_no_such_executable
"""Auto-ported test: TestPosixSpawnP::test_no_such_executable (CPython 3.12 oracle)."""
...
try:
    ...
    assert status != 0
print("TestPosixSpawnP::test_no_such_executable: ok")
