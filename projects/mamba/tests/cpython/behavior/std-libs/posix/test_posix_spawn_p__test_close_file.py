...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_spawn_p__test_close_file"
# subject = "cpython.test_posix.TestPosixSpawnP.test_close_file"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixSpawnP::test_close_file
"""Auto-ported test: TestPosixSpawnP::test_close_file (CPython 3.12 oracle)."""
...
pid = spawn_func(args[0], args, os.environ, file_actions=[(os.POSIX_SPAWN_CLOSE, 0)])
support.wait_process(pid, exitcode=0)
with open(closefile, encoding='utf-8') as f:

    assert f.read() == 'is closed %d' % errno.EBADF
print("TestPosixSpawnP::test_close_file: ok")
