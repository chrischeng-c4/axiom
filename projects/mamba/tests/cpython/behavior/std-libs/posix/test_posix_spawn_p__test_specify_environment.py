...
# lib = "posix"
# dimension = "behavior"
# case = "test_posix_spawn_p__test_specify_environment"
# subject = "cpython.test_posix.TestPosixSpawnP.test_specify_environment"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_posix.py::TestPosixSpawnP::test_specify_environment
"""Auto-ported test: TestPosixSpawnP::test_specify_environment (CPython 3.12 oracle)."""
...
pid = spawn_func(args[0], args, {**os.environ, 'foo': 'bar'})
support.wait_process(pid, exitcode=0)
with open(envfile, encoding='utf-8') as f:

    assert f.read() == 'bar'
print("TestPosixSpawnP::test_specify_environment: ok")
