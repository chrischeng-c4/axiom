...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_accumulate"
# subject = "cpython.test_itertools.TestBasicOps.test_accumulate"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_accumulate
"""Auto-ported test: TestBasicOps::test_accumulate (CPython 3.12 oracle)."""
...
for typ in (int, complex, Decimal, Fraction):
    ...
    assert list(accumulate(map(typ, range(10)))) == list(map(typ, [0, 1, 3, 6, 10, 15, 21, 28, 36, 45]))
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    pickletest(proto, accumulate(range(10)))
    pickletest(proto, accumulate(range(10), initial=7))
...
try:
    ...
    pass
print("TestBasicOps::test_accumulate: ok")
