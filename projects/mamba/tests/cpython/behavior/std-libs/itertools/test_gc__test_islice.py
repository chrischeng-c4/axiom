...
# lib = "itertools"
# dimension = "behavior"
# case = "test_gc__test_islice"
# subject = "cpython.test_itertools.TestGC.test_islice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestGC::test_islice
"""Auto-ported test: TestGC::test_islice (CPython 3.12 oracle)."""
...
a = []
makecycle(islice([a] * 2, None), a)
print("TestGC::test_islice: ok")
