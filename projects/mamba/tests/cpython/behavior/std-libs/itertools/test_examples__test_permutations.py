...
# lib = "itertools"
# dimension = "behavior"
# case = "test_examples__test_permutations"
# subject = "cpython.test_itertools.TestExamples.test_permutations"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestExamples::test_permutations
"""Auto-ported test: TestExamples::test_permutations (CPython 3.12 oracle)."""
...
assert list(permutations('ABCD', 2)) == list(map(tuple, 'AB AC AD BA BC BD CA CB CD DA DB DC'.split()))

assert list(permutations(range(3))) == [(0, 1, 2), (0, 2, 1), (1, 0, 2), (1, 2, 0), (2, 0, 1), (2, 1, 0)]
print("TestExamples::test_permutations: ok")
