...
# lib = "itertools"
# dimension = "behavior"
# case = "regression_tests__test_issue30347_1"
# subject = "cpython.test_itertools.RegressionTests.test_issue30347_1"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::RegressionTests::test_issue30347_1
"""Auto-ported test: RegressionTests::test_issue30347_1 (CPython 3.12 oracle)."""
...
for k, b in groupby(range(10), f):
    list(b)
print("RegressionTests::test_issue30347_1: ok")
