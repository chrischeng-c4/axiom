...
# lib = "itertools"
# dimension = "behavior"
# case = "test_gc__test_combinations_with_replacement"
# subject = "cpython.test_itertools.TestGC.test_combinations_with_replacement"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestGC::test_combinations_with_replacement
"""Auto-ported test: TestGC::test_combinations_with_replacement (CPython 3.12 oracle)."""
...
a = []
makecycle(combinations_with_replacement([1, 2, a, 3], 3), a)
print("TestGC::test_combinations_with_replacement: ok")
