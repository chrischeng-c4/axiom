...
# lib = "itertools"
# dimension = "behavior"
# case = "test_gc__test_takewhile"
# subject = "cpython.test_itertools.TestGC.test_takewhile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestGC::test_takewhile
"""Auto-ported test: TestGC::test_takewhile (CPython 3.12 oracle)."""
...
a = []
makecycle(takewhile(bool, [1, 0, a, a]), a)
print("TestGC::test_takewhile: ok")
