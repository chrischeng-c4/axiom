...
# lib = "itertools"
# dimension = "behavior"
# case = "length_transparency__test_repeat"
# subject = "cpython.test_itertools.LengthTransparency.test_repeat"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::LengthTransparency::test_repeat
"""Auto-ported test: LengthTransparency::test_repeat (CPython 3.12 oracle)."""
...
assert operator.length_hint(repeat(None, 50)) == 50

assert operator.length_hint(repeat(None, 0)) == 0

assert operator.length_hint(repeat(None), 12) == 12
print("LengthTransparency::test_repeat: ok")
