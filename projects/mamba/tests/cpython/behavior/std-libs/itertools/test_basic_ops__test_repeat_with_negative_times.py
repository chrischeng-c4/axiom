...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_repeat_with_negative_times"
# subject = "cpython.test_itertools.TestBasicOps.test_repeat_with_negative_times"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_repeat_with_negative_times
"""Auto-ported test: TestBasicOps::test_repeat_with_negative_times (CPython 3.12 oracle)."""
...
assert repr(repeat('a', -1)) == "repeat('a', 0)"

assert repr(repeat('a', -2)) == "repeat('a', 0)"

assert repr(repeat('a', times=-1)) == "repeat('a', 0)"

assert repr(repeat('a', times=-2)) == "repeat('a', 0)"
print("TestBasicOps::test_repeat_with_negative_times: ok")
