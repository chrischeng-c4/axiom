...
# lib = "itertools"
# dimension = "behavior"
# case = "test_examples__test_chain_from_iterable"
# subject = "cpython.test_itertools.TestExamples.test_chain_from_iterable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestExamples::test_chain_from_iterable
"""Auto-ported test: TestExamples::test_chain_from_iterable (CPython 3.12 oracle)."""
...
assert ''.join(chain.from_iterable(['ABC', 'DEF'])) == 'ABCDEF'
print("TestExamples::test_chain_from_iterable: ok")
