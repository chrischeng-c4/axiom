...
# lib = "itertools"
# dimension = "behavior"
# case = "length_transparency__test_repeat_with_negative_times"
# subject = "cpython.test_itertools.LengthTransparency.test_repeat_with_negative_times"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::LengthTransparency::test_repeat_with_negative_times
"""Auto-ported test: LengthTransparency::test_repeat_with_negative_times (CPython 3.12 oracle)."""
...
assert operator.length_hint(repeat(None, -1)) == 0

assert operator.length_hint(repeat(None, -2)) == 0

assert operator.length_hint(repeat(None, times=-1)) == 0

assert operator.length_hint(repeat(None, times=-2)) == 0
print("LengthTransparency::test_repeat_with_negative_times: ok")
