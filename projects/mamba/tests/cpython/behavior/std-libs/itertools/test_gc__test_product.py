...
# lib = "itertools"
# dimension = "behavior"
# case = "test_gc__test_product"
# subject = "cpython.test_itertools.TestGC.test_product"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestGC::test_product
"""Auto-ported test: TestGC::test_product (CPython 3.12 oracle)."""
...
a = []
makecycle(product([1, 2, a, 3], repeat=3), a)
print("TestGC::test_product: ok")
