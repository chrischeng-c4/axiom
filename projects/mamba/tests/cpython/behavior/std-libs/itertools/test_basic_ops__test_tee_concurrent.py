...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_tee_concurrent"
# subject = "cpython.test_itertools.TestBasicOps.test_tee_concurrent"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_tee_concurrent
"""Auto-ported test: TestBasicOps::test_tee_concurrent (CPython 3.12 oracle)."""
...
try:
    ...
    try:
        ...
        import re as _re_aR
        assert _re_aR.search('tee', str(_aR_e))
finally:
    finish.set()
    thread.join()
print("TestBasicOps::test_tee_concurrent: ok")
