...
# lib = "itertools"
# dimension = "behavior"
# case = "test_examples__test_chain"
# subject = "cpython.test_itertools.TestExamples.test_chain"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestExamples::test_chain
"""Auto-ported test: TestExamples::test_chain (CPython 3.12 oracle)."""
...
assert ''.join(chain('ABC', 'DEF')) == 'ABCDEF'
print("TestExamples::test_chain: ok")
