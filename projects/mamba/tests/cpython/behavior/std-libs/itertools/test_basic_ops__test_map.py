...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_map"
# subject = "cpython.test_itertools.TestBasicOps.test_map"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_map
"""Auto-ported test: TestBasicOps::test_map (CPython 3.12 oracle)."""
...
assert list(map(operator.pow, range(3), range(1, 7))) == [0 ** 1, 1 ** 2, 2 ** 3]
...
assert list(copy.copy(c)) == ans
c = map(tupleize, 'abc', count())

assert list(copy.deepcopy(c)) == ans
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    c = map(tupleize, 'abc', count())
    pickletest(proto, c)
print("TestBasicOps::test_map: ok")
