...
# lib = "itertools"
# dimension = "behavior"
# case = "test_basic_ops__test_zip_longest_tuple_reuse"
# subject = "cpython.test_itertools.TestBasicOps.test_zip_longest_tuple_reuse"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_itertools.py::TestBasicOps::test_zip_longest_tuple_reuse
"""Auto-ported test: TestBasicOps::test_zip_longest_tuple_reuse (CPython 3.12 oracle)."""
...
assert min(ids) == max(ids)
ids = list(map(id, list(zip_longest('abc', 'def'))))

assert len(dict.fromkeys(ids)) == len(ids)
print("TestBasicOps::test_zip_longest_tuple_reuse: ok")
