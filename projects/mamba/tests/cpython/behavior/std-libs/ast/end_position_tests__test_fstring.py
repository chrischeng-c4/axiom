...
# lib = "ast"
# dimension = "behavior"
# case = "end_position_tests__test_fstring"
# subject = "cpython.test_ast.EndPositionTests.test_fstring"
# kind = "semantic"
...
_check_content(s, binop, 'x + y')

print("EndPositionTests::test_fstring: ok")
