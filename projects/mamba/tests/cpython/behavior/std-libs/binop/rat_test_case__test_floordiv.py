...
# lib = "binop"
# dimension = "behavior"
# case = "rat_test_case__test_floordiv"
# subject = "cpython.test_binop.RatTestCase.test_floordiv"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_binop.py::RatTestCase::test_floordiv
"""Auto-ported test: RatTestCase::test_floordiv (CPython 3.12 oracle)."""
...
assert Rat(10) // Rat(4) == 2

assert Rat(10, 3) // Rat(4, 3) == 2

assert Rat(10) // 4 == 2

assert 10 // Rat(4) == 2
print("RatTestCase::test_floordiv: ok")
