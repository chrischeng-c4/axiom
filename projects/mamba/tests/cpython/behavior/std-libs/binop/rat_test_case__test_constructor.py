...
# lib = "binop"
# dimension = "behavior"
# case = "rat_test_case__test_constructor"
# subject = "cpython.test_binop.RatTestCase.test_constructor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_binop.py::RatTestCase::test_constructor
"""Auto-ported test: RatTestCase::test_constructor (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError("Rat(1, 0) didn't raise ZeroDivisionError")
for bad in ('0', 0.0, 0j, (), [], {}, None, Rat, unittest):
    try:
        ...
        raise AssertionError("Rat(%r) didn't raise TypeError" % bad)
    try:
        a = Rat(1, bad)
    except TypeError:
        pass
        ...
        raise AssertionError("Rat(1, %r) didn't raise TypeError" % bad)
print("RatTestCase::test_constructor: ok")
