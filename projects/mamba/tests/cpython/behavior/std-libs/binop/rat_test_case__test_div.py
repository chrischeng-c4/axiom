...
# lib = "binop"
# dimension = "behavior"
# case = "rat_test_case__test_div"
# subject = "cpython.test_binop.RatTestCase.test_div"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_binop.py::RatTestCase::test_div
"""Auto-ported test: RatTestCase::test_div (CPython 3.12 oracle)."""
...
assert Rat(10, 3) / Rat(5, 7) == Rat(14, 3)

assert Rat(10, 3) / 3 == Rat(10, 9)

assert 2 / Rat(5) == Rat(2, 5)

assert 3.0 * Rat(1, 2) == 1.5

assert Rat(1, 2) * 3.0 == 1.5
print("RatTestCase::test_div: ok")
