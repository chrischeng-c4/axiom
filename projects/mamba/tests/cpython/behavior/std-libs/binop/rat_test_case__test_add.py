...
# lib = "binop"
# dimension = "behavior"
# case = "rat_test_case__test_add"
# subject = "cpython.test_binop.RatTestCase.test_add"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_binop.py::RatTestCase::test_add
"""Auto-ported test: RatTestCase::test_add (CPython 3.12 oracle)."""
...
assert Rat(2, 3) + Rat(1, 3) == 1

assert Rat(2, 3) + 1 == Rat(5, 3)

assert 1 + Rat(2, 3) == Rat(5, 3)

assert 1.0 + Rat(1, 2) == 1.5

assert Rat(1, 2) + 1.0 == 1.5
print("RatTestCase::test_add: ok")
