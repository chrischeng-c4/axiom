...
# lib = "urllib"
# dimension = "behavior"
# case = "urlencode_tests__test_nonstring_seq_values"
# subject = "cpython.test_urllib.urlencode_Tests.test_nonstring_seq_values"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::urlencode_Tests::test_nonstring_seq_values
"""Auto-ported test: urlencode_Tests::test_nonstring_seq_values (CPython 3.12 oracle)."""
...
assert 'a=1&a=2' == urllib.parse.urlencode({'a': [1, 2]}, True)

assert 'a=None&a=a' == urllib.parse.urlencode({'a': [None, 'a']}, True)
data = collections.OrderedDict([('a', 1), ('b', 1)])

assert 'a=a&a=b' == urllib.parse.urlencode({'a': data}, True)
print("urlencode_Tests::test_nonstring_seq_values: ok")
