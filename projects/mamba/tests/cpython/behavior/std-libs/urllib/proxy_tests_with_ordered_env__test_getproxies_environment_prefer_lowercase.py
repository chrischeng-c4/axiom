...
# lib = "urllib"
# dimension = "behavior"
# case = "proxy_tests_with_ordered_env__test_getproxies_environment_prefer_lowercase"
# subject = "cpython.test_urllib.ProxyTests_withOrderedEnv.test_getproxies_environment_prefer_lowercase"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::ProxyTests_withOrderedEnv::test_getproxies_environment_prefer_lowercase
"""Auto-ported test: ProxyTests_withOrderedEnv::test_getproxies_environment_prefer_lowercase (CPython 3.12 oracle)."""
...
# --- test body ---
self__saved_env = os.environ
os.environ = collections.OrderedDict()
os.environ['no_proxy'] = ''
os.environ['No_Proxy'] = 'localhost'

assert not urllib.request.proxy_bypass_environment('localhost')

assert not urllib.request.proxy_bypass_environment('arbitrary')
...
assert urllib.request.proxy_bypass_environment('localhost')

assert urllib.request.proxy_bypass_environment('noproxy.com:5678')

assert urllib.request.proxy_bypass_environment('my.proxy:1234')

assert not urllib.request.proxy_bypass_environment('my.proxy')
...
assert 'http://somewhere:3128' == proxies['http']
print("ProxyTests_withOrderedEnv::test_getproxies_environment_prefer_lowercase: ok")
