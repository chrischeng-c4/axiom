...
# lib = "urllib"
# dimension = "behavior"
# case = "urlretrieve_file_tests__test_reporthook_8193_bytes"
# subject = "cpython.test_urllib.urlretrieve_FileTests.test_reporthook_8193_bytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::urlretrieve_FileTests::test_reporthook_8193_bytes
"""Auto-ported test: urlretrieve_FileTests::test_reporthook_8193_bytes (CPython 3.12 oracle)."""
...
srcFileName = createNewTempFile(b'x' * 8193)
urllib.request.urlretrieve(constructLocalFileUrl(srcFileName), os_helper.TESTFN, hooktester)

assert len(report) == 3

assert report[0][2] == 8193

assert report[0][1] == 8192

assert report[1][1] == 8192

assert report[2][1] == 8192
print("urlretrieve_FileTests::test_reporthook_8193_bytes: ok")
