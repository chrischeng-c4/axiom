...
# lib = "urllib"
# dimension = "behavior"
# case = "ur_lopener_tests__test_urlopener_retrieve_file"
# subject = "cpython.test_urllib.URLopener_Tests.test_urlopener_retrieve_file"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::URLopener_Tests::test_urlopener_retrieve_file
"""Auto-ported test: URLopener_Tests::test_urlopener_retrieve_file (CPython 3.12 oracle)."""
...
with os_helper.temp_dir() as tmpdir:
    ...
    assert os.path.normcase(filename) == os.path.normcase(tmpfile)
print("URLopener_Tests::test_urlopener_retrieve_file: ok")
