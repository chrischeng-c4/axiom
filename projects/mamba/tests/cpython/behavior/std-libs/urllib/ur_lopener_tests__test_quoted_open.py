...
# lib = "urllib"
# dimension = "behavior"
# case = "ur_lopener_tests__test_quoted_open"
# subject = "cpython.test_urllib.URLopener_Tests.test_quoted_open"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib.py::URLopener_Tests::test_quoted_open
"""Auto-ported test: URLopener_Tests::test_quoted_open (CPython 3.12 oracle)."""
...
with warnings_helper.check_warnings(('DummyURLopener style of invoking requests is deprecated.', DeprecationWarning)):
    ...
    assert DummyURLopener().open('spam://example/ /') == '//example/%20/'

    assert DummyURLopener().open("spam://c:|windows%/:=&?~#+!$,;'@()*[]|/path/") == "//c:|windows%/:=&?~#+!$,;'@()*[]|/path/"
print("URLopener_Tests::test_quoted_open: ok")
