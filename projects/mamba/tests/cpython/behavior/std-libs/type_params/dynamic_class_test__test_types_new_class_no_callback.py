...
# lib = "type_params"
# dimension = "behavior"
# case = "dynamic_class_test__test_types_new_class_no_callback"
# subject = "cpython.test_type_params.DynamicClassTest.test_types_new_class_no_callback"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_params.py::DynamicClassTest::test_types_new_class_no_callback
"""Auto-ported test: DynamicClassTest::test_types_new_class_no_callback (CPython 3.12 oracle)."""
...
assert Klass.__type_params__ == ()

assert Klass.__parameters__ == (T,)
print("DynamicClassTest::test_types_new_class_no_callback: ok")
