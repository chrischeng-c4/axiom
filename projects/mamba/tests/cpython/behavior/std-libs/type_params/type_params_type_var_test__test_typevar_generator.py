...
# lib = "type_params"
# dimension = "behavior"
# case = "type_params_type_var_test__test_typevar_generator"
# subject = "cpython.test_type_params.TypeParamsTypeVarTest.test_typevar_generator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_params.py::TypeParamsTypeVarTest::test_typevar_generator
"""Auto-ported test: TypeParamsTypeVarTest::test_typevar_generator (CPython 3.12 oracle)."""
...
assert c.__name__ == 'C'
print("TypeParamsTypeVarTest::test_typevar_generator: ok")
