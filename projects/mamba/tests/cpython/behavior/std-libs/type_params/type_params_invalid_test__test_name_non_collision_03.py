...
# subject = "cpython.test_type_params.TypeParamsInvalidTest.test_name_non_collision_03"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_params.py::TypeParamsInvalidTest::test_name_non_collision_03
