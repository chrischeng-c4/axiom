...
# lib = "type_params"
# dimension = "behavior"
# case = "type_params_runtime_test__test_name_error"
# subject = "cpython.test_type_params.TypeParamsRuntimeTest.test_name_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_params.py::TypeParamsRuntimeTest::test_name_error
"""Auto-ported test: TypeParamsRuntimeTest::test_name_error (CPython 3.12 oracle)."""
...
try:
    ...
    pass
print("TypeParamsRuntimeTest::test_name_error: ok")
