...
# lib = "locale"
# dimension = "behavior"
# case = "test_fr_fr_number_formatting__test_currency"
# subject = "cpython.test_locale.TestFrFRNumberFormatting.test_currency"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_locale.py::TestFrFRNumberFormatting::test_currency
"""Auto-ported test: TestFrFRNumberFormatting::test_currency (CPython 3.12 oracle)."""
...
euro = '€'
_test_currency(50000, '50000,00 ' + euro)
_test_currency(50000, '50 000,00 ' + euro, grouping=True)
_test_currency(50000, '50 000,00 EUR', grouping=True, international=True)
print("TestFrFRNumberFormatting::test_currency: ok")
