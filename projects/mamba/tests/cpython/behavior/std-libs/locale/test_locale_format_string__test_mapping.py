...
# lib = "locale"
# dimension = "behavior"
# case = "test_locale_format_string__test_mapping"
# subject = "cpython.test_locale.TestLocaleFormatString.test_mapping"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_locale.py::TestLocaleFormatString::test_mapping
"""Auto-ported test: TestLocaleFormatString::test_mapping (CPython 3.12 oracle)."""
...
assert locale.format_string('%(foo)s bing.', {'foo': 'bar'}) == '%(foo)s bing.' % {'foo': 'bar'}

assert locale.format_string('%(foo)s', {'foo': 'bar'}) == '%(foo)s' % {'foo': 'bar'}
print("TestLocaleFormatString::test_mapping: ok")
