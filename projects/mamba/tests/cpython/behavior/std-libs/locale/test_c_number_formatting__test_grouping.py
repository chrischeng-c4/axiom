...
# lib = "locale"
# dimension = "behavior"
# case = "test_c_number_formatting__test_grouping"
# subject = "cpython.test_locale.TestCNumberFormatting.test_grouping"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_locale.py::TestCNumberFormatting::test_grouping
"""Auto-ported test: TestCNumberFormatting::test_grouping (CPython 3.12 oracle)."""
...
_test_format_string('%.2f', 12345.67, grouping=True, out='12345.67')
print("TestCNumberFormatting::test_grouping: ok")
