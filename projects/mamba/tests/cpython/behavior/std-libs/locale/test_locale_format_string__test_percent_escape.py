...
# lib = "locale"
# dimension = "behavior"
# case = "test_locale_format_string__test_percent_escape"
# subject = "cpython.test_locale.TestLocaleFormatString.test_percent_escape"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_locale.py::TestLocaleFormatString::test_percent_escape
"""Auto-ported test: TestLocaleFormatString::test_percent_escape (CPython 3.12 oracle)."""
...
assert locale.format_string('%f%%', 1.0) == '%f%%' % 1.0

assert locale.format_string('%d %f%%d', (1, 1.0)) == '%d %f%%d' % (1, 1.0)

assert locale.format_string('%(foo)s %%d', {'foo': 'bar'}) == '%(foo)s %%d' % {'foo': 'bar'}
print("TestLocaleFormatString::test_percent_escape: ok")
