...
# lib = "codeccallbacks"
# dimension = "behavior"
# case = "codec_callback_test__test_fake_error_class"
# subject = "cpython.test_codeccallbacks.CodecCallbackTest.test_fake_error_class"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codeccallbacks.py::CodecCallbackTest::test_fake_error_class
"""Auto-ported test: CodecCallbackTest::test_fake_error_class (CPython 3.12 oracle)."""
...
for cls in (UnicodeEncodeError, UnicodeDecodeError, UnicodeTranslateError):
    ...
    for handler in handlers:
        try:
            handler(FakeUnicodeError())
            raise AssertionError('expected (TypeError, FakeUnicodeError)')
        except (TypeError, FakeUnicodeError):
            pass
print("CodecCallbackTest::test_fake_error_class: ok")
