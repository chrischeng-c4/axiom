...
# lib = "codeccallbacks"
# dimension = "behavior"
# case = "codec_callback_test__test_uninamereplace"
# subject = "cpython.test_codeccallbacks.CodecCallbackTest.test_uninamereplace"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codeccallbacks.py::CodecCallbackTest::test_uninamereplace
"""Auto-ported test: CodecCallbackTest::test_uninamereplace (CPython 3.12 oracle)."""
...
assert sin.encode('ascii', 'test.uninamereplace') == sout
sout = b'\xac\x1b[1mETHIOPIC SYLLABLE SEE, EURO SIGN, CJK UNIFIED IDEOGRAPH-8000\x1b[0m'

assert sin.encode('latin-1', 'test.uninamereplace') == sout
sout = b'\xac\x1b[1mETHIOPIC SYLLABLE SEE\x1b[0m\xa4\x1b[1mCJK UNIFIED IDEOGRAPH-8000\x1b[0m'

assert sin.encode('iso-8859-15', 'test.uninamereplace') == sout
print("CodecCallbackTest::test_uninamereplace: ok")
