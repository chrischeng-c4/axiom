...
# lib = "weakref"
# dimension = "behavior"
# case = "mapping_test_case__test_weak_keys_destroy_while_iterating"
# subject = "cpython.test_weakref.MappingTestCase.test_weak_keys_destroy_while_iterating"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakref.py::MappingTestCase::test_weak_keys_destroy_while_iterating
"""Auto-ported test: MappingTestCase::test_weak_keys_destroy_while_iterating (CPython 3.12 oracle)."""
...
check_weak_destroy_while_iterating(dict, objects, 'keyrefs')
dict, objects = make_weak_keyed_dict()
...
print("MappingTestCase::test_weak_keys_destroy_while_iterating: ok")
