...
# lib = "weakref"
# dimension = "behavior"
# case = "references_test_case__test_getweakrefcount"
# subject = "cpython.test_weakref.ReferencesTestCase.test_getweakrefcount"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakref.py::ReferencesTestCase::test_getweakrefcount
"""Auto-ported test: ReferencesTestCase::test_getweakrefcount (CPython 3.12 oracle)."""
...
proxy2 = weakref.proxy(o, callback)
...
assert weakref.getweakrefcount(1) == 0
print("ReferencesTestCase::test_getweakrefcount: ok")
