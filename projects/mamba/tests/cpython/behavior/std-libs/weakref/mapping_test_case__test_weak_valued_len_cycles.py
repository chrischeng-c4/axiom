...
# lib = "weakref"
# dimension = "behavior"
# case = "mapping_test_case__test_weak_valued_len_cycles"
# subject = "cpython.test_weakref.MappingTestCase.test_weak_valued_len_cycles"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakref.py::MappingTestCase::test_weak_valued_len_cycles
"""Auto-ported test: MappingTestCase::test_weak_valued_len_cycles (CPython 3.12 oracle)."""
...
def make_weak_valued_dict():
    ...
    return (dict, objects)
self_cbcalled = 0
check_len_cycles(weakref.WeakValueDictionary, lambda k: (1, k))
print("MappingTestCase::test_weak_valued_len_cycles: ok")
