...
# lib = "weakref"
# dimension = "behavior"
# case = "mapping_test_case__test_weak_keys"
# subject = "cpython.test_weakref.MappingTestCase.test_weak_keys"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_weakref.py::MappingTestCase::test_weak_keys
"""Auto-ported test: MappingTestCase::test_weak_keys (CPython 3.12 oracle)."""
...
assert len(dict) == COUNT
del objects[0]
gc_collect()

assert len(dict) == COUNT - 1
del objects, o
gc_collect()
...
assert 34 not in dict
print("MappingTestCase::test_weak_keys: ok")
