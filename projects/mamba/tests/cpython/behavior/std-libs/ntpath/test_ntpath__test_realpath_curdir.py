...
# lib = "ntpath"
# dimension = "behavior"
# case = "test_ntpath__test_realpath_curdir"
# subject = "cpython.test_ntpath.TestNtpath.test_realpath_curdir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ntpath.py::TestNtpath::test_realpath_curdir
"""Auto-ported test: TestNtpath::test_realpath_curdir (CPython 3.12 oracle)."""
...
tester("ntpath.realpath('.\\.')", expected)
tester("ntpath.realpath('\\'.join(['.'] * 100))", expected)
print("TestNtpath::test_realpath_curdir: ok")
