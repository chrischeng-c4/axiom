...
# lib = "ntpath"
# dimension = "behavior"
# case = "test_ntpath__test_realpath_pardir_strict"
# subject = "cpython.test_ntpath.TestNtpath.test_realpath_pardir_strict"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ntpath.py::TestNtpath::test_realpath_pardir_strict
"""Auto-ported test: TestNtpath::test_realpath_pardir_strict (CPython 3.12 oracle)."""
...
tester("ntpath.realpath('../..', strict=True)", ntpath.dirname(ntpath.dirname(expected)))
tester("ntpath.realpath('/'.join(['..'] * 50), strict=True)", ntpath.splitdrive(expected)[0] + '\\')
tester("ntpath.realpath('..\\..', strict=True)", ntpath.dirname(ntpath.dirname(expected)))
tester("ntpath.realpath('\\'.join(['..'] * 50), strict=True)", ntpath.splitdrive(expected)[0] + '\\')
print("TestNtpath::test_realpath_pardir_strict: ok")
