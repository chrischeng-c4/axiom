...
# lib = "http_cookiejar"
# dimension = "behavior"
# case = "cookie_tests__test_domain_match"
# subject = "cpython.test_http_cookiejar.CookieTests.test_domain_match"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_http_cookiejar.py::CookieTests::test_domain_match
"""Auto-ported test: CookieTests::test_domain_match (CPython 3.12 oracle)."""
...
assert not user_domain_match('192.168.1.1', '')
print("CookieTests::test_domain_match: ok")
