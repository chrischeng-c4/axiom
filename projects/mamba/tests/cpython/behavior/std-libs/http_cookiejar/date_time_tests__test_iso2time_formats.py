...
# lib = "http_cookiejar"
# dimension = "behavior"
# case = "date_time_tests__test_iso2time_formats"
# subject = "cpython.test_http_cookiejar.DateTimeTests.test_iso2time_formats"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_http_cookiejar.py::DateTimeTests::test_iso2time_formats
"""Auto-ported test: DateTimeTests::test_iso2time_formats (CPython 3.12 oracle)."""
...
for s in tests:
    ...
    assert iso2time(s) == test_t

    assert iso2time(s.lower()) == test_t

    assert iso2time(s.upper()) == test_t
print("DateTimeTests::test_iso2time_formats: ok")
