...
# lib = "http_cookiejar"
# dimension = "behavior"
# case = "cookie_tests__test_request_path"
# subject = "cpython.test_http_cookiejar.CookieTests.test_request_path"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_http_cookiejar.py::CookieTests::test_request_path
"""Auto-ported test: CookieTests::test_request_path (CPython 3.12 oracle)."""
...
assert request_path(req) == '/rheum/rhaponticum;foo=bar;sing=song'
req = urllib.request.Request('http://www.example.com/rheum/rhaponticum?apples=pears&spam=eggs#ni')

assert request_path(req) == '/rheum/rhaponticum'
req = urllib.request.Request('http://www.example.com')

assert request_path(req) == '/'
print("CookieTests::test_request_path: ok")
