...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_disassemble_class_method"
# subject = "cpython.test_dis.DisWithFileTests.test_disassemble_class_method"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_disassemble_class_method
"""Auto-ported test: DisWithFileTests::test_disassemble_class_method (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
do_disassembly_test(_C.cm, dis_c_class_method)
print("DisWithFileTests::test_disassemble_class_method: ok")
