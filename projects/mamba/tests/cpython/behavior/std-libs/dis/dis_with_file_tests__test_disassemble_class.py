...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_disassemble_class"
# subject = "cpython.test_dis.DisWithFileTests.test_disassemble_class"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_disassemble_class
"""Auto-ported test: DisWithFileTests::test_disassemble_class (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
do_disassembly_test(_C, dis_c)
print("DisWithFileTests::test_disassemble_class: ok")
