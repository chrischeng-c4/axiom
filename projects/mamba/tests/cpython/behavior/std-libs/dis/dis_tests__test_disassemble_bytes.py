...
# lib = "dis"
# dimension = "behavior"
# case = "dis_tests__test_disassemble_bytes"
# subject = "cpython.test_dis.DisTests.test_disassemble_bytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisTests::test_disassemble_bytes
"""Auto-ported test: DisTests::test_disassemble_bytes (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
do_disassembly_test(_f.__code__.co_code, dis_f_co_code)
print("DisTests::test_disassemble_bytes: ok")
