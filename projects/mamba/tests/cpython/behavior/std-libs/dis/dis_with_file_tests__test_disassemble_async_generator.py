...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_disassemble_async_generator"
# subject = "cpython.test_dis.DisWithFileTests.test_disassemble_async_generator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_disassemble_async_generator
"""Auto-ported test: DisWithFileTests::test_disassemble_async_generator (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
agen_func_disas = get_disassembly(_ag)
agen_disas = get_disassembly(_ag(1))

assert agen_disas == agen_func_disas
print("DisWithFileTests::test_disassemble_async_generator: ok")
