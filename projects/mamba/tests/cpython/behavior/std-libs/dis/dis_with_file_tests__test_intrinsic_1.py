...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_intrinsic_1"
# subject = "cpython.test_dis.DisWithFileTests.test_intrinsic_1"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_intrinsic_1
"""Auto-ported test: DisWithFileTests::test_intrinsic_1 (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
do_disassembly_test('from math import *', dis_intrinsic_1_2)
do_disassembly_test('+a', dis_intrinsic_1_5)
do_disassembly_test('(*a,)', dis_intrinsic_1_6)
print("DisWithFileTests::test_intrinsic_1: ok")
