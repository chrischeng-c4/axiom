...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_disassemble_str"
# subject = "cpython.test_dis.DisWithFileTests.test_disassemble_str"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_disassemble_str
"""Auto-ported test: DisWithFileTests::test_disassemble_str (CPython 3.12 oracle)."""
...
do_disassembly_test(simple_stmt_str, dis_simple_stmt_str)
do_disassembly_test(annot_stmt_str, dis_annot_stmt_str)
do_disassembly_test(compound_stmt_str, dis_compound_stmt_str)
print("DisWithFileTests::test_disassemble_str: ok")
