...
# lib = "dis"
# dimension = "behavior"
# case = "dis_tests__test_boundaries"
# subject = "cpython.test_dis.DisTests.test_boundaries"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisTests::test_boundaries
"""Auto-ported test: DisTests::test_boundaries (CPython 3.12 oracle)."""
...
assert dis.opmap['EXTENDED_ARG'] == dis.EXTENDED_ARG

assert dis.opmap['STORE_NAME'] == dis.HAVE_ARGUMENT
print("DisTests::test_boundaries: ok")
