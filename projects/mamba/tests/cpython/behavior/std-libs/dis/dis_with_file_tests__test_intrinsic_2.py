...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_intrinsic_2"
# subject = "cpython.test_dis.DisWithFileTests.test_intrinsic_2"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_intrinsic_2
"""Auto-ported test: DisWithFileTests::test_intrinsic_2 (CPython 3.12 oracle)."""
...
assert 'CALL_INTRINSIC_2         1 (INTRINSIC_PREP_RERAISE_STAR)' in get_disassembly('try: pass\nexcept* Exception: x')
print("DisWithFileTests::test_intrinsic_2: ok")
