...
# lib = "dis"
# dimension = "behavior"
# case = "instruction_tests__test_co_positions_with_lots_of_caches"
# subject = "cpython.test_dis.InstructionTests.test_co_positions_with_lots_of_caches"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::InstructionTests::test_co_positions_with_lots_of_caches
"""Auto-ported test: InstructionTests::test_co_positions_with_lots_of_caches (CPython 3.12 oracle)."""
...
for show_caches in (False, True):
    for adaptive in (False, True):
        co_positions = [positions for op, positions in zip(ops, code.co_positions(), strict=True) if show_caches or op != cache_opcode]
        dis_positions = [instruction.positions for instruction in dis.get_instructions(code, adaptive=adaptive, show_caches=show_caches)]

        assert co_positions == dis_positions
print("InstructionTests::test_co_positions_with_lots_of_caches: ok")
