...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_disassemble_generator"
# subject = "cpython.test_dis.DisWithFileTests.test_disassemble_generator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_disassemble_generator
"""Auto-ported test: DisWithFileTests::test_disassemble_generator (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
gen_func_disas = get_disassembly(_g)
gen_disas = get_disassembly(_g(1))

assert gen_disas == gen_func_disas
print("DisWithFileTests::test_disassemble_generator: ok")
