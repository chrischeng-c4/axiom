...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_super_instructions"
# subject = "cpython.test_dis.DisWithFileTests.test_super_instructions"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_super_instructions
"""Auto-ported test: DisWithFileTests::test_super_instructions (CPython 3.12 oracle)."""
...
def strip_offsets(text):
    ...
    return ''.join(res)
code_quicken(lambda: load_test(0, 0))
got = get_disassembly(load_test, adaptive=True)
do_disassembly_compare(got, dis_load_test_quickened_code, True)
print("DisWithFileTests::test_super_instructions: ok")
