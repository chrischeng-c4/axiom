...
# lib = "dis"
# dimension = "behavior"
# case = "dis_with_file_tests__test_big_linenos"
# subject = "cpython.test_dis.DisWithFileTests.test_big_linenos"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dis.py::DisWithFileTests::test_big_linenos
"""Auto-ported test: DisWithFileTests::test_big_linenos (CPython 3.12 oracle)."""
...
for i in range(1, 300):
    ...
    do_disassembly_test(func(i), expected)
...
do_disassembly_test(dis_module, dis_module_expected_results)
print("DisWithFileTests::test_big_linenos: ok")
