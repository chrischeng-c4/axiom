...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_http_body_iterable"
# subject = "cpython.test_urllib2.HandlerTests.test_http_body_iterable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_http_body_iterable
"""Auto-ported test: HandlerTests::test_http_body_iterable (CPython 3.12 oracle)."""
...
for headers in ({}, {'Content-Length': 11}):
    ...
    if not headers:
        ...
        assert newreq.get_header('Content-length') == None

        assert newreq.get_header('Transfer-encoding') == 'chunked'
    else:

        assert int(newreq.get_header('Content-length')) == 11
print("HandlerTests::test_http_body_iterable: ok")
