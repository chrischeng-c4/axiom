...
# lib = "urllib2"
# dimension = "behavior"
# case = "trivial_tests__test_parse_http_list"
# subject = "cpython.test_urllib2.TrivialTests.test_parse_http_list"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::TrivialTests::test_parse_http_list
"""Auto-ported test: TrivialTests::test_parse_http_list (CPython 3.12 oracle)."""
...
for string, list in tests:
    ...
    assert urllib.request.parse_http_list(string) == list
print("TrivialTests::test_parse_http_list: ok")
