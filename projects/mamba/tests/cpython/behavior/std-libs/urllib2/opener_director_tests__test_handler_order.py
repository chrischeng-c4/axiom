...
# lib = "urllib2"
# dimension = "behavior"
# case = "opener_director_tests__test_handler_order"
# subject = "cpython.test_urllib2.OpenerDirectorTests.test_handler_order"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::OpenerDirectorTests::test_handler_order
"""Auto-ported test: OpenerDirectorTests::test_handler_order (CPython 3.12 oracle)."""
...
assert o.calls[0][0] == handlers[1]

assert o.calls[1][0] == handlers[0]
print("OpenerDirectorTests::test_handler_order: ok")
