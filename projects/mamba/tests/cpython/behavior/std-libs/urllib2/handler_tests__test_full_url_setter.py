...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_full_url_setter"
# subject = "cpython.test_urllib2.HandlerTests.test_full_url_setter"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_full_url_setter
"""Auto-ported test: HandlerTests::test_full_url_setter (CPython 3.12 oracle)."""
...
for url in urls:
    ...
    assert (r.fragment or '') == parsed.fragment

    assert urlparse(r.get_full_url()).query == parsed.query
print("HandlerTests::test_full_url_setter: ok")
