...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_cookies"
# subject = "cpython.test_urllib2.HandlerTests.test_cookies"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_cookies
"""Auto-ported test: HandlerTests::test_cookies (CPython 3.12 oracle)."""
...
assert cj.ach_req is req

assert cj.ach_req is newreq

assert req.origin_req_host == 'example.com'

assert not req.unverifiable
newr = h.http_response(req, r)

assert cj.ec_req is req

assert cj.ec_r is r

assert r is newr
print("HandlerTests::test_cookies: ok")
