...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_basic_prior_auth_auto_send"
# subject = "cpython.test_urllib2.HandlerTests.test_basic_prior_auth_auto_send"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_basic_prior_auth_auto_send
"""Auto-ported test: HandlerTests::test_basic_prior_auth_auto_send (CPython 3.12 oracle)."""
...
assert pwd_manager.is_authenticated(request_url)

assert pwd_manager.is_authenticated(request_url + '/nested')

assert not pwd_manager.is_authenticated(request_url + 'plain')
opener = OpenerDirector()
opener.add_handler(auth_prior_handler)
opener.add_handler(http_handler)
opener.open(request_url)

assert http_handler.has_auth_header
print("HandlerTests::test_basic_prior_auth_auto_send: ok")
