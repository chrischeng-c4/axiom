...
# lib = "urllib2"
# dimension = "behavior"
# case = "trivial_tests__test_trivial"
# subject = "cpython.test_urllib2.TrivialTests.test_trivial"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::TrivialTests::test_trivial
"""Auto-ported test: TrivialTests::test_trivial (CPython 3.12 oracle)."""
...
try:
    urllib.request.urlopen('bogus url')
...
with urllib.request.urlopen(file_url) as f:
    f.read()
print("TrivialTests::test_trivial: ok")
