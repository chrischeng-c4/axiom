...
# lib = "urllib2"
# dimension = "behavior"
# case = "handler_tests__test_proxy_basic_auth"
# subject = "cpython.test_urllib2.HandlerTests.test_proxy_basic_auth"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::HandlerTests::test_proxy_basic_auth
"""Auto-ported test: HandlerTests::test_proxy_basic_auth (CPython 3.12 oracle)."""
...
opener.add_handler(auth_handler)
opener.add_handler(http_handler)
_test_basic_auth(opener, auth_handler, 'Proxy-authorization', realm, http_handler, password_manager, 'http://acme.example.com:3128/protected', 'proxy.example.com:3128')
print("HandlerTests::test_proxy_basic_auth: ok")
