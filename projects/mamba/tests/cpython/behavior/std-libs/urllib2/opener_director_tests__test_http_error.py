...
# lib = "urllib2"
# dimension = "behavior"
# case = "opener_director_tests__test_http_error"
# subject = "cpython.test_urllib2.OpenerDirectorTests.test_http_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::OpenerDirectorTests::test_http_error
"""Auto-ported test: OpenerDirectorTests::test_http_error (CPython 3.12 oracle)."""
...
for expected, got in zip(calls, o.calls):
    ...
    assert (handler, method_name) == got[:2]

    assert args == got[2]
print("OpenerDirectorTests::test_http_error: ok")
