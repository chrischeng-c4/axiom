...
# lib = "urllib2"
# dimension = "behavior"
# case = "request_hdrs_tests__test_request_headers_dict"
# subject = "cpython.test_urllib2.RequestHdrsTests.test_request_headers_dict"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urllib2.py::RequestHdrsTests::test_request_headers_dict
"""Auto-ported test: RequestHdrsTests::test_request_headers_dict (CPython 3.12 oracle)."""
...
assert Request(url, headers={'Spam-eggs': 'blah'}).headers['Spam-eggs'] == 'blah'

assert Request(url, headers={'spam-EggS': 'blah'}).headers['Spam-eggs'] == 'blah'
print("RequestHdrsTests::test_request_headers_dict: ok")
