...
# lib = "socket"
# dimension = "behavior"
# case = "inheritance_test__test_socketpair"
# subject = "cpython.test_socket.InheritanceTest.test_socketpair"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_socket.py::InheritanceTest::test_socketpair
"""Auto-ported test: InheritanceTest::test_socketpair (CPython 3.12 oracle)."""
...
assert s1.get_inheritable() == False

assert s2.get_inheritable() == False
print("InheritanceTest::test_socketpair: ok")
