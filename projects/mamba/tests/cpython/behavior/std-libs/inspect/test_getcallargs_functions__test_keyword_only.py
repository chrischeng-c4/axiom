...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getcallargs_functions__test_keyword_only"
# subject = "cpython.test_inspect.TestGetcallargsFunctions.test_keyword_only"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetcallargsFunctions::test_keyword_only
"""Auto-ported test: TestGetcallargsFunctions::test_keyword_only (CPython 3.12 oracle)."""
...
f = makeCallable('a=3, *, c, d=2')
assertEqualCallArgs(f, 'c=3')
assertEqualCallArgs(f, 'c=3, a=3')
assertEqualCallArgs(f, 'a=2, c=4')
assertEqualCallArgs(f, '4, c=4')
assertEqualException(f, '')
assertEqualException(f, '3')
assertEqualException(f, 'a=3')
assertEqualException(f, 'd=4')
f = makeCallable('*, c, d=2')
assertEqualCallArgs(f, 'c=3')
assertEqualCallArgs(f, 'c=3, d=4')
assertEqualCallArgs(f, 'd=4, c=3')
print("TestGetcallargsFunctions::test_keyword_only: ok")
