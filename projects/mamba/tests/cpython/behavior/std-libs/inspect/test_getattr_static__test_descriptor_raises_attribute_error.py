...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_descriptor_raises_attribute_error"
# subject = "cpython.test_inspect.TestGetattrStatic.test_descriptor_raises_AttributeError"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_descriptor_raises_AttributeError
"""Auto-ported test: TestGetattrStatic::test_descriptor_raises_AttributeError (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(thing, 'x') == desc
print("TestGetattrStatic::test_descriptor_raises_AttributeError: ok")
