...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_wrapper"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_wrapper"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_wrapper
"""Auto-ported test: TestSignatureObject::test_signature_on_wrapper (CPython 3.12 oracle)."""
...
assert signature(wrapper) == ((('a', ..., ..., 'positional_or_keyword'),), ...)
wrapper = Wrapper()
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('wrapper loop', str(_aR_e))
print("TestSignatureObject::test_signature_on_wrapper: ok")
