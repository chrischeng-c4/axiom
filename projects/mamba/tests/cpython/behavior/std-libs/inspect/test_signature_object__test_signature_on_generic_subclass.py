...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_generic_subclass"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_generic_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_generic_subclass
"""Auto-ported test: TestSignatureObject::test_signature_on_generic_subclass (CPython 3.12 oracle)."""
...
assert signature(A) == ((('a', ..., int, 'keyword_only'),), None)
print("TestSignatureObject::test_signature_on_generic_subclass: ok")
