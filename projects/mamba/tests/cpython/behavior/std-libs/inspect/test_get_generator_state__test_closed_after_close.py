...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_generator_state__test_closed_after_close"
# subject = "cpython.test_inspect.TestGetGeneratorState.test_closed_after_close"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetGeneratorState::test_closed_after_close
"""Auto-ported test: TestGetGeneratorState::test_closed_after_close (CPython 3.12 oracle)."""
...
self_generator.close()

assert _generatorstate() == inspect.GEN_CLOSED
print("TestGetGeneratorState::test_closed_after_close: ok")
