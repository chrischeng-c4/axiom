...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_partialmethod"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_partialmethod"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_partialmethod
"""Auto-ported test: TestSignatureObject::test_signature_on_partialmethod (CPython 3.12 oracle)."""
...
assert signature(Spam.ham, eval_str=False) == ((('it', ..., ..., 'positional_or_keyword'), ('a', ..., ..., 'positional_or_keyword'), ('c', 1, ..., 'keyword_only')), 'spam')

assert signature(Spam().ham, eval_str=False) == ((('a', ..., ..., 'positional_or_keyword'), ('c', 1, ..., 'keyword_only')), 'spam')
...
assert signature(Spam.g, eval_str=False) == ((('self', ..., 'anno', 'positional_or_keyword'),), ...)
print("TestSignatureObject::test_signature_on_partialmethod: ok")
