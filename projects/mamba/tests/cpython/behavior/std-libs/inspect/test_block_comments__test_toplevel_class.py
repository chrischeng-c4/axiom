...
# lib = "inspect"
# dimension = "behavior"
# case = "test_block_comments__test_toplevel_class"
# subject = "cpython.test_inspect.TestBlockComments.test_toplevel_class"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBlockComments::test_toplevel_class
"""Auto-ported test: TestBlockComments::test_toplevel_class (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod.WhichComments, 96, 114)
print("TestBlockComments::test_toplevel_class: ok")
