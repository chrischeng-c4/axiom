...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_bind__test_signature_bind_just_args"
# subject = "cpython.test_inspect.TestSignatureBind.test_signature_bind_just_args"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureBind::test_signature_bind_just_args
"""Auto-ported test: TestSignatureBind::test_signature_bind_just_args (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search("missing a required argument: 'b'", str(_aR_e))
try:
    call(test)
    raise AssertionError('expected TypeError')
except TypeError as _aR_e:
    import re as _re_aR
    assert _re_aR.search("missing a required argument: 'a'", str(_aR_e))
...
assert call(test, 1, 2) == (1, 2, 10)

def test(a=1, b=2, c=3):
    return (a, b, c)

assert call(test, a=10, c=13) == (10, 2, 13)

assert call(test, a=10) == (10, 2, 3)

assert call(test, b=10) == (1, 10, 3)
print("TestSignatureBind::test_signature_bind_just_args: ok")
