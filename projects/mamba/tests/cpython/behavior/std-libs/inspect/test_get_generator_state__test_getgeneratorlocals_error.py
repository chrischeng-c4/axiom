...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_generator_state__test_getgeneratorlocals_error"
# subject = "cpython.test_inspect.TestGetGeneratorState.test_getgeneratorlocals_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetGeneratorState::test_getgeneratorlocals_error
"""Auto-ported test: TestGetGeneratorState::test_getgeneratorlocals_error (CPython 3.12 oracle)."""
...
try:
    inspect.getgeneratorlocals(1)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    inspect.getgeneratorlocals(lambda x: True)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    inspect.getgeneratorlocals(set)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    inspect.getgeneratorlocals((2, 3))
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("TestGetGeneratorState::test_getgeneratorlocals_error: ok")
