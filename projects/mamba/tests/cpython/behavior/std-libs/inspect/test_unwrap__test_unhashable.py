...
# lib = "inspect"
# dimension = "behavior"
# case = "test_unwrap__test_unhashable"
# subject = "cpython.test_inspect.TestUnwrap.test_unhashable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestUnwrap::test_unhashable
"""Auto-ported test: TestUnwrap::test_unhashable (CPython 3.12 oracle)."""
...
assert inspect.unwrap(C()) is None
print("TestUnwrap::test_unhashable: ok")
