...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getcallargs_functions__test_varkw_only"
# subject = "cpython.test_inspect.TestGetcallargsFunctions.test_varkw_only"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetcallargsFunctions::test_varkw_only
"""Auto-ported test: TestGetcallargsFunctions::test_varkw_only (CPython 3.12 oracle)."""
...
assertEqualCallArgs(f, 'a=1')
assertEqualCallArgs(f, 'a=1, b=2')
assertEqualCallArgs(f, 'c=3, **{"a": 1, "b": 2}')
assertEqualCallArgs(f, '**collections.UserDict(a=1, b=2)')
assertEqualCallArgs(f, 'c=3, **collections.UserDict(a=1, b=2)')
print("TestGetcallargsFunctions::test_varkw_only: ok")
