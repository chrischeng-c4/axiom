...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_multiline_sig"
# subject = "cpython.test_inspect.TestBuggyCases.test_multiline_sig"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_multiline_sig
"""Auto-ported test: TestBuggyCases::test_multiline_sig (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.multiline_sig[0], 63, 64)
print("TestBuggyCases::test_multiline_sig: ok")
