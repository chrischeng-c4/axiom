...
# lib = "inspect"
# dimension = "behavior"
# case = "test_predicates__test_isawaitable"
# subject = "cpython.test_inspect.TestPredicates.test_isawaitable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestPredicates::test_isawaitable
"""Auto-ported test: TestPredicates::test_isawaitable (CPython 3.12 oracle)."""
...
assert not inspect.isawaitable(Future)
...
assert not inspect.isawaitable(not_fut)
coro.close()
gen_coro.close()
print("TestPredicates::test_isawaitable: ok")
