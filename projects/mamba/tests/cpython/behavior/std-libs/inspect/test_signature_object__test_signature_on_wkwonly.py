...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_wkwonly"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_wkwonly"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_wkwonly
"""Auto-ported test: TestSignatureObject::test_signature_on_wkwonly (CPython 3.12 oracle)."""
...
assert signature(test) == ((('a', ..., float, 'keyword_only'), ('b', ..., str, 'keyword_only')), int)
print("TestSignatureObject::test_signature_on_wkwonly: ok")
