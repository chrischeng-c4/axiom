...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_nested_class_definition_indented_string"
# subject = "cpython.test_inspect.TestBuggyCases.test_nested_class_definition_indented_string"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_nested_class_definition_indented_string
"""Auto-ported test: TestBuggyCases::test_nested_class_definition_indented_string (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.cls173.cls175, 175, 176)
print("TestBuggyCases::test_nested_class_definition_indented_string: ok")
