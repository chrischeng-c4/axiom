...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_non_function"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_non_function"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_non_function
"""Auto-ported test: TestSignatureObject::test_signature_on_non_function (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('is not a callable object', str(_aR_e))
print("TestSignatureObject::test_signature_on_non_function: ok")
