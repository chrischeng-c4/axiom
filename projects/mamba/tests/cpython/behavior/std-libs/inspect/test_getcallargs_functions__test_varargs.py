...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getcallargs_functions__test_varargs"
# subject = "cpython.test_inspect.TestGetcallargsFunctions.test_varargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetcallargsFunctions::test_varargs
"""Auto-ported test: TestGetcallargsFunctions::test_varargs (CPython 3.12 oracle)."""
...
assertEqualCallArgs(f, '2, 3, 4')
assertEqualCallArgs(f, '*(2,3,4)')
assertEqualCallArgs(f, '2, *[3,4]')
assertEqualCallArgs(f, '2, 3, *collections.UserList([4])')
print("TestGetcallargsFunctions::test_varargs: ok")
