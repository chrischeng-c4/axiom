...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_decorated"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_decorated"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_decorated
"""Auto-ported test: TestSignatureObject::test_signature_on_decorated (CPython 3.12 oracle)."""
...
assert signature(Foo.bar) == ((('self', ..., ..., 'positional_or_keyword'), ('a', ..., ..., 'positional_or_keyword'), ('b', ..., ..., 'positional_or_keyword')), ...)

assert signature(Foo().bar) == ((('a', ..., ..., 'positional_or_keyword'), ('b', ..., ..., 'positional_or_keyword')), ...)

assert signature(Foo.bar, follow_wrapped=False) == ((('args', ..., ..., 'var_positional'), ('kwargs', ..., ..., 'var_keyword')), ...)

assert signature(bar) == ((('a', ..., ..., 'positional_or_keyword'), ('b', ..., ..., 'positional_or_keyword')), ...)
...
assert signature(Foo.__call__) == ((('a', ..., ..., 'positional_or_keyword'), ('b', ..., ..., 'positional_or_keyword')), ...)

assert signature(Foo().__call__) == ((('b', ..., ..., 'positional_or_keyword'),), ...)

def wrapped_foo_call():
    pass
wrapped_foo_call.__wrapped__ = Foo.__call__

assert signature(wrapped_foo_call) == ((('a', ..., ..., 'positional_or_keyword'), ('b', ..., ..., 'positional_or_keyword')), ...)
print("TestSignatureObject::test_signature_on_decorated: ok")
