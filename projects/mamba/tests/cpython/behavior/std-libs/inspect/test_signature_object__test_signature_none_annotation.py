...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_none_annotation"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_none_annotation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_none_annotation
"""Auto-ported test: TestSignatureObject::test_signature_none_annotation (CPython 3.12 oracle)."""
...
for signature_func in (inspect.signature, inspect.Signature.from_callable):
    ...
    assert signature_func(foo) == inspect.Signature()

assert inspect.get_annotations(foo) == {}
print("TestSignatureObject::test_signature_none_annotation: ok")
