...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_str_positional_only"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_str_positional_only"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_str_positional_only
"""Auto-ported test: TestSignatureObject::test_signature_str_positional_only (CPython 3.12 oracle)."""
...
assert str(inspect.signature(test)) == '(a_po, /, *, b, **kwargs)'

assert str(S(parameters=[P('foo', P.POSITIONAL_ONLY)])) == '(foo, /)'

assert str(S(parameters=[P('foo', P.POSITIONAL_ONLY), P('bar', P.VAR_KEYWORD)])) == '(foo, /, **bar)'

assert str(S(parameters=[P('foo', P.POSITIONAL_ONLY), P('bar', P.VAR_POSITIONAL)])) == '(foo, /, *bar)'
print("TestSignatureObject::test_signature_str_positional_only: ok")
