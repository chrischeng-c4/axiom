...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_getmembers_method"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_getmembers_method"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_getmembers_method
"""Auto-ported test: TestClassesAndFunctions::test_getmembers_method (CPython 3.12 oracle)."""
...
assert ('f', B.f) in inspect.getmembers(B)

assert ('f', B.f) not in inspect.getmembers(B, inspect.ismethod)
b = B()

assert ('f', b.f) in inspect.getmembers(b)

assert ('f', b.f) in inspect.getmembers(b, inspect.ismethod)
print("TestClassesAndFunctions::test_getmembers_method: ok")
