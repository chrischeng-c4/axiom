...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_findsource_with_out_of_bounds_lineno"
# subject = "cpython.test_inspect.TestBuggyCases.test_findsource_with_out_of_bounds_lineno"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_findsource_with_out_of_bounds_lineno
"""Auto-ported test: TestBuggyCases::test_findsource_with_out_of_bounds_lineno (CPython 3.12 oracle)."""
...
assert func.__code__.co_firstlineno == 1 + 2 * mod_len
try:
    inspect.findsource(func)
    raise AssertionError('expected IOError')
except IOError as _aR_e:
    import re as _re_aR
    assert _re_aR.search('lineno is out of bounds', str(_aR_e))
print("TestBuggyCases::test_findsource_with_out_of_bounds_lineno: ok")
