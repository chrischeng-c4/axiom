...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_mocks"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_mocks"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_mocks
"""Auto-ported test: TestSignatureObject::test_signature_on_mocks (CPython 3.12 oracle)."""
...
for mock in (unittest.mock.Mock(), unittest.mock.AsyncMock(), unittest.mock.MagicMock()):

    assert str(inspect.signature(mock)) == '(*args, **kwargs)'
print("TestSignatureObject::test_signature_on_mocks: ok")
