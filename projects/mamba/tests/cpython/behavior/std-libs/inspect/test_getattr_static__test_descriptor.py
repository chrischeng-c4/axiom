...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_descriptor"
# subject = "cpython.test_inspect.TestGetattrStatic.test_descriptor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_descriptor
"""Auto-ported test: TestGetattrStatic::test_descriptor (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(foo, 'd') == 1
descriptor.__set__ = lambda s, i, v: None

assert inspect.getattr_static(foo, 'd') == Foo.__dict__['d']
del descriptor.__set__
descriptor.__delete__ = lambda s, i, o: None

assert inspect.getattr_static(foo, 'd') == Foo.__dict__['d']
print("TestGetattrStatic::test_descriptor: ok")
