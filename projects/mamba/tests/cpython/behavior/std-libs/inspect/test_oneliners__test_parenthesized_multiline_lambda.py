...
# lib = "inspect"
# dimension = "behavior"
# case = "test_oneliners__test_parenthesized_multiline_lambda"
# subject = "cpython.test_inspect.TestOneliners.test_parenthesized_multiline_lambda"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestOneliners::test_parenthesized_multiline_lambda
"""Auto-ported test: TestOneliners::test_parenthesized_multiline_lambda (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.parenthesized_lambda, 279, 279)
assertSourceEqual(mod2.parenthesized_lambda2, 281, 281)
assertSourceEqual(mod2.parenthesized_lambda3, 283, 283)
print("TestOneliners::test_parenthesized_multiline_lambda: ok")
