...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_method"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_method"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_method
"""Auto-ported test: TestSignatureObject::test_signature_on_method (CPython 3.12 oracle)."""
...
assert signature(Test().m1) == ((('arg1', ..., ..., 'positional_or_keyword'), ('arg2', 1, ..., 'positional_or_keyword')), int)

assert signature(Test().m2) == ((('args', ..., ..., 'var_positional'),), ...)

assert signature(Test) == ((('args', ..., ..., 'var_positional'),), ...)
try:
    signature(Test())
    raise AssertionError('expected ValueError')
except ValueError as _aR_e:
    import re as _re_aR
    assert _re_aR.search('invalid method signature', str(_aR_e))
print("TestSignatureObject::test_signature_on_method: ok")
