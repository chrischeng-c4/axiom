...
# lib = "inspect"
# dimension = "behavior"
# case = "test_unwrap__test_wrapped_descriptor"
# subject = "cpython.test_inspect.TestUnwrap.test_wrapped_descriptor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestUnwrap::test_wrapped_descriptor
"""Auto-ported test: TestUnwrap::test_wrapped_descriptor (CPython 3.12 oracle)."""
...
assert inspect.unwrap(NTimesUnwrappable) is NTimesUnwrappable

assert inspect.unwrap(staticmethod) is staticmethod

assert inspect.unwrap(classmethod) is classmethod

assert inspect.unwrap(staticmethod(classmethod)) is classmethod

assert inspect.unwrap(classmethod(staticmethod)) is staticmethod
print("TestUnwrap::test_wrapped_descriptor: ok")
