...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_class_virtual_attribute"
# subject = "cpython.test_inspect.TestGetattrStatic.test_classVirtualAttribute"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_classVirtualAttribute
"""Auto-ported test: TestGetattrStatic::test_classVirtualAttribute (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(Thing, 'x') == Thing.__dict__['x']
print("TestGetattrStatic::test_classVirtualAttribute: ok")
