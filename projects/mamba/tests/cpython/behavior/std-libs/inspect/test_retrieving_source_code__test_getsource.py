...
# lib = "inspect"
# dimension = "behavior"
# case = "test_retrieving_source_code__test_getsource"
# subject = "cpython.test_inspect.TestRetrievingSourceCode.test_getsource"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestRetrievingSourceCode::test_getsource
"""Auto-ported test: TestRetrievingSourceCode::test_getsource (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(git.abuse, 29, 39)
assertSourceEqual(mod.StupidGit, 21, 51)
assertSourceEqual(mod.lobbest, 75, 76)
assertSourceEqual(mod.after_closing, 120, 120)
print("TestRetrievingSourceCode::test_getsource: ok")
