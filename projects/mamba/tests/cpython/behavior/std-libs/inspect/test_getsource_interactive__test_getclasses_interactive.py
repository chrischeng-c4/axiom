...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getsource_interactive__test_getclasses_interactive"
# subject = "cpython.test_inspect.TestGetsourceInteractive.test_getclasses_interactive"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetsourceInteractive::test_getclasses_interactive
"""Auto-ported test: TestGetsourceInteractive::test_getclasses_interactive (CPython 3.12 oracle)."""
...
assert b'OSError: source code not available' in stderr
print("TestGetsourceInteractive::test_getclasses_interactive: ok")
