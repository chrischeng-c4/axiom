...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_generator_state__test_closed_after_immediate_exception"
# subject = "cpython.test_inspect.TestGetGeneratorState.test_closed_after_immediate_exception"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetGeneratorState::test_closed_after_immediate_exception
"""Auto-ported test: TestGetGeneratorState::test_closed_after_immediate_exception (CPython 3.12 oracle)."""
...
try:
    self_generator.throw(RuntimeError)
    raise AssertionError('expected RuntimeError')
except RuntimeError:
    pass

assert _generatorstate() == inspect.GEN_CLOSED
print("TestGetGeneratorState::test_closed_after_immediate_exception: ok")
