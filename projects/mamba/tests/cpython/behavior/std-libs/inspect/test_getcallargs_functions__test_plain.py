...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getcallargs_functions__test_plain"
# subject = "cpython.test_inspect.TestGetcallargsFunctions.test_plain"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetcallargsFunctions::test_plain
"""Auto-ported test: TestGetcallargsFunctions::test_plain (CPython 3.12 oracle)."""
...
f = makeCallable('a, b=1')
assertEqualCallArgs(f, '2')
assertEqualCallArgs(f, '2, 3')
assertEqualCallArgs(f, 'a=2')
assertEqualCallArgs(f, 'b=3, a=2')
assertEqualCallArgs(f, '2, b=3')
assertEqualCallArgs(f, '*(2,)')
assertEqualCallArgs(f, '*[2]')
assertEqualCallArgs(f, '*(2, 3)')
assertEqualCallArgs(f, '*[2, 3]')
...
assertEqualCallArgs(f, '2, **{"b":3}')
assertEqualCallArgs(f, '**{"b":3, "a":2}')
assertEqualCallArgs(f, '*collections.UserList([2])')
assertEqualCallArgs(f, '*collections.UserList([2, 3])')
assertEqualCallArgs(f, '**collections.UserDict(a=2)')
assertEqualCallArgs(f, '2, **collections.UserDict(b=3)')
assertEqualCallArgs(f, 'b=2, **collections.UserDict(a=3)')
print("TestGetcallargsFunctions::test_plain: ok")
