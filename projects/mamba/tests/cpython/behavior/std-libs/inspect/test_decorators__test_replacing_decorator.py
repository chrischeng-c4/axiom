...
# lib = "inspect"
# dimension = "behavior"
# case = "test_decorators__test_replacing_decorator"
# subject = "cpython.test_inspect.TestDecorators.test_replacing_decorator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestDecorators::test_replacing_decorator
"""Auto-ported test: TestDecorators::test_replacing_decorator (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.gone, 9, 10)
print("TestDecorators::test_replacing_decorator: ok")
