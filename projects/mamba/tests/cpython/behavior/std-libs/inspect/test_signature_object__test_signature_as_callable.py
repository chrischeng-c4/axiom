...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_as_callable"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_as_callable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_as_callable
"""Auto-ported test: TestSignatureObject::test_signature_as_callable (CPython 3.12 oracle)."""
...
assert signature(S) == ((('a', ..., ..., 'positional_or_keyword'), ('b', 2, ..., 'positional_or_keyword')), ...)
...
assert signature(S) == ((('a', ..., ..., 'positional_or_keyword'), ('b', 2, ..., 'positional_or_keyword')), ...)
print("TestSignatureObject::test_signature_as_callable: ok")
