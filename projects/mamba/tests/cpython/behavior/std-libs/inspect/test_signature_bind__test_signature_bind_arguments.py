...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_bind__test_signature_bind_arguments"
# subject = "cpython.test_inspect.TestSignatureBind.test_signature_bind_arguments"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureBind::test_signature_bind_arguments
"""Auto-ported test: TestSignatureBind::test_signature_bind_arguments (CPython 3.12 oracle)."""
...
assert tuple(ba.arguments.items()) == (('a', 10), ('args', (20,)), ('b', 30), ('kwargs', {'c': 40, 'args': 50, 'kwargs': 60}))

assert ba.kwargs == {'b': 30, 'c': 40, 'args': 50, 'kwargs': 60}

assert ba.args == (10, 20)
print("TestSignatureBind::test_signature_bind_arguments: ok")
