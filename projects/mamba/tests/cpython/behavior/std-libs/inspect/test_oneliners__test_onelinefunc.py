...
# lib = "inspect"
# dimension = "behavior"
# case = "test_oneliners__test_onelinefunc"
# subject = "cpython.test_inspect.TestOneliners.test_onelinefunc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestOneliners::test_onelinefunc
"""Auto-ported test: TestOneliners::test_onelinefunc (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.onelinefunc, 37, 37)
print("TestOneliners::test_onelinefunc: ok")
