...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_instance_attr"
# subject = "cpython.test_inspect.TestGetattrStatic.test_instance_attr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_instance_attr
"""Auto-ported test: TestGetattrStatic::test_instance_attr (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(thing, 'x') == 3
del thing.x

assert inspect.getattr_static(thing, 'x') == 2
print("TestGetattrStatic::test_instance_attr: ok")
