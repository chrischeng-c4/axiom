...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_metaclass"
# subject = "cpython.test_inspect.TestGetattrStatic.test_metaclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_metaclass
"""Auto-ported test: TestGetattrStatic::test_metaclass (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(Thing, 'attr') == 'foo'
...
assert inspect.getattr_static(OtherThing, 'attr') == 'foo'

class OtherOtherThing(OtherThing):
    pass

assert inspect.getattr_static(OtherOtherThing, 'x') == 3
print("TestGetattrStatic::test_metaclass: ok")
