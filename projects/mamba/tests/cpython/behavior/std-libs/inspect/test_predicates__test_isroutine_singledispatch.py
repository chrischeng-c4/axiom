...
# lib = "inspect"
# dimension = "behavior"
# case = "test_predicates__test_isroutine_singledispatch"
# subject = "cpython.test_inspect.TestPredicates.test_isroutine_singledispatch"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestPredicates::test_isroutine_singledispatch
"""Auto-ported test: TestPredicates::test_isroutine_singledispatch (CPython 3.12 oracle)."""
...
assert inspect.isroutine(functools.singledispatch(mod.spam))
...
assert inspect.isroutine(A.method)

assert inspect.isroutine(A().method)

assert inspect.isroutine(A.static_method)

assert inspect.isroutine(A.class_method)
print("TestPredicates::test_isroutine_singledispatch: ok")
