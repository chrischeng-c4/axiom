...
# lib = "inspect"
# dimension = "behavior"
# case = "test_classes_and_functions__test_getmembers_custom_broken_dir"
# subject = "cpython.test_inspect.TestClassesAndFunctions.test_getmembers_custom_broken_dir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestClassesAndFunctions::test_getmembers_custom_broken_dir
"""Auto-ported test: TestClassesAndFunctions::test_getmembers_custom_broken_dir (CPython 3.12 oracle)."""
...
assert inspect.getmembers(bd) == [('existing', 1), ('method', bd.method)]

assert inspect.getmembers(bd, inspect.ismethod) == [('method', bd.method)]
print("TestClassesAndFunctions::test_getmembers_custom_broken_dir: ok")
