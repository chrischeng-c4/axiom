...
# lib = "inspect"
# dimension = "behavior"
# case = "test_parameter_object__test_signature_parameter_kinds"
# subject = "cpython.test_inspect.TestParameterObject.test_signature_parameter_kinds"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestParameterObject::test_signature_parameter_kinds
"""Auto-ported test: TestParameterObject::test_signature_parameter_kinds (CPython 3.12 oracle)."""
...
assert P.POSITIONAL_ONLY < P.POSITIONAL_OR_KEYWORD < P.VAR_POSITIONAL < P.KEYWORD_ONLY < P.VAR_KEYWORD

assert str(P.POSITIONAL_ONLY) == 'POSITIONAL_ONLY'

assert 'POSITIONAL_ONLY' in repr(P.POSITIONAL_ONLY)
print("TestParameterObject::test_signature_parameter_kinds: ok")
