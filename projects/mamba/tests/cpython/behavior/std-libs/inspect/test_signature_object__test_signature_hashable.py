...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_hashable"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_hashable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_hashable
"""Auto-ported test: TestSignatureObject::test_signature_hashable (CPython 3.12 oracle)."""
...
assert hash(foo_sig) == hash(manual_sig)

assert hash(foo_sig) != hash(manual_sig.replace(return_annotation='spam'))

def bar(a) -> 1:
    pass

assert hash(foo_sig) != hash(inspect.signature(bar))
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('unhashable type', str(_aR_e))
print("TestSignatureObject::test_signature_hashable: ok")
