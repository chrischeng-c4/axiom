...
# lib = "inspect"
# dimension = "behavior"
# case = "test_get_generator_state__test_closed_after_exhaustion"
# subject = "cpython.test_inspect.TestGetGeneratorState.test_closed_after_exhaustion"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetGeneratorState::test_closed_after_exhaustion
"""Auto-ported test: TestGetGeneratorState::test_closed_after_exhaustion (CPython 3.12 oracle)."""
...
for i in self_generator:
    pass

assert _generatorstate() == inspect.GEN_CLOSED
print("TestGetGeneratorState::test_closed_after_exhaustion: ok")
