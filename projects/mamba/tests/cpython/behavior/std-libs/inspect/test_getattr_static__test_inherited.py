...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_inherited"
# subject = "cpython.test_inspect.TestGetattrStatic.test_inherited"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_inherited
"""Auto-ported test: TestGetattrStatic::test_inherited (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(something, 'x') == Thing.x
print("TestGetattrStatic::test_inherited: ok")
