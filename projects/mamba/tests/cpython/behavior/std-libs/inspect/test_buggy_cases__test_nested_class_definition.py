...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_nested_class_definition"
# subject = "cpython.test_inspect.TestBuggyCases.test_nested_class_definition"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_nested_class_definition
"""Auto-ported test: TestBuggyCases::test_nested_class_definition (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.cls183, 183, 188)
assertSourceEqual(mod2.cls183.cls185, 185, 188)
print("TestBuggyCases::test_nested_class_definition: ok")
