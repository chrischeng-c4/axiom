...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_non_comparable"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_non_comparable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_non_comparable
"""Auto-ported test: TestSignatureObject::test_signature_on_non_comparable (CPython 3.12 oracle)."""
...
assert signature(NoncomparableCallable()) == ((('a', ..., ..., 'positional_or_keyword'),), ...)
print("TestSignatureObject::test_signature_on_non_comparable: ok")
