...
# lib = "inspect"
# dimension = "behavior"
# case = "test_buggy_cases__test_getsource_on_method"
# subject = "cpython.test_inspect.TestBuggyCases.test_getsource_on_method"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestBuggyCases::test_getsource_on_method
"""Auto-ported test: TestBuggyCases::test_getsource_on_method (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
assertSourceEqual(mod2.ClassWithMethod.method, 118, 119)
print("TestBuggyCases::test_getsource_on_method: ok")
