...
# lib = "inspect"
# dimension = "behavior"
# case = "test_unwrap__test_cycle"
# subject = "cpython.test_inspect.TestUnwrap.test_cycle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestUnwrap::test_cycle
"""Auto-ported test: TestUnwrap::test_cycle (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('wrapper loop', str(_aR_e))
print("TestUnwrap::test_cycle: ok")
