...
# lib = "inspect"
# dimension = "behavior"
# case = "test_retrieving_source_code__test_getfile_builtin_class"
# subject = "cpython.test_inspect.TestRetrievingSourceCode.test_getfile_builtin_class"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestRetrievingSourceCode::test_getfile_builtin_class
"""Auto-ported test: TestRetrievingSourceCode::test_getfile_builtin_class (CPython 3.12 oracle)."""
...
assert str(e.exception).startswith('<class')
print("TestRetrievingSourceCode::test_getfile_builtin_class: ok")
