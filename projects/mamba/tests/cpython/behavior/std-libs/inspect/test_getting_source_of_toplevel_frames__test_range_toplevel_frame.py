...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getting_source_of_toplevel_frames__test_range_toplevel_frame"
# subject = "cpython.test_inspect.TestGettingSourceOfToplevelFrames.test_range_toplevel_frame"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGettingSourceOfToplevelFrames::test_range_toplevel_frame
"""Auto-ported test: TestGettingSourceOfToplevelFrames::test_range_toplevel_frame (CPython 3.12 oracle)."""
...
with open(inspect.getsourcefile(fodderModule), encoding='utf-8') as fp:
    self_source = fp.read()
self_maxDiff = None
assertSourceEqual(mod.currentframe, 1, None)
print("TestGettingSourceOfToplevelFrames::test_range_toplevel_frame: ok")
