...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_callable_objects"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_callable_objects"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_callable_objects
"""Auto-ported test: TestSignatureObject::test_signature_on_callable_objects (CPython 3.12 oracle)."""
...
assert signature(Foo()) == ((('a', ..., ..., 'positional_or_keyword'),), ...)
...
assert signature(Bar()) == ((('a', ..., ..., 'positional_or_keyword'),), ...)
...
assert signature(C()) == signature(dict.fromkeys)
...
assert signature(c) == ((('a', ..., ..., 'positional_or_keyword'),), ...)
print("TestSignatureObject::test_signature_on_callable_objects: ok")
