...
# lib = "inspect"
# dimension = "behavior"
# case = "test_predicates__test_isclass"
# subject = "cpython.test_inspect.TestPredicates.test_isclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestPredicates::test_isclass
"""Auto-ported test: TestPredicates::test_isclass (CPython 3.12 oracle)."""
...
assert not inspect.isclass(CustomGetattr())
print("TestPredicates::test_isclass: ok")
