...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_inherited_classattribute"
# subject = "cpython.test_inspect.TestGetattrStatic.test_inherited_classattribute"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_inherited_classattribute
"""Auto-ported test: TestGetattrStatic::test_inherited_classattribute (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(OtherThing, 'x') == Thing.x
print("TestGetattrStatic::test_inherited_classattribute: ok")
