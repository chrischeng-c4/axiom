...
# lib = "inspect"
# dimension = "behavior"
# case = "test_getattr_static__test_mro_as_property"
# subject = "cpython.test_inspect.TestGetattrStatic.test_mro_as_property"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestGetattrStatic::test_mro_as_property
"""Auto-ported test: TestGetattrStatic::test_mro_as_property (CPython 3.12 oracle)."""
...
assert inspect.getattr_static(Something, 'foo') == 3
print("TestGetattrStatic::test_mro_as_property: ok")
