...
# lib = "inspect"
# dimension = "behavior"
# case = "test_signature_object__test_signature_on_classmethod"
# subject = "cpython.test_inspect.TestSignatureObject.test_signature_on_classmethod"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestSignatureObject::test_signature_on_classmethod
"""Auto-ported test: TestSignatureObject::test_signature_on_classmethod (CPython 3.12 oracle)."""
...
assert signature(meth) == ((('arg1', ..., ..., 'positional_or_keyword'), ('arg2', 1, ..., 'keyword_only')), ...)
meth = Test.foo

assert signature(meth) == ((('arg1', ..., ..., 'positional_or_keyword'), ('arg2', 1, ..., 'keyword_only')), ...)
print("TestSignatureObject::test_signature_on_classmethod: ok")
