...
# lib = "inspect"
# dimension = "behavior"
# case = "test_predicates__test_isabstract_during_init_subclass"
# subject = "cpython.test_inspect.TestPredicates.test_isabstract_during_init_subclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_inspect.py::TestPredicates::test_isabstract_during_init_subclass
"""Auto-ported test: TestPredicates::test_isabstract_during_init_subclass (CPython 3.12 oracle)."""
...
assert isabstract_checks == [True, False]
...
assert isabstract_checks == [True, True, False]
print("TestPredicates::test_isabstract_during_init_subclass: ok")
