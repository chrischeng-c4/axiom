...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "utility_tests__test_to_bytes"
# subject = "cpython.test_urlparse.Utility_Tests.test_to_bytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::Utility_Tests::test_to_bytes
"""Auto-ported test: Utility_Tests::test_to_bytes (CPython 3.12 oracle)."""
...
assert result == 'http://www.python.org'

try:
    urllib.parse._to_bytes('http://www.python.org/mediæval')
    raise AssertionError('expected UnicodeError')
except UnicodeError:
    pass
print("Utility_Tests::test_to_bytes: ok")
