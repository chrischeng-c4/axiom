...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "utility_tests__test_splitport"
# subject = "cpython.test_urlparse.Utility_Tests.test_splitport"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::Utility_Tests::test_splitport
"""Auto-ported test: Utility_Tests::test_splitport (CPython 3.12 oracle)."""
...
assert splitport('parrot:88') == ('parrot', '88')

assert splitport('parrot') == ('parrot', None)

assert splitport('parrot:') == ('parrot', None)

assert splitport('127.0.0.1') == ('127.0.0.1', None)

assert splitport('parrot:cheese') == ('parrot:cheese', None)

assert splitport('[::1]:88') == ('[::1]', '88')

assert splitport('[::1]') == ('[::1]', None)

assert splitport(':88') == ('', '88')
print("Utility_Tests::test_splitport: ok")
