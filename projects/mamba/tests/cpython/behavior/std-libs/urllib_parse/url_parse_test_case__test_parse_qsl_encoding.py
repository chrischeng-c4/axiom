...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_parse_qsl_encoding"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_parse_qsl_encoding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_parse_qsl_encoding
"""Auto-ported test: UrlParseTestCase::test_parse_qsl_encoding (CPython 3.12 oracle)."""
...
assert result == [('key', 'Ł-')]
print("UrlParseTestCase::test_parse_qsl_encoding: ok")
