...
# lib = "urllib_parse"
# dimension = "behavior"
# case = "url_parse_test_case__test_noslash"
# subject = "cpython.test_urlparse.UrlParseTestCase.test_noslash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_urlparse.py::UrlParseTestCase::test_noslash
"""Auto-ported test: UrlParseTestCase::test_noslash (CPython 3.12 oracle)."""
...
assert urllib.parse.urlparse('http://example.com?blahblah=/foo') == ('http', 'example.com', '', '', 'blahblah=/foo', '')

assert urllib.parse.urlparse(b'http://example.com?blahblah=/foo') == (b'http', b'example.com', b'', b'', b'blahblah=/foo', b'')
print("UrlParseTestCase::test_noslash: ok")
