...
# lib = "zipimport"
# dimension = "behavior"
# case = "bad_file_zip_import_test_case__test_empty_filename"
# subject = "cpython.test_zipimport.BadFileZipImportTestCase.testEmptyFilename"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_zipimport.py::BadFileZipImportTestCase::testEmptyFilename
"""Auto-ported test: BadFileZipImportTestCase::testEmptyFilename (CPython 3.12 oracle)."""
...
def assertZipFailure(filename):
    ...
    try:
        ...
        pass
assertZipFailure('')
print("BadFileZipImportTestCase::testEmptyFilename: ok")
