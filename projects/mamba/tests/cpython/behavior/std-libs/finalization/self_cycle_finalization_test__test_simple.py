...
# lib = "finalization"
# dimension = "behavior"
# case = "self_cycle_finalization_test__test_simple"
# subject = "cpython.test_finalization.SelfCycleFinalizationTest.test_simple"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_finalization.py::SelfCycleFinalizationTest::test_simple
"""Auto-ported test: SelfCycleFinalizationTest::test_simple (CPython 3.12 oracle)."""
...
with SimpleBase.test():
    ...
    assert_del_calls(ids)
    assert_survivors([])
print("SelfCycleFinalizationTest::test_simple: ok")
