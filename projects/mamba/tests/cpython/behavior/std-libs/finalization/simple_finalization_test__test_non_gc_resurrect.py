...
# lib = "finalization"
# dimension = "behavior"
# case = "simple_finalization_test__test_non_gc_resurrect"
# subject = "cpython.test_finalization.SimpleFinalizationTest.test_non_gc_resurrect"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_finalization.py::SimpleFinalizationTest::test_non_gc_resurrect
"""Auto-ported test: SimpleFinalizationTest::test_non_gc_resurrect (CPython 3.12 oracle)."""
...
with SimpleBase.test():
    ...
    assert not gc.is_tracked(s)
    ids = [id(s)]
    del s
    gc.collect()
    assert_del_calls(ids)
    assert_survivors(ids)
    clear_survivors()
    gc.collect()
    assert_del_calls(ids * 2)
    assert_survivors(ids)
print("SimpleFinalizationTest::test_non_gc_resurrect: ok")
