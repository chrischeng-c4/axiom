...
# lib = "finalization"
# dimension = "behavior"
# case = "simple_finalization_test__test_non_gc"
# subject = "cpython.test_finalization.SimpleFinalizationTest.test_non_gc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_finalization.py::SimpleFinalizationTest::test_non_gc
"""Auto-ported test: SimpleFinalizationTest::test_non_gc (CPython 3.12 oracle)."""
...
with SimpleBase.test():
    ...
    assert_del_calls(ids)
    assert_survivors([])
print("SimpleFinalizationTest::test_non_gc: ok")
