...
# lib = "finalization"
# dimension = "behavior"
# case = "simple_finalization_test__test_simple"
# subject = "cpython.test_finalization.SimpleFinalizationTest.test_simple"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_finalization.py::SimpleFinalizationTest::test_simple
"""Auto-ported test: SimpleFinalizationTest::test_simple (CPython 3.12 oracle)."""
...
with SimpleBase.test():
    ...
    assert_del_calls(ids)
    assert_survivors([])
print("SimpleFinalizationTest::test_simple: ok")
