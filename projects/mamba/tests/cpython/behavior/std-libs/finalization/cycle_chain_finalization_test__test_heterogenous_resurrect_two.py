...
# lib = "finalization"
# dimension = "behavior"
# case = "cycle_chain_finalization_test__test_heterogenous_resurrect_two"
# subject = "cpython.test_finalization.CycleChainFinalizationTest.test_heterogenous_resurrect_two"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_finalization.py::CycleChainFinalizationTest::test_heterogenous_resurrect_two
"""Auto-ported test: CycleChainFinalizationTest::test_heterogenous_resurrect_two (CPython 3.12 oracle)."""
...
gc.garbage[:] = []
check_resurrecting_chain([ChainedResurrector, SimpleChained, SuicidalChained] * 2)
print("CycleChainFinalizationTest::test_heterogenous_resurrect_two: ok")
