...
# lib = "finalization"
# dimension = "behavior"
# case = "self_cycle_finalization_test__test_simple_suicide"
# subject = "cpython.test_finalization.SelfCycleFinalizationTest.test_simple_suicide"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_finalization.py::SelfCycleFinalizationTest::test_simple_suicide
"""Auto-ported test: SelfCycleFinalizationTest::test_simple_suicide (CPython 3.12 oracle)."""
...
with SimpleBase.test():
    ...
    assert wr() is None
print("SelfCycleFinalizationTest::test_simple_suicide: ok")
