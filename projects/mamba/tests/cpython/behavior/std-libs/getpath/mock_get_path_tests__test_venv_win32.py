...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_venv_win32"
# subject = "cpython.test_getpath.MockGetPathTests.test_venv_win32"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_venv_win32
"""Auto-ported test: MockGetPathTests::test_venv_win32 (CPython 3.12 oracle)."""
...
"""Test a venv layout on Windows.
        ...
        """
ns = MockNTNamespace(argv0='C:\\Python\\python.exe', ENV___PYVENV_LAUNCHER__='C:\\venv\\Scripts\\python.exe', real_executable='C:\\Python\\python.exe')
ns.add_known_xfile('C:\\Python\\python.exe')
ns.add_known_xfile('C:\\venv\\Scripts\\python.exe')
ns.add_known_file('C:\\Python\\Lib\\os.py')
ns.add_known_dir('C:\\Python\\DLLs')
ns.add_known_file('C:\\venv\\pyvenv.cfg', ['home = C:\\Python'])
expected = dict(executable='C:\\venv\\Scripts\\python.exe', prefix='C:\\Python', exec_prefix='C:\\Python', base_executable='C:\\Python\\python.exe', base_prefix='C:\\Python', base_exec_prefix='C:\\Python', module_search_paths_set=1, module_search_paths=['C:\\Python\\python98.zip', 'C:\\Python\\DLLs', 'C:\\Python\\Lib', 'C:\\Python'])
actual = getpath(ns, expected)

assert expected == actual
print("MockGetPathTests::test_venv_win32: ok")
