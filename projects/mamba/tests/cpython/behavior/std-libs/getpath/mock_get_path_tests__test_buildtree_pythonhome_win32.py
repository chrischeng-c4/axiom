...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_buildtree_pythonhome_win32"
# subject = "cpython.test_getpath.MockGetPathTests.test_buildtree_pythonhome_win32"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_buildtree_pythonhome_win32
"""Auto-ported test: MockGetPathTests::test_buildtree_pythonhome_win32 (CPython 3.12 oracle)."""
...
ns = MockNTNamespace(argv0='C:\\Out\\python.exe', real_executable='C:\\Out\\python.exe', ENV_PYTHONHOME='C:\\CPython')
ns.add_known_xfile('C:\\Out\\python.exe')
ns.add_known_file('C:\\CPython\\Lib\\os.py')
ns.add_known_file('C:\\Out\\pybuilddir.txt', [''])
expected = dict(executable='C:\\Out\\python.exe', base_executable='C:\\Out\\python.exe', prefix='C:\\CPython', exec_prefix='C:\\CPython', build_prefix='C:\\', _is_python_build=1, module_search_paths_set=1, module_search_paths=['C:\\Out\\python98.zip', 'C:\\Out', 'C:\\CPython\\Lib'])
actual = getpath(ns, expected)

assert expected == actual
print("MockGetPathTests::test_buildtree_pythonhome_win32: ok")
