...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_alt_framework_macos"
# subject = "cpython.test_getpath.MockGetPathTests.test_alt_framework_macos"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_alt_framework_macos
"""Auto-ported test: MockGetPathTests::test_alt_framework_macos (CPython 3.12 oracle)."""
...
""" Test framework layout on macOS with alternate framework name
        ...
        (WITH_NEXT_FRAMEWORK).
        """
ns = MockPosixNamespace(argv0='/Library/Frameworks/DebugPython.framework/Versions/9.8/Resources/Python.app/Contents/MacOS/DebugPython', os_name='darwin', WITH_NEXT_FRAMEWORK=1, PREFIX='/Library/Frameworks/DebugPython.framework/Versions/9.8', EXEC_PREFIX='/Library/Frameworks/DebugPython.framework/Versions/9.8', ENV___PYVENV_LAUNCHER__='/Library/Frameworks/DebugPython.framework/Versions/9.8/bin/python9.8', real_executable='/Library/Frameworks/DebugPython.framework/Versions/9.8/Resources/Python.app/Contents/MacOS/DebugPython', library='/Library/Frameworks/DebugPython.framework/Versions/9.8/DebugPython', PYTHONPATH=None, ENV_PYTHONHOME=None, ENV_PYTHONEXECUTABLE=None, executable_dir=None, py_setpath=None)
...
expected = dict(executable='/Library/Frameworks/DebugPython.framework/Versions/9.8/bin/python9.8', prefix='/Library/Frameworks/DebugPython.framework/Versions/9.8', exec_prefix='/Library/Frameworks/DebugPython.framework/Versions/9.8', base_executable='/Library/Frameworks/DebugPython.framework/Versions/9.8/bin/python9.8', base_prefix='/Library/Frameworks/DebugPython.framework/Versions/9.8', base_exec_prefix='/Library/Frameworks/DebugPython.framework/Versions/9.8', module_search_paths_set=1, module_search_paths=['/Library/Frameworks/DebugPython.framework/Versions/9.8/lib/python98.zip', '/Library/Frameworks/DebugPython.framework/Versions/9.8/lib/python9.8', '/Library/Frameworks/DebugPython.framework/Versions/9.8/lib/python9.8/lib-dynload'])
actual = getpath(ns, expected)

assert expected == actual
print("MockGetPathTests::test_alt_framework_macos: ok")
