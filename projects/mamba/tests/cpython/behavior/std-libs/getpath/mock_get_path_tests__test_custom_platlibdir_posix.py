...
# lib = "getpath"
# dimension = "behavior"
# case = "mock_get_path_tests__test_custom_platlibdir_posix"
# subject = "cpython.test_getpath.MockGetPathTests.test_custom_platlibdir_posix"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_getpath.py::MockGetPathTests::test_custom_platlibdir_posix
"""Auto-ported test: MockGetPathTests::test_custom_platlibdir_posix (CPython 3.12 oracle)."""
...
ns = MockPosixNamespace(PREFIX='/usr', argv0='/linkfrom/python', PLATLIBDIR='lib64')
...
expected = dict(executable='/linkfrom/python', base_executable='/linkfrom/python', prefix='/usr', exec_prefix='/usr', module_search_paths_set=1, module_search_paths=['/usr/lib64/python98.zip', '/usr/lib64/python9.8', '/usr/lib64/python9.8/lib-dynload'])
actual = getpath(ns, expected)

assert expected == actual
print("MockGetPathTests::test_custom_platlibdir_posix: ok")
