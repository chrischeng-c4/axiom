...
# lib = "codecs"
# dimension = "behavior"
# case = "codecs_module_test__test_decode"
# subject = "cpython.test_codecs.CodecsModuleTest.test_decode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::CodecsModuleTest::test_decode
"""Auto-ported test: CodecsModuleTest::test_decode (CPython 3.12 oracle)."""
...
assert codecs.decode(b'\xe4\xf6\xfc', 'latin-1') == 'äöü'
...
assert codecs.decode(obj=b'\xe4\xf6\xfc', encoding='latin-1') == 'äöü'

assert codecs.decode(b'[\xff]', 'ascii', errors='ignore') == '[]'
print("CodecsModuleTest::test_decode: ok")
