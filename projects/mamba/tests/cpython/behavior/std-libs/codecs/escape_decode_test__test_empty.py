...
# lib = "codecs"
# dimension = "behavior"
# case = "escape_decode_test__test_empty"
# subject = "cpython.test_codecs.EscapeDecodeTest.test_empty"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::EscapeDecodeTest::test_empty
"""Auto-ported test: EscapeDecodeTest::test_empty (CPython 3.12 oracle)."""
...
assert codecs.escape_decode(b'') == (b'', 0)

assert codecs.escape_decode(bytearray()) == (b'', 0)
print("EscapeDecodeTest::test_empty: ok")
