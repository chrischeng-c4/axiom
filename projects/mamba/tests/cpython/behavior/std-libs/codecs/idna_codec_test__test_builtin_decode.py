...
# lib = "codecs"
# dimension = "behavior"
# case = "idna_codec_test__test_builtin_decode"
# subject = "cpython.test_codecs.IDNACodecTest.test_builtin_decode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::IDNACodecTest::test_builtin_decode
"""Auto-ported test: IDNACodecTest::test_builtin_decode (CPython 3.12 oracle)."""
...
assert str(b'python.org', 'idna') == 'python.org'

assert str(b'python.org.', 'idna') == 'python.org.'

assert str(b'xn--pythn-mua.org', 'idna') == 'pythön.org'

assert str(b'xn--pythn-mua.org.', 'idna') == 'pythön.org.'
print("IDNACodecTest::test_builtin_decode: ok")
