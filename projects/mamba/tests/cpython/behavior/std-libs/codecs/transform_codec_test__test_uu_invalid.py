...
# lib = "codecs"
# dimension = "behavior"
# case = "transform_codec_test__test_uu_invalid"
# subject = "cpython.test_codecs.TransformCodecTest.test_uu_invalid"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::TransformCodecTest::test_uu_invalid
"""Auto-ported test: TransformCodecTest::test_uu_invalid (CPython 3.12 oracle)."""
...
try:
    codecs.decode(b'', 'uu-codec')
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("TransformCodecTest::test_uu_invalid: ok")
