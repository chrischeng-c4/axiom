...
# lib = "codecs"
# dimension = "behavior"
# case = "basic_unicode_test__test_seek"
# subject = "cpython.test_codecs.BasicUnicodeTest.test_seek"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::BasicUnicodeTest::test_seek
"""Auto-ported test: BasicUnicodeTest::test_seek (CPython 3.12 oracle)."""
...
for encoding in all_unicode_encodings:
    ...
    for t in range(5):
        ...
        assert s == data
print("BasicUnicodeTest::test_seek: ok")
