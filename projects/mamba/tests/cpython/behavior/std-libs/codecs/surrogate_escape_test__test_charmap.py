...
# lib = "codecs"
# dimension = "behavior"
# case = "surrogate_escape_test__test_charmap"
# subject = "cpython.test_codecs.SurrogateEscapeTest.test_charmap"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::SurrogateEscapeTest::test_charmap
"""Auto-ported test: SurrogateEscapeTest::test_charmap (CPython 3.12 oracle)."""
...
assert b'foo\xa5bar'.decode('iso-8859-3', 'surrogateescape') == 'foo\udca5bar'

assert 'foo\udca5bar'.encode('iso-8859-3', 'surrogateescape') == b'foo\xa5bar'
print("SurrogateEscapeTest::test_charmap: ok")
