...
# lib = "codecs"
# dimension = "behavior"
# case = "codec_name_normalization_test__test_encodings_normalize_encoding"
# subject = "cpython.test_codecs.CodecNameNormalizationTest.test_encodings_normalize_encoding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::CodecNameNormalizationTest::test_encodings_normalize_encoding
"""Auto-ported test: CodecNameNormalizationTest::test_encodings_normalize_encoding (CPython 3.12 oracle)."""
...
assert normalize('utf_8') == 'utf_8'

assert normalize('utfé€\U0010ffff-8') == 'utf_8'

assert normalize('utf   8') == 'utf_8'
...
assert normalize('utf...8') == 'utf...8'
print("CodecNameNormalizationTest::test_encodings_normalize_encoding: ok")
