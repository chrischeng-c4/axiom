...
# lib = "codecs"
# dimension = "behavior"
# case = "utf32_be_test__test_errors"
# subject = "cpython.test_codecs.UTF32BETest.test_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF32BETest::test_errors
"""Auto-ported test: UTF32BETest::test_errors (CPython 3.12 oracle)."""
...
try:
    codecs.utf_32_be_decode(b'\xff', 'strict', True)
    raise AssertionError('expected UnicodeDecodeError')
except UnicodeDecodeError:
    pass
print("UTF32BETest::test_errors: ok")
