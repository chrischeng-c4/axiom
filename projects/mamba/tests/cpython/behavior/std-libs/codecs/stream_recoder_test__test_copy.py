...
# lib = "codecs"
# dimension = "behavior"
# case = "stream_recoder_test__test_copy"
# subject = "cpython.test_codecs.StreamRecoderTest.test_copy"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::StreamRecoderTest::test_copy
"""Auto-ported test: StreamRecoderTest::test_copy (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('StreamRecoder', str(_aR_e))
try:
    copy.deepcopy(sr)
    raise AssertionError('expected TypeError')
except TypeError as _aR_e:
    import re as _re_aR
    assert _re_aR.search('StreamRecoder', str(_aR_e))
print("StreamRecoderTest::test_copy: ok")
