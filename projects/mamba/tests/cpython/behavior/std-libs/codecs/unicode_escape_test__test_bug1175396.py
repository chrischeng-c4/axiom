...
# lib = "codecs"
# dimension = "behavior"
# case = "unicode_escape_test__test_bug1175396"
# subject = "cpython.test_codecs.UnicodeEscapeTest.test_bug1175396"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UnicodeEscapeTest::test_bug1175396
"""Auto-ported test: UnicodeEscapeTest::test_bug1175396 (CPython 3.12 oracle)."""
...
stream = io.BytesIO(''.join(s).encode(encoding))
reader = codecs.getreader(encoding)(stream)
for i, line in enumerate(reader):

    assert line == s[i]
print("UnicodeEscapeTest::test_bug1175396: ok")
