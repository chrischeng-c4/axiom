...
# lib = "codecs"
# dimension = "behavior"
# case = "basic_unicode_test__test_decoder_state"
# subject = "cpython.test_codecs.BasicUnicodeTest.test_decoder_state"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::BasicUnicodeTest::test_decoder_state
"""Auto-ported test: BasicUnicodeTest::test_decoder_state (CPython 3.12 oracle)."""
...
for encoding in all_unicode_encodings:
    if encoding not in broken_unicode_with_stateful:
        check_state_handling_decode(encoding, u, u.encode(encoding))
        check_state_handling_encode(encoding, u, u.encode(encoding))
print("BasicUnicodeTest::test_decoder_state: ok")
