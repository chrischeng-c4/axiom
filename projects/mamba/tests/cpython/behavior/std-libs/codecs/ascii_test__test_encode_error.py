...
# lib = "codecs"
# dimension = "behavior"
# case = "ascii_test__test_encode_error"
# subject = "cpython.test_codecs.ASCIITest.test_encode_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::ASCIITest::test_encode_error
"""Auto-ported test: ASCIITest::test_encode_error (CPython 3.12 oracle)."""
...
for data, error_handler, expected in (('[\x80ÿ€]', 'ignore', b'[]'), ('[\x80ÿ€]', 'replace', b'[???]'), ('[\x80ÿ€]', 'xmlcharrefreplace', b'[&#128;&#255;&#8364;]'), ('[\x80ÿ€\U000abcde]', 'backslashreplace', b'[\\x80\\xff\\u20ac\\U000abcde]'), ('[\udc80\udcff]', 'surrogateescape', b'[\x80\xff]')):
    ...
    assert data.encode('ascii', error_handler) == expected
print("ASCIITest::test_encode_error: ok")
