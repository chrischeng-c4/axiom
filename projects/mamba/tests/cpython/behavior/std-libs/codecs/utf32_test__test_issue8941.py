...
# lib = "codecs"
# dimension = "behavior"
# case = "utf32_test__test_issue8941"
# subject = "cpython.test_codecs.UTF32Test.test_issue8941"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF32Test::test_issue8941
"""Auto-ported test: UTF32Test::test_issue8941 (CPython 3.12 oracle)."""
...
assert '𐀀' * 1024 == codecs.utf_32_decode(encoded_le)[0]
encoded_be = b'\x00\x00\xfe\xff' + b'\x00\x01\x00\x00' * 1024

assert '𐀀' * 1024 == codecs.utf_32_decode(encoded_be)[0]
print("UTF32Test::test_issue8941: ok")
