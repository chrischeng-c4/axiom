...
# lib = "codecs"
# dimension = "behavior"
# case = "utf8_sig_test__test_incremental_surrogatepass"
# subject = "cpython.test_codecs.UTF8SigTest.test_incremental_surrogatepass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF8SigTest::test_incremental_surrogatepass
"""Auto-ported test: UTF8SigTest::test_incremental_surrogatepass (CPython 3.12 oracle)."""
...
for i in range(1, len(data)):
    ...
    assert dec.decode(data[i:]) == '\udc02'
print("UTF8SigTest::test_incremental_surrogatepass: ok")
