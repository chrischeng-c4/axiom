...
# lib = "codecs"
# dimension = "behavior"
# case = "utf16_be_test__test_errors"
# subject = "cpython.test_codecs.UTF16BETest.test_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF16BETest::test_errors
"""Auto-ported test: UTF16BETest::test_errors (CPython 3.12 oracle)."""
...
for raw, expected in tests:
    ...
    assert raw.decode('utf-16be', 'replace') == expected
print("UTF16BETest::test_errors: ok")
