...
# lib = "codecs"
# dimension = "behavior"
# case = "utf32_test__test_only_one_bom"
# subject = "cpython.test_codecs.UTF32Test.test_only_one_bom"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF32Test::test_only_one_bom
"""Auto-ported test: UTF32Test::test_only_one_bom (CPython 3.12 oracle)."""
...
assert d == spamle or d == spambe
s = io.BytesIO(d)
f = reader(s)

assert f.read() == 'spamspam'
print("UTF32Test::test_only_one_bom: ok")
