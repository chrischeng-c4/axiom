...
# lib = "codecs"
# dimension = "behavior"
# case = "utf8_sig_test__test_stream_bare"
# subject = "cpython.test_codecs.UTF8SigTest.test_stream_bare"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_codecs.py::UTF8SigTest::test_stream_bare
"""Auto-ported test: UTF8SigTest::test_stream_bare (CPython 3.12 oracle)."""
...
for sizehint in [None] + list(range(1, 11)) + [64, 128, 256, 512, 1024]:
    ...
    assert got == unistring
print("UTF8SigTest::test_stream_bare: ok")
