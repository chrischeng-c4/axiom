...
# lib = "codecs"
# dimension = "behavior"
# case = "read_buffer_test__test_array"
# subject = "cpython.test_codecs.ReadBufferTest.test_array"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::ReadBufferTest::test_array
"""Auto-ported test: ReadBufferTest::test_array (CPython 3.12 oracle)."""
...
assert codecs.readbuffer_encode(array.array('b', b'spam')) == (b'spam', 4)
print("ReadBufferTest::test_array: ok")
