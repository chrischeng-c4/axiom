...
# lib = "codecs"
# dimension = "behavior"
# case = "transform_codec_test__test_quopri_stateless"
# subject = "cpython.test_codecs.TransformCodecTest.test_quopri_stateless"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_codecs.py::TransformCodecTest::test_quopri_stateless
"""Auto-ported test: TransformCodecTest::test_quopri_stateless (CPython 3.12 oracle)."""
...
assert encoded == b'space=20tab=09eol=20\n'
unescaped = b'space tab eol\n'

assert codecs.decode(unescaped, 'quopri-codec') == unescaped
print("TransformCodecTest::test_quopri_stateless: ok")
