...
# lib = "codecs"
# dimension = "behavior"
# case = "punycode_test__test_encode"
# subject = "cpython.test_codecs.PunycodeTest.test_encode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::PunycodeTest::test_encode
"""Auto-ported test: PunycodeTest::test_encode (CPython 3.12 oracle)."""
...
for uni, puny in punycode_testcases:
    ...
    assert str(uni.encode('punycode'), 'ascii').lower() == str(puny, 'ascii').lower()
print("PunycodeTest::test_encode: ok")
