...
# lib = "codecs"
# dimension = "behavior"
# case = "utf32_test__test_errors"
# subject = "cpython.test_codecs.UTF32Test.test_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF32Test::test_errors
"""Auto-ported test: UTF32Test::test_errors (CPython 3.12 oracle)."""
...
try:
    codecs.utf_32_decode(b'\xff', 'strict', True)
    raise AssertionError('expected UnicodeDecodeError')
except UnicodeDecodeError:
    pass
print("UTF32Test::test_errors: ok")
