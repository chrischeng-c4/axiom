...
# lib = "codecs"
# dimension = "behavior"
# case = "stream_recoder_test__test_seeking_write"
# subject = "cpython.test_codecs.StreamRecoderTest.test_seeking_write"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::StreamRecoderTest::test_seeking_write
"""Auto-ported test: StreamRecoderTest::test_seeking_write (CPython 3.12 oracle)."""
...
assert sr.readline() == b'789\n'
sr.seek(0)

assert sr.readline() == b'1\n'

assert sr.readline() == b'abc\n'

assert sr.readline() == b'789\n'
print("StreamRecoderTest::test_seeking_write: ok")
