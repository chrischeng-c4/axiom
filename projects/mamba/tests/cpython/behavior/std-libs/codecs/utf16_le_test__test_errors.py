...
# lib = "codecs"
# dimension = "behavior"
# case = "utf16_le_test__test_errors"
# subject = "cpython.test_codecs.UTF16LETest.test_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::UTF16LETest::test_errors
"""Auto-ported test: UTF16LETest::test_errors (CPython 3.12 oracle)."""
...
for raw, expected in tests:
    ...
    assert raw.decode('utf-16le', 'replace') == expected
print("UTF16LETest::test_errors: ok")
