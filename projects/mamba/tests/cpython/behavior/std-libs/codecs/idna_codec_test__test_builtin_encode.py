...
# lib = "codecs"
# dimension = "behavior"
# case = "idna_codec_test__test_builtin_encode"
# subject = "cpython.test_codecs.IDNACodecTest.test_builtin_encode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::IDNACodecTest::test_builtin_encode
"""Auto-ported test: IDNACodecTest::test_builtin_encode (CPython 3.12 oracle)."""
...
assert 'pythön.org.'.encode('idna') == b'xn--pythn-mua.org.'
print("IDNACodecTest::test_builtin_encode: ok")
