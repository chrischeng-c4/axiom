...
# lib = "codecs"
# dimension = "behavior"
# case = "ascii_test__test_decode_error"
# subject = "cpython.test_codecs.ASCIITest.test_decode_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codecs.py::ASCIITest::test_decode_error
"""Auto-ported test: ASCIITest::test_decode_error (CPython 3.12 oracle)."""
...
for data, error_handler, expected in ((b'[\x80\xff]', 'ignore', '[]'), (b'[\x80\xff]', 'replace', '[��]'), (b'[\x80\xff]', 'surrogateescape', '[\udc80\udcff]'), (b'[\x80\xff]', 'backslashreplace', '[\\x80\\xff]')):
    ...
    assert data.decode('ascii', error_handler) == expected
print("ASCIITest::test_decode_error: ok")
