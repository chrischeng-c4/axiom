...
# lib = "getargs"
# dimension = "behavior"
# case = "keyword_only__test_case__test_mixed_args"
# subject = "cpython.test_getargs.KeywordOnly_TestCase.test_mixed_args"
# kind = "semantic"
...
assert getargs_keyword_only(1, 2, keyword_only=3) == (1, 2, 3)

print("KeywordOnly_TestCase::test_mixed_args: ok")
