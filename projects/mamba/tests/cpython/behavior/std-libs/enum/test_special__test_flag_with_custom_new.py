...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_flag_with_custom_new"
# subject = "cpython.test_enum.TestSpecial.test_flag_with_custom_new"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_flag_with_custom_new
"""Auto-ported test: TestSpecial::test_flag_with_custom_new (CPython 3.12 oracle)."""
...
assert FlagFromChar._all_bits_ == 316912650057057350374175801343

assert FlagFromChar._flag_mask_ == 158456325028528675187087900672

assert FlagFromChar.a == 158456325028528675187087900672

assert FlagFromChar.a | 1 == 158456325028528675187087900673
...
assert FlagFromChar._flag_mask_ == 158456325028528675187087900674

assert FlagFromChar.a.value == 158456325028528675187087900672

assert (FlagFromChar.a | FlagFromChar.z).value == 158456325028528675187087900674
...
assert FlagFromChar.a | 1 == 158456325028528675187087900673
print("TestSpecial::test_flag_with_custom_new: ok")
