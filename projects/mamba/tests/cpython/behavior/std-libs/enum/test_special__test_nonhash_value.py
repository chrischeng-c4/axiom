...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_nonhash_value"
# subject = "cpython.test_enum.TestSpecial.test_nonhash_value"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_nonhash_value
"""Auto-ported test: TestSpecial::test_nonhash_value (CPython 3.12 oracle)."""
...
for enum, value in zip(ColorInAList, range(3)):
    ...
    assert ColorInAList([value]) is enum
print("TestSpecial::test_nonhash_value: ok")
