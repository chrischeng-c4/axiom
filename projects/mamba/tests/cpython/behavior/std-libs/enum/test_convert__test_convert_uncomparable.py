...
# lib = "enum"
# dimension = "behavior"
# case = "test_convert__test_convert_uncomparable"
# subject = "cpython.test_enum.TestConvert.test_convert_uncomparable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestConvert::test_convert_uncomparable
"""Auto-ported test: TestConvert::test_convert_uncomparable (CPython 3.12 oracle)."""
...
# --- test body ---
uncomp = enum.Enum._convert_('Uncomparable', MODULE, filter=lambda x: x.startswith('UNCOMPARABLE_'))

assert list(uncomp) == [uncomp.UNCOMPARABLE_A, uncomp.UNCOMPARABLE_B, uncomp.UNCOMPARABLE_C]
print("TestConvert::test_convert_uncomparable: ok")
