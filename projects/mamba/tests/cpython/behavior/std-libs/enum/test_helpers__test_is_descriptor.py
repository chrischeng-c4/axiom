...
# lib = "enum"
# dimension = "behavior"
# case = "test_helpers__test_is_descriptor"
# subject = "cpython.test_enum.TestHelpers.test_is_descriptor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestHelpers::test_is_descriptor
"""Auto-ported test: TestHelpers::test_is_descriptor (CPython 3.12 oracle)."""
...
for attr in ('__get__', '__set__', '__delete__'):
    ...
    assert not enum._is_descriptor(obj)
    setattr(obj, attr, 1)

    assert enum._is_descriptor(obj)
print("TestHelpers::test_is_descriptor: ok")
