...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_duplicate_values_give_unique_enum_items"
# subject = "cpython.test_enum.TestSpecial.test_duplicate_values_give_unique_enum_items"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_duplicate_values_give_unique_enum_items
"""Auto-ported test: TestSpecial::test_duplicate_values_give_unique_enum_items (CPython 3.12 oracle)."""
...
assert list(AutoNumber) == [AutoNumber.first, AutoNumber.second, AutoNumber.third]

assert int(AutoNumber.second) == 2

assert AutoNumber.third.value == 3

assert AutoNumber(1) is AutoNumber.first
print("TestSpecial::test_duplicate_values_give_unique_enum_items: ok")
