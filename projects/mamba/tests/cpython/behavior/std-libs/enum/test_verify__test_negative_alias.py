...
# lib = "enum"
# dimension = "behavior"
# case = "test_verify__test_negative_alias"
# subject = "cpython.test_enum.TestVerify.test_negative_alias"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestVerify::test_negative_alias
"""Auto-ported test: TestVerify::test_negative_alias (CPython 3.12 oracle)."""
...
class Color(Flag):
    ...
    BLUE = 4
    WHITE = -1
print("TestVerify::test_negative_alias: ok")
