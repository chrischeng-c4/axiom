...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_private_variable_is_normal_attribute"
# subject = "cpython.test_enum.TestSpecial.test_private_variable_is_normal_attribute"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_private_variable_is_normal_attribute
"""Auto-ported test: TestSpecial::test_private_variable_is_normal_attribute (CPython 3.12 oracle)."""
...
assert Private._Private__corporal == 'Radar'

assert Private._Private__major_ == 'Hoolihan'
print("TestSpecial::test_private_variable_is_normal_attribute: ok")
