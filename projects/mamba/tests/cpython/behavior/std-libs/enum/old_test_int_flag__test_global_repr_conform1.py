...
# lib = "enum"
# dimension = "behavior"
# case = "old_test_int_flag__test_global_repr_conform1"
# subject = "cpython.test_enum.OldTestIntFlag.test_global_repr_conform1"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::OldTestIntFlag::test_global_repr_conform1
"""Auto-ported test: OldTestIntFlag::test_global_repr_conform1 (CPython 3.12 oracle)."""
...
assert repr(HeadlightsC(0)) == '%s.OFF_C' % SHORT_MODULE

assert repr(HeadlightsC(2 ** 0 + 2 ** 2 + 2 ** 3)) == '%(m)s.LOW_BEAM_C|%(m)s.FOG_C' % {'m': SHORT_MODULE}

assert repr(HeadlightsC(2 ** 3)) == '%(m)s.OFF_C' % {'m': SHORT_MODULE}
print("OldTestIntFlag::test_global_repr_conform1: ok")
