...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_no_members"
# subject = "cpython.test_enum.TestSpecial.test_no_members"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_no_members
"""Auto-ported test: TestSpecial::test_no_members (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('has no members', str(_aR_e))
try:
    Flag(7)
    raise AssertionError('expected TypeError')
except TypeError as _aR_e:
    import re as _re_aR
    assert _re_aR.search('has no members', str(_aR_e))
print("TestSpecial::test_no_members: ok")
