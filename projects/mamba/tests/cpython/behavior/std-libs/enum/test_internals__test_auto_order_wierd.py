...
# lib = "enum"
# dimension = "behavior"
# case = "test_internals__test_auto_order_wierd"
# subject = "cpython.test_enum.TestInternals.test_auto_order_wierd"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestInternals::test_auto_order_wierd
"""Auto-ported test: TestInternals::test_auto_order_wierd (CPython 3.12 oracle)."""
...
assert Color.red.value == 'pathological case'

assert Color.blue.value == 'blue'
print("TestInternals::test_auto_order_wierd: ok")
