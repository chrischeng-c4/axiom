...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_missing_override"
# subject = "cpython.test_enum.TestSpecial.test_missing_override"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_missing_override
"""Auto-ported test: TestSpecial::test_missing_override (CPython 3.12 oracle)."""
...
assert Color('three') is Color.blue
try:
    Color(7)
...
try:
    ...
    raise Exception('Exception not raised.')
print("TestSpecial::test_missing_override: ok")
