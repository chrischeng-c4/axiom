...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_using_members_as_nonmember"
# subject = "cpython.test_enum.TestSpecial.test_using_members_as_nonmember"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_using_members_as_nonmember
"""Auto-ported test: TestSpecial::test_using_members_as_nonmember (CPython 3.12 oracle)."""
...
assert Example.B.value == 2

assert Example.ALL == 3

assert type(Example.ALL) is int
...
assert type(Example.ALL) is int
print("TestSpecial::test_using_members_as_nonmember: ok")
