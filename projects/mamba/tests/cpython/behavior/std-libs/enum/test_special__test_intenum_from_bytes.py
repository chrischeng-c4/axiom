...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_intenum_from_bytes"
# subject = "cpython.test_enum.TestSpecial.test_intenum_from_bytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_intenum_from_bytes
"""Auto-ported test: TestSpecial::test_intenum_from_bytes (CPython 3.12 oracle)."""
...
assert IntStooges.from_bytes(b'\x00\x03', 'big') is IntStooges.MOE
try:
    IntStooges.from_bytes(b'\x00\x05', 'big')
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("TestSpecial::test_intenum_from_bytes: ok")
