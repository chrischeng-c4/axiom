...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_repr_and_str_with_no_init_mixin"
# subject = "cpython.test_enum.TestSpecial.test_repr_and_str_with_no_init_mixin"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_repr_and_str_with_no_init_mixin
"""Auto-ported test: TestSpecial::test_repr_and_str_with_no_init_mixin (CPython 3.12 oracle)."""
...
assert repr(Entries.ENTRY1) == 'Foo'

assert str(Entries.ENTRY1) == 'ooF'
print("TestSpecial::test_repr_and_str_with_no_init_mixin: ok")
