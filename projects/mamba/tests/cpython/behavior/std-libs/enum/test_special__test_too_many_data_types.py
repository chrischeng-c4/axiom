...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_too_many_data_types"
# subject = "cpython.test_enum.TestSpecial.test_too_many_data_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_too_many_data_types
"""Auto-ported test: TestSpecial::test_too_many_data_types (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('too many data types', str(_aR_e))
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('too many data types', str(_aR_e))
print("TestSpecial::test_too_many_data_types: ok")
