...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_init"
# subject = "cpython.test_enum.TestSpecial.test_init"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_init
"""Auto-ported test: TestSpecial::test_init (CPython 3.12 oracle)."""
...
assert round(Planet.EARTH.surface_gravity, 2) == 9.8

assert Planet.EARTH.value == (5.976e+24, 6378140.0)
print("TestSpecial::test_init: ok")
