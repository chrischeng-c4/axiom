...
# lib = "enum"
# dimension = "behavior"
# case = "old_test_flag__test_number_reset_and_order_cleanup"
# subject = "cpython.test_enum.OldTestFlag.test_number_reset_and_order_cleanup"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::OldTestFlag::test_number_reset_and_order_cleanup
"""Auto-ported test: OldTestFlag::test_number_reset_and_order_cleanup (CPython 3.12 oracle)."""
...
assert list(Confused) == [Confused.ONE, Confused.TWO, Confused.FOUR, Confused.EIGHT, Confused.SIXTEEN]

assert Confused.TWO is Confused.DOS

assert Confused.DOS._value_ == 2

assert Confused.EIGHT._value_ == 8

assert Confused.SIXTEEN._value_ == 16
print("OldTestFlag::test_number_reset_and_order_cleanup: ok")
