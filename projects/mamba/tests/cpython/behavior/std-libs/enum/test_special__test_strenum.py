...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_strenum"
# subject = "cpython.test_enum.TestSpecial.test_strenum"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_strenum
"""Auto-ported test: TestSpecial::test_strenum (CPython 3.12 oracle)."""
...
assert '{}'.format(GoodStrEnum.one) == '1'

assert GoodStrEnum.one == str(GoodStrEnum.one)

assert GoodStrEnum.one == '{}'.format(GoodStrEnum.one)

assert repr(GoodStrEnum.one) == "<GoodStrEnum.one: '1'>"
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('1 is not a string', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search('2 is not a string', str(_aR_e))
try:
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('encoding must be a string, not %r' % (sys.getdefaultencoding,), str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search('errors must be a string, not 9', str(_aR_e))
print("TestSpecial::test_strenum: ok")
