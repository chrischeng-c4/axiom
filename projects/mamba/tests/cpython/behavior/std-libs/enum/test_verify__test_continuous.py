...
# lib = "enum"
# dimension = "behavior"
# case = "test_verify__test_continuous"
# subject = "cpython.test_enum.TestVerify.test_continuous"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestVerify::test_continuous
"""Auto-ported test: TestVerify::test_continuous (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('invalid enum .Missing.: missing values 5, 6, 7, 8, 9, 10, 12', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search('invalid flag .Incomplete.: missing values 32', str(_aR_e))
try:
    ...
    import re as _re_aR
    assert _re_aR.search('invalid flag .StillIncomplete.: missing values 16', str(_aR_e))
print("TestVerify::test_continuous: ok")
