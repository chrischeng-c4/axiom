...
# lib = "enum"
# dimension = "behavior"
# case = "old_test_flag__test_auto_number_garbage"
# subject = "cpython.test_enum.OldTestFlag.test_auto_number_garbage"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::OldTestFlag::test_auto_number_garbage
"""Auto-ported test: OldTestFlag::test_auto_number_garbage (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('invalid flag value .not an int.', str(_aR_e))
print("OldTestFlag::test_auto_number_garbage: ok")
