...
# lib = "enum"
# dimension = "behavior"
# case = "test_unique__test_unique_clean"
# subject = "cpython.test_enum.TestUnique.test_unique_clean"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestUnique::test_unique_clean
"""Auto-ported test: TestUnique::test_unique_clean (CPython 3.12 oracle)."""
...
class Cleaner(IntEnum):
    ...
    double = 2
    triple = 3
print("TestUnique::test_unique_clean: ok")
