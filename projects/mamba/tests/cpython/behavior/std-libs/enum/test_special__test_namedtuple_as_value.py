...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_namedtuple_as_value"
# subject = "cpython.test_enum.TestSpecial.test_namedtuple_as_value"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_namedtuple_as_value
"""Auto-ported test: TestSpecial::test_namedtuple_as_value (CPython 3.12 oracle)."""
...
assert repr(NTEnum.NONE) == '<NTEnum.NONE: TTuple(id=0, a=0, blist=[])>'

assert NTEnum.NONE.value == TTuple(id=0, a=0, blist=[])

assert [x.value for x in NTEnum] == [TTuple(id=0, a=0, blist=[]), TTuple(id=1, a=2, blist=[4]), TTuple(id=2, a=4, blist=[0, 1, 2])]

try:
    getattr(NTEnum.NONE, 'id')
...
assert repr(NTCEnum.NONE) == '<NTCEnum.NONE: TTuple(id=0, a=0, blist=[])>'

assert NTCEnum.NONE.value == TTuple(id=0, a=0, blist=[])

assert NTCEnum.NONE.id == 0

assert NTCEnum.A.a == 2

assert NTCEnum.B.blist == [0, 1, 2]

assert [x.value for x in NTCEnum] == [TTuple(id=0, a=0, blist=[]), TTuple(id=1, a=2, blist=[4]), TTuple(id=2, a=4, blist=[0, 1, 2])]
...
assert repr(NTDEnum.NONE) == '<NTDEnum.NONE: TTuple(id=0, a=0, blist=[])>'

assert NTDEnum.NONE.id == 0

assert NTDEnum.A.a == 2

assert NTDEnum.B.blist == [0, 1, 2]
print("TestSpecial::test_namedtuple_as_value: ok")
