...
# lib = "enum"
# dimension = "behavior"
# case = "test_special__test_nested_classes_in_enum_with_nonmember"
# subject = "cpython.test_enum.TestSpecial.test_nested_classes_in_enum_with_nonmember"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestSpecial::test_nested_classes_in_enum_with_nonmember
"""Auto-ported test: TestSpecial::test_nested_classes_in_enum_with_nonmember (CPython 3.12 oracle)."""
...
assert Outer.Inner.foo.value == 10

assert list(Outer.Inner) == [Outer.Inner.foo, Outer.Inner.bar]

assert list(Outer) == [Outer.a, Outer.b]
print("TestSpecial::test_nested_classes_in_enum_with_nonmember: ok")
