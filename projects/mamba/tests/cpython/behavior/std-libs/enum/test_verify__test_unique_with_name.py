...
# lib = "enum"
# dimension = "behavior"
# case = "test_verify__test_unique_with_name"
# subject = "cpython.test_enum.TestVerify.test_unique_with_name"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_enum.py::TestVerify::test_unique_with_name
"""Auto-ported test: TestVerify::test_unique_with_name (CPython 3.12 oracle)."""
...
class Sillier(IntEnum):
    ...
    triple = 3
    value = 4
print("TestVerify::test_unique_with_name: ok")
