...
# lib = "smtplib"
# dimension = "behavior"
# case = "bad_helo_server_tests__test_failing_helo"
# subject = "cpython.test_smtplib.BadHELOServerTests.testFailingHELO"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_smtplib.py::BadHELOServerTests::testFailingHELO
"""Auto-ported test: BadHELOServerTests::testFailingHELO (CPython 3.12 oracle)."""
...
self_old_stdout = sys.stdout
self_output = io.StringIO()
sys.stdout = self_output
self_port = 25

try:
    smtplib.SMTP(HOST, self_port, 'localhost', 3)
    raise AssertionError('expected smtplib.SMTPConnectError')
except smtplib.SMTPConnectError:
    pass
print("BadHELOServerTests::testFailingHELO: ok")
