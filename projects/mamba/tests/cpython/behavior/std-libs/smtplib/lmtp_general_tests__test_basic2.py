...
# lib = "smtplib"
# dimension = "behavior"
# case = "lmtp_general_tests__test_basic2"
# subject = "cpython.test_smtplib.LMTPGeneralTests.testBasic2"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_smtplib.py::LMTPGeneralTests::testBasic2
"""Auto-ported test: LMTPGeneralTests::testBasic2 (CPython 3.12 oracle)."""
...
client = client('%s:%s' % (HOST, self_port))
client.close()
print("LMTPGeneralTests::testBasic2: ok")
