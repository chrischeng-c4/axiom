...
# lib = "smtplib"
# dimension = "behavior"
# case = "smtp_general_tests__test_timeout_zero"
# subject = "cpython.test_smtplib.SMTPGeneralTests.testTimeoutZero"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_smtplib.py::SMTPGeneralTests::testTimeoutZero
"""Auto-ported test: SMTPGeneralTests::testTimeoutZero (CPython 3.12 oracle)."""
...
try:
    client(HOST, self_port, timeout=0)
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("SMTPGeneralTests::testTimeoutZero: ok")
