...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_ipv4_mapped"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testIpv4Mapped"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testIpv4Mapped
"""Auto-ported test: IpaddrUnitTest::testIpv4Mapped (CPython 3.12 oracle)."""
...
assert ipaddress.ip_address('::ffff:192.168.1.1').ipv4_mapped == ipaddress.ip_address('192.168.1.1')

assert ipaddress.ip_address('::c0a8:101').ipv4_mapped == None

assert ipaddress.ip_address('::ffff:c0a8:101').ipv4_mapped == ipaddress.ip_address('192.168.1.1')
print("IpaddrUnitTest::testIpv4Mapped: ok")
