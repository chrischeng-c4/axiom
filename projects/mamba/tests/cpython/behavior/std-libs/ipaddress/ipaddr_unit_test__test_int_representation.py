...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_int_representation"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testIntRepresentation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testIntRepresentation
"""Auto-ported test: IpaddrUnitTest::testIntRepresentation (CPython 3.12 oracle)."""
...
assert 16909060 == int(self_ipv4_address)

assert 42540616829182469433547762482097946625 == int(self_ipv6_address)
print("IpaddrUnitTest::testIntRepresentation: ok")
