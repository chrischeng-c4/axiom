...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_i_pv4_network_helpers"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testIPv4NetworkHelpers"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testIPv4NetworkHelpers
"""Auto-ported test: IpaddrUnitTest::testIPv4NetworkHelpers (CPython 3.12 oracle)."""
...
print("IpaddrUnitTest::testIPv4NetworkHelpers: ok")
