...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_max_prefix_length"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testMaxPrefixLength"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testMaxPrefixLength
"""Auto-ported test: IpaddrUnitTest::testMaxPrefixLength (CPython 3.12 oracle)."""
...
assert self_ipv4_interface.max_prefixlen == 32

assert self_ipv6_interface.max_prefixlen == 128

assert self_ipv6_scoped_interface.max_prefixlen == 128
print("IpaddrUnitTest::testMaxPrefixLength: ok")
