...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_supernet_fails_for_large_cidr_diff"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testSupernetFailsForLargeCidrDiff"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testSupernetFailsForLargeCidrDiff
"""Auto-ported test: IpaddrUnitTest::testSupernetFailsForLargeCidrDiff (CPython 3.12 oracle)."""
...
try:
    self_ipv4_interface.network.supernet(25)
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    self_ipv6_interface.network.supernet(65)
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    self_ipv6_scoped_interface.network.supernet(65)
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("IpaddrUnitTest::testSupernetFailsForLargeCidrDiff: ok")
