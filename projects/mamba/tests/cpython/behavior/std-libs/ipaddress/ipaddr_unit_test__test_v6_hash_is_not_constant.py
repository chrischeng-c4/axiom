...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_v6_hash_is_not_constant"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testV6HashIsNotConstant"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testV6HashIsNotConstant
"""Auto-ported test: IpaddrUnitTest::testV6HashIsNotConstant (CPython 3.12 oracle)."""
...
print("IpaddrUnitTest::testV6HashIsNotConstant: ok")
