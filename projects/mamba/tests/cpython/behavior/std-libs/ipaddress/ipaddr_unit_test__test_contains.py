...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_contains"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testContains"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testContains
"""Auto-ported test: IpaddrUnitTest::testContains (CPython 3.12 oracle)."""
...
assert ipaddress.IPv4Interface('1.2.3.128/25') in self_ipv4_network

assert ipaddress.IPv4Interface('1.2.4.1/24') not in self_ipv4_network
addr1 = ipaddress.IPv4Address('1.2.3.37')

assert addr1 in self_ipv4_network

assert not ipaddress.IPv4Network('1.1.0.0/16').__contains__(ipaddress.IPv4Network('1.0.0.0/15'))
print("IpaddrUnitTest::testContains: ok")
