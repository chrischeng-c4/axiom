...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_copy_constructor"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testCopyConstructor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testCopyConstructor
"""Auto-ported test: IpaddrUnitTest::testCopyConstructor (CPython 3.12 oracle)."""
...
print("IpaddrUnitTest::testCopyConstructor: ok")
