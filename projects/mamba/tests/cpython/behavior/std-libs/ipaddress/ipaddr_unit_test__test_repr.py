...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_repr"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testRepr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testRepr
"""Auto-ported test: IpaddrUnitTest::testRepr (CPython 3.12 oracle)."""
...
assert "IPv6Interface('::1%scope/128')" == repr(ipaddress.IPv6Interface('::1%scope'))
print("IpaddrUnitTest::testRepr: ok")
