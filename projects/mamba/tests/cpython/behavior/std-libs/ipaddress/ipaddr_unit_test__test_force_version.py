...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_force_version"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testForceVersion"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testForceVersion
"""Auto-ported test: IpaddrUnitTest::testForceVersion (CPython 3.12 oracle)."""
...
print("IpaddrUnitTest::testForceVersion: ok")
