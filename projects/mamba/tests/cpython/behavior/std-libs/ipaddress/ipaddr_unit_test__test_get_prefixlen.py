...
# lib = "ipaddress"
# dimension = "behavior"
# case = "ipaddr_unit_test__test_get_prefixlen"
# subject = "cpython.test_ipaddress.IpaddrUnitTest.testGetPrefixlen"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::IpaddrUnitTest::testGetPrefixlen
"""Auto-ported test: IpaddrUnitTest::testGetPrefixlen (CPython 3.12 oracle)."""
...
assert self_ipv4_interface.network.prefixlen == 24

assert self_ipv6_interface.network.prefixlen == 64

assert self_ipv6_scoped_interface.network.prefixlen == 64
print("IpaddrUnitTest::testGetPrefixlen: ok")
