...
# lib = "ipaddress"
# dimension = "behavior"
# case = "comparison_tests__test_mixed_type_equality"
# subject = "cpython.test_ipaddress.ComparisonTests.test_mixed_type_equality"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::ComparisonTests::test_mixed_type_equality
"""Auto-ported test: ComparisonTests::test_mixed_type_equality (CPython 3.12 oracle)."""
...
for lhs in objects:
    for rhs in objects:
        ...
        assert lhs != rhs
print("ComparisonTests::test_mixed_type_equality: ok")
