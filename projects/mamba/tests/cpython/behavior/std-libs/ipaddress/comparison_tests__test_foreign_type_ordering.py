...
# lib = "ipaddress"
# dimension = "behavior"
# case = "comparison_tests__test_foreign_type_ordering"
# subject = "cpython.test_ipaddress.ComparisonTests.test_foreign_type_ordering"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_ipaddress.py::ComparisonTests::test_foreign_type_ordering
"""Auto-ported test: ComparisonTests::test_foreign_type_ordering (CPython 3.12 oracle)."""
...
for obj in objects_with_scoped:
    ...
    assert not obj > LARGEST

    assert obj <= LARGEST

    assert not obj >= LARGEST

    assert not obj < SMALLEST
    ...
    assert obj >= SMALLEST
print("ComparisonTests::test_foreign_type_ordering: ok")
