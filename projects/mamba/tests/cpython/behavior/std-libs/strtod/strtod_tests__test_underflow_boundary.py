...
# lib = "strtod"
# dimension = "behavior"
# case = "strtod_tests__test_underflow_boundary"
# subject = "cpython.test_strtod.StrtodTests.test_underflow_boundary"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_strtod.py::StrtodTests::test_underflow_boundary
"""Auto-ported test: StrtodTests::test_underflow_boundary (CPython 3.12 oracle)."""
...
for exponent in range(-400, -320):
    ...
    for j in range(TEST_SIZE):
        ...
        check_strtod(s)
print("StrtodTests::test_underflow_boundary: ok")
