...
# lib = "strtod"
# dimension = "behavior"
# case = "strtod_tests__test_short_halfway_cases"
# subject = "cpython.test_strtod.StrtodTests.test_short_halfway_cases"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_strtod.py::StrtodTests::test_short_halfway_cases
"""Auto-ported test: StrtodTests::test_short_halfway_cases (CPython 3.12 oracle)."""
...
for k in (0, 5, 10, 15, 20):
    ...
    for i in range(TEST_SIZE):
        ...
        while digits < 10 ** 20:
            ...
            digits *= 5
            exponent -= 1
print("StrtodTests::test_short_halfway_cases: ok")
