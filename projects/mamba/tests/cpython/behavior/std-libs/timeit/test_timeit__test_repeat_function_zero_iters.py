...
# lib = "timeit"
# dimension = "behavior"
# case = "test_timeit__test_repeat_function_zero_iters"
# subject = "cpython.test_timeit.TestTimeit.test_repeat_function_zero_iters"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_timeit.py::TestTimeit::test_repeat_function_zero_iters
"""Auto-ported test: TestTimeit::test_repeat_function_zero_iters (CPython 3.12 oracle)."""
...
delta_times = timeit.repeat(fake_stmt, fake_setup, number=0, timer=FakeTimer())

assert delta_times == DEFAULT_REPEAT * [0.0]
print("TestTimeit::test_repeat_function_zero_iters: ok")
