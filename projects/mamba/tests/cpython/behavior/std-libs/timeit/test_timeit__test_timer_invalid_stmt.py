...
# lib = "timeit"
# dimension = "behavior"
# case = "test_timeit__test_timer_invalid_stmt"
# subject = "cpython.test_timeit.TestTimeit.test_timer_invalid_stmt"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_timeit.py::TestTimeit::test_timer_invalid_stmt
"""Auto-ported test: TestTimeit::test_timer_invalid_stmt (CPython 3.12 oracle)."""
...
try:
    timeit.Timer(setup='while False:\n  pass', stmt='  break')
    raise AssertionError('expected SyntaxError')
except SyntaxError:
    pass
print("TestTimeit::test_timer_invalid_stmt: ok")
