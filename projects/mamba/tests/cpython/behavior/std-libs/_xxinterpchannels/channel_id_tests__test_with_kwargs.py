...
# dimension = "behavior"
# case = "channel_id_tests__test_with_kwargs"
# subject = "cpython.test__xxinterpchannels.ChannelIDTests.test_with_kwargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelIDTests::test_with_kwargs
"""Auto-ported test: ChannelIDTests::test_with_kwargs (CPython 3.12 oracle)."""
...
assert cid.end == 'both'
print("ChannelIDTests::test_with_kwargs: ok")
