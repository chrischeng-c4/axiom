...
# dimension = "behavior"
# case = "channel_tests__test_recv_empty"
# subject = "cpython.test__xxinterpchannels.ChannelTests.test_recv_empty"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelTests::test_recv_empty
"""Auto-ported test: ChannelTests::test_recv_empty (CPython 3.12 oracle)."""
...
try:
    channels.recv(cid)
    raise AssertionError('expected channels.ChannelEmptyError')
except channels.ChannelEmptyError:
    pass
print("ChannelTests::test_recv_empty: ok")
