...
# dimension = "behavior"
# case = "channel_tests__test_create_cid"
# subject = "cpython.test__xxinterpchannels.ChannelTests.test_create_cid"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test__xxinterpchannels.py::ChannelTests::test_create_cid
"""Auto-ported test: ChannelTests::test_create_cid (CPython 3.12 oracle)."""
...
assert isinstance(cid, channels.ChannelID)
print("ChannelTests::test_create_cid: ok")
