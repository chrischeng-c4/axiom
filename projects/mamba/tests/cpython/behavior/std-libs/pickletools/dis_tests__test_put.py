...
# lib = "pickletools"
# dimension = "behavior"
# case = "dis_tests__test_put"
# subject = "cpython.test_pickletools.DisTests.test_put"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pickletools.py::DisTests::test_put
"""Auto-ported test: DisTests::test_put (CPython 3.12 oracle)."""
...
def check_dis_error(data, expected, expected_error, **kwargs):
    ...
    assert out.getvalue() == expected
check_dis(b'Np0\nq\x01r\x02\x00\x00\x00\x94.', '    0: N    NONE\n    1: p    PUT        0\n    4: q    BINPUT     1\n    6: r    LONG_BINPUT 2\n   11: \\x94 MEMOIZE    (as 3)\n   12: .    STOP\nhighest protocol among opcodes = 4\n')
print("DisTests::test_put: ok")
