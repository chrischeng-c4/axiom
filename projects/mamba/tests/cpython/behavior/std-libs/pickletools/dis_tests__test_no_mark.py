...
# lib = "pickletools"
# dimension = "behavior"
# case = "dis_tests__test_no_mark"
# subject = "cpython.test_pickletools.DisTests.test_no_mark"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pickletools.py::DisTests::test_no_mark
"""Auto-ported test: DisTests::test_no_mark (CPython 3.12 oracle)."""
...
def check_dis_error(data, expected, expected_error, **kwargs):
    ...
    assert out.getvalue() == expected
check_dis_error(b'Nt.', '    0: N    NONE\n    1: t    TUPLE      no MARK exists on stack\n', 'no MARK exists on stack')
print("DisTests::test_no_mark: ok")
