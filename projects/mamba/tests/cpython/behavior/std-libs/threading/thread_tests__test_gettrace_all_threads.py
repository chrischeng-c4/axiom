...
# lib = "threading"
# dimension = "behavior"
# case = "thread_tests__test_gettrace_all_threads"
# subject = "cpython.test_threading.ThreadTests.test_gettrace_all_threads"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::ThreadTests::test_gettrace_all_threads
"""Auto-ported test: ThreadTests::test_gettrace_all_threads (CPython 3.12 oracle)."""
...
try:
    ...
    assert trace_funcs == [None, fn]

    assert threading.gettrace() == fn

    assert sys.gettrace() == fn
finally:
    threading.settrace_all_threads(old_trace)

assert threading.gettrace() == old_trace

assert sys.gettrace() == old_trace
print("ThreadTests::test_gettrace_all_threads: ok")
