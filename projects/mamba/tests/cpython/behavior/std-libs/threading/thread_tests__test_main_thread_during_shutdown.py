...
# lib = "threading"
# dimension = "behavior"
# case = "thread_tests__test_main_thread_during_shutdown"
# subject = "cpython.test_threading.ThreadTests.test_main_thread_during_shutdown"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::ThreadTests::test_main_thread_during_shutdown
"""Auto-ported test: ThreadTests::test_main_thread_during_shutdown (CPython 3.12 oracle)."""
...
assert data.splitlines() == ['GC: True True True'] * 2
print("ThreadTests::test_main_thread_during_shutdown: ok")
