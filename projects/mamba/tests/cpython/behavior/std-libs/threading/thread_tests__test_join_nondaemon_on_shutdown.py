...
# lib = "threading"
# dimension = "behavior"
# case = "thread_tests__test_join_nondaemon_on_shutdown"
# subject = "cpython.test_threading.ThreadTests.test_join_nondaemon_on_shutdown"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::ThreadTests::test_join_nondaemon_on_shutdown
"""Auto-ported test: ThreadTests::test_join_nondaemon_on_shutdown (CPython 3.12 oracle)."""
...
assert out.strip() == b'Woke up, sleep function is: <built-in function sleep>'

assert err == b''
print("ThreadTests::test_join_nondaemon_on_shutdown: ok")
