...
# lib = "threading"
# dimension = "behavior"
# case = "thread_tests__test_shutdown_locks"
# subject = "cpython.test_threading.ThreadTests.test_shutdown_locks"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::ThreadTests::test_shutdown_locks
"""Auto-ported test: ThreadTests::test_shutdown_locks (CPython 3.12 oracle)."""
...
for daemon in (False, True):
    ...
    if not daemon:
        ...
        assert tstate_lock in threading._shutdown_locks
    else:

        assert tstate_lock not in threading._shutdown_locks
    event.set()
    thread.join()

    assert tstate_lock not in threading._shutdown_locks
print("ThreadTests::test_shutdown_locks: ok")
