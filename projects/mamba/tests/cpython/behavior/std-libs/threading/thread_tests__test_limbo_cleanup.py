...
# lib = "threading"
# dimension = "behavior"
# case = "thread_tests__test_limbo_cleanup"
# subject = "cpython.test_threading.ThreadTests.test_limbo_cleanup"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::ThreadTests::test_limbo_cleanup
"""Auto-ported test: ThreadTests::test_limbo_cleanup (CPython 3.12 oracle)."""
...
try:
    ...
    try:
        t.start()
        raise AssertionError('expected threading.ThreadError')
    except threading.ThreadError:
        pass

    assert not t in threading._limbo
finally:
    threading._start_new_thread = _start_new_thread
print("ThreadTests::test_limbo_cleanup: ok")
