...
# lib = "threading"
# dimension = "behavior"
# case = "thread_tests__test_getprofile"
# subject = "cpython.test_threading.ThreadTests.test_getprofile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_threading.py::ThreadTests::test_getprofile
"""Auto-ported test: ThreadTests::test_getprofile (CPython 3.12 oracle)."""
...
try:
    ...
    assert fn == threading.getprofile()
finally:
    threading.setprofile(old_profile)
print("ThreadTests::test_getprofile: ok")
