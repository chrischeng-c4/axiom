...
# lib = "hashlib"
# dimension = "behavior"
# case = "hash_lib_test_case__test_algorithms_guaranteed"
# subject = "cpython.test_hashlib.HashLibTestCase.test_algorithms_guaranteed"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_hashlib.py::HashLibTestCase::test_algorithms_guaranteed
"""Auto-ported test: HashLibTestCase::test_algorithms_guaranteed (CPython 3.12 oracle)."""
...
assert hashlib.algorithms_guaranteed == set((_algo for _algo in supported_hash_names if _algo.islower()))
print("HashLibTestCase::test_algorithms_guaranteed: ok")
