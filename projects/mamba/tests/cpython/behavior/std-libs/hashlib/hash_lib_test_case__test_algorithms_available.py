...
# lib = "hashlib"
# dimension = "behavior"
# case = "hash_lib_test_case__test_algorithms_available"
# subject = "cpython.test_hashlib.HashLibTestCase.test_algorithms_available"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_hashlib.py::HashLibTestCase::test_algorithms_available
"""Auto-ported test: HashLibTestCase::test_algorithms_available (CPython 3.12 oracle)."""
...
assert set(hashlib.algorithms_guaranteed).issubset(hashlib.algorithms_available)

assert 'undefined' not in hashlib.algorithms_available
for name in hashlib.algorithms_available:
    digest = hashlib.new(name, usedforsecurity=False)
print("HashLibTestCase::test_algorithms_available: ok")
