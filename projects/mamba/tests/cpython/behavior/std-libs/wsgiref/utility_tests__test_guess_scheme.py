...
# lib = "wsgiref"
# dimension = "behavior"
# case = "utility_tests__test_guess_scheme"
# subject = "cpython.test_wsgiref.UtilityTests.testGuessScheme"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wsgiref.py::UtilityTests::testGuessScheme
"""Auto-ported test: UtilityTests::testGuessScheme (CPython 3.12 oracle)."""
...
assert util.guess_scheme({'HTTPS': 'foo'}) == 'http'
...
print("UtilityTests::testGuessScheme: ok")
