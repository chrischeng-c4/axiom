...
# lib = "wsgiref"
# dimension = "behavior"
# case = "integration_tests__test_wsgi_input"
# subject = "cpython.test_wsgiref.IntegrationTests.test_wsgi_input"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wsgiref.py::IntegrationTests::test_wsgi_input
"""Auto-ported test: IntegrationTests::test_wsgi_input (CPython 3.12 oracle)."""
...
assert err.splitlines()[-2] == 'AssertionError'
print("IntegrationTests::test_wsgi_input: ok")
