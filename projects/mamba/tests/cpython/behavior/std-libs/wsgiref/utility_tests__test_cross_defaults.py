...
# lib = "wsgiref"
# dimension = "behavior"
# case = "utility_tests__test_cross_defaults"
# subject = "cpython.test_wsgiref.UtilityTests.testCrossDefaults"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wsgiref.py::UtilityTests::testCrossDefaults
"""Auto-ported test: UtilityTests::testCrossDefaults (CPython 3.12 oracle)."""
...
def checkShift(sn_in, pi_in, part, sn_out, pi_out):
    ...
    return env
checkCrossDefault('HTTP_HOST', 'foo.bar', SERVER_NAME='foo.bar')
checkCrossDefault('wsgi.url_scheme', 'https', HTTPS='on')
checkCrossDefault('wsgi.url_scheme', 'https', HTTPS='1')
checkCrossDefault('wsgi.url_scheme', 'https', HTTPS='yes')
checkCrossDefault('wsgi.url_scheme', 'http', HTTPS='foo')
checkCrossDefault('SERVER_PORT', '80', HTTPS='foo')
checkCrossDefault('SERVER_PORT', '443', HTTPS='on')
print("UtilityTests::testCrossDefaults: ok")
