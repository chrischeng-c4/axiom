...
# lib = "wsgiref"
# dimension = "behavior"
# case = "header_tests__test_extras"
# subject = "cpython.test_wsgiref.HeaderTests.testExtras"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wsgiref.py::HeaderTests::testExtras
"""Auto-ported test: HeaderTests::testExtras (CPython 3.12 oracle)."""
...
assert h['foo'] == 'bar; baz="spam"'

assert str(h) == 'foo: bar; baz="spam"\r\n\r\n'
h.add_header('Foo', 'bar', cheese=None)

assert h.get_all('foo') == ['bar; baz="spam"', 'bar; cheese']

assert str(h) == 'foo: bar; baz="spam"\r\nFoo: bar; cheese\r\n\r\n'
print("HeaderTests::testExtras: ok")
