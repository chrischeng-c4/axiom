...
# lib = "wsgiref"
# dimension = "behavior"
# case = "handler_tests__test_basic_error_output"
# subject = "cpython.test_wsgiref.HandlerTests.testBasicErrorOutput"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_wsgiref.py::HandlerTests::testBasicErrorOutput
"""Auto-ported test: HandlerTests::testBasicErrorOutput (CPython 3.12 oracle)."""
...
assert h.stdout.getvalue() == 'Status: 200 OK\r\nContent-Length: 0\r\n\r\n'.encode('iso-8859-1')

assert h.stderr.getvalue() == ''
h = ErrorHandler()
h.run(error_app)

assert h.stdout.getvalue() == ('Status: %s\r\nContent-Type: text/plain\r\nContent-Length: %d\r\n\r\n' % (h.error_status, len(h.error_body))).encode('iso-8859-1') + h.error_body

assert 'AssertionError' in h.stderr.getvalue()
print("HandlerTests::testBasicErrorOutput: ok")
