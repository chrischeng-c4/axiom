...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_compact_width"
# subject = "cpython.test_pprint.QueryTestCase.test_compact_width"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_compact_width
"""Auto-ported test: QueryTestCase::test_compact_width (CPython 3.12 oracle)."""
...
for w in range(levels * 2 + 1, levels + 3 * number - 1):
    ...
    assert maxwidth > w - 3
print("QueryTestCase::test_compact_width: ok")
