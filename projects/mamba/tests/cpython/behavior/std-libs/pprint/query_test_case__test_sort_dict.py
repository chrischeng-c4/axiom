...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_sort_dict"
# subject = "cpython.test_pprint.QueryTestCase.test_sort_dict"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_sort_dict
"""Auto-ported test: QueryTestCase::test_sort_dict (CPython 3.12 oracle)."""
...
assert pprint.pformat(d, sort_dicts=False) == "{'c': None, 'b': None, 'a': None}"

assert pprint.pformat([d, d], sort_dicts=False) == "[{'c': None, 'b': None, 'a': None}, {'c': None, 'b': None, 'a': None}]"
print("QueryTestCase::test_sort_dict: ok")
