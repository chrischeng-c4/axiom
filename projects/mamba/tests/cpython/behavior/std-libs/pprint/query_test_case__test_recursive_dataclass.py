...
# lib = "pprint"
# dimension = "behavior"
# case = "query_test_case__test_recursive_dataclass"
# subject = "cpython.test_pprint.QueryTestCase.test_recursive_dataclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pprint.py::QueryTestCase::test_recursive_dataclass
"""Auto-ported test: QueryTestCase::test_recursive_dataclass (CPython 3.12 oracle)."""
...
assert formatted == 'dataclass4(a=...,\n           b=1)'
print("QueryTestCase::test_recursive_dataclass: ok")
