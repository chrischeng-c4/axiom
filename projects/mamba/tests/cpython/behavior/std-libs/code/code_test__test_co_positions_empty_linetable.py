...
# lib = "code"
# dimension = "behavior"
# case = "code_test__test_co_positions_empty_linetable"
# subject = "cpython.test_code.CodeTest.test_co_positions_empty_linetable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_code.py::CodeTest::test_co_positions_empty_linetable
"""Auto-ported test: CodeTest::test_co_positions_empty_linetable (CPython 3.12 oracle)."""
...
for line, end_line, column, end_column in positions:
    ...
    assert end_line == new_code.co_firstlineno + 1
print("CodeTest::test_co_positions_empty_linetable: ok")
