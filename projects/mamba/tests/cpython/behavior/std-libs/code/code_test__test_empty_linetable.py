...
# lib = "code"
# dimension = "behavior"
# case = "code_test__test_empty_linetable"
# subject = "cpython.test_code.CodeTest.test_empty_linetable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_code.py::CodeTest::test_empty_linetable
"""Auto-ported test: CodeTest::test_empty_linetable (CPython 3.12 oracle)."""
...
assert list(new_code.co_lines()) == []
print("CodeTest::test_empty_linetable: ok")
