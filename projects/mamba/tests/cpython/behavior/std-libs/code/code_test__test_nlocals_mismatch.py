...
# lib = "code"
# dimension = "behavior"
# case = "code_test__test_nlocals_mismatch"
# subject = "cpython.test_code.CodeTest.test_nlocals_mismatch"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_code.py::CodeTest::test_nlocals_mismatch
"""Auto-ported test: CodeTest::test_nlocals_mismatch (CPython 3.12 oracle)."""
...
for diff in (-1, 1):
    try:
        CodeType(co.co_argcount, co.co_posonlyargcount, co.co_kwonlyargcount, co.co_nlocals + diff, co.co_stacksize, co.co_flags, co.co_code, co.co_consts, co.co_names, co.co_varnames, co.co_filename, co.co_name, co.co_qualname, co.co_firstlineno, co.co_linetable, co.co_exceptiontable, co.co_freevars, co.co_cellvars)
...
try:
    ...
    pass
print("CodeTest::test_nlocals_mismatch: ok")
