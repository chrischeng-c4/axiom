...
# lib = "code"
# dimension = "behavior"
# case = "code_test__test_code_hash_uses_order"
# subject = "cpython.test_code.CodeTest.test_code_hash_uses_order"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_code.py::CodeTest::test_code_hash_uses_order
"""Auto-ported test: CodeTest::test_code_hash_uses_order (CPython 3.12 oracle)."""
...
assert c.co_kwonlyargcount == 2
swapped = c.replace(co_posonlyargcount=2, co_kwonlyargcount=0)

assert c != swapped

assert hash(c) != hash(swapped)
print("CodeTest::test_code_hash_uses_order: ok")
