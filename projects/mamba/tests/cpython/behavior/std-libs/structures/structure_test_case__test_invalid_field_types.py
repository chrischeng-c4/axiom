...
# lib = "structures"
# dimension = "behavior"
# case = "structure_test_case__test_invalid_field_types"
# subject = "cpython.test_structures.StructureTestCase.test_invalid_field_types"
# kind = "semantic"
...
class POINT(Structure):
    pass
try:
    setattr(POINT, '_fields_', [('x', 1), ('y', 2)])
    raise AssertionError('assertRaises: no raise')
except TypeError:
    pass

print("StructureTestCase::test_invalid_field_types: ok")
