...
# lib = "structures"
# dimension = "behavior"
# case = "structure_test_case__test_invalid_name"
# subject = "cpython.test_structures.StructureTestCase.test_invalid_name"
# kind = "semantic"
...
def declare_with_name(name):
    ...
    class S(Structure):
        _fields_ = [(name, c_int)]
try:
    declare_with_name(b'x')
    raise AssertionError('assertRaises: no raise')
except TypeError:
    pass

print("StructureTestCase::test_invalid_name: ok")
