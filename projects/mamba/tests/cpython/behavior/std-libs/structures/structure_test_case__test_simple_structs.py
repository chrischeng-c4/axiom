...
# lib = "structures"
# dimension = "behavior"
# case = "structure_test_case__test_simple_structs"
# subject = "cpython.test_structures.StructureTestCase.test_simple_structs"
# kind = "semantic"
...
for code, tp in formats.items():

    class X(Structure):
        _fields_ = [('x', c_char), ('y', tp)]
    assert (sizeof(X), code) == (calcsize('c%c0%c' % (code, code)), code)

print("StructureTestCase::test_simple_structs: ok")
