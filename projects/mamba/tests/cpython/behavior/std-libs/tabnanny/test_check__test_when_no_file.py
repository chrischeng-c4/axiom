...
# lib = "tabnanny"
# dimension = "behavior"
# case = "test_check__test_when_no_file"
# subject = "cpython.test_tabnanny.TestCheck.test_when_no_file"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_tabnanny.py::TestCheck::test_when_no_file
"""Auto-ported test: TestCheck::test_when_no_file (CPython 3.12 oracle)."""
...
try:
    verify_tabnanny_check(path, err=err)
    raise AssertionError('expected SystemExit')
except SystemExit:
    pass
print("TestCheck::test_when_no_file: ok")
