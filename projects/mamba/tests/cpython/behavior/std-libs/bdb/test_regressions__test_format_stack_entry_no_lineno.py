...
# lib = "bdb"
# dimension = "behavior"
# case = "test_regressions__test_format_stack_entry_no_lineno"
# subject = "cpython.test_bdb.TestRegressions.test_format_stack_entry_no_lineno"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bdb.py::TestRegressions::test_format_stack_entry_no_lineno
"""Auto-ported test: TestRegressions::test_format_stack_entry_no_lineno (CPython 3.12 oracle)."""
...
assert 'Warning: lineno is None' in Bdb().format_stack_entry((sys._getframe(), None))
print("TestRegressions::test_format_stack_entry_no_lineno: ok")
