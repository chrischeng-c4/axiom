...
# lib = "sys_setprofile"
# dimension = "behavior"
# case = "profile_hook_test_case__test_distant_exception"
# subject = "cpython.test_sys_setprofile.ProfileHookTestCase.test_distant_exception"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_setprofile.py::ProfileHookTestCase::test_distant_exception
"""Auto-ported test: ProfileHookTestCase::test_distant_exception (CPython 3.12 oracle)."""
...
i_ident = ident(i)
j_ident = ident(j)
check_events(j, [(1, 'call', j_ident), (2, 'call', i_ident), (3, 'call', h_ident), (4, 'call', g_ident), (5, 'call', f_ident), (5, 'return', f_ident), (4, 'return', g_ident), (3, 'return', h_ident), (2, 'return', i_ident), (1, 'return', j_ident)])
print("ProfileHookTestCase::test_distant_exception: ok")
