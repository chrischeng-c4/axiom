...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_namedtuple_field_descriptor"
# subject = "cpython.test_pydoc.TestDescriptions.test_namedtuple_field_descriptor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_namedtuple_field_descriptor
"""Auto-ported test: TestDescriptions::test_namedtuple_field_descriptor (CPython 3.12 oracle)."""
...
assert _get_summary_lines(Box.width) == '    Alias for field number 0\n'
print("TestDescriptions::test_namedtuple_field_descriptor: ok")
