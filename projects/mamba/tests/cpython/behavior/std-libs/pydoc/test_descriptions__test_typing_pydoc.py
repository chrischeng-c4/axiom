...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_typing_pydoc"
# subject = "cpython.test_pydoc.TestDescriptions.test_typing_pydoc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_typing_pydoc
"""Auto-ported test: TestDescriptions::test_typing_pydoc (CPython 3.12 oracle)."""
...
assert pydoc.render_doc(foo).splitlines()[-1] == 'f\x08fo\x08oo\x08o(data: List[Any], x: int) -> Iterator[Tuple[int, Any]]'

assert pydoc.render_doc(C).splitlines()[2] == 'class C\x08C(collections.abc.Mapping, typing.Generic)'
print("TestDescriptions::test_typing_pydoc: ok")
