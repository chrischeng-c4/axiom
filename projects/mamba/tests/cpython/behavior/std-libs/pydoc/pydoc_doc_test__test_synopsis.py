...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_doc_test__test_synopsis"
# subject = "cpython.test_pydoc.PydocDocTest.test_synopsis"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocDocTest::test_synopsis
"""Auto-ported test: PydocDocTest::test_synopsis (CPython 3.12 oracle)."""
...
for encoding in ('ISO-8859-1', 'UTF-8'):
    ...
    assert synopsis == 'line 1: hé'
print("PydocDocTest::test_synopsis: ok")
