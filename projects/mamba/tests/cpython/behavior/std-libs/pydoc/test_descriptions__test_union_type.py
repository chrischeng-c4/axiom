...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_union_type"
# subject = "cpython.test_pydoc.TestDescriptions.test_union_type"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_union_type
"""Auto-ported test: TestDescriptions::test_union_type (CPython 3.12 oracle)."""
...
assert pydoc.describe(typing.Union[int, str]) == '_UnionGenericAlias'
doc = pydoc.render_doc(typing.Union[int, str], renderer=pydoc.plaintext)

assert '_UnionGenericAlias in module typing' in doc

assert 'Union = typing.Union' in doc
if typing.Union.__doc__:

    assert typing.Union.__doc__.strip().splitlines()[0] in doc

assert pydoc.describe(int | str) == 'UnionType'
doc = pydoc.render_doc(int | str, renderer=pydoc.plaintext)

assert 'UnionType in module types object' in doc

assert '\nclass UnionType(builtins.object)' in doc
if not MISSING_C_DOCSTRINGS:

    assert types.UnionType.__doc__.strip().splitlines()[0] in doc
print("TestDescriptions::test_union_type: ok")
