...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_doc_test__test_stripid"
# subject = "cpython.test_pydoc.PydocDocTest.test_stripid"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocDocTest::test_stripid
"""Auto-ported test: PydocDocTest::test_stripid (CPython 3.12 oracle)."""
...
assert stripid('<function stripid at 0x88dcee4>') == '<function stripid>'

assert stripid('<function stripid at 0x01F65390>') == '<function stripid>'

assert stripid('42') == '42'

assert stripid("<type 'exceptions.Exception'>") == "<type 'exceptions.Exception'>"
print("PydocDocTest::test_stripid: ok")
