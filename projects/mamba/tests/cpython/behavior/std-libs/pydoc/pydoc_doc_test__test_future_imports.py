...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_doc_test__test_future_imports"
# subject = "cpython.test_pydoc.PydocDocTest.test__future__imports"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocDocTest::test__future__imports
"""Auto-ported test: PydocDocTest::test__future__imports (CPython 3.12 oracle)."""
...
for feature in __future__.all_feature_names:
    ...
    assert txt in future_text

    assert html in future_html

    assert txt not in pydoc_mod_text

    assert html not in pydoc_mod_html
print("PydocDocTest::test__future__imports: ok")
