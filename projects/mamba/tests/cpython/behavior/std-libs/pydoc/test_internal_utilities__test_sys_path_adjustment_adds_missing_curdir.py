...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_internal_utilities__test_sys_path_adjustment_adds_missing_curdir"
# subject = "cpython.test_pydoc.TestInternalUtilities.test_sys_path_adjustment_adds_missing_curdir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestInternalUtilities::test_sys_path_adjustment_adds_missing_curdir
"""Auto-ported test: TestInternalUtilities::test_sys_path_adjustment_adds_missing_curdir (CPython 3.12 oracle)."""
...
expected_path = [self_abs_curdir] + clean_path

assert _get_revised_path(clean_path) == expected_path
print("TestInternalUtilities::test_sys_path_adjustment_adds_missing_curdir: ok")
