...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_field_order_for_named_tuples"
# subject = "cpython.test_pydoc.TestDescriptions.test_field_order_for_named_tuples"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_field_order_for_named_tuples
"""Auto-ported test: TestDescriptions::test_field_order_for_named_tuples (CPython 3.12 oracle)."""
...
assert s.index('nickname') < s.index('firstname')

assert s.index('firstname') < s.index('agegroup')
...
print("TestDescriptions::test_field_order_for_named_tuples: ok")
