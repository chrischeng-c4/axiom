...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_doc_test__test_lambda_without_return_annotation"
# subject = "cpython.test_pydoc.PydocDocTest.test_lambda_without_return_annotation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocDocTest::test_lambda_without_return_annotation
"""Auto-ported test: PydocDocTest::test_lambda_without_return_annotation (CPython 3.12 oracle)."""
...
assert 'lambda (a: int, b: int, c: int)' in helptext
print("PydocDocTest::test_lambda_without_return_annotation: ok")
