...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_doc_test__test_lambda_with_return_and_params_annotation"
# subject = "cpython.test_pydoc.PydocDocTest.test_lambda_with_return_and_params_annotation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocDocTest::test_lambda_with_return_and_params_annotation
"""Auto-ported test: PydocDocTest::test_lambda_with_return_and_params_annotation (CPython 3.12 oracle)."""
...
assert 'lambda (a: int, b: int, c: int) -> int' in helptext
print("PydocDocTest::test_lambda_with_return_and_params_annotation: ok")
