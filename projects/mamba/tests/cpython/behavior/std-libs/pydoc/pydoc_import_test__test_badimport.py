...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_import_test__test_badimport"
# subject = "cpython.test_pydoc.PydocImportTest.test_badimport"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocImportTest::test_badimport
"""Auto-ported test: PydocImportTest::test_badimport (CPython 3.12 oracle)."""
...
# --- test body ---
def _restricted_walk_packages(walk_packages, path=None):
    """
...
def call_url_handler(url, expected_title):
...
def restrict_walk_packages(path=None):
    walk_packages = pkgutil.walk_packages
    pkgutil.walk_packages = _restricted_walk_packages(walk_packages, path)
    try:
        yield
    finally:
        pkgutil.walk_packages = walk_packages
self_test_dir = os.mkdir(TESTFN)
pass
...
print("PydocImportTest::test_badimport: ok")
