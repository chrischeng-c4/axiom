...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_unbound_builtin_method_noargs"
# subject = "cpython.test_pydoc.TestDescriptions.test_unbound_builtin_method_noargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_unbound_builtin_method_noargs
"""Auto-ported test: TestDescriptions::test_unbound_builtin_method_noargs (CPython 3.12 oracle)."""
...
assert _get_summary_line(str.lower) == 'lower(self, /) unbound builtins.str method'
print("TestDescriptions::test_unbound_builtin_method_noargs: ok")
