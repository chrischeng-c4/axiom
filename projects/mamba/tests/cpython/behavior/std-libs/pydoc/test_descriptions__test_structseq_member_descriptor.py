...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_structseq_member_descriptor"
# subject = "cpython.test_pydoc.TestDescriptions.test_structseq_member_descriptor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_structseq_member_descriptor
"""Auto-ported test: TestDescriptions::test_structseq_member_descriptor (CPython 3.12 oracle)."""
...
assert _get_summary_line(type(sys.hash_info).width) == 'width'

assert _get_summary_line(type(sys.flags).debug) == 'debug'

assert _get_summary_line(type(sys.version_info).major) == 'major'

assert _get_summary_line(type(sys.float_info).max) == 'max'
print("TestDescriptions::test_structseq_member_descriptor: ok")
