...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_doc_test__test_fail_help_output_redirect"
# subject = "cpython.test_pydoc.PydocDocTest.test_fail_help_output_redirect"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocDocTest::test_fail_help_output_redirect
"""Auto-ported test: PydocDocTest::test_fail_help_output_redirect (CPython 3.12 oracle)."""
...
with StringIO() as buf:
    ...
    assert expected == buf.getvalue().strip().replace('\n', os.linesep)
print("PydocDocTest::test_fail_help_output_redirect: ok")
