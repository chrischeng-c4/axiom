...
# lib = "pydoc"
# dimension = "behavior"
# case = "test_descriptions__test_property"
# subject = "cpython.test_pydoc.TestDescriptions.test_property"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::TestDescriptions::test_property
"""Auto-ported test: TestDescriptions::test_property (CPython 3.12 oracle)."""
...
assert _get_summary_lines(Rect.area) == '    Area of the rect\n'

assert '\n |  area\n |      Area of the rect\n' in pydoc.plain(pydoc.render_doc(Rect))
print("TestDescriptions::test_property: ok")
