...
# lib = "pydoc"
# dimension = "behavior"
# case = "pydoc_doc_test__test_is_package_when_not_package"
# subject = "cpython.test_pydoc.PydocDocTest.test_is_package_when_not_package"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_pydoc.py::PydocDocTest::test_is_package_when_not_package
"""Auto-ported test: PydocDocTest::test_is_package_when_not_package (CPython 3.12 oracle)."""
...
with os_helper.temp_cwd() as test_dir:
    ...
    assert not pydoc.ispackage(test_dir)
print("PydocDocTest::test_is_package_when_not_package: ok")
