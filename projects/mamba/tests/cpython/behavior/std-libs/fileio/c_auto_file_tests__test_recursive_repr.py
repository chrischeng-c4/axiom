...
# lib = "fileio"
# dimension = "behavior"
# case = "c_auto_file_tests__test_recursive_repr"
# subject = "cpython.test_fileio.CAutoFileTests.testRecursiveRepr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_fileio.py::CAutoFileTests::testRecursiveRepr
"""Auto-ported test: CAutoFileTests::testRecursiveRepr (CPython 3.12 oracle)."""
...
with swap_attr(self_f, 'name', self_f):
    try:
        ...
        pass
print("CAutoFileTests::testRecursiveRepr: ok")
