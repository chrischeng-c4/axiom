...
# lib = "email"
# dimension = "behavior"
# case = "test_quopri__test_decode_one_word"
# subject = "cpython.test_email.TestQuopri.test_decode_one_word"
# kind = "semantic"
...
_test_decode('hello', 'hello')

print("TestQuopri::test_decode_one_word: ok")
