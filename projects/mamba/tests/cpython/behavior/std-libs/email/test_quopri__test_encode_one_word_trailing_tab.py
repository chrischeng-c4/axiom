...
# lib = "email"
# dimension = "behavior"
# case = "test_quopri__test_encode_one_word_trailing_tab"
# subject = "cpython.test_email.TestQuopri.test_encode_one_word_trailing_tab"
# kind = "semantic"
...
_test_encode('hello  \t', 'hello  =09')

print("TestQuopri::test_encode_one_word_trailing_tab: ok")
