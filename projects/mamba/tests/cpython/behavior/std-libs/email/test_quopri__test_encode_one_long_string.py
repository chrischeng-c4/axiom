...
# lib = "email"
# dimension = "behavior"
# case = "test_quopri__test_encode_one_long_string"
# subject = "cpython.test_email.TestQuopri.test_encode_one_long_string"
# kind = "semantic"
...
_test_encode('x' * 100, 'x' * 75 + '=\n' + 'x' * 25)

print("TestQuopri::test_encode_one_long_string: ok")
