...
# lib = "shutil"
# dimension = "behavior"
# case = "test_archives__test_unpack_archive_tar"
# subject = "cpython.test_shutil.TestArchives.test_unpack_archive_tar"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestArchives::test_unpack_archive_tar
"""Auto-ported test: TestArchives::test_unpack_archive_tar (CPython 3.12 oracle)."""
...
def mkdtemp(prefix=None):
    ...
    pass
    return d
check_unpack_tarball('tar')
print("TestArchives::test_unpack_archive_tar: ok")
