...
# lib = "shutil"
# dimension = "behavior"
# case = "test_move__test_move_file_to_dir_pathlike_src"
# subject = "cpython.test_shutil.TestMove.test_move_file_to_dir_pathlike_src"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestMove::test_move_file_to_dir_pathlike_src
"""Auto-ported test: TestMove::test_move_file_to_dir_pathlike_src (CPython 3.12 oracle)."""
...
src = FakePath(self_src_file)
_check_move_file(src, self_dst_dir, self_dst_file)
print("TestMove::test_move_file_to_dir_pathlike_src: ok")
