...
# lib = "shutil"
# dimension = "behavior"
# case = "test_copy__test_copy_return_value"
# subject = "cpython.test_shutil.TestCopy.test_copy_return_value"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestCopy::test_copy_return_value
"""Auto-ported test: TestCopy::test_copy_return_value (CPython 3.12 oracle)."""
...
for fn in (shutil.copy, shutil.copy2):
    ...
    assert rv == os.path.join(dst_dir, 'foo')
    rv = fn(src, os.path.join(dst_dir, 'bar'))

    assert rv == os.path.join(dst_dir, 'bar')
print("TestCopy::test_copy_return_value: ok")
