...
# lib = "shutil"
# dimension = "behavior"
# case = "test_move__test_destinsrc_false_positive"
# subject = "cpython.test_shutil.TestMove.test_destinsrc_false_positive"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestMove::test_destinsrc_false_positive
"""Auto-ported test: TestMove::test_destinsrc_false_positive (CPython 3.12 oracle)."""
...
try:
    for src, dst in [('srcdir', 'src/dest'), ('srcdir', 'srcdir.new')]:
        ...
        assert not shutil._destinsrc(src, dst)
finally:
    os_helper.rmtree(TESTFN)
print("TestMove::test_destinsrc_false_positive: ok")
