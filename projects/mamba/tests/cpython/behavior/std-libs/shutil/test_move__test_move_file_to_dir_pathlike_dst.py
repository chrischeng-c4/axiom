...
# lib = "shutil"
# dimension = "behavior"
# case = "test_move__test_move_file_to_dir_pathlike_dst"
# subject = "cpython.test_shutil.TestMove.test_move_file_to_dir_pathlike_dst"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestMove::test_move_file_to_dir_pathlike_dst
"""Auto-ported test: TestMove::test_move_file_to_dir_pathlike_dst (CPython 3.12 oracle)."""
...
dst = FakePath(self_dst_dir)
_check_move_file(self_src_file, dst, self_dst_file)
print("TestMove::test_move_file_to_dir_pathlike_dst: ok")
