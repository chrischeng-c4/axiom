...
# lib = "shutil"
# dimension = "behavior"
# case = "test_move__test_move_dir"
# subject = "cpython.test_shutil.TestMove.test_move_dir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestMove::test_move_dir
"""Auto-ported test: TestMove::test_move_dir (CPython 3.12 oracle)."""
...
dst_dir = tempfile.mktemp(dir=mkdtemp())
try:
    _check_move_dir(self_src_dir, dst_dir, dst_dir)
finally:
    os_helper.rmtree(dst_dir)
print("TestMove::test_move_dir: ok")
