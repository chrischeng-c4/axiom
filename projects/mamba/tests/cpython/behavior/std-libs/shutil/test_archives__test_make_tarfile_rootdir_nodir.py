...
# lib = "shutil"
# dimension = "behavior"
# case = "test_archives__test_make_tarfile_rootdir_nodir"
# subject = "cpython.test_shutil.TestArchives.test_make_tarfile_rootdir_nodir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestArchives::test_make_tarfile_rootdir_nodir
"""Auto-ported test: TestArchives::test_make_tarfile_rootdir_nodir (CPython 3.12 oracle)."""
...
for dry_run in (False, True):
    ...
    assert not os.path.exists(f'{TESTFN}.tar')
    ...
    assert not os.path.exists(f'{TESTFN}.tar')
print("TestArchives::test_make_tarfile_rootdir_nodir: ok")
