...
# lib = "shutil"
# dimension = "behavior"
# case = "test_copy__test_copyfile_copy_dir"
# subject = "cpython.test_shutil.TestCopy.test_copyfile_copy_dir"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestCopy::test_copyfile_copy_dir
"""Auto-ported test: TestCopy::test_copyfile_copy_dir (CPython 3.12 oracle)."""
...
try:
    shutil.copyfile(src_dir, dst)
    raise AssertionError('expected err')
except err:
    pass

try:
    shutil.copyfile(src_file, src_dir)
    raise AssertionError('expected err')
except err:
    pass

try:
    shutil.copyfile(dir2, src_dir)
    raise AssertionError('expected err')
except err:
    pass
print("TestCopy::test_copyfile_copy_dir: ok")
