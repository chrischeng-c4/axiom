...
# lib = "shutil"
# dimension = "behavior"
# case = "test_rm_tree__test_rmtree_dont_delete_file"
# subject = "cpython.test_shutil.TestRmTree.test_rmtree_dont_delete_file"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestRmTree::test_rmtree_dont_delete_file
"""Auto-ported test: TestRmTree::test_rmtree_dont_delete_file (CPython 3.12 oracle)."""
...
def mkdtemp(prefix=None):
    ...
    pass
    return d
handle, path = tempfile.mkstemp(dir=mkdtemp())
os.close(handle)
...
try:
    ...
    pass
os.remove(path)
print("TestRmTree::test_rmtree_dont_delete_file: ok")
