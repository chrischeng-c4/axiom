...
# lib = "shutil"
# dimension = "behavior"
# case = "test_get_terminal_size__test_bad_environ"
# subject = "cpython.test_shutil.TestGetTerminalSize.test_bad_environ"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestGetTerminalSize::test_bad_environ
"""Auto-ported test: TestGetTerminalSize::test_bad_environ (CPython 3.12 oracle)."""
...
assert size.lines >= 0
print("TestGetTerminalSize::test_bad_environ: ok")
