...
# lib = "shutil"
# dimension = "behavior"
# case = "test_move__test_dont_move_dir_in_itself"
# subject = "cpython.test_shutil.TestMove.test_dont_move_dir_in_itself"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestMove::test_dont_move_dir_in_itself
"""Auto-ported test: TestMove::test_dont_move_dir_in_itself (CPython 3.12 oracle)."""
...
dst = os.path.join(self_src_dir, 'bar')

try:
    shutil.move(self_src_dir, dst)
    raise AssertionError('expected shutil.Error')
except shutil.Error:
    pass
print("TestMove::test_dont_move_dir_in_itself: ok")
