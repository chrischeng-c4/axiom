...
# lib = "shutil"
# dimension = "behavior"
# case = "test_copy__test_copyfile_return_value"
# subject = "cpython.test_shutil.TestCopy.test_copyfile_return_value"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestCopy::test_copyfile_return_value
"""Auto-ported test: TestCopy::test_copyfile_return_value (CPython 3.12 oracle)."""
...
assert read_file(src_file) == read_file(dst_file)
print("TestCopy::test_copyfile_return_value: ok")
