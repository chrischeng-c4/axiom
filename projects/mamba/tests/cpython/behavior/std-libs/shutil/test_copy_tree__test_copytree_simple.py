...
# lib = "shutil"
# dimension = "behavior"
# case = "test_copy_tree__test_copytree_simple"
# subject = "cpython.test_shutil.TestCopyTree.test_copytree_simple"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shutil.py::TestCopyTree::test_copytree_simple
"""Auto-ported test: TestCopyTree::test_copytree_simple (CPython 3.12 oracle)."""
...
def mkdtemp(prefix=None):
    ...
    return d
src_dir = mkdtemp()
dst_dir = os.path.join(mkdtemp(), 'destination')
pass
pass
...
assert os.path.isfile(os.path.join(dst_dir, 'test.txt'))

assert os.path.isdir(os.path.join(dst_dir, 'test_dir'))

assert os.path.isfile(os.path.join(dst_dir, 'test_dir', 'test.txt'))
...
assert actual == '456'
print("TestCopyTree::test_copytree_simple: ok")
