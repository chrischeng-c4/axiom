...
# lib = "time"
# dimension = "behavior"
# case = "test_c_py_time__test_from_seconds_object"
# subject = "cpython.test_time.TestCPyTime.test_FromSecondsObject"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_time.py::TestCPyTime::test_FromSecondsObject
"""Auto-ported test: TestCPyTime::test_FromSecondsObject (CPython 3.12 oracle)."""
...
check_int_rounding(PyTime_FromSecondsObject, lambda secs: secs * SEC_TO_NS)
check_float_rounding(PyTime_FromSecondsObject, lambda ns: decimal_round(ns * SEC_TO_NS))
for time_rnd, _ in ROUNDING_MODES:
    try:
        ...
        pass
print("TestCPyTime::test_FromSecondsObject: ok")
