...
# lib = "time"
# dimension = "behavior"
# case = "time_test_case__test_insane_timestamps"
# subject = "cpython.test_time.TimeTestCase.test_insane_timestamps"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_time.py::TimeTestCase::test_insane_timestamps
"""Auto-ported test: TimeTestCase::test_insane_timestamps (CPython 3.12 oracle)."""
...
for func in (time.ctime, time.gmtime, time.localtime):
    for unreasonable in (-1e+200, 1e+200):
        ...
        try:
            ...
            pass
print("TimeTestCase::test_insane_timestamps: ok")
