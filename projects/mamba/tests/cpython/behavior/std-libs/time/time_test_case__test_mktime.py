...
# lib = "time"
# dimension = "behavior"
# case = "time_test_case__test_mktime"
# subject = "cpython.test_time.TimeTestCase.test_mktime"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_time.py::TimeTestCase::test_mktime
"""Auto-ported test: TimeTestCase::test_mktime (CPython 3.12 oracle)."""
...
for t in (-2, -1, 0, 1):
    try:
        ...
        assert time.mktime(tt) == t
print("TimeTestCase::test_mktime: ok")
