...
# lib = "time"
# dimension = "behavior"
# case = "time_test_case__test_strftime_bounding_check"
# subject = "cpython.test_time.TimeTestCase.test_strftime_bounding_check"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_time.py::TimeTestCase::test_strftime_bounding_check
"""Auto-ported test: TimeTestCase::test_strftime_bounding_check (CPython 3.12 oracle)."""
...
def _bounds_checking(func):
    ...
    try:
        ...
        pass
self_t = time.time()
_bounds_checking(lambda tup: time.strftime('', tup))
print("TimeTestCase::test_strftime_bounding_check: ok")
