...
# lib = "time"
# dimension = "behavior"
# case = "test_c_py_time__test_as_seconds_double"
# subject = "cpython.test_time.TestCPyTime.test_AsSecondsDouble"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_time.py::TestCPyTime::test_AsSecondsDouble
"""Auto-ported test: TestCPyTime::test_AsSecondsDouble (CPython 3.12 oracle)."""
...
def float_converter(ns):
    if abs(ns) % SEC_TO_NS == 0:
        ...
        return float(ns) / SEC_TO_NS
check_int_rounding(lambda ns, rnd: PyTime_AsSecondsDouble(ns), float_converter, NS_TO_SEC)
for time_rnd, _ in ROUNDING_MODES:
    try:
        ...
        pass
print("TestCPyTime::test_AsSecondsDouble: ok")
