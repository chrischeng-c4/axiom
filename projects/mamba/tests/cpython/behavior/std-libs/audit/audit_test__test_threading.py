...
# lib = "audit"
# dimension = "behavior"
# case = "audit_test__test_threading"
# subject = "cpython.test_audit.AuditTest.test_threading"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audit.py::AuditTest::test_threading
"""Auto-ported test: AuditTest::test_threading (CPython 3.12 oracle)."""
...
returncode, events, stderr = run_python('test_threading')
if returncode:
...
expected = [('_thread.start_new_thread', '(<test_func>, (), None)'), ('test.test_func', '()')]

assert actual == expected
print("AuditTest::test_threading: ok")
