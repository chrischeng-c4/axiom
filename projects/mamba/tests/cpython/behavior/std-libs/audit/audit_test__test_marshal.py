...
# lib = "audit"
# dimension = "behavior"
# case = "audit_test__test_marshal"
# subject = "cpython.test_audit.AuditTest.test_marshal"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audit.py::AuditTest::test_marshal
"""Auto-ported test: AuditTest::test_marshal (CPython 3.12 oracle)."""
...
do_test('test_marshal')
print("AuditTest::test_marshal: ok")
