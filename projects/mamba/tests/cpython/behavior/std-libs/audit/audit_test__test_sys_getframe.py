...
# lib = "audit"
# dimension = "behavior"
# case = "audit_test__test_sys_getframe"
# subject = "cpython.test_audit.AuditTest.test_sys_getframe"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audit.py::AuditTest::test_sys_getframe
"""Auto-ported test: AuditTest::test_sys_getframe (CPython 3.12 oracle)."""
...
returncode, events, stderr = run_python('test_sys_getframe')
if returncode:
...
print("AuditTest::test_sys_getframe: ok")
