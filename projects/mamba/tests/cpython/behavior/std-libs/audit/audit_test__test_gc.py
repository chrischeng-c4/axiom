...
# lib = "audit"
# dimension = "behavior"
# case = "audit_test__test_gc"
# subject = "cpython.test_audit.AuditTest.test_gc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_audit.py::AuditTest::test_gc
"""Auto-ported test: AuditTest::test_gc (CPython 3.12 oracle)."""
...
returncode, events, stderr = run_python('test_gc')
if returncode:
...
assert [event[0] for event in events] == ['gc.get_objects', 'gc.get_referrers', 'gc.get_referents']
print("AuditTest::test_gc: ok")
