...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_communicate_timeout_large_output"
# subject = "cpython.test_subprocess.ProcessTestCase.test_communicate_timeout_large_output"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_communicate_timeout_large_output
"""Auto-ported test: ProcessTestCase::test_communicate_timeout_large_output (CPython 3.12 oracle)."""
...
try:
    p.communicate(timeout=0.4)
    raise AssertionError('expected subprocess.TimeoutExpired')
except subprocess.TimeoutExpired:
    pass
stdout, _ = p.communicate()

assert len(stdout) == 4 * 64 * 1024
print("ProcessTestCase::test_communicate_timeout_large_output: ok")
