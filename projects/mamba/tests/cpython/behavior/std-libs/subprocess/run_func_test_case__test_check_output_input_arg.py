...
# lib = "subprocess"
# dimension = "behavior"
# case = "run_func_test_case__test_check_output_input_arg"
# subject = "cpython.test_subprocess.RunFuncTestCase.test_check_output_input_arg"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::RunFuncTestCase::test_check_output_input_arg
"""Auto-ported test: RunFuncTestCase::test_check_output_input_arg (CPython 3.12 oracle)."""
...
cp = run_python('import sys; sys.stdout.write(sys.stdin.read().upper())', input=b'pear', stdout=subprocess.PIPE)

assert b'PEAR' in cp.stdout
print("RunFuncTestCase::test_check_output_input_arg: ok")
