...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_check_output"
# subject = "cpython.test_subprocess.ProcessTestCase.test_check_output"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_check_output
"""Auto-ported test: ProcessTestCase::test_check_output (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('stdout argument not allowed, it will be overridden', str(_aR_e))
try:
    subprocess.check_output([], check=False)
    raise AssertionError('expected ValueError')
except ValueError as _aR_e:
    import re as _re_aR
    assert _re_aR.search('check argument not allowed, it will be overridden', str(_aR_e))
print("ProcessTestCase::test_check_output: ok")
