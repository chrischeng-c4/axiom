...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_stderr_pipe"
# subject = "cpython.test_subprocess.ProcessTestCase.test_stderr_pipe"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_stderr_pipe
"""Auto-ported test: ProcessTestCase::test_stderr_pipe (CPython 3.12 oracle)."""
...
with p:
    ...
    assert p.stderr.read() == b'strawberry'
print("ProcessTestCase::test_stderr_pipe: ok")
