...
# lib = "subprocess"
# dimension = "behavior"
# case = "run_func_test_case__test_check_output_stdin_with_input_arg"
# subject = "cpython.test_subprocess.RunFuncTestCase.test_check_output_stdin_with_input_arg"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::RunFuncTestCase::test_check_output_stdin_with_input_arg
"""Auto-ported test: RunFuncTestCase::test_check_output_stdin_with_input_arg (CPython 3.12 oracle)."""
...
tf.seek(0)
try:
    output = run_python("print('will not be run')", stdin=tf, input=b'hare')
...
print("RunFuncTestCase::test_check_output_stdin_with_input_arg: ok")
