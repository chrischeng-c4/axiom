...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_repr"
# subject = "cpython.test_subprocess.ProcessTestCase.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_repr
"""Auto-ported test: ProcessTestCase::test_repr (CPython 3.12 oracle)."""
...
with unittest.mock.patch.object(subprocess.Popen, '_execute_child'):
    for cmd, shell, code, sx in cases:
        ...
        assert repr(p) == sx
print("ProcessTestCase::test_repr: ok")
