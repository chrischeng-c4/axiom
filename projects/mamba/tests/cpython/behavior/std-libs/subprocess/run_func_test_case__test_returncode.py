...
# lib = "subprocess"
# dimension = "behavior"
# case = "run_func_test_case__test_returncode"
# subject = "cpython.test_subprocess.RunFuncTestCase.test_returncode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::RunFuncTestCase::test_returncode
"""Auto-ported test: RunFuncTestCase::test_returncode (CPython 3.12 oracle)."""
...
cp = run_python('import sys; sys.exit(47)')

assert cp.returncode == 47
try:
    cp.check_returncode()
    raise AssertionError('expected subprocess.CalledProcessError')
except subprocess.CalledProcessError:
    pass
print("RunFuncTestCase::test_returncode: ok")
