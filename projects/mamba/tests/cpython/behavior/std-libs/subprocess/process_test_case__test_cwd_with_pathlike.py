...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_cwd_with_pathlike"
# subject = "cpython.test_subprocess.ProcessTestCase.test_cwd_with_pathlike"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_cwd_with_pathlike
"""Auto-ported test: ProcessTestCase::test_cwd_with_pathlike (CPython 3.12 oracle)."""
...
temp_dir = _normalize_cwd(temp_dir)
_assert_cwd(temp_dir, sys.executable, cwd=FakePath(temp_dir))
print("ProcessTestCase::test_cwd_with_pathlike: ok")
