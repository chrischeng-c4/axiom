...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_leaking_fds_on_error"
# subject = "cpython.test_subprocess.ProcessTestCase.test_leaking_fds_on_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_leaking_fds_on_error
"""Auto-ported test: ProcessTestCase::test_leaking_fds_on_error (CPython 3.12 oracle)."""
...
for i in range(1024):
    try:
        ...
        pass
print("ProcessTestCase::test_leaking_fds_on_error: ok")
