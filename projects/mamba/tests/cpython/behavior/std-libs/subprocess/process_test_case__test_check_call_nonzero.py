...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_check_call_nonzero"
# subject = "cpython.test_subprocess.ProcessTestCase.test_check_call_nonzero"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_check_call_nonzero
"""Auto-ported test: ProcessTestCase::test_check_call_nonzero (CPython 3.12 oracle)."""
...
except subprocess.CalledProcessError as _aR_e:
    import types as _types_aR
    c = _types_aR.SimpleNamespace(exception=_aR_e)

assert c.exception.returncode == 47
print("ProcessTestCase::test_check_call_nonzero: ok")
