...
# lib = "subprocess"
# dimension = "behavior"
# case = "run_func_test_case__test_stderr_with_capture_output_arg"
# subject = "cpython.test_subprocess.RunFuncTestCase.test_stderr_with_capture_output_arg"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::RunFuncTestCase::test_stderr_with_capture_output_arg
"""Auto-ported test: RunFuncTestCase::test_stderr_with_capture_output_arg (CPython 3.12 oracle)."""
...
pass
try:
    output = run_python("print('will not be run')", capture_output=True, stderr=tf)
    raise AssertionError('expected ValueError')
except ValueError as _aR_e:
    import types as _types_aR
    c = _types_aR.SimpleNamespace(exception=_aR_e)

assert 'stderr' in c.exception.args[0]

assert 'capture_output' in c.exception.args[0]
print("RunFuncTestCase::test_stderr_with_capture_output_arg: ok")
