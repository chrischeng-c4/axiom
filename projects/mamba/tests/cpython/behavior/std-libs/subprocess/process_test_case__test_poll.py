...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_poll"
# subject = "cpython.test_subprocess.ProcessTestCase.test_poll"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_poll
"""Auto-ported test: ProcessTestCase::test_poll (CPython 3.12 oracle)."""
...
assert p.poll() == 0
print("ProcessTestCase::test_poll: ok")
