...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_check_output_timeout"
# subject = "cpython.test_subprocess.ProcessTestCase.test_check_output_timeout"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_check_output_timeout
"""Auto-ported test: ProcessTestCase::test_check_output_timeout (CPython 3.12 oracle)."""
...
try:
    output = subprocess.check_output([sys.executable, '-c', 'import time; time.sleep(3600)'], timeout=0.1)
    raise AssertionError('expected subprocess.TimeoutExpired')
except subprocess.TimeoutExpired as _aR_e:
    import types as _types_aR
    c = _types_aR.SimpleNamespace(exception=_aR_e)
print("ProcessTestCase::test_check_output_timeout: ok")
