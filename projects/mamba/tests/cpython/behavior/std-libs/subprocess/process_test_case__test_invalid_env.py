...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_invalid_env"
# subject = "cpython.test_subprocess.ProcessTestCase.test_invalid_env"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_invalid_env
"""Auto-ported test: ProcessTestCase::test_invalid_env (CPython 3.12 oracle)."""
...
with subprocess.Popen([sys.executable, '-c', 'import sys, os;sys.stdout.write(os.getenv("FRUIT"))'], stdout=subprocess.PIPE, env=newenv) as p:
    ...
    assert stdout == b'orange=lemon'
print("ProcessTestCase::test_invalid_env: ok")
