...
# lib = "subprocess"
# dimension = "behavior"
# case = "process_test_case__test_stdout_filedes_of_stdout"
# subject = "cpython.test_subprocess.ProcessTestCase.test_stdout_filedes_of_stdout"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_subprocess.py::ProcessTestCase::test_stdout_filedes_of_stdout
"""Auto-ported test: ProcessTestCase::test_stdout_filedes_of_stdout (CPython 3.12 oracle)."""
...
assert out.rstrip() == b'test with stdout=1'
print("ProcessTestCase::test_stdout_filedes_of_stdout: ok")
