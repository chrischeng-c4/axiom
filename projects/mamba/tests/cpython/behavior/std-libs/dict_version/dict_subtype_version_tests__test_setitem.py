...
# lib = "dict_version"
# dimension = "behavior"
# case = "dict_subtype_version_tests__test_setitem"
# subject = "cpython.test_dict_version.DictSubtypeVersionTests.test_setitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_dict_version.py::DictSubtypeVersionTests::test_setitem
"""Auto-ported test: DictSubtypeVersionTests::test_setitem (CPython 3.12 oracle)."""
...
self_dict = None
d = new_dict()
check_version_changed(d, d.__setitem__, 'x', 'x')
check_version_changed(d, d.__setitem__, 'y', 'y')
check_version_changed(d, d.__setitem__, 'x', 1)
check_version_changed(d, d.__setitem__, 'y', 2)
print("DictSubtypeVersionTests::test_setitem: ok")
