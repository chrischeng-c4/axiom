...
# lib = "zlib"
# dimension = "behavior"
# case = "compress_object_test_case__test_pair"
# subject = "cpython.test_zlib.CompressObjectTestCase.test_pair"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_zlib.py::CompressObjectTestCase::test_pair
"""Auto-ported test: CompressObjectTestCase::test_pair (CPython 3.12 oracle)."""
...
for v1, v2 in ((x1, x2), (bytearray(x1), bytearray(x2))):
    ...
    assert isinstance(dco.unconsumed_tail, bytes)

    assert isinstance(dco.unused_data, bytes)
print("CompressObjectTestCase::test_pair: ok")
