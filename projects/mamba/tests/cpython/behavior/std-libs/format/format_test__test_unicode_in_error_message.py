...
# lib = "format"
# dimension = "behavior"
# case = "format_test__test_unicode_in_error_message"
# subject = "cpython.test_format.FormatTest.test_unicode_in_error_message"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_format.py::FormatTest::test_unicode_in_error_message
"""Auto-ported test: FormatTest::test_unicode_in_error_message (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search(str_err, str(_aR_e))
print("FormatTest::test_unicode_in_error_message: ok")
