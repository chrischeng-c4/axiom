...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_replace__test_is_dataclass"
# subject = "cpython.__init__.TestReplace.test_is_dataclass"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestReplace::test_is_dataclass
"""Auto-ported test: TestReplace::test_is_dataclass (CPython 3.12 oracle)."""
...
print("TestReplace::test_is_dataclass: ok")
