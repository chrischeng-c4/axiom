...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_ordering__test_generic_extending"
# subject = "cpython.__init__.TestOrdering.test_generic_extending"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestOrdering::test_generic_extending
"""Auto-ported test: TestOrdering::test_generic_extending (CPython 3.12 oracle)."""
...
print("TestOrdering::test_generic_extending: ok")
