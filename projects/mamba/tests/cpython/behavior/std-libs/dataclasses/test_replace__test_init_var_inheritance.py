...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_replace__test_init_var_inheritance"
# subject = "cpython.__init__.TestReplace.test_init_var_inheritance"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestReplace::test_init_var_inheritance
"""Auto-ported test: TestReplace::test_init_var_inheritance (CPython 3.12 oracle)."""
...
print("TestReplace::test_init_var_inheritance: ok")
