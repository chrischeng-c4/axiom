...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_frozen__test_field_named_like_builtin_frozen"
# subject = "cpython.__init__.TestFrozen.test_field_named_like_builtin_frozen"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestFrozen::test_field_named_like_builtin_frozen
"""Auto-ported test: TestFrozen::test_field_named_like_builtin_frozen (CPython 3.12 oracle)."""
...
print("TestFrozen::test_field_named_like_builtin_frozen: ok")
