...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_slots__test_field_named_like_builtin_frozen"
# subject = "cpython.__init__.TestSlots.test_field_named_like_builtin_frozen"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestSlots::test_field_named_like_builtin_frozen
"""Auto-ported test: TestSlots::test_field_named_like_builtin_frozen (CPython 3.12 oracle)."""
...
print("TestSlots::test_field_named_like_builtin_frozen: ok")
