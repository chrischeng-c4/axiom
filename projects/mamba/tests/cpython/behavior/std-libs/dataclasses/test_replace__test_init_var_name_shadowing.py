...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_replace__test_init_var_name_shadowing"
# subject = "cpython.__init__.TestReplace.test_init_var_name_shadowing"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestReplace::test_init_var_name_shadowing
"""Auto-ported test: TestReplace::test_init_var_name_shadowing (CPython 3.12 oracle)."""
...
print("TestReplace::test_init_var_name_shadowing: ok")
