...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_replace__test"
# subject = "cpython.__init__.TestReplace.test"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestReplace::test
"""Auto-ported test: TestReplace::test (CPython 3.12 oracle)."""
