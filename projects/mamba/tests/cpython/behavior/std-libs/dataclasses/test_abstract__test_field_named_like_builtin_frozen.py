...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_abstract__test_field_named_like_builtin_frozen"
# subject = "cpython.__init__.TestAbstract.test_field_named_like_builtin_frozen"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestAbstract::test_field_named_like_builtin_frozen
"""Auto-ported test: TestAbstract::test_field_named_like_builtin_frozen (CPython 3.12 oracle)."""
...
print("TestAbstract::test_field_named_like_builtin_frozen: ok")
