...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_replace__test_generic_extending"
# subject = "cpython.__init__.TestReplace.test_generic_extending"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestReplace::test_generic_extending
"""Auto-ported test: TestReplace::test_generic_extending (CPython 3.12 oracle)."""
...
print("TestReplace::test_generic_extending: ok")
