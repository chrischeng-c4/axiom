...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_eq__test_two_fields_one_default"
# subject = "cpython.__init__.TestEq.test_two_fields_one_default"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestEq::test_two_fields_one_default
"""Auto-ported test: TestEq::test_two_fields_one_default (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search("non-default argument 'y' follows default argument", str(_aR_e))
print("TestEq::test_two_fields_one_default: ok")
