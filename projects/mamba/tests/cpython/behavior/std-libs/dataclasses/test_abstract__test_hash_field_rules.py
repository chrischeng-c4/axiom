...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_abstract__test_hash_field_rules"
# subject = "cpython.__init__.TestAbstract.test_hash_field_rules"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestAbstract::test_hash_field_rules
"""Auto-ported test: TestAbstract::test_hash_field_rules (CPython 3.12 oracle)."""
...
print("TestAbstract::test_hash_field_rules: ok")
