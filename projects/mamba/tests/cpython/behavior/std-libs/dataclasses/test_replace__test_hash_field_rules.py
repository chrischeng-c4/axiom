...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_replace__test_hash_field_rules"
# subject = "cpython.__init__.TestReplace.test_hash_field_rules"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestReplace::test_hash_field_rules
"""Auto-ported test: TestReplace::test_hash_field_rules (CPython 3.12 oracle)."""
...
print("TestReplace::test_hash_field_rules: ok")
