...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_replace__test_init_var"
# subject = "cpython.__init__.TestReplace.test_init_var"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestReplace::test_init_var
"""Auto-ported test: TestReplace::test_init_var (CPython 3.12 oracle)."""
...
assert c.x == 20
print("TestReplace::test_init_var: ok")
