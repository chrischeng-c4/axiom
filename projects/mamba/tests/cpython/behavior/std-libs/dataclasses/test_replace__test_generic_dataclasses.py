...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_replace__test_generic_dataclasses"
# subject = "cpython.__init__.TestReplace.test_generic_dataclasses"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestReplace::test_generic_dataclasses
"""Auto-ported test: TestReplace::test_generic_dataclasses (CPython 3.12 oracle)."""
...
print("TestReplace::test_generic_dataclasses: ok")
