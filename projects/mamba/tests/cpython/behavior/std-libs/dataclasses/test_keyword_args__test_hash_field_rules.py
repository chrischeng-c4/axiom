...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_keyword_args__test_hash_field_rules"
# subject = "cpython.__init__.TestKeywordArgs.test_hash_field_rules"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestKeywordArgs::test_hash_field_rules
"""Auto-ported test: TestKeywordArgs::test_hash_field_rules (CPython 3.12 oracle)."""
...
print("TestKeywordArgs::test_hash_field_rules: ok")
