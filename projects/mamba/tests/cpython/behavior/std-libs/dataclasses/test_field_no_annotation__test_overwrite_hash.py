...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_field_no_annotation__test_overwrite_hash"
# subject = "cpython.__init__.TestFieldNoAnnotation.test_overwrite_hash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestFieldNoAnnotation::test_overwrite_hash
"""Auto-ported test: TestFieldNoAnnotation::test_overwrite_hash (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('Cannot overwrite attribute __hash__', str(_aR_e))
print("TestFieldNoAnnotation::test_overwrite_hash: ok")
