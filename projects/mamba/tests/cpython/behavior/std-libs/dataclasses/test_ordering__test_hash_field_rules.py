...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_ordering__test_hash_field_rules"
# subject = "cpython.__init__.TestOrdering.test_hash_field_rules"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestOrdering::test_hash_field_rules
"""Auto-ported test: TestOrdering::test_hash_field_rules (CPython 3.12 oracle)."""
...
print("TestOrdering::test_hash_field_rules: ok")
