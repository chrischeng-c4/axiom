...
# lib = "dataclasses"
# dimension = "behavior"
# case = "test_string_annotations__test_field_metadata_mapping"
# subject = "cpython.__init__.TestStringAnnotations.test_field_metadata_mapping"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::TestStringAnnotations::test_field_metadata_mapping
"""Auto-ported test: TestStringAnnotations::test_field_metadata_mapping (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search('does not support item assignment', str(_aR_e))
print("TestStringAnnotations::test_field_metadata_mapping: ok")
