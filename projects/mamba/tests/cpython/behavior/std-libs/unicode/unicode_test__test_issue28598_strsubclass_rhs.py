...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_issue28598_strsubclass_rhs"
# subject = "cpython.test_unicode.UnicodeTest.test_issue28598_strsubclass_rhs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_issue28598_strsubclass_rhs
"""Auto-ported test: UnicodeTest::test_issue28598_strsubclass_rhs (CPython 3.12 oracle)."""
...
assert 'lhs %% %r' % SubclassedStr('rhs') == "Success, self.__rmod__('lhs %% %r') was called"
print("UnicodeTest::test_issue28598_strsubclass_rhs: ok")
