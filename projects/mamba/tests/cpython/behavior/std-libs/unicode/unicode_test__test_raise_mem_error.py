...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_raise_mem_error"
# subject = "cpython.test_unicode.UnicodeTest.test_raiseMemError"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_raiseMemError
"""Auto-ported test: UnicodeTest::test_raiseMemError (CPython 3.12 oracle)."""
...
for char in ('a', 'é', '€', '\U0010ffff'):
    ...
    assert sys.getsizeof(char * 42) == struct_size + char_size * (42 + 1)
    ...
    try:
        ...
        pass
print("UnicodeTest::test_raiseMemError: ok")
