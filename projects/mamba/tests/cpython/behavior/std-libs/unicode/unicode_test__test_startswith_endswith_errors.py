...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_startswith_endswith_errors"
# subject = "cpython.test_unicode.UnicodeTest.test_startswith_endswith_errors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_startswith_endswith_errors
"""Auto-ported test: UnicodeTest::test_startswith_endswith_errors (CPython 3.12 oracle)."""
...
for meth in ('foo'.startswith, 'foo'.endswith):
    ...
    assert 'tuple' in exc
print("UnicodeTest::test_startswith_endswith_errors: ok")
