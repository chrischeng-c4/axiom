...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_surrogates"
# subject = "cpython.test_unicode.UnicodeTest.test_surrogates"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_surrogates
"""Auto-ported test: UnicodeTest::test_surrogates (CPython 3.12 oracle)."""
...
for meth_name in ('isalpha', 'isalnum', 'isdigit', 'isspace', 'isdecimal', 'isnumeric', 'isidentifier', 'isprintable'):
    ...
    for s in ('\ud800', '\udfff', '\ud800\ud800', '\udfff\udfff', 'a\ud800b\udfff', 'a\udfffb\ud800', 'a\ud800b\udfffa', 'a\udfffb\ud800a'):
        ...
        assert not meth(s)
print("UnicodeTest::test_surrogates: ok")
