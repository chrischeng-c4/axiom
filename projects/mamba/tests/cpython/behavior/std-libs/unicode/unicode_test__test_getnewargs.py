...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_getnewargs"
# subject = "cpython.test_unicode.UnicodeTest.test_getnewargs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_getnewargs
"""Auto-ported test: UnicodeTest::test_getnewargs (CPython 3.12 oracle)."""
...
assert args[0] is not text

assert args[0] == text

assert len(args) == 1
print("UnicodeTest::test_getnewargs: ok")
