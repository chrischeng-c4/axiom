...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_replace_id"
# subject = "cpython.test_unicode.UnicodeTest.test_replace_id"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_replace_id
"""Auto-ported test: UnicodeTest::test_replace_id (CPython 3.12 oracle)."""
...
assert text.replace(pattern, pattern) is text
print("UnicodeTest::test_replace_id: ok")
