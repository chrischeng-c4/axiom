...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_printable_repr"
# subject = "cpython.test_unicode.UnicodeTest.test_printable_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_printable_repr
"""Auto-ported test: UnicodeTest::test_printable_repr (CPython 3.12 oracle)."""
...
assert repr('𐀀') == "'%c'" % (65536,)

assert repr('\U00014000') == "'\\U00014000'"
print("UnicodeTest::test_printable_repr: ok")
