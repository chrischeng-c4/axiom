...
# lib = "unicode"
# dimension = "behavior"
# case = "unicode_test__test_invalid_start_byte"
# subject = "cpython.test_unicode.UnicodeTest.test_invalid_start_byte"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_unicode.py::UnicodeTest::test_invalid_start_byte
"""Auto-ported test: UnicodeTest::test_invalid_start_byte (CPython 3.12 oracle)."""
...
for byte in b'\x80\xa0\x9f\xbf\xc0\xc1\xf5\xff':
    assertCorrectUTF8Decoding(bytes([byte]), '�', 'invalid start byte')
print("UnicodeTest::test_invalid_start_byte: ok")
