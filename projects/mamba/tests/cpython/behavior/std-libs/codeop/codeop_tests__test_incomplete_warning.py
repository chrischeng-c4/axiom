...
# lib = "codeop"
# dimension = "behavior"
# case = "codeop_tests__test_incomplete_warning"
# subject = "cpython.test_codeop.CodeopTests.test_incomplete_warning"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_codeop.py::CodeopTests::test_incomplete_warning
"""Auto-ported test: CodeopTests::test_incomplete_warning (CPython 3.12 oracle)."""
...
assert w == []
print("CodeopTests::test_incomplete_warning: ok")
