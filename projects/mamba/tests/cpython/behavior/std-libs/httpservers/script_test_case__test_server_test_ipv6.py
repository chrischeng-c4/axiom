...
# lib = "httpservers"
# dimension = "behavior"
# case = "script_test_case__test_server_test_ipv6"
# subject = "cpython.test_httpservers.ScriptTestCase.test_server_test_ipv6"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httpservers.py::ScriptTestCase::test_server_test_ipv6
"""Auto-ported test: ScriptTestCase::test_server_test_ipv6 (CPython 3.12 oracle)."""
...
for bind in ipv6_addrs:
    mock_server = mock_server_class()
    server.test(ServerClass=mock_server, bind=bind)

    assert mock_server.address_family == socket.AF_INET6
print("ScriptTestCase::test_server_test_ipv6: ok")
