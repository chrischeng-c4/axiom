...
# lib = "httpservers"
# dimension = "behavior"
# case = "base_http_request_handler_test_case__test_html_escape_on_error"
# subject = "cpython.test_httpservers.BaseHTTPRequestHandlerTestCase.test_html_escape_on_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httpservers.py::BaseHTTPRequestHandlerTestCase::test_html_escape_on_error
"""Auto-ported test: BaseHTTPRequestHandlerTestCase::test_html_escape_on_error (CPython 3.12 oracle)."""
...
result = send_typical_request(b'<script>alert("hello")</script> / HTTP/1.1')
result = b''.join(result)
text = '<script>alert("hello")</script>'

assert html.escape(text, quote=False).encode('ascii') in result
print("BaseHTTPRequestHandlerTestCase::test_html_escape_on_error: ok")
