...
# lib = "httpservers"
# dimension = "behavior"
# case = "base_http_request_handler_test_case__test_date_time_string"
# subject = "cpython.test_httpservers.BaseHTTPRequestHandlerTestCase.test_date_time_string"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httpservers.py::BaseHTTPRequestHandlerTestCase::test_date_time_string
"""Auto-ported test: BaseHTTPRequestHandlerTestCase::test_date_time_string (CPython 3.12 oracle)."""
...
expected = '%s, %02d %3s %4d %02d:%02d:%02d GMT' % (self_handler.weekdayname[wd], day, self_handler.monthname[month], year, hh, mm, ss)

assert self_handler.date_time_string(timestamp=now) == expected
print("BaseHTTPRequestHandlerTestCase::test_date_time_string: ok")
