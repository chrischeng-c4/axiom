...
# lib = "httpservers"
# dimension = "behavior"
# case = "base_http_request_handler_test_case__test_with_continue_rejected"
# subject = "cpython.test_httpservers.BaseHTTPRequestHandlerTestCase.test_with_continue_rejected"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httpservers.py::BaseHTTPRequestHandlerTestCase::test_with_continue_rejected
"""Auto-ported test: BaseHTTPRequestHandlerTestCase::test_with_continue_rejected (CPython 3.12 oracle)."""
...
usual_handler = self_handler
self_handler = RejectingSocketlessRequestHandler()
result = send_typical_request(b'GET / HTTP/1.1\r\nExpect: 100-continue\r\n\r\n')

assert result[0] == b'HTTP/1.1 417 Expectation Failed\r\n'
verify_expected_headers(result[1:-1])

assert not self_handler.get_called

assert sum((r == b'Connection: close\r\n' for r in result[1:-1])) == 1
self_handler = usual_handler
print("BaseHTTPRequestHandlerTestCase::test_with_continue_rejected: ok")
