...
# lib = "httpservers"
# dimension = "behavior"
# case = "base_http_request_handler_test_case__test_header_buffering_of_send_header"
# subject = "cpython.test_httpservers.BaseHTTPRequestHandlerTestCase.test_header_buffering_of_send_header"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_httpservers.py::BaseHTTPRequestHandlerTestCase::test_header_buffering_of_send_header
"""Auto-ported test: BaseHTTPRequestHandlerTestCase::test_header_buffering_of_send_header (CPython 3.12 oracle)."""
...
assert output.getData() == b'Foo: foo\r\nbar: bar\r\n\r\n'

assert output.numWrites == 1
print("BaseHTTPRequestHandlerTestCase::test_header_buffering_of_send_header: ok")
