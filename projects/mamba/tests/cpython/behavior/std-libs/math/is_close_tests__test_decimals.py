...
# lib = "math"
# dimension = "behavior"
# case = "is_close_tests__test_decimals"
# subject = "cpython.test_math.IsCloseTests.test_decimals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_math.py::IsCloseTests::test_decimals
"""Auto-ported test: IsCloseTests::test_decimals (CPython 3.12 oracle)."""
...
assertAllClose(decimal_examples, rel_tol=1e-08)
assertAllNotClose(decimal_examples, rel_tol=1e-09)
print("IsCloseTests::test_decimals: ok")
