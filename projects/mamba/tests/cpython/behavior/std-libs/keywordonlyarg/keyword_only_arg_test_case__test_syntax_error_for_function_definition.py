...
# lib = "keywordonlyarg"
# dimension = "behavior"
# case = "keyword_only_arg_test_case__test_syntax_error_for_function_definition"
# subject = "cpython.test_keywordonlyarg.KeywordOnlyArgTestCase.testSyntaxErrorForFunctionDefinition"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_keywordonlyarg.py::KeywordOnlyArgTestCase::testSyntaxErrorForFunctionDefinition
"""Auto-ported test: KeywordOnlyArgTestCase::testSyntaxErrorForFunctionDefinition (CPython 3.12 oracle)."""
...
def assertRaisesSyntaxError(codestr):
    ...
    try:
        ...
        pass
assertRaisesSyntaxError('def f(p, *):\n  pass\n')
assertRaisesSyntaxError('def f(p1, *, p1=100):\n  pass\n')
assertRaisesSyntaxError('def f(p1, *k1, k1=100):\n  pass\n')
assertRaisesSyntaxError('def f(p1, *, k1, k1=100):\n  pass\n')
assertRaisesSyntaxError('def f(p1, *, **k1):\n  pass\n')
assertRaisesSyntaxError('def f(p1, *, k1, **k1):\n  pass\n')
assertRaisesSyntaxError('def f(p1, *, None, **k1):\n  pass\n')
assertRaisesSyntaxError('def f(p, *, (k1, k2), **kw):\n  pass\n')
print("KeywordOnlyArgTestCase::testSyntaxErrorForFunctionDefinition: ok")
