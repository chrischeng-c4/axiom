...
# lib = "keywordonlyarg"
# dimension = "behavior"
# case = "keyword_only_arg_test_case__test_syntax_for_many_arguments"
# subject = "cpython.test_keywordonlyarg.KeywordOnlyArgTestCase.testSyntaxForManyArguments"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_keywordonlyarg.py::KeywordOnlyArgTestCase::testSyntaxForManyArguments
"""Auto-ported test: KeywordOnlyArgTestCase::testSyntaxForManyArguments (CPython 3.12 oracle)."""
...
fundef = 'def f(*, %s):\n  pass\n' % ', '.join(('i%d' % i for i in range(300)))
compile(fundef, '<test>', 'single')
print("KeywordOnlyArgTestCase::testSyntaxForManyArguments: ok")
