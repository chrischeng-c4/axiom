...
# lib = "array"
# dimension = "behavior"
# case = "double_test__test_delslice"
# subject = "cpython.test_array.DoubleTest.test_delslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::DoubleTest::test_delslice
"""Auto-ported test: DoubleTest::test_delslice (CPython 3.12 oracle)."""
...
a = array.array(typecode, range(10))
del a[9::1 << 333]
print("DoubleTest::test_delslice: ok")
