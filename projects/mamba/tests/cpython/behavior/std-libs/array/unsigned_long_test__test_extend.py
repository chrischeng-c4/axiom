...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_test__test_extend"
# subject = "cpython.test_array.UnsignedLongTest.test_extend"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongTest::test_extend
"""Auto-ported test: UnsignedLongTest::test_extend (CPython 3.12 oracle)."""
...
assert a == array.array(typecode, example + example[::-1])
print("UnsignedLongTest::test_extend: ok")
