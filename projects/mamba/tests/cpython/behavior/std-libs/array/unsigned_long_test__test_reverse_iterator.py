...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_test__test_reverse_iterator"
# subject = "cpython.test_array.UnsignedLongTest.test_reverse_iterator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongTest::test_reverse_iterator
"""Auto-ported test: UnsignedLongTest::test_reverse_iterator (CPython 3.12 oracle)."""
...
assert list(reversed(a)) == list(iter(a))[::-1]
print("UnsignedLongTest::test_reverse_iterator: ok")
