...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_int_test__test_iterator_pickle"
# subject = "cpython.test_array.UnsignedIntTest.test_iterator_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedIntTest::test_iterator_pickle
"""Auto-ported test: UnsignedIntTest::test_iterator_pickle (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert list(it) == []
print("UnsignedIntTest::test_iterator_pickle: ok")
