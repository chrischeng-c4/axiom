...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_int_test__test_delslice"
# subject = "cpython.test_array.UnsignedIntTest.test_delslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedIntTest::test_delslice
"""Auto-ported test: UnsignedIntTest::test_delslice (CPython 3.12 oracle)."""
...
a = array.array(typecode, range(10))
del a[9::1 << 333]
print("UnsignedIntTest::test_delslice: ok")
