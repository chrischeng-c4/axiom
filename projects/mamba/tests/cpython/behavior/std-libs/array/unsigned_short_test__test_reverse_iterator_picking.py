...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_short_test__test_reverse_iterator_picking"
# subject = "cpython.test_array.UnsignedShortTest.test_reverse_iterator_picking"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedShortTest::test_reverse_iterator_picking
"""Auto-ported test: UnsignedShortTest::test_reverse_iterator_picking (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert list(a) == data2
print("UnsignedShortTest::test_reverse_iterator_picking: ok")
