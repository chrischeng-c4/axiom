...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_byte_test__test_len"
# subject = "cpython.test_array.UnsignedByteTest.test_len"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedByteTest::test_len
"""Auto-ported test: UnsignedByteTest::test_len (CPython 3.12 oracle)."""
...
assert len(a) == len(example)
print("UnsignedByteTest::test_len: ok")
