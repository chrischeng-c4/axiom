...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_long_test__test_iterationcontains"
# subject = "cpython.test_array.UnsignedLongLongTest.test_iterationcontains"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongLongTest::test_iterationcontains
"""Auto-ported test: UnsignedLongLongTest::test_iterationcontains (CPython 3.12 oracle)."""
...
b = array.array(typecode, [20])

assert (a[-1] in a) == True

assert (b[0] not in a) == True
print("UnsignedLongLongTest::test_iterationcontains: ok")
