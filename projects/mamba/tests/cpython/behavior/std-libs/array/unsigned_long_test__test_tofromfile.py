...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_test__test_tofromfile"
# subject = "cpython.test_array.UnsignedLongTest.test_tofromfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongTest::test_tofromfile
"""Auto-ported test: UnsignedLongTest::test_tofromfile (CPython 3.12 oracle)."""
...
try:
    ...
    if not f.closed:
        f.close()
    os_helper.unlink(os_helper.TESTFN)
print("UnsignedLongTest::test_tofromfile: ok")
