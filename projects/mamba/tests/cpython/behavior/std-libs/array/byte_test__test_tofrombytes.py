...
# lib = "array"
# dimension = "behavior"
# case = "byte_test__test_tofrombytes"
# subject = "cpython.test_array.ByteTest.test_tofrombytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::ByteTest::test_tofrombytes
"""Auto-ported test: ByteTest::test_tofrombytes (CPython 3.12 oracle)."""
...
if a.itemsize > 1:
    ...
    try:
        ...
        pass
print("ByteTest::test_tofrombytes: ok")
