...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_long_test__test_remove"
# subject = "cpython.test_array.UnsignedLongLongTest.test_remove"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongLongTest::test_remove
"""Auto-ported test: UnsignedLongLongTest::test_remove (CPython 3.12 oracle)."""
...
for x in example:
    ...
    assert a == array.array(typecode, example2)
a = array.array(typecode, example)
...
try:
    ...
    pass
print("UnsignedLongLongTest::test_remove: ok")
