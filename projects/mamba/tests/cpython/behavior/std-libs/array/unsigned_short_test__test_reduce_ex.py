...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_short_test__test_reduce_ex"
# subject = "cpython.test_array.UnsignedShortTest.test_reduce_ex"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedShortTest::test_reduce_ex
"""Auto-ported test: UnsignedShortTest::test_reduce_ex (CPython 3.12 oracle)."""
...
for protocol in range(3):
    ...
    assert a.__reduce_ex__(protocol)[0] is array.array
for protocol in range(3, pickle.HIGHEST_PROTOCOL + 1):

    assert a.__reduce_ex__(protocol)[0] is array_reconstructor
print("UnsignedShortTest::test_reduce_ex: ok")
