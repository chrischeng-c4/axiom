...
# lib = "array"
# dimension = "behavior"
# case = "short_test__test_tofrombytes"
# subject = "cpython.test_array.ShortTest.test_tofrombytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::ShortTest::test_tofrombytes
"""Auto-ported test: ShortTest::test_tofrombytes (CPython 3.12 oracle)."""
...
if a.itemsize > 1:
    ...
    try:
        ...
        pass
print("ShortTest::test_tofrombytes: ok")
