...
# lib = "array"
# dimension = "behavior"
# case = "double_test__test_tofrombytes"
# subject = "cpython.test_array.DoubleTest.test_tofrombytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::DoubleTest::test_tofrombytes
"""Auto-ported test: DoubleTest::test_tofrombytes (CPython 3.12 oracle)."""
...
if a.itemsize > 1:
    ...
    try:
        ...
        pass
print("DoubleTest::test_tofrombytes: ok")
