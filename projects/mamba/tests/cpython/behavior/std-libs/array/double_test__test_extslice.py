...
# lib = "array"
# dimension = "behavior"
# case = "double_test__test_extslice"
# subject = "cpython.test_array.DoubleTest.test_extslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::DoubleTest::test_extslice
"""Auto-ported test: DoubleTest::test_extslice (CPython 3.12 oracle)."""
...
assert a[-1000:-2000:-2] == array.array(typecode, [])
print("DoubleTest::test_extslice: ok")
