...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_byte_test__test_delslice"
# subject = "cpython.test_array.UnsignedByteTest.test_delslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedByteTest::test_delslice
"""Auto-ported test: UnsignedByteTest::test_delslice (CPython 3.12 oracle)."""
...
a = array.array(typecode, range(10))
del a[9::1 << 333]
print("UnsignedByteTest::test_delslice: ok")
