...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_long_test__test_add"
# subject = "cpython.test_array.UnsignedLongLongTest.test_add"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongLongTest::test_add
"""Auto-ported test: UnsignedLongLongTest::test_add (CPython 3.12 oracle)."""
...
def check_overflow(lower, upper):
    ...
    try:
        ...
        pass
a = array.array(typecode, example) + array.array(typecode, example[::-1])
...
try:
    ...
    pass
print("UnsignedLongLongTest::test_add: ok")
