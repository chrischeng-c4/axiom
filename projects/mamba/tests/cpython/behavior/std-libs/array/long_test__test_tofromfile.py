...
# lib = "array"
# dimension = "behavior"
# case = "long_test__test_tofromfile"
# subject = "cpython.test_array.LongTest.test_tofromfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::LongTest::test_tofromfile
"""Auto-ported test: LongTest::test_tofromfile (CPython 3.12 oracle)."""
...
try:
    ...
    if not f.closed:
        f.close()
    os_helper.unlink(os_helper.TESTFN)
print("LongTest::test_tofromfile: ok")
