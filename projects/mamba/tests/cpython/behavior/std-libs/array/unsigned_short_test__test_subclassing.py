...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_short_test__test_subclassing"
# subject = "cpython.test_array.UnsignedShortTest.test_subclassing"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedShortTest::test_subclassing
"""Auto-ported test: UnsignedShortTest::test_subclassing (CPython 3.12 oracle)."""
...
a = ExaggeratingArray(typecode, [3, 6, 7, 11], 4)
assertEntryEqual(a[0], 7)

try:
    setattr(a, 'color', 'blue')
    raise AssertionError('expected AttributeError')
except AttributeError:
    pass
print("UnsignedShortTest::test_subclassing: ok")
