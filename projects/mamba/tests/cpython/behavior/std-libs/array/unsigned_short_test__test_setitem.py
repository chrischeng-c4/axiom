...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_short_test__test_setitem"
# subject = "cpython.test_array.UnsignedShortTest.test_setitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedShortTest::test_setitem
"""Auto-ported test: UnsignedShortTest::test_setitem (CPython 3.12 oracle)."""
...
try:
    a.__setitem__(0, None)
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    a.__setitem__(len(example), example[0])
    raise AssertionError('expected IndexError')
except IndexError:
    pass

try:
    a.__setitem__(-len(example) - 1, example[0])
    raise AssertionError('expected IndexError')
except IndexError:
    pass
print("UnsignedShortTest::test_setitem: ok")
