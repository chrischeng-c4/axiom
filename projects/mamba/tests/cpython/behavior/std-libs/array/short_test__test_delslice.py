...
# lib = "array"
# dimension = "behavior"
# case = "short_test__test_delslice"
# subject = "cpython.test_array.ShortTest.test_delslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::ShortTest::test_delslice
"""Auto-ported test: ShortTest::test_delslice (CPython 3.12 oracle)."""
...
a = array.array(typecode, range(10))
del a[9::1 << 333]
print("ShortTest::test_delslice: ok")
