...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_byte_test__test_weakref"
# subject = "cpython.test_array.UnsignedByteTest.test_weakref"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedByteTest::test_weakref
"""Auto-ported test: UnsignedByteTest::test_weakref (CPython 3.12 oracle)."""
...
def check_overflow(lower, upper):
    ...
    try:
        ...
        pass
s = array.array(typecode, example)
p = weakref.proxy(s)

assert p.tobytes() == s.tobytes()
s = None
support.gc_collect()
...
try:
    ...
    pass
print("UnsignedByteTest::test_weakref: ok")
