...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_byte_test__test_extended_set_del_slice"
# subject = "cpython.test_array.UnsignedByteTest.test_extended_set_del_slice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedByteTest::test_extended_set_del_slice
"""Auto-ported test: UnsignedByteTest::test_extended_set_del_slice (CPython 3.12 oracle)."""
...
for start in indices:
    for stop in indices:
        for step in indices[1:]:
            ...
            assert a == array.array(typecode, L)
print("UnsignedByteTest::test_extended_set_del_slice: ok")
