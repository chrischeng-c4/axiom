...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_long_long_test__test_tofrombytes"
# subject = "cpython.test_array.UnsignedLongLongTest.test_tofrombytes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedLongLongTest::test_tofrombytes
"""Auto-ported test: UnsignedLongLongTest::test_tofrombytes (CPython 3.12 oracle)."""
...
c = array.array(typecode, bytearray(a.tobytes()))
...
if a.itemsize > 1:
    ...
    try:
        ...
        pass
print("UnsignedLongLongTest::test_tofrombytes: ok")
