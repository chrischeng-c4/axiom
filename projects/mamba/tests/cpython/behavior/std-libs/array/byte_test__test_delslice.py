...
# lib = "array"
# dimension = "behavior"
# case = "byte_test__test_delslice"
# subject = "cpython.test_array.ByteTest.test_delslice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::ByteTest::test_delslice
"""Auto-ported test: ByteTest::test_delslice (CPython 3.12 oracle)."""
...
a = array.array(typecode, range(10))
del a[9::1 << 333]
print("ByteTest::test_delslice: ok")
