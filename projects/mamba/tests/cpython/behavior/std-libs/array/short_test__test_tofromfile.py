...
# lib = "array"
# dimension = "behavior"
# case = "short_test__test_tofromfile"
# subject = "cpython.test_array.ShortTest.test_tofromfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::ShortTest::test_tofromfile
"""Auto-ported test: ShortTest::test_tofromfile (CPython 3.12 oracle)."""
...
try:
    ...
    if not f.closed:
        f.close()
    os_helper.unlink(os_helper.TESTFN)
print("ShortTest::test_tofromfile: ok")
