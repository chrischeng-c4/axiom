...
# lib = "array"
# dimension = "behavior"
# case = "double_test__test_tofromfile"
# subject = "cpython.test_array.DoubleTest.test_tofromfile"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::DoubleTest::test_tofromfile
"""Auto-ported test: DoubleTest::test_tofromfile (CPython 3.12 oracle)."""
...
try:
    ...
    if not f.closed:
        f.close()
    os_helper.unlink(os_helper.TESTFN)
print("DoubleTest::test_tofromfile: ok")
