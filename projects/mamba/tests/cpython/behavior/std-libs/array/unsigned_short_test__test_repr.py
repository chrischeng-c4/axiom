...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_short_test__test_repr"
# subject = "cpython.test_array.UnsignedShortTest.test_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedShortTest::test_repr
"""Auto-ported test: UnsignedShortTest::test_repr (CPython 3.12 oracle)."""
...
assert repr(a) == "array('%s')" % typecode
print("UnsignedShortTest::test_repr: ok")
