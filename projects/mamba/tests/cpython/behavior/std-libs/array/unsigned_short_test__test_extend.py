...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_short_test__test_extend"
# subject = "cpython.test_array.UnsignedShortTest.test_extend"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedShortTest::test_extend
"""Auto-ported test: UnsignedShortTest::test_extend (CPython 3.12 oracle)."""
...
try:
    ...
    pass
a.extend(array.array(typecode, example[::-1]))

assert a == array.array(typecode, example + example[::-1])
a = array.array(typecode, example)
a.extend(a)

assert a == array.array(typecode, example + example)
...
assert a == array.array(typecode, example + example[::-1])
print("UnsignedShortTest::test_extend: ok")
