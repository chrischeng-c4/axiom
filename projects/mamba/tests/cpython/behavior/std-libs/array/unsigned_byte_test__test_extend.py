...
# lib = "array"
# dimension = "behavior"
# case = "unsigned_byte_test__test_extend"
# subject = "cpython.test_array.UnsignedByteTest.test_extend"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_array.py::UnsignedByteTest::test_extend
"""Auto-ported test: UnsignedByteTest::test_extend (CPython 3.12 oracle)."""
...
assert a == array.array(typecode, example + example[::-1])
print("UnsignedByteTest::test_extend: ok")
