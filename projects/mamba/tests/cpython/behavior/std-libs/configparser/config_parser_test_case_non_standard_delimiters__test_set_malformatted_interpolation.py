...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_non_standard_delimiters__test_set_malformatted_interpolation"
# subject = "cpython.test_configparser.ConfigParserTestCaseNonStandardDelimiters.test_set_malformatted_interpolation"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNonStandardDelimiters::test_set_malformatted_interpolation
"""Auto-ported test: ConfigParserTestCaseNonStandardDelimiters::test_set_malformatted_interpolation (CPython 3.12 oracle)."""
...
def parse_error(cf, exc, src):
    ...
    try:
        ...
        cm = _types_aR.SimpleNamespace(exception=_aR_e)
    return cm.exception
cf = fromstring('[sect]\noption1{eq}foo\n'.format(eq=delimiters[0]))

assert cf.get('sect', 'option1') == 'foo'
...
assert cf.get('sect', 'option2') == 'foo%bar'
print("ConfigParserTestCaseNonStandardDelimiters::test_set_malformatted_interpolation: ok")
