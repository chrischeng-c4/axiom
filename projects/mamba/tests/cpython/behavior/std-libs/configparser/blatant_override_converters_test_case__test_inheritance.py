...
# lib = "configparser"
# dimension = "behavior"
# case = "blatant_override_converters_test_case__test_inheritance"
# subject = "cpython.test_configparser.BlatantOverrideConvertersTestCase.test_inheritance"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::BlatantOverrideConvertersTestCase::test_inheritance
"""Auto-ported test: BlatantOverrideConvertersTestCase::test_inheritance (CPython 3.12 oracle)."""
...
assert cfg.converters['len'] is None
...
assert not cfg.getboolean('two', 'one')
print("BlatantOverrideConvertersTestCase::test_inheritance: ok")
