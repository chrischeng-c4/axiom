...
# lib = "configparser"
# dimension = "behavior"
# case = "copy_test_case__test_set_string_types"
# subject = "cpython.test_configparser.CopyTestCase.test_set_string_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::CopyTestCase::test_set_string_types
"""Auto-ported test: CopyTestCase::test_set_string_types (CPython 3.12 oracle)."""
...
cf.set('sect', 'option1', 'splat')
cf.set('sect', 'option2', 'splat')
print("CopyTestCase::test_set_string_types: ok")
