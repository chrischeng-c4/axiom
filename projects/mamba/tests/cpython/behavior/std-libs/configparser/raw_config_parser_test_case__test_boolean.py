...
# lib = "configparser"
# dimension = "behavior"
# case = "raw_config_parser_test_case__test_boolean"
# subject = "cpython.test_configparser.RawConfigParserTestCase.test_boolean"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::RawConfigParserTestCase::test_boolean
"""Auto-ported test: RawConfigParserTestCase::test_boolean (CPython 3.12 oracle)."""
...
for x in range(1, 5):
    ...
    try:
        ...
        pass
print("RawConfigParserTestCase::test_boolean: ok")
