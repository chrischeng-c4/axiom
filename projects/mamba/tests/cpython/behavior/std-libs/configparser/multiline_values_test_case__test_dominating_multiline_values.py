...
# lib = "configparser"
# dimension = "behavior"
# case = "multiline_values_test_case__test_dominating_multiline_values"
# subject = "cpython.test_configparser.MultilineValuesTestCase.test_dominating_multiline_values"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_configparser.py::MultilineValuesTestCase::test_dominating_multiline_values
"""Auto-ported test: MultilineValuesTestCase::test_dominating_multiline_values (CPython 3.12 oracle)."""
...
with open(os_helper.TESTFN, 'w', encoding='utf-8') as f:
    cf.write(f)
cf_from_file = newconfig()
with open(os_helper.TESTFN, encoding='utf-8') as f:
    cf_from_file.read_file(f)

assert cf_from_file.get('section8', 'lovely_spam4') == wonderful_spam.replace('\t\n', '\n')
print("MultilineValuesTestCase::test_dominating_multiline_values: ok")
