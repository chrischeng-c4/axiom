...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_no_interpolation__test_boolean"
# subject = "cpython.test_configparser.ConfigParserTestCaseNoInterpolation.test_boolean"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNoInterpolation::test_boolean
"""Auto-ported test: ConfigParserTestCaseNoInterpolation::test_boolean (CPython 3.12 oracle)."""
...
def parse_error(cf, exc, src):
    ...
    try:
        ...
        cm = _types_aR.SimpleNamespace(exception=_aR_e)
    return cm.exception
cf = fromstring('[BOOLTEST]\nT1{equals}1\nT2{equals}TRUE\nT3{equals}True\nT4{equals}oN\nT5{equals}yes\nF1{equals}0\nF2{equals}FALSE\nF3{equals}False\nF4{equals}oFF\nF5{equals}nO\nE1{equals}2\nE2{equals}foo\nE3{equals}-1\nE4{equals}0.1\nE5{equals}FALSE AND MORE'.format(equals=delimiters[0]))
for x in range(1, 5):

    assert cf.getboolean('BOOLTEST', 't%d' % x)

    assert not cf.getboolean('BOOLTEST', 'f%d' % x)
    ...
    try:
        ...
        pass
print("ConfigParserTestCaseNoInterpolation::test_boolean: ok")
