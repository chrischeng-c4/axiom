...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_non_standard_delimiters__test_set_string_types"
# subject = "cpython.test_configparser.ConfigParserTestCaseNonStandardDelimiters.test_set_string_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNonStandardDelimiters::test_set_string_types
"""Auto-ported test: ConfigParserTestCaseNonStandardDelimiters::test_set_string_types (CPython 3.12 oracle)."""
...
cf.set('sect', 'option1', 'splat')
cf.set('sect', 'option2', 'splat')
print("ConfigParserTestCaseNonStandardDelimiters::test_set_string_types: ok")
