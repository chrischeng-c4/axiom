...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_no_interpolation__test_setitem"
# subject = "cpython.test_configparser.ConfigParserTestCaseNoInterpolation.test_setitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNoInterpolation::test_setitem
"""Auto-ported test: ConfigParserTestCaseNoInterpolation::test_setitem (CPython 3.12 oracle)."""
...
assert set(cf['section2'].keys()) == {'name22'}
print("ConfigParserTestCaseNoInterpolation::test_setitem: ok")
