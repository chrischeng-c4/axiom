...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_extended_interpolation__test_set_string_types"
# subject = "cpython.test_configparser.ConfigParserTestCaseExtendedInterpolation.test_set_string_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseExtendedInterpolation::test_set_string_types
"""Auto-ported test: ConfigParserTestCaseExtendedInterpolation::test_set_string_types (CPython 3.12 oracle)."""
...
cf.set('sect', 'option1', 'splat')
cf.set('sect', 'option2', 'splat')
print("ConfigParserTestCaseExtendedInterpolation::test_set_string_types: ok")
