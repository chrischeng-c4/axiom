...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_legacy_interpolation__test_setitem"
# subject = "cpython.test_configparser.ConfigParserTestCaseLegacyInterpolation.test_setitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseLegacyInterpolation::test_setitem
"""Auto-ported test: ConfigParserTestCaseLegacyInterpolation::test_setitem (CPython 3.12 oracle)."""
...
assert set(cf['section2'].keys()) == {'name22'}
print("ConfigParserTestCaseLegacyInterpolation::test_setitem: ok")
