...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case_no_interpolation__test_get_after_duplicate_option_error"
# subject = "cpython.test_configparser.ConfigParserTestCaseNoInterpolation.test_get_after_duplicate_option_error"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCaseNoInterpolation::test_get_after_duplicate_option_error
"""Auto-ported test: ConfigParserTestCaseNoInterpolation::test_get_after_duplicate_option_error (CPython 3.12 oracle)."""
...
assert cf.get('Foo', 'x') == '1'
print("ConfigParserTestCaseNoInterpolation::test_get_after_duplicate_option_error: ok")
