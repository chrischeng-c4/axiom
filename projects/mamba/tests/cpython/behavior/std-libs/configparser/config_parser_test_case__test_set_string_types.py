...
# lib = "configparser"
# dimension = "behavior"
# case = "config_parser_test_case__test_set_string_types"
# subject = "cpython.test_configparser.ConfigParserTestCase.test_set_string_types"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::ConfigParserTestCase::test_set_string_types
"""Auto-ported test: ConfigParserTestCase::test_set_string_types (CPython 3.12 oracle)."""
...
cf.set('sect', 'option1', 'splat')
cf.set('sect', 'option2', 'splat')
print("ConfigParserTestCase::test_set_string_types: ok")
