...
# lib = "configparser"
# dimension = "behavior"
# case = "multiline_values_test_case__test_boolean"
# subject = "cpython.test_configparser.MultilineValuesTestCase.test_boolean"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::MultilineValuesTestCase::test_boolean
"""Auto-ported test: MultilineValuesTestCase::test_boolean (CPython 3.12 oracle)."""
...
for x in range(1, 5):
    ...
    try:
        ...
        pass
print("MultilineValuesTestCase::test_boolean: ok")
