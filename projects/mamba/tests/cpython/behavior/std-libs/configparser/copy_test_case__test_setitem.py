...
# lib = "configparser"
# dimension = "behavior"
# case = "copy_test_case__test_setitem"
# subject = "cpython.test_configparser.CopyTestCase.test_setitem"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_configparser.py::CopyTestCase::test_setitem
"""Auto-ported test: CopyTestCase::test_setitem (CPython 3.12 oracle)."""
...
assert set(cf['section2'].keys()) == {'name22'}
print("CopyTestCase::test_setitem: ok")
