...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_slice"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_slice"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_slice
"""Auto-ported test: TestBufferProtocol::test_memoryview_slice (CPython 3.12 oracle)."""
...
try:
    m.__getitem__(slice(0, 2, 0))
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    m.__setitem__(slice(0, 2, 0), bytearray([1, 2]))
    raise AssertionError('expected ValueError')
except ValueError:
    pass
...
try:
    m.__getitem__((slice(0, 2, 1), slice(0, 2, 1)))
    raise AssertionError('expected NotImplementedError')
except NotImplementedError:
    pass

try:
    m.__setitem__((slice(0, 2, 1), slice(0, 2, 1)), bytearray([1, 2]))
    raise AssertionError('expected NotImplementedError')
except NotImplementedError:
    pass

try:
    m.__getitem__((slice(0, 2, 1), {}))
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    m.__setitem__((slice(0, 2, 1), {}), bytearray([1, 2]))
    raise AssertionError('expected TypeError')
except TypeError:
    pass

try:
    m.__setitem__(slice(0, 1, 1), [1])
    raise AssertionError('expected TypeError')
except TypeError:
    pass
for flags in (0, ND_PIL):
    ...
    assert m2 == ex2
print("TestBufferProtocol::test_memoryview_slice: ok")
