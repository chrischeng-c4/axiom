...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_zero_strides"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_zero_strides"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_zero_strides
"""Auto-ported test: TestBufferProtocol::test_ndarray_zero_strides (CPython 3.12 oracle)."""
...
for flags in (0, ND_PIL):
    ...
    assert nd.tolist() == [1, 1, 1, 1, 1]

    assert mv.tolist() == [1, 1, 1, 1, 1]
print("TestBufferProtocol::test_ndarray_zero_strides: ok")
