...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_compare_random_formats"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_compare_random_formats"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_compare_random_formats
"""Auto-ported test: TestBufferProtocol::test_memoryview_compare_random_formats (CPython 3.12 oracle)."""
...
for _ in range(100):
    ...
    for flags in (0, ND_PIL):
        ...
        assert m == nd
print("TestBufferProtocol::test_memoryview_compare_random_formats: ok")
