...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_redirect"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_redirect"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_redirect
"""Auto-ported test: TestBufferProtocol::test_memoryview_redirect (CPython 3.12 oracle)."""
...
for x in (nd, a):
    ...
    assert m[1:3] == x[1:3]
print("TestBufferProtocol::test_memoryview_redirect: ok")
