...
# lib = "buffer"
# dimension = "behavior"
# case = "test_python_buffer_protocol__test_buffer_flags"
# subject = "cpython.test_buffer.TestPythonBufferProtocol.test_buffer_flags"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestPythonBufferProtocol::test_buffer_flags
"""Auto-ported test: TestPythonBufferProtocol::test_buffer_flags (CPython 3.12 oracle)."""
...
with memoryview(immutable) as mv:
    ...
    assert mv.tobytes() == b'hello'
print("TestPythonBufferProtocol::test_buffer_flags: ok")
