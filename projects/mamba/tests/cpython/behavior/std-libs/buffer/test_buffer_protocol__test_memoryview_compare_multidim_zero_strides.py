...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_compare_multidim_zero_strides"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_compare_multidim_zero_strides"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_compare_multidim_zero_strides
"""Auto-ported test: TestBufferProtocol::test_memoryview_compare_multidim_zero_strides (CPython 3.12 oracle)."""
...
assert v == w
print("TestBufferProtocol::test_memoryview_compare_multidim_zero_strides: ok")
