...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_fortran"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_fortran"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_fortran
"""Auto-ported test: TestBufferProtocol::test_ndarray_fortran (CPython 3.12 oracle)."""
...
assert nd.tolist() == farray(items, (3, 4))
print("TestBufferProtocol::test_ndarray_fortran: ok")
