...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_sequence"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_sequence"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_sequence
"""Auto-ported test: TestBufferProtocol::test_memoryview_sequence (CPython 3.12 oracle)."""
...
try:
    eval('9.0 in m', locals())
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("TestBufferProtocol::test_memoryview_sequence: ok")
