...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_memoryview_compare_multidim_mixed"
# subject = "cpython.test_buffer.TestBufferProtocol.test_memoryview_compare_multidim_mixed"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_memoryview_compare_multidim_mixed
"""Auto-ported test: TestBufferProtocol::test_memoryview_compare_multidim_mixed (CPython 3.12 oracle)."""
...
assert v != w
print("TestBufferProtocol::test_memoryview_compare_multidim_mixed: ok")
