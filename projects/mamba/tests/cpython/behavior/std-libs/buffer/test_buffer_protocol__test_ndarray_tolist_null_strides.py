...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_tolist_null_strides"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_tolist_null_strides"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_tolist_null_strides
"""Auto-ported test: TestBufferProtocol::test_ndarray_tolist_null_strides (CPython 3.12 oracle)."""
...
assert nd.tolist() == ex.tolist()
m = memoryview(ex)

assert m.tolist() == ex.tolist()
print("TestBufferProtocol::test_ndarray_tolist_null_strides: ok")
