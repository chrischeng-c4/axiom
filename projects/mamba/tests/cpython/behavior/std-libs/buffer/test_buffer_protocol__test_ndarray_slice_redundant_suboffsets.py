...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_slice_redundant_suboffsets"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_slice_redundant_suboffsets"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_slice_redundant_suboffsets
"""Auto-ported test: TestBufferProtocol::test_ndarray_slice_redundant_suboffsets (CPython 3.12 oracle)."""
...
for shape in permutations(shape_t):
    ...
    for slices in rslices_ndim(ndim, shape):
        ...
        if nderr or listerr:
            ...
            assert nderr is listerr
        else:

            assert ndsliced.tolist() == sliced
print("TestBufferProtocol::test_ndarray_slice_redundant_suboffsets: ok")
