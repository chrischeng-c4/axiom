...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_re_export"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_re_export"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_re_export
"""Auto-ported test: TestBufferProtocol::test_ndarray_re_export (CPython 3.12 oracle)."""
...
assert ex.flags & ND_PIL

assert ex.obj is nd

assert ex.suboffsets == (0, -1)

assert not ex.c_contiguous

assert not ex.f_contiguous

assert not ex.contiguous
print("TestBufferProtocol::test_ndarray_re_export: ok")
