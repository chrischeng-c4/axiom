...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_index_getitem_single"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_index_getitem_single"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_index_getitem_single
"""Auto-ported test: TestBufferProtocol::test_ndarray_index_getitem_single (CPython 3.12 oracle)."""
...
for fmt, items, _ in iter_format(5):
    ...
    if is_memoryview_format(fmt):
        ...
        assert mv.__eq__(nd) is NotImplemented
        for i in range(-5, 5):
...
for i in range(-5, 5):
    ...
    assert nd[i] == items[i]
print("TestBufferProtocol::test_ndarray_index_getitem_single: ok")
