...
# lib = "buffer"
# dimension = "behavior"
# case = "test_buffer_protocol__test_ndarray_cmp_contig"
# subject = "cpython.test_buffer.TestBufferProtocol.test_ndarray_cmp_contig"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_buffer.py::TestBufferProtocol::test_ndarray_cmp_contig
"""Auto-ported test: TestBufferProtocol::test_ndarray_cmp_contig (CPython 3.12 oracle)."""
...
assert not cmp_contig(b'123', b'456')
x = ndarray(list(range(12)), shape=[3, 4])
y = ndarray(list(range(12)), shape=[4, 3])

assert not cmp_contig(x, y)
x = ndarray([1], shape=[1], format='B')

assert cmp_contig(x, b'\x01')

assert cmp_contig(b'\x01', x)
print("TestBufferProtocol::test_ndarray_cmp_contig: ok")
