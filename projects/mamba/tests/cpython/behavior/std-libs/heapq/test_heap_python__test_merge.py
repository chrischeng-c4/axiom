...
# lib = "heapq"
# dimension = "behavior"
# case = "test_heap_python__test_merge"
# subject = "cpython.test_heapq.TestHeapPython.test_merge"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_heapq.py::TestHeapPython::test_merge
"""Auto-ported test: TestHeapPython::test_merge (CPython 3.12 oracle)."""
...
for key in [None, itemgetter(0), itemgetter(1), itemgetter(1, 0)]:
    for reverse in [False, True]:
        ...
        assert sorted(chain(*inputs), key=key, reverse=reverse) == list(module.merge(*seqs, key=key, reverse=reverse))

        assert list(module.merge()) == []
print("TestHeapPython::test_merge: ok")
