...
# lib = "heapq"
# dimension = "behavior"
# case = "test_heap_python__test_nlargest"
# subject = "cpython.test_heapq.TestHeapPython.test_nlargest"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_heapq.py::TestHeapPython::test_nlargest
"""Auto-ported test: TestHeapPython::test_nlargest (CPython 3.12 oracle)."""
...
for f in (None, lambda x: x[0] * 547 % 2000):
    for n in (0, 1, 2, 10, 100, 400, 999, 1000, 1100):
        ...
        assert list(module.nlargest(n, data)) == sorted(data, reverse=True)[:n]

        assert list(module.nlargest(n, data, key=f)) == sorted(data, key=f, reverse=True)[:n]
print("TestHeapPython::test_nlargest: ok")
