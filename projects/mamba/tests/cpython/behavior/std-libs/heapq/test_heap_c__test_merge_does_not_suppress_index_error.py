...
# lib = "heapq"
# dimension = "behavior"
# case = "test_heap_c__test_merge_does_not_suppress_index_error"
# subject = "cpython.test_heapq.TestHeapC.test_merge_does_not_suppress_index_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_heapq.py::TestHeapC::test_merge_does_not_suppress_index_error
"""Auto-ported test: TestHeapC::test_merge_does_not_suppress_index_error (CPython 3.12 oracle)."""
...
def iterable():
    ...
    for i in range(20):
        yield s[i]
try:
    list(module.merge(iterable(), iterable()))
    raise AssertionError('expected IndexError')
except IndexError:
    pass
print("TestHeapC::test_merge_does_not_suppress_index_error: ok")
