...
# lib = "gc"
# dimension = "behavior"
# case = "gc_tests__test_newinstance"
# subject = "cpython.test_gc.GCTests.test_newinstance"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_gc.py::GCTests::test_newinstance
"""Auto-ported test: GCTests::test_newinstance (CPython 3.12 oracle)."""
...
assert gc.collect() == 0
print("GCTests::test_newinstance: ok")
