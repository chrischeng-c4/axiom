...
# lib = "gc"
# dimension = "behavior"
# case = "gc_tests__test_function"
# subject = "cpython.test_gc.GCTests.test_function"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_gc.py::GCTests::test_function
"""Auto-ported test: GCTests::test_function (CPython 3.12 oracle)."""
...
assert gc.collect() == 2
print("GCTests::test_function: ok")
