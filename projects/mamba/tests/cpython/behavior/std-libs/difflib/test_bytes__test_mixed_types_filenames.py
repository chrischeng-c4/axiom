...
# lib = "difflib"
# dimension = "behavior"
# case = "test_bytes__test_mixed_types_filenames"
# subject = "cpython.test_difflib.TestBytes.test_mixed_types_filenames"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_difflib.py::TestBytes::test_mixed_types_filenames
"""Auto-ported test: TestBytes::test_mixed_types_filenames (CPython 3.12 oracle)."""
...
fna = b'ol\xe9.txt'
fnb = b'ol\xc3a9.txt'
_assert_type_error("all arguments must be str, not: b'ol\\xe9.txt'", difflib.unified_diff, a, b, fna, fnb)
print("TestBytes::test_mixed_types_filenames: ok")
