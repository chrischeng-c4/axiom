...
# lib = "difflib"
# dimension = "behavior"
# case = "test_find_longest__test_default_args"
# subject = "cpython.test_difflib.TestFindLongest.test_default_args"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_difflib.py::TestFindLongest::test_default_args
"""Auto-ported test: TestFindLongest::test_default_args (CPython 3.12 oracle)."""
...
assert not longer_match_exists(a[2:], b[4:], match.size)
...
assert not longer_match_exists(a, b[1:5], match.size)
print("TestFindLongest::test_default_args: ok")
