...
# lib = "collections"
# dimension = "behavior"
# case = "test_named_tuple__test_field_repr"
# subject = "cpython.test_collections.TestNamedTuple.test_field_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestNamedTuple::test_field_repr
"""Auto-ported test: TestNamedTuple::test_field_repr (CPython 3.12 oracle)."""
...
assert repr(Point.y) == "_tuplegetter(1, 'Alias for field number 1')"
Point.x.__doc__ = 'The x-coordinate'
Point.y.__doc__ = 'The y-coordinate'

assert repr(Point.x) == "_tuplegetter(0, 'The x-coordinate')"

assert repr(Point.y) == "_tuplegetter(1, 'The y-coordinate')"
print("TestNamedTuple::test_field_repr: ok")
