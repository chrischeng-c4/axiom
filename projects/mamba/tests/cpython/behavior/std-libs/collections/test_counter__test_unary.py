...
# lib = "collections"
# dimension = "behavior"
# case = "test_counter__test_unary"
# subject = "cpython.test_collections.TestCounter.test_unary"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestCounter::test_unary
"""Auto-ported test: TestCounter::test_unary (CPython 3.12 oracle)."""
...
assert dict(+c) == dict(c=5, d=10, e=15, g=40)

assert dict(-c) == dict(a=5)
print("TestCounter::test_unary: ok")
