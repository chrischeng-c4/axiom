...
# lib = "collections"
# dimension = "behavior"
# case = "test_chain_map__test_missing"
# subject = "cpython.test_collections.TestChainMap.test_missing"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestChainMap::test_missing
"""Auto-ported test: TestChainMap::test_missing (CPython 3.12 oracle)."""
...
assert d.pop('a', 1001) == 1

assert d.pop('a', 1002) == 1002
...
try:
    ...
    pass
print("TestChainMap::test_missing: ok")
