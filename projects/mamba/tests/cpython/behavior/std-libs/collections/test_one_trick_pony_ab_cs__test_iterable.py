...
# lib = "collections"
# dimension = "behavior"
# case = "test_one_trick_pony_ab_cs__test_iterable"
# subject = "cpython.test_collections.TestOneTrickPonyABCs.test_Iterable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestOneTrickPonyABCs::test_Iterable
"""Auto-ported test: TestOneTrickPonyABCs::test_Iterable (CPython 3.12 oracle)."""
...
assert not issubclass(str, I)
validate_abstract_methods(Iterable, '__iter__')
validate_isinstance(Iterable, '__iter__')
...
assert issubclass(It, Iterable)

assert isinstance(It(), Iterable)

assert not issubclass(ItBlocked, Iterable)

assert not isinstance(ItBlocked(), Iterable)
print("TestOneTrickPonyABCs::test_Iterable: ok")
