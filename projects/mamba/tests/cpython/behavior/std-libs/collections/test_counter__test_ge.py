...
# lib = "collections"
# dimension = "behavior"
# case = "test_counter__test_ge"
# subject = "cpython.test_collections.TestCounter.test_ge"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestCounter::test_ge
"""Auto-ported test: TestCounter::test_ge (CPython 3.12 oracle)."""
...
assert Counter(a=2, b=1, c=0) >= Counter('aab')

assert not Counter(a=3, b=2, c=0) >= Counter('aabd')
print("TestCounter::test_ge: ok")
