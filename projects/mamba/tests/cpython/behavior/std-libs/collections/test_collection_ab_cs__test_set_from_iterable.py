...
# lib = "collections"
# dimension = "behavior"
# case = "test_collection_ab_cs__test_set_from_iterable"
# subject = "cpython.test_collections.TestCollectionABCs.test_Set_from_iterable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestCollectionABCs::test_Set_from_iterable
"""Auto-ported test: TestCollectionABCs::test_Set_from_iterable (CPython 3.12 oracle)."""
...
assert isinstance(actual, SetUsingInstanceFromIterable)

assert 'from_iterable' == actual.created_by
...
assert isinstance(impl, SetUsingInstanceFromIterable)

assert 'test' == impl.created_by

assert {1, 2, 4} == impl
print("TestCollectionABCs::test_Set_from_iterable: ok")
