...
# lib = "collections"
# dimension = "behavior"
# case = "test_one_trick_pony_ab_cs__test_hashable"
# subject = "cpython.test_collections.TestOneTrickPonyABCs.test_Hashable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestOneTrickPonyABCs::test_Hashable
"""Auto-ported test: TestOneTrickPonyABCs::test_Hashable (CPython 3.12 oracle)."""
...
assert not issubclass(int, H)
validate_abstract_methods(Hashable, '__hash__')
validate_isinstance(Hashable, '__hash__')
print("TestOneTrickPonyABCs::test_Hashable: ok")
