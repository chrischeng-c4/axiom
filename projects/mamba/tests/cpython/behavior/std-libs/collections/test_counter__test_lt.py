...
# lib = "collections"
# dimension = "behavior"
# case = "test_counter__test_lt"
# subject = "cpython.test_collections.TestCounter.test_lt"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_collections.py::TestCounter::test_lt
"""Auto-ported test: TestCounter::test_lt (CPython 3.12 oracle)."""
...
assert Counter(a=3, b=1, c=0) < Counter('ababa')

assert not Counter(a=3, b=2, c=0) < Counter('ababa')
print("TestCounter::test_lt: ok")
