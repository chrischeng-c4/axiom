...
# lib = "xml_etree_c"
# dimension = "behavior"
# case = "test_alias_working__test_alias_working"
# subject = "cpython.test_xml_etree_c.TestAliasWorking.test_alias_working"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_xml_etree_c.py::TestAliasWorking::test_alias_working
"""Auto-ported test: TestAliasWorking::test_alias_working (CPython 3.12 oracle)."""
...
assert e.tag == 'foo'
print("TestAliasWorking::test_alias_working: ok")
