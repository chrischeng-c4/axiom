...
# lib = "bz2"
# dimension = "behavior"
# case = "compress_decompress_test__test_decompress_bad_data"
# subject = "cpython.test_bz2.CompressDecompressTest.testDecompressBadData"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::CompressDecompressTest::testDecompressBadData
"""Auto-ported test: CompressDecompressTest::testDecompressBadData (CPython 3.12 oracle)."""
...
try:
    bz2.decompress(BAD_DATA)
    raise AssertionError('expected OSError')
except OSError:
    pass
print("CompressDecompressTest::testDecompressBadData: ok")
