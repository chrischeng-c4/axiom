...
# lib = "bz2"
# dimension = "behavior"
# case = "open_test__test_x_mode"
# subject = "cpython.test_bz2.OpenTest.test_x_mode"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::OpenTest::test_x_mode
"""Auto-ported test: OpenTest::test_x_mode (CPython 3.12 oracle)."""
...
os.close(fd)
for mode in ('x', 'xb', 'xt'):
    unlink(self_filename)
    encoding = 'utf-8' if 't' in mode else None
    with open(self_filename, mode, encoding=encoding) as f:
        pass
    try:
        with open(self_filename, mode) as f:
            pass
        raise AssertionError('expected FileExistsError')
    except FileExistsError:
        pass
print("OpenTest::test_x_mode: ok")
