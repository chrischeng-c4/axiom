...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_open_nonexistent"
# subject = "cpython.test_bz2.BZ2FileTest.testOpenNonexistent"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::testOpenNonexistent
"""Auto-ported test: BZ2FileTest::testOpenNonexistent (CPython 3.12 oracle)."""
...
try:
    BZ2File('/non/existent')
    raise AssertionError('expected OSError')
except OSError:
    pass
print("BZ2FileTest::testOpenNonexistent: ok")
