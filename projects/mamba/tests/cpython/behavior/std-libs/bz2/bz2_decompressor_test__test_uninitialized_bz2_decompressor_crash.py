...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_decompressor_test__test_uninitialized_bz2_decompressor_crash"
# subject = "cpython.test_bz2.BZ2DecompressorTest.test_uninitialized_BZ2Decompressor_crash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2DecompressorTest::test_uninitialized_BZ2Decompressor_crash
"""Auto-ported test: BZ2DecompressorTest::test_uninitialized_BZ2Decompressor_crash (CPython 3.12 oracle)."""
...
assert BZ2Decompressor.__new__(BZ2Decompressor).decompress(bytes()) == b''
print("BZ2DecompressorTest::test_uninitialized_BZ2Decompressor_crash: ok")
