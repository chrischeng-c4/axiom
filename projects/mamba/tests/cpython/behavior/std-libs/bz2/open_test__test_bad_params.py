...
# lib = "bz2"
# dimension = "behavior"
# case = "open_test__test_bad_params"
# subject = "cpython.test_bz2.OpenTest.test_bad_params"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::OpenTest::test_bad_params
"""Auto-ported test: OpenTest::test_bad_params (CPython 3.12 oracle)."""
...
try:
    open(self_filename, 'wbt')
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    open(self_filename, 'xbt')
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    open(self_filename, 'rb', encoding='utf-8')
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    open(self_filename, 'rb', errors='ignore')
    raise AssertionError('expected ValueError')
except ValueError:
    pass

try:
    open(self_filename, 'rb', newline='\n')
    raise AssertionError('expected ValueError')
except ValueError:
    pass
print("OpenTest::test_bad_params: ok")
