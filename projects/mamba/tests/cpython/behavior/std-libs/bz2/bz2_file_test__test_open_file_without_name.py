...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_open_file_without_name"
# subject = "cpython.test_bz2.BZ2FileTest.testOpenFileWithoutName"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::testOpenFileWithoutName
"""Auto-ported test: BZ2FileTest::testOpenFileWithoutName (CPython 3.12 oracle)."""
...
with BZ2File(bio, 'wb') as f:
    ...
    try:
        f.fileno()
        raise AssertionError('expected io.UnsupportedOperation')
...
try:
    ...
    pass
print("BZ2FileTest::testOpenFileWithoutName: ok")
