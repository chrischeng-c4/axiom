...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_fileno"
# subject = "cpython.test_bz2.BZ2FileTest.testFileno"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::testFileno
"""Auto-ported test: BZ2FileTest::testFileno (CPython 3.12 oracle)."""
...
os.close(fd)
createTempFile()
with open(self_filename, 'rb') as rawf:
    bz2f = BZ2File(rawf)
    try:
...
try:
    ...
    pass
print("BZ2FileTest::testFileno: ok")
