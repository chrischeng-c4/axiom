...
# lib = "bz2"
# dimension = "behavior"
# case = "open_test__test_fileobj"
# subject = "cpython.test_bz2.OpenTest.test_fileobj"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::OpenTest::test_fileobj
"""Auto-ported test: OpenTest::test_fileobj (CPython 3.12 oracle)."""
...
os.close(fd)
with open(BytesIO(DATA), 'r') as f:

    assert f.read() == TEXT
with open(BytesIO(DATA), 'rb') as f:

    assert f.read() == TEXT
text = TEXT.decode('ascii')
with open(BytesIO(DATA), 'rt', encoding='utf-8') as f:

    assert f.read() == text
print("OpenTest::test_fileobj: ok")
