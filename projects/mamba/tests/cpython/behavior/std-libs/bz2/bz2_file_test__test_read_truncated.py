...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_read_truncated"
# subject = "cpython.test_bz2.BZ2FileTest.test_read_truncated"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::test_read_truncated
"""Auto-ported test: BZ2FileTest::test_read_truncated (CPython 3.12 oracle)."""
...
for i in range(22):
    with BZ2File(BytesIO(truncated[:i])) as f:
        ...
        try:
            ...
            pass
print("BZ2FileTest::test_read_truncated: ok")
