...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_append"
# subject = "cpython.test_bz2.BZ2FileTest.testAppend"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::testAppend
"""Auto-ported test: BZ2FileTest::testAppend (CPython 3.12 oracle)."""
...
os.close(fd)
with BZ2File(self_filename, 'w') as bz2f:
    ...
    try:
        ...
        pass
    bz2f.write(TEXT)
with BZ2File(self_filename, 'a') as bz2f:
...
print("BZ2FileTest::testAppend: ok")
