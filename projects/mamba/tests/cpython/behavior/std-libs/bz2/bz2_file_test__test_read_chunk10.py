...
# lib = "bz2"
# dimension = "behavior"
# case = "bz2_file_test__test_read_chunk10"
# subject = "cpython.test_bz2.BZ2FileTest.testReadChunk10"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_bz2.py::BZ2FileTest::testReadChunk10
"""Auto-ported test: BZ2FileTest::testReadChunk10 (CPython 3.12 oracle)."""
...
with BZ2File(self_filename) as bz2f:
    ...
    assert text == TEXT
print("BZ2FileTest::testReadChunk10: ok")
