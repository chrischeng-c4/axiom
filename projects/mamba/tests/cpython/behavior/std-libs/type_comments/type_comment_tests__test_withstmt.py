...
# lib = "type_comments"
# dimension = "behavior"
# case = "type_comment_tests__test_withstmt"
# subject = "cpython.test_type_comments.TypeCommentTests.test_withstmt"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_comments.py::TypeCommentTests::test_withstmt
"""Auto-ported test: TypeCommentTests::test_withstmt (CPython 3.12 oracle)."""
...
for tree in parse_all(withstmt):

    assert tree.body[0].type_comment == 'int'
tree = classic_parse(withstmt)

assert tree.body[0].type_comment == None
print("TypeCommentTests::test_withstmt: ok")
