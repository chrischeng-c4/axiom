...
# lib = "type_comments"
# dimension = "behavior"
# case = "type_comment_tests__test_forstmt"
# subject = "cpython.test_type_comments.TypeCommentTests.test_forstmt"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_type_comments.py::TypeCommentTests::test_forstmt
"""Auto-ported test: TypeCommentTests::test_forstmt (CPython 3.12 oracle)."""
...
for tree in parse_all(forstmt):

    assert tree.body[0].type_comment == 'int'
tree = classic_parse(forstmt)

assert tree.body[0].type_comment == None
print("TypeCommentTests::test_forstmt: ok")
