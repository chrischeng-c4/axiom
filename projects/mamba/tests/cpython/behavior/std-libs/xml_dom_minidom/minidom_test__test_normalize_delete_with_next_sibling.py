...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_normalize_delete_with_next_sibling"
# subject = "cpython.test_minidom.MinidomTest.testNormalizeDeleteWithNextSibling"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testNormalizeDeleteWithNextSibling
"""Auto-ported test: MinidomTest::testNormalizeDeleteWithNextSibling (CPython 3.12 oracle)."""
...
confirm(len(root.childNodes) == 2 and root.childNodes.length == 2, 'testNormalizeDeleteWithNextSibling -- preparation')
doc.normalize()
confirm(len(root.childNodes) == 1 and root.childNodes.length == 1 and (root.firstChild.data == 'second') and (root.firstChild is root.lastChild) and (root.firstChild.nextSibling is None) and (root.firstChild.previousSibling is None), 'testNormalizeDeleteWithNextSibling -- result')
doc.unlink()
print("MinidomTest::testNormalizeDeleteWithNextSibling: ok")
