...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_cdata_parsing"
# subject = "cpython.test_minidom.MinidomTest.test_cdata_parsing"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::test_cdata_parsing
"""Auto-ported test: MinidomTest::test_cdata_parsing (CPython 3.12 oracle)."""
...
checkWholeText(dom1.getElementsByTagName('node')[0].firstChild, '</data>')
dom2 = parseString(dom1.toprettyxml())
checkWholeText(dom2.getElementsByTagName('node')[0].firstChild, '</data>')
print("MinidomTest::test_cdata_parsing: ok")
