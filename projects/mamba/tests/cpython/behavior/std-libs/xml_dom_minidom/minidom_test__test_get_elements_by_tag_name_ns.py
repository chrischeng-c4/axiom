...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_get_elements_by_tag_name_ns"
# subject = "cpython.test_minidom.MinidomTest.testGetElementsByTagNameNS"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testGetElementsByTagNameNS
"""Auto-ported test: MinidomTest::testGetElementsByTagNameNS (CPython 3.12 oracle)."""
...
confirm(len(elems) == 1 and elems[0].namespaceURI == 'http://pyxml.sf.net/minidom' and (elems[0].localName == 'myelem') and (elems[0].prefix == 'minidom') and (elems[0].tagName == 'minidom:myelem') and (elems[0].nodeName == 'minidom:myelem'))
dom.unlink()
print("MinidomTest::testGetElementsByTagNameNS: ok")
