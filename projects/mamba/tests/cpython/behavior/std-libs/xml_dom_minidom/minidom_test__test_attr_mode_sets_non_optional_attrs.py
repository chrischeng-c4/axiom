...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_attr_mode_sets_non_optional_attrs"
# subject = "cpython.test_minidom.MinidomTest.testAttrModeSetsNonOptionalAttrs"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testAttrModeSetsNonOptionalAttrs
"""Auto-ported test: MinidomTest::testAttrModeSetsNonOptionalAttrs (CPython 3.12 oracle)."""
...
assert attr.name == 'qName'

assert attr.namespaceURI == 'namespaceURI'

assert attr.prefix == 'prefix'

assert attr.localName == attr.name
print("MinidomTest::testAttrModeSetsNonOptionalAttrs: ok")
