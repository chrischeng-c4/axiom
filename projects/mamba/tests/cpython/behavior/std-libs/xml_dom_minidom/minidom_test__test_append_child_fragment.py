...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_append_child_fragment"
# subject = "cpython.test_minidom.MinidomTest.testAppendChildFragment"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testAppendChildFragment
"""Auto-ported test: MinidomTest::testAppendChildFragment (CPython 3.12 oracle)."""
...
confirm(tuple(dom.documentElement.childNodes) == (orig, c1, c2, c3), 'appendChild(<fragment>)')
frag.unlink()
dom.unlink()
print("MinidomTest::testAppendChildFragment: ok")
