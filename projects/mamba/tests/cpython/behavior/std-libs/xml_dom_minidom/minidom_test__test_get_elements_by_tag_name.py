...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_get_elements_by_tag_name"
# subject = "cpython.test_minidom.MinidomTest.testGetElementsByTagName"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testGetElementsByTagName
"""Auto-ported test: MinidomTest::testGetElementsByTagName (CPython 3.12 oracle)."""
...
dom = parse(tstfile)
confirm(dom.getElementsByTagName('LI') == dom.documentElement.getElementsByTagName('LI'))
dom.unlink()
print("MinidomTest::testGetElementsByTagName: ok")
