...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_doc_remove_child"
# subject = "cpython.test_minidom.MinidomTest.testDocRemoveChild"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testDocRemoveChild
"""Auto-ported test: MinidomTest::testDocRemoveChild (CPython 3.12 oracle)."""
...
try:
    doc.removeChild(title_tag)
    raise AssertionError('expected xml.dom.NotFoundErr')
...
assert num_children_after == num_children_before - 1
print("MinidomTest::testDocRemoveChild: ok")
