...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_bug1433694"
# subject = "cpython.test_minidom.MinidomTest.testBug1433694"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testBug1433694
"""Auto-ported test: MinidomTest::testBug1433694 (CPython 3.12 oracle)."""
...
node.normalize()
confirm(node.childNodes[-1].nextSibling is None, "Final child's .nextSibling should be None")
print("MinidomTest::testBug1433694: ok")
