...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_standalone"
# subject = "cpython.test_minidom.MinidomTest.testStandalone"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testStandalone
"""Auto-ported test: MinidomTest::testStandalone (CPython 3.12 oracle)."""
...
assert doc.toxml(standalone=None) == '<?xml version="1.0" ?><foo>€</foo>'

assert doc.toxml(standalone=True) == '<?xml version="1.0" standalone="yes"?><foo>€</foo>'

assert doc.toxml(standalone=False) == '<?xml version="1.0" standalone="no"?><foo>€</foo>'

assert doc.toxml('utf-8', True) == b'<?xml version="1.0" encoding="utf-8" standalone="yes"?><foo>\xe2\x82\xac</foo>'
doc.unlink()
print("MinidomTest::testStandalone: ok")
