...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_toxml_with_attributes_ordered"
# subject = "cpython.test_minidom.MinidomTest.test_toxml_with_attributes_ordered"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::test_toxml_with_attributes_ordered
"""Auto-ported test: MinidomTest::test_toxml_with_attributes_ordered (CPython 3.12 oracle)."""
...
assert doc.toxml() == xml_str
print("MinidomTest::test_toxml_with_attributes_ordered: ok")
