...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_insert_before_fragment"
# subject = "cpython.test_minidom.MinidomTest.testInsertBeforeFragment"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testInsertBeforeFragment
"""Auto-ported test: MinidomTest::testInsertBeforeFragment (CPython 3.12 oracle)."""
...
confirm(tuple(dom.documentElement.childNodes) == (orig, c1, c2, c3), 'insertBefore(<fragment>, None)')
frag.unlink()
dom.unlink()
dom, orig, c1, c2, c3, frag = _create_fragment_test_nodes()
dom.documentElement.insertBefore(frag, orig)
confirm(tuple(dom.documentElement.childNodes) == (c1, c2, c3, orig), 'insertBefore(<fragment>, orig)')
frag.unlink()
dom.unlink()
print("MinidomTest::testInsertBeforeFragment: ok")
