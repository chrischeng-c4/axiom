...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_parents"
# subject = "cpython.test_minidom.MinidomTest.testParents"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::testParents
"""Auto-ported test: MinidomTest::testParents (CPython 3.12 oracle)."""
...
confirm(root.parentNode is doc and elm1.parentNode is root and (elm2a.parentNode is elm1) and (elm2b.parentNode is elm1) and (elm3.parentNode is elm2b), 'testParents')
doc.unlink()
print("MinidomTest::testParents: ok")
