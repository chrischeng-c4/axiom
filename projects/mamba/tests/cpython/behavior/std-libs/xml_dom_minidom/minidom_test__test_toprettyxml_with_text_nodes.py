...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_toprettyxml_with_text_nodes"
# subject = "cpython.test_minidom.MinidomTest.test_toprettyxml_with_text_nodes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::test_toprettyxml_with_text_nodes
"""Auto-ported test: MinidomTest::test_toprettyxml_with_text_nodes (CPython 3.12 oracle)."""
...
assert parseString('<B>A</B>').toprettyxml() == decl + '<B>A</B>\n'

assert parseString('<C>A<B>A</B></C>').toprettyxml() == decl + '<C>\n\tA\n\t<B>A</B>\n</C>\n'

assert parseString('<C><B>A</B>A</C>').toprettyxml() == decl + '<C>\n\t<B>A</B>\n\tA\n</C>\n'

assert parseString('<C><B>A</B><B>A</B></C>').toprettyxml() == decl + '<C>\n\t<B>A</B>\n\t<B>A</B>\n</C>\n'

assert parseString('<C><B>A</B>A<B>A</B></C>').toprettyxml() == decl + '<C>\n\t<B>A</B>\n\tA\n\t<B>A</B>\n</C>\n'
print("MinidomTest::test_toprettyxml_with_text_nodes: ok")
