...
# lib = "xml_dom_minidom"
# dimension = "behavior"
# case = "minidom_test__test_toprettyxml_preserves_content_of_text_node"
# subject = "cpython.test_minidom.MinidomTest.test_toprettyxml_preserves_content_of_text_node"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_minidom.py::MinidomTest::test_toprettyxml_preserves_content_of_text_node
"""Auto-ported test: MinidomTest::test_toprettyxml_preserves_content_of_text_node (CPython 3.12 oracle)."""
...
for str in ('<B>A</B>', '<A><B>C</B></A>'):
    ...
    assert dom.getElementsByTagName('B')[0].childNodes[0].toxml() == dom2.getElementsByTagName('B')[0].childNodes[0].toxml()
print("MinidomTest::test_toprettyxml_preserves_content_of_text_node: ok")
