...
# lib = "profile"
# dimension = "behavior"
# case = "profile_test__test_output_file_when_changing_directory"
# subject = "cpython.test_profile.ProfileTest.test_output_file_when_changing_directory"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_profile.py::ProfileTest::test_output_file_when_changing_directory
"""Auto-ported test: ProfileTest::test_output_file_when_changing_directory (CPython 3.12 oracle)."""
...
with temp_dir() as tmpdir, change_cwd(tmpdir):
    ...
    assert_python_ok('-m', profilermodule.__name__, '-o', 'out.pstats', 'demo.py')

    assert os.path.exists('out.pstats')
print("ProfileTest::test_output_file_when_changing_directory: ok")
