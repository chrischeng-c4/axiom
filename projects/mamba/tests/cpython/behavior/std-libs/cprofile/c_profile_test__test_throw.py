...
# lib = "cprofile"
# dimension = "behavior"
# case = "c_profile_test__test_throw"
# subject = "cpython.test_cprofile.CProfileTest.test_throw"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_cprofile.py::CProfileTest::test_throw
"""Auto-ported test: CProfileTest::test_throw (CPython 3.12 oracle)."""
...
for func, (cc, nc, _, _, _) in pr.stats.items():
    if func[2] == '<genexpr>':
        ...
        assert nc == 2
print("CProfileTest::test_throw: ok")
