...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_nonlocal"
# subject = "cpython.test_symtable.SymtableTest.test_nonlocal"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_nonlocal
"""Auto-ported test: SymtableTest::test_nonlocal (CPython 3.12 oracle)."""
...
assert not spam.lookup('some_var').is_nonlocal()

assert other_internal.lookup('some_var').is_nonlocal()
expected = ('some_var',)

assert other_internal.get_nonlocals() == expected
print("SymtableTest::test_nonlocal: ok")
