...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_function_info"
# subject = "cpython.test_symtable.SymtableTest.test_function_info"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_function_info
"""Auto-ported test: SymtableTest::test_function_info (CPython 3.12 oracle)."""
...
assert sorted(func.get_parameters()) == ['a', 'b', 'kw', 'var']
expected = ['a', 'b', 'internal', 'kw', 'other_internal', 'some_var', 'var', 'x']

assert sorted(func.get_locals()) == expected

assert sorted(func.get_globals()) == ['bar', 'glob', 'some_assigned_global_var']

assert internal.get_frees() == ('x',)
print("SymtableTest::test_function_info: ok")
