...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_optimized"
# subject = "cpython.test_symtable.SymtableTest.test_optimized"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_optimized
"""Auto-ported test: SymtableTest::test_optimized (CPython 3.12 oracle)."""
...
assert not top.is_optimized()

assert spam.is_optimized()
print("SymtableTest::test_optimized: ok")
