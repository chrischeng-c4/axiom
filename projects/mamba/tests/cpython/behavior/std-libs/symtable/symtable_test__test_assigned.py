...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_assigned"
# subject = "cpython.test_symtable.SymtableTest.test_assigned"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_assigned
"""Auto-ported test: SymtableTest::test_assigned (CPython 3.12 oracle)."""
...
assert not internal.lookup('x').is_assigned()
print("SymtableTest::test_assigned: ok")
