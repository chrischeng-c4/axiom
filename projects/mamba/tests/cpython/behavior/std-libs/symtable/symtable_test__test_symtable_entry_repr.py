...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_symtable_entry_repr"
# subject = "cpython.test_symtable.SymtableTest.test_symtable_entry_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_symtable_entry_repr
"""Auto-ported test: SymtableTest::test_symtable_entry_repr (CPython 3.12 oracle)."""
...
expected = f'<symtable entry top({top.get_id()}), line {top.get_lineno()}>'

assert repr(top._table) == expected
print("SymtableTest::test_symtable_entry_repr: ok")
