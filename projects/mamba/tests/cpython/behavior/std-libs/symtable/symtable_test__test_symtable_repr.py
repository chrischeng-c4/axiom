...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_symtable_repr"
# subject = "cpython.test_symtable.SymtableTest.test_symtable_repr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_symtable_repr
"""Auto-ported test: SymtableTest::test_symtable_repr (CPython 3.12 oracle)."""
...
assert str(top) == '<SymbolTable for module ?>'

assert str(spam) == '<Function SymbolTable for spam in ?>'
print("SymtableTest::test_symtable_repr: ok")
