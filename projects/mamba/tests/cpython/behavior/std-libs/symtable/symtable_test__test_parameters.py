...
# lib = "symtable"
# dimension = "behavior"
# case = "symtable_test__test_parameters"
# subject = "cpython.test_symtable.SymtableTest.test_parameters"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_symtable.py::SymtableTest::test_parameters
"""Auto-ported test: SymtableTest::test_parameters (CPython 3.12 oracle)."""
...
assert not spam.lookup('x').is_parameter()
print("SymtableTest::test_parameters: ok")
