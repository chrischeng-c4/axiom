...
# lib = "curses"
# dimension = "behavior"
# case = "textbox_test__test_move_left_and_right"
# subject = "cpython.test_curses.TextboxTest.test_move_left_and_right"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TextboxTest::test_move_left_and_right
"""Auto-ported test: TextboxTest::test_move_left_and_right (CPython 3.12 oracle)."""
...
self_textbox.do_command(curses.KEY_RIGHT)
self_mock_win.move.assert_called_with(1, 2)
self_mock_win.reset_mock()
print("TextboxTest::test_move_left_and_right: ok")
