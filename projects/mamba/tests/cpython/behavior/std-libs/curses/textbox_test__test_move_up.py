...
# lib = "curses"
# dimension = "behavior"
# case = "textbox_test__test_move_up"
# subject = "cpython.test_curses.TextboxTest.test_move_up"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TextboxTest::test_move_up
"""Auto-ported test: TextboxTest::test_move_up (CPython 3.12 oracle)."""
...
self_textbox.do_command(curses.KEY_UP)
self_mock_win.move.assert_called_with(0, 1)
self_mock_win.reset_mock()
print("TextboxTest::test_move_up: ok")
