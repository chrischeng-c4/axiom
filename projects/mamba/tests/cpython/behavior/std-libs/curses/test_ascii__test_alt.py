...
# lib = "curses"
# dimension = "behavior"
# case = "test_ascii__test_alt"
# subject = "cpython.test_curses.TestAscii.test_alt"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestAscii::test_alt
"""Auto-ported test: TestAscii::test_alt (CPython 3.12 oracle)."""
...
assert alt(ord('A')) == 193
print("TestAscii::test_alt: ok")
