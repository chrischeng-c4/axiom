...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_scroll"
# subject = "cpython.test_curses.TestCurses.test_scroll"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_scroll
"""Auto-ported test: TestCurses::test_scroll (CPython 3.12 oracle)."""
...
assert win.instr(0, 0) == b'dolor sit amet,'
win.scroll(2)

assert win.instr(0, 0) == b'adipiscing elit'
win.scroll(-3)
...
assert win.instr(3, 0) == b'adipiscing elit'
win.scrollok(False)
print("TestCurses::test_scroll: ok")
