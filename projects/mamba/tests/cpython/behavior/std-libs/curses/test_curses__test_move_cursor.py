...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_move_cursor"
# subject = "cpython.test_curses.TestCurses.test_move_cursor"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_move_cursor
"""Auto-ported test: TestCurses::test_move_cursor (CPython 3.12 oracle)."""
...
assert stdscr.getyx() == (1, 2)

assert win.getyx() == (2, 4)
win.cursyncup()

assert stdscr.getyx() == (4, 9)
print("TestCurses::test_move_cursor: ok")
