...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_output_string_embedded_null_chars"
# subject = "cpython.test_curses.TestCurses.test_output_string_embedded_null_chars"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_output_string_embedded_null_chars
"""Auto-ported test: TestCurses::test_output_string_embedded_null_chars (CPython 3.12 oracle)."""
...
for arg in ['a\x00', b'a\x00']:
    ...
    try:
        stdscr.insnstr(arg, 1)
        raise AssertionError('expected ValueError')
    except ValueError:
        pass
print("TestCurses::test_output_string_embedded_null_chars: ok")
