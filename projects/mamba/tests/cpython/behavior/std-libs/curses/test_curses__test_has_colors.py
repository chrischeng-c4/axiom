...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_has_colors"
# subject = "cpython.test_curses.TestCurses.test_has_colors"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_has_colors
"""Auto-ported test: TestCurses::test_has_colors (CPython 3.12 oracle)."""
...
assert isinstance(curses.has_colors(), bool)

assert isinstance(curses.can_change_color(), bool)
print("TestCurses::test_has_colors: ok")
