...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_resize"
# subject = "cpython.test_curses.TestCurses.test_resize"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_resize
"""Auto-ported test: TestCurses::test_resize (CPython 3.12 oracle)."""
...
assert win.getmaxyx() == (4, 20)
win.resize(5, 15)

assert win.getmaxyx() == (5, 15)
print("TestCurses::test_resize: ok")
