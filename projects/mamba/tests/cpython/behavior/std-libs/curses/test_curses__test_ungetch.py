...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_ungetch"
# subject = "cpython.test_curses.TestCurses.test_ungetch"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_ungetch
"""Auto-ported test: TestCurses::test_ungetch (CPython 3.12 oracle)."""
...
assert self_stdscr.getkey() == 'A'
curses.ungetch('B')

assert self_stdscr.getkey() == 'B'
curses.ungetch(67)

assert self_stdscr.getkey() == 'C'
print("TestCurses::test_ungetch: ok")
