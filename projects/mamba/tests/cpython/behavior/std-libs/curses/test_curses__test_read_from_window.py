...
# lib = "curses"
# dimension = "behavior"
# case = "test_curses__test_read_from_window"
# subject = "cpython.test_curses.TestCurses.test_read_from_window"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestCurses::test_read_from_window
"""Auto-ported test: TestCurses::test_read_from_window (CPython 3.12 oracle)."""
...
assert stdscr.inch() == 65 | curses.A_BOLD

assert stdscr.inch(0, 3) == 67 | curses.A_BOLD
stdscr.move(0, 0)

assert stdscr.instr()[:6] == b' ABCD '

assert stdscr.instr(3)[:6] == b' AB'

assert stdscr.instr(0, 2)[:4] == b'BCD '
...
try:
    ...
    pass
print("TestCurses::test_read_from_window: ok")
