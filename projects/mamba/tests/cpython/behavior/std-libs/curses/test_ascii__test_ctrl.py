...
# lib = "curses"
# dimension = "behavior"
# case = "test_ascii__test_ctrl"
# subject = "cpython.test_curses.TestAscii.test_ctrl"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_curses.py::TestAscii::test_ctrl
"""Auto-ported test: TestAscii::test_ctrl (CPython 3.12 oracle)."""
...
assert ctrl(ord('J')) == ord('\n')
print("TestAscii::test_ctrl: ok")
