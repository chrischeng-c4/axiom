...
# lib = "memoryio"
# dimension = "behavior"
# case = "py_bytes_io_test__test_write"
# subject = "cpython.test_memoryio.PyBytesIOTest.test_write"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::PyBytesIOTest::test_write
"""Auto-ported test: PyBytesIOTest::test_write (CPython 3.12 oracle)."""
...
def write_ops(f, t):
    ...
    assert f.tell() == 1
buf = buftype('hello world\n')
memio = ioclass(buf)
write_ops(memio, buftype)
...
try:
    ...
    pass
print("PyBytesIOTest::test_write: ok")
