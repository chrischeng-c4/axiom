...
# lib = "memoryio"
# dimension = "behavior"
# case = "c_string_io_test__test_overseek"
# subject = "cpython.test_memoryio.CStringIOTest.test_overseek"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::CStringIOTest::test_overseek
"""Auto-ported test: CStringIOTest::test_overseek (CPython 3.12 oracle)."""
...
assert memio.seek(len(buf) + 1) == 11

assert memio.read() == EOF

assert memio.tell() == 11
...
assert memio.getvalue() == buf + buftype('\x00') + buf
print("CStringIOTest::test_overseek: ok")
