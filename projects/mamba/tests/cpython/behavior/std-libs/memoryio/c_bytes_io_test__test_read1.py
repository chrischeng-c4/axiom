...
# lib = "memoryio"
# dimension = "behavior"
# case = "c_bytes_io_test__test_read1"
# subject = "cpython.test_memoryio.CBytesIOTest.test_read1"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_memoryio.py::CBytesIOTest::test_read1
"""Auto-ported test: CBytesIOTest::test_read1 (CPython 3.12 oracle)."""
...
assert ioclass(buf).read1() == buf

assert ioclass(buf).read1(-1) == buf
print("CBytesIOTest::test_read1: ok")
