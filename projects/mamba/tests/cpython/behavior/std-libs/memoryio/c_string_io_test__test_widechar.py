...
# lib = "memoryio"
# dimension = "behavior"
# case = "c_string_io_test__test_widechar"
# subject = "cpython.test_memoryio.CStringIOTest.test_widechar"
# kind = "semantic"
# xfail = ""
# mem_carveout = ""
...
# status = "filled"
# ///
# Auto-ported from CPython 3.12 test_memoryio.py::CStringIOTest::test_widechar
"""Auto-ported test: CStringIOTest::test_widechar (CPython 3.12 oracle)."""
...
assert memio.write(buf) == len(buf)

assert memio.tell() == len(buf)

assert memio.getvalue() == buf

assert memio.write(buf) == len(buf)

assert memio.tell() == len(buf) * 2

assert memio.getvalue() == buf + buf
print("CStringIOTest::test_widechar: ok")
