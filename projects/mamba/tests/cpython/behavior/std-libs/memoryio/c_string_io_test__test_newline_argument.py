...
# lib = "memoryio"
# dimension = "behavior"
# case = "c_string_io_test__test_newline_argument"
# subject = "cpython.test_memoryio.CStringIOTest.test_newline_argument"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_memoryio.py::CStringIOTest::test_newline_argument
"""Auto-ported test: CStringIOTest::test_newline_argument (CPython 3.12 oracle)."""
...
try:
    ioclass(newline='error')
    raise AssertionError('expected ValueError')
except ValueError:
    pass
for newline in (None, '', '\n', '\r', '\r\n'):
    ioclass(newline=newline)
print("CStringIOTest::test_newline_argument: ok")
