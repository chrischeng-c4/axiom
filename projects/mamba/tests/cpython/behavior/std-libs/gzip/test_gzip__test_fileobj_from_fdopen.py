...
# lib = "gzip"
# dimension = "behavior"
# case = "test_gzip__test_fileobj_from_fdopen"
# subject = "cpython.test_gzip.TestGzip.test_fileobj_from_fdopen"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_gzip.py::TestGzip::test_fileobj_from_fdopen
"""Auto-ported test: TestGzip::test_fileobj_from_fdopen (CPython 3.12 oracle)."""
...
with os.fdopen(fd, 'wb') as raw:
    ...
    try:
        ...
        pass
fd = os.open(filename, os.O_WRONLY | os.O_CREAT | os.O_APPEND)
...
with os.fdopen(fd, 'rb') as raw:
    ...
    try:
        ...
        pass
print("TestGzip::test_fileobj_from_fdopen: ok")
