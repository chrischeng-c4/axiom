...
# lib = "gzip"
# dimension = "behavior"
# case = "test_gzip__test_bytes_filename"
# subject = "cpython.test_gzip.TestGzip.test_bytes_filename"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_gzip.py::TestGzip::test_bytes_filename
"""Auto-ported test: TestGzip::test_bytes_filename (CPython 3.12 oracle)."""
...
assert f.name == str_filename
print("TestGzip::test_bytes_filename: ok")
