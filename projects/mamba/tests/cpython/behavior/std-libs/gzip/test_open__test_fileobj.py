...
# lib = "gzip"
# dimension = "behavior"
# case = "test_open__test_fileobj"
# subject = "cpython.test_gzip.TestOpen.test_fileobj"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_gzip.py::TestOpen::test_fileobj
"""Auto-ported test: TestOpen::test_fileobj (CPython 3.12 oracle)."""
...
with gzip.open(io.BytesIO(compressed), 'r') as f:
    ...
    assert f.read() == uncompressed_bytes
with gzip.open(io.BytesIO(compressed), 'rb') as f:

    assert f.read() == uncompressed_bytes
with gzip.open(io.BytesIO(compressed), 'rt', encoding='ascii') as f:

    assert f.read() == uncompressed_str
print("TestOpen::test_fileobj: ok")
