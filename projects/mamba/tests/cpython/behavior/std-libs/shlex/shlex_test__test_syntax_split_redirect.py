...
# lib = "shlex"
# dimension = "behavior"
# case = "shlex_test__test_syntax_split_redirect"
# subject = "cpython.test_shlex.ShlexTest.testSyntaxSplitRedirect"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shlex.py::ShlexTest::testSyntaxSplitRedirect
"""Auto-ported test: ShlexTest::testSyntaxSplitRedirect (CPython 3.12 oracle)."""
...
for delimiter in ('<', '|'):
    ...
    for ss, ws in itertools.product(src, (False, True)):
        ...
        assert ref == result
print("ShlexTest::testSyntaxSplitRedirect: ok")
