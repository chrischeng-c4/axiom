...
# lib = "shlex"
# dimension = "behavior"
# case = "shlex_test__test_punctuation_with_posix"
# subject = "cpython.test_shlex.ShlexTest.testPunctuationWithPosix"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shlex.py::ShlexTest::testPunctuationWithPosix
"""Auto-ported test: ShlexTest::testPunctuationWithPosix (CPython 3.12 oracle)."""
...
assert list(s) == ['f', '>', '"abc"']
print("ShlexTest::testPunctuationWithPosix: ok")
