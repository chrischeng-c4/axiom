...
# lib = "shlex"
# dimension = "behavior"
# case = "shlex_test__test_join_roundtrip"
# subject = "cpython.test_shlex.ShlexTest.testJoinRoundtrip"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shlex.py::ShlexTest::testJoinRoundtrip
"""Auto-ported test: ShlexTest::testJoinRoundtrip (CPython 3.12 oracle)."""
...
for item in self_posix_data:
    item[0] = item[0].replace('\\n', '\n')
all_data = self_data + self_posix_data
for command, *split_command in all_data:
    joined = shlex.join(split_command)
    resplit = shlex.split(joined)

    assert split_command == resplit
print("ShlexTest::testJoinRoundtrip: ok")
