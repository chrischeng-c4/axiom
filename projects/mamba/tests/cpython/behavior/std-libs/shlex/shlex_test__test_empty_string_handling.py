...
# lib = "shlex"
# dimension = "behavior"
# case = "shlex_test__test_empty_string_handling"
# subject = "cpython.test_shlex.ShlexTest.testEmptyStringHandling"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_shlex.py::ShlexTest::testEmptyStringHandling
"""Auto-ported test: ShlexTest::testEmptyStringHandling (CPython 3.12 oracle)."""
...
for punct in (False, True):
    ...
    assert slist == expected
expected = ["''", ')', 'abc']
s = shlex.shlex("'')abc", punctuation_chars=True)

assert list(s) == expected
print("ShlexTest::testEmptyStringHandling: ok")
