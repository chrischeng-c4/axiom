...
# lib = "import"
# dimension = "behavior"
# case = "import_tests__test_issue31286"
# subject = "cpython.__init__.ImportTests.test_issue31286"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTests::test_issue31286
"""Auto-ported test: ImportTests::test_issue31286 (CPython 3.12 oracle)."""
...
for i in range(2):
    import test.support.script_helper as x
print("ImportTests::test_issue31286: ok")
