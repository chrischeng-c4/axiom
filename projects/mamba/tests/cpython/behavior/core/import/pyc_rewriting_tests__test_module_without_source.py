...
# lib = "import"
# dimension = "behavior"
# case = "pyc_rewriting_tests__test_module_without_source"
# subject = "cpython.__init__.PycRewritingTests.test_module_without_source"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::PycRewritingTests::test_module_without_source
"""Auto-ported test: PycRewritingTests::test_module_without_source (CPython 3.12 oracle)."""
...
py_compile.compile(file_name, dfile=target)
os.remove(file_name)
pyc_file = make_legacy_pyc(file_name)
importlib.invalidate_caches()
mod = import_module()

assert mod.module_filename == pyc_file

assert mod.code_filename == target

assert mod.func_filename == target
print("PycRewritingTests::test_module_without_source: ok")
