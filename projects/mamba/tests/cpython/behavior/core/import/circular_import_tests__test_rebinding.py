...
# lib = "import"
# dimension = "behavior"
# case = "circular_import_tests__test_rebinding"
# subject = "cpython.__init__.CircularImportTests.test_rebinding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::CircularImportTests::test_rebinding
"""Auto-ported test: CircularImportTests::test_rebinding (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('circular import with rebinding of module attribute failed')
from test.test_import.data.circular_imports.subpkg import util

assert util.util is rebinding.util
print("CircularImportTests::test_rebinding: ok")
