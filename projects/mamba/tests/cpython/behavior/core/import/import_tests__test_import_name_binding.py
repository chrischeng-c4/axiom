...
# lib = "import"
# dimension = "behavior"
# case = "import_tests__test_import_name_binding"
# subject = "cpython.__init__.ImportTests.test_import_name_binding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTests::test_import_name_binding
"""Auto-ported test: ImportTests::test_import_name_binding (CPython 3.12 oracle)."""
...
assert hasattr(test.support, '__file__')
import test.support as y

assert y is test.support
print("ImportTests::test_import_name_binding: ok")
