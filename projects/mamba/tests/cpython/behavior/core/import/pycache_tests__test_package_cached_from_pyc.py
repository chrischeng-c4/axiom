...
# lib = "import"
# dimension = "behavior"
# case = "pycache_tests__test_package_cached_from_pyc"
# subject = "cpython.__init__.PycacheTests.test_package___cached___from_pyc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::PycacheTests::test_package___cached___from_pyc
"""Auto-ported test: PycacheTests::test_package___cached___from_pyc (CPython 3.12 oracle)."""
...
def _clean():
    ...
    rmtree('__pycache__')
    unlink(self_source)
self_source = TESTFN + '.py'
_clean()
with open(self_source, 'w', encoding='utf-8') as fp:
...
importlib.invalidate_caches()
m = __import__('pep3147.foo')
init_pyc = importlib.util.cache_from_source(os.path.join('pep3147', '__init__.py'))

assert m.__cached__ == os.path.join(os.getcwd(), init_pyc)
foo_pyc = importlib.util.cache_from_source(os.path.join('pep3147', 'foo.py'))

assert sys.modules['pep3147.foo'].__cached__ == os.path.join(os.getcwd(), foo_pyc)
print("PycacheTests::test_package___cached___from_pyc: ok")
