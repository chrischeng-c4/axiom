...
# lib = "import"
# dimension = "behavior"
# case = "import_tests__test_from_import_missing_attr_has_name"
# subject = "cpython.__init__.ImportTests.test_from_import_missing_attr_has_name"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTests::test_from_import_missing_attr_has_name
"""Auto-ported test: ImportTests::test_from_import_missing_attr_has_name (CPython 3.12 oracle)."""
...
assert cm.exception.name == '_warning'

assert cm.exception.path is None
print("ImportTests::test_from_import_missing_attr_has_name: ok")
