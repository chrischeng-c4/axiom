...
# lib = "import"
# dimension = "behavior"
# case = "import_traceback_tests__test_syntax_error"
# subject = "cpython.__init__.ImportTracebackTests.test_syntax_error"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTracebackTests::test_syntax_error
"""Auto-ported test: ImportTracebackTests::test_syntax_error (CPython 3.12 oracle)."""
...
create_module('foo', 'invalid syntax is invalid')
try:
    import foo
...
assert_traceback(tb, [__file__])
print("ImportTracebackTests::test_syntax_error: ok")
