...
# lib = "import"
# dimension = "behavior"
# case = "import_tests__test_from_import_message_for_nonexistent_module"
# subject = "cpython.__init__.ImportTests.test_from_import_message_for_nonexistent_module"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTests::test_from_import_message_for_nonexistent_module
"""Auto-ported test: ImportTests::test_from_import_message_for_nonexistent_module (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search("^No module named 'bogus'", str(_aR_e))
print("ImportTests::test_from_import_message_for_nonexistent_module: ok")
