...
# lib = "import"
# dimension = "behavior"
# case = "import_tests__test_from_import_message_for_existing_module"
# subject = "cpython.__init__.ImportTests.test_from_import_message_for_existing_module"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::ImportTests::test_from_import_message_for_existing_module
"""Auto-ported test: ImportTests::test_from_import_message_for_existing_module (CPython 3.12 oracle)."""
...
try:
    ...
    import re as _re_aR
    assert _re_aR.search("^cannot import name 'bogus'", str(_aR_e))
print("ImportTests::test_from_import_message_for_existing_module: ok")
