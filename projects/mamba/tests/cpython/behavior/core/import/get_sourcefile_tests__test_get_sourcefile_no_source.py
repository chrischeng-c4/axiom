...
# lib = "import"
# dimension = "behavior"
# case = "get_sourcefile_tests__test_get_sourcefile_no_source"
# subject = "cpython.__init__.GetSourcefileTests.test_get_sourcefile_no_source"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::GetSourcefileTests::test_get_sourcefile_no_source
"""Auto-ported test: GetSourcefileTests::test_get_sourcefile_no_source (CPython 3.12 oracle)."""
...
with mock.patch('importlib._bootstrap_external._path_isfile') as _path_isfile:
    ...
    assert _get_sourcefile(path) == path
print("GetSourcefileTests::test_get_sourcefile_no_source: ok")
