...
# lib = "import"
# dimension = "behavior"
# case = "subinterp_import_tests__test_disallowed_reimport"
# subject = "cpython.__init__.SubinterpImportTests.test_disallowed_reimport"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::SubinterpImportTests::test_disallowed_reimport
"""Auto-ported test: SubinterpImportTests::test_disallowed_reimport (CPython 3.12 oracle)."""
...
try:
    _interpreters.run_string(interpid, script)
    raise AssertionError('expected _interpreters.RunFailedError')
...
try:
    ...
    pass
print("SubinterpImportTests::test_disallowed_reimport: ok")
