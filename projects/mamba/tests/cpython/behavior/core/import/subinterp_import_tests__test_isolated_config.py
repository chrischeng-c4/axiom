...
# lib = "import"
# dimension = "behavior"
# case = "subinterp_import_tests__test_isolated_config"
# subject = "cpython.__init__.SubinterpImportTests.test_isolated_config"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::SubinterpImportTests::test_isolated_config
"""Auto-ported test: SubinterpImportTests::test_isolated_config (CPython 3.12 oracle)."""
...
check_compatible_here(module, strict=True, isolated=True)
check_compatible_fresh(module, strict=True, isolated=True)
print("SubinterpImportTests::test_isolated_config: ok")
