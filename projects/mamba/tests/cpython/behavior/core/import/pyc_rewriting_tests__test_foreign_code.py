...
# lib = "import"
# dimension = "behavior"
# case = "pyc_rewriting_tests__test_foreign_code"
# subject = "cpython.__init__.PycRewritingTests.test_foreign_code"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 __init__.py::PycRewritingTests::test_foreign_code
"""Auto-ported test: PycRewritingTests::test_foreign_code (CPython 3.12 oracle)."""
...
def import_module():
    ns = globals()
    __import__(module_name, ns, ns)
    return sys.modules[module_name]
self_sys_path = sys.path[:]
self_orig_module = sys.modules.pop(module_name, None)
os.mkdir(dir_name)
...
assert mod.constant.co_filename == foreign_code.co_filename
print("PycRewritingTests::test_foreign_code: ok")
