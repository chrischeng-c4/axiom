...
# lib = "with"
# dimension = "behavior"
# case = "failure_test_case__test_assignment_to_tuple_containing_none_error"
# subject = "cpython.test_with.FailureTestCase.testAssignmentToTupleContainingNoneError"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_with.py::FailureTestCase::testAssignmentToTupleContainingNoneError
"""Auto-ported test: FailureTestCase::testAssignmentToTupleContainingNoneError (CPython 3.12 oracle)."""
...
def assertRaisesSyntaxError(codestr):
    ...
    try:
        ...
        pass
assertRaisesSyntaxError('with mock as (foo, None, bar):\n  pass')
print("FailureTestCase::testAssignmentToTupleContainingNoneError: ok")
