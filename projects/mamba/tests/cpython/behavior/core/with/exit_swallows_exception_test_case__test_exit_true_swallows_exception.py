...
# lib = "with"
# dimension = "behavior"
# case = "exit_swallows_exception_test_case__test_exit_true_swallows_exception"
# subject = "cpython.test_with.ExitSwallowsExceptionTestCase.testExitTrueSwallowsException"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_with.py::ExitSwallowsExceptionTestCase::testExitTrueSwallowsException
"""Auto-ported test: ExitSwallowsExceptionTestCase::testExitTrueSwallowsException (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('ZeroDivisionError should have been swallowed')
print("ExitSwallowsExceptionTestCase::testExitTrueSwallowsException: ok")
