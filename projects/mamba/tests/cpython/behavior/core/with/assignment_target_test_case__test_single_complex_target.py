...
# lib = "with"
# dimension = "behavior"
# case = "assignment_target_test_case__test_single_complex_target"
# subject = "cpython.test_with.AssignmentTargetTestCase.testSingleComplexTarget"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_with.py::AssignmentTargetTestCase::testSingleComplexTarget
"""Auto-ported test: AssignmentTargetTestCase::testSingleComplexTarget (CPython 3.12 oracle)."""
...
with mock_contextmanager_generator() as targets[1][0]:
    ...
    assert list(targets.keys()) == [1]

    assert targets[1][0].__class__ == MockResource
with mock_contextmanager_generator() as list(targets.values())[0][1]:

    assert list(targets.keys()) == [1]

    assert targets[1][1].__class__ == MockResource
...
with mock_contextmanager_generator() as blah.foo:
    ...
    assert hasattr(blah, 'foo') == True
print("AssignmentTargetTestCase::testSingleComplexTarget: ok")
