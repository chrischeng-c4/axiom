...
# lib = "peepholer"
# dimension = "behavior"
# case = "test_tranforms__test_constant_folding"
# subject = "cpython.test_peepholer.TestTranforms.test_constant_folding"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_peepholer.py::TestTranforms::test_constant_folding
"""Auto-ported test: TestTranforms::test_constant_folding (CPython 3.12 oracle)."""
...
for e in exprs:
    ...
    for instr in dis.get_instructions(code):
        ...
        assert not instr.opname.startswith('UNARY_')

        assert not instr.opname.startswith('BINARY_')

        assert not instr.opname.startswith('BUILD_')
    check_lnotab(code)
print("TestTranforms::test_constant_folding: ok")
