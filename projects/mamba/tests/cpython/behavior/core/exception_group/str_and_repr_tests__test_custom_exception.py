...
# lib = "exception_group"
# dimension = "behavior"
# case = "str_and_repr_tests__test_custom_exception"
# subject = "cpython.test_exception_group.StrAndReprTests.test_custom_exception"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exception_group.py::StrAndReprTests::test_custom_exception
"""Auto-ported test: StrAndReprTests::test_custom_exception (CPython 3.12 oracle)."""
...
class MyEG(ExceptionGroup):
    pass
eg = MyEG('flat', [ValueError(1), TypeError(2)])

assert str(eg) == 'flat (2 sub-exceptions)'

assert repr(eg) == "MyEG('flat', [ValueError(1), TypeError(2)])"
eg = MyEG('nested', [eg, ValueError(1), eg, TypeError(2)])

assert str(eg) == 'nested (4 sub-exceptions)'

assert repr(eg) == "MyEG('nested', [MyEG('flat', [ValueError(1), TypeError(2)]), ValueError(1), MyEG('flat', [ValueError(1), TypeError(2)]), TypeError(2)])"
print("StrAndReprTests::test_custom_exception: ok")
