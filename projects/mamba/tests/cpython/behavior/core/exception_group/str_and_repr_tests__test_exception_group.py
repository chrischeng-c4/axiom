...
# lib = "exception_group"
# dimension = "behavior"
# case = "str_and_repr_tests__test_exception_group"
# subject = "cpython.test_exception_group.StrAndReprTests.test_ExceptionGroup"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exception_group.py::StrAndReprTests::test_ExceptionGroup
"""Auto-ported test: StrAndReprTests::test_ExceptionGroup (CPython 3.12 oracle)."""
...
assert repr(eg) == "ExceptionGroup('flat', [ValueError(1), TypeError(2)])"
eg = BaseExceptionGroup('nested', [eg, ValueError(1), eg, TypeError(2)])

assert str(eg) == 'nested (4 sub-exceptions)'

assert repr(eg) == "ExceptionGroup('nested', [ExceptionGroup('flat', [ValueError(1), TypeError(2)]), ValueError(1), ExceptionGroup('flat', [ValueError(1), TypeError(2)]), TypeError(2)])"
print("StrAndReprTests::test_ExceptionGroup: ok")
