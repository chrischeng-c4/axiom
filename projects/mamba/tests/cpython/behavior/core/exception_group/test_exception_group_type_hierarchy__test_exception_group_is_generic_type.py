...
# lib = "exception_group"
# dimension = "behavior"
# case = "test_exception_group_type_hierarchy__test_exception_group_is_generic_type"
# subject = "cpython.test_exception_group.TestExceptionGroupTypeHierarchy.test_exception_group_is_generic_type"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exception_group.py::TestExceptionGroupTypeHierarchy::test_exception_group_is_generic_type
"""Auto-ported test: TestExceptionGroupTypeHierarchy::test_exception_group_is_generic_type (CPython 3.12 oracle)."""
...
assert isinstance(ExceptionGroup[E], types.GenericAlias)

assert isinstance(BaseExceptionGroup[E], types.GenericAlias)
print("TestExceptionGroupTypeHierarchy::test_exception_group_is_generic_type: ok")
