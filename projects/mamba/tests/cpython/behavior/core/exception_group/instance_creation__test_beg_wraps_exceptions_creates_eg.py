...
# lib = "exception_group"
# dimension = "behavior"
# case = "instance_creation__test_beg_wraps_exceptions_creates_eg"
# subject = "cpython.test_exception_group.InstanceCreation.test_BEG_wraps_Exceptions__creates_EG"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exception_group.py::InstanceCreation::test_BEG_wraps_Exceptions__creates_EG
"""Auto-ported test: InstanceCreation::test_BEG_wraps_Exceptions__creates_EG (CPython 3.12 oracle)."""
...
assert type(BaseExceptionGroup('beg', excs)) is ExceptionGroup
print("InstanceCreation::test_BEG_wraps_Exceptions__creates_EG: ok")
