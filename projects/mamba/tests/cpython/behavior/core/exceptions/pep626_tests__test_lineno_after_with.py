...
# lib = "exceptions"
# dimension = "behavior"
# case = "pep626_tests__test_lineno_after_with"
# subject = "cpython.test_exceptions.PEP626Tests.test_lineno_after_with"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::PEP626Tests::test_lineno_after_with
"""Auto-ported test: PEP626Tests::test_lineno_after_with (CPython 3.12 oracle)."""
...
def after_with():
    with Noop():
        1 / 0
        pass
lineno_after_raise(after_with, 2)
print("PEP626Tests::test_lineno_after_with: ok")
