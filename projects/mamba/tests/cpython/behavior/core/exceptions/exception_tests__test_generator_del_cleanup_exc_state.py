...
# lib = "exceptions"
# dimension = "behavior"
# case = "exception_tests__test_generator_del_cleanup_exc_state"
# subject = "cpython.test_exceptions.ExceptionTests.test_generator_del_cleanup_exc_state"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::ExceptionTests::test_generator_del_cleanup_exc_state
"""Auto-ported test: ExceptionTests::test_generator_del_cleanup_exc_state (CPython 3.12 oracle)."""
...
def do_del(g):
    g = None
_check_generator_cleanup_exc_state(do_del)
print("ExceptionTests::test_generator_del_cleanup_exc_state: ok")
