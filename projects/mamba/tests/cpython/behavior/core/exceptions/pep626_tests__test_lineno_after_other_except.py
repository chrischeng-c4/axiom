...
# lib = "exceptions"
# dimension = "behavior"
# case = "pep626_tests__test_lineno_after_other_except"
# subject = "cpython.test_exceptions.PEP626Tests.test_lineno_after_other_except"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::PEP626Tests::test_lineno_after_other_except
"""Auto-ported test: PEP626Tests::test_lineno_after_other_except (CPython 3.12 oracle)."""
...
def other_except():
    try:
        ...
        pass
lineno_after_raise(other_except, 3)
print("PEP626Tests::test_lineno_after_other_except: ok")
