...
# lib = "exceptions"
# dimension = "behavior"
# case = "pep626_tests__test_lineno_in_finally_normal"
# subject = "cpython.test_exceptions.PEP626Tests.test_lineno_in_finally_normal"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::PEP626Tests::test_lineno_in_finally_normal
"""Auto-ported test: PEP626Tests::test_lineno_in_finally_normal (CPython 3.12 oracle)."""
...
def in_finally_normal():
    try:
        ...
        1 / 0
        pass
lineno_after_raise(in_finally_normal, 4)
print("PEP626Tests::test_lineno_in_finally_normal: ok")
