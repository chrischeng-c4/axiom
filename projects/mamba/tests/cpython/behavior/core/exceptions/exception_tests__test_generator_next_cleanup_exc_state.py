...
# lib = "exceptions"
# dimension = "behavior"
# case = "exception_tests__test_generator_next_cleanup_exc_state"
# subject = "cpython.test_exceptions.ExceptionTests.test_generator_next_cleanup_exc_state"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::ExceptionTests::test_generator_next_cleanup_exc_state
"""Auto-ported test: ExceptionTests::test_generator_next_cleanup_exc_state (CPython 3.12 oracle)."""
...
_check_generator_cleanup_exc_state(do_next)
print("ExceptionTests::test_generator_next_cleanup_exc_state: ok")
