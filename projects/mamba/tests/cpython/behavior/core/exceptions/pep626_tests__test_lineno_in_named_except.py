...
# lib = "exceptions"
# dimension = "behavior"
# case = "pep626_tests__test_lineno_in_named_except"
# subject = "cpython.test_exceptions.PEP626Tests.test_lineno_in_named_except"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_exceptions.py::PEP626Tests::test_lineno_in_named_except
"""Auto-ported test: PEP626Tests::test_lineno_in_named_except (CPython 3.12 oracle)."""
...
def in_named_except():
    try:
        ...
        1 / 0
        pass
lineno_after_raise(in_named_except, 4)
print("PEP626Tests::test_lineno_in_named_except: ok")
