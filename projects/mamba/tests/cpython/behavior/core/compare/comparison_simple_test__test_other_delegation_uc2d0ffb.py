...
_suite = unittest.defaultTestLoader.loadTestsFromName("ComparisonSimpleTest.test_other_delegation", test_compare)
_result = unittest.TextTestRunner(stream=io.StringIO(), verbosity=0).run(_suite)
assert _result.wasSuccessful(), "CPython ComparisonSimpleTest.test_other_delegation did not pass"
