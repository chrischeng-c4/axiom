...
# lib = "compile"
# dimension = "behavior"
# case = "test_source_positions__test_multiline_list_comprehension"
# subject = "cpython.test_compile.TestSourcePositions.test_multiline_list_comprehension"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestSourcePositions::test_multiline_list_comprehension
"""Auto-ported test: TestSourcePositions::test_multiline_list_comprehension (CPython 3.12 oracle)."""
...
assertOpcodeSourcePositionIs(compiled_code, 'LIST_APPEND', line=1, end_line=2, column=1, end_column=8, occurrence=1)
assertOpcodeSourcePositionIs(compiled_code, 'JUMP_BACKWARD', line=1, end_line=2, column=1, end_column=8, occurrence=1)
print("TestSourcePositions::test_multiline_list_comprehension: ok")
