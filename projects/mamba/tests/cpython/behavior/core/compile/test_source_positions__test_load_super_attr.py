...
# lib = "compile"
# dimension = "behavior"
# case = "test_source_positions__test_load_super_attr"
# subject = "cpython.test_compile.TestSourcePositions.test_load_super_attr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestSourcePositions::test_load_super_attr
"""Auto-ported test: TestSourcePositions::test_load_super_attr (CPython 3.12 oracle)."""
...
assertOpcodeSourcePositionIs(code, 'LOAD_GLOBAL', line=3, end_line=3, column=4, end_column=9)
print("TestSourcePositions::test_load_super_attr: ok")
