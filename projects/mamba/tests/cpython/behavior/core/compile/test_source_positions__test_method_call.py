...
# lib = "compile"
# dimension = "behavior"
# case = "test_source_positions__test_method_call"
# subject = "cpython.test_compile.TestSourcePositions.test_method_call"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestSourcePositions::test_method_call
"""Auto-ported test: TestSourcePositions::test_method_call (CPython 3.12 oracle)."""
...
assertOpcodeSourcePositionIs(code, 'CALL', line=4, end_line=5, column=5, end_column=10)
print("TestSourcePositions::test_method_call: ok")
