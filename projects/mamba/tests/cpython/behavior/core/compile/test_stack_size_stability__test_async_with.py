...
# lib = "compile"
# dimension = "behavior"
# case = "test_stack_size_stability__test_async_with"
# subject = "cpython.test_compile.TestStackSizeStability.test_async_with"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestStackSizeStability::test_async_with
"""Auto-ported test: TestStackSizeStability::test_async_with (CPython 3.12 oracle)."""
...
print("TestStackSizeStability::test_async_with: ok")
