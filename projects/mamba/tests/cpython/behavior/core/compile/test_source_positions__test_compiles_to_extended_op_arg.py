...
# lib = "compile"
# dimension = "behavior"
# case = "test_source_positions__test_compiles_to_extended_op_arg"
# subject = "cpython.test_compile.TestSourcePositions.test_compiles_to_extended_op_arg"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestSourcePositions::test_compiles_to_extended_op_arg
"""Auto-ported test: TestSourcePositions::test_compiles_to_extended_op_arg (CPython 3.12 oracle)."""
...
assertOpcodeSourcePositionIs(compiled_code, 'BINARY_OP', line=10000 + 2, end_line=10000 + 2, column=2, end_column=8, occurrence=1)
assertOpcodeSourcePositionIs(compiled_code, 'BINARY_OP', line=10000 + 4, end_line=10000 + 4, column=2, end_column=9, occurrence=2)
print("TestSourcePositions::test_compiles_to_extended_op_arg: ok")
