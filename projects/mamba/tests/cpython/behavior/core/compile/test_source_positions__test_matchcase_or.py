...
# lib = "compile"
# dimension = "behavior"
# case = "test_source_positions__test_matchcase_or"
# subject = "cpython.test_compile.TestSourcePositions.test_matchcase_or"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestSourcePositions::test_matchcase_or
"""Auto-ported test: TestSourcePositions::test_matchcase_or (CPython 3.12 oracle)."""
...
assertOpcodeSourcePositionIs(compiled_code, 'MATCH_CLASS', line=2, end_line=2, column=9, end_column=13, occurrence=1)
assertOpcodeSourcePositionIs(compiled_code, 'MATCH_CLASS', line=2, end_line=2, column=16, end_column=20, occurrence=2)
print("TestSourcePositions::test_matchcase_or: ok")
