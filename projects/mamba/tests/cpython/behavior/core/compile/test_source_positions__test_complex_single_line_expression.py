...
# lib = "compile"
# dimension = "behavior"
# case = "test_source_positions__test_complex_single_line_expression"
# subject = "cpython.test_compile.TestSourcePositions.test_complex_single_line_expression"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestSourcePositions::test_complex_single_line_expression
"""Auto-ported test: TestSourcePositions::test_complex_single_line_expression (CPython 3.12 oracle)."""
...
assertOpcodeSourcePositionIs(compiled_code, 'BINARY_SUBSCR', line=1, end_line=1, column=13, end_column=21)
assertOpcodeSourcePositionIs(compiled_code, 'BINARY_OP', line=1, end_line=1, column=9, end_column=21, occurrence=1)
assertOpcodeSourcePositionIs(compiled_code, 'BINARY_OP', line=1, end_line=1, column=9, end_column=26, occurrence=2)
assertOpcodeSourcePositionIs(compiled_code, 'BINARY_OP', line=1, end_line=1, column=4, end_column=27, occurrence=3)
assertOpcodeSourcePositionIs(compiled_code, 'BINARY_OP', line=1, end_line=1, column=0, end_column=27, occurrence=4)
print("TestSourcePositions::test_complex_single_line_expression: ok")
