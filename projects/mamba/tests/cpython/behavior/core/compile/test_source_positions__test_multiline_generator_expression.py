...
# lib = "compile"
# dimension = "behavior"
# case = "test_source_positions__test_multiline_generator_expression"
# subject = "cpython.test_compile.TestSourcePositions.test_multiline_generator_expression"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_compile.py::TestSourcePositions::test_multiline_generator_expression
"""Auto-ported test: TestSourcePositions::test_multiline_generator_expression (CPython 3.12 oracle)."""
...
assertOpcodeSourcePositionIs(compiled_code, 'YIELD_VALUE', line=1, end_line=2, column=1, end_column=8, occurrence=1)
assertOpcodeSourcePositionIs(compiled_code, 'JUMP_BACKWARD', line=1, end_line=2, column=1, end_column=8, occurrence=1)
assertOpcodeSourcePositionIs(compiled_code, 'RETURN_CONST', line=4, end_line=4, column=7, end_column=14, occurrence=1)
print("TestSourcePositions::test_multiline_generator_expression: ok")
