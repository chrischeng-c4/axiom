...
# lib = "sys_settrace"
# dimension = "behavior"
# case = "trace_test_case__test_flow_converges_on_same_line"
# subject = "cpython.test.test_sys_settrace.TraceTestCase.test_flow_converges_on_same_line"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_settrace.py::TraceTestCase::test_flow_converges_on_same_line
"""Auto-ported test: TraceTestCase::test_flow_converges_on_same_line (CPython 3.12 oracle)."""
...
def func():
    for i in range(2):
        foo(i)
run_and_compare(func, [(0, 'call'), (1, 'line'), (2, 'line'), (-8, 'call'), (-7, 'line'), (-2, 'line'), (-2, 'return'), (1, 'line'), (2, 'line'), (-8, 'call'), (-7, 'line'), (-6, 'line'), (-5, 'line'), (-5, 'exception'), (-4, 'line'), (-3, 'line'), (-2, 'line'), (-2, 'return'), (1, 'line'), (1, 'return')])
print("TraceTestCase::test_flow_converges_on_same_line: ok")
