...
# lib = "sys_settrace"
# dimension = "behavior"
# case = "test_set_local_trace__test_if_false_in_try_except"
# subject = "cpython.test.test_sys_settrace.TestSetLocalTrace.test_if_false_in_try_except"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_settrace.py::TestSetLocalTrace::test_if_false_in_try_except
"""Auto-ported test: TestSetLocalTrace::test_if_false_in_try_except (CPython 3.12 oracle)."""
...
def func():
    try:
        ...
        X
run_and_compare(func, [(0, 'call'), (1, 'line'), (2, 'line'), (2, 'return')])
print("TestSetLocalTrace::test_if_false_in_try_except: ok")
