...
# lib = "sys_settrace"
# dimension = "behavior"
# case = "test_set_local_trace__test_set_and_retrieve_func"
# subject = "cpython.test.test_sys_settrace.TestSetLocalTrace.test_set_and_retrieve_func"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_settrace.py::TestSetLocalTrace::test_set_and_retrieve_func
"""Auto-ported test: TestSetLocalTrace::test_set_and_retrieve_func (CPython 3.12 oracle)."""
...
try:
    ...
    sys.settrace(None)
print("TestSetLocalTrace::test_set_and_retrieve_func: ok")
