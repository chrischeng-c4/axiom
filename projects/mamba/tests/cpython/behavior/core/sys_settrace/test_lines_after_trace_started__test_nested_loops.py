...
# lib = "sys_settrace"
# dimension = "behavior"
# case = "test_lines_after_trace_started__test_nested_loops"
# subject = "cpython.test.test_sys_settrace.TestLinesAfterTraceStarted.test_nested_loops"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_settrace.py::TestLinesAfterTraceStarted::test_nested_loops
"""Auto-ported test: TestLinesAfterTraceStarted::test_nested_loops (CPython 3.12 oracle)."""
...
def func():
    for i in range(2):
        for j in range(2):
            a = i + j
    return a == 1
run_and_compare(func, [(0, 'call'), (1, 'line'), (2, 'line'), (3, 'line'), (2, 'line'), (3, 'line'), (2, 'line'), (1, 'line'), (2, 'line'), (3, 'line'), (2, 'line'), (3, 'line'), (2, 'line'), (1, 'line'), (4, 'line'), (4, 'return')])
print("TestLinesAfterTraceStarted::test_nested_loops: ok")
