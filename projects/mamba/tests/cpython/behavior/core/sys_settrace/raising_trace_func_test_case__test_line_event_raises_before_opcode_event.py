...
# lib = "sys_settrace"
# dimension = "behavior"
# case = "raising_trace_func_test_case__test_line_event_raises_before_opcode_event"
# subject = "cpython.test.test_sys_settrace.RaisingTraceFuncTestCase.test_line_event_raises_before_opcode_event"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_settrace.py::RaisingTraceFuncTestCase::test_line_event_raises_before_opcode_event
"""Auto-ported test: RaisingTraceFuncTestCase::test_line_event_raises_before_opcode_event (CPython 3.12 oracle)."""
...
def f():
    ...
    if self_raiseOnEvent == 'exception':
        x = 0
        y = 1 / x
    else:
        return 1

def run_test_for_event(event):
    """Tests that an exception raised in response to the given event is
        handled OK."""
    self_raiseOnEvent = event
    try:
...
assert caught.exception is exception
print("RaisingTraceFuncTestCase::test_line_event_raises_before_opcode_event: ok")
