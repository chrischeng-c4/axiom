...
# lib = "sys_settrace"
# dimension = "behavior"
# case = "trace_test_case__test_break_to_continue2"
# subject = "cpython.test.test_sys_settrace.TraceTestCase.test_break_to_continue2"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_sys_settrace.py::TraceTestCase::test_break_to_continue2
"""Auto-ported test: TraceTestCase::test_break_to_continue2 (CPython 3.12 oracle)."""
...
def func():
    ...
    while x:
        ...
        while TRUE:
            ...
            continue
run_and_compare(func, [(0, 'call'), (1, 'line'), (2, 'line'), (3, 'line'), (4, 'line'), (5, 'line'), (6, 'line'), (3, 'line'), (3, 'return')])
print("TraceTestCase::test_break_to_continue2: ok")
