...
# lib = "grammar"
# dimension = "behavior"
# case = "grammar_tests__test_continue_in_finally"
# subject = "cpython.test_grammar.GrammarTests.test_continue_in_finally"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::GrammarTests::test_continue_in_finally
"""Auto-ported test: GrammarTests::test_continue_in_finally (CPython 3.12 oracle)."""
...
assert count == 1
print("GrammarTests::test_continue_in_finally: ok")
