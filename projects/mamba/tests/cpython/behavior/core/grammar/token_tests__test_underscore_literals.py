...
# lib = "grammar"
# dimension = "behavior"
# case = "token_tests__test_underscore_literals"
# subject = "cpython.test_grammar.TokenTests.test_underscore_literals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::TokenTests::test_underscore_literals
"""Auto-ported test: TokenTests::test_underscore_literals (CPython 3.12 oracle)."""
...
for lit in VALID_UNDERSCORE_LITERALS:
    ...
    assert eval(lit) == eval(lit.replace('_', ''))
...
try:
    ...
    pass
print("TokenTests::test_underscore_literals: ok")
