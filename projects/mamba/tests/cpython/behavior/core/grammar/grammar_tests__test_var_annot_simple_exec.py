...
# lib = "grammar"
# dimension = "behavior"
# case = "grammar_tests__test_var_annot_simple_exec"
# subject = "cpython.test_grammar.GrammarTests.test_var_annot_simple_exec"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::GrammarTests::test_var_annot_simple_exec
"""Auto-ported test: GrammarTests::test_var_annot_simple_exec (CPython 3.12 oracle)."""
...
assert lns['__annotations__'] == {1: 2, 'x': int}
try:
    gns['__annotations__']
    raise AssertionError('expected KeyError')
except KeyError:
    pass
print("GrammarTests::test_var_annot_simple_exec: ok")
