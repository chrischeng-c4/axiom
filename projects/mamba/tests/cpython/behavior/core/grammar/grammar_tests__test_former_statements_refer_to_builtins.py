...
# lib = "grammar"
# dimension = "behavior"
# case = "grammar_tests__test_former_statements_refer_to_builtins"
# subject = "cpython.test_grammar.GrammarTests.test_former_statements_refer_to_builtins"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::GrammarTests::test_former_statements_refer_to_builtins
"""Auto-ported test: GrammarTests::test_former_statements_refer_to_builtins (CPython 3.12 oracle)."""
...
for keyword in keywords:
    ...
    for case in cases:
        ...
        try:
            ...
            import re as _re_aR
            assert _re_aR.search(custom_msg, str(_aR_e))
...
print("GrammarTests::test_former_statements_refer_to_builtins: ok")
