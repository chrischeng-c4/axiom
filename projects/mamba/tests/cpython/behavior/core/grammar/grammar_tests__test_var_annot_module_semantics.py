...
# lib = "grammar"
# dimension = "behavior"
# case = "grammar_tests__test_var_annot_module_semantics"
# subject = "cpython.test_grammar.GrammarTests.test_var_annot_module_semantics"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_grammar.py::GrammarTests::test_var_annot_module_semantics
"""Auto-ported test: GrammarTests::test_var_annot_module_semantics (CPython 3.12 oracle)."""
...
assert ann_module.__annotations__ == {1: 2, 'x': int, 'y': str, 'f': typing.Tuple[int, int], 'u': int | float}

assert ann_module.M.__annotations__ == {'123': 123, 'o': type}

assert ann_module2.__annotations__ == {}
print("GrammarTests::test_var_annot_module_semantics: ok")
