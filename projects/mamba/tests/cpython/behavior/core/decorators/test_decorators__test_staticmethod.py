...
# lib = "decorators"
# dimension = "behavior"
# case = "test_decorators__test_staticmethod"
# subject = "cpython.test_decorators.TestDecorators.test_staticmethod"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_decorators.py::TestDecorators::test_staticmethod
"""Auto-ported test: TestDecorators::test_staticmethod (CPython 3.12 oracle)."""
...
def check_wrapper_attrs(method_wrapper, format_str):
    ...
    return wrapper
wrapper = check_wrapper_attrs(staticmethod, '<staticmethod({!r})>')

assert wrapper(1) == 1
print("TestDecorators::test_staticmethod: ok")
