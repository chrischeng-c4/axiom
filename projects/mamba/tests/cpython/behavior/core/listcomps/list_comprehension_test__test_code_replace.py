...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_code_replace"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_code_replace"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_code_replace
"""Auto-ported test: ListComprehensionTest::test_code_replace (CPython 3.12 oracle)."""
...
def _replacing_exec(code_string, ns):
    ...
    exec(co, ns)
code = '\n            x = 3\n            [x for x in (1, 2)]\n            dir()\n            y = [x]\n        '
_check_in_scopes(code, {'y': [3], 'x': 3})
_check_in_scopes(code, {'y': [3], 'x': 3}, exec_func=_replacing_exec)
print("ListComprehensionTest::test_code_replace: ok")
