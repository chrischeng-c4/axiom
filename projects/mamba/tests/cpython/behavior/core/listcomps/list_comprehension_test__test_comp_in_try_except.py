...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_comp_in_try_except"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_comp_in_try_except"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_comp_in_try_except
"""Auto-ported test: ListComprehensionTest::test_comp_in_try_except (CPython 3.12 oracle)."""
...
_check_in_scopes(code, {'value': ['ab'], 'result': [2], 'snapshot': None})
code = template.format(func='int')
_check_in_scopes(code, {'value': ['ab'], 'result': None, 'snapshot': ['ab']}, raises=ValueError)
print("ListComprehensionTest::test_comp_in_try_except: ok")
