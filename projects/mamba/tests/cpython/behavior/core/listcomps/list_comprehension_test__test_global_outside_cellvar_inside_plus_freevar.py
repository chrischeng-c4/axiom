...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_global_outside_cellvar_inside_plus_freevar"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_global_outside_cellvar_inside_plus_freevar"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_global_outside_cellvar_inside_plus_freevar
"""Auto-ported test: ListComprehensionTest::test_global_outside_cellvar_inside_plus_freevar (CPython 3.12 oracle)."""
...
_check_in_scopes(code, {'x': (2, 1)}, ns={'b': 2}, scopes=['function', 'module'])
_check_in_scopes(code, raises=NameError, scopes=['class'])
print("ListComprehensionTest::test_global_outside_cellvar_inside_plus_freevar: ok")
