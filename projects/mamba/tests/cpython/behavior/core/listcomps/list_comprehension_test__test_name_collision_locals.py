...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_name_collision_locals"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_name_collision_locals"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_name_collision_locals
"""Auto-ported test: ListComprehensionTest::test_name_collision_locals (CPython 3.12 oracle)."""
...
_check_in_scopes(code, {'foo': 1, 'same_f_locals': True}, scopes=['module'])
print("ListComprehensionTest::test_name_collision_locals: ok")
