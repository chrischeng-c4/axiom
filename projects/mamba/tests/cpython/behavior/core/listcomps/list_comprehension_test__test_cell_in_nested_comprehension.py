...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_cell_in_nested_comprehension"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_cell_in_nested_comprehension"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_cell_in_nested_comprehension
"""Auto-ported test: ListComprehensionTest::test_cell_in_nested_comprehension (CPython 3.12 oracle)."""
...
_check_in_scopes(code, {'x': (2, 2, 1)}, ns={'b': 2}, scopes=['function', 'module'])
_check_in_scopes(code, raises=NameError, scopes=['class'])
print("ListComprehensionTest::test_cell_in_nested_comprehension: ok")
