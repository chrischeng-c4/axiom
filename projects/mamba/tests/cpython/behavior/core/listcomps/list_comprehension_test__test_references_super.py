...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_references_super"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_references_super"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_references_super
"""Auto-ported test: ListComprehensionTest::test_references_super (CPython 3.12 oracle)."""
...
_check_in_scopes(code, outputs={'res': [super]})
print("ListComprehensionTest::test_references_super: ok")
