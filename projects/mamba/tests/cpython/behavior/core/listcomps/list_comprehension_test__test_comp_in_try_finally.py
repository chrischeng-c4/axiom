...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_comp_in_try_finally"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_comp_in_try_finally"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_comp_in_try_finally
"""Auto-ported test: ListComprehensionTest::test_comp_in_try_finally (CPython 3.12 oracle)."""
...
_check_in_scopes(code, {'value': ['ab'], 'result': [2], 'snapshot': ['ab']})
code = template.format(func='int')
_check_in_scopes(code, {'value': ['ab'], 'result': None, 'snapshot': ['ab']}, raises=ValueError)
print("ListComprehensionTest::test_comp_in_try_finally: ok")
