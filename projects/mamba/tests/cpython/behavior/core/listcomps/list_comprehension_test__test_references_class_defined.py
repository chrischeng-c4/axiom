...
# lib = "listcomps"
# dimension = "behavior"
# case = "list_comprehension_test__test_references_class_defined"
# subject = "cpython.test_listcomps.ListComprehensionTest.test_references___class___defined"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_listcomps.py::ListComprehensionTest::test_references___class___defined
"""Auto-ported test: ListComprehensionTest::test_references___class___defined (CPython 3.12 oracle)."""
...
_check_in_scopes(code, outputs={'res': [2]}, scopes=['module', 'function'])
_check_in_scopes(code, raises=NameError, scopes=['class'])
print("ListComprehensionTest::test_references___class___defined: ok")
