...
# subject = "cpython.test_bytes.CAPITest.test_fromstringandsize"
# kind = "semantic"
...
_suite = unittest.defaultTestLoader.loadTestsFromName("CAPITest.test_fromstringandsize", test_bytes)
