...
# lib = "builtins"
# dimension = "behavior"
# case = "builtin_test__test_input"
# subject = "cpython.test_builtin.BuiltinTest.test_input"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::BuiltinTest::test_input
"""Auto-ported test: BuiltinTest::test_input (CPython 3.12 oracle)."""
...
try:
    ...
    assert input() == 'The quick brown fox jumps over the lazy dog.'
    ...
    sys.stdout = savestdout
    fp.close()
print("BuiltinTest::test_input: ok")
