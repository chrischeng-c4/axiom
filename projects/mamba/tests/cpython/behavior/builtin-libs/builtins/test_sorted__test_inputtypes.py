...
# lib = "builtins"
# dimension = "behavior"
# case = "test_sorted__test_inputtypes"
# subject = "cpython.test_builtin.TestSorted.test_inputtypes"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::TestSorted::test_inputtypes
"""Auto-ported test: TestSorted::test_inputtypes (CPython 3.12 oracle)."""
...
for T in types:
    ...
    assert sorted(s) == sorted(T(s))
s = ''.join(set(s))
types = [str, set, frozenset, list, tuple, dict.fromkeys]
for T in types:

    assert sorted(s) == sorted(T(s))
print("TestSorted::test_inputtypes: ok")
