...
# lib = "builtins"
# dimension = "behavior"
# case = "builtin_test__test_singleton_attribute_access"
# subject = "cpython.test_builtin.BuiltinTest.test_singleton_attribute_access"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::BuiltinTest::test_singleton_attribute_access
"""Auto-ported test: BuiltinTest::test_singleton_attribute_access (CPython 3.12 oracle)."""
...
for singleton in (NotImplemented, Ellipsis):
    ...
    assert type(singleton) is singleton.__class__

    assert type(singleton).__class__ is type
    try:
        singleton.prop = 1
    ...
    try:
        ...
        pass
print("BuiltinTest::test_singleton_attribute_access: ok")
