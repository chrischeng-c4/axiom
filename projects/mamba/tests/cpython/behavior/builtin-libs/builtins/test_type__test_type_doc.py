...
# lib = "builtins"
# dimension = "behavior"
# case = "test_type__test_type_doc"
# subject = "cpython.test_builtin.TestType.test_type_doc"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::TestType::test_type_doc
"""Auto-ported test: TestType::test_type_doc (CPython 3.12 oracle)."""
...
for doc in ('x', 'Ä', '🐍', 'x\x00y', 'x\udcdcy', b'x', 42, None):
    ...
    assert A.__doc__ == doc
print("TestType::test_type_doc: ok")
