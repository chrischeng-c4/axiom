...
# lib = "builtins"
# dimension = "behavior"
# case = "test_sorted__test_baddecorator"
# subject = "cpython.test_builtin.TestSorted.test_baddecorator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::TestSorted::test_baddecorator
"""Auto-ported test: TestSorted::test_baddecorator (CPython 3.12 oracle)."""
...
try:
    sorted(data, None, lambda x, y: 0)
    raise AssertionError('expected TypeError')
except TypeError:
    pass
print("TestSorted::test_baddecorator: ok")
