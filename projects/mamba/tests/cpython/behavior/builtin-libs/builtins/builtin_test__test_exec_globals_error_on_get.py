...
# lib = "builtins"
# dimension = "behavior"
# case = "builtin_test__test_exec_globals_error_on_get"
# subject = "cpython.test_builtin.BuiltinTest.test_exec_globals_error_on_get"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::BuiltinTest::test_exec_globals_error_on_get
"""Auto-ported test: BuiltinTest::test_exec_globals_error_on_get (CPython 3.12 oracle)."""
...
try:
    ...
    raise AssertionError('expected setonlyerror')
except setonlyerror:
    pass
code = compile('superglobal', 'test', 'exec')

try:
    exec(code, {'__builtins__': setonlydict({'superglobal': 1})})
    raise AssertionError('expected setonlyerror')
except setonlyerror:
    pass
print("BuiltinTest::test_exec_globals_error_on_get: ok")
