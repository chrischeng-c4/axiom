...
# lib = "builtins"
# dimension = "behavior"
# case = "builtin_test__test_compile_async_generator"
# subject = "cpython.test_builtin.BuiltinTest.test_compile_async_generator"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::BuiltinTest::test_compile_async_generator
"""Auto-ported test: BuiltinTest::test_compile_async_generator (CPython 3.12 oracle)."""
...
assert type(glob['ticker']()) == AsyncGeneratorType
print("BuiltinTest::test_compile_async_generator: ok")
