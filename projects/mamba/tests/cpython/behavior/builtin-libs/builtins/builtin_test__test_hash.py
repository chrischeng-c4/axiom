...
# lib = "builtins"
# dimension = "behavior"
# case = "builtin_test__test_hash"
# subject = "cpython.test_builtin.BuiltinTest.test_hash"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::BuiltinTest::test_hash
"""Auto-ported test: BuiltinTest::test_hash (CPython 3.12 oracle)."""
...
assert hash(Z(42)) == hash(42)
print("BuiltinTest::test_hash: ok")
