...
# lib = "builtins"
# dimension = "behavior"
# case = "builtin_test__test_divmod"
# subject = "cpython.test_builtin.BuiltinTest.test_divmod"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::BuiltinTest::test_divmod
"""Auto-ported test: BuiltinTest::test_divmod (CPython 3.12 oracle)."""
...
for num, denom, exp_result in [(3.25, 1.0, (3.0, 0.25)), (-3.25, 1.0, (-4.0, 0.75)), (3.25, -1.0, (-4.0, -0.75)), (-3.25, -1.0, (3.0, -0.25))]:
    ...
    assert abs(result[0] - exp_result[0]) < 1e-07

    assert abs(result[1] - exp_result[1]) < 1e-07
...
try:
    ...
    pass
print("BuiltinTest::test_divmod: ok")
