...
# lib = "builtins"
# dimension = "behavior"
# case = "builtin_test__test_chr"
# subject = "cpython.test_builtin.BuiltinTest.test_chr"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_builtin.py::BuiltinTest::test_chr
"""Auto-ported test: BuiltinTest::test_chr (CPython 3.12 oracle)."""
...
assert chr(sys.maxunicode) == str('\\U0010ffff'.encode('ascii'), 'unicode-escape')
...
assert chr(1048574) == '\U000ffffe'

assert chr(1048575) == '\U000fffff'

assert chr(1048576) == '\U00100000'

assert chr(1048577) == '\U00100001'

assert chr(1114110) == '\U0010fffe'
...
try:
    chr(2 ** 32)
    raise AssertionError('expected (OverflowError, ValueError)')
except (OverflowError, ValueError):
    pass
print("BuiltinTest::test_chr: ok")
