...
# lib = "iter"
# dimension = "behavior"
# case = "test_case__test_builtin_list"
# subject = "cpython.test_iter.TestCase.test_builtin_list"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_iter.py::TestCase::test_builtin_list
"""Auto-ported test: TestCase::test_builtin_list (CPython 3.12 oracle)."""
...
assert list(SequenceClass(5)) == list(range(5))

assert list(SequenceClass(0)) == []
...
try:
    ...
    try:
        ...
        pass
print("TestCase::test_builtin_list: ok")
