...
# lib = "iter"
# dimension = "behavior"
# case = "test_case__test_iter_callable"
# subject = "cpython.test_iter.TestCase.test_iter_callable"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_iter.py::TestCase::test_iter_callable
"""Auto-ported test: TestCase::test_iter_callable (CPython 3.12 oracle)."""
...
check_iterator(iter(CallableIterClass(), 10), list(range(10)), pickle=True)
print("TestCase::test_iter_callable: ok")
