...
# lib = "iter"
# dimension = "behavior"
# case = "test_case__test_mutating_seq_class_iter_pickle"
# subject = "cpython.test_iter.TestCase.test_mutating_seq_class_iter_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_iter.py::TestCase::test_mutating_seq_class_iter_pickle
"""Auto-ported test: TestCase::test_mutating_seq_class_iter_pickle (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert list(it) == []
print("TestCase::test_mutating_seq_class_iter_pickle: ok")
