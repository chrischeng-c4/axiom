...
# lib = "iter"
# dimension = "behavior"
# case = "test_case__test_builtin_tuple"
# subject = "cpython.test_iter.TestCase.test_builtin_tuple"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_iter.py::TestCase::test_builtin_tuple
"""Auto-ported test: TestCase::test_builtin_tuple (CPython 3.12 oracle)."""
...
assert tuple(SequenceClass(5)) == (0, 1, 2, 3, 4)

assert tuple(SequenceClass(0)) == ()
...
try:
    ...
    try:
        ...
        pass
print("TestCase::test_builtin_tuple: ok")
