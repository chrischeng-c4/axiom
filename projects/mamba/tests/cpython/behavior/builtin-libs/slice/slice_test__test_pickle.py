...
# lib = "slice"
# dimension = "behavior"
# case = "slice_test__test_pickle"
# subject = "cpython.test_slice.SliceTest.test_pickle"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_slice.py::SliceTest::test_pickle
"""Auto-ported test: SliceTest::test_pickle (CPython 3.12 oracle)."""
...
for protocol in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert s.indices(15) == t.indices(15)

    assert id(s) != id(t)
print("SliceTest::test_pickle: ok")
