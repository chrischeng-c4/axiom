...
# lib = "range"
# dimension = "behavior"
# case = "range_test__test_iterator_pickling_overflowing_index"
# subject = "cpython.test_range.RangeTest.test_iterator_pickling_overflowing_index"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_range.py::RangeTest::test_iterator_pickling_overflowing_index
"""Auto-ported test: RangeTest::test_iterator_pickling_overflowing_index (CPython 3.12 oracle)."""
...
for proto in range(pickle.HIGHEST_PROTOCOL + 1):
    ...
    assert next(it) == 2 ** 32 + 1
print("RangeTest::test_iterator_pickling_overflowing_index: ok")
