...
# lib = "set_methods"
# dimension = "behavior"
# case = "test_graphs__test_cuboctahedron"
# subject = "cpython.test_set.TestGraphs.test_cuboctahedron"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_set.py::TestGraphs::test_cuboctahedron
"""Auto-ported test: TestGraphs::test_cuboctahedron (CPython 3.12 oracle)."""
...
assert vertices == othervertices
cubofaces = faces(cuboctahedron)
facesizes = collections.defaultdict(int)
for face in cubofaces:
    facesizes[len(face)] += 1

assert facesizes[3] == 8

assert facesizes[4] == 6
for vertex in cuboctahedron:
    ...
    for cubevert in edge:
        ...
        assert cubevert in g
print("TestGraphs::test_cuboctahedron: ok")
