...
# lib = "set_methods"
# dimension = "behavior"
# case = "test_only_sets_dict__test_union"
# subject = "cpython.test_set.TestOnlySetsDict.test_union"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_set.py::TestOnlySetsDict::test_union
"""Auto-ported test: TestOnlySetsDict::test_union (CPython 3.12 oracle)."""
...
if self_otherIsIterable:
    ...
    try:
        ...
        pass
print("TestOnlySetsDict::test_union: ok")
