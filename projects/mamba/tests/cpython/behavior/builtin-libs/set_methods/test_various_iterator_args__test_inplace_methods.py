...
# lib = "set_methods"
# dimension = "behavior"
# case = "test_various_iterator_args__test_inplace_methods"
# subject = "cpython.test_set.TestVariousIteratorArgs.test_inplace_methods"
# kind = "semantic"
...
# Auto-ported from CPython 3.12 test_set.py::TestVariousIteratorArgs::test_inplace_methods
"""Auto-ported test: TestVariousIteratorArgs::test_inplace_methods (CPython 3.12 oracle)."""
...
for data in ('123', '', range(1000), ('do', 1.2), range(2000, 2200, 5), 'december'):
    for methname in ('update', 'intersection_update', 'difference_update', 'symmetric_difference_update'):
        for g in (G, I, Ig, S, L, R):
            ...
            assert sorted(s, key=repr) == sorted(t, key=repr)

        try:
            getattr(set('january'), methname)(X(data))
            raise AssertionError('expected TypeError')
        except TypeError:
            pass

        try:
            getattr(set('january'), methname)(N(data))
            raise AssertionError('expected TypeError')
        except TypeError:
            pass
        ...
        try:
            ...
            pass
print("TestVariousIteratorArgs::test_inplace_methods: ok")
