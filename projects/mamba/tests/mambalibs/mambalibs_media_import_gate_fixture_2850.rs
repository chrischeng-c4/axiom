//! Schema gate for the mambalibs media import gate fixture — closes
//! #2850.
...
const LIBRARY: &str = "media";
const ISSUE: i64 = 2850;
const FIXTURE: &str = "mambalibs_media_import_gate";
const STATUS_FIELD: &str = "media_import_status";
const SUPPORTED_CASE: &str = "media_import_supported";
const BLOCKED_CASE: &str = "media_import_blocked";
const OOS_FLAG: &str = "media_codec_coverage";
...
fn sample_policy_pins_tiny_in_memory_data() {
    ...
    for f in &[
        ...
        "forbid_codec_invocation",
        "forbid_external_media_files",
    ] {
