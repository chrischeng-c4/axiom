...
/// Ported from `tests/cpython/behavior/std-libs/metaclass/super_call_forwards_args_kwargs_to_type_call.py`.
#[test]
fn test_gen_behavior_std_libs_metaclass_super_call_forwards_args_kwargs_to_type_call() {
...
"###);
    assert_output(&out, r###"super_call_forwards_args_kwargs_to_type_call OK
"###);
}
