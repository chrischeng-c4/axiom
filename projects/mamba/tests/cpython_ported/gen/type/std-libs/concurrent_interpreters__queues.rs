...
/// Ported from `tests/cpython/type/std-libs/concurrent_interpreters__queues/Queue____new____id_as_int_wrong.py`.
#[test]
fn test_gen_type_std_libs_concurrent_interpreters__queues_Queue____new____id_as_int_wrong() {
...
/// Ported from `tests/cpython/type/std-libs/concurrent_interpreters__queues/create__maxsize_as_int_wrong.py`.
#[test]
fn test_gen_type_std_libs_concurrent_interpreters__queues_create__maxsize_as_int_wrong() {
    let out = run_type_wall_fixture(r###"# /// script
# requires-python = ">=3.12"
# dependencies = []
#
