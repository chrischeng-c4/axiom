...
/// Ported from `tests/cpython/type/std-libs/email_contentmanager/ContentManager__add_get_handler__key_as_str_wrong.py`.
#[test]
fn test_gen_type_std_libs_email_contentmanager_ContentManager__add_get_handler__key_as_str_wrong() {
