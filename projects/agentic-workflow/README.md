...
| WorkItem loop-state model | change | #189 | implemented | verified | smoke | `cargo test -p agentic-workflow --lib loop_state_round_trips`; projects/agentic-workflow/tech-design/logic/workitem-loop-state-model.md |
