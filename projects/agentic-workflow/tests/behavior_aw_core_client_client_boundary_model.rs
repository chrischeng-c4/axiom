// SPEC-MANAGED: projects/agentic-workflow/tech-design/surface/specs/aw-capability-claim-closure-ec-inventory.md#aw-core-client-client-boundary-model
// CODEGEN-BEGIN
// AW-EC-BEGIN
...
fn aw_core_client_client_boundary_model() {
    let command =
        "./target/debug/aw td check projects/agentic-workflow/tech-design/surface/specs/aw-client-boundaries.md";
