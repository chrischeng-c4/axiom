// SPEC-MANAGED: projects/agentic-workflow/tech-design/core/validate/spec_alignment_tests.md#tests
// CODEGEN-BEGIN
...
"#,
    ...
    fn test_zero_false_positives_on_existing_specs() {
        ...
        let spec_path =
            PathBuf::from("projects/agentic-workflow/tech-design/core/logic/spec-structure.md");
        if !spec_path.exists() {
