//! analyze_code_for_spec MCP Tool
//!
//! Analyzes code files to suggest spec structure for code generation.
//! Uses tree-sitter to extract symbols and patterns from source code.
//! Split into submodules by language and functionality.

// SPEC-MANAGED: projects/agentic-workflow/tech-design/core/tools/analyze/mod.md#source
// CODEGEN-BEGIN
mod python;
mod rust_lang;
mod suggestions;
...
/// @spec projects/agentic-workflow/tech-design/core/tools/analyze/mod.md#source
