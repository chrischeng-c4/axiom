...
// SPEC-MANAGED: projects/agentic-workflow/tech-design/core/tools/task.md#schema
// CODEGEN-BEGIN
/// Agent task kind dispatched by the get_task MCP tool. Variants stay PascalCase both in Rust and as the wire string consumed by the hand-written from_str dispatch.
/// @spec projects/agentic-workflow/tech-design/core/tools/task.md#schema
...
// SPEC-MANAGED: projects/agentic-workflow/tech-design/core/tools/task/runtime.md#source
// CODEGEN-BEGIN
/// @spec projects/agentic-workflow/tech-design/core/tools/task/runtime.md#source
impl TaskType {
