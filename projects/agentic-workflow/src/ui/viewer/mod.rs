// SPEC-MANAGED: projects/agentic-workflow/tech-design/core/interfaces/ui/viewer/mod.md#source
// CODEGEN-BEGIN
use axum::{
    extract::{Path, State},
...
/// @spec projects/agentic-workflow/tech-design/core/interfaces/ui/viewer/mod.md#source
