...
fn set_capability_type(project: &str, args: CapabilitySetTypeArgs) -> Result<()> {
    ...
    let capability_type =
        crate::cli::capability_type::CapabilityType::from_cli_str(&args.r#type)?;
...
async fn build_capability_report_inner(
    ...
    let capability_types = {
        ...
        let mut t = crate::cli::capability_type::load_capability_types_from_readme(&report.cap_path)
            .unwrap_or_default();
        for (id, ty) in
