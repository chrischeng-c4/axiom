// SPEC-MANAGED: projects/agentic-workflow/tech-design/core/generate/generators/primitive_registry.md#source
// CODEGEN-BEGIN
...
///
/// Prose types per the current TD taxonomy: Overview, Doc, Requirements, and
/// Scenarios. Test sections are structural artifact sources.
///
