---
id: projects-agentic-workflow-src-cli-generator-rs
...
capability_refs:
  - id: existing-project-standardization
    ...
    coverage: full
    rationale: "Generator request CLI turns standardization generator gaps into WI/TD/CB work roots."
command_refs:
  - command: aw generator
  - command: aw generator check
  - command: aw generator request
---

# Generator CLI Source

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/cli/generator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `GeneratorArgs` | projects/agentic-workflow/src/cli/generator.rs | struct | pub | 15 |  |
| `GeneratorCheckArgs` | projects/agentic-workflow/src/cli/generator.rs | struct | pub | 50 |  |
| `GeneratorCheckReport` | projects/agentic-workflow/src/cli/generator.rs | struct | pub | 117 |  |
| `GeneratorCommand` | projects/agentic-workflow/src/cli/generator.rs | enum | pub | 22 |  |
| `GeneratorGap` | projects/agentic-workflow/src/cli/generator.rs | struct | pub | 90 |  |
| `GeneratorHealthSummary` | projects/agentic-workflow/src/cli/generator.rs | struct | pub | 97 |  |
| `GeneratorNextAction` | projects/agentic-workflow/src/cli/generator.rs | struct | pub | 110 |  |
| `GeneratorRequestArgs` | projects/agentic-workflow/src/cli/generator.rs | struct | pub | 75 |  |
| `GeneratorRequestReport` | projects/agentic-workflow/src/cli/generator.rs | struct | pub | 129 |  |
| `run` | projects/agentic-workflow/src/cli/generator.rs | function | pub | 142 | run(args: GeneratorArgs) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/cli/generator.rs -->
`````rust
...
changes:
  - path: projects/agentic-workflow/src/cli/generator.rs
    ...
    section: source
    description: |
      Whole-file source template for the aw generator gap-inspection and request surface.
```
