...
# Standardized projects/agentic-workflow/src/cli/validate_proposal.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/cli/validate_proposal.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ValidationSummary` | projects/agentic-workflow/src/cli/validate_proposal.rs | struct | pub | 19 |  |
| `has_warnings` | projects/agentic-workflow/src/cli/validate_proposal.rs | function | pub | 45 | has_warnings(&self) -> bool |
| `is_valid` | projects/agentic-workflow/src/cli/validate_proposal.rs | function | pub | 36 | is_valid(&self) -> bool |
| `is_valid_strict` | projects/agentic-workflow/src/cli/validate_proposal.rs | function | pub | 41 | is_valid_strict(&self) -> bool |
| `run` | projects/agentic-workflow/src/cli/validate_proposal.rs | function | pub | 160 | run(change_id: &str, options: &ValidationOptions) -> Result<()> |
| `to_json_output` | projects/agentic-workflow/src/cli/validate_proposal.rs | function | pub | 50 | to_json_output(&self, strict: bool) -> ValidationJsonOutput |
| `validate_proposal` | projects/agentic-workflow/src/cli/validate_proposal.rs | function | pub | 300 | validate_proposal(     change_id: &str,     project_root: &PathBuf,     options: &ValidationOptions, ) -> Result<ValidationSummary> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=projects/agentic-workflow/src/cli/validate_proposal.rs -->
```rust
