...
# Standardized projects/agentic-workflow/src/cli/chat_members.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/cli/chat_members.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ChannelMessage` | projects/agentic-workflow/src/cli/chat_members.rs | struct | pub | 31 |  |
| `Member` | projects/agentic-workflow/src/cli/chat_members.rs | struct | pub | 65 |  |
| `MembersFile` | projects/agentic-workflow/src/cli/chat_members.rs | struct | pub | 80 |  |
| `MessageFrontmatter` | projects/agentic-workflow/src/cli/chat_members.rs | struct | pub | 51 |  |
| `detect_git_branch` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 214 | detect_git_branch(cwd: &Path) -> Option<String> |
| `detect_git_toplevel` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 227 | detect_git_toplevel(cwd: &Path) -> Option<String> |
| `detect_team_identity` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 208 | detect_team_identity(cwd: &Path, _members_path: &Path) -> Result<String> |
| `is_old_pipe_format` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 282 | is_old_pipe_format(content: &str) -> bool |
| `lookup_member_name_by_branch` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 241 | lookup_member_name_by_branch(branch: &str, members_path: &Path) -> Option<String> |
| `parse_channel_jsonl` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 526 | parse_channel_jsonl(content: &str) -> Vec<ChannelMessage> |
| `parse_channel_markdown` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 493 | parse_channel_markdown(content: &str) -> Vec<ChannelMessage> |
| `parse_frontmatter_blocks` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 557 | parse_frontmatter_blocks(content: &str) -> Vec<ChannelMessage> |
| `parse_pipe_format` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 358 | parse_pipe_format(content: &str) -> Vec<ChannelMessage> |
| `parse_pipe_line` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 310 | parse_pipe_line(id: i64, line: &str) -> ChannelMessage |
| `read_config_team_name` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 251 | read_config_team_name(cwd: &Path) -> Option<String> |
| `read_members_file` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 613 | read_members_file(path: &Path) -> Result<MembersFile> |
| `resolve_identity` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 126 | resolve_identity(cwd: &Path) -> Result<String> |
| `rewrite_channel_as_frontmatter` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 481 | rewrite_channel_as_frontmatter(path: &Path, msgs: &[ChannelMessage]) -> Result<()> |
| `run_members_register` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 632 | run_members_register(     identity: &str,     branch: &str,     wt_path: &str,     projects: &[String],     capabilities: &[String],     members_path: &Path, ) -> Result<()> |
| `serialize_message_block` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 452 | serialize_message_block(msg: &ChannelMessage) -> String |
| `serialize_message_jsonl` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 550 | serialize_message_jsonl(msg: &ChannelMessage) -> Result<String> |
| `write_members_file` | projects/agentic-workflow/src/cli/chat_members.rs | function | pub | 625 | write_members_file(path: &Path, mf: &MembersFile) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/cli/chat_members.rs -->
```rust
