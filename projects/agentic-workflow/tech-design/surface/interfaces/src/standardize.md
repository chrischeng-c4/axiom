...
command_refs:
  ...
  - command: aw standardize managed next
  - command: aw standardize managed report
  - command: aw standardize managed run
  - command: aw standardize semantic
  - command: aw standardize semantic next
  - command: aw standardize semantic report
  - command: aw standardize semantic run
  - command: aw standardize traceability
  - command: aw standardize traceability next
  - command: aw standardize traceability report
  - command: aw standardize traceability run
---
...
|------|--------|------|------------|------|-----------|
| `CodegenCoverage` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 407 |  |
| `CommandTraceabilityCoverage` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 512 |  |
| `CoverageMapEntry` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 763 |  |
| `DependencyPolicyFinding` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 650 |  |
| `DeploymentFacetFinding` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 659 |  |
| `FrontendEcosystemAst` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 719 |  |
| `FrontendSourceNode` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 735 |  |
| `FrontendWorkspaceNode` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 726 |  |
| `GeneratorPrimitiveGap` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 772 |  |
| `ImportEdge` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 755 |  |
| `MarkerCounts` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 400 |  |
| `ProjectHealthStandardizeCoverage` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 622 |  |
| `RegenerabilityCoverage` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 420 |  |
| `SemanticCoverage` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 447 |  |
| `SemanticGap` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 781 |  |
| `SourceEvidenceDomain` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 693 |  |
| `SourceEvidenceGraph` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 686 |  |
| `SourceEvidenceNode` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 702 |  |
| `SourceSymbol` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 747 |  |
| `SourceUnit` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 671 |  |
| `StackMigrationCoverage` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 611 |  |
| `StandardizationCoverage` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 388 |  |
| `StandardizeAction` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 790 |  |
| `StandardizeActionKind` | projects/agentic-workflow/src/cli/standardize.rs | enum | pub | 803 |  |
| `StandardizeArgs` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 57 |  |
| `StandardizeAuditArgs` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 77 |  |
| `StandardizeAuditCheckArgs` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 99 |  |
| `StandardizeAuditCommand` | projects/agentic-workflow/src/cli/standardize.rs | enum | pub | 84 |  |
| `StandardizeAuditRecordArgs` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 126 |  |
| `StandardizeCommand` | projects/agentic-workflow/src/cli/standardize.rs | enum | pub | 64 |  |
| `StandardizeNextArgs` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 236 |  |
| `StandardizeReportArgs` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 186 |  |
| `StandardizeRunArgs` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 267 |  |
| `StandardizeStageArgs` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 145 |  |
| `StandardizeStageCommand` | projects/agentic-workflow/src/cli/standardize.rs | enum | pub | 152 |  |
| `StandardizeTraceabilityArgs` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 298 |  |
| `StandardizeTraceabilityCommand` | projects/agentic-workflow/src/cli/standardize.rs | enum | pub | 305 |  |
| `StandardizeTraceabilityReportArgs` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 340 |  |
| `StandardizeTraceabilityRunArgs` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 363 |  |
| `TraceabilityBlocker` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 543 |  |
| `TraceabilityBlockerKind` | projects/agentic-workflow/src/cli/standardize.rs | enum | pub | 554 |  |
| `TraceabilityCoverage` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 471 |  |
| `WorkspaceStackMigration` | projects/agentic-workflow/src/cli/standardize.rs | struct | pub | 632 |  |
| `as_str` | projects/agentic-workflow/src/cli/standardize.rs | function | pub | 577 | as_str(self) -> &'static str |
| `project_health_standardize_coverage` | projects/agentic-workflow/src/cli/standardize.rs | function | pub | 1624 | project_health_standardize_coverage(     project: &str,     verify_traceability: bool,     verify_codegen_drift: bool, ) -> Result<ProjectHealthStandardizeCoverage> |
| `project_managed_coverage` | projects/agentic-workflow/src/cli/standardize.rs | function | pub | 1547 | project_managed_coverage(project: &str) -> Result<StandardizationCoverage> |
| `project_regenerability_coverage` | projects/agentic-workflow/src/cli/standardize.rs | function | pub | 1556 | project_regenerability_coverage(project: &str) -> Result<RegenerabilityCoverage> |
| `project_regenerability_fast_coverage` | projects/agentic-workflow/src/cli/standardize.rs | function | pub | 1564 | project_regenerability_fast_coverage(project: &str) -> Result<RegenerabilityCoverage> |
| `project_semantic_coverage` | projects/agentic-workflow/src/cli/standardize.rs | function | pub | 1587 | project_semantic_coverage(project: &str) -> Result<SemanticCoverage> |
| `project_stack_migration_coverage` | projects/agentic-workflow/src/cli/standardize.rs | function | pub | 1617 | project_stack_migration_coverage(project: &str) -> Result<StackMigrationCoverage> |
| `project_traceability_coverage` | projects/agentic-workflow/src/cli/standardize.rs | function | pub | 1596 | project_traceability_coverage(project: &str) -> Result<TraceabilityCoverage> |
| `ready_fixture` | projects/agentic-workflow/src/cli/standardize.rs | function | pub | 490 | ready_fixture(project: &str) -> Self |
| `ready_fixture` | projects/agentic-workflow/src/cli/standardize.rs | function | pub | 526 | ready_fixture() -> Self |
| `run` | projects/agentic-workflow/src/cli/standardize.rs | function | pub | 929 | run(args: StandardizeArgs) -> Result<()> |
## Source
...
fn project_standardize_parent_summary(
    ...
    next.insert("reason".to_string(), serde_json::Value::String(reason.clone()));
    next.insert("layer".to_string(), serde_json::Value::String(layer.to_string()));
    next.insert(
...
fn project_standardize_parent_step(
    ...
    if report.workflow_lock_count > 0 {
        let reason = report
            ...
            .cloned()
            .unwrap_or_else(|| "workflow lock requires current owner or HITL resolution".to_string());
    ...
    if !report.capability_ready {
        ...
        let status = if command.is_some() { "continue" } else { "blocked" };
...
fn build_semantic_coverage(project_root: &Path, inventory: &Inventory) -> Result<SemanticCoverage> {
    ...
    let semantic_files = td_index.values().filter(|td| !td.is_claim).count();
    ...
    let percent = if inventory.files.is_empty() {
        100.0
    } else {
        (semantically_covered_files as f64 / inventory.files.len() as f64) * 100.0
    };
...
fn traceability_requires_implementation_edge(section: &str) -> bool {
    !matches!(
        section,
        "changes" | "overview" | "doc" | "reference-context" | "review" | "changelog"
    )
}
...
fn build_regenerability_coverage_with_options(
    ...
    for file in &inventory.files {
        ...
        if file.markers.handwrite || !file.markers.managed() || unsupported_codegen || codegen_drift
        {
...
fn source_spec_refs(abs: &Path, project_root: &Path) -> Vec<String> {
    ...
    for line in content.lines() {
        ...
        let normalized =
            if let Some(stripped) = spec.strip_prefix(project_root.to_string_lossy().as_ref()) {
...
"##;
    ...
    fn traceability_missing_capability_sections_returns_blocker() {
        ...
        assert_eq!(blocker.kind, TraceabilityBlockerKind::TdInvalidCapabilityRef);
        assert!(blocker
            .reason
            .contains("capability document parse failed"));
