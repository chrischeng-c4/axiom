...
capability_refs:
  ...
  - id: project-local-td-and-ec-gates
    role: primary
    gap: cb-generation-and-standardize-scan-defaults
...
# Standardized projects/agentic-workflow/src/cli/cb.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/cli/cb.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CbArgs` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 22 |  |
| `CbCheckArgs` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 171 |  |
| `CbClaimArgs` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 97 |  |
| `CbColdVerifySummary` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 661 |  |
| `CbCommand` | projects/agentic-workflow/src/cli/cb.rs | enum | pub | 31 |  |
| `CbFillArgs` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 64 |  |
| `CbGenArgs` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 126 |  |
| `CbGeneratorMaturitySummary` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 652 |  |
| `CbVerifySummary` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 642 |  |
| `project_force_regen_cold_verify_summary` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 739 | project_force_regen_cold_verify_summary(project: &str) -> Result<Vec<CbColdVerifySummary>> |
| `project_force_regen_cold_verify_workspaces` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 755 | project_force_regen_cold_verify_workspaces(project: &str) -> Result<Vec<String>> |
| `project_force_regen_verify_summary` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 683 | project_force_regen_verify_summary(project: &str) -> Result<CbVerifySummary> |
| `run` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 185 | run(args: CbArgs) -> Result<()> |
| `run_check` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 3260 | run_check(args: CbCheckArgs) -> Result<()> |
| `run_claim` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 3278 | run_claim(args: CbClaimArgs) -> Result<()> |
| `run_gen` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 236 | run_gen(args: CbGenArgs) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/cli/cb.rs -->
`````rust
...
pub struct CbClaimArgs {
    ...
    #[arg(long)]
    pub init: bool,
    // Create a minimal issue stub in `.aw/issues/open/` using the
...
fn run_force_regen(
    ...
    let public_api_updates = if sync_public_api {
    ...
    if !dry_run {
        format_rust_files_in_scope(&scope.source_roots)?;
    }
...
fn run_force_regen_verify_cold(project: &str, workspace: Option<&str>) -> Result<()> {
    ...
    println!(
        "generator_maturity: primitive {}/{} ({:.1}%), source_template {}/{} ({:.1}%), artifact_replay {}/{} ({:.1}%)",
        summary.generator_maturity.generator_primitive_files,
        summary.generator_maturity.target_files,
        percent_of(
            summary.generator_maturity.generator_primitive_files,
            summary.generator_maturity.target_files
        ),
        summary.generator_maturity.source_template_files,
        summary.generator_maturity.target_files,
        percent_of(
            summary.generator_maturity.source_template_files,
            summary.generator_maturity.target_files
        ),
        summary.generator_maturity.artifact_replay_files,
        summary.generator_maturity.target_files,
        percent_of(
            summary.generator_maturity.artifact_replay_files,
            summary.generator_maturity.target_files
...
fn force_regen_verify_cold_summary_at(
    ...
    let generator_maturity = CbGeneratorMaturitySummary {
        target_files: expected_files,
        artifact_replay_files: 0,
        source_template_files: 0,
        generator_primitive_files: expected_files,
    };
    ...
    let verify_result = (|| {
        let (_, _, _, changed_paths) =
            run_force_regen_specs(&temp_root, &temp_scope, &temp_specs, false)?;
...
pub struct CbColdVerifySummary {
    ...
    pub generator_maturity: CbGeneratorMaturitySummary,
    pub failures: Vec<String>,
}
...
pub fn project_force_regen_verify_summary(project: &str) -> Result<CbVerifySummary> {
    ...
    let replay_mismatches = force_regen_replay_mismatches(&cwd, &scope, &specs)?;
...
fn run_force_regen_specs(
    ...
    for spec in specs {
        ...
        let report = run_apply_scoped_targets(&spec_path, root, dry_run, &scope.source_roots)
            .map_err(|e| {
                anyhow::anyhow!("regeneration failed for {}: {}", spec_path.display(), e)
        })?;
        updated_files += report.files.iter().filter(|f| f.updated).count();
        created_files += report.files_created();
        blocks_updated += report.total_blocks_updated();
...
fn force_regen_replay_mismatches(
    ...
    let verify_result = (|| {
        let (_, _, _, changed_paths) = run_force_regen_specs(&temp_root, &temp_scope, specs, false)?;
        format_rust_files(&changed_paths)?;
...
mod tests {
    use super::{
        cb_verify_summary_from_report, collect_force_regen_specs, compare_source_roots,
        extract_cold_rebuild_target_paths, extract_spec_managed_ref, extract_spec_managed_refs,
        is_minified_asset_file, resolve_project_force_regen_scope, sample_count,
        sample_semantic_review_units, td_public_symbol_semantic_coverage,
        upsert_public_api_overview, upsert_public_api_overview_targets, CbCommand, CbGenArgs,
...
"#,
        ...
        let scope =
            resolve_project_force_regen_scope(root, "fixture_platform", Some("fixture_platform-backend"))
                .unwrap();
...
"#,
        ...
        let scope =
            resolve_project_force_regen_scope(root, "fp", Some("fixture_platform-backend"))
                .unwrap();
...
pub async fn run_claim(args: CbClaimArgs) -> Result<()> {
    ...
    if !score_dir.exists() {
        if args.init {
            ...
            std::fs::create_dir_all(score_dir.join("issues/open"))
                .context("failed to create .aw/issues/open")?;
        } else {
            let env = serde_json::json!({
                "action": "error",
...
// Create a minimal issue stub at `.aw/issues/open/<slug>.md`.
