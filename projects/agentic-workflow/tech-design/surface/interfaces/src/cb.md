...
capability_refs:
  - id: td-cb-lifecycle-automation
    ...
    coverage: full
    rationale: "TD/CB CLI surface manifests cover lifecycle dispatch, generation, marker-fill, and terminal code-check command behavior."
...
|------|--------|------|------------|------|-----------|
| `CbCheckArgs` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 156 |  |
| `CbClaimArgs` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 77 |  |
| `CbCodegenOriginSummary` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 743 |  |
| `CbColdVerifySummary` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 752 |  |
| `CbFillArgs` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 50 |  |
| `CbGenArgs` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 111 |  |
| `CbGenSourceArgs` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 175 |  |
| `CbVerifySummary` | projects/agentic-workflow/src/cli/cb.rs | struct | pub | 733 |  |
| `code_check_target_is_slug` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 4305 | code_check_target_is_slug(project_root: &std::path::Path, target: &str) -> bool |
| `project_force_regen_cold_verify_summary` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 830 | project_force_regen_cold_verify_summary(project: &str) -> Result<Vec<CbColdVerifySummary>> |
| `project_force_regen_cold_verify_workspaces` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 846 | project_force_regen_cold_verify_workspaces(project: &str) -> Result<Vec<String>> |
| `project_force_regen_verify_summary` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 774 | project_force_regen_verify_summary(project: &str) -> Result<CbVerifySummary> |
| `run_check` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 4320 | run_check(args: CbCheckArgs) -> Result<()> |
| `run_claim` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 5112 | run_claim(args: CbClaimArgs) -> Result<()> |
| `run_gen` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 223 | run_gen(args: CbGenArgs) -> Result<()> |
| `run_gen_source` | projects/agentic-workflow/src/cli/cb.rs | function | pub | 192 | run_gen_source(args: CbGenSourceArgs) -> Result<()> |
## Source
...
changes:
  ...
  - path: projects/agentic-workflow/src/cli/cb.rs
    ...
    section: source
    description: |
      Issue #848: whole-file resync to the post-terminal-lifecycle source
      (run_check_lifecycle_terminal, BranchLandingOutcome,
      land_td_lifecycle_branch, terminal_commit_already_landed,
      empty_implementation_gate_message, ensure_claim_issue/ClaimIssueRef,
