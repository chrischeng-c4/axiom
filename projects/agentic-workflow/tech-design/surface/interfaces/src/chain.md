...
# Standardized projects/agentic-workflow/src/cli/chain.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/cli/chain.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ChainBlockerKind` | projects/agentic-workflow/src/cli/chain.rs | enum | pub | 46 |  |
| `ChainBlocker` | projects/agentic-workflow/src/cli/chain.rs | struct | pub | 74 |  |
| `validate_aw_command_string` | projects/agentic-workflow/src/cli/chain.rs | function | pub | 141 | validate_aw_command_string(cmd: &str) -> Result<(), ChainBlocker> |
| `normalize_legacy_next_action` | projects/agentic-workflow/src/cli/chain.rs | function | pub | 348 | normalize_legacy_next_action(cmd: &str, slug: &str) -> Option<String> |

## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/cli/chain.rs -->
```rust
