...
|------|--------|------|------------|------|-----------|
| `ChainBlockerKind` | projects/agentic-workflow/src/cli/chain.rs | enum | pub | 47 |  |
| `ChainBlocker` | projects/agentic-workflow/src/cli/chain.rs | struct | pub | 75 |  |
| `validate_aw_command_string` | projects/agentic-workflow/src/cli/chain.rs | function | pub | 142 | validate_aw_command_string(cmd: &str) -> Result<(), ChainBlocker> |
| `normalize_legacy_next_action` | projects/agentic-workflow/src/cli/chain.rs | function | pub | 585 | normalize_legacy_next_action(cmd: &str, slug: &str) -> Option<String> |
