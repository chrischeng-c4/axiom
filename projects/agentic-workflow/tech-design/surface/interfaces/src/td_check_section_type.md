...
# Standardized projects/agentic-workflow/src/cli/td_check_section_type.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/cli/td_check_section_type.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CheckArgs` | projects/agentic-workflow/src/cli/td_check_section_type.rs | struct | pub | 32 |  |
| `Finding` | projects/agentic-workflow/src/cli/td_check_section_type.rs | struct | pub | 48 |  |
| `FindingKind` | projects/agentic-workflow/src/cli/td_check_section_type.rs | enum | pub | 40 |  |
| `Report` | projects/agentic-workflow/src/cli/td_check_section_type.rs | struct | pub | 60 |  |
| `run` | projects/agentic-workflow/src/cli/td_check_section_type.rs | function | pub | 77 | run(args: CheckArgs) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/cli/td_check_section_type.rs -->
````rust
