...
# Standardized projects/agentic-workflow/src/cli/issues.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/cli/issues.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ArbitrateArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 561 |  |
| `AtomizeArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 449 |  |
| `BackendKind` | projects/agentic-workflow/src/cli/issues.rs | enum | pub | 603 |  |
| `CloseArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 359 |  |
| `CreateArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 239 |  |
| `CreateValidationError` | projects/agentic-workflow/src/cli/issues.rs | enum | pub | 1323 |  |
| `DraftArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 71 |  |
| `DraftCommand` | projects/agentic-workflow/src/cli/issues.rs | enum | pub | 78 |  |
| `DraftFillArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 129 |  |
| `DraftInitArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 91 |  |
| `DraftReviewArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 165 |  |
| `DraftValidateArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 154 |  |
| `EnrichArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 497 |  |
| `EpicizeArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 425 |  |
| `FillSectionArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 528 |  |
| `FindArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 382 |  |
| `IssuesArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 26 |  |
| `IssuesCommand` | projects/agentic-workflow/src/cli/issues.rs | enum | pub | 35 |  |
| `ListArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 184 |  |
| `PlanArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 397 |  |
| `PrioritizeArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 473 |  |
| `PrioritizeLanes` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 3768 |  |
| `PriorityFilter` | projects/agentic-workflow/src/cli/issues.rs | enum | pub | 298 |  |
| `ReviewArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 576 |  |
| `ShowArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 216 |  |
| `StateFilter` | projects/agentic-workflow/src/cli/issues.rs | enum | pub | 612 |  |
| `TypeFilter` | projects/agentic-workflow/src/cli/issues.rs | enum | pub | 631 |  |
| `UpdateArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 320 |  |
| `ValidateArgs` | projects/agentic-workflow/src/cli/issues.rs | struct | pub | 505 |  |
| `as_label_suffix` | projects/agentic-workflow/src/cli/issues.rs | function | pub | 308 | as_label_suffix(&self) -> &'static str |
| `build_create_label_vec` | projects/agentic-workflow/src/cli/issues.rs | function | pub | 1416 | build_create_label_vec(     type_label: &str,     project_labels: &[String],     priority_label: Option<&str>,     agent_label: Option<&str>, ) -> Vec<String> |
| `check_project_cardinality` | projects/agentic-workflow/src/cli/issues.rs | function | pub | 1391 | check_project_cardinality(     issue_type: IssueType,     observed: usize, ) -> std::result::Result<(), CreateValidationError> |
| `load_project_open_issues` | projects/agentic-workflow/src/cli/issues.rs | function | pub | 3349 | load_project_open_issues(     project_root: &Path,     project: &str,     repo: Option<String>, ) -> Result<(String, String, Vec<Issue>)> |
| `prioritize_lanes` | projects/agentic-workflow/src/cli/issues.rs | function | pub | 3777 | prioritize_lanes(issues: &[Issue]) -> PrioritizeLanes |
| `read_known_agent_name_label_pairs` | projects/agentic-workflow/src/cli/issues.rs | function | pub | 1172 | read_known_agent_name_label_pairs(project_root: &Path) -> Vec<(String, String)> |
| `read_known_project_name_label_pairs` | projects/agentic-workflow/src/cli/issues.rs | function | pub | 1163 | read_known_project_name_label_pairs(project_root: &Path) -> Vec<(String, String)> |
| `resolve_agent_label` | projects/agentic-workflow/src/cli/issues.rs | function | pub | 1298 | resolve_agent_label(     project_root: &Path,     name: &str, ) -> std::result::Result<String, CreateValidationError> |
| `resolve_project_label` | projects/agentic-workflow/src/cli/issues.rs | function | pub | 1225 | resolve_project_label(     project_root: &Path,     name: &str, ) -> std::result::Result<String, CreateValidationError> |
| `run` | projects/agentic-workflow/src/cli/issues.rs | function | pub | 1009 | run(args: IssuesArgs) -> Result<()> |
| `to_envelope_message` | projects/agentic-workflow/src/cli/issues.rs | function | pub | 1352 | to_envelope_message(&self) -> String |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/cli/issues.rs -->
````rust
...
//! `--backend` flag. Output is human-formatted by default; pass `--json`
//! to get a machine-parseable array/object (for agent consumption).

use crate::issues::{
    make_backend, remote_read_cache_backend, resolve_default_backend, Issue, IssueBackend,
    IssueErrorCode, IssueFilter, IssuePatch, IssueState, IssueType, LocalBackend,
};
...
pub struct EnrichArgs {
    /// Work-item slug (filename stem from .aw/issues/).
    pub slug: String,
}
...
async fn run_create(args: CreateArgs) -> Result<()> {
    ...
    if create_uses_remote_backend(&kind) {
        ...
        // Write the issue into the current checkout's `.aw/issues`.
        ...
        // Validates the checkout-hosted issue file. Rollback removes the file
        // from the current checkout; the branch stays in place so the user can
        ...
        if looks_like_structured_attempt(&created.body) {
            if let Err(verr) = validate_structured_issue(&created.body, created.state) {
                let issue_path = active_path
                    .join(".aw/issues/open")
                    .join(format!("{}.md", created.slug));
...
async fn run_fill_section_brief(
    ...
    println!("Issue file: .aw/issues/open/{}.md", slug);
        ...
        Err(e) => {
            if args.push && e.to_string().contains("not found") {
                ...
                if kind != "local" {
                    let remote = make_backend(&kind, &project_root, repo.clone(), host.clone())
                        .context("Failed to create remote backend")?;
                    let updated = match remote.update(&args.id, &patch).await {
                        Ok(issue) => issue,
                        Err(e) => {
                            if args.json {
                                emit_json_error(&e.to_string(), IssueErrorCode::Backend);
    ...
    if args.push && !updated_from_remote {
        if let Some(remote_id) = updated.github_id.or(updated.gitlab_id) {
            let remote = make_backend("github", &project_root, args.repo.clone(), None)
                .context("Failed to create remote backend")?;
            if let Err(e) = remote.update(&remote_id.to_string(), &patch).await {
                if args.json {
                    emit_json_error(&e.to_string(), IssueErrorCode::Backend);
                }
                return Err(e);
...
fn render_capability_wi_plan(
    ...
    out.push_str(&format!(
        "4. `aw run --project {} --max-ticks 1 --json`\n",
        project
    ));
...
async fn run_enrich(args: EnrichArgs) -> Result<()> {
    ...
    let result = serde_json::json!({
        ...
        "message": format!(
            "Mainthread: {} the ## Reference Context section in .aw/issues/open/{}.md.",
