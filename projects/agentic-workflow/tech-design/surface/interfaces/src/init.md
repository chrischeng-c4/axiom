...
# Standardized projects/agentic-workflow/src/cli/init.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/cli/init.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `NewArgs` | projects/agentic-workflow/src/cli/init.rs | struct | pub | 71 |  |
| `run_new` | projects/agentic-workflow/src/cli/init.rs | function | pub | 89 | run_new(args: NewArgs) -> Result<()> |
| `WorkspaceType` | projects/agentic-workflow/src/cli/init.rs | enum | pub(crate) | 615 |  |
| `detect_workspace_type` | projects/agentic-workflow/src/cli/init.rs | function | pub(crate) | 631 | detect_workspace_type(project_root: &Path) -> WorkspaceType |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/cli/init.rs -->
```rust
