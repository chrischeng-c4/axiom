...
# Standardized projects/agentic-workflow/src/cli/workflow_guard.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/cli/workflow_guard.rs` generated from AST during Score force-regeneration standardization.
...
| `TransitionLock` | projects/agentic-workflow/src/cli/workflow_guard.rs | struct | pub | 25 |  |
...
| `with_active_phase` | projects/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 83 | with_active_phase(mut self, phase: impl Into<String>) -> Self |
| `with_current_section` | projects/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 93 | with_current_section(mut self, section: impl Into<String>) -> Self |
| `with_dirty_paths` | projects/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 106 | with_dirty_paths(mut self, paths: impl IntoIterator<Item = impl Into<String>>) -> Self |
| `with_expected_payload` | projects/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 73 | with_expected_payload(mut self, path: impl Into<String>) -> Self |
| `with_phase_from` | projects/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 78 | with_phase_from(mut self, phase: impl Into<String>) -> Self |
| `with_remaining_sections` | projects/agentic-workflow/src/cli/workflow_guard.rs | function | pub | 98 | with_remaining_sections(         mut self,         sections: impl IntoIterator<Item = impl Into<String>>,     ) -> Self |
## Source
<!-- type: source lang: rust -->
<!-- source-snapshot: path=projects/agentic-workflow/src/cli/workflow_guard.rs -->
`````rust
