---
id: projects-score-src-fillback-rs
...
# Standardized projects/agentic-workflow/src/cli/fillback.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/cli/fillback.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `run` | projects/agentic-workflow/src/cli/fillback.rs | function | pub | 25 | run(path: Option<&str>, module: Option<&str>, force: bool) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/cli/fillback.rs -->
```rust
...
use agentic_workflow::fillback::code::{CodeStrategy, CodeStrategyConfig};
use agentic_workflow::fillback::ImportStrategy;
