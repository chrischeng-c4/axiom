---
id: projects-score-src-update-rs
...
# Standardized projects/agentic-workflow/src/cli/update.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/cli/update.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `is_newer` | projects/agentic-workflow/src/cli/update.rs | function | pub | 102 | is_newer(new_version: &str, current: &str) -> bool |
| `run` | projects/agentic-workflow/src/cli/update.rs | function | pub | 14 | run(check_only: bool) -> Result<()> |
## Source
