...
Public API manifest for `projects/agentic-workflow/src/cli/proposal.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ProposalCommands` | projects/agentic-workflow/src/cli/proposal.rs | enum | pub | 16 |  |
| `run` | projects/agentic-workflow/src/cli/proposal.rs | function | pub | 31 | run(cmd: ProposalCommands) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=projects/agentic-workflow/src/cli/proposal.rs -->
```rust
