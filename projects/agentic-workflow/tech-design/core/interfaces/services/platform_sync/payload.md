...
# Standardized projects/agentic-workflow/src/services/platform_sync/payload.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/services/platform_sync/payload.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `build_payload` | projects/agentic-workflow/src/services/platform_sync/payload.rs | function | pub | 143 | build_payload(project_root: &Path, change_id: &str) -> Result<SyncPayload> |
| `build_payload_with_config` | projects/agentic-workflow/src/services/platform_sync/payload.rs | function | pub | 160 | build_payload_with_config(     project_root: &Path,     change_id: &str,     config: Option<&PlatformConfig>, ) -> Result<SyncPayload> |
| `update_body_with_spec_links` | projects/agentic-workflow/src/services/platform_sync/payload.rs | function | pub | 333 | update_body_with_spec_links(     body: &str,     spec_links: &[(String, u64, String)], // (spec_id, issue_number, url) ) -> String |
| `write_issue_to_frontmatter` | projects/agentic-workflow/src/services/platform_sync/payload.rs | function | pub | 70 | write_issue_to_frontmatter(path: &Path, issue_number: u64) -> Result<()> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=projects/agentic-workflow/src/services/platform_sync/payload.rs -->
~~~rust
