...
# Standardized projects/agentic-workflow/src/services/reference_context_service_tests.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/services/reference_context_service_tests.rs` generated from AST during Score force-regeneration standardization.
...
<!-- source-snapshot: path=projects/agentic-workflow/src/services/reference_context_service_tests.rs -->
```rust
use super::*;
...
```yaml
changes:
  - path: projects/agentic-workflow/src/services/reference_context_service_tests.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
