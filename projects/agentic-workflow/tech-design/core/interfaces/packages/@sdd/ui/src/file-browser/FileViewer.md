...
# Standardized projects/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `EXT_TO_LANGUAGE` | projects/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 15 |  |
| `FileViewer` | projects/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | function | pub | 43 | FileViewer({ file }: FileViewerProps) |
| `FileViewerProps` | projects/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | interface | pub | 11 |  |
| `IMAGE_EXTENSIONS` | projects/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 34 |  |
| `VIDEO_EXTENSIONS` | projects/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 35 |  |
| `bodyRows` | projects/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 166 |  |
| `getExtension` | projects/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | function | pub | 37 | getExtension(filename: string) |
| `language` | projects/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 91 |  |
| `parsed` | projects/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 112 |  |
| `rows` | projects/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 120 |  |
| `rows` | projects/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx | constant | pub | 151 |  |
## Source
...
```yaml
changes:
  - path: projects/agentic-workflow/packages/@sdd/ui/src/file-browser/FileViewer.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
