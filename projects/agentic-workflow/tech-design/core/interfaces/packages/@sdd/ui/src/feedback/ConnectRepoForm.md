...
# Standardized projects/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ConnectRepoFormData` | projects/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | interface | pub | 9 |  |
| `ConnectRepoFormProps` | projects/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | interface | pub | 30 |  |
| `LegacyConnectRepoFormData` | projects/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | interface | pub | 23 |  |
| `Platform` | projects/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | type | pub | 7 |  |
| `[form, setForm]` | projects/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | constant | pub | 39 |  |
| `[platform, setPlatform]` | projects/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | constant | pub | 38 |  |
| `handleSubmit` | projects/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | function | pub | 52 |  |
| `isGitHubValid` | projects/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | constant | pub | 49 |  |
| `isGitLabValid` | projects/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | constant | pub | 48 |  |
| `isValid` | projects/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | constant | pub | 50 |  |
| `platformLabel` | projects/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx | constant | pub | 76 |  |
## Source
...
```yaml
changes:
  - path: projects/agentic-workflow/packages/@sdd/ui/src/feedback/ConnectRepoForm.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
