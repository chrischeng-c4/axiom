---
id: projects-sdd-packages-sdd-ui-src-editing-inlineeditdescription-tsx
...
# Standardized projects/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `InlineEditDescriptionProps` | projects/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx | interface | pub | 9 |  |
| `[draft, setDraft]` | projects/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx | constant | pub | 19 |  |
| `[editing, setEditing]` | projects/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx | constant | pub | 18 |  |
| `save` | projects/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx | function | pub | 29 |  |
| `textareaRef` | projects/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx | constant | pub | 20 |  |
## Source
...
```yaml
changes:
  - path: projects/agentic-workflow/packages/@sdd/ui/src/editing/InlineEditDescription.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
