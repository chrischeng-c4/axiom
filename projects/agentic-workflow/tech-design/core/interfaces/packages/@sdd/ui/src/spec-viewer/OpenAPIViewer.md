---
id: projects-sdd-packages-sdd-ui-src-spec-viewer-openapiviewer-tsx
...
# Standardized projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Endpoint` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | interface | pub | 24 |  |
| `HTTP_METHODS` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 11 |  |
| `HttpMethod` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | type | pub | 12 |  |
| `METHOD_COLORS` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 14 |  |
| `OpenAPIViewerProps` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | interface | pub | 7 |  |
| `[expanded, setExpanded]` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 36 |  |
| `[showSource, setShowSource]` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 139 |  |
| `endpoints` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 149 |  |
| `parameters` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 39 |  |
| `requestBody` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 40 |  |
| `responses` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 41 |  |
| `schemaToString` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | function | pub | 31 | schemaToString(schema: unknown) |
| `{ method, path, op }` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 37 |  |
| `{ parsed, error }` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx | constant | pub | 141 |  |
## Source
...
```yaml
changes:
  - path: projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/OpenAPIViewer.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
