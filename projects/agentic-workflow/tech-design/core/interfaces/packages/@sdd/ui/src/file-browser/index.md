...
# Standardized projects/agentic-workflow/packages/@sdd/ui/src/file-browser/index.ts

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/packages/@sdd/ui/src/file-browser/index.ts` generated from AST during Score force-regeneration standardization.
...
```yaml
changes:
  - path: projects/agentic-workflow/packages/@sdd/ui/src/file-browser/index.ts
    action: create
    section: source
    impl_mode: codegen
    description: |
