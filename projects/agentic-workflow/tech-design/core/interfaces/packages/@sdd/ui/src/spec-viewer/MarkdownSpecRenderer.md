---
id: projects-sdd-packages-sdd-ui-src-spec-viewer-markdownspecrenderer-tsx
...
# Standardized projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Heading` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx | interface | pub | 21 |  |
| `[MermaidDiagram, setMermaidDiagram]` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx | constant | pub | 43 |  |
| `[showSource, setShowSource]` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx | constant | pub | 42 |  |
| `makeId` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx | function | pub | 33 | makeId(scope: string, text: string) |
| `parseHeadings` | projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx | function | pub | 23 | parseHeadings(content: string) |
## Source
...
```yaml
changes:
  - path: projects/agentic-workflow/packages/@sdd/ui/src/spec-viewer/MarkdownSpecRenderer.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
