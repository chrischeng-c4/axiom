---
id: projects-sdd-packages-sdd-ui-src-pipeline-specpipelinehistory-tsx
...
# Standardized projects/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `NodeStatusIcon` | projects/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | function | pub | 14 | NodeStatusIcon({ status }: { status: StageStatus }) |
| `[MermaidDiagram, setMermaidDiagram]` | projects/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | constant | pub | 30 |  |
| `[expanded, setExpanded]` | projects/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | constant | pub | 284 |  |
| `[showSource, setShowSource]` | projects/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | constant | pub | 29 |  |
| `buckets` | projects/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | constant | pub | 247 |  |
| `handleSelectNode` | projects/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | function | pub | 334 |  |
| `hasAnyHistory` | projects/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | constant | pub | 332 |  |
| `multiModule` | projects/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx | constant | pub | 248 |  |
## Source
...
```yaml
changes:
  - path: projects/agentic-workflow/packages/@sdd/ui/src/pipeline/SpecPipelineHistory.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
      Generate the complete SpecPipelineHistory component from the generic
      Source template. This is a cross-language raw source template used for
      regenerable adoption before a higher-level React generator exists.
```
