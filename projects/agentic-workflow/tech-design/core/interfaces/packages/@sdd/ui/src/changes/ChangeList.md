---
id: projects-sdd-packages-sdd-ui-src-changes-changelist-tsx
...
# Standardized projects/agentic-workflow/packages/@sdd/ui/src/changes/ChangeList.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/packages/@sdd/ui/src/changes/ChangeList.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ChangeListProps` | projects/agentic-workflow/packages/@sdd/ui/src/changes/ChangeList.tsx | interface | pub | 14 |  |
| `STATUS_COLORS` | projects/agentic-workflow/packages/@sdd/ui/src/changes/ChangeList.tsx | constant | pub | 6 |  |
## Source
...
```yaml
changes:
  - path: projects/agentic-workflow/packages/@sdd/ui/src/changes/ChangeList.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
