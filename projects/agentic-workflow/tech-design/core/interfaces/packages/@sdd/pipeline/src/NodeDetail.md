---
id: projects-sdd-packages-sdd-pipeline-src-nodedetail-tsx
...
# Standardized projects/agentic-workflow/packages/@sdd/pipeline/src/NodeDetail.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/packages/@sdd/pipeline/src/NodeDetail.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `STATUS_BADGE` | projects/agentic-workflow/packages/@sdd/pipeline/src/NodeDetail.tsx | constant | pub | 6 |  |
| `StatusBadge` | projects/agentic-workflow/packages/@sdd/pipeline/src/NodeDetail.tsx | function | pub | 14 | StatusBadge({ status }: { status: NodeStatus }) |
## Source
...
```yaml
changes:
  - path: projects/agentic-workflow/packages/@sdd/pipeline/src/NodeDetail.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
