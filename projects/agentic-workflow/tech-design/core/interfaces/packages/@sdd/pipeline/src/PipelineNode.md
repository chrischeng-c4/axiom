...
# Standardized projects/agentic-workflow/packages/@sdd/pipeline/src/PipelineNode.tsx

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/packages/@sdd/pipeline/src/PipelineNode.tsx` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `STATUS_COLORS` | projects/agentic-workflow/packages/@sdd/pipeline/src/PipelineNode.tsx | constant | pub | 5 |  |
| `colors` | projects/agentic-workflow/packages/@sdd/pipeline/src/PipelineNode.tsx | constant | pub | 17 |  |
## Source
...
```yaml
changes:
  - path: projects/agentic-workflow/packages/@sdd/pipeline/src/PipelineNode.tsx
    action: create
    section: source
    impl_mode: codegen
    description: |
