...
Public API manifest for `projects/agentic-workflow/src/agents/restructure_codebase.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RestructureCodebaseAgent` | projects/agentic-workflow/src/agents/restructure_codebase.rs | struct | pub | 70 |  |
| `RestructureCodebaseAgentBuilder` | projects/agentic-workflow/src/agents/restructure_codebase.rs | struct | pub | 79 |  |
| `RestructureCodebaseAgentConfig` | projects/agentic-workflow/src/agents/restructure_codebase.rs | struct | pub | 55 |  |
| `build` | projects/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 313 | build(self) -> NovaResult<RestructureCodebaseAgent> |
| `builder` | projects/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 192 | builder() -> RestructureCodebaseAgentBuilder |
| `new` | projects/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 271 | new() -> Self |
| `with_max_retries` | projects/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 303 | with_max_retries(mut self, n: u32) -> Self |
| `with_max_turns` | projects/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 298 | with_max_turns(mut self, max_turns: u32) -> Self |
| `with_model` | projects/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 288 | with_model(mut self, model: impl Into<String>) -> Self |
| `with_provider` | projects/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 278 | with_provider(mut self, provider: P) -> Self |
| `with_provider_arc` | projects/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 283 | with_provider_arc(mut self, provider: Arc<dyn LLMProvider>) -> Self |
| `with_temperature` | projects/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 293 | with_temperature(mut self, temperature: f32) -> Self |
| `with_token_budget` | projects/agentic-workflow/src/agents/restructure_codebase.rs | function | pub | 308 | with_token_budget(mut self, budget: u64) -> Self |
## Schema
...
<!-- source-snapshot: path=projects/agentic-workflow/src/agents/restructure_codebase.rs -->
~~~rust
