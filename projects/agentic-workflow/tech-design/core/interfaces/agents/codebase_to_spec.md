...
Public API manifest for `projects/agentic-workflow/src/agents/codebase_to_spec.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CodebaseToSpecAgent` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | struct | pub | 70 |  |
| `CodebaseToSpecAgentBuilder` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | struct | pub | 79 |  |
| `CodebaseToSpecAgentConfig` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | struct | pub | 57 |  |
| `CodebaseToSpecInput` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | struct | pub | 45 |  |
| `build` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | function | pub | 415 | build(self) -> NovaResult<CodebaseToSpecAgent> |
| `builder` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | function | pub | 118 | builder() -> CodebaseToSpecAgentBuilder |
| `generate_spec` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | function | pub | 123 | generate_spec(&self, input: &CodebaseToSpecInput) -> NovaResult<String> |
| `new` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | function | pub | 378 | new() -> Self |
| `revise_spec` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | function | pub | 129 | revise_spec(&self, spec: &str, issues: &[ReviewIssue]) -> NovaResult<String> |
| `with_max_retries` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | function | pub | 410 | with_max_retries(mut self, n: u32) -> Self |
| `with_max_tokens` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | function | pub | 400 | with_max_tokens(mut self, max_tokens: u32) -> Self |
| `with_model` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | function | pub | 395 | with_model(mut self, model: impl Into<String>) -> Self |
| `with_provider` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | function | pub | 385 | with_provider(mut self, provider: P) -> Self |
| `with_provider_arc` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | function | pub | 390 | with_provider_arc(mut self, provider: Arc<dyn LLMProvider>) -> Self |
| `with_temperature` | projects/agentic-workflow/src/agents/codebase_to_spec.rs | function | pub | 405 | with_temperature(mut self, temperature: f32) -> Self |
## Schema
...
<!-- source-snapshot: path=projects/agentic-workflow/src/agents/codebase_to_spec.rs -->
~~~rust
...
changes:
  - path: projects/agentic-workflow/src/agents/codebase_to_spec.rs
    ...
    impl_mode: codegen
    description: |
      Source template owns the complete codebase-to-spec agent module,
      including generated data shapes, defaults, prompt builders, LLM retry
      behavior, Agent dispatch, builder methods, and unit tests.
  - action: annotate
    section: schema
...
- [overview] 4 standard agent pattern types.
