...
# Change Spec Agent Types

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/agents/change_spec.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ChangeSpecAgent` | projects/agentic-workflow/src/agents/change_spec.rs | struct | pub | 85 |  |
| `ChangeSpecAgentBuilder` | projects/agentic-workflow/src/agents/change_spec.rs | struct | pub | 94 |  |
| `ChangeSpecAgentConfig` | projects/agentic-workflow/src/agents/change_spec.rs | struct | pub | 72 |  |
| `ChangeSpecInput` | projects/agentic-workflow/src/agents/change_spec.rs | struct | pub | 62 |  |
| `build` | projects/agentic-workflow/src/agents/change_spec.rs | function | pub | 421 | build(self) -> NovaResult<ChangeSpecAgent> |
| `builder` | projects/agentic-workflow/src/agents/change_spec.rs | function | pub | 133 | builder() -> ChangeSpecAgentBuilder |
| `generate_spec` | projects/agentic-workflow/src/agents/change_spec.rs | function | pub | 138 | generate_spec(&self, input: &ChangeSpecInput) -> NovaResult<String> |
| `new` | projects/agentic-workflow/src/agents/change_spec.rs | function | pub | 384 | new() -> Self |
| `revise_spec` | projects/agentic-workflow/src/agents/change_spec.rs | function | pub | 144 | revise_spec(&self, spec: &str, issues: &[ReviewIssue]) -> NovaResult<String> |
| `with_max_retries` | projects/agentic-workflow/src/agents/change_spec.rs | function | pub | 416 | with_max_retries(mut self, n: u32) -> Self |
| `with_max_tokens` | projects/agentic-workflow/src/agents/change_spec.rs | function | pub | 406 | with_max_tokens(mut self, max_tokens: u32) -> Self |
| `with_model` | projects/agentic-workflow/src/agents/change_spec.rs | function | pub | 401 | with_model(mut self, model: impl Into<String>) -> Self |
| `with_provider` | projects/agentic-workflow/src/agents/change_spec.rs | function | pub | 391 | with_provider(mut self, provider: P) -> Self |
| `with_provider_arc` | projects/agentic-workflow/src/agents/change_spec.rs | function | pub | 396 | with_provider_arc(mut self, provider: Arc<dyn LLMProvider>) -> Self |
| `with_temperature` | projects/agentic-workflow/src/agents/change_spec.rs | function | pub | 411 | with_temperature(mut self, temperature: f32) -> Self |
## Schema
...
definitions:
  ChangeSpecInput:
    ...
    description: Input for ChangeSpecAgent.
    properties:
      issue:
        type: object
        x-rust-type: "StructuredIssue"
        description: "The structured issue to resolve."
      context:
        type: object
        x-rust-type: "ReferenceContextOutput"
        description: "Synthesized reference context from existing project specs."
    x-rust-struct:
  ...
  ChangeSpecAgentConfig:
    ...
    description: Configuration for ChangeSpecAgent.
    properties:
      model:
        type: string
  ...
  ChangeSpecAgent:
    ...
    description: ChangeSpec agent.
    properties:
      config:
        type: object
        x-rust-type: "ChangeSpecAgentConfig"
  ...
  ChangeSpecAgentBuilder:
    type: object
    required: [config, provider]
    description: Builder for ChangeSpecAgent.
    properties:
      config:
        type: object
        x-rust-type: "ChangeSpecAgentConfig"
...
<!-- source-snapshot: path=projects/agentic-workflow/src/agents/change_spec.rs -->
~~~rust
