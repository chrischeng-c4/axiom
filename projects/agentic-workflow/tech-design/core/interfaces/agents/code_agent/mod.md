...
Public API manifest for `projects/agentic-workflow/src/agents/code_agent/mod.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CodeAgent` | projects/agentic-workflow/src/agents/code_agent/mod.rs | struct | pub | 64 |  |
| `CodeAgentBuilder` | projects/agentic-workflow/src/agents/code_agent/mod.rs | struct | pub | 77 |  |
| `CodeAgentConfig` | projects/agentic-workflow/src/agents/code_agent/mod.rs | struct | pub | 47 |  |
| `build` | projects/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 389 | build(self) -> NovaResult<CodeAgent> |
| `builder` | projects/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 118 | builder() -> CodeAgentBuilder |
| `new` | projects/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 319 | new() -> Self |
| `with_base_branch` | projects/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 374 | with_base_branch(mut self, branch: impl Into<String>) -> Self |
| `with_branch_prefix` | projects/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 379 | with_branch_prefix(mut self, prefix: impl Into<String>) -> Self |
| `with_max_revisions` | projects/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 369 | with_max_revisions(mut self, n: u32) -> Self |
| `with_model` | projects/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 364 | with_model(mut self, model: impl Into<String>) -> Self |
| `with_platform` | projects/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 353 | with_platform(mut self, platform: P) -> Self |
| `with_platform_arc` | projects/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 359 | with_platform_arc(mut self, platform: Arc<dyn PlatformIntegration>) -> Self |
| `with_provider` | projects/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 329 | with_provider(mut self, provider: P) -> Self |
| `with_provider_arc` | projects/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 335 | with_provider_arc(mut self, provider: Arc<dyn LLMProvider>) -> Self |
| `with_reviewer` | projects/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 341 | with_reviewer(mut self, reviewer: R) -> Self |
| `with_reviewer_arc` | projects/agentic-workflow/src/agents/code_agent/mod.rs | function | pub | 347 | with_reviewer_arc(mut self, reviewer: Arc<dyn Reviewer>) -> Self |
## Schema
...
<!-- source-snapshot: path=projects/agentic-workflow/src/agents/code_agent/mod.rs -->
````rust
