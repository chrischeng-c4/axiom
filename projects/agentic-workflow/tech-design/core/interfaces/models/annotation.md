...
Public API manifest for `projects/agentic-workflow/src/models/annotation.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Annotation` | projects/agentic-workflow/src/models/annotation.rs | struct | pub | 20 |  |
| `AnnotationError` | projects/agentic-workflow/src/models/annotation.rs | enum | pub | 100 |  |
| `AnnotationResult` | projects/agentic-workflow/src/models/annotation.rs | type | pub | 95 |  |
| `AnnotationStore` | projects/agentic-workflow/src/models/annotation.rs | struct | pub | 41 |  |
| `add` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 191 | add(&mut self, annotation: Annotation) |
| `find` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 196 | find(&self, id: &str) -> Option<&Annotation> |
| `find_mut` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 201 | find_mut(&mut self, id: &str) -> Option<&mut Annotation> |
| `for_file` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 206 | for_file(&self, file: &str) -> Vec<&Annotation> |
| `for_section` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 211 | for_section(&self, file: &str, section_id: &str) -> Vec<&Annotation> |
| `get_author_name` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 260 | get_author_name() -> String |
| `is_empty` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 243 | is_empty(&self) -> bool |
| `len` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 238 | len(&self) -> usize |
| `load` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 131 | load(path: &Path, change_id: &str) -> AnnotationResult<Self> |
| `new` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 51 | new(         file: impl Into<String>,         section_id: impl Into<String>,         content: impl Into<String>,         author: impl Into<String>,     ) -> Self |
| `new` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 120 | new(change_id: impl Into<String>) -> Self |
| `remove` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 228 | remove(&mut self, id: &str) -> AnnotationResult<Annotation> |
| `resolve` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 88 | resolve(&mut self) |
| `resolve` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 219 | resolve(&mut self, id: &str) -> AnnotationResult<()> |
| `save` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 162 | save(&self, path: &Path) -> AnnotationResult<()> |
| `unresolved_count` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 248 | unresolved_count(&self) -> usize |
| `with_timestamp` | projects/agentic-workflow/src/models/annotation.rs | function | pub | 69 | with_timestamp(         file: impl Into<String>,         section_id: impl Into<String>,         content: impl Into<String>,         author: impl Into<String>,         created_at: DateTime<Utc>,     ) -> Self |
## Schema
...
definitions:
  Annotation:
    type: object
    required: [id, file, section_id, content, author, created_at, resolved]
    description: A single annotation comment on a plan section.
    properties:
      id:
        type: string
      ...
      file:
        type: string
        description: "File being annotated (e.g., \"proposal.md\")."
      section_id:
        type: string
        description: "Section ID (slugified heading text)."
      content:
        type: string
        description: "Annotation content/comment."
      author:
        type: string
        description: "Author name (auto-populated from git config or OS user)."
      created_at:
        type: string
  ...
  AnnotationStore:
    ...
    description: Container for all annotations associated with a change.
    properties:
      change_id:
        type: string
        description: "Change ID this store belongs to."
      annotations:
        type: array
        items:
...
<!-- source-snapshot: path=projects/agentic-workflow/src/models/annotation.rs -->
```rust
...
changes:
  - path: projects/agentic-workflow/src/models/annotation.rs
    ...
    impl_mode: codegen
    description: |
      Source template owns the complete annotation model module.
  - action: annotate
    section: schema
...
- [schema] All 7 `Annotation` fields, their types, and derives (`Debug, Clone, Serialize, Deserialize, PartialEq`) match the live source exactly; `x-serde-default: true` on `resolved` is correct.
- [schema] `AnnotationStore` fields and derives (`Debug, Clone, Serialize, Deserialize`, no `PartialEq`) match source.
- [overview] Hand-written boundary is clearly documented and consistent with `## Changes`; `AnnotationError` exclusion rationale (thiserror gap) is correctly stated.
- [changes] `replaces` list contains only the two structs under codegen scope; hand-written block enumerates all preserved items accurately.
