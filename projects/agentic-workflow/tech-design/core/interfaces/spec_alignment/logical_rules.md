...
# Standardized projects/agentic-workflow/src/spec_alignment/logical_rules.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/spec_alignment/logical_rules.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `check` | projects/agentic-workflow/src/spec_alignment/logical_rules.rs | function | pub | 30 | check(doc: &SpecDocument) -> Vec<Violation> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:claim-code -->

<!-- source-snapshot: path=projects/agentic-workflow/src/spec_alignment/logical_rules.rs -->
```rust
...
```yaml
changes:
  - path: projects/agentic-workflow/src/spec_alignment/logical_rules.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
