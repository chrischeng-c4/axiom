...
Public API manifest for `projects/agentic-workflow/src/spec_ir/orchestrator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `CodegenStrategy` | projects/agentic-workflow/src/spec_ir/orchestrator.rs | enum | pub | 15 |  |
| `detect_yaml_ir` | projects/agentic-workflow/src/spec_ir/orchestrator.rs | function | pub | 28 | detect_yaml_ir(change_dir: &Path) -> Vec<PathBuf> |
| `has_yaml_ir` | projects/agentic-workflow/src/spec_ir/orchestrator.rs | function | pub | 81 | has_yaml_ir(change_dir: &Path) -> bool |
| `resolve_strategy` | projects/agentic-workflow/src/spec_ir/orchestrator.rs | function | pub | 63 | resolve_strategy(change_dir: &Path, legacy_allowed: bool) -> CodegenStrategy |
## Schema
...
<!-- source-snapshot: path=projects/agentic-workflow/src/spec_ir/orchestrator.rs -->
```rust
...
```yaml
changes:
  - path: projects/agentic-workflow/src/spec_ir/orchestrator.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
