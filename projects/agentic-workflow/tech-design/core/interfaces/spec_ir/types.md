...
Public API manifest for `projects/agentic-workflow/src/spec_ir/types.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `API_VERSION` | projects/agentic-workflow/src/spec_ir/types.rs | constant | pub | 30 |  |
| `ManifestMetadata` | projects/agentic-workflow/src/spec_ir/types.rs | struct | pub | 56 |  |
| `SpecKind` | projects/agentic-workflow/src/spec_ir/types.rs | enum | pub | 37 |  |
| `SpecManifest` | projects/agentic-workflow/src/spec_ir/types.rs | struct | pub | 79 |  |
| `as_snake` | projects/agentic-workflow/src/spec_ir/types.rs | function | pub | 92 | as_snake(&self) -> &'static str |
| `filename` | projects/agentic-workflow/src/spec_ir/types.rs | function | pub | 216 | filename(&self) -> String |
| `from_file` | projects/agentic-workflow/src/spec_ir/types.rs | function | pub | 177 | from_file(path: &Path) -> crate::Result<Self> |
| `from_spec_ir_kind` | projects/agentic-workflow/src/spec_ir/types.rs | function | pub | 116 | from_spec_ir_kind(tag: &str) -> Option<Self> |
| `from_str_loose` | projects/agentic-workflow/src/spec_ir/types.rs | function | pub | 129 | from_str_loose(s: &str) -> Option<Self> |
| `from_yaml` | projects/agentic-workflow/src/spec_ir/types.rs | function | pub | 169 | from_yaml(yaml: &str) -> crate::Result<Self> |
| `new` | projects/agentic-workflow/src/spec_ir/types.rs | function | pub | 145 | new(         kind: SpecKind,         name: impl Into<String>,         change_id: impl Into<String>,         spec: serde_yaml::Value,     ) -> Self |
| `spec_ir_kind` | projects/agentic-workflow/src/spec_ir/types.rs | function | pub | 107 | spec_ir_kind(&self) -> &'static str |
| `to_yaml` | projects/agentic-workflow/src/spec_ir/types.rs | function | pub | 164 | to_yaml(&self) -> crate::Result<String> |
| `validate` | projects/agentic-workflow/src/spec_ir/types.rs | function | pub | 196 | validate(&self) -> crate::Result<()> |
| `write_to` | projects/agentic-workflow/src/spec_ir/types.rs | function | pub | 184 | write_to(&self, path: &Path) -> crate::Result<()> |
## Schema
...
<!-- source-snapshot: path=projects/agentic-workflow/src/spec_ir/types.rs -->
```rust
...
```yaml
changes:
  - path: projects/agentic-workflow/src/spec_ir/types.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
