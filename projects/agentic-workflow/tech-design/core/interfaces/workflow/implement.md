...
# Standardized projects/agentic-workflow/src/workflow/implement.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/workflow/implement.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `handle` | projects/agentic-workflow/src/workflow/implement.rs | function | pub | 29 | handle(change_dir: &Path, change_id: &str, project_path: &str) -> Result<Value> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=projects/agentic-workflow/src/workflow/implement.rs -->
~~~rust
...
```yaml
changes:
  - path: projects/agentic-workflow/src/workflow/implement.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
