...
# Standardized projects/agentic-workflow/src/workflow/mod.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/workflow/mod.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `definition` | projects/agentic-workflow/src/workflow/mod.rs | function | pub | 34 | definition() -> ToolDefinition |
| `execute` | projects/agentic-workflow/src/workflow/mod.rs | function | pub | 85 | execute(args: &Value, project_root: &Path) -> Result<String> |
| `helpers` | projects/agentic-workflow/src/workflow/mod.rs | module | pub | 17 |  |
| `scope` | projects/agentic-workflow/src/workflow/mod.rs | module | pub | 19 |  |
| `task_graph` | projects/agentic-workflow/src/workflow/mod.rs | module | pub | 20 |  |
| `test_gate` | projects/agentic-workflow/src/workflow/mod.rs | module | pub | 21 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/workflow/mod.rs -->
```rust
