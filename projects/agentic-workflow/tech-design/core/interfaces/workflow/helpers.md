...
Public API manifest for `projects/agentic-workflow/src/workflow/helpers.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RUN_CHANGE_TOOL` | projects/agentic-workflow/src/workflow/helpers.rs | constant | pub | 17 |  |
| `SpecInfo` | projects/agentic-workflow/src/workflow/helpers.rs | struct | pub | 268 |  |
| `analyze_specs` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 292 | analyze_specs(     proposal_path: &Path,     specs_dir: &Path, ) -> crate::Result<(Vec<SpecInfo>, Option<String>)> |
| `check_exploration_needs_clarification` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 196 | check_exploration_needs_clarification(path: &Path) -> bool |
| `collect_alignment_warnings` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 763 | collect_alignment_warnings(change_dir: &Path) -> Option<Vec<serde_json::Value>> |
| `collect_spec_files` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 725 | collect_spec_files(dir: &Path) -> Vec<String> |
| `count_spec_files` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 276 | count_spec_files(specs_dir: &Path) -> usize |
| `extract_review_info` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 611 | extract_review_info(path: &Path) -> (Option<String>, Vec<String>) |
| `extract_verdict` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 547 | extract_verdict(path: &Path) -> Option<String> |
| `extract_verdict_from_content` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 554 | extract_verdict_from_content(content: &str) -> Option<String> |
| `extract_verdict_or_approved` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 530 | extract_verdict_or_approved(path: &Path) -> Option<String> |
| `find_specs_to_merge` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 666 | find_specs_to_merge(change_dir: &Path) -> Vec<std::path::PathBuf> |
| `format_cli_command` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 41 | format_cli_command(tool: &str, args: &serde_json::Value) -> String |
| `get_last_review_verdict` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 439 | get_last_review_verdict(change_dir: &Path) -> Option<String> |
| `get_schema_version` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 153 | get_schema_version(change_dir: &Path) -> u32 |
| `has_review_verdict` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 511 | has_review_verdict(change_dir: &Path, artifact: &str) -> bool |
| `has_review_verdict_at` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 521 | has_review_verdict_at(path: &Path) -> bool |
| `mainthread_must_fix` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 222 | mainthread_must_fix(     change_id: &str,     phase: &StatePhase,     artifact_type: &str,     review_file: &str,     interface: SddInterface, ) -> serde_json::Value |
| `next_action` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 27 | next_action(     _interface: SddInterface,     tool: &str,     args: serde_json::Value, ) -> serde_json::Value |
| `parse_affected_specs` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 357 | parse_affected_specs(content: &str) -> Vec<SpecInfo> |
| `phase_to_string` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 143 | phase_to_string(phase: &StatePhase) -> &'static str |
| `read_complexity_from_state` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 179 | read_complexity_from_state(change_dir: &Path) -> Option<String> |
| `suggest_topics` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 210 | suggest_topics(description: &str) -> Vec<&'static str> |
| `write_artifact_payload` | projects/agentic-workflow/src/workflow/helpers.rs | function | pub | 111 | write_artifact_payload(     project_root: &Path,     change_id: &str,     group_id: Option<&str>,     action_kebab: &str,     payload: &serde_json::Value, ) -> crate::Result<String> |
## Schema
...
definitions:
  SpecInfo:
    type: object
    required: [id, depends]
    description: Spec metadata extracted from a spec file.
    properties:
      id:
        type: string
      ...
      depends:
        ...
        description: "Dependencies on other specs."
    x-rust-struct:
      derive: [Debug, Clone]
```
...
<!-- source-snapshot: path=projects/agentic-workflow/src/workflow/helpers.rs -->
```rust
...
pub fn format_cli_command(tool: &str, args: &serde_json::Value) -> String {
    if tool == RUN_CHANGE_TOOL {
        ...
        let payload_path = match group_id {
            ...
            None => format!(
                ".aw/changes/{}/payloads/{}.json",
                change_id, action_kebab
            ),
        };
        format!(
            "score artifact {} {} {}",
...
```yaml
changes:
  - path: projects/agentic-workflow/src/workflow/helpers.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
      Source template owns the complete workflow helpers module.
```
...
- [overview] Single trivial helper struct.
