...
Public API manifest for `projects/agentic-workflow/src/workflow/task_graph.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TaskInfo` | projects/agentic-workflow/src/workflow/task_graph.rs | struct | pub | 15 |  |
| `build_task_execution_order` | projects/agentic-workflow/src/workflow/task_graph.rs | function | pub | 99 | build_task_execution_order(tasks: &[TaskInfo]) -> Vec<String> |
| `find_completed_tasks` | projects/agentic-workflow/src/workflow/task_graph.rs | function | pub | 181 | find_completed_tasks(     change_dir: &Path,     tasks: &[TaskInfo], ) -> std::collections::HashSet<String> |
| `find_next_task` | projects/agentic-workflow/src/workflow/task_graph.rs | function | pub | 153 | find_next_task(     tasks: &[TaskInfo],     execution_order: &[String],     current_task_id: Option<&str>,     completed_tasks: &std::collections::HashSet<String>, ) -> Option<String> |
| `is_codegen_eligible` | projects/agentic-workflow/src/workflow/task_graph.rs | function | pub | 215 | is_codegen_eligible(change_dir: &Path, spec_ref: &str) -> bool |
| `parse_task_blocks` | projects/agentic-workflow/src/workflow/task_graph.rs | function | pub | 35 | parse_task_blocks(content: &str) -> Vec<TaskInfo> |
## Schema
...
<!-- source-snapshot: path=projects/agentic-workflow/src/workflow/task_graph.rs -->
~~~rust
...
```yaml
changes:
  - path: projects/agentic-workflow/src/workflow/task_graph.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
