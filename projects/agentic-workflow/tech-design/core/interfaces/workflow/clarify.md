---
id: projects-sdd-src-workflow-clarify-rs
...
# Standardized projects/agentic-workflow/src/workflow/clarify.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/workflow/clarify.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `handle` | projects/agentic-workflow/src/workflow/clarify.rs | function | pub | 16 | handle(     change_dir: &Path,     change_id: &str,     description: Option<&str>,     project_path: &str, ) -> Result<Value> |
| `handle_clarifications_review` | projects/agentic-workflow/src/workflow/clarify.rs | function | pub | 133 | handle_clarifications_review(     change_dir: &Path,     change_id: &str,     _project_path: &str, ) -> Result<Value> |
| `handle_post_clarifications_review` | projects/agentic-workflow/src/workflow/clarify.rs | function | pub | 257 | handle_post_clarifications_review(     change_dir: &Path,     change_id: &str,     _project_path: &str, ) -> Result<Value> |
| `handle_post_clarify` | projects/agentic-workflow/src/workflow/clarify.rs | function | pub | 229 | handle_post_clarify(     change_dir: &Path,     change_id: &str,     _project_path: &str, ) -> Result<Value> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/workflow/clarify.rs -->
````rust
...
pub fn handle(
    ...
    match action {
        Action::Clarify => {
            ...
            let effective_desc = description.map(|s| s.to_string()).or_else(|| {
                std::fs::read_to_string(change_dir.join("user_input.md")).ok()
            });
...
pub fn handle_post_clarify(
    ...
    let phase_str = helpers::phase_to_string(
        &StateManager::load(change_dir)?.phase().clone(),
    );
    Ok(json!({
        "change_id": change_id,
        "current_phase": phase_str,
...
mod tests {
    ...
    fn test_new_change_returns_clarify() {
        ...
        assert!(result["prompt"].as_str().unwrap().contains("Clarify Change"));
...
```yaml
changes:
  - path: projects/agentic-workflow/src/workflow/clarify.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
      Source template owns the complete clarification workflow module.
```
