---
id: sdd-interfaces-issues-types-patch-apply-source
...
<!-- source-from-target: handwrite-gap issue-patch-apply -->
...
changes:
  - path: projects/agentic-workflow/src/issues/types.rs
    ...
    impl_mode: codegen
    replaces:
      - "<handwrite-gap:issue-patch-apply>"
    description: "Source template owns IssuePatch apply behavior."
```
