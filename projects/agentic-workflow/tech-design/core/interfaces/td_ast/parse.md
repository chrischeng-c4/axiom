...
Public API manifest for `projects/agentic-workflow/src/td_ast/parse.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `parse_td` | projects/agentic-workflow/src/td_ast/parse.rs | function | pub | 59 | parse_td(path: &Path) -> Result<TDAst, TdParseError> |
| `parse_td_str` | projects/agentic-workflow/src/td_ast/parse.rs | function | pub | 77 | parse_td_str(raw: &str) -> Result<TDAst, TdParseError> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/td_ast/parse.rs -->
~~~rust
