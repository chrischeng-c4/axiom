...
Public API manifest for `projects/agentic-workflow/src/state/manager.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AgentLock` | projects/agentic-workflow/src/state/manager.rs | struct | pub | 39 |  |
| `StalenessReport` | projects/agentic-workflow/src/state/manager.rs | struct | pub | 62 |  |
| `StateManager` | projects/agentic-workflow/src/state/manager.rs | struct | pub | 46 |  |
| `append_telemetry_call` | projects/agentic-workflow/src/state/manager.rs | function | pub | 774 | append_telemetry_call(&mut self, call: LlmCall) |
| `change_dir` | projects/agentic-workflow/src/state/manager.rs | function | pub | 267 | change_dir(&self) -> &Path |
| `check_staleness` | projects/agentic-workflow/src/state/manager.rs | function | pub | 562 | check_staleness(&self) -> Result<StalenessReport> |
| `clear_delegation_guard` | projects/agentic-workflow/src/state/manager.rs | function | pub | 321 | clear_delegation_guard(&mut self) |
| `clear_validations` | projects/agentic-workflow/src/state/manager.rs | function | pub | 685 | clear_validations(&mut self) |
| `git_workflow` | projects/agentic-workflow/src/state/manager.rs | function | pub | 397 | git_workflow(&self) -> Option<&str> |
| `has_stale` | projects/agentic-workflow/src/state/manager.rs | function | pub | 945 | has_stale(&self) -> bool |
| `increment_iteration` | projects/agentic-workflow/src/state/manager.rs | function | pub | 364 | increment_iteration(&mut self) |
| `increment_revision_count` | projects/agentic-workflow/src/state/manager.rs | function | pub | 381 | increment_revision_count(&mut self, stage: &str) |
| `is_complete` | projects/agentic-workflow/src/state/manager.rs | function | pub | 950 | is_complete(&self) -> bool |
| `is_delegation_stale` | projects/agentic-workflow/src/state/manager.rs | function | pub | 352 | is_delegation_stale(&self) -> bool |
| `is_file_stale` | projects/agentic-workflow/src/state/manager.rs | function | pub | 543 | is_file_stale(&self, filename: &str) -> Result<bool> |
| `is_fresh` | projects/agentic-workflow/src/state/manager.rs | function | pub | 955 | is_fresh(&self) -> bool |
| `last_validation` | projects/agentic-workflow/src/state/manager.rs | function | pub | 680 | last_validation(&self, step: &str) -> Option<&ValidationEntry> |
| `load` | projects/agentic-workflow/src/state/manager.rs | function | pub | 78 | load(change_dir: impl Into<PathBuf>) -> Result<Self> |
| `mark_spec_revised` | projects/agentic-workflow/src/state/manager.rs | function | pub | 457 | mark_spec_revised(&mut self) -> Result<()> |
| `phase` | projects/agentic-workflow/src/state/manager.rs | function | pub | 301 | phase(&self) -> &StatePhase |
| `record_challenge_validation` | projects/agentic-workflow/src/state/manager.rs | function | pub | 649 | record_challenge_validation(         &mut self,         verdict: &str,         issues_parsed: u32,         high: u32,         medium: u32,         low: u32,     ) |
| `record_llm_call` | projects/agentic-workflow/src/state/manager.rs | function | pub | 704 | record_llm_call(         &mut self,         step: &str,         model: Option<String>,         tokens_in: Option<u64>,         tokens_out: Option<u64>,         duration_ms: Option<u64>,         cost_per_1m_input: Option<f64>,         cost_per_1m_output: Option<f64>,     ) |
| `record_validation` | projects/agentic-workflow/src/state/manager.rs | function | pub | 615 | record_validation(         &mut self,         step: impl Into<String>,         mode: ValidationMode,         valid: bool,         high: u32,         medium: u32,         low: u32,         errors: Vec<String>,         warnings: Vec<String>,     ) |
| `revision_count` | projects/agentic-workflow/src/state/manager.rs | function | pub | 376 | revision_count(&self, stage: &str) -> u32 |
| `rollback_delegation` | projects/agentic-workflow/src/state/manager.rs | function | pub | 327 | rollback_delegation(&mut self) |
| `run_blocking_io` | projects/agentic-workflow/src/state/manager.rs | function | pub | 859 | run_blocking_io(build_fut: F) -> Result<T> |
| `save` | projects/agentic-workflow/src/state/manager.rs | function | pub | 189 | save(&mut self) -> Result<()> |
| `save_if_dirty` | projects/agentic-workflow/src/state/manager.rs | function | pub | 248 | save_if_dirty(&mut self) -> Result<()> |
| `session_id` | projects/agentic-workflow/src/state/manager.rs | function | pub | 408 | session_id(&self) -> Option<&str> |
| `set_delegation_guard` | projects/agentic-workflow/src/state/manager.rs | function | pub | 310 | set_delegation_guard(&mut self, allowed_phases: Vec<StatePhase>, action: &str) |
| `set_git_workflow` | projects/agentic-workflow/src/state/manager.rs | function | pub | 391 | set_git_workflow(&mut self, workflow: String) |
| `set_last_action` | projects/agentic-workflow/src/state/manager.rs | function | pub | 370 | set_last_action(&mut self, action: impl Into<String>) |
| `set_phase` | projects/agentic-workflow/src/state/manager.rs | function | pub | 278 | set_phase(&mut self, phase: StatePhase) -> Result<()> |
| `set_session_id` | projects/agentic-workflow/src/state/manager.rs | function | pub | 402 | set_session_id(&mut self, session_id: String) |
| `state` | projects/agentic-workflow/src/state/manager.rs | function | pub | 256 | state(&self) -> &State |
| `state_mut` | projects/agentic-workflow/src/state/manager.rs | function | pub | 261 | state_mut(&mut self) -> &mut State |
| `telemetry_summary` | projects/agentic-workflow/src/state/manager.rs | function | pub | 792 | telemetry_summary(&self) -> Option<&Telemetry> |
| `total_files` | projects/agentic-workflow/src/state/manager.rs | function | pub | 960 | total_files(&self) -> usize |
| `try_acquire_agent_lock` | projects/agentic-workflow/src/state/manager.rs | function | pub | 338 | try_acquire_agent_lock(&self) -> Result<AgentLock> |
| `update_all_checksums` | projects/agentic-workflow/src/state/manager.rs | function | pub | 516 | update_all_checksums(&mut self) -> Result<()> |
| `update_checksum` | projects/agentic-workflow/src/state/manager.rs | function | pub | 490 | update_checksum(&mut self, filename: &str) -> Result<()> |
| `update_phase_from_proposal_verdict` | projects/agentic-workflow/src/state/manager.rs | function | pub | 415 | update_phase_from_proposal_verdict(&mut self, verdict: &str) -> Result<()> |
| `update_phase_from_review` | projects/agentic-workflow/src/state/manager.rs | function | pub | 474 | update_phase_from_review(&mut self, verdict: &str) -> Result<()> |
| `update_phase_from_spec_verdict` | projects/agentic-workflow/src/state/manager.rs | function | pub | 429 | update_phase_from_spec_verdict(         &mut self,         verdict: &str,         is_last_spec: bool,     ) -> Result<()> |
| `update_phase_from_verdict` | projects/agentic-workflow/src/state/manager.rs | function | pub | 466 | update_phase_from_verdict(&mut self, verdict: &str) -> Result<()> |
## Schema
...
<!-- source-snapshot: path=projects/agentic-workflow/src/state/manager.rs -->
```rust
