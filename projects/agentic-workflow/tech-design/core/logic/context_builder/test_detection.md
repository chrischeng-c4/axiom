...
Public API manifest for `projects/agentic-workflow/src/context_builder/test_detection.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TestLanguage` | projects/agentic-workflow/src/context_builder/test_detection.rs | enum | pub | 17 |  |
| `detect_test_files` | projects/agentic-workflow/src/context_builder/test_detection.rs | function | pub | 59 | detect_test_files(     project_files: &[String],     target_file: &str,     language: TestLanguage, ) -> Vec<ContextEntry> |
| `from_path` | projects/agentic-workflow/src/context_builder/test_detection.rs | function | pub | 33 | from_path(path: &Path) -> Option<Self> |
## Schema
