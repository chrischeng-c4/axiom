...
fixture: projects/agentic-workflow/src/runtime/session.rs::drive_lifecycle_loop
...
function `drive_lifecycle_loop` in `projects/agentic-workflow/src/runtime/session.rs`
...
Public API manifest for `projects/agentic-workflow/src/runtime/session.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `IssueBinding` | projects/agentic-workflow/src/runtime/session.rs | struct | pub | 42 |  |
| `Phase` | projects/agentic-workflow/src/runtime/session.rs | enum | pub | 32 |  |
| `Session` | projects/agentic-workflow/src/runtime/session.rs | struct | pub | 66 |  |
| `SessionBuilder` | projects/agentic-workflow/src/runtime/session.rs | struct | pub | 684 |  |
| `binding` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 89 | binding(&self) -> Option<&IssueBinding> |
| `binding` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 714 | binding(mut self, b: IssueBinding) -> Self |
| `build` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 718 | build(self) -> Result<Session> |
| `builder` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 85 | builder() -> SessionBuilder |
| `close_issue` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 184 | close_issue(&self, id: &IssueId, message: Option<&str>) -> Result<()> |
| `create_issue` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 101 | create_issue(&mut self, title: &str) -> Result<mpsc::Receiver<SessionEvent>> |
| `decide` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 133 | decide(&mut self, user_input: &str) -> Result<mpsc::Receiver<SessionEvent>> |
| `issue_backend` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 706 | issue_backend(mut self, b: Arc<dyn IssueBackend>) -> Self |
| `list_issues` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 170 | list_issues(&self, filter: &ListFilter) -> Result<Vec<IssueRef>> |
| `provider` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 694 | provider(mut self, p: Arc<dyn LLMProvider>) -> Self |
| `read_issue` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 177 | read_issue(&self, id: &IssueId) -> Result<IssueBody> |
| `router` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 710 | router(mut self, r: Arc<dyn ModelRouter>) -> Self |
| `score_process` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 698 | score_process(mut self, s: Arc<dyn ScoreProcess>) -> Self |
| `set_binding` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 191 | set_binding(&mut self, binding: IssueBinding) |
| `turn` | projects/agentic-workflow/src/runtime/session.rs | function | pub | 160 | turn(&mut self, _prompt: &str) -> Result<mpsc::Receiver<SessionEvent>> |
## Schema
<!-- type: schema lang: yaml -->

The loop consumes envelopes (defined in `projects/agentic-workflow/src/runtime/envelope.rs`)
...
<!-- source-snapshot: path=projects/agentic-workflow/src/runtime/session.rs -->
```rust
