...
Public API manifest for `projects/agentic-workflow/src/issues/push_through.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `push_through` | projects/agentic-workflow/src/issues/push_through.rs | function | pub | 38 | push_through(     issue_path: &Path,     backend: &dyn IssueBackend,     slug: &str, ) -> Result<Issue> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=projects/agentic-workflow/src/issues/push_through.rs -->
```rust
