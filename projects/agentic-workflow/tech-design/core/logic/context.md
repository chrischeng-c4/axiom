...
# Standardized projects/agentic-workflow/src/context.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/context.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `cleanup_context_files` | projects/agentic-workflow/src/context.rs | function | pub | 153 | cleanup_context_files(change_dir: &Path) -> Result<()> |
| `create_archive_review_skeleton` | projects/agentic-workflow/src/context.rs | function | pub | 139 | create_archive_review_skeleton(     change_dir: &Path,     change_id: &str,     iteration: u32, ) -> Result<()> |
| `create_review_skeleton` | projects/agentic-workflow/src/context.rs | function | pub | 125 | create_review_skeleton(change_dir: &Path, change_id: &str, iteration: u32) -> Result<()> |
| `resolve_change_id_conflict` | projects/agentic-workflow/src/context.rs | function | pub | 182 | resolve_change_id_conflict(change_id: &str, changes_dir: &Path) -> Result<String> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:claim-code -->

<!-- source-snapshot: path=projects/agentic-workflow/src/context.rs -->
~~~rust
...
```yaml
changes:
  - path: projects/agentic-workflow/src/context.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
