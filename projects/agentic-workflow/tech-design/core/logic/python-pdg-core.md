...
Implement a statement-level CFG for Python in 'crates/cclab-lens/src/semantic/pdg/cfg.rs' that handles sequential execution, if-else branches, loops (for/while), exceptions (try/except/finally), and function calls.
...
Construct the Post-Dominator Tree in 'crates/cclab-lens/src/semantic/pdg/dominator.rs' from the CFG to identify control dependencies between statements.
...
Track reaching definitions and build def-use chains in 'crates/cclab-lens/src/semantic/pdg/data_flow.rs' for all variables to identify data dependencies.
...
Combine control and data dependencies into a unified Program Dependence Graph (PDG) in 'crates/cclab-lens/src/semantic/pdg/mod.rs' where nodes are statements and edges represent dependencies.
...
Implement algorithms for forward and backward program slicing in 'crates/cclab-lens/src/semantic/pdg/mod.rs' by traversing the PDG.
