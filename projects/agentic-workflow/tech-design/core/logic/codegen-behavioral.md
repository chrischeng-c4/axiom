...
main_spec_ref: projects/agentic-workflow/logic/codegen-behavioral.md
merge_strategy: new
capability_refs:
...
requirements:
  ...
  R4:
    ...
    notes: |
      ...
      Markers tracked in .aw/codegen_markers.yaml.
  R5:
