---
id: projects-sdd-src-validate-rules-r7g_dangling_capability_ref-rs
...
# Standardized projects/agentic-workflow/src/validate/rules/r7g_dangling_capability_ref.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/validate/rules/r7g_dangling_capability_ref.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DanglingCapabilityRefRule` | projects/agentic-workflow/src/validate/rules/r7g_dangling_capability_ref.rs | struct | pub | 32 |  |
## Source
...
```yaml
changes:
  - path: projects/agentic-workflow/src/validate/rules/r7g_dangling_capability_ref.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
