---
id: projects-sdd-src-validate-rules-r3d_lowercase_enum-rs
...
# Standardized projects/agentic-workflow/src/validate/rules/r3d_lowercase_enum.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/validate/rules/r3d_lowercase_enum.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `LowercaseEnumRule` | projects/agentic-workflow/src/validate/rules/r3d_lowercase_enum.rs | struct | pub | 225 |  |
## Source
