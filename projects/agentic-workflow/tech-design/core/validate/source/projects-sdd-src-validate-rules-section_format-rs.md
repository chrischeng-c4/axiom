...
# Standardized projects/agentic-workflow/src/validate/rules/section_format.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/validate/rules/section_format.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DEFAULT_LOOKAHEAD` | projects/agentic-workflow/src/validate/rules/section_format.rs | constant | pub | 29 |  |
| `PLACEHOLDER_MARKER` | projects/agentic-workflow/src/validate/rules/section_format.rs | constant | pub | 34 |  |
| `SectionFormatRule` | projects/agentic-workflow/src/validate/rules/section_format.rs | struct | pub | 40 |  |
| `check_section_format` | projects/agentic-workflow/src/validate/rules/section_format.rs | function | pub | 67 | check_section_format(spec_path: &Path, content: &str, lookahead: usize) -> Vec<Finding> |
## Source
