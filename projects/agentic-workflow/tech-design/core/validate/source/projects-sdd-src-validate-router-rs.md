...
# Standardized projects/agentic-workflow/src/validate/router.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/validate/router.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `PathShape` | projects/agentic-workflow/src/validate/router.rs | enum | pub | 20 |  |
| `classify` | projects/agentic-workflow/src/validate/router.rs | function | pub | 31 | classify(target: &str, project_root: &Path) -> PathShape |
| `resolve_spec_files` | projects/agentic-workflow/src/validate/router.rs | function | pub | 56 | resolve_spec_files(shape: &PathShape) -> std::io::Result<Vec<PathBuf>> |
## Source
...
mod tests {
    ...
    fn prefix_with_slash() {
        ...
        match classify("projects/agentic-workflow/tech-design/core", &root) {
            PathShape::Prefix(p) => {
                assert_eq!(p, PathBuf::from("/repo/projects/agentic-workflow/tech-design/core"));
            }
