...
# Standardized projects/agentic-workflow/src/validate/rules/r6a_loose_root_file.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/validate/rules/r6a_loose_root_file.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `LooseRootFileRule` | projects/agentic-workflow/src/validate/rules/r6a_loose_root_file.rs | struct | pub | 20 |  |
| `is_codegen_fixture_spec` | projects/agentic-workflow/src/validate/rules/r6a_loose_root_file.rs | function | pub | 141 | is_codegen_fixture_spec(content: &str) -> bool |
| `locate_in_crate_spec_root` | projects/agentic-workflow/src/validate/rules/r6a_loose_root_file.rs | function | pub | 82 | locate_in_crate_spec_root(spec_path: &Path) -> Option<(String, String)> |
## Source
