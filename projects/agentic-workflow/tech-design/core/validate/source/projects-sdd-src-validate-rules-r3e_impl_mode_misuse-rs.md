...
# Standardized projects/agentic-workflow/src/validate/rules/r3e_impl_mode_misuse.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/validate/rules/r3e_impl_mode_misuse.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ImplModeMisuseRule` | projects/agentic-workflow/src/validate/rules/r3e_impl_mode_misuse.rs | struct | pub | 194 |  |
## Source
