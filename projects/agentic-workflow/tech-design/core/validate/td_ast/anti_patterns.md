...
Public API manifest for `projects/agentic-workflow/src/td_ast/anti_patterns.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `check_content_anti_patterns` | projects/agentic-workflow/src/td_ast/anti_patterns.rs | function | pub | 31 | check_content_anti_patterns(ast: &TDAst, spec_content: &str) -> Vec<TdError> |
| `check_filesystem_anti_patterns` | projects/agentic-workflow/src/td_ast/anti_patterns.rs | function | pub | 42 | check_filesystem_anti_patterns(     ast: &TDAst,     spec_content: &str,     project_root: &Path, ) -> Vec<TdError> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/td_ast/anti_patterns.rs -->
````rust
