...
# Standardized projects/agentic-workflow/examples/audit_smoke.rs
...
```yaml
changes:
  - path: projects/agentic-workflow/examples/audit_smoke.rs
    action: create
    section: tests
    impl_mode: codegen
    description: |
