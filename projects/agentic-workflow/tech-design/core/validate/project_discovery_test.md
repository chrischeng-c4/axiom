---
id: projects-sdd-tests-project-discovery-test-rs
...
# Project Discovery Integration Tests

## Overview
<!-- type: overview lang: markdown -->

Codegenerated integration tests for project discovery naming and relative
`test_cmd` behavior. The file is emitted through the Rust tests template from
the `tests` section.
...
changes:
  - path: projects/agentic-workflow/tests/project_discovery_test.rs
    ...
    impl_mode: codegen
    description: |
      Generate the complete project discovery integration test file from the
