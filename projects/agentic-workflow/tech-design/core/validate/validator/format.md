...
# SpecFormatValidator Type

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/validator/format.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SpecFormatValidator` | projects/agentic-workflow/src/validator/format.rs | struct | pub | 12 |  |
| `new` | projects/agentic-workflow/src/validator/format.rs | function | pub | 20 | new(rules: ValidationRules) -> Self |
| `validate` | projects/agentic-workflow/src/validator/format.rs | function | pub | 33 | validate(&self, file_path: &Path) -> ValidationResult |
| `validate_with_type` | projects/agentic-workflow/src/validator/format.rs | function | pub | 25 | validate_with_type(&self, file_path: &Path, doc_type: DocumentType) -> ValidationResult |
## Schema
...
definitions:
  SpecFormatValidator:
    type: object
    required: [rules]
    description: AST-based format validator for spec files.
    properties:
      rules:
        type: object
...
<!-- source-snapshot: path=projects/agentic-workflow/src/validator/format.rs -->
~~~rust
