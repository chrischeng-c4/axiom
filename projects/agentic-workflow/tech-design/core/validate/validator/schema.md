...
Public API manifest for `projects/agentic-workflow/src/validator/schema.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DocumentType` | projects/agentic-workflow/src/validator/schema.rs | enum | pub | 17 |  |
| `SchemaValidator` | projects/agentic-workflow/src/validator/schema.rs | struct | pub | 32 |  |
| `from_filename` | projects/agentic-workflow/src/validator/schema.rs | function | pub | 53 | from_filename(filename: &str) -> Option<Self> |
| `from_type_field` | projects/agentic-workflow/src/validator/schema.rs | function | pub | 72 | from_type_field(type_field: &str) -> Option<Self> |
| `new` | projects/agentic-workflow/src/validator/schema.rs | function | pub | 90 | new(schemas_dir: impl Into<std::path::PathBuf>) -> Self |
| `schema_filename` | projects/agentic-workflow/src/validator/schema.rs | function | pub | 42 | schema_filename(&self) -> &'static str |
| `validate_content` | projects/agentic-workflow/src/validator/schema.rs | function | pub | 141 | validate_content(&mut self, content: &str, file_path: &Path) -> ValidationResult |
| `validate_file` | projects/agentic-workflow/src/validator/schema.rs | function | pub | 117 | validate_file(&mut self, file_path: &Path) -> ValidationResult |
| `validate_frontmatter_content` | projects/agentic-workflow/src/validator/schema.rs | function | pub | 332 | validate_frontmatter_content(     content: &str,     doc_type: DocumentType,     project_root: &Path, ) -> ValidationResult |
| `validate_frontmatter_schema` | projects/agentic-workflow/src/validator/schema.rs | function | pub | 324 | validate_frontmatter_schema(file_path: &Path, project_root: &Path) -> ValidationResult |
| `validate_required_fields` | projects/agentic-workflow/src/validator/schema.rs | function | pub | 273 | validate_required_fields(         &self,         frontmatter: &serde_yaml::Value,         doc_type: DocumentType,         file_path: &Path,     ) -> ValidationResult |
## Schema
...
<!-- source-snapshot: path=projects/agentic-workflow/src/validator/schema.rs -->
```rust
