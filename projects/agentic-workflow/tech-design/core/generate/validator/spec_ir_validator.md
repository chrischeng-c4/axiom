...
Public API manifest for `projects/agentic-workflow/src/generate/validator/spec_ir_validator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ComponentValidator` | projects/agentic-workflow/src/generate/validator/spec_ir_validator.rs | struct | pub | 99 |  |
| `DeployValidator` | projects/agentic-workflow/src/generate/validator/spec_ir_validator.rs | struct | pub | 91 |  |
| `DesignTokenValidator` | projects/agentic-workflow/src/generate/validator/spec_ir_validator.rs | struct | pub | 103 |  |
| `WireframeValidator` | projects/agentic-workflow/src/generate/validator/spec_ir_validator.rs | struct | pub | 95 |  |
| `validate_spec_ir` | projects/agentic-workflow/src/generate/validator/spec_ir_validator.rs | function | pub | 68 | validate_spec_ir(spec: &SpecIR) -> ValidationResult |
## Schema
...
<!-- source-snapshot: path=projects/agentic-workflow/src/generate/validator/spec_ir_validator.rs -->
```rust
...
```yaml
changes:
  - path: projects/agentic-workflow/src/generate/validator/spec_ir_validator.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
