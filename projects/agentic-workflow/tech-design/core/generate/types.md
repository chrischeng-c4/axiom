...
Public API manifest for `projects/agentic-workflow/src/generate/types.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AbstractType` | projects/agentic-workflow/src/generate/types.rs | enum | pub | 23 |  |
| `RustConfig` | projects/agentic-workflow/src/generate/types.rs | struct | pub | 75 |  |
| `RustTypeTranslator` | projects/agentic-workflow/src/generate/types.rs | struct | pub | 95 |  |
| `derive_attr` | projects/agentic-workflow/src/generate/types.rs | function | pub | 320 | derive_attr(&self) -> String |
| `has_serde_derives` | projects/agentic-workflow/src/generate/types.rs | function | pub | 285 | has_serde_derives(&self) -> bool |
| `merge_overrides` | projects/agentic-workflow/src/generate/types.rs | function | pub | 292 | merge_overrides(&self, frontmatter: &serde_yaml::Value) -> Self |
| `parse_abstract_type` | projects/agentic-workflow/src/generate/types.rs | function | pub | 135 | parse_abstract_type(s: &str) -> Result<AbstractType, String> |
| `serde_rename_attr` | projects/agentic-workflow/src/generate/types.rs | function | pub | 338 | serde_rename_attr(&self) -> String |
| `vis_prefix` | projects/agentic-workflow/src/generate/types.rs | function | pub | 350 | vis_prefix(&self) -> String |
## Schema
...
<!-- source-snapshot: path=projects/agentic-workflow/src/generate/types.rs -->
```rust
