---
id: projects-sdd-src-generate-mcp-handlers-rs
...
# Standardized projects/agentic-workflow/src/generate/mcp/handlers.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/generate/mcp/handlers.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `HandlerResult` | projects/agentic-workflow/src/generate/mcp/handlers.rs | type | pub | 37 |  |
| `call_tool` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 501 | call_tool(name: &str, args: &Value) -> HandlerResult |
| `handle_generate_asyncapi` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 457 | handle_generate_asyncapi(args: &Value) -> HandlerResult |
| `handle_generate_block_plus` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 410 | handle_generate_block_plus(args: &Value) -> HandlerResult |
| `handle_generate_class` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 71 | handle_generate_class(args: &Value) -> HandlerResult |
| `handle_generate_class_plus` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 255 | handle_generate_class_plus(args: &Value) -> HandlerResult |
| `handle_generate_erd` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 101 | handle_generate_erd(args: &Value) -> HandlerResult |
| `handle_generate_erd_plus` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 286 | handle_generate_erd_plus(args: &Value) -> HandlerResult |
| `handle_generate_flowchart` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 41 | handle_generate_flowchart(args: &Value) -> HandlerResult |
| `handle_generate_flowchart_plus` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 193 | handle_generate_flowchart_plus(args: &Value) -> HandlerResult |
| `handle_generate_journey` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 145 | handle_generate_journey(args: &Value) -> HandlerResult |
| `handle_generate_journey_plus` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 379 | handle_generate_journey_plus(args: &Value) -> HandlerResult |
| `handle_generate_mermaid_plus` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 160 | handle_generate_mermaid_plus(args: &Value) -> HandlerResult |
| `handle_generate_mindmap` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 115 | handle_generate_mindmap(args: &Value) -> HandlerResult |
| `handle_generate_mindmap_plus` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 348 | handle_generate_mindmap_plus(args: &Value) -> HandlerResult |
| `handle_generate_openapi` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 443 | handle_generate_openapi(args: &Value) -> HandlerResult |
| `handle_generate_openrpc` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 472 | handle_generate_openrpc(args: &Value) -> HandlerResult |
| `handle_generate_requirement` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 130 | handle_generate_requirement(args: &Value) -> HandlerResult |
| `handle_generate_requirement_plus` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 317 | handle_generate_requirement_plus(args: &Value) -> HandlerResult |
| `handle_generate_sequence` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 56 | handle_generate_sequence(args: &Value) -> HandlerResult |
| `handle_generate_sequence_plus` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 224 | handle_generate_sequence_plus(args: &Value) -> HandlerResult |
| `handle_generate_serverless_workflow` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 486 | handle_generate_serverless_workflow(args: &Value) -> HandlerResult |
| `handle_generate_state` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 86 | handle_generate_state(args: &Value) -> HandlerResult |
| `is_sdd_tool` | projects/agentic-workflow/src/generate/mcp/handlers.rs | function | pub | 533 | is_sdd_tool(name: &str) -> bool |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/generate/mcp/handlers.rs -->
```rust
...
```yaml
changes:
  - path: projects/agentic-workflow/src/generate/mcp/handlers.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
      Source template owns the complete SDD MCP generate-tool handlers module.
```
