...
Public API manifest for `projects/agentic-workflow/src/generate/mcp/tools.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SddTools` | projects/agentic-workflow/src/generate/mcp/tools.rs | struct | pub | 25 |  |
| `ToolSchema` | projects/agentic-workflow/src/generate/mcp/tools.rs | struct | pub | 14 |  |
| `count` | projects/agentic-workflow/src/generate/mcp/tools.rs | function | pub | 59 | count() -> usize |
| `list` | projects/agentic-workflow/src/generate/mcp/tools.rs | function | pub | 29 | list() -> Vec<ToolSchema> |
## Schema
...
definitions:
  ToolSchema:
    ...
    description: Tool schema for MCP protocol.
    properties:
      name:
        type: string
  ...
  SddTools:
    ...
    required: []
    properties: {}
    description: SDD generate tool registry.
    x-rust-struct:
      derive: []
      unit: true
```
...
<!-- source-snapshot: path=projects/agentic-workflow/src/generate/mcp/tools.rs -->
```rust
...
```yaml
changes:
  - path: projects/agentic-workflow/src/generate/mcp/tools.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
      Source template owns the complete MCP tool schema registry.
  - action: annotate
    section: schema
...
- [overview] Schema struct + unit-struct registry.
