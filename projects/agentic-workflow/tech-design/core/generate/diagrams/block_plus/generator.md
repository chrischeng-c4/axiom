...
Public API manifest for `projects/agentic-workflow/src/generate/diagrams/block_plus/generator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `BlockPlusGenerator` | projects/agentic-workflow/src/generate/diagrams/block_plus/generator.rs | struct | pub | 18 |  |
| `BlockPlusOutput` | projects/agentic-workflow/src/generate/diagrams/block_plus/generator.rs | struct | pub | 11 |  |
| `generate` | projects/agentic-workflow/src/generate/diagrams/block_plus/generator.rs | function | pub | 26 | generate(         &self,         diagram: &BlockDef,         validation: BlockValidationResult,     ) -> Result<BlockPlusOutput, String> |
| `generate_mermaid` | projects/agentic-workflow/src/generate/diagrams/block_plus/generator.rs | function | pub | 63 | generate_mermaid(&self, diagram: &BlockDef) -> Result<String, String> |
| `new` | projects/agentic-workflow/src/generate/diagrams/block_plus/generator.rs | function | pub | 22 | new() -> Self |
## Schema
...
<!-- source-snapshot: path=projects/agentic-workflow/src/generate/diagrams/block_plus/generator.rs -->
````rust
//! Block+ generator
