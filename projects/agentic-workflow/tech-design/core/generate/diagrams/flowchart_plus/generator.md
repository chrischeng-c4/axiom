---
id: sdd-generate-flowchart-plus-generator
...
Public API manifest for `projects/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `FlowchartPlusGenerator` | projects/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs | struct | pub | 33 |  |
| `FlowchartPlusOutput` | projects/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs | struct | pub | 20 |  |
| `generate` | projects/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs | function | pub | 41 | generate(         &self,         flowchart: &FlowchartDef,         validation: FlowchartValidationResult,     ) -> Result<FlowchartPlusOutput, String> |
| `generate_mermaid` | projects/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs | function | pub | 187 | generate_mermaid(&self, flowchart: &FlowchartDef) -> Result<String, String> |
| `new` | projects/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs | function | pub | 36 | new() -> Self |
## Schema
...
definitions:
  FlowchartPlusOutput:
    ...
    properties:
      ...
      validation:
        type: object
        x-rust-type: "FlowchartValidationResult"
...
<!-- source-snapshot: path=projects/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs -->
````rust
//! Flowchart+ generator
//!
...
changes:
  - path: projects/agentic-workflow/src/generate/diagrams/flowchart_plus/generator.rs
    ...
    impl_mode: codegen
    description: |
      Source template owns the complete Flowchart+ generator module.
  - action: annotate
    section: schema
...
- [schema] Both well-formed; foreign type FlowchartValidationResult via x-rust-type.
