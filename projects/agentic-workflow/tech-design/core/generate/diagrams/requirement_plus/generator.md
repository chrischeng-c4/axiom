...
Public API manifest for `projects/agentic-workflow/src/generate/diagrams/requirement_plus/generator.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RequirementPlusGenerator` | projects/agentic-workflow/src/generate/diagrams/requirement_plus/generator.rs | struct | pub | 21 |  |
| `RequirementPlusOutput` | projects/agentic-workflow/src/generate/diagrams/requirement_plus/generator.rs | struct | pub | 14 |  |
| `generate` | projects/agentic-workflow/src/generate/diagrams/requirement_plus/generator.rs | function | pub | 29 | generate(         &self,         diagram: &RequirementDiagramDef,         validation: RequirementValidationResult,     ) -> Result<RequirementPlusOutput, String> |
| `generate_mermaid` | projects/agentic-workflow/src/generate/diagrams/requirement_plus/generator.rs | function | pub | 67 | generate_mermaid(&self, diagram: &RequirementDiagramDef) -> Result<String, String> |
| `new` | projects/agentic-workflow/src/generate/diagrams/requirement_plus/generator.rs | function | pub | 25 | new() -> Self |
## Schema
...
<!-- source-snapshot: path=projects/agentic-workflow/src/generate/diagrams/requirement_plus/generator.rs -->
````rust
