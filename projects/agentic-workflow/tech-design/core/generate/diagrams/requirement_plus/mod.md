...
# Standardized projects/agentic-workflow/src/generate/diagrams/requirement_plus/mod.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/generate/diagrams/requirement_plus/mod.rs` generated from AST during Score force-regeneration standardization.
...
<!-- source-snapshot: path=projects/agentic-workflow/src/generate/diagrams/requirement_plus/mod.rs -->
```rust
