---
id: sdd-generate-state-plus-schema
...
Public API manifest for `projects/agentic-workflow/src/generate/diagrams/state_plus/schema.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ActionDef` | projects/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | struct | pub | 130 |  |
| `ActionRef` | projects/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | enum | pub | 45 |  |
| `GuardDef` | projects/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | struct | pub | 119 |  |
| `StateMachineDef` | projects/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | struct | pub | 53 |  |
| `StateNodeDef` | projects/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | struct | pub | 74 |  |
| `StateType` | projects/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | enum | pub | 16 |  |
| `TransitionDetail` | projects/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | struct | pub | 101 |  |
| `TransitionInput` | projects/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | enum | pub | 32 |  |
| `to_vec` | projects/agentic-workflow/src/generate/diagrams/state_plus/schema.rs | function | pub | 139 | to_vec(&self) -> Vec<String> |
## Schema
...
<!-- source-snapshot: path=projects/agentic-workflow/src/generate/diagrams/state_plus/schema.rs -->
```rust
...
```yaml
changes:
  - path: projects/agentic-workflow/src/generate/diagrams/state_plus/schema.rs
    action: modify
    section: source
    impl_mode: codegen
    description: |
      Source template owns the complete State+ schema module.
  - action: annotate
    section: schema
