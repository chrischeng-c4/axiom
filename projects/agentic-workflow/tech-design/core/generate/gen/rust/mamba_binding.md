---
id: sdd-generate-gen-rust-mamba-binding
...
# MambaBindingGenOutput Type

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/generate/gen/rust/mamba_binding.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MambaBindingGenOutput` | projects/agentic-workflow/src/generate/gen/rust/mamba_binding.rs | struct | pub | 37 |  |
| `generate_mamba_binding` | projects/agentic-workflow/src/generate/gen/rust/mamba_binding.rs | function | pub | 46 | generate_mamba_binding(schema_yaml: &Value, struct_name: &str) -> MambaBindingGenOutput |
| `generate_mamba_binding_with_provenance` | projects/agentic-workflow/src/generate/gen/rust/mamba_binding.rs | function | pub | 53 | generate_mamba_binding_with_provenance(     schema_yaml: &Value,     struct_name: &str,     spec_path: &str, ) -> MambaBindingGenOutput |
## Schema
...
definitions:
  MambaBindingGenOutput:
    type: object
    required: [code, emitted]
    description: Output from mamba-binding code generation.
    properties:
      code:
        type: string
        description: "Appended to the end of the schema-generated struct file."
      emitted:
        type: boolean
        description: "Whether binding code was emitted (i.e. x-mamba-binding was present)."
    x-rust-struct:
      derive: [Debug, Clone]
```
...
<!-- source-snapshot: path=projects/agentic-workflow/src/generate/gen/rust/mamba_binding.rs -->
```rust
...
struct BindingContext {
    ...
    /// `.aw/tech-design/projects/api/http-exception.md`) used in `@spec`
...
"#,
        ...
        assert!(out.code.contains("mb_wrap_native"));
    }
...
changes:
  - path: projects/agentic-workflow/src/generate/gen/rust/mamba_binding.rs
    ...
    impl_mode: codegen
    description: |
      Source template owns the complete mamba-binding generator module.
  - action: annotate
    section: schema
...
- [overview] Single output struct, standard shape.
- [schema] Both fields in `required:`.
