...
Public API manifest for `projects/agentic-workflow/src/generate/gen/rust/logic.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `LogicGenOutput` | projects/agentic-workflow/src/generate/gen/rust/logic.rs | struct | pub | 190 |  |
| `generate_logic` | projects/agentic-workflow/src/generate/gen/rust/logic.rs | function | pub | 203 | generate_logic(     content: &LogicContent,     spec_path: &str,     config: &RustConfig, ) -> LogicGenOutput |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-managed-markers -->

<!-- source-snapshot: path=projects/agentic-workflow/src/generate/gen/rust/logic.rs -->
```rust
