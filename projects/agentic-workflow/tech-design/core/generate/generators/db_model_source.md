---
id: sdd-generate-generators-db-model-source
...
# DbModelGenerator Source

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/generators/db_model.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DbModelGenerator` | projects/agentic-workflow/src/generators/db_model.rs | struct | pub | 94 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:fold-shadow -->

<!-- source-snapshot: path=projects/agentic-workflow/src/generators/db_model.rs -->
````rust
...
```yaml
changes:
  - path: projects/agentic-workflow/src/generators/db_model.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
      - "<handwrite-gap:standardize:fold-shadow>"
    description: "Source template owns the DB model section generator behavior and tests."
```
