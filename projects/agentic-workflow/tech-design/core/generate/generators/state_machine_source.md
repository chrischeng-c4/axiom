...
Public API manifest for `projects/agentic-workflow/src/generators/state_machine.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `StateMachineGenerator` | projects/agentic-workflow/src/generators/state_machine.rs | struct | pub | 92 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:fold-shadow -->

<!-- source-snapshot: path=projects/agentic-workflow/src/generators/state_machine.rs -->
````rust
