---
id: sdd-generate-generators-scenarios-source
...
# ScenariosGenerator Source

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/generators/scenarios.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ScenariosGenerator` | projects/agentic-workflow/src/generators/scenarios.rs | struct | pub | 96 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:fold-shadow -->

<!-- source-snapshot: path=projects/agentic-workflow/src/generators/scenarios.rs -->
````rust
...
```yaml
changes:
  - path: projects/agentic-workflow/src/generators/scenarios.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
      - "<handwrite-gap:standardize:fold-shadow>"
    description: "Source template owns the scenarios section generator behavior and tests."
```
