---
id: sdd-generate-generators-rpc-api-source
...
# RpcApiGenerator Source

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/generators/rpc_api.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RpcApiGenerator` | projects/agentic-workflow/src/generators/rpc_api.rs | struct | pub | 103 |  |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: handwrite-gap standardize:fold-shadow -->

<!-- source-snapshot: path=projects/agentic-workflow/src/generators/rpc_api.rs -->
````rust
...
changes:
  - path: projects/agentic-workflow/src/generators/rpc_api.rs
    ...
    description: "Source template owns the RPC API section generator behavior and tests."
```
