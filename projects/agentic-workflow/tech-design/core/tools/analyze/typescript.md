---
id: projects-sdd-src-tools-analyze-typescript-rs
...
# Standardized projects/agentic-workflow/src/tools/analyze/typescript.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/tools/analyze/typescript.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `analyze` | projects/agentic-workflow/src/tools/analyze/typescript.rs | function | pub | 10 | analyze(source: &str) -> Result<AnalysisResult> |
## Source
...
```yaml
changes:
  - path: projects/agentic-workflow/src/tools/analyze/typescript.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
      - "<handwrite-tracker:projects-sdd-src-tools-analyze-typescript-rs>"
    description: "TypeScript and JavaScript tree-sitter analyzer."
```
