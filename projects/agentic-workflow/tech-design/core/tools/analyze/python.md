---
id: projects-sdd-src-tools-analyze-python-rs
...
# Standardized projects/agentic-workflow/src/tools/analyze/python.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/tools/analyze/python.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `analyze` | projects/agentic-workflow/src/tools/analyze/python.rs | function | pub | 10 | analyze(source: &str) -> Result<AnalysisResult> |
## Source
...
```yaml
changes:
  - path: projects/agentic-workflow/src/tools/analyze/python.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
      - "<handwrite-tracker:projects-sdd-src-tools-analyze-python-rs>"
    description: "Python tree-sitter analyzer."
```
