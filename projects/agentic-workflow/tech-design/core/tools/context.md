---
id: projects-sdd-src-tools-context-rs
...
# Standardized projects/agentic-workflow/src/tools/context.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/tools/context.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `definition` | projects/agentic-workflow/src/tools/context.rs | function | pub | 23 | definition() -> ToolDefinition |
| `execute` | projects/agentic-workflow/src/tools/context.rs | function | pub | 177 | execute(args: &Value, project_root: &Path) -> Result<String> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/tools/context.rs -->
```rust
...
```yaml
changes:
  - path: projects/agentic-workflow/src/tools/context.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
      - "<handwrite-gap:standardize:claim-code>"
    description: "Structured context artifact MCP tool and tests."
```
