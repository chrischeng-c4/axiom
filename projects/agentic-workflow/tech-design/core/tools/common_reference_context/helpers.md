...
Public API manifest for `projects/agentic-workflow/src/tools/common_reference_context.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `GroupSubState` | projects/agentic-workflow/src/tools/common_reference_context.rs | enum | pub | 21 |  |
| `build_already_filled_summary` | projects/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 162 | build_already_filled_summary(content: &str, filled_sections: &[String]) -> String |
| `extract_specs_from_prose` | projects/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 372 | extract_specs_from_prose(prose: &str) -> Vec<serde_json::Value> |
| `generate_section_loop_skeleton` | projects/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 226 | generate_section_loop_skeleton(     change_id: &str,     group_id: &str,     sections: &[&str], ) -> String |
| `is_create_complete` | projects/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 135 | is_create_complete(content: &str) -> bool |
| `mark_group_done` | projects/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 110 | mark_group_done(_change_dir: &Path, _group_id: &str) -> Result<()> |
| `read_fill_sections` | projects/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 121 | read_fill_sections(content: &str) -> Vec<String> |
| `read_filled_sections` | projects/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 129 | read_filled_sections(content: &str) -> Vec<String> |
| `render_specs_markdown` | projects/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 498 | render_specs_markdown(     change_id: &str,     group_id: &str,     date: &str,     specs: &[Value],     spec_plan: Option<&Vec<Value>>, ) -> String |
| `replace_ref_ctx_section` | projects/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 256 | replace_ref_ctx_section(content: &str, section: &str, new_content: &str) -> String |
| `resolve_next_group` | projects/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 42 | resolve_next_group(change_dir: &Path) -> Result<GroupSubState> |
| `resolve_next_section` | projects/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 151 | resolve_next_section(content: &str) -> Option<String> |
| `verify_artifact_written` | projects/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 355 | verify_artifact_written(change_dir: &Path, group_id: &str) -> bool |
| `write_spec_plan_yaml` | projects/agentic-workflow/src/tools/common_reference_context.rs | function | pub | 583 | write_spec_plan_yaml(group_dir: &Path, plan_entries: &[Value]) -> crate::Result<()> |
## Source
