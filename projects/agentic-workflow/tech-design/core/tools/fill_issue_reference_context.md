...
# Standardized projects/agentic-workflow/src/tools/fill_issue_reference_context.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/tools/fill_issue_reference_context.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `artifact_definition` | projects/agentic-workflow/src/tools/fill_issue_reference_context.rs | function | pub | 48 | artifact_definition() -> ToolDefinition |
| `execute_artifact` | projects/agentic-workflow/src/tools/fill_issue_reference_context.rs | function | pub | 129 | execute_artifact(args: &Value, project_root: &Path) -> Result<String> |
| `execute_workflow` | projects/agentic-workflow/src/tools/fill_issue_reference_context.rs | function | pub | 84 | execute_workflow(args: &Value, project_root: &Path) -> Result<String> |
| `workflow_definition` | projects/agentic-workflow/src/tools/fill_issue_reference_context.rs | function | pub | 24 | workflow_definition() -> ToolDefinition |
## Source
...
```yaml
changes:
  - path: projects/agentic-workflow/src/tools/fill_issue_reference_context.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
