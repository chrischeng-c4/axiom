---
id: projects-sdd-src-tools-state-update-rs
...
# Standardized projects/agentic-workflow/src/tools/state_update.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/tools/state_update.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `definition` | projects/agentic-workflow/src/tools/state_update.rs | function | pub | 17 | definition() -> ToolDefinition |
| `execute` | projects/agentic-workflow/src/tools/state_update.rs | function | pub | 71 | execute(args: &Value, project_root: &Path) -> Result<String> |
## Source
<!-- type: source lang: rust -->
<!-- source-from-target: strip-handwrite -->

<!-- source-snapshot: path=projects/agentic-workflow/src/tools/state_update.rs -->
```rust
...
mod tests {
    ...
    fn test_invalid_change_id() {
        ...
        let result = execute(&args, project_root);
        assert!(result.is_err());
        assert!(result.unwrap_err().to_string().contains("Invalid change_id"));
    }
...
```yaml
changes:
  - path: projects/agentic-workflow/src/tools/state_update.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
      - "<handwrite-gap:standardize:claim-code>"
    description: "Validated STATE.yaml phase update MCP tool and tests."
```
