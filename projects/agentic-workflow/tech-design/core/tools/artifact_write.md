---
id: projects-sdd-src-tools-artifact-write-rs
...
# Standardized projects/agentic-workflow/src/tools/artifact_write.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `projects/agentic-workflow/src/tools/artifact_write.rs` generated from AST during Score force-regeneration standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `definition` | projects/agentic-workflow/src/tools/artifact_write.rs | function | pub | 14 | definition() -> ToolDefinition |
| `execute` | projects/agentic-workflow/src/tools/artifact_write.rs | function | pub | 74 | execute(args: &Value, project_root: &Path) -> Result<String> |
## Source
...
```yaml
changes:
  - path: projects/agentic-workflow/src/tools/artifact_write.rs
    action: modify
    section: source
    impl_mode: codegen
    replaces:
      - "<handwrite-tracker:projects-sdd-src-tools-artifact-write-rs>"
    description: "Unified artifact writer MCP adapter."
```
