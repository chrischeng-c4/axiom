...
# Standardized projects/arena/src/measure.rs
...
```yaml
changes:
  - path: projects/arena/src/measure.rs
    action: modify
    section: rust-source-unit
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `projects/arena/src/measure.rs` captured during arena
