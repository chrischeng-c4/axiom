...
# Standardized projects/arena/src/engine.rs
...
```yaml
changes:
  - path: projects/arena/src/engine.rs
    action: modify
    section: rust-source-unit
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `projects/arena/src/engine.rs` captured during arena
