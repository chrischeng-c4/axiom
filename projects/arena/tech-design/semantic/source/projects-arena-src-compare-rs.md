...
# Standardized projects/arena/src/compare.rs
...
```yaml
changes:
  - path: projects/arena/src/compare.rs
    action: modify
    section: rust-source-unit
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `projects/arena/src/compare.rs` captured during arena
