# Task: Restructure Input for Change 'gcp-cloud-integration'
...
cclab sdd artifact restructure-input gcp-cloud-integration cclab/changes/gcp-cloud-integration/payloads/restructure-input.json
```