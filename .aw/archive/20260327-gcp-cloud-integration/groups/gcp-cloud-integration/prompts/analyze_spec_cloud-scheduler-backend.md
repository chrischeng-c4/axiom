# Task: Analyze Spec 'cloud-scheduler-backend' for Change 'gcp-cloud-integration'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact gcp-cloud-integration`.
...
1. Read context from `cclab/changes/gcp-cloud-integration/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact gcp-cloud-integration` with scope="cloud-scheduler-backend"
...
cclab sdd artifact create-change-spec gcp-cloud-integration <payload_path>
```
