# Task: Review Reference Context for Group 'gcp-cloud-integration' (Change 'gcp-cloud-integration')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-queue/cclab/changes/gcp-cloud-integration/groups/gcp-cloud-integration/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-queue/cclab/changes/gcp-cloud-integration/groups/gcp-cloud-integration/reference_context.md`
...
cclab sdd artifact review-reference-context gcp-cloud-integration cclab/changes/gcp-cloud-integration/payloads/review-reference-context.json
```