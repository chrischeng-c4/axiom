# Task: Analyze Spec 'scheduler-backends-gcp' for Change 'gcp-cloud-integration'
...
2. Read the skeleton via `cclab sdd workflow read-artifact gcp-cloud-integration` with scope="scheduler-backends-gcp"
