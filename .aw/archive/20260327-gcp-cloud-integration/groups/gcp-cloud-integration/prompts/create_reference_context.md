# Task: Gather Reference Context for Group 'gcp-cloud-integration' (Change 'gcp-cloud-integration')
...
- List specs under `/Users/chris.cheng/cclab/cclab-queue/cclab/specs/` using Glob
...
Write file: cclab/changes/gcp-cloud-integration/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context gcp-cloud-integration cclab/changes/gcp-cloud-integration/payloads/create-reference-context.json
```