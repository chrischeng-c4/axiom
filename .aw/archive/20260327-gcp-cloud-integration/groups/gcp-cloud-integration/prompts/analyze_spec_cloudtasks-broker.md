# Task: Analyze Spec 'cloudtasks-broker' for Change 'gcp-cloud-integration'
...
2. Read the skeleton via `cclab sdd workflow read-artifact gcp-cloud-integration` with scope="cloudtasks-broker"
