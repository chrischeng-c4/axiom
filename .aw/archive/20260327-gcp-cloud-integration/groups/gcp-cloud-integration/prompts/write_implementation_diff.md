# Task: Write Implementation Diff for Change 'gcp-cloud-integration'
...
cclab sdd artifact create-change-implementation gcp-cloud-integration cclab/changes/gcp-cloud-integration/payloads/create-change-implementation.json
```