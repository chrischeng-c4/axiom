# Task: Restructure Input for Change '1142'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chrischeng/projects/wt/sdd/cclab/changes/1142/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chrischeng/projects/wt/sdd/cclab/changes/1142/user_input.md` — user's original description
...
cclab sdd artifact restructure-input 1142 cclab/changes/1142/payloads/restructure-input.json
```