# Task: Analyze Spec 'check-alignment-phase3' for Change '1142'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact 1142`.
...
1. Read context from `cclab/changes/1142/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact 1142` with scope="check-alignment-phase3"
...
cclab sdd artifact create-change-spec 1142 <payload_path>
```
