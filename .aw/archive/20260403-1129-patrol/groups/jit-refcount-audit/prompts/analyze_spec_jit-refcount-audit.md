# Task: Analyze Spec 'jit-refcount-audit' for Change '1129-patrol'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact 1129-patrol`.
...
1. Read context from `cclab/changes/1129-patrol/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact 1129-patrol` with scope="jit-refcount-audit"
...
cclab sdd artifact create-change-spec 1129-patrol <payload_path>
```
