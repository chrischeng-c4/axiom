# Task: Gather Reference Context for Group 'jit-refcount-audit' (Change '1129-patrol')
...
Based on keyword analysis of requirements: [overview, cli, container, changes]
...
Write file: cclab/changes/1129-patrol/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context 1129-patrol cclab/changes/1129-patrol/payloads/create-reference-context.json
```