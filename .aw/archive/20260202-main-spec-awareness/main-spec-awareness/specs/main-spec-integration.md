...
version: 1
spec_type: utility
created_at: 2026-02-02T10:30:59.582474+00:00
updated_at: 2026-02-02T10:30:59.582474+00:00
requirements:
  total: 6
  ids:
    - R1
...
history:
  - timestamp: 2026-02-02T10:30:59.582474+00:00
    agent: "mcp"
    tool: "create_spec"
    action: "created"
---
...
### Scenario: Spec Group Categorization

- **WHEN** A new spec is created with `spec_group` set to "auth"
- **THEN** The spec file contains `spec_group: "auth"` in frontmatter

### Scenario: Merge Strategy

- **WHEN** A spec is created with `merge_strategy` set to "patch"
- **THEN** The spec file contains `merge_strategy: "patch"` in frontmatter

### Scenario: Planning Prompt Update

- **WHEN** The planning agent starts
- **THEN** It receives instructions to check existing specs using `list_main_specs`
