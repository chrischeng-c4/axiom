# Task: Fill Section 'requirements' for Spec 'sdd-format-rules-yaml' (Change 'sdd-spec-format-unify')

**group_id**: `sdd-spec-format-unify` (pass this to the artifact CLI)

## Instructions

1. Read the current spec: `.score/changes/sdd-spec-format-unify/groups/sdd-spec-format-unify/specs/sdd-format-rules-yaml.md`
...
```
# Read spec
Read file: .score/changes/sdd-spec-format-unify/groups/sdd-spec-format-unify/specs/sdd-format-rules-yaml.md
