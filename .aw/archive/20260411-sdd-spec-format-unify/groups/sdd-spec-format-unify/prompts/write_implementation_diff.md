# Task: Write Implementation Diff for Change 'sdd-spec-format-unify'
...
score artifact create-change-implementation sdd-spec-format-unify .score/changes/sdd-spec-format-unify/payloads/create-change-implementation.json
```