# Task: Gather Reference Context for Group 'sdd-spec-format-unify' (Change 'sdd-spec-format-unify')
...
Based on keyword analysis of requirements: [overview, schema, state-machine, logic, dependency, interaction, rest-api, rpc-api, wireframe, component, design-token, config, test-plan, changes]
...
Write file: .score/changes/sdd-spec-format-unify/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context sdd-spec-format-unify .score/changes/sdd-spec-format-unify/payloads/create-reference-context.json
```