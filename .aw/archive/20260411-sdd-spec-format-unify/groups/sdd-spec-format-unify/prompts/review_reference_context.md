# Task: Review Reference Context for Group 'sdd-spec-format-unify' (Change 'sdd-spec-format-unify')
...
score artifact review-reference-context sdd-spec-format-unify .score/changes/sdd-spec-format-unify/payloads/review-reference-context.json
```