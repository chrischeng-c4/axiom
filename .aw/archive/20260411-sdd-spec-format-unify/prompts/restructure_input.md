# Task: Restructure Input for Change 'sdd-spec-format-unify'
...
score artifact restructure-input sdd-spec-format-unify .score/changes/sdd-spec-format-unify/payloads/restructure-input.json
```