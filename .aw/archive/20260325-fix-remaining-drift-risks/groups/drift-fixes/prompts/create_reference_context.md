# Task: Gather Reference Context for Group 'drift-fixes' (Change 'fix-remaining-drift-risks')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/fix-remaining-drift-risks/groups/drift-fixes/pre_clarifications.md`
...
Write file: cclab/changes/fix-remaining-drift-risks/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context fix-remaining-drift-risks cclab/changes/fix-remaining-drift-risks/payloads/create-reference-context.json
```