# Task: Restructure Input for Change 'fix-remaining-drift-risks'
...
cclab sdd artifact restructure-input fix-remaining-drift-risks cclab/changes/fix-remaining-drift-risks/payloads/restructure-input.json
```