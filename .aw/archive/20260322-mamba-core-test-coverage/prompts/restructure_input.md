# Task: Restructure Input for Change 'mamba-core-test-coverage'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chrischeng/projects/cclab-sdd/cclab/changes/mamba-core-test-coverage/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chrischeng/projects/cclab-sdd/cclab/changes/mamba-core-test-coverage/user_input.md` — user's original description
...
cclab sdd artifact restructure-input mamba-core-test-coverage cclab/changes/mamba-core-test-coverage/payloads/restructure-input.json
```