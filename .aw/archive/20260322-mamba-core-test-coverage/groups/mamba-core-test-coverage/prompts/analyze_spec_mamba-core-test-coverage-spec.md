# Task: Analyze Spec 'mamba-core-test-coverage-spec' for Change 'mamba-core-test-coverage'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-core-test-coverage`.
...
1. Read context from `cclab/changes/mamba-core-test-coverage/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-core-test-coverage` with scope="mamba-core-test-coverage-spec"
...
cclab sdd artifact create-change-spec mamba-core-test-coverage <payload_path>
```
