# Task: Write Implementation Diff for Change 'mamba-core-test-coverage'
...
cclab sdd artifact create-change-implementation mamba-core-test-coverage cclab/changes/mamba-core-test-coverage/payloads/create-change-implementation.json
```