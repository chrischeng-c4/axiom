# Task: Review Implementation of Spec 'jet-workspace-protocol-spec' for Change 'jet-workspace-protocol'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/jet-workspace-protocol/groups/jet-workspace-protocol/specs/jet-workspace-protocol-spec.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `cclab/changes/jet-workspace-protocol/implementation.md`
4. List changed files via `cclab sdd workflow list-changed-files jet-workspace-protocol`
...
Read file: cclab/changes/jet-workspace-protocol/groups/jet-workspace-protocol/specs/jet-workspace-protocol-spec.md
Read file: cclab/changes/jet-workspace-protocol/implementation.md

# List changed files
cclab sdd workflow list-changed-files jet-workspace-protocol

# Write review (write payload JSON first, then run)
cclab sdd artifact review-change-implementation jet-workspace-protocol cclab/changes/jet-workspace-protocol/payloads/review-change-implementation.json
```