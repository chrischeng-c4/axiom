# Task: Review Reference Context for Group 'jet-workspace-protocol' (Change 'jet-workspace-protocol')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chrischeng/projects/cclab-sdd/cclab/changes/jet-workspace-protocol/groups/jet-workspace-protocol/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chrischeng/projects/cclab-sdd/cclab/changes/jet-workspace-protocol/groups/jet-workspace-protocol/reference_context.md`
...
cclab sdd artifact review-reference-context jet-workspace-protocol cclab/changes/jet-workspace-protocol/payloads/review-reference-context.json
```