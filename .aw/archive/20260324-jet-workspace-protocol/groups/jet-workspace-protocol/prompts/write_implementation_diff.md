# Task: Write Implementation Diff for Change 'jet-workspace-protocol'
...
cclab sdd artifact create-change-implementation jet-workspace-protocol cclab/changes/jet-workspace-protocol/payloads/create-change-implementation.json
```