# Task: Gather Reference Context for Group 'jet-workspace-protocol' (Change 'jet-workspace-protocol')
...
Write file: cclab/changes/jet-workspace-protocol/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context jet-workspace-protocol cclab/changes/jet-workspace-protocol/payloads/create-reference-context.json
```