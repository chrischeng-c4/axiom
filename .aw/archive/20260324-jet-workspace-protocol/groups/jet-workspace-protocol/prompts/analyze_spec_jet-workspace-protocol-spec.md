# Task: Analyze Spec 'jet-workspace-protocol-spec' for Change 'jet-workspace-protocol'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact jet-workspace-protocol`.
...
1. Read context from `cclab/changes/jet-workspace-protocol/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact jet-workspace-protocol` with scope="jet-workspace-protocol-spec"
...
cclab sdd artifact create-change-spec jet-workspace-protocol <payload_path>
```
