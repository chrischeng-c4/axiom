# Task: Restructure Input for Change 'jet-workspace-protocol'
...
cclab sdd artifact restructure-input jet-workspace-protocol cclab/changes/jet-workspace-protocol/payloads/restructure-input.json
```