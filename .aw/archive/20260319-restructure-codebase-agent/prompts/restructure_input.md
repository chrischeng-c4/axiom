# Task: Restructure Input for Change 'restructure-codebase-agent'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/restructure-codebase-agent/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/restructure-codebase-agent/user_input.md` — user's original description
...
cclab sdd artifact restructure-input restructure-codebase-agent cclab/changes/restructure-codebase-agent/payloads/restructure-input.json
```