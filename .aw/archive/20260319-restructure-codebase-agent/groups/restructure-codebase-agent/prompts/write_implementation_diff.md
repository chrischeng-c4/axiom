# Task: Write Implementation Diff for Change 'restructure-codebase-agent'
...
cclab sdd artifact create-change-implementation restructure-codebase-agent cclab/changes/restructure-codebase-agent/payloads/create-change-implementation.json
```