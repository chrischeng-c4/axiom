# Task: Post-Clarification for Group 'restructure-codebase-agent' (Change 'restructure-codebase-agent')
...
1. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/restructure-codebase-agent/groups/restructure-codebase-agent/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/restructure-codebase-agent/groups/restructure-codebase-agent/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/restructure-codebase-agent/groups/restructure-codebase-agent/reference_context.md`
...
cclab sdd artifact create-post-clarifications restructure-codebase-agent cclab/changes/restructure-codebase-agent/payloads/create-post-clarifications.json
