# Task: Restructure Input for Change 'resolver-compat'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/resolver-compat/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/resolver-compat/user_input.md` — user's original description
...
cclab sdd artifact restructure-input resolver-compat cclab/changes/resolver-compat/payloads/restructure-input.json
```