# Task: Review Reference Context for Group 'install-performance-reliability' (Change 'jet-remaining')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-remaining/groups/install-performance-reliability/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-remaining/groups/install-performance-reliability/reference_context.md`
...
cclab sdd artifact review-reference-context jet-remaining cclab/changes/jet-remaining/payloads/review-reference-context.json
```