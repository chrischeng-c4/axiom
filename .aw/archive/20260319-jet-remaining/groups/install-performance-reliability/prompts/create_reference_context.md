# Task: Gather Reference Context for Group 'install-performance-reliability' (Change 'jet-remaining')
...
cclab sdd artifact create-reference-context jet-remaining cclab/changes/jet-remaining/payloads/create-reference-context.json
```