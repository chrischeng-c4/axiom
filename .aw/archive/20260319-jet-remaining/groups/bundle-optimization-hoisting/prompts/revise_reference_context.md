# Task: Revise Reference Context for Group 'bundle-optimization-hoisting' (Change 'jet-remaining')

## Instructions

1. **Read artifact + review feedback**:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-remaining/groups/bundle-optimization-hoisting/reference_context.md`
   Focus on the `# Reviews` section — list each issue to address.
2. **Read pre-clarifications** (confirm scope):
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-remaining/groups/bundle-optimization-hoisting/pre_clarifications.md`
...
cclab sdd artifact revise-reference-context jet-remaining cclab/changes/jet-remaining/payloads/revise-reference-context.json
```