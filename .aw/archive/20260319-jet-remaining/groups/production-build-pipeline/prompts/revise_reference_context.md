# Task: Revise Reference Context for Group 'production-build-pipeline' (Change 'jet-remaining')

## Instructions

1. **Read artifact + review feedback**:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-remaining/groups/production-build-pipeline/reference_context.md`
   Focus on the `# Reviews` section — list each issue to address.
2. **Read pre-clarifications** (confirm scope):
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-remaining/groups/production-build-pipeline/pre_clarifications.md`
