# Task: Restructure Input for Change 'jet-remaining'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-remaining/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-remaining/user_input.md` — user's original description
...
cclab sdd artifact restructure-input jet-remaining cclab/changes/jet-remaining/payloads/restructure-input.json
```