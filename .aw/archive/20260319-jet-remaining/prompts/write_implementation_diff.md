# Task: Write Implementation Diff for Change 'jet-remaining'
...
cclab sdd artifact create-change-implementation jet-remaining cclab/changes/jet-remaining/payloads/create-change-implementation.json
```