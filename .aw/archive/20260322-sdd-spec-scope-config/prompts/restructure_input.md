# Task: Restructure Input for Change 'sdd-spec-scope-config'
...
cclab sdd artifact restructure-input sdd-spec-scope-config cclab/changes/sdd-spec-scope-config/payloads/restructure-input.json
```