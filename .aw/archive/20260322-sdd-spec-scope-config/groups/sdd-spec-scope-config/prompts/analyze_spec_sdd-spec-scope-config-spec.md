# Task: Analyze Spec 'sdd-spec-scope-config-spec' for Change 'sdd-spec-scope-config'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact sdd-spec-scope-config`.
...
1. Read context from `cclab/changes/sdd-spec-scope-config/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact sdd-spec-scope-config` with scope="sdd-spec-scope-config-spec"
...
cclab sdd artifact create-change-spec sdd-spec-scope-config <payload_path>
```
