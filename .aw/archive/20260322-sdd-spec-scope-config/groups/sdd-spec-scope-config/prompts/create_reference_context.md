# Task: Gather Reference Context for Group 'sdd-spec-scope-config' (Change 'sdd-spec-scope-config')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chrischeng/projects/cclab-sdd/cclab/changes/sdd-spec-scope-config/groups/sdd-spec-scope-config/pre_clarifications.md`
...
Write file: cclab/changes/sdd-spec-scope-config/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context sdd-spec-scope-config cclab/changes/sdd-spec-scope-config/payloads/create-reference-context.json
```