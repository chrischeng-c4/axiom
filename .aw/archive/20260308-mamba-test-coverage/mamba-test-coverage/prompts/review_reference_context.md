# Task: Review Reference Context for Group 'codegen-hir-mir-coverage' (Change 'mamba-test-coverage')
...
2. **Read the reference context artifact**:
   `/Users/chrischeng/projects/cclab/cclab/changes/mamba-test-coverage/groups/codegen-hir-mir-coverage/reference_context.md`
...
```
mcp__cclab-mcp__sdd_artifact_review_reference_context(project_path="/Users/chrischeng/projects/cclab", change_id="mamba-test-coverage", group_id="codegen-hir-mir-coverage", verdict="...", summary="...", checklist_results=[...], issues=[...])
```