# Task: Restructure Input for Change 'mamba-test-coverage'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chrischeng/projects/cclab/cclab/changes/mamba-test-coverage/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chrischeng/projects/cclab/cclab/changes/mamba-test-coverage/user_input.md` — user's original description
...
mcp__cclab-mcp__sdd_artifact_restructure_input(project_path="/Users/chrischeng/projects/cclab", change_id="mamba-test-coverage", groups=[{"id": "...", "issues": [...], "requirements": "...", "questions": [{"topic": "...", "question": "..."}]}])