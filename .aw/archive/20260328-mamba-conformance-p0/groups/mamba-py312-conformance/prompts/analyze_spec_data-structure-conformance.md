# Task: Analyze Spec 'data-structure-conformance' for Change 'mamba-conformance-p0'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-conformance-p0`.
...
1. Read context from `cclab/changes/mamba-conformance-p0/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-conformance-p0` with scope="data-structure-conformance"
...
cclab sdd artifact create-change-spec mamba-conformance-p0 <payload_path>
```
