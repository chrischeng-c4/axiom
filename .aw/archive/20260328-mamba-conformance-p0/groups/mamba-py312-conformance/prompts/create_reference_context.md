# Task: Gather Reference Context for Group 'mamba-py312-conformance' (Change 'mamba-conformance-p0')
...
Write file: cclab/changes/mamba-conformance-p0/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context mamba-conformance-p0 cclab/changes/mamba-conformance-p0/payloads/create-reference-context.json
```