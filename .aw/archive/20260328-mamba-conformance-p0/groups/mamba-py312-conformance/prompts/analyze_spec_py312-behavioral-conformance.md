# Task: Analyze Spec 'py312-behavioral-conformance' for Change 'mamba-conformance-p0'
...
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-conformance-p0` with scope="py312-behavioral-conformance"
