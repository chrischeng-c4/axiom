# Task: Analyze Spec 'generator-iterator-conformance' for Change 'mamba-conformance-p0'
...
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-conformance-p0` with scope="generator-iterator-conformance"
