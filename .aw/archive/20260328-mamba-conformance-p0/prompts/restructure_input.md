# Task: Restructure Input for Change 'mamba-conformance-p0'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-conformance-p0/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-conformance-p0/user_input.md` — user's original description
...
cclab sdd artifact restructure-input mamba-conformance-p0 cclab/changes/mamba-conformance-p0/payloads/restructure-input.json
```