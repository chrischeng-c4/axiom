# Task: Review Implementation of Spec 'generator-iterator-conformance' for Change 'mamba-conformance-p0'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/mamba-conformance-p0/specs/generator-iterator-conformance.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `cclab/changes/mamba-conformance-p0/implementation.md`
4. List changed files via `cclab sdd workflow list-changed-files mamba-conformance-p0`
...
Read file: cclab/changes/mamba-conformance-p0/specs/generator-iterator-conformance.md
Read file: cclab/changes/mamba-conformance-p0/implementation.md

# List changed files
cclab sdd workflow list-changed-files mamba-conformance-p0

# Write review (write payload JSON first, then run)
cclab sdd artifact review-change-implementation mamba-conformance-p0 cclab/changes/mamba-conformance-p0/payloads/review-change-implementation.json
```