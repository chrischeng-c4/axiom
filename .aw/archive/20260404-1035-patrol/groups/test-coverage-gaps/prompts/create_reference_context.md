# Task: Gather Reference Context for Group 'test-coverage-gaps' (Change '1035-patrol')
...
Write file: cclab/changes/1035-patrol/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context 1035-patrol cclab/changes/1035-patrol/payloads/create-reference-context.json
```