# Task: Review Reference Context for Group 'test-coverage-gaps' (Change '1035-patrol')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chrischeng/projects/wt/mamba/cclab/changes/1035-patrol/groups/test-coverage-gaps/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chrischeng/projects/wt/mamba/cclab/changes/1035-patrol/groups/test-coverage-gaps/reference_context.md`
...
cclab sdd artifact review-reference-context 1035-patrol cclab/changes/1035-patrol/payloads/review-reference-context.json
```