# Task: Analyze Spec 'stdlib-coverage-top5' for Change '1035-patrol'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact 1035-patrol`.
...
1. Read context from `cclab/changes/1035-patrol/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact 1035-patrol` with scope="stdlib-coverage-top5"
...
cclab sdd artifact create-change-spec 1035-patrol <payload_path>
```
