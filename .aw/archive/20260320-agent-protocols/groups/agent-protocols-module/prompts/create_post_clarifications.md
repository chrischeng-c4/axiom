# Task: Post-Clarification for Group 'agent-protocols-module' (Change 'agent-protocols')
...
1. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-protocols/groups/agent-protocols-module/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-protocols/groups/agent-protocols-module/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-protocols/groups/agent-protocols-module/reference_context.md`
...
cclab sdd artifact create-post-clarifications agent-protocols cclab/changes/agent-protocols/payloads/create-post-clarifications.json
