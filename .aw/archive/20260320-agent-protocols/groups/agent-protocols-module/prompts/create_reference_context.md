# Task: Gather Reference Context for Group 'agent-protocols-module' (Change 'agent-protocols')
...
cclab sdd artifact create-reference-context agent-protocols cclab/changes/agent-protocols/payloads/create-reference-context.json
```