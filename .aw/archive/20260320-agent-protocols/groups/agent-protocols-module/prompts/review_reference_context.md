# Task: Review Reference Context for Group 'agent-protocols-module' (Change 'agent-protocols')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-protocols/groups/agent-protocols-module/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-protocols/groups/agent-protocols-module/reference_context.md`
...
cclab sdd artifact review-reference-context agent-protocols cclab/changes/agent-protocols/payloads/review-reference-context.json
```