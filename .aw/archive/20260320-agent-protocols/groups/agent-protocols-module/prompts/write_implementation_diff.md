# Task: Write Implementation Diff for Change 'agent-protocols'
...
cclab sdd artifact create-change-implementation agent-protocols cclab/changes/agent-protocols/payloads/create-change-implementation.json
```