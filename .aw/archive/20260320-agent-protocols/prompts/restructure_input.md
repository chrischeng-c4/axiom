# Task: Restructure Input for Change 'agent-protocols'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-protocols/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-protocols/user_input.md` — user's original description
...
cclab sdd artifact restructure-input agent-protocols cclab/changes/agent-protocols/payloads/restructure-input.json
```