# Task: Revise Reference Context for Group 'jet-dev-server-v2' (Change 'jet-dev-server-v2')
...
cclab sdd artifact revise-reference-context jet-dev-server-v2 cclab/changes/jet-dev-server-v2/payloads/revise-reference-context.json
```