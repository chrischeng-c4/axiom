# Task: Review Reference Context for Group 'jet-dev-server-v2' (Change 'jet-dev-server-v2')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-dev-server-v2/groups/jet-dev-server-v2/reference_context.md`
...
cclab sdd artifact review-reference-context jet-dev-server-v2 cclab/changes/jet-dev-server-v2/payloads/review-reference-context.json
```