# Task: Analyze Spec 'jet-dev-server-v2-spec' for Change 'jet-dev-server-v2'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact jet-dev-server-v2`.
...
1. Read context from `cclab/changes/jet-dev-server-v2/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact jet-dev-server-v2` with scope="jet-dev-server-v2-spec"
...
cclab sdd artifact create-change-spec jet-dev-server-v2 <payload_path>
```
