# Task: Restructure Input for Change 'jet-dev-server-v2'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-dev-server-v2/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-dev-server-v2/user_input.md` — user's original description
...
cclab sdd artifact restructure-input jet-dev-server-v2 cclab/changes/jet-dev-server-v2/payloads/restructure-input.json
```