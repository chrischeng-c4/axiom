# Task: Restructure Input for Change 'mamba-jit-memory'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-jit-memory/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-jit-memory/user_input.md` — user's original description
...
cclab sdd artifact restructure-input mamba-jit-memory cclab/changes/mamba-jit-memory/payloads/restructure-input.json
```