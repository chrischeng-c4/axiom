# Task: Analyze Spec 'cranelift-jit-memory-fix' for Change 'mamba-jit-memory'
...
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-jit-memory` with scope="cranelift-jit-memory-fix"
