# Task: Gather Reference Context for Group 'jit-memory' (Change 'mamba-jit-memory')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-jit-memory/groups/jit-memory/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, wireframe, component, config, test-plan, changes]
...
Write file: cclab/changes/mamba-jit-memory/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context mamba-jit-memory cclab/changes/mamba-jit-memory/payloads/create-reference-context.json
```