# Task: Analyze Spec 'jit-memory' for Change 'mamba-jit-memory'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-jit-memory`.
...
1. Read context from `cclab/changes/mamba-jit-memory/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-jit-memory` with scope="jit-memory"
...
cclab sdd artifact create-change-spec mamba-jit-memory <payload_path>
```
