...
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-test/cclab/changes/mamba-test-coverage/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-test/cclab/changes/mamba-test-coverage/user_input.md` — user's original description
...
cclab sdd artifact restructure-input mamba-test-coverage cclab/changes/mamba-test-coverage/payloads/restructure-input.json
```