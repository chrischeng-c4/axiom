# Task: Analyze Spec 'mamba-test-coverage-spec' for Change 'mamba-test-coverage'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-test-coverage`.
...
1. Read context from `cclab/changes/mamba-test-coverage/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-test-coverage` with scope="mamba-test-coverage-spec"
...
cclab sdd artifact create-change-spec mamba-test-coverage <payload_path>
```
