# Task: Restructure Input for Change 'sdd-workflow-cleanup'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-workflow-cleanup/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-workflow-cleanup/user_input.md` — user's original description
...
cclab sdd artifact restructure-input sdd-workflow-cleanup cclab/changes/sdd-workflow-cleanup/payloads/restructure-input.json
```