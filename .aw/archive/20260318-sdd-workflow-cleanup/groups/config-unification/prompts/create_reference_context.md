# Task: Gather Reference Context for Group 'config-unification' (Change 'sdd-workflow-cleanup')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-workflow-cleanup/groups/config-unification/pre_clarifications.md`
...
cclab sdd artifact create-reference-context sdd-workflow-cleanup cclab/changes/sdd-workflow-cleanup/payloads/create-reference-context.json
```