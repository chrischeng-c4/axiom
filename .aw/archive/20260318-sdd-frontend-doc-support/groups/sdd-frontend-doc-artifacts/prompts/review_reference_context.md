# Task: Review Reference Context for Group 'sdd-frontend-doc-artifacts' (Change 'sdd-frontend-doc-support')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-frontend-doc-support/groups/sdd-frontend-doc-artifacts/reference_context.md`
...
cclab sdd artifact review-reference-context sdd-frontend-doc-support cclab/changes/sdd-frontend-doc-support/payloads/review-reference-context.json
```