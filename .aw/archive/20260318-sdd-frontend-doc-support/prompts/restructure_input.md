# Task: Restructure Input for Change 'sdd-frontend-doc-support'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-frontend-doc-support/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-frontend-doc-support/user_input.md` — user's original description
...
cclab sdd artifact restructure-input sdd-frontend-doc-support cclab/changes/sdd-frontend-doc-support/payloads/restructure-input.json
```