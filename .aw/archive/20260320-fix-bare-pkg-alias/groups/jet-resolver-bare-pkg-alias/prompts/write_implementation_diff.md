# Task: Write Implementation Diff for Change 'fix-bare-pkg-alias'
...
cclab sdd artifact create-change-implementation fix-bare-pkg-alias cclab/changes/fix-bare-pkg-alias/payloads/create-change-implementation.json
```