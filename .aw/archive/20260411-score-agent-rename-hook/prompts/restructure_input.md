# Task: Restructure Input for Change 'score-agent-rename-hook'
...
score artifact restructure-input score-agent-rename-hook .score/changes/score-agent-rename-hook/payloads/restructure-input.json
```