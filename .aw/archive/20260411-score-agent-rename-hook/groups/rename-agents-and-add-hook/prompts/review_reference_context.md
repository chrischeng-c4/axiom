# Task: Review Reference Context for Group 'rename-agents-and-add-hook' (Change 'score-agent-rename-hook')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/main/.score/changes/score-agent-rename-hook/groups/rename-agents-and-add-hook/reference_context.md`
...
score artifact review-reference-context score-agent-rename-hook .score/changes/score-agent-rename-hook/payloads/review-reference-context.json
```