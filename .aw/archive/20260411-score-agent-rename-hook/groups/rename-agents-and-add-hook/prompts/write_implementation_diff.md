# Task: Write Implementation Diff for Change 'score-agent-rename-hook'
...
score artifact create-change-implementation score-agent-rename-hook .score/changes/score-agent-rename-hook/payloads/create-change-implementation.json
```