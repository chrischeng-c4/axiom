# Task: Review Spec 'bug-init-change-phase-mapping-conflates-crrr-terminal-spec' for Change 'bug-init-change-phase-mapping-conflates-crrr-terminal'

## Instructions

1. **Run automated validation**:
   `score workflow validate-spec-completeness bug-init-change-phase-mapping-conflates-crrr-terminal --spec-id bug-init-change-phase-mapping-conflates-crrr-terminal-spec`
2. **Read the spec**:
   `.score/changes/bug-init-change-phase-mapping-conflates-crrr-terminal/specs/bug-init-change-phase-mapping-conflates-crrr-terminal-spec.md`
...
score artifact review-change-spec bug-init-change-phase-mapping-conflates-crrr-terminal .score/changes/bug-init-change-phase-mapping-conflates-crrr-terminal/payloads/review-change-spec.json
```