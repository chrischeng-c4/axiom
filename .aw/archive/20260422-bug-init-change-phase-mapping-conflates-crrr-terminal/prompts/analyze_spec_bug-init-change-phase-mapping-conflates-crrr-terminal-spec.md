# Task: Analyze Spec 'bug-init-change-phase-mapping-conflates-crrr-terminal-spec' for Change 'bug-init-change-phase-mapping-conflates-crrr-terminal'

A skeleton has been generated at `.score/changes/bug-init-change-phase-mapping-conflates-crrr-terminal/specs/bug-init-change-phase-mapping-conflates-crrr-terminal-spec.md`.
...
2. Read the skeleton: `.score/changes/bug-init-change-phase-mapping-conflates-crrr-terminal/specs/bug-init-change-phase-mapping-conflates-crrr-terminal-spec.md`
...
4. Decide which sections to fill based on the nature of the change. Pick ONLY leaf section names from this list — NEVER pass umbrella words like `diagrams`, `api_spec`, or `test_plan`:
   ...
   Docs: `doc`
5. Write a JSON payload file to `.score/changes/bug-init-change-phase-mapping-conflates-crrr-terminal/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/bug-init-change-phase-mapping-conflates-crrr-terminal/proposal.md
