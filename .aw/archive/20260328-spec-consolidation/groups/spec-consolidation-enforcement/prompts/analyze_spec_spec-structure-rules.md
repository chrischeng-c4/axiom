# Task: Analyze Spec 'spec-structure-rules' for Change 'spec-consolidation'
...
2. Read the skeleton via `cclab sdd workflow read-artifact spec-consolidation` with scope="spec-structure-rules"
