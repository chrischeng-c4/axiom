# Task: Analyze Spec 'artifact-tools-update' for Change 'spec-consolidation'
...
2. Read the skeleton via `cclab sdd workflow read-artifact spec-consolidation` with scope="artifact-tools-update"
