# Task: Review Implementation of Spec 'artifact-tools-update' for Change 'spec-consolidation'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/spec-consolidation/groups/spec-consolidation-enforcement/specs/artifact-tools-update.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `cclab/changes/spec-consolidation/implementation.md`
4. List changed files via `cclab sdd workflow list-changed-files spec-consolidation`
...
Read file: cclab/changes/spec-consolidation/groups/spec-consolidation-enforcement/specs/artifact-tools-update.md
Read file: cclab/changes/spec-consolidation/implementation.md

# List changed files
cclab sdd workflow list-changed-files spec-consolidation

# Write review (write payload JSON first, then run)
cclab sdd artifact review-change-implementation spec-consolidation cclab/changes/spec-consolidation/payloads/review-change-implementation.json
```