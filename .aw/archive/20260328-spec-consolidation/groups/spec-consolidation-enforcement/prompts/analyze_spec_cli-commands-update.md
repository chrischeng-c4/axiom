# Task: Analyze Spec 'cli-commands-update' for Change 'spec-consolidation'
...
2. Read the skeleton via `cclab sdd workflow read-artifact spec-consolidation` with scope="cli-commands-update"
