# Task: Review Reference Context for Group 'spec-consolidation-enforcement' (Change 'spec-consolidation')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/spec-consolidation/groups/spec-consolidation-enforcement/reference_context.md`
...
cclab sdd artifact review-reference-context spec-consolidation cclab/changes/spec-consolidation/payloads/review-reference-context.json
```