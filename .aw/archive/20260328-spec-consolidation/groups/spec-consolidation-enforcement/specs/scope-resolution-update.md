...
- **GIVEN** config has `cclab-sdd = "crates"` and `cclab/specs/crates/cclab-sdd/logic/state-machine.md` exists at depth 2
...
- **GIVEN** `cclab/specs/crates/cclab-sdd/` contains `logic/state-machine.md`, `logic/change-spec.md`, `interfaces/tools/artifact-tools.md`
