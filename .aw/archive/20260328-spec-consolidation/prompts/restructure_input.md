# Task: Restructure Input for Change 'spec-consolidation'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/spec-consolidation/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/spec-consolidation/user_input.md` — user's original description
...
cclab sdd artifact restructure-input spec-consolidation cclab/changes/spec-consolidation/payloads/restructure-input.json
```