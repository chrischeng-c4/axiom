# Task: Write Implementation Diff for Change 'mamba-binding-tests'
...
cclab sdd artifact create-change-implementation mamba-binding-tests cclab/changes/mamba-binding-tests/payloads/create-change-implementation.json
```