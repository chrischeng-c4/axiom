# Task: Gather Reference Context for Group 'mamba-tests' (Change 'mamba-binding-tests')
...
Based on keyword analysis of requirements: [overview, db-model, schema, state-machine, logic, dependency, interaction, rest-api, async-api, cli, design-token, config, test-plan, changes]
...
Write file: cclab/changes/mamba-binding-tests/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context mamba-binding-tests cclab/changes/mamba-binding-tests/payloads/create-reference-context.json
```