# Task: Analyze Spec 'mamba-binding-tests-spec' for Change 'mamba-binding-tests'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-binding-tests`.
...
1. Read context from `cclab/changes/mamba-binding-tests/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-binding-tests` with scope="mamba-binding-tests-spec"
...
cclab sdd artifact create-change-spec mamba-binding-tests <payload_path>
```
