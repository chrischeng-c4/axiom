# Task: Restructure Input for Change 'mamba-binding-tests'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chrischeng/projects/cclab-sdd/cclab/changes/mamba-binding-tests/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chrischeng/projects/cclab-sdd/cclab/changes/mamba-binding-tests/user_input.md` — user's original description
...
cclab sdd artifact restructure-input mamba-binding-tests cclab/changes/mamba-binding-tests/payloads/restructure-input.json
```