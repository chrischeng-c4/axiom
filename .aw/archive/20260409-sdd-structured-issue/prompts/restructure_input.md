# Task: Restructure Input for Change 'sdd-structured-issue'
...
score artifact restructure-input sdd-structured-issue .score/changes/sdd-structured-issue/payloads/restructure-input.json
```