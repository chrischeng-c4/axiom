# Task: Review Reference Context for Group 'structured-issue-format' (Change 'sdd-structured-issue')
...
score artifact review-reference-context sdd-structured-issue .score/changes/sdd-structured-issue/payloads/review-reference-context.json
```