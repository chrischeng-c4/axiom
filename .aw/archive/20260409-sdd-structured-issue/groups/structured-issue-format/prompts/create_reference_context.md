# Task: Gather Reference Context for Group 'structured-issue-format' (Change 'sdd-structured-issue')
...
Write file: .score/changes/sdd-structured-issue/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context sdd-structured-issue .score/changes/sdd-structured-issue/payloads/create-reference-context.json
```