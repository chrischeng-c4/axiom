# Task: Write Implementation Diff for Change 'sdd-structured-issue'
...
score artifact create-change-implementation sdd-structured-issue .score/changes/sdd-structured-issue/payloads/create-change-implementation.json
```