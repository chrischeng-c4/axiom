# Task: Write Implementation Diff for Change 'sdd-subagent-mode'
...
cclab sdd artifact create-change-implementation sdd-subagent-mode cclab/changes/sdd-subagent-mode/payloads/create-change-implementation.json
```