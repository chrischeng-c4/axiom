# Task: Analyze Spec 'subagent-executor-resolution' for Change 'sdd-subagent-mode'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact sdd-subagent-mode`.
...
1. Read context from `cclab/changes/sdd-subagent-mode/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact sdd-subagent-mode` with scope="subagent-executor-resolution"
...
cclab sdd artifact create-change-spec sdd-subagent-mode <payload_path>
```
