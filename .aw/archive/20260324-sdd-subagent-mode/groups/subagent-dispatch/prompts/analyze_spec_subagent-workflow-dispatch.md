# Task: Analyze Spec 'subagent-workflow-dispatch' for Change 'sdd-subagent-mode'
...
2. Read the skeleton via `cclab sdd workflow read-artifact sdd-subagent-mode` with scope="subagent-workflow-dispatch"
