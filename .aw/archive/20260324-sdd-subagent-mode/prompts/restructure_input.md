# Task: Restructure Input for Change 'sdd-subagent-mode'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-subagent-mode/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-subagent-mode/user_input.md` — user's original description
...
cclab sdd artifact restructure-input sdd-subagent-mode cclab/changes/sdd-subagent-mode/payloads/restructure-input.json
```