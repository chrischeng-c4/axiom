# Task: Restructure Input for Change 'jet-postcss-tailwind'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chrischeng/projects/cclab-sdd/cclab/changes/jet-postcss-tailwind/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chrischeng/projects/cclab-sdd/cclab/changes/jet-postcss-tailwind/user_input.md` — user's original description
...
cclab sdd artifact restructure-input jet-postcss-tailwind cclab/changes/jet-postcss-tailwind/payloads/restructure-input.json
```