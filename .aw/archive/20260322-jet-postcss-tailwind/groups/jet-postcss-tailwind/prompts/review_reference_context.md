# Task: Review Reference Context for Group 'jet-postcss-tailwind' (Change 'jet-postcss-tailwind')
...
2. **Read the reference context artifact**:
   `/Users/chrischeng/projects/cclab-sdd/cclab/changes/jet-postcss-tailwind/groups/jet-postcss-tailwind/reference_context.md`
...
cclab sdd artifact review-reference-context jet-postcss-tailwind cclab/changes/jet-postcss-tailwind/payloads/review-reference-context.json
```