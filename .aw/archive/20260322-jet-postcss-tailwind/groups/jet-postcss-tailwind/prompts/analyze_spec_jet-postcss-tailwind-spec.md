# Task: Analyze Spec 'jet-postcss-tailwind-spec' for Change 'jet-postcss-tailwind'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact jet-postcss-tailwind`.
...
1. Read context from `cclab/changes/jet-postcss-tailwind/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact jet-postcss-tailwind` with scope="jet-postcss-tailwind-spec"
...
cclab sdd artifact create-change-spec jet-postcss-tailwind <payload_path>
```
