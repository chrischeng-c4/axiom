# Task: Write Implementation Diff for Change 'jet-postcss-tailwind'
...
cclab sdd artifact create-change-implementation jet-postcss-tailwind cclab/changes/jet-postcss-tailwind/payloads/create-change-implementation.json
```