# Task: Gather Reference Context for Group 'consolidate-codegen' (Change 'consolidate-codegen')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/wt/conductor/.score/changes/consolidate-codegen/groups/consolidate-codegen/pre_clarifications.md`
...
Read these specs using the Read tool (file paths under `/Users/chris.cheng/cclab/wt/conductor/.score/tech_design/`).
...
Write file: .score/changes/consolidate-codegen/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context consolidate-codegen .score/changes/consolidate-codegen/payloads/create-reference-context.json
```