# Task: Analyze Spec 'consolidate-codegen-spec' for Change 'consolidate-codegen'

A skeleton has been generated at `.score/changes/consolidate-codegen/groups/consolidate-codegen/specs/consolidate-codegen-spec.md`.

**group_id**: `consolidate-codegen` (pass this to the artifact CLI as `group_id` parameter)
...
1. Read context:
   - Read file: `.score/changes/consolidate-codegen/proposal.md` for spec_plan routing
   - Read file: `.score/changes/consolidate-codegen/reference_context.md` if no proposal
2. Read the skeleton: `.score/changes/consolidate-codegen/groups/consolidate-codegen/specs/consolidate-codegen-spec.md`
...
5. Write a JSON payload file to `.score/changes/consolidate-codegen/groups/consolidate-codegen/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/consolidate-codegen/proposal.md
...
score artifact create-change-spec consolidate-codegen .score/changes/consolidate-codegen/groups/consolidate-codegen/payloads/create-change-spec.json
```
