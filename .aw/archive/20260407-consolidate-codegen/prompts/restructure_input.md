# Task: Restructure Input for Change 'consolidate-codegen'
...
score artifact restructure-input consolidate-codegen .score/changes/consolidate-codegen/payloads/restructure-input.json
```