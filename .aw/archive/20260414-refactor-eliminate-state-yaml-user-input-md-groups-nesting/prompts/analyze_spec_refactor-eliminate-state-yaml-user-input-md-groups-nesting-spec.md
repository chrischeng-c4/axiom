# Task: Analyze Spec 'refactor-eliminate-state-yaml-user-input-md-groups-nesting-spec' for Change 'refactor-eliminate-state-yaml-user-input-md-groups-nesting'

A skeleton has been generated at `.score/changes/refactor-eliminate-state-yaml-user-input-md-groups-nesting/specs/refactor-eliminate-state-yaml-user-input-md-groups-nesting-spec.md`.
...
2. Read the skeleton: `.score/changes/refactor-eliminate-state-yaml-user-input-md-groups-nesting/specs/refactor-eliminate-state-yaml-user-input-md-groups-nesting-spec.md`
...
5. Write a JSON payload file to `.score/changes/refactor-eliminate-state-yaml-user-input-md-groups-nesting/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/refactor-eliminate-state-yaml-user-input-md-groups-nesting/proposal.md
...
score artifact create-change-spec refactor-eliminate-state-yaml-user-input-md-groups-nesting .score/changes/refactor-eliminate-state-yaml-user-input-md-groups-nesting/payloads/create-change-spec.json
```
