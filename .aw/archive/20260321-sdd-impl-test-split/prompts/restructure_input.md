# Task: Restructure Input for Change 'sdd-impl-test-split'
...
cclab sdd artifact restructure-input sdd-impl-test-split cclab/changes/sdd-impl-test-split/payloads/restructure-input.json
```