# Task: Gather Reference Context for Group 'sdd-impl-test-split' (Change 'sdd-impl-test-split')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chrischeng/projects/cclab-sdd/cclab/changes/sdd-impl-test-split/groups/sdd-impl-test-split/pre_clarifications.md`
...
Write file: cclab/changes/sdd-impl-test-split/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context sdd-impl-test-split cclab/changes/sdd-impl-test-split/payloads/create-reference-context.json
```