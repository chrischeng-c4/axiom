# Task: Analyze Spec 'sdd-impl-test-split-spec' for Change 'sdd-impl-test-split'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact sdd-impl-test-split`.
...
1. Read context from `cclab/changes/sdd-impl-test-split/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact sdd-impl-test-split` with scope="sdd-impl-test-split-spec"
...
cclab sdd artifact create-change-spec sdd-impl-test-split <payload_path>
```
