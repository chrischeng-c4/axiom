# Task: Restructure Input for Change 'mamba-thread-safe'

## Step 1: Read Input

Read:
- `/Users/chrischeng/projects/cclab/cclab/changes/mamba-thread-safe/user_input.md` — user's description
...
mcp__cclab-mcp__sdd_artifact_restructure_input(project_path="/Users/chrischeng/projects/cclab", change_id="mamba-thread-safe", groups=[{"id": "...", "issues": [...], "requirements": "...", "questions": [{"topic": "...", "question": "..."}]}])