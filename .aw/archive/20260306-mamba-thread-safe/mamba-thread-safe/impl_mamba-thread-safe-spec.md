# Implementation Diff — Task mamba-thread-safe-spec
...
Cargo.lock                                         |  79 ++---
 ...
 15 files changed, 561 insertions(+), 335 deletions(-)
```
...
diff --git a/crates/cclab-sdd/src/mcp/tools/phase_transition.rs b/crates/cclab-sdd/src/mcp/tools/phase_transition.rs
index 8da471b..284d9ec 100644
--- a/crates/cclab-sdd/src/mcp/tools/phase_transition.rs
+++ b/crates/cclab-sdd/src/mcp/tools/phase_transition.rs
@@ -181,6 +181,8 @@ pub fn validate_transition(from: &StatePhase, to: &StatePhase) -> Result<()> {
...
+        // Reset: reviewed → created (retry after TerminalFailure)
+        (StatePhase::ChangeImplementationReviewed, StatePhase::ChangeImplementationCreated) => true,
         // Impl → Merge
         (StatePhase::ChangeImplementationCreated, StatePhase::ChangeMergeCreated) => true,
