# Task: Gather Reference Context for Group 'mamba-py312-conformance' (Change 'mamba-py312-conformance')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-py312-conformance/groups/mamba-py312-conformance/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, async-api, cli, changes]
...
Write file: cclab/changes/mamba-py312-conformance/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context mamba-py312-conformance cclab/changes/mamba-py312-conformance/payloads/create-reference-context.json
```