# Task: Restructure Input for Change 'mamba-py312-conformance'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-py312-conformance/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-py312-conformance/user_input.md` — user's original description
...
cclab sdd artifact restructure-input mamba-py312-conformance cclab/changes/mamba-py312-conformance/payloads/restructure-input.json
```