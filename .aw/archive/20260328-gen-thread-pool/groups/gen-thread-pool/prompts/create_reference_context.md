# Task: Gather Reference Context for Group 'gen-thread-pool' (Change 'gen-thread-pool')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/gen-thread-pool/groups/gen-thread-pool/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, state-machine, wireframe, component, test-plan, changes]
...
Read these specs using the Read tool (file paths under `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/specs/`).
...
Write file: cclab/changes/gen-thread-pool/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context gen-thread-pool cclab/changes/gen-thread-pool/payloads/create-reference-context.json
```