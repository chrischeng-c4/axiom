# Task: Analyze Spec 'generator-thread-pool-design' for Change 'gen-thread-pool'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact gen-thread-pool`.
...
1. Read context from `cclab/changes/gen-thread-pool/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact gen-thread-pool` with scope="generator-thread-pool-design"
...
cclab sdd artifact create-change-spec gen-thread-pool <payload_path>
```
