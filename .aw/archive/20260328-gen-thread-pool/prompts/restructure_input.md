# Task: Restructure Input for Change 'gen-thread-pool'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/gen-thread-pool/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/gen-thread-pool/user_input.md` — user's original description
...
cclab sdd artifact restructure-input gen-thread-pool cclab/changes/gen-thread-pool/payloads/restructure-input.json
```