# Task: Write Implementation Diff for Change 'fix-monorepo-bundler'
...
cclab sdd artifact create-change-implementation fix-monorepo-bundler cclab/changes/fix-monorepo-bundler/payloads/create-change-implementation.json
```