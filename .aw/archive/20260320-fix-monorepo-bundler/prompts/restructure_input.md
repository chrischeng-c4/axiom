# Task: Restructure Input for Change 'fix-monorepo-bundler'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/fix-monorepo-bundler/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/fix-monorepo-bundler/user_input.md` — user's original description
...
cclab sdd artifact restructure-input fix-monorepo-bundler cclab/changes/fix-monorepo-bundler/payloads/restructure-input.json
```