# Task: Review Reference Context for Group 'lambda-limitations' (Change 'mamba-p1-bugfix')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chrischeng/projects/cclab-sdd/cclab/changes/mamba-p1-bugfix/groups/lambda-limitations/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chrischeng/projects/cclab-sdd/cclab/changes/mamba-p1-bugfix/groups/lambda-limitations/reference_context.md`
...
cclab sdd artifact review-reference-context mamba-p1-bugfix cclab/changes/mamba-p1-bugfix/payloads/review-reference-context.json
```