# Task: Analyze Spec 'tokens-and-indent' for Change 'mamba-p1-bugfix'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-p1-bugfix`.
...
1. Read context from `cclab/changes/mamba-p1-bugfix/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-p1-bugfix` with scope="tokens-and-indent"
...
cclab sdd artifact create-change-spec mamba-p1-bugfix <payload_path>
```
