# Task: Gather Reference Context for Group 'future-stdlib-module' (Change 'mamba-stdlib-future')
...
Based on keyword analysis of requirements: [overview, cli, changes]
...
Write file: .score/changes/mamba-stdlib-future/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context mamba-stdlib-future .score/changes/mamba-stdlib-future/payloads/create-reference-context.json
```