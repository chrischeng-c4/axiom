# Task: Restructure Input for Change 'mamba-stdlib-future'
...
score artifact restructure-input mamba-stdlib-future .score/changes/mamba-stdlib-future/payloads/restructure-input.json
```