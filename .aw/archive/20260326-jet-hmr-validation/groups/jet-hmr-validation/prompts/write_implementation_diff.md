# Task: Write Implementation Diff for Change 'jet-hmr-validation'
...
cclab sdd artifact create-change-implementation jet-hmr-validation cclab/changes/jet-hmr-validation/payloads/create-change-implementation.json
```