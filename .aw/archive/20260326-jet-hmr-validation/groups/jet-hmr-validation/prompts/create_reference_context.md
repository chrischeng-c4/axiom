# Task: Gather Reference Context for Group 'jet-hmr-validation' (Change 'jet-hmr-validation')
...
Based on keyword analysis of requirements: [overview, schema, state-machine, logic, dependency, interaction, rest-api, wireframe, component, design-token, e2e-scenario, test-plan, changes]
...
Write file: cclab/changes/jet-hmr-validation/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context jet-hmr-validation cclab/changes/jet-hmr-validation/payloads/create-reference-context.json
```