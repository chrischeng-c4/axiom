# Task: Analyze Spec 'jet-hmr-validation-spec' for Change 'jet-hmr-validation'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact jet-hmr-validation`.
...
1. Read context from `cclab/changes/jet-hmr-validation/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact jet-hmr-validation` with scope="jet-hmr-validation-spec"
...
cclab sdd artifact create-change-spec jet-hmr-validation <payload_path>
```
