# Task: Review Reference Context for Group 'jet-hmr-validation' (Change 'jet-hmr-validation')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-hmr-validation/groups/jet-hmr-validation/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-hmr-validation/groups/jet-hmr-validation/reference_context.md`
...
cclab sdd artifact review-reference-context jet-hmr-validation cclab/changes/jet-hmr-validation/payloads/review-reference-context.json
```