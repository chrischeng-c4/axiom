# Task: Review Implementation of Spec 'jet-hmr-validation-spec' for Change 'jet-hmr-validation'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/jet-hmr-validation/groups/jet-hmr-validation/specs/jet-hmr-validation-spec.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `cclab/changes/jet-hmr-validation/implementation.md`
4. List changed files via `cclab sdd workflow list-changed-files jet-hmr-validation`
...
Read file: cclab/changes/jet-hmr-validation/groups/jet-hmr-validation/specs/jet-hmr-validation-spec.md
Read file: cclab/changes/jet-hmr-validation/implementation.md

# List changed files
cclab sdd workflow list-changed-files jet-hmr-validation

# Write review (write payload JSON first, then run)
cclab sdd artifact review-change-implementation jet-hmr-validation cclab/changes/jet-hmr-validation/payloads/review-change-implementation.json
```