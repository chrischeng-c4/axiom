# Task: Restructure Input for Change 'jet-hmr-validation'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-hmr-validation/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-hmr-validation/user_input.md` — user's original description
...
cclab sdd artifact restructure-input jet-hmr-validation cclab/changes/jet-hmr-validation/payloads/restructure-input.json
```