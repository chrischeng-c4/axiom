# Task: Analyze Spec 'issues-cli-crud-spec' for Change 'issues-cli-crud'

A skeleton has been generated at `.score/changes/issues-cli-crud/groups/issues-cli-crud/specs/issues-cli-crud-spec.md`.

**group_id**: `issues-cli-crud` (pass this to the artifact CLI as `group_id` parameter)
...
1. Read context:
   - Read file: `.score/changes/issues-cli-crud/proposal.md` for spec_plan routing
   - Read file: `.score/changes/issues-cli-crud/reference_context.md` if no proposal
2. Read the skeleton: `.score/changes/issues-cli-crud/groups/issues-cli-crud/specs/issues-cli-crud-spec.md`
...
5. Write a JSON payload file to `.score/changes/issues-cli-crud/groups/issues-cli-crud/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/issues-cli-crud/proposal.md
...
score artifact create-change-spec issues-cli-crud .score/changes/issues-cli-crud/groups/issues-cli-crud/payloads/create-change-spec.json
```
