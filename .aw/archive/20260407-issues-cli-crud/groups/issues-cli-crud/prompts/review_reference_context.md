# Task: Review Reference Context for Group 'issues-cli-crud' (Change 'issues-cli-crud')
...
3. **Verify each spec entry**: For each spec listed in the artifact, read the actual spec under `/Users/chrischeng/projects/wt/conductor/.score/tech_design/` to verify relevance and key requirements are accurate.
...
score artifact review-reference-context issues-cli-crud .score/changes/issues-cli-crud/payloads/review-reference-context.json
```