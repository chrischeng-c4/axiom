# Task: Gather Reference Context for Group 'issues-cli-crud' (Change 'issues-cli-crud')
...
Read these specs using the Read tool (file paths under `/Users/chrischeng/projects/wt/conductor/.score/tech_design/`).
...
Write file: .score/changes/issues-cli-crud/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context issues-cli-crud .score/changes/issues-cli-crud/payloads/create-reference-context.json
```