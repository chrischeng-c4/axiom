# Task: Post-Clarification for Group 'issues-cli-crud' (Change 'issues-cli-crud')
...
1. `/Users/chrischeng/projects/wt/conductor/.score/changes/issues-cli-crud/groups/issues-cli-crud/requirements.md`
2. `/Users/chrischeng/projects/wt/conductor/.score/changes/issues-cli-crud/groups/issues-cli-crud/pre_clarifications.md`
3. `/Users/chrischeng/projects/wt/conductor/.score/changes/issues-cli-crud/groups/issues-cli-crud/reference_context.md`
4. Actual specs — read high/medium relevance specs from reference_context.md

- Read high/medium relevance specs listed in reference_context.md (under `/Users/chrischeng/projects/wt/conductor/.score/tech_design/`)
...
score artifact create-post-clarifications issues-cli-crud .score/changes/issues-cli-crud/payloads/create-post-clarifications.json
