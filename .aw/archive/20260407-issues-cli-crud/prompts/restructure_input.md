# Task: Restructure Input for Change 'issues-cli-crud'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chrischeng/projects/wt/conductor/.score/changes/issues-cli-crud/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chrischeng/projects/wt/conductor/.score/changes/issues-cli-crud/user_input.md` — user's original description
...
score artifact restructure-input issues-cli-crud .score/changes/issues-cli-crud/payloads/restructure-input.json
```