# Task: Analyze Spec 'bug-find-project-root-must-resolve-to-main-repo-when-i-spec' for Change 'bug-find-project-root-must-resolve-to-main-repo-when-i'

A skeleton has been generated at `.score/changes/bug-find-project-root-must-resolve-to-main-repo-when-i/specs/bug-find-project-root-must-resolve-to-main-repo-when-i-spec.md`.
...
2. Read the skeleton: `.score/changes/bug-find-project-root-must-resolve-to-main-repo-when-i/specs/bug-find-project-root-must-resolve-to-main-repo-when-i-spec.md`
...
5. Write a JSON payload file to `.score/changes/bug-find-project-root-must-resolve-to-main-repo-when-i/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/bug-find-project-root-must-resolve-to-main-repo-when-i/proposal.md
...
score artifact create-change-spec bug-find-project-root-must-resolve-to-main-repo-when-i .score/changes/bug-find-project-root-must-resolve-to-main-repo-when-i/payloads/create-change-spec.json
```
