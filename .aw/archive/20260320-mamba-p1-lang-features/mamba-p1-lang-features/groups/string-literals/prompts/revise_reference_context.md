# Task: Revise Reference Context for Group 'string-literals' (Change 'mamba-p1-lang-features')

## Instructions

1. **Read artifact + review feedback**:
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-p1-lang-features/groups/string-literals/reference_context.md`
   Focus on the `# Reviews` section — list each issue to address.
2. **Read pre-clarifications** (confirm scope):
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-p1-lang-features/groups/string-literals/pre_clarifications.md`
...
cclab sdd artifact revise-reference-context mamba-p1-lang-features cclab/changes/mamba-p1-lang-features/payloads/revise-reference-context.json
```