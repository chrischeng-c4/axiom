# Task: Review Reference Context for Group 'scope-modifiers' (Change 'mamba-p1-lang-features')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-p1-lang-features/groups/scope-modifiers/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-p1-lang-features/groups/scope-modifiers/reference_context.md`
