# Task: Review Reference Context for Group 'decorator-full' (Change 'mamba-p1-lang-features')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-p1-lang-features/groups/decorator-full/reference_context.md`
