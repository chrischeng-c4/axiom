# Task: Gather Reference Context for Group 'decorator-full' (Change 'mamba-p1-lang-features')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-p1-lang-features/groups/decorator-full/pre_clarifications.md`
