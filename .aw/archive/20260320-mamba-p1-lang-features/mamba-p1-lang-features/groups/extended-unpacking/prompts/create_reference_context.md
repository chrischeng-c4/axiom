# Task: Gather Reference Context for Group 'extended-unpacking' (Change 'mamba-p1-lang-features')

Issues: #845_star-expressions-a-b-1-2-3-extended-unpacking
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-p1-lang-features/groups/extended-unpacking/pre_clarifications.md`
