# Task: Review Reference Context for Group 'extended-unpacking' (Change 'mamba-p1-lang-features')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-p1-lang-features/groups/extended-unpacking/reference_context.md`
