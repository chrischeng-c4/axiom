# Task: Restructure Input for Change 'mamba-p1-lang-features'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-p1-lang-features/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-p1-lang-features/user_input.md` — user's original description
...
cclab sdd artifact restructure-input mamba-p1-lang-features cclab/changes/mamba-p1-lang-features/payloads/restructure-input.json
```