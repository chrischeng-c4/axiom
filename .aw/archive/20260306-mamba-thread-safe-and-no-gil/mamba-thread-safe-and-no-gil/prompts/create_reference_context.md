# Task: Gather Reference Context for Group 'mamba-thread-safe-no-gil-runtime' (Change 'mamba-thread-safe-and-no-gil')
...
```
mcp__cclab-mcp__sdd_artifact_create_reference_context(project_path="/Users/chrischeng/projects/cclab", change_id="mamba-thread-safe-and-no-gil", group_id="mamba-thread-safe-no-gil-runtime", specs=[{"spec_id": "...", "spec_group": "...", "relevance": "high", "key_requirements": ["R1", "R3"]}])
```