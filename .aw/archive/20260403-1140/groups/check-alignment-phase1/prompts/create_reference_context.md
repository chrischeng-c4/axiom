# Task: Gather Reference Context for Group 'check-alignment-phase1' (Change '1140')
...
Write file: cclab/changes/1140/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context 1140 cclab/changes/1140/payloads/create-reference-context.json
```