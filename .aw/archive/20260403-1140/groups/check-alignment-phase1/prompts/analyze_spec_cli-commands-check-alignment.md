# Task: Analyze Spec 'cli-commands-check-alignment' for Change '1140'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact 1140`.
...
1. Read context from `cclab/changes/1140/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact 1140` with scope="cli-commands-check-alignment"
...
cclab sdd artifact create-change-spec 1140 <payload_path>
```
