# Task: Review Reference Context for Group 'check-alignment-phase1' (Change '1140')
...
cclab sdd artifact review-reference-context 1140 cclab/changes/1140/payloads/review-reference-context.json
```