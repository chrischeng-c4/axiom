# Task: Review Reference Context for Group 'artifact-guard' (Change 'sdd-artifact-guard')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-artifact-guard/groups/artifact-guard/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-artifact-guard/groups/artifact-guard/reference_context.md`
...
cclab sdd artifact review-reference-context sdd-artifact-guard cclab/changes/sdd-artifact-guard/payloads/review-reference-context.json
```