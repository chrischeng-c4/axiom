# Task: Analyze Spec 'change-spec-review-rules' for Change 'spec-decomposition-rules'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact spec-decomposition-rules`.
...
1. Read context from `cclab/changes/spec-decomposition-rules/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact spec-decomposition-rules` with scope="change-spec-review-rules"
...
cclab sdd artifact create-change-spec spec-decomposition-rules <payload_path>
```
