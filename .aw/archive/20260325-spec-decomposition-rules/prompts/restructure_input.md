# Task: Restructure Input for Change 'spec-decomposition-rules'
...
cclab sdd artifact restructure-input spec-decomposition-rules cclab/changes/spec-decomposition-rules/payloads/restructure-input.json
```