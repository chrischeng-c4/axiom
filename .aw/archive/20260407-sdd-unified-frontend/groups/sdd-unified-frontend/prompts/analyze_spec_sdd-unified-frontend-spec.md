# Task: Analyze Spec 'sdd-unified-frontend-spec' for Change 'sdd-unified-frontend'

A skeleton has been generated at `.score/changes/sdd-unified-frontend/groups/sdd-unified-frontend/specs/sdd-unified-frontend-spec.md`.

**group_id**: `sdd-unified-frontend` (pass this to the artifact CLI as `group_id` parameter)
...
1. Read context:
   - Read file: `.score/changes/sdd-unified-frontend/proposal.md` for spec_plan routing
   - Read file: `.score/changes/sdd-unified-frontend/reference_context.md` if no proposal
2. Read the skeleton: `.score/changes/sdd-unified-frontend/groups/sdd-unified-frontend/specs/sdd-unified-frontend-spec.md`
...
5. Write a JSON payload file to `.score/changes/sdd-unified-frontend/groups/sdd-unified-frontend/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/sdd-unified-frontend/proposal.md
...
score artifact create-change-spec sdd-unified-frontend .score/changes/sdd-unified-frontend/groups/sdd-unified-frontend/payloads/create-change-spec.json
```
