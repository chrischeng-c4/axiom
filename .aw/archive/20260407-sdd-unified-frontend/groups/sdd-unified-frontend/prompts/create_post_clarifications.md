# Task: Post-Clarification for Group 'sdd-unified-frontend' (Change 'sdd-unified-frontend')
...
1. `/Users/chris.cheng/cclab/wt/conductor/.score/changes/sdd-unified-frontend/groups/sdd-unified-frontend/requirements.md`
2. `/Users/chris.cheng/cclab/wt/conductor/.score/changes/sdd-unified-frontend/groups/sdd-unified-frontend/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/wt/conductor/.score/changes/sdd-unified-frontend/groups/sdd-unified-frontend/reference_context.md`
4. Actual specs — read high/medium relevance specs from reference_context.md

- Read high/medium relevance specs listed in reference_context.md (under `/Users/chris.cheng/cclab/wt/conductor/.score/tech_design/`)
...
score artifact create-post-clarifications sdd-unified-frontend .score/changes/sdd-unified-frontend/payloads/create-post-clarifications.json
