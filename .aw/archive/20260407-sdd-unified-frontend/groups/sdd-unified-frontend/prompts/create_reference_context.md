# Task: Gather Reference Context for Group 'sdd-unified-frontend' (Change 'sdd-unified-frontend')
...
Based on keyword analysis of requirements: [overview, schema, logic, dependency, interaction, rest-api, wireframe, component, pipeline, test-plan, changes]
...
Write file: .score/changes/sdd-unified-frontend/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context sdd-unified-frontend .score/changes/sdd-unified-frontend/payloads/create-reference-context.json
```