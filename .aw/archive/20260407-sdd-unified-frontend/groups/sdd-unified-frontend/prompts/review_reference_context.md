# Task: Review Reference Context for Group 'sdd-unified-frontend' (Change 'sdd-unified-frontend')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/wt/conductor/.score/changes/sdd-unified-frontend/groups/sdd-unified-frontend/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/wt/conductor/.score/changes/sdd-unified-frontend/groups/sdd-unified-frontend/reference_context.md`
3. **Verify each spec entry**: For each spec listed in the artifact, read the actual spec under `/Users/chris.cheng/cclab/wt/conductor/.score/tech_design/` to verify relevance and key requirements are accurate.
...
score artifact review-reference-context sdd-unified-frontend .score/changes/sdd-unified-frontend/payloads/review-reference-context.json
```