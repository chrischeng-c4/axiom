# Task: Restructure Input for Change 'sdd-unified-frontend'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/wt/conductor/.score/changes/sdd-unified-frontend/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/wt/conductor/.score/changes/sdd-unified-frontend/user_input.md` — user's original description
...
score artifact restructure-input sdd-unified-frontend .score/changes/sdd-unified-frontend/payloads/restructure-input.json
```