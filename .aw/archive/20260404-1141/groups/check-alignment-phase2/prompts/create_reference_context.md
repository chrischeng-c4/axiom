# Task: Gather Reference Context for Group 'check-alignment-phase2' (Change '1141')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chrischeng/projects/wt/sdd/cclab/changes/1141/groups/check-alignment-phase2/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, state-machine, prompt, logic, dependency, interaction, cli, design-token, test-plan, changes]
...
Write file: cclab/changes/1141/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context 1141 cclab/changes/1141/payloads/create-reference-context.json
```