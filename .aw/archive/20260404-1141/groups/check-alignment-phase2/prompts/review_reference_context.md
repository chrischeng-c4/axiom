# Task: Review Reference Context for Group 'check-alignment-phase2' (Change '1141')
...
2. **Read the reference context artifact**:
   `/Users/chrischeng/projects/wt/sdd/cclab/changes/1141/groups/check-alignment-phase2/reference_context.md`
...
cclab sdd artifact review-reference-context 1141 cclab/changes/1141/payloads/review-reference-context.json
```