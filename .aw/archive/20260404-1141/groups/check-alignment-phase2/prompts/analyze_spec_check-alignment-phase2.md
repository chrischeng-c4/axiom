# Task: Analyze Spec 'check-alignment-phase2' for Change '1141'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact 1141`.
...
1. Read context from `cclab/changes/1141/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact 1141` with scope="check-alignment-phase2"
...
cclab sdd artifact create-change-spec 1141 <payload_path>
```
