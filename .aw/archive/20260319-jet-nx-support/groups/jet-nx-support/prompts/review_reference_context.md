# Task: Review Reference Context for Group 'jet-nx-support' (Change 'jet-nx-support')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-nx-support/groups/jet-nx-support/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-nx-support/groups/jet-nx-support/reference_context.md`
...
cclab sdd artifact review-reference-context jet-nx-support cclab/changes/jet-nx-support/payloads/review-reference-context.json
```