# Task: Restructure Input for Change 'jet-nx-support'
...
cclab sdd artifact restructure-input jet-nx-support cclab/changes/jet-nx-support/payloads/restructure-input.json
```