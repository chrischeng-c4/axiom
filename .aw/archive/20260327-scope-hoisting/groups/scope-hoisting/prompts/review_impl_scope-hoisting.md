# Task: Review Implementation of Spec 'scope-hoisting' for Change 'scope-hoisting'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/scope-hoisting/groups/scope-hoisting/specs/scope-hoisting.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `cclab/changes/scope-hoisting/implementation.md`
4. List changed files via `cclab sdd workflow list-changed-files scope-hoisting`
...
Read file: cclab/changes/scope-hoisting/groups/scope-hoisting/specs/scope-hoisting.md
Read file: cclab/changes/scope-hoisting/implementation.md

# List changed files
cclab sdd workflow list-changed-files scope-hoisting

# Write review (write payload JSON first, then run)
cclab sdd artifact review-change-implementation scope-hoisting cclab/changes/scope-hoisting/payloads/review-change-implementation.json
```