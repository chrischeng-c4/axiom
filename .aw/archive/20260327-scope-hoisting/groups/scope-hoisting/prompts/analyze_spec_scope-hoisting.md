# Task: Analyze Spec 'scope-hoisting' for Change 'scope-hoisting'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact scope-hoisting`.
...
1. Read context from `cclab/changes/scope-hoisting/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact scope-hoisting` with scope="scope-hoisting"
...
cclab sdd artifact create-change-spec scope-hoisting <payload_path>
```
