# Task: Gather Reference Context for Group 'scope-hoisting' (Change 'scope-hoisting')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/scope-hoisting/groups/scope-hoisting/pre_clarifications.md`
...
Write file: cclab/changes/scope-hoisting/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context scope-hoisting cclab/changes/scope-hoisting/payloads/create-reference-context.json
```