# Task: Restructure Input for Change 'scope-hoisting'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/scope-hoisting/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/scope-hoisting/user_input.md` — user's original description
...
cclab sdd artifact restructure-input scope-hoisting cclab/changes/scope-hoisting/payloads/restructure-input.json
```