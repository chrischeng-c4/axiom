# Task: Restructure Input for Change 'lens-dissolution'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/lens-dissolution/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/lens-dissolution/user_input.md` — user's original description
...
cclab sdd artifact restructure-input lens-dissolution cclab/changes/lens-dissolution/payloads/restructure-input.json
```