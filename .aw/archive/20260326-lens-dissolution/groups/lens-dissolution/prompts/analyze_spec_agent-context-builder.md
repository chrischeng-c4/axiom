# Task: Analyze Spec 'agent-context-builder' for Change 'lens-dissolution'
...
2. Read the skeleton via `cclab sdd workflow read-artifact lens-dissolution` with scope="agent-context-builder"
