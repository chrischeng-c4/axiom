# Task: Review Reference Context for Group 'lens-dissolution' (Change 'lens-dissolution')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/lens-dissolution/groups/lens-dissolution/reference_context.md`
...
cclab sdd artifact review-reference-context lens-dissolution cclab/changes/lens-dissolution/payloads/review-reference-context.json
```