# Task: Analyze Spec 'type-inference-pipeline' for Change 'lens-dissolution'
...
2. Read the skeleton via `cclab sdd workflow read-artifact lens-dissolution` with scope="type-inference-pipeline"
