# Task: Post-Clarification for Group 'mamba-conformance-xfail' (Change 'cclab-mamba-fix-xfail')
...
1. `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/cclab-mamba-fix-xfail/groups/mamba-conformance-xfail/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/cclab-mamba-fix-xfail/groups/mamba-conformance-xfail/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/cclab-mamba-fix-xfail/groups/mamba-conformance-xfail/reference_context.md`
...
```
mcp__cclab-mcp__sdd_artifact_create_post_clarifications(project_path="/Users/chris.cheng/cclab/cclab-mamba", change_id="cclab-mamba-fix-xfail", group_id="mamba-conformance-xfail", skipped=true)
```

Or with clarifications:

```
mcp__cclab-mcp__sdd_artifact_create_post_clarifications(project_path="/Users/chris.cheng/cclab/cclab-mamba", change_id="cclab-mamba-fix-xfail", group_id="mamba-conformance-xfail", questions=[{"topic": "...", "question": "...", "answer": "...", "rationale": "..."}], contradictions=[{"spec_id": "...", "requirement": "...", "conflict": "...", "resolution": "..."}])
```