# Task: Restructure Input for Change 'cclab-mamba-fix-xfail'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/cclab-mamba-fix-xfail/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/cclab-mamba-fix-xfail/user_input.md` — user's original description
...
mcp__cclab-mcp__sdd_artifact_restructure_input(project_path="/Users/chris.cheng/cclab/cclab-mamba", change_id="cclab-mamba-fix-xfail", groups=[{"id": "...", "issues": [...], "requirements": "...", "questions": [{"topic": "...", "question": "..."}]}])