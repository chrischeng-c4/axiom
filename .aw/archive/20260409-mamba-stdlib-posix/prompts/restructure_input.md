# Task: Restructure Input for Change 'mamba-stdlib-posix'
...
score artifact restructure-input mamba-stdlib-posix .score/changes/mamba-stdlib-posix/payloads/restructure-input.json
```