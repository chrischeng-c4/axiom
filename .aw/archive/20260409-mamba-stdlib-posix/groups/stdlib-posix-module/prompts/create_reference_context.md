# Task: Gather Reference Context for Group 'stdlib-posix-module' (Change 'mamba-stdlib-posix')
...
Write file: .score/changes/mamba-stdlib-posix/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context mamba-stdlib-posix .score/changes/mamba-stdlib-posix/payloads/create-reference-context.json
```