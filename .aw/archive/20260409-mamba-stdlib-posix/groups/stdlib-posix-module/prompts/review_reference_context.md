# Task: Review Reference Context for Group 'stdlib-posix-module' (Change 'mamba-stdlib-posix')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/main/.score/changes/mamba-stdlib-posix/groups/stdlib-posix-module/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/main/.score/changes/mamba-stdlib-posix/groups/stdlib-posix-module/reference_context.md`
...
score artifact review-reference-context mamba-stdlib-posix .score/changes/mamba-stdlib-posix/payloads/review-reference-context.json
```