# Task: Write Implementation Diff for Change 'agent-crr-review'
...
cclab sdd artifact create-change-implementation agent-crr-review cclab/changes/agent-crr-review/payloads/create-change-implementation.json
```