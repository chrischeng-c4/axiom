# Task: Post-Clarification for Group 'agent-crr-core' (Change 'agent-crr-review')
...
1. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-crr-review/groups/agent-crr-core/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-crr-review/groups/agent-crr-core/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-crr-review/groups/agent-crr-core/reference_context.md`
...
cclab sdd artifact create-post-clarifications agent-crr-review cclab/changes/agent-crr-review/payloads/create-post-clarifications.json
