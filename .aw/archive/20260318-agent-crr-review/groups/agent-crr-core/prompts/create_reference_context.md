# Task: Gather Reference Context for Group 'agent-crr-core' (Change 'agent-crr-review')
...
cclab sdd artifact create-reference-context agent-crr-review cclab/changes/agent-crr-review/payloads/create-reference-context.json
```