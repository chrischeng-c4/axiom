# Task: Restructure Input for Change 'agent-crr-review'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-crr-review/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-crr-review/user_input.md` — user's original description
...
cclab sdd artifact restructure-input agent-crr-review cclab/changes/agent-crr-review/payloads/restructure-input.json
```