# Task: Review Implementation of Spec 'mamba-conformance-p1-spec' for Change 'mamba-conformance-p1'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/mamba-conformance-p1/groups/mamba-p1-oop/specs/mamba-conformance-p1-spec.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `cclab/changes/mamba-conformance-p1/implementation.md`
4. List changed files via `cclab sdd workflow list-changed-files mamba-conformance-p1`
...
Read file: cclab/changes/mamba-conformance-p1/groups/mamba-p1-oop/specs/mamba-conformance-p1-spec.md
Read file: cclab/changes/mamba-conformance-p1/implementation.md

# List changed files
cclab sdd workflow list-changed-files mamba-conformance-p1

# Write review (write payload JSON first, then run)
cclab sdd artifact review-change-implementation mamba-conformance-p1 cclab/changes/mamba-conformance-p1/payloads/review-change-implementation.json
```