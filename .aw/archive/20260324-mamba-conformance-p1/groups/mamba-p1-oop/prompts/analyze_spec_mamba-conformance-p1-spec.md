# Task: Analyze Spec 'mamba-conformance-p1-spec' for Change 'mamba-conformance-p1'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-conformance-p1`.
...
1. Read context from `cclab/changes/mamba-conformance-p1/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-conformance-p1` with scope="mamba-conformance-p1-spec"
...
cclab sdd artifact create-change-spec mamba-conformance-p1 <payload_path>
```
