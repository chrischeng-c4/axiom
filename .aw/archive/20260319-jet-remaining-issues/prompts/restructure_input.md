# Task: Restructure Input for Change 'jet-remaining-issues'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-remaining-issues/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-remaining-issues/user_input.md` — user's original description
...
cclab sdd artifact restructure-input jet-remaining-issues cclab/changes/jet-remaining-issues/payloads/restructure-input.json
```