# Task: Write Implementation Diff for Change 'mamba-refcount'
...
score artifact create-change-implementation mamba-refcount .score/changes/mamba-refcount/payloads/create-change-implementation.json
```