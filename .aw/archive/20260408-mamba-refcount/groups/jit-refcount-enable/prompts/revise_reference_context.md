# Task: Revise Reference Context for Group 'jit-refcount-enable' (Change 'mamba-refcount')

## Instructions

1. **Read artifact + review feedback**:
   `/Users/chris.cheng/cclab/main/.score/changes/mamba-refcount/groups/jit-refcount-enable/reference_context.md`
...
score artifact revise-reference-context mamba-refcount .score/changes/mamba-refcount/payloads/revise-reference-context.json
```