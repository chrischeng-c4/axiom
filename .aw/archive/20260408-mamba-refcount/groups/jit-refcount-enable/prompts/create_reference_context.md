# Task: Gather Reference Context for Group 'jit-refcount-enable' (Change 'mamba-refcount')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/main/.score/changes/mamba-refcount/groups/jit-refcount-enable/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, db-model, state-machine, cli, test-plan, changes]
...
Write file: .score/changes/mamba-refcount/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context mamba-refcount .score/changes/mamba-refcount/payloads/create-reference-context.json
```