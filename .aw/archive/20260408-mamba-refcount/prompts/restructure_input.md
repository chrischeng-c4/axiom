# Task: Restructure Input for Change 'mamba-refcount'
...
score artifact restructure-input mamba-refcount .score/changes/mamba-refcount/payloads/restructure-input.json
```