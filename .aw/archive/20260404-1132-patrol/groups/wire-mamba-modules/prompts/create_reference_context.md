# Task: Gather Reference Context for Group 'wire-mamba-modules' (Change '1132-patrol')
...
Write file: cclab/changes/1132-patrol/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context 1132-patrol cclab/changes/1132-patrol/payloads/create-reference-context.json
```