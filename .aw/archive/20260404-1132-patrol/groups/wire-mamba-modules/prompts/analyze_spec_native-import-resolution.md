# Task: Analyze Spec 'native-import-resolution' for Change '1132-patrol'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact 1132-patrol`.
...
1. Read context from `cclab/changes/1132-patrol/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact 1132-patrol` with scope="native-import-resolution"
...
cclab sdd artifact create-change-spec 1132-patrol <payload_path>
```
