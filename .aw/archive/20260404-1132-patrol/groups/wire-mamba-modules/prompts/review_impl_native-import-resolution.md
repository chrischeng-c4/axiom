# Task: Review Implementation of Spec 'native-import-resolution' for Change '1132-patrol'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/1132-patrol/groups/wire-mamba-modules/specs/native-import-resolution.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `cclab/changes/1132-patrol/implementation.md`
4. List changed files via `cclab sdd workflow list-changed-files 1132-patrol`
...
Read file: cclab/changes/1132-patrol/groups/wire-mamba-modules/specs/native-import-resolution.md
Read file: cclab/changes/1132-patrol/implementation.md

# List changed files
cclab sdd workflow list-changed-files 1132-patrol

# Write review (write payload JSON first, then run)
cclab sdd artifact review-change-implementation 1132-patrol cclab/changes/1132-patrol/payloads/review-change-implementation.json
```