# Task: Review Reference Context for Group 'default' (Change 'score-init-bootstrap')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/main/.score/changes/score-init-bootstrap/groups/default/reference_context.md`
...
score artifact review-reference-context score-init-bootstrap .score/changes/score-init-bootstrap/payloads/review-reference-context.json
```