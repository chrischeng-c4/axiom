# Task: Gather Reference Context for Group 'default' (Change 'score-init-bootstrap')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/main/.score/changes/score-init-bootstrap/groups/default/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, cli, config, changes]
...
Write file: .score/changes/score-init-bootstrap/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context score-init-bootstrap .score/changes/score-init-bootstrap/payloads/create-reference-context.json
```