# Task: Revise Reference Context for Group 'default' (Change 'score-init-bootstrap')
...
score artifact revise-reference-context score-init-bootstrap .score/changes/score-init-bootstrap/payloads/revise-reference-context.json
```