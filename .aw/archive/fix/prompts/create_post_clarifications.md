# Task: Post-Clarification for Group 'jet-bundler-fixes' (Change 'fix')
...
1. `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/fix/groups/jet-bundler-fixes/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/fix/groups/jet-bundler-fixes/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/fix/groups/jet-bundler-fixes/reference_context.md`
...
```
mcp__cclab-mcp__sdd_artifact_create_post_clarifications(project_path="/Users/chris.cheng/cclab/cclab-jet", change_id="fix", group_id="jet-bundler-fixes", skipped=true)
```

Or with clarifications:

```
mcp__cclab-mcp__sdd_artifact_create_post_clarifications(project_path="/Users/chris.cheng/cclab/cclab-jet", change_id="fix", group_id="jet-bundler-fixes", questions=[{"topic": "...", "question": "...", "answer": "...", "rationale": "..."}], contradictions=[{"spec_id": "...", "requirement": "...", "conflict": "...", "resolution": "..."}])
```