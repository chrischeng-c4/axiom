...
main_spec_ref: crates/sdd/logic/codegen-structural.md
merge_strategy: new
...
```yaml
changes:
  - path: crates/sdd/src/generate/gen/rust/schema.rs
    action: create
    description: |
  ...
  - path: crates/sdd/src/generate/gen/rust/db_model.rs
    action: create
    description: |
  ...
  - path: crates/sdd/src/generate/gen/rust/config.rs
    action: create
    description: |
  ...
  - path: crates/sdd/src/generate/gen/mod.rs
    action: create
    description: |
  ...
  - path: crates/sdd/src/generate/config_loader.rs
    action: create
    description: |
      Loads codegen config from .score/config.toml [codegen.rust.defaults].
      pub struct RustConfig { derives: Vec<String>, serde_rename_strategy: String, visibility: String }
      pub fn load_rust_config(project_root: &Path) -> RustConfig
      Supports per-spec overrides via x-rust: YAML key in frontmatter.
  - path: crates/sdd/src/generate/mod.rs
    action: modify
    description: Add pub mod gen; pub mod config_loader; to existing module.
```
## Wireframe
