# Task: Review Reference Context for Group 'codegen-td-to-code-main' (Change 'codegen-td-to-code')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/main/.score/worktrees/codegen-td-to-code/.score/changes/codegen-td-to-code/groups/codegen-td-to-code-main/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/main/.score/worktrees/codegen-td-to-code/.score/changes/codegen-td-to-code/groups/codegen-td-to-code-main/reference_context.md`
3. **Verify each spec entry**: For each spec listed in the artifact, read the actual spec under `/Users/chris.cheng/cclab/main/.score/worktrees/codegen-td-to-code/.score/tech_design/` to verify relevance and key requirements are accurate.
...
score artifact review-reference-context codegen-td-to-code .score/changes/codegen-td-to-code/payloads/review-reference-context.json
```