# Task: Analyze Spec 'mamba-conformance-p2-spec' for Change 'mamba-conformance-p2'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-conformance-p2`.
...
1. Read context from `cclab/changes/mamba-conformance-p2/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-conformance-p2` with scope="mamba-conformance-p2-spec"
...
cclab sdd artifact create-change-spec mamba-conformance-p2 <payload_path>
```
