...
updated_at: 2026-02-02T14:23:29.642637+00:00
requirements:
  total: 4
  ids:
    - R1
...
Defines how cclab-aurora generates framework-specific test suites and integrates with cclab-probe to execute and validate generated services for FastAPI, Express, and Axum outputs.
...
sequenceDiagram
    ...
    participant testgen as Aurora Test Generator
