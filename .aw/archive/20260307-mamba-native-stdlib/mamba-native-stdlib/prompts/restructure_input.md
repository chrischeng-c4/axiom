# Task: Restructure Input for Change 'mamba-native-stdlib'

## Step 1: Read Input

Read:
- `/Users/chrischeng/projects/cclab/cclab/changes/mamba-native-stdlib/user_input.md` — user's description
...
mcp__cclab-mcp__sdd_artifact_restructure_input(project_path="/Users/chrischeng/projects/cclab", change_id="mamba-native-stdlib", groups=[{"id": "...", "issues": [...], "requirements": "...", "questions": [{"topic": "...", "question": "..."}]}])