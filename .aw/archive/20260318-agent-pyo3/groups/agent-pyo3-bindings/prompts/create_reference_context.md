# Task: Gather Reference Context for Group 'agent-pyo3-bindings' (Change 'agent-pyo3')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-pyo3/groups/agent-pyo3-bindings/pre_clarifications.md`
...
cclab sdd artifact create-reference-context agent-pyo3 cclab/changes/agent-pyo3/payloads/create-reference-context.json
```