# Task: Write Implementation Diff for Change 'agent-pyo3'
...
cclab sdd artifact create-change-implementation agent-pyo3 cclab/changes/agent-pyo3/payloads/create-change-implementation.json
```