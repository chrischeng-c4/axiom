# Task: Review Reference Context for Group 'agent-pyo3-bindings' (Change 'agent-pyo3')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-pyo3/groups/agent-pyo3-bindings/reference_context.md`
...
cclab sdd artifact review-reference-context agent-pyo3 cclab/changes/agent-pyo3/payloads/review-reference-context.json
```