# Task: Restructure Input for Change 'agent-pyo3'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-pyo3/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/agent-pyo3/user_input.md` — user's original description
...
cclab sdd artifact restructure-input agent-pyo3 cclab/changes/agent-pyo3/payloads/restructure-input.json
```