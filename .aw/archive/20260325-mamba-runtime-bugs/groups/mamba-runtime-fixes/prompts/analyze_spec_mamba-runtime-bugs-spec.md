# Task: Analyze Spec 'mamba-runtime-bugs-spec' for Change 'mamba-runtime-bugs'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-runtime-bugs`.
...
1. Read context from `cclab/changes/mamba-runtime-bugs/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-runtime-bugs` with scope="mamba-runtime-bugs-spec"
...
cclab sdd artifact create-change-spec mamba-runtime-bugs <payload_path>
```
