# Task: Write Implementation Diff for Change 'mamba-runtime-bugs'
...
cclab sdd artifact create-change-implementation mamba-runtime-bugs cclab/changes/mamba-runtime-bugs/payloads/create-change-implementation.json
```