# Task: Review Implementation of Spec 'mamba-runtime-bugs-spec' for Change 'mamba-runtime-bugs'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/mamba-runtime-bugs/groups/mamba-runtime-fixes/specs/mamba-runtime-bugs-spec.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `cclab/changes/mamba-runtime-bugs/implementation.md`
4. List changed files via `cclab sdd workflow list-changed-files mamba-runtime-bugs`
...
Read file: cclab/changes/mamba-runtime-bugs/groups/mamba-runtime-fixes/specs/mamba-runtime-bugs-spec.md
Read file: cclab/changes/mamba-runtime-bugs/implementation.md

# List changed files
cclab sdd workflow list-changed-files mamba-runtime-bugs

# Write review (write payload JSON first, then run)
cclab sdd artifact review-change-implementation mamba-runtime-bugs cclab/changes/mamba-runtime-bugs/payloads/review-change-implementation.json
```