# Task: Revise Reference Context for Group 'issue-centric-workflow' (Change 'sdd-issue-centric')

## Instructions

1. **Read artifact + review feedback**:
   `/Users/chris.cheng/cclab/main/.score/changes/sdd-issue-centric/groups/issue-centric-workflow/reference_context.md`
   Focus on the `# Reviews` section — list each issue to address.
2. **Read pre-clarifications** (confirm scope):
   `/Users/chris.cheng/cclab/main/.score/changes/sdd-issue-centric/groups/issue-centric-workflow/pre_clarifications.md`
...
score artifact revise-reference-context sdd-issue-centric .score/changes/sdd-issue-centric/payloads/revise-reference-context.json
```