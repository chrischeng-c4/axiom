# Task: Gather Reference Context for Group 'issue-centric-workflow' (Change 'sdd-issue-centric')
...
Write file: .score/changes/sdd-issue-centric/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context sdd-issue-centric .score/changes/sdd-issue-centric/payloads/create-reference-context.json
```