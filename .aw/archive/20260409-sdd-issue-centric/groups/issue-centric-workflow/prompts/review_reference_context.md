# Task: Review Reference Context for Group 'issue-centric-workflow' (Change 'sdd-issue-centric')
...
score artifact review-reference-context sdd-issue-centric .score/changes/sdd-issue-centric/payloads/review-reference-context.json
```