# Task: Post-Clarification for Group 'phase-advance-and-timeout' (Change 'sdd-phase-advance-timeout')
...
1. `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-phase-advance-timeout/groups/phase-advance-and-timeout/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-phase-advance-timeout/groups/phase-advance-and-timeout/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-phase-advance-timeout/groups/phase-advance-and-timeout/reference_context.md`
...
cclab sdd artifact create-post-clarifications sdd-phase-advance-timeout cclab/changes/sdd-phase-advance-timeout/payloads/create-post-clarifications.json
