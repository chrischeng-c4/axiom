# Task: Restructure Input for Change 'sdd-phase-advance-timeout'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-phase-advance-timeout/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-phase-advance-timeout/user_input.md` — user's original description
...
cclab sdd artifact restructure-input sdd-phase-advance-timeout cclab/changes/sdd-phase-advance-timeout/payloads/restructure-input.json
```