# Task: Restructure Input for Change 'lens-full-upgrade'

## Step 1: Read Input

Read:
- `/Users/chris.cheng/cclab/cclab-lens/cclab/changes/lens-full-upgrade/user_input.md` — user's description
...
mcp__cclab-mcp__sdd_artifact_restructure_input(project_path="/Users/chris.cheng/cclab/cclab-lens", change_id="lens-full-upgrade", groups=[{"id": "...", "issues": [...], "requirements": "...", "questions": [{"topic": "...", "question": "..."}]}])