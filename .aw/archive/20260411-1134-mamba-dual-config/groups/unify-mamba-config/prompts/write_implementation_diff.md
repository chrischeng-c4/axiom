# Task: Write Implementation Diff for Change '1134-mamba-dual-config'
...
score artifact create-change-implementation 1134-mamba-dual-config .score/changes/1134-mamba-dual-config/payloads/create-change-implementation.json
```