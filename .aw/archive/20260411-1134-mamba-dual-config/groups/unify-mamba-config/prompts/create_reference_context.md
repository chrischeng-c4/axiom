# Task: Gather Reference Context for Group 'unify-mamba-config' (Change '1134-mamba-dual-config')
...
Write file: .score/changes/1134-mamba-dual-config/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context 1134-mamba-dual-config .score/changes/1134-mamba-dual-config/payloads/create-reference-context.json
```