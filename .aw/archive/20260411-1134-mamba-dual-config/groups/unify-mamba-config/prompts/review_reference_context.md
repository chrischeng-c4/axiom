# Task: Review Reference Context for Group 'unify-mamba-config' (Change '1134-mamba-dual-config')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/main/.score/changes/1134-mamba-dual-config/groups/unify-mamba-config/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/main/.score/changes/1134-mamba-dual-config/groups/unify-mamba-config/reference_context.md`
...
score artifact review-reference-context 1134-mamba-dual-config .score/changes/1134-mamba-dual-config/payloads/review-reference-context.json
```