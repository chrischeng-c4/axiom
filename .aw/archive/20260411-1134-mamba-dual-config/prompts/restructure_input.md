# Task: Restructure Input for Change '1134-mamba-dual-config'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/main/.score/changes/1134-mamba-dual-config/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/main/.score/changes/1134-mamba-dual-config/user_input.md` — user's original description
...
score artifact restructure-input 1134-mamba-dual-config .score/changes/1134-mamba-dual-config/payloads/restructure-input.json
```