# Task: Restructure Input for Change 'mangle-module-scope'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/mangle-module-scope/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/mangle-module-scope/user_input.md` — user's original description
...
cclab sdd artifact restructure-input mangle-module-scope cclab/changes/mangle-module-scope/payloads/restructure-input.json
```