# Task: Review Reference Context for Group 'mangle-module-scope' (Change 'mangle-module-scope')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/mangle-module-scope/groups/mangle-module-scope/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/mangle-module-scope/groups/mangle-module-scope/reference_context.md`
...
cclab sdd artifact review-reference-context mangle-module-scope cclab/changes/mangle-module-scope/payloads/review-reference-context.json
```