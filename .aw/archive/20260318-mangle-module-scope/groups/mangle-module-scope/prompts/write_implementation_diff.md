# Task: Write Implementation Diff for Change 'mangle-module-scope'
...
cclab sdd artifact create-change-implementation mangle-module-scope cclab/changes/mangle-module-scope/payloads/create-change-implementation.json
```