# Task: Review Reference Context for Group 'unify-mamba-config' (Change 'mamba-config-unify')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/main/.score/changes/mamba-config-unify/groups/unify-mamba-config/reference_context.md`
...
score artifact review-reference-context mamba-config-unify .score/changes/mamba-config-unify/payloads/review-reference-context.json
```