# Task: Analyze Spec 'mamba-config-unify-spec' for Change 'mamba-config-unify'

A skeleton has been generated at `.score/changes/mamba-config-unify/groups/unify-mamba-config/specs/mamba-config-unify-spec.md`.
...
1. Read context:
   - Read file: `.score/changes/mamba-config-unify/proposal.md` for spec_plan routing
   - Read file: `.score/changes/mamba-config-unify/reference_context.md` if no proposal
2. Read the skeleton: `.score/changes/mamba-config-unify/groups/unify-mamba-config/specs/mamba-config-unify-spec.md`
...
5. Write a JSON payload file to `.score/changes/mamba-config-unify/groups/unify-mamba-config/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/mamba-config-unify/proposal.md
