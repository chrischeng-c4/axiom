# Task: Write Implementation Diff for Change 'mamba-config-unify'
...
score artifact create-change-implementation mamba-config-unify .score/changes/mamba-config-unify/payloads/create-change-implementation.json
```