# Task: Restructure Input for Change 'mamba-config-unify'
...
score artifact restructure-input mamba-config-unify .score/changes/mamba-config-unify/payloads/restructure-input.json
```