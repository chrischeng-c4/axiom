# Task: Restructure Input for Change 'mamba-xfail-zero'

## Step 1: Read Input

Read:
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-xfail-zero/user_input.md` — user's description
...
cclab sdd artifact restructure-input mamba-xfail-zero cclab/changes/mamba-xfail-zero/payloads/restructure-input.json
```