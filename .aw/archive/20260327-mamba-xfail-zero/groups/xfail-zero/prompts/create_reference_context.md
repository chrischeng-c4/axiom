# Task: Gather Reference Context for Group 'xfail-zero' (Change 'mamba-xfail-zero')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-xfail-zero/groups/xfail-zero/pre_clarifications.md`
...
Write file: cclab/changes/mamba-xfail-zero/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context mamba-xfail-zero cclab/changes/mamba-xfail-zero/payloads/create-reference-context.json
```