# Task: Post-Clarification for Group 'xfail-zero' (Change 'mamba-xfail-zero')

## Context Sources

Read these files before analysis:
1. `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-xfail-zero/groups/xfail-zero/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-xfail-zero/groups/xfail-zero/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-xfail-zero/groups/xfail-zero/reference_context.md`
...
cclab sdd artifact create-post-clarifications mamba-xfail-zero cclab/changes/mamba-xfail-zero/payloads/create-post-clarifications.json
