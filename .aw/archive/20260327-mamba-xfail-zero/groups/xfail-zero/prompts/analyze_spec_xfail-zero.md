# Task: Analyze Spec 'xfail-zero' for Change 'mamba-xfail-zero'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-xfail-zero`.
...
1. Read context from `cclab/changes/mamba-xfail-zero/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-xfail-zero` with scope="xfail-zero"
...
cclab sdd artifact create-change-spec mamba-xfail-zero <payload_path>
```
