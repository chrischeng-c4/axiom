# Task: Analyze Spec 'schedule-monitor' for Change 'scheduler-runtime-complete'
...
2. Read the skeleton via `cclab sdd workflow read-artifact scheduler-runtime-complete` with scope="schedule-monitor"
