# Task: Analyze Spec 'push-receiver' for Change 'scheduler-runtime-complete'
...
2. Read the skeleton via `cclab sdd workflow read-artifact scheduler-runtime-complete` with scope="push-receiver"
