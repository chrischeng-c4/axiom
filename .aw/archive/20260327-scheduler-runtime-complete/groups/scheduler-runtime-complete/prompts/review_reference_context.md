# Task: Review Reference Context for Group 'scheduler-runtime-complete' (Change 'scheduler-runtime-complete')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-queue/cclab/changes/scheduler-runtime-complete/groups/scheduler-runtime-complete/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-queue/cclab/changes/scheduler-runtime-complete/groups/scheduler-runtime-complete/reference_context.md`
3. **Verify each spec entry**: For each spec listed in the artifact, read the actual spec under `/Users/chris.cheng/cclab/cclab-queue/cclab/specs/` to verify relevance and key requirements are accurate.
...
cclab sdd artifact review-reference-context scheduler-runtime-complete cclab/changes/scheduler-runtime-complete/payloads/review-reference-context.json
```