# Task: Analyze Spec 'scheduler-mode-selection' for Change 'scheduler-runtime-complete'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact scheduler-runtime-complete`.
...
1. Read context from `cclab/changes/scheduler-runtime-complete/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact scheduler-runtime-complete` with scope="scheduler-mode-selection"
...
cclab sdd artifact create-change-spec scheduler-runtime-complete <payload_path>
```
