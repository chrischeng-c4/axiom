# Task: Analyze Spec 'k8s-cronjob-backend' for Change 'scheduler-runtime-complete'
...
2. Read the skeleton via `cclab sdd workflow read-artifact scheduler-runtime-complete` with scope="k8s-cronjob-backend"
