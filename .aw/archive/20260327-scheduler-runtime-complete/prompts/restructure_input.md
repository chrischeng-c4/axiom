# Task: Restructure Input for Change 'scheduler-runtime-complete'
...
cclab sdd artifact restructure-input scheduler-runtime-complete cclab/changes/scheduler-runtime-complete/payloads/restructure-input.json
```