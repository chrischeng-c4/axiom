# Task: Review Reference Context for Group 'code-agent-core' (Change 'change-impl-agent')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/change-impl-agent/groups/code-agent-core/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/change-impl-agent/groups/code-agent-core/reference_context.md`
...
cclab sdd artifact review-reference-context change-impl-agent cclab/changes/change-impl-agent/payloads/review-reference-context.json
```