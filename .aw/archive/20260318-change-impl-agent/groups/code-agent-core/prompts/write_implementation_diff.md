# Task: Write Implementation Diff for Change 'change-impl-agent'
...
cclab sdd artifact create-change-implementation change-impl-agent cclab/changes/change-impl-agent/payloads/create-change-implementation.json
```