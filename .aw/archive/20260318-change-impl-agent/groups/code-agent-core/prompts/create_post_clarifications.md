# Task: Post-Clarification for Group 'code-agent-core' (Change 'change-impl-agent')
...
1. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/change-impl-agent/groups/code-agent-core/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/change-impl-agent/groups/code-agent-core/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/change-impl-agent/groups/code-agent-core/reference_context.md`
...
cclab sdd artifact create-post-clarifications change-impl-agent cclab/changes/change-impl-agent/payloads/create-post-clarifications.json
