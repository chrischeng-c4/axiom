# Task: Gather Reference Context for Group 'code-agent-core' (Change 'change-impl-agent')
...
cclab sdd artifact create-reference-context change-impl-agent cclab/changes/change-impl-agent/payloads/create-reference-context.json
```