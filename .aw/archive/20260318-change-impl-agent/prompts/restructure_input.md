# Task: Restructure Input for Change 'change-impl-agent'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/change-impl-agent/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/change-impl-agent/user_input.md` — user's original description
...
cclab sdd artifact restructure-input change-impl-agent cclab/changes/change-impl-agent/payloads/restructure-input.json
```