# Task: Write Implementation Diff for Change 'mamba-all-p1'
...
cclab sdd artifact create-change-implementation mamba-all-p1 cclab/changes/mamba-all-p1/payloads/create-change-implementation.json
```