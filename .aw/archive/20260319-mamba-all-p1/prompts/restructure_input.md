# Task: Restructure Input for Change 'mamba-all-p1'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-all-p1/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-all-p1/user_input.md` — user's original description
...
cclab sdd artifact restructure-input mamba-all-p1 cclab/changes/mamba-all-p1/payloads/restructure-input.json
```