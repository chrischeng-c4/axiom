# Task: Post-Clarification for Group 'exception-handling' (Change 'mamba-all-p1')

Issues: #834_exception-chaining-cause-context-suppress-context, #755_py3-12-conformance-exception-hierarchy

## Context Sources

Read these files before analysis:
1. `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-all-p1/groups/exception-handling/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-all-p1/groups/exception-handling/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-all-p1/groups/exception-handling/reference_context.md`
