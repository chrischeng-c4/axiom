# Task: Gather Reference Context for Group 'stdlib-introspection' (Change 'mamba-all-p1')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-all-p1/groups/stdlib-introspection/pre_clarifications.md`
