# Task: Post-Clarification for Group 'stdlib-introspection' (Change 'mamba-all-p1')

Issues: #667_add-native-stdlib-dis-bytecode-disassembler, #668_add-native-stdlib-ast-abstract-syntax-tree, #669_add-native-stdlib-tokenize-tokenizer-for-python-so

## Context Sources

Read these files before analysis:
1. `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-all-p1/groups/stdlib-introspection/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-all-p1/groups/stdlib-introspection/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-all-p1/groups/stdlib-introspection/reference_context.md`
