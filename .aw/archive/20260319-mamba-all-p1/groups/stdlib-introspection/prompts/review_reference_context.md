# Task: Review Reference Context for Group 'stdlib-introspection' (Change 'mamba-all-p1')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/mamba-all-p1/groups/stdlib-introspection/reference_context.md`
