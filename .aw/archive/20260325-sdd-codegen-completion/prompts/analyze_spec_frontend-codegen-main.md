# Task: Analyze Spec 'frontend-codegen-main' for Change 'sdd-codegen-completion'

A skeleton has been generated at `specs/frontend-codegen-main.md`.
...
1. Read context from `cclab/changes/sdd-codegen-completion/proposal.md` or `reference_context.md`
2. Read the skeleton: `cclab/changes/sdd-codegen-completion/specs/frontend-codegen-main.md`
...
cclab sdd artifact create-change-spec sdd-codegen-completion cclab/changes/sdd-codegen-completion/payloads/create-change-spec.json
```
