# Task: Restructure Input for Change 'sdd-codegen-completion'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-completion/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-completion/user_input.md` — user's original description
...
cclab sdd artifact restructure-input sdd-codegen-completion cclab/changes/sdd-codegen-completion/payloads/restructure-input.json
```