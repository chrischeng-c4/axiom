# Task: Revise Reference Context for Group 'frontend-codegen' (Change 'sdd-codegen-completion')

## Instructions

1. **Read artifact + review feedback**:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-completion/groups/frontend-codegen/reference_context.md`
   Focus on the `# Reviews` section — list each issue to address.
2. **Read pre-clarifications** (confirm scope):
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-completion/groups/frontend-codegen/pre_clarifications.md`
...
cclab sdd artifact revise-reference-context sdd-codegen-completion cclab/changes/sdd-codegen-completion/payloads/revise-reference-context.json
```