# Task: Review Reference Context for Group 'deploy-section-type' (Change 'sdd-codegen-completion')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-completion/groups/deploy-section-type/reference_context.md`
...
cclab sdd artifact review-reference-context sdd-codegen-completion cclab/changes/sdd-codegen-completion/payloads/review-reference-context.json
```