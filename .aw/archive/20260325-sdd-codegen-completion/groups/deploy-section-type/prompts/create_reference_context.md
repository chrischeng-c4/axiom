# Task: Gather Reference Context for Group 'deploy-section-type' (Change 'sdd-codegen-completion')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-completion/groups/deploy-section-type/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, db-model, schema, logic, dependency, interaction, rest-api, config, test-plan, changes]
...
Write file: cclab/changes/sdd-codegen-completion/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context sdd-codegen-completion cclab/changes/sdd-codegen-completion/payloads/create-reference-context.json
```