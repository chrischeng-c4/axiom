# Task: Write Implementation Diff for Change 'sdd-merge-gaps-fix'
...
score artifact create-change-implementation sdd-merge-gaps-fix .score/changes/sdd-merge-gaps-fix/payloads/create-change-implementation.json
```