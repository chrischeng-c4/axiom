# Task: Gather Reference Context for Group 'scope-summary' (Change 'post-clarifications-scope-summary')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/post-clarifications-scope-summary/groups/scope-summary/pre_clarifications.md`
...
Write file: cclab/changes/post-clarifications-scope-summary/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context post-clarifications-scope-summary cclab/changes/post-clarifications-scope-summary/payloads/create-reference-context.json
```