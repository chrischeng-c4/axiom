# Task: Restructure Input for Change 'post-clarifications-scope-summary'
...
cclab sdd artifact restructure-input post-clarifications-scope-summary cclab/changes/post-clarifications-scope-summary/payloads/restructure-input.json
```