# Task: Restructure Input for Change 'mamba-conformance-basics'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chrischeng/projects/cclab-sdd/cclab/changes/mamba-conformance-basics/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chrischeng/projects/cclab-sdd/cclab/changes/mamba-conformance-basics/user_input.md` — user's original description
...
cclab sdd artifact restructure-input mamba-conformance-basics cclab/changes/mamba-conformance-basics/payloads/restructure-input.json
```