# Task: Analyze Spec 'repl' for Change 'mamba-conformance-basics'
...
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-conformance-basics` with scope="repl"
