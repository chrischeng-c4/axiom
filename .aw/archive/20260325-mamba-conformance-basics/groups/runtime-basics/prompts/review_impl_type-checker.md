# Task: Review Implementation of Spec 'type-checker' for Change 'mamba-conformance-basics'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/mamba-conformance-basics/groups/runtime-basics/specs/type-checker.md`
