# Task: Implement Tests for Spec 'cranelift-jit' (Change 'mamba-conformance-basics')

## Instructions

Production code for spec 'cranelift-jit' has been implemented and verified to compile.
Now implement **test functions only** (`#[test]` functions / `#[cfg(test)]` blocks).

1. Read spec **cranelift-jit**: `cclab/changes/mamba-conformance-basics/groups/runtime-basics/specs/cranelift-jit.md`
...
```
# Read spec
Read file: cclab/changes/mamba-conformance-basics/groups/runtime-basics/specs/cranelift-jit.md
