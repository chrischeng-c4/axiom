# Task: Review Implementation of Spec 'cranelift' for Change 'mamba-conformance-basics'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/mamba-conformance-basics/groups/runtime-basics/specs/cranelift.md`
