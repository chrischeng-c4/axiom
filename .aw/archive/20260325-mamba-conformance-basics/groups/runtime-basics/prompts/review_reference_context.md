# Task: Review Reference Context for Group 'runtime-basics' (Change 'mamba-conformance-basics')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/mamba-conformance-basics/groups/runtime-basics/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/mamba-conformance-basics/groups/runtime-basics/reference_context.md`
...
cclab sdd artifact review-reference-context mamba-conformance-basics cclab/changes/mamba-conformance-basics/payloads/review-reference-context.json
```