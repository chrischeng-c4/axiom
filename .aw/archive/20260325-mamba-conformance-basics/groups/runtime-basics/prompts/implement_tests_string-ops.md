# Task: Implement Tests for Spec 'string-ops' (Change 'mamba-conformance-basics')

## Instructions

Production code for spec 'string-ops' has been implemented and verified to compile.
Now implement **test functions only** (`#[test]` functions / `#[cfg(test)]` blocks).

1. Read spec **string-ops**: `cclab/changes/mamba-conformance-basics/groups/runtime-basics/specs/string-ops.md`
