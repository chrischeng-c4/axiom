# Task: Analyze Spec 'type-checker' for Change 'mamba-conformance-basics'
...
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-conformance-basics` with scope="type-checker"
