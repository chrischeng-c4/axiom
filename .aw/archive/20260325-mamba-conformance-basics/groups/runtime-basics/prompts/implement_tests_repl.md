# Task: Implement Tests for Spec 'repl' (Change 'mamba-conformance-basics')

## Instructions

Production code for spec 'repl' has been implemented and verified to compile.
Now implement **test functions only** (`#[test]` functions / `#[cfg(test)]` blocks).

1. Read spec **repl**: `cclab/changes/mamba-conformance-basics/groups/runtime-basics/specs/repl.md`
