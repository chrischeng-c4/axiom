# Task: Review Implementation of Spec 'string-ops' for Change 'mamba-conformance-basics'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/mamba-conformance-basics/groups/runtime-basics/specs/string-ops.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `cclab/changes/mamba-conformance-basics/implementation.md`
4. List changed files via `cclab sdd workflow list-changed-files mamba-conformance-basics`
...
Read file: cclab/changes/mamba-conformance-basics/groups/runtime-basics/specs/string-ops.md
Read file: cclab/changes/mamba-conformance-basics/implementation.md

# List changed files
cclab sdd workflow list-changed-files mamba-conformance-basics

# Write review (write payload JSON first, then run)
cclab sdd artifact review-change-implementation mamba-conformance-basics cclab/changes/mamba-conformance-basics/payloads/review-change-implementation.json
```