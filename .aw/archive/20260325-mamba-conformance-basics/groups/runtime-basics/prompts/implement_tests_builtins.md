# Task: Implement Tests for Spec 'builtins' (Change 'mamba-conformance-basics')

## Instructions

Production code for spec 'builtins' has been implemented and verified to compile.
Now implement **test functions only** (`#[test]` functions / `#[cfg(test)]` blocks).

1. Read spec **builtins**: `cclab/changes/mamba-conformance-basics/groups/runtime-basics/specs/builtins.md`
...
```
# Read spec
Read file: cclab/changes/mamba-conformance-basics/groups/runtime-basics/specs/builtins.md
