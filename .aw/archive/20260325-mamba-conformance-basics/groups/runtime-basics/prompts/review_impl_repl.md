# Task: Review Implementation of Spec 'repl' for Change 'mamba-conformance-basics'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/mamba-conformance-basics/groups/runtime-basics/specs/repl.md`
...
Read file: cclab/changes/mamba-conformance-basics/groups/runtime-basics/specs/repl.md
