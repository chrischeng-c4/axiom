# Task: Analyze Spec 'cranelift' for Change 'mamba-conformance-basics'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-conformance-basics`.
...
1. Read context from `cclab/changes/mamba-conformance-basics/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-conformance-basics` with scope="cranelift"
...
cclab sdd artifact create-change-spec mamba-conformance-basics <payload_path>
```
