# Task: Revise Reference Context for Group 'runtime-basics' (Change 'mamba-conformance-basics')
...
cclab sdd artifact revise-reference-context mamba-conformance-basics cclab/changes/mamba-conformance-basics/payloads/revise-reference-context.json
```