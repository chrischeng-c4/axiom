# Task: Analyze Spec 'state-machine-docs-phase' for Change '1145'
...
2. Read the skeleton via `cclab sdd workflow read-artifact 1145` with scope="state-machine-docs-phase"
