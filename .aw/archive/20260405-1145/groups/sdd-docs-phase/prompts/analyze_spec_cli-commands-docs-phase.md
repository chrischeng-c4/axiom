# Task: Analyze Spec 'cli-commands-docs-phase' for Change '1145'
...
2. Read the skeleton via `cclab sdd workflow read-artifact 1145` with scope="cli-commands-docs-phase"
