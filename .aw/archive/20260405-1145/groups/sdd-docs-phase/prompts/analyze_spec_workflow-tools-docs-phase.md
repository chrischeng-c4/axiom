# Task: Analyze Spec 'workflow-tools-docs-phase' for Change '1145'
...
2. Read the skeleton via `cclab sdd workflow read-artifact 1145` with scope="workflow-tools-docs-phase"
