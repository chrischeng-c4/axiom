# Task: Analyze Spec 'artifact-tools-docs-phase' for Change '1145'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact 1145`.
...
1. Read context from `cclab/changes/1145/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact 1145` with scope="artifact-tools-docs-phase"
...
cclab sdd artifact create-change-spec 1145 <payload_path>
```
