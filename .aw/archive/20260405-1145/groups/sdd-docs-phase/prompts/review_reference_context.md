# Task: Review Reference Context for Group 'sdd-docs-phase' (Change '1145')
...
cclab sdd artifact review-reference-context 1145 cclab/changes/1145/payloads/review-reference-context.json
```