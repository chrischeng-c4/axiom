# Task: Revise Reference Context for Group 'sdd-docs-phase' (Change '1145')

## Instructions

1. **Read artifact + review feedback**:
   `/Users/chrischeng/projects/wt/sdd/cclab/changes/1145/groups/sdd-docs-phase/reference_context.md`
   Focus on the `# Reviews` section — list each issue to address.
2. **Read pre-clarifications** (confirm scope):
   `/Users/chrischeng/projects/wt/sdd/cclab/changes/1145/groups/sdd-docs-phase/pre_clarifications.md`
...
cclab sdd artifact revise-reference-context 1145 cclab/changes/1145/payloads/revise-reference-context.json
```