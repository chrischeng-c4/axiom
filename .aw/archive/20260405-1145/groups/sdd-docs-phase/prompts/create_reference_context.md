# Task: Gather Reference Context for Group 'sdd-docs-phase' (Change '1145')
...
Based on keyword analysis of requirements: [overview, state-machine, cli, config, test-plan, changes]
...
Write file: cclab/changes/1145/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context 1145 cclab/changes/1145/payloads/create-reference-context.json
```