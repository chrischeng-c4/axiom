# Task: Analyze Spec 'enhancement-page-api-parity-with-playwright-fill-gaps-in-runti-spec' for Change 'enhancement-page-api-parity-with-playwright-fill-gaps-in-runti'

A skeleton has been generated at `.score/changes/enhancement-page-api-parity-with-playwright-fill-gaps-in-runti/specs/enhancement-page-api-parity-with-playwright-fill-gaps-in-runti-spec.md`.
...
2. Read the skeleton: `.score/changes/enhancement-page-api-parity-with-playwright-fill-gaps-in-runti/specs/enhancement-page-api-parity-with-playwright-fill-gaps-in-runti-spec.md`
...
4. Decide which sections to fill based on the nature of the change. Pick ONLY leaf section names from this list — NEVER pass umbrella words like `diagrams`, `api_spec`, or `test_plan`:
   ...
   Docs: `doc`
5. Write a JSON payload file to `.score/changes/enhancement-page-api-parity-with-playwright-fill-gaps-in-runti/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/enhancement-page-api-parity-with-playwright-fill-gaps-in-runti/proposal.md
...
score artifact create-change-spec enhancement-page-api-parity-with-playwright-fill-gaps-in-runti .score/changes/enhancement-page-api-parity-with-playwright-fill-gaps-in-runti/payloads/create-change-spec.json
```
