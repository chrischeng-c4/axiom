# Task: Restructure Input for Change 'sdd-gen-code-pipeline'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-gen-code-pipeline/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-gen-code-pipeline/user_input.md` — user's original description
...
cclab sdd artifact restructure-input sdd-gen-code-pipeline cclab/changes/sdd-gen-code-pipeline/payloads/restructure-input.json
```