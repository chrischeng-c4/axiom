# Task: Write Implementation Diff for Change 'change-spec-agent'
...
cclab sdd artifact create-change-implementation change-spec-agent cclab/changes/change-spec-agent/payloads/create-change-implementation.json
```