# Task: Post-Clarification for Group 'spec-agent-core' (Change 'change-spec-agent')
...
1. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/change-spec-agent/groups/spec-agent-core/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/change-spec-agent/groups/spec-agent-core/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/change-spec-agent/groups/spec-agent-core/reference_context.md`
...
cclab sdd artifact create-post-clarifications change-spec-agent cclab/changes/change-spec-agent/payloads/create-post-clarifications.json
