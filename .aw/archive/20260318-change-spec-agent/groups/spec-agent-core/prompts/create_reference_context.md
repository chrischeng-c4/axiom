# Task: Gather Reference Context for Group 'spec-agent-core' (Change 'change-spec-agent')
...
cclab sdd artifact create-reference-context change-spec-agent cclab/changes/change-spec-agent/payloads/create-reference-context.json
```