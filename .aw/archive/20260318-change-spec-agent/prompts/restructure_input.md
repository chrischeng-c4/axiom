# Task: Restructure Input for Change 'change-spec-agent'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/change-spec-agent/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/change-spec-agent/user_input.md` — user's original description
...
cclab sdd artifact restructure-input change-spec-agent cclab/changes/change-spec-agent/payloads/restructure-input.json
```