# Task: Restructure Input for Change 'jet-test-gaps'

## Step 1: Read Input

Read:
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-test-gaps/user_input.md` — user's description
...
cclab sdd artifact restructure-input jet-test-gaps cclab/changes/jet-test-gaps/payloads/restructure-input.json
```