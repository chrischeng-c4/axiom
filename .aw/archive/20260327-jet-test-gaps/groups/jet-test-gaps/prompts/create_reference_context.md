# Task: Gather Reference Context for Group 'jet-test-gaps' (Change 'jet-test-gaps')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-test-gaps/groups/jet-test-gaps/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, async-api, pipeline, e2e-scenario, test-plan, changes]
...
- `read_path:specs/crates/cclab-jet/dev-server.md`
- `read_path:specs/crates/cclab-jet/hmr.md`
...
Write file: cclab/changes/jet-test-gaps/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context jet-test-gaps cclab/changes/jet-test-gaps/payloads/create-reference-context.json
```