# Task: Analyze Spec 'jet-postcss-tailwind' for Change 'jet-test-gaps'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact jet-test-gaps`.
...
1. Read context from `cclab/changes/jet-test-gaps/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact jet-test-gaps` with scope="jet-postcss-tailwind"
...
cclab sdd artifact create-change-spec jet-test-gaps <payload_path>
```
