# Task: Analyze Spec 'jet-aot-build' for Change 'jet-test-gaps'
...
2. Read the skeleton via `cclab sdd workflow read-artifact jet-test-gaps` with scope="jet-aot-build"
