# Task: Write Implementation Diff for Change 'sdd-codegen-testgen'
...
cclab sdd artifact create-change-implementation sdd-codegen-testgen cclab/changes/sdd-codegen-testgen/payloads/create-change-implementation.json
```