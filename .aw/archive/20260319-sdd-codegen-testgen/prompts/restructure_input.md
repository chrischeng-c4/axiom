# Task: Restructure Input for Change 'sdd-codegen-testgen'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-testgen/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-testgen/user_input.md` — user's original description
...
cclab sdd artifact restructure-input sdd-codegen-testgen cclab/changes/sdd-codegen-testgen/payloads/restructure-input.json
```