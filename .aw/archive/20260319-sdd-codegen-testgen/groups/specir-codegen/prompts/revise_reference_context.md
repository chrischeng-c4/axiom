# Task: Revise Reference Context for Group 'specir-codegen' (Change 'sdd-codegen-testgen')

## Instructions

1. **Read artifact + review feedback**:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-testgen/groups/specir-codegen/reference_context.md`
   Focus on the `# Reviews` section — list each issue to address.
2. **Read pre-clarifications** (confirm scope):
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-testgen/groups/specir-codegen/pre_clarifications.md`
...
cclab sdd artifact revise-reference-context sdd-codegen-testgen cclab/changes/sdd-codegen-testgen/payloads/revise-reference-context.json
```