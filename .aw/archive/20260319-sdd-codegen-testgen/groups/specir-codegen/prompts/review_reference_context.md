# Task: Review Reference Context for Group 'specir-codegen' (Change 'sdd-codegen-testgen')
...
cclab sdd artifact review-reference-context sdd-codegen-testgen cclab/changes/sdd-codegen-testgen/payloads/review-reference-context.json
```