# Task: Gather Reference Context for Group 'specir-codegen' (Change 'sdd-codegen-testgen')
...
Based on keyword analysis of requirements: [overview, db-model, schema, state-machine, logic, dependency, interaction, rest-api, cli, config, test-plan, changes]
