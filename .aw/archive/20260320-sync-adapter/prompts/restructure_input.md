# Task: Restructure Input for Change 'sync-adapter'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/sync-adapter/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/sync-adapter/user_input.md` — user's original description
...
cclab sdd artifact restructure-input sync-adapter cclab/changes/sync-adapter/payloads/restructure-input.json
```