# Task: Post-Clarification for Group 'sync-adapter' (Change 'sync-adapter')
...
1. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/sync-adapter/groups/sync-adapter/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/sync-adapter/groups/sync-adapter/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/sync-adapter/groups/sync-adapter/reference_context.md`
...
cclab sdd artifact create-post-clarifications sync-adapter cclab/changes/sync-adapter/payloads/create-post-clarifications.json
