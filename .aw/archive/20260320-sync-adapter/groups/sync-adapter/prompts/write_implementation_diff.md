# Task: Write Implementation Diff for Change 'sync-adapter'
...
cclab sdd artifact create-change-implementation sync-adapter cclab/changes/sync-adapter/payloads/create-change-implementation.json
```