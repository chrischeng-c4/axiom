# Task: Analyze Spec 'mamba-conformance-p0-spec' for Change 'mamba-conformance-p0'
...
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-conformance-p0` with scope="mamba-conformance-p0-spec"
