# Task: Gather Reference Context for Group 'mamba-p0-fixes' (Change 'mamba-conformance-p0')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-conformance-p0/groups/mamba-p0-fixes/pre_clarifications.md`
