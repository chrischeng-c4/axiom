# Task: Gather Reference Context for Group 'hcl-grammar-fix' (Change 'lens-beyond-ide')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-lens/cclab/changes/lens-beyond-ide/groups/hcl-grammar-fix/pre_clarifications.md`
...
```
mcp__cclab-mcp__sdd_artifact_create_reference_context(project_path="/Users/chris.cheng/cclab/cclab-lens", change_id="lens-beyond-ide", group_id="hcl-grammar-fix", specs=[{"spec_id": "...", "spec_group": "...", "relevance": "high", "key_requirements": ["R1", "R3"]}])
```