# Task: Restructure Input for Change 'lens-beyond-ide'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-lens/cclab/changes/lens-beyond-ide/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-lens/cclab/changes/lens-beyond-ide/user_input.md` — user's original description
...
mcp__cclab-mcp__sdd_artifact_restructure_input(project_path="/Users/chris.cheng/cclab/cclab-lens", change_id="lens-beyond-ide", groups=[{"id": "...", "issues": [...], "requirements": "...", "questions": [{"topic": "...", "question": "..."}]}])