# Task: Restructure Input for Change 'sdd-merge-3way'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chrischeng/projects/cclab-sdd/cclab/changes/sdd-merge-3way/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chrischeng/projects/cclab-sdd/cclab/changes/sdd-merge-3way/user_input.md` — user's original description
...
cclab sdd artifact restructure-input sdd-merge-3way cclab/changes/sdd-merge-3way/payloads/restructure-input.json
```