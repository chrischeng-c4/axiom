# Task: Gather Reference Context for Group 'merge-3way' (Change 'sdd-merge-3way')
...
Write file: cclab/changes/sdd-merge-3way/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context sdd-merge-3way cclab/changes/sdd-merge-3way/payloads/create-reference-context.json
```