# Task: Review Reference Context for Group 'merge-3way' (Change 'sdd-merge-3way')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chrischeng/projects/cclab-sdd/cclab/changes/sdd-merge-3way/groups/merge-3way/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chrischeng/projects/cclab-sdd/cclab/changes/sdd-merge-3way/groups/merge-3way/reference_context.md`
...
cclab sdd artifact review-reference-context sdd-merge-3way cclab/changes/sdd-merge-3way/payloads/review-reference-context.json
```