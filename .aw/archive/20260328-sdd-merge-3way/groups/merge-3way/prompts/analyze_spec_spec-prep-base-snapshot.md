# Task: Analyze Spec 'spec-prep-base-snapshot' for Change 'sdd-merge-3way'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact sdd-merge-3way`.
...
1. Read context from `cclab/changes/sdd-merge-3way/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact sdd-merge-3way` with scope="spec-prep-base-snapshot"
...
cclab sdd artifact create-change-spec sdd-merge-3way <payload_path>
```
