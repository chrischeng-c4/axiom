# Task: Write Implementation Diff for Change 'sdd-merge-3way'
...
cclab sdd artifact create-change-implementation sdd-merge-3way cclab/changes/sdd-merge-3way/payloads/create-change-implementation.json
```