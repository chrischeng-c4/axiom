# Task: Implement Tests for Spec 'merge-3way' (Change 'sdd-merge-3way')

## Instructions

Production code for spec 'merge-3way' has been implemented and verified to compile.
Now implement **test functions only** (`#[test]` functions / `#[cfg(test)]` blocks).

1. Read spec **merge-3way**: `cclab/changes/sdd-merge-3way/groups/merge-3way/specs/merge-3way.md`
...
5. When done, run `cclab sdd workflow create-change-implementation sdd-merge-3way` to advance
