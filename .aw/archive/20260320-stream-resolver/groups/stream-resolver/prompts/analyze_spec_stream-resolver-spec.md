# Task: Analyze Spec 'stream-resolver-spec' for Change 'stream-resolver'

A skeleton has been generated at `specs/stream-resolver-spec.md`.
...
1. Read context from `cclab/changes/stream-resolver/proposal.md` or `reference_context.md`
2. Read the skeleton: `cclab/changes/stream-resolver/specs/stream-resolver-spec.md`
...
cclab sdd artifact create-change-spec stream-resolver cclab/changes/stream-resolver/payloads/create-change-spec.json
```
