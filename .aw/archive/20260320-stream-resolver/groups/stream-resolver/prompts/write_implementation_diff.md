# Task: Write Implementation Diff for Change 'stream-resolver'
...
cclab sdd artifact create-change-implementation stream-resolver cclab/changes/stream-resolver/payloads/create-change-implementation.json
```