# Task: Gather Reference Context for Group 'add-idlelib-stdlib' (Change '1000-patrol')
...
Write file: cclab/changes/1000-patrol/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context 1000-patrol cclab/changes/1000-patrol/payloads/create-reference-context.json
```