# Task: Review Reference Context for Group 'add-idlelib-stdlib' (Change '1000-patrol')
...
cclab sdd artifact review-reference-context 1000-patrol cclab/changes/1000-patrol/payloads/review-reference-context.json
```