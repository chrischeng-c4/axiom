# Task: Analyze Spec 'idlelib-stub' for Change '1000-patrol'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact 1000-patrol`.
...
1. Read context from `cclab/changes/1000-patrol/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact 1000-patrol` with scope="idlelib-stub"
...
cclab sdd artifact create-change-spec 1000-patrol <payload_path>
```
