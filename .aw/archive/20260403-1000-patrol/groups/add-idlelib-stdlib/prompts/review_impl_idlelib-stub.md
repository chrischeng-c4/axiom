# Task: Review Implementation of Spec 'idlelib-stub' for Change '1000-patrol'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/1000-patrol/groups/add-idlelib-stdlib/specs/idlelib-stub.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `cclab/changes/1000-patrol/implementation.md`
4. List changed files via `cclab sdd workflow list-changed-files 1000-patrol`
...
Read file: cclab/changes/1000-patrol/groups/add-idlelib-stdlib/specs/idlelib-stub.md
Read file: cclab/changes/1000-patrol/implementation.md

# List changed files
cclab sdd workflow list-changed-files 1000-patrol

# Write review (write payload JSON first, then run)
cclab sdd artifact review-change-implementation 1000-patrol cclab/changes/1000-patrol/payloads/review-change-implementation.json
```