# Task: Restructure Input for Change 'clean-mcp-refs'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/clean-mcp-refs/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/clean-mcp-refs/user_input.md` — user's original description
...
cclab sdd artifact restructure-input clean-mcp-refs cclab/changes/clean-mcp-refs/payloads/restructure-input.json
```