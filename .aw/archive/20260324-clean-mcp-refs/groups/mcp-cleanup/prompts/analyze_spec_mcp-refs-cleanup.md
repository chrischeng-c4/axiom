# Task: Analyze Spec 'mcp-refs-cleanup' for Change 'clean-mcp-refs'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact clean-mcp-refs`.
...
1. Read context from `cclab/changes/clean-mcp-refs/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact clean-mcp-refs` with scope="mcp-refs-cleanup"
...
cclab sdd artifact create-change-spec clean-mcp-refs <payload_path>
```
