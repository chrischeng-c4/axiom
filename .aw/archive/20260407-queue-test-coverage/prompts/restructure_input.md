# Task: Restructure Input for Change 'queue-test-coverage'
...
cclab sdd artifact restructure-input queue-test-coverage cclab/changes/queue-test-coverage/payloads/restructure-input.json
```