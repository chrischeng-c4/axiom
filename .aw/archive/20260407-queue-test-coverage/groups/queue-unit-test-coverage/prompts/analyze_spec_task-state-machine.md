# Task: Analyze Spec 'task-state-machine' for Change 'queue-test-coverage'
...
2. Read the skeleton via `cclab sdd workflow read-artifact queue-test-coverage` with scope="task-state-machine"
