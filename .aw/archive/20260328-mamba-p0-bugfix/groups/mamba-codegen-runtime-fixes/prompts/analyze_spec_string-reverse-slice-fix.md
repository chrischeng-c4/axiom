# Task: Analyze Spec 'string-reverse-slice-fix' for Change 'mamba-p0-bugfix'
...
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-p0-bugfix` with scope="string-reverse-slice-fix"
