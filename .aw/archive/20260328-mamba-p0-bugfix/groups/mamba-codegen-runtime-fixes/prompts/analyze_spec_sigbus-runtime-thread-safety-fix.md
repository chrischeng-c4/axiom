# Task: Analyze Spec 'sigbus-runtime-thread-safety-fix' for Change 'mamba-p0-bugfix'
...
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-p0-bugfix` with scope="sigbus-runtime-thread-safety-fix"
