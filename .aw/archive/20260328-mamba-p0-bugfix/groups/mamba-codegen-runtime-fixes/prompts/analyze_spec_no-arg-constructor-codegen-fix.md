# Task: Analyze Spec 'no-arg-constructor-codegen-fix' for Change 'mamba-p0-bugfix'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-p0-bugfix`.
...
1. Read context from `cclab/changes/mamba-p0-bugfix/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-p0-bugfix` with scope="no-arg-constructor-codegen-fix"
...
cclab sdd artifact create-change-spec mamba-p0-bugfix <payload_path>
```
