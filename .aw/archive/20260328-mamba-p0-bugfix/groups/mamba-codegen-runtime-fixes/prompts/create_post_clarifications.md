# Task: Post-Clarification for Group 'mamba-codegen-runtime-fixes' (Change 'mamba-p0-bugfix')
...
1. `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-p0-bugfix/groups/mamba-codegen-runtime-fixes/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-p0-bugfix/groups/mamba-codegen-runtime-fixes/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-p0-bugfix/groups/mamba-codegen-runtime-fixes/reference_context.md`
...
cclab sdd artifact create-post-clarifications mamba-p0-bugfix cclab/changes/mamba-p0-bugfix/payloads/create-post-clarifications.json
