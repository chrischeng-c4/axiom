# Task: Review Reference Context for Group 'mamba-codegen-runtime-fixes' (Change 'mamba-p0-bugfix')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-p0-bugfix/groups/mamba-codegen-runtime-fixes/reference_context.md`
...
cclab sdd artifact review-reference-context mamba-p0-bugfix cclab/changes/mamba-p0-bugfix/payloads/review-reference-context.json
```