# Task: Gather Reference Context for Group 'mamba-codegen-runtime-fixes' (Change 'mamba-p0-bugfix')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-p0-bugfix/groups/mamba-codegen-runtime-fixes/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, state-machine, changes]
...
Write file: cclab/changes/mamba-p0-bugfix/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context mamba-p0-bugfix cclab/changes/mamba-p0-bugfix/payloads/create-reference-context.json
```