# Task: Restructure Input for Change 'mamba-p0-bugfix'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-p0-bugfix/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-p0-bugfix/user_input.md` — user's original description
...
cclab sdd artifact restructure-input mamba-p0-bugfix cclab/changes/mamba-p0-bugfix/payloads/restructure-input.json
```