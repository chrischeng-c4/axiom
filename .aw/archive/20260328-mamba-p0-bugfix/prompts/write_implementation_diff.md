# Task: Write Implementation Diff for Change 'mamba-p0-bugfix'
...
cclab sdd artifact create-change-implementation mamba-p0-bugfix cclab/changes/mamba-p0-bugfix/payloads/create-change-implementation.json
```