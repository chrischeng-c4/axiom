# Task: Review Implementation of Spec 'sigbus-runtime-thread-safety-fix' for Change 'mamba-p0-bugfix'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/mamba-p0-bugfix/specs/sigbus-runtime-thread-safety-fix.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `cclab/changes/mamba-p0-bugfix/implementation.md`
4. List changed files via `cclab sdd workflow list-changed-files mamba-p0-bugfix`
...
Read file: cclab/changes/mamba-p0-bugfix/specs/sigbus-runtime-thread-safety-fix.md
Read file: cclab/changes/mamba-p0-bugfix/implementation.md

# List changed files
cclab sdd workflow list-changed-files mamba-p0-bugfix

# Write review (write payload JSON first, then run)
cclab sdd artifact review-change-implementation mamba-p0-bugfix cclab/changes/mamba-p0-bugfix/payloads/review-change-implementation.json
```