# Task: Restructure Input for Change 'cclab-api-asgi-dispatch'
...
cclab sdd artifact restructure-input cclab-api-asgi-dispatch cclab/changes/cclab-api-asgi-dispatch/payloads/restructure-input.json
```