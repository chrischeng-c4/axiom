# Task: Analyze Spec 'asgi-dispatch-spec' for Change 'cclab-api-asgi-dispatch'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact cclab-api-asgi-dispatch`.
...
1. Read context from `cclab/changes/cclab-api-asgi-dispatch/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact cclab-api-asgi-dispatch` with scope="asgi-dispatch-spec"
...
cclab sdd artifact create-change-spec cclab-api-asgi-dispatch <payload_path>
```
