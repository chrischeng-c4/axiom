# Task: Review Reference Context for Group 'structured-output' (Change 'cclab-agent-p0')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/cclab-agent-p0/groups/structured-output/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/cclab-agent-p0/groups/structured-output/reference_context.md`
...
cclab sdd artifact review-reference-context cclab-agent-p0 cclab/changes/cclab-agent-p0/payloads/review-reference-context.json
```