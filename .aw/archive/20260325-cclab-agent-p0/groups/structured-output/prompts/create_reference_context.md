# Task: Gather Reference Context for Group 'structured-output' (Change 'cclab-agent-p0')
...
cclab sdd artifact create-reference-context cclab-agent-p0 cclab/changes/cclab-agent-p0/payloads/create-reference-context.json
```