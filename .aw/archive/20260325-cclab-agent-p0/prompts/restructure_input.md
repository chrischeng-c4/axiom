# Task: Restructure Input for Change 'cclab-agent-p0'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/cclab-agent-p0/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/cclab-agent-p0/user_input.md` — user's original description
...
cclab sdd artifact restructure-input cclab-agent-p0 cclab/changes/cclab-agent-p0/payloads/restructure-input.json
```