# Task: Review Reference Context for Group 'token-counting-and-compact' (Change 'cclab-agent-p0')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/cclab-agent-p0/groups/token-counting-and-compact/reference_context.md`
...
```
mcp__cclab-mcp__sdd_artifact_review_reference_context(project_path="/Users/chris.cheng/cclab/cclab-agent", change_id="cclab-agent-p0", group_id="token-counting-and-compact", verdict="...", summary="...", checklist_results=[...], issues=[...])
```