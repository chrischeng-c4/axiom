# Task: Gather Reference Context for Group 'index-path-and-cli-hints' (Change 'sdd-index-path-rename')
...
Write file: cclab/changes/sdd-index-path-rename/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context sdd-index-path-rename cclab/changes/sdd-index-path-rename/payloads/create-reference-context.json
```