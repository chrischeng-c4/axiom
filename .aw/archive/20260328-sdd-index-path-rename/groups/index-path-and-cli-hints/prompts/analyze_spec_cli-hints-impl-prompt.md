# Task: Analyze Spec 'cli-hints-impl-prompt' for Change 'sdd-index-path-rename'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact sdd-index-path-rename`.
...
1. Read context from `cclab/changes/sdd-index-path-rename/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact sdd-index-path-rename` with scope="cli-hints-impl-prompt"
...
cclab sdd artifact create-change-spec sdd-index-path-rename <payload_path>
```
