# Task: Review Reference Context for Group 'index-path-and-cli-hints' (Change 'sdd-index-path-rename')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-index-path-rename/groups/index-path-and-cli-hints/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-index-path-rename/groups/index-path-and-cli-hints/reference_context.md`
...
cclab sdd artifact review-reference-context sdd-index-path-rename cclab/changes/sdd-index-path-rename/payloads/review-reference-context.json
```