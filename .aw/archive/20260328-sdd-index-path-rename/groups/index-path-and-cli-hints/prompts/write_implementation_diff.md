# Task: Write Implementation Diff for Change 'sdd-index-path-rename'
...
cclab sdd artifact create-change-implementation sdd-index-path-rename cclab/changes/sdd-index-path-rename/payloads/create-change-implementation.json
```