# Task: Analyze Spec 'index-path-rename' for Change 'sdd-index-path-rename'
...
2. Read the skeleton via `cclab sdd workflow read-artifact sdd-index-path-rename` with scope="index-path-rename"
