# Task: Restructure Input for Change 'sdd-index-path-rename'
...
cclab sdd artifact restructure-input sdd-index-path-rename cclab/changes/sdd-index-path-rename/payloads/restructure-input.json
```