# Task: Review Reference Context for Group 'noarg-constructor-codegen' (Change 'mamba-noarg-constructor')
...
2. **Read the reference context artifact**:
   `/Users/chrischeng/projects/cclab-sdd/cclab/changes/mamba-noarg-constructor/groups/noarg-constructor-codegen/reference_context.md`
...
cclab sdd artifact review-reference-context mamba-noarg-constructor cclab/changes/mamba-noarg-constructor/payloads/review-reference-context.json
```