# Task: Gather Reference Context for Group 'noarg-constructor-codegen' (Change 'mamba-noarg-constructor')

Issues: #1109_fix-mamba-no-arg-constructor-codegen-verifier-erro
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chrischeng/projects/cclab-sdd/cclab/changes/mamba-noarg-constructor/groups/noarg-constructor-codegen/pre_clarifications.md`
...
Write file: cclab/changes/mamba-noarg-constructor/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context mamba-noarg-constructor cclab/changes/mamba-noarg-constructor/payloads/create-reference-context.json
```