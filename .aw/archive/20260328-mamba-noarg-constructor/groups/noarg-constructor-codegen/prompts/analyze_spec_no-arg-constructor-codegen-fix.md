# Task: Analyze Spec 'no-arg-constructor-codegen-fix' for Change 'mamba-noarg-constructor'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-noarg-constructor`.
...
1. Read context from `cclab/changes/mamba-noarg-constructor/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-noarg-constructor` with scope="no-arg-constructor-codegen-fix"
...
cclab sdd artifact create-change-spec mamba-noarg-constructor <payload_path>
```
