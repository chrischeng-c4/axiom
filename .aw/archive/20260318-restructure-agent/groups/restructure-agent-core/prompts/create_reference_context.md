# Task: Gather Reference Context for Group 'restructure-agent-core' (Change 'restructure-agent')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/restructure-agent/groups/restructure-agent-core/pre_clarifications.md`
...
Write file: cclab/changes/restructure-agent/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context restructure-agent cclab/changes/restructure-agent/payloads/create-reference-context.json
```