# Task: Write Implementation Diff for Change 'restructure-agent'
...
cclab sdd artifact create-change-implementation restructure-agent cclab/changes/restructure-agent/payloads/create-change-implementation.json
```