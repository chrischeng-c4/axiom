# Task: Review Reference Context for Group 'restructure-agent-core' (Change 'restructure-agent')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/restructure-agent/groups/restructure-agent-core/reference_context.md`
...
cclab sdd artifact review-reference-context restructure-agent cclab/changes/restructure-agent/payloads/review-reference-context.json
```