# Task: Post-Clarification for Group 'restructure-agent-core' (Change 'restructure-agent')
...
1. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/restructure-agent/groups/restructure-agent-core/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/restructure-agent/groups/restructure-agent-core/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/restructure-agent/groups/restructure-agent-core/reference_context.md`
...
cclab sdd artifact create-post-clarifications restructure-agent cclab/changes/restructure-agent/payloads/create-post-clarifications.json
