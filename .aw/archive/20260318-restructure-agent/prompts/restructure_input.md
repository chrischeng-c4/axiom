# Task: Restructure Input for Change 'restructure-agent'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/restructure-agent/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/restructure-agent/user_input.md` — user's original description
...
cclab sdd artifact restructure-input restructure-agent cclab/changes/restructure-agent/payloads/restructure-input.json
```