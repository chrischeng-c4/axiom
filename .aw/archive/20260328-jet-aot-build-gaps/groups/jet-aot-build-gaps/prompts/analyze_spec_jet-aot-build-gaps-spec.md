# Task: Analyze Spec 'jet-aot-build-gaps-spec' for Change 'jet-aot-build-gaps'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact jet-aot-build-gaps`.
...
1. Read context from `cclab/changes/jet-aot-build-gaps/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact jet-aot-build-gaps` with scope="jet-aot-build-gaps-spec"
...
cclab sdd artifact create-change-spec jet-aot-build-gaps <payload_path>
```
