# Task: Restructure Input for Change 'jet-aot-build-gaps'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-aot-build-gaps/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/jet-aot-build-gaps/user_input.md` — user's original description
...
cclab sdd artifact restructure-input jet-aot-build-gaps cclab/changes/jet-aot-build-gaps/payloads/restructure-input.json
```