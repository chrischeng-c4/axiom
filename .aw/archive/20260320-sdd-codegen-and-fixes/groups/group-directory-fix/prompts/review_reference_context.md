# Task: Review Reference Context for Group 'group-directory-fix' (Change 'sdd-codegen-and-fixes')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-and-fixes/groups/group-directory-fix/reference_context.md`
