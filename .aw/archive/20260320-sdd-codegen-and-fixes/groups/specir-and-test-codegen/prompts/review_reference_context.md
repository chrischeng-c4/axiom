# Task: Review Reference Context for Group 'specir-and-test-codegen' (Change 'sdd-codegen-and-fixes')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-and-fixes/groups/specir-and-test-codegen/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-and-fixes/groups/specir-and-test-codegen/reference_context.md`
...
cclab sdd artifact review-reference-context sdd-codegen-and-fixes cclab/changes/sdd-codegen-and-fixes/payloads/review-reference-context.json
```