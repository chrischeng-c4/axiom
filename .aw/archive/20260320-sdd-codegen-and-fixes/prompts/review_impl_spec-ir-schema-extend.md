# Task: Review Implementation of Spec 'spec-ir-schema-extend' for Change 'sdd-codegen-and-fixes'

## Instructions

1. Read spec: `cclab/changes/sdd-codegen-and-fixes/specs/spec-ir-schema-extend.md`
...
Read file: cclab/changes/sdd-codegen-and-fixes/specs/spec-ir-schema-extend.md
