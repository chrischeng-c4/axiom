# Task: Restructure Input for Change 'sdd-codegen-and-fixes'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-and-fixes/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-codegen-and-fixes/user_input.md` — user's original description
...
cclab sdd artifact restructure-input sdd-codegen-and-fixes cclab/changes/sdd-codegen-and-fixes/payloads/restructure-input.json
```