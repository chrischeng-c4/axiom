# Task: Review Implementation of Spec 'generator-deploy' for Change 'sdd-codegen-and-fixes'

## Instructions

1. Read spec: `cclab/changes/sdd-codegen-and-fixes/specs/generator-deploy.md`
...
Read file: cclab/changes/sdd-codegen-and-fixes/specs/generator-deploy.md
