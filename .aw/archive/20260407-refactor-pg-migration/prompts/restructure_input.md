# Task: Restructure Input for Change 'refactor-pg-migration'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/wt/conductor/.score/changes/refactor-pg-migration/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/wt/conductor/.score/changes/refactor-pg-migration/user_input.md` — user's original description
...
score artifact restructure-input refactor-pg-migration .score/changes/refactor-pg-migration/payloads/restructure-input.json
```