# Task: Analyze Spec 'refactor-pg-migration-spec' for Change 'refactor-pg-migration'

A skeleton has been generated at `.score/changes/refactor-pg-migration/groups/refactor-pg-migration/specs/refactor-pg-migration-spec.md`.

**group_id**: `refactor-pg-migration` (pass this to the artifact CLI as `group_id` parameter)
...
1. Read context:
   - Read file: `.score/changes/refactor-pg-migration/proposal.md` for spec_plan routing
   - Read file: `.score/changes/refactor-pg-migration/reference_context.md` if no proposal
2. Read the skeleton: `.score/changes/refactor-pg-migration/groups/refactor-pg-migration/specs/refactor-pg-migration-spec.md`
...
5. Write a JSON payload file to `.score/changes/refactor-pg-migration/groups/refactor-pg-migration/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/refactor-pg-migration/proposal.md
...
score artifact create-change-spec refactor-pg-migration .score/changes/refactor-pg-migration/groups/refactor-pg-migration/payloads/create-change-spec.json
```
