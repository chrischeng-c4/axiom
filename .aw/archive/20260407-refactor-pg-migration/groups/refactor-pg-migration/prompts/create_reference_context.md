# Task: Gather Reference Context for Group 'refactor-pg-migration' (Change 'refactor-pg-migration')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/wt/conductor/.score/changes/refactor-pg-migration/groups/refactor-pg-migration/pre_clarifications.md`
...
Write file: .score/changes/refactor-pg-migration/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context refactor-pg-migration .score/changes/refactor-pg-migration/payloads/create-reference-context.json
```