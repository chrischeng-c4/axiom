# Task: Post-Clarification for Group 'refactor-pg-migration' (Change 'refactor-pg-migration')
...
1. `/Users/chris.cheng/cclab/wt/conductor/.score/changes/refactor-pg-migration/groups/refactor-pg-migration/requirements.md`
2. `/Users/chris.cheng/cclab/wt/conductor/.score/changes/refactor-pg-migration/groups/refactor-pg-migration/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/wt/conductor/.score/changes/refactor-pg-migration/groups/refactor-pg-migration/reference_context.md`
4. Actual specs — read high/medium relevance specs from reference_context.md

- List specs under `/Users/chris.cheng/cclab/wt/conductor/.score/tech_design/` using Glob and read the most relevant ones
...
score artifact create-post-clarifications refactor-pg-migration .score/changes/refactor-pg-migration/payloads/create-post-clarifications.json
