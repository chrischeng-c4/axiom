# Task: Restructure Input for Change 'install-perf'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/install-perf/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/install-perf/user_input.md` — user's original description
...
cclab sdd artifact restructure-input install-perf cclab/changes/install-perf/payloads/restructure-input.json
```