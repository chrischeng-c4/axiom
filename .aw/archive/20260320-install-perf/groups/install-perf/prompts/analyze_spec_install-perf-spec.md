# Task: Analyze Spec 'install-perf-spec' for Change 'install-perf'

A skeleton has been generated at `specs/install-perf-spec.md`.
...
1. Read context from `cclab/changes/install-perf/proposal.md` or `reference_context.md`
2. Read the skeleton: `cclab/changes/install-perf/specs/install-perf-spec.md`
...
cclab sdd artifact create-change-spec install-perf cclab/changes/install-perf/payloads/create-change-spec.json
```
