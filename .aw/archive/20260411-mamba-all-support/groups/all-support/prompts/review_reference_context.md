...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/main/.score/worktrees/mamba-all-support/.score/changes/mamba-all-support/groups/all-support/reference_context.md`
3. **Verify each spec entry**: For each spec listed in the artifact, read the actual spec under `/Users/chris.cheng/cclab/main/.score/worktrees/mamba-all-support/.score/tech_design/` to verify relevance and key requirements are accurate.
