# Task: Gather Reference Context for Group 'all-support' (Change 'mamba-all-support')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/main/.score/worktrees/mamba-all-support/.score/changes/mamba-all-support/groups/all-support/pre_clarifications.md`
...
- List specs under `/Users/chris.cheng/cclab/main/.score/worktrees/mamba-all-support/.score/tech_design/` using Glob
...
Write file: .score/changes/mamba-all-support/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context mamba-all-support .score/changes/mamba-all-support/payloads/create-reference-context.json
```