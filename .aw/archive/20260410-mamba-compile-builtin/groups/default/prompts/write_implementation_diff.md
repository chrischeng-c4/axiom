# Task: Write Implementation Diff for Change 'mamba-compile-builtin'
...
score artifact create-change-implementation mamba-compile-builtin .score/changes/mamba-compile-builtin/payloads/create-change-implementation.json
```