# Task: Fill Section 'changes' for Spec 'mamba-compile-builtin-value-rc' (Change 'mamba-compile-builtin')

**group_id**: `default` (pass this to the artifact CLI)

## Instructions

1. Read the current spec: `.score/changes/mamba-compile-builtin/groups/default/specs/mamba-compile-builtin-value-rc.md`
