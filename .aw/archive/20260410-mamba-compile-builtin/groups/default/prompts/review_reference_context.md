# Task: Review Reference Context for Group 'default' (Change 'mamba-compile-builtin')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/main/.score/changes/mamba-compile-builtin/groups/default/reference_context.md`
...
score artifact review-reference-context mamba-compile-builtin .score/changes/mamba-compile-builtin/payloads/review-reference-context.json
```