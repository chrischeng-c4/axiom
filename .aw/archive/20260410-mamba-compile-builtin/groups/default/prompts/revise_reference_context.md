# Task: Revise Reference Context for Group 'default' (Change 'mamba-compile-builtin')
...
score artifact revise-reference-context mamba-compile-builtin .score/changes/mamba-compile-builtin/payloads/revise-reference-context.json
```