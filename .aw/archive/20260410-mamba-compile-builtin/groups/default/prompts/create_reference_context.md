# Task: Gather Reference Context for Group 'default' (Change 'mamba-compile-builtin')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/main/.score/changes/mamba-compile-builtin/groups/default/pre_clarifications.md`
...
Write file: .score/changes/mamba-compile-builtin/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context mamba-compile-builtin .score/changes/mamba-compile-builtin/payloads/create-reference-context.json
```