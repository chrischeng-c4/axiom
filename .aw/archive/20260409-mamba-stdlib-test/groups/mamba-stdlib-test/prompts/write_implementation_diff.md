# Task: Write Implementation Diff for Change 'mamba-stdlib-test'
...
score artifact create-change-implementation mamba-stdlib-test .score/changes/mamba-stdlib-test/payloads/create-change-implementation.json
```