# Task: Review Reference Context for Group 'mamba-stdlib-test' (Change 'mamba-stdlib-test')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/main/.score/changes/mamba-stdlib-test/groups/mamba-stdlib-test/reference_context.md`
...
score artifact review-reference-context mamba-stdlib-test .score/changes/mamba-stdlib-test/payloads/review-reference-context.json
```