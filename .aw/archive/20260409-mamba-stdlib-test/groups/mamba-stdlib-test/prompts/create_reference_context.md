# Task: Gather Reference Context for Group 'mamba-stdlib-test' (Change 'mamba-stdlib-test')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/main/.score/changes/mamba-stdlib-test/groups/mamba-stdlib-test/pre_clarifications.md`
...
Write file: .score/changes/mamba-stdlib-test/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context mamba-stdlib-test .score/changes/mamba-stdlib-test/payloads/create-reference-context.json
```