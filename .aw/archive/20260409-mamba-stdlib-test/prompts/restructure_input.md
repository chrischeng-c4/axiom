# Task: Restructure Input for Change 'mamba-stdlib-test'
...
score artifact restructure-input mamba-stdlib-test .score/changes/mamba-stdlib-test/payloads/restructure-input.json
```