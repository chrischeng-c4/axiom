# Task: Restructure Input for Change 'mamba-stdlib-builtins'
...
score artifact restructure-input mamba-stdlib-builtins .score/changes/mamba-stdlib-builtins/payloads/restructure-input.json
```