# Task: Gather Reference Context for Group 'stdlib-builtins-module' (Change 'mamba-stdlib-builtins')
...
Write file: .score/changes/mamba-stdlib-builtins/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context mamba-stdlib-builtins .score/changes/mamba-stdlib-builtins/payloads/create-reference-context.json
```