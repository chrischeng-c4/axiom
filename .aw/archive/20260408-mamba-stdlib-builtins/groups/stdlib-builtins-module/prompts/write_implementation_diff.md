# Task: Write Implementation Diff for Change 'mamba-stdlib-builtins'
...
score artifact create-change-implementation mamba-stdlib-builtins .score/changes/mamba-stdlib-builtins/payloads/create-change-implementation.json
```