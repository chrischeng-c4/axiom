# Task: Write Implementation Diff for Change 'merge-lens-into-sdd'
...
cclab sdd artifact create-change-implementation merge-lens-into-sdd cclab/changes/merge-lens-into-sdd/payloads/create-change-implementation.json
```