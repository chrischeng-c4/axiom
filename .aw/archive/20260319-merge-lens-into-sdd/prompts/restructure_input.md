# Task: Restructure Input for Change 'merge-lens-into-sdd'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/merge-lens-into-sdd/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/merge-lens-into-sdd/user_input.md` — user's original description
...
cclab sdd artifact restructure-input merge-lens-into-sdd cclab/changes/merge-lens-into-sdd/payloads/restructure-input.json
```