# Task: Write Implementation Diff for Change 'mamba-756-patrol'
...
score artifact create-change-implementation mamba-756-patrol .score/changes/mamba-756-patrol/payloads/create-change-implementation.json
```