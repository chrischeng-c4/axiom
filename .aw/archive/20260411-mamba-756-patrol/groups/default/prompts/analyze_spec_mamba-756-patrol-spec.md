# Task: Analyze Spec 'mamba-756-patrol-spec' for Change 'mamba-756-patrol'

A skeleton has been generated at `.score/changes/mamba-756-patrol/groups/default/specs/mamba-756-patrol-spec.md`.
...
1. Read context:
   - Read file: `.score/changes/mamba-756-patrol/proposal.md` for spec_plan routing
   - Read file: `.score/changes/mamba-756-patrol/reference_context.md` if no proposal
2. Read the skeleton: `.score/changes/mamba-756-patrol/groups/default/specs/mamba-756-patrol-spec.md`
...
5. Write a JSON payload file to `.score/changes/mamba-756-patrol/groups/default/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/mamba-756-patrol/proposal.md
...
score artifact create-change-spec mamba-756-patrol .score/changes/mamba-756-patrol/groups/default/payloads/create-change-spec.json
```
