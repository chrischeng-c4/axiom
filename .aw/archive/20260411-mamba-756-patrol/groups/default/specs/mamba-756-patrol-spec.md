...
merge_strategy: new
filled_sections: [overview, requirements, scenarios, state-machine, interaction, schema, db-model, logic, test-plan, changes]
fill_sections: [overview, requirements, scenarios, state-machine, interaction, schema, db-model, logic, test-plan, changes]
---
...
files:
  ...
  - path: .score/tech_design/crates/mamba/testing/mamba-py312-conformance.md
    action: modify
    satisfies: [R1, R2, R3, R4, R5, R6, R7, R8]
    desc: |
