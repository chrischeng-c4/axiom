# Genesis - Spec-Driven Development

You are assisting with a project that uses **Genesis** for spec-driven development (SDD).
...
The Genesis workflow is streamlined into three high-level stages, accessed via specific skills:
