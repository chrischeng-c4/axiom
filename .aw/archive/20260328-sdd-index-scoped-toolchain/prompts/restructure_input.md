# Task: Restructure Input for Change 'sdd-index-scoped-toolchain'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-index-scoped-toolchain/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/sdd-index-scoped-toolchain/user_input.md` — user's original description
...
cclab sdd artifact restructure-input sdd-index-scoped-toolchain cclab/changes/sdd-index-scoped-toolchain/payloads/restructure-input.json
```