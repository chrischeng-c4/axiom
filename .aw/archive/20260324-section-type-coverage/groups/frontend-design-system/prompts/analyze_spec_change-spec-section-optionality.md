# Task: Analyze Spec 'change-spec-section-optionality' for Change 'section-type-coverage'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact section-type-coverage`.
...
1. Read context from `cclab/changes/section-type-coverage/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact section-type-coverage` with scope="change-spec-section-optionality"
...
cclab sdd artifact create-change-spec section-type-coverage <payload_path>
```
