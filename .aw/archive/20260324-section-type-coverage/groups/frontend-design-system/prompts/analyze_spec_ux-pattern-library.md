# Task: Analyze Spec 'ux-pattern-library' for Change 'section-type-coverage'
...
2. Read the skeleton via `cclab sdd workflow read-artifact section-type-coverage` with scope="ux-pattern-library"
