# Task: Review Reference Context for Group 'frontend-design-system' (Change 'section-type-coverage')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/section-type-coverage/groups/frontend-design-system/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/section-type-coverage/groups/frontend-design-system/reference_context.md`
...
cclab sdd artifact review-reference-context section-type-coverage cclab/changes/section-type-coverage/payloads/review-reference-context.json
```