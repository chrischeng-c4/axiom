# Task: Analyze Spec 'tech-stack-inference' for Change 'section-type-coverage'
...
2. Read the skeleton via `cclab sdd workflow read-artifact section-type-coverage` with scope="tech-stack-inference"
