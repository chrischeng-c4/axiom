# Task: Revise Reference Context for Group 'frontend-design-system' (Change 'section-type-coverage')
...
cclab sdd artifact revise-reference-context section-type-coverage cclab/changes/section-type-coverage/payloads/revise-reference-context.json
```