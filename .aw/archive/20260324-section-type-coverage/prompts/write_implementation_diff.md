# Task: Write Implementation Diff for Change 'section-type-coverage'
...
cclab sdd artifact create-change-implementation section-type-coverage cclab/changes/section-type-coverage/payloads/create-change-implementation.json
```