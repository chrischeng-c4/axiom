# Task: Restructure Input for Change 'section-type-coverage'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/section-type-coverage/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/section-type-coverage/user_input.md` — user's original description
...
cclab sdd artifact restructure-input section-type-coverage cclab/changes/section-type-coverage/payloads/restructure-input.json
```