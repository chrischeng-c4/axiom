# Task: Review Implementation of Spec 'reference-context-types' for Change 'section-type-coverage'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/section-type-coverage/specs/reference-context-types.md`
...
Read file: cclab/changes/section-type-coverage/specs/reference-context-types.md
