# Task: Write Implementation Diff for Change 'mamba-type-3arg'
...
score artifact create-change-implementation mamba-type-3arg .score/changes/mamba-type-3arg/payloads/create-change-implementation.json
```