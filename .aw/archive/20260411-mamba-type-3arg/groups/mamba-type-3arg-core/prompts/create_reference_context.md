# Task: Gather Reference Context for Group 'mamba-type-3arg-core' (Change 'mamba-type-3arg')
...
- `read_path:specs/crates/mamba/stdlib/builtins.md`
...
- `read_path:specs/crates/mamba/stdlib/future.md`
...
- `read_path:specs/crates/mamba/stdlib/main.md`
...
- `read_path:specs/crates/mamba/stdlib/posix.md`
...
Read these specs using the Read tool (file paths under `/Users/chris.cheng/cclab/main/.score/worktrees/mamba-type-3arg/.score/tech_design/`).
...
Write file: .score/changes/mamba-type-3arg/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context mamba-type-3arg .score/changes/mamba-type-3arg/payloads/create-reference-context.json
```