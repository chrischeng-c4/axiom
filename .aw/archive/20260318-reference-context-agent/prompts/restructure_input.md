# Task: Restructure Input for Change 'reference-context-agent'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/reference-context-agent/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/reference-context-agent/user_input.md` — user's original description
...
cclab sdd artifact restructure-input reference-context-agent cclab/changes/reference-context-agent/payloads/restructure-input.json
```