# Task: Post-Clarification for Group 'reference-context-agent' (Change 'reference-context-agent')
...
1. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/reference-context-agent/groups/reference-context-agent/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/reference-context-agent/groups/reference-context-agent/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/reference-context-agent/groups/reference-context-agent/reference_context.md`
...
cclab sdd artifact create-post-clarifications reference-context-agent cclab/changes/reference-context-agent/payloads/create-post-clarifications.json
