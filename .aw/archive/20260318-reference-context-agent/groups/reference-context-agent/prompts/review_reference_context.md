# Task: Review Reference Context for Group 'reference-context-agent' (Change 'reference-context-agent')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/reference-context-agent/groups/reference-context-agent/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/reference-context-agent/groups/reference-context-agent/reference_context.md`
...
cclab sdd artifact review-reference-context reference-context-agent cclab/changes/reference-context-agent/payloads/review-reference-context.json
```