# Task: Write Implementation Diff for Change 'reference-context-agent'
...
cclab sdd artifact create-change-implementation reference-context-agent cclab/changes/reference-context-agent/payloads/create-change-implementation.json
```