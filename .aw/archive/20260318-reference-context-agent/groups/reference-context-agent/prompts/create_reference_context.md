# Task: Gather Reference Context for Group 'reference-context-agent' (Change 'reference-context-agent')
...
cclab sdd artifact create-reference-context reference-context-agent cclab/changes/reference-context-agent/payloads/create-reference-context.json
```