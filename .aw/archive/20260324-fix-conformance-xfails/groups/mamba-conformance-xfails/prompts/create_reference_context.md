# Task: Gather Reference Context for Group 'mamba-conformance-xfails' (Change 'fix-conformance-xfails')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/fix-conformance-xfails/groups/mamba-conformance-xfails/pre_clarifications.md`
...
Write file: cclab/changes/fix-conformance-xfails/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context fix-conformance-xfails cclab/changes/fix-conformance-xfails/payloads/create-reference-context.json
```