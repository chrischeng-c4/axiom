# Task: Analyze Spec 'fix-conformance-xfails-spec' for Change 'fix-conformance-xfails'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact fix-conformance-xfails`.
...
1. Read context from `cclab/changes/fix-conformance-xfails/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact fix-conformance-xfails` with scope="fix-conformance-xfails-spec"
...
cclab sdd artifact create-change-spec fix-conformance-xfails <payload_path>
```
