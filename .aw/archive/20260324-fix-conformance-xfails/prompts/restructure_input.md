# Task: Restructure Input for Change 'fix-conformance-xfails'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/fix-conformance-xfails/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/fix-conformance-xfails/user_input.md` — user's original description
...
cclab sdd artifact restructure-input fix-conformance-xfails cclab/changes/fix-conformance-xfails/payloads/restructure-input.json
```