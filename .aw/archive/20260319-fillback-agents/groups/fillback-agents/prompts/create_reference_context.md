# Task: Gather Reference Context for Group 'fillback-agents' (Change 'fillback-agents')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-agent/cclab/changes/fillback-agents/groups/fillback-agents/pre_clarifications.md`
...
cclab sdd artifact create-reference-context fillback-agents cclab/changes/fillback-agents/payloads/create-reference-context.json
```