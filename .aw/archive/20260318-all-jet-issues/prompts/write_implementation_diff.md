# Task: Write Implementation Diff for Change 'all-jet-issues'
...
cclab sdd artifact create-change-implementation all-jet-issues cclab/changes/all-jet-issues/payloads/create-change-implementation.json
```