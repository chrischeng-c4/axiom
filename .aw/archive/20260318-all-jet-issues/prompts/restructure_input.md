# Task: Restructure Input for Change 'all-jet-issues'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/all-jet-issues/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/all-jet-issues/user_input.md` — user's original description
...
cclab sdd artifact restructure-input all-jet-issues cclab/changes/all-jet-issues/payloads/restructure-input.json
```