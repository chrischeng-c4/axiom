# Task: Post-Clarification for Group 'jet-install-optimizations' (Change 'all-jet-issues')
...
1. `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/all-jet-issues/groups/jet-install-optimizations/requirements.md`
2. `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/all-jet-issues/groups/jet-install-optimizations/pre_clarifications.md`
3. `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/all-jet-issues/groups/jet-install-optimizations/reference_context.md`
...
cclab sdd artifact create-post-clarifications all-jet-issues cclab/changes/all-jet-issues/payloads/create-post-clarifications.json
