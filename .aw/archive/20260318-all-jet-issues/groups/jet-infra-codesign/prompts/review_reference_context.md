# Task: Review Reference Context for Group 'jet-infra-codesign' (Change 'all-jet-issues')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/all-jet-issues/groups/jet-infra-codesign/reference_context.md`
