# Task: Review Reference Context for Group 'sdd-execution-modes' (Change 'sdd-execution-modes')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-sdd-mamba-test/cclab/changes/sdd-execution-modes/groups/sdd-execution-modes/reference_context.md`
...
cclab sdd artifact review-reference-context sdd-execution-modes cclab/changes/sdd-execution-modes/payloads/review-reference-context.json
```