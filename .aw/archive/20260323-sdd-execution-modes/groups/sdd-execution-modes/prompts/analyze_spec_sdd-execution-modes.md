# Task: Analyze Spec 'sdd-execution-modes' for Change 'sdd-execution-modes'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact sdd-execution-modes`.
...
1. Read context from `cclab/changes/sdd-execution-modes/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact sdd-execution-modes` with scope="sdd-execution-modes"
...
cclab sdd artifact create-change-spec sdd-execution-modes <payload_path>
```
