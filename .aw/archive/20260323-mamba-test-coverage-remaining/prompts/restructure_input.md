# Task: Restructure Input for Change 'mamba-test-coverage-remaining'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-test/cclab/changes/mamba-test-coverage-remaining/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-test/cclab/changes/mamba-test-coverage-remaining/user_input.md` — user's original description
...
cclab sdd artifact restructure-input mamba-test-coverage-remaining cclab/changes/mamba-test-coverage-remaining/payloads/restructure-input.json
```