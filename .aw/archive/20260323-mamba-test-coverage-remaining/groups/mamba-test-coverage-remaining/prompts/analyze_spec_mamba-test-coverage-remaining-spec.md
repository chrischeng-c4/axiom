# Task: Analyze Spec 'mamba-test-coverage-remaining-spec' for Change 'mamba-test-coverage-remaining'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-test-coverage-remaining`.
...
1. Read context from `cclab/changes/mamba-test-coverage-remaining/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-test-coverage-remaining` with scope="mamba-test-coverage-remaining-spec"
...
cclab sdd artifact create-change-spec mamba-test-coverage-remaining <payload_path>
```
