# Task: Review Reference Context for Group 'mamba-test-coverage-remaining' (Change 'mamba-test-coverage-remaining')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-sdd-mamba-test/cclab/changes/mamba-test-coverage-remaining/groups/mamba-test-coverage-remaining/reference_context.md`
...
cclab sdd artifact review-reference-context mamba-test-coverage-remaining cclab/changes/mamba-test-coverage-remaining/payloads/review-reference-context.json
```