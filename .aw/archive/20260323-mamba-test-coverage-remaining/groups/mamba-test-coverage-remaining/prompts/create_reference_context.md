# Task: Gather Reference Context for Group 'mamba-test-coverage-remaining' (Change 'mamba-test-coverage-remaining')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd-mamba-test/cclab/changes/mamba-test-coverage-remaining/groups/mamba-test-coverage-remaining/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, db-model, design-token, changes]
...
Write file: cclab/changes/mamba-test-coverage-remaining/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context mamba-test-coverage-remaining cclab/changes/mamba-test-coverage-remaining/payloads/create-reference-context.json
```