# Task: Restructure Input for Change '1133-patrol'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chrischeng/projects/wt/mamba/cclab/changes/1133-patrol/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chrischeng/projects/wt/mamba/cclab/changes/1133-patrol/user_input.md` — user's original description
...
cclab sdd artifact restructure-input 1133-patrol cclab/changes/1133-patrol/payloads/restructure-input.json
```