# Task: Review Reference Context for Group 'fix-name-builtin' (Change '1133-patrol')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chrischeng/projects/wt/mamba/cclab/changes/1133-patrol/groups/fix-name-builtin/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chrischeng/projects/wt/mamba/cclab/changes/1133-patrol/groups/fix-name-builtin/reference_context.md`
...
cclab sdd artifact review-reference-context 1133-patrol cclab/changes/1133-patrol/payloads/review-reference-context.json
```