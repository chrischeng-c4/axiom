# Task: Analyze Spec 'name-builtin-init' for Change '1133-patrol'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact 1133-patrol`.
...
1. Read context from `cclab/changes/1133-patrol/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact 1133-patrol` with scope="name-builtin-init"
...
cclab sdd artifact create-change-spec 1133-patrol <payload_path>
```
