# Task: Gather Reference Context for Group 'fix-name-builtin' (Change '1133-patrol')
...
Write file: cclab/changes/1133-patrol/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context 1133-patrol cclab/changes/1133-patrol/payloads/create-reference-context.json
```