...
.../crates/mamba/codegen/jit-refcount.md     | 585 ++++++++++-------
 ...
 crates/mamba/src/lower/hir_to_mir.rs         |  80 ++-
 ...
 30 files changed, 1169 insertions(+), 964 deletions(-)
```
...
+            self.current_stmts.push(MirInst::StoreGlobal { name: name_sym, value: main_vreg });
...
@@ -1685,17 +1695,53 @@ impl<'a> HirToMir<'a> {
...
@@ -2968,6 +3014,20 @@ impl<'a> HirToMir<'a> {
                                 dest, name: *sym, ty: *ty,
                             });
                             dest
+                        } else if self.symbol_table
...
**Summary**: __name__ fix implemented in hir_to_mir.rs. Manually approved after agent timeout.
