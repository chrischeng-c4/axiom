# Task: Analyze Spec 'sdd-config-repo-platform' for Change '1136'
...
2. Read the skeleton via `cclab sdd workflow read-artifact 1136` with scope="sdd-config-repo-platform"
