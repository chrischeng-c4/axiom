# Task: Analyze Spec 'change-merge-git-integration' for Change '1136'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact 1136`.
...
1. Read context from `cclab/changes/1136/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact 1136` with scope="change-merge-git-integration"
...
cclab sdd artifact create-change-spec 1136 <payload_path>
```
