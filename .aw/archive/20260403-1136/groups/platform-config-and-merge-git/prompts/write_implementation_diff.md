# Task: Write Implementation Diff for Change '1136'
...
cclab sdd artifact create-change-implementation 1136 cclab/changes/1136/payloads/create-change-implementation.json
```