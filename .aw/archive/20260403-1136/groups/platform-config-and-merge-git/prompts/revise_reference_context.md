# Task: Revise Reference Context for Group 'platform-config-and-merge-git' (Change '1136')

## Instructions

1. **Read artifact + review feedback**:
   `/Users/chrischeng/projects/wt/sdd/cclab/changes/1136/groups/platform-config-and-merge-git/reference_context.md`
   Focus on the `# Reviews` section — list each issue to address.
2. **Read pre-clarifications** (confirm scope):
   `/Users/chrischeng/projects/wt/sdd/cclab/changes/1136/groups/platform-config-and-merge-git/pre_clarifications.md`
...
cclab sdd artifact revise-reference-context 1136 cclab/changes/1136/payloads/revise-reference-context.json
```