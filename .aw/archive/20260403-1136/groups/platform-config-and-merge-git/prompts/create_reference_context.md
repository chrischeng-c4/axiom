# Task: Gather Reference Context for Group 'platform-config-and-merge-git' (Change '1136')
...
Write file: cclab/changes/1136/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context 1136 cclab/changes/1136/payloads/create-reference-context.json
```