# Task: Review Reference Context for Group 'platform-config-and-merge-git' (Change '1136')
...
cclab sdd artifact review-reference-context 1136 cclab/changes/1136/payloads/review-reference-context.json
```