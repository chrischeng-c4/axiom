# Task: Analyze Spec 'platform-config-repo-spec' for Change '1136'
...
2. Read the skeleton via `cclab sdd workflow read-artifact 1136` with scope="platform-config-repo-spec"
