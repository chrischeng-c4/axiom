# Task: Write Implementation Diff for Change 'mamba-all-support'
...
score artifact create-change-implementation mamba-all-support .score/changes/mamba-all-support/payloads/create-change-implementation.json
```