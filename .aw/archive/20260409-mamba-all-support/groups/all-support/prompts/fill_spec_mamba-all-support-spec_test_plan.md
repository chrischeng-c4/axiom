# Task: Fill Section 'test_plan' for Spec 'mamba-all-support-spec' (Change 'mamba-all-support')
...
3. Write content for the **test_plan** section
...
Run `score artifact create-change-spec` with section="test_plan" and your content.
