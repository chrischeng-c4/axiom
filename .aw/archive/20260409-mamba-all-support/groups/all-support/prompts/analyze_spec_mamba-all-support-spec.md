# Task: Analyze Spec 'mamba-all-support-spec' for Change 'mamba-all-support'

A skeleton has been generated at `.score/changes/mamba-all-support/groups/all-support/specs/mamba-all-support-spec.md`.

**group_id**: `all-support` (pass this to the artifact CLI as `group_id` parameter)
...
1. Read context:
   - Read file: `.score/changes/mamba-all-support/proposal.md` for spec_plan routing
   - Read file: `.score/changes/mamba-all-support/reference_context.md` if no proposal
2. Read the skeleton: `.score/changes/mamba-all-support/groups/all-support/specs/mamba-all-support-spec.md`
...
5. Write a JSON payload file to `.score/changes/mamba-all-support/groups/all-support/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/mamba-all-support/proposal.md
