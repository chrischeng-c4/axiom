# Task: Restructure Input for Change 'mamba-all-support'

## Step 1: Read Input

Read:
- `/Users/chris.cheng/cclab/main/.score/changes/mamba-all-support/user_input.md` — user's description
...
score artifact restructure-input mamba-all-support .score/changes/mamba-all-support/payloads/restructure-input.json
```