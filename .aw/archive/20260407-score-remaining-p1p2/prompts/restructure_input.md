# Task: Restructure Input for Change 'score-remaining-p1p2'
...
score artifact restructure-input score-remaining-p1p2 .score/changes/score-remaining-p1p2/payloads/restructure-input.json
```