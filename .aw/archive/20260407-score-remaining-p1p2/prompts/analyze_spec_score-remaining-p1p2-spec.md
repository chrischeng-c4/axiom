# Task: Analyze Spec 'score-remaining-p1p2-spec' for Change 'score-remaining-p1p2'

A skeleton has been generated at `.score/changes/score-remaining-p1p2/specs/score-remaining-p1p2-spec.md`.
...
1. Read context:
   - Read file: `.score/changes/score-remaining-p1p2/proposal.md` for spec_plan routing
   - Read file: `.score/changes/score-remaining-p1p2/reference_context.md` if no proposal
2. Read the skeleton: `.score/changes/score-remaining-p1p2/specs/score-remaining-p1p2-spec.md`
...
5. Write a JSON payload file to `.score/changes/score-remaining-p1p2/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/score-remaining-p1p2/proposal.md
...
score artifact create-change-spec score-remaining-p1p2 .score/changes/score-remaining-p1p2/payloads/create-change-spec.json
```
