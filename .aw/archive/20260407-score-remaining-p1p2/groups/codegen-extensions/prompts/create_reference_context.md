# Task: Gather Reference Context for Group 'codegen-extensions' (Change 'score-remaining-p1p2')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/wt/conductor/.score/changes/score-remaining-p1p2/groups/codegen-extensions/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, state-machine, async-api, changes]
