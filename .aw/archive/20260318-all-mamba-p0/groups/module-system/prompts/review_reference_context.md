# Task: Review Reference Context for Group 'module-system' (Change 'all-mamba-p0')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/all-mamba-p0/groups/module-system/reference_context.md`
