# Task: Review Reference Context for Group 'bigint-fallback' (Change 'all-mamba-p0')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/all-mamba-p0/groups/bigint-fallback/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/all-mamba-p0/groups/bigint-fallback/reference_context.md`
