# Task: Gather Reference Context for Group 'builtins-conformance' (Change 'all-mamba-p0')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/all-mamba-p0/groups/builtins-conformance/pre_clarifications.md`
