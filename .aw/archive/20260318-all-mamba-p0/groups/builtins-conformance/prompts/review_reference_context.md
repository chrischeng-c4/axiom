# Task: Review Reference Context for Group 'builtins-conformance' (Change 'all-mamba-p0')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/all-mamba-p0/groups/builtins-conformance/reference_context.md`
