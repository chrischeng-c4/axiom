# Task: Restructure Input for Change 'all-mamba-p0'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/all-mamba-p0/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-mamba/cclab/changes/all-mamba-p0/user_input.md` — user's original description
...
cclab sdd artifact restructure-input all-mamba-p0 cclab/changes/all-mamba-p0/payloads/restructure-input.json
```