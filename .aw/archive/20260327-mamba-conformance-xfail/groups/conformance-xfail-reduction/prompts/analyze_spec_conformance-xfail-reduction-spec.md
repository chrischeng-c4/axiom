# Task: Analyze Spec 'conformance-xfail-reduction-spec' for Change 'mamba-conformance-xfail'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-conformance-xfail`.
...
1. Read context from `cclab/changes/mamba-conformance-xfail/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-conformance-xfail` with scope="conformance-xfail-reduction-spec"
...
cclab sdd artifact create-change-spec mamba-conformance-xfail <payload_path>
```
