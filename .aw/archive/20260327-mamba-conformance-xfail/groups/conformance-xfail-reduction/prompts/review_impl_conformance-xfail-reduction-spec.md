# Task: Review Implementation of Spec 'conformance-xfail-reduction-spec' for Change 'mamba-conformance-xfail'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `cclab/changes/mamba-conformance-xfail/groups/conformance-xfail-reduction/specs/conformance-xfail-reduction-spec.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `cclab/changes/mamba-conformance-xfail/implementation.md`
4. List changed files via `cclab sdd workflow list-changed-files mamba-conformance-xfail`
...
Read file: cclab/changes/mamba-conformance-xfail/implementation.md

# List changed files
cclab sdd workflow list-changed-files mamba-conformance-xfail

# Write review (write payload JSON first, then run)
cclab sdd artifact review-change-implementation mamba-conformance-xfail cclab/changes/mamba-conformance-xfail/payloads/review-change-implementation.json
```