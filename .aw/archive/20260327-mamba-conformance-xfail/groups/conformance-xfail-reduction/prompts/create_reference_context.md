# Task: Gather Reference Context for Group 'conformance-xfail-reduction' (Change 'mamba-conformance-xfail')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-conformance-xfail/groups/conformance-xfail-reduction/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, pipeline, changes]
...
- List specs under `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/specs/` using Glob
...
Write file: cclab/changes/mamba-conformance-xfail/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context mamba-conformance-xfail cclab/changes/mamba-conformance-xfail/payloads/create-reference-context.json
```