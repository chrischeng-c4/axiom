# Task: Review Reference Context for Group 'stdlib-main-module' (Change 'mamba-stdlib-main')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/main/.score/changes/mamba-stdlib-main/groups/stdlib-main-module/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/main/.score/changes/mamba-stdlib-main/groups/stdlib-main-module/reference_context.md`
...
score artifact review-reference-context mamba-stdlib-main .score/changes/mamba-stdlib-main/payloads/review-reference-context.json
```