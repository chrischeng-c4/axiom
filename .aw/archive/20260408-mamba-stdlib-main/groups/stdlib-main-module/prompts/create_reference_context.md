# Task: Gather Reference Context for Group 'stdlib-main-module' (Change 'mamba-stdlib-main')
...
Write file: .score/changes/mamba-stdlib-main/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
score artifact create-reference-context mamba-stdlib-main .score/changes/mamba-stdlib-main/payloads/create-reference-context.json
```