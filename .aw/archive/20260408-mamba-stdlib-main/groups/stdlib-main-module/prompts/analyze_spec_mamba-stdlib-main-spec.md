# Task: Analyze Spec 'mamba-stdlib-main-spec' for Change 'mamba-stdlib-main'

A skeleton has been generated at `.score/changes/mamba-stdlib-main/groups/stdlib-main-module/specs/mamba-stdlib-main-spec.md`.

**group_id**: `stdlib-main-module` (pass this to the artifact CLI as `group_id` parameter)
...
1. Read context:
   - Read file: `.score/changes/mamba-stdlib-main/proposal.md` for spec_plan routing
   - Read file: `.score/changes/mamba-stdlib-main/reference_context.md` if no proposal
2. Read the skeleton: `.score/changes/mamba-stdlib-main/groups/stdlib-main-module/specs/mamba-stdlib-main-spec.md`
...
5. Write a JSON payload file to `.score/changes/mamba-stdlib-main/groups/stdlib-main-module/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/mamba-stdlib-main/proposal.md
...
score artifact create-change-spec mamba-stdlib-main .score/changes/mamba-stdlib-main/groups/stdlib-main-module/payloads/create-change-spec.json
```
