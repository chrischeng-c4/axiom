# Task: Analyze Spec 'sdd-tdd-gate-spec' for Change 'sdd-tdd-gate'

A skeleton has been generated at `.score/changes/sdd-tdd-gate/specs/sdd-tdd-gate-spec.md`.
...
1. Read context:
   - Read file: `.score/changes/sdd-tdd-gate/proposal.md` for spec_plan routing
   - Read file: `.score/changes/sdd-tdd-gate/reference_context.md` if no proposal
2. Read the skeleton: `.score/changes/sdd-tdd-gate/specs/sdd-tdd-gate-spec.md`
...
5. Write a JSON payload file to `.score/changes/sdd-tdd-gate/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/sdd-tdd-gate/proposal.md
...
score artifact create-change-spec sdd-tdd-gate .score/changes/sdd-tdd-gate/payloads/create-change-spec.json
```
