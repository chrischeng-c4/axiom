# Task: Restructure Input for Change 'sdd-tdd-gate'
...
score artifact restructure-input sdd-tdd-gate .score/changes/sdd-tdd-gate/payloads/restructure-input.json
```