# Task: Gather Reference Context for Group 'tdd-workflow-gate' (Change 'sdd-tdd-gate')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/main/.score/changes/sdd-tdd-gate/groups/tdd-workflow-gate/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, state-machine, prompt, logic, dependency, interaction, cli, config, test-fixture, test-plan, changes]
