# Task: Review Reference Context for Group 'tdd-workflow-gate' (Change 'sdd-tdd-gate')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/main/.score/changes/sdd-tdd-gate/groups/tdd-workflow-gate/reference_context.md`
