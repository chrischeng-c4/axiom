# Task: Review Reference Context for Group 'test-config' (Change 'sdd-tdd-gate')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/main/.score/changes/sdd-tdd-gate/groups/test-config/reference_context.md`
...
score artifact review-reference-context sdd-tdd-gate .score/changes/sdd-tdd-gate/payloads/review-reference-context.json
```