# Task: Restructure Input for Change 'mamba-refcount-jit'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-refcount-jit/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-refcount-jit/user_input.md` — user's original description
...
cclab sdd artifact restructure-input mamba-refcount-jit cclab/changes/mamba-refcount-jit/payloads/restructure-input.json
```