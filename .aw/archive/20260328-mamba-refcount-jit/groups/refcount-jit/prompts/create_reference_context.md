# Task: Gather Reference Context for Group 'refcount-jit' (Change 'mamba-refcount-jit')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd-mamba-conformance/cclab/changes/mamba-refcount-jit/groups/refcount-jit/pre_clarifications.md`
...
Write file: cclab/changes/mamba-refcount-jit/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context mamba-refcount-jit cclab/changes/mamba-refcount-jit/payloads/create-reference-context.json
```