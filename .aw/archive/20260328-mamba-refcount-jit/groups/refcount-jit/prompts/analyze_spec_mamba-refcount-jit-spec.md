# Task: Analyze Spec 'mamba-refcount-jit-spec' for Change 'mamba-refcount-jit'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact mamba-refcount-jit`.
...
1. Read context from `cclab/changes/mamba-refcount-jit/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact mamba-refcount-jit` with scope="mamba-refcount-jit-spec"
...
cclab sdd artifact create-change-spec mamba-refcount-jit <payload_path>
```
