# Task: Restructure Input for Change 'enhanced-changes-section'
...
cclab sdd artifact restructure-input enhanced-changes-section cclab/changes/enhanced-changes-section/payloads/restructure-input.json
```