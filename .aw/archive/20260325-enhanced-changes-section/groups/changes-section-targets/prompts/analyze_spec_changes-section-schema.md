# Task: Analyze Spec 'changes-section-schema' for Change 'enhanced-changes-section'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact enhanced-changes-section`.
...
1. Read context from `cclab/changes/enhanced-changes-section/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact enhanced-changes-section` with scope="changes-section-schema"
...
cclab sdd artifact create-change-spec enhanced-changes-section <payload_path>
```
