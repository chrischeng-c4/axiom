# Task: Gather Reference Context for Group 'changes-section-targets' (Change 'enhanced-changes-section')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/enhanced-changes-section/groups/changes-section-targets/pre_clarifications.md`
...
Write file: cclab/changes/enhanced-changes-section/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context enhanced-changes-section cclab/changes/enhanced-changes-section/payloads/create-reference-context.json
```