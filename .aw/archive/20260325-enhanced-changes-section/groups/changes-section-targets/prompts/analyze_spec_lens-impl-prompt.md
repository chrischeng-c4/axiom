# Task: Analyze Spec 'lens-impl-prompt' for Change 'enhanced-changes-section'
...
2. Read the skeleton via `cclab sdd workflow read-artifact enhanced-changes-section` with scope="lens-impl-prompt"
