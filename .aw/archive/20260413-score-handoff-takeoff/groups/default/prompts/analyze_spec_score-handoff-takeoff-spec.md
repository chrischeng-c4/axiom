# Task: Analyze Spec 'score-handoff-takeoff-spec' for Change 'score-handoff-takeoff'

A skeleton has been generated at `.score/changes/score-handoff-takeoff/groups/default/specs/score-handoff-takeoff-spec.md`.
...
1. Read context:
   - Read file: `.score/changes/score-handoff-takeoff/proposal.md` for spec_plan routing
   - Read file: `.score/changes/score-handoff-takeoff/reference_context.md` if no proposal
2. Read the skeleton: `.score/changes/score-handoff-takeoff/groups/default/specs/score-handoff-takeoff-spec.md`
...
5. Write a JSON payload file to `.score/changes/score-handoff-takeoff/groups/default/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/score-handoff-takeoff/proposal.md
