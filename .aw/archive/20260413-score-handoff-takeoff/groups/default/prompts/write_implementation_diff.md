# Task: Write Implementation Diff for Change 'score-handoff-takeoff'
...
score artifact create-change-implementation score-handoff-takeoff .score/changes/score-handoff-takeoff/payloads/create-change-implementation.json
```