# Task: Write Implementation Diff for Change 'all-issues'
...
cclab sdd artifact create-change-implementation all-issues cclab/changes/all-issues/payloads/create-change-implementation.json
```