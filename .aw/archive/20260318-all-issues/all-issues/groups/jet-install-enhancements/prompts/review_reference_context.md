# Task: Review Reference Context for Group 'jet-install-enhancements' (Change 'all-issues')
...
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/all-issues/groups/jet-install-enhancements/reference_context.md`
...
cclab sdd artifact review-reference-context all-issues cclab/changes/all-issues/payloads/review-reference-context.json
```