# Task: Review Reference Context for Group 'jet-build-production' (Change 'all-issues')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/all-issues/groups/jet-build-production/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/all-issues/groups/jet-build-production/reference_context.md`
