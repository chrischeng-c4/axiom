# Task: Analyze Spec 'bug-init-change-writes-score-changes-to-main-repo-inst-spec' for Change 'bug-init-change-writes-score-changes-to-main-repo-inst'

A skeleton has been generated at `.score/changes/bug-init-change-writes-score-changes-to-main-repo-inst/groups/default/specs/bug-init-change-writes-score-changes-to-main-repo-inst-spec.md`.

**group_id**: `default` (pass this to the artifact CLI as `group_id` parameter)
...
1. Read context:
   - Read file: `.score/changes/bug-init-change-writes-score-changes-to-main-repo-inst/proposal.md` for spec_plan routing
   - Read file: `.score/changes/bug-init-change-writes-score-changes-to-main-repo-inst/reference_context.md` if no proposal
2. Read the skeleton: `.score/changes/bug-init-change-writes-score-changes-to-main-repo-inst/groups/default/specs/bug-init-change-writes-score-changes-to-main-repo-inst-spec.md`
...
5. Write a JSON payload file to `.score/changes/bug-init-change-writes-score-changes-to-main-repo-inst/groups/default/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/bug-init-change-writes-score-changes-to-main-repo-inst/proposal.md
...
score artifact create-change-spec bug-init-change-writes-score-changes-to-main-repo-inst .score/changes/bug-init-change-writes-score-changes-to-main-repo-inst/groups/default/payloads/create-change-spec.json
```
