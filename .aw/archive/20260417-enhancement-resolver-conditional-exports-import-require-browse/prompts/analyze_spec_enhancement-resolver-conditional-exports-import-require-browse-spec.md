...
A skeleton has been generated at `.score/changes/enhancement-resolver-conditional-exports-import-require-browse/specs/enhancement-resolver-conditional-exports-import-require-browse-spec.md`.
...
2. Read the skeleton: `.score/changes/enhancement-resolver-conditional-exports-import-require-browse/specs/enhancement-resolver-conditional-exports-import-require-browse-spec.md`
...
4. Decide which sections to fill based on the nature of the change. Pick ONLY leaf section names from this list — NEVER pass umbrella words like `diagrams`, `api_spec`, or `test_plan`:
   ...
   Docs: `doc`
5. Write a JSON payload file to `.score/changes/enhancement-resolver-conditional-exports-import-require-browse/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/enhancement-resolver-conditional-exports-import-require-browse/proposal.md
...
score artifact create-change-spec enhancement-resolver-conditional-exports-import-require-browse .score/changes/enhancement-resolver-conditional-exports-import-require-browse/payloads/create-change-spec.json
```
