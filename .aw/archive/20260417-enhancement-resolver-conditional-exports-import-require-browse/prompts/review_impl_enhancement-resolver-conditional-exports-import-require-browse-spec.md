...
1. Read spec: `.score/changes/enhancement-resolver-conditional-exports-import-require-browse/specs/enhancement-resolver-conditional-exports-import-require-browse-spec.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `.score/changes/enhancement-resolver-conditional-exports-import-require-browse/implementation.md`
...
Read file: .score/changes/enhancement-resolver-conditional-exports-import-require-browse/implementation.md
...
score artifact review-change-implementation enhancement-resolver-conditional-exports-import-require-browse .score/changes/enhancement-resolver-conditional-exports-import-require-browse/payloads/review-change-implementation.json
```