# Task: Review Implementation of Spec 'enhancement-native-trace-viewer-trace-capture-standalone-html-spec' for Change 'enhancement-native-trace-viewer-trace-capture-standalone-html'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `.score/changes/enhancement-native-trace-viewer-trace-capture-standalone-html/specs/enhancement-native-trace-viewer-trace-capture-standalone-html-spec.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `.score/changes/enhancement-native-trace-viewer-trace-capture-standalone-html/implementation.md`
4. List changed files via `score workflow list-changed-files enhancement-native-trace-viewer-trace-capture-standalone-html`
...
Read file: .score/changes/enhancement-native-trace-viewer-trace-capture-standalone-html/implementation.md

# List changed files
score workflow list-changed-files enhancement-native-trace-viewer-trace-capture-standalone-html

# Write review (write payload JSON first, then run)
score artifact review-change-implementation enhancement-native-trace-viewer-trace-capture-standalone-html .score/changes/enhancement-native-trace-viewer-trace-capture-standalone-html/payloads/review-change-implementation.json
```