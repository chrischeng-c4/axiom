# Task: Gather Reference Context for Group 'lens-dissolution' (Change 'lens-dissolution')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-sdd/cclab/changes/lens-dissolution/groups/lens-dissolution/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, schema, model, logic, dependency, interaction, rpc-api, cli, pipeline, test-plan, changes]
...
### cclab-lens
- `read_path:specs/crates/cclab-lens/README.md`
- `read_path:specs/crates/cclab-lens/analysis-tools.md`
- `read_path:specs/crates/cclab-lens/cclab-lens-spec.md`
- `read_path:specs/crates/cclab-lens/class-diagram.md`
- `read_path:specs/crates/cclab-lens/code-analysis-service-v2.md`
- `read_path:specs/crates/cclab-lens/lens-beyond-ide.md`
- `read_path:specs/crates/cclab-lens/lens-cli-subcommands.md`
- `read_path:specs/crates/cclab-lens/lens-codegen-unification.md`
- `read_path:specs/crates/cclab-lens/lens-comprehensive.md`
- `read_path:specs/crates/cclab-lens/lens-full-upgrade-spec.md`
- `read_path:specs/crates/cclab-lens/lens-index-storage.md`
- `read_path:specs/crates/cclab-lens/lens-lang-support.md`
- `read_path:specs/crates/cclab-lens/lens-markdown.md`
- `read_path:specs/crates/cclab-lens/lens-pdg-mcp-tools.md`
- `read_path:specs/crates/cclab-lens/lens-yaml-codegen.md`
- `read_path:specs/crates/cclab-lens/python-pdg-core.md`
- `read_path:specs/crates/cclab-lens/refactoring-api.md`
- `read_path:specs/crates/cclab-lens/rust-symbol-analysis.md`
- `read_path:specs/crates/cclab-lens/semantic-search-api.md`
- `read_path:specs/crates/cclab-lens/usage-examples.md`
...
Write file: cclab/changes/lens-dissolution/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context lens-dissolution cclab/changes/lens-dissolution/payloads/create-reference-context.json
```