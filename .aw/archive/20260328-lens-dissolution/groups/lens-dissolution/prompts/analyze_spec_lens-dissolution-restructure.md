# Task: Analyze Spec 'lens-dissolution-restructure' for Change 'lens-dissolution'
...
2. Read the skeleton via `cclab sdd workflow read-artifact lens-dissolution` with scope="lens-dissolution-restructure"
