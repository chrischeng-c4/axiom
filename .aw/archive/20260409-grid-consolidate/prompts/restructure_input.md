# Task: Restructure Input for Change 'grid-consolidate'
...
score artifact restructure-input grid-consolidate .score/changes/grid-consolidate/payloads/restructure-input.json
```