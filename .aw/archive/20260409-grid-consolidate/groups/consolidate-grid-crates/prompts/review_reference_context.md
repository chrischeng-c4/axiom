# Task: Review Reference Context for Group 'consolidate-grid-crates' (Change 'grid-consolidate')
...
score artifact review-reference-context grid-consolidate .score/changes/grid-consolidate/payloads/review-reference-context.json
```