# Task: Revise Reference Context for Group 'consolidate-grid-crates' (Change 'grid-consolidate')

## Instructions

1. **Read artifact + review feedback**:
   `/Users/chris.cheng/cclab/main/.score/changes/grid-consolidate/groups/consolidate-grid-crates/reference_context.md`
...
score artifact revise-reference-context grid-consolidate .score/changes/grid-consolidate/payloads/revise-reference-context.json
```