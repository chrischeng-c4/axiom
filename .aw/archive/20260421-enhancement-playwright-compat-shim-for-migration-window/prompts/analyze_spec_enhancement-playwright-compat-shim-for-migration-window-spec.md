# Task: Analyze Spec 'enhancement-playwright-compat-shim-for-migration-window-spec' for Change 'enhancement-playwright-compat-shim-for-migration-window'

A skeleton has been generated at `.score/changes/enhancement-playwright-compat-shim-for-migration-window/specs/enhancement-playwright-compat-shim-for-migration-window-spec.md`.
...
2. Read the skeleton: `.score/changes/enhancement-playwright-compat-shim-for-migration-window/specs/enhancement-playwright-compat-shim-for-migration-window-spec.md`
...
4. Decide which sections to fill based on the nature of the change. Pick ONLY leaf section names from this list — NEVER pass umbrella words like `diagrams`, `api_spec`, or `test_plan`:
   ...
   Docs: `doc`
5. Write a JSON payload file to `.score/changes/enhancement-playwright-compat-shim-for-migration-window/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .score/changes/enhancement-playwright-compat-shim-for-migration-window/proposal.md
