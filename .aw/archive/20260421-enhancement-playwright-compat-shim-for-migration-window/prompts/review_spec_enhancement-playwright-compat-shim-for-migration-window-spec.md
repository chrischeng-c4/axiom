# Task: Review Spec 'enhancement-playwright-compat-shim-for-migration-window-spec' for Change 'enhancement-playwright-compat-shim-for-migration-window'

## Instructions

1. **Run automated validation**:
   `score workflow validate-spec-completeness enhancement-playwright-compat-shim-for-migration-window --spec-id enhancement-playwright-compat-shim-for-migration-window-spec`
2. **Read the spec**:
   `.score/changes/enhancement-playwright-compat-shim-for-migration-window/specs/enhancement-playwright-compat-shim-for-migration-window-spec.md`
...
score artifact review-change-spec enhancement-playwright-compat-shim-for-migration-window .score/changes/enhancement-playwright-compat-shim-for-migration-window/payloads/review-change-spec.json
```