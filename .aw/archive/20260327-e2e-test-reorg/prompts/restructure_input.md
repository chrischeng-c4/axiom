# Task: Restructure Input for Change 'e2e-test-reorg'
...
cclab sdd artifact restructure-input e2e-test-reorg cclab/changes/e2e-test-reorg/payloads/restructure-input.json
```