# Task: Analyze Spec 'e2e-test-infrastructure' for Change 'e2e-test-reorg'

A skeleton has been generated. Find it via `cclab sdd workflow read-artifact e2e-test-reorg`.
...
1. Read context from `cclab/changes/e2e-test-reorg/proposal.md` or `reference_context.md`
2. Read the skeleton via `cclab sdd workflow read-artifact e2e-test-reorg` with scope="e2e-test-infrastructure"
...
cclab sdd artifact create-change-spec e2e-test-reorg <payload_path>
```
