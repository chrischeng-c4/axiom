# Task: Gather Reference Context for Group 'e2e-test-reorg' (Change 'e2e-test-reorg')
...
1. **Understand scope**: Read group pre-clarifications to identify which crates/areas are in scope:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/e2e-test-reorg/groups/e2e-test-reorg/pre_clarifications.md`
...
Based on keyword analysis of requirements: [overview, state-machine, logic, dependency, interaction, config, pipeline, e2e-scenario, test-fixture, test-plan, changes]
...
- List specs under `/Users/chris.cheng/cclab/cclab-jet/cclab/specs/` using Glob
...
Write file: cclab/changes/e2e-test-reorg/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context e2e-test-reorg cclab/changes/e2e-test-reorg/payloads/create-reference-context.json
```