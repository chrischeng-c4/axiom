# Task: Review Reference Context for Group 'jet-build-real-world-validation' (Change 'all-open-jet-issues')

## Instructions

1. **Read pre-clarifications** (scope & requirements):
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/all-open-jet-issues/groups/jet-build-real-world-validation/pre_clarifications.md`
2. **Read the reference context artifact**:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/all-open-jet-issues/groups/jet-build-real-world-validation/reference_context.md`
...
cclab sdd artifact review-reference-context all-open-jet-issues cclab/changes/all-open-jet-issues/payloads/review-reference-context.json
```