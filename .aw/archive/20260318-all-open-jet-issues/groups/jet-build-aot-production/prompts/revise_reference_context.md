# Task: Revise Reference Context for Group 'jet-build-aot-production' (Change 'all-open-jet-issues')

## Instructions

1. **Read artifact + review feedback**:
   `/Users/chris.cheng/cclab/cclab-jet/cclab/changes/all-open-jet-issues/groups/jet-build-aot-production/reference_context.md`
...
cclab sdd artifact revise-reference-context all-open-jet-issues cclab/changes/all-open-jet-issues/payloads/revise-reference-context.json
```