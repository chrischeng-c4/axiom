# Task: Write Implementation Diff for Change 'all-open-jet-issues'
...
cclab sdd artifact create-change-implementation all-open-jet-issues cclab/changes/all-open-jet-issues/payloads/create-change-implementation.json
```