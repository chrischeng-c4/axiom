# Task: Gather Reference Context for Group 'string-reverse-slice' (Change 'mamba-string-reverse-slice')

Issues: #1111_fix-mamba-string-reverse-slice-1-returns-empty-str
...
Write file: cclab/changes/mamba-string-reverse-slice/payloads/create-reference-context.json

# Step 2: Run artifact CLI (MUST use this — do NOT write reference_context.md directly)
cclab sdd artifact create-reference-context mamba-string-reverse-slice cclab/changes/mamba-string-reverse-slice/payloads/create-reference-context.json
```