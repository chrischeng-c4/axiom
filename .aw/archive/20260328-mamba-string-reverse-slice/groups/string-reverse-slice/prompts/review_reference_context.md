# Task: Review Reference Context for Group 'string-reverse-slice' (Change 'mamba-string-reverse-slice')
...
cclab sdd artifact review-reference-context mamba-string-reverse-slice cclab/changes/mamba-string-reverse-slice/payloads/review-reference-context.json
```