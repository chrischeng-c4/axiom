# Task: Write Implementation Diff for Change 'mamba-string-reverse-slice'
...
cclab sdd artifact create-change-implementation mamba-string-reverse-slice cclab/changes/mamba-string-reverse-slice/payloads/create-change-implementation.json
```