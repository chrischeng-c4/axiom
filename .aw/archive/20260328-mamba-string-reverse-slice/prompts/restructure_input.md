# Task: Restructure Input for Change 'mamba-string-reverse-slice'

## Step 1: Read Issues

Read these files using the Read tool:
- `/Users/chrischeng/projects/cclab-sdd/cclab/changes/mamba-string-reverse-slice/issues/issue_*.md` — each issue's title, body, and labels
- `/Users/chrischeng/projects/cclab-sdd/cclab/changes/mamba-string-reverse-slice/user_input.md` — user's original description
...
cclab sdd artifact restructure-input mamba-string-reverse-slice cclab/changes/mamba-string-reverse-slice/payloads/restructure-input.json
```