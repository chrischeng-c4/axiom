...
version: 1
spec_type: algorithm
created_at: 2026-01-30T04:25:53.479970+00:00
updated_at: 2026-01-30T04:25:53.479970+00:00
requirements:
  total: 6
  ids:
    - R1
...
history:
  - timestamp: 2026-01-30T04:25:53.479970+00:00
    agent: "mcp"
    tool: "create_spec"
    action: "created"
---
...
- **WHEN** The text "我来到北京清华大学" is tokenized in Precise mode.
- **THEN** The result should be ["我", "来到", "北京", "清华大学"].

### Scenario: HMM Recognition of Unknown Words

- **WHEN** The text "杭研大厦" is tokenized and "杭研" is not in the dictionary.
...
- **WHEN** TF-IDF extraction is run on "我来到北京清华大学" with topK=2.
...
flowchart TB
    ...
    InputText -->|Read Text| BuildDAG
    BuildDAG -->|Find Paths| CalcPathProb
    CalcPathProb -->|Max Probability| RouteSelection
