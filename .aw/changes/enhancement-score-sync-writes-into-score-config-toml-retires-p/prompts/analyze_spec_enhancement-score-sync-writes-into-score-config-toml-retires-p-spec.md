# Task: Analyze Spec 'enhancement-score-sync-writes-into-score-config-toml-retires-p-spec' for Change 'enhancement-score-sync-writes-into-score-config-toml-retires-p'

A skeleton has been generated at `.aw/changes/enhancement-score-sync-writes-into-score-config-toml-retires-p/specs/enhancement-score-sync-writes-into-score-config-toml-retires-p-spec.md`.
...
2. Read the skeleton: `.aw/changes/enhancement-score-sync-writes-into-score-config-toml-retires-p/specs/enhancement-score-sync-writes-into-score-config-toml-retires-p-spec.md`
...
4. Decide which sections to fill based on the nature of the change. Pick ONLY leaf section names from this list — NEVER pass umbrella words like `diagrams`, `api_spec`, or `test_plan`:
   ...
   Docs: `doc`
5. Write a JSON payload file to `.aw/changes/enhancement-score-sync-writes-into-score-config-toml-retires-p/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .aw/changes/enhancement-score-sync-writes-into-score-config-toml-retires-p/proposal.md
...
score artifact create-change-spec enhancement-score-sync-writes-into-score-config-toml-retires-p .aw/changes/enhancement-score-sync-writes-into-score-config-toml-retires-p/payloads/create-change-spec.json
```
