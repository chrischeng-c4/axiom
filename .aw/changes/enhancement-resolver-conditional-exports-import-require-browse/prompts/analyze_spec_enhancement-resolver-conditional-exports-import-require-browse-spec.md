# Task: Analyze Spec 'enhancement-resolver-conditional-exports-import-require-browse-spec' for Change 'enhancement-resolver-conditional-exports-import-require-browse'

A skeleton has been generated at `.aw/changes/enhancement-resolver-conditional-exports-import-require-browse/specs/enhancement-resolver-conditional-exports-import-require-browse-spec.md`.
...
1. Read context:
   - Read the issue file in `.aw/issues/open/` that initiated this change (see user_input.md for the slug)
   - The issue's ## Problem, ## Requirements, ## Scope, and ## Reference Context sections are your primary context
2. Read the skeleton: `.aw/changes/enhancement-resolver-conditional-exports-import-require-browse/specs/enhancement-resolver-conditional-exports-import-require-browse-spec.md`
...
4. Decide which sections to fill based on the nature of the change. Pick ONLY leaf section names from this list — NEVER pass umbrella words like `diagrams`, `api_spec`, or `test_plan`:
   ...
   Docs: `doc`
5. Write a JSON payload file to `.aw/changes/enhancement-resolver-conditional-exports-import-require-browse/payloads/create-change-spec.json` then run the artifact CLI.
...
```
# Read artifacts
Read file: .aw/changes/enhancement-resolver-conditional-exports-import-require-browse/proposal.md
