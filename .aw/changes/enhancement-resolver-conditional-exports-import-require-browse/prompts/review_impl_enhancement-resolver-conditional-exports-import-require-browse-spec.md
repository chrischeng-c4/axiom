# Task: Review Implementation of Spec 'enhancement-resolver-conditional-exports-import-require-browse-spec' for Change 'enhancement-resolver-conditional-exports-import-require-browse'

## Pre-Review Step (MANDATORY)

Before evaluating any checklist items:
1. Read spec: `.aw/changes/enhancement-resolver-conditional-exports-import-require-browse/specs/enhancement-resolver-conditional-exports-import-require-browse-spec.md`
2. Find the `## Test Plan` section (if present) and note whether it exists and how many test cases it defines.

## Instructions

3. Read implementation diff: `.aw/changes/enhancement-resolver-conditional-exports-import-require-browse/implementation.md`
4. List changed files via `score workflow list-changed-files enhancement-resolver-conditional-exports-import-require-browse`
...
Read file: .aw/changes/enhancement-resolver-conditional-exports-import-require-browse/implementation.md

# List changed files
score workflow list-changed-files enhancement-resolver-conditional-exports-import-require-browse

# Write review (write payload JSON first, then run)
score artifact review-change-implementation enhancement-resolver-conditional-exports-import-require-browse .aw/changes/enhancement-resolver-conditional-exports-import-require-browse/payloads/review-change-implementation.json
```