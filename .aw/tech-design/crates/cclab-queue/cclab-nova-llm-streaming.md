...
Unified streaming interface and multi-provider support (Claude, OpenAI, Gemini) for cclab-nova-llm and cclab Python bindings. This spec covers the internal Rust implementation and the exposure to Python.
...
Implement PyStreamResponse in cclab/src/agent/py_llm.rs as a Python AsyncIterator.
...
Expose Claude and Gemini providers to Python-compatible callers and implement complete_stream in Mamba bindings.
