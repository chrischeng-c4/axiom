---
id: projects-jet-logic-worker-pool-md
...
```yaml
changes:
  - path: ".aw/tech-design/projects/jet/logic/worker-pool.md"
    action: modify
    section: doc
...
changes:
  ...
  - path: .aw/tech-design/crates/jet/logic/worker-pool.md
    action: add
    section: doc
    impl_mode: hand-written
...
- Spec: `.aw/changes/enhancement-parallel-test-execution-sharding-for-native-test-r/specs/enhancement-parallel-test-execution-sharding-for-native-test-r-spec.md`
