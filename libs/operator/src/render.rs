// SPEC-MANAGED: libs/operator/tech-design/semantic/source/libs-operator-src-render-rs.md#rust-source-unit
// CODEGEN-BEGIN
...
/// @spec libs/operator/tech-design/semantic/source/libs-operator-src-render-rs.md#source
