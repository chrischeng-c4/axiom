---
id: libs-raft-host-src-llm-rs
summary: Lossless rust-source-unit coverage for `libs/raft-host/src/llm.rs`.
capability_refs:
...
# Standardized libs/raft-host/src/llm.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/raft-host/src/llm.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TOPIC` | libs/raft-host/src/llm.rs | const | pub | 4 | pub const TOPIC: cli_std::llm::Topic = cli_std::llm::Topic { |
| `topic` | libs/raft-host/src/llm.rs | function | pub | 54 | pub fn topic() -> &'static cli_std::llm::Topic { |
...
changes:
  - path: "libs/raft-host/src/llm.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/raft-host/src/llm.rs` captured during libs codegen standardization.
```
