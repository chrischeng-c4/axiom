---
id: libs-raft-host-src-cluster-rs
summary: Lossless rust-source-unit coverage for `libs/raft-host/src/cluster.rs`.
capability_refs:
...
# Standardized libs/raft-host/src/cluster.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/raft-host/src/cluster.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `replica_mode` | libs/raft-host/src/cluster.rs | function | pub | 18 | pub fn replica_mode() -> bool { |
| `ClusterDims` | libs/raft-host/src/cluster.rs | struct | pub | 32 | pub struct ClusterDims { |
| `from_env` | libs/raft-host/src/cluster.rs | function | pub | 41 | pub fn from_env() -> Result<Self> { |
| `pod_ordinal` | libs/raft-host/src/cluster.rs | function | pub | 51 | pub fn pod_ordinal(&self) -> Result<u32> { |
| `shard_index` | libs/raft-host/src/cluster.rs | function | pub | 62 | pub fn shard_index(&self) -> Result<u32> { |
| `replica_index` | libs/raft-host/src/cluster.rs | function | pub | 68 | pub fn replica_index(&self) -> Result<u32> { |
| `is_voter` | libs/raft-host/src/cluster.rs | function | pub | 74 | pub fn is_voter(&self) -> Result<bool> { |
| `peer_ordinal` | libs/raft-host/src/cluster.rs | function | pub | 83 | pub fn peer_ordinal(shard_count: u32, shard_index: u32, replica: u32) -> u32 { |
| `parse_peer_overrides` | libs/raft-host/src/cluster.rs | function | pub | 92 | pub fn parse_peer_overrides(env_var: &str) -> Vec<String> { |
| `ClusterTopology` | libs/raft-host/src/cluster.rs | struct | pub | 106 | pub struct ClusterTopology { |
...
changes:
  - path: "libs/raft-host/src/cluster.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/raft-host/src/cluster.rs` captured during libs codegen standardization.
```
