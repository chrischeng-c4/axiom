// SPEC-MANAGED: libs/raft-host/tech-design/semantic/source/libs-raft-host-src-config-rs.md#rust-source-unit
// CODEGEN-BEGIN
...
/// @spec libs/raft-host/tech-design/semantic/source/libs-raft-host-src-config-rs.md#source
