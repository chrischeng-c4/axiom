---
id: libs-openapi-codegen-src-emit-rust-client-emit-rs
summary: Lossless rust-source-unit coverage for `libs/openapi-codegen/src/emit/rust/client_emit.rs`.
capability_refs:
...
# Standardized libs/openapi-codegen/src/emit/rust/client_emit.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/openapi-codegen/src/emit/rust/client_emit.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `HEADER` | libs/openapi-codegen/src/emit/rust/client_emit.rs | const | pub | 10 | pub const HEADER: &str = "// Code generated by openapi-codegen. DO NOT EDIT.\n"; |
| `emit` | libs/openapi-codegen/src/emit/rust/client_emit.rs | function | pub | 12 | pub fn emit(ops: &[OperationIR], tm: &TypeMap) -> String { |
| `TransportPolicy` | libs/openapi-codegen/src/emit/rust/client_emit.rs | struct | pub | 23 | out.push_str("pub struct TransportPolicy {\n"); |
| `recommended_h2_connections` | libs/openapi-codegen/src/emit/rust/client_emit.rs | function | pub | 44 | "pub fn recommended_h2_connections(concurrency: usize, parallelism: usize) -> usize {\n", |
| `ClientError` | libs/openapi-codegen/src/emit/rust/client_emit.rs | enum | pub | 51 | out.push_str("pub enum ClientError {\n"); |
| `ClientResult` | libs/openapi-codegen/src/emit/rust/client_emit.rs | type | pub | 74 | out.push_str("pub type ClientResult<T> = std::result::Result<T, ClientError>;\n\n"); |
| `Client` | libs/openapi-codegen/src/emit/rust/client_emit.rs | struct | pub | 86 | out.push_str("pub struct Client {\n"); |
| `new` | libs/openapi-codegen/src/emit/rust/client_emit.rs | function | pub | 93 | out.push_str("    pub fn new(base_url: impl Into<String>) -> Self {\n"); |
| `with_policy` | libs/openapi-codegen/src/emit/rust/client_emit.rs | function | pub | 97 | "    pub fn with_policy(base_url: impl Into<String>, policy: TransportPolicy) -> Self {\n", |
...
/// @spec libs/openapi-codegen/tech-design/semantic/source/libs-openapi-codegen-src-emit-rust-client-emit-rs.md#source
...
changes:
  - path: "libs/openapi-codegen/src/emit/rust/client_emit.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/openapi-codegen/src/emit/rust/client_emit.rs` captured during libs codegen standardization.
```
