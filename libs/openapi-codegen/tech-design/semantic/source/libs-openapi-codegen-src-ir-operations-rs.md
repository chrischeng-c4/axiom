---
id: libs-openapi-codegen-src-ir-operations-rs
summary: Lossless rust-source-unit coverage for `libs/openapi-codegen/src/ir/operations.rs`.
capability_refs:
...
# Standardized libs/openapi-codegen/src/ir/operations.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/openapi-codegen/src/ir/operations.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ParamIR` | libs/openapi-codegen/src/ir/operations.rs | struct | pub | 13 | pub struct ParamIR { |
| `BodyIR` | libs/openapi-codegen/src/ir/operations.rs | struct | pub | 21 | pub struct BodyIR { |
| `OperationIR` | libs/openapi-codegen/src/ir/operations.rs | struct | pub | 28 | pub struct OperationIR { |
| `has_inputs` | libs/openapi-codegen/src/ir/operations.rs | function | pub | 48 | pub fn has_inputs(&self) -> bool { |
| `build` | libs/openapi-codegen/src/ir/operations.rs | function | pub | 60 | pub fn build(spec: &Spec) -> Vec<OperationIR> { |
...
changes:
  - path: "libs/openapi-codegen/src/ir/operations.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/openapi-codegen/src/ir/operations.rs` captured during libs codegen standardization.
```
