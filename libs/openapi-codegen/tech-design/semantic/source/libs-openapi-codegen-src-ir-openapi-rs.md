---
id: libs-openapi-codegen-src-ir-openapi-rs
summary: Lossless rust-source-unit coverage for `libs/openapi-codegen/src/ir/openapi.rs`.
capability_refs:
...
# Standardized libs/openapi-codegen/src/ir/openapi.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/openapi-codegen/src/ir/openapi.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Spec` | libs/openapi-codegen/src/ir/openapi.rs | struct | pub | 15 | pub struct Spec { |
| `Info` | libs/openapi-codegen/src/ir/openapi.rs | struct | pub | 28 | pub struct Info { |
| `Components` | libs/openapi-codegen/src/ir/openapi.rs | struct | pub | 36 | pub struct Components { |
| `PathItem` | libs/openapi-codegen/src/ir/openapi.rs | struct | pub | 42 | pub struct PathItem { |
| `Operation` | libs/openapi-codegen/src/ir/openapi.rs | struct | pub | 59 | pub struct Operation { |
| `Parameter` | libs/openapi-codegen/src/ir/openapi.rs | struct | pub | 75 | pub struct Parameter { |
| `RequestBody` | libs/openapi-codegen/src/ir/openapi.rs | struct | pub | 87 | pub struct RequestBody { |
| `Response` | libs/openapi-codegen/src/ir/openapi.rs | struct | pub | 95 | pub struct Response { |
| `MediaType` | libs/openapi-codegen/src/ir/openapi.rs | struct | pub | 101 | pub struct MediaType { |
| `RefOr` | libs/openapi-codegen/src/ir/openapi.rs | enum | pub | 114 | pub enum RefOr<T> { |
| `RefObj` | libs/openapi-codegen/src/ir/openapi.rs | struct | pub | 120 | pub struct RefObj { |
| `AdditionalProperties` | libs/openapi-codegen/src/ir/openapi.rs | enum | pub | 128 | pub enum AdditionalProperties { |
| `Schema` | libs/openapi-codegen/src/ir/openapi.rs | struct | pub | 136 | pub struct Schema { |
| `type_names` | libs/openapi-codegen/src/ir/openapi.rs | function | pub | 166 | pub fn type_names(&self) -> Vec<String> { |
| `is_nullable` | libs/openapi-codegen/src/ir/openapi.rs | function | pub | 176 | pub fn is_nullable(&self) -> bool { |
| `TypeField` | libs/openapi-codegen/src/ir/openapi.rs | struct | pub | 184 | pub struct TypeField(pub Vec<String>); |
...
changes:
  - path: "libs/openapi-codegen/src/ir/openapi.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/openapi-codegen/src/ir/openapi.rs` captured during libs codegen standardization.
```
