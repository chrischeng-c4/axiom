---
id: libs-openapi-codegen-src-lib-rs
summary: Lossless rust-source-unit coverage for `libs/openapi-codegen/src/lib.rs`.
capability_refs:
...
# Standardized libs/openapi-codegen/src/lib.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/openapi-codegen/src/lib.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `emit` | libs/openapi-codegen/src/lib.rs | module | pub | 18 | pub mod emit; |
| `ir` | libs/openapi-codegen/src/lib.rs | module | pub | 19 | pub mod ir; |
| `llm` | libs/openapi-codegen/src/lib.rs | module | pub | 20 | pub mod llm; |
| `build_type_map` | libs/openapi-codegen/src/lib.rs | re-export | pub | 22 | pub use ir::{build_type_map, TypeMap}; |
| `TypeMap` | libs/openapi-codegen/src/lib.rs | re-export | pub | 22 | pub use ir::{build_type_map, TypeMap}; |
| `Lang` | libs/openapi-codegen/src/lib.rs | enum | pub | 26 | pub enum Lang { |
| `HttpClient` | libs/openapi-codegen/src/lib.rs | enum | pub | 38 | pub enum HttpClient { |
| `GenOptions` | libs/openapi-codegen/src/lib.rs | struct | pub | 48 | pub struct GenOptions { |
| `GeneratedFile` | libs/openapi-codegen/src/lib.rs | struct | pub | 62 | pub struct GeneratedFile { |
| `GeneratedOutput` | libs/openapi-codegen/src/lib.rs | struct | pub | 69 | pub struct GeneratedOutput { |
| `generate` | libs/openapi-codegen/src/lib.rs | function | pub | 75 | pub fn generate(spec_json: &str, opts: &GenOptions) -> Result<GeneratedOutput> { |
| `run` | libs/openapi-codegen/src/lib.rs | function | pub | 85 | pub fn run(opts: &GenOptions) -> i32 { |
...
changes:
  - path: "libs/openapi-codegen/src/lib.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/openapi-codegen/src/lib.rs` captured during libs codegen standardization.
```
