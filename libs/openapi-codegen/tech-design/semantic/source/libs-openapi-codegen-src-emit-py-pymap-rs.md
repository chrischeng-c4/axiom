---
id: libs-openapi-codegen-src-emit-py-pymap-rs
summary: Lossless rust-source-unit coverage for `libs/openapi-codegen/src/emit/py/pymap.rs`.
capability_refs:
...
# Standardized libs/openapi-codegen/src/emit/py/pymap.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/openapi-codegen/src/emit/py/pymap.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `type_expr` | libs/openapi-codegen/src/emit/py/pymap.rs | function | pub | 7 | pub fn type_expr(node: &RefOr<Schema>, tm: &TypeMap) -> String { |
| `optional` | libs/openapi-codegen/src/emit/py/pymap.rs | function | pub | 24 | pub fn optional(ty: &str) -> String { |
| `object_expr` | libs/openapi-codegen/src/emit/py/pymap.rs | function | pub | 106 | pub fn object_expr(schema: &Schema, tm: &TypeMap) -> String { |
...
changes:
  - path: "libs/openapi-codegen/src/emit/py/pymap.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/openapi-codegen/src/emit/py/pymap.rs` captured during libs codegen standardization.
```
