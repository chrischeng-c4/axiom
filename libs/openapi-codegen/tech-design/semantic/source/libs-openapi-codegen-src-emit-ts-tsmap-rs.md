---
id: libs-openapi-codegen-src-emit-ts-tsmap-rs
summary: Lossless rust-source-unit coverage for `libs/openapi-codegen/src/emit/ts/tsmap.rs`.
capability_refs:
...
# Standardized libs/openapi-codegen/src/emit/ts/tsmap.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/openapi-codegen/src/emit/ts/tsmap.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TypeMap` | libs/openapi-codegen/src/emit/ts/tsmap.rs | re-export | pub | 12 | pub use crate::ir::typemap::TypeMap; |
| `type_expr` | libs/openapi-codegen/src/emit/ts/tsmap.rs | function | pub | 16 | pub fn type_expr(node: &RefOr<Schema>, tm: &TypeMap) -> String { |
| `object_expr` | libs/openapi-codegen/src/emit/ts/tsmap.rs | function | pub | 108 | pub fn object_expr(schema: &Schema, tm: &TypeMap) -> String { |
...
// The schema-key → type-name map is language-neutral and lives in `ir`; this
// module renders the TypeScript type *expressions* over it.
pub use crate::ir::typemap::TypeMap;
...
changes:
  - path: "libs/openapi-codegen/src/emit/ts/tsmap.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/openapi-codegen/src/emit/ts/tsmap.rs` captured during libs codegen standardization.
```
