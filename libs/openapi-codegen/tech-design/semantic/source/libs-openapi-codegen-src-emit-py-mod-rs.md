---
id: libs-openapi-codegen-src-emit-py-mod-rs
summary: Lossless rust-source-unit coverage for `libs/openapi-codegen/src/emit/py/mod.rs`.
capability_refs:
...
# Standardized libs/openapi-codegen/src/emit/py/mod.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/openapi-codegen/src/emit/py/mod.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `client_emit` | libs/openapi-codegen/src/emit/py/mod.rs | module | pub | 8 | pub mod client_emit; |
| `models_emit` | libs/openapi-codegen/src/emit/py/mod.rs | module | pub | 9 | pub mod models_emit; |
| `pymap` | libs/openapi-codegen/src/emit/py/mod.rs | module | pub | 10 | pub mod pymap; |
| `runtime_emit` | libs/openapi-codegen/src/emit/py/mod.rs | module | pub | 11 | pub mod runtime_emit; |
| `generate` | libs/openapi-codegen/src/emit/py/mod.rs | function | pub | 20 | pub fn generate(spec_json: &str, opts: &GenOptions) -> Result<GeneratedOutput> { |
...
changes:
  - path: "libs/openapi-codegen/src/emit/py/mod.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/openapi-codegen/src/emit/py/mod.rs` captured during libs codegen standardization.
```
