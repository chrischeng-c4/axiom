---
id: libs-openapi-codegen-src-emit-ts-hooks-emit-rs
summary: Lossless rust-source-unit coverage for `libs/openapi-codegen/src/emit/ts/hooks_emit.rs`.
capability_refs:
...
# Standardized libs/openapi-codegen/src/emit/ts/hooks_emit.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/openapi-codegen/src/emit/ts/hooks_emit.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `emit` | libs/openapi-codegen/src/emit/ts/hooks_emit.rs | function | pub | 13 | pub fn emit(plans: &[OperationPlan]) -> String { |
...
changes:
  - path: "libs/openapi-codegen/src/emit/ts/hooks_emit.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/openapi-codegen/src/emit/ts/hooks_emit.rs` captured during libs codegen standardization.
```
