---
id: libs-openapi-codegen-src-emit-ts-plan-rs
summary: Lossless rust-source-unit coverage for `libs/openapi-codegen/src/emit/ts/plan.rs`.
capability_refs:
...
# Standardized libs/openapi-codegen/src/emit/ts/plan.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/openapi-codegen/src/emit/ts/plan.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ParamField` | libs/openapi-codegen/src/emit/ts/plan.rs | struct | pub | 13 | pub struct ParamField { |
| `BodyField` | libs/openapi-codegen/src/emit/ts/plan.rs | struct | pub | 21 | pub struct BodyField { |
| `OperationPlan` | libs/openapi-codegen/src/emit/ts/plan.rs | struct | pub | 28 | pub struct OperationPlan { |
| `has_inputs` | libs/openapi-codegen/src/emit/ts/plan.rs | function | pub | 51 | pub fn has_inputs(&self) -> bool { |
| `query_required` | libs/openapi-codegen/src/emit/ts/plan.rs | function | pub | 54 | pub fn query_required(&self) -> bool { |
| `headers_required` | libs/openapi-codegen/src/emit/ts/plan.rs | function | pub | 57 | pub fn headers_required(&self) -> bool { |
| `build` | libs/openapi-codegen/src/emit/ts/plan.rs | function | pub | 64 | pub fn build(spec: &Spec, tm: &TypeMap) -> Vec<OperationPlan> { |
...
changes:
  - path: "libs/openapi-codegen/src/emit/ts/plan.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/openapi-codegen/src/emit/ts/plan.rs` captured during libs codegen standardization.
```
