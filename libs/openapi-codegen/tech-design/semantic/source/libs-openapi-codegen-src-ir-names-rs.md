---
id: libs-openapi-codegen-src-ir-names-rs
summary: Lossless rust-source-unit coverage for `libs/openapi-codegen/src/ir/names.rs`.
capability_refs:
...
# Standardized libs/openapi-codegen/src/ir/names.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/openapi-codegen/src/ir/names.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `to_pascal` | libs/openapi-codegen/src/ir/names.rs | function | pub | 39 | pub fn to_pascal(input: &str) -> String { |
| `to_camel` | libs/openapi-codegen/src/ir/names.rs | function | pub | 51 | pub fn to_camel(input: &str) -> String { |
| `to_snake` | libs/openapi-codegen/src/ir/names.rs | function | pub | 63 | pub fn to_snake(input: &str) -> String { |
| `is_ident` | libs/openapi-codegen/src/ir/names.rs | function | pub | 84 | pub fn is_ident(s: &str) -> bool { |
| `prop_key` | libs/openapi-codegen/src/ir/names.rs | function | pub | 94 | pub fn prop_key(key: &str) -> String { |
| `param_access` | libs/openapi-codegen/src/ir/names.rs | function | pub | 104 | pub fn param_access(name: &str) -> String { |
| `NameRegistry` | libs/openapi-codegen/src/ir/names.rs | struct | pub | 117 | pub struct NameRegistry { |
| `new` | libs/openapi-codegen/src/ir/names.rs | function | pub | 122 | pub fn new() -> Self { |
| `unique` | libs/openapi-codegen/src/ir/names.rs | function | pub | 126 | pub fn unique(&mut self, base: &str) -> String { |
...
changes:
  - path: "libs/openapi-codegen/src/ir/names.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/openapi-codegen/src/ir/names.rs` captured during libs codegen standardization.
```
