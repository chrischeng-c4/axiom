...
pub fn emit(ops: &[OperationIR], tm: &TypeMap) -> String {
    ...
    out.push_str("from typing import Any, Literal, Optional, Protocol\n");
    ...
    out.push_str("    def __init__(self, base_url: str, *, client: Optional[SupportsRequest] = None) -> None:\n");
    ...
    out.push_str("\n\nclass AsyncClient:\n");
    out.push_str("    def __init__(self, base_url: str, *, client: Optional[AsyncSupportsRequest] = None) -> None:\n");
    out.push_str("        self._base_url = base_url.rstrip(\"/\")\n");
