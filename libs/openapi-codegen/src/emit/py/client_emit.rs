...
pub fn emit(ops: &[OperationIR], tm: &TypeMap, target: PythonTarget) -> String {
    ...
    out.push_str("    def request(self, method: str, url: str, *, params: dict[str, Any], headers: dict[str, Any], json: Any = None, data: Any = None, content: Any = None, timeout: float | None = None) -> ResponseLike: ...\n\n\n");
    out.push_str("class AsyncSupportsRequest(Protocol):\n");
    out.push_str("    async def request(self, method: str, url: str, *, params: dict[str, Any], headers: dict[str, Any], json: Any = None, data: Any = None, content: Any = None, timeout: float | None = None) -> ResponseLike: ...\n\n\n");
...
fn param_ann(p: &ParamIR, tm: &TypeMap, target: PythonTarget) -> (String, String, bool) {
    let ty = p
        .schema
        .as_ref()
...
fn response(ir: &OperationIR, tm: &TypeMap, target: PythonTarget) -> (String, String) {
    match &ir.response {
...
mod tests {
    ...
    fn init_signatures_accept_use_post_fallback() {
        ...
        let out = emit(&operations::build(&s), &tm, PythonTarget::Py311);
