...
// @command cargo test -p openapi-codegen --test target_profile_matrix python_314_generated_model_contract -- --exact
// AW-EC-END
...
fn python_314_generated_model_contract() {
    let command =
        "cargo test -p openapi-codegen --test target_profile_matrix python_314_generated_model_contract -- --exact";
