// SPEC-MANAGED: libs/transport-h2c/tech-design/semantic/source/libs-h2c-src-error-rs.md#rust-source-unit
// CODEGEN-BEGIN
...
/// @spec libs/transport-h2c/tech-design/semantic/source/libs-h2c-src-error-rs.md#source
pub enum H2cError {
