// SPEC-MANAGED: libs/transport-h2c/tech-design/semantic/source/libs-h2c-src-manager-rs.md#rust-source-unit
// CODEGEN-BEGIN
...
#[derive(Clone, Debug)]
/// @spec libs/transport-h2c/tech-design/semantic/source/libs-h2c-src-manager-rs.md#source
