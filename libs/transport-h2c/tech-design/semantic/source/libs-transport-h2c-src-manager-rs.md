---
id: libs-transport-h2c-src-manager-rs
summary: Lossless rust-source-unit coverage for `libs/transport-h2c/src/manager.rs`.
capability_refs:
...
# Standardized libs/transport-h2c/src/manager.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/transport-h2c/src/manager.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ManagerConfig` | libs/transport-h2c/src/manager.rs | struct | pub | 40 | pub struct ManagerConfig { |
| `for_concurrency` | libs/transport-h2c/src/manager.rs | function | pub | 96 | pub fn for_concurrency(concurrency: usize) -> Self { |
| `ManagerStats` | libs/transport-h2c/src/manager.rs | struct | pub | 114 | pub struct ManagerStats { |
| `H2cManager` | libs/transport-h2c/src/manager.rs | struct | pub | 157 | pub struct H2cManager { |
| `connect` | libs/transport-h2c/src/manager.rs | function | pub | 173 | pub async fn connect(endpoint: &str) -> Result<Self> { |
| `with_config` | libs/transport-h2c/src/manager.rs | function | pub | 178 | pub async fn with_config(endpoint: &str, cfg: ManagerConfig) -> Result<Self> { |
| `authority` | libs/transport-h2c/src/manager.rs | function | pub | 205 | pub fn authority(&self) -> &str { |
| `get` | libs/transport-h2c/src/manager.rs | function | pub | 210 | pub async fn get(&self, path: &str) -> Result<Response<Bytes>> { |
| `put` | libs/transport-h2c/src/manager.rs | function | pub | 216 | pub async fn put(&self, path: &str, body: Bytes) -> Result<Response<Bytes>> { |
| `post` | libs/transport-h2c/src/manager.rs | function | pub | 221 | pub async fn post(&self, path: &str, body: Bytes) -> Result<Response<Bytes>> { |
| `request` | libs/transport-h2c/src/manager.rs | function | pub | 227 | pub async fn request(&self, req: Request<Bytes>) -> Result<Response<Bytes>> { |
| `stats` | libs/transport-h2c/src/manager.rs | function | pub | 259 | pub async fn stats(&self) -> ManagerStats { |
| `shutdown` | libs/transport-h2c/src/manager.rs | function | pub | 280 | pub async fn shutdown(&self) { |
...
changes:
  - path: "libs/transport-h2c/src/manager.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/transport-h2c/src/manager.rs` captured during libs codegen standardization.
```
