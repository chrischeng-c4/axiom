...
# Standardized libs/transport-h2c/examples/conn_sweep.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/transport-h2c/examples/conn_sweep.rs` captured during libs codegen standardization.
...
async fn main() {
    ...
    let cores = transport_h2c::cpu_parallelism();
...
changes:
  - path: "libs/transport-h2c/examples/conn_sweep.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/transport-h2c/examples/conn_sweep.rs` captured during libs codegen standardization.
```
