---
id: libs-transport-h2c-src-lib-rs
summary: Lossless rust-source-unit coverage for `libs/transport-h2c/src/lib.rs`.
capability_refs:
...
# Standardized libs/transport-h2c/src/lib.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/transport-h2c/src/lib.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `llm` | libs/transport-h2c/src/lib.rs | module | pub | 37 | pub mod llm; |
| `H2cError` | libs/transport-h2c/src/lib.rs | re-export | pub | 40 | pub use error::{H2cError, Result}; |
| `Result` | libs/transport-h2c/src/lib.rs | re-export | pub | 40 | pub use error::{H2cError, Result}; |
| `H2cManager` | libs/transport-h2c/src/lib.rs | re-export | pub | 41 | pub use manager::{H2cManager, ManagerConfig, ManagerStats}; |
...
| `h2c_client` | libs/transport-h2c/src/lib.rs | function | pub | 81 | pub fn h2c_client() -> reqwest::Result<reqwest::Client> { |
| `h2c_client_with` | libs/transport-h2c/src/lib.rs | function | pub | 86 | pub fn h2c_client_with( |
| `H2cPool` | libs/transport-h2c/src/lib.rs | struct | pub | 120 | pub struct H2cPool { |
| `for_concurrency` | libs/transport-h2c/src/lib.rs | function | pub | 127 | pub fn for_concurrency(concurrency: usize) -> reqwest::Result<Self> { |
| `with_connections` | libs/transport-h2c/src/lib.rs | function | pub | 132 | pub fn with_connections(n: usize) -> reqwest::Result<Self> { |
| `with_connections_and` | libs/transport-h2c/src/lib.rs | function | pub | 137 | pub fn with_connections_and( |
| `connections` | libs/transport-h2c/src/lib.rs | function | pub | 152 | pub fn connections(&self) -> usize { |
| `client` | libs/transport-h2c/src/lib.rs | function | pub | 157 | pub fn client(&self) -> &reqwest::Client { |
| `get` | libs/transport-h2c/src/lib.rs | function | pub | 163 | pub fn get<U: reqwest::IntoUrl>(&self, url: U) -> reqwest::RequestBuilder { |
| `post` | libs/transport-h2c/src/lib.rs | function | pub | 168 | pub fn post<U: reqwest::IntoUrl>(&self, url: U) -> reqwest::RequestBuilder { |
...
changes:
  - path: "libs/transport-h2c/src/lib.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/transport-h2c/src/lib.rs` captured during libs codegen standardization.
```
