...
# Standardized libs/transport-h2c/src/server.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/transport-h2c/src/server.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `serve_connection` | libs/transport-h2c/src/server.rs | function | pub | 34 | pub async fn serve_connection( |
| `serve_connection_with_options` | libs/transport-h2c/src/server.rs | function | pub | 43 | pub async fn serve_connection_with_options( |
...
changes:
  - path: "libs/transport-h2c/src/server.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/transport-h2c/src/server.rs` captured during libs codegen standardization.
```
