---
id: libs-transport-h2c-src-conn-rs
summary: Lossless rust-source-unit coverage for `libs/transport-h2c/src/conn.rs`.
capability_refs:
...
# Standardized libs/transport-h2c/src/conn.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/transport-h2c/src/conn.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ConnConfig` | libs/transport-h2c/src/conn.rs | struct | pub | 25 | pub(crate) struct ConnConfig { |
| `ManagedConn` | libs/transport-h2c/src/conn.rs | struct | pub | 32 | pub(crate) struct ManagedConn { |
| `connect` | libs/transport-h2c/src/conn.rs | function | pub | 56 | pub(crate) async fn connect(id: usize, authority: &str, cfg: ConnConfig) -> Result<Arc<Self>> { |
| `is_healthy` | libs/transport-h2c/src/conn.rs | function | pub | 104 | pub(crate) fn is_healthy(&self) -> bool { |
| `mark_dead` | libs/transport-h2c/src/conn.rs | function | pub | 108 | pub(crate) fn mark_dead(&self) { |
| `in_flight` | libs/transport-h2c/src/conn.rs | function | pub | 112 | pub(crate) fn in_flight(&self) -> usize { |
| `reserve` | libs/transport-h2c/src/conn.rs | function | pub | 118 | pub(crate) fn reserve(&self) { |
| `release` | libs/transport-h2c/src/conn.rs | function | pub | 123 | pub(crate) fn release(&self) { |
| `total` | libs/transport-h2c/src/conn.rs | function | pub | 127 | pub(crate) fn total(&self) -> u64 { |
| `errors` | libs/transport-h2c/src/conn.rs | function | pub | 131 | pub(crate) fn errors(&self) -> u64 { |
| `touch` | libs/transport-h2c/src/conn.rs | function | pub | 136 | pub(crate) fn touch(&self) { |
| `idle` | libs/transport-h2c/src/conn.rs | function | pub | 142 | pub(crate) fn idle(&self) -> Duration { |
| `send` | libs/transport-h2c/src/conn.rs | function | pub | 150 | pub(crate) async fn send(&self, req: Request<Bytes>) -> Result<Response<Bytes>> { |
| `ping` | libs/transport-h2c/src/conn.rs | function | pub | 192 | pub(crate) async fn ping(&self) -> Result<Duration> { |
...
changes:
  - path: "libs/transport-h2c/src/conn.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/transport-h2c/src/conn.rs` captured during libs codegen standardization.
```
