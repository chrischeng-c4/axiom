---
id: libs-transport-h2c-src-llm-rs
summary: Lossless rust-source-unit coverage for `libs/transport-h2c/src/llm.rs`.
capability_refs:
...
# Standardized libs/transport-h2c/src/llm.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/transport-h2c/src/llm.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TOPIC` | libs/transport-h2c/src/llm.rs | const | pub | 4 | pub const TOPIC: cli_std::llm::Topic = cli_std::llm::Topic { |
| `topic` | libs/transport-h2c/src/llm.rs | function | pub | 59 | pub fn topic() -> &'static cli_std::llm::Topic { |
...
```rust
let pool = transport_h2c::H2cPool::for_concurrency(target_concurrency)?;
...
changes:
  - path: "libs/transport-h2c/src/llm.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/transport-h2c/src/llm.rs` captured during libs codegen standardization.
```
