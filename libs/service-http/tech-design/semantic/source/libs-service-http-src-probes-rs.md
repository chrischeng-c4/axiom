---
id: libs-service-http-src-probes-rs
summary: Lossless rust-source-unit coverage for `libs/service-http/src/probes.rs`.
capability_refs:
...
# Standardized libs/service-http/src/probes.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/service-http/src/probes.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `standard_probe_routes` | libs/service-http/src/probes.rs | function | pub | 46 | pub fn standard_probe_routes<R: ReadinessHook + 'static>( |
...
changes:
  - path: "libs/service-http/src/probes.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/service-http/src/probes.rs` captured during libs codegen standardization.
```
