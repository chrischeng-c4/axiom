---
id: libs-service-http-src-config-rs
summary: Lossless rust-source-unit coverage for `libs/service-http/src/config.rs`.
capability_refs:
...
# Standardized libs/service-http/src/config.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/service-http/src/config.rs` captured during libs codegen standardization.
