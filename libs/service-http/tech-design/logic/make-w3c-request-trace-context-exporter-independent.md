...
changes:
  - path: libs/service-http/src/transport.rs
    ...
    anchor: trace_layer
    description: Implement strict W3C parsing, exporter-independent id generation, and an always-on request make-span that records canonical fields while preserving optional OTLP parent attachment.
