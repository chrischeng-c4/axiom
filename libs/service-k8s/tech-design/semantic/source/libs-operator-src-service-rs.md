...
summary: Lossless rust-source-unit coverage for `libs/service-k8s/src/service.rs`.
capability_refs:
...
# Standardized libs/service-k8s/src/service.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/service-k8s/src/service.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ReadinessTarget` | libs/service-k8s/src/service.rs | struct | pub | 13 | pub struct ReadinessTarget { |
| `ReadyFacts` | libs/service-k8s/src/service.rs | struct | pub | 20 | pub struct ReadyFacts { |
| `get` | libs/service-k8s/src/service.rs | function | pub | 26 | pub fn get(&self, name: &str) -> i64 { |
| `ManagedService` | libs/service-k8s/src/service.rs | trait | pub | 34 | pub trait ManagedService: |
| `ClusterSpec` | libs/service-k8s/src/service.rs | struct | pub | 63 | pub struct ClusterSpec { |
| `ResourceSpec` | libs/service-k8s/src/service.rs | struct | pub | 80 | pub struct ResourceSpec { |
...
changes:
  - path: "libs/service-k8s/src/service.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/service-k8s/src/service.rs` captured during libs codegen standardization.
```
