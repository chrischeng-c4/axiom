---
id: libs-operator-src-resize-rs
summary: Lossless rust-source-unit coverage for `libs/service-k8s/src/resize.rs`.
capability_refs:
...
# Standardized libs/service-k8s/src/resize.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/service-k8s/src/resize.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ResizeAction` | libs/service-k8s/src/resize.rs | enum | pub | 30 | pub enum ResizeAction { |
| `parse_storage_bytes` | libs/service-k8s/src/resize.rs | function | pub | 55 | pub fn parse_storage_bytes(qty: &str) -> Result<u64> { |
| `decide` | libs/service-k8s/src/resize.rs | function | pub | 92 | pub fn decide(current: &str, desired: &str) -> ResizeAction { |
| `PvcResizeOutcome` | libs/service-k8s/src/resize.rs | struct | pub | 124 | pub struct PvcResizeOutcome { |
| `resize_instance` | libs/service-k8s/src/resize.rs | function | pub | 139 | pub async fn resize_instance<F, D>( |
...
changes:
  - path: "libs/service-k8s/src/resize.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/service-k8s/src/resize.rs` captured during libs codegen standardization.
```
