...
# Standardized libs/service-k8s/src/render.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/service-k8s/src/render.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ENV_POD_NAME` | libs/service-k8s/src/render.rs | const | pub | 19 | pub const ENV_POD_NAME: &str = "POD_NAME"; |
| `ENV_POD_NAMESPACE` | libs/service-k8s/src/render.rs | const | pub | 20 | pub const ENV_POD_NAMESPACE: &str = "POD_NAMESPACE"; |
| `ENV_SHARD_COUNT` | libs/service-k8s/src/render.rs | const | pub | 21 | pub const ENV_SHARD_COUNT: &str = "SHARD_COUNT"; |
| `ENV_REPLICAS_PER_SHARD` | libs/service-k8s/src/render.rs | const | pub | 22 | pub const ENV_REPLICAS_PER_SHARD: &str = "REPLICAS_PER_SHARD"; |
| `ENV_VOTER_COUNT` | libs/service-k8s/src/render.rs | const | pub | 23 | pub const ENV_VOTER_COUNT: &str = "VOTER_COUNT"; |
| `RenderCtx` | libs/service-k8s/src/render.rs | struct | pub | 26 | pub struct RenderCtx<'a> { |
| `labels` | libs/service-k8s/src/render.rs | function | pub | 38 | pub fn labels(&self, component: &str) -> Value { |
| `selector` | libs/service-k8s/src/render.rs | function | pub | 50 | pub fn selector(&self, component: &str) -> Value { |
| `meta` | libs/service-k8s/src/render.rs | function | pub | 59 | pub fn meta(&self, name: &str, component: &str) -> Value { |
| `owner_ref` | libs/service-k8s/src/render.rs | function | pub | 70 | pub fn owner_ref(api_version: &str, kind: &str, name: &str, uid: &str) -> Value { |
| `guaranteed_resources` | libs/service-k8s/src/render.rs | function | pub | 82 | pub fn guaranteed_resources(cpu: &str, memory: &str) -> Value { |
| `WorkloadVolumeClaim` | libs/service-k8s/src/render.rs | struct | pub | 90 | pub struct WorkloadVolumeClaim<'a> { |
| `service_account` | libs/service-k8s/src/render.rs | function | pub | 98 | pub fn service_account(cx: &RenderCtx, component: &str) -> Value { |
| `headless_service_with_ports` | libs/service-k8s/src/render.rs | function | pub | 137 | pub fn headless_service_with_ports( |
| `headless_service` | libs/service-k8s/src/render.rs | function | pub | 147 | pub fn headless_service(cx: &RenderCtx, name: &str, component: &str, port: i32) -> Value { |
| `client_service_with_ports` | libs/service-k8s/src/render.rs | function | pub | 157 | pub fn client_service_with_ports( |
| `client_service` | libs/service-k8s/src/render.rs | function | pub | 167 | pub fn client_service(cx: &RenderCtx, name: &str, component: &str, port: i32) -> Value { |
| `pdb` | libs/service-k8s/src/render.rs | function | pub | 177 | pub fn pdb(cx: &RenderCtx, name: &str, component: &str, max_unavailable: i32) -> Value { |
| `HorizontalPodAutoscaler` | libs/service-k8s/src/render.rs | struct | pub | 187 | pub struct HorizontalPodAutoscaler<'a> { |
| `horizontal_pod_autoscaler` | libs/service-k8s/src/render.rs | function | pub | 201 | pub fn horizontal_pod_autoscaler(p: HorizontalPodAutoscaler) -> Value { |
| `CronJob` | libs/service-k8s/src/render.rs | struct | pub | 236 | pub struct CronJob<'a> { |
| `cron_job` | libs/service-k8s/src/render.rs | function | pub | 260 | pub fn cron_job(p: CronJob) -> Value { |
| `ServiceStatefulSet` | libs/service-k8s/src/render.rs | struct | pub | 340 | pub struct ServiceStatefulSet<'a> { |
| `service_statefulset` | libs/service-k8s/src/render.rs | function | pub | 381 | pub fn service_statefulset(p: ServiceStatefulSet) -> Value { |
| `ShardedStatefulSet` | libs/service-k8s/src/render.rs | struct | pub | 525 | pub struct ShardedStatefulSet<'a> { |
| `sharded_statefulset` | libs/service-k8s/src/render.rs | function | pub | 554 | pub fn sharded_statefulset(p: ShardedStatefulSet) -> Value { |
...
changes:
  - path: "libs/service-k8s/src/render.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/service-k8s/src/render.rs` captured during libs codegen standardization.
```
