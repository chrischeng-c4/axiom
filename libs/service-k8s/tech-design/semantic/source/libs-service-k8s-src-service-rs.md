---
id: libs-service-k8s-src-service-rs
...
|------|--------|------|------------|------|-----------|
| `ReadinessTarget` | libs/service-k8s/src/service.rs | struct | pub | 14 | pub struct ReadinessTarget { |
| `ReadyFacts` | libs/service-k8s/src/service.rs | struct | pub | 21 | pub struct ReadyFacts { |
| `get` | libs/service-k8s/src/service.rs | function | pub | 27 | pub fn get(&self, name: &str) -> i64 { |
| `ReconcilePlan` | libs/service-k8s/src/service.rs | struct | pub | 35 | pub struct ReconcilePlan { |
| `ManagedService` | libs/service-k8s/src/service.rs | trait | pub | 43 | pub trait ManagedService: |
| `Condition` | libs/service-k8s/src/service.rs | struct | pub | 199 | pub struct Condition { |
| `ConditionStatus` | libs/service-k8s/src/service.rs | enum | pub | 220 | pub enum ConditionStatus { |
| `as_str` | libs/service-k8s/src/service.rs | function | pub | 227 | pub fn as_str(self) -> &'static str { |
| `from_bool` | libs/service-k8s/src/service.rs | function | pub | 236 | pub fn from_bool(value: bool) -> Self { |
| `ConditionFact` | libs/service-k8s/src/service.rs | struct | pub | 252 | pub struct ConditionFact { |
| `new` | libs/service-k8s/src/service.rs | function | pub | 260 | pub fn new( |
| `project` | libs/service-k8s/src/service.rs | function | pub | 285 | pub fn project( |
| `now_rfc3339` | libs/service-k8s/src/service.rs | function | pub | 315 | pub fn now_rfc3339() -> String { |
| `ClusterSpec` | libs/service-k8s/src/service.rs | struct | pub | 471 | pub struct ClusterSpec { |
| `ResourceSpec` | libs/service-k8s/src/service.rs | struct | pub | 493 | pub struct ResourceSpec { |
