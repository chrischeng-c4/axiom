// SPEC-MANAGED: libs/service-k8s/tech-design/semantic/source/libs-operator-src-lease-rs.md#rust-source-unit
// CODEGEN-BEGIN
...
/// the reconcile loop.
/// @spec libs/service-k8s/tech-design/semantic/source/libs-operator-src-lease-rs.md#source
pub struct Election {
