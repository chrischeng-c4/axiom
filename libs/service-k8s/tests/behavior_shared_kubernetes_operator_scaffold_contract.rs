// SPEC-MANAGED: libs/service-k8s/external-contracts/behavior/shared-kubernetes-operator-scaffold-contract.md#shared-kubernetes-operator-scaffold-contract
// CODEGEN-BEGIN
// AW-EC-BEGIN
// @ec shared-kubernetes-operator-scaffold-contract
// @capability shared-kubernetes-operator-scaffold
