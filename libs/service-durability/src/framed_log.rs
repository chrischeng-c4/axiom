// SPEC-MANAGED: libs/service-durability/tech-design/semantic/source/libs-service-durability-src-framed_log-rs.md#rust-source-unit
// CODEGEN-BEGIN
...
/// @spec libs/service-durability/tech-design/semantic/source/libs-service-durability-src-framed_log-rs.md#source
pub struct LogFrame {
    pub seq: u64,
    pub payload: Vec<u8>,
}
