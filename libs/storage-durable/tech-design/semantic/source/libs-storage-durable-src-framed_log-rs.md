---
id: libs-storage-durable-src-framed-log-rs
summary: Lossless rust-source-unit coverage for `libs/storage-durable/src/framed_log.rs`.
capability_refs:
...
# Standardized libs/storage-durable/src/framed_log.rs

## Overview
<!-- type: overview lang: markdown -->

Lossless rust-source-unit coverage for `libs/storage-durable/src/framed_log.rs`.

### Symbols

| Name | Target | Kind | Visibility | Signature |
|------|--------|------|------------|-----------|
| `LogFrame` | libs/storage-durable/src/framed_log.rs | struct | pub | LogFrame { seq, payload } |
| `FramedLogWriter` | libs/storage-durable/src/framed_log.rs | struct | pub | FramedLogWriter |
| `open` | libs/storage-durable/src/framed_log.rs | method | pub | open(path, policy) -> Result<Self> |
| `append` | libs/storage-durable/src/framed_log.rs | method | pub | append(&mut self, seq, payload) -> Result<()> |
| `flush` | libs/storage-durable/src/framed_log.rs | method | pub | flush(&mut self) -> Result<()> |
| `sync` | libs/storage-durable/src/framed_log.rs | method | pub | sync(&mut self) -> Result<()> |
| `maybe_sync` | libs/storage-durable/src/framed_log.rs | method | pub | maybe_sync(&mut self) -> Result<()> |
| `truncate_through` | libs/storage-durable/src/framed_log.rs | method | pub | truncate_through(&mut self, through) -> Result<()> |
| `FramedLogReader` | libs/storage-durable/src/framed_log.rs | struct | pub | FramedLogReader |
| `replay` | libs/storage-durable/src/framed_log.rs | method | pub | replay(path, from_seq, apply) -> Result<u64> |
| `read_frames` | libs/storage-durable/src/framed_log.rs | method | pub | read_frames(path, from_seq) -> Result<Vec<LogFrame>> |
| `scan_good_end` | libs/storage-durable/src/framed_log.rs | method | pub | scan_good_end(path) -> Result<u64> |
...
changes:
  - path: "libs/storage-durable/src/framed_log.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/storage-durable/src/framed_log.rs`.
```
