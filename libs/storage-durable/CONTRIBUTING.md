# Contributing to storage-durable

## Brief

How to change `libs/storage-durable`. What it promises and the work roots it
...
| Gate | Command |
|---|---|
| unit + colocated tests | `cargo test -p storage-durable` |
