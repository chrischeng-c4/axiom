...
summary: Lossless rust-source-unit coverage for `libs/h2c/examples/conn_sweep.rs`.
capability_refs:
...
# Standardized libs/h2c/examples/conn_sweep.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/h2c/examples/conn_sweep.rs` captured during libs codegen standardization.
...
changes:
  - path: "libs/h2c/examples/conn_sweep.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/h2c/examples/conn_sweep.rs` captured during libs codegen standardization.
```
