...
summary: Lossless rust-source-unit coverage for `libs/h2c/src/server.rs`.
capability_refs:
...
# Standardized libs/h2c/src/server.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/h2c/src/server.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `serve` | libs/h2c/src/server.rs | function | pub | 23 | pub async fn serve( |
...
changes:
  - path: "libs/h2c/src/server.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/h2c/src/server.rs` captured during libs codegen standardization.
```
