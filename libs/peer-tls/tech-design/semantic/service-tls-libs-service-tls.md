---
id: semantic-peer-tls-libs-peer-tls
summary: Semantic coverage for the peer-tls library source, manifest, tests, and project-root context artifact.
capability_refs:
...
- path: "libs/peer-tls/Cargo.toml"
  ...
  replaces:
    - "<handwrite-tracker:libs-peer-tls-cargo-toml>"
- path: "libs/peer-tls/src/lib.rs"
  action: modify
  section: schema
  description: |
  ...
  impl_mode: hand-written
  replaces:
    - "<handwrite-tracker:libs-peer-tls-src-lib-rs>"
- path: "libs/peer-tls/llms.txt"
  action: modify
  section: schema
  description: |
