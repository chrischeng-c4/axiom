---
id: libs-raft-core-src-lib-rs
summary: Lossless rust-source-unit coverage for `libs/raft-core/src/lib.rs`.
capability_refs:
...
# Standardized libs/raft-core/src/lib.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/raft-core/src/lib.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `NodeId` | libs/raft-core/src/lib.rs | type | pub | 29 | pub type NodeId = u64; |
| `Term` | libs/raft-core/src/lib.rs | type | pub | 30 | pub type Term = u64; |
| `Index` | libs/raft-core/src/lib.rs | type | pub | 32 | pub type Index = u64; |
| `RaftEntry` | libs/raft-core/src/lib.rs | struct | pub | 42 | pub struct RaftEntry { |
| `PersistedState` | libs/raft-core/src/lib.rs | struct | pub | 53 | pub struct PersistedState { |
| `Role` | libs/raft-core/src/lib.rs | enum | pub | 66 | pub enum Role { |
| `VoteReq` | libs/raft-core/src/lib.rs | struct | pub | 73 | pub struct VoteReq { |
| `VoteResp` | libs/raft-core/src/lib.rs | struct | pub | 81 | pub struct VoteResp { |
| `AppendReq` | libs/raft-core/src/lib.rs | struct | pub | 87 | pub struct AppendReq { |
| `AppendResp` | libs/raft-core/src/lib.rs | struct | pub | 97 | pub struct AppendResp { |
| `InstallSnapshotReq` | libs/raft-core/src/lib.rs | struct | pub | 107 | pub struct InstallSnapshotReq { |
| `InstallSnapshotResp` | libs/raft-core/src/lib.rs | struct | pub | 116 | pub struct InstallSnapshotResp { |
| `RaftMsg` | libs/raft-core/src/lib.rs | enum | pub | 123 | pub enum RaftMsg { |
| `Outgoing` | libs/raft-core/src/lib.rs | struct | pub | 134 | pub struct Outgoing { |
| `RaftTransport` | libs/raft-core/src/lib.rs | trait | pub | 141 | pub trait RaftTransport { |
| `Membership` | libs/raft-core/src/lib.rs | struct | pub | 147 | pub struct Membership { |
| `auto_membership` | libs/raft-core/src/lib.rs | function | pub | 156 | pub fn auto_membership(n: u64) -> Membership { |
| `RaftNode` | libs/raft-core/src/lib.rs | struct | pub | 166 | pub struct RaftNode { |
| `new` | libs/raft-core/src/lib.rs | function | pub | 203 | pub fn new(id: NodeId, membership: &Membership) -> RaftNode { |
| `from_persisted` | libs/raft-core/src/lib.rs | function | pub | 243 | pub fn from_persisted(id: NodeId, membership: &Membership, state: PersistedState) -> RaftNode { |
| `persisted` | libs/raft-core/src/lib.rs | function | pub | 257 | pub fn persisted(&self) -> PersistedState { |
| `id` | libs/raft-core/src/lib.rs | function | pub | 268 | pub fn id(&self) -> NodeId { |
| `role` | libs/raft-core/src/lib.rs | function | pub | 271 | pub fn role(&self) -> Role { |
| `is_leader` | libs/raft-core/src/lib.rs | function | pub | 274 | pub fn is_leader(&self) -> bool { |
| `is_voter` | libs/raft-core/src/lib.rs | function | pub | 277 | pub fn is_voter(&self) -> bool { |
| `current_term` | libs/raft-core/src/lib.rs | function | pub | 280 | pub fn current_term(&self) -> Term { |
| `commit_index` | libs/raft-core/src/lib.rs | function | pub | 283 | pub fn commit_index(&self) -> Index { |
| `last_index` | libs/raft-core/src/lib.rs | function | pub | 287 | pub fn last_index(&self) -> Index { |
| `snapshot_index` | libs/raft-core/src/lib.rs | function | pub | 291 | pub fn snapshot_index(&self) -> Index { |
| `log_len` | libs/raft-core/src/lib.rs | function | pub | 295 | pub fn log_len(&self) -> usize { |
| `leader` | libs/raft-core/src/lib.rs | function | pub | 299 | pub fn leader(&self) -> Option<NodeId> { |
| `take_outgoing` | libs/raft-core/src/lib.rs | function | pub | 327 | pub fn take_outgoing(&mut self) -> Vec<Outgoing> { |
| `take_committed` | libs/raft-core/src/lib.rs | function | pub | 332 | pub fn take_committed(&mut self) -> Vec<RaftEntry> { |
| `take_installed_snapshot` | libs/raft-core/src/lib.rs | function | pub | 345 | pub fn take_installed_snapshot(&mut self) -> Option<Vec<u8>> { |
| `compact` | libs/raft-core/src/lib.rs | function | pub | 353 | pub fn compact(&mut self, up_to: Index, snapshot: Vec<u8>) { |
| `tick` | libs/raft-core/src/lib.rs | function | pub | 370 | pub fn tick(&mut self) { |
| `propose` | libs/raft-core/src/lib.rs | function | pub | 502 | pub fn propose(&mut self, command: Vec<u8>) -> Option<Index> { |
| `handle` | libs/raft-core/src/lib.rs | function | pub | 518 | pub fn handle(&mut self, from: NodeId, msg: RaftMsg) { |
...
changes:
  - path: "libs/raft-core/src/lib.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/raft-core/src/lib.rs` captured during libs codegen standardization.
```
