---
id: libs-raft-core-tests-snapshot-rs
summary: Lossless rust-source-unit coverage for `libs/raft-core/tests/snapshot.rs`.
capability_refs:
...
# Standardized libs/raft-core/tests/snapshot.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/raft-core/tests/snapshot.rs` captured during libs codegen standardization.
...
changes:
  - path: "libs/raft-core/tests/snapshot.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/raft-core/tests/snapshot.rs` captured during libs codegen standardization.
```
