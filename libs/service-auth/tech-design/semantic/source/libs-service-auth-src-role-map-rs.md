...
|------|--------|------|------------|------|-----------|
| `Role` | libs/service-auth/src/role_map.rs | enum | pub | 43 | pub enum Role { |
| `covers` | libs/service-auth/src/role_map.rs | function | pub | 51 | pub fn covers(self, needed: Role) -> bool { |
| `TokenClaims` | libs/service-auth/src/role_map.rs | struct | pub | 60 | pub struct TokenClaims { |
| `load_registry` | libs/service-auth/src/role_map.rs | function | pub | 76 | pub fn load_registry( |
| `RoleMapPrincipal` | libs/service-auth/src/role_map.rs | enum | pub | 107 | pub enum RoleMapPrincipal { |
| `ensure` | libs/service-auth/src/role_map.rs | function | pub | 118 | pub fn ensure(&self, resource: &str, needed: Role) -> Result<(), RoleMapDenied> { |
| `subject` | libs/service-auth/src/role_map.rs | function | pub | 138 | pub fn subject(&self) -> Option<&str> { |
| `RoleMapDenied` | libs/service-auth/src/role_map.rs | struct | pub | 150 | pub struct RoleMapDenied { |
| `StaticRoleMapVerifier` | libs/service-auth/src/role_map.rs | struct | pub | 159 | pub struct StaticRoleMapVerifier { |
| `new` | libs/service-auth/src/role_map.rs | function | pub | 165 | pub fn new(required: bool, tokens: HashMap<String, TokenClaims>) -> Self { |
| `open` | libs/service-auth/src/role_map.rs | function | pub | 170 | pub fn open() -> Self { |
