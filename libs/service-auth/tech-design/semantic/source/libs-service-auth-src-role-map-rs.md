---
id: libs-service-auth-src-role-map-rs
summary: Lossless rust-source-unit coverage for `libs/service-auth/src/role_map.rs`.
capability_refs:
...
# Standardized libs/service-auth/src/role_map.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/service-auth/src/role_map.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Role` | libs/service-auth/src/role_map.rs | enum | pub | 53 | pub enum Role { |
| `covers` | libs/service-auth/src/role_map.rs | function | pub | 62 | pub fn covers(self, needed: Role) -> bool { |
| `TokenClaims` | libs/service-auth/src/role_map.rs | struct | pub | 72 | pub struct TokenClaims { |
| `Registry` | libs/service-auth/src/role_map.rs | struct | pub | 118 | pub struct Registry { |
| `from_tokens` | libs/service-auth/src/role_map.rs | function | pub | 128 | pub fn from_tokens(tokens: HashMap<String, TokenClaims>) -> Self { |
| `len` | libs/service-auth/src/role_map.rs | function | pub | 136 | pub fn len(&self) -> usize { |
| `is_empty` | libs/service-auth/src/role_map.rs | function | pub | 141 | pub fn is_empty(&self) -> bool { |
| `parse` | libs/service-auth/src/role_map.rs | function | pub | 146 | pub fn parse(json: &str) -> Result<Self> { |
| `load_registry_file` | libs/service-auth/src/role_map.rs | function | pub | 190 | pub fn load_registry_file( |
| `load_registry` | libs/service-auth/src/role_map.rs | function | pub | 225 | pub fn load_registry( |
| `RoleMapPrincipal` | libs/service-auth/src/role_map.rs | enum | pub | 267 | pub enum RoleMapPrincipal { |
| `ensure` | libs/service-auth/src/role_map.rs | function | pub | 279 | pub fn ensure(&self, resource: &str, needed: Role) -> Result<(), RoleMapDenied> { |
| `subject` | libs/service-auth/src/role_map.rs | function | pub | 299 | pub fn subject(&self) -> Option<&str> { |
| `RoleMapDenied` | libs/service-auth/src/role_map.rs | struct | pub | 312 | pub struct RoleMapDenied { |
| `StaticRoleMapVerifier` | libs/service-auth/src/role_map.rs | struct | pub | 322 | pub struct StaticRoleMapVerifier { |
| `new` | libs/service-auth/src/role_map.rs | function | pub | 329 | pub fn new(required: bool, tokens: HashMap<String, TokenClaims>) -> Self { |
| `open` | libs/service-auth/src/role_map.rs | function | pub | 334 | pub fn open() -> Self { |
...
changes:
  - path: "libs/service-auth/src/role_map.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/service-auth/src/role_map.rs` captured during libs codegen standardization.
```
