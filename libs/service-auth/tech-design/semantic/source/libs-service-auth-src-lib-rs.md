---
id: libs-service-auth-src-lib-rs
summary: Lossless rust-source-unit coverage for `libs/service-auth/src/lib.rs`.
capability_refs:
...
# Standardized libs/service-auth/src/lib.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/service-auth/src/lib.rs` captured during libs codegen standardization.
...
changes:
  - path: "libs/service-auth/src/lib.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/service-auth/src/lib.rs` captured during libs codegen standardization.
```
