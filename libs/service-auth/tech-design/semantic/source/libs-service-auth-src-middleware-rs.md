---
id: libs-service-auth-src-middleware-rs
summary: Lossless rust-source-unit coverage for `libs/service-auth/src/middleware.rs`.
capability_refs:
...
# Standardized libs/service-auth/src/middleware.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/service-auth/src/middleware.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `bearer_token` | libs/service-auth/src/middleware.rs | function | pub | 35 | pub fn bearer_token(headers: &HeaderMap) -> Option<&str> { |
| `auth_middleware` | libs/service-auth/src/middleware.rs | function | pub | 50 | pub async fn auth_middleware<V: Verifier>( |
...
changes:
  - path: "libs/service-auth/src/middleware.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/service-auth/src/middleware.rs` captured during libs codegen standardization.
```
