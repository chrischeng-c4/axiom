...
CASES = (
    ("destination-uri-contract-behavior", 12),
    ("destination-uri-contract-security", 13),
    ("crd-safe-scheduled-policy-behavior", 11),
    ("crd-safe-scheduled-policy-security", 11),
    ("retained-object-write-behavior", 12),
    ("retained-object-write-security", 13),
    ("fail-loud-unlinked-adapter-behavior", 10),
    ("fail-loud-unlinked-adapter-security", 11),
    ("exact-object-restore-fetch-behavior", 11),
    ("exact-object-restore-fetch-security", 13),
    ("non-drifting-scheme-documentation-behavior", 10),
    ("non-drifting-scheme-documentation-security", 11),
    ("authenticated-admin-snapshot-transport-behavior", 10),
    ("authenticated-admin-snapshot-transport-security", 10),
)
