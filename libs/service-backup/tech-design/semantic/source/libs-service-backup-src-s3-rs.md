---
id: libs-service-backup-src-s3-rs
summary: Lossless rust-source-unit coverage for `libs/service-backup/src/s3.rs`.
capability_refs:
...
# Standardized libs/service-backup/src/s3.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/service-backup/src/s3.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `S3Sink` | libs/service-backup/src/s3.rs | struct | pub | 15 | pub(crate) struct S3Sink { |
| `from_destination` | libs/service-backup/src/s3.rs | function | pub | 23 | pub(crate) fn from_destination(destination: &BackupDestination) -> Result<Self> { |
| `get_object` | libs/service-backup/src/s3.rs | function | pub | 107 | pub(crate) fn get_object(bucket: String, key: String) -> Result<Vec<u8>> { |
...
changes:
  - path: "libs/service-backup/src/s3.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/service-backup/src/s3.rs` captured during libs codegen standardization.
```
