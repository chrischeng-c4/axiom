...
summary: Lossless rust-source-unit coverage for `libs/claimtoken/src/lib.rs`.
capability_refs:
...
# Standardized libs/claimtoken/src/lib.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/claimtoken/src/lib.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Scope` | libs/claimtoken/src/lib.rs | struct | pub | 14 | pub struct Scope { |
| `sign` | libs/claimtoken/src/lib.rs | function | pub | 50 | pub fn sign(secret: &[u8], scope: &Scope) -> String { |
| `verify` | libs/claimtoken/src/lib.rs | function | pub | 58 | pub fn verify(secret: &[u8], token: &str, now: u64) -> Option<Scope> { |
...
changes:
  - path: "libs/claimtoken/src/lib.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/claimtoken/src/lib.rs` captured during libs codegen standardization.
```
