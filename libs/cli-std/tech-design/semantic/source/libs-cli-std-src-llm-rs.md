...
|------|--------|------|------------|------|-----------|
| `Topic` | libs/cli-std/src/llm.rs | struct | pub | 8 | pub struct Topic { |
| `Format` | libs/cli-std/src/llm.rs | enum | pub | 16 | pub enum Format { |
| `parse` | libs/cli-std/src/llm.rs | function | pub | 23 | pub fn parse(s: &str) -> Self { |
| `render` | libs/cli-std/src/llm.rs | function | pub | 34 | pub fn render( |
