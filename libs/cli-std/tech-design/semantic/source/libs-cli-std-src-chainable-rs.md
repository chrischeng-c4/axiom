---
id: libs-cli-std-src-chainable-rs
summary: Lossless rust-source-unit coverage for `libs/cli-std/src/chainable.rs`.
capability_refs:
...
# Standardized libs/cli-std/src/chainable.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/cli-std/src/chainable.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ChainableViolation` | libs/cli-std/src/chainable.rs | struct | pub | 35 | pub struct ChainableViolation(String); |
| `assert_chainable` | libs/cli-std/src/chainable.rs | function | pub | 77 | pub fn assert_chainable(output: &str) -> Result<(), ChainableViolation> { |
| `assert_command_chainable` | libs/cli-std/src/chainable.rs | function | pub | 126 | pub fn assert_command_chainable(command: &mut std::process::Command) -> anyhow::Result<String> { |
...
changes:
  - path: "libs/cli-std/src/chainable.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/cli-std/src/chainable.rs` captured during libs codegen standardization.
```
