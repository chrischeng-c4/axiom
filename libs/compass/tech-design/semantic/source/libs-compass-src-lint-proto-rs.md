---
id: libs-compass-src-lint-proto-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/proto.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/proto.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/proto.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ProtoChecker` | libs/compass/src/lint/proto.rs | struct | pub | 11 | pub struct ProtoChecker; |
| `new` | libs/compass/src/lint/proto.rs | function | pub | 14 | pub fn new() -> Self { |
...
changes:
  - path: "libs/compass/src/lint/proto.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/proto.rs` captured during libs codegen standardization.
```
