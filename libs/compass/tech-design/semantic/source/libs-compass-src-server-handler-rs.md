---
id: libs-compass-src-server-handler-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/server/handler.rs`.
capability_refs:
...
# Standardized libs/compass/src/server/handler.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/server/handler.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RequestHandler` | libs/compass/src/server/handler.rs | struct | pub | 36 | pub struct RequestHandler { |
| `new` | libs/compass/src/server/handler.rs | function | pub | 57 | pub fn new(root: PathBuf) -> Result<Self, String> { |
| `new_with_scope` | libs/compass/src/server/handler.rs | function | pub | 82 | pub fn new_with_scope( |
| `set_document_override` | libs/compass/src/server/handler.rs | function | pub | 118 | pub async fn set_document_override(&self, path: impl AsRef<Path>, content: String) { |
| `remove_document_override` | libs/compass/src/server/handler.rs | function | pub | 128 | pub async fn remove_document_override(&self, path: impl AsRef<Path>) { |
| `get_document_content` | libs/compass/src/server/handler.rs | function | pub | 138 | pub async fn get_document_content(&self, path: &Path) -> Result<String, String> { |
| `handle` | libs/compass/src/server/handler.rs | function | pub | 152 | pub async fn handle(&self, request: Request) -> Response { |
| `index_directory` | libs/compass/src/server/handler.rs | function | pub | 1023 | pub async fn index_directory(&self, dir: &Path) -> usize { |
| `invalidate_file` | libs/compass/src/server/handler.rs | function | pub | 1038 | pub async fn invalidate_file(&self, path: &Path) { |
| `analyze_file_async` | libs/compass/src/server/handler.rs | function | pub | 1048 | pub async fn analyze_file_async(&self, path_str: &str) -> Option<()> { |
| `cache_size` | libs/compass/src/server/handler.rs | function | pub | 1055 | pub async fn cache_size(&self) -> usize { |
| `flush_cache` | libs/compass/src/server/handler.rs | function | pub | 1061 | pub async fn flush_cache(&self) { |
...
changes:
  - path: "libs/compass/src/server/handler.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/server/handler.rs` captured during libs codegen standardization.
```
