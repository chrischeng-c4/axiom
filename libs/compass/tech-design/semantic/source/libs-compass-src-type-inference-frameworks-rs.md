---
id: libs-compass-src-type-inference-frameworks-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/frameworks.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/frameworks.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/frameworks.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Framework` | libs/compass/src/type_inference/frameworks.rs | enum | pub | 23 | pub enum Framework { |
| `FrameworkDetection` | libs/compass/src/type_inference/frameworks.rs | struct | pub | 35 | pub struct FrameworkDetection { |
| `empty` | libs/compass/src/type_inference/frameworks.rs | function | pub | 46 | pub fn empty() -> Self { |
| `has_framework` | libs/compass/src/type_inference/frameworks.rs | function | pub | 55 | pub fn has_framework(&self, framework: &Framework) -> bool { |
| `confidence_for` | libs/compass/src/type_inference/frameworks.rs | function | pub | 60 | pub fn confidence_for(&self, framework: &Framework) -> f64 { |
| `add_framework` | libs/compass/src/type_inference/frameworks.rs | function | pub | 67 | pub fn add_framework(&mut self, framework: Framework, confidence: f64) { |
| `FrameworkDetector` | libs/compass/src/type_inference/frameworks.rs | struct | pub | 80 | pub struct FrameworkDetector { |
| `new` | libs/compass/src/type_inference/frameworks.rs | function | pub | 87 | pub fn new(root: PathBuf) -> Self { |
| `detect` | libs/compass/src/type_inference/frameworks.rs | function | pub | 96 | pub fn detect(&self) -> FrameworkDetection { |
| `FrameworkTypeProvider` | libs/compass/src/type_inference/frameworks.rs | trait | pub | 403 | pub trait FrameworkTypeProvider { |
| `MethodType` | libs/compass/src/type_inference/frameworks.rs | struct | pub | 419 | pub struct MethodType { |
| `DjangoTypeProvider` | libs/compass/src/type_inference/frameworks.rs | struct | pub | 433 | pub struct DjangoTypeProvider { |
| `DjangoModel` | libs/compass/src/type_inference/frameworks.rs | struct | pub | 440 | pub struct DjangoModel { |
| `DjangoField` | libs/compass/src/type_inference/frameworks.rs | struct | pub | 451 | pub struct DjangoField { |
| `DjangoFieldType` | libs/compass/src/type_inference/frameworks.rs | enum | pub | 464 | pub enum DjangoFieldType { |
| `DjangoRelation` | libs/compass/src/type_inference/frameworks.rs | struct | pub | 480 | pub struct DjangoRelation { |
| `DjangoRelationType` | libs/compass/src/type_inference/frameworks.rs | enum | pub | 491 | pub enum DjangoRelationType { |
| `register_model` | libs/compass/src/type_inference/frameworks.rs | function | pub | 506 | pub fn register_model(&mut self, model: DjangoModel) { |
| `get_model` | libs/compass/src/type_inference/frameworks.rs | function | pub | 511 | pub fn get_model(&self, name: &str) -> Option<&DjangoModel> { |
| `parse_models_from_source` | libs/compass/src/type_inference/frameworks.rs | function | pub | 754 | pub fn parse_models_from_source(&mut self, source: &str, module_path: &str) { |
| `FastAPITypeProvider` | libs/compass/src/type_inference/frameworks.rs | struct | pub | 948 | pub struct FastAPITypeProvider { |
| `FastAPIEndpoint` | libs/compass/src/type_inference/frameworks.rs | struct | pub | 957 | pub struct FastAPIEndpoint { |
| `register_endpoint` | libs/compass/src/type_inference/frameworks.rs | function | pub | 980 | pub fn register_endpoint(&mut self, name: String, endpoint: FastAPIEndpoint) { |
| `register_dependency` | libs/compass/src/type_inference/frameworks.rs | function | pub | 985 | pub fn register_dependency(&mut self, name: String, ty: Type) { |
| `PydanticTypeProvider` | libs/compass/src/type_inference/frameworks.rs | struct | pub | 1172 | pub struct PydanticTypeProvider { |
| `PydanticModel` | libs/compass/src/type_inference/frameworks.rs | struct | pub | 1179 | pub struct PydanticModel { |
| `PydanticField` | libs/compass/src/type_inference/frameworks.rs | struct | pub | 1192 | pub struct PydanticField { |
| `PydanticConfig` | libs/compass/src/type_inference/frameworks.rs | struct | pub | 1207 | pub struct PydanticConfig { |
| `PydanticExtra` | libs/compass/src/type_inference/frameworks.rs | enum | pub | 1218 | pub enum PydanticExtra { |
| `FrameworkRegistry` | libs/compass/src/type_inference/frameworks.rs | struct | pub | 1422 | pub struct FrameworkRegistry { |
| `register` | libs/compass/src/type_inference/frameworks.rs | function | pub | 1436 | pub fn register(&mut self, provider: Box<dyn FrameworkTypeProvider + Send + Sync>) { |
| `get_type` | libs/compass/src/type_inference/frameworks.rs | function | pub | 1441 | pub fn get_type(&self, symbol: &str, context: &TypeContext) -> Option<Type> { |
| `get_attribute_type` | libs/compass/src/type_inference/frameworks.rs | function | pub | 1451 | pub fn get_attribute_type(&self, base_type: &Type, attr: &str) -> Option<Type> { |
| `get_method_signature` | libs/compass/src/type_inference/frameworks.rs | function | pub | 1461 | pub fn get_method_signature(&self, base_type: &Type, method: &str) -> Option<MethodType> { |
...
use super::package_managers::{PackageManagerDetection, PackageManagerDetector};
...
changes:
  - path: "libs/compass/src/type_inference/frameworks.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/frameworks.rs` captured during libs codegen standardization.
```
