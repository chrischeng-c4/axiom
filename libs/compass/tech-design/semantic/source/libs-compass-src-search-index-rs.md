---
id: libs-compass-src-search-index-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/search/index.rs`.
capability_refs:
...
# Standardized libs/compass/src/search/index.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/search/index.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `IndexPosition` | libs/compass/src/search/index.rs | struct | pub | 20 | pub struct IndexPosition { |
| `IndexSymbolKind` | libs/compass/src/search/index.rs | enum | pub | 29 | pub enum IndexSymbolKind { |
| `SymbolEntry` | libs/compass/src/search/index.rs | struct | pub | 91 | pub struct SymbolEntry { |
| `SearchIndex` | libs/compass/src/search/index.rs | struct | pub | 122 | pub struct SearchIndex { |
| `new` | libs/compass/src/search/index.rs | function | pub | 132 | pub fn new() -> Self { |
| `insert` | libs/compass/src/search/index.rs | function | pub | 137 | pub fn insert(&mut self, path: &Path, symbol: &Symbol) { |
| `remove_file` | libs/compass/src/search/index.rs | function | pub | 172 | pub fn remove_file(&mut self, path: &Path) { |
| `query_by_name` | libs/compass/src/search/index.rs | function | pub | 179 | pub fn query_by_name(&self, pattern: &str) -> Vec<&SymbolEntry> { |
| `query_by_type` | libs/compass/src/search/index.rs | function | pub | 191 | pub fn query_by_type(&self, type_sig: &str) -> Vec<&SymbolEntry> { |
| `query_docs` | libs/compass/src/search/index.rs | function | pub | 203 | pub fn query_docs(&self, keyword: &str) -> Vec<&SymbolEntry> { |
| `len` | libs/compass/src/search/index.rs | function | pub | 215 | pub fn len(&self) -> usize { |
| `is_empty` | libs/compass/src/search/index.rs | function | pub | 220 | pub fn is_empty(&self) -> bool { |
| `to_bytes` | libs/compass/src/search/index.rs | function | pub | 227 | pub fn to_bytes(&self) -> anyhow::Result<Vec<u8>> { |
| `from_bytes` | libs/compass/src/search/index.rs | function | pub | 239 | pub fn from_bytes(bytes: &[u8]) -> anyhow::Result<Self> { |
...
changes:
  - path: "libs/compass/src/search/index.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/search/index.rs` captured during libs codegen standardization.
```
