---
id: libs-compass-src-gen-python-quasar-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/gen/python/quasar.rs`.
capability_refs:
...
# Standardized libs/compass/src/gen/python/quasar.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/gen/python/quasar.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `QuasarGenerator` | libs/compass/src/gen/python/quasar.rs | struct | pub | 10 | pub struct QuasarGenerator; |
| `new` | libs/compass/src/gen/python/quasar.rs | function | pub | 13 | pub fn new() -> Self { |
| `generate_router` | libs/compass/src/gen/python/quasar.rs | function | pub | 18 | pub fn generate_router(&self, spec: &RestApiSpec, ctx: &GenContext) -> String { |
...
changes:
  - path: "libs/compass/src/gen/python/quasar.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/gen/python/quasar.rs` captured during libs codegen standardization.
```
