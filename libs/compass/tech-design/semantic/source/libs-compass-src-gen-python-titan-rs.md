---
id: libs-compass-src-gen-python-titan-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/gen/python/titan.rs`.
capability_refs:
...
# Standardized libs/compass/src/gen/python/titan.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/gen/python/titan.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TitanGenerator` | libs/compass/src/gen/python/titan.rs | struct | pub | 13 | pub struct TitanGenerator; |
| `new` | libs/compass/src/gen/python/titan.rs | function | pub | 16 | pub fn new() -> Self { |
...
changes:
  - path: "libs/compass/src/gen/python/titan.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/gen/python/titan.rs` captured during libs codegen standardization.
```
