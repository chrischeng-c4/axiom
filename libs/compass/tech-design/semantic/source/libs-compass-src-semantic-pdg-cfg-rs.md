---
id: libs-compass-src-semantic-pdg-cfg-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/semantic/pdg/cfg.rs`.
capability_refs:
...
# Standardized libs/compass/src/semantic/pdg/cfg.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/semantic/pdg/cfg.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `BlockId` | libs/compass/src/semantic/pdg/cfg.rs | type | pub | 12 | pub type BlockId = u32; |
| `BasicBlock` | libs/compass/src/semantic/pdg/cfg.rs | struct | pub | 16 | pub struct BasicBlock { |
| `StatementInfo` | libs/compass/src/semantic/pdg/cfg.rs | struct | pub | 27 | pub struct StatementInfo { |
| `StatementKind` | libs/compass/src/semantic/pdg/cfg.rs | enum | pub | 40 | pub enum StatementKind { |
| `BlockKind` | libs/compass/src/semantic/pdg/cfg.rs | enum | pub | 71 | pub enum BlockKind { |
| `EdgeKind` | libs/compass/src/semantic/pdg/cfg.rs | enum | pub | 94 | pub enum EdgeKind { |
| `CfgEdge` | libs/compass/src/semantic/pdg/cfg.rs | struct | pub | 115 | pub struct CfgEdge { |
| `ControlFlowGraph` | libs/compass/src/semantic/pdg/cfg.rs | struct | pub | 126 | pub struct ControlFlowGraph { |
| `new` | libs/compass/src/semantic/pdg/cfg.rs | function | pub | 145 | pub fn new() -> Self { |
| `create_block` | libs/compass/src/semantic/pdg/cfg.rs | function | pub | 178 | pub fn create_block(&mut self, kind: BlockKind) -> BlockId { |
| `add_edge` | libs/compass/src/semantic/pdg/cfg.rs | function | pub | 193 | pub fn add_edge(&mut self, from: BlockId, to: BlockId, kind: EdgeKind) { |
| `add_statement` | libs/compass/src/semantic/pdg/cfg.rs | function | pub | 204 | pub fn add_statement(&mut self, block_id: BlockId, stmt: StatementInfo) { |
| `get_successors` | libs/compass/src/semantic/pdg/cfg.rs | function | pub | 211 | pub fn get_successors(&self, block_id: BlockId) -> Vec<BlockId> { |
| `get_predecessors` | libs/compass/src/semantic/pdg/cfg.rs | function | pub | 219 | pub fn get_predecessors(&self, block_id: BlockId) -> Vec<BlockId> { |
| `block_ids` | libs/compass/src/semantic/pdg/cfg.rs | function | pub | 227 | pub fn block_ids(&self) -> Vec<BlockId> { |
| `get_block` | libs/compass/src/semantic/pdg/cfg.rs | function | pub | 232 | pub fn get_block(&self, id: BlockId) -> Option<&BasicBlock> { |
| `all_statements` | libs/compass/src/semantic/pdg/cfg.rs | function | pub | 237 | pub fn all_statements(&self) -> Vec<&StatementInfo> { |
| `dominates` | libs/compass/src/semantic/pdg/cfg.rs | function | pub | 250 | pub fn dominates(&self, a: BlockId, b: BlockId) -> bool { |
| `CfgBuilder` | libs/compass/src/semantic/pdg/cfg.rs | struct | pub | 280 | pub struct CfgBuilder<'a> { |
| `build` | libs/compass/src/semantic/pdg/cfg.rs | function | pub | 323 | pub fn build(mut self, file: &ParsedFile) -> ControlFlowGraph { |
| `build_function` | libs/compass/src/semantic/pdg/cfg.rs | function | pub | 345 | pub fn build_function( |
...
changes:
  - path: "libs/compass/src/semantic/pdg/cfg.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/semantic/pdg/cfg.rs` captured during libs codegen standardization.
```
