---
id: libs-compass-src-type-inference-rust-types-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/rust_types.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/rust_types.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/rust_types.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `LifetimeId` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 14 | pub struct LifetimeId(pub usize); |
| `Lifetime` | libs/compass/src/type_inference/rust_types.rs | enum | pub | 18 | pub enum Lifetime { |
| `named` | libs/compass/src/type_inference/rust_types.rs | function | pub | 31 | pub fn named(id: LifetimeId, name: impl Into<String>) -> Self { |
| `outlives` | libs/compass/src/type_inference/rust_types.rs | function | pub | 39 | pub fn outlives(&self, other: &Lifetime) -> bool { |
| `TraitId` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 55 | pub struct TraitId(pub usize); |
| `TraitDef` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 59 | pub struct TraitDef { |
| `TraitBound` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 84 | pub struct TraitBound { |
| `TraitRef` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 95 | pub struct TraitRef { |
| `AssociatedType` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 108 | pub struct AssociatedType { |
| `TraitMethod` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 119 | pub struct TraitMethod { |
| `SelfParam` | libs/compass/src/type_inference/rust_types.rs | enum | pub | 140 | pub enum SelfParam { |
| `RustType` | libs/compass/src/type_inference/rust_types.rs | enum | pub | 157 | pub enum RustType { |
| `ClosureKind` | libs/compass/src/type_inference/rust_types.rs | enum | pub | 263 | pub enum ClosureKind { |
| `RustTypeParam` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 271 | pub struct RustTypeParam { |
| `RustParam` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 284 | pub struct RustParam { |
| `WherePredicate` | libs/compass/src/type_inference/rust_types.rs | enum | pub | 295 | pub enum WherePredicate { |
| `ImplBlock` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 316 | pub struct ImplBlock { |
| `ImplMethod` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 339 | pub struct ImplMethod { |
| `Visibility` | libs/compass/src/type_inference/rust_types.rs | enum | pub | 352 | pub enum Visibility { |
| `StructDef` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 366 | pub struct StructDef { |
| `StructFields` | libs/compass/src/type_inference/rust_types.rs | enum | pub | 383 | pub enum StructFields { |
| `StructField` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 394 | pub struct StructField { |
| `EnumDef` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 405 | pub struct EnumDef { |
| `EnumVariant` | libs/compass/src/type_inference/rust_types.rs | struct | pub | 422 | pub struct EnumVariant { |
| `to_generic_type` | libs/compass/src/type_inference/rust_types.rs | function | pub | 437 | pub fn to_generic_type(&self) -> Type { |
| `implements_trait` | libs/compass/src/type_inference/rust_types.rs | function | pub | 479 | pub fn implements_trait(&self, trait_ref: &TraitRef, impls: &[ImplBlock]) -> bool { |
| `array_size` | libs/compass/src/type_inference/rust_types.rs | function | pub | 566 | pub fn array_size(&self) -> Option<usize> { |
...
changes:
  - path: "libs/compass/src/type_inference/rust_types.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/rust_types.rs` captured during libs codegen standardization.
```
