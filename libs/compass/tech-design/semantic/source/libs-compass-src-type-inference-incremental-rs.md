---
id: libs-compass-src-type-inference-incremental-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/incremental.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/incremental.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/incremental.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `FileChange` | libs/compass/src/type_inference/incremental.rs | struct | pub | 24 | pub struct FileChange { |
| `ChangeKind` | libs/compass/src/type_inference/incremental.rs | enum | pub | 37 | pub enum ChangeKind { |
| `ChangeTracker` | libs/compass/src/type_inference/incremental.rs | struct | pub | 49 | pub struct ChangeTracker { |
| `new` | libs/compass/src/type_inference/incremental.rs | function | pub | 60 | pub fn new() -> Self { |
| `with_debounce` | libs/compass/src/type_inference/incremental.rs | function | pub | 69 | pub fn with_debounce(mut self, debounce: Duration) -> Self { |
| `record_change` | libs/compass/src/type_inference/incremental.rs | function | pub | 75 | pub fn record_change(&mut self, file: PathBuf, kind: ChangeKind, new_hash: ContentHash) { |
| `get_pending_changes` | libs/compass/src/type_inference/incremental.rs | function | pub | 91 | pub fn get_pending_changes(&mut self) -> Vec<FileChange> { |
| `has_changed` | libs/compass/src/type_inference/incremental.rs | function | pub | 106 | pub fn has_changed(&self, file: &PathBuf, hash: &ContentHash) -> bool { |
| `clear` | libs/compass/src/type_inference/incremental.rs | function | pub | 114 | pub fn clear(&mut self) { |
| `DependencyGraph` | libs/compass/src/type_inference/incremental.rs | struct | pub | 130 | pub struct DependencyGraph { |
| `add_dependency` | libs/compass/src/type_inference/incremental.rs | function | pub | 147 | pub fn add_dependency(&mut self, from: PathBuf, to: PathBuf) { |
| `remove_file` | libs/compass/src/type_inference/incremental.rs | function | pub | 156 | pub fn remove_file(&mut self, file: &PathBuf) { |
| `get_affected_files` | libs/compass/src/type_inference/incremental.rs | function | pub | 177 | pub fn get_affected_files(&self, changed: &PathBuf) -> HashSet<PathBuf> { |
| `get_dependencies` | libs/compass/src/type_inference/incremental.rs | function | pub | 193 | pub fn get_dependencies(&self, file: &PathBuf) -> Option<&HashSet<PathBuf>> { |
| `get_dependents` | libs/compass/src/type_inference/incremental.rs | function | pub | 198 | pub fn get_dependents(&self, file: &PathBuf) -> Option<&HashSet<PathBuf>> { |
| `contains` | libs/compass/src/type_inference/incremental.rs | function | pub | 203 | pub fn contains(&self, file: &PathBuf) -> bool { |
| `IncrementalConfig` | libs/compass/src/type_inference/incremental.rs | struct | pub | 220 | pub struct IncrementalConfig { |
| `AnalysisResult` | libs/compass/src/type_inference/incremental.rs | struct | pub | 247 | pub struct AnalysisResult { |
| `empty` | libs/compass/src/type_inference/incremental.rs | function | pub | 260 | pub fn empty() -> Self { |
| `has_failures` | libs/compass/src/type_inference/incremental.rs | function | pub | 270 | pub fn has_failures(&self) -> bool { |
| `IncrementalAnalyzer` | libs/compass/src/type_inference/incremental.rs | struct | pub | 276 | pub struct IncrementalAnalyzer { |
| `CachedAnalysis` | libs/compass/src/type_inference/incremental.rs | struct | pub | 290 | pub struct CachedAnalysis { |
| `default_config` | libs/compass/src/type_inference/incremental.rs | function | pub | 313 | pub fn default_config() -> Self { |
| `file_changed` | libs/compass/src/type_inference/incremental.rs | function | pub | 318 | pub fn file_changed(&mut self, file: PathBuf, kind: ChangeKind, hash: ContentHash) { |
| `get_files_to_analyze` | libs/compass/src/type_inference/incremental.rs | function | pub | 323 | pub fn get_files_to_analyze(&mut self) -> Vec<PathBuf> { |
| `analyze` | libs/compass/src/type_inference/incremental.rs | function | pub | 341 | pub fn analyze(&mut self, files: Vec<PathBuf>) -> AnalysisResult { |
| `invalidate` | libs/compass/src/type_inference/incremental.rs | function | pub | 535 | pub fn invalidate(&mut self, file: &PathBuf) { |
| `clear_cache` | libs/compass/src/type_inference/incremental.rs | function | pub | 540 | pub fn clear_cache(&mut self) { |
| `dep_graph` | libs/compass/src/type_inference/incremental.rs | function | pub | 546 | pub fn dep_graph(&self) -> &DependencyGraph { |
...
changes:
  - path: "libs/compass/src/type_inference/incremental.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/incremental.rs` captured during libs codegen standardization.
```
