---
id: libs-compass-src-search-query-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/search/query.rs`.
capability_refs:
...
# Standardized libs/compass/src/search/query.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/search/query.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `search_by_type_signature` | libs/compass/src/search/query.rs | function | pub | 87 | pub fn search_by_type_signature(index: &SearchIndex, q: &SearchQuery, pat: &str) -> SearchResult { |
| `CallGraphIndex` | libs/compass/src/search/query.rs | struct | pub | 160 | pub struct CallGraphIndex { |
| `search_call_hierarchy` | libs/compass/src/search/query.rs | function | pub | 165 | pub fn search_call_hierarchy( |
| `search_implementations` | libs/compass/src/search/query.rs | function | pub | 216 | pub fn search_implementations(index: &SearchIndex, q: &SearchQuery, proto: &str) -> SearchResult { |
| `search_usages` | libs/compass/src/search/query.rs | function | pub | 263 | pub fn search_usages( |
| `search_similar_code` | libs/compass/src/search/query.rs | function | pub | 292 | pub fn search_similar_code(index: &SearchIndex, q: &SearchQuery, pattern: &str) -> SearchResult { |
| `search_documentation` | libs/compass/src/search/query.rs | function | pub | 364 | pub fn search_documentation(index: &SearchIndex, q: &SearchQuery, kw: &str) -> SearchResult { |
...
changes:
  - path: "libs/compass/src/search/query.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/search/query.rs` captured during libs codegen standardization.
```
