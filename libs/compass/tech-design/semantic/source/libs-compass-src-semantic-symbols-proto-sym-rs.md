---
id: libs-compass-src-semantic-symbols-proto-sym-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/semantic/symbols/proto_sym.rs`.
capability_refs:
...
# Standardized libs/compass/src/semantic/symbols/proto_sym.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/semantic/symbols/proto_sym.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `visit_proto_lines` | libs/compass/src/semantic/symbols/proto_sym.rs | function | pub | 15 | pub(crate) fn visit_proto_lines(&mut self, source: &str) { |
| `build_proto` | libs/compass/src/semantic/symbols/proto_sym.rs | function | pub | 156 | pub fn build_proto(mut self, file: &crate::syntax::ParsedFile) -> super::SymbolTable { |
| `build_proto_from_source` | libs/compass/src/semantic/symbols/proto_sym.rs | function | pub | 163 | pub fn build_proto_from_source(mut self, source: &str) -> super::SymbolTable { |
...
changes:
  - path: "libs/compass/src/semantic/symbols/proto_sym.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/semantic/symbols/proto_sym.rs` captured during libs codegen standardization.
```
