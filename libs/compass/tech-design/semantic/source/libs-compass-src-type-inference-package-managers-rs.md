---
id: libs-compass-src-type-inference-package-managers-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/package_managers.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/package_managers.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/package_managers.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `PackageManager` | libs/compass/src/type_inference/package_managers.rs | enum | pub | 24 | pub enum PackageManager { |
| `display_name` | libs/compass/src/type_inference/package_managers.rs | function | pub | 39 | pub fn display_name(&self) -> &str { |
| `config_file_name` | libs/compass/src/type_inference/package_managers.rs | function | pub | 50 | pub fn config_file_name(&self) -> &str { |
| `lock_file_name` | libs/compass/src/type_inference/package_managers.rs | function | pub | 61 | pub fn lock_file_name(&self) -> Option<&str> { |
| `Dependency` | libs/compass/src/type_inference/package_managers.rs | struct | pub | 74 | pub struct Dependency { |
| `new` | libs/compass/src/type_inference/package_managers.rs | function | pub | 89 | pub fn new(name: String) -> Self { |
| `with_version` | libs/compass/src/type_inference/package_managers.rs | function | pub | 100 | pub fn with_version(mut self, version: String) -> Self { |
| `with_extras` | libs/compass/src/type_inference/package_managers.rs | function | pub | 106 | pub fn with_extras(mut self, extras: Vec<String>) -> Self { |
| `as_dev` | libs/compass/src/type_inference/package_managers.rs | function | pub | 112 | pub fn as_dev(mut self) -> Self { |
| `is_framework` | libs/compass/src/type_inference/package_managers.rs | function | pub | 118 | pub fn is_framework(&self) -> bool { |
| `PackageManagerDetection` | libs/compass/src/type_inference/package_managers.rs | struct | pub | 128 | pub struct PackageManagerDetection { |
| `unknown` | libs/compass/src/type_inference/package_managers.rs | function | pub | 145 | pub fn unknown() -> Self { |
| `framework_dependencies` | libs/compass/src/type_inference/package_managers.rs | function | pub | 157 | pub fn framework_dependencies(&self) -> Vec<&Dependency> { |
| `has_dependency` | libs/compass/src/type_inference/package_managers.rs | function | pub | 165 | pub fn has_dependency(&self, name: &str) -> bool { |
| `get_dependency` | libs/compass/src/type_inference/package_managers.rs | function | pub | 170 | pub fn get_dependency(&self, name: &str) -> Option<&Dependency> { |
| `PackageManagerDetector` | libs/compass/src/type_inference/package_managers.rs | struct | pub | 180 | pub struct PackageManagerDetector { |
| `detect` | libs/compass/src/type_inference/package_managers.rs | function | pub | 194 | pub fn detect(&self) -> PackageManagerDetection { |
| `parse_dependency_line` | libs/compass/src/type_inference/package_managers.rs | function | pub | 491 | pub fn parse_dependency_line(line: &str) -> Option<Dependency> { |
...
changes:
  - path: "libs/compass/src/type_inference/package_managers.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/package_managers.rs` captured during libs codegen standardization.
```
