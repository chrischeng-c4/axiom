---
id: libs-compass-src-search-mod-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/search/mod.rs`.
capability_refs:
...
# Standardized libs/compass/src/search/mod.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/search/mod.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `index` | libs/compass/src/search/mod.rs | module | pub | 11 | pub mod index; |
| `query` | libs/compass/src/search/mod.rs | module | pub | 12 | pub mod query; |
| `SearchEngine` | libs/compass/src/search/mod.rs | struct | pub | 35 | pub struct SearchEngine { |
| `new` | libs/compass/src/search/mod.rs | function | pub | 44 | pub fn new() -> Self { |
| `build_index` | libs/compass/src/search/mod.rs | function | pub | 54 | pub fn build_index(&mut self, symbols: &HashMap<PathBuf, SymbolTable>) { |
| `update_file` | libs/compass/src/search/mod.rs | function | pub | 64 | pub fn update_file(&mut self, path: &Path, symbols: &SymbolTable) { |
| `remove_file` | libs/compass/src/search/mod.rs | function | pub | 71 | pub fn remove_file(&mut self, path: &Path) { |
| `save_index` | libs/compass/src/search/mod.rs | function | pub | 79 | pub fn save_index(&self, project_root: &Path) -> Result<()> { |
| `load_index` | libs/compass/src/search/mod.rs | function | pub | 91 | pub fn load_index(project_root: &Path) -> Result<Self> { |
| `search` | libs/compass/src/search/mod.rs | function | pub | 108 | pub fn search(&self, query: SearchQuery) -> SearchResult { |
| `index_size` | libs/compass/src/search/mod.rs | function | pub | 150 | pub fn index_size(&self) -> usize { |
| `is_empty` | libs/compass/src/search/mod.rs | function | pub | 155 | pub fn is_empty(&self) -> bool { |
| `raw_index` | libs/compass/src/search/mod.rs | function | pub | 160 | pub fn raw_index(&self) -> &SearchIndex { |
| `call_graph_mut` | libs/compass/src/search/mod.rs | function | pub | 165 | pub fn call_graph_mut(&mut self) -> &mut CallGraphIndex { |
...
changes:
  - path: "libs/compass/src/search/mod.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/search/mod.rs` captured during libs codegen standardization.
```
