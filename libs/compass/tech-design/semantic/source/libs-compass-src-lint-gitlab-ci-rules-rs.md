---
id: libs-compass-src-lint-gitlab-ci-rules-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/gitlab_ci_rules.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/gitlab_ci_rules.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/gitlab_ci_rules.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `check_unknown_keywords` | libs/compass/src/lint/gitlab_ci_rules.rs | function | pub | 8 | pub(super) fn check_unknown_keywords(jobs: &[CiJob], lines: &[&str]) -> Vec<Diagnostic> { |
| `check_needs_references` | libs/compass/src/lint/gitlab_ci_rules.rs | function | pub | 67 | pub(super) fn check_needs_references(jobs: &[CiJob], lines: &[&str]) -> Vec<Diagnostic> { |
| `check_circular_needs` | libs/compass/src/lint/gitlab_ci_rules.rs | function | pub | 92 | pub(super) fn check_circular_needs(jobs: &[CiJob], lines: &[&str]) -> Vec<Diagnostic> { |
| `check_missing_timeout` | libs/compass/src/lint/gitlab_ci_rules.rs | function | pub | 187 | pub(super) fn check_missing_timeout(jobs: &[CiJob], lines: &[&str]) -> Vec<Diagnostic> { |
| `check_allow_failure_without_manual` | libs/compass/src/lint/gitlab_ci_rules.rs | function | pub | 212 | pub(super) fn check_allow_failure_without_manual( |
| `check_unused_templates` | libs/compass/src/lint/gitlab_ci_rules.rs | function | pub | 240 | pub(super) fn check_unused_templates( |
| `check_invalid_includes` | libs/compass/src/lint/gitlab_ci_rules.rs | function | pub | 279 | pub(super) fn check_invalid_includes(lines: &[&str]) -> Vec<Diagnostic> { |
...
changes:
  - path: "libs/compass/src/lint/gitlab_ci_rules.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/gitlab_ci_rules.rs` captured during libs codegen standardization.
```
