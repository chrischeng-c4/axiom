---
id: libs-compass-src-type-inference-project-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/project.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/project.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/project.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ProjectConfig` | libs/compass/src/type_inference/project.rs | struct | pub | 47 | pub struct ProjectConfig { |
| `new` | libs/compass/src/type_inference/project.rs | function | pub | 63 | pub fn new(root: PathBuf) -> Self { |
| `from_pyproject` | libs/compass/src/type_inference/project.rs | function | pub | 75 | pub fn from_pyproject(root: &Path) -> Self { |
| `should_exclude` | libs/compass/src/type_inference/project.rs | function | pub | 138 | pub fn should_exclude(&self, path: &Path) -> bool { |
| `ProjectAnalyzer` | libs/compass/src/type_inference/project.rs | struct | pub | 157 | pub struct ProjectAnalyzer { |
| `from_root` | libs/compass/src/type_inference/project.rs | function | pub | 193 | pub fn from_root(root: &Path) -> Result<Self> { |
| `discover_files` | libs/compass/src/type_inference/project.rs | function | pub | 199 | pub fn discover_files(&self) -> Vec<PathBuf> { |
| `build_graph` | libs/compass/src/type_inference/project.rs | function | pub | 235 | pub fn build_graph(&mut self) { |
| `analyze` | libs/compass/src/type_inference/project.rs | function | pub | 285 | pub fn analyze(&mut self) -> &HashMap<String, Vec<TypeError>> { |
| `get_module_info` | libs/compass/src/type_inference/project.rs | function | pub | 346 | pub fn get_module_info(&self, name: &str) -> Option<&ModuleInfo> { |
| `get_type` | libs/compass/src/type_inference/project.rs | function | pub | 351 | pub fn get_type(&self, module: &str, name: &str) -> Option<&Type> { |
| `all_errors` | libs/compass/src/type_inference/project.rs | function | pub | 368 | pub fn all_errors(&self) -> impl Iterator<Item = (&String, &Vec<TypeError>)> { |
| `module_errors` | libs/compass/src/type_inference/project.rs | function | pub | 373 | pub fn module_errors(&self, name: &str) -> Option<&Vec<TypeError>> { |
| `graph` | libs/compass/src/type_inference/project.rs | function | pub | 378 | pub fn graph(&self) -> &ModuleGraph { |
| `circular_imports` | libs/compass/src/type_inference/project.rs | function | pub | 383 | pub fn circular_imports(&self) -> Vec<Vec<String>> { |
| `cache` | libs/compass/src/type_inference/project.rs | function | pub | 388 | pub fn cache(&self) -> &AnalysisCache { |
| `analyze_parallel` | libs/compass/src/type_inference/project.rs | function | pub | 394 | pub fn analyze_parallel(&mut self) -> &HashMap<String, Vec<TypeError>> { |
| `analyze_incremental` | libs/compass/src/type_inference/project.rs | function | pub | 469 | pub fn analyze_incremental(&mut self) -> &HashMap<String, Vec<TypeError>> { |
...
changes:
  - path: "libs/compass/src/type_inference/project.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/project.rs` captured during libs codegen standardization.
```
