---
id: libs-compass-src-type-inference-rust-symbols-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/rust_symbols.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/rust_symbols.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/rust_symbols.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RustSymbols` | libs/compass/src/type_inference/rust_symbols.rs | struct | pub | 17 | pub struct RustSymbols { |
| `RustFunction` | libs/compass/src/type_inference/rust_symbols.rs | struct | pub | 36 | pub struct RustFunction { |
| `RustConstant` | libs/compass/src/type_inference/rust_symbols.rs | struct | pub | 61 | pub struct RustConstant { |
| `RustTypeAlias` | libs/compass/src/type_inference/rust_symbols.rs | struct | pub | 74 | pub struct RustTypeAlias { |
| `RustSymbolCollector` | libs/compass/src/type_inference/rust_symbols.rs | struct | pub | 92 | pub struct RustSymbolCollector { |
| `new` | libs/compass/src/type_inference/rust_symbols.rs | function | pub | 103 | pub fn new() -> Self { |
| `collect` | libs/compass/src/type_inference/rust_symbols.rs | function | pub | 112 | pub fn collect(&mut self, node: &Node, source: &str) -> RustSymbols { |
...
changes:
  - path: "libs/compass/src/type_inference/rust_symbols.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/rust_symbols.rs` captured during libs codegen standardization.
```
