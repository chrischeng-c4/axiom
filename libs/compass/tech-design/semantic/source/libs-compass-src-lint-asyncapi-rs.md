---
id: libs-compass-src-lint-asyncapi-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/asyncapi.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/asyncapi.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/asyncapi.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AsyncApiChecker` | libs/compass/src/lint/asyncapi.rs | struct | pub | 8 | pub struct AsyncApiChecker; |
| `new` | libs/compass/src/lint/asyncapi.rs | function | pub | 11 | pub fn new() -> Self { |
| `is_asyncapi` | libs/compass/src/lint/asyncapi.rs | function | pub | 16 | pub fn is_asyncapi(source: &str) -> bool { |
...
changes:
  - path: "libs/compass/src/lint/asyncapi.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/asyncapi.rs` captured during libs codegen standardization.
```
