---
id: libs-compass-src-lint-kubernetes-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/kubernetes.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/kubernetes.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/kubernetes.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `KubernetesChecker` | libs/compass/src/lint/kubernetes.rs | struct | pub | 9 | pub struct KubernetesChecker; |
| `new` | libs/compass/src/lint/kubernetes.rs | function | pub | 12 | pub fn new() -> Self { |
| `is_k8s_manifest` | libs/compass/src/lint/kubernetes.rs | function | pub | 255 | pub(super) fn is_k8s_manifest(lines: &[&str]) -> bool { |
...
changes:
  - path: "libs/compass/src/lint/kubernetes.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/kubernetes.rs` captured during libs codegen standardization.
```
