---
id: libs-compass-src-lint-autofix-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/autofix.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/autofix.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/autofix.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `FixResult` | libs/compass/src/lint/autofix.rs | struct | pub | 9 | pub struct FixResult { |
| `apply_fix` | libs/compass/src/lint/autofix.rs | function | pub | 22 | pub fn apply_fix(source: &str, fix: &QuickFix) -> FixResult { |
| `apply_all_fixes` | libs/compass/src/lint/autofix.rs | function | pub | 56 | pub fn apply_all_fixes(source: &str, diagnostics: &[Diagnostic]) -> FixResult { |
...
changes:
  - path: "libs/compass/src/lint/autofix.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/autofix.rs` captured during libs codegen standardization.
```
