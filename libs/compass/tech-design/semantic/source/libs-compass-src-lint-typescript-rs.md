---
id: libs-compass-src-lint-typescript-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/typescript.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/typescript.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/typescript.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TypeScriptChecker` | libs/compass/src/lint/typescript.rs | struct | pub | 8 | pub struct TypeScriptChecker; |
| `new` | libs/compass/src/lint/typescript.rs | function | pub | 11 | pub fn new() -> Self { |
...
changes:
  - path: "libs/compass/src/lint/typescript.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/typescript.rs` captured during libs codegen standardization.
```
