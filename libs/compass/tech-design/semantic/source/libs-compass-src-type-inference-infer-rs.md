---
id: libs-compass-src-type-inference-infer-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/infer.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/infer.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/infer.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TypeInferencer` | libs/compass/src/type_inference/infer.rs | struct | pub | 16 | pub struct TypeInferencer<'a> { |
| `new` | libs/compass/src/type_inference/infer.rs | function | pub | 43 | pub fn new(source: &'a str) -> Self { |
| `framework_registry_mut` | libs/compass/src/type_inference/infer.rs | function | pub | 73 | pub fn framework_registry_mut(&mut self) -> &mut FrameworkRegistry { |
| `bind_type` | libs/compass/src/type_inference/infer.rs | function | pub | 78 | pub fn bind_type(&mut self, name: String, ty: Type) { |
| `set_type_overrides` | libs/compass/src/type_inference/infer.rs | function | pub | 83 | pub fn set_type_overrides(&mut self, overrides: HashMap<String, Type>) { |
| `clear_type_overrides` | libs/compass/src/type_inference/infer.rs | function | pub | 88 | pub fn clear_type_overrides(&mut self) { |
| `register_type_var` | libs/compass/src/type_inference/infer.rs | function | pub | 93 | pub fn register_type_var(&mut self, name: &str, bound: Option<Type>, constraints: Vec<Type>) { |
| `register_type_var_with_variance` | libs/compass/src/type_inference/infer.rs | function | pub | 98 | pub fn register_type_var_with_variance( |
| `get_type_var` | libs/compass/src/type_inference/infer.rs | function | pub | 119 | pub fn get_type_var(&self, name: &str) -> Option<&Type> { |
| `instantiate_generic` | libs/compass/src/type_inference/infer.rs | function | pub | 124 | pub fn instantiate_generic(&self, generic_type: &Type, type_args: &[Type]) -> Type { |
| `get_class` | libs/compass/src/type_inference/infer.rs | function | pub | 139 | pub fn get_class(&self, name: &str) -> Option<&ClassInfo> { |
| `get_attribute_recursive` | libs/compass/src/type_inference/infer.rs | function | pub | 145 | pub fn get_attribute_recursive(&self, class_name: &str, attr_name: &str) -> Option<Type> { |
| `is_subclass` | libs/compass/src/type_inference/infer.rs | function | pub | 183 | pub fn is_subclass(&self, child: &str, parent: &str) -> bool { |
| `infer_expr` | libs/compass/src/type_inference/infer.rs | function | pub | 220 | pub fn infer_expr(&mut self, node: &Node) -> Type { |
| `analyze_dataclass` | libs/compass/src/type_inference/infer.rs | function | pub | 754 | pub fn analyze_dataclass(&mut self, node: &Node) -> Type { |
| `analyze_namedtuple` | libs/compass/src/type_inference/infer.rs | function | pub | 868 | pub fn analyze_namedtuple(&mut self, node: &Node) -> Type { |
| `has_property_decorator` | libs/compass/src/type_inference/infer.rs | function | pub | 933 | pub fn has_property_decorator(&self, node: &Node) -> bool { |
| `get_property_type` | libs/compass/src/type_inference/infer.rs | function | pub | 964 | pub fn get_property_type(&mut self, node: &Node) -> Type { |
| `analyze_function` | libs/compass/src/type_inference/infer.rs | function | pub | 972 | pub fn analyze_function(&mut self, node: &Node) -> Type { |
| `analyze_class` | libs/compass/src/type_inference/infer.rs | function | pub | 1051 | pub fn analyze_class(&mut self, node: &Node) -> ClassInfo { |
| `bind_assignment` | libs/compass/src/type_inference/infer.rs | function | pub | 1332 | pub fn bind_assignment(&mut self, target: &Node, value_type: Type) { |
| `env` | libs/compass/src/type_inference/infer.rs | function | pub | 1340 | pub fn env(&self) -> &TypeEnv { |
| `get_env_types` | libs/compass/src/type_inference/infer.rs | function | pub | 1345 | pub fn get_env_types(&self) -> HashMap<String, Type> { |
| `analyze_import` | libs/compass/src/type_inference/infer.rs | function | pub | 1350 | pub fn analyze_import(&mut self, node: &Node) { |
| `parse_typevar_call` | libs/compass/src/type_inference/infer.rs | function | pub | 1367 | pub fn parse_typevar_call(&self, node: &Node) -> Option<TypeVarInfo> { |
| `try_register_typevar_assignment` | libs/compass/src/type_inference/infer.rs | function | pub | 1447 | pub fn try_register_typevar_assignment(&mut self, node: &Node) -> bool { |
| `TypeVarInfo` | libs/compass/src/type_inference/infer.rs | struct | pub | 1482 | pub struct TypeVarInfo { |
...
changes:
  - path: "libs/compass/src/type_inference/infer.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/infer.rs` captured during libs codegen standardization.
```
