---
id: libs-compass-src-lint-go-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/go.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/go.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/go.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `GoImportGraph` | libs/compass/src/lint/go.rs | struct | pub | 22 | pub struct GoImportGraph { |
| `new` | libs/compass/src/lint/go.rs | function | pub | 32 | pub fn new() -> Self { |
| `add_file` | libs/compass/src/lint/go.rs | function | pub | 37 | pub fn add_file(&mut self, file_path: &str, file: &ParsedFile) { |
| `files_importing` | libs/compass/src/lint/go.rs | function | pub | 49 | pub fn files_importing(&self, module_path: &str) -> Vec<&str> { |
| `imports_of` | libs/compass/src/lint/go.rs | function | pub | 57 | pub fn imports_of(&self, file_path: &str) -> Vec<&str> { |
| `GoChecker` | libs/compass/src/lint/go.rs | struct | pub | 91 | pub struct GoChecker; |
...
changes:
  - path: "libs/compass/src/lint/go.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/go.rs` captured during libs codegen standardization.
```
