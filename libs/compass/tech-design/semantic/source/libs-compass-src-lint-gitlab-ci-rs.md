---
id: libs-compass-src-lint-gitlab-ci-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/gitlab_ci.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/gitlab_ci.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/gitlab_ci.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `GitlabCiChecker` | libs/compass/src/lint/gitlab_ci.rs | struct | pub | 10 | pub struct GitlabCiChecker; |
| `CiJob` | libs/compass/src/lint/gitlab_ci.rs | struct | pub | 14 | pub(super) struct CiJob { |
| `new` | libs/compass/src/lint/gitlab_ci.rs | function | pub | 33 | pub fn new() -> Self { |
| `parse_ci_structure` | libs/compass/src/lint/gitlab_ci.rs | function | pub | 57 | pub(super) fn parse_ci_structure(lines: &[&str]) -> (Vec<String>, Vec<CiJob>, Vec<String>) { |
| `extract_yaml_key` | libs/compass/src/lint/gitlab_ci.rs | function | pub | 372 | pub(super) fn extract_yaml_key(line: &str) -> Option<&str> { |
| `extract_yaml_value` | libs/compass/src/lint/gitlab_ci.rs | function | pub | 384 | pub(super) fn extract_yaml_value(line: &str) -> Option<String> { |
| `is_gitlab_ci` | libs/compass/src/lint/gitlab_ci.rs | function | pub | 397 | pub(super) fn is_gitlab_ci(source: &str) -> bool { |
...
changes:
  - path: "libs/compass/src/lint/gitlab_ci.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/gitlab_ci.rs` captured during libs codegen standardization.
```
