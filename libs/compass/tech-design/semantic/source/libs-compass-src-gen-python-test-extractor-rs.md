---
id: libs-compass-src-gen-python-test-extractor-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/gen/python/test_extractor.rs`.
capability_refs:
...
# Standardized libs/compass/src/gen/python/test_extractor.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/gen/python/test_extractor.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TestExtractorConfig` | libs/compass/src/gen/python/test_extractor.rs | struct | pub | 11 | pub struct TestExtractorConfig { |
| `RustTest` | libs/compass/src/gen/python/test_extractor.rs | struct | pub | 20 | pub struct RustTest { |
| `TestExtractor` | libs/compass/src/gen/python/test_extractor.rs | struct | pub | 29 | pub struct TestExtractor { |
| `new` | libs/compass/src/gen/python/test_extractor.rs | function | pub | 34 | pub fn new(config: TestExtractorConfig) -> Self { |
| `extract_tests` | libs/compass/src/gen/python/test_extractor.rs | function | pub | 39 | pub fn extract_tests(&self, path: &Path) -> Result<Vec<RustTest>> { |
| `extract_tests_from_source` | libs/compass/src/gen/python/test_extractor.rs | function | pub | 47 | pub fn extract_tests_from_source( |
| `translate_to_python` | libs/compass/src/gen/python/test_extractor.rs | function | pub | 147 | pub fn translate_to_python(&self, test: &RustTest) -> String { |
| `generate_test_file` | libs/compass/src/gen/python/test_extractor.rs | function | pub | 468 | pub fn generate_test_file(&self, tests: &[RustTest]) -> String { |
...
changes:
  - path: "libs/compass/src/gen/python/test_extractor.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/gen/python/test_extractor.rs` captured during libs codegen standardization.
```
