---
id: libs-compass-src-type-inference-ts-infer-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/ts_infer.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/ts_infer.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/ts_infer.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TsTypeInferencer` | libs/compass/src/type_inference/ts_infer.rs | struct | pub | 19 | pub struct TsTypeInferencer<'a> { |
| `new` | libs/compass/src/type_inference/ts_infer.rs | function | pub | 36 | pub fn new(source: &'a str) -> Self { |
| `context` | libs/compass/src/type_inference/ts_infer.rs | function | pub | 48 | pub fn context(&self) -> &TsTypeContext { |
| `context_mut` | libs/compass/src/type_inference/ts_infer.rs | function | pub | 53 | pub fn context_mut(&mut self) -> &mut TsTypeContext { |
| `fresh_type_var` | libs/compass/src/type_inference/ts_infer.rs | function | pub | 63 | pub fn fresh_type_var(&mut self, name: &str) -> Type { |
| `fresh_type_var_bounded` | libs/compass/src/type_inference/ts_infer.rs | function | pub | 76 | pub fn fresh_type_var_bounded(&mut self, name: &str, bound: Type) -> Type { |
| `infer_expr` | libs/compass/src/type_inference/ts_infer.rs | function | pub | 89 | pub fn infer_expr(&mut self, node: &Node) -> Type { |
| `infer_call_expr` | libs/compass/src/type_inference/ts_infer.rs | function | pub | 313 | pub fn infer_call_expr(&mut self, node: &Node) -> Type { |
| `parse_type_annotation` | libs/compass/src/type_inference/ts_infer.rs | function | pub | 727 | pub fn parse_type_annotation(&mut self, node: &Node) -> Type { |
| `apply_type_guard` | libs/compass/src/type_inference/ts_infer.rs | function | pub | 1317 | pub fn apply_type_guard(&mut self, condition: &Node, is_true_branch: bool) { |
| `check_structural_compatibility` | libs/compass/src/type_inference/ts_infer.rs | function | pub | 1402 | pub fn check_structural_compatibility(&self, value_ty: &Type, interface_name: &str) -> bool { |
| `bind_variable` | libs/compass/src/type_inference/ts_infer.rs | function | pub | 1454 | pub fn bind_variable(&mut self, name: String, ty: Type) { |
| `enter_scope` | libs/compass/src/type_inference/ts_infer.rs | function | pub | 1459 | pub fn enter_scope(&mut self) { |
| `exit_scope` | libs/compass/src/type_inference/ts_infer.rs | function | pub | 1464 | pub fn exit_scope(&mut self) { |
...
changes:
  - path: "libs/compass/src/type_inference/ts_infer.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/ts_infer.rs` captured during libs codegen standardization.
```
