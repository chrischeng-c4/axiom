---
id: libs-compass-src-type-inference-semantic-search-rust-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/semantic_search_rust.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/semantic_search_rust.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/semantic_search_rust.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RustSearchProvider` | libs/compass/src/type_inference/semantic_search_rust.rs | struct | pub | 14 | pub struct RustSearchProvider; |
| `new` | libs/compass/src/type_inference/semantic_search_rust.rs | function | pub | 17 | pub fn new() -> Self { |
| `extract_docstrings` | libs/compass/src/type_inference/semantic_search_rust.rs | function | pub | 22 | pub fn extract_docstrings(&self, root: &Node, source: &str) -> HashMap<String, String> { |
| `build_call_graph` | libs/compass/src/type_inference/semantic_search_rust.rs | function | pub | 125 | pub fn build_call_graph(&self, root: &Node, source: &str, file: &PathBuf) -> Vec<CallSite> { |
| `find_usages` | libs/compass/src/type_inference/semantic_search_rust.rs | function | pub | 247 | pub fn find_usages( |
| `find_implementations` | libs/compass/src/type_inference/semantic_search_rust.rs | function | pub | 336 | pub fn find_implementations( |
...
changes:
  - path: "libs/compass/src/type_inference/semantic_search_rust.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/semantic_search_rust.rs` captured during libs codegen standardization.
```
