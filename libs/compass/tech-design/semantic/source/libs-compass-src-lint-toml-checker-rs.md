---
id: libs-compass-src-lint-toml-checker-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/toml_checker.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/toml_checker.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/toml_checker.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TomlChecker` | libs/compass/src/lint/toml_checker.rs | struct | pub | 18 | pub struct TomlChecker; |
| `new` | libs/compass/src/lint/toml_checker.rs | function | pub | 21 | pub fn new() -> Self { |
...
changes:
  - path: "libs/compass/src/lint/toml_checker.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/toml_checker.rs` captured during libs codegen standardization.
```
