---
id: libs-compass-src-lint-dockerfile-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/dockerfile.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/dockerfile.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/dockerfile.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DockerfileChecker` | libs/compass/src/lint/dockerfile.rs | struct | pub | 8 | pub struct DockerfileChecker; |
| `new` | libs/compass/src/lint/dockerfile.rs | function | pub | 11 | pub fn new() -> Self { |
...
changes:
  - path: "libs/compass/src/lint/dockerfile.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/dockerfile.rs` captured during libs codegen standardization.
```
