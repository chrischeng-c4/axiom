---
id: libs-compass-src-watch-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/watch.rs`.
capability_refs:
...
# Standardized libs/compass/src/watch.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/watch.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `WatchEvent` | libs/compass/src/watch.rs | enum | pub | 18 | pub enum WatchEvent { |
| `WatchConfig` | libs/compass/src/watch.rs | struct | pub | 31 | pub struct WatchConfig { |
| `new` | libs/compass/src/watch.rs | function | pub | 68 | pub fn new(root: PathBuf) -> Self { |
| `with_debounce` | libs/compass/src/watch.rs | function | pub | 76 | pub fn with_debounce(mut self, debounce: Duration) -> Self { |
| `with_extensions` | libs/compass/src/watch.rs | function | pub | 82 | pub fn with_extensions(mut self, extensions: Vec<String>) -> Self { |
| `FileWatcher` | libs/compass/src/watch.rs | struct | pub | 110 | pub struct FileWatcher { |
| `start` | libs/compass/src/watch.rs | function | pub | 177 | pub fn start(&mut self) -> Result<(), String> { |
| `events` | libs/compass/src/watch.rs | function | pub | 261 | pub fn events(&self) -> &Receiver<WatchEvent> { |
| `trigger_analysis` | libs/compass/src/watch.rs | function | pub | 266 | pub fn trigger_analysis(&self, paths: Vec<PathBuf>) { |
...
changes:
  - path: "libs/compass/src/watch.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/watch.rs` captured during libs codegen standardization.
```
