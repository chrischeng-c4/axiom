---
id: libs-compass-src-type-inference-cfg-narrow-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/cfg_narrow.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/cfg_narrow.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/cfg_narrow.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `BlockNarrowEnv` | libs/compass/src/type_inference/cfg_narrow.rs | struct | pub | 18 | pub struct BlockNarrowEnv { |
| `join` | libs/compass/src/type_inference/cfg_narrow.rs | function | pub | 27 | pub fn join(&self, other: &BlockNarrowEnv) -> BlockNarrowEnv { |
| `get` | libs/compass/src/type_inference/cfg_narrow.rs | function | pub | 42 | pub fn get(&self, var: &str) -> Option<&Type> { |
| `CfgNarrowingResult` | libs/compass/src/type_inference/cfg_narrow.rs | struct | pub | 48 | pub struct CfgNarrowingResult { |
| `type_at_line` | libs/compass/src/type_inference/cfg_narrow.rs | function | pub | 55 | pub fn type_at_line(&self, line: usize, var: &str, cfg: &ControlFlowGraph) -> Option<&Type> { |
| `is_narrowed_in_block` | libs/compass/src/type_inference/cfg_narrow.rs | function | pub | 68 | pub fn is_narrowed_in_block(&self, block_id: BlockId, var: &str) -> bool { |
| `CfgNarrowingPass` | libs/compass/src/type_inference/cfg_narrow.rs | struct | pub | 80 | pub struct CfgNarrowingPass<'a> { |
| `new` | libs/compass/src/type_inference/cfg_narrow.rs | function | pub | 90 | pub fn new( |
| `run` | libs/compass/src/type_inference/cfg_narrow.rs | function | pub | 109 | pub fn run(&self) -> CfgNarrowingResult { |
| `resolve_typevar_bindings` | libs/compass/src/type_inference/cfg_narrow.rs | function | pub | 443 | pub fn resolve_typevar_bindings( |
| `apply_typevar_bindings` | libs/compass/src/type_inference/cfg_narrow.rs | function | pub | 457 | pub fn apply_typevar_bindings( |
| `check_protocol_satisfaction` | libs/compass/src/type_inference/cfg_narrow.rs | function | pub | 472 | pub fn check_protocol_satisfaction( |
| `ProtocolCheckResult` | libs/compass/src/type_inference/cfg_narrow.rs | struct | pub | 505 | pub struct ProtocolCheckResult { |
| `is_satisfied` | libs/compass/src/type_inference/cfg_narrow.rs | function | pub | 511 | pub fn is_satisfied(&self) -> bool { |
| `ProtocolMemberError` | libs/compass/src/type_inference/cfg_narrow.rs | struct | pub | 518 | pub struct ProtocolMemberError { |
| `resolve_overload` | libs/compass/src/type_inference/cfg_narrow.rs | function | pub | 567 | pub fn resolve_overload( |
...
changes:
  - path: "libs/compass/src/type_inference/cfg_narrow.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/cfg_narrow.rs` captured during libs codegen standardization.
```
