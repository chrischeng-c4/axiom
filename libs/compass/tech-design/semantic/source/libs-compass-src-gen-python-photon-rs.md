---
id: libs-compass-src-gen-python-photon-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/gen/python/photon.rs`.
capability_refs:
...
# Standardized libs/compass/src/gen/python/photon.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/gen/python/photon.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `PhotonGenerator` | libs/compass/src/gen/python/photon.rs | struct | pub | 10 | pub struct PhotonGenerator; |
| `new` | libs/compass/src/gen/python/photon.rs | function | pub | 13 | pub fn new() -> Self { |
| `generate_client` | libs/compass/src/gen/python/photon.rs | function | pub | 18 | pub fn generate_client(&self, spec: &RestApiSpec, ctx: &GenContext) -> String { |
...
changes:
  - path: "libs/compass/src/gen/python/photon.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/gen/python/photon.rs` captured during libs codegen standardization.
```
