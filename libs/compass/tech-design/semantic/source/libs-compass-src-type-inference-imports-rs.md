---
id: libs-compass-src-type-inference-imports-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/imports.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/imports.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/imports.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Import` | libs/compass/src/type_inference/imports.rs | enum | pub | 21 | pub enum Import { |
| `ImportedName` | libs/compass/src/type_inference/imports.rs | struct | pub | 38 | pub struct ImportedName { |
| `ModuleLoadState` | libs/compass/src/type_inference/imports.rs | enum | pub | 45 | pub enum ModuleLoadState { |
| `ModuleInfo` | libs/compass/src/type_inference/imports.rs | struct | pub | 59 | pub struct ModuleInfo { |
| `new` | libs/compass/src/type_inference/imports.rs | function | pub | 80 | pub fn new(path: &str) -> Self { |
| `from_file` | libs/compass/src/type_inference/imports.rs | function | pub | 94 | pub fn from_file(path: &str, file_path: PathBuf) -> Self { |
| `get_export` | libs/compass/src/type_inference/imports.rs | function | pub | 113 | pub fn get_export(&self, name: &str) -> Option<&Type> { |
| `is_loaded` | libs/compass/src/type_inference/imports.rs | function | pub | 118 | pub fn is_loaded(&self) -> bool { |
| `ModuleIndexEntry` | libs/compass/src/type_inference/imports.rs | struct | pub | 125 | pub struct ModuleIndexEntry { |
| `ImportResolver` | libs/compass/src/type_inference/imports.rs | struct | pub | 138 | pub struct ImportResolver { |
| `with_search_paths` | libs/compass/src/type_inference/imports.rs | function | pub | 166 | pub fn with_search_paths(paths: Vec<PathBuf>) -> Self { |
| `set_search_paths` | libs/compass/src/type_inference/imports.rs | function | pub | 178 | pub fn set_search_paths(&mut self, paths: Vec<PathBuf>) { |
| `add_search_path` | libs/compass/src/type_inference/imports.rs | function | pub | 184 | pub fn add_search_path(&mut self, path: PathBuf) { |
| `search_paths` | libs/compass/src/type_inference/imports.rs | function | pub | 192 | pub fn search_paths(&self) -> &[PathBuf] { |
| `set_cwd` | libs/compass/src/type_inference/imports.rs | function | pub | 197 | pub fn set_cwd(&mut self, cwd: PathBuf) { |
| `register_module` | libs/compass/src/type_inference/imports.rs | function | pub | 202 | pub fn register_module(&mut self, module_path: &str, info: ModuleInfo) { |
| `get_module` | libs/compass/src/type_inference/imports.rs | function | pub | 207 | pub fn get_module(&self, module_path: &str) -> Option<&ModuleInfo> { |
| `get_module_mut` | libs/compass/src/type_inference/imports.rs | function | pub | 212 | pub fn get_module_mut(&mut self, module_path: &str) -> Option<&mut ModuleInfo> { |
| `has_module` | libs/compass/src/type_inference/imports.rs | function | pub | 217 | pub fn has_module(&self, module_path: &str) -> bool { |
| `module_names` | libs/compass/src/type_inference/imports.rs | function | pub | 222 | pub fn module_names(&self) -> impl Iterator<Item = &String> { |
| `build_index` | libs/compass/src/type_inference/imports.rs | function | pub | 227 | pub fn build_index(&mut self) { |
| `list_modules` | libs/compass/src/type_inference/imports.rs | function | pub | 346 | pub fn list_modules(&self, prefix: Option<&str>) -> Vec<&ModuleIndexEntry> { |
| `get_index_entry` | libs/compass/src/type_inference/imports.rs | function | pub | 358 | pub fn get_index_entry(&self, module_path: &str) -> Option<&ModuleIndexEntry> { |
| `is_indexed` | libs/compass/src/type_inference/imports.rs | function | pub | 363 | pub fn is_indexed(&self) -> bool { |
| `is_loading` | libs/compass/src/type_inference/imports.rs | function | pub | 368 | pub fn is_loading(&self, module_path: &str) -> bool { |
| `start_loading` | libs/compass/src/type_inference/imports.rs | function | pub | 373 | pub fn start_loading(&mut self, module_path: &str) { |
| `finish_loading` | libs/compass/src/type_inference/imports.rs | function | pub | 378 | pub fn finish_loading(&mut self, module_path: &str) { |
| `resolve_import` | libs/compass/src/type_inference/imports.rs | function | pub | 383 | pub fn resolve_import(&self, import: &Import) -> HashMap<String, Type> { |
| `resolve_module_path` | libs/compass/src/type_inference/imports.rs | function | pub | 429 | pub fn resolve_module_path(&self, module_path: &str) -> Option<PathBuf> { |
| `get_or_resolve_module` | libs/compass/src/type_inference/imports.rs | function | pub | 486 | pub fn get_or_resolve_module(&mut self, module_path: &str) -> Option<&ModuleInfo> { |
| `clear` | libs/compass/src/type_inference/imports.rs | function | pub | 509 | pub fn clear(&mut self) { |
| `parse_import` | libs/compass/src/type_inference/imports.rs | function | pub | 518 | pub fn parse_import(source: &str, node: &tree_sitter::Node) -> Option<Import> { |
| `create_builtins_module` | libs/compass/src/type_inference/imports.rs | function | pub | 591 | pub fn create_builtins_module() -> ModuleInfo { |
| `create_typing_module` | libs/compass/src/type_inference/imports.rs | function | pub | 706 | pub fn create_typing_module() -> ModuleInfo { |
...
changes:
  - path: "libs/compass/src/type_inference/imports.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/imports.rs` captured during libs codegen standardization.
```
