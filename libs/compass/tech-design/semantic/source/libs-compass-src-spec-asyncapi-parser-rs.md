---
id: libs-compass-src-spec-asyncapi-parser-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/spec/asyncapi/parser.rs`.
capability_refs:
...
# Standardized libs/compass/src/spec/asyncapi/parser.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/spec/asyncapi/parser.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AsyncApiError` | libs/compass/src/spec/asyncapi/parser.rs | enum | pub | 17 | pub enum AsyncApiError { |
| `AsyncApiParser` | libs/compass/src/spec/asyncapi/parser.rs | struct | pub | 45 | pub struct AsyncApiParser { |
| `new` | libs/compass/src/spec/asyncapi/parser.rs | function | pub | 53 | pub fn new() -> Self { |
| `parse_json` | libs/compass/src/spec/asyncapi/parser.rs | function | pub | 61 | pub fn parse_json(&mut self, json: &str) -> Result<EventApiSpec, AsyncApiError> { |
| `parse_yaml` | libs/compass/src/spec/asyncapi/parser.rs | function | pub | 68 | pub fn parse_yaml(&mut self, yaml: &str) -> Result<EventApiSpec, AsyncApiError> { |
| `parse_value` | libs/compass/src/spec/asyncapi/parser.rs | function | pub | 75 | pub fn parse_value(&mut self, value: &Value) -> Result<EventApiSpec, AsyncApiError> { |
...
changes:
  - path: "libs/compass/src/spec/asyncapi/parser.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/spec/asyncapi/parser.rs` captured during libs codegen standardization.
```
