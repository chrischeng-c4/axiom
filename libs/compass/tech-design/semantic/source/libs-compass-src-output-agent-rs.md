---
id: libs-compass-src-output-agent-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/output/agent.rs`.
capability_refs:
...
# Standardized libs/compass/src/output/agent.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/output/agent.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `AgentOutputBuilder` | libs/compass/src/output/agent.rs | struct | pub | 17 | pub struct AgentOutputBuilder<'a> { |
| `new` | libs/compass/src/output/agent.rs | function | pub | 23 | pub fn new(project_root: &'a Path) -> Self { |
| `build` | libs/compass/src/output/agent.rs | function | pub | 32 | pub fn build( |
...
changes:
  - path: "libs/compass/src/output/agent.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/output/agent.rs` captured during libs codegen standardization.
```
