---
id: libs-compass-src-semantic-symbols-dockerfile-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/semantic/symbols/dockerfile.rs`.
capability_refs:
...
# Standardized libs/compass/src/semantic/symbols/dockerfile.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/semantic/symbols/dockerfile.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `visit_dockerfile_lines` | libs/compass/src/semantic/symbols/dockerfile.rs | function | pub | 16 | pub(crate) fn visit_dockerfile_lines(&mut self, source: &str) { |
...
changes:
  - path: "libs/compass/src/semantic/symbols/dockerfile.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/semantic/symbols/dockerfile.rs` captured during libs codegen standardization.
```
