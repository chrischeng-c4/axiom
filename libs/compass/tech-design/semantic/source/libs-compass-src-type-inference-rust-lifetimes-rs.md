---
id: libs-compass-src-type-inference-rust-lifetimes-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/rust_lifetimes.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/rust_lifetimes.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/rust_lifetimes.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `LifetimeConstraint` | libs/compass/src/type_inference/rust_lifetimes.rs | struct | pub | 18 | pub struct LifetimeConstraint { |
| `Borrow` | libs/compass/src/type_inference/rust_lifetimes.rs | struct | pub | 29 | pub struct Borrow { |
| `BorrowId` | libs/compass/src/type_inference/rust_lifetimes.rs | struct | pub | 44 | pub struct BorrowId(pub usize); |
| `LifetimeError` | libs/compass/src/type_inference/rust_lifetimes.rs | struct | pub | 52 | pub struct LifetimeError { |
| `LifetimeErrorKind` | libs/compass/src/type_inference/rust_lifetimes.rs | enum | pub | 65 | pub enum LifetimeErrorKind { |
| `BorrowState` | libs/compass/src/type_inference/rust_lifetimes.rs | struct | pub | 88 | pub struct BorrowState { |
| `new` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 99 | pub fn new() -> Self { |
| `borrow` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 104 | pub fn borrow( |
| `end_borrow` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 161 | pub fn end_borrow(&mut self, id: BorrowId) { |
| `move_value` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 168 | pub fn move_value(&mut self, path: &str, span: (usize, usize)) -> Result<(), LifetimeError> { |
| `is_valid` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 186 | pub fn is_valid(&self, path: &str) -> bool { |
| `has_mutable_borrow` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 191 | pub fn has_mutable_borrow(&self, path: &str) -> bool { |
| `has_any_borrow` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 199 | pub fn has_any_borrow(&self, path: &str) -> bool { |
| `clear` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 207 | pub fn clear(&mut self) { |
| `child` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 213 | pub fn child(&self) -> Self { |
| `LifetimeAnalyzer` | libs/compass/src/type_inference/rust_lifetimes.rs | struct | pub | 227 | pub struct LifetimeAnalyzer { |
| `fresh_lifetime` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 254 | pub fn fresh_lifetime(&mut self) -> LifetimeId { |
| `add_outlives_constraint` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 261 | pub fn add_outlives_constraint( |
| `check_use` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 304 | pub fn check_use(&mut self, path: &str, span: (usize, usize)) { |
| `check_assignment` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 316 | pub fn check_assignment(&mut self, path: &str, span: (usize, usize)) { |
| `infer_reference_lifetime` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 328 | pub fn infer_reference_lifetime(&mut self, ty: &RustType) -> Option<LifetimeId> { |
| `type_has_lifetime` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 346 | pub fn type_has_lifetime(&self, ty: &RustType) -> bool { |
| `validate_constraints` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 361 | pub fn validate_constraints(&mut self) -> bool { |
| `errors` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 414 | pub fn errors(&self) -> &[LifetimeError] { |
| `has_errors` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 419 | pub fn has_errors(&self) -> bool { |
| `clear_errors` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 424 | pub fn clear_errors(&mut self) { |
| `enter_scope` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 429 | pub fn enter_scope(&mut self) -> BorrowState { |
| `exit_scope` | libs/compass/src/type_inference/rust_lifetimes.rs | function | pub | 435 | pub fn exit_scope(&mut self, previous: BorrowState) { |
...
changes:
  - path: "libs/compass/src/type_inference/rust_lifetimes.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/rust_lifetimes.rs` captured during libs codegen standardization.
```
