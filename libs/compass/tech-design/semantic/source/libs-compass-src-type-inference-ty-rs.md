---
id: libs-compass-src-type-inference-ty-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/ty.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/ty.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/ty.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TypeVarId` | libs/compass/src/type_inference/ty.rs | struct | pub | 8 | pub struct TypeVarId(pub usize); |
| `ParamSpecId` | libs/compass/src/type_inference/ty.rs | struct | pub | 12 | pub struct ParamSpecId(pub usize); |
| `TypeVarTupleId` | libs/compass/src/type_inference/ty.rs | struct | pub | 16 | pub struct TypeVarTupleId(pub usize); |
| `Variance` | libs/compass/src/type_inference/ty.rs | enum | pub | 25 | pub enum Variance { |
| `allows_subtype` | libs/compass/src/type_inference/ty.rs | function | pub | 41 | pub fn allows_subtype(&self, is_subtype: bool, is_supertype: bool) -> bool { |
| `ParamKind` | libs/compass/src/type_inference/ty.rs | enum | pub | 52 | pub enum ParamKind { |
| `Param` | libs/compass/src/type_inference/ty.rs | struct | pub | 67 | pub struct Param { |
| `LiteralValue` | libs/compass/src/type_inference/ty.rs | enum | pub | 76 | pub enum LiteralValue { |
| `Type` | libs/compass/src/type_inference/ty.rs | enum | pub | 86 | pub enum Type { |
| `optional` | libs/compass/src/type_inference/ty.rs | function | pub | 225 | pub fn optional(inner: Type) -> Self { |
| `list` | libs/compass/src/type_inference/ty.rs | function | pub | 230 | pub fn list(element: Type) -> Self { |
| `dict` | libs/compass/src/type_inference/ty.rs | function | pub | 235 | pub fn dict(key: Type, value: Type) -> Self { |
| `union` | libs/compass/src/type_inference/ty.rs | function | pub | 240 | pub fn union(types: Vec<Type>) -> Self { |
| `callable` | libs/compass/src/type_inference/ty.rs | function | pub | 264 | pub fn callable(params: Vec<Type>, ret: Type) -> Self { |
| `is_any` | libs/compass/src/type_inference/ty.rs | function | pub | 282 | pub fn is_any(&self) -> bool { |
| `is_unknown` | libs/compass/src/type_inference/ty.rs | function | pub | 287 | pub fn is_unknown(&self) -> bool { |
| `is_error` | libs/compass/src/type_inference/ty.rs | function | pub | 292 | pub fn is_error(&self) -> bool { |
| `contains_none` | libs/compass/src/type_inference/ty.rs | function | pub | 297 | pub fn contains_none(&self) -> bool { |
| `without_none` | libs/compass/src/type_inference/ty.rs | function | pub | 307 | pub fn without_none(&self) -> Type { |
| `substitute` | libs/compass/src/type_inference/ty.rs | function | pub | 324 | pub fn substitute(&self, substitutions: &std::collections::HashMap<TypeVarId, Type>) -> Type { |
| `type_vars` | libs/compass/src/type_inference/ty.rs | function | pub | 376 | pub fn type_vars(&self) -> Vec<TypeVarId> { |
| `unify` | libs/compass/src/type_inference/ty.rs | function | pub | 418 | pub fn unify(&self, concrete: &Type, subs: &mut HashMap<TypeVarId, Type>) -> bool { |
| `type_var` | libs/compass/src/type_inference/ty.rs | function | pub | 512 | pub fn type_var(id: usize, name: &str) -> Type { |
| `type_var_bounded` | libs/compass/src/type_inference/ty.rs | function | pub | 523 | pub fn type_var_bounded(id: usize, name: &str, bound: Type) -> Type { |
| `type_var_with_variance` | libs/compass/src/type_inference/ty.rs | function | pub | 534 | pub fn type_var_with_variance(id: usize, name: &str, variance: Variance) -> Type { |
| `type_var_covariant` | libs/compass/src/type_inference/ty.rs | function | pub | 545 | pub fn type_var_covariant(id: usize, name: &str) -> Type { |
| `type_var_contravariant` | libs/compass/src/type_inference/ty.rs | function | pub | 550 | pub fn type_var_contravariant(id: usize, name: &str) -> Type { |
| `param_spec` | libs/compass/src/type_inference/ty.rs | function | pub | 555 | pub fn param_spec(id: usize, name: &str) -> Type { |
| `type_var_tuple` | libs/compass/src/type_inference/ty.rs | function | pub | 563 | pub fn type_var_tuple(id: usize, name: &str) -> Type { |
| `final_type` | libs/compass/src/type_inference/ty.rs | function | pub | 571 | pub fn final_type(inner: Type) -> Type { |
| `annotated` | libs/compass/src/type_inference/ty.rs | function | pub | 576 | pub fn annotated(inner: Type, metadata: Vec<String>) -> Type { |
| `self_type` | libs/compass/src/type_inference/ty.rs | function | pub | 584 | pub fn self_type(class_name: Option<String>) -> Type { |
| `overloaded` | libs/compass/src/type_inference/ty.rs | function | pub | 589 | pub fn overloaded(signatures: Vec<Type>) -> Type { |
| `concatenate` | libs/compass/src/type_inference/ty.rs | function | pub | 594 | pub fn concatenate(params: Vec<Type>, param_spec: Type) -> Type { |
| `unwrap_final` | libs/compass/src/type_inference/ty.rs | function | pub | 602 | pub fn unwrap_final(&self) -> &Type { |
| `unwrap_annotated` | libs/compass/src/type_inference/ty.rs | function | pub | 610 | pub fn unwrap_annotated(&self) -> &Type { |
| `is_final` | libs/compass/src/type_inference/ty.rs | function | pub | 618 | pub fn is_final(&self) -> bool { |
| `is_literal_string` | libs/compass/src/type_inference/ty.rs | function | pub | 623 | pub fn is_literal_string(&self) -> bool { |
| `type_guard` | libs/compass/src/type_inference/ty.rs | function | pub | 631 | pub fn type_guard(inner: Type) -> Type { |
| `type_is` | libs/compass/src/type_inference/ty.rs | function | pub | 636 | pub fn type_is(inner: Type) -> Type { |
| `is_type_guard` | libs/compass/src/type_inference/ty.rs | function | pub | 641 | pub fn is_type_guard(&self) -> bool { |
| `is_type_is` | libs/compass/src/type_inference/ty.rs | function | pub | 646 | pub fn is_type_is(&self) -> bool { |
| `get_guard_type` | libs/compass/src/type_inference/ty.rs | function | pub | 651 | pub fn get_guard_type(&self) -> Option<&Type> { |
...
changes:
  - path: "libs/compass/src/type_inference/ty.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/ty.rs` captured during libs codegen standardization.
```
