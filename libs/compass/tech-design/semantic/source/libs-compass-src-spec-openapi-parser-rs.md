---
id: libs-compass-src-spec-openapi-parser-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/spec/openapi/parser.rs`.
capability_refs:
...
# Standardized libs/compass/src/spec/openapi/parser.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/spec/openapi/parser.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `OpenApiError` | libs/compass/src/spec/openapi/parser.rs | enum | pub | 18 | pub enum OpenApiError { |
| `OpenApiParser` | libs/compass/src/spec/openapi/parser.rs | struct | pub | 46 | pub struct OpenApiParser { |
| `new` | libs/compass/src/spec/openapi/parser.rs | function | pub | 52 | pub fn new() -> Self { |
| `parse_json` | libs/compass/src/spec/openapi/parser.rs | function | pub | 59 | pub fn parse_json(&mut self, json: &str) -> Result<RestApiSpec, OpenApiError> { |
| `parse_yaml` | libs/compass/src/spec/openapi/parser.rs | function | pub | 66 | pub fn parse_yaml(&mut self, yaml: &str) -> Result<RestApiSpec, OpenApiError> { |
| `parse_value` | libs/compass/src/spec/openapi/parser.rs | function | pub | 73 | pub fn parse_value(&mut self, value: &Value) -> Result<RestApiSpec, OpenApiError> { |
...
changes:
  - path: "libs/compass/src/spec/openapi/parser.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/spec/openapi/parser.rs` captured during libs codegen standardization.
```
