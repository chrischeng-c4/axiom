---
id: libs-compass-src-type-inference-propagation-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/propagation.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/propagation.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/propagation.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `PropagationRequest` | libs/compass/src/type_inference/propagation.rs | struct | pub | 33 | pub struct PropagationRequest { |
| `PropagatedType` | libs/compass/src/type_inference/propagation.rs | struct | pub | 43 | pub struct PropagatedType { |
| `PropagationResult` | libs/compass/src/type_inference/propagation.rs | struct | pub | 58 | pub struct PropagationResult { |
| `PropagationStats` | libs/compass/src/type_inference/propagation.rs | struct | pub | 69 | pub struct PropagationStats { |
| `PropagationPipeline` | libs/compass/src/type_inference/propagation.rs | struct | pub | 87 | pub struct PropagationPipeline; |
| `run` | libs/compass/src/type_inference/propagation.rs | function | pub | 98 | pub fn run( |
| `invalidate_and_repropagate` | libs/compass/src/type_inference/propagation.rs | function | pub | 236 | pub fn invalidate_and_repropagate( |
...
changes:
  - path: "libs/compass/src/type_inference/propagation.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/propagation.rs` captured during libs codegen standardization.
```
