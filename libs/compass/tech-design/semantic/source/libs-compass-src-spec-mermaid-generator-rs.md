---
id: libs-compass-src-spec-mermaid-generator-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/spec/mermaid/generator.rs`.
capability_refs:
...
# Standardized libs/compass/src/spec/mermaid/generator.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/spec/mermaid/generator.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MermaidGenerator` | libs/compass/src/spec/mermaid/generator.rs | struct | pub | 11 | pub struct MermaidGenerator; |
| `new` | libs/compass/src/spec/mermaid/generator.rs | function | pub | 14 | pub fn new() -> Self { |
| `generate_class_diagram` | libs/compass/src/spec/mermaid/generator.rs | function | pub | 19 | pub fn generate_class_diagram(&self, spec: &DataModelSpec) -> String { |
| `generate_er_diagram` | libs/compass/src/spec/mermaid/generator.rs | function | pub | 81 | pub fn generate_er_diagram(&self, spec: &DataModelSpec) -> String { |
| `generate_sequence_diagram` | libs/compass/src/spec/mermaid/generator.rs | function | pub | 121 | pub fn generate_sequence_diagram(&self, spec: &RestApiSpec) -> String { |
| `generate_event_sequence` | libs/compass/src/spec/mermaid/generator.rs | function | pub | 152 | pub fn generate_event_sequence(&self, spec: &EventApiSpec) -> String { |
| `generate_state_diagram` | libs/compass/src/spec/mermaid/generator.rs | function | pub | 183 | pub fn generate_state_diagram(&self, spec: &StateMachineSpec) -> String { |
| `generate_flowchart` | libs/compass/src/spec/mermaid/generator.rs | function | pub | 220 | pub fn generate_flowchart(&self, spec: &ControlFlowSpec, direction: &str) -> String { |
...
changes:
  - path: "libs/compass/src/spec/mermaid/generator.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/spec/mermaid/generator.rs` captured during libs codegen standardization.
```
