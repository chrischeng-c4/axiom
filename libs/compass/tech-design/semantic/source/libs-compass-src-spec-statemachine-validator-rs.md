---
id: libs-compass-src-spec-statemachine-validator-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/spec/statemachine/validator.rs`.
capability_refs:
...
# Standardized libs/compass/src/spec/statemachine/validator.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/spec/statemachine/validator.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ValidationResult` | libs/compass/src/spec/statemachine/validator.rs | struct | pub | 16 | pub struct ValidationResult { |
| `ok` | libs/compass/src/spec/statemachine/validator.rs | function | pub | 23 | pub fn ok() -> Self { |
| `with_error` | libs/compass/src/spec/statemachine/validator.rs | function | pub | 31 | pub fn with_error(mut self, error: ValidationError) -> Self { |
| `with_warning` | libs/compass/src/spec/statemachine/validator.rs | function | pub | 37 | pub fn with_warning(mut self, warning: ValidationError) -> Self { |
| `ValidationError` | libs/compass/src/spec/statemachine/validator.rs | struct | pub | 45 | pub struct ValidationError { |
| `Severity` | libs/compass/src/spec/statemachine/validator.rs | enum | pub | 55 | pub enum Severity { |
| `StateMachineValidator` | libs/compass/src/spec/statemachine/validator.rs | struct | pub | 72 | pub struct StateMachineValidator { |
| `new` | libs/compass/src/spec/statemachine/validator.rs | function | pub | 78 | pub fn new() -> Self { |
| `strict` | libs/compass/src/spec/statemachine/validator.rs | function | pub | 84 | pub fn strict() -> Self { |
| `with_strict` | libs/compass/src/spec/statemachine/validator.rs | function | pub | 89 | pub fn with_strict(mut self, strict: bool) -> Self { |
| `validate` | libs/compass/src/spec/statemachine/validator.rs | function | pub | 95 | pub fn validate(&self, machine: &StateMachineDef) -> ValidationResult { |
...
changes:
  - path: "libs/compass/src/spec/statemachine/validator.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/spec/statemachine/validator.rs` captured during libs codegen standardization.
```
