---
id: libs-compass-src-lint-mermaid-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/mermaid.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/mermaid.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/mermaid.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MermaidChecker` | libs/compass/src/lint/mermaid.rs | struct | pub | 29 | pub struct MermaidChecker; |
| `new` | libs/compass/src/lint/mermaid.rs | function | pub | 32 | pub fn new() -> Self { |
...
changes:
  - path: "libs/compass/src/lint/mermaid.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/mermaid.rs` captured during libs codegen standardization.
```
