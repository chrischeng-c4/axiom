---
id: libs-compass-src-semantic-scope-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/semantic/scope.rs`.
capability_refs:
...
# Standardized libs/compass/src/semantic/scope.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/semantic/scope.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SymbolKind` | libs/compass/src/semantic/scope.rs | enum | pub | 14 | pub enum SymbolKind { |
| `Symbol` | libs/compass/src/semantic/scope.rs | struct | pub | 26 | pub struct Symbol { |
| `ScopeKind` | libs/compass/src/semantic/scope.rs | enum | pub | 36 | pub enum ScopeKind { |
| `Scope` | libs/compass/src/semantic/scope.rs | struct | pub | 46 | pub struct Scope { |
| `new` | libs/compass/src/semantic/scope.rs | function | pub | 53 | pub fn new(kind: ScopeKind, parent: Option<usize>) -> Self { |
| `define` | libs/compass/src/semantic/scope.rs | function | pub | 61 | pub fn define(&mut self, name: String, kind: SymbolKind, range: Range) { |
| `mark_used` | libs/compass/src/semantic/scope.rs | function | pub | 78 | pub fn mark_used(&mut self, name: &str) -> bool { |
| `ScopeAnalyzer` | libs/compass/src/semantic/scope.rs | struct | pub | 89 | pub struct ScopeAnalyzer { |
| `analyze` | libs/compass/src/semantic/scope.rs | function | pub | 106 | pub fn analyze(&mut self, file: &ParsedFile) { |
| `unused_symbols` | libs/compass/src/semantic/scope.rs | function | pub | 433 | pub fn unused_symbols(&self) -> Vec<&Symbol> { |
| `redeclared_symbols` | libs/compass/src/semantic/scope.rs | function | pub | 459 | pub fn redeclared_symbols(&self) -> Vec<&Symbol> { |
...
changes:
  - path: "libs/compass/src/semantic/scope.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/semantic/scope.rs` captured during libs codegen standardization.
```
