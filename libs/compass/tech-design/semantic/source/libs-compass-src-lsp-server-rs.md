---
id: libs-compass-src-lsp-server-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lsp/server.rs`.
capability_refs:
...
# Standardized libs/compass/src/lsp/server.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lsp/server.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ArgusServer` | libs/compass/src/lsp/server.rs | struct | pub | 40 | pub struct ArgusServer { |
| `new` | libs/compass/src/lsp/server.rs | function | pub | 53 | pub fn new(client: Client) -> Self { |
| `run_server` | libs/compass/src/lsp/server.rs | function | pub | 1044 | pub async fn run_server() { |
| `run_server_tcp` | libs/compass/src/lsp/server.rs | function | pub | 1053 | pub async fn run_server_tcp(port: u16) -> std::io::Result<()> { |
...
changes:
  - path: "libs/compass/src/lsp/server.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lsp/server.rs` captured during libs codegen standardization.
```
