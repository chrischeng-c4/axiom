---
id: libs-compass-src-semantic-types-go-advanced-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/semantic/types/go_advanced.rs`.
capability_refs:
...
# Standardized libs/compass/src/semantic/types/go_advanced.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/semantic/types/go_advanced.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SatisfactionResult` | libs/compass/src/semantic/types/go_advanced.rs | struct | pub | 12 | pub struct SatisfactionResult { |
| `check_interface_satisfaction` | libs/compass/src/semantic/types/go_advanced.rs | function | pub | 25 | pub fn check_interface_satisfaction(inference: &GoTypeInference) -> Vec<SatisfactionResult> { |
| `validate_type_assertions` | libs/compass/src/semantic/types/go_advanced.rs | function | pub | 72 | pub fn validate_type_assertions(inference: &GoTypeInference) -> Vec<(usize, bool)> { |
...
changes:
  - path: "libs/compass/src/semantic/types/go_advanced.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/semantic/types/go_advanced.rs` captured during libs codegen standardization.
```
