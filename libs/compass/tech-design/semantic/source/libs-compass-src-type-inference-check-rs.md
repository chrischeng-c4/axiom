---
id: libs-compass-src-type-inference-check-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/check.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/check.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/check.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TypeError` | libs/compass/src/type_inference/check.rs | struct | pub | 15 | pub struct TypeError { |
| `TypeChecker` | libs/compass/src/type_inference/check.rs | struct | pub | 40 | pub struct TypeChecker<'a> { |
| `new` | libs/compass/src/type_inference/check.rs | function | pub | 54 | pub fn new(source: &'a str) -> Self { |
| `check_file` | libs/compass/src/type_inference/check.rs | function | pub | 77 | pub fn check_file(&mut self, file: &ParsedFile) -> Vec<Diagnostic> { |
| `diagnostics` | libs/compass/src/type_inference/check.rs | function | pub | 1094 | pub fn diagnostics(&self) -> &[Diagnostic] { |
| `SemanticModelBuilder` | libs/compass/src/type_inference/check.rs | struct | pub | 1110 | pub struct SemanticModelBuilder<'a> { |
| `build` | libs/compass/src/type_inference/check.rs | function | pub | 1134 | pub fn build(mut self, file: &ParsedFile) -> SemanticModel { |
| `build_semantic_model` | libs/compass/src/type_inference/check.rs | function | pub | 1591 | pub fn build_semantic_model(file: &ParsedFile, source: &str, file_path: PathBuf) -> SemanticModel { |
...
use super::model::{ParamInfo, ScopeId, SemanticModel, SemanticSymbolKind, SymbolData, TypeInfo};
...
changes:
  - path: "libs/compass/src/type_inference/check.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/check.rs` captured during libs codegen standardization.
```
