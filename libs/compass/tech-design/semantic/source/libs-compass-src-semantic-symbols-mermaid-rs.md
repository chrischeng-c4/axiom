---
id: libs-compass-src-semantic-symbols-mermaid-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/semantic/symbols/mermaid.rs`.
capability_refs:
...
# Standardized libs/compass/src/semantic/symbols/mermaid.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/semantic/symbols/mermaid.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `visit_mermaid_lines` | libs/compass/src/semantic/symbols/mermaid.rs | function | pub | 15 | pub(crate) fn visit_mermaid_lines(&mut self, source: &str) { |
...
changes:
  - path: "libs/compass/src/semantic/symbols/mermaid.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/semantic/symbols/mermaid.rs` captured during libs codegen standardization.
```
