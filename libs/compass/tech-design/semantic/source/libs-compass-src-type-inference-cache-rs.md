---
id: libs-compass-src-type-inference-cache-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/cache.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/cache.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/cache.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ContentHash` | libs/compass/src/type_inference/cache.rs | struct | pub | 19 | pub struct ContentHash(pub(crate) u64); |
| `from_content` | libs/compass/src/type_inference/cache.rs | function | pub | 23 | pub fn from_content(content: &str) -> Self { |
| `from_file` | libs/compass/src/type_inference/cache.rs | function | pub | 31 | pub fn from_file(path: &Path) -> Option<Self> { |
| `CacheEntry` | libs/compass/src/type_inference/cache.rs | struct | pub | 40 | pub struct CacheEntry { |
| `new` | libs/compass/src/type_inference/cache.rs | function | pub | 60 | pub fn new( |
| `mtime_changed` | libs/compass/src/type_inference/cache.rs | function | pub | 81 | pub fn mtime_changed(&self) -> bool { |
| `content_changed` | libs/compass/src/type_inference/cache.rs | function | pub | 93 | pub fn content_changed(&self) -> bool { |
| `needs_reanalysis` | libs/compass/src/type_inference/cache.rs | function | pub | 101 | pub fn needs_reanalysis(&self) -> bool { |
| `AnalysisCache` | libs/compass/src/type_inference/cache.rs | struct | pub | 113 | pub struct AnalysisCache { |
| `store` | libs/compass/src/type_inference/cache.rs | function | pub | 129 | pub fn store(&mut self, entry: CacheEntry) { |
| `get` | libs/compass/src/type_inference/cache.rs | function | pub | 144 | pub fn get(&self, module_name: &str) -> Option<&CacheEntry> { |
| `get_mut` | libs/compass/src/type_inference/cache.rs | function | pub | 149 | pub fn get_mut(&mut self, module_name: &str) -> Option<&mut CacheEntry> { |
| `has` | libs/compass/src/type_inference/cache.rs | function | pub | 154 | pub fn has(&self, module_name: &str) -> bool { |
| `remove` | libs/compass/src/type_inference/cache.rs | function | pub | 159 | pub fn remove(&mut self, module_name: &str) -> Option<CacheEntry> { |
| `get_changed_modules` | libs/compass/src/type_inference/cache.rs | function | pub | 174 | pub fn get_changed_modules(&self) -> Vec<String> { |
| `get_affected_modules` | libs/compass/src/type_inference/cache.rs | function | pub | 184 | pub fn get_affected_modules(&self, changed: &str) -> HashSet<String> { |
| `invalidate` | libs/compass/src/type_inference/cache.rs | function | pub | 204 | pub fn invalidate(&mut self, module_name: &str) { |
| `invalidate_propagation` | libs/compass/src/type_inference/cache.rs | function | pub | 216 | pub fn invalidate_propagation(&mut self, module_name: &str) { |
| `module_names` | libs/compass/src/type_inference/cache.rs | function | pub | 226 | pub fn module_names(&self) -> impl Iterator<Item = &String> { |
| `stats` | libs/compass/src/type_inference/cache.rs | function | pub | 231 | pub fn stats(&self) -> CacheStats { |
| `clear` | libs/compass/src/type_inference/cache.rs | function | pub | 239 | pub fn clear(&mut self) { |
| `CacheStats` | libs/compass/src/type_inference/cache.rs | struct | pub | 247 | pub struct CacheStats { |
...
changes:
  - path: "libs/compass/src/type_inference/cache.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/cache.rs` captured during libs codegen standardization.
```
