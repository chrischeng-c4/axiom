---
id: libs-compass-src-lint-openrpc-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/openrpc.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/openrpc.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/openrpc.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `OpenRpcChecker` | libs/compass/src/lint/openrpc.rs | struct | pub | 9 | pub struct OpenRpcChecker; |
| `new` | libs/compass/src/lint/openrpc.rs | function | pub | 12 | pub fn new() -> Self { |
| `is_openrpc` | libs/compass/src/lint/openrpc.rs | function | pub | 18 | pub fn is_openrpc(source: &str) -> bool { |
| `check_json` | libs/compass/src/lint/openrpc.rs | function | pub | 26 | pub fn check_json(source: &str) -> Vec<Diagnostic> { |
...
changes:
  - path: "libs/compass/src/lint/openrpc.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/openrpc.rs` captured during libs codegen standardization.
```
