---
id: libs-compass-src-semantic-symbols-sql-sym-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/semantic/symbols/sql_sym.rs`.
capability_refs:
...
# Standardized libs/compass/src/semantic/symbols/sql_sym.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/semantic/symbols/sql_sym.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `visit_sql_lines` | libs/compass/src/semantic/symbols/sql_sym.rs | function | pub | 14 | pub(crate) fn visit_sql_lines(&mut self, source: &str) { |
| `build_sql` | libs/compass/src/semantic/symbols/sql_sym.rs | function | pub | 131 | pub fn build_sql(mut self, file: &crate::syntax::ParsedFile) -> super::SymbolTable { |
| `build_sql_from_source` | libs/compass/src/semantic/symbols/sql_sym.rs | function | pub | 138 | pub fn build_sql_from_source(mut self, source: &str) -> super::SymbolTable { |
...
changes:
  - path: "libs/compass/src/semantic/symbols/sql_sym.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/semantic/symbols/sql_sym.rs` captured during libs codegen standardization.
```
