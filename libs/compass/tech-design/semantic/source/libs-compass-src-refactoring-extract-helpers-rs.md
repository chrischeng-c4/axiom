---
id: libs-compass-src-refactoring-extract-helpers-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/refactoring/extract_helpers.rs`.
capability_refs:
...
# Standardized libs/compass/src/refactoring/extract_helpers.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/refactoring/extract_helpers.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DataFlow` | libs/compass/src/refactoring/extract_helpers.rs | struct | pub | 14 | pub(super) struct DataFlow { |
| `analyze_data_flow` | libs/compass/src/refactoring/extract_helpers.rs | function | pub | 22 | pub(super) fn analyze_data_flow(selected: &str) -> DataFlow { |
| `build_function_def` | libs/compass/src/refactoring/extract_helpers.rs | function | pub | 124 | pub(super) fn build_function_def( |
| `build_method_def` | libs/compass/src/refactoring/extract_helpers.rs | function | pub | 160 | pub(super) fn build_method_def( |
| `build_call_expr` | libs/compass/src/refactoring/extract_helpers.rs | function | pub | 190 | pub(super) fn build_call_expr(name: &str, flow: &DataFlow) -> String { |
| `build_method_call` | libs/compass/src/refactoring/extract_helpers.rs | function | pub | 202 | pub(super) fn build_method_call(name: &str, flow: &DataFlow) -> String { |
| `find_statement_start` | libs/compass/src/refactoring/extract_helpers.rs | function | pub | 226 | pub(super) fn find_statement_start(source: &str, pos: usize) -> usize { |
| `leading_indent` | libs/compass/src/refactoring/extract_helpers.rs | function | pub | 231 | pub(super) fn leading_indent(source: &str, line_start: usize) -> String { |
| `find_insertion_point` | libs/compass/src/refactoring/extract_helpers.rs | function | pub | 238 | pub(super) fn find_insertion_point(source: &str, span: Span) -> usize { |
...
changes:
  - path: "libs/compass/src/refactoring/extract_helpers.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/refactoring/extract_helpers.rs` captured during libs codegen standardization.
```
