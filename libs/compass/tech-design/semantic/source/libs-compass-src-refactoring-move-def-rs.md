---
id: libs-compass-src-refactoring-move-def-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/refactoring/move_def.rs`.
capability_refs:
...
# Standardized libs/compass/src/refactoring/move_def.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/refactoring/move_def.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MoveDefEngine` | libs/compass/src/refactoring/move_def.rs | struct | pub | 23 | pub struct MoveDefEngine; |
...
changes:
  - path: "libs/compass/src/refactoring/move_def.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/refactoring/move_def.rs` captured during libs codegen standardization.
```
