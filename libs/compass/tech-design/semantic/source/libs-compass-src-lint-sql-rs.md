---
id: libs-compass-src-lint-sql-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/sql.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/sql.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/sql.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SqlChecker` | libs/compass/src/lint/sql.rs | struct | pub | 11 | pub struct SqlChecker; |
| `new` | libs/compass/src/lint/sql.rs | function | pub | 14 | pub fn new() -> Self { |
| `detect_sql_injection` | libs/compass/src/lint/sql.rs | function | pub | 339 | pub fn detect_sql_injection(source: &str, language: &str) -> Vec<Diagnostic> { |
...
changes:
  - path: "libs/compass/src/lint/sql.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/sql.rs` captured during libs codegen standardization.
```
