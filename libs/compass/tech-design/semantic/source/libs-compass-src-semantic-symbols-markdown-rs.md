---
id: libs-compass-src-semantic-symbols-markdown-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/semantic/symbols/markdown.rs`.
capability_refs:
...
# Standardized libs/compass/src/semantic/symbols/markdown.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/semantic/symbols/markdown.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `visit_markdown_lines` | libs/compass/src/semantic/symbols/markdown.rs | function | pub | 13 | pub(crate) fn visit_markdown_lines(&mut self, source: &str) { |
...
changes:
  - path: "libs/compass/src/semantic/symbols/markdown.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/semantic/symbols/markdown.rs` captured during libs codegen standardization.
```
