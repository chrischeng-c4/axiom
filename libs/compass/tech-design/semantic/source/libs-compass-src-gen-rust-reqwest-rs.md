---
id: libs-compass-src-gen-rust-reqwest-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/gen/rust/reqwest.rs`.
capability_refs:
...
# Standardized libs/compass/src/gen/rust/reqwest.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/gen/rust/reqwest.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ReqwestGenerator` | libs/compass/src/gen/rust/reqwest.rs | struct | pub | 10 | pub struct ReqwestGenerator; |
| `new` | libs/compass/src/gen/rust/reqwest.rs | function | pub | 13 | pub fn new() -> Self { |
| `generate_client` | libs/compass/src/gen/rust/reqwest.rs | function | pub | 18 | pub fn generate_client(&self, spec: &RestApiSpec, ctx: &GenContext) -> String { |
| `with_client` | libs/compass/src/gen/rust/reqwest.rs | function | pub | 69 | "{}pub fn with_client(client: reqwest::Client, base_url: impl Into<String>) -> Self {{", |
| `PetStoreClient` | libs/compass/src/gen/rust/reqwest.rs | struct | pub | 423 | assert!(code.contains("pub struct PetStoreClient")); |
| `get_pet` | libs/compass/src/gen/rust/reqwest.rs | function | pub | 424 | assert!(code.contains("pub async fn get_pet")); |
...
changes:
  - path: "libs/compass/src/gen/rust/reqwest.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/gen/rust/reqwest.rs` captured during libs codegen standardization.
```
