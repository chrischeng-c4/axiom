---
id: libs-compass-src-type-inference-stubs-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/stubs.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/stubs.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/stubs.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `StubLoader` | libs/compass/src/type_inference/stubs.rs | struct | pub | 20 | pub struct StubLoader { |
| `new` | libs/compass/src/type_inference/stubs.rs | function | pub | 30 | pub fn new() -> Self { |
| `set_stub_paths` | libs/compass/src/type_inference/stubs.rs | function | pub | 39 | pub fn set_stub_paths(&mut self, paths: Vec<PathBuf>) { |
| `add_stub_path` | libs/compass/src/type_inference/stubs.rs | function | pub | 44 | pub fn add_stub_path(&mut self, path: PathBuf) { |
| `load_builtins` | libs/compass/src/type_inference/stubs.rs | function | pub | 51 | pub fn load_builtins(&mut self) { |
| `get_or_load_stub` | libs/compass/src/type_inference/stubs.rs | function | pub | 91 | pub fn get_or_load_stub(&mut self, module_path: &str) -> Option<&ModuleInfo> { |
| `is_typed_package` | libs/compass/src/type_inference/stubs.rs | function | pub | 111 | pub fn is_typed_package(&self, package_path: &Path) -> bool { |
| `get_stub` | libs/compass/src/type_inference/stubs.rs | function | pub | 116 | pub fn get_stub(&self, module_path: &str) -> Option<&ModuleInfo> { |
| `has_stub` | libs/compass/src/type_inference/stubs.rs | function | pub | 121 | pub fn has_stub(&self, module_path: &str) -> bool { |
| `load_stub` | libs/compass/src/type_inference/stubs.rs | function | pub | 127 | pub fn load_stub(&mut self, module_path: &str) -> Option<&ModuleInfo> { |
| `modules` | libs/compass/src/type_inference/stubs.rs | function | pub | 492 | pub fn modules(&self) -> impl Iterator<Item = (&String, &ModuleInfo)> { |
...
changes:
  - path: "libs/compass/src/type_inference/stubs.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/stubs.rs` captured during libs codegen standardization.
```
