---
id: libs-compass-src-output-reporter-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/output/reporter.rs`.
capability_refs:
...
# Standardized libs/compass/src/output/reporter.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/output/reporter.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `OutputFormat` | libs/compass/src/output/reporter.rs | enum | pub | 13 | pub enum OutputFormat { |
| `from_str` | libs/compass/src/output/reporter.rs | function | pub | 28 | pub fn from_str(s: &str) -> Option<Self> { |
| `Reporter` | libs/compass/src/output/reporter.rs | struct | pub | 43 | pub struct Reporter { |
| `new` | libs/compass/src/output/reporter.rs | function | pub | 48 | pub fn new(format: OutputFormat) -> Self { |
| `generate` | libs/compass/src/output/reporter.rs | function | pub | 52 | pub fn generate(&self, results: &[FileResult]) -> String { |
| `generate_agent` | libs/compass/src/output/reporter.rs | function | pub | 85 | pub fn generate_agent( |
...
changes:
  - path: "libs/compass/src/output/reporter.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/output/reporter.rs` captured during libs codegen standardization.
```
