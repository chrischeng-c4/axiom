---
id: libs-compass-src-semantic-pdg-dominator-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/semantic/pdg/dominator.rs`.
capability_refs:
...
# Standardized libs/compass/src/semantic/pdg/dominator.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/semantic/pdg/dominator.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DominatorTree` | libs/compass/src/semantic/pdg/dominator.rs | struct | pub | 11 | pub struct DominatorTree { |
| `compute` | libs/compass/src/semantic/pdg/dominator.rs | function | pub | 24 | pub fn compute(cfg: &ControlFlowGraph) -> Self { |
| `compute_post` | libs/compass/src/semantic/pdg/dominator.rs | function | pub | 44 | pub fn compute_post(cfg: &ControlFlowGraph) -> Self { |
| `dominates` | libs/compass/src/semantic/pdg/dominator.rs | function | pub | 249 | pub fn dominates(&self, a: BlockId, b: BlockId) -> bool { |
| `dominated_by` | libs/compass/src/semantic/pdg/dominator.rs | function | pub | 269 | pub fn dominated_by(&self, block: BlockId) -> HashSet<BlockId> { |
| `get_idom` | libs/compass/src/semantic/pdg/dominator.rs | function | pub | 285 | pub fn get_idom(&self, block: BlockId) -> Option<BlockId> { |
| `get_frontier` | libs/compass/src/semantic/pdg/dominator.rs | function | pub | 290 | pub fn get_frontier(&self, block: BlockId) -> HashSet<BlockId> { |
| `ControlDependencies` | libs/compass/src/semantic/pdg/dominator.rs | struct | pub | 297 | pub struct ControlDependencies { |
| `get_dependencies` | libs/compass/src/semantic/pdg/dominator.rs | function | pub | 365 | pub fn get_dependencies(&self, block: BlockId) -> HashSet<BlockId> { |
| `get_dependents` | libs/compass/src/semantic/pdg/dominator.rs | function | pub | 370 | pub fn get_dependents(&self, block: BlockId) -> HashSet<BlockId> { |
| `is_dependent` | libs/compass/src/semantic/pdg/dominator.rs | function | pub | 375 | pub fn is_dependent(&self, a: BlockId, b: BlockId) -> bool { |
...
changes:
  - path: "libs/compass/src/semantic/pdg/dominator.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/semantic/pdg/dominator.rs` captured during libs codegen standardization.
```
