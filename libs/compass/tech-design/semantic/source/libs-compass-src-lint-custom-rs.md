---
id: libs-compass-src-lint-custom-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/custom.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/custom.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/custom.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RuleKind` | libs/compass/src/lint/custom.rs | enum | pub | 47 | pub enum RuleKind { |
| `CustomRuleConfig` | libs/compass/src/lint/custom.rs | struct | pub | 56 | pub struct CustomRuleConfig { |
| `code` | libs/compass/src/lint/custom.rs | function | pub | 79 | pub fn code(&self) -> String { |
| `diagnostic_severity` | libs/compass/src/lint/custom.rs | function | pub | 84 | pub fn diagnostic_severity(&self) -> DiagnosticSeverity { |
| `CustomRulesFile` | libs/compass/src/lint/custom.rs | struct | pub | 97 | pub struct CustomRulesFile { |
| `CustomLintEngine` | libs/compass/src/lint/custom.rs | struct | pub | 126 | pub struct CustomLintEngine { |
| `from_rules_file` | libs/compass/src/lint/custom.rs | function | pub | 136 | pub fn from_rules_file(rules_file: &CustomRulesFile) -> Self { |
| `load_from_path` | libs/compass/src/lint/custom.rs | function | pub | 170 | pub fn load_from_path(path: &Path) -> std::io::Result<Self> { |
| `load_from_workspace` | libs/compass/src/lint/custom.rs | function | pub | 181 | pub fn load_from_workspace(workspace_root: &Path) -> Option<Self> { |
| `rule_count` | libs/compass/src/lint/custom.rs | function | pub | 201 | pub fn rule_count(&self) -> usize { |
| `rule_codes` | libs/compass/src/lint/custom.rs | function | pub | 206 | pub fn rule_codes(&self) -> Vec<String> { |
| `check` | libs/compass/src/lint/custom.rs | function | pub | 213 | pub fn check(&self, file: &ParsedFile) -> Vec<Diagnostic> { |
...
changes:
  - path: "libs/compass/src/lint/custom.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/custom.rs` captured during libs codegen standardization.
```
