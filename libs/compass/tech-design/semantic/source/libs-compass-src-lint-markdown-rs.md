---
id: libs-compass-src-lint-markdown-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/markdown.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/markdown.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/markdown.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MarkdownSymbol` | libs/compass/src/lint/markdown.rs | enum | pub | 31 | pub enum MarkdownSymbol { |
| `MarkdownSymbolExtractor` | libs/compass/src/lint/markdown.rs | struct | pub | 64 | pub struct MarkdownSymbolExtractor; |
| `extract` | libs/compass/src/lint/markdown.rs | function | pub | 68 | pub fn extract(source: &str) -> Vec<MarkdownSymbol> { |
| `MarkdownChecker` | libs/compass/src/lint/markdown.rs | struct | pub | 192 | pub struct MarkdownChecker { |
| `new` | libs/compass/src/lint/markdown.rs | function | pub | 199 | pub fn new() -> Self { |
| `with_workspace` | libs/compass/src/lint/markdown.rs | function | pub | 206 | pub fn with_workspace(workspace_root: PathBuf) -> Self { |
| `line_range` | libs/compass/src/lint/markdown.rs | function | pub | 443 | pub(crate) fn line_range(line_num: u32) -> Range { |
...
changes:
  - path: "libs/compass/src/lint/markdown.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/markdown.rs` captured during libs codegen standardization.
```
