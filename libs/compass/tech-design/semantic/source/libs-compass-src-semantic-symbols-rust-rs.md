---
id: libs-compass-src-semantic-symbols-rust-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/semantic/symbols/rust.rs`.
capability_refs:
...
# Standardized libs/compass/src/semantic/symbols/rust.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/semantic/symbols/rust.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `visit_rust_node` | libs/compass/src/semantic/symbols/rust.rs | function | pub | 18 | pub(crate) fn visit_rust_node(&mut self, node: &tree_sitter::Node<'_>, file: &ParsedFile) { |
...
changes:
  - path: "libs/compass/src/semantic/symbols/rust.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/semantic/symbols/rust.rs` captured during libs codegen standardization.
```
