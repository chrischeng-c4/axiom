---
id: libs-compass-src-spec-mermaid-parser-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/spec/mermaid/parser.rs`.
capability_refs:
...
# Standardized libs/compass/src/spec/mermaid/parser.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/spec/mermaid/parser.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MermaidError` | libs/compass/src/spec/mermaid/parser.rs | enum | pub | 14 | pub enum MermaidError { |
| `DiagramType` | libs/compass/src/spec/mermaid/parser.rs | enum | pub | 40 | pub enum DiagramType { |
| `MermaidSpec` | libs/compass/src/spec/mermaid/parser.rs | enum | pub | 50 | pub enum MermaidSpec { |
| `MermaidParser` | libs/compass/src/spec/mermaid/parser.rs | struct | pub | 57 | pub struct MermaidParser; |
| `new` | libs/compass/src/spec/mermaid/parser.rs | function | pub | 60 | pub fn new() -> Self { |
| `parse` | libs/compass/src/spec/mermaid/parser.rs | function | pub | 65 | pub fn parse(&self, content: &str) -> Result<MermaidSpec, MermaidError> { |
...
changes:
  - path: "libs/compass/src/spec/mermaid/parser.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/spec/mermaid/parser.rs` captured during libs codegen standardization.
```
