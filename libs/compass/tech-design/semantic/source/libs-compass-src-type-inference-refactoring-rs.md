---
id: libs-compass-src-type-inference-refactoring-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/refactoring.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/refactoring.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/refactoring.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RefactorRequest` | libs/compass/src/type_inference/refactoring.rs | struct | pub | 26 | pub struct RefactorRequest { |
| `RefactorKind` | libs/compass/src/type_inference/refactoring.rs | enum | pub | 39 | pub enum RefactorKind { |
| `RefactorOptions` | libs/compass/src/type_inference/refactoring.rs | struct | pub | 58 | pub struct RefactorOptions { |
| `SignatureChanges` | libs/compass/src/type_inference/refactoring.rs | struct | pub | 71 | pub struct SignatureChanges { |
| `RefactorResult` | libs/compass/src/type_inference/refactoring.rs | struct | pub | 88 | pub struct RefactorResult { |
| `TextEdit` | libs/compass/src/type_inference/refactoring.rs | struct | pub | 103 | pub struct TextEdit { |
| `ImportChange` | libs/compass/src/type_inference/refactoring.rs | enum | pub | 112 | pub enum ImportChange { |
| `RefactorDiagnostic` | libs/compass/src/type_inference/refactoring.rs | struct | pub | 127 | pub struct RefactorDiagnostic { |
| `DiagnosticLevel` | libs/compass/src/type_inference/refactoring.rs | enum | pub | 140 | pub enum DiagnosticLevel { |
| `empty` | libs/compass/src/type_inference/refactoring.rs | function | pub | 149 | pub fn empty() -> Self { |
| `has_changes` | libs/compass/src/type_inference/refactoring.rs | function | pub | 160 | pub fn has_changes(&self) -> bool { |
| `has_errors` | libs/compass/src/type_inference/refactoring.rs | function | pub | 165 | pub fn has_errors(&self) -> bool { |
| `add_edit` | libs/compass/src/type_inference/refactoring.rs | function | pub | 172 | pub fn add_edit(&mut self, file: PathBuf, edit: TextEdit) { |
| `add_diagnostic` | libs/compass/src/type_inference/refactoring.rs | function | pub | 177 | pub fn add_diagnostic( |
| `RefactoringEngine` | libs/compass/src/type_inference/refactoring.rs | struct | pub | 206 | pub struct RefactoringEngine { |
| `new` | libs/compass/src/type_inference/refactoring.rs | function | pub | 217 | pub fn new() -> Self { |
| `with_inferencer` | libs/compass/src/type_inference/refactoring.rs | function | pub | 226 | pub fn with_inferencer(inferencer: DeepTypeInferencer) -> Self { |
| `populate_ast_cache` | libs/compass/src/type_inference/refactoring.rs | function | pub | 235 | pub fn populate_ast_cache(&mut self, file: &PathBuf, content: &str) -> Result<(), String> { |
| `get_ast` | libs/compass/src/type_inference/refactoring.rs | function | pub | 301 | pub fn get_ast(&mut self, file: &PathBuf, content: &str) -> Result<&MutableAst, String> { |
| `get_ast_mut` | libs/compass/src/type_inference/refactoring.rs | function | pub | 311 | pub fn get_ast_mut( |
| `execute` | libs/compass/src/type_inference/refactoring.rs | function | pub | 556 | pub fn execute(&mut self, request: &RefactorRequest, source: &str) -> RefactorResult { |
| `type_context` | libs/compass/src/type_inference/refactoring.rs | function | pub | 1445 | pub fn type_context(&self) -> &TypeContext { |
...
use super::semantic_search::{SearchKind, SearchQuery, SearchScope, SemanticSearchEngine};
...
print(result)"#;
        ...
        assert!(
            func_def_edit.new_text.contains("-> Any")
                || func_def_edit.new_text.contains("-> tuple")
        );
    }
...
changes:
  - path: "libs/compass/src/type_inference/refactoring.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/refactoring.rs` captured during libs codegen standardization.
```
