---
id: libs-compass-src-graph-resolve-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/graph/resolve.rs`.
capability_refs:
...
# Standardized libs/compass/src/graph/resolve.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/graph/resolve.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `ExtractedImport` | libs/compass/src/graph/resolve.rs | struct | pub | 8 | pub struct ExtractedImport { |
| `extract_imports` | libs/compass/src/graph/resolve.rs | function | pub | 15 | pub fn extract_imports(source: &str, file_path: &Path) -> Vec<ExtractedImport> { |
| `resolve_import` | libs/compass/src/graph/resolve.rs | function | pub | 26 | pub fn resolve_import( |
...
changes:
  - path: "libs/compass/src/graph/resolve.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/graph/resolve.rs` captured during libs codegen standardization.
```
