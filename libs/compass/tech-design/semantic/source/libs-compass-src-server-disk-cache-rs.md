---
id: libs-compass-src-server-disk-cache-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/server/disk_cache.rs`.
capability_refs:
...
# Standardized libs/compass/src/server/disk_cache.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/server/disk_cache.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `PersistedEntry` | libs/compass/src/server/disk_cache.rs | struct | pub | 22 | pub struct PersistedEntry { |
| `DiskCache` | libs/compass/src/server/disk_cache.rs | struct | pub | 44 | pub struct DiskCache { |
| `new` | libs/compass/src/server/disk_cache.rs | function | pub | 51 | pub fn new(cache_dir: PathBuf) -> Self { |
| `is_fresh` | libs/compass/src/server/disk_cache.rs | function | pub | 61 | pub async fn is_fresh(&self, path: &Path, current_hash: u64) -> bool { |
| `load` | libs/compass/src/server/disk_cache.rs | function | pub | 77 | pub async fn load(&self, path: &Path, current_hash: u64) -> Option<PersistedEntry> { |
| `store` | libs/compass/src/server/disk_cache.rs | function | pub | 102 | pub async fn store( |
| `invalidate` | libs/compass/src/server/disk_cache.rs | function | pub | 144 | pub async fn invalidate(&self, path: &Path) { |
| `flush_manifest` | libs/compass/src/server/disk_cache.rs | function | pub | 154 | pub async fn flush_manifest(&self) { |
| `cleanup_stale` | libs/compass/src/server/disk_cache.rs | function | pub | 170 | pub async fn cleanup_stale(&self) { |
...
changes:
  - path: "libs/compass/src/server/disk_cache.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/server/disk_cache.rs` captured during libs codegen standardization.
```
