---
id: libs-compass-src-type-inference-semantic-search-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/semantic_search.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/semantic_search.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/semantic_search.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `SearchQuery` | libs/compass/src/type_inference/semantic_search.rs | struct | pub | 23 | pub struct SearchQuery { |
| `SearchKind` | libs/compass/src/type_inference/semantic_search.rs | enum | pub | 34 | pub enum SearchKind { |
| `CallDirection` | libs/compass/src/type_inference/semantic_search.rs | enum | pub | 63 | pub enum CallDirection { |
| `TypeHierarchyDirection` | libs/compass/src/type_inference/semantic_search.rs | enum | pub | 72 | pub enum TypeHierarchyDirection { |
| `SearchScope` | libs/compass/src/type_inference/semantic_search.rs | enum | pub | 83 | pub enum SearchScope { |
| `SearchResult` | libs/compass/src/type_inference/semantic_search.rs | struct | pub | 100 | pub struct SearchResult { |
| `SearchMatch` | libs/compass/src/type_inference/semantic_search.rs | struct | pub | 111 | pub struct SearchMatch { |
| `MatchKind` | libs/compass/src/type_inference/semantic_search.rs | enum | pub | 128 | pub enum MatchKind { |
| `MatchContext` | libs/compass/src/type_inference/semantic_search.rs | struct | pub | 149 | pub struct MatchContext { |
| `SearchStats` | libs/compass/src/type_inference/semantic_search.rs | struct | pub | 160 | pub struct SearchStats { |
| `empty` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 171 | pub fn empty() -> Self { |
| `is_empty` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 180 | pub fn is_empty(&self) -> bool { |
| `len` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 185 | pub fn len(&self) -> usize { |
| `SemanticSearchEngine` | libs/compass/src/type_inference/semantic_search.rs | struct | pub | 195 | pub struct SemanticSearchEngine { |
| `SymbolLocation` | libs/compass/src/type_inference/semantic_search.rs | struct | pub | 208 | pub struct SymbolLocation { |
| `TypeLocation` | libs/compass/src/type_inference/semantic_search.rs | struct | pub | 225 | pub struct TypeLocation { |
| `CallSite` | libs/compass/src/type_inference/semantic_search.rs | struct | pub | 236 | pub struct CallSite { |
| `CallGraph` | libs/compass/src/type_inference/semantic_search.rs | struct | pub | 249 | pub struct CallGraph { |
| `new` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 257 | pub fn new() -> Self { |
| `add_call` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 262 | pub fn add_call(&mut self, call_site: CallSite) { |
| `get_callees` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 275 | pub fn get_callees(&self, function: &str) -> Vec<&CallSite> { |
| `get_callers` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 283 | pub fn get_callers(&self, function: &str) -> Vec<&CallSite> { |
| `with_inferencer` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 303 | pub fn with_inferencer(inferencer: DeepTypeInferencer) -> Self { |
| `search` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 313 | pub fn search(&self, query: &SearchQuery) -> SearchResult { |
| `index_file` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 871 | pub fn index_file(&mut self, file: PathBuf, symbols: Vec<SymbolLocation>) { |
| `index_symbol_table` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 948 | pub fn index_symbol_table(&mut self, file: PathBuf, symbol_table: &SymbolTable) { |
| `index_symbol_table_with_source` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 957 | pub fn index_symbol_table_with_source( |
| `update_docstrings` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 979 | pub fn update_docstrings(&mut self, docstrings: std::collections::HashMap<String, String>) { |
| `extract_docstrings` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 991 | pub fn extract_docstrings( |
| `build_call_graph` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 1211 | pub fn build_call_graph( |
| `type_context` | libs/compass/src/type_inference/semantic_search.rs | function | pub | 1531 | pub fn type_context(&self) -> &TypeContext { |
...
use super::deep_inference::{DeepTypeInferencer, TypeContext};
...
impl SemanticSearchEngine {
    ...
    fn compute_signature_match_score(
        ...
        func_params: &[crate::type_inference::ty::Param],
        func_return: &Type,
    ) -> f64 {
        let mut score = 0.0;
...
mod tests {
    ...
    fn test_convert_type_info() {
        ...
        let int_type =
            SemanticSearchEngine::convert_type_info(&TypeInfo::Primitive("int".to_string()));
...
changes:
  - path: "libs/compass/src/type_inference/semantic_search.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/semantic_search.rs` captured during libs codegen standardization.
```
