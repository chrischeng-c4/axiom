---
id: libs-compass-src-type-inference-narrow-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/narrow.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/narrow.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/narrow.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `NarrowingCondition` | libs/compass/src/type_inference/narrow.rs | enum | pub | 15 | pub enum NarrowingCondition { |
| `TypeNarrower` | libs/compass/src/type_inference/narrow.rs | struct | pub | 64 | pub struct TypeNarrower { |
| `NarrowingScope` | libs/compass/src/type_inference/narrow.rs | struct | pub | 71 | pub struct NarrowingScope { |
| `new` | libs/compass/src/type_inference/narrow.rs | function | pub | 77 | pub fn new() -> Self { |
| `push_scope` | libs/compass/src/type_inference/narrow.rs | function | pub | 82 | pub fn push_scope(&mut self) { |
| `pop_scope` | libs/compass/src/type_inference/narrow.rs | function | pub | 87 | pub fn pop_scope(&mut self) -> Option<NarrowingScope> { |
| `apply_condition` | libs/compass/src/type_inference/narrow.rs | function | pub | 92 | pub fn apply_condition( |
| `get_narrowed` | libs/compass/src/type_inference/narrow.rs | function | pub | 319 | pub fn get_narrowed(&self, name: &str) -> Option<&Type> { |
| `narrow_type` | libs/compass/src/type_inference/narrow.rs | function | pub | 329 | pub fn narrow_type(&self, name: &str, original: &Type) -> Type { |
| `negate_condition` | libs/compass/src/type_inference/narrow.rs | function | pub | 340 | pub fn negate_condition(condition: &NarrowingCondition) -> NarrowingCondition { |
| `MatchPattern` | libs/compass/src/type_inference/narrow.rs | enum | pub | 409 | pub enum MatchPattern { |
| `parse_match_pattern` | libs/compass/src/type_inference/narrow.rs | function | pub | 432 | pub fn parse_match_pattern( |
| `get_match_subject` | libs/compass/src/type_inference/narrow.rs | function | pub | 512 | pub fn get_match_subject(source: &str, node: &tree_sitter::Node) -> Option<String> { |
| `parse_assert` | libs/compass/src/type_inference/narrow.rs | function | pub | 531 | pub fn parse_assert(source: &str, node: &tree_sitter::Node) -> NarrowingCondition { |
| `parse_condition` | libs/compass/src/type_inference/narrow.rs | function | pub | 549 | pub fn parse_condition(source: &str, node: &tree_sitter::Node) -> NarrowingCondition { |
...
changes:
  - path: "libs/compass/src/type_inference/narrow.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/narrow.rs` captured during libs codegen standardization.
```
