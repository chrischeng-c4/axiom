---
id: libs-compass-src-spec-json-schema-parser-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/spec/json_schema/parser.rs`.
capability_refs:
...
# Standardized libs/compass/src/spec/json_schema/parser.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/spec/json_schema/parser.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `JsonSchemaError` | libs/compass/src/spec/json_schema/parser.rs | enum | pub | 17 | pub enum JsonSchemaError { |
| `JsonSchemaParser` | libs/compass/src/spec/json_schema/parser.rs | struct | pub | 45 | pub struct JsonSchemaParser { |
| `new` | libs/compass/src/spec/json_schema/parser.rs | function | pub | 53 | pub fn new() -> Self { |
| `parse_str` | libs/compass/src/spec/json_schema/parser.rs | function | pub | 61 | pub fn parse_str(&mut self, json: &str) -> Result<DataModelSpec, JsonSchemaError> { |
| `parse_value` | libs/compass/src/spec/json_schema/parser.rs | function | pub | 68 | pub fn parse_value(&mut self, value: &Value) -> Result<DataModelSpec, JsonSchemaError> { |
| `parse_enums` | libs/compass/src/spec/json_schema/parser.rs | function | pub | 503 | pub fn parse_enums(&self, value: &Value) -> Result<Vec<EnumDef>, JsonSchemaError> { |
...
changes:
  - path: "libs/compass/src/spec/json_schema/parser.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/spec/json_schema/parser.rs` captured during libs codegen standardization.
```
