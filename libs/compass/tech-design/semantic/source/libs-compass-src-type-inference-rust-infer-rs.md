---
id: libs-compass-src-type-inference-rust-infer-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/rust_infer.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/rust_infer.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/rust_infer.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `MethodResolution` | libs/compass/src/type_inference/rust_infer.rs | re-export | pub | 25 | pub use super::rust_traits::{MethodResolution, TraitResolver}; |
| `TraitResolver` | libs/compass/src/type_inference/rust_infer.rs | re-export | pub | 25 | pub use super::rust_traits::{MethodResolution, TraitResolver}; |
| `RustTypeContext` | libs/compass/src/type_inference/rust_infer.rs | struct | pub | 33 | pub struct RustTypeContext { |
| `new` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 54 | pub fn new() -> Self { |
| `fresh_type_var` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 68 | pub fn fresh_type_var(&mut self, name: impl Into<String>) -> RustType { |
| `fresh_lifetime` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 79 | pub fn fresh_lifetime(&mut self) -> Lifetime { |
| `lookup_type` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 86 | pub fn lookup_type(&self, name: &str) -> Option<RustType> { |
| `bind_type` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 91 | pub fn bind_type(&mut self, name: String, ty: RustType) { |
| `lookup_lifetime` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 96 | pub fn lookup_lifetime(&self, name: &str) -> Option<Lifetime> { |
| `bind_lifetime` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 101 | pub fn bind_lifetime(&mut self, name: String, lifetime: Lifetime) { |
| `child` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 106 | pub fn child(&self) -> Self { |
| `RustTypeInferencer` | libs/compass/src/type_inference/rust_infer.rs | struct | pub | 131 | pub struct RustTypeInferencer { |
| `RustTypeError` | libs/compass/src/type_inference/rust_infer.rs | struct | pub | 147 | pub struct RustTypeError { |
| `RustTypeErrorKind` | libs/compass/src/type_inference/rust_infer.rs | enum | pub | 158 | pub enum RustTypeErrorKind { |
| `with_context` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 186 | pub fn with_context(context: RustTypeContext) -> Self { |
| `trait_resolver` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 206 | pub fn trait_resolver(&self) -> &super::rust_traits::TraitResolver { |
| `register_impl` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 211 | pub fn register_impl(&mut self, impl_block: ImplBlock) { |
| `register_trait` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 216 | pub fn register_trait(&mut self, trait_def: TraitDef) { |
| `errors` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 221 | pub fn errors(&self) -> &[RustTypeError] { |
| `clear_errors` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 226 | pub fn clear_errors(&mut self) { |
| `infer_expr` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 231 | pub fn infer_expr(&mut self, node: &Node, source: &str) -> RustType { |
| `parse_trait_bounds_from_node` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 921 | pub fn parse_trait_bounds_from_node(&mut self, node: &Node, source: &str) -> Vec<TraitBound> { |
| `parse_qualified_path` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 1014 | pub fn parse_qualified_path(&mut self, node: &Node, source: &str) -> RustType { |
| `apply_lifetime_elision` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 1125 | pub fn apply_lifetime_elision( |
| `unify` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 1263 | pub fn unify(&mut self, t1: &RustType, t2: &RustType) -> Result<RustType, RustTypeError> { |
| `apply_substitutions` | libs/compass/src/type_inference/rust_infer.rs | function | pub | 1361 | pub fn apply_substitutions(&self, ty: &RustType) -> RustType { |
...
changes:
  - path: "libs/compass/src/type_inference/rust_infer.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/rust_infer.rs` captured during libs codegen standardization.
```
