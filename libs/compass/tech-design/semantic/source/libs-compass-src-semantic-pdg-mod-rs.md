---
id: libs-compass-src-semantic-pdg-mod-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/semantic/pdg/mod.rs`.
capability_refs:
...
# Standardized libs/compass/src/semantic/pdg/mod.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/semantic/pdg/mod.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `cfg` | libs/compass/src/semantic/pdg/mod.rs | module | pub | 10 | pub mod cfg; |
| `data_flow` | libs/compass/src/semantic/pdg/mod.rs | module | pub | 11 | pub mod data_flow; |
| `dominator` | libs/compass/src/semantic/pdg/mod.rs | module | pub | 12 | pub mod dominator; |
| `BlockId` | libs/compass/src/semantic/pdg/mod.rs | re-export | pub | 20 | pub use cfg::{BlockId, CfgBuilder, ControlFlowGraph, StatementInfo, StatementKind}; |
| `CfgBuilder` | libs/compass/src/semantic/pdg/mod.rs | re-export | pub | 20 | pub use cfg::{BlockId, CfgBuilder, ControlFlowGraph, StatementInfo, StatementKind}; |
| `ControlFlowGraph` | libs/compass/src/semantic/pdg/mod.rs | re-export | pub | 20 | pub use cfg::{BlockId, CfgBuilder, ControlFlowGraph, StatementInfo, StatementKind}; |
| `StatementInfo` | libs/compass/src/semantic/pdg/mod.rs | re-export | pub | 20 | pub use cfg::{BlockId, CfgBuilder, ControlFlowGraph, StatementInfo, StatementKind}; |
| `StatementKind` | libs/compass/src/semantic/pdg/mod.rs | re-export | pub | 20 | pub use cfg::{BlockId, CfgBuilder, ControlFlowGraph, StatementInfo, StatementKind}; |
| `DataDependencies` | libs/compass/src/semantic/pdg/mod.rs | re-export | pub | 21 | pub use data_flow::{DataDependencies, DefUseChain, Definition, Use, UseDefChain}; |
| `DefUseChain` | libs/compass/src/semantic/pdg/mod.rs | re-export | pub | 21 | pub use data_flow::{DataDependencies, DefUseChain, Definition, Use, UseDefChain}; |
| `Definition` | libs/compass/src/semantic/pdg/mod.rs | re-export | pub | 21 | pub use data_flow::{DataDependencies, DefUseChain, Definition, Use, UseDefChain}; |
| `Use` | libs/compass/src/semantic/pdg/mod.rs | re-export | pub | 21 | pub use data_flow::{DataDependencies, DefUseChain, Definition, Use, UseDefChain}; |
| `UseDefChain` | libs/compass/src/semantic/pdg/mod.rs | re-export | pub | 21 | pub use data_flow::{DataDependencies, DefUseChain, Definition, Use, UseDefChain}; |
| `ControlDependencies` | libs/compass/src/semantic/pdg/mod.rs | re-export | pub | 22 | pub use dominator::{ControlDependencies, DominatorTree}; |
| `DominatorTree` | libs/compass/src/semantic/pdg/mod.rs | re-export | pub | 22 | pub use dominator::{ControlDependencies, DominatorTree}; |
| `PdgNode` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 26 | pub struct PdgNode { |
| `PdgEdgeKind` | libs/compass/src/semantic/pdg/mod.rs | enum | pub | 43 | pub enum PdgEdgeKind { |
| `PdgEdge` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 52 | pub struct PdgEdge { |
| `ProgramDependenceGraph` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 63 | pub struct ProgramDependenceGraph { |
| `build` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 86 | pub fn build(source: &str, file: &ParsedFile) -> Self { |
| `from_cfg` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 92 | pub fn from_cfg(cfg: ControlFlowGraph, file: &ParsedFile) -> Self { |
| `with_file_path` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 200 | pub fn with_file_path(mut self, path: PathBuf) -> Self { |
| `get_node` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 206 | pub fn get_node(&self, id: u32) -> Option<&PdgNode> { |
| `get_node_by_line` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 211 | pub fn get_node_by_line(&self, line: usize) -> Option<&PdgNode> { |
| `get_nodes_by_line` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 219 | pub fn get_nodes_by_line(&self, line: usize) -> Vec<&PdgNode> { |
| `get_dependencies` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 227 | pub fn get_dependencies(&self, id: u32) -> Vec<&PdgEdge> { |
| `get_dependents` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 235 | pub fn get_dependents(&self, id: u32) -> Vec<&PdgEdge> { |
| `backward_slice` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 246 | pub fn backward_slice(&self, line: usize) -> ProgramSlice { |
| `forward_slice` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 289 | pub fn forward_slice(&self, line: usize) -> ProgramSlice { |
| `impact_analysis` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 331 | pub fn impact_analysis(&self, changed_lines: &[usize]) -> ImpactAnalysis { |
| `taint_tracking` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 354 | pub fn taint_tracking(&self, sources: &[usize], sinks: &[usize]) -> TaintAnalysis { |
| `dead_code_detection` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 433 | pub fn dead_code_detection(&self, output_lines: &[usize]) -> DeadCodeAnalysis { |
| `all_nodes` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 458 | pub fn all_nodes(&self) -> Vec<&PdgNode> { |
| `stats` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 465 | pub fn stats(&self) -> PdgStats { |
| `SliceDirection` | libs/compass/src/semantic/pdg/mod.rs | enum | pub | 489 | pub enum SliceDirection { |
| `ProgramSlice` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 496 | pub struct ProgramSlice { |
| `lines` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 515 | pub fn lines(&self) -> Vec<usize> { |
| `contains_line` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 520 | pub fn contains_line(&self, line: usize) -> bool { |
| `len` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 525 | pub fn len(&self) -> usize { |
| `is_empty` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 530 | pub fn is_empty(&self) -> bool { |
| `ImpactAnalysis` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 537 | pub struct ImpactAnalysis { |
| `impact_count` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 553 | pub fn impact_count(&self) -> usize { |
| `TaintPath` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 560 | pub struct TaintPath { |
| `TaintAnalysis` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 571 | pub struct TaintAnalysis { |
| `has_taint` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 590 | pub fn has_taint(&self) -> bool { |
| `tainted_sinks` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 595 | pub fn tainted_sinks(&self) -> Vec<usize> { |
| `DeadCodeAnalysis` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 602 | pub struct DeadCodeAnalysis { |
| `DependencyReason` | libs/compass/src/semantic/pdg/mod.rs | enum | pub | 614 | pub enum DependencyReason { |
| `ImpactTreeNode` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 622 | pub struct ImpactTreeNode { |
| `ImpactAnalysisTree` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 632 | pub struct ImpactAnalysisTree { |
| `impact_analysis_tree` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 643 | pub fn impact_analysis_tree(&self, changed_lines: &[usize]) -> ImpactAnalysisTree { |
| `TaintSourceKind` | libs/compass/src/semantic/pdg/mod.rs | enum | pub | 741 | pub enum TaintSourceKind { |
| `TaintSinkKind` | libs/compass/src/semantic/pdg/mod.rs | enum | pub | 754 | pub enum TaintSinkKind { |
| `DetectedSource` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 767 | pub struct DetectedSource { |
| `DetectedSink` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 775 | pub struct DetectedSink { |
| `SemanticTaintAnalysis` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 783 | pub struct SemanticTaintAnalysis { |
| `has_vulnerabilities` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 790 | pub fn has_vulnerabilities(&self) -> bool { |
| `detect_taint_sources` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 796 | pub fn detect_taint_sources(nodes: &HashMap<u32, PdgNode>) -> Vec<DetectedSource> { |
| `detect_taint_sinks` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 886 | pub fn detect_taint_sinks(nodes: &HashMap<u32, PdgNode>) -> Vec<DetectedSink> { |
| `semantic_taint_analysis` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 992 | pub fn semantic_taint_analysis(&self) -> SemanticTaintAnalysis { |
| `taint_analysis_explicit` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 1011 | pub fn taint_analysis_explicit( |
| `is_dead` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 1028 | pub fn is_dead(&self, line: usize) -> bool { |
| `dead_count` | libs/compass/src/semantic/pdg/mod.rs | function | pub | 1033 | pub fn dead_count(&self) -> usize { |
| `PdgStats` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 1040 | pub struct PdgStats { |
| `PdgJson` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 1053 | pub struct PdgJson { |
| `PdgNodeJson` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 1067 | pub struct PdgNodeJson { |
| `PdgEdgeJson` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 1075 | pub struct PdgEdgeJson { |
| `PdgStatsJson` | libs/compass/src/semantic/pdg/mod.rs | struct | pub | 1083 | pub struct PdgStatsJson { |
...
changes:
  - path: "libs/compass/src/semantic/pdg/mod.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/semantic/pdg/mod.rs` captured during libs codegen standardization.
```
