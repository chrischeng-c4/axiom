---
id: libs-compass-src-lint-javascript-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/javascript.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/javascript.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/javascript.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `JavaScriptChecker` | libs/compass/src/lint/javascript.rs | struct | pub | 8 | pub struct JavaScriptChecker; |
| `new` | libs/compass/src/lint/javascript.rs | function | pub | 11 | pub fn new() -> Self { |
...
changes:
  - path: "libs/compass/src/lint/javascript.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/javascript.rs` captured during libs codegen standardization.
```
