---
id: libs-compass-src-lint-python-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/python.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/python.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/python.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `PythonChecker` | libs/compass/src/lint/python.rs | struct | pub | 32 | pub struct PythonChecker { |
| `new` | libs/compass/src/lint/python.rs | function | pub | 37 | pub fn new() -> Self { |
...
changes:
  - path: "libs/compass/src/lint/python.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/python.rs` captured during libs codegen standardization.
```
