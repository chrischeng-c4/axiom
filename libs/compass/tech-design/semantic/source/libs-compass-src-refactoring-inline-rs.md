---
id: libs-compass-src-refactoring-inline-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/refactoring/inline.rs`.
capability_refs:
...
# Standardized libs/compass/src/refactoring/inline.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/refactoring/inline.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `InlineEngine` | libs/compass/src/refactoring/inline.rs | struct | pub | 20 | pub struct InlineEngine; |
...
changes:
  - path: "libs/compass/src/refactoring/inline.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/refactoring/inline.rs` captured during libs codegen standardization.
```
