---
id: libs-compass-src-gen-python-rust-scanner-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/gen/python/rust_scanner.rs`.
capability_refs:
...
# Standardized libs/compass/src/gen/python/rust_scanner.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/gen/python/rust_scanner.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RustExports` | libs/compass/src/gen/python/rust_scanner.rs | struct | pub | 17 | pub struct RustExports { |
| `merge` | libs/compass/src/gen/python/rust_scanner.rs | function | pub | 28 | pub fn merge(&mut self, other: RustExports) { |
| `is_empty` | libs/compass/src/gen/python/rust_scanner.rs | function | pub | 35 | pub fn is_empty(&self) -> bool { |
| `StructKind` | libs/compass/src/gen/python/rust_scanner.rs | enum | pub | 42 | pub enum StructKind { |
| `RustStruct` | libs/compass/src/gen/python/rust_scanner.rs | struct | pub | 53 | pub struct RustStruct { |
| `RustField` | libs/compass/src/gen/python/rust_scanner.rs | struct | pub | 68 | pub struct RustField { |
| `RustMethod` | libs/compass/src/gen/python/rust_scanner.rs | struct | pub | 77 | pub struct RustMethod { |
| `RustParam` | libs/compass/src/gen/python/rust_scanner.rs | struct | pub | 90 | pub struct RustParam { |
| `RustEnum` | libs/compass/src/gen/python/rust_scanner.rs | struct | pub | 99 | pub struct RustEnum { |
| `RustEnumVariant` | libs/compass/src/gen/python/rust_scanner.rs | struct | pub | 109 | pub struct RustEnumVariant { |
| `RustFunction` | libs/compass/src/gen/python/rust_scanner.rs | struct | pub | 118 | pub struct RustFunction { |
| `RustScanner` | libs/compass/src/gen/python/rust_scanner.rs | struct | pub | 127 | pub struct RustScanner { |
| `new` | libs/compass/src/gen/python/rust_scanner.rs | function | pub | 133 | pub fn new() -> Result<Self> { |
| `scan_crate` | libs/compass/src/gen/python/rust_scanner.rs | function | pub | 142 | pub fn scan_crate(&mut self, crate_path: &Path) -> Result<RustExports> { |
| `scan_file` | libs/compass/src/gen/python/rust_scanner.rs | function | pub | 205 | pub fn scan_file( |
| `User` | libs/compass/src/gen/python/rust_scanner.rs | struct | pub | 692 | pub struct User { |
| `LoadingStrategy` | libs/compass/src/gen/python/rust_scanner.rs | enum | pub | 722 | pub enum LoadingStrategy { |
| `connect` | libs/compass/src/gen/python/rust_scanner.rs | function | pub | 746 | pub async fn connect(url: &str) -> Result<Connection> { |
| `QueryBuilder` | libs/compass/src/gen/python/rust_scanner.rs | struct | pub | 764 | pub struct QueryBuilder { |
| `select` | libs/compass/src/gen/python/rust_scanner.rs | function | pub | 775 | pub fn select(&self, columns: Vec<String>) -> Self { |
| `execute` | libs/compass/src/gen/python/rust_scanner.rs | function | pub | 780 | pub async fn execute(&mut self) -> Result<Vec<Row>> { |
| `Container` | libs/compass/src/gen/python/rust_scanner.rs | struct | pub | 817 | pub struct Container<T> { |
| `Value` | libs/compass/src/gen/python/rust_scanner.rs | enum | pub | 831 | pub enum Value { |
...
changes:
  - path: "libs/compass/src/gen/python/rust_scanner.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/gen/python/rust_scanner.rs` captured during libs codegen standardization.
```
