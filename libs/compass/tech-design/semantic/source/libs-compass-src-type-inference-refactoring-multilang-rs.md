---
id: libs-compass-src-type-inference-refactoring-multilang-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/type_inference/refactoring_multilang.rs`.
capability_refs:
...
# Standardized libs/compass/src/type_inference/refactoring_multilang.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/type_inference/refactoring_multilang.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RefactorLanguage` | libs/compass/src/type_inference/refactoring_multilang.rs | enum | pub | 16 | pub enum RefactorLanguage { |
| `from_path` | libs/compass/src/type_inference/refactoring_multilang.rs | function | pub | 24 | pub fn from_path(path: &PathBuf) -> Option<Self> { |
| `keywords` | libs/compass/src/type_inference/refactoring_multilang.rs | function | pub | 35 | pub fn keywords(&self) -> &'static [&'static str] { |
| `is_keyword` | libs/compass/src/type_inference/refactoring_multilang.rs | function | pub | 104 | pub fn is_keyword(&self, name: &str) -> bool { |
| `MultiLangRefactorer` | libs/compass/src/type_inference/refactoring_multilang.rs | struct | pub | 110 | pub struct MultiLangRefactorer; |
| `new` | libs/compass/src/type_inference/refactoring_multilang.rs | function | pub | 113 | pub fn new() -> Self { |
| `extract_function` | libs/compass/src/type_inference/refactoring_multilang.rs | function | pub | 118 | pub fn extract_function( |
| `rename_symbol` | libs/compass/src/type_inference/refactoring_multilang.rs | function | pub | 773 | pub fn rename_symbol( |
...
changes:
  - path: "libs/compass/src/type_inference/refactoring_multilang.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/type_inference/refactoring_multilang.rs` captured during libs codegen standardization.
```
