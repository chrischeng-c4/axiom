---
id: libs-compass-src-lint-terraform-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/lint/terraform.rs`.
capability_refs:
...
# Standardized libs/compass/src/lint/terraform.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/lint/terraform.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `TerraformChecker` | libs/compass/src/lint/terraform.rs | struct | pub | 10 | pub struct TerraformChecker; |
| `new` | libs/compass/src/lint/terraform.rs | function | pub | 13 | pub fn new() -> Self { |
| `get_block_type` | libs/compass/src/lint/terraform.rs | function | pub | 214 | pub(super) fn get_block_type<'a>( |
| `get_block_label` | libs/compass/src/lint/terraform.rs | function | pub | 229 | pub(super) fn get_block_label( |
| `get_second_block_label` | libs/compass/src/lint/terraform.rs | function | pub | 250 | pub(super) fn get_second_block_label( |
| `block_has_attribute` | libs/compass/src/lint/terraform.rs | function | pub | 276 | pub(super) fn block_has_attribute( |
| `source_has_block_type` | libs/compass/src/lint/terraform.rs | function | pub | 302 | pub(super) fn source_has_block_type(&self, file: &ParsedFile, block_type: &str) -> bool { |
...
changes:
  - path: "libs/compass/src/lint/terraform.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/lint/terraform.rs` captured during libs codegen standardization.
```
