---
id: libs-compass-src-semantic-symbols-go-rs
summary: Lossless rust-source-unit coverage for `libs/compass/src/semantic/symbols/go.rs`.
capability_refs:
...
# Standardized libs/compass/src/semantic/symbols/go.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/compass/src/semantic/symbols/go.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `visit_go_node` | libs/compass/src/semantic/symbols/go.rs | function | pub | 18 | pub(crate) fn visit_go_node(&mut self, node: &tree_sitter::Node<'_>, file: &ParsedFile) { |
...
changes:
  - path: "libs/compass/src/semantic/symbols/go.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/compass/src/semantic/symbols/go.rs` captured during libs codegen standardization.
```
