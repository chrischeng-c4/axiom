# Contributing to server-lifecycle

## Brief

How to change `libs/server-lifecycle`. What it promises and the work roots it
...
| Gate | Command |
|---|---|
| unit + colocated tests | `cargo test -p server-lifecycle` |
