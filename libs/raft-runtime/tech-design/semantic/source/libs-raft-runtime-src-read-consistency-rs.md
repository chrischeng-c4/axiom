---
id: libs-raft-runtime-src-read-consistency-rs
summary: Lossless rust-source-unit coverage for `libs/raft-runtime/src/read_consistency.rs`.
capability_refs:
...
# Standardized libs/raft-runtime/src/read_consistency.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/raft-runtime/src/read_consistency.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `READ_CONSISTENCY_HEADER` | libs/raft-runtime/src/read_consistency.rs | const | pub | 14 | pub const READ_CONSISTENCY_HEADER: &str = "x-read-consistency"; |
| `ReadConsistency` | libs/raft-runtime/src/read_consistency.rs | enum | pub | 20 | pub enum ReadConsistency { |
| `from_header` | libs/raft-runtime/src/read_consistency.rs | function | pub | 33 | pub fn from_header(raw: Option<&str>) -> Self { |
...
changes:
  - path: "libs/raft-runtime/src/read_consistency.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/raft-runtime/src/read_consistency.rs` captured during libs codegen standardization.
```
