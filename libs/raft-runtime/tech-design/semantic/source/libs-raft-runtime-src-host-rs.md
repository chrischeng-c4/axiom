---
id: libs-raft-runtime-src-host-rs
summary: Lossless rust-source-unit coverage for `libs/raft-runtime/src/host.rs`.
capability_refs:
...
# Standardized libs/raft-runtime/src/host.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/raft-runtime/src/host.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RaftHost` | libs/raft-runtime/src/host.rs | struct | pub | 235 | pub struct RaftHost { |
| `spawn` | libs/raft-runtime/src/host.rs | function | pub | 252 | pub fn spawn( |
| `is_leader` | libs/raft-runtime/src/host.rs | function | pub | 316 | pub async fn is_leader(&self) -> bool { |
| `leader` | libs/raft-runtime/src/host.rs | function | pub | 319 | pub async fn leader(&self) -> Option<NodeId> { |
| `applied_watch` | libs/raft-runtime/src/host.rs | function | pub | 323 | pub fn applied_watch(&self) -> watch::Receiver<Index> { |
| `propose` | libs/raft-runtime/src/host.rs | function | pub | 330 | pub async fn propose(&self, command: Command) -> Result<Index> { |
| `snapshot_and_compact` | libs/raft-runtime/src/host.rs | function | pub | 396 | pub async fn snapshot_and_compact(&self) -> Result<Index> { |
| `router` | libs/raft-runtime/src/host.rs | function | pub | 410 | pub fn router(&self) -> Router { |
...
changes:
  - path: "libs/raft-runtime/src/host.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/raft-runtime/src/host.rs` captured during libs codegen standardization.
```
