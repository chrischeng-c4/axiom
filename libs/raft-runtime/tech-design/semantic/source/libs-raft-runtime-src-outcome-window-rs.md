---
id: libs-raft-runtime-src-outcome-window-rs
summary: Lossless rust-source-unit coverage for `libs/raft-runtime/src/outcome_window.rs`.
capability_refs:
...
# Standardized libs/raft-runtime/src/outcome_window.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/raft-runtime/src/outcome_window.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `DEFAULT_CAPACITY` | libs/raft-runtime/src/outcome_window.rs | const | pub | 23 | pub const DEFAULT_CAPACITY: u64 = 8192; |
| `OutcomeWindow` | libs/raft-runtime/src/outcome_window.rs | struct | pub | 32 | pub struct OutcomeWindow<T> { |
| `new` | libs/raft-runtime/src/outcome_window.rs | function | pub | 40 | pub fn new(capacity: u64) -> Self { |
| `insert` | libs/raft-runtime/src/outcome_window.rs | function | pub | 48 | pub fn insert(&mut self, index: u64, value: T) { |
| `advance` | libs/raft-runtime/src/outcome_window.rs | function | pub | 56 | pub fn advance(&mut self, index: u64) { |
| `claim` | libs/raft-runtime/src/outcome_window.rs | function | pub | 69 | pub fn claim(&mut self, index: u64) -> Option<T> { |
...
//! back to the handler that proposed it: `raft_runtime::RaftHost::propose`
...
changes:
  - path: "libs/raft-runtime/src/outcome_window.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/raft-runtime/src/outcome_window.rs` captured during libs codegen standardization.
```
