---
id: libs-raft-runtime-src-lib-rs
summary: Lossless rust-source-unit coverage for `libs/raft-runtime/src/lib.rs`.
capability_refs:
...
# Standardized libs/raft-runtime/src/lib.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/raft-runtime/src/lib.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `cluster` | libs/raft-runtime/src/lib.rs | module | pub | 13 | pub mod cluster; |
| `llm` | libs/raft-runtime/src/lib.rs | module | pub | 16 | pub mod llm; |
| `parse_peer_overrides` | libs/raft-runtime/src/lib.rs | re-export | pub | 23 | pub use cluster::{parse_peer_overrides, peer_ordinal, replica_mode, ClusterDims, ClusterTopology}; |
| `peer_ordinal` | libs/raft-runtime/src/lib.rs | re-export | pub | 23 | pub use cluster::{parse_peer_overrides, peer_ordinal, replica_mode, ClusterDims, ClusterTopology}; |
| `replica_mode` | libs/raft-runtime/src/lib.rs | re-export | pub | 23 | pub use cluster::{parse_peer_overrides, peer_ordinal, replica_mode, ClusterDims, ClusterTopology}; |
| `ClusterDims` | libs/raft-runtime/src/lib.rs | re-export | pub | 23 | pub use cluster::{parse_peer_overrides, peer_ordinal, replica_mode, ClusterDims, ClusterTopology}; |
| `ClusterTopology` | libs/raft-runtime/src/lib.rs | re-export | pub | 23 | pub use cluster::{parse_peer_overrides, peer_ordinal, replica_mode, ClusterDims, ClusterTopology}; |
| `HostConfig` | libs/raft-runtime/src/lib.rs | re-export | pub | 24 | pub use config::{HostConfig, SnapshotPolicy}; |
| `SnapshotPolicy` | libs/raft-runtime/src/lib.rs | re-export | pub | 24 | pub use config::{HostConfig, SnapshotPolicy}; |
| `RaftHost` | libs/raft-runtime/src/lib.rs | re-export | pub | 25 | pub use host::RaftHost; |
| `OutcomeWindow` | libs/raft-runtime/src/lib.rs | re-export | pub | 26 | pub use outcome_window::{OutcomeWindow, DEFAULT_CAPACITY as OUTCOME_WINDOW_DEFAULT_CAPACITY}; |
| `OUTCOME_WINDOW_DEFAULT_CAPACITY` | libs/raft-runtime/src/lib.rs | re-export | pub | 26 | pub use outcome_window::{OutcomeWindow, DEFAULT_CAPACITY as OUTCOME_WINDOW_DEFAULT_CAPACITY}; |
| `ReadConsistency` | libs/raft-runtime/src/lib.rs | re-export | pub | 27 | pub use read_consistency::{ReadConsistency, READ_CONSISTENCY_HEADER}; |
| `READ_CONSISTENCY_HEADER` | libs/raft-runtime/src/lib.rs | re-export | pub | 27 | pub use read_consistency::{ReadConsistency, READ_CONSISTENCY_HEADER}; |
| `Command` | libs/raft-runtime/src/lib.rs | re-export | pub | 28 | pub use state_machine::{Command, RaftStateMachine}; |
| `RaftStateMachine` | libs/raft-runtime/src/lib.rs | re-export | pub | 28 | pub use state_machine::{Command, RaftStateMachine}; |
| `FsyncPolicy` | libs/raft-runtime/src/lib.rs | re-export | pub | 29 | pub use store::{FsyncPolicy, RaftStore}; |
| `RaftStore` | libs/raft-runtime/src/lib.rs | re-export | pub | 29 | pub use store::{FsyncPolicy, RaftStore}; |
| `ClusterStateView` | libs/raft-runtime/src/lib.rs | re-export | pub | 30 | pub use view::{ClusterStateView, PeerAddr, RaftRole}; |
| `PeerAddr` | libs/raft-runtime/src/lib.rs | re-export | pub | 30 | pub use view::{ClusterStateView, PeerAddr, RaftRole}; |
| `RaftRole` | libs/raft-runtime/src/lib.rs | re-export | pub | 30 | pub use view::{ClusterStateView, PeerAddr, RaftRole}; |
| `auto_membership` | libs/raft-runtime/src/lib.rs | re-export | pub | 33 | pub use raft_core::{auto_membership, Index, Membership, NodeId, Term}; |
| `Index` | libs/raft-runtime/src/lib.rs | re-export | pub | 33 | pub use raft_core::{auto_membership, Index, Membership, NodeId, Term}; |
| `Membership` | libs/raft-runtime/src/lib.rs | re-export | pub | 33 | pub use raft_core::{auto_membership, Index, Membership, NodeId, Term}; |
| `NodeId` | libs/raft-runtime/src/lib.rs | re-export | pub | 33 | pub use raft_core::{auto_membership, Index, Membership, NodeId, Term}; |
| `Term` | libs/raft-runtime/src/lib.rs | re-export | pub | 33 | pub use raft_core::{auto_membership, Index, Membership, NodeId, Term}; |
...
changes:
  - path: "libs/raft-runtime/src/lib.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/raft-runtime/src/lib.rs` captured during libs codegen standardization.
```
