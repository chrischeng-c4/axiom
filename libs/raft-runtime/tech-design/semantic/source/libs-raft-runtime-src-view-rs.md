---
id: libs-raft-runtime-src-view-rs
summary: Lossless rust-source-unit coverage for `libs/raft-runtime/src/view.rs`.
capability_refs:
...
# Standardized libs/raft-runtime/src/view.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/raft-runtime/src/view.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `RaftRole` | libs/raft-runtime/src/view.rs | enum | pub | 15 | pub enum RaftRole { |
| `PeerAddr` | libs/raft-runtime/src/view.rs | struct | pub | 24 | pub struct PeerAddr { |
| `ClusterStateView` | libs/raft-runtime/src/view.rs | struct | pub | 34 | pub struct ClusterStateView { |
...
changes:
  - path: "libs/raft-runtime/src/view.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/raft-runtime/src/view.rs` captured during libs codegen standardization.
```
