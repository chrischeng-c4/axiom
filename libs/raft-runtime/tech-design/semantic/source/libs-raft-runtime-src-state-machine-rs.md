---
id: libs-raft-runtime-src-state-machine-rs
summary: Lossless rust-source-unit coverage for `libs/raft-runtime/src/state_machine.rs`.
capability_refs:
...
# Standardized libs/raft-runtime/src/state_machine.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/raft-runtime/src/state_machine.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Command` | libs/raft-runtime/src/state_machine.rs | type | pub | 7 | pub type Command = Vec<u8>; |
| `RaftStateMachine` | libs/raft-runtime/src/state_machine.rs | trait | pub | 17 | pub trait RaftStateMachine: Send + Sync + 'static { |
...
changes:
  - path: "libs/raft-runtime/src/state_machine.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/raft-runtime/src/state_machine.rs` captured during libs codegen standardization.
```
