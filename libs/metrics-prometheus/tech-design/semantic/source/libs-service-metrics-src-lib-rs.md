---
id: libs-metrics-prometheus-src-lib-rs
summary: Lossless rust-source-unit coverage for `libs/metrics-prometheus/src/lib.rs`.
capability_refs:
...
# Standardized libs/metrics-prometheus/src/lib.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/metrics-prometheus/src/lib.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Counter` | libs/metrics-prometheus/src/lib.rs | struct | pub | 24 | pub struct Counter(AtomicU64); |
| `new` | libs/metrics-prometheus/src/lib.rs | const | pub | 27 | pub const fn new() -> Self { |
| `incr` | libs/metrics-prometheus/src/lib.rs | function | pub | 32 | pub fn incr(&self) { |
| `add` | libs/metrics-prometheus/src/lib.rs | function | pub | 37 | pub fn add(&self, n: u64) { |
| `get` | libs/metrics-prometheus/src/lib.rs | function | pub | 42 | pub fn get(&self) -> u64 { |
| `Gauge` | libs/metrics-prometheus/src/lib.rs | struct | pub | 61 | pub struct Gauge(AtomicU64); |
| `set` | libs/metrics-prometheus/src/lib.rs | function | pub | 69 | pub fn set(&self, value: u64) { |
| `Latency` | libs/metrics-prometheus/src/lib.rs | struct | pub | 94 | pub struct Latency { |
...
changes:
  - path: "libs/metrics-prometheus/src/lib.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/metrics-prometheus/src/lib.rs` captured during libs codegen standardization.
```
