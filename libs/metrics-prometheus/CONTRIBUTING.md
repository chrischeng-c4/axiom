# Contributing to metrics-prometheus

## Brief

How to change `libs/metrics-prometheus`. What it promises and the work roots it
...
| Gate | Command |
|---|---|
| unit + colocated tests | `cargo test -p metrics-prometheus` |
