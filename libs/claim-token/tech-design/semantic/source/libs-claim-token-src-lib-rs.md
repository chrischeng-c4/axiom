...
# Standardized libs/claim-token/src/lib.rs

## Overview
<!-- type: overview lang: markdown -->

Public API manifest for `libs/claim-token/src/lib.rs` captured during libs codegen standardization.

### Symbols

| Name | Target | Kind | Visibility | Line | Signature |
|------|--------|------|------------|------|-----------|
| `Scope` | libs/claim-token/src/lib.rs | struct | pub | 14 | pub struct Scope { |
| `sign` | libs/claim-token/src/lib.rs | function | pub | 50 | pub fn sign(secret: &[u8], scope: &Scope) -> String { |
| `verify` | libs/claim-token/src/lib.rs | function | pub | 58 | pub fn verify(secret: &[u8], token: &str, now: u64) -> Option<Scope> { |
...
changes:
  - path: "libs/claim-token/src/lib.rs"
    ...
    impl_mode: codegen
    description: |
      rust-source-unit (td_ast) source for `libs/claim-token/src/lib.rs` captured during libs codegen standardization.
```
